...
if($id=="boy"){ $tempid="1"; }
elseif($id=="girl"){ $tempid="2"; }
elseif($id=="baby"){ $tempid="3"; }
elseif($id=="plushie"){ $tempid="4"; }
elseif($id=="game"){ $tempid="5"; }
elseif($id=="hobby"){ $tempid="6"; }
elseif($id=="season"){ $tempid="7"; }
elseif($id=="zaka"){ $tempid="8"; }
elseif($id=="other"){ $tempid="9"; }
...
<?
	...
	while ($i < $companynum) {
		...
		if($id=="boy"){ $mainid="$datatemp[10]"; }
		elseif($id=="girl"){ $mainid="$datatemp[11]"; }
		elseif($id=="baby"){ $mainid="$datatemp[12]"; }
		elseif($id=="plushie"){ $mainid="$datatemp[13]"; }
		elseif($id=="game"){ $mainid="$datatemp[14]"; }
		elseif($id=="hobby"){ $mainid="$datatemp[15]"; }
		elseif($id=="season"){ $mainid="$datatemp[16]"; }
		elseif($id=="zaka"){ $mainid="$datatemp[17]"; }
		elseif($id=="other"){ $mainid="$datatemp[18]"; }
