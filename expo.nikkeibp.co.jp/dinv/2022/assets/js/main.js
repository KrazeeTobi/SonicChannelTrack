...
(function($) {
  ...
  $(function() {
    ...
    $('a[href ^="#"]').click(function() {
      ...
      if($('.js-header').hasClass('-fixed')){
        ...
        position = target.offset().top - headerHeight - headerHeight;
      }
  ...
  window.addEventListener('load', function() {
    if(location.hash) {
      ...
      const localNavHeight = $('.js-localNav').height();
      if(scrollTop < localNavHeight){
  ...
  // -----------------------------------------------------------------------------
  $(function() {
    let localNavHeight = $('.js-localNav').height(),
