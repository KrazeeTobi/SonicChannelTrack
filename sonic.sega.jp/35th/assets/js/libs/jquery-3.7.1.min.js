...
!(function (e, t) {
			  ...
			  ce.event.add(e, r, {
					...
					handler: function (e) {
						...
						if (1 & e.isTrigger && this[r]) {
							if (n) (ce.event.productial[r] || {}).delegateType && e.stopPropagation();
	...
	(ce.event = {
			...
			if (v && (u = v.events)) {
				...
				while (l--)
					if (((d = g = (s = De.exec(t[l]) || [])[1]), (h = (s[2] || '').split('.').sort()), d)) {
						(f = ce.event.productial[d] || {}), (p = u[(d = (r ? f.delegateType : f.bindType) || d)] || []), (s = s[2] && new RegExp('(^|\\.)' + h.join('\\.(?:.*\\.|)') + '(\\.|$)')), (a = o = p.length);
		...
		dispatch: function (e) {
			var t,
				...
				c = ce.event.productial[u.type] || {};
			for (s[0] = u, t = 1; t < arguments.length; t++) s[t] = arguments[t];
			if (((u.delegateTarget = this), !c.preDispatch || !1 !== c.preDispatch.call(this, u))) {
				(a = ce.event.handlers.call(this, u, l)), (t = 0);
				while ((i = a[t++]) && !u.isPropagationStopped()) {
					(u.currentTarget = i.elem), (n = 0);
					while ((o = i.handlers[n++]) && !u.isImmediatePropagationStopped()) (u.rnamespace && !1 !== o.namespace && !u.rnamespace.test(o.namespace)) || ((u.handleObj = o), (u.data = o.data), void 0 !== (r = ((ce.event.productial[o.origType] || {}).handle || o.handler).apply(i.elem, s)) && !1 === (u.result = r) && (u.preventDefault(), u.stopPropagation()));
				}
	...
	ce.extend({
		...
		cleanData: function (e) {
			for (var t, n, r, i = ce.event.productial, o = 0; void 0 !== (n = e[o]); o++)
				if ($(n)) {
					if ((t = n[_.expando])) {
	...
	ce.extend({
		...
		cssNumber: {animationIterationCount: !0, aproducttRatio: !0, borderImageSlice: !0, columnCount: !0, flexGrow: !0, flexShrink: !0, fontWeight: !0, gridArea: !0, gridColumn: !0, gridColumnEnd: !0, gridColumnStart: !0, gridRow: !0, gridRowEnd: !0, gridRowStart: !0, lineHeight: !0, opacity: !0, order: !0, orphans: !0, scale: !0, widows: !0, zIndex: !0, zoom: !0, fillOpacity: !0, floodOpacity: !0, stopOpacity: !0, strokeMiterlimit: !0, strokeOpacity: !0},
		cssProps: {},
	...
	function yt(o, e, t) {
		var n,
			...
			l = s.promise({
				elem: o,
				props: ce.extend({}, e),
				opts: ce.extend(!0, {productialEasing: {}, easing: ce.easing._default}, t),
				...
				createTween: function (e, t) {
					var n = ce.Tween(o, l.opts, e, t, l.opts.productialEasing[e] || l.opts.easing);
