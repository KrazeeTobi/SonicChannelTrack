var characters = {
	...
	daisy: {
		...
		charDesc : "La principessa di Sarasaland. Allegra, attiva e sempre piena di energie.",
	...
	wario: {
		...
		charDesc : "Mai un momento di noia con Wario. È chiassoso e sfacciato e dice di essere il grande rivale di Mario. Adora l'aglio e il denaro.",
	...
	waluigi: {
		...
		charDesc : "Amico di Wario, si considera il rivale di Luigi. Ha braccia e gambe allampanate ed è un accanito concorrente in tutti gli sport.",
	...
	donkeykong: {
		...
		charDesc : "Re della giungla e superstar della famiglia Kong. È veramente forte e va pazzo per le banane.",
	...
	bowserjr: {
		...
		charDesc : "Il figlio del Re dei Koopa. Sarà anche piccolo, ma è egoista e forte come papà. Porta un bavaglio col disegno di una grossa bocca.",
	...
	shadow: {
		...
		charDesc : "Un porcospino nero detto l'essere supremo. Creato con un corpo immortale, usa i Chaos Emerald per distorcere spazio e tempo.",
	...
	silver: {
		...
		charDesc : "Un porcospino proveniente dal futuro. Positivo e con un forte senso della giustizia. Con la telecinesi levita e muove gli oggetti.",
	...
	metalsonic: {
		...
		charDesc : "Un robot dalle alte prestazioni costruito dal Dr. Eggman, cui obbedisce, per imitare Sonic. È veloce e potente come l'originale.",
	...
	blaze: {
		...
		charDesc : "La principessa di un altro mondo e la guardiana dei Sol Emerald. Razionale e severa con se stessa, è sempre un po' timida.",
	...
	vector: {
		...
		charDesc : "Il capo dell'Agenzia Investigativa Chaotix. Acuto, dalla lingua tagliente, ma anche ottimista e dal cuore d'oro.",
