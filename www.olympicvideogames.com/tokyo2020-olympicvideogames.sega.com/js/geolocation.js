	...
	this.buildURL = function(country) {
		if (this.countriesSupported.indexOf(country) > -1 ) {
			if (country === "uk" || country === "gb") {
				return "https://tokyo2020-olympicvideogames.sega.com/uk/";
			} else if (country === "tw" || country === "ct") {
				return "https://tokyo2020-olympicvideogames.sega.com/ct/";
			}
			return "https://tokyo2020-olympicvideogames.sega.com/" + country + "/";
		} else if (this.europeanCountries.indexOf(country) > -1) {
			return "https://tokyo2020-olympicvideogames.sega.com/uk/";
		} else {
			return "https://tokyo2020-olympicvideogames.sega.com/us/";
		}
	}
}
