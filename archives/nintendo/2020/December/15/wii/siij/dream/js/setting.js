...
$(function(){
	...
	$("#header").css("background-image","url(../common/img/navi04.png)");
	
	$("#header").css("background-position","center -640px");
...
if(document.documentElement.scrollHeight > document.documentElement.clientHeight){
  ...
  $("#bgBox05").css("height",parseInt(contHt)+"px");
...
window.onload = function (){
	MM_preloadImages('img/horse_f2.png','img/hopping_f2.png','img/discus_f2.png','../common/img/page-top_f2.png','../common/img/fmenu01_f2.jpg','../common/img/fmenu02_f2.jpg','../common/img/fmenu03_f2.jpg','../common/img/fmenu04_f2.jpg','../common/img/fmenu05_f2.jpg','../common/img/fmenu08_f2.jpg','../common/img/fmenu06_f2.jpg','../common/img/fmenu07_f2.jpg','img/hurdles_f2.png','img/sprint_f2.png ','img/trampoline_f2.png','img/unevenbars_f2.png ','img/rafting_f2.png');
}
