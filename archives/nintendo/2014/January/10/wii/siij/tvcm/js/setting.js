...
$(function(){
	...
	$("#header").css("background-image","url(../common/img/navi07.png)");
...
if(document.documentElement.scrollHeight > document.documentElement.clientHeight){
  ...
  $("#bgBox08").css("height",parseInt(contHt)+"px");
  ...
  if (window.innerHeight){
			...
			var minw =window.innerWidth-+360;
...
if(document.documentElement.scrollHeight > document.documentElement.clientHeight){
  ...
  if (window.innerHeight){
			var wht = window.innerHeight;
			var wwd = window.innerWidth;
			var minw =window.innerWidth-740+160;
	}else if(document.documentElement){
			var wht = document.documentElement.clientHeight;
			var wwd = document.documentElement.clientWidth;
			var minw =document.documentElement.clientWidth-740+360;
...
window.onload = function (){
	MM_preloadImages('../common/img/page-top_f2.png','../common/img/fmenu01_f2.jpg','../common/img/fmenu02_f2.jpg','../common/img/fmenu03_f2.jpg','../common/img/fmenu04_f2.jpg','../common/img/fmenu05_f2.jpg','../common/img/fmenu08_f2.jpg','../common/img/fmenu06_f2.jpg','../common/img/fmenu07_f2.jpg','img/tvcm_f2.png ','img/intro_f2.png ','img/opening_f2.png','img/btn_gotop_f2.png' );
}
