...
$(function(){
	...
	$("#header").css("background-image","url(../common/img/navi05.png)");
	
	
	
	$("#header").css("background-position","center -800px");
...
if(document.documentElement.scrollHeight > document.documentElement.clientHeight){
  ...
  $("#bgBox06").css("height",parseInt(contHt)+"px");
  ...
  $("#bgMain img").css("height",parseInt(imgWd)+"px");
	...
	MM_preloadImages('../common/img/page-top_f2.png','../common/img/fmenu01_f2.jpg','../common/img/fmenu02_f2.jpg','../common/img/fmenu03_f2.jpg','../common/img/fmenu04_f2.jpg','../common/img/fmenu05_f2.jpg','../common/img/fmenu08_f2.jpg','../common/img/fmenu07_f2.jpg');
