$(function ($) {
    ...
    function renderSubFilters() {
        ...
        templateData = { directorySponsor: exhibitorData.directorySponsor, subFilters: subFilters };
    ...
    function renderPage() {
        ...
        if (filters.filter === 'featured' || filters.filter === 'Featured') {
            ...
            templateData = { groupedItems: groupedItems, featured: exhibitorData.featuredExhibitors, isDefaultPage: isDefaultPage };
        }
        else {
            groupedItems = groupByArray(exhibitorData.exhibitors, filters.sortBy);
            templateData = { groupedItems: groupedItems, featured: exhibitorData.featuredExhibitors, filter: filters.filter, isDefaultPage: isDefaultPage };
        }
        $("#content").html(CES.templates.exhibitorListing(templateData));
    }
    ...
    function elScroll(e) {
        ...
        if (window.pageYOffset > getPageHeight() * 7 / 8) {// start at 5/6 of the way through the page
            getNextPage();
        }
    }
    ...
    function getPageHeight() {
        ...
        const elementSelector = '.index-cards';
    ...
    function groupByArray(xs, key, valueModifier) {
        ...
        return xs.reduce(function (rv, x) {
            ...
            else if (typeof v === 'undefined' && key === 'eurekaPark') {
                v = x.eurekaCategories[0].categoryName;
