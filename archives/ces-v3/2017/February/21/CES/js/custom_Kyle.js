    ...
    $(document).ready(function ($) {
        ...
        */
        ...
        if (!$.support.leadingWhitespace == false) {
            ...
            var sticky_navigation_height = $('#sticky_navigation').height();
            console.log("sticky_navigation_height first: " + sticky_navigation_height);
            var sticky_navigation = function () {
                var scroll_top = $(window).scrollTop(); // our current vertical position from the top
                
                if (scroll_top > sticky_navigation_offset_top) {
                    console.log("sticky_navigation_height before: " + sticky_navigation_height);
                    //$('#sticky_navigation').css({ 'position': 'fixed', 'top': 0, 'left': 0 });
                    //$('body').css({ 'margin-top': sticky_navigation_height });
                    $('#sticky_navigation').addClass("fixed");
                    $('#sticky_navigation').addClass("shadow");
                    //$('#sticky_navigation').parent().attr("style", "height:" + sticky_navigation_height);
                    ...
                    $('#sticky_navigation').parent().css({ 'margin-top': sticky_navigation_height + 10 }) // Plus 10 for margin-bottom on .shadow class
                    console.log("sticky_navigation_height after: " + sticky_navigation_height);
                    //$('#sticky_navigation .search-container').addClass("small-search-container");
                } else {
                    //$('body').css({ 'margin-top': '0' });                 
                    //$('#sticky_navigation').parent().removeAttr("style");
                    ...
                    $('#sticky_navigation').parent().css({ 'margin-top': '0' });
                }
            };
            var sticky_navigation_height = $('#sticky_navigation').height();
            sticky_navigation();
        ...
        */
        ...
        $("#searchTxt").focus(function () {
            $(".maintitle").removeClass("col-xs-20 col-sm-25 col-md-4 col-lg-12").addClass("col-xs-60 col-md-48 col-lg-48");
            if (windowWidth() > 991)
                $(".mainnav").fadeTo(500, 0);
            else if (windowWidth() < 991)
                $('.mainlogo').fadeTo(500, 0);
        }).focusout(function () {
            if (windowWidth() > 991)
                $(".mainnav").fadeTo(500, 1);
            else if (windowWidth() < 991)
                $('.mainlogo').fadeTo(500, 1);
            $(".maintitle").removeClass("col-xs-60 col-md-48 col-lg-48").addClass("col-xs-20 col-md-4 col-sm-25 col-lg-12");
        });
