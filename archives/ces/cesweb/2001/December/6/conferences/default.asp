...
<script language="javascript1.2">
	...
	<script language="javascript1.2">
		...
		var pageID = "1.2.1"; //INSERT PAGE ID HERE
	</script>
...
Fantastic exhibits and a whole lot more! The 2002 International CES Conference Program is the place for the latest consumer electronics education. Learn from the visionaries and the people in the trenches, making tomorrow's innovations a reality.<p>

We bring you incredible value with free <a href="/conferences/keynotes.asp?menuItem=1&subMenuItem=1&tabName=Attendee">Keynotes</a>  at the Las Vegas Hilton and <a href="/conferences/supersessions.asp?menuItem=1&subMenuItem=2&tabName=Attendee">SuperSessions</a> from the most influential industry leaders.
<p>
For more in-depth training, go to the <a href="/conferences/conference_program.asp?menuItem=1&subMenuItem=3&tabName=Attendee">
CES Knowledge Circuit</a>. We've rewired our conferences into a powerful circuit of high-energy information sessions.<p>

Our <a href="/conferences/conference_program.asp?menuItem=1&subMenuItem=3&tabName=Attendee#partner">Partner Programs</a> <!--Strategic Master Classes-->deliver quality training for professionals who want to take their expertise to another level.
<p>
You're sure to leave the CES Conference Program empowered with new insights and practical knowledge you can put to work immediately. In fact, we guarantee it. <p>

We bring you incredible value and help you find your way to the sessions that will benefit you most. Every year you get one chance to hear from the biggest names in the consumer electronics industry. Can you afford to miss it?<p>
...
<script language="JavaScript">
	if (addedValue == true) {
		...
		document.write("December 6, 2001");
		document.write("</font>");
	}
</script>
...
<font class="righthead">Free Conference Happy Hour!</font><br>
All <a href="/conferences/conference_program.asp?menuItem=1&subMenuItem=3&tabName=Attendee">Knowledge Circuit sessions</a> are free the first hour of the show, January 8, 10:30-11:30 a.m. Register now! </font>
