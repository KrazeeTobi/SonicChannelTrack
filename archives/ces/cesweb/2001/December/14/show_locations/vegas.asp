...
<head>
<title>2002 International CES: Las Vegas Information</title>
...
<script language="javascript1.2">
		...
		var pageID = "1.4.4"; //INSERT PAGE ID HERE
	</script>
...
<font class="pagehead">Las Vegas Information</font><p>
<!-- content starts here --> 
...
<TABLE WIDTH=442 BORDER=0 CELLPADDING=0 CELLSPACING=0>
	<TR>
		<TD COLSPAN=2>
			<IMG SRC="images/vegas_postcard_top.gif" WIDTH=442 HEIGHT=72></TD>
	</TR>
	<TR>
		<TD>
			<IMG SRC="images/vegas_postcard_left.gif" WIDTH=227 HEIGHT=115></TD>
		<TD>
			<IMG SRC="images/vegas_postcard_right.gif" WIDTH=215 HEIGHT=115></TD>
	</TR>
	<TR>
		<TD COLSPAN=2>
			<IMG SRC="images/vegas_postcard_bottom.gif" WIDTH=442 HEIGHT=84></TD>
	</TR>
</TABLE>
<p>
...
<font size="3"><strong>Las Vegas</strong></font> may be the "Entertainment Capital of the
...
2002 International CES almost as enticing as the
showcase itself.
<p>
<table width="35%" align="right" border="0">
<tr>
<td><div style="border-style:solid;border-width:1;border-color:666699;background-color:edf4f8;padding:5"><font class="body">CES is the best place for me to see the hot new ideas 
and products, so we can plan for the future.  I also really like the fact that it's in Las Vegas, because the fast pace of the city reflects the fast pace
of the show and technology."</font><br>
<font size="1"><em>Eric McNiff, Senior Product Manager, CYRK,Wakefield, MA</em></font>
</div>
</td>
</tr>
</table><p>
...
<a name="weather"></a><font class="head">Las Vegas Weather</font><br>
<br>
<!-- Begin weather.com magnet include -->
<form method= "post" action="http://www.weather.com/cgi-bin/uncgi/zip_city_search.cgi?par=internal&site=magnet&code=289123&promo=english">
<table>
<tr><td>
...
<!-- note: I'm not sure what this code is like 
I may research a better one with them but for now post - this is the one accuweather sent 
us as an affiliate) -->

<!--Hide text on Vegas.com conflicts with HRT contract
<a name="dining"></a><font class="subhead">Dining Out</font><br>
<br>
Indulge in Vegas. Vegas.com provides tips on where, when and how to eat in Vegas. Learn from Vegas chefs where they chose to eat. If it's not lunch @ the Las Vegas Convention Center, make a date of it. <br>
<br>
Bon appétit! For more dining information, <a href="http://www.vegas.com/dining.html">click here</a>.<br>
<br>
-->
<p><font size="1"><a href="#top">back to the top</a></font><p>

<a name="getting"></a><font class="head">Getting Around: CES Foots The Bill</font><br>
<br>
While you’re at CES, you will have plenty to do and see &#151; stimulus overload. Let us provide your 
transportation. The <a href="/hotel_travel/shuttle.asp?menuItem=7&subMenuItem=2&tabName=Attendee">CES shuttle</a> runs 
every day during the show to and from our venues. For more information on CES transportation 
opportunities including CES airfare deals and car rentals, <a href="/hotel_travel/airlines_cars.asp?menuItem=6&subMenuItem=-1&tabName=Attendee">check out CES Travel</a>.<br>
<br>
Please remember there is very limited parking at CES this year. Chose your transportation battles wisely and let us be your chauffeur!<br>
<br>
Other Vegas transportation options include:
<ul>
<li>Limos</li>
<li>Shuttle</li>
<li>Taxi - average fares</li>
<li>Bus</li>
<li>Private Cars </li>
...
<br>
For more details on getting around Vegas, including traffic jam areas and how to save some precious dollars, <a href="http://govegas.about.com/travel/govegas/msubaround.htm">check out About.com's resources for Las Vegas Visitors</a>.<br>
<p><font size="1"><a href="#top">back to the top</a></font><p>

<a name="secrets"></a><font class="head">Secrets To Vegas From Those In The Know By Vegas.com</font><br>
<br>
Tips on tipping: Since Las Vegas is a service-based city, tipping is a big, big deal. Just ask the IRS. You may not be too sure how much to tip and when. So here's a quick rundown.<br>
<ul>
...
<br>
A CES quick tip: Taking the CES shuttle requires Zero Dollars! That includes No Tipping!
</font>
<p><font size="1"><a href="#top">back to the top</a></font><p>
...
<script language="JavaScript">
	if (addedValue == true) {
		...
		document.write("December 13, 2001");
		document.write("</font>");
	}
</script>
...
<tr><td class="generalRightNav">&nbsp;<a href="#weather" class="generalRightNav">Vegas Weather</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;<a href="#getting" class="generalRightNav">Getting Around</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;<a href="#secrets" class="generalRightNav">Vegas Secrets</a></td></tr>
