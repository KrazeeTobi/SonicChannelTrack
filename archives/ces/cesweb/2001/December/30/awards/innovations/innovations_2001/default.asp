...
<font class="pagehead">Innovations 2001</font>
<br><br>

<!-- content starts here --> 

<font class="body">
Innovations 2001 is the <a href="http://www.ce.org">Consumer 
Electronics Association’s</a> (CEA) prestigious competition which honors product 
excellence in Design and Engineering.<BR><BR>

The Design &amp; Engineering Honors 
Program recognizes the most innovative products in the categories of Accessories, Audio, 
Blank Media, Computer Hardware and Software, Electronic Gaming, Home Appliances, Integrated Home Systems, 
...
Entries in the Innovations 2001 Design &amp; Engineering Honors Program were judged by a panel of 22 
prominent industry experts. For the sixth year, the Industrial Designers Society 
...
All who visit Innovations 2001 walk away with a 
sense of the excellence that can be achieved in consumer technology. <p>

<a href="javascript:displayNewWindow('/awards/innovations/innovations_2000/innov.home.html');">Click Here</a> to view last year's Innovation Honorees.
<p>
...
<script language="JavaScript">
	if (addedValue == true) {
		...
		document.write("December 30, 2001");
		document.write("</font>");
	}
</script>
