...
<script language="javascript1.2">
	...
	<script language="javascript1.2">
		...
		var pageID = "1.2.4.D"; //INSERT PAGE ID HERE
	</script>
...
<font class="pagehead">Search by Session Date</font><br>
<br>
<font class="body">

<!-- content starts here --> 
<form action=session_date_list.asp?menuItem=&subMenuItem=&tabName= method=post ><table cellpadding=3 cellspacing=1 border=0 width='60%'><tr><td class=row_label align=center>Choose a Date from the Drop Down List</td></tr><tr><td><hr color='#006388' size=1></td></tr><tr><td align=center class=row_data  colspan=1><select class=formdata name=sessiondate><option value=0>Choose a Date&nbsp;&nbsp;<option value="1/7/02">Monday, January 7, Day Before CES Opens<option value="1/8/02">Tuesday, January 8, CES Day 1<option value="1/9/02">Wednesday, January 9, CES Day 2<option value="1/10/02">Thursday, January 10, CES Day 3<option value="1/11/02">Friday, January 11, CES Day 4</select></td></tr><tr><td><hr color='#006388' size=1></td></tr><tr><td align=center><input type=submit class=formdata value="Choose Date">&nbsp;<input class=formdata type=Reset></td></tr></table></form>
