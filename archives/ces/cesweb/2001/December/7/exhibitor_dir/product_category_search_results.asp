...
<script language="javascript1.2">
		...
		function submitForm(url)
			{
				var form = document.searchByProductCategory;
				form.action = url;
				form.submit();
			}
</script>
...
<font class="head">Exhibitor Directory - Search Results</font>
<p>&nbsp;<br>
<font class="body">
...
<p>PCSearchPubliclyTraded.getMultipleSelectItems-&gt;Data Components.PCSearchProductCategory.getMultipleSelectItems@WEB_IIS1-&gt;Data Components.PCSearchProductCategory.search@WEB_IIS1</font> <font face="Arial" size=2>error '800ac351'</font>
<p>
<font face="Arial" size=2>Invalid form data</font>
<p>
<font face="Arial" size=2>/exhibitor_dir/product_category_search_results.asp</font><font face="Arial" size=2>, line 54</font> 