...
<script language="javascript">
	function newWindow(){
		winWindow = window.open('interpreter_request_mail.asp','IntReq','width=330,height=350')
	}
	function newWindow2(){
		winWindow = window.open('international_travel_agent_mail.asp','IntTA','width=330,height=500')
	}
	
	function newWindow3(){
		winWindow = window.open('international_address_change.asp','ChngAdd','width=330,height=500')
	}
</script>
...
<td class="generalRightNav">&nbsp;<a href="/contact_ces/default.asp" class="generalRightNav">Contact Us</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr><tr>

<td class="generalRightNav">&nbsp;<a href="/about_ces/default.asp" class="generalRightNav">About CES</a></td></tr>
