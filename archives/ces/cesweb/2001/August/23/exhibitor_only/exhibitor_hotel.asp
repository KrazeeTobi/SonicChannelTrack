...
<html>
<head>
	<title>2002 International CES: Housing Information for Exhibitors</title>
	...
	<script language="javascript1.2">
		...
		var pageID = "2.11"; //INSERT PAGE ID HERE
	</script>
...
<font class="pagehead">Exhibitor Housing</font><p>&nbsp;
<br>
<font class="body">
<!-- content starts here --> 
Contact CES’ official housing and travel company, Housing, Registration, Travel (HRT) to make your arrangements for the 2002 International CES, January 8 - 11, 2002.   Space is limited, so we recommend making your reservations as soon as possible. Please download the 
<a href="exhibitor_housing.pdf">Exhibitor Housing Form</a> for more detailed information or contact HRT directly:<p>
