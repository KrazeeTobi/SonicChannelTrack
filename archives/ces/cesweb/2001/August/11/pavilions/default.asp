...
<font class="pagehead">Technology Pavilions</font><br>
<br>
<font class="body">
<!-- content starts here --> 


<font class="head">Technology Pavilions at the 2002 International CES</font>
<ul>
	<li><a href="#car">Digital Car Showroom</a></li>
	<li><a href="#idb">IDB Forum</a></li>
	<li><a href="#bluetooth">Bluetooth Showcase</a></li>
	<li><a href="#imaging">Imaging Technology Pavilion</a></li>
	<li><a href="#ecommerce">E-Commerce Hub</a></li>
	<li><a href="#mp3">MP3 & Internet Audio Zone</a></li>
	<li><a href="#wireless">Wireless Data Hub</a></li>
	<li><a href="#emerge">Emerging Technologies Launchpad</a></li>
</ul>
...
<i>Las Vegas Convention Center, North 1 – 4</i><br><br>
...
<i>Las Vegas Convention Center, North 1 – 4</i><br>
<i>Sponsored by IDB Forum</i><br><br>

Get plugged in! Intelligent Data Bus (IDB) defines
the industry's first set of interface standards for automotive information,
communications and entertainment systems.<p>

IDB provides the convergence standard for electronics
equipment in new-generation automotive systems.   It’s the plug-and-play technology that makes 
off-the-shelf electronics work with all cars' networks.  <p>

Say good-bye to the gap between lengthy design and
production cycles and when innovative products appear in factory vehicles.<p>

Join leading automobile manufacturers and key engineers eager to discuss the latest
innovations in after-market car products.<p>


<a name="bluetooth"></a>
<font class="subhead">Bluetooth Showcase</font><br>
<i>Las Vegas Convention Center, South 3 – 4</i> <i>Bluetooth*<sup>TM</sup> Pavilion<br>
Endorsed by the Bluetooth*<sup>TM</sup> Special Interest Group</i><br><br>

Every year you get
one chance to see the latest Bluetooth technology in one place. This is it. 
The Bluetooth revolution makes two-way data transmission a wireless
reality.  Faster. Flawless. Better. <p>

Bluetooth technology
is the fastest growing industry standard ever. 
It’s set to transform how our digital devices communicate and
interconnect—in the office and at home. <p>

Visit the Bluetooth
Showcase.  Find out about the best
innovations using this cutting-edge wireless digital technology. Make high-speed connections with Bluetooth
technology exhibitors.<p>

<i>* Bluetooth is a
trademark owned by its proprietor and used by CES under license.</i><p>


<a name="imaging"></a>
<font class="subhead">Imaging Technology Pavilion</font><br>
<i>Las Vegas Convention Center, North 1 – 4</i><br><br>

The digital market
continues to explode, as pixel counts increase and prices decrease. Capture, edit and share. 
It’s more than just digital imaging and digital video.  It’s about content and
delivery.  Be part of a digital revolution at the new Imaging Technology Pavilion.<p>

The Internet has changed it all! Digital photography, digital video and video streaming are
converging.  Capture, enhance and share
content with equipment and services you discover at the 2002 International CES.<p>

Don't miss the video
hardware, convergence devices, photo/video
editing and processor hardware/software, digital storage media/readers, photo
printers and imaging devices, digital/video accessories, processing/storage
services, and multimedia publishing/Internet solutions.<p>


<a name="ecommerce"></a>
<font class="subhead">E-Commerce Hub</font><br>
<i>Las Vegas Convention Center, North 1 – 4</i><br><br>

Streamline. Automate. Sell.  Take customer service to
the next level.  Meet the experts who have the solutions you seek.  Check out
the newest developments in E-Commerce. Strengthen your buyer-seller relationships.
Discover the crucial innovations that will help you stay ahead of
the pack in an age where the strongest B2B and B2C leaders will make their mark.<p>

Come to the E-Commerce Hub to meet key partners who will show you how to maximize your potential.<p>


<a name="mp3"></a>
<font class="subhead">MP3 &amp; Internet Audio Zone</font><br>
<i>Las Vegas Convention Center, North 1 – 4</i><br><br>

Get the latest buzz in the world of downloadable digital audio. Explore the convergence of the
entertainment, computer and Internet industries. Find out which emerging
companies offer the hottest products, newest features and best price points.  <p>


<a name="wireless"></a>
<font class="subhead">Wireless Data Hub</font><br>
<i>Las Vegas Convention Center, North 1 – 4</i><br><br>

We’ve come a long way from the remote control! Service providers are racing to supply
wireless networks that deliver voice, news, Internet access, navigation
services and more.  Bluetooth is a key wireless technology standard.  What
other platforms will be successful in breaking new ground? Find out at the Wireless Data Hub.
See the newest and coolest wireless killer apps entering the wireless consumer market.<p>


<a name="emerge"></a>
<font class="subhead">Emerging Technologies Launchpad</font><br>
<i>Las Vegas Hilton</i><br><br>

See it first! Be “up” on what’s “in.”  Check out tomorrow's technologies, today. 
Visit this showcase of the latest consumer technology innovations.
Check out hot, growth companies and their next-generation products. Don't miss what promises to be the most- visited
pavilion at the 2002 International CES!
...
<tr><td class="generalRightNav">&nbsp;<a href="#bluetooth" class="generalRightNav">Bluetooth Showcase</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;<a href="#imaging" class="generalRightNav">Imaging Technology Pavilion</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;<a href="#ecommerce" class="generalRightNav">E-Commerce Hub</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;<a href="#mp3" class="generalRightNav">MP3 & Internet Audio Zone</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;<a href="#wireless" class="generalRightNav">Wireless Data Hub</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;<a href="#emerge" class="generalRightNav">Emerging Technologies Launchpad</a></td></tr>
