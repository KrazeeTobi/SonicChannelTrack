...
<html>
<head>
	<title>2002 International CES:  CE Technologies</title>
	<script language="javascript1.2">
		var ns=(document.layers);var ie=(document.all);
		var temp='';
		var thePath=location.pathname;
		var pageID="1.10"; //INSERT PAGE ID HERE
	</script>
...
<font class="pagehead">CE Technologies</font><br>
<br>
<font class="body">
<!-- content starts here --> 

Find out where you’ll see the new technologies at CES, who’s
exhibiting them and which pavilions highlight these products and services.
Explore which speakers and conferences are touting the new technologies, check
reference material on buying and installing them and read about the trends that
predict tomorrow’s marketplace. Finally, take note how the press views these
developments, and remember that from HDTV to DVD to tomorrow’s hot products,
the new technologies all made their debut at the International CES.

<ul>
<li><font class="subhead">Accessories</font> (from cables and new connections to
portable memory such as Memory Stick and Compact Flash)</li>

<li><font class="subhead">Audio Hardware and Software</font> (high-end audio, Internet
audio, mainstream audio, car audio, satellite radio, DVD-Audio, SACD,
multichannel audio)</li>

<li><font class="subhead">Business Management</font> (retail resources, e-commerce)</li>

<li><font class="subhead">Digital Hollywood and Content</font> (creation of a
high-quality video and audio experience, making it easily available, protecting
consumers’ rights to access to content)</li>

<li><font class="subhead">Digital Imaging</font> (camcorders and digital cameras,
including storage, retrieval, transmitting and printing) </li>

<li><font class="subhead">Electronic Gaming</font> (videogame platforms and online
venues for entertainment) </li>

<li><font class="subhead">Home Networking</font> (Internet appliances, energy
efficiency, standards for connecting, custom installation)</li>

<li><font class="subhead">Home Theater</font> (video, audio and custom installation)</li>

<li><font class="subhead">Mobile/In-Car Electronics</font> (GPS, IDB, vehicle
navigation, car audio, car security, radar detectors, satellite radio,
automotive computing)</li>

<li><font class="subhead">Personal Electronics</font> (watches, healthcare, MP3,
camera/watch combo units)</li>

<li><font class="subhead">Satellite Systems</font> (TV, satellite radio)</li>

<li><font class="subhead">Small Office/Home Office</font> (networking technologies like
1394, USB and infrared; operating systems like Linux; and handheld information.
CEA’s emphasis on state sales tax holidays and energy efficiency also is
featured here.)</li>

<li><font class="subhead">Telecommunications</font> (DSL, broadband, landline telephony)</li>

<li><font class="subhead">Video Hardware and Software</font> (DTV, DVD, interactive TV)</li>

<li><font class="subhead">Wireless Communications</font> (Bluetooth; 3G; cell phones;
pagers; family radio; handheld info devices)</li>
...
<font class="righthead">Register Now!</font> <br>
Don't miss what the high-tech industry has in store for the 2002 CES. <a href="/registration/default.asp?menuItem=0&subMenuItem=-1&tabName=Attendee"> Register Now!</a><br>
