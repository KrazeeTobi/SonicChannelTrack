...
<head>
	...
	<script language="javascript1.2">
		...
		var pageID = "1.7.1"; //INSERT PAGE ID HERE
	</script>
...
<font class="pagehead">Innovations Awards</font><br><br><img src="images/innovations_logo_2k2.jpg" align="right" width="90" height="115">
<font class="body">
...
America (IDSA) has endorsed and acted as advisors to the Design &amp;
...
categories of Accessories, Audio, Blank Media, Computer Hardware and Software,
...
Innovations 2002 display area at the 2002 International CES, January 8-11,
2002, in Las Vegas, Nevada USA.<a name="benefits"></a><p>
...
<b>Use the <a href="javascript:parseAndGo('submission/default.asp');">online entry form</a> beginning Aug. 6.The entry deadline is Friday, Sept. 28, 2001.</b><p>
...
<li>products entered must be fully functional and available for display at the Innovations 2002 Showcase exhibit at the 2002 International CES, January 8-11, 2002, Las Vegas, Nevada<a name="deadlines"></a></ul>

<font class="subhead">Deadlines</font><br>
...
</table><a name="cost"></a><p>
<font class="subhead">Cost per Entry</font><br>
<table border="0" width="80%">
<td class="shadow">CEA member companies</td><td class="shadow"> $200 first entry; $175 each additional entry</td></tr>
<td class="noshadow">Non-CEA member companies</td><td class="noshadow">$400 first entry; $350 each additional entry</td></tr>
<td class="shadow">Non-web entry fee</td><td class="shadow">$300 per entry</td></tr>
</table><br>
A one-week extension can be obtained for an additional processing fee of $300 per entry. Late applications will not be accepted without this processing fee. <a name="best"></a><p>

<font class="subhead">Best of Show Award</font><br>

Now in its fifth year, the Innovations 2002 Best of Show award is given to the most highly honored products in their category, for all categories with three or more entries. Best of Show honorees are highlighted throughout the Innovations 2002 promotional materials, and will be previewed in a special display in the Grand Lobby of the Las Vegas Convention Center during the 2002 International CES.<p>
...
<td class="generalRightNav">&nbsp;<a href="#best" class="generalRightNav">Best of Show Award</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<td class="generalRightNav">&nbsp;<a href="innovations_2001/default.asp" class="generalRightNav">See 2001 Innovations!</a></td></tr>
...
<font class="righthead">Now Accepting Entries Online!</font> <br>
...
<font class="righthead">Questions?</font> <br>
