...
function CheckFields(){
	...
	if(document.searchByExhibitorName.exhibitorName.value == ""){ 
		alert("You must enter a value for Exhibitor Name.")
		searchByExhibitorName.exhibitorName.focus()
		return false
	}

	//Vendor
	if(document.searchByExhibitorName.cbo_vendor.options[document.searchByExhibitorName.cbo_vendor.selectedIndex].value == ""){ 
		alert("Please answer whether or not you are the manufacturer.") 
		searchByExhibitorName.cbo_vendor.focus()
		return false
	}
...
<head>
	...
	<title>2002 International CES: Innovations Awards Submission&#151;Locate your company in the CESweb Database</title>
...
<body marginheight="0" marginwidth="0" leftmargin="0" topmargin="0" onLoad="document.searchByExhibitorName.reset();setBannerAd('A'); init();">
...
<!-- <tr><td><img src="/global_images/nav_menu/textonlyNavigation.gif"></td></tr> -->
	...
	<font class="pagehead">Innovations Awards Submission</font>
	<p>
	<font class="body">
		
		<form name="searchByExhibitorName" action="awards_exhibitor_name_search_results.asp?menuItem=7&subMenuItem=0&tabName=Attendee" method="post">
		<table width="100%" cellpadding="0" cellspacing="0" border="0">

			<tr cols="4">
			<td colspan="4" width="100%" class="ExhibitorHeader">
			<font class="HeaderLabel">Locate your company name</font>
			</td>
			</tr>
...
<!---
			...
			<font class="formIdentifier">
			Looking for a company but don't know how to spell the name?  Click on the first letter of the exhibitor's name to view a list of exhibitors by letter.
			</font>
			</td>
			</tr>
			...
			<tr cols="4">
			<td colspan="4" width="100%" align="center"><font class="subhead"><font size="-2">
...
--->
		...
		<td colspan="4" width="100%">
		<font class="formIdentifier">
		<b>Company Quick Find:</b> &nbsp;Type in all or part of your company's name to locate the exhibitor.
		</font>
		</td>
		</tr>
		...
		<tr cols="4">
		<td colspan="1" width="25%"><font class="formIdentifier">Company Name:</font></td>
		...
		<td colspan="3" width="75%"><font class="formInstruction">i.e. Find exhibitors whose names begin with "Micro"</font></td>
		</tr>
		...
		<tr cols="4">
		<td colspan="1" width="25%"><font class="formIdentifier">Are you the manufacturer?</font></td>
		<td colspan="2" width="50%">
		<select name="cbo_vendor">
...
<!---		
		<input type="hidden" value="unselected" name="venueArea">
		
		<tr cols="4">
		<td colspan="1" width="25%"><font class="formIdentifier">Venue Area:</font></td>
		<td colspan="3" width="75%">
		
		<select multiple name="venueArea" class="formData" size="3">

		<option value="unselected" selected>
		**********************All**********************
		</option>
		<option value="12">Alexis Park</option>
		<option value="13">Hilton</option>
		<option value="14">LVCC South 1-2</option>
		<option value="15">LVCC South 3-4</option>
		<option value="16">LVCC North 1-4</option>
		<option value="17">LVCC Central 1-2</option>
		<option value="18">LVCC Central 3-5</option>
		<option value="19">LVCC Mtg Rm</option>
		<option value="20">LVCC Outdoor</option>
		</select>
		</td>
		</tr>
...
--->
		...
		<input class="formData" type="reset" name="Reset" value="Clear Form">&nbsp;<input class="formData" type="submit" name="Submit" value="Submit Form" onClick="return CheckFields();">
		</td>
		</tr>
		...
		<tr cols="4">
		<td colspan="4" width="100%" align="center">
		<font class="formInstruction">Click 'Submit' to get your results, or 'Clear' to start over Bottom of Form
		</font>
		</td>
		</tr>
...
<script language="JavaScript">
	if (addedValue == true) {
		...
		document.write("September 2, 2001");
		document.write("</font>");
	}
</script>
...
<font class="righthead">Questions about your submission?</font> <br>
Call Cindy Hoag at (703) 907-7629 or e-mail <a href="mailto:innovations@ce.org">Innovations@ce.org</a><br>
