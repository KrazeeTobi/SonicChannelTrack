...
<font class="head">Exhibitor Only Login</font>
...
<table width="540" cellpadding="0" cellspacing="0" border="0">
    ...
    <td>
        ...
        <TABLE border=0 cellpadding="5" cellspacing="0" bgcolor=#bdcce0>        
            <TR>
              <TD><font class="formIdentifier">Login:</font></TD>
              <TD><input type=text size=10 name=text_login maxlength=25></TD>
            </TR>
            <TR>
              <TD><font class="formIdentifier">Password:</font></TD>
              <TD><input type=password size=10 name=text_password maxlength=25></TD>
            </TR>            
            <TR>
              <TD><font class="formIdentifier">Email:</font></TD>
              <TD><input type=text size=10 name=text_email maxlength=25></TD>
            </TR>
            <TR>
              <TD colspan=2 align=center><font class="body"><input type=submit value=Login></font></TD>
            </TR>
        </TABLE>
        </FORM>
        </CENTER>
    ...
    <tr>
		<TD>
			...
			The 2001 International CES Print Directory Deadline has passed! All information you provide from now through the show
			 will be included in the online directory only.<p>
			
		If you do not want to update your directory information online, or are unable to for 
		any reason, click below to download a copy of the forms. You can fill them out and fax 
		them back to us (the fax number is on the forms).
			</font>
		</TD>
	</tr>
</table>
