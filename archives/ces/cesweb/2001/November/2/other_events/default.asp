...
<font class="pagehead">Other CE Events</font><br>
<br>
<font class="body">
...
<table align="center" width="80%" border="0" cellpadding="2" cellspacing="0">
		...
		<tr>
			<td  class="noshadow" width="80%">SMPTE Conference/Exhibit  (Society of Motion Picture and TV Engineers)</td>
			<td  class="noshadow" width="80%">Nov 4 - 7</td>
		</tr>
	

		<tr>
			<td  class="shadow" width="80%">eLearning Chicago</td>
			<td  class="shadow" width="80%">Nov 7 - 8</td>
		</tr>
	

		<tr>
			<td  class="noshadow" width="80%">Western Show</td>
			<td  class="noshadow" width="80%">Nov 27 - 30</td>
		</tr>
		...
		<tr>
			<td  class="shadow" width="80%">Revolution Internet Business Show</td>
			<td  class="shadow" width="80%">Dec 4 - 6</td>
		</tr>
		...
		<tr>
			<td  class="noshadow" width="80%">NAPTE 2002 (National Association of TV Program Exectuives)</td>
			<td  class="noshadow" width="80%">Jan 21 - 24</td>
		</tr>
	
		<tr><td colspan="2"><br></td></tr>
		<tr>
			<td colspan="2"><font class="subhead">March 2002</font></td>
		</tr>
		

		<tr>
			<td  class="shadow" width="80%">Digital Car Conference & Exhibition</td>
			<td  class="shadow" width="80%">Mar 4 - 8</td>
		</tr>
...
<script language="JavaScript">
	if (addedValue == true) {
		...
		document.write("November 1, 2001");
		document.write("</font>");
	}
</script>
