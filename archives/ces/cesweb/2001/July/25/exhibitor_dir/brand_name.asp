...
<body marginheight="0" marginwidth="0" leftmargin="0" topmargin="0" onLoad="document.searchByBrandName.reset(); setBannerAd('A'); init();">
...
<!-- <tr><td><img src="/global_images/nav_menu/textonlyNavigation.gif"></td></tr> -->
	...
	<font class="head">Exhibitor Directory - Search for an Exhibitor by Brand Name</font>
	<br><br>
		...
		<tr cols="4">
		<td colspan="4" width="100%" class="ExhibitorHeader"><font class="HeaderLabel">Brand Name Information</font></td>
		</tr>
		...
		Looking for a brand name but don't know how to spell the name?  Click on the first letter of the brand name to get a list of brands and the exhibitors who offered them at the 2001 International CES.
		</font>
		</td>
		</tr>
	...
	<a href="javascript: submit('#')">#</a> | <a href="javascript: submit('A')">A</a> | <a href="javascript: submit('B')">B</a> | <a href="javascript: submit('C')">C</a> | <a href="javascript: submit('D')">D</a> | <a href="javascript: submit('E')">E</a> | <a href="javascript: submit('F')">F</a> | <a href="javascript: submit('G')">G</a> | <a href="javascript: submit('H')">H</a> | <a href="javascript: submit('I')">I</a> | <a href="javascript: submit('J')">J</a> | <a href="javascript: submit('K')">K</a> | <a href="javascript: submit('L')">L</a> | <a href="javascript: submit('M')">M</a> | <a href="javascript: submit('N')">N</a> | <a href="javascript: submit('O')">O</a> | <a href="javascript: submit('P')">P</a> | <a href="javascript: submit('Q')">Q</a> | <a href="javascript: submit('R')">R</a> | <a href="javascript: submit('S')">S</a> | <a href="javascript: submit('T')">T</a> | <a href="javascript: submit('U')">U</a> | <a href="javascript: submit('V')">V</a> | <a href="javascript: submit('W')">W</a> | <a href="javascript: submit('X')">X</a> | <a href="javascript: submit('Y')">Y</a> | <a href="javascript: submit('Z')">Z</a>
		...
		<td colspan="4" width="100%">
		<font class="formIdentifier">
		<b>Brand Quick Find:</b> &nbsp;Just type in the brand name or part of the brand name to find exhibitors who offered these products at the 2001 International CES.
		</font>
		</td>
		</tr>
		...
		<tr cols="4">
		<td colspan="1" width="25%"><font class="formIdentifier">Brand Name:</font></td>
		<td colspan="2" width="50%"><input type="text" name="brandName" size="40" maxlength="50" class="formData"></td>
		...
		**********************All**********************
		...
		<tr cols="4">
		<td colspan="4" width="100%" align="center"><input class="formData" type="reset" name="Reset" value="Clear Form">&nbsp;<input class="formData" type="submit" name="Submit" value="Submit Form">
		</td>
		</tr>
