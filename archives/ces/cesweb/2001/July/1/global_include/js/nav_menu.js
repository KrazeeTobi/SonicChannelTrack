...
Attendee.mItem[1].smItem('search by track','/conferences/session_track.asp')
...
Attendee.mItem10].smItem('consumer electronics products','/attendee/consumersOnly/')
...
Exhibitor.menuItem('exhibitor manual','/exhibitor_only/exhibitor_manual/default.asp',0)

Exhibitor.menuItem('reserving a meeting room @ ces','/exhibitor_only/meeting_room.asp',0)

Exhibitor.menuItem('promotional opportunities','/exhibitor_only/promo_ops_kit/default.asp',0)
...
/*
Exhibitor.menuItem('download ces press &amp; analyst list','/comingSoon.asp',0)

Exhibitor.menuItem('manage your exhibitor info','#',1)
Exhibitor.mItem[11].smItem('view your company info','/comingSoon.asp');
Exhibitor.mItem[11].smItem('update booth information','/comingSoon.asp');
Exhibitor.mItem[11].smItem('update address &amp; contact info','/comingSoon.asp');
Exhibitor.mItem[11].smItem('update company description','/comingSoon.asp');
Exhibitor.mItem[11].smItem('update company logo','/comingSoon.asp');
Exhibitor.mItem[11].smItem('update financial exchange info','/comingSoon.asp');
Exhibitor.mItem[11].smItem('update exporting info','/comingSoon.asp');
Exhibitor.mItem[11].smItem('update contact names','/comingSoon.asp');
Exhibitor.mItem[11].smItem('update PR contacts','/comingSoon.asp');
Exhibitor.mItem[11].smItem('view modification history','/comingSoon.asp');

Exhibitor.menuItem('manage your booth events','#',1)
Exhibitor.mItem[12].smItem('schedule an event','/comingSoon.asp');
Exhibitor.mItem[12].smItem('update a scheduled event','/comingSoon.asp');
Exhibitor.mItem[12].smItem('cancel a scheduled event','/comingSoon.asp');

Exhibitor.menuItem('manage your new products list','#',1)
Exhibitor.mItem[13].smItem('update product category info','/comingSoon.asp');
Exhibitor.mItem[13].smItem('submit new product info','/comingSoon.asp');
Exhibitor.mItem[13].smItem('update new product info','/comingSoon.asp');

Exhibitor.menuItem('manage your ces press releases','#',1)
Exhibitor.mItem[14].smItem('submit a press release','/comingSoon.asp');
Exhibitor.mItem[14].smItem('update a press release','/comingSoon.asp');
...
Press.menuItem('news highlights','/press_analysts_only/default.asp',0)
