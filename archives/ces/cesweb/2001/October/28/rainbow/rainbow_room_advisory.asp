...
<font class="pagehead">Rainbow Room Media Advisory</font><br>
<br>
<font class="body">
<!-- content starts here --> 
...
<tr>
	<td colspan="2"><font class="head">CEA to Preview 2002 International CES</font></td>
</tr>
<tr>
	<td width="15%" align="right" valign="top"><font class="body"><strong>Who:</strong></font></td>
	<td><font class="body">Consumer Electronics Association (CEA)</font></td>
</tr>
<tr>
	<td align="right" valign="top"><font class="body"><strong>What:</strong></font></td>
	<td><font class="body">2002 International CES Preview Press Conference<br>
		Find out who will be at CES and why, and what new technology is coming that will change the way consumers work, live and play.
		<p>
		Gary Shapiro, CEA CEO and president, will discuss the state of the consumer technology industry, detailing current trends and statistics, holiday predictions and CEA goals for 2002.  
		Shapiro also will announce the next steps in the association's joint campaign with the National Association of Broadcasters to promote digital television to consumers.
		<p>
		Karen Chupka, CEA vice president of events and conferences, will address highlights for the upcoming show, including CES keynoters, conference program, exhibitor areas and special events.</font>
</td>
</tr>
<tr>
	<td align="right" valign="top"><font class="body"><strong>When:</strong></font></td>
	<td><font class="body">Tuesday, October 30, 2001, 5:30-6:00pm</font></td>
</tr>
<tr>
	<td align="right" valign="top"><font class="body"><strong>Where:</strong></font></td>
	<td><font class="body">Rainbow Room<br>30 Rockefeller Plaza<br>New York City, NY</font>
</td>
</tr>
<tr>
	<td align="right" valign="top"><font class="body"><strong>About CES:</strong></font></td>
	<td><font class="body">The birthplace of new technology promises to be the Las Vegas Convention Center in Las Vegas, Nev., when the 2002 International CES returns to town January 8-11, 2002.  
	The 2002 International CES will showcase the latest innovations from more than 2,000 international exhibitors in digital video, high-end or "extreme" audio, wireless communications, 
	accessories, CE fashion, consumer technology networking, broadband, mobile electronics, content media, new business technology, delivery systems and the Internet. More than 110,000 industry 
	professionals from 110 countries, accounting for 89 percent of the industry's buying power, attend the world's premier technology and education networking event.  
	Additional information and registration can be found at www.CESweb.org.</font>
</td>
</tr>
<tr>
	<td colspan="2" align="center"><font class="body"><strong>RSVP to Jamie Lilly at (703) 907-7650 or e-mail: <a href="mailto:jlilly@ce.org">jlilly@ce.org</a> by October 30, 2001.<br>
	A reception with CES exhibitors immediately follows the press conference.</strong></font>
</td>
</tr>
<tr>
	<td align="center" colspan="2"><font class="body">For more information contact:</font>
	</td>
</tr>
<tr>
	<td align="center" colspan="2"><font class="body">
Jeff Joseph<br>
	(703) 907-7664<br>
	<a href="mailto:jjoseph@ce.org">jjoseph@ce.org</a><br>
	<a href="http://www.CE.org">www.CE.org</a><br>
	or<br>
Brad Jones<br>
	(703) 907-7060<br>
	<a href="mailto:bjones@ce.org">bjones@ce.org</a><br>
	<a href="http://www.CESweb.org">www.CESweb.org</a></font>
	</td>
</tr>
</table>
...
<script language="JavaScript">
	if (addedValue == true) {
		...
		document.write("October 28, 2001");
		document.write("</font>");
	}
</script>
