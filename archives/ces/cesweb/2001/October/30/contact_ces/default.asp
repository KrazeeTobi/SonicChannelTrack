...
<head>
<title>2002 International CES: Contact Us</title>
...
<script language="javascript1.2" src="/global_include/js/validate_contact.js"></script>
<script language="javascript1.2">
	function setSubject() {
		var queryStr = location.search.substring(1,location.search.length);
		var emailMenuParams = queryStr.split("&");
		var emailSubjectIndex = new Number(0);
		var emailSubject = new String("");
		var temp;
		var obj = document.emailContactForm.subject;
		
		if(queryStr != ""){
			for(i=0;i<emailMenuParams.length;i++) {
				temp = emailMenuParams[i].split("=");
				if (temp[0] == "emailSubject") {
					emailSubject = temp[1];
				} 
			}
		
			for(var i=0; i<obj.options.length; i++) {
			  if(obj.options[i].value == emailSubject) {
			    obj.selectedIndex = i;
			    break;
			  }
			}
...
<font class="pagehead">Contact CES</font><br>
<br>
<font class="body">
...
<font class="head">Need Help? Have A Question?</font><p>

Contact our Customer Service Center and we will be happy to help!<p>

<form name="emailContactForm" action="contact_confirmation.asp" method="post" onSubmit="return validate_contact_form();">
<table cellpadding="0" cellspacing="0" border="0" width="100%">
<tr>
<td colspan=3><font class="body">To help us properly direct your email message and provide a quick response, please answer the following questions (<font class="required">*</font> indicates a required field).</font></td>
</tr>
<tr>
<td colspan=3>&nbsp;</td>
</tr>
<tr>
<td align=right><font class="required">*</font> <font class="formIdentifier">Subject:</font></td>
<td>&nbsp;</td>
<td align=left><select name="subject" class="formData">
		<option value="unselected" selected>Please Select a Subject</option>
		<option value="Badge - Attendee">Badge - Attendee</option>
		<option value="Badge - Exhibitor">Badge - Exhibitor</option>
		<option value="Conferences">Conferences</option>
		<option value="Booth Space">Booth Space</option>
		<option value="Housing/Transportation">Housing/Transportation</option>
		<option value="Future CES Dates">Future CES Dates</option>
		<option value="CES Directory">CES Directory</option>
		<option value="Remove">Remove from Mailing Lists/Promotions by 
Exhibitors</option>
		<option value="Correction">Correction to my
Attendee Information</option>
		<option value="Help">Registration Help</option>
		<option value="Problem">Report A Problem About CESWeb</option>
		<option value="Feedback">Send Us Feedback About CESWeb</option>
...
<tr>
<td align=right><font class="formIdentifier">Email:</font></td>
<td>&nbsp;</td>
...
<tr>
<td align=right valign=top><font class="required">*</font> <font class="formIdentifier">Message</font></td>
<td>&nbsp;</td>
...
<tr>
<td align=right valign=top><font class="formIdentifier">Phone:</font> </td>
<td>&nbsp;</td>
...
<td>&nbsp;</td>
<td align=left valign=top><input type="text" size="20" name="fax" class="formData"><br><font class="formInstruction">(please include country and city codes in the numbers)<br>(e.g. +1 111 111 1111)<br>(+1 is the country code for the United States)</font></td>
</tr>
<tr>
<td colspan=3>&nbsp;</td>
</tr>
<tr>
<td align=right><font class="formIdentifier">Address:</font> </td>
<td>&nbsp;</td>
...
<tr>
<td align=right><font class="formIdentifier">City:</font> </td>
<td>&nbsp;</td>
...
<tr>
<td align=right><font class="formIdentifier">Country:</font></td>
<td>&nbsp;</td>
...
<tr>
<td align=right><font class="formIdentifier">Zip / Postal Code:</font> </td>
<td>&nbsp;</td>
...
<tr>
<td colspan=3><font class="formQuestion">Do you have ideas for improving this site? Are there features that should be added or expanded in order to make this site more valuable for you?</font><br><br></td>
</tr>
<tr>
...
<script language="javascript1.2">setSubject();</script>
</BODY>
</HTML>