...
<BODY marginheight="0" marginwidth="0" leftmargin="0" topmargin="0" onLoad="document.searchByPubliclyTraded.reset();initCategoriesCheck(); setBannerAd('A'); init();">
...
<font class="pagehead">Exhibitor Directory - Search by Publicly Traded Company</font>
<!-- content starts here --> 
...
<tr cols="4">
<td colspan="4" width="100%" class="ExhibitorHeader"><font class="HeaderLabel">Exchange Information</font></td>
</tr>
...
<tr cols="4">
<td colspan="4" width="100%"><font class="formIdentifier">To find information on a specific exhibitor, use the Exhibitor Ticker and Name fields to limit search results.  For more general searches, 
however, it may be best to leave these fields blank.</font></td>
</tr>
...
<tr cols="4">
<td colspan="1" width="25%"><font class="formIdentifier">Stock Exchange:</font></td>
...
<tr cols="4">
<td colspan="4" width="100%"><font class="formIdentifier">To find information on a specific exhibitor, use the Exhibitor Ticker and Name fields to limit search results.  For more general searches, however, it may be best to leave these fields blank.</font></td>
</tr>
...
<tr cols="4">
<td colspan="1" width="25%"><font class="formIdentifier">Exhibitor Ticker:</font></td>
...
<tr cols="4">
<td colspan="1" width="25%"><font class="formIdentifier">Exhibitor Name:</font></td>
...
<script language="JavaScript">
	if (addedValue == true) {
		...
		document.write("October 12, 2001");
		document.write("</font>");
	}
</script>
