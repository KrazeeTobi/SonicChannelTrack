...
function getExhibitorList(bShowBooths){
	var strWin;
	var xPoint = window.screen.width / 4;
	var yPoint = window.screen.height / 4;
	...
	if(bShowBooths)
		strWin = "eims_admin_exh_search.asp?booths=true";
	else
		strWin = "eims_admin_exh_search.asp?booths=false";
