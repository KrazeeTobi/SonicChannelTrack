...
<head>
<title>2001 International CES: Request for Information on Exhibiting</title>
...
<font class="head">Contact a Sales Representative</font>
<p>
<font class="subhead">Exhibit at the 2002 International CES</font>
<!-- content starts here --> 
<p>
<font class="body">
Establish your brand at the International CES and reach the $72 billion electronic market, a 
global media mecca for your industry.<p>

<font class="subhead">Act now!</font><p>
<font class="body">Please complete and submit the form below and a CES National Sales Representative will contact you 
about CES exhibiting opportunities.
</font>
(<font class="required">*</font> indicates a required field).<p>

<!--- mailto:exhibit@cesweb.org --->
<form name="exhibitorContactForm" action="exhibitor_contact_confirmation.asp?menuItem=1&subMenuItem=2&tabName=Exhibitor" method="post" onSubmit="return validForm(this)">
<table cellpadding="0" cellspacing="0" border="0" width="100%">
<tr>
<td colspan=3>&nbsp;</td>
</tr>
<tr>
<td align=right><font class="required">*</font> <font class="formIdentifier">First Name:</font></td>
<td>&nbsp;</td>
<td align=left><input type="text" name="FName" class="formData" size="25"></td>
</tr>
<tr>
<td align=right><font class="required">*</font> <font class="formIdentifier">Last Name:</font></td>
<td>&nbsp;</td>
<td align=left><input type="text" name="LName" class="formData" size="25"></td>
</tr>
<tr>
<td align=right><font class="formIdentifier">Title:</font></td>
<td>&nbsp;</td>
<td align=left><input type="text" name="title" class="formData" size="25"></td>
</tr>
<tr>
<td align=right><font class="required">*</font> <font class="formIdentifier">Company:</font></td>
<td>&nbsp;</td>
...
<tr>
<td align=right valign=top><font class="required">*</font><font class="formIdentifier">Phone:</font> </td>
<td>&nbsp;</td>
<td align=left valign=top><input type="text" size="20" name="phone" class="formData"></td>
</tr>
<tr>
<td align=right valign=top><font class="formIdentifier">Fax:</font></td>
<td>&nbsp;</td>
<td align=left valign=top><input type="text" size="20" name="fax" class="formData"><br><font class="formInstruction">(please include complete 
country and city codes in the numbers)<br>(i.e.: 001 111 111 1111)</font></td>
</tr>
<tr>
<td colspan=3>&nbsp;</td>
</tr>
<tr>
<td align=right><font class="required">*</font><font class="formIdentifier">Email:</font></td>
<td>&nbsp;</td>
<td align=left><input type="text" name="email" class="formData" size="25"></td>
</tr>
<tr>
<td align=right><font class="formIdentifier">Website Address:</font></td>
<td>&nbsp;</td>
...
<tr>
<td align=right><font class="required">*</font> <font class="formIdentifier">Address:</font> </td>
<td>&nbsp;</td>
...
<tr>
<td align=right><font class="required">*</font> <font class="formIdentifier">City:</font> </td>
<td>&nbsp;</td>
<td align=left><input type="text" size="25" name="city" class="formData"></td>
</tr>
<tr>
<td align=right><font class="formIdentifier">State:</font> </td>
<td>&nbsp;</td>
<td align=left><select name="state" class="formData">
		...
		<option value="North Dakata">North Dakata</option>
		...
		</select> <font class="formInstruction">(within the United States)</font></td>
</tr>
<tr>
<td align=right><font class="formIdentifier">Province:</font> </td>
<td>&nbsp;</td>
<td align=left><input type="text" size="25" name="province" class="formData"> <font class="formInstruction">(outside the United States)</font></td>
</tr>
<tr>
<td align=right><font class="required">*</font> <font class="formIdentifier">Country:</font> </td>
<td>&nbsp;</td>
<td align=left><select name="country" class="formData">
		...
		<option value="Gibratar">Gibratar</option>
...
<tr>
<td align=right><font class="required">*</font><font class="formIdentifier">Zip/Postal Code:</font> </td>
<td>&nbsp;</td>
...
<tr>
<td colspan=3><font class="formQuestion">Please select the category that best describes your product 
or service.</font><br><br></td>
</tr>
<tr>
<td>&nbsp;</td>
<td valign=top align=left colspan=2>
      ...
      <input type="radio" name="category" value="Audio and Video" class="formData"><font class="formIdentifier">Audio and Video<br></font>
      <input type="radio" name="category" value="Computer SoHo IT" class="formData"><font class="formIdentifier">Computer/SoHo/IT<br></font>
	  <input type="radio" name="category" value="Digital Radio" class="formData"><font class="formIdentifier">Digital Radio<br></font>
      <input type="radio" name="category" value="Emerging Technologies" class="formData"><font class="formIdentifier">Emerging Technologies<br></font>
	  <input type="radio" name="category" value="Home Information" class="formData"><font class="formIdentifier">Home Information<br></font>
      <input type="radio" name="category" value="Home Theatre Home Systems" class="formData"><font class="formIdentifier">Home
      Theater/Home Systems<br></font>
      <input type="radio" name="category" value="Internet Ecommerce" class="formData"><font class="formIdentifier">Internet/E-Commerce<br></font>
	  <input type="radio" name="category" value="Mobile Electronics" class="formData"><font class="formIdentifier">Mobile Electronics<br></font>
	  </td>
	  <td valign=top align=left>
      <input type="radio" name="category" value="Personal Electronics" class="formData"><font class="formIdentifier">Personal Electronics<br></font>
      <input type="radio" name="category" value="Publications" class="formData"><font class="formIdentifier">Publications<br></font>
      <input type="radio" name="category" value="Satellite" class="formData"><font class="formIdentifier">Satellite<br></font>
      <input type="radio" name="category" value="Specialty High End Audio" class="formData"><font class="formIdentifier">Specialty/High-End Audio<br></font>
      <input type="radio" name="category" value="Telephony" class="formData"><font class="formIdentifier">Telephony<br></font>
      <input type="radio" name="category" value="Trade Associations" class="formData"><font class="formIdentifier">Trade Associations<br></font>
      <input type="radio" name="category" value="Wireless" class="formData"><font class="formIdentifier">Wireless<br></font>
	  <input type="Radio" name="category" value="Other" class="formData" checked><font class="formIdentifier">Other:</font> <input name="other" type="text" size="25" class="formData"></td>
	  </tr>
	  </table>
</td>
</tr>
...
<tr>
<td colspan=3><font class="formQuestion">To assist us in developing your space selection options, 
what size booth would you like to consider?</font><br></td>
</tr>
<tr>
<td colspan=3><font class="formQuestion">(Booths start at 10 sq. ft. by 10 sq. ft.)</font></td></tr>
<tr>
<td>&nbsp;</td>
</tr>
<tr>
<td>&nbsp;</td>
<td colspan=2><input name="feet" type="text" size="7" class="formData"><font class="formIdentifier"> ft. x </font><input name="feet2" type="text" size="7" class="formData"><font class="formIdentifier"> ft. = </font><input name="nsf" type="text" size="7" class="formData"><font class="formIdentifier"> net sq. ft., in U.S. measurements</font></td>
</tr>
<tr>
<td colspan=3>&nbsp;</td>
</tr>
<tr>
<td colspan=3><font class="formQuestion">Comments or Questions? Please enter up to 250 characters in 
the box below.</font><br><br></td>
</tr>
<tr>
<td>&nbsp;</td>
<td colspan=2><textarea name="comments" cols="45" rows="5" class="formData"></textarea></td>
</tr>
<tr>
...
<p>
<font face="Arial" size=2>Type mismatch: 'FormatDate'</font>
<p>
<font face="Arial" size=2>/global_include/html/foot.inc</font><font face="Arial" size=2>, line 30</font> 