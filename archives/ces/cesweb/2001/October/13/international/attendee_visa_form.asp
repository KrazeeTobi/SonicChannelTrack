...
<html>
<head>
	<title>2002 International CES: Visa Letter Of Invitation Request Form</title>
	...
	<script language="javascript1.2">
		...
		var pageID = "1.6.1.4"; //INSERT PAGE ID HERE
		
		var firstNameMessage = "Please enter your First Name.";
var lastNameMessage = "Please enter your Last Name.";
var jobTitleMessage = "Please enter your Title.";
var companyNameMessage = "Please enter your Company Name.";
var embassyLocationMessage = "Please enter city location of the nearest U.S. Embassy or Consulate.";
var addressMessage = "Please enter your Mailing Address.";
var cityMessage = "Please enter your City.";
var stateMessage = "Please enter your State or Province.";
var countryMessage = "Please select your Country.";
var postalCodeMessage = "Please enter your Postal Code.";
var phoneNumberMessage = "Please enter your Phone Number.";
var faxNumberMessage = "Please enter your Fax Number.";
var emailMessage = "Please enter your Email Address.";
var emailInvalidMessage = "Your Email Address is not in the correct format.\n\nYou must enter your Email Address in the following format:\n\n example@cesweb.com";
var reenterEmailMessage = "Please re-enter your Email Address.";
var exhibitingCompanyMessage = "Please enter the Exhibiting Company Name you are applying for.";
var exhibitorBoothMessage = "Please enter the Exhibiting Company\'s Booth Number.";
var boothCostMessage = "Please enter the Cost of the Booth in U.S Dollars.";
var notesMessage = "";
	...
	<script language="javascript1.2" src="/international/include/js/validate_visa.js"></script>	
...
<font class="head">Visa Letter Of Invitation Request Form</font><br>
<br>
<font class="body">
<!-- content starts here -->

Please supply CES with the following information so that we may provide you with an invitation letter for your visa application process (<FONT class=required>*</FONT> indicates a required field)

<form name="VisaForm" action="attendee_visa_summary.asp?langid=0&menuItem=6&subMenuItem=0&tabName=Attendee" method="post" onSubmit="return validate_visa_form(document.VisaForm);">
<table cellpadding="0" cellspacing="0" border="0" width="100%">
<tr colspan="4">
	<td width="15%"></td>
	<td width="20%"></td>
...
<tr>
	...
	<td colspan="2" align=left valign="bottom">&nbsp;<input type="text" name="name_first" class="formData" size="50" maxlength="50" value=""></td>
</tr>

<tr>
	<td>&nbsp;</td>
	<td align=right><font class="required">*</font><font class="formIdentifier">Last Name:</font></td>
	<td colspan="2" align=left valign="bottom">&nbsp;<input type="text" name="name_last" class="formData" size="50" maxlength="50" value=""></td>
</tr>

<tr>
	<td>&nbsp;</td>
	<td align=right><font class="required">*</font><font class="formIdentifier">Title:</font></td>
	<td colspan="2"align=left valign="bottom">&nbsp;<input type="text" name="title" class="formData" size="50" maxlength="50" value=""></td>
</tr>

<tr>
	<td>&nbsp;</td>
	<td align=right><font class="required">*</font><font class="formIdentifier">Company Name:</font></td>
	<td colspan="2" align=left valign="bottom">&nbsp;<input type="text" name="company_name" class="formData" size="50" maxlength="255" value=""></td>
</tr>
...
<tr>
	<td>&nbsp;</td>
	<td align=right><font class="required">*</font><font class="formIdentifier">The city location of the nearest U.S. Embassy or Consulate:</font></td>
	<td colspan="2"align=left valign="bottom">&nbsp;<input type="text" name="city_location" class="formData" size="50" maxlength="255" value=""></td>
</tr>
...
<tr>
	<td>&nbsp;</td>
	<td align=right><font class="required">*</font><font class="formIdentifier">Mailing Address 1:</font></td>
	<td colspan="2"align=left valign="bottom">&nbsp;<input type="text" name="mailing_address_1" class="formData" size="50" maxlength="255" value=""></td>
</tr>

<tr>
	<td>&nbsp;</td>
	<td align=right><font class="required"></font><font class="formIdentifier">Mailing Address 2:</font></td>
	<td colspan="2"align=left valign="bottom">&nbsp;<input type="text" name="mailing_address_2" class="formData" size="50" maxlength="255" value=""></td>
</tr>

<tr>
	<td>&nbsp;</td>
	<td align=right><font class="required">*</font><font class="formIdentifier">City:</font></td>
	<td colspan="2"align=lef valign="bottom"t>&nbsp;<input type="text" name="city" class="formData" size="50" maxlength="255" value=""></td>
</tr>

<tr>
	<td>&nbsp;</td>
	<td align=right><font class="required">*</font><font class="formIdentifier">State or Province:</font></td>
	<td colspan="2"align=left valign="bottom">&nbsp;<input type="text" name="state" class="formData" size="50" maxlength="255" value=""></td>
</tr>
...
<tr>
	...
	<td colspan="2" align=left valign="bottom">&nbsp;<select name="country" class="formData">
...
<tr>
	<td>&nbsp;</td>
	<td align=right><font class="required">*</font><font class="formIdentifier">Postal Code:</font></td>
	<td colspan="2"align=left valign="bottom">&nbsp;<input type="text" name="postal_code" class="formData" size="50" maxlength="50" value=""></td>
</tr>

<tr>
	<td>&nbsp;</td>
	<td align=right><font class="required">*</font><font class="formIdentifier">Phone Number:</font></td>
	<td colspan="2"align=left valign="bottom">&nbsp;<input type="text" name="phone_number" class="formData" size="50" maxlength="50" value=""></td>
</tr>

<tr>
	<td>&nbsp;</td>
	<td align=right><font class="required">*</font><font class="formIdentifier">Fax Number:</font></td>
	<td colspan="2"align=left valign="bottom">&nbsp;<input type="text" name="fax_number" class="formData" size="50" maxlength="50" value=""></td>
</tr>
...
<tr>
	<td>&nbsp;</td>
	<td align=right><font class="required">*</font><font class="formIdentifier">Email Address:</font></td>
	<td colspan="2"align=left valign="bottom">&nbsp;<input type="text" name="email_address" class="formData" size="50" maxlength="255" value=""></td>
</tr>

<tr>
	<td>&nbsp;</td>
	<td align=right><font class="required">*</font><font class="formIdentifier">Re-enter Email Address:</font></td>
	<td colspan="2"align=left valign="bottom">&nbsp;<input type="text" name="reenter_email_address" class="formData" size="50" maxlength="255" value=""></td>
</tr>
...
<tr>
	<td>&nbsp;</td>
	<td align=right valign="top"><font class="formIdentifier">Notes:
	<BR>
	<FONT class=formInstruction>This field is for any additional <BR>information the attendee would <BR>like to provide CEA</FONT>
	</td>
	<td colspan="2"align=left>&nbsp;<textarea rows="10" cols="30" name="additional_information" maxlength="1000"></textarea></td>
</tr>
...
<p>
<font face="Arial" size=2>Variable is undefined: 'FormatDate'</font>
<p>
