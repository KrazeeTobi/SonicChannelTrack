...
<table width="90%" align="center">
	...
	<span class="subhead" style="text-align: left">CES:<br>놓치면 후회하실<br>소비자 기술 박람회</span><br>
	<span style="color:#004AA0">놀랍게도  전자업계의 구매력을 가진 사람들 중 89%(850억불)가 2002 International CES에 참석했습니다.</span><br><br>
...
<span class="pagehead">해외 참관인: 일반 안내</span><br><br>
<span class="head">글로벌화의 기회입니다.</span><BR><BR>
International CES는 다른 어떠한 박람회 보다도 가전업계의 유수 기업들이 많이 참가하는 무역 박람회입니다.  2003 International CES 참가자 구성은 다음과 같습니다.
<ul>
	<li>2,200개의 전시 업체
	<li>110,000명의 참석자
	<li>110여 국가에서 15,000명 참석
	<li> 보도 관계자 4,000명 및 분석가 1,000명
</ul>
<br>
<span class="subhead">International CES&mdash;여러분 곁으로 찾아갑니다.</span><br>
International CES가 제공하는 가치를 발견하십시오.  다음 이벤트에서 International CES 전시 부스에 들려주십시오.
<ul>
	<li>CeBIT 아시아 가전제품 박람회: 5월 14&ndash;17일, 중국 상하이
	<li>IFA (Internationale Funkausstellung): 8월  29일&ndash;9월 3일, 독일 베를린
	<li>홍콩전자제품 박람회: 10월 13&ndash;14일, 홍콩
	<li>대만 전자부품 박람회 (TAITRONICS): 10월 16&ndash;20일, 대만 타이페이
</ul>
<br>

<span class="subhead">계획을 세우십시오.</span><br>
지금 2004 International CES에 대한 계획을 세우십시오. 준비하실 사항은 다음과 같습니다.
<ul>
	<li>미리 <a href="http://www.travel.state.gov/visa_services.html" target="new">비자를 신청하십시오</a>.
	<li><a href="http://www.travel.state.gov/DS-0156.pdf" target="new">미국 비자 신청서</a>를 얻으십시오(양식 DS-0156).
	<li>가까운 <a href="http://www.travel.state.gov/links.html" target="new">미국 대사관 혹은 총영사관</a>의 위치를 알아 두십시오.
</ul>
<br>
<span class="subhead">2004년 안내</span><br>
<ul>
<li>국제 프리미어 패키지는 최상의 전시 및 컨퍼런스 패키지입니다.  국제 프리미어 패키지는 모든 전시와 기조 연설, 수퍼세션 및 70여개의 컨퍼런스 세션을 제공합니다.  또한 VIP 오찬과 인터내셔널 리셉션 등의 참석 티켓도 제공합니다.  이 특별 패키지는 해외 참석자에게만 제공되며 가격은 2003년 12월 5일까지 구입하시는 경우 $299(미화)입니다.
<br><br>
<li>2004 International CES는 미국 상무부 산하 U.S. Commercial Service가 후원하는 국제 구매 프로그램(International Buyer Program: IBP)에 참가하게 된 것을 기쁘게 생각합니다.  CES 참석자는 IBP의 Global Matchmaking Program이 제공하는 혜택을 누리실 수 있으며 미국 외부로의 수출에 관심을 가지고 있는 전시자들을 만나실 수 있습니다.  자세한 안내가 필요하시면 <a href="http://www.usatrade.gov/website/website.nsf" target="new">U.S. Commercial Service</a>의 웹사이트를 방문하십시오.
</ul>
<br>
</div>
<!-- **CONTENT ENDS HERE** -->
	...
	<TD VALIGN="top" width="135" bgcolor="#ffffff">
		...
		<TR>
			...
			<TD class="avshadowmain">
				...
				<div align="center" class="subhead">일정</div><img src="/global_images/spacer.gif" height="4" border=0><br>	
				...
				<div align="center" style="COLOR:#004aa0">
					...
					<strong>2004년 1월 8-11일<br>네바다 주 라스베가스</strong>
		...
		<TR>
			...
			<TD>
				...
				<span class="subhead">등록을 서두르세요.</span><br>
				<a href="/registration/">귀하의 이메일 주소를 입력하시면</a>, 2004 International CES의 등록이 언제 시작되는지 알려드립니다.
