...
<!--  JTG added the "lang" attribute to the following line -->
<HTML lang="es">
<HEAD>
...
<!--  JTG changed the "charset" attribute in the following line -->
...
<!-- ***END - THIS BLURB WILL LIVE ONLY ON THE ENGLISH INTERNATIONAL PAGE*** -->								

<table width="90%" align="center">
	<tr><td height="3"></td></tr>
	<tr><td>
	
	<span class="subhead" style="text-align: left">CES&nbsp;:<br>La EXPOSICI&Oacute;N POR EXCELENCIA <br>a la que NO PUEDE DEJAR de asistir.</span><br>
	<span style="color:#004AA0">Un incre&iacute;ble 89% de la capacidad de compra en la industria de productos electr&oacute;nicos de consumo (USD85.000 millones) fue detectado durante la exposici&oacute;n internacional <i>International CES</i> realizada en el a&ntilde;o 2002.</span><br><br>
	<br><A HREF="http://www.ce.org" target="new"><IMG SRC="/global_images/CEAproCESart.jpg" BORDER="0"></A><br>
...
<span class="pagehead">Visitantes internacionales: Informaci&oacute;n general</span><br><br>
<span class="head">Apuntar al mercado mundial</span><br>
La exposici&oacute;n internacional <i>International CES</i> re&uacute;ne m&aacute;s actores
principales en la industria de productos electr&oacute;nicos de consumo que
cualquier otra muestra de este tipo. En 2003, la <i>International CES</i>
convoc&oacute; aproximadamente:
<ul>
	<li>2.200 expositores
	<li>110.000 asistentes
	<li>15.000 personas de m&aacute;s de 110 pa&iacute;ses
	<li>4.000 periodistas y 1.000 analistas
</ul>
<br>
<span class="subhead">La exposici&oacute;n internacional <i>International CES</i> se acerca a usted.</span><br>
Conozca m&aacute;s acerca del valor de la muestra <i>International CES</i>. Pase
por uno de los stands de la <i>International CES</i> en los siguientes
eventos:
<ul>
	<li>CeBIT Asian Home Electronics Fair (Feria CeBIT de Productos Electr&oacute;nicos para el Hogar de Asia): del 14 al 17 de mayo, Shanghai, China
	<li>IFA (Internationale Funkausstellung): del 29 de agosto al 3 de septiembre, Berl&iacute;n, Alemania
	<li>Hong Kong Electronics Fair (Feria de Productos Electr&oacute;nicos de Hong Kong): 13 y 14 de octubre, Hong Kong
	<li>TAITRONICS (Exposici&oacute;n Internacional de Productos Electr&oacute;nicos de Taiw&aacute;n): del 16 al 20 de octubre, Taipei, Taiw&aacute;n
</ul>
<br>

<span class="subhead">Prep&aacute;rese.</span><br>
Empiece ahora a hacer planes para la exposici&oacute;n <i>International CES</i> que se llevar&aacute; a cabo en 2004. Usted puede:<ul>
	<li><a href="http://www.travel.state.gov/visa_services.html" target="new">Solicitar una visa</a> con anticipaci&oacute;n.
	<li>Conseguir el <a href="http://www.travel.state.gov/DS-0156.pdf" target="new">Formulario de Solicitud de Visa para EE.UU.</a> (Form DS-0156).
	<li>Ubicar la sede de <a href="http://www.travel.state.gov/links.html" target="new">la Embajada de EE.UU. o del Consulado General de EE.UU.</a> que se encuentre m&aacute;s cercana a usted.
</ul>
<br>
<span class="subhead">Temas de inter&eacute;s para 2004</span><br>
<ul>
<li>El paquete International Premier Package es su mejor opci&oacute;n para
la exposici&oacute;n y las conferencias. Con el paquete International
Premier Package, usted tendr&aacute; acceso a todas las muestras, los
discursos, <i>SuperSessions</i> (sesiones exclusivas) y a m&aacute;s de 70
conferencias. Adem&aacute;s, recibir&aacute; entradas para almuerzos VIP, para la
Recepci&oacute;n Internacional y &iexcl;mucho m&aacute;s! Ofrecemos este paquete
especial en forma exclusiva a nuestros asistentes internacionales 
por s&oacute;lo USD 299 si se compra con anterioridad al 5 de diciembre de
2003.
<br><br>
<li>La exposici&oacute;n internacional <i>International CES</i> 2004 se enorgullece
de participar en el <i>International Buyer Program</i> (IBP &ndash; Programa para
el comprador internacional), patrocinado por el Servicio
Comercial de EE.UU. perteneciente al Departamento de Comercio de
Estados Unidos. Aquellos que asistan a la CES podr&aacute;n aprovechar el
programa de IBP denominado <i>Global Matchmaking Program</i> (Programa
mundial de b&uacute;squeda de posibles socios comerciales) para hallar
expositores que est&eacute;n interesados en las oportunidades de
exportaci&oacute;n fuera de EE.UU. Para obtener m&aacute;s informaci&oacute;n, visite el
sitio web del <a href="http://www.usatrade.gov/website/website.nsf" 
target="new">Servicio Comercial de EE.UU.</a>
</ul>
<br>
</div>
<!-- **CONTENT ENDS HERE** -->
	...
	<TD VALIGN="top" width="135" bgcolor="#ffffff">
		...
		<TR>
			...
			<TD class="avshadowmain">
				...
				<div align="center" class="subhead">&iexcl;Agende la fecha!</div><img src="/global_images/spacer.gif" height="4" border=0><br>	
				<div align="center" class="callout_small">2004 <i>International CES</i></div>
				<div align="center" style="COLOR:#004aa0">
					<img src="/global_images/spacer.gif" height="4"><br>
					<strong>del 8 al 11 de enero de 2004<br>Las Vegas, Nevada</strong>
		...
		<TR>
			...
			<TD>
				...
				<span class="subhead">Sea el primero de la fila.</span><br>
				Por favor, s&iacute;rvase <a href="/registration/">ingresar su direcci&oacute;n de correo electr&oacute;nico</a> y le informaremos la fecha de comienzo de la inscripci&oacute;n para la exposici&oacute;n internacional 2004 <i>International CES</i>.
