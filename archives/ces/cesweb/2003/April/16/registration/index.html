...
<TITLE>2003 International CES: Registration</TITLE>
...
<SCRIPT language="javascript1.2" SRC="/registration/include/js/validate_reg_form.js"></SCRIPT>
...
<TR>
	...
	<TD ALIGN="center" COLSPAN="5" BACKGROUND="/global_images/subtab_bg_main.gif" CLASS="subtab_main">
		<!--<A HREF="http://ww4.expocard.com/ces031/" ONMOUSEOVER="rollover('subtab_main_register', subtab_main_register_active);" ONMOUSEOUT="rollover('subtab_main_register', subtab_main_register_active);"><IMG NAME="subtab_main_register" SRC="/global_images/subtab_main_register_active.gif" ALT="Register Now!" BORDER="0"></A>-->
...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.0")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="1.0">
<span class="pagehead">Registration</span><br><br>


<span class="head">Be the first to register!</span>
<br><br>
Please enter your e-mail address, and we'll let you know when registration begins for the 2004 International CES.
<br><br>

<form name="registration_form" action="default.asp" method="post" onSubmit="return validate_reg_form();">
<table width="100%" cellpadding="0" cellspacing="0" border="0">
<tr>
	<td colspan=2><div align="center"><span class="subhead">Let us notify you when registration opens.</span> (<span class="required">*</span> Denotes required field.)</div></td>
</tr>
<tr><td>&nbsp;</td></tr>
<!--Show form errors-->
...
<tr>
	<td colspan="2" align="center"><input  type="checkbox" size="25" name="future_contact" value="1" class="formData">&nbsp;<b>Add me to the CES distribution list for future CES updates!</b>**</td>
</tr>
...
<!--
<span class="subhead"><center>Two great ways to experience CES:</center>
</span><br>
<!--Register for&mdash;-->
<!--
<table width="100%">
<tr>
<td width="46%" valign="top" class="ledgershadow">
<b>EXHIBITS-PLUS PASS</b></td>

<td width="4%">&nbsp;</td>

<td width="50%" valign="top" class="ledgershadow"><b>CONFERENCE REGISTRATION </b></td></tr>

<tr>
<td width="46%" valign="top">
This FREE pass gives you access to:<br><ul>
<li>all CES exhibits&mdash;more than 2000
<li>all Technology Pavilions
<li>all keynote addresses (including Bill Gate's Pre-Show Keynote) 
<li>all SuperSessions 
<li>selected sessions on the CES Knowledge Circuit 
</ul><br>
<b>An unbelievable bargain.</b>  You can't beat the price!</td>

<td>&nbsp;</td> 

<td width="50%" valign="top">
Take advantage of everything CES has to offer.  You'll get all the perks of an EXHIBITS-PLUS PASS and:<br><ul>
<li>more than 60 Knowledge Circuit Sessions (all 10 sub-circuits)</ul><br>
<b>Whatever your interest</b>&mdash;Business Solutions, Emerging Technology, Home Networking&mdash;you'll get access to the most up-to-date information and the industry's foremost leaders.<br>
<BR>
<b>Conference registration opens September 2002.</b></td></tr>
</table>
<br><br>
...
E-mail us at <a href="mailto:CESinfo@ce.org">CESinfo@ce.org</a> or call (703) 907-7605.<br>
<br>
</div>
