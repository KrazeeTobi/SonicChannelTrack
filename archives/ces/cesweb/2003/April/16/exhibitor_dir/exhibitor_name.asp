...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.2.1")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="1.2.1">
<span class="pagehead">Exhibitor Directory :: Search by Exhibitor Name</span><br><br>
Navigate the 2003 International CES Exhibitor Directory to locate important exhibitor information including company details, show location and contact information. 
<br><br>Browse our online exhibitor directory by selecting the letter of the companies you are interested in locating or use the quick find tool to search for exhibitors.  

		<form name="searchByExhibitorName" action="exhibitor_name_search_results.asp?page=1" method="POST">
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			<tr>
			<td colspan="4" width="100%">
			<span class="subhead">Browse the 2003 International CES Exhibitor Directory</span>
			</td>
			</tr>
		...
		<tr>
		<td colspan="1" class="rowlabel">Exhibitor Name:&nbsp;&nbsp;</td>
		<td colspan="3"><input type="text" name="exhibitorName" size="40" maxlength="50" class="formData"></td>
		</tr>
		...
		<tr>
		<td colspan="1" width="25%" class="rowlabel">Show Locations:&nbsp;&nbsp;</td>
...
<!-- include virtual="/exhibitor_dir/include/asp/main_added_value.asp"-->

<!--This file contains the code to pull up exhibitor name and location info into a excel sheet-->
...
<!-- BEGIN TABLE 8 (optional added value) -->
	...
	<TR>
		...
		<span class="subhead">2003 Exhibitor List</span><br>
		<a href="include/asp/exhibitor_list_download.asp?getall=yes" alt="All exhibitors for Current Year">Download a report</a> containing the full list of 2003 International CES exhibitors (in Excel format)
		</TD>
	</TR>
	</TABLE>
<!-- END TABLE 8 -->
