...
<TITLE>2003 International CES: Airlines & Rental Cars</TITLE>
...
<TR>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/travel/airlines_cars.asp');" ONMOUSEOVER="rollover_td('airline','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('airline','leftsubnav_main_active');">
		<TD ID="airline_cellspacer" CLASS="leftsubnav">&nbsp;</TD>
		<TD ID="airline" CLASS="leftsubnav"><A HREF="/travel/airlines_cars.asp" CLASS="leftsubnav_main_active">Airlines &amp; Rental Cars</A></TD>
		<TD ID="airline_arrowcell" CLASS="leftsubnav"><IMG SRC="/global_images/context_arrow-new.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.10.2")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="1.10.2">
<span class="pagehead">Travel :: Airlines & Rental Cars</span><br><br>
<span class="head">We Can Help You Get There!</span><br><br>

Contact <b>PGI HRT</b>, CES' official hotel and travel agency, to make your travel arrangements for 2003 International CES, January 9-12, 2003.
<br><br>
<table>
<tr>
	<td align="left"><span class="text">Tel:</span></td>
	<td><span class="text">(800) 397-0939 or (702) 798-6380</span></td>
</tr>

<tr>
	<td align="left"><span class="text">Fax:</span></td>
	<td><span class="text">(702) 795-8767</span></td>
</tr>

<tr>
	<td valign="top" align="left"><span class="text">Email:</span></td>
	<td><span class="text">HOL@pgi.com</td>
</tr>

<tr>
	<td valign="top" align="left"><span class="text">Mail:</span></td>
	<td><span class="text"><b>PGI HRT</b><br>2275-A Renaissance Drive<br>Las Vegas, NV 89119<br>USA</span></td>
</tr>
</table>
<BR>
<span class="subhead">Enjoy discount savings!</span><br>
<b>Save 5-10%</b> off regular airline fares with our official airlines, and enjoy discount car rental rates.</span>
<br><br>
<b>Call early for the best fare!</b> If you are required to book directly with your travel agent or airline, ask for the meetings and convention desk and give the listed reference number.
<br><br>
<table cellpadding="0" cellspacing="0" border="0" align=center width=90%>

<tr>
	<td width=33%><span class=text><b>AIRLINE</b></span></td>
	<td width=33%><span class=text><b>REFERENCE CODE</b></span></td>
	<td width=33%><span class=text><b>PHONE</b></span></td>
</tr>

<tr>
	<td><span class=text>American Airlines</span></td>
	<td><span class=text>A4913AB</span></td>
	<td><span class=text>(800) 433-1790</span></td>
</tr>

<tr class="shadow">
	<td><span class=text>America West </span></td>
	<td><span class=text>6738</span></td>
	<td><span class=text>(800) 548-7575</span></td>
</tr>
<tr>
	<td><span class=text>Continental</span></td>
	<td><span class=text>UJWYLK</span></td>
	<td><span class=text>(800) 468-7022</span></td>
</tr>
<tr class="shadow">
	<td><span class=text>Delta</span></td>
	<td><span class=text>188603A</span></td>
	<td><span class=text>(800) 241-6760</span></td>
</tr>
<tr>
	<td><span class=text>National</span></td>
	<td><span class=text>NE0311</span></td>
	<td><span class=text>(888) 757-5387</span></td>
</tr>
<tr class="shadow">
	<td><span class=text>Southwest</span></td>
	<td><span class=text>J6272</span></td>
	<td><span class=text>(800) 433-5368</span></td>
</tr>
<tr>
	<td><span class=text>United</span></td>
	<td><span class=text>514DW</span></td>
	<td><span class=text>(800) 521-4041</span></td>
</tr>
<tr class="shadow">
	<td><span class=text>US Air</span></td>
	<td><span class=text>GF44142455</span></td>
	<td><span class=text>(800) 334-8644</span></td>
</tr>
<tr>
...
<tr>
	<td><span class=text><b>CAR RENTAL</b></span></td>
	<td><span class=text><b>REFERENCE CODE</b></u></span></td>
	<td><span class=text><b>PHONE</b></span></td>
</tr>
<!---<tr class="shadow">
	<td><span class=text>Budget</span></td>
	<td><span class=text>CES</span></td>
	<td><span class=text>800 922 2899 X133<br>702 736 1212 X133</span></td>
</tr>-->
<tr class="shadow">
	<td valign="top"><span class=text>Payless/Allstate Car Rental</span></td>
	<td valign="top"><span class=text>CES3</span></td>
	<td><span class=text>(800) 634-6186 or <br>(702) 736-6147, ext 432</span></td>
</tr>
...
<br>
<a href="/travel/pdfs/Air_Car_Rental.pdf" target="_blank">Click here for detailed information about making your reservations!</a><br><br>
For more detailed information on air travel security measures, please visit the <a href="http://www.faa.gov" target="new">Federal Aviation Administration</a> website.
<br><br>
</div>
<!-- **CONTENT ENDS HERE** -->
