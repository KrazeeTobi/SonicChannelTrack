...
<TITLE>2003 International CES: Taxi &amp; Parking</TITLE>
...
<TR>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/travel/taxi_park.asp');" ONMOUSEOVER="rollover_td('taxi','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('taxi','leftsubnav_main_active');">
		<TD ID="taxi_cellspacer" CLASS="leftsubnav">&nbsp;</TD>
		<TD ID="taxi" CLASS="leftsubnav"><A HREF="/travel/taxi_park.asp"  CLASS="leftsubnav_main_active">Taxi &amp; Parking</A></TD>
		<TD ID="taxi_arrowcell" CLASS="leftsubnav"><IMG SRC="/global_images/context_arrow-new.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.10.4")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="1.10.4">
<span class="pagehead">Travel :: Taxi & Parking</span><br><br>
<span class="head">CES by Car</span><br><br>

<span class="subhead">Taxi Service</span>
<BR>
Taxi stands are located outside all CES show locations.
<BR><BR>  
Taxi cab fares from McCarran International Airport to Las Vegas Blvd hotels ("The Strip") or Downtown Las Vegas is approximately $12 per trip.  
<BR><BR>
Taxi cabs are available at the Las Vegas Convention Center from either the North Hall or South Hall.  Cab fares from the LVCC to 
Las Vegas Blvd hotels ("The Strip") is approximately $10 per trip.  Cab fares from the LVCC to McCarran International Airport is 
apprixmately $15 per trip.
<BR><BR>  
<span class="subhead">Parking Information</span>
<BR>
Paid parking is available in some of the lots adjacent to the Las Vegas Convention Center. CES attendees are encouraged to take 
advantage of the complimentary CES shuttle bus from official hotels. The Hilton, Riviera and Alexis Park will also have available 
