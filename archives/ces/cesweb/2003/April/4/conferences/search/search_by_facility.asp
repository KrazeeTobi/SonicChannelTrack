...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.1.4.6")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<BR>
<span class="head">Search by Facility</span><br><br>
<form action=session_by_facility_list.asp method=post><table cellpadding=3 cellspacing=1 border=0><tr><td>Choose a Facility from the Drop-Down List</td></tr><tr height=7><td></td></tr><tr><td colspan=1><select class=formdata name=faevfacility><option value=0>Choose a Facility&nbsp;&nbsp;<option value="Alexis Park">Alexis Park<option value="Las Vegas Hilton">Las Vegas Hilton<option value="LVCC - North Hall">LVCC - North Hall<option value="LVCC - South Hall">LVCC - South Hall</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
