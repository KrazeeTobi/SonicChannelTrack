...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.1.4.4")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<BR>
<span class="head">Search by Date</span><br><br>
<form action=session_by_date_list.asp method=post><table cellpadding=3 cellspacing=1 border=0><tr><td>Choose a Date from the Drop-Down List</td></tr><tr height=7><td></td></tr><tr><td colspan=1><select class=formdata name=sessiondate><option value=0>Choose a Date&nbsp;&nbsp;<option value="1/8/2003">Wednesday, January 8, Day Before CES<option value="1/9/2003">Thursday, January 9, CES Day 1<option value="1/10/2003">Friday, January 10, CES Day 2<option value="1/11/2003">Saturday, January 11, CES Day 3<option value="1/12/2003">Sunday, January 12, CES Day 4</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
