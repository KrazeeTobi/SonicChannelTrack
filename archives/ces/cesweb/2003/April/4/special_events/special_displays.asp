...
<TITLE>2003 International CES: Special Events: Special Displays</TITLE>
...
<TR>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/special_events/special_displays.asp');" ONMOUSEOVER="rollover_td('special','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('special','leftsubnav_main_active');">
		<TD ID="special_cellspacer">&nbsp;</TD>
		<TD ID="special"><a href="/special_events/special_displays.asp" CLASS="leftsubnav_main_active">Special Displays</a></TD>
		<TD ID="special_arrowcell"><IMG SRC="/global_images/context_arrow-new.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.4.6")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="1.4.6">
<span class="pagehead">Special Events :: Special Displays</span><br><br>
<span class="head">Something for Everyone</span><br><br>

<span class="subhead">The CES Store</span><br>
<b>Two locations: Grand Lobby and Upper Level South Hall</b><br>
Remember your business associates, customers and top employees, with something from the CES Store. Pick up some CES gear, including jackets, sweatshirts, polo 
shirts, coffee mugs and pens. Browse through the latest consumer technology books, white papers and market 
research. Or, replace your personal digital assistant with an updated model&mdash;or buy one for the first time!
<br><i>Sponsored by: CompUSA and Microsoft Corp.</i>
<br><br>

<span class="subhead">HDTV Sports Bar</span><br>
<b>Upper Level South Hall, LVCC</b><br>
<img src="images/hdtvSpBar.gif" align="left">
What do Charles Mann and Cliff Branch have in common? Phenomenal football careers. Three Super Bowl rings.  And the HDTV Sports Bar. They'll be there. Will you? Sit back, relax and take in the best high-definition sports programming at the HDTV Sports Bar, located in the South Hall upper level lobby.
<br><b>Congratulations to Rick Palm of Boise, ID - winner of the HDTV Super Bowl Sweepstakes!</b>

<br><img src="/global_images/spacer.gif" height="16"><br>
<span class="subhead">Innovations Awards Charity Auction</span><br>
<b>Innovations Booth, Las Vegas Hilton, #55083</b><br>
<a href="ebay/"><img src="images/ebay_small.gif" align="left" vspace="5" border="0"></a>
Bid on award-winning Innovations 2003 products at the <a href="ebay/">Innovations Awards Charity Auction</a>, presented by CEA and eBay. Proceeds will benefit the National Coalition Against Domestic Violence (NCADV). 

<br><img src="/global_images/spacer.gif" height="18"><br>
<img src="images/gateway.gif" align="right">
<span class="subhead">International Gateway </span><br>
Las Vegas Hilton Ballroom and Hilton Center
extend your network beyond your current boundaries. Check out the International Gateway, catering to international exhibitors and the media.<br><br>

<img src="/global_images/spacer.gif" height="4" border="0"><br>
<span class="subhead">Mercedes Tech Drive 2003 </span><br>
<b>Gold Lot, across from the LVCC, via the pedestrian bridge</b><br>
<img src="/global_images/spacer.gif" height="3"><br><img src="images/mercedes.gif" align="left">
Experience Mercedes-Benz vehicles on a grand scale. Slip into the driver's seat, and enjoy a fully loaded, spirited spin, equipped with state-of-the-art technology. <br>
<i>Mercedes-Benz: Official automotive sponsor of the 2003 International CES. </i><br><br>

<img src="/global_images/spacer.gif" height="3" border="0"><br>
<span class="subhead">Select Products MECP Installer Challenge</span><br> 
<b>LVCC Silver Lot</b><br>
<table>
<tr>
	<td valign="top"><a href="http://www.ce.org/certifications/default.asp" target="new"><img src="images/mecp.gif" border="0" valign="top"></a></td>
	<td>Beginning at 10:00 a.m. on January 9, come watch the "best of the best" installers compete in a four-day mobile installation contest. 
	 The Select Products MECP Installer Challenge will pit two teams of MECP-certified installers against
	 each other to build the best show car. IASCA-certified judges will evaluate the
	 competition based on sound quality and custom installation. The catch is that
	 the vehicles chosen for installation will be kept secret from the participants
...
<img src="images/techhome.gif" align="right">
<span class="subhead">TechHome Demo</span><br>
<b>Lower Level South Hall, Booth #26211, LVCC</b><br>
Displaying the home networking technology for the kitchen, bedroom, utility room and rec room, CEA's TechHome Demo tours the TV stations across the country to demystify home technology for consumers.  Check out the demo at CES.
<br><br>

<a name="technocar"></a>
<span class="subhead">TechnoCar</span><br>
<b>North Hall, Booth #565, LVCC</b><br>
On a TV tour, TechnoCar generates excitement for aftermarket automotive electronics and promotes quality professional installation by MECP-certified professionals.  TechnoCar is CEA's self-contained mock-up of the interior of a car loaded with the latest mobile technology, consisting of two front seats, a center console and a dashboard.  See the car on display at CES.<br><br>

<span class="subhead">Technology is a Girl's Best Friend</span><br>
<img src="/global_images/spacer.gif" height="2"><br>
<a href="/special_events/TIAGBF/default.asp"><img src="TIAGBF/images/TIAGBF_small.gif" align="left" border="0"></a>
With 73 percent of women consumers involved in CE purchasing decisions, the International CES is pleased to announce a comprehensive program that takes a closer look at the needs of today's female technology consumers. The Technology Is A Girl's Best Friend Program at the 2003 International CES will include an exclusive product showcase, a cross-country media tour prior to the 2003 CES, a conference session during CES with top industry women, VIP receptions before and during the show and much more. <a href="/special_events/TIAGBF/default.asp"><b>View detailed information.</b></a><br>
<br>

<img src="images/thunderdorm.gif" align="right">
<span class="subhead">ThunderDorm</span><br>
<b>Lower Level South Hall, Booth #25053, LVCC</b><br>
CEA's unique educational campaign to demonstrate the latest in audio technology to college students and the lucrative Generation Y market comes to CES.
Visit <a href="http://www.ce.org/about_cea/cea_initiatives/viewInitiativesOverview.asp?name=130" target="new">www.CE.org</a> for more information.<br><br>
