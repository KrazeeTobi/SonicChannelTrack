...
<TR>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/exhibitor_dir/brand_name.asp');" ONMOUSEOVER="rollover_td('brand_name','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('brand_name','leftsubnav_main_active');">
		<TD ID="brand_name_cellspacer">&nbsp;</TD>
		<TD ID="brand_name"><A HREF="/exhibitor_dir/brand_name.asp"  CLASS="leftsubnav_main_active">Brand Names</A></TD>
		<TD ID="brand_name_arrowcell"><IMG SRC="/global_images/context_arrow-new.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.2.2")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="1.2.2">
<span class="pagehead">Exhibitor Directory :: Search by Brand Name</span><br><br>
Search for exhibitors by brand name. You can narrow your search by specifying a show location. 

		<form name="searchByBrandName" action="brand_name_search_results.asp?page=1" method="POST">
		
		<table width="100%" cellpadding="0" cellspacing="0" border="0">

		<tr cols="4">
		<td colspan="4" width="100%" class="ExhibitorHeader"><span class="subhead">Browse the Brand Names</span></td>
		</tr>
		...
		Looking for a brand name but don't know how to spell it?  Select the first letter of the brand name to view a list of brands by letter.
		</td>
		</tr>
		...
		<tr>
		<td colspan="1" class="rowlabel">Brand Name:&nbsp;&nbsp;</td>
		<td colspan="3"><input type="text" name="brandName" size="40" maxlength="50" class="formData"></td>
		</tr>
		
		<tr>
		<td>&nbsp;</td>
		<td colspan="3" width="100%">
		Enter all or part of the brand name.
		</td>
		</tr>
