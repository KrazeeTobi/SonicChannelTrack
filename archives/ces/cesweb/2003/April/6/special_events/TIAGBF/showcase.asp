...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.4.6.1.1")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<br>
<span class="callout">Product Showcase</span><br><br>
The <i>Technology is a Girl’s Best Friend Product Showcase</i> will include an exclusive display of products that help women effectively balance the demands in their daily lives. This will be your first look at products targeting the professional and personal aspects of women’s lives from several manufacturers and spanning several product categories. <br><br>

For  information on how to participate in the Technology is a Girl’s Best Friend Showcase, please contact Jayne Dalton at (703) 907-7607 or <a href="mailto:jdalton@ce.org">jdalton@ce.org</a>.
