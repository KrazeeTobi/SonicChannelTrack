...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.4.6.1.4")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<br>
<span class="callout">Exclusive Media Tours and Press Events</span><br><br>
CEA is working extensively to promote the <i>Technology is a Girl’s Best Friend</i> campaign to international media outlets before, during and after the 2003 CES.
<br><br>
<b>CES “Tech Primer” Brunch&mdash;<i>invite only</i></b><br>
<i>Tavern on the Green, New York City, NY<br>
November 6, 2002, 11:30 a.m.</i><br><br>
This invite-only brunch will include a brief overview of product trends in the CE industry, with an exclusive focus on women consumers.  <br><br> 

<b>East Coast Pre-CES Press Conference & Reception</b><br>
<i>Essex House, New York City, NY<br>
November 6, 2002, 5:30 p.m.</i> <br><br>
Hear the latest news for the upcoming CES, especially in regards to home electronics. Following the press conference is a reception for media and CES exhibitors.
