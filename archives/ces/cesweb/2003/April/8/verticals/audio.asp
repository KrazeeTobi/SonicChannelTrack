...
<TITLE>2003 International CES: Audio Hardware and Software</TITLE>
...
<!--START did you know?-->
<div id="fader" style="position:absolute; top:525px; left:165px; width:435px; text-align:left;"></div>

<SCRIPT LANGUAGE="JavaScript">
//  Begin call-out fade code

var texts = new Array(
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ Sales of home and portable audio products are expected to reach $5,954,000 in 2002. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ Home theater-in-a-box sales are expected to triple between 2000 and 2002 to just under $1 billion.  A quarter of American homes own a home theater system. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ MP3 player sales are expected to grow by 32% in 2002, with a total of 825,000 units sold. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ Roughly 31% of 2002 CES attendees come to the show specializing in audio hardware, 29% of CES attendees specialize in high-end audio and 18% specialize in audio software. ~</font>");
...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","0.15.1")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="0.15.1">
<span class="pagehead">Audio Hardware and Software</span><br><br>
<span class="head">Turn It Up</span><br><br>

The 2003 International CES showcases the latest in extreme audio, reaching beyond the traditional CD medium.  
Super Audio CD (SACD), DVD-Audio, and Internet audio such as MP3 give consumers more sound options than ever before. In their cars, consumers 
are cruising with a multitude of digital audio choices available as receivers for digital satellite radio and digital 
terrestrial radio come into the marketplace.<br><br>

<b>If audio is music to your ears, here is a small sampling of what you'll find at the 2003 International CES:</b><br>
<br>
<ul><img src="images/audio.jpg" align="right">
	<li><a href="/exhibitor_dir/product_category.asp">Exhibitors</a> such as Denon, Harman, JVC, Kenwood, Panasonic, Pioneer, Sherwood, Sony and Yamaha showcase 
	    the latest audio products and services.
	<li>Audio products and technologies in several <a href="/pavilions/">pavilions</a>, including the MP3 and Internet Audio Pavilion and the 
	    Audio Books Pavilion.
	<li>The <a href="http://www.ce.org/about_cea/cea_initiatives/viewInitiativesOverview.asp?name=130" target="new">CEA ThunderDorm</a> traveling showcase features some of the latest audio technologies for the home and on the go.
	<li>The Alexis Park, the prime location for high-end audio exhibitors, houses the world's largest high-end audio show.
	<li>Surround yourself with information at the <a href="/conferences/search/session_by_circuit_list.asp?ID_track=SMS03">Surround Music Symposium</a> and find out the newest in-car entertainment 
	    trends at the <a href="/conferences/search/session_detail.asp?ID_session=AT1">Audiotrax</a> research study presentation.
</ul>
<br>
