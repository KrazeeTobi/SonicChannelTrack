...
<TITLE>2003 International CES: Computing/Home Networking</TITLE>
...
<!--START did you know?-->
<div id="fader" style="position:absolute; top:555px; left:165px; width:435px; text-align:left;"></div>

<SCRIPT LANGUAGE="JavaScript">
//  Begin call-out fade code

var texts = new Array(
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ More than 28,000 people who come to CES specialize in home networking and automation. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ More than 6,000 installers and service professionals attend CES. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ Wi-Fi and HomePNA alliances attend CES. ~</strong></font>");
...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","0.15.2")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="0.15.2">
<span class="pagehead">Computing/Home Networking</span><br><br>
<span class="head">No Place Like Home</span><br><br>
<img src="images/networking.jpg" align="right">
Imagine equipping your home with networked systems that can control everything from distributing TV and Internet content 
to programming your alarm systems. Return home after work and simultaneously adjust the temperature while tuning in your 
favorite digital TV broadcast and checking your e-mail. This networked home is a reality for consumers and can be 
installed easily and inexpensively today.<br><br>

At the 2003 International CES you’ll see how greater affordability and ease of installation are driving growth. And whether the future of 
connectivity belongs to phone lines, wireless, electric current or a new technology yet to come, you’ll see it first at 
the 2003 International CES.<br><br>

<b>View the current state of connectivity at the 2003 International CES with a variety of home 
networking highlights, including:</b><br><br>
<ul>
	<li>Major <a href="/exhibitor_dir/product_category.asp">home networking companies</a> such as BeAtHome, Crestron, Echelon, Lutron, Netgear and X-10 are exhibiting at the 2003 show.
	<li>Home networking and information technology products in several <a href="/pavilions/default.asp">pavilions</a>, including the Energy Efficiency Pavilion and the TechHome Pavilion.
	<li>Showcasing how home networking, home theater and home office technology can work together, CEA features the new <a href="/special_events/special_displays.asp">TechHome media tour</a>.
	<li><a href="/conferences/search/session_by_circuit_list.asp?id_track=CEDIA03">CEDIA training</a> and <a href="/conferences/search/session_by_circuit_list.asp?ID_track=PA03">Parks Associates</a> conferences at the 2003 International CES educate attendees on home installation and connected home technologies.
</ul>
<br>
