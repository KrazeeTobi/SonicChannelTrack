...
<TITLE>2003 International CES: Video</TITLE>
...
<!--START did you know?-->
<div id="fader" style="position:absolute; top:482px; left:165px; width:435px; text-align:left;"></div>

<SCRIPT LANGUAGE="JavaScript">
//  Begin call-out fade code

var texts = new Array(
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ Sales of DTVs topped 1.425 million units in 2001, making digital television the most successful product in CE history. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ Stand-alone DVD players have reached 25% penetration faster than any other CE product in history, totaling 13 million units in 2001, a 53 percent increase. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ Ninety-four percent of DVD owners are satisfied with their DVD player, making it one of the most satisfying products on the market today. ~</strong></font>");
...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","0.15.8")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="0.15.8">
<span class="pagehead">Video</span><br><br>
<span class="head">Picture Perfect</span><br><br>
<img src="images/video.jpg" align="right">
The digital revolution is transforming home video from DVD to PVRs to DTV. More than two million digital TV products have been sold 
since DTV's introduction just three years ago. Manufacturers now offer more than 300 models of DTV offering spectacular picture and 
sound quality from a variety of sources including VCRs, DVDs, home satellite and broadcast HDTVs. From plasma TVs to the tiniest 
portables and LCD viewfinders, today’s new video display technologies offer the clearest pictures we’ve seen to date.<br><br>

<b>Want a clear picture of what’s to come in video technology?  The 2003 International CES is the place to be:</b><br>
<br>
<ul>
	<li>See the latest video technology has to offer in a familiar setting at the <a href="/special_events/special_displays.asp">HDTV Sports Bar</a>.
	<li>Key <a href="/conferences/">conference sessions</a> tackling the latest issues from copyrights to tuner mandates.
	<li>Vote on your choices for <a href="/special_events/awards.asp">Academy of Digital Television Pioneers</a>.
	<li>Learn more about advances in Video technology in the <a href="/conferences/search/session_by_circuit_list.asp?ID_track=HE03">Home Entertainment Track</a> and the <a href="/conferences/search/session_by_circuit_list.asp?ID_track=DH03">Digital Hollywood</a> partner program.
</ul>
<br>
