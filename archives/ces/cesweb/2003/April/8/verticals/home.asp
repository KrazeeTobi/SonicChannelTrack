...
<TITLE>2003 International CES: Home Theater</TITLE>
...
<!--START did you know?-->
<div id="fader" style="position:absolute; top:572px; left:165px; width:435px; text-align:left;"></div>

<SCRIPT LANGUAGE="JavaScript">
//  Begin call-out fade code

var texts = new Array(
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ Roughly 31% of 2002 CES attendees came to the show specializing in audio hardware, with another 31% interested in DTV/HDTV. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ More than 6,000 installers and service professionals attend CES. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ One out of every four American homes has a home theater. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ Home theater-in-a-box sales are expected to triple between 2000 and 2002, to just under $1 billion. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ CES launched numerous home theater technologies (DTV, VCR, DVD, progressive scan DVD, DVD-Audio, SACD, surround sound and PVR among others) into the marketplace. ~</strong></font>");
...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","0.15.6")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="0.15.6">
<span class="pagehead">Home Theater</span><br><br>
<span class="head">Now Playing</span><br><br>
<img src="images/theater.jpg" align="right">
Go to the movies&mdash;enjoying superlative sound and big-screen color&mdash;in your own home. Home theater combines audio and video products 
into one comprehensive system to place you in the middle of the action in a film, TV show, sporting event or concert.<br><br> 

To further enhance audio realism, consumers can take advantage of two 5.1-channel digital surround formats, Dolby Digital and DTS 
Digital Surround. The creative community is turning out more 5.1 content, stimulating sales of home theater products.<br><br>

<b>Home theater products are coming to a show near you&mdash;the 2003 International CES. Home theater highlights include:</b><br>
<br>
<ul>
	<li>Major <a href="/exhibitor_dir/product_category.asp">audio, video and home networking companies</a> such as Crestron, Denon, Echelon, Harmon, Panasonic, Philips, Pioneer, Sony, Thomson, X-10, Yamaha and Zenith are exhibiting at the 2003 International CES.
	<li>The 2003 International CES highlights home theater products in several <a href="/pavilions/">pavilions</a>, including the Xtreme Entertainment Pavilion and the TechHome Pavilion.
	<li>The new CEA <a href="/special_events/special_displays.asp">TechHome media tour</a> shows how home networking, home theater and home office technology can work together.
	<li>The CEA <a href="http://www.ce.org/about_cea/cea_initiatives/viewInitiativesOverview.asp?name=130" target="new">ThunderDorm</a> traveling showcase features a home theater and will make a stop at the 2003 International CES.
	<li>Conferences such as <a href="/conferences/search/session_by_circuit_list.asp?id_track=CEDIA03">CEDIA training</a>, <a href="/conferences/search/session_by_circuit_list.asp?ID_track=SBCA03">SBCA SkyForum</a> and <a href="/conferences/search/session_by_circuit_list.asp?ID_track=DH03">Digital Hollywood</a> sessions educate you on the latest trends and developments in the home theater industry.
</ul>
<br>
