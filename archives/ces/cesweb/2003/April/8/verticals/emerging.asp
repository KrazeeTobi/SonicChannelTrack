...
<TITLE>2003 International CES: Emerging Technology</TITLE>
...
<!--START did you know?-->
<div id="fader" style="position:absolute; top:540px; left:165px; width:435px; text-align:left;"></div>

<SCRIPT LANGUAGE="JavaScript">
//  Begin call-out fade code

var texts = new Array(
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ 58 percent of wireless phone owners prefer converged wireless phone/PDA devices to two stand-alone products capable of performing the same functions. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ Almost one-third of consumers would like to use the Internet to monitor their homes. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ 36 percent of U.S. consumers want their homes to e-mail them at work about happenings, like deliveries and children arriving home. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ CEA projects that approximately 20 million U.S. households will have broadband service by the end of 2002. ~</strong></font>");
...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","0.15.4")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="0.15.4">
<span class="pagehead">Emerging Technology</span><br><br>
<span class="head">No Boundaries</span><br><br>

Once technology marvels&mdash;now household mainstays&mdash;the X-Box, satellite radio, DVD and VCR met the public for the first time ever at the International CES. New products are slated to emerge this year, too. The 2003 International CES will host the best of the best and forge a high-tech trail of innovation.
<br><br>
<b>See what's new in consumer technology, and here's where you find it:</b>
<br><br>
<ul><img src="images/emerging.jpg" align="right">
	<li>Visit <a href="/pavilions/">25 specialty pavilions</a>, featuring the hottest advancements. Visit the Emerging Technologies Launchpad, the Embedded Technologies Pavilion and the TechHome Pavilion to test tomorrow's leading new products. 
	<li>Check out the breakthrough technologies in the South Hall, Upper Level. 
	<li>Meet the brains behind this year's best examples of design and engineering at the <a href="/awards/innovations/default.asp">Innovations 2003 Design and Engineering Showcase</a>. 
	<li>Attend 2003 International CES <a href="/conferences/knowledge_circuit.asp">Knowledge Tracks</a> focused on Emerging Technologies, Car Technologies, Home Entertainment, Gaming and more. Topics range from emerging technologies to telematics to home security. 
	<li>The free <a href="/conferences/search/session_detail.asp?ID_session=SS2&ID_track=SS03">Tomorrow's Technologies SuperSession</a> delivers valuable insight on products in development. 
	<li>Set your PDA to remind you about the <a href="/conferences/search/session_detail.asp?ID_session=SS1&ID_track=SS03">CNET Networks Reveals the Next Big Thing in CE</a> and <a href="/conferences/search/session_detail.asp?ID_session=SS6&ID_track=SS03">The Last Gadget Standing</a>. 
</ul>
<br>
