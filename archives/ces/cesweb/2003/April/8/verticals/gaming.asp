...
<TITLE>2003 International CES: Gaming</TITLE>
...
<!--START did you know?-->
<div id="fader" style="position:absolute; top:495px; left:165px; width:435px; text-align:left;"></div>

<SCRIPT LANGUAGE="JavaScript">
//  Begin call-out fade code

var texts = new Array(
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ More than 1,000 members of the media came to CES in 2002 to cover gaming. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ Sales of electronic gaming hardware are projected to reach $3 billion, and sales of electronic gaming software are projected to reach $7 billion in 2002. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ An estimated 60 percent of Americans view electronic gaming as a leisure activity. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ The Interactive Entertainment Merchants Association (IEMA) chose the 2002 CES as the place to hold their annual board meeting, conduct business and network. ~</strong></font>");
...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","0.15.5")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="0.15.5">
<span class="pagehead">Gaming</span><br><br>
<span class="head">Got Game?</span><br><br>
<img src="images/gaming.jpg" align="right">
The evolution of portable PC and wireless gaming allows consumers to play games practically anywhere–at home, at work or on-the-go. And gaming's gone global thanks to the Internet.
<br><br>

Don’t forget the gaming consoles that are quickly becoming the centerpiece of the home entertainment experience. 
In 2001, Microsoft used the the 2003 International CES venue to launch its powerful <br>X-Box&mdash;and garnered extensive 
media coverage, buyer interest and a comfortable position alongside other videogame notables. The gaming industry 
plays an even larger part at the 2003 International CES.<br><br>  

<b>If gaming gets you going, then race to see:</b><br>
<br>
<ul>
	<li>Many <a href="/exhibitor_dir/product_category.asp">gaming companies</a> such as Dolby, Nvidia, InterAct, Monster Cable and Sony showcase the latest technologies at the 2003 International CES, such as GameShark, that complement gaming console systems.
	<li><a href="/pavilions/">Pavilions</a>, such as the Xtreme Entertainment Pavilion, showcase the latest technologies, help identify new products and educate attendees on key trends within the industry.
	<li>Learn about the newest advances in gaming with the <a href="/conferences/search/session_by_circuit_list.asp?ID_track=G03">Gaming Knowledge track</a>.
</ul>
<br>
