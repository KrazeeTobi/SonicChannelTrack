...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.6.2.2.8")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<tr>
	<td><br><img src="jpgs/products/EGAINT3.jpg" width="90"  border=0 alt="Hammerhead FX"></td>
	<td><br><span class="subhead">InterAct Accessories Inc.<br>(A Recoton Company)</span><br>
	<span class="body"><a target="new" href="http://www.interact-acc.com">www.interact-acc.com</a><br>
	<i>In House Design Team</i><br>
	Hammerhead FX</span></td>
</tr>
<tr><td colspan="2"><span face="body" size="2"><br>
		The HammerHead FX (SV-262A) for PC is the world’s first dual analog, dual vibration gamepad that translates 
		Direct X force feedback protocols into vibration and is tri-compatible with a standard gameport, PC and Mac 
		USB ports.<br>
	</td>
</tr>
<tr>
...
<tr>
	<td><img src="jpgs/products/EGAMON1.jpg" width="90"  border=0 alt="Gamelink 300 S-Video AV Cable"></td>
	<td><span class="subhead">Monster Cable</span><br>
	<span class="body"><a target="new" href="http://www.ceiva.com"></a><br>
	<i>In-House Design Team</i><br>
	Gamelink 300 S-Video AV Cable</span></td>
</tr>
<tr><td colspan="2"><span face="body" size="2"><br>
		Monster Game’s GameLink 300 S-Video is heavy-duty, high-performance, S-Video equipped AV connector that 
		enables consumers to achieve the highest level of audio and video performance possible from their gaming 
		consoles.<br>
	</td>
</tr>
<tr>
...
<tr>
	<td><img src="jpgs/products/EGAMON2.jpg" width="90"  border=0 alt="GameLink 400 Component Video Cable"></td>
	<td><span class="subhead">Monster Cable</span><br>
	<span class="body"><a target="new" href="http://www.ceiva.com"></a><br>
	<i>In-House Design Team</i><br>
	GameLink 400 Component Video Cable</span></td>
</tr>
<tr><td colspan="2"><span face="body" size="2"><br>
		Monster Game’s GameLink 400 component video is a heavy-duty, ultra high-performance, component video cable 
		that enables consumers to achieve the highest level of video performance possible from their gaming consoles. 
		GameLink 400 component video is ideally suited for gaming consoles with a digital audio out.<br>
	</td>
</tr>
<tr>
	<td colspan="2"><span face="body" size="2"><br>
...
<tr>
	<td><img src="jpgs/products/EGAORE1.jpg" width="90"  border=0 alt="Accelerator Elite"></td>
	<td><span class="subhead">Oregon Scientific</span><br>
	<span class="body"><a target="new" href="http://www.oregonscientific.com">www.oregonscientific.com</a><br>
	<i>In-House Design Team</i><br>
	Accelerator Elite</span></td>
</tr>
<tr><td colspan="2"><span face="body" size="2"><br>
		The exciting new Oregon Scientific Accelerator Elite (Model #14888) is a children's talking laptop computer 
		with over 100 built-in learning activities and games. It has an oversized LCD window, DCD (digital compact 
		disc) drive, touchpad, dual speakers with digital sound and synthesizer, plus mouse and mousepad.<br>
	</td>
</tr>
<tr>
	<td colspan="2"><span face="body" size="2"><br>
		<b>Location: 4335 LVCC NO. 1&2</b>
	</td>
</tr>
</table>
<br>
