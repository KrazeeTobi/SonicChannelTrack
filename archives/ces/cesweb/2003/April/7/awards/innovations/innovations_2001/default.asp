...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.6.2.2")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<span class="head">Innovations 2001</span><br><br>

Innovations 2001 is the <a target="new" href="http://www.ce.org">Consumer 
...
sense of the excellence that can be achieved in consumer technology. <br><br>

<span class="subhead">Questions about Innovations?</span><br>Contact us at <a href="mailto:Innovations@ce.org">Innovations@ce.org</a>.
