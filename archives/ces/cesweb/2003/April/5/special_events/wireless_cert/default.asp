...
<TITLE>2003 International CES: Wireless Certification Training Program</TITLE>
...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.4.4.2")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="1.4.4.2">
<span class="pagehead">Special Events :: Wireless Certification Training Program</span><br><br>
<span class="head">Real-time training for the real world.</span><br><br>
<span class="subhead">Equip your sales staff with the most intuitive knowledge in the wireless retail market - FREE of Charge!"</span>
<br><br>
<img src="../images/earl1.jpg" align="left">
You sell the coolest wireless devices. You run hard, work fast. But it's hard to keep up with the latest trends and products. Relax. And let moderator Earl Webspace&mdash;along with the CEA Wireless Certification Program&mdash;help.
<br><br>
Through the Consumer Electronics Association (CEA) Wireless Certification Program, retailers have a one-source, turnkey program. Earl guides wireless retail sales professionals through a comprehensive series of online training modules, educating with a hip, interactive curriculum.
<br><br>
<img src="/global_images/page_sep_onpage.gif" width="100%" height="1"><br><img src="/global_images/spacer.gif" height="5" border="0"><br>
<span class="subhead">Keep your Earl-wear front and center. If Earl spots you, you may win a daily $500 prize.</span>
	<b>Daily winners:</b><br>
	Thursday - Diana Winfield, Cellular One Retail and Distribution Manager, Bermuda<br>
	Friday - Jeff Kerekes, President, Connect Cell, Wisconsin <br>
	Saturday - Albert Wu, General Manager, AAA Cellular, Guam <br>
	Sunday - James Sung, President, Cellular Fashions
<br><img src="/global_images/spacer.gif" height="5" border="0"><br>
<img src="/global_images/page_sep_onpage.gif" width="100%" height="1"><br><br>

<table border="0" cellpadding="0" cellspacing="0">
<tr>
	<td width="50%" valign="top">
	The CEA Wireless Certification Program provides front-line retail staff a tangible connection to the most current wireless information available.  Emphasizing the essentials of the industry, this series of online training modules includes a strong focus on industry, sales and product knowledge.
	<br><br>
	Try the training at the 2003 International CES at the kiosks located next to the Ultimate Wireless SuperStore. There, you can score cool Earl gear when you stop by the CEA Wireless Certification kiosks&mdash;or the free wireless training.
	</td><td width="8">&nbsp;</td>
	<td valign="top">
	<table>
		...
		<tr>
			...
			<td><span style="color:#0d1f69;">
			We are constantly researching cost-effective ways to train our nationwide sales staff.  A program like the CEA Wireless Certification Program allows every member of the team to get wireless knowledge and certification online, and it can be seamlessly integrated into our training plan.	</b></span>
			</td>
			<td valign="bottom"><img src="/global_images/close_quote.gif"></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td><b>Tyler Harrington</b>, Manager of E-Learning, Training & Development, CompUSA</td>
			<td>&nbsp;</td>
		</tr>
		<tr><td colspan="3"><img src="/global_images/page_sep_onpage.gif" width="100%" height="1"></td></tr>
	</table>
...
<img src="/global_images/spacer.gif" height="7"><br>
Through the training program, which consists of a set of training modules followed by a certification test, your staff will learn about:
<ul>
<li>The history and basics of wireless technology
<li>How various wireless devices, such as cell phones and personal digital assistants (PDAs) function
<li>Identifying the wireless needs of the everyday consumer
<li>Adding value through accessory sales
<li>And more!
</ul><br>
Integrating this free program into your training process ensures your growing and changing team remains educated, unified and motivated.
<br><br><div align="center">
<a href="http://www.ce.org" target="new"><img src="../images/cea_wcp.gif" align="center" border="0"></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="http://www.cyberscholar.com" target="new"><img src="../images/cyberscholar.gif" align="center" border="0"></a>
</div><br>
Creative Channel Services, Inc., provider of <a href="http://www.cyberscholar.com" target="new">CyberScholar.com</a>, is CEA's strategic partner for online retailer training.
<br><br>
...
<TR>
	...
	<b>11:30 a.m. - 1 p.m.<br>
	Saturday, January 11<br>LVCC S215-216</b><br>
	(Gear limited to first 150 participants, so arrive Earl-y.)<br><br>
	</TD>
</TR>
...
<TR>
	...
	<TD CLASS="">
	<!-- **INSERT ADDED VALUE HERE** -->
	<span class="subhead">Get Your Earl Gear at CES:</span><br>
	<b>CEA Wireless Certification Program Kiosks</b><br>
	Next to the Ultimate Wireless SuperStore<br>
	LVCC South 3, Upper Level<br>
	</TD>
</TR>
</TABLE>
<!-- END TABLE 8 -->
