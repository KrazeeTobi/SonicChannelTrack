...
<TITLE>2003 International CES: International Visitors</TITLE>
...
<TR>
	...
	<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0">
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/international/default.asp');" ONMOUSEOVER="rollover_td('general','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('general','leftsubnav_main_active');">
		<TD ID="general_cellspacer">&nbsp;</TD>
		<TD ID="general"><a href="/international/default.asp" CLASS="leftsubnav_main_active">General Information</a></TD>
	...
	<TR CLASS="leftsubnav_main" ONCLICK="goto_link('/international/services.asp');" ONMOUSEOVER="rollover_td('services','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('services','leftsubnav_main');">
		<TD ID="services_cellspacer">&nbsp;</TD>
		<TD ID="services"><a href="/international/services.asp" CLASS="leftsubnav_main">Attendee Services</a></TD>
	...
	<!-- END TABLE 5 (optional) -->
			...
			<TR>
				...
				<span class="subhead"><A HREF="/for_exhibitors/exhibiting/default.asp">Learn</a> why you need to exhibit at CES.</span><br>
				</div></TD>
			</TR>
			</TABLE>
...
<table width="90%" align="center">
	...
	<span class="subhead" style="text-align: left">CES:<br>The ONE SHOW<br>you MUST attend</span><br>
	<span style="color: #004AA0">An incredible 89% ($85 billion) of the consumer electronics industry buying power was found at the 2002 International CES.</span><br><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="5.1.1">
<span class="pagehead">International Visitors :: General Information</span><br><br>
<span class="head">Experience a consumer technology show unlike any other in the world.</span>
<br><br>
<span class="subhead">2003 International CES – January 9 – 12, Las Vegas, Nevada, USA</span><br>

The 2003 International CES is the largest trade fair of consumer technology products worldwide. You'll see and experience:
<br><br>
<ul>
<li><b>More innovative products.</b> Two thousand <a href="/exhibitor_dir/exhibitor_name.asp">exhibitors</a> showcase an amazing <a href="/awards/innovations/default.asp">array of consumer electronics</a>. 

<li><b>More excitement.</b> Come experience the most amazing communication, entertainment, computer and networking products the digital world has to offer. 

<li><b>More business opportunities.</b> Meet industry leaders and innovators-and perhaps your next global business partners.
</ul>
<br>
Join 100,000 professionals, including 10,000 international visitors from 100 countries outside the U.S. CES is a trade fair, a business forum, a conference with more than 100 educational sessions and a place to meet the people who can make a difference in your company's future.
<br><br>
<b><i>Don’t miss the most essential technology event of the year!</i></b><br><br> 

<span class="orange_callout">Special Registration Package Exclusively for International Attendees!</span><br>
The <a href="http://ww4.expocard.com/ces031/">International Premier Package</a> offers VIP seating to all keynotes (except Bill Gates where seating is limited), access to the exhibit floor and all educational sessions on the CES Knowledge Track, three VIP luncheon tickets for the first three days of the show, an exclusive registration area, invitation to the International Reception January 9, and a commemorative CES rolling conference bag containing valuable visitor information and CES show materials - all for $299 (U.S.).
<!--<span class="subhead">Registration is now open!</span><br>
Find out how you can save big by registering for the <a href="http://ww4.expocard.com/ces031/">International Premier Package</a>.
-->
<br><br>

<span class="subhead">Visas and Letters of Invitation</span><br>
To better serve our International visitors who require a letter of invitation to obtain a temporary visa to attend the International CES, you will now be able to request a visa letter of invitation at the same time that you register.  Simply indicate in the space provided on the registration page that you need a letter of invitation and we will prepare one for you.  We’ll process your request within 48 hours and you can expect to receive your letter within 3 to 4 weeks.<br><br>
Find out more about how to <a target="new" href="http://www.travel.state.gov/visa_services.html">apply for a visitor visa to the U.S.</a><br><br>
Get a <a target="new" href="http://www.travel.state.gov/DS-0156.pdf">U.S. Visa Application Form (Form DS-0156) </a><br><br>
Find the location of the <a target="new" href="http://www.travel.state.gov/links.html">U.S. Embassy or Consulate General nearest you</a>.<br><br>
<span class="subhead">U.S. State Department Visa Waiver Program</span><br>
Visitors from qualified countries, coming to the United States for business or tourism for 90 days or less, may be eligible to enter the United States without a visa.  Currently, 28 countries participate in the Visa Waiver Program:<br><br>
...
<br>
Find out more about the <a target="new" href="http://www.travel.state.gov/vwp.html">U.S. State Department’s Visa Waiver Program</a>.<br><br>
</div>
<!-- **CONTENT ENDS HERE** -->

<!-- include virtual="/global_include/asp/page_right_column.asp" -->		
	</TD>
	...
	<TD VALIGN="top" width="135" bgcolor="#ffffff">
		...
		<TR>
			...
			<TD>
				...
				<div align="center"><strong>January 9-12, 2003<br>Las Vegas, Nevada</strong></div>
		...
		<TR>
			...
			<TD>
				...
				<b>Your time is extremely valuable.</b><br>
				Take advantage of our <a href="services.asp">International Attendee Services</a>.
...
-->
		...
		<TR>
			...
			<TD CLASS="avshadowmain"><br>
				<b>New for 2003</b>
				<br>
				CES now offers simultaneous Japanese translation for its <a href="/conferences/keynotes.asp">keynote addresses</a>. 
				<br><br>
			</TD>
			<TD CLASS="avshadowmain"><img src="/global_images/spacer.gif" width="3"></TD>
		</TR>
		</TABLE>
