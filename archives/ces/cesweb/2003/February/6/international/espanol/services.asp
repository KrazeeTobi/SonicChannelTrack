...
<TR>
	...
	<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0">
	<TR CLASS="leftsubnav_main" ONCLICK="goto_link('/international/espanol/default.asp');" ONMOUSEOVER="rollover_td('general','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('general','leftsubnav_main');">
		<TD ID="general_cellspacer">&nbsp;</TD>
		<TD ID="general"><a href="/international/espanol/default.asp" CLASS="leftsubnav_main">Información general</a></TD>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/international/espanol/services.asp');" ONMOUSEOVER="rollover_td('services','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('services','leftsubnav_main_active');">
		<TD ID="services_cellspacer">&nbsp;</TD>
		<TD ID="services"><a href="/international/espanol/services.asp" CLASS="leftsubnav_main_active">Servicios a los asistentes</a></TD>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="5.3.2">
<span class="pagehead">Visitantes internacionales :: Servicios a los
asistentes</span>
<br><br>
<span class="head">Aproveche su tiempo en el CES.</span>
<br><br>
<span class="subhead">Servicios a los asistentes internacionales</span><br>
El CES Internacional da la bienvenida a los visitantes de todo el mundo.  Les
agradecemos que hagan un viaje tan largo para asister al CES, y su tiempo es
muy valioso.  Proporcionamos muchos servicios en CES para hacer su experiencia
lo más rentable posible.<br><br>
<b>Centro de comercio internacional (ICC)</b><br>
<em><b>¡Dos localizaciones para ayudarle!</b></em><br>
Para asegurar que su experiencia en el CES es productiva, nos complace
facilitarle dos localizaciones ICC para su conveniencia – el South Hall de Las
Vegas Convention Center y el Las Vegas Hilton.  En ambas localizaciones ICC le
ofrecemos servicios de negocios tales como salas de reuniones, copiadoras, fax,
y conexión a internet.  El personal profesional, multilingüe está siempre
dispuesto para ayudarle con información, servicios de traducción e
interpretación.<br><br>
<b><em>Servicios de negocios ICC:</em></b><br>
<ul>
	<li>Estaciones internet
	<li>Salas de reuniones privadas – disponibles para reservarse diariamente
por horas.
	<li>Máquinas copiadoras y fax
	<li>Acceso a teléfonos con tarjetas de llamadas o sólo con tarjeas de
crédito
</ul>
<br>
<b><em>Horario ICC:</em></b><br>
<table width="50%">
	<tr>
	<td>
	8 de enero<br>
	Del 9 al 11 de enero<br>
	12 de enero
	</td>
	<td>
	De 12:00 p.m. a 6:00 p.m.<br>
	De 8:30 a.m. a 6:00 p.m.<br>
	De 8:30 a.m. a 4:00 p.m.
	</td>
	</tr>
</table>
<br>
<b>Intérpretes en CES</b><br>
En cada localización ICC existen a su disposición intérpretes para
cualquiera que necesite ayuda en chino, japonés, francés, alemán o
español.<br><br>
<b>Encuentre a los expositores de exportación</b><br>
El CES Internacional identifica a los expositores, junto con los productos
que fabrican, que estén interesados en exportar a países específicos
y regiones.  A principios de agosto, le será posible buscar
en nuestro directorio de expositores y localizar a los expositores de
exportación
a los que estén buscando llegar a su mercado.  Compruebe a menudo la Sección de
Expositores
de CESweb – los expositores actualizan continuamente sus listados hasta que 
comienza la feria de 2003.<br><br>
<b>Recepción internacional</b><br>
Está cordialmente invitado a asistir a la Recepción Internacional del CES
el jueves, 9 de enero de 2003.  Este es la mejor oportunidad para conocer y 
conectar con los expositores de exportación y con otros colegas de
la industria internacional. Las invitaciones estarán disponibles in situ en la
zona
de Inscripción Internacional o en cualquier ICC el de Las Vegas
Convention Center o el de Las Vegas Hilton.<br><br>
<b>Transporte en el CES</b><br>
<b><i>Desde el aeropuerto.</i></b> Las Vegas ofrece muchas
formas de
transporte a y desde el aeropuerto tales como servicios
regulares de transporte, vehículos de alquiler,
taxis y limusinas. Las Vegas también tiene convenientes y
accesibles
servicios regulares de transporte de extraradio/centro y un
sistema de transporte público, que recorre
rutas programadas todos los días.<br><br>
<b><i>Desde los hoteles oficiales del CES.</i></b> Los servicios
regulares de autobus gratis
le llevan desde los hoteles oficiales del CES al Las
Vegas
Convention Center todos los días de la muestra. El servicio también está
disponible
desde el Convention Center al Alexis Park Hotel.<br><br>
<b>¿De visita en Las Vegas por primera vez?</b><br>
Las Vegas es una de las principales atracciones turísticas en el mundo. 
Si es por su buena comida, ocio de gran calidad, casinos,
la presa Hoover o
el Gran Cañón, la institución <a target="new"
href="http://www.lasvegasfreedom.com">Las Vegas Convention &
Visitor’s Authority </a>posee información que le ayudará a hacer de su
viaje al CES Internacional 2003 una experiencia memorable y completa.
<br><br>
Encuentre adicionalmente <a target="new"
href="http://www.vegasfreedom.com/play-12.asp">Información sobre
mapas y transporte en Las Vegas</a>.
<br><br>
</div>
<!-- **CONTENT ENDS HERE** -->
