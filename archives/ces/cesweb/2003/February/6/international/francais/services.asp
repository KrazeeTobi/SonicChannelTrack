...
<TITLE>Salon international de l'électronique grand public (CES) 2003: visiteurs internationaux</TITLE>
...
<a name="top"></a>
<SCRIPT language="javascript1.2" SRC="http://www.cesweb.org/global_include/js/global_script.js"></SCRIPT>
...
<TR>
	...
	<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0">
	<TR CLASS="leftsubnav_main" ONCLICK="goto_link('/international/francais/default.asp');" ONMOUSEOVER="rollover_td('general','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('general','leftsubnav_main');">
		<TD ID="general_cellspacer">&nbsp;</TD>
		<TD ID="general"><a href="/international/francais/default.asp" CLASS="leftsubnav_main">Informations générales</a></TD>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/international/francais/services.asp');" ONMOUSEOVER="rollover_td('services','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('services','leftsubnav_main_active');">
		<TD ID="services_cellspacer">&nbsp;</TD>
		<TD ID="services"><a href="/international/francais/services.asp" CLASS="leftsubnav_main_active">Services aux participants</a></TD>
		<TD ID="services_arrowcell"><IMG SRC="/global_images/context_arrow-new.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="5.4.2">
<span class="pagehead">Visiteurs internationaux : services aux participants</span>
<br><br>
<span class="head">Maximisez votre temps pendant votre participation au CES</span>
<br><br>
<span class="subhead">Les services proposés aux participants internationaux</span><br>
Le salon international de l'électronique grand public (CES) souhaite la bienvenue aux visiteurs du monde entier. Nous vous remercions pour le long voyage que vous avez effectué afin de participer au CES et nous sommes conscients de l'importance du temps dont vous disposez. De nombreux services sont donc organisés pour rentabiliser au maximum votre participation.<br><br>
<b>Centre International du Commerce (ICC)</b><br>
<em><b>Deux lieux à votre service!</b></em><br>
Pour rendre votre participation au CES productive, nous sommes heureux de mettre deux centres internationaux de commerce (ICC) à votre disposition – le South Hall du Las Vegas Convention Center et le Hilton de Las Vegas. Vous y disposerez de toutes les commodités professionnelles telles que des salles de réunions, des photocopieurs, des télécopieurs et des connexions Internet. L'équipe professionnelle multilingue est toujours à votre disposition et prête à vous assister pour tout ce qui concerne les services d'information, de traduction ou d'interprétariat.<br><br>
<b><em>Les services des ICC :</em></b><br>
<ul>
	<li>Stations Internet
	<li>Salles de réunions privées – réservation quotidienne à l'heure
	<li>Télécopieurs et photocopieurs
	<li>Téléphones accessibles par carte téléphonique ou carte de crédit uniquement
</ul>
<br>
<b><em>Horaires des ICC :</em></b><br>
<table width="50%">
	<tr>
	<td>
	8 janvier<br>
...
<br>
<b>Les interprètes au CES</b><br>
Chaque centre international de commerce (ICC) dispose d'interprètes prêts à apporter leur expertise en chinois, japonais, français, allemand ou espangol.<br><br>
<b>Rencontrer des exposants exportateurs</b><br>
Le salon international de d'électronique grand public (CES) identifie les exposants non seulement par les produits qu'ils fabriquent mais aussi par l'intérêt qu'ils portent à l'exportation vers des pays et des régions spécifiques. Dès le mois d'août, vous pourrez parcourir notre répertoire des exposants pour rechercher ceux d'entre eux qui sont intéressés par votre marché. Visitez souvent la section Exposants du site du CES. Les listes sont régulièrement mises à jour jusqu'au début du salon en 2003.<br><br>
<b>La réception internationale</b><br>
Vous êtes cordialement invités à assister à la réception internationale du CES le jeudi 9 janvier 2003. Il s’agit de la meilleure opportunité qui vous est offerte de rencontrer des exposants exportateurs ainsi que des collègues étrangers et de tisser des relations avec eux. Les invitations seront disponibles sur le site dans l'espace Inscription internationale ou dans les centres internationaux de commerce (ICC) au Las Vegas Convention Center ou au Hilton de Las Vegas.<br><br>
<b>Le transport au CES</b><br>
<b><i>Depuis l'aéroport.</i></b> Las Vegas met à votre disposition de nombreux moyens de transport vers et depuis l'aéroport : navettes, voitures de location, taxis et limousines.  Las Vegas propose également des navettes pratiques et accessibles pour desservir le centre-ville de même qu'un système de transport public, dont le trajet quotidien est programmé.<br><br>
<b><i>Depuis les hôtels officiels du CES.</i></b> Des services gratuits de navettes par autobus vous emmènent des hôtels officiels du CES au Las Vegas Convention Center pendant l'ensemble de quatre jours du salon. Ce service est également disponible du Convention Center à l'hôtel Alexis Park.<br><br>
<b>Vous visitez Las Vegas pour la première fois ?</b><br>
Las Vegas se classe parmi les tous premiers sites touristiques au monde. Qu'il s'agisse de restauration fine, de loisirs haut de gamme, de casinos, du barrage Hoover ou du grand Canyon, <a target="new" href="http://www.lasvegasfreedom.com">Las Vegas Convention & Visitor’s Authority </a>mettent à votre disposition tous les renseignements qui rendront, inoubliable et complet, votre voyage au salon international de l'électronique grand public (CES) 2003.
<br><br>
Trouver d'autres <a target="new" href="http://www.vegasfreedom.com/play-12.asp">informations relatives aux cartes et aux transports à Las Vegas</a>.<br><br>
</div>
<!-- **CONTENT ENDS HERE** -->
