...
<TITLE>2003 International CES: Digital Imaging</TITLE>
...
<!--START did you know?-->
<div id="fader" style="position:absolute; top:465px; left:165px; width:435px; text-align:left;"></div>

<SCRIPT LANGUAGE="JavaScript">
//  Begin call-out fade code

var texts = new Array(
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ Four out of every 10 U.S. households has a camcorder. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ More than one-in-four U.S. households has at least one digital camera. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ Forty-five percent of online households that do not own a digital camera say they will consider buying one in 2003. ~</strong></font>",
"<font size='-1' color='{COLOR}' face='Arial'><strong>~ By 2005, U.S. manufacturer-to-dealer digital camera sales are expected to reach 16.3 million units compared to 7.6 million units projected for 2002. ~</strong></font>");
...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","0.15.3")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="0.15.3">
<span class="pagehead">Digital Imaging</span><br><br>
<span class="head">Picture This</span><br><br>
<img src="images/digital.jpg" align="right">
Digital cameras and camcorders, software editing packages and storage and printing options are advancing in ways that make it easy 
and fun for consumers to enjoy digital imaging. Prices are coming down as sales of digital cameras and camcorders continue to rise, 
and online photo sites are attracting traditional camera users to the digital marketplace.<br><br> 

Software is more powerful, new portable storage disks have increased and the speed of processors and video graphics cards allows 
users to edit their photography more easily on the computer.<br><br>

<b>Here are a few areas for digital imaging you’ll see at the 2003 International CES:</b><br>
<br>
<ul>
	<li><a href="/pavilions/">Pavilions</a>, such as the Imaging Technology Pavilion, showcase the latest technologies, help identify new products and educate attendees on key trends within the industry.
	<li>Major <a href="/exhibitor_dir/product_category.asp">digital imaging companies</a> such as Canon, Fuji, JVC, Olympus, Panasonic and Sony are exhibiting at the 2003 show.
</ul>
<br>
