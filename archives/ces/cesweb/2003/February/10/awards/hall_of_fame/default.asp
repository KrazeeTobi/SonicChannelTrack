...
<TITLE>2003 International CES: Hall of Fame</TITLE>
...
<TR>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/awards/hall_of_fame/default.asp');" ONMOUSEOVER="rollover_td('hall','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('hall','leftsubnav_main_active');">
		<TD ID="hall_cellspacer">&nbsp;</TD>
		<TD ID="hall"><A HREF="/awards/hall_of_fame/default.asp" CLASS="leftsubnav_main_active">CE Hall of Fame</A></TD>
		<TD ID="hall_arrowcell"><IMG SRC="/global_images/context_arrow-new.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.6.4")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="1.6.4">
<span class="pagehead">Awards :: CE Hall of Fame</span><br><br>
<span class="head">Paying Tribute to CE Pioneers</span><br><br>
The Consumer Electronics Association (CEA) created the CE Hall of Fame to pay tribute to those leaders in the consumer technology industry who have helped to advance our lifestyles and workstyles. Hall of Fame inductees are the champions for the development or advancement of a new technology, business practice or concept. They are the engineers, the corporate leaders, the marketers, the journalists and other innovators who have fueled our industry throughout the decades.  
<br><br>
Fifty contributors to the development of the consumer electronics industry were showcased at the 2000 International CES, seven more were added in 2001 and ten others were inducted in 2002. In 2003, we will be inducting another class of Hall of Famers. The deadline for nominations is June 28, 2002.
<br><br>
We base our entrants and nominees’ eligibility on past participation in the design, development, manufacturing and retail or distribution of consumer electronics products, accessories and related products offered through consumer channels. Also eligible are those who have contributed to the industry in other significant ways.  The nominees must have been retired from the position for which they were nominated for more than 36 months from August 1, 2002.
<br><br>
The 2003 inductees will be announced at the CEA Industry Forum and Fall Conference in San Francisco. The new inductees also will be showcased at the 2003 International CES in Las Vegas. For more information, visit <a href="http://www.CE.org/halloffame" target="_blank">www.CE.org/halloffame</a>.
