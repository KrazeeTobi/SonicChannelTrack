...
<TITLE>2003 International CES: The Next Big Thing</TITLE> 
...
<TR>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/awards/next_big_thing/default.asp');" ONMOUSEOVER="rollover_td('next','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('next','leftsubnav_main_active');">
		<TD ID="next_cellspacer">&nbsp;</TD>
		<TD ID="next"><A HREF="/awards/next_big_thing/default.asp" CLASS="leftsubnav_main_active">The Next Big Thing</A></TD>
		<TD ID="next_arrowcell"><IMG SRC="/global_images/context_arrow-new.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.6.5")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="1.6.5">
<span class="pagehead">Awards :: The Next Big Thing</span><br><br>
<span class="head">The Search Is On</span> 
<br><br>
<table border=0>
<tr>
	<td valign="top"><a href="http://www.cnet.com" target="new"><img src="/awards/images/cnetlogo.gif" border="0" align="left"></a></td>
	<td><a target="new" href="http://www.ZDNet.com"><img src="/awards/images/ZDnet.gif" border="0" align="right"></a><a target="new" href="http://www.cnet.com">CNET</a> and <a target="new" href="http://www.ZDNet.com">ZDNet</a> honor the most promising products and technologies in personal technology and consumer electronics.  Produced by AnchorDesk’s David Coursey, the program will document the search for the Next Big Thing in a series of online reports that culminate at CES.  Stop by CNET’s booth in the Grand Lobby of the LVCC and the <a href ="/conferences/search/session_detail.asp?ID_session=SS1&ID_track=SS03">Next Big Thing SuperSession</a> to find out what Coursey’s search has revealed.</td>
</tr>
</table>
<br>
The purpose of AnchorDesk's "Search for the Next Big Thing" is to spotlight emerging technologies and products that will change how people use personal technology and consumer electronics. It also will discover today's leading-edge products that illustrate the broader trends.
<br><br>
The search will begin in five major areas, but expand as other technologies and products are discovered. They are: digital storage, PDA/phone/wireless devices, new TV/entertainment technology, online games and digital imaging.
<br><br>
The selection process will take place through a series of columns in ZDNet's AnchorDesk describing candidate technologies and products, video segments illustrating the products, an online special report, segments on CNET Radio, and a SuperSession at CES.  The program also will include bylined essays by industry figures describing their vision of the Next Big Thing.  Nominees will be selected by ZDNet AnchorDesk Executive Editor David Coursey, former host of the DEMO, Showcase, and Digital Living Room conferences.
<br><br>
Next Big Thing nominees will be announced before CES with the final selections made during the Super Session.
<br><br>
Nominations for technologies and products to be considered for the awards program are being accepted now. Nomination information may be found at <a target="new" href="http://www.anchordesk.com">www.anchordesk.com.</a> There is no fee for participating, and AnchorDesk will honor non-disclosure agreements when appropriate.
