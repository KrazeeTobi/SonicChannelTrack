...
<!-- Rollover script -->	
		...
		/* for graphical rollovers*/
			...
			function introllOver(which,name) 
				{
				var on="/global_images/0.0/random_main4/0.0_" + which + "_r.gif";
				if(document.images) {document.images[which].src=on;}
				else if (document.GetElementById){document.GetElementById(name).src=on;}
				}
			function introllOff(which) 
				{
				var on="/global_images/0.0/random_main4/0.0_" + which + ".gif";
				if(document.images){document.images[which].src=on;}
				else if (document.GetElementById){document.GetElementById(which).src=on;}
				}
...
<!-- logo and banner image row -->	
	<tr>
	    ...
	    <td width="10"></td>
	    <td width="610" colspan="6"><img src="/global_images/0.0/random_main4/0.0.banner.gif" alt="" width="610" height="74" border="0"></td>
	</tr>
<!-- /logo and banner image row -->		
...
<!-- colored row with section color 4 - 5 pixels high --> 
	<tr>
	    ...
	    <td width="140"></td>
	    <td width="10"></td>
	    <td width="610" colspan="6"  background="/global_images/spacer.gif" class="home4"><img src="/global_images/0.0/random_main4/0.0.bc_top.gif" width="610" height="5" hspace="0" vspace="0" border="0"></td>
	 </tr>
<!-- /colored row with section color 4 - 5 pixels high --> 	 
<!-- breadcrumb row -->
	<tr>
	    ...
	    <td width="10"></td>
			...
			<td width="610" colspan="6" background="/global_images/spacer.gif" class="home5"><img src="/global_images/0.0/random_main4/0.0.bc.gif" width="610" height="40" hspace="0" vspace="0" border="0"></td>
...
<br>
		...
		<tr>
		    ...
		    <td width="380" class="home9" valign="top"><a href="/attendees/" onmouseover=introllOver('body'); onmouseout=introllOff('body');><img name='body' src="/global_images/0.0/random_main4/0.0_body.gif" alt="Main body image" width="380" height="224" hspace="0" vspace="0" border="0"></a>
...
<!-- text for main page -->
	...
	<tr>
	    ...
	    <td class="home10"><a href="/attendees/travel/hotel.asp">Get a room</a><br>
		<span class="home10_text">Book hotel rooms early to get your first choice.</span><br><br></td>
	</tr>
	<tr>
	    <td class="home10" valign="top"><b>></b>&nbsp;&nbsp;</td>
	    <td class="home10"><a href="/attendees/exhibit_floor/directory/">Meet the players</a><br>
		<span class="home10_text">View the Exhibitor Directory to see who's part of the show.</span><br><br></td>
	</tr>
	<tr>
	    <td class="home10" valign="top"><b>></b>&nbsp;&nbsp;</td>
	    <td class="home10"><a href="/alumnireg/">Go to the show</a><br>
		<span class="home10_text">CES alumni: Sign up for the 2004 International CES today.</span></td>
	</tr>						
	</table>
