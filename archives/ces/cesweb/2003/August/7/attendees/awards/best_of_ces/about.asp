...
<head>
	...
	<title>2004 International CES:&nbsp;Best of CES Awards Program</title>
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Best of CES<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
			

<!-- text for main page -->
The Best of CES awards seek out the hottest new consumer technology products on the show floor. Only those products that debut at the 2004 International CES or are available for sale after December 1, 2003, can be crowned the Best of CES.
...
The Best of CES distinction is awarded to one product from each of the following 10 categories:
<ul>
    ...
    <li>    <b>Home Automation and Networking:</b> Includes Ethernet and wireless networking cards, hubs and routers, DSL and cable modem gateways and kits to automate home appliances, lights and garage. Also includes electronic and computerized sprinkler systems, home gateways and cable management systems.
...
<img src="/global_images/spacer.gif" alt="" width="1" height="25" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/1.0/line.gif" alt="-----------------------------------------------" width="590" height="1" hspace="0" vspace="0" border="0"><br>
<div class="section_title">How is the Best of CES award different from the CES Innovation awards? </div>
The CES Innovations awards focus on the design and engineering of the most innovative products of 2003, including products already on the market. In addition, Innovations judges review photos and text descriptions of products, but do not do any hands-on evaluation. The Best of CES considers only products that have not yet hit the market or are just starting to ship. In addition to reviewing product information, pictures and videos, the judges test each product. The judging for Innovations is wrapped up by early November. The Best of CES judging happens at CES in January.
<br><br>
<span class="subhead">Information on how to submit your new product for the Best of CES program will be posted this Fall.</span>
<!-- /text for main page -->
