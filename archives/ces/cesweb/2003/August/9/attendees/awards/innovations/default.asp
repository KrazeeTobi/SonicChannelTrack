...
<head>
	...
	<title>2004 International CES:&nbsp;CES Innovations Design and Engineering Awards</title>
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">International CES Innovations Design and Engineering Awards<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
			

<div id="1.4.1">	
<!-- text for main page -->
<img src="images/innovations_2004.gif" width="70" height="115" align="left" onmousedown='Image_OnMouseDown()' alt="Innovations Design and Engineering Showcase Honors">
<span class="intro_copy">Cut to the chase&mdash;and see the innovation to top all innovation&mdash;at the annual competition that culminates at the International CES.</span>
<br><br>The Innovations Design and Engineering Awards honor superior design and engineering among the year's most technologically advanced products in a wide range of consumer electronics categories.</span>
<br><br>
<font style="color:D75533"><strong>~~ Pick up your Innovations Call for Entries information at the CEA booth at CEDIA ~~</strong><br>
<img src="/global_images/spacer.gif" alt="" width="15" height="1" border="0">September 3-8, 2003; Booth #11</font>
<br><br>

<!-- 2 column table in main content cell -->
<table width="590" cellspacing="0" cellpadding="0" border="0" class="text">
<tr>
    <td width="285" valign="top">
		<span class="subhead"><a href="about.asp">About the Program</a><br></span>
		Honorees will be showcased in the Innovations booth at the 2004 International CES, January 8-11, 2004. Learn the behind-the-scenes skinny on judging criteria.
		<br><br>
		<span class="subhead"><a href="entry_details/details.asp">Entry Details</a><br></span>
		Any consumer electronics business can enter if they meet the qualifications. If your innovative product entered the market less than a year ago or won't hit mass production until June 2004, then you need to read about being an Innovations contender.
	</td>
    
	<td width="20"><img src="/global_images/spacer.gif" alt="" width="20" height="1" border="0"></td>
    
	<td width="285" valign="top">
		<span class="subhead"><a href="submission/temp.asp">2004 Call for Entries</a><br></span>
		We know you have what it takes to win the industry's most acclaimed technology design award. But you can't win if you don't enter.
		<br><br>
		<span class="subhead"><a href="2003/default.asp?boi=1">Innovations 2003 Honorees</a><br></span>
		See who made it into the recent ranks of Innovations Honorees at the 2003 International CES. Thirty judges. Twenty categories. Limitless innovation.
	</td>
</tr>
</table>
<!-- /2 column table in main content cell -->
