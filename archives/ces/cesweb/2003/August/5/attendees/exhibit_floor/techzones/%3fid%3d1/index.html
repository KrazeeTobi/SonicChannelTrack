...
<head>
	...
	<title>2004 International CES:&nbsp;2004 International CES TechZones</title>
...
<table width="590" cellspacing=0 cellpadding=2 border=0>
	<tr>
		...
		<td width="160"><span class="subhead">Location</span></td>
		<td width="160"><span class="subhead">Sponsor</span></td>
	</tr>
	...
	<tr class="attendees11">
		<td><a href="?id=5#distributedAudio">Distributed Audio</a></td>
...
<img src="/global_images/1.0/line.gif" alt="-----------------------------------------------" width="590" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<span class="subhead">Distributed Audio</span><br>
<span class="text_colored">LVCC, South Hall, 1-2</span>
<br><br>
Homebuilders and installers who need to wrap their hands around the value and benefits of multi-room audio systems in the home need to open the doors to the DISTRIBUTED AUDIO TECHZONE at the International CES. See the most innovative hard-wired, professionally installed systems for new construction or multi-room renovations, including audio, structured wiring and home networking products. Build it out and crank it up.
<br><br>
<b>What to expect</b><br>
Manufacturers or suppliers of products such as:<br>
<ul>
	...
	<li>distributed amplifiers and in-ceiling, in-wall and outdoor speakers
	<li>infrared distribution systems
...
<br>The International CES dedicates Saturday, January 10, 2004 to <b>ENVIRONMENTAL AWARENESS DAY</b>.  Look for special conference sessions that address energy issues and the future of recycling electronics products.  Help us advance the CE industry&mdash;and the future of recycling electronics products.
