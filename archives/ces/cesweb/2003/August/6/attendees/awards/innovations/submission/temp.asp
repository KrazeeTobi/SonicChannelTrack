...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Innovations 2004 Design and Engineering Awards Call for Entries<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
