...
What started out as a way to connect home PCs and share an Internet connection has grown to encompass a wide range of network-enabled products including digital audio servers, video servers, PBX-style telephony systems and residential gateways. These enhancements present both opportunities and challenges to the consumer electronics industry. 
<br><br>
On one hand, the new features add value and functionality to a home network. At the same time, the network becomes increasingly complicated for consumers to manage. The Internet, many CE manufacturers believe, offers the ideal platform through which consumers can interact comfortably and confidently with a diverse and dynamic home network. 
<br><br>
These home networking trends and more can be found in <em>Digital America 2003, The U.S. Consumer Electronics Industry</em>. <a href="http://www.ce.org/publications/books_references/digital_america/default.asp" target="new">Read the latest trends, growth and opportunities</a> in all CE markets.
<br>
...
<ul>
	...
	<!--<li><a href="/attendees/exhibit_floor/techzones/default.asp#hitechFitness">Hi-Tech Fitness</a>-->
...
<br>
<span class="subhead">Home Networking Trends</span><br>
<table>
<tr>
