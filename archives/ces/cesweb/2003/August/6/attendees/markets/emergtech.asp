...
Nearly all devices that have found their way into mainstream living were at one time considered emerging technology, even those that are now taking a backseat to new products. The VCR, which now competes feverishly with the DVD player for space in the average entertainment center, was once the most major announcement at the International CES, grabbing the attention of media and analysts the world over.
<br><br>
...
<br><br>
These trends and more can be found in <em>Digital America 2003, The U.S. Consumer Electronics Industry</em>. <a href="http://www.ce.org/publications/books_references/digital_america/default.asp" target="new">Read the latest trends, growth and opportunities</a> in all CE markets.
<br><br>
Here's where you'll see a host of emerging technologies firsthand:
<br>
<ul>
	<li>The Emerging Technologies Launchpad at CES showcases the latest consumer technology applications still under development and promoted by top innovators.
	<li>The <a href="/attendees/awards/best_of_ces">Best of CES awards</a> recognize the top technology advancements in the industry.
	<li>The <a href="/attendees/awards/innovations">Innovations awards</a> program recognizes outstanding achievement in product and engineering design.
</ul>
