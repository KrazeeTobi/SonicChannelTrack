...
<head>
	...
	<title>2004 International CES:&nbsp;E-mail List Removal</title>
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="home7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">E-mail List Removal<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
...
<!-- text for main page -->
	...
	<form name="sF" action="/listremove/default.asp" method="post" onSubmit="return validateemail(this)">
	<span class="subhead">To unsubscribe from the list, please enter your e-mail address:</span>
	<br><br>
	<input type="text" name="removeemail" size="45">&nbsp;<input type="submit" value="submit">
