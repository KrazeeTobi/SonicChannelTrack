...
So far, 2003 has shaped up as another game-intensive year, and 2004 looks set to enhance that gaming action. Here are just a few names that might ring a bell: Xbox, Game Cube, Sims, Burnout 2, Final Fantasy, Chaos Legion...  These are no longer tricky terms from teenage patois that most adults can't understand. They are leisure's wave of the future. 
<br><br>
Convergence is in the works. Phones aren't just for calling people anymore, televisions are becoming more than just a big-screen reflection of what's happening in the game console, and personal digital assistants have become gaming landscapes all their own. High-speed Internet connections via cable modems and digital subscriber lines have wiped out the old spectre of lag time that made Internet gaming a nearly impossible chore on old dial-up phone lines. 
<br><br>
These gaming trends and more can be found in <em>Digital America 2003, The U.S. Consumer Electronics Industry</em>. <a href="http://www.ce.org/publications/books_references/digital_america/default.asp" target="new">Read the latest trends, growth and opportunities</a> in all CE markets.
<br>
...
<ul>
	...
	<!--<li><a href="/attendees/exhibit_floor/techzones/default.asp#pcGaming">PC Gaming</a>-->
...
<br>
<span class="subhead">Gaming Trends</span><br>
<table>
<tr>
