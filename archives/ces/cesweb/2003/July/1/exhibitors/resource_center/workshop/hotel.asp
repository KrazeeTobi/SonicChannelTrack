...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="exhibitor7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Hotel Accommodations<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
			

<div id="2.3.8.3">	
<!-- text for main page -->
<span class="subhead">Right next door<br></span>
Make your hotel reservations at the Las Vegas Hilton, adjacent to the Las Vegas Convention Center.<br>
<br>
<b>Reservations must be made by Friday, September 12, 2003.</b> A deposit equal to one night's room and tax is required to guarantee each reservation.  This deposit is fully refundable if cancelled more than 72-hours prior to arrival.  Call today!<br>
<br>
