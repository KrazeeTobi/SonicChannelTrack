...
<tr>
	...
	<td colspan=3>
	  ...
	  <tr>
	  <td>
	  <input type="radio" name="category" value="Audio and Video" class="formData"> Audio and Video<br></span>
      <input type="radio" name="category" value="Computer SoHo IT" class="formData"> Computer/SoHo/IT<br></span>
	  <input type="radio" name="category" value="Digital Radio" class="formData"> Digital Radio<br></span>
      <input type="radio" name="category" value="Emerging Technologies" class="formData"> Emerging Technologies<br></span>
	  <input type="radio" name="category" value="Home Information" class="formData"> Home Information<br></span>
      <input type="radio" name="category" value="Home Theatre Home Systems" class="formData"> Home Theater/Home Systems<br></span>
	  <input type="radio" name="category" value="Internet Ecommerce" class="formData"> Internet/E-Commerce<br></span>
