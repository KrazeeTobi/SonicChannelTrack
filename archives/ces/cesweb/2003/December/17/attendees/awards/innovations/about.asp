...
<head>
	...
	<title>2004 International CES:&nbsp;About the CES Innovations Awards Showcase</title>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">About the International CES Innovations Awards Showcase<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<div id="1.4.1.1">	
<!-- text for main page -->
<img src="images/innovations_2004.gif" align="right" vspace="0" width="70" height="117" hspace="10" onmousedown='Image_OnMouseDown()' alt="Innovations Design and Engineering Showcase Honors">
Since 1989, the prestigious Innovations Design and Engineering Awards Showcase has given consumer technology manufacturers and developers an opportunity to have their newest products <a href="2003/judges.asp">judged by a preeminent panel</a> of independent industry designers, engineers and journalists.


<br><img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/1.0/line.gif" alt="-----------------------------------------------" width="496" height="1" hspace="0" vspace="0" border="0"><br>
<div class="section_title">Innovations judging</div>
For the ninth year, the <a href="http://www.idsa.org" target="new">Industrial Designers Society of America</a> (IDSA) will endorse and act as advisors to the Innovations Design & Engineering Showcase.
<br><br>
...
<img src="images/best_of_2004.gif" width="70" height="95" border="0" align="left" onmousedown='Image_OnMouseDown()' alt="Best of Innovations 2004 Logo">
Now in its seventh year, the Best of Innovations Awards</a> are given to the most highly honored products in all facets of the consumer technology industry.<br><br>
See the special display in the Grand Lobby of the Las Vegas Convention Center during the 2004 International CES. 
