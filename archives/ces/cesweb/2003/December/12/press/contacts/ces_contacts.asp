...
<!-- logo and banner image row -->	
	<tr>
	    ...
	    <td width="10"></td>
	    <td width="610" colspan="6"><img src="/global_images/3.0/random1/3.0.banner.gif" alt="" width="610" height="74" border="0"></td>
	</tr>
<!-- /logo and banner image row -->		
