...
<head>
	...
	<title>2004 International CES:&nbsp;Airlines & Rental Cars</title>
...
<!-- breadcrumb row -->
	<tr>
	    <td width="10"></td>
			...
			<td width="140"><a href="/registration_temp.asp" onmouseover=snrollOver('.register'); onmouseout=snrollOff('.register');><img src="/global_images/1.0/1.0.register.gif" alt="Register" name=".register" id=".register" width="140" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Airlines & Rental Cars<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<div id="1.5.2">

<span class="section_title">Save big on travel</span><br><br>
Impress your boss and colleagues with big travel savings for the 2004 International CES. <a href="http://www.tvlon.com/2004CES/" target="new">Book your Las Vegas airline reservations today</a> to take advantage of deep discounts and specially negotiated airfares for the 2004 International CES. 
<br><br>
Be prepared for takeoff. The <a href="http://129.33.119.130/public/theme_home1.jsp">Transportation Security Administration</a> offers information on air travel security measures.
<br>
...
<div class="subhead">Save with the official CES car rental company</div><br>
<table width="400" cellspacing="0" cellpadding="0" border="0" class="text">
<tr>
    <td width="120" valign="top"><span class="black">Company Name<br></span>
	</td>
    
	<td width="20"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
   
	<td width="120" valign="top"><span class="black">Reference Number<br></span>
	</td>
    
	<td width="20"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
    
	<td width="120" valign="top"><span class="black">Phone Number<br></span>
	</td>				
</tr>
<tr>
    <td width="120" valign="top" class="text"><a href="http://www.budgetvegas.com/?pc=CES2004" target="new">Budget Rent a Car</a></td>
    
	<td width="20"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
   
	<td width="120" valign="top" class="text">CES2004</td>
    
	<td width="20"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
    
	<td width="120" valign="top" class="text">(800) 922-2899
	</td>				
</tr>
</table>
<br><br><br><br><br>
<!--
<span class="subhead">Enjoy discount savings<br></span>
Enjoy special fares with our official airlines, and receive discount car rental rates.
<br>

<img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/1.0/line.gif" alt="-----------------------------------------------" width="590" height="1" hspace="0" vspace="0" border="0"><br>
<div class="section_title">Participating airlines</div>

<table width="590" cellspacing="0" cellpadding="0" border="0" class="text">
<tr>
    <td width="186" valign="top"><span class="black">Airline Name<br></span>
	</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
   
	<td width="186" valign="top"><span class="black">Reference Number<br></span>
	</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
    
	<td width="186" valign="top"><span class="black">Reservations Hotline<br></span>
	</td>				
</tr>
<tr class="attendees11">
    <td width="186" valign="top">American Airlines</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
   
	<td width="186" valign="top" class="text">A1714AE</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
    
	<td width="186" valign="top" class="text">(800) 433-1790
	</td>				
</tr>
<tr>
    <td width="186" valign="top" class="text">America West</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
   
	<td width="186" valign="top" class="text">7093</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
    
	<td width="186" valign="top" class="text">(800) 548-7575
	</td>				
</tr>
<tr class="attendees11">
    <td width="186" valign="top" class="text">Continental</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
   
	<td width="186" valign="top" class="text">UMTLNS</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
    
	<td width="186" valign="top" class="text">(800) 468-7022
	</td>				
</tr>
<tr>
    <td width="186" valign="top" class="text">Delta</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
   
	<td width="186" valign="top" class="text">197573A</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
    
	<td width="186" valign="top" class="text">(800) 241-6760
	</td>				
</tr>
<tr class="attendees11">
    <td width="186" valign="top" class="text">Southwest</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
   
	<td width="186" valign="top" class="text">UO239</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
    
	<td width="186" valign="top" class="text">(800) 433-5368
	</td>				
</tr>
<tr>
    <td width="186" valign="top" class="text">United</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
   
	<td width="186" valign="top" class="text">524DC</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
    
	<td width="186" valign="top" class="text">(800) 521-4041
	</td>				
</tr>
</table>
	<br>
	<span class="subhead">Be prepared for takeoff<br></span> 
...
<img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/1.0/line.gif" alt="-----------------------------------------------" width="590" height="1" hspace="0" vspace="0" border="0"><br>
<div class="section_title">Participating car rental companies</div>

<table width="590" cellspacing="0" cellpadding="0" border="0" class="text">
<tr>
    <td width="186" valign="top"><span class="black">Company Name<br></span>
	</td>
	...
	<td width="186" valign="top"><span class="black">Phone Number<br></span>
	</td>				
</tr>
<tr>
    <td width="186" valign="top" class="text"><a href="http://www.budgetvegas.com/?pc=CES2004" target="new">Budget Rent a Car</a></td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
   
	<td width="186" valign="top" class="text">CES2004</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
    
	<td width="186" valign="top" class="text">(800) 634-6186
	</td>				
</tr>
</table>
<br><br>
<span class="subhead">Call early for the best rates<br></span> 
If you are required to book directly with your travel agent or airline, ask for the Meetings and Convention Desk and give the listed reference number. 
-->
