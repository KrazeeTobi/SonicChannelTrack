...
<head>
	...
	<title>2004 International CES:&nbsp;Technology is a Girl's Best Friend Program Overview</title>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Technology is a Girl's Best Friend<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<div id="1.2.5.1">	
<!-- text for main page -->
<img src="/attendees/exhibit_floor/displays/techgirl/images/tiagbf.gif" align="right">
<span class="section_title">Move over diamonds...</span><br><br>
The Consumer Electronics Association (CEA) debuted a campaign focusing on the female technology consumer titled Technology Is A Girl's Best Friend at the 2003 International CES. CEA is proud to bring you an expanded Tech Girl presence at the 2004 International CES that will clearly demonstrate why technology is overtaking diamonds.  
<br><br>
<table bgcolor="#E5F5FD" width="590" cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
		...
		<td valign="top" class="text">
			<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span>Program Overview<BR>			
		</td>
	    <td>&nbsp;</td>
		<td valign="top" class="text">
			<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span><a href="/attendees/exhibit_floor/displays/techgirl/techgirl_2004winners.asp">Showcase Honorees</a><br>&nbsp;&nbsp;&nbsp;&nbsp;<strong>(Just announced!)</strong><BR>			
		</td>
	    <td>&nbsp;</td>
		<td valign="top" class="text">
...
<br>
Contrary to what many may believe, women are buying consumer electronics products in huge numbers.  According to research conducted by CEA, women are involved in nearly 75 percent of all CE purchase decisions.  What's more, 71 percent of women surveyed by CEA said their most recent CE purchase was made for themselves, not as a gift.
<br><br>
In an effort to recognize the estimated $55 billion female consumers will spend this year alone on CE products, the International CES will again highlight the needs of this important consumer base with the "Technology is a Girl's Best Friend" (Tech Girl) Program, featuring a product showcase, conference SuperSession and more. 
<br><br>
<span class="subhead">CES Store</span><br>
The Tech Girl campaign will have a presence in the CES Store this year. Gone at last are the days of black vinyl computer bags and plastic PDA cases.  Look for fashionable laptop bags, consumer electronics accessories and more in this hot section of the LVCC Grand Lobby.  
<!-- /text for main page -->
</div>
