  ...
  <table width="90%" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      <td valign="top"><br>
        ...
        Innersound<br>
        Innovision<br>
        Internet Home Alliance<br>
        Intrique Technology<br>
        JCM Sales Inc.<br>
        Juster USA<br>
        Kanam Electronics<br>
        Kenon Electronics<br>
        Kicker<br>
        Lite On it<br>
        Mobile 2000 (The TW)<br>
        Nokia<br>
        Norazza Inc.<br>
        OSIM<br>
        Overbreak<br>
        Palm<br>
        Pepper Computer<br>
        Plexter Intl. Limited<br>
        Promic Technology<br>
        Quality Products<br>
        ...
        SEAO Audio<br>
        SED Tubes/PMA<br>
        Shine in Technology (The TW)<br>
        Shinybow Technology (The TW)<br>
  ...
  <table width="90%" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      <td valign="top"><br>
        ...
        Gem Sound<br>
        GoVideo<br>
        Heartland-Electronics<br>
        InfoTrends Research Group<br>
        J. Bonz Corp. dba Grand Destiny Group<br>
        Kamar International, Inc.<br>
        Lenoxx Electronics<br>
        LouisClark Ltd.<br>
        Maxsa Innovations<br>
        Medion USA, Inc.<br>
        Mobile Acoustics<br>
        Nirotek America Corporation<br>
        Nissan Technical Center North America<br>
        Nuvo Technologies<br>
        Omnitel Communications<br>
        Oxford Semiconductor Corp<br>
        Phantom Technologies<br>
        Pictograph Entertainment Inc.<br>
        Pixelworks<br>
        PowerBase USA, Inc.<br>
        Rennaissance Sound LLC<br>
        Shell HomeGenie<br>
        Smartech Com. SVC., Inc.<br>
        SOHO Technology Networks<br>
        Standard Microsystems Corporation<br>
        Subconscious Technologies<br>
        Twist Group, Inc.<br>
        Visionaire Technology Corp.<br>
        Westinghouse Digital Electronics </td>
    </tr>
  </table>
</div>
...
<img src="/global_images/spacer.gif" alt="" width="1" height="10" hspace="0" vspace="0" border="0"><br>
  ...
  <a name="workshop"></a> <span class="subhead">Free Exhibitor Workshop</span><br>
  Join us at the <a href="/exhibitors/resource_center/workshop/" title="exhibitor workshop">exhibitor 
  workshop</a> in Las Vegas, October 15-16, 2003. <a href="/exhibitors/resource_center/workshop/registration.asp" title="Register">Register</a> 
  by September 15, 2003, and you could win free airfare and accommodations for 
  the event.
  <br><br> 
  Show how dedicated you are to making your exhibit the best it can be. The FREE 
  2004 International CES Exhibitor Workshop is a pre-show event tailored to give 
  you details on how to make the most of your 2004 CES experience. You'll also 
  receive discounts from vendors, a peer networking reception, discounted hotel 
  accommodations and an exclusive show floor tour. Check out the <a href="/exhibitors/resource_center/workshop/agenda.asp" title="agenda">agenda.</a><br>
  <img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
  <img src="/global_images/2.0/line.gif" alt="-----------------------------------------------" width="380" height="1" hspace="0" vspace="0" border="0"><br>
  <img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
  <a name="attendee"></a> <span class="subhead">Attendee Promotion Update</span><br>
  The 2004 International CES attendee brochure is hitting the mail&mdash;500,000 copies 
  in the U.S. and 135,000 copies overseas. We're promoting the 2004 pavilions, 
  called <a href="/exhibitors/space/techzones.asp">TechZones</a>, 
  and driving attendance to our new Silver exhibits, featuring the Innovations 
  Showcase, and Gold exhibits, featuring MECP training and NOPI.
  <br><br>
  Take a <a href="/attendees/exhibit_floor/areas/maps.asp#int" title="virtual tour">virtual 
  tour</a> of the 2004 International CES show floor, and keep an eye out for a 
  copy of the brochure!<br>
  <img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
  <img src="/global_images/2.0/line.gif" alt="-----------------------------------------------" width="380" height="1" hspace="0" vspace="0" border="0"><br>
  <img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
  <a name="findyou"></a> <span class="subhead">Make It Easy For Them To Find You</span><br>
  You're not playing Hide 'n Seek. You want to make it easy for International 
  CES attendees and industry leaders to find you&mdash;year 'round. <br>
  <br>
  So, update your International CES <a href="/directory_updates" title="directory listing">directory 
  listing</a> now. <br>
  <br>
  Your updated listing will make your company and product information accessible 
  to more than 110,000 consumer technology professionals. It's like the <i>Yellow 
  Pages</i> for the entire industry, listing every International CES exhibitor 
  by name and market in an online and printed directory. <br>
  <br>
  There's even room for <a href="mailto:kfabiano@napco.com">your logo</a> too&mdash;another 
  perk of participating in the 2004 International CES. <br>
  <br>
  <i>Information entered prior to November 3, 2003, will be used in the print 
  directory and International CES pre-show planner, reaching more than 135,000 
  industry professionals. </i> <br>
  <br>
  <a href="/directory_updates" title="Update now">Update your listing online</a>, by fax or mail. Two minutes of work reaps year-long 
  benefits.
  <br><br>
  For assistance, contact us at (703) 907-4337 or <a href="mailto:CESdirectory@ce.org">CESdirectory@ce.org</a>. 
  <br>
  <img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
  <img src="/global_images/2.0/line.gif" alt="-----------------------------------------------" width="380" height="1" hspace="0" vspace="0" border="0"><br>
  <img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
  <a name="savebig"></a> <span class="subhead">Save Big on Travel</span><br>
  Impress your boss and colleagues with big travel savings for the 2004 International 
  CES. <a href="/attendees/travel/" title="CES/Travel-on">Book your Las Vegas airline reservations</a> through CES/Travel-on 
  for deep discounts and specially negotiated airfares for the 2004 International 
  CES. <br>
  <img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
  <img src="/global_images/2.0/line.gif" alt="-----------------------------------------------" width="380" height="1" hspace="0" vspace="0" border="0"><br>
  <img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
  <a name="fuel"></a> <span class="subhead">Race to FUEL the Consumer Electronics 
  Industry</span><br>
  Sponsor the 2nd Annual International CES 5K Run/Walk, to benefit NSTEP technology 
  education programs and the CEA community. <br>
  <br>
  Sponsor company names and logos will cover event signs, banners, registration 
  materials, t-shirts and much more. Contact Andrea Cooke at (703) 907-7412 or 
  <a href="mailto:andrea.cooke@nationalstep.org">andrea.cooke@nationalstep.org</a>. 
  <br>
  <br>
  Visit <a href="/attendees/special_events/" title="www.CESweb.org">the Special Events section</a> 
  in early October for more race information. <br>
  <img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
  <img src="/global_images/2.0/line.gif" alt="-----------------------------------------------" width="380" height="1" hspace="0" vspace="0" border="0"><br>
  <img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
  <a name="drive"></a> <span class="subhead">Drive Your Message Home to 2004 International 
  CES Attendees</span><br>
  Make an impression on International CES attendees, with eye-catching advertisements 
  on official CES shuttle buses that transport attendees to and from official 
  show locations and hotels. Shuttle bus advertising will increase your exposure 
  throughout the entire city. Blanket the interior of the shuttles with <strong>decorative 
  headrests</strong>. Have attendees <strong>listen to your audio message</strong>. 
  Showcase your promotional message on the <strong>side panels. Or, wrap an entire 
  bus</strong> with your promotional message. Ask about these on-site shuttle 
  bus sponsorships-your <strong>moving billboards</strong> won't be missed: <br>
  <br>
</p>
<ul>
  <li>LVCC Shuttle Loop Sponsorship</li>
  <li>Registration Express Sponsorship</li>
  <li>Alexis Park Shuttle Sponsorship</li>
</ul>
<br>
Call Kathy Norton at (800) 616-2622, or e-mail <a href="mailto:kathyn@cmac.net">kathyn@cmac.net</a> 
for more information. <br>
<img src="/global_images/spacer.gif" alt="" width="1" height="140" hspace="0" vspace="0" border="0"><br>
<!-- bottom text navigation -->
<div align="center">[ <a href="sep2k3_pg1.asp">page 1</a> ] &nbsp; [ <strong>page 
  2</strong> ]</div>
...
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableborder">
  ...
  <tr> 
    <td> <ul>
        <li>Don't crowd your booth with staff. </li>
        <li>Leave room for attendees to visit comfortably.</li>
        <li>Take knowledgeable staff who know your product/service.</li>
        <li>Hold a pre CES staff meeting:</li>
        <ul>
          <li>Build staff excitement.</li>
          <li>Discuss work schedule and on-site dress code.</li>
        </ul>
        <li>Meet on-site daily.</li>
        <li>Review exhibit goals.</li>
      </ul></td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5" class="tableborder">
  ...
  <tr> 
    <td><a href="/attendees/travel/hotel.asp">Choose from single or group block 
      reservations</a> from a variety of official CES hotels to get the best rates 
      in Las Vegas. </td>
  </tr>
</table>
<img src="/global_images/spacer.gif" alt="" width="1" height="15" hspace="0" vspace="0" border="0"><br>
...
<table width="95%" border="0" cellspacing="0" cellpadding="5" class="tableborder">
  ...
  <tr> 
    <td><p> The GES National ServicenterSM has relocated into a 10,597 square 
        foot, state-of-the-art facility in Las Vegas. This relocation allows us 
        to provide an even greater level of service to nationwide exhibitors, 
        through our convenient business hours and toll free number. <br>
        <br>
        With one phone call, answer all your questions about booth space and set 
        up needs, as well make transportation arrangements for show materials 
        and goods. Need help placing orders for you booth? Can't decide on furniture? 
        Let GES make it easy for you. <br>
        <br>
        Call us at (800) 475-2098 between 6 a.m. and 5 p.m. PST. International 
        callers, please dial +(702) 263-1592. <br>
        <br>
        We're here to help make the 2004 International CES your best show yet! 
        <br>
        <br>
