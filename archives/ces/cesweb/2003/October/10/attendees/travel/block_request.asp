...
<tr><!--row1-->
	...
	<td width="170" valign="top" class="text"><input type="radio" name="hotel" value="Alexis Park">Alexis Park</td>   
...
<tr><!--row2-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
    <td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="AmeriSuites">AmeriSuites 
	</td>
	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="Harrah's">Harrah's
	</td>
	<td width="200" valign="top" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Paris**
	</td>
	<!--<td width="200" valign="top" class="text">
		<input type="radio" name="hotel" value="NewYork NewYork">New York New York
	</td>-->	
...
<tr><!--row3-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
    <td width="170" valign="top" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bally's**
	</td>	
	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="HGVC at the LV Hilton">HGVC at the LV Hilton
	</td>
	
	<td width="200" valign="top" class="text">
		<input type="radio" name="hotel" value="Rio All-Suite Hotel & Casino">Rio All-Suite Hotel & Casino
	</td>
</tr>
<tr><!--row4-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
	<td width="170" valign="center" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bellagio*</td>	
	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="HGVC on the LV Strip">HGVC on the LV Strip
	</td>	
	<td width="200" valign="top" class="text">
		<input type="radio" name="hotel" value="Riviera">Riviera
	</td>
</tr>

<tr><!--row5-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
   	<td width="170" valign="center" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Caesars Palace*</td>		
	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="ImperialPalace">Imperial Palace</input>
	</td>	
	<td width="200" valign="top" class="text">
		<input type="radio" name="hotel" value="Sahara Hotel">Sahara Hotel
	</td>
<tr><!--row6-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
   	<td width="170" valign="top" class="text">
	...
	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="Las Vegas Hilton">Las Vegas Hilton
	</td>	
	<td width="200" valign="top" class="text">
...
<tr><!--row7-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
 	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="EmbassySuites">Embassy Suites LV
	</td>
   	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="MGM Grand">MGM Grand
	</td>
	<td width="200" valign="top" class="text">
		<input type="radio" name="hotel" value="Treasure Island">Treasure Island
    </td>
</tr>
<tr><!--row8-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
	...
	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="Mirage">Mirage
	</td>
	<td width="200" valign="top" class="text">
		<input type="radio" name="hotel" value="Westin Casuarina">Westin Casuarina
	</td>	
</tr>
<tr><!--row9-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
	...
	<td width="170" valign="top" class="text"></td>
	
</table>
<img src="/global_images/spacer.gif" height="10"><br>*only accepting individual room reservations
<img src="/global_images/spacer.gif" height="10"><br>**Sold Out
