...
<head>
	...
	<title>2004 International CES:&nbsp;Call for Speakers</title>
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">2004 International CES Call for Speakers<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
			

<!-- text for main page -->
<div id="1.1.7">
<span class="subhead">AUGUST 15th SPEAKER SUBMISSION DEADLINE HAS PASSED</span><br><br>

Thank you for your interest in our speaking opportunities for the 2004 International CES.  Unfortunately, the submission deadline has passed, and we are no longer accepting entries.
<br><br>
However, if you would like us to keep you in mind for future CEA and CES events, continue to the <a href="http://www.ce.org/events/speaking_opps.asp" target="new">submission form</a>.
...
<tr>
	...
	Copy Protection<br>
	Datacasting<br>
	Digital Imaging/Desktop Video<br>
	Digital Radio<br>
	Digital Recording Media<br>
	DVD Audio and Video<br>
	Electronic Gaming<br>
	E-Marketing<br>
	Flash Memory/Compact Storage<br>
	Handheld Computing<br>	
	</span></td>
	<td valign="top" width="28%"><span class="text">
	HDTV<br>
	...
	Wireless Communications/Handsets<br>
...
<br>
<b>All speaker candidates will be contacted by September 26, 2003.</b>
-->
<!-- /text for main page -->
