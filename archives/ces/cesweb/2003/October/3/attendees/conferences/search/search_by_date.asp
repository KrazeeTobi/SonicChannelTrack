...
<!-- text for main page -->
<div id="1.1.6.4">
<form action=session_by_date_list.asp method=post><table cellpadding=3 cellspacing=1 border=0><tr><td><span class='subhead'>Choose a date from the drop-down list.</span></td></tr><tr height=7><td></td></tr><tr><td colspan=1><select class=formdata name=sessiondate><option value=0>Choose a Date&nbsp;&nbsp;<option value="1/6/2004"><option value="1/7/2004">Wednesday, January 7, Day Before CES<option value="1/8/2004">Thursday, January 8, CES Day 1<option value="1/9/2004">Friday, January 9, CES Day 2<option value="1/10/2004">Saturday, January 10, CES Day 3<option value="1/11/2004">Sunday, January 11, CES Day 4</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
