...
<head>
	...
	<title>2004 International CES:&nbsp;Search the Conference Program by Track</title>
...
<!-- CONFERENCES -->
	...
	<a href="/attendees/conferences/search/search_by_name.asp">Search for Sessions</a><br>
			...
			<span class="nav_fourth_arrow"><b>></b> &nbsp;</span>by Track/Partner Program</a><br>
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Search by Track/Partner Program<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
			

<!-- text for main page -->
<div id="1.1.6.2">
<form action=session_by_track_list.asp method=post><table cellpadding=3 cellspacing=1 border=0><tr><td><span class='subhead'>Choose a track or partner program from the drop-down list.</span></td></tr><tr height=7><td></td></tr><tr><td colspan=2><select class=formdata name=ID_track><option value=0>Choose a Track&nbsp;&nbsp;<option value=BN04>Business Networking<option value=CT04>Car Technologies<option value=CEDIA04>CEDIA Program<option value=CON04>CONNECTIONS™<option value=DGS03>Digital Games Summit<option value=DH04>Digital Hollywood<option value=L04>Embedded Linux Consortium<option value=ET04>Emerging Technologies<option value=ENT04>Entertainment At Home and Away<option value=G04>Gaming<option value=GG04>GartnerG2 -- The Digital Consumer Landscape: Monetizing Pipes, Platforms an...<option value=HN04>Home Networking<option value=I2I04>I2I™ -Inventures Industry Insights™ <option value=IIS04>Industry Insiders Series<option value=IP04>IPv6 Products and Services: Enabling Consumer Electronics with Next Gen Int...<option value=MECP04>MECP/Select Products Installer Training<option value=N04>Networked Interoperability <option value=SBCA04>Satellite Broadcasting and Communications Association – Satellite Power!<option value=SV04>Storage Visions<sup>SM</sup>/Home Gateway 2004<option value=SS04>SuperSessions<option value=PA04>The Digital Home (and Beyond) Value Chain: Broadband Services and Home Netw...<option value=W04>Wireless<option value=WT04>Wireless Retail</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
