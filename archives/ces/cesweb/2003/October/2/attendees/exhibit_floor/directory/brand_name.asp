...
<head>
	...
	<title>2004 International CES:&nbsp;Exhibitor Directory - Search for Brand Name</title>
...
<!-- EXHIBIT FLOOR -->
	...
	<a href="/attendees/exhibit_floor/directory/">Exhibitor Directory</a><br>
			...
			<span class="nav_fourth_arrow"><b>></b> &nbsp;</span>by Brand Name</a><br>
			</span>
...
<div id="1.2.1.7">	
<!-- text for main page -->
Browse our online exhibitor directory by selecting the letter of the brand you wish to locate, or use the quick find tool to search for brands by name.
<br>
...
<div class="section_title">Browse the Brand Names</div>
Choose a letter below to view a list of brands by letter. Select the # for a list of brands with a number leading the name. 
<br>
...
<tr>
	...
	<img src="/global_images/spacer.gif" alt="" width="1" height="35" hspace="0" vspace="0" border="0"><br>
       <img src="/global_images/1.0/line.gif" alt="-----------------------------------------------" width="590" height="1" hspace="0" vspace="0" border="0"><br>
	<div class="section_title">Brand Name Quick Find</div>
	</td>
</tr>
...
<tr>
<td width="20%" class="rowlabel">Brand Name&nbsp;&nbsp;</td>
<td width="48%"><input type="text" name="brandName" size="40" maxlength="50" class="formData"><br><span class="text_colored">Enter all or part of the brand name.</span></td>
...
<tr>
	...
	<br><span class="text_colored">Select a show location to view brands by venue.</span>
	</td>
</tr>
