...
<br><img src="/global_include/images/spacer.gif" height="10" width="1" border="0"><br>
<span class="section_title">Manufacturing Exhibitor Name</span><br><br>
<table width="100%" cellpadding="0" cellspacing="0" border="0">
<form name="searchByExhibitorName" action="techgirl_exhibitor_name_search_results.asp?" method="post">
<tr cols="4">
	<td colspan="4" width="100%">
	Type in all or part of the manufacturing company's name to locate the exhibitor.
	</td>
</tr>
...
<tr cols="4">
	...
	<td colspan="3" width="75%">(i.e. Find exhibitors whose names begin with "Micro")</td>
</tr>
