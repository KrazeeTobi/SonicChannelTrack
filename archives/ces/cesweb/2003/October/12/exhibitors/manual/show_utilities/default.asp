...
<tr>
		...
		<td valign="top" class="text">
			...
			<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span><a href="?id=41#41" class="inpagenav">Telephone, Internet / Network Service (LV Hilton)</a><br>				
		</td>
	    <td>&nbsp;</td>
		<td valign="top" class="text">
...
<tr><td>
	<font style="color:#CC0000"><strong>NEW THIS YEAR:</strong> Anyone showing up at CES with devices/computers that do not have the latest virus definitions, operating system patches, etc and cause network problems will be disconnected from the network until their devices/computers are free of problems.  SmartCity will have automatic port monitoring that will close down ports when it detects a problem.  SmartCity should also have CD's with the latest fixes that they can give to customers to fix their devices.</font><br><br>
	<strong>Smart City</strong> is the exclusive provider of Telephone, Internet and Data Network service in the Las Vegas Convention Center.  Contact Smart City at (800) 446-6911, (702) 943-6000 or e-mail <a href="mailto:snewcomb@smartcitynetworks.com">snewcomb@smartcitynetworks.com</a></td></tr>
