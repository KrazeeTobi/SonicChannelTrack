...
<br>
		...
		<tr>
		    ...
		    <td width="380" class="home9" valign="top"><a href="/attendees/" onmouseover=introllOver('body'); onmouseout=introllOff('body');><img name='body' src="/global_images/0.0/random_main2/0.0_body.gif" alt="Main body image" width="380" height="224" hspace="0" vspace="0" border="0"></a>
...
<!-- text for main page -->
	...
	<tr>
		...
		<span class="home10_text">Browse more than 2,000 companies in the exhibitor directory.</span><br><br></td>
	</tr>
	<tr>
	    <td class="home10" valign="top"><b>></b>&nbsp;&nbsp;</td>
