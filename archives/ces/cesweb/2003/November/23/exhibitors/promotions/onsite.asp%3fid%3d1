...
<head>
	...
	<title>2004 International CES:&nbsp;byb+ On-site Advertising Opportunities</title>
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="exhibitor7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">On-site Advertising Opportunities<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
...
<table width="590" cellspacing=0 cellpadding=1 border=0>
	...
	<tr>
		...
		<td width="290"><span class="section_title">$2,000+</span></td>
	</tr>
	<tr>
		<td colspan=3>
		<br>The 2004 International CES is a powerful, competitive forum to promote your products and services. An exhibit floor packed with more than 110,000 attendees and 2,000 exhibitors means you have to compete for buyers' time and attention. Reach attendees <i>first</i>, with an impressive banner or kiosk outside the exhibit hall. Leverage high traffic but less competition to capture their interest.
		<br><br>
		...
		Phone: (401) 849-9300<br>E-mail: <A HREF="mailto:liztardif1@aol.com">liztardif1@aol.com</A><br>
		<br>
		<table cellpadding=0 cellspacing=4 border=0>
		<tr>
			<td valign=top>
			<a href="images/onsite_banner_shuttle_large.jpg" target="new"><img border=0 src="images/onsite_banner_shuttle_small.jpg"><br>
			...
			<tr>
			<td valign=top>
			<a href="images/onsite_banner_ext2_large.jpg" target="new"><img border=0 src="images/onsite_banner_ext2_small.jpg"><br>
			<font size="-2">Click for larger image.</a><br>
			...
			<td width="4"></td>
			<td valign=top>
			<a href="images/onsite_banner_ext_large.jpg" target="new"><img border=0 src="images/onsite_banner_ext_small.jpg"><br>
			<font size="-2">Click for larger image.</a><br>
	...
	<tr>
		...
		<td width="290"><span class="section_title">$3,500+</span></td>
	</tr>
	<tr>
		<td colspan=3><br>
...
<img src="/global_images/spacer.gif" width="1" height="5" border="0"><br><a href="#">[back to top]</a>		
	...
	<tr>
		...
		<td width="290"><span class="section_title">$5,350+</span></td>
	</tr>
	<tr>
		<td colspan=3><br>
