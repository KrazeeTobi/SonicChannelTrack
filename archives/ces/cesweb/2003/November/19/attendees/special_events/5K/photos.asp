...
<head>
	...
	<title>2004 International CES:&nbsp;2003 CES 5K Run/Walk Photos</title>
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">2003 International CES 5K Run/Walk Photos<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
...
<table bgcolor="#E5F5FD" width="590" cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
		...
		<td valign="top" class="text">
			...
			<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span>2003 Race Photos<BR>
		</td>
	    <td>&nbsp;</td>
		<td valign="top" class="text">
...
<tr>
	<td><img src="images/stretching.jpg" style="border: 1px #cccccc solid"><br><span class="text_colored">Stretching out, an important part of any race, is also recommended before walking the International CES show floor.</span></td>
	<td><img src="/global_images/spacer.gif" width="60" height="1"></td>
	<td><img src="images/start.jpg" style="border: 1px #cccccc solid"><br><span class="text_colored">The 2003 International CES 5K Run/Walk starting line brought hundreds of folks together for a little lively competition.</span></td>
</tr>
<tr><td><img src="/global_images/spacer.gif" width=1" height="20"></td></tr>
<tr>
	<td><img src="images/kathy_gary.jpg" style="border: 1px #cccccc solid"><br><span class="text_colored">NSTEP President Kathy Warye and CEA President Gary Shapiro kick off the first annual International CES 5K Run/Walk to benefit technology in education.</span></td>
	<td><img src="/global_images/spacer.gif" width="40" height="1"></td>
	<td valign="top"><img src="images/raffle_winner.jpg" style="border: 1px #cccccc solid"><br><span class="text_colored">Many runners and walkers received great consumer tech prizes like Circuit City gift certificates.</span></td>
</tr>
<tr><td><img src="/global_images/spacer.gif" width=1" height="20"></td></tr>
<tr>
	<td><img src="images/winner_male.jpg" style="border: 1px #cccccc solid"><br><span class="text_colored">NSTEP President Kathy Warye and CEA Chair Kathy Gornik congratulate the fastest male overall winner.</span></td>
	<td><img src="/global_images/spacer.gif" width="40" height="1"></td>
	<td><img src="images/winner_female.jpg" style="border: 1px #cccccc solid"><br><span class="text_colored">NSTEP President Kathy Warye and CEA Chair Kathy Gornik congratulate the fastest female overall winner.</span></td>
</tr>
<tr><td><img src="/global_images/spacer.gif" width=1" height="20"></td></tr>
<tr>
	<td><img src="images/banner_LVCChoriz.jpg" style="border: 1px #cccccc solid"><br><span class="text_colored">Big banners pumped up International CES attendees for the 5K Run/Walk to benefit NSTEP.</span></td>
	<td><img src="/global_images/spacer.gif" width="40" height="1"></td>
	<td><img src="images/banner_forumshops.jpg" style="border: 1px #cccccc solid"><br><span class="text_colored">A few runners relax a minute before the big 5K Run/Walk.</span></td>
</tr>
</table>
