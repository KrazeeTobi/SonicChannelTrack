...
<head>
	...
	<title>2004 International CES:&nbsp;TechTV's 2003 Best of CES Award Winners</title>
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">TechTV's 2003 Best of CES Award Winners <br><img src="/global_images/spacer.gif" height="16" width="1"></div>
			

<!-- text for main page -->
At the 2003 International CES, TechTV's products lab and appointed panel of judges selected the winners in each category based on innovative appeal, usability, usefulness and affordability. 
<br><br>
<center><span class="section_title">2003 BEST OF SHOW</span>
<BR><BR>
