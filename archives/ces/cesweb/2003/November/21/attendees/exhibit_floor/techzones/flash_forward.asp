...
<div id="1.2.2.1">	
<!-- text for main page -->
<img src="images/FlashForward_small_spons.gif" border="0" align="right">
<span class="intro_copy">Digital imaging is in the 2004 International CES picture.</span><br>
The International CES attracts more than 29,000 digital imaging retailers, distributors and buyers like you&mdash;more than any other tradeshow&mdash;to see and test the biggest array of cutting-edge digital technologies and applications.

<br>
<img src="/global_images/spacer.gif" alt="" width="1" height="55" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/1.0/line.gif" alt="-----------------------------------------------" width="590" height="1" hspace="0" vspace="0" border="0"><br>
<div class="section_title">Get focused at the 2004 International CES</div>

Discover the <em>next best thing</em> for digital imaging&mdash;<strong>Flash Forward: Bringing Digital Imaging Into Focus</strong>. Get critical, <em>real</em> solutions to the developing digital imaging experience in these zones within the larger Flash Forward: Bringing Digital Imaging Into Focus TechZone:
<br><br>
...
<tr>
    <td width="285" valign="top">
		...
		Retailers prepare to capture this booming market can see what's new for the snapshot photographer, family memory-keeper, hobbyist and professional photographer.
		<br><br>
		<strong>:: Zone:</strong> <span class="subhead">Digital Camcorders</span><br>
		Consumers are upgrading from analog to digital camcorders, with enhanced features, improved image quality and on-board imaging effects. See the latest digital camcorders and related technologies.
		<br><br>
		<strong>:: Zone:</strong> <span class="subhead">Power and Batteries</span><br>
		How has interest in digital photography impacted consumer use of power and batteries? What are the margins? Do consumers understand the vast differences in batteries, and how to get what's best for their needs? Learn about leading power and battery solutions.
		<br><br>
		<strong>:: Zone:</strong> <span class="subhead">Accessories</span><br>
		Enhancing digital capture devices with high margin accessories: Camera bags, lens attachments and more. Camera accessories boost the total sale of digital camera purchases.
		<br><br>
		<strong>:: Zone:</strong> <span class="subhead">Embedded Technologies</span><br>
		Learn how the components inside the camera impact the quality, performance and cost of digital photography. 
		<br><br>
		<strong>:: Zone:</strong> <span class="subhead">Storage Media</span><br>
		Consumers need storage solutions! Here you'll see camera cards or off-camera storage such as CD, DVD and more. Get savvy to the pros and cons of media formats and applications, so you can learn how to sell storage media products to consumers.    
		<br><br>
		<strong>:: Zone:</strong> <span class="subhead">Image and Video Software</span><br>
		As digital imaging and multimedia converge, software solutions are critical. Get educated about image archiving, management, editing, bundling, pricing and selling. See software solutions for the digital camera, camcorder, photo printing, image management and beyond.
	</td>
	...
	<td width="285" valign="top">
		...
		The next phase takes imaging beyond the PC. Intelligent set-top devices, next-generation TVs and home networks are spurring the growth of digital imaging. 
		...
		At-home photo printer use is growing&mdash;and we showcase the solutions for the best print technologies, print speeds, printer features and more. 
		<br><img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
		<strong>:: Zone:</strong> <span class="subhead">Retail Digital Photofinishing</span><br>
		Featured here are retail solutions for the growing photofinishing market: photo kiosks, digital minilabs, consumer services and retail partnerships.
		<br><img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
		<strong>:: Zone:</strong> <span class="subhead">Online Photo Services</span><br>
		Get a better understanding about the role of online photo services in digital photo finishing and photo management. This zone explores the evolving role of online photo services, as digital photography grows. 
		<br><img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
		<strong>:: Zone:</strong> <span class="subhead">Print Media and Consumables</span><br>
		This zone leads the way for the consumer transition from plain paper to the pro-quality look, feel and longevity offered by photo papers. Photo media and inks/toners are responsible for the dramatic improvement in print quality and performance. See the best of the best here.
		<br><img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
		<strong>:: Zone:</strong> <span class="subhead">Wireless Imaging</span><br>
		Wireless imaging impacts the digital imaging industry. Image-enabled cell phones are gaining popularity, as new handsets and service plans are announced. Learn how to how to make money in this growth area. This zone introduces the technology trends and cell phone camera capabilities. 
	</td>
</tr>
</table>
<br><br>
<span class="subhead">Flash Forward: Bringing Digital Imaging Into Focus Solutions Center</span><br>
The Flash Forward: Bringing Digital Imaging Into Focus Solutions Center, managed by InfoTrends Research Group, features 30-45 minute educational sessions throughout the show. Solution Center topics revolve around each Flash Forward: Bringing Digital Imaging Into Focus zone, and sessions include a mix of presentations and demonstrations.    
<br>

<img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/1.0/line.gif" alt="-----------------------------------------------" width="590" height="1" hspace="0" vspace="0" border="0"><br>
<div class="section_title">What to expect</div>

<span class="subhead">Manufacturers, retailers and other professionals who work with:</span><br>
...
<br>
<span class="subhead">Meet these retailers at the International CES:</span>
...
<div align="center"><img src="images/FlashForward_large_spons.gif" border="0" alt="Flash Forward: Bringing Digital Imaging Into Focus"></div>
<!--
[[Call out]]
