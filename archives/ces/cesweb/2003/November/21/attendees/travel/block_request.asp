...
<head>
	...
	<title>2004 International CES:&nbsp;Hotel Reservations: Room Block Request</title>
...
function validForm(passedForm)
	{
		...
		alert("Your requested dates must be between 12/27/03 and 1/16/04.")
		passedForm.input7.focus
		return false
		}
	
		if((year=="2003")&&(month != "12")){
		alert("Your requested dates must be between 12/27/03 and 1/16/04.")
		passedForm.input7.focus
		return false
		}		
			
		if((year=="2003")&&(month == "12")&& (day < "27")){
		alert("Your requested dates must be between 12/27/03 and 1/16/04.")
		passedForm.input7.focus
		return false
		}
		
		if((year=="2004")&&(month != "01")){
		alert("Your requested dates must be between 12/27/03 and 1/16/04.")
		passedForm.input7.focus
		return false
		}		
			
		if((year=="2004")&&(month == "01")&& (day > "16")){
		alert("Your requested dates must be between 12/27/03 and 1/16/04.")
		passedForm.input7.focus
		return false
		}
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Room Block Request<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
...
<tr>
	<td colspan="2">Please select an offical 2004 International CES hotel.</td>
</tr>

<tr><td colspan=2 height="6"><img src="/global_images/spacer.gif" height="6"></td></tr>

<tr><td colspan="2">
<!-- ***************** START TABLE TO HOLD 3 COLUMN RADIO BUTTONS FOR HOTELS ***************** -->
<b>Available Hotels</b>
<table cellpadding="0" cellspacing="0" border="0">
<tr><!--row1-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="Best Western Mardi Gras Inn">Best Western Mardi Gras Inn
	</td>
	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="Flamingo Las Vegas">Flamingo Las Vegas
	</td>
	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="ImperialPalace">Imperial Palace</input>
	</td>
</tr>
<tr><!--row2-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="Circus Circus">Circus Circus
	</td> 
	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="Golden Nugget">Golden Nugget
	</td>
	<td width="200" valign="top" class="text">
		<input type="radio" name="hotel" value="Monte Carlo Hotel">Monte Carlo Hotel
	</td>
</tr>
<tr><!--row3-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
	 <td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="Excalibur">Excalibur
	</td>  
	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="Harrah's">Harrah's
	</td>
	<td width="200" valign="top" class="text">
		<input type="radio" name="hotel" value="Stardust">Stardust
	</td>
</tr>
</table>
<br><br>
<b>Unavailable Hotels</b>
<table cellpadding="0" cellspacing="0" border="0">
<tr><!--row2-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
   <td width="170" valign="top" class="text"><!--<input type="radio" name="hotel" value="Alexis Park">-->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Alexis Park<font style="color:CC0000"> **</font></td>   
  		<td width="170" valign="top" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;HGVC at the LV Hilton <font style="color:CC0000">**</font>
	</td>
	 <td width="200" valign="top" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Paris<font style="color:CC0000"> **</font>
	<!--<td width="200" valign="top" class="text">
		<input type="radio" name="hotel" value="NewYork NewYork">New York New York
	</td>-->	
</tr>
<tr><!--row3-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
      <td width="170" valign="top" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AmeriSuites<font style="color:CC0000"> **</font></td>
	<td width="170" valign="top" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;HGVC on the LV Strip<font style="color:CC0000">**</font>	</td>
	<td width="200" valign="top" class="text">
		<!--<input type="radio" name="hotel" value="Rio All-Suite Hotel & Casino">-->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Rio All-Suite Hotel & Casino<font style="color:CC0000">*</font>
	</td>	
</tr>
<tr><!--row4-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
	    <td width="170" valign="top" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bally's<font style="color:CC0000"> **</font>
	</td>
	<td width="170" valign="top" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<!--<input type="radio" name="hotel" value="Las Vegas Hilton">-->Las Vegas Hilton<font style="color:CC0000"> **</font>
	</td>
	<td width="200" valign="top" class="text"><!--<input type="radio" name="hotel" value="Riviera">-->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Riviera<font style="color:CC0000">**</font>
	</td>
</tr>

<tr><!--row5-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
	<td width="170" valign="center" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bellagio<font style="color:CC0000"> **</font></td>	
	  <td width="170" valign="top" class="text">
		<!--<input type="radio" name="hotel" value="MGM Grand">-->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MGM Grand<font style="color:CC0000"> **</font>
	</td>
		<td width="200" valign="top" class="text">
		<!--<input type="radio" name="hotel" value="Sahara Hotel">-->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sahara Hotel<font style="color:CC0000"> *</font>
	</td>
<tr><!--row6-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
   		<td width="170" valign="center" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Caesars Palace<font style="color:CC0000"> **</font></td>
    
     <td width="170" valign="top" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mirage<font style="color:CC0000"> **</font></td>		
	 <td width="200" valign="top" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Treasure Island<font style="color:CC0000"> **</font>
	</td> 
	</tr>
<tr><!--row6-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
   	<td width="170" valign="top" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Embassy Suites LV<font style="color:CC0000"> **</font>
	</td>
	<td width="200" valign="top" class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;New York New York<font style="color:CC0000"> **</font></td>
      <td width="200" valign="top" class="text">
		<!--<input type="radio" name="hotel" value="Westin Casuarina">-->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Westin Casuarina<font style="color:CC0000"> **</font>
	</td>	
		
</tr>
	
</table>
<img src="/global_images/spacer.gif" height="10"><br><font style="color:CC0000">*</font>only accepting individual room reservations
<img src="/global_images/spacer.gif" height="10"><br><font style="color:CC0000">**</font>Sold Out
...
<tr>
	<td colspan=2>Please indicate the first and last nights of your block and the maximum number of rooms needed on your night of highest occupancy. <span class="text_colored">Show days are January 8-11, 2004.</span><br>
	</td>
</tr>
...
<tr><td colspan=2 height="12"><img src="/global_images/spacer.gif" height="12"></td></tr>
...
<tr><td colspan=2 height="4"><img src="/global_images/spacer.gif" height="18"></td></tr>
