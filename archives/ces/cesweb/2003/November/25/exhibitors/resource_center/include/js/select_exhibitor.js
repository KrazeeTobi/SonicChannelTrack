...
function getExhibitorList(bShowBooths){
	...
	if(bShowBooths)
		strWin = "/exhibitors/resource_center/include/asp/eims_admin_exh_search.asp?booths=true";
	else
		strWin = "/exhibitors/resource_center/include/asp/eims_admin_exh_search.asp?booths=false";
