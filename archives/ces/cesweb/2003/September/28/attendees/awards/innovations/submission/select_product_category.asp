...
<head>
	...
	<title>2004 International CES:&nbsp;Innovations 2004 Product Category Selection</title>
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Product Category Selection<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
			

<div id="1.4.1.4">	
<!-- text for main page -->
<span class="text_colored">Select the Product Category that represents your new entry submission.</span>
<br><br>
If you need assistance making a selection, view our detailed list of <a href="include/2004InnovationsProductCat.pdf" target="new">Product Categories</a> (pdf), including definitions and/or sub-categories.
<br>
...
<form name="frm_manuf" action="select_product_category.asp?ia_id=&login_id=" method="post">
	...
	<tr>
		<td><input type="radio" name=productCategory value="Eco Design">Eco Design</td>
		<td><input type="radio" name=productCategory value="Retail Accessories">Retailing CE Accessories</td>
		<td><input type="radio" name=productCategory value="Wireless Communications">Wireless Communications</td>
	</tr>
	<tr>
		<td></td>
		<td align="center"><br><input type="submit" name="btn_submit" value="Continue" class="formData"></td>
		<td></td>	
	</tr>
</table>
<br>
