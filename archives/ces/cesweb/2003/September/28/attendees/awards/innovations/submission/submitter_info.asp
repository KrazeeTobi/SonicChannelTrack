...
<head>
	...
	<title>2004 International CES:&nbsp;Innovations 2004 Submitter Information</title>
	...
	if(document.frm_submit.txt_third_fname.value == ""){
		alert("You must enter the Submitter's first name.")
		frm_submit.txt_third_fname.focus()
		return false
	}
	
	//Submitter's last name
	else if(document.frm_submit.txt_third_lname.value == ""){
		alert("You must enter the Submitter's last name.")
		frm_submit.txt_third_lname.focus()
		return false
	}
	
	//Submitting Company Name
	else if(document.frm_submit.txt_third_company.value == ""){
		alert("You must enter the Submitting Company name.")
		frm_submit.txt_third_company.focus()
		return false
	}
	
	//address1
	else if(document.frm_submit.txt_third_address1.value == ""){
		alert("You must enter the Company's address.")
		frm_submit.txt_third_address1.focus()
		return false
	}

		//city
	else if(document.frm_submit.txt_third_city.value == ""){
		alert("You must enter the Company's city.")
		frm_submit.txt_third_city.focus()
		return false
	}
	
			//zip
	else if(document.frm_submit.txt_third_zip.value == ""){
		alert("You must enter the Company's zip code.")	
		frm_submit.txt_third_zip.focus()	
		return false
	}	
		
		//country
	else if(document.frm_submit.txt_third_country.value == "unselected"){
		alert("You must enter the Company's country.")		
		return false
	}
	
		//phone
	else if(document.frm_submit.txt_third_phone.value == ""){
		alert("You must enter the phone.")
		frm_submit.txt_third_phone.focus()
		return false
	}
	
		//Manuf url
	else if(document.frm_submit.txt_third_url.value == ""){
		alert("You must enter the Company's url.")
		frm_submit.txt_third_url.focus()
		return false
	}
	
		//Manuf email
	else if(document.frm_submit.txt_third_email.value == ""){
		alert("You must enter the email.")
		frm_submit.txt_third_email.focus()
		return false
	}
	
	if(document.frm_submit.chk_agree.checked == false){
		alert("You must agree to the Terms and Conditions below.")
		frm_submit.chk_agree.focus()
		return false
	}
}
</script>
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Submitter Information<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
			
<div id="1.4.1.4">	
<!-- text for main page -->

<span class=text_colored>Please tell us about yourself and your company.</span>
<b><span class=required>*</span> Denotes required field.</b><br>

<table width='100%' cellpadding='2' cellspacing='0' border='0'>
<form action='submitter_submit.asp?login_id=' method='post' name='frm_submit'>
	<tr>
		<td><img src="/global_images.spacer.gif" width="170" height="1" border="0">&nbsp;</td>
		<td><img src="/global_images.spacer.gif" width="410" height="1" border="0">&nbsp;</td>	
	</tr>
	<tr>
		<td class='rowlabel'><font class='body'><span class='required'>*</span> First Name&nbsp;&nbsp;</font></td>
		<td><input type='text' name='txt_third_fname' size='25' maxlength='50' class='formData'></td>
	</tr>
	<tr>
		<td class='rowlabel'><font class='body'><span class='required'>*</span> Last Name&nbsp;&nbsp;</font></td>
		<td><input type='text' name='txt_third_lname' size='25' maxlength='50' class='formData' ></td>
	</tr>
	<tr>
		<td class='rowlabel'><font class='body'>Job Title&nbsp;&nbsp;</font></td>
		<td><input type='text' name='txt_third_jobtitle' size='40' maxlength='75' class='formData'></td>
	</tr>	
	<tr>
		<td class='rowlabel'><font class='body'><span class='required'>*</span> Company Name&nbsp;&nbsp;</font></td>
		<td><input type='text' name='txt_third_company' size='40' maxlength='75' class='formData'></td>
	</tr>
	<tr>
		<td class='rowlabel'><font class='body'><span class='required'>*</span> Address 1&nbsp;&nbsp;</font></td>
		<td><input type='text' name='txt_third_address1' size='40' maxlength='75' class='formData'></td>
	</tr>
	<tr>
		<td class='rowlabel'><font class='body'>Address 2&nbsp;&nbsp;</font></td>
		<td><input type='text' name='txt_third_address2' size='40' maxlength='75' class='formData'></td>
	</tr>
	<tr>
		<td class='rowlabel'><font class='body'><span class='required'>*</span> City&nbsp;&nbsp;</font></td>
		<td><input type='text' name='txt_third_city' size='40' maxlength='75' class='formData'></td>
	</tr>
	<tr>
		<td class='rowlabel'><font class='body'>State&nbsp;&nbsp;</font></td>
		<td> 
		<SELECT NAME='txt_third_state'>
	...
	<tr>
		<td class='rowlabel'><font class='body'><span class='required'>*</span>Zip&nbsp;&nbsp;</font></td>
		<td><input type='text' name='txt_third_zip' size='5' maxlength='9' class='formData'></td>
	</tr>
	<tr>
		<td class='rowlabel'><font class='body'><span class='required'>*</span> Country&nbsp;&nbsp;</font></td>
		<td> 
		<SELECT NAME='txt_third_country'>
	...
	<tr>
		<td class='rowlabel'><font class='body'><span class='required'>*</span> Phone&nbsp;&nbsp;</font></td>
		<td><input type='text' name='txt_third_phone' size='12' maxlength='20' class='formData'></td>
	</tr>
	<tr>
		<td class='rowlabel'><font class='body'>Fax:&nbsp;&nbsp;</font></td>
		<td><input type='text' name='txt_third_fax' size='12' maxlength='20' class='formData'></td>
	</tr>	
	<tr>
		<td class='rowlabel'><font class='body'><span class='required'>*</span> E-mail&nbsp;&nbsp;</font></td>
		<td><input type='text' name='txt_third_email' size='40' maxlength='75' class='formData'></td>
	</tr>
	<tr>
		<td class='rowlabel'><font class='body'><span class='required'>*</span>Company Website URL&nbsp;&nbsp;</font></td>
		<td><input type='text' name='txt_third_url' size='40' maxlength='75' class='formData'></td>
	</tr>	
	<tr>
		<td colspan=2><br>
		...
		The individual submitting this application represents and warrants that he/she is duly authorized to submit this entry form on behalf of the listed company.
		By submitting this application, the company that owns full rights to the submitted product's trademarks and logos hereby grants CEA permission to use all trademarks and logos associated with the submitted product in association with promotions and announcements regarding Innovations 2004.
		<BR><BR><input type=checkbox name='chk_agree' value='agree'> <b>I Agree</b> (box must be checked in order to proceed)</font></td>
	</tr>
</table>
<br>
<table cellpadding='0' cellspacing='0' border='0' align='center'>
	<tr>
		<td>
			...
			<input type='submit' name='btn_submit' value='Continue' class='formData'  onClick="return CheckFields()">
		</td>
	</tr>
</table>
</form>
