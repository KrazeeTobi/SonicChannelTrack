...
<TR>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/ces_locations/floorplans.asp');" ONMOUSEOVER="rollover_td('floor','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('floor','leftsubnav_main_active');">
		<TD ID="floor_cellspacer">&nbsp;</TD>
		<TD ID="floor"><a href="/ces_locations/floorplans.asp" CLASS="leftsubnav_main_active">Floorplans</a></TD>
		<TD ID="floor_arrowcell"><IMG SRC="/global_images/context_arrow-new.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.9.3")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="1.9.3">
<span class="pagehead">CES Locations :: Floorplans</span>
<br><br>
...
<br><br>
<a href="/for_exhibitors/floorplans/launch_floorplan.asp" target="new"><b>Download the floorplans</b></a>, powered by EXPOCAD, for a comprehensive glimpse of the 2003 International CES show layout.
