...
<TITLE>2004 International CES: Contact CES</TITLE>
...
<script language="javascript1.2" src="/contact_ces/include/js/validate_fields.js"></script>
</HEAD>
...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","0.3")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<div class="text" id="0.3">
<span class="pagehead">Contact CES</span><br><br>
<span class="head">Need Help? Have A Question?</span><br><br>

<span class="subhead">Contact our Customer Service Center and we will be happy to help!</span>

<form name="emailContactForm" action="default.asp" method="post" onSubmit="return validate_contact_form();">
<table cellpadding="0" cellspacing="0" border="0" width="100%">
<tr>
	<td colspan=3><span class="body">To help us properly direct your email message, please answer the following questions (<span class="required">*</span> indicates a required field).</span></td>
</tr>
<tr>
	<td colspan=3>&nbsp;</td>
</tr>
<tr>
	<td class="rowlabel"><span class="required">*</span> Subject:&nbsp;</td>
	<td>&nbsp;</td>
	<td align=left>
	<select name="subject" class="formData">
		...
		<option value="Remove">Remove from Mailing Lists/Promotions by Exhibitors</option>
		<option value="Correction">Correction to my Attendee Information</option>
...
<tr>
	<td class="rowlabel"><span class="required">*</span> Message:&nbsp;</td>
	<td>&nbsp;</td>
...
<tr>
	...
	<td>&nbsp;</td>
	<td align=left valign=top><input type="text" size="20" name="fax" class="formData"><br><span class="formInstruction">(please include country and city codes in the numbers)<br>(e.g. +1 111 111 1111)<br>(+1 is the country code for the United States)</span></td>
</tr>
<tr>
	<td colspan=3>&nbsp;</td>
</tr>
...
<tr>
	<td colspan=3><strong>Do you have ideas for improving this site? Are there features that should be added or expanded in order to make this site more valuable for you?</strong><br><br></td>
</tr>
<tr>
	<td colspan=1></td>
	<td colspan=2><textarea name="comments" cols="45" rows="5"></textarea></td>
</tr>
<tr>
