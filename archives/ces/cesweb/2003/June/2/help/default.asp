...
<TITLE>2004 International CES: Help</TITLE>
...
<TR>
	...
	<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0">
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/help/default.asp');" ONMOUSEOVER="rollover_td('general','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('general','leftsubnav_main_active');">
		<TD ID="general_cellspacer">&nbsp;</TD>
		<TD ID="general"><a href="/help/default.asp" CLASS="leftsubnav_main_active">Help Information</a></TD>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","0.4.1")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="0.4.1">
<span class="pagehead">Help :: General Information</span><br><br>
<span class="head">Your Questions Answered</span>
<br><br>

CESWeb is the hub of all information related to the annual tradeshow for consumer technology, 2001 International CES. It has been designed to help you find all the information you need to attend the show, exhibit at the show, speak at the show and cover the show as a member of the press.<br><br> 
<!--
<span><b>Navigating CESweb</b></span><br>
Some browsers and platforms are unable to render the dhtml used to build our left-hand navigation. If you are experiencing problems with the left-hand navigation, click on the button below to get a text-only version. Clicking the button a second time will take you back to the dynamic (original) navigation.
<br><br>
-->
<span class="subhead">Frequently Asked Questions</span><br>
Our Frequently Asked Questions are organized by category to make it easier for you to find the answers you need. Browse our <a href="/help/general_faq.asp">General FAQs</a> or FAQs by <a href="/help/press_faq.asp">Press</a>, <a href="/help/exhibitor_faq.asp">Exhibitors</a> and <a href="/help/speaker_faq.asp">Speakers</a> for quick and easy access to all the questions and answers important to you.
<br><br>

<span class="subhead">Getting Help</span><br>
If you can't find help for your specific question here or would like personalized assistance, please feel free to e-mail us at <a href="mailto:cesinfo@ce.org">cesinfo@ce.org</a>. We return most e-mails within 24 hours. 
<br><br>
<span class="subhead">CES Customer Service</span><br>
To speak with a customer service representative, call our Customer Service Center at (866) 233-7968 (USA), (301) 631-3983 (International). We are available to answer calls during normal business hours (9am to 5pm EST Monday through Friday).
