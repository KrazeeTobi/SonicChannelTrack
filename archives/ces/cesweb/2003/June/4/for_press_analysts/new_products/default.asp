...
<TITLE>2004 International CES: New Products @ CES</TITLE>
...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","3.4.1")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="3.4.1">
<span class="pagehead">New Products @ CES</span><br><br>

<span class="head">CES is the birthplace of new technology.</span><br><br>
Each year at CES, exhibitors showcase new, innovative technologies.  The CES new products database (searchable by
product category) is your direct link to these technologies.
<br><br>

<table width="100%" cellspacing="0" cellpadding="0" border="0">
<form name="NewProdCatSearch" action="eims_new_product_announce.asp" method="GET">
<tr>
	<td colspan="2">Please select a product category to view a list of new products at the 2003 International CES.
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<select name="prodcat" class="formData">
			<option selected value="0">All Categories
			<option value="1">Audio
			<option value="2">Adult Entertainment
			<option value="578">Batteries
			<option value="416">Biometrics
			<option value="3">Blank Media
			<option value="595">Business Services/Solutions
			...
			<option value="563">Film Industry
			<option value="571">Furniture
			...
			<option value="9">Mobile Electronics
