...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.1.4.2")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<BR>
<span class="head">Search by Track/Partner Program</span><br><br>
<form action=session_by_circuit_list.asp method=post><table cellpadding=3 cellspacing=1 border=0><tr><td>Choose a Track or Partner Program from the Drop-Down List</td></tr><tr height=7><td></td></tr><tr><td colspan=2><select class=formdata name=ID_track><option value=0>Choose a Track&nbsp;&nbsp;<option value=WE03>Andrew Seybold’s Wireless Experience<option value=AT03>AudioTrax<option value=BSS03>Business Solutions<option value=CT03>Car Technologies<option value=CEDIA-CBM03>CEDIA Business Management Track<option value=CEDIA-CHN03>CEDIA Home Networking Track<option value=CEDIA-CHT03>CEDIA Home Theater Track<option value=CEDIA-CIF03>CEDIA Installation Fundamentals Track<option value=CEDIA-CPC03>CEDIA Professional Certification Track<option value=CEDIA03>CEDIA Training Program<option value=CEDIA-CWH03>CEDIA Whole-House Systems Track<option value=DH03>Digital Hollywood<option value=ET03>Emerging Technologies<option value=G03>Gaming<option value=GG03>GartnerG2<option value=HE03>Home Entertainment<option value=IIS03>Industry Insider Series<option value=MECP03>MECP Certification Program<option value=HN03>Networking<option value=PA03>Parks Associates<option value=SBCA03>SBCA Satellite Program<option value=SS03>SuperSessions<option value=SMS03>Surround Music Symposium<option value=TH03>TechHome Basic Training<option value=WR03>Wireless Retail Training Track<option value=W03>Wireless Technologies</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
<br><br>
</div>
<!-- **CONTENT ENDS HERE** -->
