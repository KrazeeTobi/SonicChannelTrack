...
<!-- breadcrumb row -->
	<tr>
	    ...
	    <td width="10"></td>
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/attendees/">Attendees</a>&nbsp;>&nbsp;<a href="/attendees/travel/">Travel</a>&nbsp;>&nbsp;<a href="/attendees/travel/hotel.asp">Hotel Reservations</a>&nbsp;>&nbsp;
...
<tr><!--row2-->
	...
	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="New York New York">New York New York
	</td>	
</tr>
<tr><!--row3-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
    <td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="Bally's">Bally's
	</td>	
   	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="HGVC at the LV Hilton">HGVC at the LV Hilton
	</td>
	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="Paris">Paris
	</td>
</tr>
<tr><!--row4-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
...
<tr><!--row5-->
	<td width="20"><img src="/global_images/spacer.gif"></td>
   	<td width="170" valign="top" class="text">
		<input type="radio" name="hotel" value="Caesars Palace">Caesars Palace
	</td>
	<td width="170" valign="top" class="text">
