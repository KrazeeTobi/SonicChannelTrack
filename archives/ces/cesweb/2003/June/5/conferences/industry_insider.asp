...
<TR>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/conferences/industry_insider.asp');" ONMOUSEOVER="rollover_td('insider','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('insider','leftsubnav_main_active');">
		<TD ID="insider_cellspacer">&nbsp;</TD>
		<TD ID="insider"><A HREF="/conferences/industry_insider.asp" CLASS="leftsubnav_main_active">Industry Insider Series</A></TD>
		<TD ID="insider_arrowcell"><IMG SRC="/global_images/context_arrow-new.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.1.9")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="1.1.9">
<span class="pagehead">Conferences :: Industry Insider Series</span><br><br>
<span class="head">Smart. Candid. Real.</span><br><br>

Through this series of intimate, one-hour talks, meet the real industry insiders, the new generation of leaders well on their way to taking CE to the next threshold.
<br><br>
...
<br><br>
<img src="/conferences/images/insider/dell.jpg" align="left">
<br><b>Michael Dell</b><br>
Chairman and CEO<br>
Dell Computer Corporation<br>
Thursday, January 9, 3:00 p.m.<br>
LVCC - North Hall - N250<br>
<a href="Michael_Dell_CES_Keynote_Transcript.doc">Read Transcript</a>
<br><br>
Michael Dell offers his uninhibited insight on the 
consumer technology marketplace.  Dell, a prominent figure in the IT field, founded Dell Computer Corp. in 1984. Honored 
repeatedly for his visionary leadership, Dell has been named "Entrepreneur of the Year" from <i>Inc.</i>, "Man of the Year" 
by <i>PC Magazine</i>, and "CEO of the Year" by <i>Financial World</i> and <i>Industry Week</i>.

<br><br><div align="center"><img src="/global_images/page_sep_onpage.gif" width="80%" height="1"></div><a name="glaser"></a><br>
<img src="/conferences/images/insider/glasser.jpg" align="left">
<br><b>Rob Glaser</b><br>
Chairman and CEO<br>
RealNetworks<br>
Friday, January 10, 3:00 p.m.<br>
LVCC - North Hall - N250<br>
<br><br>
Rob Glaser shares his vision for the future of Internet media delivery on devices, talking specifically about the Helix Community and the role of the Helix DNA Client in expanding the reach of digital media to mobile and living room devices.  Since founding RealNetworks in 1994, Glaser has played an integral role in the transformation of the Internet into the next great mass medium.
<br><br>
</div>
<!-- **CONTENT ENDS HERE** -->
