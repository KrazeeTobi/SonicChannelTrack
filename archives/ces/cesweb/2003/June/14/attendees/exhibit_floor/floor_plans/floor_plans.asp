...
<head>
	...
	<title>2004 International CES:&nbsp;Exhibition Floor Plans</title>
...
<!-- breadcrumb row -->
	<tr>
	    ...
	    <td width="390" colspan="2" background="/global_images/spacer.gif" class="attendees6" valign="bottom"><span class="attendees_nav_breadcrumb"><a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/attendees/">Attendees</a>&nbsp;>&nbsp;<a href="/attendees/exhibit_floor/">Exhibit Floor</a>&nbsp;>&nbsp;Floor Plans</span><br><img src="/global_images/spacer.gif" height="8" width="1"></td>
	   
	    <td width="200" background="/global_images/spacer.gif" colspan="2" class="attendees6"><img src="/global_images/1.0/1.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","1.2.4") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images/1.0/1.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="43" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images/1.0/1.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">2004 International CES Floor Plans<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
			

<!-- text for main page -->
Interactive floor plans, updated frequently, provide an aerial view of the entire 2004 International CES. 
<br><br>
Browse by exhibitor, view specific booth locations, or see where each technology category resides on the show floor.

<br><br>
<a href="launch_floorplan.asp" target="new"><b>Download the floor plans</b></a>, powered by EXPOCAD, for a comprehensive glimpse of the 2004 International CES show layout.
<span class="text_colored">Please be patient while the floor plans and full exhibitor list load.  This may take a few moments.</span>
<br><br>
<span class="subhead">General directions for use</span><br>
<ul>
<li>Double-click on an exhibitor listed on the left to locate their booth.<br>
<li>Click and drag on any area within the floor plan to view surrounding areas.<br>
...
<br>
<span class="subhead">Internet Explorer users having trouble?</span><br>
If you do not have Java enabled in your Internet browser, you may experience problems loading the floor plans.
