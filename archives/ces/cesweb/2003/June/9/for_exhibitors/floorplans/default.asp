...
<TITLE>2004 International CES: Floorplans</TITLE>
...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","2.6")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="2.6">
<span class="pagehead">2003 International CES Floorplans</span>
<br><br>
<span class="head">A Birds-Eye View</span>
<br><br>
If you're an International CES newcomer, get a feel for the general layout of the show by viewing last year's floor plans.
<br><br>
You may browse by exhibitor name to view individual booths and their location within the floor layout.  
Product categories are also highlighted in each exhibit hall.
<br><br>
<a href="launch_floorplan.asp" target="new"><b>Download the floorplans</b></a>, powered by EXPOCAD, for a comprehensive glimpse of the 2003 International CES show layout.
<i>Please be patient while the floorplans and full exhibitor list load.  This may take a few moments.</i>
<br><br>
<b>General Directions for Use</b><br>
<ul>
<li>Double-click on an exhibitor listed on the left to locate their booth.<br>
<li>Click and drag on any area within the floorplan to view surrounding areas.<br>
<li>Choose "Zoom In/Out" to view more or less detail.<br>
<li>Choose "Zoom All" to return to the initial view of all exhibit halls.<br>
<li>The "Help" button explains the use of all toolbar functions.<br>
</ul>
<br>
<b>Internet Explorer users having trouble?</b><br>
If you do not have Java enabled in your Internet browser, you may experience problems loading the floorplans.
<a href="vr2_troubleshoot.pdf" target="new">Download these brief instructions</a> to ensure Java is enabled on your browser.
<br><br>
If you have questions regarding your booth space, please call CES Sales at (703) 907-7661.
<br><br>
</div>
<!-- **CONTENT ENDS HERE** -->
