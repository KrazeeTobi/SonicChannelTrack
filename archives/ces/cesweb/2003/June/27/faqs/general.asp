...
<ul>
	<li><a href="#badge">I registered for International CES. Where's my badge?</a></li> 
	<li><a href="#show">If I have a badge, can I walk right into the show?</a></li> 
	<li><a href="#holder">Where can I pick up my badge holder?</a></li> 
	<li><a href="#sent">Why isn't my badge holder sent with my badge?</a></li> <i>(NEW)</i>
	<li><a href="#new">I missed the advance registration deadline. Can I register on-site?</a></li> 
	<li><a href="#id">What type of identification will I need to pick up a badge and/or badge holder?</a></li> 
</ul>
<br>

<span class="subhead">Exhibitors</span><br>
<ul>
	<li><a href="#exhibiting">How do I find out who is exhibiting?</a></li> 
	<li><a href="#appointments">Can I make appointments with exhibitors before getting to the show?</a></li> 
</ul>
<br>

<span class="subhead">General Show Info</span><br>
<ul>
	<li><a href="#around">How do I find my way around?</a></li> 
	<li><a href="#attend">What are the requirements for attending International CES?</a> <i>(NEW)</i></li>
	<li><a href="#speak">I've heard you have big names at the show? Who is speaking?</a></li> 
	<li><a href="#cool">What other cool stuff is happening at International CES?</a> <i>(NEW)</i></li>
	<li><a href="#luggage">Are luggage and strollers allowed on the show floor?</a> <i>(NEW)</i></li>
	<li><a href="#camera">Are cameras allowed on the show floor?</a> <i>(NEW)</i></li>
</ul>
<br>

<span class="subhead">International CES Conferences</span><br>
<ul>
	<li><a href="#session">How can I find a conference session that's right for me?</a></li> 
	<li><a href="#register">Why would I register for conferences in advance?</a> <i>(NEW)</i></li>
	<li><a href="#satisfaction">What does my "satisfaction is guaranteed" mean?</a></li> 
	<li><a href="#cancel">What is the cancellation policy for conferences?</a> <i>(NEW)</i></li>
</ul>
<br>

<span class="subhead">Security</span><br>
<ul>
	<li><a href="#security">What is International CES doing to enhance security at the show?</a></li> 
	<li><a href="#lines">I do not want to wait in long lines to get into the show. What should I do?</a></li> 
</ul>
<br>

<span class="subhead">Travel</span><br>
<ul>
	<li><a href="#book">Should I wait to book my hotel and airline reservations so that prices will come down?</a></li> 
	<li><a href="#airline">Airline travel is more difficult these days. I cannot afford to spend hours waiting in line. How can I avoid delays?</a></li>
	<li><a href="#visa">How do I get an International Visa letter of invitation?</a></li> 
</ul>
<br>
...
<table width="590" border="0" cellpadding="0" cellspacing="0">
	...
	<tr class="home11"><td>Alexis Park Resort</td><td>Closed</td><td>8 a.m. - 6 p.m.</td><td>7:30 a.m. - 6:30 p.m.</td>
	</tr>
...
<table width="590" border="0" cellpadding="0" cellspacing="0">
	...
	<tr class="home11"><td width="180">Alexis Park Resort</td><td width="130">7:30 a.m. - 6:30 p.m.</td><td width="130">7:30 a.m. - 6:30 p.m.</td><td width="130">8 a.m. - 3 p.m.</td>
	</tr>
	...
	<tr><td>LVCC Silver Lot</td><td>8 a.m. - 6:30 p.m.</td><td>8 a.m. - 6:30 p.m.</td><td>8 a.m. - 3:00 p.m.</td>
	</tr>
	<tr class="home11"><td>McCarran Airport</td><td>8 a.m. - midnight</td><td>Closed</td><td>Closed</td>
	</tr>
</table>
<img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<a href=#top>[return to question list]</a>
