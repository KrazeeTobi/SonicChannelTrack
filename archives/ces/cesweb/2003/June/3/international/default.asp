...
<!-- ***THIS BLURB WILL LIVE ONLY ON THE ENGLISH INTERNATIONAL PAGE*** -->
						...
						<TR>
							<TD>&nbsp;</TD>
							<TD><div class="text" align="center">
...
<!-- **CONTENT STARTS HERE** -->
<span class="pagehead">International Visitor :: General Information</span><br><br>
<span class="head">Going global.</span><BR><BR>
The International CES unites more major players in the consumer electronics industry than any other trade fair of its kind. The 2003 International CES attracted approximately:
<ul>
	<li>2,200 exhibitors
	<li>110,000 attendees
	<li>15,000 people from more than 110 countries
	<li>4,000 journalists and 1,000 analysts
</ul>
<br>
<span class="subhead">The International CES&mdash;coming to a location near you.</span><br>
Learn more about the value of the International CES. Stop by the International CES exhibit booth at these events:
<ul>
	<li>IFA (International Funkausstellung): August 29-September 3, Berlin, Germany
	<li>Hong Kong Electronics Fair: October 13-14, Hong Kong
	<li>TAITRONICS: October 16-20, Taipei, Taiwan
</ul>
<br>

<span class="subhead">Be prepared.</span><br>
Start making plans for 2004 International CES now. You can:
<ul>
	<li><a href="http://www.travel.state.gov/visa_services.html" target="new">Apply for a visa</a> early.
	<li>Get a <a href="http://www.travel.state.gov/DS-0156.pdf" target="new">U.S. Visa Application Form</a> (Form DS-0156).
	<li>Find the location of the <a href="http://www.travel.state.gov/links.html" target="new">U.S. Embassy or Consulate General</a> nearest you.
</ul>
<br>
<span class="subhead">Points of interest for 2004</span><br>
<ul>
<li>The International Premier Package is your best exhibit and conference package.  With the International Premier Package, you get access to all the exhibits, keynotes, SuperSessions, and more than 70 conference sessions. Plus, you receive tickets to VIP luncheons, the International Reception, and much more!  This special package is offered exclusively to our international attendees for just $299 (U.S.) if purchased before December 5, 2003.
<br><br>
<li>The 2004 International CES is a proud participant in the International Buyer Program (IBP), sponsored by the U.S. Commercial Service sector of the U.S. Department of Commerce. Attendees at CES can take advantage of the IBP's Global Matchmaking Program and find exhibitors interested in exporting opportunities outside the United States.  Visit the <a href="http://www.usatrade.gov/website/website.nsf" target="new">U. S. Commercial Service</a> website for more information. 
</ul>
<br>
</div>
<!-- **CONTENT ENDS HERE** -->
	...
	<TD VALIGN="top" width="135" bgcolor="#ffffff">
		...
		<TR>
			...
			<TD class="avshadowmain">
				...
				<div align="center" style="COLOR:#004aa0">
					...
					<strong>January 8-11, 2004<br>Las Vegas, Nevada</strong>
		...
		<TR>
			...
			<TD>
				...
				<span class="subhead">First in line.</span><br>
				Please <a href="/registration/">enter your e-mail address</a>, and we'll let you know when registration begins for the 2004 International CES.
