...
function openNewWindow(strURL) {
	...
	var newWindow = window.open(strURL,"newWindow", "toolbar=no,menubar=no,resizable=no,status=no,scrollbars=yes,location=no,directories=no,copyhistory=no,height=430,width=500,left=50,top=50");
} 
</script>
...
<TR>
	...
	<TD ALIGN="center" COLSPAN="5" BACKGROUND="/global_images/subtab_bg_main.gif" CLASS="subtab_main">
		...
		<A HREF="/pavilions/default.asp" ONMOUSEOVER="rollover('subtab_main_pavillions', subtab_main_pavillions_active);" ONMOUSEOUT="rollover('subtab_main_pavillions', subtab_main_pavillions_active);"><IMG NAME="subtab_main_pavillions" SRC="/global_images/subtab_main_pavillions_active.gif" ALT="Pavilions" BORDER="0"></A>
...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.5")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="1.5">
<span class="pagehead">Pavilions</span><br><br>

<table border=0>
<tr>
	<td>
	<span class="head">Shows Within The Show</span>
	<br><br>
	As the world's largest consumer technology tradeshow, it's our job to find innovative ways to get 2004 International CES attendees synced up with the exhibitors that interest them. That's where technology pavilions come in. 
	<br><br>
	These show-within-a-show zones host the coolest products in concentrated, market-specific environments. Here's a sample of the pavilions currently on the 2004 International CES drawing board.
	</td>
	<td width="3"></td>
<td width="220">
	<img vspace="0" src="/for_exhibitors/exhibit_promotion/images/2004/UWS-RECEPTION_small.jpg"><br>
	<span style="color:#004aa0;">Retailers seek training and merchandising ideas at the Ultimate Wireless SuperStore.</span>
</td>
</tr>
</table>
...
<tr>
	...
	USB<br> 
	Weather Radio <br>
	Ultimate Wireless SuperStore<br> 
	</td>
</tr>
</table>
<br>

<a href="2k3_pavilions.asp">View the technology pavilion line-up</a> from the 2003 International CES.
<br><br>
<!--<span class="head">An Extremely Hip Place To Be.</span><br><br>
The 2003 International CES Technology Pavilions gave attendees with a speicific product category in mind a concentrated place to:
...
<table cellspacing=0 cellpadding=0 border=0 width="90%" align="center">
	<tr>
		<td width="46%">
		<ul>
			<li>Talk to the manufacturers
			<li>Make partnership alliances
			<li>Understand how applications interact
		</ul>
		</td>
		<td valign=top>
		<ul>
			<li>Be the first to see and test new products
			<li>Heighten your knowledge of the industry's newest innovations
		</ul>
		</td>
	</tr>
</table>
...
<table width="100%" cellpadding="2" cellspacing="0" border=0>
	<tr>
		<a name="audio"></a>
		<td class="" colspan="3"><span class="subhead">Audio, Digital Imaging and Video</span></th>
	</tr>
	<tr>
		<td class="tablehead" width="40%"><b>Pavilion</b></th>
		<td class="tablehead" width="14%"><b>Location</b></th>
		<td class="tablehead"><b>Sponsor</b></th>
	</tr>
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=Audio_Books_Pavilion')>Audio Books Pavilion</a></td>
		<td class="">South 3</td>
		<td class="">Audio Publishers Association (APA)</td>	
	</tr>
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=Imaging_Technology')>Imaging Technology</a></td>
		<td class="">South 3-4</td>
		<td class=""></td>	
	</tr>	
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=MP3_Internet_Audio')>MP3 & Internet Audio</a></td>
		<td class="">South 3-4</td>
		<td class=""></td>	
	</tr>
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=Polaroid_Licensed_Products')>Polaroid Licensed Products</a></td>
		<td class="">Central 3-5</td>
	...
	<tr>
		<a name="computing"></a>
		<td class="" colspan="3"><span class="subhead">Computing and Data Storage</span></th>
	</tr>
	<tr>
		<td class="tablehead"><b>Pavilion</b></th>
		<td class="tablehead"><b>Location</b></th>
		<td class="tablehead"><b>Sponsor</b></th>
	</tr>
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=Business_Solutions')>Business Solutions</a></td>
		<td class="">South 3</td>
		<td class=""></td>	
	</tr>
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=Memory_Stick')>Memory Stick</a></td>
		<td class="">Central 3-5</td>
		<td class=""></td>	
	</tr>
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=RWPPI')>RWPPI (RW Product Promotion Initiative)</a></td>
		<td class="">Central 3-5</td>
		<td class="">RWPPI</td>	
	</tr>
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=SD_Card')>SD Card</a></td>
		<td class="">Central 1-2</td>
		<td class="">SD Card Assoc.</td>	
	</tr>
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=USB')>USB</a></td>
		<td class="">South 3</td>
		<td class="">USB Implementers Forum</td>	
	</tr>
	
	<tr><td height="10"></td></tr>
	<tr>
		<a name="emerging"></a>
		<td class="" colspan="3"><span class="subhead">Emerging Tech and Electronic Gaming</span></th>
	</tr>
	<tr>
		<td class="tablehead"><b>Pavilion</b></th>
		<td class="tablehead"><b>Location</b></th>
	...
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=Embedded_Technologies')>Embedded Technology</a></td>
		<td class="">South 3-4</td>
		<td class="">EE Times, Embedded Systems, CMP, JEDEC</td>	
	</tr>
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=Emerging_Technologies_Launch_Pad')>Emerging Technologies Launch Pad</a></td>
		<td class="">South 4</td>
		<td class=""></td>	
	</tr>
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=Xtreme_Entertainment_Pavilion')>Xtreme Entertainment Pavilion</a></td>
		<td class="">South 3-4</td>
		<td class=""></td>	
	</tr>
	...
	<tr>
		<a name="energy"></a>
		<td class="" colspan="3"><span class="subhead">Energy Efficiency</span></th>
	</tr>
	<tr>
		<td class="tablehead"><b>Pavilion</b></th>
		<td class="tablehead"><b>Location</b></th>
	...
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=Electronics_Recycling_Center')>Electronics Recycling Center</a></td>
		<td class="">South 4</td>
		<td class="">U.S. EPA</td>	
	</tr>
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=Energy_Technology_Center')>Energy Technology Center</a></td>
		<td class="">South 4</td>
		<td class="">Energy Star</td>	
	</tr>
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=Portable_Power_Center')>Portable Power Center</a></td>
		<td class="">South 3</td>
		<td class=""></td>	
	</tr>
	<tr><td height="10"></td></tr>
	<tr>
		<a name="home"></a>
		<td class="" colspan="3"><span class="subhead">Home Networking, Home Theater</span></th>
	</tr>
	<tr>
		<td class="tablehead"><b>Pavilion</b></th>
		<td class="tablehead"><b>Location</b></th>
	...
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=Home_Plug_Powerline_Alliance')>HomePlug Powerline Alliance</a></td>
		<td class="">South 3</td>
		<td class="">HomePlug Powerline Alliance</td>	
	</tr>	
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=SmartRight')>SmartRight Pavilion</a></td>
		<td class="">South 4</td>
		<td class=""></td>	
	</tr>
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=TechHome')>TechHome</a></td>
		<td class="">South 2</td>
		<td class="">TechHome Division of CEA</td>	
	</tr>
	
	<tr><td height="10"></td></tr>
	<tr>
		<a name="mobile"></a>
		<td class="" colspan="3"><span class="subhead">Mobile Electronics</span></th>
	</tr>
	<tr>
		<td class="tablehead"><b>Pavilion</b></th>
		<td class="tablehead"><b>Location</b></th>
	...
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=Digital_Car_Showroom')>Digital Car Showroom</a></td>
		<td class="">North 2</td>
		<td class="">SAE</td>	
	</tr>
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=MOST_Consortium')>MOST Cooperation</a></td>
		<td class="">North 4</td>
		<td class="">MOST Cooperation, Oasis</td>	
	</tr>
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=Telematics_Update_Pavilion')><i>Telematics Update</i> Pavilion</a></td>
		<td class="">North 4</td>
		<td class=""><i>Telematics Update</i> Magazine</td>	
	</tr>

	<tr><td height="10"></td></tr>
	<tr>
		<a name="wireless"></a>
		<td class="" colspan="3"><span class="subhead">Wireless</span></th>
	</tr>
	<tr>
		<td class="tablehead"><b>Pavilion</b></th>
		<td class="tablehead"><b>Location</b></th>
	...
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=Bluetooth')>Bluetooth</a></td>
		<td class="">South 3</td>
		<td class="">Bluetooth SIG</td>	
	</tr>
	<tr>
		<td class=""><a href=javascript:openNewWindow('case_popups.asp?name=Ultimate_Wireless_SuperStore')>Ultimate Wireless SuperStore</a></td>
		<td class="">South 3</td>
		<td class=""></td>	
	</tr>
</table>
...
<TR>
	...
	<!--<a href="Xtreme_Entertainment.pdf" target="new"><img src="images/xepLOGO_small.gif" border="0"></a><br><br>
	<a href="Ultimate_Wireless.pdf" target="new"><img src="images/wirelessLOGO_small.gif" border="0"></a>-->
	</TD>
</TR>
</TABLE>
<!-- END TABLE 8 -->
