...
<BODY BGCOLOR="#FFFFFF" LEFTMARGIN="0" TOPMARGIN="0" MARGINWIDTH="0" MARGINHEIGHT="0" ONLOAD="document.searchByExhibitorName.reset(); init();">
...
<span class="head">Company Quick Find</span><br><br>



<form name="searchByExhibitorName" action="awards_exhibitor_name_search_results.asp" method="post">
<table width="100%" cellpadding="0" cellspacing="0" border="0">

<tr cols="4">
	<td colspan="4" width="100%">
	Type in all or part of your company's name to locate the exhibitor.
	</td>
</tr>
...
<tr cols="4">
	<td colspan="1" width="25%" class="formIdentifier">Company Name:&nbsp;&nbsp;</td>
