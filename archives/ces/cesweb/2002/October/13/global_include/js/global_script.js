...
function preloadExhibitorImages() {
	...
	if (document.images) {
		subtab_exhibitors_exhibiting_standard = new Image();
		...
		subtab_exhibitors_exhibiting_active = new Image();
		...
		subtab_exhibitors_exhibiting_standard.src = "/global_images/subtab_exhibitors_exhibiting.gif";
		...
		subtab_exhibitors_exhibiting_active.src = "/global_images/subtab_exhibitors_exhibiting_active.gif";
