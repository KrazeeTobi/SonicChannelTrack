...
<META NAME="description" CONTENT="Die weltgrößte jährliche Handelsmesse für jeden, der im Geschäftsbereich der Herstellung, dem Verkauf, des Marketings und der Entwicklung von Konsumtechnologie tätig ist. Internationale Visionäre im Bereich von Content Media, Lieferung und Hardware veranschaulichen auf der CES neue Businessmodelle und Konsumanwendungen, die durch neue Technologien ermöglicht wurden.">

<meta name="keywords" content="Konsumerelektronik, CES, WCES, IT, Digital, Technologieausbildung, Informationstechnologie, Technologiekonferenzen, Technologie Handesmessen, Gespräche, Las Vegas Show, E-Commerce, Digitales TV, Bluetooth, Digitalkamera, Internetanwendungen, Palmtop PC, MP3, Wireless, Kleinbüro, DVD, Satellit, Heimkino, Audio, Home Networking, Telefone, Surround, Video, Computer, Home Office, Technologie- und Elektronikveranstaltungen, Mobile Elektronik">
...
<TR>
	...
	<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0">
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/international/deutsch/default.asp');" ONMOUSEOVER="rollover_td('general','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('general','leftsubnav_main_active');">
		<TD ID="general_cellspacer">&nbsp;</TD>
		<TD ID="general"><a href="/international/deutsch/default.asp" CLASS="leftsubnav_main_active">Allgemeine Informationen</a></TD>
	...
	<TR CLASS="leftsubnav_main" ONCLICK="goto_link('/international/deutsch/services.asp');" ONMOUSEOVER="rollover_td('services','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('services','leftsubnav_main');">
		<TD ID="services_cellspacer">&nbsp;</TD>
		<TD ID="services"><a href="/international/deutsch/services.asp" CLASS="leftsubnav_main">Besucherservice</a></TD>
...
<table width="90%" align="center">
	...
	<span class="subhead" style="text-align: left">CES:<br>Die EINE MESSE, die Sie NICHT versäumen dEfen</span><br>
	<span style="color: #004AA0">Eine unglaubliche Kaufkraft von 89% (USD85 Milliarden) der Konsumelektronikindustrie wurde auf der Internationalen CES 2002 festgestellt.</span><br><br>
	<br><A HREF="http://www.ce.org" target="new"><IMG SRC="/global_images/CEAproCESlogo.gif" BORDER="0"></A><br>
	<!--<span style="color: #006E93;">CES wird von der Consumer Elektronics Association (CEA) gesponsert, produziert und verwaltet.
	FE weitere Informationen Eer CEA besuchen Sie bitte <A target="new" HREF="http://www.ce.org">www.ce.org</A><br>
	</span>-->
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="5.2.1">
<span class="pagehead">Internationale Gäste :: Allgemeine Informationen</span><br><br>
<span class="head">Erfahren Sie eine Messe der Konsumtechnologie, wie keine andere in dieser Welt.</span>
<br><br>
<span class="subhead">Die Internationale CES – 9.  – 12. Januar, Las Vegas, Nevada, USA</span><br>

Die  Internationale CES 2003 ist die größte Handelsmesse der Konsumtechnologieprodukte weltweit. Sie erleben und erfahren:
<br><br>
<ul>
<li><b>Mehr innovative Produkte.</b> Zweitausend Aussteller gestalten ein erlebnisreiches Schaufenster aus dem Bereich der Konsumelektronik.

<li><b>Mehr Erlebnisse.</b> Sehen Sie die erstaunlichsten Produkte der Kommunikations-, Unterhaltungs-, Computer- und Netzwerkindustrie, die die digitale Welt zu bieten hat.

<li><b>Mehr Geschäftsmöglichkeiten.</b> Treffen Sie Industrieführer und Innovatoren – und vielleicht Ihre nächsten globalen Geschäftpartner.
</ul>
<br>
Treffen Sie sich mit 100.000 Experten, einschließlich 10.000 internationale Besucher aus 100 Ländern außerhalb der USA. Die CES ist eine Handelsmesse, ein Geschäftsforum, eine Konferenz mit mehr als 100 Bildungsseminaren und ein Platz, um Menschen zu treffen, die für Ihre Unternehmenszukunft wichtig sein können.
<br><br>
<b><i>Versäumen Sie nicht das wichtigste Technologieereignis des Jahres!</i></b><br><br>

<span class="subhead">Registrierung ab sofort möglich!</span><br>
Finden Sie heraus, wie Sie große Einsparungen erzielen, wenn Sie sich für das <a href="http://ww4.expocard.com/ces031/">International Premier Package (Internationales Premium Paket) registrieren lassen</a>.
<!--<span class="subhead">Die Registrierung beginnt am 1. August 2002</span><br>
<b>Seien Sie de erste bei der Registrierung!</b> Bitte <a href="/registration/default.asp">geben Sie uns Ihre E-Mail Adresse</a> und Sie erhalten von uns Benachrichtigungen über Registrierung, Konferenzsitzungen und spezielle Ereignisse.-->
<br><br>

<span class="subhead">Visa und Offizielle Einladungsschreiben </span><br>
Um unseren internationalen Gästen, die ein Einladungsschreiben benötigen, besser dienen zu können, werden Sie jetzt in der Lage sein, das Einladungsschreiben zur Beantragung des zeitlich begrenzten Visa zum Besuch der Internationalen CES gleichzeitig mit Ihrer Registrierung anzufordern. Tragen Sie einfach im vorgesehenen Feld der Registrierungsseite ein, dass Sie ein offizielles Einladungsschreiben benötigen und wir werden es für Sie vorbereiten. Ihre Anfrage wird innerhalb von 48 Stunden bearbeitet und Sie können davon ausgehen, dass Sie Ihr Schreiben innerhalb der nächsten 3 bis 4 Wochen erhalten.<br><br>
Hier sind weitere Informationen darüber abrufbar, wie man <a target="new" href="http://www.travel.state.gov/visa_services.html">einen Antrag auf ein Besuchervisa zur Einreise in die USA stellt.</a><br><br>
Hier erhalten Sie ein <a target="new" href="http://www.travel.state.gov/DS-0156.pdf">US Visa Antragsformular (Formular DS-0156) </a><br><br>
Finden Sie den für Sie am nächsten gelegenen Standort einer <a target="new" href="http://www.travel.state.gov/links.html">US Botschaft oder eines Konsulats</a>.<br><br>
<span class="subhead">U.S. State Department Visa Waiver Program (Programm des US Außenministeriums zur Visabefreiung) </span><br>
Besucher aus bestimmten Ländern, die sich geschäftlich oder als Tourist für 90 Tage oder weniger in den USA aufhalten, können rechtmäßig in die USA ohne Visa einreisen. Gegenwärtig nehmen 28 Länder am Programm zur Visabefreiung teil:<br><br>
<table width="45%" cellspacing="0" cellpadding="0"  border="0">
	<tr class="ledgershadow">
		<td width="60%">Andorra</td>
		<td>&nbsp;&nbsp;</td>
		<td>Luxemburg</td>
	</tr>
...
<br>
Hier erhalten Sie weitere Informationen über das <a target="new" href="http://www.travel.state.gov/vwp.html">U.S. State Department’s Visa Waiver Program (Programm des US Außenministeriums zur Visabefreiung)</a>.<br><br>
</div>
<!-- **CONTENT ENDS HERE** -->
	...
	<TD VALIGN="top" width="135" bgcolor="#ffffff">
		...
		<TR>
			...
			<TD>
				...
				<div align="center" class="callout">Internationale CES</div>
				<div align="center"><strong>9 E12 Januar 2003<br>Las Vegas, Nevada</strong></div>
		...
		<TR>
			...
			<TD>
				...
				<b>Ihre Zeit ist extrem wertvoll.</b><br>
				Nutzen Sie die Vorteile unseres <a href="services.asp">für internationale Besucher</a>.
