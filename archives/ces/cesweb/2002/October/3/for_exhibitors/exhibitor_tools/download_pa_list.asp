...
<TITLE>2003 International CES: CES Press & Analyst List</TITLE>
...
<TR>
	...
	<TR CLASS="leftsubnav_exhibitors_active" ONCLICK="goto_link('/for_exhibitors/exhibitor_tools/download_pa_list.asp');" ONMOUSEOVER="rollover_td('download','leftsubnav_exhibitors_active');" ONMOUSEOUT="rollover_td('download','leftsubnav_exhibitors_active');">	
		<TD ID="download_cellspacer">&nbsp;</TD>
		<TD ID="download"><A HREF="/for_exhibitors/exhibitor_tools/download_pa_list.asp" CLASS="leftsubnav_exhibitors_active">CES Press &amp; Analyst List</A></TD>
		<TD ID="download_arrowcell"><IMG SRC="/global_images/context_arrow-new.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","2.4.8")><IMG SRC="/global_images/page_tool_print.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="2.4.8">
<span class="pagehead">Exhibitor Tools :: CES Press &amp; Analyst List</span><br><br>
<span class="head">Download the 2003 CES Pre-Registered Media List</span>
<br><br>
<strong>Drive media to your booth and on-site events by contacting them in advance of the show.</strong>
<br><br>
Look for the master list of verified attendee media on <b>November 1, 2002</b>. 
<br><br>
The pre-registered media list also includes financial/market analysts registered for CES.  All the lists are downloadable in ASCII format.
<br><br>
On the registration form, individuals must choose to release their telephone, fax and e-mail address.  If that contact information is not listed for an individual, then he/she did not give CES the information or does not wish to have it released.
<br><br>
Each entry also lists the individual's badge category, primary target audience, news format and product interests. 
<br><br>
<strong>This list is provided to CES exhibitors and their PR agencies only.</strong>
</div>
<!-- **CONTENT ENDS HERE** -->
