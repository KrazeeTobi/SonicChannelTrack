...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","3.5.1")><IMG SRC="/global_images/page_tool_print.gif" BORDER="0"></A><br>
...
<BR>
Download the following comprehensive reports containing the Public Relations Contact information for all Exhibitors:
<BR><BR>
