...
<TITLE>2003 International CES: 해외 참관인</TITLE>
...
<META NAME="description" CONTENT="소비자 기술의 제조, 판매, 마케팅 및 개발과 관련된 세계 최대의 연례 무역박람회. CES를 통해 컨텐트 미디어, 디리버리 및 하드웨어 분야의 국제적인 이상주의자들은 기술적으로 가능한 새로운 비즈니스 모델과 소비자 응용제품을 제시합니다.">

<meta name="keywords" content="소비자 전자제품, CES, WCES, IT, 디지털, 기술 교육, 정보 기술, 기술 회의, 기술 무역박람회, convergence, 라스 베이거스 쇼, E-커머스, 디지털 TV, 블루투스, 디지털 카메라, 인터넷 가전, 핸드헬드 PC, MP3, 무선, 스몰 오피스, dvd, 위성, 홈 시어터, 오디오, 홈 네트워킹, 전화, 서라운드, 비디오, 컴퓨터, 홈 오피스, 기술 이벤트, 전자 이벤트, 모바일 전자제품">
...
<TR>
	...
	<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0">
		<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/international/korean/default.asp');" ONMOUSEOVER="rollover_td('general','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('general','leftsubnav_main_active');">
			<TD ID="general_cellspacer">&nbsp;</TD>
			<TD ID="general"><a href="/international/korean/default.asp" CLASS="leftsubnav_main_active">일반 정보</a></TD>
		...
		<TR CLASS="leftsubnav_main" ONCLICK="goto_link('/international/korean/services.asp');" ONMOUSEOVER="rollover_td('services','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('services','leftsubnav_main');">
			<TD ID="services_cellspacer">&nbsp;</TD>
			<TD ID="services"><a href="/international/korean/services.asp" CLASS="leftsubnav_main">혖E갋� 서비스</a></TD>
...
<table width="90%" align="center">
	...
	<span class="subhead" style="text-align: left">CES:<br>꼭 참관해야 할<br>필수 박람회</span><br>
	<span style="color: #004AA0">2002 International CES에서의 소비자 가전분야 구매력은 89%(850억불)에 달했습니다.</span><br><br>
	<br><A HREF="http://www.ce.org" target="new"><IMG SRC="/global_images/CEAproCESlogo.gif" BORDER="0"></A><br>
	<!--<span style="color: #006E93;">CES는 CEA(Consumer Electronics Association)에서 후원, 주관 및 관리합니다. CEA에 대한 자세한 내용은 <A target="new" HREF="http://www.ce.org">www.ce.org</A>를 방문하십시오.<br>
	</span>-->
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="5.7.1">
<span class="pagehead">해외 참관인 :: 일반 정보</span><br><br>
<span class="head">세계 최대의 소비자 기술 박람회에 여러분을 초대합니다.</span>
<br><br>
<span class="subhead">2003 International CES, 1월 9 - 12, 미국, 네바다주, 라스 베이거스</span><br>

2003 International CES는 세계 최대의 소비자 기술 제품 무역 박람회입니다. 직접 눈으로 경험해 보십시오.
<br><br>
<ul>
<li><b>혁신적인 제품.</b> 2000여 출품업체 전시관에서는 놀라운 소비자 전자제품들을 전시합니다. 

<li><b>흥분과 열광.</b> 직접 오셔서 디지털 세계가 제공하는 놀라운 통신, 엔터테인먼트, 컴퓨터, 네트워킹 제품을 경험해 보십시오. 

<li><b>다양한 비즈니스 기회.</b> 여러분의 미래에 글로벌 비즈니스 파트너가 될 수 있는 업계의 선두주자와 첨단 기술업체와의 만남도 가질 수 있습니다.
</ul>
<br>
CES에는 미국을 포함하여 약 100개국에서 10,000명 이상의 해외 참관인 및 100,000명 이상의 전문가들이 참여합니다. CES는 무역박람회이며 동시에 비즈니스 포럼이며 100회 이상의 회의를 진행함으로써 귀사의 미래를 발전적으로 바꿔줄 사람들과의 만남의 장을 제공합니다.
<br><br>
<b><i>올해의 가장 영향력 있는 기술 이벤트를 놓치지 마십시오!</i></b><br><br> 
<span class="orange_callout">해외 참과인을 위한 특별 등록 패키지!</span><br>
<a href="http://ww4.expocard.com/ces031/">국제 프리미어 패키지</a>로 등록하시면 좌석이 제한된 빌 게이츠의 기조 연설을 제외한 모든 기조 연설에 VIP 좌석을 마련해 드리며, 모든 전시장 출입 및 CES Knowledge Track의 모든 교육 세션 참석이 가능하며, 전시회 첫 3일간에 해당하는 3장의 VIP 오찬 티켓과 1월 9일 국제 리셉션의 초대장을 제공하며, 별도의 등록 창구에서 등록하실 수 있으며, 방문객의 개인 자료나 CES 전시회 자료를 보관할 수 있는 고급 CES 롤링 컨퍼런스 가방(약 299달러 상당)을 드립니다.
<!--
<span class="subhead">등록이 개시되었습니다!</span><br>
<a href="http://ww4.expocard.com/ces031/">국제 프리미어 패키지</a>를 이용하여 등록하시면 비용 절감 방법을 찾을 수 있습니다.
-->
<!--<span class="subhead">2002년 8월 1일 등록 시작</span><br>
<b>최초 등록자가 되십시오!</b> 등록, 회의 세션 및 특별 이벤트에 대한 소식을 받을 수 있는 <a href="/registration/default.asp">전자 메일 주소를 제공</a>해 주십시오.
-->
<br><br>

<span class="subhead">비자 및 초청장</span><br>
International CES에 참관하기 위한 임시 비자 발급에 초청장이 필요하신 해외 방문객들은 등록과 동시에 비자 초청장을 요청하실 수 있습니다.  초청장이 필요한 경우 등록 페이지에 있는 란에 명시하기만 하면 임시 비자를 발급 받을 수 있도록 준비해 드립니다.  귀하의 요청은 48시간 이내에 처리되며 3~4주 내에 초청장을 받게 됩니다.<br><br>
<a target="new" href="http://www.travel.state.gov/visa_services.html">미국 방문 비자 신청</a>에 대한 자세한 내용을 보려면 클릭하십시오.<br><br>
<a target="new" href="http://www.travel.state.gov/DS-0156.pdf">미국 비자 신청 양식(Form DS-0156)</a> 다운로드<br><br>
<a target="new" href="http://www.travel.state.gov/links.html">미국 대사관 또는 영사관</a>의 위치<br><br>
<span class="subhead">미국무부 비자 면제 프로그램</span><br>
업무상 또는 여행 목적으로 90일 이내로 미국을 방문하는 비자 면제 국가의 방문객은 비자 없이도 미국에 입국하실 수 있습니다.  비자 면제 프로그램이 적용되는 28개국은 아래와 같습니다.<br><br>
...
<br>
<a target="new" href="http://www.travel.state.gov/vwp.html">미국무부 비자 면제 프로그램</a>에 대한 자세한 내용을 보려면 클릭하십시오.<br><br>
</div>
<!-- **CONTENT ENDS HERE** -->
	...
	<TD VALIGN="top" width="135" bgcolor="#ffffff">
		...
		<TR>
			...
			<TD>
				...
				<div align="center"><strong>2003년 1월 9-12일<br>네바다주 라스 베이거스</strong></div>
		...
		<TR>
			...
			<TD>
				...
				<b>당신의 시간은 소중합니다.</b><br>
                <a href="services.asp">해외 참관인 서비스</a>를 활용하십시오.
