...
-->
<TITLE>CES Internacional 2003: Visitantes internacionales</TITLE>
...
<META NAME="description" CONTENT="La mayor feria comercial anual del mundo para
cualquiera que esté relacionado con la fabricación, venta, comercialización y
desarrollo de tecnología de consumo. Los visionarios internacionales en medios
de contenido, suministro y hardware en CES ilustran nuevos modelos de negocios
y aplicaciones de consumo hechas posible por medio de la tecnología.">

<meta name="keywords" content="Electrónica de consumo, CES, WCES, IT, digital,
Formación tecnológica, Tecnología de la información, Conferencias sobre
tecnología, Feria comercial tecnologica, convergencia, Feria Las Vegas,
Comercio electrónico, Televisión digital, bluetooth, cámara digital,
electrodomésticos e internet, PC portátil, inalámbrico, pequeña oficina, dvd,
satélite, home theater, Audio, red del hogar, teléfonos, sonido envolvente,
video, ordenadores, oficina en casa, acontecimientos tecnológicos,
acontecimientos electrónicos, electrónica móvil.">

<LINK REL="stylesheet"
HREF="http://www.cesweb.org/global_include/css/global.css"
TYPE="text/css">
<a name="top"></a>
...
<TR>
	...
	<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0">
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/international/espanol/default.asp');" ONMOUSEOVER="rollover_td('general','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('general','leftsubnav_main_active');">
		<TD ID="general_cellspacer">&nbsp;</TD>
		<TD ID="general"><a href="/international/espanol/default.asp" CLASS="leftsubnav_main_active">Información general</a></TD>
	...
	<TR CLASS="leftsubnav_main" ONCLICK="goto_link('/international/espanol/services.asp');" ONMOUSEOVER="rollover_td('services','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('services','leftsubnav_main');">
		<TD ID="services_cellspacer">&nbsp;</TD>
		<TD ID="services"><a href="/international/espanol/services.asp" CLASS="leftsubnav_main">Servicios a los asistentes</a></TD>
...
<table width="90%" align="center">
	...
	<span class="subhead" style="text-align: left">CES:<br>La ÚNICA MUESTRA a la que DEBE asistir.</span><br>
	<span style="color: #004AA0">Un increíble 89% (USD 85 mil millones) del poder de compra de la industria de la electrónica de consumo se encontraba en el CES internacional 2002.</span><br><br>
	<br><A HREF="http://www.ce.org" target="new"><IMG SRC="/global_images/CEAproCESlogo.gif" BORDER="0"></A><br>
	<!--<span style="color: #006E93;">CES está patrocinado, producido y gestionado por la Consumer Electronics Association (CEA). Para conocer más sobre la CEA, visite <A target="new" HREF="http://www.ce.org">www.ce.org</A>.<br>
	</span>-->
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="5.3.1">
<span class="pagehead">Visitantes internacionales :: Información general
</span><br><br>
<span class="head">Está invitado a visitar una feria de tecnología de consumo
sin igual a ninguna otra en el mundo.</span>
<br><br>
<span class="subhead">CES Internacional 2003 – Del 9 al 12 de enero –
Las Vegas, Nevada, USA</span><br>

El CES Internacional 2003 es la mayor feria comercial de los productos de la
tecnología de consumo de todo el mundo. Verá y experimentará:
<br><br>
<ul>
<li><b>Más productos innovadores.</b> Dos mil muestras de expositores
una sorprendente selección de electrónica de consumo.

<li><b>Más emoción.</b> Venga y experimente la comunicación más
sorprendente, el entretenimiento, y los productos de ordenador y red
que el mundo digital tiene que ofrecer.

<li><b>Más oportunidades de negocio.</b> Reúnase con los líderes de la industria
y los innovadores-y quizás su próximo socio de negocios a nivel mundial.
</ul>
<br>
Únase a 100.000 profesionales, que incluyen 10.000 visitantes
internacionales de 100 países fuera de U.S.A. CES es una feria
comercial, un foro de negocios, una congreso con más de 100
sesiones de formación y un lugar para conocer a gente que puede hacer
la diferencia en el futuro de su empresa.
<br><br>
<b><i>¡No se pierda el acontecimiento tecnológico esencial del
año!</i></b><br><br>
<SPAN class=orange_callout>&iexcl;Paquete Especial de Inscripci&oacute;n S&oacute;lo para Asistentes Internacionales!</SPAN><BR>
El <A href="http://ww4.expocard.com/ces031/">Paquete Premier Internacional</A> ofrece 
ubicaciones VIP para todos los oradores principales (salvo Bill Gates donde la 
cantidad de asientos es limitada), acceso al sal&oacute;n de exposiciones y a 
todas las sesiones educativas de CES Knowledge Track, tres vales de almuerzo VIP 
para los primeros tres d&iacute;as del evento, un &aacute;rea exclusiva de inscripci&oacute;n, 
una invitaci&oacute;n a la Recepci&oacute;n Internacional que tendr&aacute; lugar 
el 9 de enero y un bolso conmemorativo con informaci&oacute;n &uacute;til para 
los visitantes y materiales de la conferencia CES - todo por US$299. 
<!--
<span class="subhead">¡La inscripción está ahora abierta!</span><br>
Descubra cómo puede ahorrar mucho al inscribirse para el <a href="http://ww4.expocard.com/ces031/">International Premier Package</a> (Paquete Premier Internacional).
-->
<br><br>
<!--<span class="subhead">La inscripción se abre el 1 de agosto de
2002</span><br>
<b>¡Sea el primero en inscribirse!</b> Denos <a
href="/registration/default.asp">por favor su e-mail</a>
para recibir información sobre la inscripción, sesiones de congreso
y acontecimientos especiales.
<br><br>-->

<span class="subhead">Visados y cartas de invitación</span><br>
Para servir mejor a nuestros asistentes internacionales que precisan una carta
de invitación para obtener un visado temporal para asistir al
CES Internacional, ahora le será posible solicitar una carta de visado
de invitación a la vez que se inscribe.  Indique
simplemente en el espacio que se facilita para ello en la página de inscripción,
que necesita una carta de invitación y le prepararemos una personalizada.
Procesaremos su solicitud en un plazo de 48 horas y puede esperar a
recibir su carta en un plazo de 3 a 4 semanas.<br><br>
Descubra más información sobre cómo <a target="new"
href="http://www.travel.state.gov/visa_services.html">solicitar
un visado de visitante a U.S.A.</a><br><br>
Obtenga un <a target="new"
href="http://www.travel.state.gov/DS-0156.pdf">Formulario de solicitud
de visado para U.S.A.(Formulario DS-0156) </a><br><br>
Encuentre la localización de la <a target="new"
href="http://www.travel.state.gov/links.html">Embajada o
del Consulado General U.S.A. más cercano a usted</a>.<br><br>
<span class="subhead">Programa de renuncia a visado del Departamento de Estado U.S.A. (Visa Waiver Program)</span><br>
Los visitantes de países cualificados, que vengan a los Estados Unidos
por negocios o turismo durante 90 días o menos, pueden tener derecho a
entrar en los Estados Unidos sin un visado. En la actualidad, son 28 los países
que participan en el Visa Waiver Program:<br><br>
<table width="45%" cellspacing="0" cellpadding="0"  border="0">
	<tr class="ledgershadow">
		<td width="60%">Alemania</td>
		<td>&nbsp;&nbsp;</td>
		<td>Italia</td>
	</tr>
...
<br>
Descubra más sobre <a target="new" href="http://www.travel.state.gov/vwp.html">el Visa Waiver Program del Departamento de Estado U.S.A.</a>.<br><br>
</div>
<!-- **CONTENT ENDS HERE** -->
	...
	<TD VALIGN="top" width="135" bgcolor="#ffffff">
		...
		<TR>
			...
			<TD>
				...
				<div align="center" class="callout">CES internacional</div>
				<div align="center"><strong>Del 9 al 12 de enero de 2003<br>Las Vegas, Nevada, USA.</strong></div>
		...
		<TR>
			...
			<TD>
				...
				<b>Su tiempo es muy valioso.</b><br>
				Aproveche nuestros <a href="services.asp">Servicios para asistentes</a>.
