...
<TR>
	...
	<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0">
	<TR CLASS="leftsubnav_main" ONCLICK="goto_link('/international/deutsch/default.asp');" ONMOUSEOVER="rollover_td('general','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('general','leftsubnav_main');">
		<TD ID="general_cellspacer">&nbsp;</TD>
		<TD ID="general"><a href="/international/deutsch/default.asp" CLASS="leftsubnav_main">Allgemeine Informationen</a></TD>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/international/deutsch/services.asp');" ONMOUSEOVER="rollover_td('services','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('services','leftsubnav_main_active');">
		<TD ID="services_cellspacer">&nbsp;</TD>
		<TD ID="services"><a href="/international/deutsch/services.asp" CLASS="leftsubnav_main_active">Besucherservice</a></TD>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="5.2.2">
<span class="pagehead">Internationale Gäste :: Besucherservice</span><br><br>
<span class="head">Maximieren Sie Ihre Zeit auf der CES</span><br><br>
<span class="subhead">Internationaler Besucherservice</span><br>
Die Internationale CES heißt Besucher aus der ganzen Welt willkommen. Wir schätzen es sehr, dass Sie große Entfernungen gereist sind, um an der CES teilzunehmen. Wir wissen, dass Ihre Zeit sehr kostbar ist. Deshalb stellen wir viele Dienstleistungen auf der CES zur Verfügung, um Ihren Aufenthalt so effektiv wie möglich zu gestalten.<br><br>
<b>International Commerce Center (ICC) (Internationales Handelszentrum)</b><br>
<em><b>Zwei Standorte stehen Ihnen zur Verfügung!</b></em><br>
Um sicherzustellen, dass Ihr CES Aufenthalt produktiv verläuft, freuen wir uns, Ihnen zwei ICC Standorte anbieten zu können – die Südhalle des Las Vegas Veranstaltungszentrums und das Las Vegas Hilton Hotel. An beiden ICC Standorten bieten wir Ihnen Geschäftsdienstleistungen an, wie z.B. Konferenzräume, Kopierer, Faxgerät und Internetverbindung. Das professionelle, mehrsprachige Personal steht Ihnen jederzeit zur Verfügung, um Ihnen mit Informationen sowie Übersetzungs- und Dolmetschleistungen behilflich zu sein.<br><br>
<b><em>ICC Geschäftsdienstleistungen:</em></b><br>
<ul>
	<li>Internetstationen
	<li>Private Konferenzräume – jeden Tag auf Stundenbasis reservierbar
	<li>Fax- und Kopiergeräte
	<li>Telefone, die nur mit Telefonkarten oder Kreditkarten genutzt werden können
</ul>
<br>
<b><em>ICC Öffnungszeiten:</em></b><br>
<table width="50%">
	<tr>
	<td>
	8. Januar<br>
...
<br>
<b>Dolmetscher auf der CES</b><br>
Dolmetscher stehen an beiden ICC Standorten für jeden zur Verfügung, der Hilfe in chinesischer, japanischer, deutscher oder spanischer Sprache benötigt.<br><br>
<b>Finden von Exportausstellern</b><br>
Die Internationale CES benennt Aussteller, zusammen mit den von ihnen hergestellten Produkten, die daran interessiert sind, in bestimmte Länder und Regionen zu exportieren. Anfang August können Sie in unserem Ausstellerverzeichnis nach Ausstellern suchen, die Ihren Markt erreichen möchten. Überprüfen Sie öfters den Bereich Aussteller auf der CES Webseite – Aussteller aktualisieren ihren Eintrag ständig, bis die Messe 2003 beginnt.<br><br>
<b>Internationaler Empfang</b><br>
Sie sind herzlich eingeladen, am CES Internationalen Empfang am Donnerstag, den 9. Januar 2003 teilzunehmen. Dies ist Ihre beste Gelegenheit, mit exportierenden Ausstellern und anderen internationalen Industriekollegen zusammenzutreffen. Einladungen werden vor Ort am Internationalen Registrierungsschalter oder im ICC Las Vegas Veranstaltungszentrum bzw. im Las Vegas Hilton Hotel erhältlich sein.<br><br>
<b>Transportmöglichkeiten bei der CES</b><br>
<b><i>Vom Flughafen.</i></b> Las Vegas bietet viele Transportvarianten vom und zum Flughafen, wie Shuttles, Mietwagen, Taxis oder Limousinen. Es verfügt aber auch über angenehme und leicht zugängliche Pendelbusse zum Strip und zur Innenstadt sowie ein öffentliches Transportsystem, welches jeden Tag festgesetzte Routen fährt.<br><br>
<b><i>Von offiziellen CES Hotels.</i></b> Ein kostenloser Shuttle Busservice wird Sie an allen vier Tagen der Messe von den offiziellen CES Hotels zum Las Vegas Veranstaltungszentrum fahren. Dieser Service steht Ihnen auch vom Veranstaltungszentrum zum Alexis Park Hotel zur Verfügung.<br><br>
<b>Zum ersten Mal in Las Vegas?</b><br>
Las Vegas ist eine der Top Touristenattraktionen der Welt. Ob man fein essen möchte, Top Qualität an Unterhaltung sucht oder Casinos, den Hooverdamm oder den Grand Canyon besuchen will, die <a target="new" href="http://www.lasvegasfreedom.com">Veranstaltungs- und Besucherbehörde Las Vegas </a>gibt Ihnen gern Informationen, um Ihre Reise zur Internationalen CES 2003 unvergesslich und vollständig zu gestalten.
<br><br>
Hier finden Sie weitere <a target="new" href="http://www.vegasfreedom.com/play-12.asp">Las Vegas Karten und Transportinformationen</a>.<br><br>
</div>
<!-- **CONTENT ENDS HERE** -->
