...
<META NAME="description" CONTENT="對涉及消費科技製造、銷售、營銷和開發的任何人士開放的世界最大的年度貿易博覽會。內容媒體、傳送和硬體方面的國際幻想家們在 CES 上展示新型業務模型和科技使之成為可能的消費者應用軟體。">

<meta name="keywords" content="消費電子，CES，WCES，IT，數位，科技教育，資訊科技，科技會議，科技博覽會，學科交叉滲透，拉斯維加斯博覽會，電子商貿，數位電視，藍牙，數碼相機，網際網路裝置，掌上電腦，MP3，無線，小型辦公室，dvd，衛星，家庭影院，音頻，家庭聯網，電話，環繞，視訊，電腦，總公司，科技大事，電子大事，流動電子">
...
<TR>
	...
	<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0">
		<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/international/chinese/default.asp');" ONMOUSEOVER="rollover_td('general','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('general','leftsubnav_main_active');">
			<TD ID="general_cellspacer"></TD>
			<TD ID="general"><a href="/international/chinese/default.asp" CLASS="leftsubnav_main_active">一般資訊</a></TD>
		...
		<TR CLASS="leftsubnav_main" ONCLICK="goto_link('/international/chinese/services.asp');" ONMOUSEOVER="rollover_td('services','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('services','leftsubnav_main');">
			<TD ID="services_cellspacer"></TD>
			<TD ID="services"><a href="/international/chinese/services.asp" CLASS="leftsubnav_main">與會人員服務</a></TD>
...
<table width="90%" align="center">
	...
	<span class="subhead" style="text-align: left">CES：您必須參加的<br>一個展覽盛會<br></span><br>
	<span style="color: #004AA0">消費電子產業竟有 89% 的購買力(850 億美元)源自 2002 International CES!</span><br><br>
	<br><A HREF="http://www.ce.org" target="new"><IMG SRC="/global_images/CEAproCESlogo.gif" BORDER="0"></A><br>
	<!--<span style="color: #006E93;">CES 由消費電子協會 (CEA) 發起、舉辦和管理。有關 ECEA 的詳情，請造訪 <A target="new" HREF="http://www.ce.org">www.ce.org</A><br>
	</span>-->
...
<!-- **CONTENT STARTS HERE** -->
<span class="pagehead">國際來賓：一般資訊</span><br><br>
<span class="head">歡迎您光臨舉世無雙的消費科技博覽會：</span> <br><br>
<span class="subhead">2003 International CES--1 月 9 - 12 日，美國內華達州拉斯維加斯</span><br>

2003 International CES 博覽會是全球規模最大的消費科技產品交易會。您將耳聞目睹、親身體驗： <br><br>
<ul>
<li><b>富於創新的產品。</b> 兩千個參展商將展出一系列令人驚異的消費電子產品。

<li><b>倍感振奮。</b> 來親自體驗這個數位世界奉獻的最令人振奮的通信、娛樂、電腦和網路產品。

<li><b>蘊含無限商機。</b> 會晤業界領導者和創新家--他們也許就是您的下一批全球業務合作夥伴。
</ul> <br> 有 100,000 名專業人員參加，包括來自美國以外的 100 多個國家的 10,000 名國際來賓。CES 是商品交易會、商業論壇、有 100 多場教育培訓會議的大型會議，是會晤能給您公司未來轉機的人們的場所。<br><br> <b><i>一年中最為重要的科技盛會，機不可失，時不再來！</i></b><br><br>

<span class="orange_callout">專為國際與會者設立的特別登錄套裝！</span><br>
<a href="http://ww4.expocard.com/ces031/">國際尊貴套裝</a>為所有要人提供 VIP 席位（席位有限，比爾蓋茨除外），享有 CES Knowledge Track 展台及全部研討會的入門場券，頭三天的三張 VIP 午餐券，造訪登錄專區，受邀參加一月九日的國際招待大會，以及一個富於紀念意義的 CES 會議卷包，內含有價值的參觀者資訊及  CES 展示材料 - 所有這一切僅需 $299（美元）。
<!--<span class="subhead">2002 年 8 月 1 日開始註冊</span><br> <b>現在就註冊!</b>請<a href="/registration/default.asp">提供您的電郵地址</a>，以接收有關註冊、會議和特殊事件的消息。 -->
<!--<span class="subhead">豋錄現已公開!</span><br>
請即瞭解如何透過豋錄<a href="http://ww4.expocard.com/ces031/">國際超級套裝</a>來獲取巨大優惠。
-->
<br><br>

<span class="subhead">簽證和請柬</span><br> 為更好地為需要簽證請柬以獲得參加 International CES 臨時簽證的國際來賓服務，您可以在註冊的同時申請一份簽證請柬。只要在註冊頁上提供的空白處指出您需要請柬，我們將會為您準備一份。我們會在 48 小時內處理您的請求，預計您會在 3 至 4 周內收到請柬。<br><br>想更詳細地瞭解如何<a target="new" href="http://www.travel.state.gov/visa_services.html">申請美國的入境簽證</a><br><br>獲得<a target="new" href="http://www.travel.state.gov/DS-0156.pdf">美國入境簽證申請表（表 DS-0156） </a><br><br>查找何處有<a target="new" href="http://www.travel.state.gov/links.html">離您最近的美國大使館或總領事館</a>。<br><br>
<span class="subhead">美國國務院簽證自動放棄程式</span><br> 來自獲准的國家、因業務或旅遊來美國 90 天以內的入境人員，沒有簽證會視為不符合進入美國的條件。目前有 28 個國家參加了簽證自動放棄程式：<br><br>
...
</table> <br>想更詳細地瞭解<a target="new" href="http://www.travel.state.gov/vwp.html">美國國務院簽證自動放棄程式</a>。<br><br> </div>
<!-- **CONTENT ENDS HERE** -->
	...
	<TD VALIGN="top" width="135" bgcolor="#ffffff">
		...
		<TR>
			...
			<TD>
                ...
                <div align="center"><strong>2003 年 1 月 9-12 日<br>內華達州拉斯維加斯</strong></div>
		...
		<TR>
			...
			<TD>
				...
				<b>您的時間极其寶貴，</b><br>
				所以何不充份利用我們的<a href="services.asp">國際與會人員服務</a>。
