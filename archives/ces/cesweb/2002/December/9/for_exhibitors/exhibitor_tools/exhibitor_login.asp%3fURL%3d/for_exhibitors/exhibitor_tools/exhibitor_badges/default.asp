...
<TITLE>2003 International CES: Exhibitor Tools Login</TITLE>
...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","2.4.0")><IMG SRC="/global_images/mail.gif" BORDER="0"></A><br>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","2.4.0")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<span class="pagehead">Exhibitor Tools :: Login</span><br><br>
        ...
        <TABLE border="0" cellpadding="5" cellspacing="0">        
			...
			<TR>  
				...
				<TD>
					...
					<input type="hidden" name="URL" value="/for_exhibitors/exhibitor_tools/exhibitor_badges/default.asp">
				</TD>
			<TR>    
			<TR>
