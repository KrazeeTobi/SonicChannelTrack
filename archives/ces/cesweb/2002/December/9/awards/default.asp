...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.6.1")><IMG SRC="/global_images/mail.gif" BORDER="0"></A><br>
...
CES hosts three prestigious awards programs to honor both industry leaders and groundbreaking products and technologies. <br><br>

<span class="subhead"><a href="innovations/default.asp">CES Innovations Awards</a></span><br>
The Innovations Awards program recognizes products that exhibit excellence in design and engineering at the International CES. The Industrial Designers Society of America (IDSA) endorses and acts as advisors to the program. The honorees are announced in mid-December with products on display at the Las Vegas Hilton during the show.
<br><br>
Learn how PR guru and journalist Edward Segal can help you generate news coverage about your entry by going to <a target="new" href="http://www.publicrelations.com/ces">http://www.publicrelations.com/ces.</a>
<!--<b>For the first time ever, this competition is open to non-International CES exhibitors.</b>-->
<br><br>
<span class="subhead"><a href="best_of_ces/default.asp">Best of CES</a></span><br>
TechTV's annual Best of CES awards honor the most outstanding new consumer technology products that debut at the International CES.   The judging takes place on-site at CES, with finalists chosen by Day 2 of CES and winners announced by the end of the show.

<br><br>
<span class="subhead"><a href="next_big_thing/default.asp">The Next Big Thing</a></span><br>
CNET and ZDNet honor the most promising products and technologies in personal technology and consumer electronics.  Produced by AnchorDesk’s David Coursey, the program will document the search for the Next Big Thing in a series of online reports that culminate at CES.  Stop by CNET’s booth in the Grand Lobby of the LVCC and the <a href="/conferences/search/session_detail.asp?ID_session=SS1&ID_track=SS03">Next Big Thing SuperSession</a> to find out what Coursey’s search has revealed.

<br><br>
<span class="subhead"><a href="hall_of_fame/default.asp">Consumer Electronics Hall of Fame</a></span><br>
Now in its fourth year, the CE Hall of Fame honors the movers and shakers that have made the consumer electronics industry what it is today. The bios and profiles of the new class of inductees are displayed throughout CES.
