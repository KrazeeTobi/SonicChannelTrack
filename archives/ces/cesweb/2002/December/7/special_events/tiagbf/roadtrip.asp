...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.4.6.1.3")><IMG SRC="/global_images/mail.gif" BORDER="0"></A><br>
...
<br>
<span class="callout">"Traveling In Style" Road Trip</span><br><br>
Building on the success of last year’s <i>Road to CES</i>, two women representatives from the Consumer Electronics Association (CEA), producer of the International CES, will be packing up and heading out to Vegas the only way they know how&mdash;in style!<br><br>

Jenny Miller and Anne-Taylor Griffith will hit the road, bound for the 2003 International CES with just a sampling of the latest technologies and gadgets you’ll want to check out at the show. From Washington, D.C., they’ll travel across the country&mdash;making stops in several cities along the way&mdash;loaded up with a variety of consumer technology products that no savvy traveler should be without. <br><br> 

Look for Jenny and Anne-Taylor’s online journal entries, complete with pictures and video footage, on www.CESweb.org. <br><br>

Visit again soon to see the route map and product descriptions of the technologies used on the <i>Traveling in Style Road Trip</i>.<br><br>
...
<TR>
	...
	<b>Sponsorship Opps</b><br>
	For <i>Traveling in Style Road Trip</i> <a href="/for_exhibitors/exhibit_promotion/ops_sponsorships.asp">sponsorship opportunities</a>, contact CES at (703) 907-7688 or <a href="mailto:PromoOpps@ce.org">PromoOpps@ce.org</a>.
	</TD>
</TR>
</TABLE>
<!-- END TABLE 8 -->
