...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.1.4.2.1")><IMG SRC="/global_images/mail.gif" BORDER="0"></A><br>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.1.4.2.1")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<BR>
<span class="head">Sessions by CES Track/Partner Program</span><br><br>
<table cellpadding=3 cellspacing=1 border=0 width='60%'><tr height=7><td></td></tr><tr><td><strong>No Track Selected - Please <a href=search_by_circuit.asp>try again</a></strong></td></tr></table>
