...
<TITLE>2003 International CES: Sirius Satellite Radio Las Vegas Challenge</TITLE>
...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","0.0.3")><IMG SRC="/global_images/mail.gif" BORDER="0"></A><br>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","0.0.3")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="0.0.3">
<span class="pagehead">Sirius Satellite Radio Las Vegas Challenge</span><br><br>
<img src="/race/images/vegas.gif"><br><br>
<!--<span class="head">Start Your Engines!</span>-->
<span class="subhead">Register below to play the Sirius Satellite Radio Las Vegas Challenge, produced by<br>the International CES.</span>
<br><br>
<b>Registration allows you to qualify for prizes, post your high score, and challenge a friend.</b>
Prizes include a Sirius Satellite Radio system, 2003 International CES Knowledge Track passes (a $396 value), and more!
<!-- INSERT CONTENT HERE -->
<form id="race_registration" method="post" action="race_Registration.asp">
<table border="0" width="100%">
	
	<tr>
		<td align="right" width="50%">First Name:&nbsp;</td>
		<td><input class="formData" type=textbox id=first_name name="first_name" size=20 maxlength=20 value=""></td>
	</tr>
	<tr>
		<td align="right">Last Name:&nbsp;</td>
		<td><input class="formData" type=textbox id=last_name name="last_name" size=20 maxlength=20 value=""></td>
	</tr>
	<tr>
		<td align="right">E-mail Address:&nbsp;</td>
		
			<td><input class="formData" type=textbox id=email_address name="email_address" size=30 maxlength=50 value=""></td>
		
	</tr>
	<tr>
		<td align="right">Are you a member of <a href="http://www.ce.org" target="new">CEA</a>?</td>
		<td><input type=Radio id=cea_member name=cea_member value="1"> Yes&nbsp;&nbsp;<input type=Radio id=cea_member name=cea_member value="0"> No</td>
	</tr>
	<tr>
		<td align="right">Do you plan to attend the 2003 International CES?</td>
		<td><input type=Radio id=attend_ces name=attend_ces value="1"> Yes&nbsp;&nbsp;<input type=Radio id=attend_ces name=attend_ces value="0"> No</td>
	</tr>
	<tr>
		<td align="right">Are you (or your company) engaged in the manufacturing, distribution, service, or promotion of consumer technology products?</td>
		<td valign="bottom"><input type=Radio id=tech_company name=tech_company value="1"> Yes&nbsp;&nbsp;<input type=Radio id=tech_company name=tech_company value="0"> No</td>
	</tr>
	<tr height=50>
		<td align=center colspan=2><input class="formData" type=submit value="Let's Race!"></td>
	</tr>
	<input type=hidden name="userEmail" value="">
	<input type=hidden name="RTID" value="">
	<input type=hidden name="userEmailchallengeEmail" value="">
	<input type=hidden name="challengeMsg" value="">
	
	<input type=hidden name="race_time" value="">	
</table>
...
<TR>
	...
	<b>Questions about the game?</b> <a href="mailto:race@ce.org">Email us</a>.<br><br>
	View the <a href="javascript:openNewWindow('rules.asp')">Official Game Rules and Prize Eligibility</a>. 
	</TD>
</TR>
</TABLE>
<!-- END TABLE 8 -->
