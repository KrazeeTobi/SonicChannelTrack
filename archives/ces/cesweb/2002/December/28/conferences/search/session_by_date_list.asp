...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.1.4.4.1")><IMG SRC="/global_images/mail.gif" BORDER="0"></A><br>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.1.4.4.1")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<BR>
<span class="head">Sessions by Date</span><br><br>
<table cellpadding=3 cellspacing=1 border=0><tr height=7><td></td></tr><tr><td><strong>No Date Selected - Please <a href=search_by_date.asp>try again</a></strong></td></tr></table>
<br><br>
</div>
<!-- **CONTENT ENDS HERE** -->
