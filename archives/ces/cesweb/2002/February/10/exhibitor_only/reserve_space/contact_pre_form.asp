...
<head>
<title>CES 2001 International</title>
...
function levyWindow() {
	repWindow = window.open('rep_a_levy.asp', 'repWin', 'width=350, height=150')
}

function amosWindow() {
	repWindow = window.open('rep_c_amos.asp', 'repWin', 'width=350, height=150')
}

function russoWindow() {
	repWindow = window.open('rep_c_russo.asp', 'repWin',  'width=350, height=150')
}

function stookeyWindow() {
	repWindow = window.open('rep_j_stookey.asp', 'repWin', 'width=350, height=150')
}

function smallwoodWindow() {
	repWindow = window.open('rep_k_smallwood.asp', 'repWin', 'width=350, height=150')
}

function strowgerWindow() {
	repWindow = window.open('rep_r_strowger.asp', 'repWin',  'width=350, height=150')
}
</script>
...
<font class="pagehead">The 2003 International CES Sales Representatives</font>
<br><br>
<!-- content starts here --> 

<font class="subhead2"><a href="mailto:exhibit@cesweb.org">Click here to have a CES Sales Representative contact you about exhibiting at CES.</a></font><p>
<font class="body">
Let us help you select the most ideal exhibit space for your company at the leading consumer 
technology event in 2003.
<p>

<table width="100%" cellpadding="3" border="0">

<tr>
<td><font class="body">Dan Cole - Sales & Business Development  (703) 907-7987&nbsp;&nbsp;<a href="mailto:dcole@ce.org">dcole@ce.org</a>
</td>
</tr>

<tr>
<td><font class="body">Chris Amos - Account Executive  (703) 907-7449&nbsp;&nbsp;<a href="mailto:camos@ce.org">camos@ce.org</a>
</td>
</tr>

<tr>
<td><font class="body">Paul Bascomb - Sales Coordinator  (703) 907-7661&nbsp;&nbsp;<a href="mailto:pbascomb@ce.org">pbascomb@ce.org</a>
</td>
</tr>

<tr>
<td><font class="body">Jayne Dalton - Staff Director, Exhibitor Services  (703) 907-7607&nbsp;&nbsp;<a href="mailto:jdalton@ce.org">jdalton@ce.org</a>
</td>

<tr>
<td><font class="body">Sylvia DeVore - Senior Coordinator, Exhibitor Services  (703) 907-7615&nbsp;&nbsp;<a href="mailto:sdevore@ce.org">sdevore@ce.org</a>
</td>
</tr>

<tr>
<td><font class="body">Matthew Hudson - Senior Sales Coordinator  (703) 907-7959&nbsp;&nbsp;<a href="mailto:mhudson@ce.org">mhudson@ce.org</a>
</td>
</tr>

<tr>
<td><font class="body">Scott Kromer - Temp Coordinator, Exhibitor Services  (703) 907-7020&nbsp;&nbsp;<a href="mailto:skromer@ce.org">skromer@ce.org</a>
</td>
</tr>

<tr>
<td><font class="body">Adam Levy - Account Executive  (703) 907-7450&nbsp;&nbsp;<a href="mailto:alevy@ce.org">alevy@ce.org</a>
</td>
</tr>

<tr>
<td><font class="body">Carole Russo - Account Executive  (703) 907-7795&nbsp;&nbsp;<a href="mailto:crusso@ce.org">crusso@ce.org</a>
</td>
</tr>

<tr>
<td><font class="body">Kirk Smallwood - Senior National Account Manager  (703) 907-7606&nbsp;&nbsp;<a href="mailto:ksmallwood@ce.org">ksmallwood@ce.org</a>
</td>
</tr>

<tr>
<td><font class="body">Jason Stookey - Account Executive  (703) 907-7678&nbsp;&nbsp;<a href="mailto:jstookey@ce.org">jstookey@ce.org</a>
</td>
</tr>

<tr>
<td><font class="body">Ryan Strowger - Account Executive  (703) 907-7679&nbsp;&nbsp;<a href="mailto:rstrowger@ce.org">rstrowger@ce.org</a>
</td>
</tr>
...
<tr><a name="reps">
<td colspan="2"><font class="body"><strong>Don't know your sales representative? Click your state for your 2003 International CES Sales Representative:</strong>
</td>

<tr>
<td colspan="2"><font class="body">
<a href="javascript:smallwoodWindow()">AK</a>&nbsp;&nbsp;
<a href="javascript:levyWindow()">AL</a>&nbsp;&nbsp;
<a href="javascript:stookeyWindow()">AR</a>&nbsp;&nbsp;
<a href="javascript:smallwoodWindow()">AZ</a>&nbsp;&nbsp;
<a href="javascript:smallwoodWindow()">CA(N)</a>&nbsp;&nbsp;
<a href="javascript:amosWindow()">CA(S)</a>&nbsp;&nbsp;
<a href="javascript:smallwoodWindow()">CO</a>&nbsp;&nbsp;
<a href="javascript:strowgerWindow()">CT</a>&nbsp;&nbsp;
<a href="javascript:levyWindow()">DC</a>&nbsp;&nbsp;
<a href="javascript:levyWindow()">DE</a>&nbsp;&nbsp;
<a href="javascript:levyWindow()">FL</a>&nbsp;&nbsp;
<a href="javascript:stookeyWindow()">GA</a>&nbsp;&nbsp;
<a href="javascript:amosWindow()">HI</a>&nbsp;&nbsp;
<a href="javascript:stookeyWindow()">IA</a>&nbsp;&nbsp;
<a href="javascript:smallwoodWindow()">ID</a>&nbsp;&nbsp;
<a href="javascript:stookeyWindow()">IL</a>&nbsp;&nbsp;
<a href="javascript:stookeyWindow()">IN</a>&nbsp;&nbsp;
<a href="javascript:stookeyWindow()">KS</a>&nbsp;&nbsp;
<a href="javascript:levyWindow()">KY</a>&nbsp;&nbsp;
<a href="javascript:levyWindow()">LA</a>&nbsp;&nbsp;
<a href="javascript:strowgerWindow()">ME</a>&nbsp;&nbsp;
<a href="javascript:strowgerWindow()">MA</a>&nbsp;&nbsp;
<a href="javascript:levyWindow()">MD</a>&nbsp;&nbsp;
<a href="javascript:stookeyWindow()">MI</a>&nbsp;&nbsp;
<a href="javascript:smallwoodWindow()">MN</a>&nbsp;&nbsp;
<a href="javascript:stookeyWindow()">MO</a>&nbsp;&nbsp;
<a href="javascript:levyWindow()">MS</a>&nbsp;&nbsp;
<a href="javascript:smallwoodWindow()">MT</a>&nbsp;&nbsp;
<a href="javascript:stookeyWindow()">NC</a>&nbsp;&nbsp;
<a href="javascript:stookeyWindow()">ND</a>&nbsp;&nbsp;
<a href="javascript:stookeyWindow()">NE</a>&nbsp;&nbsp;
<a href="javascript:strowgerWindow()">NH</a>&nbsp;&nbsp;
<a href="javascript:levyWindow()">NJ</a>&nbsp;&nbsp;
<a href="javascript:smallwoodWindow()">NM</a>&nbsp;&nbsp;
<a href="javascript:smallwoodWindow()">NV</a>&nbsp;&nbsp;
<a href="javascript:strowgerWindow()">NY</a>&nbsp;&nbsp;
<a href="javascript:stookeyWindow()">OH</a>&nbsp;&nbsp;
<a href="javascript:levyWindow()">OK</a>&nbsp;&nbsp;
<a href="javascript:smallwoodWindow()">OR</a>&nbsp;&nbsp;
<a href="javascript:levyWindow()">PA</a>&nbsp;&nbsp;
<a href="javascript:strowgerWindow()">RI</a>&nbsp;&nbsp;
<a href="javascript:stookeyWindow()">SC</a>&nbsp;&nbsp;
<a href="javascript:stookeyWindow()">SD</a>&nbsp;&nbsp;
<a href="javascript:levyWindow()">TN</a>&nbsp;&nbsp;
<a href="javascript:levyWindow()">TX</a>&nbsp;&nbsp;
<a href="javascript:smallwoodWindow()">UT</a>&nbsp;&nbsp;
<a href="javascript:levyWindow()">VA</a>&nbsp;&nbsp;
<a href="javascript:strowgerWindow()">VT</a>&nbsp;&nbsp;
<a href="javascript:smallwoodWindow()">WA</a>&nbsp;&nbsp;
<a href="javascript:stookeyWindow()">WI</a>&nbsp;&nbsp;
<a href="javascript:levyWindow()">WV</a>&nbsp;&nbsp;
<a href="javascript:smallwoodWindow()">WY</a>&nbsp;&nbsp;&nbsp;&nbsp;
<a href="javascript:russoWindow()">International Accounts</a>&nbsp;&nbsp;
</td>
</table>
...
<font class="righttext">CES is sponsored, produced and managed by the Consumer Electronics Association (CEA). To find out more about CEA, <a href="#">visit <a href="http://www.ce.org">www.ce.org</a>.<br>

<hr noshade size="1" width="100%" color="#78a5ab">

<font class="righttext">Don't know your sales representative? Click <a href="#reps">here</a> to locate your 2003 International CES Sales Representative.

<hr noshade size="1" width="100%" color="#78a5ab">

<font class="righttext">Interested in Promotional Opportunities? Call (703) 907-7688
