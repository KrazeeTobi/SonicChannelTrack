...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","4.3")><IMG SRC="/global_images/page_tool_print.gif" BORDER="0"></A><br>
...
The Speaker Ready Rooms are located in the Las Vegas Convention above the North Hall exhibits next to room N263 and in the New South Hall (TBD).
<br><br>
...
<br><br>
If you plan to use visuals during your session, all speakers are encouraged to use the CES PowerPoint template (to be provided). You must provide your own laptop. 
<br><br>
