...
<TR>
	...
	<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0">
	<TR CLASS="leftsubnav" ONCLICK="goto_link('/for_exhibitors/reserve_space/default.asp');" ONMOUSEOVER="rollover_td('overview','leftsubnav_exhibitors_active');" ONMOUSEOUT="rollover_td('overview','leftsubnav');">	
		<TD ID="overview_cellspacer">&nbsp;</TD>
		<TD ID="overview"><A HREF="/for_exhibitors/reserve_space/default.asp" CLASS="leftsubnav">Overview &amp; Deadlines</A></TD>
	...
	<TR CLASS="leftsubnav_exhibitors_active" ONCLICK="goto_link('/for_exhibitors/reserve_space/sales_reps.asp');" ONMOUSEOVER="rollover_td('cessalesreps','leftsubnav_exhibitors_active');" ONMOUSEOUT="rollover_td('cessalesreps','leftsubnav_exhibitors_active');">	
		<TD ID="cessalesreps_cellspacer">&nbsp;</TD>
		<TD ID="cessalesreps"><A HREF="/for_exhibitors/reserve_space/sales_reps.asp" CLASS="leftsubnav_exhibitors_active">CES Sales Contacts</A></TD>
		<TD ID="cessalesreps_arrowcell"><IMG SRC="/global_images/context_arrow.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","2.2.2")><IMG SRC="/global_images/page_tool_print.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="2.2.2">
<span class="pagehead">Reserve Space :: CES Sales Reps</span><br><br>
...
<tr><td><b>Dan Cole</b>
	...
	<td><b>Cindy Shin</b>
		<br>Manager, Promotional Opportunities
		<br>phone: 703 907 7688
		<br>e-mail: <a href="mailto:cshin@ce.org">cshin@ce.org</a>
	</td>
</tr>
