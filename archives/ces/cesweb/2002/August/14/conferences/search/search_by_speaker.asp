...
<TR>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/conferences/search/search_by_name.asp');" ONMOUSEOVER="rollover_td('searchprog','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('searchprog','leftsubnav_main_active');">
		...
		<TD ID="searchprog_arrowcell"><IMG SRC="/global_images/context_arrow.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.1.4.3")><IMG SRC="/global_images/page_tool_print.gif" BORDER="0"></A><br>
...
<form action=session_by_speaker_list.asp method=post><table cellpadding=3 cellspacing=1 border=0><tr><td>Choose a Speaker from the Drop-Down List</td></tr><tr height=7><td></td></tr><tr><td colspan=1><select class=formdata name=ID_speaker><option value=0>Choose a Speaker&nbsp;&nbsp;<option value=B495937>Alter, Bruce<option value=TIM909962>Bajarin, Tim<option value=S751156>Baker, Stephen<option value=M354351>Berryman, IDSA, Michelle<option value=J643322>Black, Jane<option value=J109020>Blecher, Joni<option value=D209484>Brewer, Donald<option value=R373882>Brown, Roger<option value=M408504>Candea, Michael<option value=R234172>Cericola, Rachel<option value=J450329>Chen, Janice<option value=B480541>Cooley, Brian<option value=E822475>Curran, Ed<option value=J997829>Dahl, John<option value=K578518>des Chatelets, Kristen<option value=N501766>Desmond, Ned<option value=M107128>Dever, Matt<option value=R338192>Doherty, Richard<option value=P48519>Eisenhauer, Paul<option value=D892711>Epstein, David<option value=K52822>Erdmann, Ken<option value=C456218>Evans, Craig<option value=G744701>Feather, Gary<option value=F816570>Fishkin, Fred<option value=T679485>Ford, Tracy<option value=M507030>Giorgio, Mary Anne <option value=J789730>Graham, Jefferson<option value=R494274>Green, Rich<option value=M922908>Greeson, Michael<option value=T352489>Hawthorne, Tim<option value=M87658>Heiss, Michael<option value=R343624>Hephner, Rob<option value=JUL417106>Jacobson, Julie<option value=MAU818622>Jenson, Maureen<option value=E755275>Johnson, Eric<option value=MIT360752>Klein, Mitchell<option value=J610515>Knott, Jason<option value=S93074>Kozlowski, Stan<option value=J609890>Kussard, Jeff<option value=M649776>Langberg, Mike<option value=M930431>Lasky, Michael<option value=S710567>Lawrence, Sam<option value=E809261>Matulis Myers, CAE, Elissa<option value=M833217>McConnaughey, Marc<option value=BIL255826>Menezes, Bill<option value=MIK917129>Mettler, Mike<option value=J812389>Meyers, Jason<option value=D183513>Nowak, David<option value=M256237>Paxton, Mike<option value=R410625>Pegoraro, Rob<option value=J976467>Rennie, John<option value=T603328>Rosencrans, Todd<option value=ROS612867>Rubin, Ross<option value=K482341>Scherf, Kurt<option value=A486400>Seybold, Andrew M.<option value=MUR814663>Slovick, Murray<option value=K991649>Smith, Ken<option value=M260067>Snider, Mike<option value=S988781>Somers, Steve<option value=C274791>Stevens, Cindy<option value=M154339>Stump, Matt<option value=D762096>Takahashi, Dean<option value=D861965>Tkachuk, David<option value=G82973>van Zuiden, Gordon<option value=F82805>White, Frank<option value=B675518>Whitlock, Bill<option value=STE146377>Wildstrom, Steve<option value=A532039>Willcox, Andy<option value=R972515>Wilson, Randy<option value=A813961>Wolfe, Ph.D., Andy<option value=R334407>Young, Ross</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
<br><br>
</div>
<!-- **CONTENT ENDS HERE** -->
