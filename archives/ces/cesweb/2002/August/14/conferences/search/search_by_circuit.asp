...
<form action=session_by_circuit_list.asp method=post><table cellpadding=3 cellspacing=1 border=0><tr><td>Choose a Track or Partner Program from the Drop-Down List</td></tr><tr height=7><td></td></tr><tr><td colspan=2><select class=formdata name=ID_track><option value=0>Choose a Track&nbsp;&nbsp;<option value=BSS03>Business Solutions<option value=CT03>Car Technologies<option value=CEDIA-CBM03>CEDIA Business Management Track<option value=CEDIA-CHN03>CEDIA Home Networking Track<option value=CEDIA-CHT03>CEDIA Home Theater Track<option value=CEDIA-CIF03>CEDIA Installation Fundamentals Track<option value=CEDIA03>CEDIA Installer Training Program<option value=CEDIA-CPC03>CEDIA Professional Certification Track<option value=CEDIA-CWH03>CEDIA Whole-House Systems Track<option value=ET03>Emerging Technologies<option value=G03>Gaming<option value=HE03>Home Entertainment<option value=IIS03>Industry Insider Series<option value=HN03>Networking<option value=PA03>Parks Associates<option value=SS03>SuperSessions<option value=W03>Wireless</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
<br><br>
</div>
<!-- **CONTENT ENDS HERE** -->
