...
<TITLE>2003 International CES: Best of CES Categories</TITLE>
<a name="top"></a>
<!-- **INSERT PAGE ID HERE** -->
...
<TR>
	...
	<TR CLASS="leftsubnav" ONCLICK="goto_link('/awards/innovations/default.asp');" ONMOUSEOVER="rollover_td('innovations','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('innovations','leftsubnav');">
		<TD ID="innovations_cellspacer">&nbsp;</TD>
		<TD ID="innovations"><a href="/awards/innovations/default.asp" CLASS="leftsubnav">CES Innovations</a></TD>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/awards/best_of_ces/default.asp');" ONMOUSEOVER="rollover_td('best','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('best','leftsubnav_main_active');">
		...
		<TD ID="best_arrowcell"><IMG SRC="/global_images/context_arrow.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.6.3.1")><IMG SRC="/global_images/page_tool_print.gif" BORDER="0"></A><br>
