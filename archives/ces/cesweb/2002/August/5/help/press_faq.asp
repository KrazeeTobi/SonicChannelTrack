...
<TR>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/help/press_faq.asp');" ONMOUSEOVER="rollover_td('press','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('press','leftsubnav_main_active');">
		...
		<TD ID="press_arrowcell"><IMG SRC="/global_images/context_arrow.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
		<TR CLASS="leftsubnav" ONCLICK="goto_link('/help/exhibitor_faq.asp');" ONMOUSEOVER="rollover_td('exhibitor','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('exhibitor','leftsubnav');">
		<TD ID="exhibitor_cellspacer">&nbsp;</TD>
		<TD ID="exhibitor"><A HREF="/help/exhibitor_faq.asp" CLASS="leftsubnav">Exhibitor FAQs</A></TD>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","0.4.3")><IMG SRC="/global_images/page_tool_print.gif" BORDER="0"></A><br>
...
Children 16 years of age and over may attend CES.  Children under the age of 16 must register as your guest and obtain a child wristband to be worn on-site.
<br><br>
<a href="#top">return to question list</a>
<br><br>
