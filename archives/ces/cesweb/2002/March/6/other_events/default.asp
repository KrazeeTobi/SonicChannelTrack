...
<table align="center" width="80%" border="0" cellpadding="2" cellspacing="0">
		...
		<tr>
			...
			<td  class="noshadow" width="80%">Mar 4 - 8</td>
		</tr>
	

		<tr>
			<td  class="shadow" width="80%">Electronic House Expo - Spring</td>
			<td  class="shadow" width="80%">Mar 6 - 9</td>
		</tr>
	

		<tr>
			<td  class="noshadow" width="80%">NARM</td>
			<td  class="noshadow" width="80%">Mar 9 - 12</td>
		</tr>
	

		<tr>
			<td  class="shadow" width="80%">NATM Buying Corporation</td>
			<td  class="shadow" width="80%">Mar 10 - 13</td>
		</tr>
	

		<tr>
			<td  class="noshadow" width="80%">Home Theatre Specialists of American</td>
			<td  class="noshadow" width="80%">Mar 10 - 13</td>
		</tr>
	

		<tr>
			<td  class="shadow" width="80%">CTIA Wirless Show</td>
			<td  class="shadow" width="80%">Mar 18 - 20</td>
		</tr>
	

		<tr>
			<td  class="noshadow" width="80%">IRMA</td>
			<td  class="noshadow" width="80%">Mar 20 - 24</td>
		</tr>
	

		<tr>
			<td  class="shadow" width="80%">NARDA</td>
			<td  class="shadow" width="80%">Mar 22 - 25</td>
		</tr>
	

		<tr>
			<td  class="noshadow" width="80%">JEDEX</td>
			<td  class="noshadow" width="80%">Mar 25 - 26</td>
		</tr>
		...
		<tr>
			<td  class="shadow" width="80%">ConnectExpo</td>
			<td  class="shadow" width="80%">Apr 16 - 18</td>
		</tr>
		...
		<tr>
			...
			<td  class="noshadow" width="80%">Sep 25 - 28</td>
		</tr>
	

		<tr>
			<td  class="shadow" width="80%">CEDIA Expo</td>
			<td  class="shadow" width="80%">Sep 25 - 29</td>
		</tr>
	
		<tr><td colspan="2"><br></td></tr>
		<tr>
			<td colspan="2"><font class="subhead">November 2002</font></td>
		</tr>
		

		<tr>
			<td  class="noshadow" width="80%">Electronic House Expo - Fall</td>
			<td  class="noshadow" width="80%">Nov 12 - 14</td>
		</tr>
	
		<tr><td colspan="2"><br></td></tr>
		<tr>
			<td colspan="2"><font class="subhead">September 2003</font></td>
		</tr>
		

		<tr>
			<td  class="shadow" width="80%"><a href=http://www.digitalhollywood.com>Digital Hollywood</a></td>
			<td  class="shadow" width="80%">Sep 22 - 26</td>
		</tr>
