...
<font class="pagehead">International CES Logo Instructions</font><br>
<br>
<font class="body">
<!-- content starts here --> 
Browse the <a href="javascript:parseAndGo('ces_logo_sheet.asp');">International CES Logo sheet</a> for your use in some of the following ways:<br>
<ul>
<li>National and local advertisements 
<li>Company newsletters						
<li>Add to your letterhead for show-related correspondence
<li>Specialty advertising giveaways
<li>Include on International CES Sales Achievement Awards
