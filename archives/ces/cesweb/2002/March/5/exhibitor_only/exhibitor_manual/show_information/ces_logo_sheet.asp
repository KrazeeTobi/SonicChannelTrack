...
<html>
<head>
	<title>2002 International CES: Exhibitor Manual</title>
	...
	<script language="javascript1.2">
		...
		var pageID = "2.10.1.8"; //INSERT PAGE ID HERE
	</script>
...
<font class="pagehead">International CES Logos</font><br>
<br>
<font class="body">
<!-- content starts here --> 

<font class="body">
Click on the file name to download the logo file.<p>
<table cellpadding="0" cellspacing="0" border="0" align=center width=95%>
<tr>
<td colspan=2 class="pressTableHeader">&nbsp;File Info</td>
<td colspan=2 class="pressTableHeader">Description</td>
<td class="pressTableHeader" align=center>Preview</td>
</tr>
<tr>
<td colspan=3><br></td>
</tr>
<tr>
<td class="pressTableContent">
<a href="images/2k2cesclr.jpg">2k2cesclr.jpg</a><br>
<font size=-2>JPG FILE</font><br>
</td>
<td>&nbsp;</td>
<td class="pressTableContent">2002 International CES Logo, color, white background, tagline.</td>
<td>&nbsp;</td>
<td class="pressTableContent" align=right><img src="/press_analysts_only/ces_logos/images/2k2cesclr.gif"></td>
</tr>
<tr>
...
<tr>
<td class="pressTableContent">
<a href="images/2k2cesbw.eps">2k2cesbw.eps</a><br>
<font size=-2>EPS FILE</font><br>
</td>
<td>&nbsp;</td>
<td class="pressTableContent">2002 International CES Logo, black and white, transparent background, tagline.</td>
<td>&nbsp;</td>
<td class="pressTableContent" align=right><img src="/press_analysts_only/ces_logos/images/2k2cesb&w1.gif"></td>
</tr>
<tr>
<td colspan=3><br><br></td>
</tr>
<tr>
<td class="pressTableContent">
<a href="images/2k2cescclr.eps">2k2cescclr.eps</a><br>
<font size=-2>EPS FILE</font><br>
</td>
<td>&nbsp;</td>
<td class="pressTableContent">2002 International CES Logo, color, transparent background, tagline.</td>
<td>&nbsp;</td>
<td class="pressTableContent" align=right><img src="/press_analysts_only/ces_logos/images/2k2cescclr.gif"></td>
</tr>
...
<tr>
<td class="pressTableContent">
<a href="images/2k2cessolid.eps">2k2cessolid.eps</a><br>
<font size=-2>EPS FILE</font><br>
</td>
<td>&nbsp;</td>
<td class="pressTableContent">2002 International CES Logo, black and white (solid black in place of colors), transparent background, tagline.</td>
<td>&nbsp;</td>
<td class="pressTableContent" align=right><img src="/press_analysts_only/ces_logos/images/2k2cessolid.gif"></td>
</tr>
<tr>
<td colspan=3><br><br></td>
</tr>
...
<tr>
<td class="pressTableContent">
<a href="images/CEAbw.eps">CEAbw.eps</a><br>
<font size=-2>EPS FILE</font><br>
</td>
<td>&nbsp;</td>
<td class="pressTableContent">CEA Logo, black & white, transparent background, tagline.</td>
<td>&nbsp;</td>
<td class="pressTableContent" align=right><img src="/press_analysts_only/ces_logos/images/CEAbw.gif"></td>
</tr>
...
<tr>
<td class="pressTableContent">
<a href="images/CEAclr.eps">CEAclr.eps</a><br>
<font size=-2>EPS FILE</font><br>
</td>
<td>&nbsp;</td>
<td class="pressTableContent">CEA Logo, color, transparent background, tagline.</td>
<td>&nbsp;</td>
<td class="pressTableContent" align=right><img src="/press_analysts_only/ces_logos/images/CEAclr.gif"></td>
</tr>
...
<tr>
<td class="pressTableContent">
<a href="images/icescl.eps">icescl.eps</a><br>
<font size=-2>EPS FILE</font><br>
</td>
<td>&nbsp;</td>
<td class="pressTableContent">CES Logo, color, transparent background, without tagline.</td>
<td>&nbsp;</td>
<td class="pressTableContent" align=right><img src="/press_analysts_only/ces_logos/images/icescl.gif"></td>
</tr>
</table>
...
<!--
THIS IS THE GET ADOBE ACROBAT READER TABLE...INSERT AS NEEDED
<table>
<tr><td valign=top><a href="http://www.adobe.com/products/acrobat/readstep.html"><img src="/press_analysts_only/ces_logos//global_images/getacro.gif" width=88 height=31 border=0 alt="Get the Adobe Acrobat Reader"></a></td><td><font class="body">This form is in Adobe PDF format. You will need the Adobe Acrobat reader in order to view the file.</font></td></tr>
</table>
-->
...
<script language="JavaScript">
function headerLocalNavConstant() 
	{
	var pathArray = thePath.split("/");
	var headerNavItem;
	if (pathArray[4] == "master_contact_list.asp") 
	{
		headerLocalNavItem = "contacts";
	} 
	else if (pathArray[4] == "faqs.asp")
	{
		headerLocalNavItem = "faqs";
	} 
	else if (pathArray[4] == "glossary.asp")
	{
		headerLocalNavItem = "glossary";
	} 
	else if (pathArray[4] == "tips_tricks.asp") 
	{
		headerLocalNavItem = "tips";
	} 
	else {
		headerLocalNavItem = "none";
	}

	//alert(headerLocalNavItem);

	return headerLocalNavItem;
}
</script>
<p>
<table cellpadding="0" cellspacing="0" border="0" valign="top" width="100%">
	<td bgcolor="#edf4f8" valign="center" align="center" nowrap>
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
		<tr><td class="headerRightNav" width="100%"  colspan="8"><img src="/global_images/nav_menu/right_nav/emhelp.gif">&nbsp;<br></td></tr>
		<tr><td class="generalRightNav" colspan="8"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>
		<tr align="center">
			<td class="generalRightNav">
				<script language="JavaScript">
				var headerLocalNavItem = headerLocalNavConstant();
				if (headerLocalNavItem == "contacts") 
				{
					document.write("<font class='localnavhl'>contacts</font>");
				}
				else
				{
					document.write("<a href='/exhibitor_only/exhibitor_manual/manual_help/master_contact_list.asp?menuItem=5&subMenuItem=0&tabName=Exhibitor' class='generalrightnav'><font class='localnav'>contacts</font></a>");
				}
				</script>
			</td>
			<td><font class="localnav">|</font></td>
			<td class="generalRightNav">
				<script language="JavaScript">
				if (headerLocalNavItem == "faqs") {
					document.write("<font class='localnavhl'>FAQs</font>");
				}
				else
				{
					document.write("<a href='/exhibitor_only/exhibitor_manual/manual_help/faqs.asp?menuItem=5&subMenuItem=0&tabName=Exhibitor' class='generalrightnav'><font class='localnav'>FAQs</font></a>");
				}
				</script>
			</td>
			<td><font class="localnav">|</font></td>
			<td class="generalRightNav">
				<script language="JavaScript">
				if (headerLocalNavItem == "glossary") {
					document.write("<font class='localnavhl'>glossary</font>");
				}
				else
				{
					document.write("<a href='/exhibitor_only/exhibitor_manual/manual_help/glossary.asp?menuItem=5&subMenuItem=0&tabName=Exhibitor' class='generalrightnav'><font class='localnav'>glossary</font></a>");
				}
				</script>
			</td>
			<td><font class="localnav">|</font></td>
 			<td class="generalRightNav">
				<script language="JavaScript">
				if (headerLocalNavItem == "tips") {
					document.write("<font class='localnavhl'>&nbsp;tips&nbsp;</font>");
				}
				else
				{
					document.write("<a href='/exhibitor_only/exhibitor_manual/manual_help/tips_tricks.asp?menuItem=5&subMenuItem=0&tabName=Exhibitor' class='generalrightnav'><font class='localnav'>&nbsp;tips&nbsp;</font></a>");
				}
				</script>
			</td>
			</tr>
...
<tr><td class="generalRightNav">&nbsp;&nbsp;<a href="javascript:parseAndGo('ges_service_contractor.asp');" class="generalRightNav">GES - Official Service Contractor</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;&nbsp;<a href="javascript:parseAndGo('onsite_mgt_offices.asp');" class="generalRightNav">On-site Show Management<br>&nbsp;&nbsp;Offices</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;&nbsp;<a href="javascript:parseAndGo('service_centers.asp');" class="generalRightNav">Exhibitor Service Centers</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;&nbsp;<a href="javascript:parseAndGo('first_aid.asp');" class="generalRightNav">First Aid</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;&nbsp;<a href="javascript:parseAndGo('ces_store.asp');" class="generalRightNav">CES Store</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;&nbsp;<a href="javascript:parseAndGo('show_locations_hours.asp');" class="generalRightNav">Show Locations &amp Hours</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;&nbsp;<a href="javascript:parseAndGo('decorations_colors.asp');" class="generalRightNav">Decorations &amp Show Colors</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;&nbsp;<a href="javascript:parseAndGo('ces_logo_instructions.asp');" class="generalRightNav">CES Logo Instructions</a></td></tr>
...
<script language="javascript">
	...
	{
		winWindow = window.open('/exhibitor_only/exhibitor_manual/exhibitor_manual_survey.asp','SurveyWin','width=385,height=565')
	}
</script>
...
<font class="head">No Online Transactions</font><br>
In response to exhibitor requests, CES offers order forms in a downloadable format. Sorry, there are no online transactions.<br>
<hr noshade size="1" width="100%" color="#78a5ab">
<font class="head">Exhibitor Manual Feedback</font><br>
Provide us with your <a href="javascript:surveyWindow()">feedback</a> about our online Exhibitor Manual!
</font><!-- added value main page - /default.asp -->
<script language="javascript">
	function newWindow(){
