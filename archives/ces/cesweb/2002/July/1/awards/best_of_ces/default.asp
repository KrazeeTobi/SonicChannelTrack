...
<br><BR>
TechTV, the only cable television network covering technology news, information and entertainment 24 hours a day, selects the winners of TechTV's annual Best of CES awards. These awards recognize and honor the most outstanding new consumer technology products that debut at the International CES.
<br><br>
Check back here in the fall for more information on entering products into the awards program for the 2003 CES.
<br><br>
<span class="subhead">Judging Criteria</span>
<BR>
Our judges only will evaluate products and prototypes that are being exhibited on the show floor of CES. Products will be evaluated based on the following criteria: <br><br>
<ul>
	<li>	Wow Factor: Does the product create an entirely new market or category, or does it completely change the economics or capability of an existing category. 
	<li>	Usability and Usefulness: Does the product actually solve a real problem or address a real need. Will customers purchase it, and if they do, will they be ecstatic about their new device. 
	<li>	Value: Is it affordable, within the constraints of the category, or is it just so expensive that no one will ever buy one 
</ul>
<BR>
<span class="subhead">How is the Best of CES award different from the CES Innovation award?</span>
<br>
The CES Innovation awards focus on the design of the most innovative products of 2002, including products already on the market. In addition, judges look at pictures, videos and text descriptions of products but do not do any hands-on evaluation. 
The Best of CES considers only products that have not yet begun or are just starting to ship. In addition to reviewing product information, pictures and videos, the judges test each product. 
The judging for Innovation is wrapped up by early November. The Best of CES judging happens at CES in January.
<br><br>
<span class="subhead">About TechTV</span>
<br>
TechTV, formerly known as ZDTV, is the on-air and online network dedicated to the digital lifestyle. Offering everything from industry news to product reviews, tech stocks to tech support, TechTV's original programming keeps the wired world informed and entertained. TechTV is one of the fastest growing cable networks, currently available in more than 19 million households and distributing content to 64 countries around the world. With more than 750,000 unique visitors per month, TechTV is a community destination that encourages viewer interaction through e-mail, live chat and video mail. TechTV is owned by Vulcan Ventures Inc.<br> 
