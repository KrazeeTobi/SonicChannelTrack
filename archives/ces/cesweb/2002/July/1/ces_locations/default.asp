...
<TITLE>2003 International CES: CES Locations</TITLE>
...
<TR>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/ces_locations/default.asp');" ONMOUSEOVER="rollover_td('locations','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('locations','leftsubnav_main_active');">
		...
		<TD ID="locations_arrowcell"><IMG SRC="/global_images/context_arrow.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	<TR CLASS="leftsubnav" ONCLICK="goto_link('/ces_locations/maps.asp');" ONMOUSEOVER="rollover_td('maps','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('maps','leftsubnav');">
		<TD ID="maps_cellspacer">&nbsp;</TD>
		<TD ID="maps"><a href="/ces_locations/maps.asp" CLASS="leftsubnav">Maps</a></TD>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.9.1")><IMG SRC="/global_images/page_tool_print.gif" BORDER="0"></A><br>
