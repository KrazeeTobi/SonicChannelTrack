...
<TR>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/travel/default.asp');" ONMOUSEOVER="rollover_td('hotel','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('hotel','leftsubnav_main_active');">
		...
		<TD ID="hotel_arrowcell"><IMG SRC="/global_images/context_arrow.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	<TR CLASS="leftsubnav" ONCLICK="goto_link('/travel/airlines_cars.asp');" ONMOUSEOVER="rollover_td('airline','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('airline','leftsubnav');">
		<TD ID="airline_cellspacer" CLASS="leftsubnav">&nbsp;</TD>
		<TD ID="airline" CLASS="leftsubnav"><A HREF="/travel/airlines_cars.asp" CLASS="leftsubnav">Airlines &amp; Rental Cars</A></TD>
		<TD ID="airline_arrowcell" CLASS="leftsubnav"><IMG SRC="/global_images/spacer.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	<TR CLASS="leftsubnav" ONCLICK="goto_link('/travel/shuttle.asp');" ONMOUSEOVER="rollover_td('shuttle','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('shuttle','leftsubnav');">
		<TD ID="shuttle_cellspacer" CLASS="leftsubnav">&nbsp;</TD>
		<TD ID="shuttle" CLASS="leftsubnav"><A HREF="/travel/shuttle.asp"  CLASS="leftsubnav">CES Shuttle</A></TD>
		<TD ID="shuttle_arrowcell" CLASS="leftsubnav"><IMG SRC="/global_images/spacer.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	<TR CLASS="leftsubnav" ONCLICK="goto_link('/travel/taxi_park.asp');" ONMOUSEOVER="rollover_td('taxi','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('taxi','leftsubnav');">
		<TD ID="taxi_cellspacer" CLASS="leftsubnav">&nbsp;</TD>
		<TD ID="taxi" CLASS="leftsubnav"><A HREF="/travel/taxi_park.asp"  CLASS="leftsubnav">Taxi &amp; Parking</A></TD>
		<TD ID="taxi_arrowcell" CLASS="leftsubnav"><IMG SRC="/global_images/spacer.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	<TR CLASS="leftsubnav" ONCLICK="goto_link('/travel/vegasinfo.asp');" ONMOUSEOVER="rollover_td('vegas','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('vegas','leftsubnav');">
		<TD ID="vegas_cellspacer" CLASS="leftsubnav">&nbsp;</TD>
		<TD ID="vegas" CLASS="leftsubnav"><A HREF="/travel/vegasinfo.asp" CLASS="leftsubnav">Las Vegas Info</A></TD>
