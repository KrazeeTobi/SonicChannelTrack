...
<head>
<title>2002 International CES:CES Exhibitor Press Releases</title>
...
<script language="javascript1.2">
			...
			{
				var endDate = document.searchForPR.dEndDate.value;
				var timePeriod = document.searchForPR.timeFrame.options[document.searchForPR.timeFrame.selectedIndex].value;
				var string;
				...
				switch(timePeriod)
					...
					case "1":
						...
						string = (startDateObj.getMonth() + 1) + '/' + startDateObj.getDate() + '/' + (startDateObj.getYear());
						document.searchForPR.dStartDate.value = string;
						document.searchForPR.submit();
						break;
					...
					default:
						startDateObj = new Date("01/01/00");
						string = (startDateObj.getMonth() + 1) + '/' + startDateObj.getDate() + '/' + (startDateObj.getYear());
						document.searchForPR.dStartDate.value = string;
						document.searchForPR.submit();
						break;
...
<font class="pagehead">Exhibitor Press Releases</font>
<p>
<font class="body">

<form name="searchForPR" action="press_release_search_results.asp?" method="POST">

<table width="100%" cellpadding="0" cellspacing="0" border="0">

	<tr cols="4" width="100%" valign="top">
	<td colspan="4"class="ExhibitorHeader">
	<font class="HeaderLabel">Time Frame</font>
	</td>
	</tr>
	...
	<tr cols="4" width="100%" valign="top">
	<td colspan="4">
	<font class="formIdentifier">Please choose the time period from which you would like to view the press releases.</font>
	</td>
	</tr>
	...
	<tr cols="4">
	<td colspan="1" width="25%"><font class="formIdentifier">Time Period:</font></td>
	<td colspan="3" width="75%"><select name="timeFrame" class="formData" size="1">
	<option value="unselected" selected>
	**********************All**********************
	</option>
	<option value="1">Press Releases From Today Only</option>
	<option value="2">Press Releases From The 7 Days Only</option>
	<option value="3">Press Releases From The 30 Days Only</option>
	</select>
	</td>
	</tr>
		...
		<input class="formData" type="button" name="Submit" value="Submit Form" OnClick="setStartDate()">&nbsp;<input class="formData" type="reset" name="Reset" value="Clear Form">
		</td>
		</tr>
	...
	<input type="hidden" name="dEndDate" value="1/4/02">

	<input type="hidden" name="dStartDate" value="">
