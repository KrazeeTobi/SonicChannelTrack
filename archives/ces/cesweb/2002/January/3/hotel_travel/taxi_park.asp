...
<html>
<head>
	<title>2002 International CES: Taxis and Parking</title>
	...
	<script language="javascript1.2">
		...
		var pageID = "1.8.4"; //INSERT PAGE ID HERE
	</script>
...
<font class="pagehead">Taxi and Parking</font><br>
<br>
<font class="body">
<!-- content starts here --> 
...
<a name="taxi"></a><font class="head">Taxi Service</font><p>
Ace Cab Company: 736-8383<br>
Yellow Cab: 873-2000<br>
Whittlesea Cab: 384-6111 <br>
Taxi stands are located outside all CES exhibit facilities.<p>

<a name="parking"></a><font class="head">Parking Information</font><p>
Parking is available this year, however, due to construction at the LVCC, parking is not available in the lots immediately adjacent to the LVCC.  Shuttle buses will be available to transport attendees between the convenient parking lots and exhibit facilities.  Attendees also are encouraged to take advantage of the complimentary CES shuttle buses from the hotels.  The Hilton, Riviera and Alexis Park will have available parking in their lots.<p>
