...
<html>
<head>
	<title>2002 International CES: Exhibitor Login</title>
	...
	<script language="javascript1.2">
		...
		var pageID = "2.13.0"; //INSERT PAGE ID HERE
	</script>
...
<BODY marginheight="0" marginwidth="0" leftmargin="0" topmargin="0" onLoad="exhibitorForm = document.form_login; setBannerAd('1'); init();">
...
<font class="pageHead">Exhibitor Login</font><p>
<font class="body">
<!-- content starts here --> 

<font class="head">Attention Exhibitors!</font><br>
<b>The deadline for the 2002 International CES Directory (print version) has passed!</b> All information you submit to this site from now through the show will be available in the online version only. <p>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <td>
        ...
        <TABLE border=0 cellpadding="5" cellspacing="0">        
            <TR>  
				<TD>
					<font class="formIdentifier">Exhibitor:</font>
				</TD>
				<TD>
					<font class="formData"><input type="text" name="ExhibitorName" class="formData" value=""></font>
					<font class="formData"><input type="button" class="formData" value="Choose Exhibitor" onClick="getExhibitorList();" id=button1 name=button1></font>
					<input type="hidden" name="ExhibitorID" value="">
					<input type="hidden" name="URL" value="">
				</TD>
			<TR>    
			<TR>
				<TD><font class="formIdentifier">Exhibitor ID:</font></TD>
				<TD><font class="formData"><input type=text size=10 name=TIMMS_ID maxlength=25></TD>
			</TR> 
			 <TR>
              <TD colspan=2 align=center><font class="body"><input type=submit value=Login id=submit1 name=submit1></font></TD>
            </TR>         
        </TABLE>
        </FORM>
        </CENTER>
...
<br>
			<font class="body">
				<p>Questions? Send an email to <a href="mailto:cesdirectory@ce.org">cesdirectory@ce.org</a>
			</font>
		</TD>
	</tr>
</table>
