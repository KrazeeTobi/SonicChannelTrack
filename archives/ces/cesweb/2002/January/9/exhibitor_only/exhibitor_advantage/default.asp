...
<head>
<title>2002 International CES: Exhibitor Advantage Newsletter</title>
...
<font class="pagehead">CES Exhibitor Advantage Newsletter</font>
<br><br>
...
<tr>
	<td valign="top"><img src="images/exhibitor_advantage.gif" width="20" height="400" vspace="0" border="0" alt="Exhibitor Advantage Newsletter"></td>
	<td valign="top"><font class="head">December, 2001</font><p>
	<font class="subhead">&nbsp;&nbsp;&nbsp;In this month's issue:</font>
	
	<ul>
	
	<li type="disc"><font class="body"><strong>On the Road to CES Media Tour:</strong> The Road to CES 2002 is a traveling showcase of the latest CE products used to entertain and inform the entire family while traveling across town or across country.</font>
	</li>
	
	<li type="disc"><font class="body"><strong>CES Fashion Extravaganza:</strong> The time has come! Come, see the excitement of the first-ever International CES fashion show</font>
	</li>
	
	<li type="disc"><font class="body"><strong>Events at the International Gateway:</strong> Join the worldwide CE community at the Hilton Beer Garden, located outside the International Gateway at the Las Vegas Hilton. Build relationships and explore business opportunities in an informal setting.</font>
	</li>
	
	<li type="disc"><font class="body"><strong>CEA Sales Tax Holidays:</strong> We need your help! To help spur consumer spending and stimulate the economy, the Consumer Electronics Association (CEA) has worked to a have a nationwide sales tax holiday included in the economic stimulus package.</font>
	</li>
	
	<li type="disc"><font class="body"><strong>TechTV at CES:</strong> CES TV reaches all attendees on the floor and in 50,000 CES hotel rooms! Build your brand awareness and promote your product at the four-day epicenter for all things electronic and digital.</font>
	</li>

	<li type="disc"><font class="body"><strong>Also:</strong> Lower Hotel Rates, Booth Staff Available, Exhibitor Helping Hand, and Registration Update.</font>
	</li>
	
	</ul>
	&nbsp;&nbsp;&nbsp;<a href="ExhAdvDec01.pdf"><font class="subhead">Read about these topics and more in this month's newsletter...</font></a>
	</td>
</tr>
...
<tr><td class="generalRightNav">&nbsp;<strong>Exhibitor Advantage Archive</strong></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;&nbsp;&nbsp;&nbsp;<a href="/exhibitor_only/exhibitor_advantage/ExhAdvNov01r.pdf" class="generalRightNav">November, 2001</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;&nbsp;&nbsp;&nbsp;<a href="/exhibitor_only/exhibitor_advantage/ExhAdvOct01.pdf" class="generalRightNav">October, 2001</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;&nbsp;&nbsp;&nbsp;<a href="/exhibitor_only/exhibitor_advantage/ExhAdvSep01.pdf" class="generalRightNav">September, 2001</a></td></tr>

<tr><td class="generalRightNav"><img src="/global_images/nav_menu/right_nav/spacerLine.gif"></td></tr>

<tr><td class="generalRightNav">&nbsp;&nbsp;&nbsp;&nbsp;<a href="/exhibitor_only/exhibitor_advantage/ExhAdvAug01.pdf" class="generalRightNav">August, 2001</a></td></tr>
