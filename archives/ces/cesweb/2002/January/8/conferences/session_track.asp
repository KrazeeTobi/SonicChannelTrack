...
<script language="javascript1.2">
	...
	<script language="javascript1.2">
		...
		var pageID = "1.2.4.B"; //INSERT PAGE ID HERE
	</script>
...
<font class="pagehead">Search by Circuit/Partner Program</font><br>
<br>
<font class="body">

<!-- content starts here --> 
	<form action=session_track_list.asp?menuItem=&subMenuItem=&tabName= method=post>
<form action=session_track_list.asp?menuItem=&subMenuItem=&tabName=method=post><table cellpadding=3 cellspacing=1 border=0 width='60%'><tr><td class=row_label align=center>Choose a Circuit or Partner Program from the Drop Down List</td></tr><tr><td><hr color='#006388' size=1></td></tr><tr><td align=center class=row_data colspan=2><select class=formdata name=ID_track><option value=0>Choose a Circuit&nbsp;&nbsp;<option value=B02>Business Solutions Circuit<option value=M02>Car Technologies Circuit<option value=MSS02>CEA Mobile Surround Summit<option value=CB02>CEDIA Business Management Circuit<option value=CET02>CEDIA Essential Technologies Circuit<option value=CHN02>CEDIA Home Networking Circuit<option value=CHT02>CEDIA Home Theater Circuit<option value=C02>CEDIA Installer Training Program<option value=CPC02>CEDIA Professional Certification Circuit<option value=CWH02>CEDIA Whole-House Circuit<option value=CO02>CONNECTIONS <SUP><FONT SIZE=-1>TM</FONT></SUP><option value=DH02>Digital Hollywood<option value=E02>Emerging Technologies Circuit<option value=Q02>Gartner Dataquest Predicts Consumer Technology<option value=GP02>Government and Public Policy Circuit<option value=HE02>Home Entertainment Circuit<option value=H02>Home Networking Circuit<option value=SBCA02>SBCA Satellite Program<option value=SS02>SuperSessions<option value=WR02>Wireless Retail Training Circuit<option value=W02>Wireless Technologies Circuit<option value=WO02>Workstyle Circuit</select></td></tr><tr><td><hr color='#006388' size=1></td></tr><tr><td colspan=2 align=center><input class=formdata type=submit value="Choose Circuit">&nbsp;<input class=formdata type=Reset></td></tr></table></form>
