...
<head>
	...
	<title>2005 International CES:&nbsp;Conference Program</title>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/1.0/1.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="380"  background="/global_images2005/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">International CES Conference Program<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
<br><br> 
<span class="subhead"><a href="speakers">Speaking Opportunities</a><br></span>
Due to an overwhelming response, the deadline for the 2005 International CES <a href="/attendees/conferences/speakers/speaker_form.asp">Call For Speakers</a> has been extended to Friday, August 13, 2004.
<br> 
...
Look for the complete conference schedule in September, which will likely include sessions addressing these topics:
...
<tr> 
	...
	View the online listing and register for conferences in September.
	</td>
...
<tr> 
    <td width="5" rowspan="2" valign="top" background="/global_images2005/1.0/1.0.box_L.gif"><img height="10" width="5" src="/global_images2005/spacer.gif" vspace="1"></td>
    <td width="180" valign="top" align="center" bgcolor="white"><img src="/attendees/conferences/images/gates.jpg" width="173" height="100" border="0"></td>
    <td width="5" rowspan="2" background="/global_images2005/1.0/1.0.box_R.gif"><img height="5" width="5" src="/global_images2005/spacer.gif"></td>
</tr>
<tr>
    <td valign="top" class="white_box_bg">
	<span class="text_colored">Notable industry experts share real-world advice and knowledge during CES conference sessions.</span></td>
</tr>
<tr> 
    <td width="5" height="14"><img height="14" width=5 src="/global_images2005/1.0/1.0.box_BL.gif" align="top"></td>
    <td width="180" height="14" align="right"><img height="14" width="180" src="/global_images2005/1.0/1.0.box_B.gif"></td>
...
<tr> 
    ...
    <td width="180" height="40" valign="top" class="attendees_box_bg"><span class="text_colored">&#8220;The 2004 CES is a fantastic world-class event; anyone doing anything of significance in relation to consumer electronics should be here!&#8221;</span><br></td>
...
<tr> 
    ...
    <td width="180" align="right" valign="top" class="attendees_box_bg"> 
      - Paul W. D'Arcy<BR>
      <span class="default10">Executive VP, Sanyo Fisher Co.</span></td>
