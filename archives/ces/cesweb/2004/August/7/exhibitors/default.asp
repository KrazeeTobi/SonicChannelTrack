...
<!-- primary navigation row -->
	<tr>
		...
		<td width="610" colspan="6"  background="/global_images2005/spacer.gif"><a href="/attendees/"  onmouseover=introllOver('tab_attendees'); onmouseout=introllOff('tab_attendees');><img name='tab_attendees' src="/global_images2005/2.0/random_main0/2.0_tab_attendees.gif" alt="Attendees" width="70" height="27" hspace="0" vspace="0" border="0" ></a><a href="/exhibitors/" onmouseover=introllOver('tab_exhibitor'); onmouseout=introllOff('tab_exhibitor');><img name='tab_exhibitor' src="/global_images2005/2.0/random_main0/2.0_tab_exhibitor.gif" alt="Exhibitor Services" width="118" height="27" hspace="0" vspace="0" border="0"></a><a href="/press/" onmouseover=introllOver('tab_press'); onmouseout=introllOff('tab_press');><img name='tab_press' src="/global_images2005/2.0/random_main0/2.0_tab_press.gif" width="78" height="27" alt="Press" border="0"></a><a href="/international/" onmouseover=introllOver('tab_international'); onmouseout=introllOff('tab_international');><a href="/international/" onmouseover=introllOver('tab_international'); onmouseout=introllOff('tab_international');><img src="/global_images2005/2.0/random_main0/2.0_tab_international.gif" width="134" height="27" alt="" border="0" name="tab_international"></a><img src="/global_images2005/2.0/random_main0/2.0_tab_right.gif" alt="" width="210" height="27" hspace="0" vspace="0" border="0"></td>
	</tr>
<!-- /primary navigation row -->
...
<!-- colored row with section color 4 - 5 pixels high -->
	<tr>
	    ...
	    <td width="140"></td>
	    <td width="10"></td>
	    <td width="610" colspan="6"  background="/global_images2005/spacer.gif" class="exhibitor4"><img src="/global_images2005/2.0/random_main0/2.0.bc_top.gif" width="610" height="5" hspace="0" vspace="0" border="0"></td>
	 </tr>
<!-- /colored row with section color 4 - 5 pixels high -->
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<td width="610" colspan="6" background="/global_images2005/spacer.gif" class="exhibitor5"><img src="/global_images2005/2.0/random_main0/2.0.bc.gif" width="610" height="40" hspace="0" vspace="0" border="0"></td>
...
-->
	...
	<tr>
	   	...
	   	<td width="380" class="exhibitor7" valign="top">
			...
			Plenty of pre-show, on-site and post-show marketing opportunities are available—and many are free. Pick your sponsorships early, and make sure to check out <a href="/exhibitors/promotions/press.asp?id=0#unveiled">CES Unveiled: The Official Press Event of the International CES</a>, a great way to get noticed by top-tier press before show doors open. <a href="/exhibitors/promotions/default.asp">Build your brand (BYB) now</a>.
			
			<br>
			<img src="/global_images2005/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
			<img src="/global_images2005/2.0/2.0.line.gif" alt="-----------------------------------------------" width="380" height="2" hspace="0" vspace="0" border="0"><br>
			<img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>			
			<span class="section_title">Knowing is more than half the battle</span><br><br>
			...
			<tr>
				...
				<td valign="top">
				Taking the guesswork out of anything you do also takes the anxiety and stress level down several notches. That's why attending the <a href="/exhibitors/resource_center/workshop">International CES Exhibitor Workshop</a> September 21 at the Las Vegas Convention Center with an experienced CES team and many of the show’s vendors is essential to your tradeshow experience. 
				<br><br>
				Read Dan's column in the <a href="/exhibitors/newsletter/aug2k4_pg1.asp">August issue</a> of Exhibitor's Source to learn more.				
				</td>
			</tr>
			</table>			
			<br><br>
