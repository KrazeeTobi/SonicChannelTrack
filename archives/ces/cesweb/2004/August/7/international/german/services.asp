...
<head>
	...
	<title>2005 International CES:&nbsp;German</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.4.3") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<!-- GERMAN -->
	...
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
	<a href="/international/german/delegations.asp">Delegationsgruppen-<br>programm</a><br>
	<img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br> 
	Internationales Serviceangebot</a><br>
	<img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Internationales Serviceangebot<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="4.4.3">	
<!-- text for main page -->

<span class="subhead">International Commerce Center (ICC)</span><br>
Das International Commerce Center ist ein idealer Treffpunkt für Sie und Ihre Kollegen und Kolleginnen, die ebenfalls die Messe besuchen. Hier können Sie Ihre E-Mail lesen, leichte Erfrischungen zu sich nehmen und Ihre Fragen zur Messe von unserem vielsprachigen Personal beantworten lassen. Die ICCs befinden sich auf der oberen Etage der South Hall des Las Vegas Convention Center und im Las Vegas Hilton und sie stehen allen internationalen Messebesuchern und Ausstellern offen.
<br><br>

<span class="subhead">Dolmetscher verfügbar</span><br>
Ein vielsprachiges Personal steht sowohl in beiden ICC-Räumlichkeiten als auch im internationalen Anmeldungsbereich auf der unteren Etage der South Hall zur Verfügung. Dolmetschdienste werden in sieben Sprachen angeboten: Spanisch, Deutsch, Französisch, Chinesisch, Japanisch, Koreanisch, Italienisch und Portugiesisch. 
<br><br>

<span class="subhead">Internationaler Empfang</span><br>
Genießen Sie den ersten Abend der Messe mit Networking mit Ausstellern und Teilnehmern aus aller Welt. Der internationale Empfang findet am Donnerstagabend, den 6. Januar, von 18.00 bis 19.30 Uhr in der South Hall, Raum S222, statt. Alle internationalen Besucher, Aussteller und Pressemitglieder sind zu dieser Networking-Veranstaltung eingeladen. 
<br><br>

Haben Sie Vorschläge, wie wir unser Serviceangebot an die internationalen Teilnehmer und Aussteller weiter ausbauen können? Dann schicken Sie bitte eine E-Mail an Diann Groff unter <a href="mailto:dgroff@ce.org">dgroff@ce.org</a>.
