...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.1.3") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">International Services<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
The International Commerce Center is a great meeting ground for you and your colleagues attending the show. Check your e-mail, enjoy the light refreshments and have your questions about the show answered by the multilingual staff. The ICCs are located in the upper level of the Las Vegas Convention Center South Hall and the Las Vegas Hilton and are available to all international attendees and exhibitors.  
<br><br>

<span class="subhead">Interpreters Available</span><br>
A multilingual staff is available onsite in both ICC locations and in the International Registration area on the lower level of the South Hall. The interpreters are fluent in several languages: Spanish, German, French, Chinese, Japanese, Korean, Italian and Portuguese.
<br><br>

<span class="subhead">International Reception</span><br>
Enjoy the first evening of the show networking with exhibitors and attendees from around the world. The international reception will be held Thursday evening, January 6, from 6:00-7:30 p.m. in the South Hall, Room S222.  All international attendees, exhibitors and press are invited to this networking event.  
<br><br>

Are there other services you would like to suggest we provide international attendees and exhibitors? E-mail Diann Groff at <a href="mailto:dgroff@ce.org">dgroff@ce.org</a>.
