...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.7.2") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">代表团团体方案<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<meta http-equiv="Content-Type" content="text/html; charset=gb2312"><div id="4.7.2">	
<!-- text for main page -->

国际消费电子产品展 CES 为您组团和带团来参加尽可能地提供方便。我们会与您同心协力，使您的努力成功，并使贵团成员对因随贵团旅行而得到的增值和奖励而感到高兴。 
<br><br>
今天就争取成为正式代表团的团长吧。做法很简单，只要填写 <a href="/international/english/pdf/international delegation group program application.pdf" target="_blank">Delegation Application form (pdf)</a>（PDF文件格式的代表团申请表），然后将其传真给 Elena Vasquez 即可，传真号码为 703-907-7602。
<br><br>

<span class="subhead">代表团团长将得到的优惠包括：</span>
<ul>
	...
	<li>您的大名将作为正式代表团团长列于国际消费电子产品展 CES 网站 (<a href="http://www.CESweb.org">www.CESweb.org</a>)。
	<li>您将被邀请出席国际代表团团长晚宴。 
	<li>您将得到一个带轮子的 CES 背包，这样您就可以带着您的展览资料轻松自如地在展厅内转悠。
</ul>
<br>

* <em>促销资料在使用徽标之前，必须先得到 CES 的审查和批准。</em>
<br><br>

<span class="subhead">代表团成员将获得的优惠包括：</span>
<ul>
	<li>来 CES 前，您有权上网查看参展厂商名册， 这些参展厂商向代表团的国家和地区进行出口或表示有兴趣出口。
	<li>有可能免费参加一个会议。
      <ul>
        <li> 每位代表团团长将得到 5-10 张免费入场券。每张入场券供一人免费进入一个会场。如果您有兴趣参加某一会议，请与您的代表团团长联系。 </li>
    </ul>
	<li>专供代表团成员的免费展品，外加入场券。
	<li>突出显示国际消费电子产品展 CES 热点的代表团指南。 
	<li>您将被邀请出席国际来宾招待会。 
	<li>您将应邀在会展开幕日的早上出席代表团成员早餐会，届时将免费供应欧洲大陆式早餐。
</ul>
