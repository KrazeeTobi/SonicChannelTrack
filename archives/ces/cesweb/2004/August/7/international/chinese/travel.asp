...
当您申请入美签证时，应该做的事情： 
<ol>
	<li><strong>尽早</strong>申请签证！美国所有驻外使馆均设立<a href="http://travel.state.gov/specialnotice.html" target="_blank">新审核程序</a>，这样就拉长了您的申请时间。美国领事馆建议您至少在旅行日前60天开始办理签证申请手续。您可以打电话到<a href="http://travel.state.gov/visa/questions_embassy.html" target="_blank">当地大使馆</a>的领事处，了解签证约谈的等候时间。
...
从2004年10月26日起，所有27个享有免签证来美待遇 (VWP) 国家的免签证旅客，必须出示电脑可读护照或美国签证。欲知详情，请参阅“关于免签证和所要求的电脑可读护照，<a href="http://travel.state.gov/visa/tempvisitors_novisa_waiver.html#7" target="_blank">我需要知道什么</a>。”
<br>
<br>
...
<ul>
<li><a href="https://evisaforms.state.gov/ds156.asp?lang=1" target="_blank">Nonimmigrant Visa Application (pdf) （PDF文件格式的非移民签证申请）</a>
