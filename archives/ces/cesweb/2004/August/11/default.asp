...
<!-- Rollover script -->	
		...
		<style>
			.text_colored, .intro_copy, .section_title, .subhead, .body_title, .intro_dates
				{color:#194286}
			.homepagelink {color : #FBB13E;}
			.homepagelink a, .homepagelink a:visited {color : #FBB13E; text-decoration:none;}
			.homepagelink a:hover {color : #FBB13E; text-decoration : underline;}
		</style>
...
<td width="50%" valign="top" background="/global_images2005/0.0/0.0_files/0.0_bg4.gif">&nbsp;</td>
<td width="1%" valign="top" background="/global_images2005/0.0/0.0_files/0.0_bg4.gif">
<!-- main table for site -->
...
<!-- primary navigation row -->
	<tr>
		...
		<td width="610" colspan="6"  background="/global_images2005/spacer.gif"><a href="/attendees/"  onmouseover=introllOver('tab_attendees'); onmouseout=introllOff('tab_attendees');><img name='tab_attendees' src="/global_images2005/0.0/random_main4/0.0_tab_attendees.gif" alt="Attendees" width="70" height="27" hspace="0" vspace="0" border="0" ></a><a href="/exhibitors/" onmouseover=introllOver('tab_exhibitor'); onmouseout=introllOff('tab_exhibitor');><img name='tab_exhibitor' src="/global_images2005/0.0/random_main4/0.0_tab_exhibitor.gif" alt="Exhibitor Services" width="118" height="27" hspace="0" vspace="0" border="0"></a><a href="/press/" onmouseover=introllOver('tab_press'); onmouseout=introllOff('tab_press');><img name='tab_press' src="/global_images2005/0.0/random_main4/0.0_tab_press.gif" width="78" height="27" alt="Press" border="0"></a><a href="/international/" onmouseover=introllOver('tab_international'); onmouseout=introllOff('tab_international');><img src="/global_images2005/0.0/random_main4/0.0_tab_international.gif" width="134" height="27" alt="" border="0" name="tab_international"></a><img src="/global_images2005/0.0/random_main4/0.0_tab_right.gif" alt="" width="210" height="27" hspace="0" vspace="0" border="0"></td>
	</tr>
<!-- /primary navigation row -->
...
<!-- colored row with section color 4 - 5 pixels high --> 
	<tr>
	    ...
	    <td width="140"></td>
	    <td width="10"></td>
	    <td width="610" colspan="6"  background="/global_images2005/spacer.gif" class="international4"><img src="/global_images2005/0.0/random_main4/0.0.bc_top.gif" width="610" height="5" hspace="0" vspace="0" border="0"></td>
	 </tr>
<!-- /colored row with section color 4 - 5 pixels high --> 	 
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<td width="610" colspan="6" background="/global_images2005/spacer.gif" class="international5"><img src="/global_images2005/0.0/random_main4/0.0.bc.gif" width="610" height="40" hspace="0" vspace="0" border="0"></td>
...
<img src="/global_images2005/0.0/random_main4/0.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a>
<br>
</span>
		...
		<!-- checking to see if the page is a main section page or not -->
			...
			<tr>
				...
				-->
				    ...
				    <td width="380" class="international9" valign="top" colspan=6>
					<table border=0 cellspacing=0 cellpadding=0>
					<tr>
						<td colspan=2><img src="global_images2005/0.0/random_main4/0.0.main.gif" alt="Main Image" width="610" height="149" border="0"></td>
					</tr>
					<tr>
						<td><a href="/register/" onmouseover=introllOver('register'); onmouseout=introllOff('register');><img src="global_images2005/0.0/random_main4/0.0_register.gif" alt="register" width="162" height="56" border="0" name="register" id="register"></a></td>
						<td><img src="global_images2005/0.0/random_main4/0.0.bottom.right.gif" alt="picture" width="448" height="56" border="0"></td>
					</tr>
					</table>
		...
		<tr>
			...
			<td width="375" valign="top"><img src="global_images2005/spacer.gif" width="10" height="18"><br>
				...
				<table cellspacing="0" cellpadding="0" border="0">
					<tr>
						<td width="90" valign="top"><img src="global_images2005/spacer.gif" width="10" height="2"><br><img src="/global_images2005/HPgatesbarrett.jpg" style="border: 1px #5c5c5c solid" alt="" width="90" height="71" border="0"></td>
						<td width="10">&nbsp;</td>
						<td width="275" valign="top"><font style="color:#ffffff">Microsoft and Intel executives, Bill Gates and Craig Barrett, will deliver the opening and pre-show keynotes at the upcoming world's largest consumer technology tradeshow.</font>
						<span class="homepagelink"><a href="/press/news/release_detail.asp?id=10515">Read on.</a></span></td>
					</tr>
					<tr>
						<td width="375" colspan="3"><img src="global_images2005/spacer.gif" width="1" height="10"></td>
					</tr>
					<tr>
						<td width="90" valign="top"><img src="global_images2005/spacer.gif" width="10" height="2"><br><img src="/global_images2005/HPmonorail.jpg" style="border: 1px #5c5c5c solid" alt="" width="90" height="68" border="0"></td>
						<td width="10">&nbsp;</td>
						<td width="275" valign="top"><font style="color:#ffffff">Some hotels are already full during the 2005 International CES. Book today and get the latest information on other updates, including the now-open Las Vegas Monorail.</font>
						<span class="homepagelink"><a href="/attendees/travel">Make your travel plans.</a></span></td>
					</tr>
				</table>
			</td>
			<td width="25" valign="top"></td>
			<td width="190" valign="top"><img src="global_images2005/spacer.gif" width="10" height="18"><BR>
			<!-- you can update the font here.. I don't have specs - AK -->
			<span style="color:#ffffff; font-weight:bold; font-size: 13px;">What's your interest?</span><br>
			<font style="color:#ffffff"><b>></b></font>&nbsp;&nbsp;<span class="homepagelink"><a href="/attendees/markets/audio.asp">Audio</a></span><br>
			<font style="color:#ffffff"><b>></b></font>&nbsp;&nbsp;<span class="homepagelink"><a href="/attendees/markets/imaging.asp">Digital Imaging</a></span><br>
			<font style="color:#ffffff"><b>></b></font>&nbsp;&nbsp;<span class="homepagelink"><a href="/attendees/markets/emergtech.asp">Emerging Technology</a></span><br>
			<font style="color:#ffffff"><b>></b></font>&nbsp;&nbsp;<span class="homepagelink"><a href="/attendees/markets/gaming.asp">Gaming</a></span><br>
			<font style="color:#ffffff"><b>></b></font>&nbsp;&nbsp;<span class="homepagelink"><a href="/attendees/markets/networking.asp">Home Networking</a></span><br>
			<font style="color:#ffffff"><b>></b></font>&nbsp;&nbsp;<span class="homepagelink"><a href="/attendees/markets/theater.asp">Home Theater/Video</a></span><br>
			<font style="color:#ffffff"><b>></b></font>&nbsp;&nbsp;<span class="homepagelink"><a href="/attendees/markets/mobile.asp">Mobile Electronics</a></span><br>
			<font style="color:#ffffff"><b>></b></font>&nbsp;&nbsp;<span class="homepagelink"><a href="/attendees/markets/wireless.asp">Wireless</a></span><br><br><br>
			</td>
			<td width="10" valign="top"></td>
		</tr>
		</table>
...
<!-- footer row -->
	<tr>
	    ...
	    <td width="140"></td>
	    <td width="10"></td>
	   	<td width="610" colspan=6><img src="global_images2005/0.0/0.0_bottom.gif" alt="" width="610" height="10" border="0"></td>
	</tr>
	<tr>
	    <td width="10"></td>
	    <td width="140"></td>
...
<td width="49%" valign="top" background="/global_images2005/0.0/0.0_files/0.0_bg4.gif">&nbsp;</td>
</tr>
</table>
