...
<!-- Rollover script -->
		...
		/* for graphical rollovers*/
			...
			function introllOver(which,name)
				{
				var on="/global_images2005/2.0/random_main4/2.0_" + which + "_r.gif";
				//var on="/global_images2005/2.0/2.0_" + which + "_r.gif";
				if(document.images) {document.images[which].src=on;}
				else if (document.GetElementById){document.GetElementById(name).src=on;}
				}
			function introllOff(which)
				{
				var on="/global_images2005/2.0/random_main4/2.0_" + which + ".gif";
				//var on="/global_images2005/2.0/2.0_" + which + ".gif";
				if(document.images){document.images[which].src=on;}
				else if (document.GetElementById){document.GetElementById(which).src=on;}
				}
...
<!-- logo and banner image row -->
	<tr>
	    ...
	    <td width="10"></td>
	    <td width="610" colspan="6"><img src="/global_images2005/2.0/random_main4/2.0.banner.gif" alt="" width="610" height="74" border="0"></td>
	</tr>
<!-- /logo and banner image row -->
...
<!-- table for secondary navigation and form -->
				...
				<td class="exhibitor_second_nav" width="560"><span class="exh_sec_nav_active"><a href='/exhibitors/space/'>Exhibit Space</a></span>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='/exhibitors/promotions/'>Promotions</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='/exhibitors/resource_center/'>Resource Center</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='/exhibitors/pr/'>PR Help</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='/exhibitors/manual/'>Manual</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='/exhibitors/newsletter/'>Newsletter</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='/exhibitors/downloads/'>Downloads</a></td>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.1.3") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<!--
	<table bgcolor="#E7F1DD" width="140" cellspacing="0" cellpadding="0" border="0">
		<tr>
		    <td width="10"><img src="/global_images2005/exhibitor_in_page_up_left_w.gif" alt="" width="10" height="10" hspace="0" vspace="0" border="0"></td>
		    <td width="120"><img src="/global_images2005/spacer.gif" alt="" width="120" height="10" hspace="0" vspace="0" border="0"></td>
		    <td width="10"><img src="/global_images2005/exhibitor_in_page_up_right_w.gif" alt="" width="10" height="10" hspace="0" vspace="0" border="0"></td>
		</tr>
		<tr>
		    <td>&nbsp;</td>
		...
		<tr>
		    <td width="10"><img src="/global_images2005/exhibitor_in_page_down_left_w.gif" alt="" width="10" height="10" hspace="0" vspace="0" border="0"></td>
		    <td width="120"><img src="/global_images2005/spacer.gif" alt="" width="120" height="10" hspace="0" vspace="0" border="0"></td>
		    <td width="10"><img src="/global_images2005/exhibitor_in_page_down_right_w.gif" alt="" width="10" height="10" hspace="0" vspace="0" border="0"></td>
		</tr>
	</table>
-->
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">2005 International CES TechZones<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
<img src="/attendees/show_floor/techzones/images/logo.gif" align="right" hspace="5" vspace="0">
See what brands are building and dominating in your market. Meet the tech players who set the standard for your niche. Get your hands on new and emerging technologies, products and companies. 
<br><br>
All in one spot. All at market-specific International CES TechZones. Look for the CES TechZone logo and get in the zone.
<br>
...
As you plan your 2005 business strategy, get what you need to know at the International CES TechZones. These zones&mdash;all located within the International CES&mdash;are concentrated versions of the markets they represent.
<br><br>
<img src="/attendees/show_floor/techzones/images/InnovationsPlus.gif" align="right" hspace="5" vspace="0">
<strong>NEW!</strong> Consider participation in the <strong>Innovations Plus</strong> exhibit area, home to a variety of CES TechZones. Located just outside the Las Vegas Convention Center in the Central Plaza, Innovations Plus also features the 2005 International CES Innovations Honorees displays.
<br><br>
<table width="590" cellspacing=0 cellpadding=2 border=0>
	...
	<tr class="exhibitor11">
		<td><a href="#assistive">Assistive Technologies</a></td>
		<td>Innovations Plus</td>
		<td><em>ABILITY</em> Magazine</td>
	</tr>
	<tr>
		<td><a href="#auto">Auto Aftermarket</a></td>
		<td>Hilton</td>
		<td></td>
	</tr>
	<!--<tr class="exhibitor11">
	...
	<tr class="exhibitor11">
		<td><a href="#connectedHome">Connected Home Entertainment</a></td>
	...
	<tr>
		<td><a href="#digitalCar">Digital Car/Telematics</a></td>
		<td>LVCC North</td>
		<td>ITS America</td>
	</tr>
	<tr class="exhibitor11">
		<td><a href="#DSL">DSL Forum</a></td>
		<td>Innovations Plus</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td><a href="#dvdram">DVD-RAM</a></td>
		<td>LVCC Central</td>
	...
	<tr class="exhibitor11">
		<td><a href="#energy">Energy Efficiency/Electronics Recycling</a></td>
		<td>South 3-4</td>
		<td>Energy Star, EPA</td>
	</tr>
	<tr>
		<td><a href="#flashForward">Flash Forward</a></td>
		<td>Central Plaza</td>
	...
	<tr class="exhibitor11">
		<td><a href="#memory">Memory Stick</a></td>
		<td>LVCC Central</td>
		<td></td>
	</tr>
	<tr>
		<td><a href="#MP3">MP3 and Internet Audio</a></td>
		<td>Innovations Plus</td>
		<td></td>
	</tr>
	<!--<tr class="exhibitor11">
		<td><a href="#personalBroadband">Personal Broadband</a></td>
		<td>Innovations Plus</td>
		<td></td>
	</tr>-->
	<tr class="exhibitor11">
		<td><a href="#portablePower">Portable Power</a></td>
		<td>Innovations Plus</td>
		<td></td>
	</tr>
	<tr>
		<td><a href="#qualcomm">Qualcomm Partners</a></td>
		<td>TBD</td>
		<td></td>
	</tr>
	<tr class="exhibitor11">
		<td><a href="#RWPPI">RWPPI</a></td>
		<td>LVCC Central</td>
		<td>RWPPI</td>
	</tr>
	<tr>
	...
	<tr  class="exhibitor11">
		<td><a href="#studio">Studio at Home</a></td>
		<td>Central Plaza</td>
		<td></td>
	</tr>
	<!--<tr>
	...
	<tr>
		<td><a href="#techHome">TechHome</a></td>
		<td>LVCC South 1-2</td>
		<td>CEA's TechHome Division</td>
	</tr>
	<tr class="exhibitor11">
		<td><a href="#ultrawideband">Ultrawideband</a></td>
		<td>Innovations Plus</td>
...
<span class="text_colored">Innovations Plus</span><br>
<img align="right" src="/attendees/show_floor/techzones/images/abilityMag.gif" alt="Ability Magazine">
<!--<br><br>
Without accessibility, consumer electronics&mdash;in all markets&mdash;become constrained and limited. More and more, today's technology products and services address universal design and accessibility for people with special needs, including those with visual, hearing, physical, and cognitive disabilities. At the Accessibility TechZone, see how dynamic companies conform to various legislation that works to keep access to information a fundamental human right.
<br><br>
<b>Who to expect</b><br>
...
<span class="text_colored">Hilton</span><br>
<br><img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<a href="#top">[back to top]</a><br>
...
<br><br>
The concept of fewer cables is becoming more attractive to consumers, and Bluetooth technology is frequently the standard savior to the no-wires mentality. It's all about short-range wireless technology and interoperability at the BLUETOOTH TECHZONE. Make strategic connections at the only show focused on the most complete range of technologies servicing the entire consumer electronics market.
<br><br>
<img src="images/Bluetooth.gif" align="right" alt="Bluetooth">
<b>Who to expect</b><br>
<ul>
	<li>Addvalue Communications Ptd Ltd
	<li>DSP Group
	<li>FingerSystem USA
	<li>G.G. Telecom
	<li>Innovi Technologies
	<li>NextLink
	<li>Parrot S.A.
	<li>RF Micro Devices
</ul>
...
<span class="text_colored">LVCC, South Hall 3-4</span>
<br><br>
Integrating home networking solutions and applications consumers seek for the fastest Internet access is becoming an integral part of business for many consumer technology companies. See the newest personal connectivity developments as these products reach the retail channel at the Broadband to the Home TechZone. 
<br><br>
<img align="right" src="images/CommTech.gif" alt="Communications Technology">
<b>Who to expect</b><br>
<ul>
	<li>Arcadyan
	<li>ARRIS
...
<br>                          
CES offers a prime opportunity to showcase the tools and services we rely on, including hardware, software, communication devices and business services. Meet face-to-face with 110,000+ key industry leaders and decision makers, at the BUSINESS SOLUTIONS SHOWCASE at the 2004 International CES.   
<br><br>
<b>Who to expect</b><br>
At the Business Solutions TechZone, meet companies that: 
<ul>
	<li>provide services for the entire retail channel 
	<li>are prepared to offer solutions to corporate decision makers 
...
<br><br>
More than ever, mobile electronics and aftermarket automotive accessories are being marketed, distributed and sold through the same channels. The International CES, creators of the world’s largest mobile electronics event, and NOPI, North America’s largest automotive aftermarket accessories distributor, teamed up to produce the CES/NOPI showcase. If the mobile electronics aftermarket industry impacts your bottom line, then join the largest gathering of specialty automotive retailers, distributors and manufacturers from the U.S. and abroad at the CES/NOPI Showcase.
<br><br>
<b>Who to expect</b><br>
Mobile eletronics aftermarket businesses, including those involved in:<br>
<img align="right" src="/attendees/show_floor/techzones/images/NOPI.gif" hspace="10" alt="NOPI">
<ul>
...
<span class="text_colored">LVCC, South Hall 3-4</span>
<br><br>
<img align="right" src="/attendees/show_floor/techzones/images/StorageVisions.gif" hspace="25" alt="Storage Visions">
The International CES defines consumer technology’s future. The future is certain to contain a great deal of rich multimedia content thanks to high-definition video, MPEG, MP3 and other digital technology. To enjoy that content, we need readily available, inexpensive, well-managed digital storage. See what's in store at the DIGITAL CONTENT STORAGE TechZone to see new ways to use, manage and store digital content for commercial, home or mobile users.
<br><br>
<b>Who to expect</b><br>
<ul>
	<li>Fairwinds
	<li>Glide Write
	<li>Mapower Electronics USA
	<li>NetCell
	<li>Storage Visions
</ul>
<img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
...
<br><br>
<img align="right" src="/attendees/show_floor/techzones/images/dvdram.gif" alt="">
Join leading technology companies, including Hitachi, HLDS, Maxell, LG, Panasonic, Samsung, TEAC, Toshiba, JVC and the Recordable DVD Council to promote DVD-RAM capabilities and new technologies at this exclusive CES TechZone.
<br><br>
<b>Who should exhibit here?</b><br>
Manufacturers or suppliers of DVD-RAM compatible products.
<br><img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<a href="#top">[back to top]</a><br>
...
<br><br>
<img align="right" src="/attendees/show_floor/techzones/images/dvdrw.gif" alt="DVD+RW Alliance">
<b>What to expect</b><br>
The latest DVD+R/+RW innovations from industry leaders who provide:<br>
<ul>
...
<span class="text_colored">LVCC, South Hall, 3-4</span>
<br><br>
Gone are the days of Linux being confined to the PC. Heading for mainstream use thanks to its efficiency, speed and flexibility, Linux has found its way into countless consumer electronics products, including PDAs and gaming systems. If you're interested in the open-source revolution, open up to the EMBEDDED LINUX TECHZONE  at the 2004 International CES.
<br>
<b>Who to expect</b><br><img src="images/Linux.gif" align="right" alt="Embedded Linux Consortium" border="0">
...
<br><br>
<img src="/attendees/show_floor/techzones/images/EnergyStar.gif" align="right" alt="Energy Star" hspace="5" vspace="0" border="0">
Look to the future. If your products demonstrate how to save energy and protect the environment or address the productive handling of used electronics equipment, you need to be part of the ENERGY EFFICIENCY AND ELECTRONICS RECYCLING TECHZONE. This CES TechZone promotes energy-efficient products and electronics recycling. Exhibit here, and make your most productive contacts all year.  
<br><img src="/global_images2005/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
<img src="/attendees/show_floor/techzones/images/GreenDay.gif" align="left" alt="Environmental Awareness Day" hspace="16" vspace="2" border="0">
<br>The International CES dedicates Saturday, January 8, 2005, to <strong>GREEN SATURDAY, ENVIRONMENTAL AWARENESS DAY</strong>. Look for special conference announcements that address the future of recycling electronics products. Help us advance electronics recycling and the future of the CE industry.
<br><img src="/global_images2005/spacer.gif" alt="" width="1" height="36" hspace="0" vspace="0" border="0"><br>
<img src="/attendees/show_floor/techzones/images/EPA.gif" align="right" alt="Environmental Protection Agency" hspace="12" border="0">
<b>Who should exhibit here?</b><br>
<ul>
...
<img src="/global_images2005/2.0/2.0.line.gif" alt="-----------------------------------------------" width="590" height="2" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<span class="subhead">Flash Forward</span><br>
<span class="text_colored">Central Plaza</span>
<br><br>
Get the exposure you deserve at the <strong>Flash Forward: Bringing Digital Imaging Into Focus</strong> TechZone. Participate in an exclusive digital imaging retail model brought to you by CEA. 
<br><br>
Offer critical, <em>real</em> solutions to the developing digital imaging experience. Gain front-line exposure to retailers, as you demo tomorrow's new products and most versatile applications. 
<br><br>
<strong><a href="flashFWD2005.pdf" target="_blank">Read more details (pdf)</a></strong> about the digital imaging industry's essential venue to showcase, train and sell digital.
<br><br>
<a href="flash_forward.asp"><img src="/attendees/show_floor/techzones/images/FlashForward_small_spons.gif" align="right" alt="Flash Forward: Bringing Digital Imaging Into Focus" border="0"></a>
<b>Who should exhibit here?</b><br>
Manufacturers of:
<table>
<tr>
...
<br><br>
Get your heart rate up&mdash;or at least see the most advanced ways to monitor it&mdash;at the International CES HI-TECH FITNESS TECHZONE. Health technology is increasing the industry's heart rate&mdash;whether it's medical advances that help track physical condition or gadgets that make getting in shape fun. Here's the place to test the tools that make it easier to monitor health and improve well-being.
<br><br>
<b>Who to expect</b><br>
...
<img src="/attendees/show_floor/techzones/images/HomePlug.gif" align="right" alt="" border="0"><br><br>
...
<br><br>
There's a new home for emerging technologies, companies and products: the exciting, energized Launch TechZone at the 2004 International CES. Make strategic connections at the largest technology event in North America and see the products that are barely out of beta and launching at the 2004 International CES.
<br><br>
<b>Who to expect</b><br>
<ul>
	<li>Keybowl
...
<br><b>About the MIT Media Lab</b><br>
...
<img src="/attendees/show_floor/techzones/images/MITMedia2.gif" align="right" alt="" border="0">
<ul>
...
<span class="text_colored">LVCC, South Hall 3-4</span>
<br><br>
A recent eBrain Market Research study reports that a third of consumers who don't own any mobile tech devices plan to purchase multiple mobile technology products in the future. As this technology becomes a necessity, more consumer technology professionals look to learn more about the future of mobile computing solutions. That's why we've created the MOBILE COMPUTING Tech Zone at the 2004 International CES.
<br><br>
...
<br><br>
<img src="images/MobileComputing.gif" align="right" alt="Mobile Computing">
<b>Who to expect</b><br>
	<ul>
		<li>Fujitsu
		<li>Motion Computing
		<li>Pelham Sloane Inc.
		<li>Softier, Inc.
		<li>Thaddeus Computing
		<li>TRC
		<li>WintopUSA
	</ul>
<img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
...
<span class="text_colored">Innovations Plus</span>
<br><br>
If you offer solutions for hours of portable digital listening, participate in the MP3 TechZone, a cost-effective complement to your marketing plan. The International CES connects digital content, the Internet and broadband with wireless media and devices. Introduce your innovative products to the mass market through the most comprehensive array of distribution channels. 
<br><br>
<b>Who should exhibit here?</b><br>
...
<!--<a name="personalBroadband"></a>
<img src="/global_images2005/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/2.0/2.0.line.gif" alt="------------------------------------------------><!---" width="590" height="2" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<span class="subhead">Personal Broadband</span><br>
<span class="text_colored">Innovations Plus</span>
<br><img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<a href="#top">[back to top]</a><br>-->
...
<img src="/global_images2005/2.0/2.0.line.gif" alt="-----------------------------------------------" width="590" height="2" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<span class="subhead">Qualcomm Partners</span><br>
<span class="text_colored">TBD</span>
<br><img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<a href="#top">[back to top]</a><br>
...
<ul>
	...
	<li>Products compatible with SD memory cards 
</ul>
<img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<a href="#top">[back to top]</a><br>
...
<img src="/attendees/show_floor/techzones/images/smartRight.gif" align="right" alt="SmartRight">
<br><br>
...
<span class="text_colored">LVCC, South Hall, 3-4</span>
<br><br>
The tablet PC brings the simplicity of pen and paper to computing. Whether away from the desk or out on the road, we want the convenience of being able to collaborate and work effectively. Recent computer evolution allows mobile workers to access a powerful, versatile computing solution to enhance the role of the traditional notebook PC. Scribble down some notes on this newer market at the CES TABLET PC TECHNOLOGIES TECHZONE.
<br><br>
<b>Who to expect</b><br>
<ul>
...
<span class="text_colored">LVCC South 1-2</span>
<br>
<img align="right" src="/attendees/show_floor/techzones/images/techhome.gif" alt="TechHome, Produced by CEA">
<br>
If your products are at the core of the networked home, increase efficiency, conserve energy or make consumers' home lives easier, then join the International CES at the TECHHOME TechZone, featuring the most cutting-edge innovations of tomorrow's smart home. 
<br><br>
<b>Who should exhibit here?</b><br>
Manufacturers or suppliers of products such as:
<table border="0">
<tr>
	...
	<ul>
		...
		<li>Data or entertainment distribution<br>systems and solutions
		<li>Set-top boxes 
	...
	<td width="6"><img src="/global_images2005/spacer.gif" alt="" width="6"></td>
	<td valign="top">
	<ul>
...
<span class="text_colored">Innovations Plus</span>
<br><br>
Wireless connectivity has enabled a new mobile lifestyle filled with conveniences for mobile computing users&mdash;at work and in our digital homes. Ultrawideband (UWB) technology offers a solution for the bandwidth, cost, power consumption and physical size requirements of next-generation consumer electronic devices. UWB enables wireless connectivity with consistent high data rates across multiple devices and PCs and promises to make it easy to create highspeed WPANs that connect devices.
<br><img align="right" src="/attendees/show_floor/techzones/images/MBOA.gif" alt="MBOA">
<br>
<b>Who should exhibit here?</b><br>
Manufacturers or suppliers of products such as:
<ul>
	<li>Consumer electronic manufacturers
	<li>Silicon/software developers
	<li>Personal computing companies
	<li>Industry organizations/ecosystem participants
</ul>
<img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<a href="#top">[back to top]</a><br>
...
<span class="text_colored">LVCC, South Hall, 3-4</span>
<br><br>
Many would agree the wireless revolution takes more collaboration between companies&mdash;from carriers and operators to mobile product manufacturers and the companies who make them work&mdash;than any other consumer technology innovation hitting the market today. The Ultimate Wireless SuperStore uses zones to organize a fragmented industry into displays that define a wireless customer's buying experience. See how the most innovative wireless products, services and applications complement each other&mdash;and how you fit into the process. 
<br><br>
<img src="images/WirelessSuperstore.gif" align="right" alt="Ultimate Wireless Superstore">
<b>Who to expect</b><br>
...
<span class="text_colored">LVCC, South Hall 1-2</span>
<br><img align="right" src="/attendees/show_floor/techzones/images/upnp.gif" alt=""><br>
...
<span class="text_colored">LVCC, South Hall 3-4</span>
<br><br>
USB technology makes "plug and play" a reality and accommodates busy lives. The impact of USB connectivity on small office/home office, PCs, printers, scanners, PDAs and digital cameras is huge. Join us in the USB TechZone&mdash;dedicated exclusively to the use of this standard&mdash;at the 2004 International CES. 
<br><img src="images/USB.gif" align="right" alt="USB"><br><img src="images/USB_highspeed.gif" align="right" alt="USB Hi Speed">
<b>Who to expect</b><br>
<ul>
	<li>AboCom Systems
	<li>Argosy Technology
	<li>Billionton Systems
	<li>CP Technologies
	<li>Digitalks
	<li>ENE Technology
	<li>Freecom Technologies
	<li>Genesys Logic
	<li>IDEATIVE
	<li>Imagine LAN
	<li>JPC USA/Quik Tech Solutions
	<li>Lumberg
	<li>OnSpec
	<li>Plextor Corp.
	<li>Prolific Technology
	<li>SIIG
	<li>Silicon Motion
	<li>Syscan
	<li>USB Implementer's Forum
	<li>Western Digital
	<li>Ziplinq
	<li>Zoran Corporation
</ul>
<img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<a href="#top">[back to top]</a><br>
-->
