...
<head>
	...
	<title>2005 International CES:&nbsp;byb+ Direct Mail Opportunities</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/exhibitors/">Exhibitor Services</a>&nbsp;>&nbsp;<a href="/exhibitors/promotions/">Promotions</a>&nbsp;>&nbsp;Direct Mail
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.2.5") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<table class="exhibitor8" width="590" cellspacing="0" cellpadding="0" border="0">
	<tr>
	    ...
	    <td width="154"><img src="/global_images2005/spacer.gif" alt="" width="154" height="10" hspace="0" vspace="0" border="0"></td>
	    <td width="10"><img src="/global_images2005/spacer.gif" alt="" width="10" height="10" hspace="0" vspace="0" border="0"></td>
	    <td width="213"><img src="/global_images2005/spacer.gif" alt="" width="213" height="10" hspace="0" vspace="0" border="0"></td>
		<td width="10"><img src="/global_images2005/spacer.gif" alt="" width="10" height="10" hspace="0" vspace="0" border="0"></td>
	...
	<tr>
		...
		<td valign="top" class="text">
			<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span><a href="?id=1#email" class="inpagenav">E-mail Campaign</a><BR>
		</td>
	    <td>&nbsp;</td>
		<td valign="top" class="text">
			<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span><a href="?id=2#preRegList" class="inpagenav">Pre-Registered Attendee Mailing Lists</a><br>
		</td>
		<td>&nbsp;</td>
		<td valign="top" class="text">
			<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span><a href="?id=3#postShowList" class="inpagenav">Post Show Attendee Mailing Lists</a><br>				
		</td>
	    <td>&nbsp;</td>
	</tr>
	<tr>
...
<table width="590" cellspacing=0 cellpadding=1 border=0 ID="Table1">
	...
	<tr>
		<td colspan=3><br>
		Coordinate your e-marketing campaign with the extensive International CES marketing campaign. Add your message to CES e-mails. Reach more than 80,000 readers per e-mail, including pre-registrants and 2004 International CES attendees, loyal CES customers, conference attendees, VIP buyers, an international audience and more.
		<br><br>
		Include a logo and 50-75 words about your company and product, plus a web link. Call now for details.		
		<br><br>
		<table border="0" cellpadding="0" cellspacing="0" width="100%" ID="Table3">
		<tr>
			<td valign="top">
			<B>Marketing Investment</B><br>
			CES Exhibitors: $5,000 for one e-mail; $8,000 for two.
			<br>Exclusive Opportunities Available
			<br><br>
			<B>Contact</B><br>
		...
		<br><img src="/global_images2005/spacer.gif" width="1" height="5" border="0"><br><a href="#">[back to top]</a>			
			...
			<td width="180" valign="top">
				<img border="0" src="images/2005/mail-edm.jpg">
			</td>	
		</tr>
		</table>
		</td>
	...
	<tr>
		<td colspan=3><br>
		Capture the attention of pre-registered attendees heading to Vegas for the world's largest consumer technology event. Personally invite a targeted audience to your booth, with pre-registered CES attendee lists. The pre-show list is available from October through December.
		<br><br>	
		<a href="pdfs/ListRentalAgreementForm.pdf" target="new">Download and print the order form.</a>
		<br><br>
		<B>Marketing Investment</B><br>
		$625+<br>
		Cost Per Thousand: $125 per 1000 names<br>
		Minimum Order: 5,000 names
		<br>Postal Addresses Only
		<br><br>
		<B>Deadlines</B><br>
		Requests Due: December 15
		<br><br>
		<B>Contact</B><br>
		Manager, Promotional Opportunities, CES<br>
		Phone: (703) 907-7688<br>
	...
	<tr>
		<td colspan=3><br>
		Reach a targeted group of International CES attendees via mail, months before the show doors open. Reinforce your messaging to our verified, post show 2004 attendee list.
		<br><br>	
		<a href="pdfs/ListRentalAgreementForm.pdf" target="new">Download and print the order form.</a>	
		<br><br>
		<B>Marketing Investment</B><br>
