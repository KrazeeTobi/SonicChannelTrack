...
<head>
	...
	<title>2005 International CES:&nbsp;2005 International CES Exhibit Booth Space</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/exhibitors/">Exhibitor Services</a>&nbsp;>&nbsp;<a href="/exhibitors/space/">Exhibit Space</a>&nbsp;>&nbsp;Exhibit Booth Space
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.1.2") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/2.0/2.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Exhibit Booth Space<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
<!--
<br><br>
<span class="subhead">Need a visual?</span><br>
Download a detailed <a href="/attendees/exhibit_floor/areas/images/location_map_0730.pdf" target="new">2004 International CES location map</a>.
-->
<br>
...
<table border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td colspan="3"><div class="section_title">Las Vegas Convention Center</div></td>
	</tr>
	<tr>
		<td width="285" valign="top"><span class="subhead">North Hall<br></span>
			<span class="text_colored">Mobile Electronics</span><br>
			<ul>
				<li>Car Audio/Video
			...
			<br>
			<span class="subhead">South Hall<br></span>
			<span class="text_colored">Home Information & Wireless, Home Theater/Home Systems, Satellite</span><br>
			<ul>
				<li>Break-Through Technologies
				<li>Information Technology
				<li>Gaming & Entertainment Products & Solutions
				<li>Home Information
				<li>Home Systems
				<li>Home Theater
			...
			<span class="subhead">Gold Exhibits</span><br>
			<ul>
				<li>Outdoor Exhibits
				<li>Select Products MECP Installers Challenge
				<li>Show Parking
			</ul><br>
		...
		<td valign="top" width="285">
			<span class="subhead">Central Hall<br></span>
			<span class="text_colored">Audio/Video</span><br>
			<ul>
			...
			<span class="subhead">CES Central Plaza</span> (formerly Silver Exhibits)<br>
			<ul>
				<li>Exhibitor registration
				<li>Outdoor exhibits
				<img src="/attendees/show_floor/areas/images/innovationsPlus_small.gif" align="right">
				<li><strong>(New!) Innovations Plus</strong>, featuring:
				<br>&nbsp;&nbsp;&nbsp;- Best of Innovations
				<br>&nbsp;&nbsp;&nbsp;- Innovations 2005 Showcase
				<br>&nbsp;&nbsp;&nbsp;- International CES TechZones
				<br>&nbsp;&nbsp;&nbsp;- Flash Forward: Bringing Digital Imaging Into Focus
			</ul><br>
			<span class="subhead">CES South Plaza</span><br>
			<ul>
				<li>HD Pro Showcase
				<li>NextGen05 Demonstration Home
				<li>Outdoor exhibits
				<li>Studio@Home Showcase
			</ul><br>
		</td>
	</tr>
	<tr><td colspan="3">	
		...
		<img src="/global_images2005/2.0/2.0.line.gif" alt="-----------------------------------------------" width="590" height="2" hspace="0" vspace="0" border="0"><br>
		<img src="/global_images2005/spacer.gif" alt="" width="1" height="4" hspace="0" vspace="0" border="0"><br>
	</td></tr>
	<tr>
		<td width="285">
		<span class="section_title">The Las Vegas Hilton</span><br>
			<ul>
				<li>The International Gateway
			</ul>
		</td>
		<td width="20">&nbsp;</td>
		<td valign="top" width="285"><span class="section_title">Alexis Park</span><br>
			<ul>
