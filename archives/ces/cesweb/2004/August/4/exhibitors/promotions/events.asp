...
<head>
	...
	<title>2005 International CES:&nbsp;byb+ Industry Events</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/exhibitors/">Exhibitor Services</a>&nbsp;>&nbsp;<a href="/exhibitors/promotions/">Promotions</a>&nbsp;>&nbsp;Industry Events
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.2.7") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/2.0/2.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Industry Events<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
<br>-->
Maximize the power of your brand through <a href="./pdfs/CEAsponsorships.pdf" target="new">CEA sponsorship opportunities</a>. Your sponsorship of CEA's high-level events throughout the year will introduce you to the world's most influential consumer electronics industry innovators and leading press. <a href="http://www.ce.org/events/sponsorship_opps.asp">Visit CE.org for more information</a> on these CEA industry events:
<br><br>
<ul>
	<li>CEA Winter Summit
	<li>HDTV Summit
	<li>CEA CEO Summit
	<li>CEA 2003 Summer Technology & Standards Forum
	<li>CEA Industry Forum and Fall Conference
	<li>2005 International CES<br>
		<span class="text_colored">January 6-9, 2005, Las Vegas, NV</span>
</ul>

<br>
<B>Contact</B><br>
Manager, Promotional Opportunities, CES<br>
Phone: (703) 907-7688; E-mail: <A HREF="mailto:byb@ce.org">byb@ce.org</A><br><br>
<!-- /text for main page -->
</div>	
