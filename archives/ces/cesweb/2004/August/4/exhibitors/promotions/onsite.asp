...
<head>
	...
	<title>2005 International CES:&nbsp;byb+ On-site Advertising Opportunities</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/exhibitors/">Exhibitor Services</a>&nbsp;>&nbsp;<a href="/exhibitors/promotions/">Promotions</a>&nbsp;>&nbsp;On-site Advertising
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.2.2") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/2.0/2.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">On-site Advertising Opportunities<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
<table class="exhibitor8" width="590" cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
		...
		<td valign="top" class="text">
			<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span><a href="?id=1#banners" class="inpagenav">Interior and Exterior Banners</a><BR>
			<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span><a href="?id=2#inflatables" class="inpagenav">Inflatable, Custom Promotions</a><BR>	
		</td>
	    <td>&nbsp;</td>
		<td valign="top" class="text">
			<!--<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span><a href="?id=3#cesTV" class="inpagenav">International CES-TV</a><br>-->
			<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span><a href="?id=4#kiosks" class="inpagenav">Literature Kiosks</a><br>
		</td>
		<td>&nbsp;</td>
		<td valign="top" class="text">
			<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span><a href="?id=5#shuttleBus" class="inpagenav">Shuttle Advertising Programs</a><br>				
		</td>
	    <td>&nbsp;</td>
	</tr>
	<tr>
...
<table width="590" cellspacing=0 cellpadding=1 border=0>
	...
	<tr>
		...
		<br>
		<B>Contacts</B><br>
		Manager, Promotional Opportunties, International CES<br>
		Phone: (703) 907-7688<br>
		E-mail: <A HREF="mailto:byb@ce.org">byb@ce.org</A><br><br>
		<table cellpadding=0 cellspacing=4 border=0>
		<tr>
			<td valign=top>
			<a href="images/2005/onsite-shuttlebanners-large.jpg" target="new"><img border=0 src="images/2005/onsite-shuttlebanners-small.jpg"><br>
			<font size="-2">Click for larger image.</a><br>
			Shuttle Bus Banner and Kiosk Example</font><br>
			<img src="/global_images2005/spacer.gif" width="1" height="5" border="0"><br><a href="#">[back to top]</a>			
			</td>
			<td width="4"></td>
			<td valign=top>
			<a href="images/2005/onsite-indoorbanner-large.jpg" target="new"><img border=0 src="images/2005/onsite-indoorbanner-small.jpg"><br>
			<font size="-2">Click for larger image.</a><br>
			Grand Lobby Interior Banner Example</font><br>
			</td>
		</tr>
		<tr>
			<td valign=top>
			<a href="images/2005/onsite-outdoorbanner-large.jpg" target="new"><img border=0 src="images/2005/onsite-outdoorbanner-small.jpg"><br>
			<font size="-2">Click for larger image.</a><br>
			North Hall Exterior Banner Example</font><br>
			<img src="/global_images2005/spacer.gif" width="1" height="5" border="0"><br><a href="#">[back to top]</a>			
			</td>
			<td width="4"></td>
			<td valign=top>
			<a href="images/2005/onsite-outdoorbanner2-large.jpg" target="new"><img border=0 src="images/2005/onsite-outdoorbanner2-small.jpg"><br>
			<font size="-2">Click for larger image.</a><br>
			Grand Concourse Kiosk Example</font><br>
			</td>
		</tr>
		</table>
		</td>
	...
	<tr>
		<td colspan=3>
		<br>Reach attendees before they come <i>in</i>. Put your company name, logo and booth number on a custom inflatable or other free-standing promotional product. If you have an item or idea you would like to place outside the LVCC, contact us for details.
		<br>
		<table border="0" cellpadding="0" cellspacing="0" width="100%" ID="Table6">
		<tr>
		<td valign="top">
			<br><B>Marketing Investment</B><br>
			$10,000<br>
			<br>
			<B>Contacts</B><br>
			Manager, Promotional Opportunties, International CES<br>
			...
			<img src="/global_images2005/spacer.gif" width="1" height="5" border="0"><br><a href="#">[back to top]</a>
		<td width="200">
			<a href="images/2005/onsite-inflatable-large.jpg" target="new"><img border=0 src="images/2005/onsite-inflatable-small.jpg"><br>
...
<!--
	...
	<tr>
		<td width="300"><span class="section_title">International CES-TV</span></td>
		<td width="290"><span class="section_title">$1,000+</span></td>
	</tr>
	<tr>
		<td colspan=3><br>
		Jack Halsbond &amp; Company will again produce the daily television programming for the Consumer Electronics Association at 2005 International CES, January 6-9, 2005 in Las Vegas.
		<br><br>
		Seen daily throughout the Las Vegas Convention Center during the show run, CES-TV, will also be <i>available 24 hours each day</i> in these select area hotels:
		<br>
		<table cellspacing="0" cellpadding="0" border="0">
		<tr><td width="40%">
		<ul>
...
-->
	...
	<tr>
		<td colspan=3><br>
		Display your literature, promote new products and direct buyers to your booth&mdash;with an illuminated literature kiosk, guaranteed to call attendees' attention. Put valuable information within arms' reach of attendees, throughout the show.
		<br><br>
		<B>Marketing Investment</B><br>
		$5,000<br>
		<br>
		...
		Phone: (205) 323-8814<br>E-mail: <A HREF="mailto:bbeasley@aesmarketing.com">bbeasley@aesmarketing.com</A><br>
		<img src="/global_images2005/spacer.gif" width="1" height="5" border="0"><br><a href="#">[back to top]</a>		
		<!-- (.jpg from AES) -->
		</td>
	</tr>
	...
	<tr>
		<td colspan=3><br>
		Reach your target audience with shuttle-related advertising programs on the popular International CES shuttles. With almost 40,000 riders a day, vehicle graphics and headrest covers provide impact and visibility. Custom audio and video programs get attendees' undivided attention before they arrive at the convention center. Let our expertise help drive attendees to your booth!
		<!--<a href="pdfs/shuttle.pdf" target="_blank">Download detailed information.</a>-->
		<br><br>
		<B>Marketing Investment</B><br>
		$5,000+<br>
		<br>
		<b>Deadline</b><br>
		Reservations due November 18
		<br><br>
		<b>Contacts</b><br>
		Kathy Norton, CES Advertising Manager<br>
		Phone: (800) 616-2622<br>
		E-mail: <a href="mailto:Kathyn@cmac.net ">Kathyn@cmac.net </a><br>
		<br>
		<br>
		<table cellpadding=0 cellspacing=0 border=0>
		<tr>
			<td valign=top>
			<a href="images/ads_shuttleBusWrap_large.jpg" target="new"><img border=0 src="images/ads_shuttleBusWrap.jpg"><br>
			<font size="-2">Click for larger image.</a><br>
			...
			<td width="10">&nbsp;</td>
			<td valign=top>
			<a href="images/ads_shuttleBusHeadrest_large.jpg" target="new"><img border=0  src="images/ads_shuttleBusHeadrest.jpg"><br>
			<font size="-2">Click for larger image.</a><br>
