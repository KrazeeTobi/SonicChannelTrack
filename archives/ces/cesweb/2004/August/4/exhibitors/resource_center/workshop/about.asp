...
<head>
	...
	<title>2005 International CES:&nbsp;Exhibitor Workshop Details</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/exhibitors/">Exhibitor Services</a>&nbsp;>&nbsp;<a href="/exhibitors/resource_center/">Resource Center</a>&nbsp;>&nbsp;<a href="/exhibitors/resource_center/workshop/">Exhibitor Workshop</a>&nbsp;>&nbsp;Details
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.3.8.1") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<!-- RESOURCE CENTER -->	
		...
		<a href="/exhibitors/resource_center/workshop/">Exhibitor Workshop</a><br>
				...
				<span class="nav_fourth_arrow"><b>></b> &nbsp;</span>Workshop Details</a><br>
				<span class="nav_fourth_arrow"><b>></b> &nbsp;</span><a href="/exhibitors/resource_center/workshop/agenda.asp">Workshop Agenda</a><br>
				<span class="nav_fourth_arrow"><b>></b> &nbsp;</span><a href="/exhibitors/resource_center/workshop/hotel.asp">Hotel Reservations</a><br>
				<span class="nav_fourth_arrow"><b>></b> &nbsp;</span><a href="/exhibitors/resource_center/workshop/registration.asp">Registration</a><br>
				</span>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/2.0/2.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Exhibitor Workshop Details<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="2.3.8.1">	
<!-- text for main page -->
Talk one-on-one with International CES experts and key vendors to discuss all aspects of the show, including an exclusive update and exhibiting aid from International CES Operations, Sales and Marketing representatives. 
<br><br>

Attending the one-day Exhibitor Workshop on Tuesday, September 21, 2004 may be the most valuable thing you do to prepare for the 2005 International CES. 
<br><br>
<span class="subhead"><a href ="/exhibitors/resource_center/workshop/registration.asp">Registration is FREE</a>  to 2005 International CES exhibitors.</span>
<br>
...
<span class="subhead">JUST ANNOUNCED! Guest Speaker and Panel<br></span>
Listen to Jon Bromberg, industry consultant and a former director of events at Microsoft, discuss how to make the most of your
relationship with CES. Learn from leading industry representatives on how to increase your return on investment and justify participation in the 2005 International CES.
<br><br>
<span class="subhead">NEW! Lunch featuring Round Table Discussions + Vendor Fair</span><br>
Join us for the <i>One-on-One With the Pros</i> lunch session, another great opportunity to get your questions answered from tradeshow experts. Topics at the roundtable discussions include: freight, first–timer tips, CES promotional opportunities, show operations and exhibitor manual, Internet requirements, and the exhibit space selection process.
<br><br>
Profit from new contacts at our vendor fair. Get discounts on logistical supplies and services, from furniture to electricity to shipping and material handling. Vendors you’ll get a chance to meet include:
<br><br>
<ul>
<table cellspacing="0" cellpadding="0" border="0" width="90%" align="center">
<tr class="exhibitor11">
	<td width="40%">
	<li>Las Vegas Convention Center</li></td><td width="55%">
	<li>GES - General Contractor</li>
	</td>
</tr>
<tr>
	<td>
	<li>Smart City - Internet/Telecomm</li></td><td>
	<li>Dine Direct - Restaurant Reservations</li>
	</td>
</tr>
<tr class="exhibitor11">
	<td>
	<li>Pro-Tect & SOA - Security</li></td><td>
	<li>Aramark - Food and Beverage</li>
	</td>
</tr>
<tr>
	<td>
	<li>Encore - Audio/Visual</li></td><td>
	<li>ExpoExchange - Lead Retrieval Card Readers</li>
	</td>
</tr>
<tr class="exhibitor11">
	<td>
	<li>Spring Valley Floral - Floral/Plants</li></td><td>
	<li>Oscar/Einzig Photographers</li>
	</td>
</tr>
<tr>
	<td>
	<li>CMAC - Transportation and Limos</li></td><td>
	<li>Judy Venn & Associates - Models/Hostesses</li>
	</td>
</tr>
</table>
</ul>
<br>
<span class="subhead">Tour the Las Vegas Convention Center<br></span>
Get a hall-by-hall education to understand the complete International CES layout, new show features and traffic flow.  Get a first look at the CES Central Plaza, which will include Innovations Plus, Best of Innovations, Flash Forward 2.0, exciting exhibitors like Gibson and much more.
<br><br>
<span class="subhead">2005 International CES Operations<br></span>
To fine-tune your booth display and your time spent prepping for the show, the Exhibitor Workshop offers detailed information about show operations and standards. Gain tips on show logistics for moving in and out, setting up, and staying within the guidelines of utility requirements, security, fire marshal rules and other regulations.
<br><br>
<span class="subhead">Public Relations and Marketing<br></span>
Will your company and brand make the headlines at the 2005 International CES? Pick up important tips on how to get the attention of the 4,000 industry trade press and media attending CES.
<br><br>
<span class="subhead">byb+ Sponsorship Opportunities<br></span>
Learn how to build your brand (byb) through exclusive International CES sponsorship opportunities—including free opportunities available to all exhibitors. We’ll help you target the attendees you most want to meet through opportunities that best suit your needs. <a href="/exhibitors/promotions">See all 2005 International CES sponsorship opportunities.</a>

<!--<span class="subhead">Vendor Trade Fair and Reception<br></span>
During the Exhibitor Workshop, attend the Vendor Trade Fair to meet 2004 International CES vendors and receive discounts exclusive to workshop participants. Vendors include:  <br>
<ul>
<table cellspacing="0" cellpadding="0" border="0" width="90%" align="center">
<tr class="exhibitor11">
	<td width="40%">
	<li>LVCC</li></td><td width="55%">
	<li>GES - General Contractor</li>
	</td>
</tr>
<tr>
...
<tr class="exhibitor11">
	<td>
	<li>Pro-Tect - Security</li></td><td>
	<li>Aramark - Catering</li>
	</td>
</tr>
<tr>
	<td>
	<li>CMAC - Transportations/Limo Services</li></td><td>
	<li>Encore - Audio/Visual</li>
	</td>
</tr>
<tr class="exhibitor11">
	<td>
	<li>Spring Valley Floral - Floral/Plants</li></td><td>
	<li>Macc Inc./North American Van Lines - Van Line Freight</li>
	</td>
</tr>
<tr>
	<td>
	<li>Alexis Park</li></td><td>
	<li>GeoLogistics - International Freight Forwarder</li>
	</td>
</tr>
<tr class="exhibitor11">
	<td>
	<li>LV Hilton</li></td><td>
	<li>Judy Venn & Associates - Booth Hostesses</li>
	</td>
</tr>
<tr>
	<td>
	<li>Dine Direct - Restaurant Reservations</li></td><td>
	<li>ExpoExchange - Registration and Lead Retrieval</li>
	</td>
</tr>
<tr class="exhibitor11">
	<td>
	<li>Einzig - Show Photographer</li></td><td>
	<li>Business Wire</li>
	</td>
</tr> 
</table>
...
<br>
<span class="subhead">Cocktail Reception<br></span>
Join us for an exhibitor cocktail reception 6 p.m. Wednesday, October 15, 2003, in the Foundation Room at Mandalay Bay. Meet vendors, learn how to make the most of your ROI, get exhibitor discounts, and enjoy networking at the cocktail reception&mdash;all on us.<br>
<br>-->
<br><br>
<span class="subhead">Questions?<br></span>
For more information on the International CES Exhibitor Workshop, contact Andrew R. Bradley at (703) 907-4312 or <a href="mailto:abradley@ce.org?subject=Exhibiting Workshop Questions via CESweb.org">abradley@ce.org</a>. 
