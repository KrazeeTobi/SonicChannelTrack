...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/exhibitors/">Exhibitor Services</a>&nbsp;>&nbsp;<a href="/exhibitors/resource_center/">Resource Center</a>&nbsp;>&nbsp;Exhibition Industry Research
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.3.7") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<!-- RESOURCE CENTER -->	
		...
		<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
		<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
		Exhibition Industry Research</a><br>
		<img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
		<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/2.0/2.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="380"  background="/global_images2005/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Exhibition Industry Research<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="2.3.7">	
<!-- text for main page -->
<span class="subhead">Access FREE Critical Industry Research</span><br>
Join the Consumer Electronics Association (CEA)&mdash;producer of the International CES&mdash;and leading industry members to support the Center for Exhibition Industry Research (CEIR), provider of critical research and promotion for the exhibition industry.
<br>
...
<br>
<a href="http://www.CEIR.org" target="new"><img src="images/vcp.gif" hspace="10" align="left" border="0"></a>
<b>CEA’s support of the VCP gives you FREE access to this information. Go to <a href="http://www.CEIR.org" target="new">www.CEIR.org</a> and click on the VCP icon.
<br><br>
Your Password is CES2003. Your UserID is your company name.</b>
<br><br><img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
...
<!--
<br>
<img src="/global_images2005/spacer.gif" alt="" width="1" height="40" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/2.0/2.0.line.gif" alt="-----------------------------------------------" width="380" height="2" hspace="0" vspace="0" border="0"><br>
<div class="section_title">A single dollar helps continue this vital research</div>
Exhibitions are a proven, cost-effective way to generate revenue. Ensure their continued success by supporting the research to help us all do our jobs better.
<br><br>
It's easy, and it's just $1! Just check "YES!" to the additional $1 line-item for the VCP on your final GES invoice.
<b>CEA will match your contribution</b>, and turn your $1 into $2!
<br><br>
...
<tr> 
	...
	Exhibitions are used in 87% of the selling process, more than any other marketing tool.* 
	<br><br>
...
<br>
<span class="subhead">A single dollar helps</span><br>
Exhibitions are a proven, cost-effective way to generate revenue. Ensure their continued success by supporting this vital research.
<br><br>
It's easy, and it's just $1! Just check "YES!" to the additional $1 line-item for the VCP on your final GES invoice.
<br><br>
<b>CEA will match your contribution</b>, and turn your $1 into $2!
<br><br>
Funds collected through the VCP are dedicated exclusively to funding exhibition industry and promotion. 
<br><img src="/global_images2005/spacer.gif" alt="" width="1" height="102" hspace="0" vspace="0" border="0"><br>
*Source: CEIR Research Reports 		</td>
	    <td width="10"  background="/global_images2005/spacer.gif" class="exhibitor8">&nbsp;</td>
		</tr>
<!-- /main body row -->
<!-- footer row -->
