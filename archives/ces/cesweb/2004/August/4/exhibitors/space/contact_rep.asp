...
<head>
	...
	<title>2005 International CES:&nbsp;Contact an International CES Sales Representative</title>
	...
	function validate_form(){
			if (document.emailContactForm.LName.value.length == 0) {
			alert ("Please enter your last name.");
			emailContactForm.LName.focus();
			return false;
		}
	
		if (document.emailContactForm.email.value.length == 0) {
			alert ("Please enter your e-mail address so we may contact you.");
			emailContactForm.email.focus();
			return false;
		}
	return true;
	}
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/exhibitors/">Exhibitor Services</a>&nbsp;>&nbsp;<a href="/exhibitors/space/">Exhibit Space</a>&nbsp;>&nbsp;<a href="/exhibitors/space/contacts.asp">Contacts</a>&nbsp;>&nbsp;Contact a Rep
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.1.5.1") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/2.0/2.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Contact an International CES Sales Representative<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
<form name="emailContactForm" action="contact_rep.asp" method="post" onSubmit="return validate_form();">
...
<tr>
	...
	<td><input type="text" name="FName" class="formData" size="25"></td>
</tr>
...
<tr>
	...
	<td><input type="text" name="LName" class="formData" size="25"></td>
</tr>
<tr><td colspan=2 height="4"><img src="/global_images2005/spacer.gif" height="4"></td></tr>
...
<tr>
	<td class="rowlabel"><span class="required">* </span>Fax&nbsp;&nbsp;</td>
...
<tr>
	...
	<td><input type="text" name="webaddress" class="formData" size="25"></td>
</tr>
<tr><td colspan=2 height="4"><img src="/global_images2005/spacer.gif" height="4"></td></tr>
...
<tr><td colspan=2>Please select the category that best describes your product or service:</td>
</tr>
<tr><td colspan=2 height="4"><img src="/global_images2005/spacer.gif" height="4"></td></tr>
...
<tr>
	...
	<td colspan=3>
	  ...
	  <tr>
	  <td>
	  <input type="radio" name="category" value="Audio & Video" class="formData"> Audio & Video<br></span>
      <input type="radio" name="category" value="Digital Imaging" class="formData"> Digital Imaging<br></span>
	  <input type="radio" name="category" value="Digital Radio" class="formData"> Digital Radio<br></span>
      <input type="radio" name="category" value="Embedded Technologies" class="formData"> Embedded Technologies<br></span>
      <input type="radio" name="category" value="Gaming" class="formData"> Gaming<br></span>
      <input type="radio" name="category" value="High Performance Radio" class="formData"> High Performance Radio<br></span>
	  <input type="radio" name="category" value="Home Networking Home Information Systems" class="formData"> Home Networking/Home Information Systems<br></span>
      <input type="radio" name="category" value="Home Theater" class="formData"> Home Theater<br></span>
	  <input type="radio" name="category" value="Information Technology" class="formData"> Information Technology<br></span>
	  </td>
	  <td>
	  <input type="radio" name="category" value="International Gateway" class="formData"> International Gateway<br></span>
	  <input type="radio" name="category" value="Mobile Electronics" class="formData"> Mobile Electronics<br></span>
      <input type="radio" name="category" value="Outdoor Space" class="formData"> Outdoor Space<br></span>
      <input type="radio" name="category" value="Publication" class="formData"> Publication<br></span>
      <input type="radio" name="category" value="Satellite" class="formData"> Satellite<br></span>
      <input type="radio" name="category" value="Trade Association" class="formData"> Trade Association<br></span>
      <input type="radio" name="category" value="Wireless Communications" class="formData"> Wireless Communications<br></span>
	  <input type="Radio" name="category" value="Other" class="formData" checked> Other:</span> <input name="other" type="text" size="25" class="formData">
	  </td>
	  </tr>
	  </table>
	</td>
...
<tr>
	<td colspan=2 height="25"><img src="/global_images2005/spacer.gif" height="25"></td></tr>
<tr>
	<td colspan=3>To assist us in developing your space selection options, what size booth would you like to consider?<br>
	<span class="text_colored">(Booths start at 10 sq. ft. by 10 sq. ft.)</span>
	</td>
</tr>
<tr>
	<td colspan=2 height="8"><img src="/global_images2005/spacer.gif" height="8"></td></tr>
<tr>
	<td>&nbsp;</td>
	<td colspan=3><IMG SRC="/global_images2005/spacer.gif" width="4" height="1"><input name="feet" type="text" size="7" class="formData">  ft. x </span><input name="feet2" type="text" size="7" class="formData">  ft. = </span><input name="nsf" type="text" size="7" class="formData">  net sq. ft., in U.S. measurements</span></td>
</tr>

<tr><td colspan=2 height="25"><img src="/global_images2005/spacer.gif" height="25"></td></tr>
<tr>
	<td colspan=3>Comments or Questions? Please enter up to 250 characters in the box below.
</td>
</tr>
<tr><td colspan=2 height="4"><img src="/global_images2005/spacer.gif" height="4"></td></tr>
<tr>
	<td>&nbsp;</td>
	<td>
	<textarea name="comments" cols="45" rows="5" class="formData"></textarea></td>
</tr>
