...
<head>
	...
	<title>2005 International CES:&nbsp;Exhibitor Public/Investor Relations Kit</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/exhibitors/">Exhibitor Services</a>&nbsp;>&nbsp;<a href="/exhibitors/pr/">PR Help</a>&nbsp;>&nbsp;Exhibitor PR Kit
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.7.1") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/2.0/2.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Exhibitor Public/Investor Relations Kit<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="2.7.1">	
<!-- text for main page -->
Ranked the largest technology tradeshow in North America by <em>Tradeshow Week</em>, the International CES offers exhibitors excellent press exposure. The International CES Exhibitor PR kit offers tips and contacts to assist with your company's public and investor relations efforts. 
<br><br>

<table class="exhibitor8" width="350" cellspacing="0" cellpadding="0" border="0">
	<tr>
	    <td width="10"><img src="/global_images2005/in_page_up_left.gif" alt="" width="10" height="10" hspace="0" vspace="0" border="0"></td>
	    <td width="330"><img src="/global_images2005/spacer.gif" alt="" width="330" height="10" hspace="0" vspace="0" border="0"></td>
	    <td width="10"><img src="/global_images2005/in_page_up_right.gif" alt="" width="10" height="10" hspace="0" vspace="0" border="0"></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td><span class="subhead">Downloads at-a-glance:</span></td>
	</tr>
	<tr>
	    <td>&nbsp;</td>
		<td valign="top" class="text">
			<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span><a href="pdfs/ExhibitorPRKit2k5.pdf" target="_blank">Comprehensive 2005 International CES Exhibitor PR/IR Kit (pdf)</a><BR>
			<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span><a href="pdfs/PublicRelationsContactForm.pdf" target="_blank">Public Relations Contacts Form (pdf)</a><BR>
			<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span><a href="pdfs/FacilityReservationForm.pdf" target="_blank">Press Conference Facility Reservation Form (pdf)</a><BR>
			<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span><a href="pdfs/CelebrityForm.pdf" target="_blank">Special Event/Celebrity Appearance Form (pdf)</a><BR>
		</td>
	    <td>&nbsp;</td>
	</tr>
	<tr>
...
<br>
<span class="subhead"><a href="publicity.asp">Publicity Tips</a></span><br>
Take advantage of the media interest generated by the International CES, and use these tips and free publicity opportunities to get the coverage your company deserves.
<br><br>
<span class="subhead"><a href="contact.asp">Contacts and Deadlines</a></span><br>
Locate CES and other key contacts dedicated to supporting your PR efforts. Also, a deadline checklist ensures you don't miss a single opportunity.
<br><br>
<span class="subhead"><a href="pr_contacts.asp">PR/IR Contact Information</a></span><br>
Submit or update your public and investor relations contact information so CES can keep you informed throughout the year.  We'll also distribute your information in a variety of materials made available to attending press and analysts.
<br><br>
<span class="subhead"><a href="press_room.asp">Press Room</a></span><br>
Although exhibitor and public relations representatives are not allowed in the press room, your company's presence is visible through press kits and sponsorships.  Be sure to put your company name and logo in front of the 5,500+ attending media and analysts.
<br><br>
<span class="subhead"><a href="kit.asp">Press Kits and Releases</a></span><br>
Learn the specifics of when and how to get your press kits to us. It's one of the easiest ways to get your information in front of the press.  Also, find tips on writing and distributing releases, and tailoring your PR campaign to reach the numerous financial/industry analysts before and during the show.
<br><br>
<span class="subhead"><a href="events.asp">Press Events</a></span><br>
We want to assist you in making all of your company's important announcements at the 2005 International CES. Here you'll find information about:
<ul>
	<li>Press conferences
	<li>Interview rooms
	<li>Awards programs
	<li>Celebrity appearances
	<li>Regional media outreach campaign
	<li>Speaking opportunities
</ul>
<!-- /text for main page -->
</div>
