...
<head>
	...
	<title>2005 International CES:&nbsp;Exhibitor Public/Investor Relations Contact Information</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/exhibitors/">Exhibitor Services</a>&nbsp;>&nbsp;<a href="/exhibitors/pr/">PR Help</a>&nbsp;>&nbsp;<a href="/exhibitors/pr/pr_kit/default.asp">Exhibitor PR Kit</a>&nbsp;>&nbsp;PR/IR Contact Info
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.7.1.3") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<!-- PR HELP -->
	...
	<a href="/exhibitors/pr/pr_kit/default.asp">Exhibitor PR Kit</a><br>
			...
			<span class="nav_fourth_arrow"><b>></b> &nbsp;</span>PR/IR Contact Information</a><br>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/2.0/2.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Exhibitor Public/Investor Relations Contact Information<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="2.7.1.3">	
<!-- text for main page -->
The 2005 International CES is about more than your booth.  It is a chance to brand your company name and maximize your opportunities before, during and after CES.  To assist your public relations staff with your CES investment, we send information throughout the year about promotional opportunities as part of your CES Exhibitor Package.
<br><br>
<span class="subhead">Update your information today</span><br>
Download the <a href="pdfs/PublicRelationsContactForm.pdf" target="new">Exhibitor Public/Investor Relations Contacts</a> forms.  Fax your completed forms to (703) 907-7690.
<br><br>
The contacts you list will be individuals to whom we will direct any inquiries we receive regarding your company or products.  The contact information will be posted on CESweb.org for access by the media and other visitors to the CES website.
<br><br>
If your contact information has changed since you submitted your Public/Investor Relations Contacts forms, <a href="/exhibitors/resource_center/directory/eims_pr_contacts.asp">submit your updates online</a> (login required) or e-mail <a href="mailto:prcontacts@ce.org">prcontacts@ce.org</a>.
<br><br>
<b>Keep in mind that the PR plan does not work if the messenger is unable to deliver the message.</b>
