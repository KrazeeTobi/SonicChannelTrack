...
<head>
	...
	<title>2005 International CES:&nbsp;Airlines and Car Rental</title>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/1.0/1.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Airlines and Car Rental<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
Impress your boss and colleagues with big travel savings for the 2005 International CES. <a href="http://www.tvlon.com/2005CES" target="_blank">Book your Las Vegas airline reservations</a> today to take advantage of huge discounts and specially negotiated airfares for the 2005 International CES. 
<br><br>
Be prepared for takeoff. The <a href="http://129.33.119.130/public/display?theme=175" target="_blank">Transportation Security Administration</a> offers information on air travel security measures.
<br>
...
<tr>
    <td width="120" valign="top" class="text"><a href="http://www.budgetvegas.com/?pc=CES2005" target="new">Budget Rent a Car</a></td>
    
	<td width="20"><img src="/global_images2005/spacer.gif" alt="" width="16" height="1" border="0"></td>
   
	<td width="120" valign="top" class="text">CES2005</td>
