...
<head>
	...
	<title>2005 International CES:&nbsp;Home Networking</title>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/1.0/1.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
	...
	<tr> 
		...
		Learn about <a href="http://www.ce.org/ce_technologies/display.asp?id=Home%20Networking" target="new">CEA Home Networking initiatives</a> and how you can get involved.<br>
	...
	<tr> 
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="380"  background="/global_images2005/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Home Networking<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="1.6.5">		
<!-- text for main page -->
<!--<span class="section_title">No place like home</span><br><br>-->
<img src="images/home_networking2.jpg" align="right" hspace="5" style="border: 1px #cccccc solid">
Home networking is witnessing growth both in new construction and in existing homes, thanks in large part to the success of the Internet. Consumers' desire to share a broadband Internet connection is the leading application for networked computers, followed by the need to share files, hard disk content and printers. Sharing a broadband connection will continue to be the primary driver for home networking products in 2004. 
<br><br>Once the infrastructure is in place, opportunities for networked entertainment, communications and security products will increase the value and appeal of home networks. See it all and make your networked home connections at the 2005 International CES. 
...
At the 2005 International CES, expect home networking exhibitors to turn out en masse, including CorAccess, D-Link, HP, Microsoft, Motorola Broadband, Net Gear, OnQ Technologies, Scientific Atlanta, USTEC and XtremeSpectrum. 
<br><br>
Use the <a href="/attendees/directory/exhibitor_name.asp">exhibitor directory</a> and search by product category to see a complete list of 2005 home networking exhibitors.
<!--<ul>-->
...
These 2005 International CES TechZones offer buyers, distributors, engineers and other attendees and exhibitors a condensed cross-section of the networking market:
<ul>
...
<br>-->
<strong>Visit the CEA website, <a href="http://www.CE.org">www.CE.org</a></strong>, to learn more about publications, upcoming events and current initiatives in home networking.
<br>
...
<tr> 
	...
	<tr>
		<td><img src="/global_images2005/markets/networking.gif" alt="" hspace="0" vspace="0" border="0"></td>
	</tr>
	<tr>
		<td>Look for this sign to find home networking exhibits on the 2005 International CES show floor.</td>
	</tr>
	</table>
	</td>
...
<tr>
	<td valign="top"><img src="/global_images2005/bullet.gif"></td><td><strong>Home Networking Reception</strong><br><span class="text_colored">6-8 p.m. January 8, LVCC South Hall 1-2, TechHome TechZone</span></td>
</tr>
<tr>
...
<tr>
	<td valign="top"><img src="/global_images2005/bullet.gif"></td><td><strong>Home Networking Trends Chat</strong><br><span class="text_colored">11 a.m. January 8, LVCC Grand Lobby, CEA Stage</span><br>Park Associates' Kurt Scherf discusses the latest home networking trends.</td>
</tr>
</table>
-->

<span class="subhead">Home Networking at the International CES</span><br>
<ul>
	<li>Bill Gates highlighted interactivity between Microsoft products, the Internet and the home entertainment experience in 2003.
	<li>The CEA TechHome exhibit showcases the latest products and technology for the modern connected home.
	<li>More than 30,000 attendees engage with home networking companies.
	<li>Home networking and information technology conference sessions include topics on home security, interconnectivity of home products and appliances, and home entertainment.
	<li>Several HNIT industry leaders from such companies such as Lutron, Onkyo and Russound share insight in CES home networking conference sessions.
	<li>With more than 50 percent of CEA's current membership comprised of companies with sales under $30 million, CEA created a Small Business Program, which offers services and programs to grow this important membership and business segment. 
	<li>To help evaluate and compare a home's technological capabilities, CEA developed the TechHome Rating System.
	<li>CEA's online training module (<a href="http://www.CEKnowHow.com" target="_blank">www.CEKnowHow.com</a>) focuses on home networking, helping experienced and junior sales associates alike become familiar with today's networked home products.
</ul><br>
...
<!--
<img src="/global_images2005/spacer.gif" alt="" width="1" height="20" hspace="0" vspace="0" border="0"><br>
<span class="subhead">2003-2004 Home Networking Advances</span>
<ul>
	<li>The Internet is driving home networking. 
	<li>Platforms inch toward standardization. 
	<li>Major companies invest in home networking research and development. 
	<li>Low cost and ease of installation are key factors driving growth. 
	<li>Connectivity with simplicity still is the primary goal. 
	<li>Networked content is king. 
</ul>
<br>
