...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/1.0/1.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
	...
	<tr> 
		...
		Learn about <a href="http://www.ce.org/ce_technologies/display.asp?id=wireless" target="new">CEA Wireless initiatives</a> and how you can get involved.<br>
	...
	<tr> 
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="380"  background="/global_images2005/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Wireless<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="1.6.8">		
<!-- text for main page -->
<!--<span class="section_title">Pull the plug</span><br><br>-->
<img src="images/wireless2.jpg" align="right" hspace="5" style="border: 1px #cccccc solid">
Wireless is getting personal. From college campuses to youth soccer fields to corporate boardrooms, consumers are making mobile devices natural extensions of themselves. During the next decade, the need for immediate real-time access will be aided by faster data transmission speeds, boosts in battery power, increased use of local area networks (LANS), more location-based services and innovative new wireless gadgets. 

<br><br>Wireless technology pervades every consumer technology product category today. See it all come together at the 2005 International CES January 6-9, 2005, in Las Vegas.
...
At the 2005 International CES, exhibiting carriers such as Sprint and Verizon join wireless manufacturers and distributors, including Audiovox, Brightpoint, Cellstar, Kyocera, Nokia and Samsung to showcase the hottest wireless products and services.
<br><br>
Use the <a href="/attendees/directory/exhibitor_name.asp">exhibitor directory</a> and search by product category to see a complete list of 2005 wireless exhibitors.
<!--<ul>-->

<!--</ul>
<br>
<strong>Note:</strong> This offers just a sample of 2005 International CES wireless exhibitors. <a href="/attendees/exhibit_floor/directory/exhibitor_name.asp">Browse the exhibitor directory</a> for a complete list.
<br>-->
...
These 2005 International CES TechZones offer buyers, distributors, engineers and other attendees and exhibitors a condensed cross-section of the wireless communications market:
<ul>
	<li>Assistive Technologies
	<li>Connected Home Entertainment
	<li>Digital Car/Telematics
	<li>Flash Forward
	<li>MP3
	<li>Portable Power
	<li>TechHome
...
<br>
<strong>Visit the CEA website, <a href="http://www.CE.org">www.CE.org</a></strong>, to learn more about publications, upcoming events and current initiatives in wireless communications.
<br>
...
<tr> 
	...
	<tr>
		<td><img src="/global_images2005/markets/wireless.gif" alt="" hspace="0" vspace="0" border="0"></td>
	</tr>
	<tr>
		<td>Look for this sign to find wireless exhibits on the 2005 International CES show floor.</td>
	</tr>
	</table>
	</td>
...
<tr>
	<td valign="top"><img src="/global_images2005/bullet.gif"></td><td><strong>Fastest Finger Contest</strong><br><span class="text_colored">Thursday 10 a.m., Friday and Saturday 9 a.m., Sunday 11 a.m., LVCC Grand Lobby, CEA Stage</span><br>Compete to see who can use wireless data devices the fastest.</td>
</tr>
<tr>
	<td valign="top"><img src="/global_images2005/bullet.gif"></td><td><strong>Wireless Communications Reception</strong><br><span class="text_colored">5:30-7:30 p.m. January 8, LVCC South Hall, Room S233</span></td>
</tr>
<tr>
	<td valign="top"><img src="/global_images2005/bullet.gif"></td><td><strong>International Gateway Happy Hours</strong><br><span class="text_colored">4-6 p.m. January 10-11, LV Hilton</span><br>Meet members of the press and international exhibitors to extend your network beyond the U.S.</td>
</tr>
<tr>
	<td valign="top"><img src="/global_images2005/bullet.gif"></td><td><strong>NextGen04 Demo Home</strong><br><span class="text_colored">LVCC Silver Exhibits</span><br>See the practical application of home automation and whole house broadband for the next generation of home buyers.</td>
</tr>
<tr>
...
<span class="subhead">Wireless at the International CES</span><br>
<ul>
	<li>CES features top players from the WiFi market in exhibits and conferences sessions.
	<li>More than 28,000 executives attended the 2004 CES to explore wireless technology.
	<li>Wireless conference sessions focus on trends and topics such as WiFi, Bluetooth, 802.11 technology and wireless communications sales training. 
	<li>The CEA Wireless Certification Program offers web-based educational to help retail managers and sales personnel better sell wireless and handheld products.
	<li>CEA equips small retailers with success essentials with the first-ever wireless guidebook for the small business owner, <em>Selling Wireless Successfully: The Retailer's Survival Guide</em>.
	<li>CEA's Wireless Communications Division (WCD) unveils the monthly Wireless Webcast Series, bringing timely presentations focusing on industry issues, trends, products and more.
</ul><br>
...
<!--
<img src="/global_images2005/spacer.gif" alt="" width="1" height="20" hspace="0" vspace="0" border="0"><br>
<span class="subhead">2003-2004 Wireless Advances</span>
<ul>
	<li>Ring tone variations, gaming and digital cameras add new features to wireless phones. 
	<li>Mobile phone companies take aim at youth market.  
	<li>PDAs continue to add phone and wireless Internet capabilities. 
	<li>Bluetooth about to shed “big potential” tag.  
	<li>WiFi hits a few bumps but continues to grow. 
</ul>
<br>
