...
<!-- CONFERENCES -->
	...
	Speaking Opportunities</a><br>
			...
			<span class="nav_fourth">
			<span class="nav_fourth_arrow"><b>></b> &nbsp;</span><a href="speaker_form.asp">Call for Speakers Form</a><br>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/1.0/1.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Speaking Opportunities<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<!-- text for main page -->
<div id="1.1.7">
More than 130,000 industry professionals from 110 countries came to Las Vegas to see the cutting edge in consumer technology at the 2005 International CES, featuring four days of conference sessions, keynote speeches and exhibits. It is the showcase for financial analysts, venture capitalists, developers, consumer technology manufacturers, corporate buyers and retailers. A speaking position in the CES conference program is your opportunity to reach this audience.
<br><br>
<strong>You may secure a speaking opportunity</strong> at the 2005 International CES for you, your company or your client by answering the <a href="speaker_form.asp">2005 International CES CALL FOR SPEAKERS</a>.
<br><br>
The 2005 International CES will host conference sessions addressing wireless technology, home networking, mobile electronics, emerging technologies, retailing trends, e-commerce, digital content and much more.  Please see the <a href="speaker_form.asp">online entry form</a> for a full list of conference subjects.
<br><br>
All submissions should include a 50 to 75-word biography, a photo, and at least three key points you can address for each session selected.  Should you be chosen to speak at the 2005 International CES, your bio and photo will be posted on <a href="http://www.CESweb.org">www.CESweb.org</a>.
<br><br>
...
<span class="subhead">Suggested topics for the 2005 International CES conference program include:</span>
<br><br>
<table width="90%" border="0">
<tr>
	<td valign="top" width="34%"><span class="text">
	...
	<td valign="top" width="32%"><span class="text">
	Handheld Computing<br>	
	HDTV<br>
	High Performance Audio<br>
	Home Automation<br>
	Home IT Networking<br>
...
<br>
Because of the number of sessions and the need for a balanced program, a limited number of presenters will be accepted. We consider all proposals based on industry representation, professionalism, prior public speaking experience and session topic relevance.  
<br><br>
Those selected to participate in the conferences program receive a <a href="speaker_services.asp">variety of resources</a> to enhance their 2005 International CES experience.
<br><br>
<strong>NOTE: All speaker candidates will be notified of their acceptance status on or before September 24, 2004.</strong>

<!--
The 2004 International CES offers more than 100 conference sessions to address the wide range of issues that matter to consumer technology professionals.
<br><br>
<table width="590" cellspacing="0" cellpadding="0" border="0"  class="text">
<tr>
    <td width="285" valign="top">
		<span class="subhead"><a href="call_speakers.asp">Call for Speakers</a><br></span>
		Apply to speak on more than 50 available topics at the 2004 International CES before August 15. All candidates will be notified by September 26, 2003.
	</td>
    
	<td width="20"><img src="/global_images2005/spacer.gif" alt="" width="20" height="1" border="0"></td>
    
	<td width="285" valign="top">
		<span class="subhead"><a href="speaker_services.asp">Speaker Services</a><br></span>
		Those selected to participate in the conferences program receive a variety of resources to enhance their 2004 International CES experience.
	</td>
</tr>
</table>
-->
