...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.2.3") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<!-- SPANISH -->
	...
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br> 
	Servicios internacionales</a><br>
	<img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Servicios internacionales<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="4.2.3">	
<!-- text for main page -->

<span class="subhead">Centro de Comercio Internacional (ICC)</span><br>
El Centro de Comercio Internacional es un excelente medio de reuniones para usted y sus colegas que asisten a la exposición. Revise sus mensajes de correo electrónico, disfrute de bocadillos ligeros y obtenga respuestas a sus preguntas sobre la exposición con la ayuda del personal políglota. Los ICC se encuentran en el nivel superior del vestíbulo sur del Centro de Convenciones de Las Vegas y en Las Vegas Hilton, y están disponibles para todos los asistentes y los expositores internacionales.
<br><br>

<span class="subhead">Intérpretes disponibles</span><br>
El sitio tiene a su disposición su personal políglota en ambas ubicaciones del ICC y en el área de registro internacional, en el nivel inferior del vestíbulo sur. Los intérpretes dominan con fluidez varios idiomas: español, alemán, francés, chino, japonés, coreano, italiano y portugués.
<br><br>

<span class="subhead">Recepción internacional</span><br>
Disfrute la primera noche de la exposición generando contactos con los expositores y los asistentes de todo el mundo. La recepción internacional se celebrará la noche del jueves 6 de enero, de 6:00 a 7:30 p.m. en el vestíbulo sur, sala S222. Se invita a este evento a todos los asistentes internacionales, expositores y representantes de la prensa. 
<br><br>

¿Habría otros servicios que quisiera sugerir para que los ofrezcamos a los asistentes y expositores internacionales? Envíe un mensaje de correo electrónico para Diann Groff a: <a href="mailto:dgroff@ce.org">dgroff@ce.org</a>.
