...
<head>
	...
	<title>2005 International CES:&nbsp;Programme Groupe Délégation</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.3.2") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<!-- FRENCH -->
	...
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
	Programme Groupe Délégation</a><br>
	<img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br> 
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Programme Groupe Délégation<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="4.3.2">	
<!-- text for main page -->

Le CES international facilite autant que possible le recrutement et l’organisation de groupes de participants au salon. Par la valeur ajoutée et les incitations dont bénéficieront les membres de votre groupe, nous vous aiderons à couronner vos efforts de succès et à satisfaire vos délégués. 
<br><br>
Prenez dès aujourd’hui la tête d’une délégation ! Il suffit de remplir le formulaire de délégation <a href="/international/english/pdf/International delegation group Program Application.pdf" target="_blank">Delegation Application form (pdf)</a> et de le renvoyer par fax à l’attention d’Elena Vasquez, au +1-703-907-7602.
<br><br>

<span class="subhead">Avantages offerts aux chefs de délégation :</span>
<ul>
	<li>Brochures promotionnelles et formulaires électroniques de recrutement. 
	<li>Usage du logo CES 2005 sur le matériel promotionnel de marque*.
	<li>Capacité dinscription de membres de délégation et de maintien de liste en ligne. 
	<li>Hôtel gratuit pour les chefs de délégation amenant 50 participants individuels ou plus au Salon CES (15 pour les groupes du secteur public). 
	<li>Inscription au site CES international (<a href="http://www.CESweb.org">www.CESweb.org</a>) à titre de chef officiel de délégation. 
	<li>Invitation au Dîner des chefs de délégation. 
	<li>Sac à dos sur roues CES pour le transport aisé du matériel du salon dans les salles d’exposition. 
</ul>
<br>

* <em>Le matériel promotionnel doit être soumis à l’approbation du CES avant l’usage du logo. </em>
<br><br>

<span class="subhead">Avantages offerts aux membres individuels de groupe : </span>
<ul>
	<li>Avant l’ouverture du Salon CES, accès à la liste des exposants exportateurs ayant exprimé un intérêt pour le pays et la région du groupe. 
	<li>Possibilité de participation gratuite à une conférence.    
	  <ul>
	    <li>Chaque chef de délégation recevra 5 à 10 laissez-passer. Chaque laissez-passer
	      donnera accès à une conférence. 
	      Adressez-vous à votre chef de délégation concernant toute conférence à laquelle
	      vous désirez
assister. </li>
    </ul>
	<li>Carte d’admission Exhibits Plus gratuite aux membres de délégation. 
	<li>Guide de délégation indiquant les principaux événements du Salon CES international. 
	<li>Invitation à la réception internationale 
	<li>Invitation à un petit déjeuner continental d’information pour délégations le matin de l’ouverture officielle du salon.
</ul>
