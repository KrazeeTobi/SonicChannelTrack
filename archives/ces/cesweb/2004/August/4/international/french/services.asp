...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.3.3") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Services internationaux<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="4.3.3">	
<!-- text for main page -->

<span class="subhead">Centre de commerce international (ICC – International Commerce Center)</span><br>
L’International Commerce Center vous offre, ainsi qu’à vos collègues présents au salon, un point de rencontre idéal. Vous pourrez y consulter votre courrier électronique, prendre un rafraîchissement ou vous renseigner sur le salon auprès du personnel multilingue du salon. Les centres seront situés à l’étage supérieur du Las Vegas Convention Center -South Hall et au Las Vegas Hilton. Ils sont ouverts à tous les visiteurs et exposants internationaux. 
<br><br>

<span class="subhead">Interprètes</span><br>
Un personnel multilingue se tiendra à votre disposition aux deux centres de commerce international, ainsi qu’au comptoir d’inscription internationale (International Registration) à l’étage inférieur du South Hall. Nos interprètes pourront vous aider dans les langues suivantes : espagnol, allemand, français, chinois, japonais, coréen, italien et portugais. 
<br><br>

<span class="subhead">Réception internationale</span><br>
Ne manquez pas la première soirée de rencontre du salon : l’occasion rêvée de prendre contact avec les exposants et visiteurs des quatre coins du monde ! La réception internationale se tiendra le jeudi 6 janvier, de 18 à 19 h 30, au South Hall, salle S222. Tous les participants internationaux, exposants et membres de la presse y sont invités. 
<br><br>

Aimeriez-vous suggérer d’autres services utiles aux visiteurs et exposants internationaux ? Adressez un courrier électronique à Diann Groff, <a href="mailto:dgroff@ce.org">dgroff@ce.org</a>.
