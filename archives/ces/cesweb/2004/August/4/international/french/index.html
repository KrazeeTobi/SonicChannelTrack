...
<head>
	...
	<title>2005 International CES:&nbsp;Visiteurs internationaux</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/international/">International Visitors</a>&nbsp;>&nbsp;Franca&iacute;s
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.3") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Visiteurs internationaux<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="4.3">	
<!-- text for main page -->

Le Salon CES international attire une multitude d’exposants et de visiteurs internationaux des plus diverses, ainsi que des milliers de professionnels américains de l’électronique grand public désireux d’établir le contact avec d’autres entreprises du monde. 

<br>
<img src="/global_images2005/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/4.0/4.0.line.gif" alt="-----------------------------------------------" width="590" height="2" hspace="0" vspace="0" border="0"><br>
<div class="section_title">Ne manquez pas les toutes dernières nouveautés de la technologie ! Rendez-vous au Salon CES international 2005 !</div>

<table width="590" cellspacing="0" cellpadding="0" border="0"  class="text">
<tr>
    <td width="291" valign="top"><span class="subhead"><a href="travel.asp">Voyage et visa</a><br></span>
Il n’est jamais trop tôt pour préparer votre voyage au Salon CES international 2005. De la demande d’un visa aux tarifs d’hôtel réduits, nous sommes prêts à vous aider pour faciliter votre voyage aux États-Unis. 
		<br><br>
		<span class="subhead"><a href="delegations.asp">Programme Groupe Délégation (NOUVEAU !)</a><br></span>
Participez à la plus grande foire commerciale de l’électronique grand public, du 6 au 9 janvier 2005 ! Amenez une délégation au Salon CES international 2005 à Las Vegas (Nevada, USA) ! Renseignez-vous sur notre nouveau programme à l’intention des groupes. 
	</td>
    
	<td width="20"><img src="/global_images2005/spacer.gif" alt="" width="20" height="1" border="0"></td>
    
	<td width="279" valign="top">
		<span class="subhead"><a href="services.asp">Services internationaux</a><br></span>
Le Salon CES international propose à ses exposants et visiteurs étrangers une série de services organisés spécifiquement pour eux : interprètes, centres de commerce, réceptions et autres. Renseignez-vous !</td>
</tr>
</table>
