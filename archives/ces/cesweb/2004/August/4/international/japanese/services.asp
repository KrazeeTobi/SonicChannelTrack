...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.6.3") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">国際サービス<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<meta http-equiv="Content-Type" content="text/html; charset=Shift_JIS"><div id="4.6.3">	
<!-- text for main page -->

<span class="subhead">国際商業センター (ICC)</span><br>
国際商業センターは、見本市の参加者や同僚の皆様のための素晴らしい出会いの場です。Eメールをチェックし、軽いスナックを楽しみながら、見本市についての質問を複数言語でスタッフに答えてもらいましょう。ICCはラスベガス コンベンション センター南ホールの上の階とラスベガス ヒルトンに位置し、国際参加企業や出展企業すべてにご利用いただけます。
<br><br>

<span class="subhead">通訳サービス</span><br>
ICCの存在する両会場および南ホールの下の階にある国際登録所のいずれでも、複数言語でスタッフのサービスをご利用いただけます。通訳は、スペイン語、ドイツ語、フランス語、中国語、日本語、韓国語、イタリア語、ポルトガル語の数ヶ国語に堪能です。
<br><br>

<span class="subhead">国際レセプション</span><br>
世界各地から参加した出展企業や参加企業の関係者とネットワークを作りながら、見本市初日の夕べをお楽しみください。国際レセプションは、南ホール、S222において1月6日（木）、午後6時から7時30分まで開催されます。このネットワーキング イベントには、海外からの参加者、出展企業関係者、報道関係者の全員が招待されます。
<br><br>

海外からの参加者や出展企業関係者に提供したいサービスが他にもありますか？ご提案は、Diann Groff (<a href="mailto:dgroff@ce.org">dgroff@ce.org</a>) 宛てにEメールでお願いいたします。
