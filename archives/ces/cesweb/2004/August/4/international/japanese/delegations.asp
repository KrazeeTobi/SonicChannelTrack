...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.6.2") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<!-- JAPANESE -->
	...
	<a href="/international/japanese/travel.asp">—·s‚ÆƒrƒUî•ñ</a><br>
	...
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br> 
	<a href="/international/japanese/services.asp">‘ÛƒT[ƒrƒX</a><br>
	<img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">‘ã•\’cƒvƒƒOƒ‰ƒ€<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<meta http-equiv="Content-Type" content="text/html; charset=Shift_JIS"><div id="4.6.2">	
<!-- text for main page -->

‘ÛCES‚Å‚ÍAŒ©–{s‚Ö‚Ì’c‘Ì‚ÌƒŠƒNƒ‹[ƒg‚â”hŒ­‚ğ‚Å‚«‚éŒÀ‚è—eˆÕ‚É‚·‚×‚­“w—Í‚ğ‚µ‚Ä‚¨‚è‚Ü‚·BŠF—l‚Ì‚¨æ‚è‘g‚İ‚ğ¬Œ÷—¡‚É“±‚«A’c‘Ì‚Ìˆêˆõ‚Æ‚µ‚ÄQ‰Á‚³‚ê‚é‘ã•\‚Ì•ûX‚ª—·s‚Å“¾‚ç‚ê‚é•t‰Á‰¿’l‚â§—ã•i‚É‚²–‘«‚¢‚½‚¾‚¯‚é‚æ‚¤‚¨è“`‚¢‚¢‚½‚µ‚Ü‚·B
<br><br>
¡‚·‚®³®‚È‘ã•\’c‚ÌƒŠ[ƒ_[‚É‚È‚è‚Ü‚µ‚å‚¤B<a href="/international/english/pdf/International Delegation group Program Application.pdf" target="_blank">‘ã•\’c\—p† (pdf)</a> ‚É•K—v–€‚ğ‚·‚×‚Ä‚²‹L“ü‚ÌãAElena Vasquez ˆ¶‚É 703-907-7602 ‚Ü‚Åƒtƒ@ƒbƒNƒX‚µ‚Ä‚­‚¾‚³‚¢B
<br><br>

<span class="subhead">‘ã•\’c‚ÌƒŠ[ƒ_[‚Ö‚Ì“Á“T‚ÍAŸ‚Ì‚Æ‚¨‚è‚Å‚·B</span>
<ul>
	<li>‘ã•\’cƒŠƒNƒ‹[ƒg‚É–ğ—§‚Âé“`—pƒpƒ“ƒtƒŒƒbƒg‚Æ“dqƒeƒ“ƒvƒŒ[ƒgB
	<li>2005”N“xCESƒƒS‚ÉƒAƒNƒZƒX‚µ‚Äé“`—p‘—¿‚É¤•W‚ğ‚Ì‚¹‚Ü‚·B*
	<li>‘ã•\’cˆõ‚Ì“o˜^‚âƒŠƒXƒg‚ÌŠÇ—‚ªs‚¦‚éƒIƒ“ƒ‰ƒCƒ“‹@”\B
	<li>CES‚É50–¼ˆÈã‚ÌŒÂli­•{ŠÖŒW’c‘Ì‚Ìê‡‚Í15–¼j‚ğ˜A‚ê‚Ä—ˆ‚ç‚ê‚½‘ã•\’c‚ÌƒŠ[ƒ_[‚ÍA–³—¿‚Åƒzƒeƒ‹h”‘‚ª‚Å‚«‚Ü‚·B
	<li>³®‚È‘ã•\’c‚ÌƒŠ[ƒ_[‚Æ‚µ‚Ä‘ÛCESƒEƒFƒuƒTƒCƒg (<a href="http://www.CESweb.org">www.CESweb.org</a>) ‚Ìˆê——‚É‹LÚ‚³‚ê‚Ü‚·B
	<li>‘ã•\’cƒŠ[ƒ_[—[H‰ï‚Ö‚Ìµ‘ÒB
	<li>CES‚Ìƒ[ƒŠƒ“ƒOƒoƒbƒNƒpƒbƒN‚ğg—p‚µ‚ÄA‰ïê“à‚ÅŒ©–{s—p‘—¿‚ğ—eˆÕ‚É‚¿‰^‚Ñ‚Å‚«‚Ü‚·B
</ul>
<br>

* <em>é“`—p‘—¿‚ÍAƒƒS‚ğg—p‚·‚é‘O‚ÉCES‚ÌR¸‚Æ³”F‚ğó‚¯‚é•K—v‚ª‚ ‚è‚Ü‚·B</em>
<br><br>

<span class="subhead">’c‘Ì‚Ìˆêˆõ‚Æ‚µ‚ÄQ‰Á‚µ‚½ŒÂl‚Ö‚Ì“Á“T‚ÍAŸ‚Ì‚Æ‚¨‚è‚Å‚·B</span>
<ul>
	<li>CESŠJÃ‘O‚ÉA’c‘Ì‚Ìog‘‚¨‚æ‚Ñ’nˆæ‚Ö—Ao‚ğs‚Á‚Ä‚¢‚éA‚ ‚é‚¢‚Í«—ˆ‚Ì—Ao‚ÉŠÖS‚ğ¦‚µ‚½o“WŠé‹Æ‚ÌƒŠƒXƒg‚Ö‚ÌƒAƒNƒZƒXB
	<li>ƒRƒ“ƒtƒ@ƒŒƒ“ƒX‚Ö‚Ì–³—¿Q‰Á‚Ì‰Â”\«
      <ul>
        <li>Še‘ã•\’cƒŠ[ƒ_[‚É‚Í5`10–‡‚ÌƒpƒX‚ª”z‚ç‚ê‚Ü‚·Bˆê–‡‚ÌƒpƒX‚ÅƒRƒ“ƒtƒ@ƒŒƒ“ƒX‚Ìˆê‚Â‚ÌƒZƒbƒVƒ‡ƒ“‚ÉQ‰Á‚Å‚«‚Ü‚·B<br>
        ƒRƒ“ƒtƒ@ƒŒƒ“ƒXƒZƒbƒVƒ‡ƒ“‚Ö‚ÌQ‰Á‚ÉŠÖS‚Ì‚ ‚é•û‚ÍAŠ‘®‚Ì‘ã•\’cƒŠ[ƒ_[‚Ü‚Å‚¨–â‚¢‡‚í‚¹‚­‚¾‚³‚¢B </li>
    </ul>
	<li>‘ã•\’cƒƒ“ƒo[—p–³—¿“W¦‰ïƒvƒ‰ƒXƒpƒX
	<li>‘ÛCES‚ÌŒÄ‚Ñ•¨‚ğ“ÁW‚µ‚½‘ã•\’cƒKƒCƒh
	<li>‘ÛƒŒƒZƒvƒVƒ‡ƒ“‚Ö‚Ìµ‘Ò
	<li>Œ©–{sŠJ–‹‚Ì’©‚ÌŠT—v‚ğ“`‚¦‚é‘ã•\’cƒRƒ“ƒ`ƒlƒ“ƒ^ƒ‹ ƒuƒŒƒbƒNƒtƒ@[ƒXƒg‚Ö‚Ìµ‘Ò
</ul>
