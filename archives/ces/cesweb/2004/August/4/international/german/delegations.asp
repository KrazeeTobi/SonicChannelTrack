...
<head>
	...
	<title>2005 International CES:&nbsp;Delegationsgruppenprogramm</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/international/">International Visitors</a>&nbsp;>&nbsp;<a href="/international/german/">Deutsch</a>&nbsp;>&nbsp;
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.4.2") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<!-- GERMAN -->
	...
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
	Delegationsgruppen-<br>programm</a><br>
	<img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br> 
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Delegationsgruppenprogramm<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="4.4.2">	
<!-- text for main page -->

Die International CES macht es Ihnen denkbar einfach, Interessentengruppen zu werben und zur Ausstellung mitzubringen. Wir werden in enger Zusammenarbeit mit Ihnen dafür sorgen, dass Ihre Delegationsteilnehmer in den Genuss eines gesteigerten Wertes und zahlreicher Anreize kommen, die mit dem Reisen in einer Gruppe verbunden sind.  
<br><br>
Ernennen Sie sich doch noch heute zu einem offiziellen Delegationsleiter. Füllen Sie einfach das <a href="/international/english/pdf/International Delegation Group Program Application.pdf" target="_blank">Antragsformular für Delegationen (im pdf-Format)</a> aus und faxen Sie es unter der Telefonnummer +1 703-907-7602 an Elena Vasquez.
<br><br>

<span class="subhead">Als Delegationsleiter bieten sich Ihnen zahlreiche Vorteile:</span>
<ul>
	<li>Werbebroschüren und elektronische Vorlagen als Hilfe bei der Anwerbung von Delegationsteilnehmern. 
	<li>Zugriff auf das 2005 CES-Logo, damit Sie Ihre eigenen Werbematerialien damit versehen können.*
	<li>Möglichkeit zur Online-Registrierung von Delegationsmitgliedern und zur Führung Ihrer Teilnehmerliste. 
	<li>Kostenloser Hotelaufenthalt für Delegationsleiter, die mindestens 50 Personen zur CES mitbringen (15 Personen für Regierungsgruppen). 
	<li>Aufnahme in die Liste der offiziellen Delegationsleiter auf der Website der International CES (<a href="http://www.CESweb.org">www.CESweb.org</a>).
	<li>Eine Einladung zum festlichen Abendessen für Delegationsleiter. 
	<li>Ein CES-Rollrucksack zum leichten Mitführen Ihrer Messematerialien auf dem Ausstellungsgelände. 
</ul>
<br>

* <em>Alle Werbematerialien müssen vor Gebrauch des Logos der CES zur Prüfung und Genehmigung vorgelegt werden. </em>
<br><br>

<span class="subhead">Personen, die als Mitglieder einer Gruppe anreisen, kommen in den Genuss der folgenden Vorteile: </span>
<ul>
	<li>Zugriff auf eine Liste der Aussteller, die Exporte in das Land bzw. die Region der Gruppe durchführen oder an solchen Exporten Interesse bekundet haben – noch vor Beginn der CES. 
  </ul>
</div>
<ul>
  <li>
    <div id="4.4.2">Das Angebot zum Gratisbesuch von Konferenzsitzungen.</div>
    <ul>
      <li>
        <div>Jeder Delegationsleiter erhält 5 bis 10 Pässe. Jeder Pass gewährt Zugang
	          zu einer Konferenzsitzung. Bitte wenden Sie sich an Ihren Delegationsleiter,
	          wenn Sie an der Teilnahme an einer Konferenzsitzung interessiert sind. </div>
      </li>
    </ul>
  </li>
</ul>
<div>
  <ul>
    <li>Kostenloser „Exhibits Plus Pass“ für Delegationsmitglieder. 
    <li>Delegationsführer mit den Höhepunkten der International CES. 
    <li>Einladung zum internationalen Empfang. 
    <li>Einladung zu einem kontinentalen Frühstück für Delegationen mit einem informativen Vortrag am ersten Morgen der Messe.
  </ul>
