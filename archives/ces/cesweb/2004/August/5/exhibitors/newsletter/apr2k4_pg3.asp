...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/2.0/2.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
  ...
  <!-- text for main page -->
  <img src="/global_images2005/spacer.gif" alt="" width="1" height="2" hspace="0" vspace="0" border="0"><br>
  ...
  <a name="newceamembers"></a><span class="subhead">New CEA Members</span></p>
<table align="center" cellpadding="0" cellspacing="0" width="90%">
  <tr>
    <td valign="bottom"><p> @Home Technology </p></td>
    <td valign="bottom"><p> Irwin Seating Co. Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> A Plus Systems / A Plus Security Inc. </p></td>
    <td valign="bottom"><p> Lehitek Electronics Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Acoustic Automation Specialists </p></td>
    <td valign="bottom"><p> LiteTouch Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Adimos Inc. </p></td>
    <td valign="bottom"><p> Macrovision </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Advanced eLiving </p></td>
    <td valign="bottom"><p> Middle Atlantic Products Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Advanced Security &amp; Integrations </p></td>
    <td valign="bottom"><p> Mooris Wiring Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> AET </p></td>
    <td valign="bottom"><p> Mr. Hook-it-up </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Akisha Networks </p></td>
    <td valign="bottom"><p> My Home Options </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Alync Inc. </p></td>
    <td valign="bottom"><p> Nationwide Security Systems </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Arc International </p></td>
    <td valign="bottom"><p> Northstar Satellites Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Ariane Controls </p></td>
    <td valign="bottom"><p> NPR - National Public Radio </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Audio Video International </p></td>
    <td valign="bottom"><p> Nugget Enterprises Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Automated Living Inc. </p></td>
    <td valign="bottom"><p> Patriot Systems Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> AVI Inc. </p></td>
    <td valign="bottom"><p> Pocono Smart Home Technology LLC </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Avix Inc. </p></td>
    <td valign="bottom"><p> Popular Merchandise Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Axonix Corp. </p></td>
    <td valign="bottom"><p> Power House Tech </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Barnworks Corp. </p></td>
    <td valign="bottom"><p> Precision Audio &amp; Video </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Blue Line Electronics </p></td>
    <td valign="bottom"><p> Proliphix LLC </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Blueroof Technologies </p></td>
    <td valign="bottom"><p> Pure Acoustics Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Charles Grainger Enterprises Inc. dbs Electronics
        Plus </p></td>
    <td valign="bottom"><p> Quicklink Audio Video </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Circuit City Stores Inc. </p></td>
    <td valign="bottom"><p> RedRadio Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Circuit Wizard.com LLC </p></td>
    <td valign="bottom"><p> ReplayTV Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Coleman Cable Inc. </p></td>
    <td valign="bottom"><p> Rio </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Comet Electric Inc. </p></td>
    <td valign="bottom"><p> Savant Technologies </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Compu Expert Distribution Inc. </p></td>
    <td valign="bottom"><p> SCE Development ( Canada ) Co. Ltd. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Computer Access Group Inc. </p></td>
    <td valign="bottom"><p> SchillingTECH Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Computerized Monitoring Services </p></td>
    <td valign="bottom"><p> Shasta Electric LP </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Concept Audio Design Inc. </p></td>
    <td valign="bottom"><p> Sight and Sound Communications </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Custom Home Theater </p></td>
    <td valign="bottom"><p> SLC Development LLC </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> DataSonic Systems </p></td>
    <td valign="bottom"><p> Smart Home Integrators </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Digital Home Ideas Inc. </p></td>
    <td valign="bottom"><p> Smart Home Technologies Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Dynamic Cabling </p></td>
    <td valign="bottom"><p> Smart Homes Plus LLC </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> EIS Services </p></td>
    <td valign="bottom"><p> Smartforce Consulting Group Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Electronic Home Solutions </p></td>
    <td valign="bottom"><p> Smartis Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Electronic Security Protection Inc. </p></td>
    <td valign="bottom"><p> Somfy Systems </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Element Digital Home </p></td>
    <td valign="bottom"><p> Specialty Marketing Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Elite Sight &amp; Sound </p></td>
    <td valign="bottom"><p> Staccato Communications </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Emerald Coast Audio </p></td>
    <td valign="bottom"><p> Structured Cable Products </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Enhanced HT </p></td>
    <td valign="bottom"><p> Structured Solutions </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Espial </p></td>
    <td valign="bottom"><p> Subjective Audio </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Evolve Solutions Inc. </p></td>
    <td valign="bottom"><p> Sunergy Systems </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Falcon Solutions LLC </p></td>
    <td valign="bottom"><p> Tech Data Corp. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> ForresterTech LLC </p></td>
    <td valign="bottom"><p> The Advantage Group </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Futuristic Home Inc. </p></td>
    <td valign="bottom"><p> The Systems Depot </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Gates General Contractor </p></td>
    <td valign="bottom"><p> Total Home Technology </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Global Cache </p></td>
    <td valign="bottom"><p> Transtech Electric Inc. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> GS-Magicstor Inc. </p></td>
    <td valign="bottom"><p> Vector Systems Design </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> HabiTech Systems Inc. </p></td>
    <td valign="bottom"><p> Video Installations Plus </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Hatton Comm &amp; Cabling Inc. </p></td>
    <td valign="bottom"><p> Warshauer Electric Supply Co. </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Holsen Inc. </p></td>
    <td valign="bottom"><p> Wigo Wireless </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Home Director </p></td>
    <td valign="bottom"><p> Wire Management </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> In Pro Car Wear Inc./IPCW </p></td>
    <td valign="bottom"><p> Wire Wizard </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Integrated Automations </p></td>
    <td valign="bottom"><p> World of Sound </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Intelligent House Home Technology Integrators </p></td>
    <td valign="bottom"><p> WorldWide Security/GC Alarm </p></td>
  </tr>
  <tr>
    <td valign="bottom"><p> Iridia Technologies Inc. </p></td>
    <td valign="bottom"><p> Yourtech Solutions </p></td>
  </tr>
</table>
</p>
<p>&nbsp;</p>
<div align="center">[ <a href="apr2k4_pg1.asp">page 1</a> ] &nbsp; [ <a href="apr2k4_pg2.asp">page
