  ...
  <tr>
   ...
   <td width="375" valign="top"><img src="/global_images2005/spacer.gif" width="10" height="18"><br>
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td><img src="/global_images2005/spacer.gif" width="10" height="2"><br><img src="/images/ces_photos/HPgatesbarrett.jpg" border="0" width="90" height="71" vspace="3"></td>
            <td width="3" ><img src="/global_images2005/spacer.gif" width="10" height="1"></td>
            <td  valign="top" style="color:#ffffff">Microsoft and Intel executives, Bill Gates and Craig Barrett, will deliver the opening and pre-show keynotes at the upcoming world's largest consumer technology tradeshow. 
                <span class="homepagelink"><a href="/press/news/rd_release_detail.asp?id=10515">Read on.</a></span></td>
        </tr>
     <tr>
      <td width="375" colspan="3"><img src="/global_images2005/spacer.gif" width="1" height="10"></td>
     </tr>
        <tr>
            <td><img src="/global_images2005/spacer.gif" width="10" height="2"><br><img src="/images/ces_photos/HPmonorail.jpg" border="0" width="90" height="69" vspace="3"></td>
            <td width="3" ><img src="/global_images2005/spacer.gif" width="10" height="1"></td>
            <td  valign="top" style="color:#ffffff">Some hotels are already full during the 2005 International CES. Book today and get the latest information on other updates, including the now-open Las Vegas Monorail.
                <span class="homepagelink"><a href="/attendees/travel/default.asp">Make your travel plans.</a></span></td>
        </tr>
    </table>&nbsp;
   </td>
