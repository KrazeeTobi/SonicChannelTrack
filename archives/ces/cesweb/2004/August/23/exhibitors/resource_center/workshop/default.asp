...
Exhibitor Workshop<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container612")) { document.getElementById("fourth_row_container612").style.display = "";}
        //-->
    </script>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue613', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue613', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue613" id="leftAddedValue613" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<TBODY>
<TR>
<TD class=text vAlign=top width=285><SPAN class=subhead><A href="/exhibitors/resource_center/workshop/about.asp">Workshop&nbsp;Details</A><BR></SPAN>The CES Exhibitor Workshop is the best way to prepare for your upcoming tradeshow experience. Meet vendors, get helpful tips and see the new show floor layout. <BR><BR><SPAN class=subhead><A href="/exhibitors/resource_center/workshop/agenda.asp">Workshop Agenda</A><BR></SPAN>A packed day at the Las Vegas Convention Center gets you prepared for the largest consumer technology tradeshow.</TD>
<TD width=20>&nbsp;</TD>
<TD class=text vAlign=top width=285><SPAN class=subhead><A href="/exhibitors/resource_center/workshop/hotel.asp">Hotel Reservations</A></SPAN><BR>A free workshop and a $59 room rate! You can't afford to miss this, and with this rate, you CAN afford to join us!<BR><BR><BR><A href="/exhibitors/resource_center/workshop/rd_registration.asp"><STRONG>Registration</STRONG></A><BR>Registration is free for all 2005 International CES exhibitors. But sign up now, because availability is limited.</TD></TR></TBODY></TABLE>
</span>
<!-- text for main page -->
</div>
