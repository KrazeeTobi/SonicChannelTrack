...
<!-- CES NEWS -->
	...
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
	<a href="/press/news/media_reports.asp">Media Coverage</a><br>
	<img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/3.0/3.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="press7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">CES Press Releases<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<!-- text for main page -->
<div id="3.1.1">		
<span class="subhead">2005 International CES Press Releases</span><br>

<table width="100%" border="0" cellpadding="3" cellspacing="3">	

	<tr>
		<td align="right" valign="top" nowrap>7/20/2004 - </td><td width="530"><a href="release_detail.asp?id=10507">2005 International CES Expands Exhibits Into Central And South Plazas</a></td>
		<!--  -->
	</tr>

	<tr>
		<td align="right" valign="top" nowrap>7/6/2004 - </td><td width="530"><a href="release_detail.asp?id=10499">Hottest Technology Under the Sun Expected at the 2005 International CES </a></td>
		<!--  -->
	</tr>

	<tr>
		<td align="right" valign="top" nowrap>6/3/2004 - </td><td width="530"><a href="release_detail.asp?id=10482">2005 International CES Issues Call for Conference Speakers </a></td>
		<!--  -->
	</tr>

	<tr>
		<td align="right" valign="top" nowrap>5/12/2004 - </td><td width="530"><a href="release_detail.asp?id=10456">2006 International CES Will Expand to Sands Convention Center</a></td>
		<!--  -->
	</tr>
...
<table width="100%" border="0" cellpadding="3" cellspacing="3">	
	...
	<tr>
		<td align="right" valign="top" nowrap>5/3/2004 - </td><td width="530"><a href="release_detail.asp?id=10481">Global Business Markets Congregate At the 2004 International CES, According To Independent Audit </a></td>
		<!--  -->
	</tr>
