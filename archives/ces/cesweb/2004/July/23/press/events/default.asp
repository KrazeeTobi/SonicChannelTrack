...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/3.0/3.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="press7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Press Events<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<!-- text for main page -->
<div id="3.3">
<span class="subhead">CES Unveiled: The 
Official Press Event of The International CES</span><br>
<img src=" /press/images/CESUnveiled.gif" align="right" vspace="8">
Tuesday, January 4, 2005
<br>4:00-7:00 p.m.
<br>Las Vegas Convention Center, Room S226
<br><br><br>
Kickoff your coverage of the largest consumer technology tradeshow in style at 
<b>CES Unveiled: The Official Press Event of the International CES</b>. Be 
the first to see the new year’s hottest products and get a sneak peek at the 
2005 Innovations Design and Engineering Showcase honorees&mdash;before the show 
officially opens. Enjoy cocktails and hors d’oeuvres, while checking out 
exclusive tabletop demonstrations and networking with the biggest names in 
technology. Only credentialed media and analysts are allowed to attend this exclusive event. It’s the best reason under the sun to arrive 
in Las Vegas a day early.
<br><br>
Press may register for CES Unveiled while <a href="/register">registering for the 2005 International CES</a>.  For more information on event registration, please call 703-907-4365 or e-mail <a href="mailto:press@ce.org">press@ce.org</a>.
...
<span class="subhead">2005 International CES Press Event Schedule</span><br>
The 2005 International CES press event schedule will be updated regularly beginning August 2004.  Please also review other upcoming CEA events at <a href="http://www.ce.org/events" target="new">www.CE.org</a>.
<br><br>

<!-- dynamic calendar download -->
<!--
...
<br><br>
		...
		<tr class=""><td width="25%" valign="top"><br><br></td> 
			<td valign="top"><a href="press_event_detail.asp?ID="></a>: </td>
		</tr>
