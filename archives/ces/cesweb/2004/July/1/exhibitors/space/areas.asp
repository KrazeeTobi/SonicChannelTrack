...
<head>
	...
	<title>2005 International CES:&nbsp;2004 International CES Exhibit Booth Space</title>
	...
	<tr>
		...
		<td valign="top" width="285">
			...
			<ul>
				...
				<li>Outdoor exhibits<br>
				<img src="/attendees/show_floor/areas/images/innovationsPlus.gif" vspace="5">
			...
			<ul>
				<li>Outdoor exhibits<br>
				<li>Prosumer Exhibits:  Studio @ Home and HD Pro Showcase 
