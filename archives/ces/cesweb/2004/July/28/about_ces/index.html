...
<head>
	...
	<title>2005 International CES:&nbsp;About the International CES</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="10" background="/global_images2005/spacer.gif" class="home5"><img src="/global_images2005/spacer.gif" alt="" width="10" height="40" hspace="0" vspace="0" border="0"></td>
		    <td width="390" colspan="2" background="/global_images2005/spacer.gif" class="home5" valign="bottom"><span class="home_nav_breadcrumb">
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;About CES
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="home6"><img src="/global_images2005/0.0/0.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","0.1") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/0.0/0.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/0.0/0.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/0.0/0.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="380"  background="/global_images2005/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">About the International CES<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
<br><img src="/global_images2005/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/0.0/0.0.line.gif" alt="-----------------------------------------------" width="380" height="2" hspace="0" vspace="0" border="0"><br>
<div class="section_title">The stats, the pictures and the partners</div>

<span class="subhead"><a href="fact_sheet.asp">CES Fact Sheet</a><br></span>
From exhibitor and attendee profiles to how the International CES came to be, scroll through the CES Fact Sheet to get background on the largest annual consumer technology show in the world.
<br><br>
<span class="subhead"><a href="photos/">CES Photos</a><br></span>
...
<tr> 
    <td width="5" height="5"><img height="5" width=5 src="/global_images2005/0.0/0.0.box_TL.gif"  align="top"></td>
    <td width="180" height="5"><img height="5" width="180" src="/global_images2005/0.0/0.0.box_T.gif"  align="top"></td>
    <td width="5" height="5"><img height="5" width=5 src="/global_images2005/0.0/0.0.box_TR.gif"  align="top"></td>
</tr>
<tr> 
    <td width="5" valign="top" background="/global_images2005/0.0/0.0.box_L.gif"><img height="10" width="5" src="/global_images2005/spacer.gif" vspace="1"></td>
    <td width="180" valign="top" class="white_box_bg">
		<table cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td colspan="3"><span class="subhead">Exhibit dates</span></td>
		</tr>
		<tr>
			<td>Thursday, Jan. 6</td>
			<td>&nbsp;&nbsp;&nbsp;</td>
			<td align="right">10 a.m. - 6 p.m.</td>
		</tr>
		<tr>
			<td>Friday, Jan. 7</td>
			<td></td>	
    ...
    <td width="5" background="/global_images2005/0.0/0.0.box_R.gif"><img height="5" width="5" src="/global_images2005/spacer.gif"></td>
</tr>
<tr> 
    <td width="5" height="14"><img height="14" width=5 src="/global_images2005/0.0/0.0.box_BL.gif" align="top"></td>
    <td width="180" height="14" align="right"><img height="14" width="180" src="/global_images2005/0.0/0.0.box_B.gif"></td>
    <td width="5" height="14"><img height="14" width=5 src="/global_images2005/0.0/0.0.box_BR.gif"  align="top"></td>
</tr>
</table>
...
<table border="0" cellpadding="0" cellspacing="0">
<tr> 
    <td width="5" height="5"><img height="5" width=5 src="/global_images2005/0.0/0.0.colorbox_TL.gif"  align="top"></td>
    <td width="180" height="5"><img height="5" width="180" src="/global_images2005/0.0/0.0.colorbox_T.gif"  align="top"></td>
    <td width="5" height="5"><img height="5" width=5 src="/global_images2005/0.0/0.0.colorbox_TR.gif"  align="top"></td>
</tr>
<tr> 
    <td width="5" height="50" valign="top" background="/global_images2005/0.0/0.0.colorbox_L.gif"><img height="10" width="5" src="/global_images2005/spacer.gif" vspace="1"></td>
    <td width="180" height="40" valign="top" class="attendees_box_bg">
	<span class="subhead">Your questions answered</span><br>
	<span class="text_colored">
	For a list of frequently asked questions regarding the 2005 International CES, visit our FAQs section, divided into categories for <a href="/faqs/general.asp">attendees</a>, <a href="/faqs/exhibitors.asp">exhibitors</a>, <a href="/faqs/speakers.asp">speakers</a>, and <a href="/faqs/press.asp">journalists/analysts</a>.
	</span><br></td>
    <td width="5" height="50" background="/global_images2005/0.0/0.0.colorbox_R.gif"><img height="5" width="5" src="/global_images2005/spacer.gif"></td>
</tr>
<tr> 
    <td width="5" height="14"><img height="14" width=5 src="/global_images2005/0.0/0.0.colorbox_BL.gif" align="top"></td>
    <td width="180" height="14" align="right"><img height="14" width="180" src="/global_images2005/0.0/0.0.colorbox_B.gif"></td>
    <td width="5" height="14"><img height="14" width=5 src="/global_images2005/0.0/0.0.colorbox_BR.gif"  align="top"></td>
</tr>
</table>
		</td>
	    <td width="10"  background="/global_images2005/spacer.gif" class="attendees8">&nbsp;</td>
...
<!-- footer row -->
	<tr>
	    ...
	    <td width="140"></td>
	    <td width="10"></td>
	    <td width="610" colspan=6><img src="/global_images2005/0.0/0.0.page_bottom.gif" alt="" width="610" height=10 hspace="0" vspace="0" border="0"></td>
	</tr>
	<tr>
	    <td width="10"></td>
	    <td width="140"></td>
