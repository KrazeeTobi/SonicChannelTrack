...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/exhibitors/">Exhibitor Services</a>&nbsp;>&nbsp;<a href="/exhibitors/pr/">PR Help</a>&nbsp;>&nbsp;<a href="/exhibitors/pr/pr_kit/default.asp">Exhibitor PR Kit</a>&nbsp;>&nbsp;Press Room
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.7.1.6") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<!-- PR HELP -->
	...
	<a href="/exhibitors/pr/pr_kit/default.asp">Exhibitor PR Kit</a><br>
			...
			<span class="nav_fourth_arrow"><b>></b> &nbsp;</span>Press Room</a><br>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/2.0/2.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Press Room<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="2.7.1.6">	
<!-- text for main page -->
Although exhibitor and public relations representatives are not allowed in the press room, your company's presence is visible through press kits and sponsorships.  The press room is where the media and analysts come to write their stories, conduct interviews, prepare for broadcasts, make telephone calls and relax.  This is also where they come to collect your press kits, press conference and events schedules, directories and public relations contact information.
<br><br>
Put your company name and logo in front of attending media and analysts by sponsoring one of the many products and services CES offers the media.  Consider sponsoring a press breakfast, lunch, snack or giveaway.

For information about <a href="/exhibitors/promotions/press.asp">CES press sponsorships</a> or to have a package custom designed for your product, contact:<br>
...
<div class="subhead">Hours of Operation</div>
Official press room hours are listed below, although you can drop off press kits as early as January 2, 2005 at the LVCC.  Only journalists, analysts and CES staff are allowed in the press room as a general rule.
<br><br>
<table border=0>
<tr>
	<td>&nbsp;</td>
	<td colspan="2"><span class="subhead">LVCC Press Room (S229)</span></td>
	<td colspan="2"><span class="subhead">Alexis Park Press Room (Suite 2531)</span></td>
</tr>
<tr class="black">
	<td width="160">Day</td>
...
<br>
<span class="subhead">Press Room Amenities</span>
<ul>
	<li>State-of-the-art computers
	<li>Free wireless and T-1 Internet connections
	<li>Schedule of exhibitor press conferences and events
	<li>Celebrity listings
	<li>Show videos and B-roll
	<li>Show photos
	<li>Phones/fax machines
	<li>Copiers
	<li>Message boards
	<li>Keynote speech transcripts
