...
<head>
	...
	<title>2005 International CES:&nbsp;Exhibitor Publicity Tips</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/exhibitors/">Exhibitor Services</a>&nbsp;>&nbsp;<a href="/exhibitors/pr/">PR Help</a>&nbsp;>&nbsp;<a href="/exhibitors/pr/pr_kit/default.asp">Exhibitor PR Kit</a>&nbsp;>&nbsp;Publicity Tips
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.7.1.1") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/2.0/2.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Publicity Tips<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="2.7.1.1">	
<!-- text for main page -->
At the 2005 International CES, expect live broadcasts from all the major channels. Look for more than 4,000 journalists generating an unprecedented number of newspaper and magazine articles, television and radio reports and online stories.
<br>
...
<tr>
    <td width="285" valign="top">
		...
		The International CES defines innovation. <a href="kit.asp#kit">Develop press materials</a> that capture that innovative spirit and reflect how your company's brand or products portray forward thinking.
		<br><br>
		<span class="subhead">2) Announce New Products at the International CES</span><br>
		...
		<br><br>
		<span class="subhead">3) Name Drop: The International CES</span><br>
		Use your exhibitor status in your announcements and benefit from CES branding. <a href="/exhibitors/resource_center/logos/default.asp">Download the official logo</a> for your marketing materials (login required).
		<br><br>
		<span class="subhead">4) Use the Web</span><br>
		Post your releases on Virtual Press Office and Business Wire through <a href="http://www.virtualpressoffice.com/CES/index.jsp">www.CESweb.org</a> for extreme exposure. CESweb.org garnered more than 3 million visits during the 2004 International CES. Don't miss the coverage!
		<br><br>
		<span class="subhead">5) Press/Analyst Materials</span><br>
		...
		<br><br>
	    <span class="subhead">6) New Product Listing</span><br>
		<a href="/exhibitors/resource_center/directory">Update your exhibitor directory listing</a> by November 1, 2004.  List announcements and product launches you plan to make, and identify which company reps will be available for interviews.  Make it easy for reporters to find your booth during the show.
	</td>
    
	<td width="20"><img src="/global_images2005/spacer.gif" alt="" width="20" height="1" border="0"></td>
	<td width="285" valign="top">
		<span class="subhead">7) Think TV</span><br>
		...
		<br><br>
		<span class="subhead">8) Tell Your Local Media</span><br>
		Announce to your local media that you'll be at the 2004 International CES. Local newspapers and business publications are likely to be interested in your CES exhibit plans. For maximum coverage, consider participating in our regional <a href="events.asp#outreach">media outreach campaign</a>.
		<br><br>
		<span class="subhead">9) Call CES for Help</span><br>
		...
		<br><br>
		<span class="subhead">10) Host a Special Event or a Celebrity</span><br>
		Want the media to flock to your booth? There's no better way to draw attention to your product than with a <a href="events.asp#celebs">special event or celebrity appearance</a>. If you've got something special planned, fill out the celebrity appearance form and let us know.
	</td>
</tr>
</table>
<br>
