...
<head>
	...
	<title>2004 International CES:&nbsp;Exhibitor Workshop Registration</title>
...
<!-- RESOURCE CENTER -->	
		...
		<!--<a href="/exhibitors/resource_center/workshop/">Exhibitor Workshop</a><br>
				...
				<span class="nav_fourth_arrow"><b>></b> &nbsp;</span><a href="/exhibitors/resource_center/workshop/hotel.asp">Hotel Accommodations</a><br>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Exhibitor Workshop Registration<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
					

<!-- text for main page -->
The 2003 pre-CES Exhibitor Workshop was a huge success.  We'll see you in Las Vegas in January 2004! 
...
-->
<!--
<span class="subhead">Registration for the 2nd International CES Exhibitor Workshop is open!<br></span>
<span class="text_colored">Join us October 15-16, 2003 in Las Vegas, NV. The workshop is FREE to 2004 International CES exhibitors.</span>
<br>
...
<b>Please take a moment to fill out this brief registration form.</b>&nbsp;(Registration closes Wednesday, October 8, 2003)
<br>
<br>
...
<tr>
	<td><img src="/global_images/spacer.gif" height="1" width="130" border="0"></td>
	<td><img src="/global_images/spacer.gif" height="1" width="440" border="0"></td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<select name="txt_state" class="formData">
			include virtual="/global_include/html/states.html"
		</select>
	</td>
</tr>
<tr><td colspan=3 height="4"><img src="/global_images/spacer.gif" height="4"></td></tr>
...
<tr>
	...
	<span class="text_colored">Required: All further correspondence regarding<br>the Exhibitor Workshop will be sent via e-mail.</span></td>
</tr>
<tr><td colspan=3 height="12"><img src="/global_images/spacer.gif" height="12"></td></tr>

<tr>
	<td>&nbsp;</td>
	<td valign="top"><input type="checkbox" name="happy_hour">&nbsp;&nbsp;Yes, I will attend the Networking Happy Hour on Wednesday, October 15, 2003 at 6 p.m.<br><img src="/global_images/spacer.gif" height="1" width="28">in the Foundation Room at Mandalay Bay.</td>
</tr>
<tr><td><img src="/global_images/spacer.gif" height="12"></td></tr>

<tr>
	<td>&nbsp;</td>
	<td valign="top"><input type="checkbox" name="tour">&nbsp;&nbsp;Yes, I would like to take part in the Tour of the LVCC on Wednesday, October 15, 2003.</td>
</tr>
<tr><td><img src="/global_images/spacer.gif" height="12"></td></tr>

<tr>
	<td>&nbsp;</td>
	<td valign="top"><input type="checkbox" name="orientation">&nbsp;&nbsp;Yes, I would like to take part in the First-time Exhibitor Orientation on Wednesday,<br><img src="/global_images/spacer.gif" height="1" width="28">October 15, 2003.</td>
</tr>
</table>

<table cellspacing="0" cellpadding="0" border="0">
<tr>
	<td><img src="/global_images/spacer.gif" height="16" width="130" border="0"></td>
	<td><img src="/global_images/spacer.gif" height="1" width="140" border="0"></td>
	<td><img src="/global_images/spacer.gif" height="1" width="300" border="0"></td>
</tr>
<tr>
	<td></td>
	<td>Where is your exhibit venue:</td></tr>
<tr>
	<td></td>
	<td><input type="radio" class="formData" name="exhibit_venue" value="Alexis Park">Alexis Park</td><td><input type="radio"class="formData" name="exhibit_venue" value="Hilton">Hilton</td>            	
</tr>
<tr>
	<td></td>
	<td><input type="radio" class="formData" name="exhibit_venue" value="Central Hall">Central Hall</td><td><input type="radio" class="formData" name="exhibit_venue" value="Silver or Gold Structure">Silver or Gold Structure</td>
</tr>
<tr>
	<td></td>
	<td><input type="radio" class="formData" name="exhibit_venue" value="North Hall">North Hall</td><td><input type="radio" class="formData" name="exhibit_venue" value="South Hall">South Hall</td>
</tr>
<tr><td colspan=2 height="20"><img src="/global_images/spacer.gif" height="12"></td></tr>
