...
<head>
	...
	<title>2004 International CES:&nbsp;Contact an International CES Sales Representative</title>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Contact an International CES Sales Representative<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
...
<form name="emailContactForm" action="contact_rep.asp" method="post">
...
<tr><td colspan=2 height="25"><img src="/global_images/spacer.gif" height="25"></td></tr>
...
<tr>
	<td colspan=2 height="25"><img src="/global_images/spacer.gif" height="25"></td></tr>
<tr>
...
<tr>
	<td colspan=2 height="8"><img src="/global_images/spacer.gif" height="8"></td></tr>
<tr>
	<td>&nbsp;</td>
	<td colspan=3><IMG SRC="/global_images/spacer.gif" width="4" height="1"><input name="feet" type="text" size="7" class="formData">  ft. x </span><input name="feet2" type="text" size="7" class="formData">  ft. = </span><input name="nsf" type="text" size="7" class="formData">  net sq. ft., in U.S. measurements</span></td>
</tr>
