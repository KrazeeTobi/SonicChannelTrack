...
<head>
	...
	<title>2004 International CES:&nbsp;CNET Reveals the Next Big Thing in CE</title>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">CNET Reveals the Next Big Thing in CE<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<!-- text for main page -->
<span class="section_title">Now, next year, and beyond<br><br></span>
<a target="new" href="http://www.cnet.com"><img border="0" align="left" hspace="6" src="/attendees/awards/next_big_thing/images/cnetlogo.gif"></a>
CNET editors set out to help International CES attendees identify the hottest trends for 2004, revealing the four technologies they believe will dominate the consumer electronics scene in a CES SuperSession called "The Next Big Thing."
<br><br><br>
If you think hot trend equals not on the market for years, think again. These editors picked technologies that are already becoming widely available, so they won't be unfamiliar. So what's poised to truly influence the way consumers use technology in their everyday lives? Read on, or <a href="http://www.cnet.com/4520-7912_1-5116483-1.html" target="new">get the whole story</a> from CNET Reviews Editor in Chief Janice Chen. 
<br><br>
<strong>Portable video players (PVPs)</strong><br>
Combining the widespread appeal of MP3 players and the consumer love affair with Hollywood films, TV shows, and home movies, these pocket-size devices are ready to change where and how people get their entertainment.
<br><br>
<strong>Smart phones</strong><br>
Sales of these devices will explode, based on the convenience they offer users.
<br><br>
<strong>Digital video recorders (DVRs)</strong><br>
These recorders let you personalize your TV watching; increased competition among makers will lead to a better experience.
<br><br>
<strong>Wi-Fi for home entertainment</strong><br>
Wireless networking is obviously not a new trend, but we're predicting that this is the year it moves out of the home office and into the living room.
