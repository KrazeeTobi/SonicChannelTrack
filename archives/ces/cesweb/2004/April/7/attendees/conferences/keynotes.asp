...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">2004 International CES Keynotes<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<!-- text for main page -->
<div id="1.1.2">	
<span class="section_title">A Total Power Trip</span><br><br>

Who says it's not appropriate to name drop? With a lineup like this, there's no way to resist. Each of these internationally respected business leaders spoke to standing-room-only crowds, weaving critical consumer technology messages with Hollywood-style entertainment.
<br><br>
...
<tr>
    <td width="140" align="center" valign="middle" bgcolor="#FFFFFF"><img src="/global_images/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
		<img src="/attendees/conferences/images/keynotes/gates.jpg" alt="" hspace="0" vspace="0" border="0"><br>
		<img src="/global_images/spacer.gif" alt="" width="1" height="11" hspace="0" vspace="0" border="0"><br>
	</td>
    <td width="10"><img src="/global_images/spacer.gif" alt="" width="10" height="1" hspace="0" vspace="0" border="0"></td>
    <td valign="top" class="text" width="440"><img src="/global_images/spacer.gif" alt="" width="440" height="8" hspace="0" vspace="0" border="0"><br>
		<a name="gates"></a>
		<span class="section_title">Pre-show Keynote</span><br>
		<span class="subhead">6:30 p.m. Wednesday, January 7, 2004, Las Vegas Hilton Theater</span><br><br>
		
		<strong>Bill Gates</strong>&nbsp;&nbsp;[<a href="http://www.microsoft.com/billgates/speeches/2004/01-07ces.asp" target="new">READ TRANSCRIPT</a>]<br>
		Chairman and Chief Software Architect, Microsoft Corporation<br><br>
		Once again, Bill Gates opened the show with his vision of the year ahead in consumer electronics, and thousands of eager attendees flocked to the Las Vegas Hilton to get a firsthand glimpse. Gates, with some witty help from popular talkshow host Jay Leno, spoke about how Microsoft will help consumers access a variety of high-tech products&mdash;from DVD players to digital cameras&mdash;all from the MSN Media Center.
		<br><br><br>
	</td>
</tr>
<tr>
...
<tr>
    <td width="140" align="center" valign="middle" bgcolor="#FFFFFF"><img src="/global_images/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
		&nbsp;<img src="/attendees/conferences/images/keynotes/shapiro.jpg" alt="" hspace="0" vspace="0" border="0"><img src="/global_images/spacer.gif" alt="" width="1" height="1" hspace="0" vspace="0" border="0"><img src="/attendees/conferences/images/keynotes/gornik.jpg" alt="" hspace="0" vspace="0" border="0">
		<img src="/global_images/spacer.gif" alt="" width="1" height="11" hspace="0" vspace="0" border="0"><br>
	</td>
    <td width="10"><img src="/global_images/spacer.gif" alt="" width="10" height="1" hspace="0" vspace="0" border="0"></td>
    <td valign="top" class="text" width="440"><img src="/global_images/spacer.gif" alt="" width="440" height="8" hspace="0" vspace="0" border="0"><br>
		...
		<span class="subhead">8:30 a.m. Thursday, January 8, 2004, Las Vegas Hilton Theater</span><br><br>
		
		<strong>Gary Shapiro</strong>&nbsp;&nbsp;[<a href="/attendees/conferences/shapiroTrans.doc" target="new">READ TRANSCRIPT</a>]<br>
		President and CEO, Consumer Electronics Association (CEA)<br><br>
		<strong>Katherine Gornik</strong>&nbsp;&nbsp;[<a href="/attendees/conferences/gornikTrans.doc" target="new">READ TRANSCRIPT</a>]<br>
		President, Thiel Audio Products Company<br>
		Chair, Consumer Electronics Association (CEA)
		<br><br>
	</td>
</tr>
<tr>
    <td width="140" align="center" valign="middle" bgcolor="#FFFFFF"><img src="/global_images/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
		<img src="/attendees/conferences/images/keynotes/ohtsubo2.jpg" alt="" hspace="0" vspace="0" border="0"><br>
		<img src="/global_images/spacer.gif" alt="" width="1" height="11" hspace="0" vspace="0" border="0"><br>
	</td>
    <td width="10"><img src="/global_images/spacer.gif" alt="" width="10" height="1" hspace="0" vspace="0" border="0"></td>
    <td valign="top" class="text" width="440"><img src="/global_images/spacer.gif" alt="" width="440" height="8" hspace="0" vspace="0" border="0"><br>
		<span class="section_title">Opening Keynote Address</span><br>
		<span class="subhead">8:30 a.m. Thursday, January 8, 2004, Las Vegas Hilton Theater</span><br><br>
		
		<strong>Fumio Ohtsubo</strong>&nbsp;&nbsp;[<a href="http://www.panasonic.com/consumer_electronics/ces_2004/speech.asp" target="new">READ TRANSCRIPT</a>]<br>
		President, Panasonic AVC Networks Company<br>
		Senior Managing Director, Matsushita Electric Industrial Co., Ltd.<br><br>
		"LifeStream, our networking vision, will help people connect. And ensure that our products connect."
		Panasonic President Fumio Ohtsubo spoke to a standing-room-only crowd about the power of LifeStream and how it will enable the world to connect in ways we never thought were imaginable.
		LifeStream is the Panasonic vision of next-level connectivity in which all of one consumer's electronics seamlessly work together. It is based on three core technologies&mdash;SD, DVD and Digital TV.
		<br><br><br>
	</td>
</tr>
<tr>
...
<tr>
    <td width="140" align="center" valign="middle" bgcolor="#FFFFFF"><img src="/global_images/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
		<img src="/attendees/conferences/images/keynotes/fiorina.jpg" alt="" hspace="0" vspace="0" border="0"><br>
		<img src="/global_images/spacer.gif" alt="" width="1" height="11" hspace="0" vspace="0" border="0"><br>
	</td>
    <td width="10"><img src="/global_images/spacer.gif" alt="" width="10" height="1" hspace="0" vspace="0" border="0"></td>
    <td valign="top" class="text" width="440"><img src="/global_images/spacer.gif" alt="" width="440" height="8" hspace="0" vspace="0" border="0"><br>
		...
		<span class="subhead">4:30 p.m. Thursday, January 8, 2004, Las Vegas Hilton Theater</span><br><br>
		
		<strong>Carly Fiorina</strong>&nbsp;&nbsp;[<a href="http://www.hp.com/hpinfo/execteam/speeches/fiorina/ces04.html" target="new">READ TRANSCRIPT</a>]<br>
		Chairman and CEO, HP<br><br>
		"We really are entering an era in which everything – everything – is going to be digital, mobile and virtual; where all of us – every single consumer – we're the photographers, and the film producers, and the deejays. We are all digital revolutionaries now." 
		<br><br>
		Fiorina spoke of the HP Digital Entertainment System, HP Media Center PC and an HP digital music player that features Apple's iTunes to launch later this year. 
		<br><br>
		Also, Alicia Keys tickled the ivories; Ben Affleck and Chris Moore empowered budding movie makers with Project Greenlight; Chairman of the Interscope Geffen A&M Records Group Jimmy Iovine got music pirating prevention support from Sheryl Crow, The Edge (U2), Dr. Dre, Toby Keith and, of course, Carly Fiorina.
		<br><br><br>
	</td>
</tr>
<tr>
...
<tr>
    <td width="140" align="center" valign="middle" bgcolor="#FFFFFF"><img src="/global_images/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
		<img src="/attendees/conferences/images/keynotes/forsee.jpg" alt="" hspace="0" vspace="0" border="0"><br>
		<img src="/global_images/spacer.gif" alt="" width="1" height="11" hspace="0" vspace="0" border="0"><br>
	</td>
    <td width="10"><img src="/global_images/spacer.gif" alt="" width="10" height="1" hspace="0" vspace="0" border="0"></td>
    <td valign="top" class="text" width="440"><img src="/global_images/spacer.gif" alt="" width="440" height="8" hspace="0" vspace="0" border="0"><br>
		...
		<span class="subhead">9 a.m. Friday, January 9, 2004, Las Vegas Hilton Theater</span><br><br>
		
		<strong>Gary Forsee</strong>&nbsp;&nbsp;[<a href="http://www3.sprint.com/PR/PressKits/Attachments/151_1252.pdf" target="new">READ TRANSCRIPT</a>]<br>
		Chairman and CEO, Sprint Corp.<br><br>
		Sprint CEO Gary Forsee spoke to well over one thousand CES attendees Friday morning, ushering in new Sprint products and services and reminding us all how far we've come in just a short time. 
		<br><br>
