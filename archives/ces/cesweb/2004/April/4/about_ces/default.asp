...
<head>
	...
	<title>2004 International CES:&nbsp;About the International CES</title>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="380"  background="/global_images/spacer.gif" class="home7" valign="top">
				
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">About the International CES<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
...
<img src="/global_images/0.0/line.gif" alt="-----------------------------------------------" width="380" height="1" hspace="0" vspace="0" border="0"><br>
...
<br><br>
<span class="subhead"><a href="partners.asp">CES Partners</a><br></span>
The Consumer Electronics Association joins together with many other businesses and organizations to bring you the world's largest annual consumer technology event. See who else makes the International CES a success.
<!--
With nearly three decades of history, the International CES reaches across markets, spans the globe and helps thousands of consumer electronics businesses grow and thrive each year.

<br><img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images//line.gif" alt="-----------------------------------------------" width="590" height="1" hspace="0" vspace="0" border="0"><br>
<div class="section_title">The stats, the pictures and the brand.</div>

<table width="590" cellspacing="0" cellpadding="0" border="0" class="text">
<tr>
    <td width="285" valign="top" class="text">
		<span class="subhead"><a href="fact_sheet.asp">CES Fact Sheet</a><br></span>
		From exhibitor and attendee profiles to how the International CES came to be, scroll through the CES Fact Sheet to get background on the largest annual consumer technology show in the world.
	</td>
	...
	<td width="285" valign="top" class="text">
		...
		The International CES photo library shows you a cross-section of the people, the products, and the high-energy show floor.
		<br><br>
		<span class="subhead"><a href="logos/">CES Logos</a><br></span>
...
<!-- /text for main page -->
		...
		<td width="10"  background="/global_images/spacer.gif" class="home7">&nbsp;</td>
	    <td width="10"  background="/global_images/spacer.gif" class="home8">&nbsp;</td>
	    <td width="190"  background="/global_images/spacer.gif" class="home8" valign="top">
...
<br>
-->
<img src="/about_ces/images/show_floor.jpg" border="0"><br><img src="/global_images/spacer.gif" alt="" width="1" height="12" hspace="0" vspace="0" border="0"><br>
