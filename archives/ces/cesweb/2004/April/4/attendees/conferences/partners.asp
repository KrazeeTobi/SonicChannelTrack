...
<head>
	...
	<title>2004 International CES:&nbsp;Partner Programs</title>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">CES Partner Programs<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<!-- text for main page -->
<div id="1.1.20">	

<span class="section_title">The Power of Partnership</span><br><br>
The International CES partnered with a variety of respected businesses and organizations to bring unique perspectives, advanced curriculum and real-world knowledge to the more than 129,000 people who attended this year's show.
<br><br>
...
<br><br>
<!--
<table align="center" width="90%" cellspacing=3 cellpadding=0 border=0 class="attendees11">
	<tr>
		<td>
		<span class="subhead">Partner Program Pricing</span><br>
		BONUS! Buy any of the Partner Program passes (single sessions not eligible), and you can purchase the<br><a href="knowledge_tracks.asp">Full Knowledge Track Pass</a> upgrade for only $150.
		Click on a program name to view pricing information.
		</td>
	</tr>
</table>
<br><br>
-->
<br>
<!-- 2 column table, containing 200px white column for images -->
<table width="590" cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
	    <td valign="top" class="text" width="375"><img src="/global_images/spacer.gif" alt="" width="375" height="8" hspace="0" vspace="0" border="0"><br>
			<span class="subhead"><a href="/attendees/conferences/search/session_by_track_list.asp?ID_track=CEDIA04&ref=CEDIA04">CEDIA</a></span><br>
			Back by popular demand, the Custom Electronic Design and Installation Association (CEDIA) delivers its most popular EXPO education classes at the 2004 International CES. 
			<br><br><br>
		</td>
		...
		<td width="200" align="center" valign="middle" bgcolor="#FFFFFF"><img src="/global_images/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
			<img src="/attendees/conferences/images/partners/cedia.gif" alt="CEDIA" hspace="0" vspace="0" border="0"><br>
	...
	<tr>
	    <td valign="top" class="text" width="375"><img src="/global_images/spacer.gif" alt="" width="375" height="8" hspace="0" vspace="0" border="0"><br>
			<span class="subhead"><a href="/attendees/conferences/search/session_by_track_list.asp?ID_track=CON04&ref=CON04">CONNECTIONS</a></span><br>
			CONNECTIONS: The Digital Home Conference and Showcase, produced by Parks Associates in partnership with CEA, hosts a half-day workshop and four sessions at the 2004 International CES focusing on insight, analysis, and market sizing for next-generation broadband and home networking services.   
			<br><br><br>
		</td>
	    <td width="15"><img src="/global_images/spacer.gif" alt="" width="15" height="1" hspace="0" vspace="0" border="0"></td>
		<td width="200" align="center" valign="middle" bgcolor="#FFFFFF"><img src="/global_images/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
			<img src="/attendees/conferences/images/partners/connections.gif" alt="CONNECTIONS" hspace="0" vspace="0" border="0"><br>
			<img src="/global_images/spacer.gif" alt="" width="1" height="11" hspace="0" vspace="0" border="0"><br>
		</td>
	</tr>
	<tr>
	    <td valign="top" colspan="3"><img src="/global_images/pixel_blue.gif" alt="-----------------------------------------------" width="590" height="1" hspace="0" vspace="0" border="0"></td>
	</tr>						
	<tr>
	    <td valign="top" class="text" width="375"><img src="/global_images/spacer.gif" alt="" width="375" height="8" hspace="0" vspace="0" border="0"><br>
			<span class="subhead"><a href="/attendees/conferences/search/session_by_track_list.asp?ID_track=DGS03&ref=DGS03">Digital Games Summit</a></span><br>
			With sites set on business issues, the Digital Game Summit takes a hard look at the electronic games industry, including industry outlook, market trends, new business opportunities, marketing and distribution, publishing, licensing, sports, music, online and wireless, new platforms, retail sales, investments, and how to form strategic partnerships and alliances.
			<br><br><br>
		</td>
	    <td width="15"><img src="/global_images/spacer.gif" alt="" width="15" height="1" hspace="0" vspace="0" border="0"></td>
		<td width="200" align="center" valign="middle" bgcolor="#FFFFFF"><img src="/global_images/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
			<img src="/attendees/conferences/images/partners/iHollywood.gif" alt="iHollywood Forum" hspace="0" vspace="0" border="0"><br>
			<img src="/global_images/spacer.gif" alt="" width="1" height="11" hspace="0" vspace="0" border="0"><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
	    <td valign="top" class="text" width="375"><img src="/global_images/spacer.gif" alt="" width="375" height="8" hspace="0" vspace="0" border="0"><br>
			<span class="subhead"><a href="/attendees/conferences/search/session_by_track_list.asp?ID_track=DH04&ref=DH04">Digital Hollywood</a></span><br>
			Join Digital Hollywood for an on-target analysis of the continuing convergence of computing and telecommunications. Learn from the experts how it impacts the entertainment industry and consumers.
			<br><br><br>
		</td>
	    <td width="15"><img src="/global_images/spacer.gif" alt="" width="15" height="1" hspace="0" vspace="0" border="0"></td>
		<td width="200" align="center" valign="middle" bgcolor="#FFFFFF"><img src="/global_images/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
			<img src="/attendees/conferences/images/partners/dig_hollywood.gif" alt="Digital Hollywood" hspace="0" vspace="0" border="0"><br>
			<img src="/global_images/spacer.gif" alt="" width="1" height="11" hspace="0" vspace="0" border="0"><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
	    <td valign="top" class="text" width="375"><img src="/global_images/spacer.gif" alt="" width="375" height="8" hspace="0" vspace="0" border="0"><br>
			<span class="subhead"><a href="/attendees/conferences/search/session_by_track_list.asp?ID_track=N04&ref=N04">Global Inventures</a></span><br>
			In a pre-show workshop, Global Inventures features exclusive presentations and panels to highlight the commercial issues emerging from standards and specs derived from electronics industry consortia. Plus, the Networked Interoperability track features nine free drop-in sessions offering updates, demos and a chance for candid Q&A  with leaders from many key interoperability forums.
			<br><br><br>
		</td>
	    <td width="15"><img src="/global_images/spacer.gif" alt="" width="15" height="1" hspace="0" vspace="0" border="0"></td>
		<td width="200" align="center" valign="middle" bgcolor="#FFFFFF"><img src="/global_images/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
			<img src="/attendees/conferences/images/partners/global_inventures.gif" alt="Global Inventures" hspace="0" vspace="0" border="0"><br>
			<img src="/global_images/spacer.gif" alt="" width="1" height="11" hspace="0" vspace="0" border="0"><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
	    <td valign="top" class="text" width="375"><img src="/global_images/spacer.gif" alt="" width="375" height="8" hspace="0" vspace="0" border="0"><br>
			<span class="subhead"><a href="/attendees/conferences/search/session_by_track_list.asp?ID_track=IP04&ref=IP04">IPv6 Products and Services: Enabling Consumer Electronics with Next Gen Internet</a></span><br>
			Internet Protocol (IP) version 6, the successor to 30-year-old IPv4, has several key advantages for consumer electronics makers and users, including a tremendous increase in IP address availability, mobility, as well as peer-to-peer service and security improvements. Alex Lightman, author of Brave New Unwired World, has organized five panels of IPv6 experts to cover the breadth, depth, and opportunities of integrating v6 into future devices. Please join us.
			<br><br><br>
		</td>
	    <td width="15"><img src="/global_images/spacer.gif" alt="" width="15" height="1" hspace="0" vspace="0" border="0"></td>
		<td width="200" align="center" valign="middle" bgcolor="#FFFFFF"><img src="/global_images/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
			<img src="/attendees/conferences/images/partners/ipv6.jpg" alt="IPv6 Forum" hspace="0" vspace="0" border="0"><br>
			<img src="/global_images/spacer.gif" alt="" width="1" height="11" hspace="0" vspace="0" border="0"><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
	    <td valign="top" class="text" width="375"><img src="/global_images/spacer.gif" alt="" width="375" height="8" hspace="0" vspace="0" border="0"><br>
			<span class="subhead"><a href="/attendees/conferences/search/session_by_track_list.asp?ID_track=MECP04&ref=MECP04">MECP</a></span><br>
			Whether you have worked in the mobile electronics industry for years or just a few months, you have something to gain from MECP certification. Learn the theory behind the techniques. Brush up on the industry's best practices and earn certification developed and supported by the entire 12-volt industry.
			<br><br><br>
		</td>
	    <td width="15"><img src="/global_images/spacer.gif" alt="" width="15" height="1" hspace="0" vspace="0" border="0"></td>
		<td width="200" align="center" valign="middle" bgcolor="#FFFFFF"><img src="/global_images/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
			<img src="/attendees/conferences/images/partners/mecp.gif" alt="MECP" hspace="0" vspace="0" border="0"><br>
			<img src="/global_images/spacer.gif" alt="" width="1" height="11" hspace="0" vspace="0" border="0"><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
	    <td valign="top" class="text" width="375"><img src="/global_images/spacer.gif" alt="" width="375" height="8" hspace="0" vspace="0" border="0"><br>
			<span class="subhead"><a href="/attendees/conferences/search/session_by_track_list.asp?ID_track=SBCA04&ref=SBCA04">SBCA</a></span><br>
			You can't afford to miss Satellite Power! - a single afternoon packed with information-rich panels on the latest DBS/satellite radio technologies and offerings, high-level executive interviews, research presentations, networking opportunities and much more. 
			<br><br><br>
		</td>
	    <td width="15"><img src="/global_images/spacer.gif" alt="" width="15" height="1" hspace="0" vspace="0" border="0"></td>
		<td width="200" align="center" valign="middle" bgcolor="#FFFFFF"><img src="/global_images/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
			<img src="/attendees/conferences/images/partners/sbca.gif" alt="SBCA" hspace="0" vspace="0" border="0"><br>
			<img src="/global_images/spacer.gif" alt="" width="1" height="11" hspace="0" vspace="0" border="0"><br>
		</td>
	</tr>
	<tr>
	...
	<tr>
	    <td valign="top" class="text" width="375"><img src="/global_images/spacer.gif" alt="" width="375" height="8" hspace="0" vspace="0" border="0"><br>
			<span class="subhead"><a href="/attendees/conferences/search/session_by_track_list.asp?ID_track=SV04&ref=SV04">Storage Visions</a></span><br>
			The 2004 Storage Visions Conference and Home Gateway Summit addresses data storage requirements for content creation, content distribution, and consumer electronics. Hear from this diverse group of corporate officers, analysts, and professionals who help shape how the entire world creates and shares content.
			<br><br><br>
		</td>
	    <td width="15"><img src="/global_images/spacer.gif" alt="" width="15" height="1" hspace="0" vspace="0" border="0"></td>
		<td width="200" align="center" valign="middle" bgcolor="#FFFFFF"><img src="/global_images/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
			<img src="/attendees/conferences/images/partners/storage_visions.gif" alt="Storage Visions" hspace="0" vspace="0" border="0"><br>
			<img src="/global_images/spacer.gif" alt="" width="1" height="11" hspace="0" vspace="0" border="0"><br>
		</td>
	</tr>
	<tr>
