...
<div id="1.3.1">	
<!-- text for main page -->
<span class="intro_copy">The 2004 International CES rolled out the red carpet.</span><br>Actors, musicians, comedians and other celebrities entertained the high-tech masses during the four-day show in Las Vegas this January. 
<br><br><br>
<table width="100%" align="center" border=0>
<tr>
	<td valign="top" width="23%"><img src="/attendees/special_events/images/celebs/keys.jpg" style="border: 2px #333333 solid"><br>R&B artist, Alicia Keys</td>
	<td width="2%"></td>
	<td valign="top" width="23%"><img src="/attendees/special_events/images/celebs/keith.jpg" style="border: 2px #333333 solid"><br>Country artist, Toby Keith, and producer, James Stroud</td>
	<td width="2%"></td>
	<td valign="top" width="23%"><img src="/attendees/special_events/images/celebs/bangles.jpg" style="border: 2px #333333 solid"><br>Members of The Bangles</td>
	<td width="2%"></td>
	<td valign="top" width="23%"><img src="/attendees/special_events/images/celebs/leno.jpg" style="border: 2px #333333 solid"><br><em>The Tonight Show</em> host, Jay Leno</td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
	<td valign="top"><img src="/attendees/special_events/images/celebs/affleck.jpg" style="border: 2px #333333 solid"><br>Actor, Ben Affleck</td>
	<td width="2%"></td>	
	<td valign="top"><img src="/attendees/special_events/images/celebs/skynyrd.jpg" style="border: 2px #333333 solid"><br>Rickey Medlocke of Lynyrd Skynyrd</td>
	<td width="2%"></td>
	<td valign="top"><img src="/attendees/special_events/images/celebs/dre.jpg" style="border: 2px #333333 solid"><br>Dr. Dre and The Edge (U2) join producer, Jimmy Iovine</td>
	<td width="2%"></td>
	<td valign="top"><img src="/attendees/special_events/images/celebs/rhimes.jpg" style="border: 2px #333333 solid"><br>Country artist, LeAnn Rimes</td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
	<td valign="top"><img src="/attendees/special_events/images/celebs/crow.jpg" style="border: 2px #333333 solid"><br>Recording artist, Sheryl Crow joins HP President, Carly Fiorina</td>
	<td width="2%"></td>
	<td valign="top"><img src="/attendees/special_events/images/celebs/freeman.jpg" style="border: 2px #333333 solid"><br>Actor, Morgan Freeman</td>
	<td width="2%"></td>
	<td valign="top"><img src="/attendees/special_events/images/celebs/marley2.jpg" style="border: 2px #333333 solid"><br>Reggae artist, Ziggy Marley</td>
	<td width="2%"></td>
	<td valign="top"></td>
</tr>
</table>
...
<div class="section_title">More</div>
...
<ul>
	...
	<li>Ricky Skaggs 
	<li>Jonny Lang  
	<li>Richard Karn, formerly "Al Borland" on <em>Home Improvement</em> & current host of <em>Family Feud</em>
	<li>Ray Herndon w/ special guest Jessi Colter 
	<li>Joe Jackson  
	<li>Steve Garvey, retired professional baseball player
	<li>Ara Arslanian, NHRA Drag Racer
	<li>Jean Francois, extreme artist
	<li>Carmen Basillio 
	<li>Iran "the Blade" Barkley, boxer 
	<li>Jake "the Raging Bull" LaMotta, boxer 
	<li>Josh Hancock, <em>Shifting Gears</em>
	<li>Elliot Scheiner, multiple Grammy winner
	<li>Johnathan "Fatal1ty" Wendel, 3 time world champion gamer
</ul>
