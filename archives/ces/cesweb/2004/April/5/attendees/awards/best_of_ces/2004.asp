...
<head>
	...
	<title>2004 International CES:&nbsp;TechTV's 2004 Best of CES Award Winners</title>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">TechTV's 2004 Best of CES Award Winners <br><img src="/global_images/spacer.gif" height="16" width="1"></div>
