  ...
  <tr>
   ...
   <td width="375" valign="top"><img src="/global_images2005/spacer.gif" width="10" height="18"><br>
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td><img src="/global_images2005/spacer.gif" width="10" height="2"><br><img src="/images/ces_photos/HP_Powell.jpg" border="0" width="90" height="73" vspace="3"></td>
            <td width="3" ><img src="/global_images2005/spacer.gif" width="10" height="1"></td>
            <td  valign="top" style="color:#ffffff">Just announced! If HDTV, broadband and consumer home recording rights matter to you, join FCC Chairman Michael Powell for his Industry Insider session.
                <span class="homepagelink"><a href="/attendees/conferences/insiders.asp">See all Industry Insiders.</a></span></td>
        </tr>
     <tr>
