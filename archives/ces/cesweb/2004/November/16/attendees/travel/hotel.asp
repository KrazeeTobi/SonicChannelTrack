...
<tr class="attendees11">
    <td valign="top" class="text">
        <a href="http://www.lasvegasstriphgvc.hilton.com" target="_blank">HGVC on the LV Strip</a> </td>
    <td><img src="/global_images2005/spacer.gif" alt="" height="1" border="0"></td>
    
        <td valign="top" class="text">$239 1-BR Suite <BR>$189 Studios</td>
        <td><img src="/global_images2005/spacer.gif" alt="" height="1" border="0"></td>
...
<tr class="attendees11">
    ...
    <td><img src="/global_images2005/spacer.gif" alt="" height="1" border="0"></td>
        ...
        <td valign="top" class="text">CES Rate Sold Out<BR>Room Available for $229<BR>on Thurs, Fri and Sat nights</td>
        <td><img src="/global_images2005/spacer.gif" alt="" height="1" border="0"></td>
        <td valign="top"></td>
