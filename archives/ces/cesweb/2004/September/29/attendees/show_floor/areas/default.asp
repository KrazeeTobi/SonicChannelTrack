...
<html>
<head><!-- PageID 195 - generated by RedDot 5.6 - 5.6.0.31 - Y-9bp -->
...
Exhibit Areas<br>
    ...
    <img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
               <script language="JavaScript">
              <!--
                  if (checkActiveNav("/attendees/show_floor/areas/default.asp")) { document.getElementById("fourth_row_container34").style.display = "";}
              //-->
