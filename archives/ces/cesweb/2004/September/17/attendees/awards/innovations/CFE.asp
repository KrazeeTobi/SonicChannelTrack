...
<html>
<head><!-- PageID 1785 - generated by RedDot 5.6 - 5.6.0.25 - Y-9bp -->
...
<div class="body_title">CES Innovations 2005 Awards Call for Entries<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<SPAN class=section_title>Now open!</SPAN> <BR><BR><IMG height=131 hspace=6 src="/images/general/2k5_InnovSample.gif" width=80 align=right>The Innovations Design and Engineering Awards program recognizes the most innovative consumer electronics products in 29 categories. <BR><BR>Winning this award is your ticket to meeting industry journalists, retailers, and high-tech heavyweights—in one of the most popular exhibits at the International CES. Honorees are displayed in CES Central Plaza. <BR><BR><STRONG>Here are a few tips in preparing your entry for the online submission process:</STRONG> 
<UL>
