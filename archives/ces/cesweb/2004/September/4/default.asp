  ...
  <tr>
   ...
   <td width="375" valign="top"><img src="/global_images2005/spacer.gif" width="10" height="18"><br>
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td><img src="/global_images2005/spacer.gif" width="10" height="2"><br><img src="/images/ces_photos/zander.jpg" border="0" width="90" height="71" vspace="3"></td>
            <td width="3" ><img src="/global_images2005/spacer.gif" width="10" height="1"></td>
            <td  valign="top" style="color:#ffffff">Motorola CEO Ed Zander joins Microsoft's Bill Gates and Intel's Craig Barrett in the 2005 International CES lineup.
                <span class="homepagelink"><a href="/press/news/rd_release_detail.asp?id=10535">Read on.</a></span></td>
        </tr>
     <tr>
