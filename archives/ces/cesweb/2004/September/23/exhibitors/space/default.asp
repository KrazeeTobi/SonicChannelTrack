...
<html>
<head><!-- PageID 22 - generated by RedDot 5.6 - 5.6.0.25 - Y-9bp -->
...
<span class="text">
Use our <A href="/docs/Exhibit_Overview.pdf" target=_blank>Exhibitor Overview (pdf)</A> to learn more about who attends the International CES and why, and then look below to see what kind of exhibit space works best for you. <BR><BR><SPAN class=subhead><A href="/exhibitors/space/areas.asp">Exhibit Booth Space</A></SPAN><BR>Choose from a variety of exhibiting options, from open space on the show floor to turnkey designer packages. Divided into easy-to-navigate categories, the show floor's design offers your company maximum exposure to the attendees you need to meet. <BR><BR><SPAN class=subhead><A href="/exhibitors/space/techzones.asp">TechZones</A></SPAN><BR><IMG height=27 hspace=6 src="/images/general/techzone_small.gif" width=120 align=right>Showcase your company in a CES TechZone. These high-energy, show-within-a-show zones thrust developing technologies and new companies into the limelight.<BR><BR><SPAN class=subhead><A href="/exhibitors/space/suites.asp">Meeting Place</A></SPAN><BR>Conduct private meetings and product demonstrations in hard-walled CES Meeting Place hospitality suites—right on the show floor! Customize your meeting space according to your needs. Access the concierge area. Receive food and beverage service. It's that easy. <BR><BR><SPAN class=subhead>Other Meeting Room Options</SPAN><BR>Hilton hospitality suites and permanent convention center meeting rooms provide other options for exhibitors. Contact an International CES <A href="/exhibitors/space/contacts.asp">business development representative</A> to review availability.
</span>
<!-- text for main page -->
</div>
...
<tr> 
    ...
    <td width="180" valign="top" class="white_box_bg"><SPAN class=subhead>Secure your space today<BR></SPAN>Download the 2005 International CES <A href="/docs/2k5_space_contract.pdf" target=_blank>Space Agreement (pdf)</A> and contact a <A href="/exhibitors/space/contacts.asp">sales representative</A> to review options and availability.</td>
