...
<html>
<head><!-- PageID 336 - generated by RedDot 5.6 - 5.6.0.31 - Y-9bp -->
...
Hotel Reservations<br>
    ...
    <img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
               <script language="JavaScript">
              <!--
                  if (checkActiveNav("/attendees/travel/hotel.asp")) { document.getElementById("fourth_row_container335").style.display = "";}
              //-->
...
<a href="/attendees/travel/airlines.asp">Airlines and Car Rental</a><br>
    ...
    <img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
               <script language="JavaScript">
              <!--
                  if (checkActiveNav("/attendees/travel/airlines.asp")) { document.getElementById("fourth_row_container482").style.display = "";}
              //-->
              </script> <img src="/global_images2005/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
<a href="/attendees/travel/shuttle.asp">CES Shuttle</a><br>
    ...
    <img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
               <script language="JavaScript">
              <!--
                  if (checkActiveNav("/attendees/travel/shuttle.asp")) { document.getElementById("fourth_row_container485").style.display = "";}
              //-->
              </script> <img src="/global_images2005/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
<a href="/attendees/travel/taxi.asp">Taxi and Parking</a><br>
    ...
    <img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
               <script language="JavaScript">
              <!--
                  if (checkActiveNav("/attendees/travel/taxi.asp")) { document.getElementById("fourth_row_container489").style.display = "";}
              //-->
              </script> <img src="/global_images2005/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
<a href="/attendees/travel/vegas.asp">Las Vegas Information</a><br>
    ...
    <img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
               <script language="JavaScript">
              <!--
                  if (checkActiveNav("/attendees/travel/vegas.asp")) { document.getElementById("fourth_row_container492").style.display = "";}
              //-->
              </script> 
        <img src="/global_images2005/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
...
<tr class="attendees11">
    ...
    <td><img src="/global_images2005/spacer.gif" alt="" height="1" border="0"></td>
        ...
        <td valign="top" class="text">$239 1-BR<BR>(Studios Sold Out)</td>
        <td><img src="/global_images2005/spacer.gif" alt="" height="1" border="0"></td>
...
<tr class="attendees11">
    ...
    <td><img src="/global_images2005/spacer.gif" alt="" height="1" border="0"></td>
        ...
        <td><img src="/global_images2005/spacer.gif" alt="" height="1" border="0"></td>
        <td valign="top">Or call 1-800-468-3571<BR>Request group&nbsp;code OVBD</td>
