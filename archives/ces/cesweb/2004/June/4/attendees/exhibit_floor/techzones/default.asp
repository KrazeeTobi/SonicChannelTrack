...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">2004 International CES TechZones<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
...
<img src="images/logo.gif" align="right" hspace="5" vspace="0">
See what brands are building in your market. Meet the tech players who set the standard for your niche. Get your hands on new and emerging technologies, products and companies. 
<br><br>
All in one spot. All at market-specific International CES TechZones. Look for the logo to get in the zone.
<br>
...
As you plan your 2004 business strategy, get what you need to know at the International CES TechZones. These zones--all located within the International CES&mdash;are concentrated versions of the markets they represent.
<br><br>
<table width="590" cellspacing=0 cellpadding=2 border=0>
	...
	<!--<tr>
		<td><a href="?id=22#memory">Memory Stick</a></td>
...
<br><br>
Consumers, homebuilders and installers who need to wrap their hands around the value and benefits of multi-room audio/video systems in the home need to open the doors to the CONNECTED HOME ENTERTAINMENT TECHZONE at the International CES. See the most innovative hard-wired, professionally installed systems for new construction through no-new-wires retail products.  Check out multi-room networked entertainment, including audio, structured wiring, whole-house video, no-new-wires and wireless products. Build it out and crank it up.
<br><br>
<b>Who to expect</b><br>
<ul>
	<li>Entropic Communications
	<li>Sonance
	<li>Spidcom Technologies
	<li>Ucentric Systems LLC
</ul>
<!--Manufacturers or suppliers of products such as:<br>
<ul>
...
<!--Manufacturers of:<br>
<ul>
	<li>digital content creation and distribution products
	<li>editing and archiving products
	<li>digital storage devices
</ul>-->
<ul>
	<li>Fairwinds
	<li>Glide Write
...
<br><br>
<img align="right" src="/attendees/exhibit_floor/techzones/images/dvdram.gif" alt="">
...
<span class="text_colored">LVCC, South Hall 3-4</span>
<br><br>
<img src="images/EnergyStar.gif" align="right" alt="Energy Star" hspace="5" vspace="0" border="0">
The past decade's explosion of consumer technology prevalence has created a whole new issue for high-tech companies and consumers&mdash;and a burgeoning market opportunity. Products that save energy, protect the environment  and address the productive use of used electronics equipment come together at the ENERGY EFFICIENCY AND ELECTRONICS RECYCLING TECHZONE at the 2004 International CES. This TechZone promotes energy-efficient products and their manufacturers.
<br><img src="/global_images/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
<img src="images/GreenDay.gif" align="left" alt="Environmental Awareness Day" hspace="16" vspace="2" border="0">
<br>The International CES dedicates Saturday, January 10, 2004 to <b>GREEN SATURDAY, ENVIRONMENTAL AWARENESS DAY</b>.  Look for a special conference session that addresses the future of recycling electronics products.  Help us advance the CE industry&mdash;and the future of recycling electronics products.
<br><img src="/global_images/spacer.gif" alt="" width="1" height="36" hspace="0" vspace="0" border="0"><br>
<img src="images/EPA.gif" align="right" alt="Environmental Protection Agency" hspace="12" border="0">
<b>Who to expect</b><br>
<table>
<tr>
	<td>
	...
	<ul>
		...
		<li>Panasonic
		<li>ReCellular
		<li>Ricoh Corporation
		<li>Seasonic
		<li>U.S. EPA - Plug-in to eCycling
	</ul>	
	</td>
</tr>
</table>
...
<br><br>
Discover the <i>next best thing</i> for digital imaging&mdash;<b>Flash Forward: Bringing Digital Imaging Into Focus</b> at the 2004 International CES. View this exclusive digital imaging retail model brought to you by InfoTrends Research Group and CEA. Gain critical, <i>real</i> solutions to the developing digital imaging experience and demo tomorrow's new products and applications.
<br><br>
...
<br><br>
<a href="flash_forward.asp"><img src="images/FlashForward_small_spons.gif" align="right" alt="Flash Forward: Bringing Digital Imaging Into Focus" border="0"></a>
<b>Who to expect</b><br>
<table>
<tr>
	<td>
	...
	<td valign="top">
	<ul>
		<li>Int'l Imaging Industry Assn
		<li>Jasc Software
		<li>mediaGear
		<li>National Semiconductor
		<li>Pacific Image Electronics
		<li>Pexagon Technology
		<li>Pixel Magic Imaging
		<li>SMaL Camera Technologies
		<li>Ulead
		<li>Wynit
	</ul>	
	</td>
...
<span class="text_colored">LVCC, South Hall 3-4</span>
<br><br>
Digital music and the devices consumers use to access music continue to carry a happy tune for CE companies the world over. The International CES connects digital content, the Internet and broadband with wireless media and devices at the MP3 AND INTERNET AUDIO TECHZONE&mdash;where innovative products meet the mass market through the most comprehensive array of distribution channels.
<br><br>
<b>Who to expect</b><br>
<!--Manufacturers or suppliers of digital music, hardware, devices, accessories, software, content, services and pipelines-->
<table>
<tr>
	<td>
	<ul>
...
<span class="text_colored">LVCC, South Hall 3-4</span>
<br><br>
Everyone's computing on the go these days, but how long can they do it before their laptop or pocket game needs more juice? New power sources for portable computers, communications and entertainment devices keep us playing and working and in touch longer than ever. The products, the batteries, the chargers and power management systems that keep the batteries charged all have a place to keep you turned on and running on full power at the PORTABLE POWER CENTER.
<br><br>
<b>Who to expect</b><br>
<table>
<tr>
	<td>
	<ul>
		<li>AccuPower-USA, Inc.
		<li>Battery Technology Inc.
		<li>Cellular Distributor, Inc.
		<li>China Liaoning Suppo Battery (Shenyang) Co. Ltd.
		<li>Dongguan Dake Battery
		<li>Go Power! Electric Inc.
		<li>Golden Regent Electronics Industrial Ltd.
		<li>Innergy Power Corporation
	</ul>	
	</td>
	<td valign="top">
	<ul>
		<li>Lind Electronics
		<li>Millennium Pacific Inc.
		<li>OPTI-UPS
		<li>Temtex Industries Inc./Interall North America
		<li>Valence Technology Inc.
		<li>Vanson Electronics Ltd.
		<li>Yuntong Power Co. Ltd.
	</ul>	
	</td>
</tr>
</table>
...
<b>What to expect</b><br>
<ul>
	<li>manufacturers and distributors of next-generation DVD-R/RW products
	<li>live recording demonstrations to obtain easy knowledge of "The World of DVD-R/RW"
</ul>
<img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<a href="#top">[back to top]</a><br>
...
<span class="text_colored">LVCC, South Hall 1-2</span>
<br><br>
Home sweet home takes on a whole new meaning in the digital decade. Families put networking, security, home entertainment systems, energy management solutions and high-speed Internet connections on their dream-home wish lists, and it's opening up new doors for a variety of consumer technology companies. Hang your hat at the International CES TECHHOME TECHZONE while you see how Mom, Dad and the kids enjoy a new kind of high-tech habitat.
<br><br>
<img align="right" src="images/techhome.gif" alt="TechHome, Produced by CEA">
<b>Who to expect</b><br>
...
<tr>
	...
	<ul>
		<li>A5Tek Corp.
		<li>Caba
		<li>CorAccess Systems
		<li>DeCorp America
		<li>DigitalDeck, Inc.
		<li>EH Publishing
		<li>GE Interlogix
		<li>Global Communications UK Ltd.
		<li>HAI (Home Automation Inc.)
		<li>HomePlug Powerline Alliance 
		<li>HomeSeer Technologies LLC
		<li>Intellon Corporation
		<li>Intrigue Technologies Inc.
	</ul>	
	</td>
	<td>
	<ul>
		<li>Odyssey Technologies, Inc.
		<li>OnQ Technologies
		<li>Parks Associates
		<li>PrismQ
		<li>Residential Systems
		<li>Shell Home Genie
		<li>TMIO, LLC
		<li>University of Wisconsin Trace Center
		<li>UPnP Implementers 
		<li>USTEC
		<li>Vantage Controls
		<li>WeatherHawk
		<li>X10 PRO
...
<br><br>
Grab your GPS and find your way to the DIGITAL CAR SHOWROOM, spotlighting digital car products at the 2004 International CES, the world's largest mobile electronics tradeshow. Let us guide you through the ins and outs of mobile electronics and telematics, convergence and communications technologies. We'll get you there. 
<br><br>
...
<tr>
	...
	<ul>
		<li>Microsoft
		<li>Mindready Solutions
		<li>MOTIA
		<li>Pharos Science & Applications
		<li>Skybility
		<li>Telcontar
		<li>Topp
	</ul>
...
<span class="text_colored">LVCC, South Hall 1-2</span>
<br><img align="right" src="/attendees/exhibit_floor/techzones/images/upnp.gif" alt=""><br>
...
<!--Manufacturers and suppliers of high-speed and original USB products.-->
<img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<a href="#top">[back to top]</a><br>
