...
<head>
	...
	<title>2004 International CES:&nbsp;Exhibitor Publicity Tips</title>
...
<!-- RESOURCE CENTER -->	
		...
		<a href="/exhibitors/resource_center/pr_kit/default.asp">Exhibitor PR Kit</a><br>
				...
				<span class="nav_fourth_arrow"><b>></b> &nbsp;</span>Publicity Tips</a><br>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Publicity Tips<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<div id="2.3.5.1">	
<!-- text for main page -->
At the 2004 International CES, expect live broadcasts from all the major channels. Look for more than 4,000 journalists generating an unprecedented number of newspaper and magazine articles, television and radio reports and online stories.
<br>
Follow these tips to garner the publicity you deserve.
<br><br>
<table width="590" cellspacing="0" cellpadding="0" border="0"  class="text">
<tr>
    <td width="285" valign="top">
		<span class="subhead">1) Media Positioning</span><br>
		The International CES defines innovation. <a href="kit.asp?id=2#kit">Develop press materials</a> that capture that innovative spirit and reflect how your company's brand or products portray forward thinking.
		<br><br>
		<span class="subhead">2) Send Releases to CEA</span><br>
		Send CEA your releases and product information. We'll make efforts to include highlights in our extensive pre-show publicity campaign.
		<br><br>
		<span class="subhead">3) Announce New Products at the International CES</span><br>
		Debut your new products at the show to generate extensive national publicity, including television coverage. Will your product be the hot talk of the show?
		<br><br>
		<span class="subhead">4) Name Drop: The International CES</span><br>
		Use your exhibitor status in your announcements and benefit from CES branding. <a href="/about_ces/logos/default.asp">Download the official logo</a> for your marketing materials
		<br><br>
		<span class="subhead">5) Use the Web</span><br>
		Post your releases on Virtual Press Office and Business Wire through www.CESweb.org (coming in July) for extreme exposure. CESweb attracted more than 16 million hits during the 2003 International CES. Don't miss the coverage!
		<br><br>
		<span class="subhead">6) Press/Analyst Materials</span><br>
		CES continues to be the international media and financial community showcase for the consumer technology industry, with the most anticipated product launches and OEM deals. Consider who will read your materials and make sure they stand out from the competition.
	</td>
    
	<td width="20"><img src="/global_images/spacer.gif" alt="" width="20" height="1" border="0"></td>
	<td width="285" valign="top">
	    <span class="subhead">7) New Product Listing</span><br>
		Update your 2004 Directory listing online by November 3, 2003.  List products you'll exhibit, announcements/product launches you plan to make, and which company reps will be available for interviews.  Make it easy for reporters to find your booth during the show.
		<br><br>
		<span class="subhead">8) Think TV</span><br>
		Be prepared to present your products to television journalists. Television coverage of the International CES increases annually, with more programs reporting directly from the show floor. Make your presentation visually interesting and be prepared to do television interviews.
		<br><br>
		<span class="subhead">9) Tell Your Local Media</span><br>
		Announce to your local media that you'll be at the 2003 International CES. Local newspapers and business publications are likely to be interested in your CES exhibit plans. For maximum coverage, consider participating in our regional <a href="events.asp?id=3#outreach">media outreach campaign</a>.
		<br><br>
		<span class="subhead">10) Call CES for Help</span><br>
		The International CES wants to keep your company's name in front of key industry decision makers. CEA promotes the consumer technology industry and the International CES all year long, through <a href="http://www.ce.org/events" target="new">industry-specific events</a> and international media tours. Contact Wendy Hudak at 770-643-7144 or <a href="mailto:whudak@ce.org">whudak@ce.org</a> for promotion assistance.
		<br><br>
		<span class="subhead">11) Host a Special Event or a Celebrity</span><br>
		Want the media to flock to your booth? There's no better way to draw attention to your product than with a <a href="events.asp?id=4#celebs">special event or celebrity appearance</a>. If you've got something special planned, fill out the celebrity appearance form and let us know.
	</td>
</tr>
</table>
<br>
