...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="home7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">International CES Photos<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<!-- text for main page -->
<div id="0.1.2">	
<span class="section_title">Picture the Excitement</span>
<br><br>
Choose from the three photo categories to see the high-tech, high-energy International CES action.
<br><br>
...
<tr>
    <td width="186" valign="top" class="text">
		<a href="photos.asp?option=people"><img src="images/shapiro.jpg" border="0"></a><br><br>
		<span class="subhead"><a href="photos.asp?option=people">People</a></span><br>
		You ought to be in pictures. If you were at the 2004 International CES, maybe you are. Anyone look familiar?
	</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
    
	<td width="186" valign="top" class="text">
		<a href="photos.asp?option=products"><img src="images/camera.jpg" border="0"></a><br><br>	
		<span class="subhead"><a href="photos.asp?option=products">Products</a></span><br>
		Digital media players, coffee makers, navigation systems and more. Every consumer technology product you can imagine&mdash;from every angle.
	</td>
    
	<td width="16"><img src="/global_images/spacer.gif" alt="" width="16" height="1" border="0"></td>
    
	<td width="186" valign="top" class="text">
		<a href="photos.asp?option=show_floor"><img src="images/floor.jpg" border="0"></a><br><br>	
		<span class="subhead"><a href="photos.asp?option=show_floor">Show Floor</a></span><br>
		The 2004 International CES show floor gives thousands of people the chance to connect with each other in one high-energy forum. See for yourself.
	</td>				
</tr>
</table>
<!-- /3 column table in main content cell -->		
