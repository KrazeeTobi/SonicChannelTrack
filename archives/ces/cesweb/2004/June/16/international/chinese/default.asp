...
<head>
	...
	<title>2005 International CES:&nbsp;国际参观者</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.7") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">国际参观者<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<meta http-equiv="Content-Type" content="text/html; charset=gb2312"><div id="4.7">	
<!-- text for main page -->

国际消费电子产品展 CES 吸引了来自不同群体的国际参展厂商、参加者以及成千上万名美国消费者产品技术的行家。他们渴望着与世界各地其它公司的同仁交流沟通。 
<br>
...
<tr>
    <td width="285" valign="top"><span class="subhead"><a href="travel.asp">旅行和签证信息</a><br></span>
现在就开始安排您参加 2005 年国际消费电子产品展 CES 的旅行计划，决非为期过早。从旅馆费率的折价到签证申请，我们尽力提供一切服务，使您的美国之旅尽可能地容易成行。
		<br><br>
		<span class="subhead"><a href="delegations.asp">代表团团体方案 (新!)</a><br></span>
成为2005 年1月6-9日全球领先消费者产品技术贸易展的一份子，带一个代表团到美国内华达州的拉斯维加斯参加2005 年国际消费电子产品展。了解我们新的团体方案。
	</td>
    
	<td width="20"><img src="/global_images2005/spacer.gif" alt="" width="20" height="1" border="0"></td>
    
	<td width="285" valign="top">
		<span class="subhead"><a href="services.asp">国际服务</a><br></span>
国际消费电子产品展 CES 提供专门为旅美的外国参展厂商和参加者而设计的各种服务。了解有关现场口译员、商务中心和接待工作等服务内容。</td>
</tr>
</table>
