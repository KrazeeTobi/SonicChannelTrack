...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.1") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">International Visitors<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
<tr>
    <td width="285" valign="top"><span class="subhead"><a href="travel.asp">Travel & Visa Information</a><br></span>
		It's never too early to start making your travel plans to attend the 2005 International CES. From discounted hotel rates to visa applications, we offer everything we can to make traveling to the U.S. as easy as possible.
		<br><br>
		<span class="subhead"><a href="delegations.asp">Delegation Group Program (NEW!)</a><br></span>
		Be part of the leading consumer technology tradeshow January 6-9, 2005, and bring a delegation to the 2005 International CES in Las Vegas, Nevada, USA. Learn about our new group program.
	</td>
    
	<td width="20"><img src="/global_images2005/spacer.gif" alt="" width="20" height="1" border="0"></td>
    
	<td width="285" valign="top">
		<span class="subhead"><a href="services.asp">International Services</a><br></span>
		The International CES offers a variety of services created specifically for exhibitors and attendees who travel to the U.S. from another country. Learn about on-site interpreters, commerce centers, receptions and more.	</td>
</tr>
</table>
