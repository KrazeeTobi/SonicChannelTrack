...
<!-- colored row with section color 4 - 5 pixels high -->
	<tr>
	    ...
	    <td width="140"></td>
	    <td width="10"></td>
	    <td width="610" colspan="6"  background="/global_images2005/spacer.gif" class="attendees4"><img src="/global_images2005/1.0/random_main0/1.0.bc_top.gif" width="610" height="5" hspace="0" vspace="0" border="0"></td>
	 </tr>
<!-- /colored row with section color 4 - 5 pixels high -->
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<td width="610" colspan="6" background="/global_images2005/spacer.gif" class="attendees5"><img src="/global_images2005/1.0/random_main0/1.0.bc.gif" width="610" height="40" hspace="0" vspace="0" border="0"></td>
...
<tr> 
    ...
    <td width="130" class="box10_3margin"><span class="subhead">Mark your calendar!</span><br>
      ...
      Las Vegas, Nevada<br>
      <br>
     <a href="/register/email.asp">E-mail me</a> when general registration opens in July.<br></td>
...
-->			
		...
		<td class="attendees9">	
			...
			<tr>
				...
				<td class="attendees9" valign="top">Alumni attendees can register for the 2005 International CES today. It's free, and the form is pre-populated for your convenience.
