...
<head>
	...
	<title>2005 International CES:&nbsp;Show Floor</title>
...
<!-- SHOW FLOOR -->
	...
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
	<a href="/attendees/show_floor/maps/">Venue Maps</a><br>
	<img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
	<!--
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/1.0/1.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Show Floor<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="1.2">	
<!-- text for main page -->
The largest annual consumer electronics tradeshow offers a wealth of opportunity for your business&mdash;if you know where to go and how to get there. Find the businesses, product categories and places that matter to you with 2005 International CES maps and area descriptions.
<br>
...
<tr>
    <td width="285" valign="top" class="text">
		...
		Use this list to find registration kiosks, product categories, booth locations and conference rooms.
		<br><br>
		<span class="subhead"><a href="maps/">Venue Maps</a><br></span>
		Need a visual? Download and print the location map.<!-- or take a virtual tour. -->
	</td>
    
	<td width="20"><img src="/global_images2005/spacer.gif" alt="" width="16" height="1" border="0"></td>

	<td width="285" valign="top" class="text">
		<span class="subhead"><a href="techzones/">TechZones</a><br></span>
		2005 International CES TechZones pull together players in each consumer electronics niche and deliver them to you in concentrated locations on the show floor.  
	</td>				
</tr>
</table>
