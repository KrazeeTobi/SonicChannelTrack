...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.5.3") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">해외 방문객 서비스<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<meta http-equiv="Content-Type" content="text/html; charset=euc-kr"><div id="4.5.3">	
<!-- text for main page -->

<span class="subhead">해외무역센터(ICC)</span><br>
해외무역센터는 쇼에 참가하는 업계의 동료들을 만날 수 있는 훌륭한 장소입니다. 이곳에서 이메일을 확인하거나 여러 언어를 구사하는 직원을 통해 쇼에 관한 질문을 하거나 또는 음료를 즐기실 수 있습니다. ICC는 라스베가스 컨벤션 센터 사우스홀 및 라스베가스 힐튼의 2층에 위치하며, 모든 해외 참관인과 전시업체가 사용할 수 있습니다. 
<br><br>

<span class="subhead">통역 서비스</span><br>
두 곳의 ICC와 사우스홀의 아래층에 위치한 등록 장소에는 다국어를 구사하는 직원들이 상주하고 있습니다. 이곳의 통역자들은 다음 언어를 구사합니다: 스페인어, 독어, 불어, 중국어, 일어, 한국어, 이태리어, 포르투갈어. 
<br><br>

<span class="subhead">국제 리셉션</span><br>
쇼의 첫째 날 저녁 시간에 있는 리셉션에서 전 세계의 전시업체 및 참관인과 네트워킹 시간을 가지십시오. 인터내셔널 리셉션이 있는 시간은 1월 6일 오후 6:00-7:30이며, 장소는 사우스홀 S222 실입니다. 모든 해외 참관인과 전시업체 및 언론 관계자를 초래합니다. 
<br><br>

그 밖에 해외 참관인과 전시업체를 위한 서비스에 대한 제안이 있으십니까? Diann Groff에게 <a href="mailto:dgroff@ce.org">dgroff@ce.org</a>로 이메일을 보내십시오.
<!-- /text for main page -->
</div>
