...
2004년 10월 26일부터는, 비자 생략 프로그램(VWP)에 해당하는 27개 국가의 비자 생략 대상 여행자는 기계 판독 가능한 여권이나 미국 비자를 제시해야 합니다. 이에 관한 안내가 필요하시면, "VWP 및 기계 판독용 여권에 관한 <a href="http://travel.state.gov/vwp.html#3" target="_blank">내가 알아야 할 사항</a>"을 읽어보십시오. 
<br><br>
...
<ul>
<li><a href="http://travel.state.gov/DS-0156.pdf" target="_blank">비이민 비자 신청서(pdf) </a>
