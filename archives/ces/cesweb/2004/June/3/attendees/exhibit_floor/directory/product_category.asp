...
<head>
	...
	<title>2004 International CES:&nbsp;Exhibitor Directory - Search by Product Category</title>
    ...
    function productCategoryBodyOnLoad() {
        document.searchByProductCategory.reset(); 
        initCategoriesCheck();
    }
    </script>
...
<!-- EXHIBIT FLOOR -->
	...
	<a href="/attendees/exhibit_floor/directory/">Exhibitor Directory</a><br>
			...
			<span class="nav_fourth_arrow"><b>></b> &nbsp;</span>by Product Category</a><br>
...
<div class="section_title">Search by Product Category</div>
Search for exhibitors by product category.  Narrow your search by specifying a show location. 
<br>
...
<tr>
	...
	<td><select name="productCategory" class="formData" onChange="loadSubs(document.searchByProductCategory.productCategory, document.searchByProductCategory.subCategory1); checkCategory('productCategory','none')">
...
<tr>
	<td><img src="/global_images/spacer.gif" height="10" width="1" border="0"></td>
	<td><img src="/global_images/spacer.gif" height="10" width="1" border="0"></td>	
</tr>

<tr cols="4">
	<td class="rowlabel">Category&nbsp;&nbsp;</td>
	<td><select name="subCategory1" class="formData" onFocus="checkCategory('subCategory1', 'productCategory');" onChange=" loadSubs(document.searchByProductCategory.subCategory1, document.searchByProductCategory.subCategory2);">
			<option value="unselected" selected>**********************All**********************</option>
			<option>&nbsp;
			<option>&nbsp;
			<option>&nbsp;
...
<tr>
	...
	Choose a show location to view exhibitors by venue.
	</span>
	</td>
</tr>
