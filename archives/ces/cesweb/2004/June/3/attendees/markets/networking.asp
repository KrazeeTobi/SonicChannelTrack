	...
	<table bgcolor="#E5F5FD" width="140" cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			...
			<td valign="top" class="text">
				...
				Learn about <a href="http://www.ce.org/ce_technologies/display.asp?id=Home%20Networking" target="new">CEA Home Networking initiatives</a> and how you can get involved.
			</td>
		</tr>
		<tr>
...
<br><br>
<strong>Visit the CEA website, <a href="http://www.CE.org">www.CE.org</a></strong>, to learn more about publications, upcoming events and current initiatives in home networking.<br><br>
...
This year's International CES exhibitors included Microsoft, Net Gear, D-Link, USTEC, OnQ Technologies, CorAccess, HP, XtremeSpectrum, Motorola Broadband and Scientific Atlanta.
<br><br>
Use the <a href="/attendees/exhibit_floor/directory/exhibitor_name.asp">exhibitor directory</a> and search by product category to see a complete list of 2004 home networking exhibitors.
<br>
...
Highlighting technology advancements, new products and companies, these 2004 International CES TechZones offered a glimpse into what consumers can expect from the home networking market this year:
<ul>
...
See the full list of <a href="/attendees/special_events/">special events</a> and <a href="/attendees/exhibit_floor/displays/">displays</a> that took place at the 2004 International CES, including these designed for the home networking market:
<ul> 
	<li>Home Networking Reception
	<li>NextGen04 Demo Home
	<li>TechHome Demo
	<li>TechKnow Overload
	<li>Home Networking Trends Chat
</ul>
...
<tr>
	<td valign="top"><img src="/global_images/bullet.gif"></td><td><strong>Home Networking Trends Chat</strong><br><span class="text_colored">11 a.m. January 8, LVCC Grand Lobby, CEA Stage</span><br>Park Associates' Kurt Scherf discusses the latest home networking trends.</td>
</tr>
</table>
-->
