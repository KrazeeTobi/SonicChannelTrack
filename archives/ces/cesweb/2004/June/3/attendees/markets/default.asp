...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">International CES Markets<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<div id="1.6">		
<!-- text for main page -->
<span class="section_title">What's your interest?</span><br><br>
Everyone who attends the International CES comes with a host of objectives in mind, and almost all of them can fit cleanly into a product category that resides in the vast expanses of the growing consumer electronics industry.
It can get a bit overwhelming, especially as you navigate through more than 1.3 million square feet of space, filled with wall-to-wall exhibitors, events and conferences.
<br><br>
Use this section to get a feel for what the International CES offers&mdash;one market at a time.
<br><br>
...
<tr>
	...
	<a href="emergtech.asp"><img border="0" src="images/emerging_tech_sm.jpg" alt="Emerging Tech" align="middle"></a>&nbsp;&nbsp;&nbsp;<a href="emergtech.asp">Emerging Tech</a><br><br>
	</td>
	<td valign="top" width="190">
	<a href="gaming.asp"><img border="0" src="images/gaming_sm.jpg" alt="Gaming" align="middle"></a>&nbsp;&nbsp;&nbsp;<a href="gaming.asp">Gaming</a><br><br>
	<a href="networking.asp"><img border="0" src="images/home_networking_sm.jpg" alt="Home Networking" align="middle"></a>&nbsp;&nbsp;&nbsp;<a href="networking.asp">Home Networking</a><br><br>	
