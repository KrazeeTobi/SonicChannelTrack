	...
	<table bgcolor="#E5F5FD" width="140" cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			...
			<td valign="top" class="text">
				...
				Learn about <a href="http://www.ce.org/ce_technologies/display.asp?id=Mobile" target="new">CEA Mobile Electronics initiatives</a> and how you can get involved.
			</td>
		</tr>
		<tr>
...
<br><br>
<strong>Visit the CEA website, <a href="http://www.CE.org">www.CE.org</a></strong>, to learn more about publications, upcoming events and current initiatives in mobile electronics.<br><br>
...
This year's International CES exhibitors included Delphi, Visteon, Johnson Controls, Mytek, XM Satellite Radio, Sirius Satellite Radio, Vibe Technologies, Boston Acoustics, Microsoft Automotive and Clarion.
<br><br>
Use the <a href="/attendees/exhibit_floor/directory/exhibitor_name.asp">exhibitor directory</a> and search by product category to see a complete list of 2004 mobile electronics exhibitors.
<br>
...
Highlighting technology advancements, new products and companies, these 2004 International CES TechZones offered a glimpse into what consumers can expect from the mobile electronics market this year:
<ul>
