...
<ol>
	<li>早目にビザを申請してください！すべての米国大使館において、申請の処理時間を延長する恐れのある<a href="http://travel.state.gov/specialnotice.html" target="_blank">最新の審査過程</a>を実施中です。米国の領事館は、少なくとも出発日の60日前にビザ申請を開始することをお勧めします。<a href="http://travel.state.gov/links.html" target="_blank">最寄の大使館</a>の領事部に電話して、インタビューを受けるための待ち時間はどれぐらいかを確認することもできます。
...
2004年10月26日より、27のビザ免除プログラム (VWP) 対象国すべてからのビザ免除旅行者は、機械可読パスポートまたは米国ビザのいずれかを提示しなくてはなりません。詳細については、「VWPおよび必須の機械可読パスポートについての<a href="http://travel.state.gov/vwp.html#3" target="_blank">基本情報</a>」をご覧ください。
<br><br>
...
<ul>
<li><a href="http://travel.state.gov/DS-0156.pdf" target="_blank">一時渡航者用ビザの申請 (pdf) </a>
