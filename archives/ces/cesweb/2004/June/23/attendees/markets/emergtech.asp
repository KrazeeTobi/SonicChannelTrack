...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/1.0/1.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="380"  background="/global_images2005/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Emerging Technology<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="1.6.3">		
<!-- text for main page -->
<!--span class="section_title">No boundaries</span><br><br>-->
<img src="images/emerging_tech2.jpg" align="right" hspace="5" style="border: 1px #cccccc solid">
...
Spanning every product category, embedded technology will have its largest presence ever at the upcoming International CES, January 6-9, 2005. 
<br><br>
Use the <a href="/attendees/directory/exhibitor_name.asp">exhibitor directory</a> and search by product category to see a complete list of 2005 International CES exhibitors.
...
These 2005 International CES TechZones offer buyers, distributors, engineers and other attendees and exhibitors a condensed cross-section of the emerging tech market:
<ul>
	...
	<li>DSL Forum
	<li>DVD-RAM		
	<li>Energy Efficiency/Electronics Recycling
	<li>Flash Forward
	<li>MP3
	<li>Personal Broadband
	<li>Portable Power
	<li>Qualcomm Partners
	<li>RWPPI
	<li>SD Card
...
<ul>
	...
	<li><a href="/attendees/conferences/search/session_by_track_list.asp?ID_track=IP04&ref=IP04">IPv6</a><br>
...
See the full list of <a href="/attendees/special_events/">special events</a> and <a href="/attendees/exhibit_floor/displays/">displays</a> that took place at the 2004 International CES, including these designed for the emerging tech market:
<ul> 
	<li>Green Saturday at CES
	<li>Innovations 2004 Awards
	<li>NextGen04 Demo Home
	<li>TechnoCar
	<li>Technology is a Girl's Best Friend Showcase
	<li>TechTV's Best of CES Awards
	<li>Fastest Geek Contest Finals
</ul>
<br>-->
<strong>Visit the CEA website, <a href="http://www.CE.org">www.CE.org</a></strong>, to learn more about publications, upcoming events and current initiatives in emerging technology.
...
<tr> 
	...
	<tr>
		<td><img src="/global_images2005/markets/emergTech.gif" alt="" hspace="0" vspace="0" border="0"></td>
	</tr>
	<tr>	
		<td>Look for this sign to find emerging technology exhibits on the 2005 International CES floor.</td>
	</tr>
	</table>
	</td>
...
<span class="subhead">Emerging Technology at the International CES</span><br>
<ul>
	<li>Key technologies such as DTV and DVD launched at CES.
	<li>The Best of CES awards recognize the top technology advancements in the industry.
	<li>The Innovations Awards program recognizes outstanding achievement in product and engineering design.
	<li>More than 6,000 engineers attend the International CES to investigate new technologies.
	<li>More than 200 universities attend the show to evaluate equipment, streamline operations and gauge the future of technology.
	<li>Members from engineering organizations, such as the Society of Automotive Engineers (SAE) and IEEE, regularly attend CES.
	<li>The Emerging Technologies knowledge track and CES SuperSessions address the newest technologies coming to market.
	<li>Keynotes and Industry Insider sessions enable engineers to gain strategic insight on the future of CE technologies directly from industry leaders.
	<li>In 2005, the IEEE is featuring its International Conference on Consumer Electronics (ICCE) alongside the International CES. 
</ul><br>
...
<tr>
	<td valign="top"><img src="/global_images2005/bullet.gif"></td><td><strong>Green Saturday at CES</strong><br>Get up to speed on energy efficiency with a day devoted to electronics recycling efforts.</td>
</tr>
<tr>
	<td valign="top"><img src="/global_images2005/bullet.gif"></td><td><strong>Innovations 2004 Awards</strong><br><span class="text_colored">LVCC Silver Exhibits</span><br>See the year's most technologically advanced products in 20 consumer electronics categories.</td>
</tr>
<tr>
	<td valign="top"><img src="/global_images2005/bullet.gif"></td><td><strong>NextGen04 Demo Home</strong><br><span class="text_colored">LVCC Silver Exhibits</span><br>View the practical application of home automation and whole house broadband for the next generation of home buyers.</td>
</tr>
<tr>
...
<tr>
	<td valign="top"><img src="/global_images2005/bullet.gif"></td><td><strong>Technology is a Girl's Best Friend Showcase</strong><br><span class="text_colored">LVCC Grand Lobby</span><br>See award-winning products tailored to the female consumer, and learn how to capture this tech-hungry market.</td>
</tr>
<tr>
	<td valign="top"><img src="/global_images2005/bullet.gif"></td><td><strong>TechTV's Best of CES Awards</strong><br><span class="text_colored">2 p.m. January 10, LVCC Grand Lobby, CEA Stage</span><br>From value to wow-factor, see which products passed the TechTV test.</td>
</tr>
<tr>
	<td valign="top"><img src="/global_images2005/bullet.gif"></td><td><strong>Fastest Geek Contest Finals</strong><br><span class="text_colored">10 a.m. January 11, LVCC Grand Lobby, CEA Stage</span><br>See the winners from PC Magazine.</td>
</tr>
</table>
-->		</td>
	    <td width="10"  background="/global_images2005/spacer.gif" class="attendees8">&nbsp;</td>
