...
<head>
	...
	<title>2005 International CES:&nbsp;Exhibitor Resource Center</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.3") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/2.0/2.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Exhibitor Resource Center<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
<tr>
    <td width="285" valign="top">
		...
		This list keeps you organized with to-do items for your exhibit experience.
		<br><br><br>
		...
		<br><br>
		<!--
		<span class="subhead"><a href="directory/">Update Your 2004 Directory Listing</a><br></span>
		Update your listing in the online International CES directory&mdash;the best resource in the industry for leading company and product information. 
		<br><br>
	...
	<td width="285" valign="top">
		...
		New CES exhibitors receive helpful tips. This 2004 guide is an excellent general resource for tradeshow managers. 
		<br><br>
		-->
...
<br><span class="text_colored">Coming early Summer: 2004 International CES Attendee Audit Summary</span>
<!-- /text for main page -->
</div>
