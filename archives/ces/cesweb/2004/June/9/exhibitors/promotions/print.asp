...
<table width="590" cellspacing=0 cellpadding=1 border=0 ID="Table1">
	...
	<tr>
		<td colspan=3><br>
		The official show directory is the ultimate reference guide for the 2005 International CES. And it's the year round source for complete company profiles, brand listings and important product information.  Ads are prominently placed and bring results-even after the show is over. Ask about packages with the <I>CES Show Guide</I> and the <I>CES Pre-Show Planner</I>, also published by <I>Dealerscope/E-Gear</I> magazines.<br>
		<br>
		<!--
		...
		Tab ad closing: November 2
		Materials due: November 9
	    ...
	    Mattie Sacerdote<br>
		Phone: (215) 238-5352<br>
		Email: <A HREF="mailto:msacerdote@napco.com">msacerdote@napco.com</A><br>
		<img src="/global_images2005/spacer.gif" width="1" height="5" border="0"><br><a href="#">[back to top]</a>
		</td>
	</tr>		
	...
	<tr>
		<td colspan=3><br>		
		This is the most complete guide to planning packed days at the 2005 International CES.  Produced by <i>Dealerscope/ E-Gear</i> magazines, the pre-show planner is the <i>early</i> place to reach more than 80,000 CES attendees.  Call now to reserve ad space.  Ask about package ad deals with the show directory.
		<br><br>
