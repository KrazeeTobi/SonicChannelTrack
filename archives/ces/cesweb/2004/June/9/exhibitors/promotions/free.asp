...
<head>
	...
	<title>2005 International CES:&nbsp;byb+ Free Opportunities</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.2.8") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/2.0/2.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Free Opportunities<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="2.2.8">		
<!-- text for main page -->
Take advantage of these additional International CES exhibitor benefits&mdash;at no cost to you&mdash;and make the most of your exposure at the 2005 International CES.
<br><br>
...
<table width="590" cellspacing=0 cellpadding=1 border=0 ID="Table1">
	...
	<tr>
		...
		<ul>
			<li><A HREF="/attendees/awards/innovations/default.asp">Innovations 2005</A>, honoring excellence in design and engineering.  An entry fee is required.  Honorees receive additional benefits and press exposure, free of charge.<br><br>
			<li><A HREF="/attendees/awards/best_of_ces/default.asp">TechTV's Best of CES Awards</A>, honoring the most outstanding new consumer technology products debuted at the 2005 International CES<br><br>
		...
		<br>
		<B>Innovations 2005 Contact</B><br>
	...
	<tr>
		<td colspan=3><br>
		Help your customers register for CES! Place a link on your corporate website to online registration for the 2005 International CES.
	...
	<tr>
		...
		<br>
		<B>Deadlines</B><br>
		Press Kits Due: January 5, 2005<br>
		<br>
