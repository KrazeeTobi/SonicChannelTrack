...
<head>
	...
	<title>2004 International CES:&nbsp;2004 International CES Registration</title>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="home7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">2004 International CES Registration<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<div id="0.9">	
<!-- text for main page -->

<span class="section_title">Registration Deadline Extended</span><br><br>
...
<br><br>
Advance registration is open until January 2, 2004, 5 p.m. EST.  You can register online until January 2nd, however due to holiday mail delays, we cannot guarantee that you will receive your badge in the mail before the show.  In the event that you do not receive your badge, you may <a href="http://dev.cesweb.org/faqs/general.asp?id=12#new">pick it up at an on-site registration area</a>.
<br><br>
Thank you for your participation in the 2004 International CES.
<br><br>
<strong><a href="http://ww4.expocard.com/ces041/default.asp">Click here to continue to registration.</a></strong>
<br><br>
<!-- /text for main page -->
</div>
