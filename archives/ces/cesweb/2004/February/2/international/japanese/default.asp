...
<!-- text for main page -->
<span class="section_title">今すぐご計画ください</span>
<br><br>
2004年度国際CESでは、ワイヤレスやデジタルイメージング、そしてホームコンピューティングやネットワーキングといった数多くの市場における新しい消費者テクノロジーのトレンドを学べます。
また製品の輸出に関心を持つ米国メーカーと出会うチャンスです。
110を越える国々から集まる2,300社以上の出展企業、4,000名以上のジャーナリスト、そして110,000名以上の参加者と共に、実り多い４日間をお過ごしください。
このチャンスをお見逃しなく。
<br>
<br>
当日参加者登録所は、2004年１月７日の正午から受付を開始します。
...
<span class="subhead">国際コマースセンター（ICC）<br></span>
<span class="text_colored">ラスベガスコンベンションセンターのS224号室、およびラスベガスヒルトンの54025ブース</span>
<br>
国際コマースセンターでは以下がご利用いただけます。
<ul>
	<li><strong>母国語によるアシスタンス</strong> 多国語に堪能なスタッフがご質問にお答えし、登録や会議室の予約のお手伝いをします。
	<br><br>
	<li><strong>輸出チャンスに関するご相談</strong> 米商務省の貿易担当者により、米国外への輸出機会に関心を持つ出展企業との引き合い支援が提供されます。
	  2004年度国際CESは、米商務省の米商業サービスの<span class="subhead">国際バイヤープログラム（IBP）</span> 参加イベントです。
	  詳細は、<a href="http://www.export.gov/comm_svc/intl_buyer_program.html" target="new">米商業サービスホームページ</a>をご覧ください。
	<br>
	<br><li><strong>ビジネス取引とネットワーキング</strong>ICCではまた、インターネットやコピーサービスのほか、無料の飲み物や軽食をご用意しています。
</ul>

<img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/4.0/line.gif" alt="-----------------------------------------------" width="590" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<span class="subhead">世界各地のCES<br></span>
<span class="text_colored">1月８日（木）午後６時～７時30分、ラスベガスコンベンションセンター、サウスホールS222号室</span><br>
このネットワーキングレセプションには、すべての国際ビジター、出展企業、および報道陣が招待されています。 世界各地の様々な食べ物や飲み物をお楽しみください。

<br>
<img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/4.0/line.gif" alt="-----------------------------------------------" width="590" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<span class="subhead">国際ゲートウェイハッピーアワー<br></span>
<span class="text_colored">１月９日・10日（金・土）午後４時～６時、ヒルトンインターナショナルゲートウェイ</span><br>
CES参加者全員がゲートウェイを訪れ、他の参加者や出展企業とネットワーキングしながら、台湾や韓国、中国、イギリス、その他の国々からのユニークな消費者家電製品を見ることができるチャンスです。
<br>
...
<tr>
	<td>
	<span class="subhead">2004年度国際CESへのご旅行の準備</span><br><img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
	<ul>
		<li>入国ビサの取得に招待状が必要かどうかを確認します。 <a href="http://www.unitedstatesvisas.gov" target="new">www.unitedstatesvisas.gov</a>をご覧ください。
		<br>
		<br>
		<li><a href="http://ces.expoexchange.com/ces041/default.asp">2004年度国際CESに登録します。</a>ビサ取得のための招待状が必要な出展企業は、直ちにCESカスタマーサービス<a href="mailto:CESinfo@CE.org">CESinfo@CE.org</a>までご請求ください。
		  参加者は、即時エキスポエクスチェンジ (+301-631-3983) に連絡し、フェデラルエクスプレスの請求先番号を提供してください。
		  パスポート番号をご用意ください。
		<br>
		<br><li>ビサ申請手続きについて、<a href="../Source/pdf/tips_english.pdf" target="new">ビサ取得のヒント</a> (pdf版) を読みます。
		<br><br><li><a href="http://travel.state.gov/DS-0156.pdf" target="new">アメリカ合衆国ビサ申請書 (フォーム DS-0156)</a> (pdf版) をダウンロードします。
		<br><br><li><a href="http://travel.state.gov/links.html" target="new">最寄の米国大使館または領事館</a>に連絡し、ビサの面接を予約します。
		<br><br><li>ホテルや航空運賃など、<a href="/attendees/travel/">渡航準備を手配します</a>。
		<br><br>
		<li>CESの参加を最大限に活用するため、他の国際バイヤーと共に代表団にご参加ください。 詳細は、<a href="http://travel.state.gov/links.html" target="new">最寄の大使館または領事館</a>の商業貿易担当者にお問い合わせください。
	</ul><br>
	</td>
</tr>
</table>
