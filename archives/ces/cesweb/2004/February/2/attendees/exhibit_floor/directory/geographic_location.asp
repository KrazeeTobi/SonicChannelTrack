...
<head>
	...
	<title>2004 International CES:&nbsp;Exhibitor Directory - Search by Geographic Area</title>
...
<script language="javascript1.2">
    ...
    function productCategoryBodyOnLoad() {
        document.searchByGeographicLocation.reset(); 
        initCategoriesCheck();
    }
</script>
...
<!-- EXHIBIT FLOOR -->
	...
	<a href="/attendees/exhibit_floor/directory/">Exhibitor Directory</a><br>
			...
			<span class="nav_fourth_arrow"><b>></b> &nbsp;</span>by Geographic Area</a><br>
...
<div class="section_title">Search by Geographic Location</div>
<span class="text_colored">1) Select a Country or Region, or choose a U.S. State to view a list of domestic exhibitors.</span>
<br>
...
<tr>
	<td class="rowlabel">Country / Region&nbsp;&nbsp;</td>
	<td><select name="country" size="1" onChange="checkNation('country')" class="formData">
...
<tr>
	<td class="rowlabel">U.S. State&nbsp;&nbsp;</td>
	<td><select name="state" class="formData" size="1" onFocus="checkNation('state')">
	<option value="unselected" selected>**********************All**********************</option>
...
<tr>
	<td colspan="2"><span class="text_colored">2) Specify market information to locate regional exhibitors by product category.</span></td>
</tr>
...
<td class="rowlabel">Market&nbsp;&nbsp;</td>
	<td><select name="productCategory" class="formData" onChange="loadSubs(document.searchByGeographicLocation.productCategory, document.searchByGeographicLocation.subCategory1); checkCategory('productCategory','none')">
		<option value="unselected" selected>**********************All**********************</option>
		<option>&nbsp;
		<option>&nbsp;
		<option>&nbsp;
...
<tr>
	...
	<td><select name="subCategory1" class="formData" onFocus="checkCategory('subCategory1', 'productCategory');" onChange=" loadSubs(document.searchByGeographicLocation.subCategory1, document.searchByGeographicLocation.subCategory2);">
		<option value="unselected" selected>**********************All**********************</option>
		<option>&nbsp;
		<option>&nbsp;
		<option>&nbsp;
...
<tr>
	<td colspan="2"><span class="text_colored">3) Further narrow your search by selecting a show location.</span></td>
</tr>
