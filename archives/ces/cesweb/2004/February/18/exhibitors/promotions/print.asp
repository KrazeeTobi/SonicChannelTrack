...
<head>
	...
	<title>2004 International CES:&nbsp;byb+ Print Advertising Opportunities</title>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Print Advertising Opportunities<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<div id="2.2.3">		
<!-- text for main page -->
Reach tech savvy CE industry movers who read the leading trade publications and are anxious to plan for the 2004 International CES. The editorial calendars are filling up—and ad space is running out. Reserve your space today!
<br><br>
...
<table width="590" cellspacing=0 cellpadding=1 border=0 ID="Table1">
	...
	<tr>
		...
		<br>
		<B>Deadlines</B><br>
		Ad closing: November 21<br>
		Materials due: December 5<br>			
		<br><br><br><br><br><a href="images/print_ces_daily_large.jpg" target="new"><font size="-2">Click for larger image.</font></a><br><br>
		<B>Contacts</B><br>
	...
	<tr>
		<td colspan=3><br>
		The official show directory is the ultimate reference guide for the 2004 International CES. And it's the year round source for complete company profiles, brand listings and important product information.  Ads are prominently placed and bring results-even after the show is over. Ask about packages with the <I>CES Show Guide</I> and the <I>CES Pre-Show Planner</I>, also published by <I>Dealerscope/E-Gear</I> magazines.<br>
		<br>
		<!--
		...
		<br>
		-->
		<a href="images/print_directory_large.jpg" target="new"><img border="0" src="images/print_directory.jpg" align="left" hspace="5"></a>
		<B>Marketing Investment</B><br>
		Call for details!<br>
		<br>
		<B>Deadlines</B><br>
		Ad closing: November 1<br>
		Materials due: November 18<br>
		Distributed: On-site<br>
		Deadline to include logos in Directory: November 3<br>
		<br><br><a href="images/print_directory_large.jpg" target="new"><font size="-2">Click for larger image.</font></a><br><br>
		<!--
		...
		E-mail: <A HREF="mailto:kfabiano@napco.com">kfabiano@napco.com</A><br>
		<img src="/global_images/spacer.gif" width="1" height="5" border="0"><br><a href="#">[back to top]</a>
		</td>
	</tr>		
	...
	<tr>
		<td colspan=3><br>		
		This is the most complete guide to planning packed days at the 2004 International CES.  Produced by <i>Dealerscope/ E-Gear</i> magazines, the pre-show planner is the <i>early</i> place to reach more than 80,000 CES attendees.  Call now to reserve ad space.  Ask about package ad deals with the show directory.
		<br><br>
		<a href="images/print_pre-show_planner_large.jpg" target="new"><img border="0" src="images/print_pre-show_planner.jpg" align="left" hspace="5"></a>
		<B>Marketing Investment</B><br>
		Call for details!<br>
		<br>
		<B>Deadlines</B><br>
		Ad closing: October 24<br>
		Materials due: October 31<br>
		Distributed: Early November<br>		
		<br><br><br><a href="images/print_pre-show_planner_large.jpg" target="new"><font size="-2">Click for larger image.</font></a><br><br>
		<B>Contacts</B><br>
		Eric Schwartz, Group Publisher/Vice President-NAPCO<br>
		Phone: (215) 238-5420<br>
		E-mail: <A HREF="mailto:eschwartz@napco.com">eschwartz@napco.com</A><br>
	...
	<tr>
		...
		<br>The <i>International CES Show Guide</i> provides quick listings, maps and event information for attendees on-the-move. Ask about package ad deals with the <i>CES Directory</i> and the <i>CES Pre-Show Planner</i>, custom-published by <i>Dealerscope/E-Gear</i> magazines.<br>
		<br>
		<a href="images/print_show_guide_large.jpg" target="new"><img border="0" src="images/print_show_guide.jpg" align="left" hspace="5"></a>		
		<B>Marketing Investment</B><br>
		Call for details!<br>
		<br>
		<B>Deadlines</B><br>
		...
		Distributed: One-site<br>		
		<br><br><br><a href="images/print_show_guide_large.jpg" target="new"><font size="-2">Click for larger image.</font></a><br><br>
		<B>Contacts</B><br>
		Eric Schwartz, Group Publisher/Vice President-NAPCO<br>
		Phone: (215) 238-5420<br>
		E-mail: <A HREF="mailto:eschwartz@napco.com">eschwartz@napco.com</A><br>
