...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Sessions by Keyword<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<!-- text for main page -->
<div id="1.1.6.7.1">
<table cellpadding=3 cellspacing=1 border=0><tr height=7><td colspan=4></td></tr><tr><td align=center><strong>No search string was entered. Please <a href=search_by_keyword.asp> try again</a>.</strong></td></tr></table>
<!-- /text for main page -->
