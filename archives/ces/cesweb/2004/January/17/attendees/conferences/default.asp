...
<head>
	...
	<title>2004 International CES:&nbsp;Conference Program</title>
...
<!--Conferences&nbsp;&nbsp;|&nbsp;&nbsp;<a href='/attendees/exhibit_floor'>Exhibit Floor</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='/attendees/special_events'>Special Events</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='/attendees/awards'>Awards</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='/attendees/travel'>Hotel/Travel</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='/attendees/markets/default.asp'>Markets</a>-->
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="380"  background="/global_images/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">2004 International CES Conference Program<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<!-- text for main page -->
<div id="1.1">	
More than 100 sessions within the 2004 International CES Conference Program put 129,000 professionals nose-to-nose with the industry’s visionaries and technology talent. In four days, speakers delved into each consumer technology market, including wireless, mobile electronics, home networking and digital technology.
<br>
...
<span class="section_title">Instant replay</span><br><br>

<strong>Read the transcripts and purchase Mobiltape recordings</strong> from the 2004 International CES conference sessions, including:
<ul>
	<li><a href="keynotes.asp">Keynote</a> and <a href="insider_series.asp">Industry Insider</a> transcripts and audio recordings
	<br><br><li><a href="supersessions.asp">SuperSession</a> audio recordings
	<br><br><li>Audio recordings of all sessions within the <a href="knowledge_tracks.asp">CES Knowledge Tracks</a> and <a href="partners.asp">Partner Programs</a>
</ul>	
<br>

<!--
Choose one of the categories below or <a href="search/search_by_name.asp">search the program</a> to see the complete list of conference sessions available at the 2004 International CES.
<br><br>

	<span class="subhead">Get the big picture: <a href="keynotes.asp">Keynotes</a>, <a href="insider_series.asp">Industry Insiders</a> and <a href="supersessions.asp">SuperSessions</a><br></span>
	Included in your Exhibits-Plus Pass, our Keynotes, Industry Insiders and SuperSessions give you the best perspective on the industry.<br>
	<br>

	<span class="subhead">Focus on your interests: <a href="knowledge_tracks.asp">CES Knowledge Tracks</a><br></span>
	Mix and match sessions from different tracks to suit your specific needs.
	<br><br>
	
	<span class="subhead">Learn from the pros: <a href="partners.asp">CES Partner Programs</a><br></span>
	From real-world instruction to market forecasting, a variety of CEA partners share secrets of success, unique perspectives and visions.
-->
...
<img src="/global_images/1.0/line.gif" alt="-----------------------------------------------" width="380" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/spacer.gif" alt="" width="1" height="3" hspace="0" vspace="0" border="0"><br>
<span class="section_title">Register and power your whole year</span><br><br>
<a href="/register">Register online</a> through January 2 for an Exhibits-Plus Pass with access to:
<ul>
	<li>All exhibits (including the International Gateway)
	<li>All <a href="/attendees/exhibit_floor/techzones/">TechZones</a>
	<li>All <a href="keynotes.asp">Keynote</a> and <a href="insider_series.asp">Industry Insider</a> Addresses
	<li>All <a href="supersessions.asp">SuperSessions</a>
	<li>Select sessions on the <a href="knowledge_tracks.asp">CES Knowledge Tracks</a>
</ul>
-->
...
<img src="/global_images/1.0/line.gif" alt="-----------------------------------------------" width="380" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/spacer.gif" alt="" width="1" height="3" hspace="0" vspace="0" border="0"><br>
<span class="section_title">Make your travel accommodations early</span><br><br>
Visit the <a href="/travel">Hotel/Travel section</a> for complete travel information.  Book your hotel rooms online, and receive discounted rates on airfare and car rentals.
<br><br>
<span class="subhead">Show days and times</span>
<table cellpadding=1 cellspacing=0>
<tr>
	<td>Thursday, January 8</td>
	<td>&nbsp;&nbsp;&nbsp;</td>
	<td align="right">10 am - 6 pm</td>
</tr>
<tr>
	<td>Friday, January 9</td>
	<td>&nbsp;&nbsp;&nbsp;</td>	
	<td align="right">9 am - 6 pm</td>
</tr>
<tr>
	<td>Saturday, January 10</td>
	<td>&nbsp;&nbsp;&nbsp;</td>	
	<td align="right">9 am - 6 pm</td>
</tr>
<tr>
...
<!-- /text for main page -->
		...
		<img src="/global_images/spacer.gif" alt="" width="1" height="28" hspace="0" vspace="0" border="0""><br>
				<div align="center">
<img src="images/gates.jpg" style="border: 1px #999999 solid">
</div>

<img src="/global_images/spacer.gif" alt="" width="1" height="12" hspace="0" vspace="0" border="0"><br>
...
<img src="/global_images/spacer.gif" alt="" width="1" height="16" hspace="0" vspace="0" border="0"><br>
<table width="100%" border="0">
	<tr><td colspan="3"><img src="/global_images/1.0/line.gif" alt="-----------------------------------------------" width="100%" height="1" hspace="0" vspace="0" border="0"></td></tr>
	<tr>
		<td valign="top"><img src="/global_images/quote_open.gif"></td>
		<td><span class="text_colored">
		The 2004 CES is a fantastic world-class event; anyone doing anything of significance in relation to consumer electronics should be here!
		</span>
		</td>
		<td valign="bottom"><img src="/global_images/quote_close.gif"></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td colspan="2"><b>Paul W. D'Arcy</b>, Executive VP,<br>Sanyo Fisher Co.</td>
	</tr>
	<tr><td colspan="3"><img src="/global_images/1.0/line.gif" alt="-----------------------------------------------" width="100%" height="1" hspace="0" vspace="0" border="0"></td></tr>
</table>

<img src="/global_images/spacer.gif" alt="" width="1" height="16" hspace="0" vspace="0" border="0"><br>
<a href="http://www.mobiltape.com" target="new"><img src="/attendees/conferences/images/mobiletape.gif" alt="Mobiltape" border="0"></a>
<br>Official provider of 2004 International CES conference program audio recordings
		</td>
	    <td width="10"  background="/global_images/spacer.gif" class="attendees8">&nbsp;</td>
		</tr>
<!-- /main body row -->	
