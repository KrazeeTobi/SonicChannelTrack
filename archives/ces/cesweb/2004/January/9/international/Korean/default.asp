...
<!-- text for main page -->
<span class="section_title">지금 계획하십시오</span>
<br><br>
2004 International CES에서는 무선, 디지털 이미징, 홈 컴퓨팅 및 네트워킹 등을 포함한 여러 시장에서의 새로운 가전 기술 동향에 대해 알아볼 수 있습니다.  해외로 수출하는데 관심이 있는 미국 제조업체들을 만날 수 있는 기회이기도 합니다.  전세계 110여 국가에서2,300여 전시업체, 4,000여 보도 관계자들 및110,000 참관자들과 함께 4일에 거쳐 시간을 보내십시오.  지금 계획하셔야 합니다.
<br><br>
현장 참관자 등록은2004년 1월7일12시에 시작됩니다.
...
<span class="subhead">국제 무역 센터(ICC)<br></span>
<span class="text_colored">Las Vegas Convention Center, Room S224및 Las Vegas Hilton, Booth 54025</span>
<br>
국제 무역 센터(International Commerce Centers)를 방문하십시오:
<ul>
	<li><strong>귀하의 언어로 도움을 받으실 수 있습니다.</strong> 다국어를 구성하는 친절한 직원들이 등록절차의 도움 또는 회의실 예약을 도와드릴 수 있습니다.
	<br><br><li><strong>수출 기회에 대한 토론을 나누십시오.</strong> 미국 연방 상무부 대표자들이 참석하여 미국 외부로의 수출 기회에 관심있는 전시업체들을 찾을 수 있도록 도와 드립니다.  2004 International CES는 미국 연방 상무부 산하U.S. Commercial Service가 후원하는 <span class="subhead">국제 구매자 프로그램 (International Buyer Program: IBP)</span> 의 자랑스런 참가자입니다.  보다 자세한 내용은<a href="http://www.export.gov/comm_svc/intl_buyer_program.html" target="new">U.S. Commercial Service 웹사이트</a>를 방문하십시오.
	<br><br><li><strong>사업과 네트워크를 함께 하십시오.</strong> 국제 무역 센터에서는 인터넷 스테이션, 복사 서비스 그리고 간단한 다과와 음료를 무료로 제공합니다.
</ul>

<img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/4.0/line.gif" alt="-----------------------------------------------" width="590" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<span class="subhead">CES 전체 리셉션 (CES Around the World)<br></span>
<span class="text_colored">1월8일, 목요일, 오후 6:00 ~ 7:30, LVCC South Hall, Room S222</span><br>
본 네트워킹 리셉션에는 모든 국제 참관자, 전시업체 및 보도 관계자들을 초대합니다.  초대자들을 전 세계의 여러 지역을 대표하는 음식과 음료를 맛 보실 수 있습니다.

<br>
<img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/4.0/line.gif" alt="-----------------------------------------------" width="590" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<span class="subhead">인터내셔널 게이트웨이 리셉션(International Gateway Happy Hours)<br></span>
<span class="text_colored">1월9 ~ 10일, 금~ 토요일, 오후 4 ~ 6, Hilton International Gateway</span><br>
모든 CES 참관자들이 게이트웨이를 방문하고, 다른 참관자들 및 전시업체와 네트워크도 하며, 대만, 한국, 중국, 홍콩, 영국 및 다른 나라에서 온 독특한 가전제품을 보실 수 있는 기회입니다.
<br>

<img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<table bgcolor="#FFEDDC" width="90%" align="center" style="border: 1px #cccccc solid">
<tr>
	<td>
	<span class="subhead">2004년 International CES 여행을 위한 점검표</span><br><img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
	<ul>
		<li>비자 초청 서신이 필요한지 확인하십시오. <a href="http://www.unitedstatesvisas.gov" target="new">www.unitedstatesvisas.gov</a>를 방문하시면 됩니다.
		<br><br><li><a href="http://ces.expoexchange.com/ces041/default.asp">2004 International CES에 등록하십시오.</a> 비자 초청 서신이 필요한 전시자는 지금 CES 고객 서비스 <a href="mailto:CESinfo@CE.org">CESinfo@CE.org</a>로 이메일을 보내어 요청하셔야 합니다. 참관자는 바로 ExpoExchange (전화번호 +301-631-3983)으로 연락하셔서, 등록을 한 다음 FedEx 구좌번호를 제공하십시오.  귀하의 여권번호를 준비하십시오.
		<br><br><li>비자 신청 과정에 대해 저희가 준비한 <a href="../Source/pdf/tips_english.pdf" target="new">비자 신청 요령</a> (visa tip sheet) (pdf 파일)을 검토하십시오.
		<br><br><li><a href="http://travel.state.gov/DS-0156.pdf" target="new">미국 비자 신청서</a> (U.S. Visa Application Form, 양식번호 DS-0156) (pdf 파일)를 다운로드 하십시오.
		<br><br><li>가까운<a href="http://travel.state.gov/links.html" target="new">미국 대사관 또는 총영사관의 위치를 확인한</a> 다음, 비자 인터뷰에 대한 시간 약속을 하십시오.
		<br><br><li>호텔 및 항공편 등 <a href="/attendees/travel/">여행에 필요한 예약을 하십시오.</a>
		<br><br><li>귀하의 CES 참관이 더욱 좋은 체험이 될 수 있도록, 다른 국제 구매자 일행으로 구성된 사절단에 합류하십시오.  보다 자세한 내용은 <a href="http://travel.state.gov/links.html" target="new">귀하 지역의 대사관 또는 영사관</a>의 무역 담당부서 (commercial trade section)로 연락하시면 됩니다.
	</ul><br>
	</td>
</tr>
</table>
...
<span class="subhead">좀 더 자세한 정보가 필요하십니까?</span> <a href="mailto:cesinfo@ce.org">CESinfo@CE.org</a>로 연락하십시오.
