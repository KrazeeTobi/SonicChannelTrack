...
<html>
<head><!-- PageID 2072 - generated by RedDot 5.6 - 5.6.1.8 - Y-9bp -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2005 International CES:&nbsp;DEMMY Awards</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/awards/2072.asp';
...
DEMMY Awards<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container2071")) { document.getElementById("fourth_row_container2071").style.display = "";}
        //-->
    </script>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue2072', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue2072', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue2072" id="leftAddedValue2072" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">DEMMY Awards<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
Get ready for the DEMMY Awards. The Consumer Electronics Association (CEA), producer of the International CES,&nbsp;is reaching out to audio-video professionals who use sound demonstrations to help consumers invest in the best possible choice of audio equipment.&nbsp;<BR><BR>Which materials help most effectively convey the quality of performance of an overall system? What materials elicit the 'Wow!' reactions from customers? The 2005 DEMMY Awards will tell us all.
<P><STRONG>CEA will start accepting nominations for this new awards program at the 2005 International CES. </STRONG>Look for the DEMMY&nbsp;Awards signs at select&nbsp;exhibits at the&nbsp;<A href="/attendees/show_floor/areas/alexis_park.asp">Alexis Park</A>.&nbsp;The 2005 DEMMY Awards will recognize recordings that reflect the highest quality of sound engineering, incorporate natural tonal balance, great clarity of detail, and have a realistic, three-dimensional soundstage.</P>Selection categories include: 
<UL>
<LI>Best CD track </LI>
<LI>Best LP track </LI>
<LI>Best high-resolution two-channel track </LI>
<LI>Best high-resolution multi-channel track </LI>
<LI>Best segment of a DVD as a movie </LI>
<LI>Best segment of a DVD as a music video or concert<BR></LI></UL>
<P>Visit&nbsp;<A href="http://www.ce.org/DEMMYAwards" target=_blank>www.CE.org/DEMMYAwards</A> for more information.</P>
</span>
