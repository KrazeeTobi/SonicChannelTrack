...
<html>
<head><!-- PageID 1696 - generated by RedDot 5.6 - 5.6.0.31 - Y-9bp -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2005 International CES:&nbsp;by Facility</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/conferences/search/search_by_facility.asp';
...
<div>
<form action="/attendees/conferences/search/session_by_facility_list.asp" method=post><table cellpadding=3 cellspacing=1 border=0><tr><td><span class='subhead'>Choose a facility from the drop-down list.</span></td></tr><tr height=7><td></td></tr><tr><td colspan=1><select class=formdata name=faevfacility><option value=0>Choose a Facility&nbsp;&nbsp;<option value="Gold Exhibits @ LVCC">Gold Exhibits @ LVCC<option value="North Hall">North Hall<option value="Renaissance Las Vegas Hotel">Renaissance Las Vegas Hotel<option value="Riviera Convention Center">Riviera Convention Center<option value="South Hall">South Hall</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
</div>
