...
<TITLE>2005 International CES:&nbsp;Innovation 2005 Awards Online Judging</TITLE>
...
//function CheckFields(){
	...
	//Category Check
//	var i
//	var checkStr = frm_category.rdo_category[].value
	
//	for (i = 0;  i < checkStr.length;  i++)
//	if(document.frm_category.rdo_category[i].checked == false){
...
<tr>
	...
	<strong>The username/password combination you have entered does not exist.<br><br>
	Please use your browser's <i>BACK</i> button to re-enter a valid username and password.</strong>
