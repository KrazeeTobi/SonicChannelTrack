...
<span class="text">
Locate registration, shuttle bus routes, parking and much more. <A href="/print/docs/LocationMap9_29.pdf" target=_blank>Download and print an Adobe PDF version</A> of the 2005 International CES Location map and bring it with you to the show.
<P align=center><A href="/print/docs/LocationMap9_29.pdf" target=_blank><IMG height=334 src="/print/images/general/LocationMap9_29.jpg" width=500 border=1></A></P>
</span>
<!-- text for main page -->
</div>
