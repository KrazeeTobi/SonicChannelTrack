...
<html>
<head><!-- PageID 308 - generated by RedDot 5.6 - 5.6.0.31 - Y-9bp -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2005 International CES:&nbsp;Exhibitors by Geographic Area Search Results</title>
...
<script language="javascript">
    ...
    var thisPageUrl='/attendees/directory/rd_geographic_location_search_results.asp';
        ...
        var parentLinks=new Array('dummy','/attendees/default.htm','/attendees/directory/default.asp','/attendees/directory/rd_geographic_location.asp');
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue308', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue308', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue308" id="leftAddedValue308" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
