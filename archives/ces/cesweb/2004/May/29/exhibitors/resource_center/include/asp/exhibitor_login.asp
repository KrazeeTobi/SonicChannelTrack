...
<head>
	...
	<title>2004 International CES:&nbsp;Exhibitor Login</title>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Exhibitor Login<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
...
<li><b>Insert your Exhibitor ID in the text box provided.</b>
</ol>

<FORM name="form_login" method=POST action="exhibitor_login.asp">
<img src="/global_images/spacer.gif" height="1" width="20" border="0" align="left">
<TABLE border="0" cellpadding="0" cellspacing="0">        
	...
	<tr><td height="4"><img src="/global_images/spacer.gif" height="6" width="1"></td></tr>
	...
	<tr><td colspan="2"><img src="/global_images/spacer.gif" height="4" width="0"></td></tr>
	...
	<tr><td colspan="2"><img src="/global_images/spacer.gif" height="6" width="1"></td></tr>
	
	<TR>
		<TD></td>
		<td><input type=submit value=Login id=submit1 name=submit1 disabled="true"></TD>
	</TR>  
	<tr><td colspan="2"><img src="/global_images/spacer.gif" height="4" width="1"></td></tr>   
	
	<tr>
		<td colspan="2"><img src="/global_images/spacer.gif" height="1" width="74">
			<input type="checkbox" name="noIDbox" disabled="true" onClick="passwordUnknown(form_login.ExhibitorName.value);">Don't know your Exhibitor ID? Select here, and we'll e-mail it to you.
		</td>
	</tr>    
</TABLE>
</FORM>
