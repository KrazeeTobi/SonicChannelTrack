...
<head><!-- PageID 4291 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
...
<link type="text/css" rel="stylesheet" href="css/em_styles.css" />
...
<script type="text/javascript">
    ...
    self.setTimeout('closeSWF()', 15000);
    function closeSWF(){
    //alert("close");
        $.fancybox.close(); 
    }
</script>
<!-- <script src="/EM/EM/js/jquery-1.1.3.1.pack.js" type="text/javascript"></script> -->
<script src="/EM/EM/js/jquery.history_remote.pack.js" type="text/javascript"></script>
<script src="/EM/EM/js/jquery.tabs.pack.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function() {
...
<body class="home" id="home" onload="javascript:showPopup();">
   <div id="newwrap">
        <div id="container">
    ...
    <div id="ctacontainer">
        ...
        <div id="register"><a href="pre-reg.html" title="Register"><img src="/images/framework/cesweb_register1.png" alt="Register" name="cesweb_register" onMouseOver="over(8)" onMouseOut="out(8)" /></a></div>
	...
	<div id="container-home">
    	<!-- <div id="page-bottom"> -->
            ...
            <div id="em_header">
                ...
                <img src="images/em_masthead.png" alt="ENTERTAINMENT MATTERS" width="940" height="112" />
                </a>
            </div><!-- END: MASTHEAD -->
                
                <!-- BEGIN: LEFT SIDEBAR -->
                <div class="left">
                	<a href="http://www.variety.com" target=_blank><img src="images/variety-logo.gif" alt="SPONSORED BY VARIETY" width="119" height="72" border=0 /></a>&nbsp;<a href="http://www.mycricket.com" target=_blank><img src="images/cricket-logo.gif" alt="SPONSORED BY CRICKET" border=0 width="110" height="65" /></a>
                    
                    <!-- BEGIN: DROPDOWN NAV -->
                    <div id="main_nav">
                        <ul id="menu">
                            <li>
                                <a href="floor.html" class="floor" title="ON THE FLOOR"></a>
                            </li>
                            
                            <li>
                                <a href="events.html" class="events" title="EVENTS"></a>
                            </li>
                            <li>
                            	<a href="conference-programs.html" class="conference" title="CONFERENCE PROGRAMS"></a>
                            </li>
                            <li>
                            	<a href="multimedia.html" class="multimedia" title="MULTIMEDIA"></a>
                            </li>
                            
                            <li>
                            	<a  href="red-carpet.html" class="red" title="RED CARPET"></a>
                            </li>
                            <li>
                            	<a href="hollywood-assistants.html" class="hollywood" title="HOLLYWOOD ASSISTANTS"></a>
                            </li>
                        </ul>
                    </div> <!-- END: DROPDOWN NAV -->
                    
                    <!-- BEGIN: REGISTER NOW BUTTON -->
                    <div id="home_registerNow">
                    	<a href="pre-reg.html" title="Register">
                        </a>
                    </div><!-- END: REGISTER NOW BUTTON -->
                    
                    <!-- BEGIN: LEFT SIDEBAR SOCIAL -->
                    <div id="sidebar_social">
                    	<a href="http://www.facebook.com/EMatCES" title="facebook" target="_blank">
                        <img src="images/social_facebook.png" alt="facebook" width="40" height="29" />
                        </a>
                        <a href="http://twitter.com/IntlCES   " title="twitter" target="_blank">
                        <img src="images/social_twitter.png" alt="twitter" width="36" height="29" />
                        </a>
                        <a href="http://www.linkedin.com/groups?home=&gid=2183410&trk=anet_ug_hm" title="Linked In" target="_blank">
                        <img src="images/social_linkedin.png" alt="Linked In" width="36" height="29" />
                        </a>
                        <a href="http://www.flickr.com/photos/21045961@N03/" title="flickr" target="_blank">
                        <img src="images/social_flickr.png" alt="flickr" width="37" height="29" />
                        </a>
                        <a href="http://www.youtube.com/cesonthetube" title="You Tube" target="_blank">
                        <img src="images/social_youtube.png" alt="You Tube" width="33" height="29" style="float:left;clear:none;" />
                        </a>
                ...
                <div class="right">
                    ...
                    <div id="em_slideshow" >
                        ...
                        <div class="em_anythingSlider">
        					<div class="wrapper">
                                <ul>
                                    <li>
                                        <img src="images/slideshow_01.jpg">
                                    </li>
                                    <li>
                                       <img src="images/slideshow_02.jpg">
                                    </li>
                                    <li>
                                      <img src="images/slideshow_03.jpg">
                                    </li>
                                    <li>
                                        <img src="images/slideshow_04.jpg">
                                    </li>
                                    <li>
                                       <img src="images/slideshow_05.jpg">
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div id="tab_container">
                       <div id="container-4">
                           <ul class="tabs">
                               <li id="why_em_matters">          
                                   <a href="#fragment-10">
                                   <img src="images/tab_why.png" alt="" width="309" height="28" />
                                   </a>
                               </li>
                               <!-- <li>
                               	   <a href="#fragment-11">
                           ...
                           <div id="fragment-10">
                                <p>
                                    Entertainment Matters, sponsored by <i>Variety</i> and Cricket, is the new <A href="http://www.cesweb.org/" target=_blank>International CES®</A> program developed to help entertainment professionals navigate the largest, most influential technology show in the world, through <a href="floor.html">exhibits</a>, <a href="conference-programs.html">conference programs</a> and <a href="events.html">events</a> critical to the Hollywood community. 
                                    <br /><br />
                                    It's your connection to lucrative partnerships and groundbreaking innovations at the world's most influential technology event. 
                                    <br /><br />                                    
                                    <ul class="em_logo">
                                        ...
                                        <li>Participate in conference programs that reveal key industry trends.</li>
                                         <li>And so much more.</li>
                                    </ul>
                                    <br />
                                    <h3>Entertainment Matters Digital Content SmartBrief </h3>
Stay on top of the digital entertainment industry with CES' <A href="content-brief.html">Entertainment Matters Digital Content SmartBrief</A>, bringing you the digital content news that really matters. Knowledgeable editors handpick key articles from hundreds of publications, summarize them and provide direct links to the original sources.
    ...
    <a id="jump" href="101577_entertainmentMatters_jumpPage_v1.swf"></a>
<!--/EM/EM-register.asp-->
