...
<head><!-- PageID 1131 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Voyage et visa</title>
    ...
    <div class="right-blue-box-blue-interior">
        <ul>
            ...
            <li><a href="/international/korean/travel.asp">한국어</a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/french.asp" class="footer">Français</a>&nbsp;&gt;&nbsp;Voyage et visa</div>
                        </div>
                        <div class="headerbox">
...
<P><STRONG>Vous avez besoin d’aide ? <BR></STRONG><A href="/docs/French_FR_6443_2K11VisaTips_Press_Ready.pdf" target=_blank>Téléchargez notre fiche de conseils pour les visas</A>, qui contient des instructions détaillées, les adresses de sites web importants et d’autres informations destinées à faciliter votre demande de visa.<BR><BR>
...
<TR>
<TD>
<H3>Avis important pour les participants qui voyagent en vertu du Visa Waiver Program</H3>Depuis le 8 septembre 2010, toutes les demandes d’enregistrement au Electronic System for Travel Authorization (ESTA) ou les renouvellements le jour même ou après cette date devront être accompagnées d’un paiement pour des frais de 14 $ par carte de crédit ou de débit. Les enregistrements actuels au ESTA resteront valides jusqu’à leur date d’échéance. Pour obtenir de plus amples renseignements, cliquez sur le lien suivant <A href="http://cbp.gov/xp/cgov/travel/id_visa/esta/" target=_blank>consultez la page de l’ESTA sur le site Web du Département de la Sécurité intérieure, des Douanes et de la Protection des frontières.</A></A></TD></TR></TBODY></TABLE></P>
<H2>Voyage</H2>
