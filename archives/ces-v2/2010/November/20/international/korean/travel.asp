...
<head><!-- PageID 1156 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: 여행 및 비자 안내</title>
    ...
    <div class="right-blue-box-blue-interior">
        <ul>
            ...
            <li><a href="/international/korean/travel.asp">한국어</a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/korean.asp" class="footer">한국어 </a>&nbsp;&gt;&nbsp;여행 및 비자 안내</div>
                        </div>
                        <div class="headerbox">
                       <h1>여행 및 비자 안내</h1>
                            <div class="icon_wrap">
...
<DT target="_blank">
<P><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: "><SPAN class=subhead><STRONG><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">비자가</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">필요하십니까</SPAN></SPAN><SPAN class=text1><SPAN>?</SPAN></SPAN></STRONG></SPAN></SPAN></SPAN><SPAN class=text1><SPAN><BR></SPAN></SPAN><A href="https://ceac.state.gov/genniv/"><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">이제</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">비자</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">신청서를</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">온라인으로</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">접수시킬</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">수</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">있습니다</SPAN></SPAN></A><SPAN class=text1><SPAN><A href="https://ceac.state.gov/genniv/">. </A><BR><BR></SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: "><SPAN class=subhead><SPAN class=text1><STRONG><SPAN lang=KO style="FONT-FAMILY: ">도움이</SPAN><SPAN lang=KO> </SPAN></STRONG></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: "><STRONG>필요하십니까</STRONG></SPAN><SPAN><STRONG>?</STRONG><BR></SPAN></SPAN></SPAN></SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">단계별</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">설명을</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">제공하는</SPAN><SPAN lang=KO> </SPAN></SPAN><A href="/docs/Korean_KO_6443_2K11VisaTips_Press_Ready.pdf" target=_blank><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">비자</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">안내서</SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">를</SPAN><SPAN lang=KO> </SPAN></SPAN></A><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">다운로드</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">하십시오</SPAN><SPAN>.&nbsp; </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">비자</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">신청</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">절차에</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">대한</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">웹사이트</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">주소와</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">각종</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">정보가</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">제공됩니다</SPAN><SPAN>.</SPAN></SPAN><BR><BR>
...
<TR>
<TD>
<H3>비자 면제 프로그램으로 여행하시는 참가자 여러분들을 위한 중요한 정보</H3>2010년 9월 8일부터, 전자여행 허가 (ESTA)등록 신청 또는 갱신을 위한 모든 전자 시스템을 이용하시려면 신용카드나 현금카드로 $14의 사용료를 지불하셔야 합니다. 기존의 전자여행허가 (ESTA)는 만료일까지 유효합니다. 더 자세한 정보를 원하시면&nbsp; <A href="http://cbp.gov/xp/cgov/travel/id_visa/esta/" target=_blank>국토 안보부 (Department of Homeland Security)의 관세 및 국경 보안청 (Customs and Border Protection) 웹사이트에 있는 전자여행허가 (ESTA) 웹페이지를 방문하십시오</A>.</A></TD></TR></TBODY></TABLE><BR></P>
