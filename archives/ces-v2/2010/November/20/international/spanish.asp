...
<head><!-- PageID 1110 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
...
<div class="right-blue-box" align="center">
    ...
    <div>
        ...
        <br /><br />
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;Español</div>
                        </div>
                        <div class="headerbox">
                       <h1>Español</h1>
                            <div class="icon_wrap">
...
<H3>Forje conexiones internacionales y potencial</H3>Se espera que más de 120,000 concurrentes provenientes de más de 130 países asistirán a CES – el punto de lanzamiento de tecnologías nuevas. Con más de 2,500 expositores que darán a conocer más de 20,000 productos nuevos, CES se perfila como los cuatros días más emocionantes del año para la industria de productos electrónicos de consumo.&nbsp;<A href="/register">Inscríbase ahora mismo.</A><BR><BR><IMG align=middle src="/images/photos/International_Horizontal_1.jpg" width=480 height=162><BR><BR>
<H3>CES: Tecnología y educación</H3>CES significa más que sólo un despliegue de tecnología innovadora. <A href="/conferenceProgram/default.asp">El programa de conferencias de CES</A> comprende más de 300 sesiones que abarcan todas las facetas de la industria de la electrónica de consumo. Además, las ponencias SuperSessions, que siempre son gratuitas, le brindan la oportunidad de educarse sobre una variedad de tendencias dentro de una amplia gama de mercados.<BR>
<A href="/events/keynotes.asp">La lista de oradores principales </A>de este año incluye a Steve Ballmer de Microsoft, Ivan Seidenberg de Verizon, Rupert Stadler de Audi, Boo-Keun Yoon de Samsung, y Allan Mullaly de Ford. La participación en SuperSessions y discursos de oradores principales es gratuita con su pase “Exhibits Plus”, y no es necesario inscribirse de antemano para participar. No obstante, llegue temprano ya que el espacio es limitado. Todos los discursos principales se interpretarán a Chino, Coreano y Japonés. <BR>
...
<A href="http://cesweb.org/international/spanish/travel.asp">Información sobre traslado y visas</A><BR>Use esta útil información a medida que viaje hacia o de regreso de Estados Unidos.<BR><BR><A >Programa de grupos de delegaciones<BR></A>La Exposición Internacional CES atrae a una enorme audiencia internacional por su programa de delegaciones exitoso. Aprenda cómo organizar una delegación en su país o región o cómo sumarse a una.
...
<P><A href="/docs/Spanish_6673_2011CESfacts_SP_PRESS_READY.pdf" target=_blank>Información general (pdf)<BR></A>¡Aprenda sobre la historia de la exposición, las categorías actuales de productos, las próximas fechas y mucho más en su idioma! </P>    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/international/spanish.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
