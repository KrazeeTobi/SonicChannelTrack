...
<div class="right-blue-box" align="center">
    ...
    <div>
        <UL>
<LI><A href="/docs/Interim_Brochure(4).pdf" target=_blank>英語版総合パンフレット（PDF）</A> </LI>
<LI><A href="/docs/Japanese_6673_2011CESfacts_JPN_PRESS_READY.pdf" target=_blank>日本語版CESファクトシート（PDF） </A></LI>
<LI><A href="/docs/2011_DL_Program_Description(4).pdf" target=_blank>代表団リーダーと代表者の特典（英語版PDF）</A></LI></UL>
    </div>
</div>
                        </div>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/japanese.asp" class="footer">日本語</a>&nbsp;&gt;&nbsp;代表団プログラム</div>
                        </div>
                        <div class="headerbox">
                       <h1>代表団プログラム</h1>
                            <div class="icon_wrap">
