    ...
    <div class="right-blue-box-blue-interior">
        <ul>
            ...
            <li><a href="/international/korean/travel.asp">한국어</a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/chinese.asp" class="footer">汉语</a>&nbsp;&gt;&nbsp;旅行和签证信息</div>
                        </div>
                        <div class="headerbox">
                       <h1>旅行和签证信息</h1>
                            <div class="icon_wrap">
...
<SPAN class=text><STRONG><SPAN class=subhead>您需要签证吗？</SPAN><BR></STRONG><A href="https://ceac.state.gov/genniv/ " target=_blank>现在您可以上网填写签证申请表 。</A> <BR><BR><SPAN class=subhead><STRONG>需要帮助吗？<BR></STRONG></SPAN>有关按部就班的说明、网站地址和使您成功通过签证申请程序的其他信息，请下载 <A href="/docs/6680_ChineseVisaTip6.9.pdf" target=_blank>Visa Tip Sheet&nbsp; （签证提示单）。<BR></A></SPAN><BR>
...
<TR>
<TD>
<H3>对于根据免签证计划旅行的参加者之重要通知</H3>2010年9月8日当日或以后，所有旅游授权电子系统 (ESTA) 的登记申请或换新件，需以信用卡或借记卡方式支付14美元。该规定自2010年9月8日起生效。现有ESTA 登记至其逾期日之前仍旧有效。有关详情请 <A href="http://cbp.gov/xp/cgov/travel/id_visa/esta/" target=_blank>访问美国国土安全部海关与边境保护局网站上的 ESTA 网页</A>。</A></TD></TR></TBODY></TABLE><BR>
