...
<head><!-- PageID 648 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Direct Mail/Online Ads</title>
...
<br />Communicate with CES attendees through full, dedicated HTML e-mail blasts. These blasts are created entirely by you and will be sent out directly by CES on your behalf. Through each e-mail blast, you will have the opportunity to reach more than 200,000 readers including 2011 CES pre-registrants, 2010 verified attendees, prospects, international attendees, VIP buyers and more. <BR><BR><A href="/docs/2011_CES_Attendee_EDM_Opportunities_Flyer.pdf" target=_blank>Download the flyer for more information and drop date options. </A><BR><BR><STRONG>Marketing Investment</STRONG><BR>$15,000+<BR><BR><STRONG>Restrictions</STRONG>:<BR>
<UL>
