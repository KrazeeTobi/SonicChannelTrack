...
<head><!-- PageID 3894 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Hot Topics</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/exhibitors/default.asp-->
            ...
            <li class="selected"><a href="/exhibitors/showPlanning/hot-topics.asp">Hot Topics</a></li>
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/showPlanning/default.asp" class="footer">Show Planning</a>&nbsp;&gt;&nbsp;Hot Topics</div>
                        </div>
                        <div class="headerbox">
                       <h1>Hot Topics</h1>
                            <div class="icon_wrap">
...
<div class="page_header_block">
    <div class="blue_box">
        ...
        <li><a href="#4555">GES Workshops - Sign up now!</a></li><!---->
        
        <li><a href="#4493">International CES Exhibitor Video Portal - Powered by Origin Digital</a></li><!---->
        
            </ul>
        
            <ul>
        
        <li><a href="#4402">New! Important EAC Information</a></li><!---->
        
        <li><a href="#4126">Exhibitor's Source Newsletter Operations Content</a></li><!---->
        
            </ul>
        
            <ul>
        
        <li><a href="#3966">Budgeting and Cost Savings at CES</a></li><!---->
        
        <li><a href="#3968">Show Planning</a></li><!---->
...
<div class="sponsorshipTitle">GES Workshops - Sign up now!</div>
<br />On behalf of our general service contractor Global Experience Specialist (GES), we would like to invite you to participate in GES sponsored exhibitor webinar for the upcoming 2011 International CES. Please share this and invite all of your colleagues involved in planning and managing your CES presence.<BR>&nbsp;<BR><STRONG>GES is offering two webinars:<BR><BR>CES Strategy<BR>Wednesday, November 17 at 1 p.m. CST<BR></STRONG>This session will help you develop specific and actionable objectives for CES 2011, confirm your target audience and define the key activities and messages to attract, engage, and deliver a memorable and meaningful experience.
<P><STRONG>CES Planning and Execution, Thursday<BR>November 18 at 1 p.m. CST<BR></STRONG>This session will focus on how to optimize your spend through better planning, product and service ordering, and taking advantage of discount deadlines and other “tricks of the trade.”</P>
<P>Participation in the CES Workshops is free of charge, and we invite everyone to participate in order to make the most of your CES participation.<BR>&nbsp;<BR>R.S.V.P.: Please send an e-mail to <A href="mailto:srosenow@ges.com">srosenow@ges.com</A>. We will e-mail instructions to access the workshop online.</P>
...
<div class="sponsorshipTitle">International CES Exhibitor Video Portal - Powered by Origin Digital</div>
<br />CES and Origin Digital present ConventionTV, an online branded channel with the capability of showcasing real-time, online exhibitor experiences such as live entertainment straight from the show floor. Until now, users have associated tradeshows with a virtual, cartoon-like online environment, an experience clearly lacking the effectiveness required for major conferences like CES. <BR><BR>For 2011, CES has taken on an entirely new approach for its upcoming show.&nbsp;Origin Digital gives CES Exhibitors the capability of creating an innovative online series. CES exhibitors can now make the most of their marketing investment by showcasing their new <BR>products and driving their business to the next level. To find out how Origin Digital can assist you with extending your three-day presence to a global audience, contact Origin Digital’s Brendon Winters at <A href="mailto:bwinters@origindigital.com">bwinters@origindigital.com</A><BR><BR>Check out the <A href="http://cesportal.odaptor.com/" target==_blank>CES Operations Video Portal </A>to learn tips and tricks of the 2011 CES and for a sneak preview of Origin Digital's portal.
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sponsorshipTitle">New! Important EAC Information</div>
<br />Effective November 1, 2010, the Las Vegas Convention and Visitors Authority (LVCVA) requires the ESCA Exhibition Industry Worker Identification System (WIS) badge in order to gain access to their facilities. The new ID badge system allows the LVCC to improve security of their facilites and closely monitor access. It ensures that proper review of all staffing is established and monitored each day. All contractors, suppliers, and vendors who work in the LVCC must now be indentified with the WIS badge. <BR><BR>Companies can go to <A href="http://www.ESCA.org">www.ESCA.org</A> for a complete overview of the process invovled in registering for the badges. On the site, look for the WIS login page or go to <A href="http://www.workeridbadge.com/admin/home">www.workeridbadge.com/admin/home</A>. Each company will need to name a staff member as administrator who will be responsible for editing the badge records of all employees. If you need any further information on registering, please contact:
<P>Mitt Amaudet<BR>WIS National Administrator<BR>ESCA Member Services Director<BR>469-574-0694<BR><A href="mailto:mitt@esca.org">mitt@esca.org</A><BR><BR>EACs will not be permitted to work in the building without the WIS badge. At this time, only trade union workers are exempt from needing&nbsp;a ESCA&nbsp;WIS badge. <BR></P>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sponsorshipTitle">Exhibitor's Source Newsletter Operations Content</div>
<br />Haven't received the&nbsp;latest&nbsp;Exhibitor's Source Newsletter? You can access all our latest and archived <A href="/exhibitors/newsletter/default.asp">newsletters</A> anytime on our website.
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sponsorshipTitle">Budgeting and Cost Savings at CES</div>
<br />In an effort to help you make the most of your budget, we have provided you with some cost-saving tips for the 2011 CES.&nbsp; &nbsp;<BR><BR><STRONG>Need tips and ideas for saving money and slashing your tradeshow budget?</STRONG> <A href="http://www.exhibitoronline.com/exhibitormagazine/feb10/all-star-awards-wacker-chemical-corp.asp" target==_blank>Check out this article</A> from Exhibitor Magazine about how one Event and Tradeshow Coordinator saved more than $57k and still generated hundreds of leads. <BR><BR><STRONG></STRONG><STRONG>GES Holds Pricing...Again!</STRONG><BR>We are excited to announce that GES, our official services contractor, will once again hold exhibitor show pricing for the 2011 International CES. Everything that you order through GES will be the same price as last year – or in some cases even lower. This includes everything from material handling, labor, and electrical to furniture, carpet and graphics. GES has now held their pricing for a second year in a row to show how much they care about your business and your budgets, and we hope this especially helps as you plan for 2011.<BR><STRONG><BR>Pay on time, and save big.</STRONG><BR>Advance pricing is 30 percent cheaper than ordering after the deadline in most cases (even more for on-site orders). Only 51 percent of CES exhibitors take advantage of advance pricing, which means most of you pay 30-50 percent or more than necessary. Look for the deadline checklist on this page next month. You can even import deadlines into your Outlook calendar.<BR><BR><STRONG>Know your targeted freight move-in and move-out dates</STRONG> so you can schedule your shipments and plan labor accordingly. <A href="http://www.cesweb.org/manual" target=_blank>CES target freight floor plans</A>&nbsp;are available now so click on the map that corresponds with your hall or venue. Contact <STRONG><A href="mailto: kswearingen@ce.org">Katie Swearingen</A></STRONG> at 703-907-7637 with any questions. 
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sponsorshipTitle">Show Planning</div>
<br /><B>2011 CES show schedule<BR></B>Please note that the 2011 CES show dates are Thursday, January 6 – Sunday, January 9, 2011. We will once again be dark on January 1, which means no exhibitor activity in the hall. December 31 will be a half day with labor calls ending at 12 noon and the premises clear by 2 p.m. at the latest. Please keep these dates in mind as you begin planning and budgeting for CES.<BR><BR><B>Request your room block – 10-20 rooms or more!<BR></B>Attention CES Exhibitors: It’s time to book your Las Vegas hotels for the 2011 International CES.<BR><BR>Get a head start on CES room rates from preferred properties before we offer these discounted rates to the more than 120,000 consumer technology professionals who attend CES to investigate new products hitting the market like yours! <A href="http://www.cesweb.org/hotelTravel/hotel.asp">Request your room block</A> now to ensure your entire booth staff is able to stay at the same property. <A href="http://www.cesweb.org/hotelTravel/blockRequest.asp" target==_blank>Request your block now</A> to get your first pick and to avoid “sold out” signs.<BR><BR><B>Money-Saving Tips</B><BR>CES offers complimentary shuttle service to each CES venue from all official CES hotels. Book with one of these hotels to avoid cab fare or other shuttle costs. That’s savings! <BR><BR>We continue to work with Las Vegas properties to provide you with additional hotel options at fair rates. As hotels are confirmed, the list will be updated. Should you have any questions, please contact <A href="mailto:CEShotels@CE.org">CEShotels@CE.org</A>.nbsp;You can also book individual rooms through CESweb.org.
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibitors/showPlanning/hot-topics.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
