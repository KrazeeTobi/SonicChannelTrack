...
<div class="page_header_block">
    <div class="blue_box">
        ...
        <li><a href="#4403">Go Green at CES</a></li><!---->
...
<br /><STRONG>GES’ New Customer Service Guarantee <BR><BR></STRONG>Global Experience Specialists (GES) is pleased to introduce its Customer Service Guarantee, the first program of its kind in the tradeshow industry. Your order will be delivered on time and to your satisfaction or it’s free. GES looks forward to exceeding your expectations at the 2011 CES! Check back here in the next couple of weeks&nbsp;for more information on this program.<BR><BR>In the meantime, <A href="http://cesportal.odaptor.com/" target==_blank>see the latest GES video, and meet your GES team for the 2011 International CES!</A>&nbsp; 
...
<div class="sponsorshipTitle">Go Green at CES</div>
<br /><STRONG>Go Green with your CES Exhibit! Join in on the Greenest Trade Show in North America! <BR></STRONG>GES, in partnership with CEA, continue to partner in driving green initiatives that recognize International CES as the greenest trade show in North America.&nbsp; Let us transform your exhibit with sustainable materials to create a great look while using recyclable materials. <BR><BR>GES’ Sustainable Exhibit offers the customer an option to&nbsp;<A href="http://ges.com/ecomm/2011/q1/11-05117/pdf/Full-ESM%20104.pdf">rent an eco-friendly booth package.</A> <BR><BR><STRONG>GES’ GREEN INITIATIVES<BR></STRONG>At GES, we understand the significance of doing whatever is possible to not only preserve our environment, but to improve it. This begins with educating our employees and clients, having a global vision and mobilizing our collective efforts to meet this commitment.&nbsp; Over the years, our organization has set itself apart as an environmentally responsible industry leader, doing our part in making this planet a more beautiful and resourceful place to live.&nbsp; 
<P><STRONG>Our Green Exhibition Products:</STRONG></P>
<UL class=text>
<LI class=text>We offer a selection of carpets that contain 25% post industrial recycled content and that are 100% recyclable </LI>
<LI class=text>100% recyclable carpet padding </LI>
<LI class=text>Biodegradable trash bags and waste baskets made from 100% recycled content </LI>
<LI class=text>Using electronic distribution for our show’s exhibitor manuals rather than paper </LI>
<LI class=text><A href="http://3e.ges.com/pdf/Flooring_Options.pdf">Eco friendly carpet</A> </LI></UL>
<P><STRONG>Our Green Operational Efforts:</STRONG></P>
<UL class=text>
<LI class=text>Recycling carpet and padding </LI>
<LI class=text>Utilizing energy efficient lighting </LI>
<LI class=text>Recycling paper and ink cartridges from printers </LI>
<LI class=text>Purchasing recycled paper and signage products </LI>
<LI class=text>Recycling steel and aluminum exhibit structures </LI>
<LI class=text>Retreading tires on our trucks </LI></UL>
<P><STRONG>Helping Green Your Meeting<BR></STRONG>The GES team is also focusing on a number of additional reduce, re-use and recycle efforts in combination with other conservation initiatives. In order to help you here is a convenient check list for your event.</P>
<UL class=text>
<LI class=text>Confirm empty cardboard boxes can be set aside for pick up </LI>
<LI class=text>Place cans and bottles in recycling bins </LI>
<LI class=text>Label unwanted show literature for recycling </LI>
<LI class=text>Use “Green” aisle carpeting </LI>
<LI class=text>Encourage vendors to purchase greener products </LI>
<LI class=text>Help conserve energy by limiting full light activities </LI>
<LI class=text>Minimize use of heating and air conditioning </LI></UL>
<P>We invite you to begin a dialogue with us on a multitude of other efforts we can work on as a team to support sustainability for your CES exhibit booth or meeting room.</P>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>    
