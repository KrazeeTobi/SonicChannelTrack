...
Eighty-five percent of all CES exhibitors cite press/media coverage as one of the most important reasons for attending the show. It's easy to see why PR is oftentimes the highest priority for exhibitors at the International CES. The more than 5,000 media and bloggers who cover CES each year are able to get a company's name into the minds of millions of consumers with the simple stroke of a keyboard. Let us help you reach the media.<BR><BR>
...
<P>The International CES press kit area is going green! To reduce our environmental footprint and in accordance with media feedback, the LVCC press room will only house electronic exhibitor press kits. If you are a 2011 CES exhibitor, you&nbsp;are welcome to bring in a one-page spec sheet that lists media contacts and the URL that houses the electronic press kit.&nbsp;You can also bring in USB drives and CDs. Printed press materials greater than one page in length should be stored in your booth.&nbsp;</P></TD></TR></TBODY></TABLE><BR>
<H3><A href="/exhibitors/pr/exhibitorPRnl-Nov.asp">Exhibitor PR Newsletter</A></H3>This monthly newsletter helps you keep your public relations efforts in check with valuable tips, deadline reminders and breaking news.<BR><BR>
<H3><A href="/exhibitors/pr/prList.asp">Pre-Registered Media/Industry Analyst List</A></H3><STRONG>Login required<BR></STRONG>View a list of media and industry analysts who are pre-registered for the 2011 International CES and the CES Unveiled pre-CES press events.&nbsp; <BR><BR><BR>
<TABLE style="BORDER-BOTTOM: #9f9f9f 1px solid; BORDER-LEFT: #9f9f9f 1px solid; BORDER-TOP: #9f9f9f 1px solid; BORDER-RIGHT: #9f9f9f 1px solid" border=0 cellPadding=8 width="100%">
<TBODY>
<TR>
