...
<head><!-- PageID 332 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: For Exhibitors</title>
...
<div class="right-blue-box" align="center">
    <div class="right-blue-box-header">2011 CES: Show Hours</div>
    
    <div>
        Thursday, Jan. 6: 10 a.m.-6 p.m.<BR>Friday, Jan. 7: 9 a.m.-6 p.m.<BR>Saturday, Jan. 8: 9 a.m.-6 p.m.<BR>Sunday, Jan. 9: 9 a.m.-4 p.m.<BR><BR><A href="http://cesweb.org/aboutces.asp#740">See future show dates.</A>
    </div>
</div>
<div class="right-box-no-border" align="center">
    
    <br/><A href="http://www.dealerscope.com/promo/ces_2011_promo.pdf?" target=_blank><IMG border=0 src="/images/content/Dealerscope_Ad_CES_200x200.gif" width=200 height=200></A>
</div>
<div class="right-box-no-border" align="center">
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <UL class=blue_box>
<LI class=blue_box><A href="/exhibitors/newsletter/aug10.asp">
<DIV class=sub-content-header>Mark Your Calendars – 2011 Exhibitor Workshop is Coming!</DIV></A>&nbsp;</LI></UL>Find this story and more in this month's <A href="/exhibitors/newsletter/aug10.asp">Exhibitor's Source newsletter.<BR></A><BR>
    </div>
</div>
...
<TD vAlign=top>
<UL>
<LI class=text>Add workshop webcasts to your calendar </LI>
<LI class=text>Get a space contract </LI>
<LI class=text>Compare industry shows for value,&nbsp;price </LI>
<LI class=text>Ask veteran exhibitors advice</LI></UL>
<P class=text><STRONG>Maximize-your-marketing budget idea:<BR><A href="http://cesweb.org/exhibitors/sponsorships/pressOpportunitites.asp#824">Exhibit&nbsp;at the CES New York Press Preview.</A></STRONG></P></TD>
<TD>&nbsp;</TD>
<TD vAlign=top>
<UL>
<LI class=text>Reach 5,000+ media and bloggers </LI>
<LI class=text>Meet key retailers </LI>
<LI class=text>Network among more than 120,000 CE&nbsp;professionals </LI>
...
<div class="sub-content-header">Enter the Exhibitor Video Contest - Deadline Extended!</div>
<br />

<IMG hspace=5 align=right src="/images/photos/ContestPage.jpg" width=200 height=202>There’s still time to enter the 2011 International CES “Visit Me at CES” exhibitor video competition. Create an up to one minute long video that lets attendees know why they should visit your booth at CES. <BR><BR>The deadline to submit your entry is now <STRONG>midnight November 9 (P.T.)</STRONG>.

<P>Voting will be open to the general public and the top five videos that receive the most votes will be featured on CESweb.org for the entire month of December leading up the show. Also, an announcement with the winners will be made in a CES press release. <BR><BR>Don’t miss this great opportunity to build your buzz and get people excited for the 2011 show! <A href="http://www.cesweb.org/contest" target=_blank>Enter today</A>. </P>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="3997"></a>

<div class="sub-content-header">2010 CES Attendee Audit: Numbers, Markets and More</div>
<br />

<IMG hspace=5 align=left src="/images/photos/09floor.jpg" width=190 height=127>An independent audit, performed by Veris Consulting LLC, verified all attendance and the numbers are now in! Two thousand five hundred exhibitors showcased their latest products on more than 1.4 million net square feet of exhibit space, with a total of 126,641 in attendance. 
<P>CES attracts the "who's who" of the technology and related industries, including C-level executives from the entertainment, wireless and consumer electronics industries. More than 8,000 attendees represented companies with more than $500 million in total annual sales.</P>
<P><A href="/docs/Final_Audit_Summary_-_with_TWICE.pdf" target=_blank>Download your copy of the 2010 Audit Summary now!</A></P>
<P><STRONG>Snapshot: 2010 International CES Attendees</STRONG> <BR>
...
<LI class=text>Total: 126,641 
<UL></UL></LI></UL></TD></TR></TBODY></TABLE></P>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="3819"></a>

<div class="sub-content-header">Deadline To-Do: Update Your Directory Listing</div>
<br />

<IMG hspace=5 align=right src="/images/content/MYS_Logo.jpg" width=144 height=127>New for the 2011 show, CES is partnering with Map Your Show (MYS) to provide this year's&nbsp;online <A href="/exhibitors/default.asp">Exhibitor Directory</A> and floor plan. These easy-to-use interactive applications are sure to please both exhibitors and attendees alike as they make their plans for this year’s show. <BR><BR>Don't miss out on your opportunity to get noticed! <A href="/exhibitors/cesSmartBooth/default.asp">Login to your Exhibtor Dashboard</A> today to fill out your&nbsp;company's free listing.<BR><BR>In addition to displaying basic contact and product information, exhibitors will have the opportunity to highlight their exhibitor listings with pictures, videos or even Flash presentations. Creating eye-catching presentations is a surefire way to snag the attention of attendees who will be using MyCES as they create their agendas for the 2011 show. Attendees will populate their planners with sessions they wish to attend along with, of course, a list of all their must-see exhibitors.<BR><BR>If at any time you have any questions regarding the Online Exhibitor Directory, Floor Plan or Exhibitor Dashboard, you can e-mail MYS at <A href="mailto:help@mapyourshow.com">help@mapyourshow.com</A> or give them a call at 888-527-8823.<BR><BR>    
