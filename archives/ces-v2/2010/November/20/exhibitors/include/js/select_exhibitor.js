...
function getExhibitorList(bShowBooths){
	...
	var height = 675//2 * (window.screen.height / 3);
	var width = 439;
	...
	if(bShowBooths)
		strWin = "/exhibitors/include/asp/eims_admin_exh_search.asp?booths=true";
	else
		strWin = "/exhibitors/include/asp/eims_admin_exh_search.asp?booths=false";
