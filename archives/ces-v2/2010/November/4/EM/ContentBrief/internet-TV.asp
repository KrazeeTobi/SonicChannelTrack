...
<head><!-- PageID 4447 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Way Over the Top: Internet TV Avalanche Augurs Changes in Program Packaging </title>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><!-- <img src="/images/framework/secondarynav_awards.gif" />--></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show')" class="first_link"><a href="/awards/hot-stuff.asp">Hot Stuff</a></li>
                
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards308','show')" class="link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/EM/ContentBrief/default.asp" class="footer">Content Brief</a>&nbsp;&gt;&nbsp;Way Over the Top: Internet TV Avalanche Augurs Changes in Program Packaging </div>
                        </div>
                        <div class="headerbox">
                       <h1>Way Over the Top: Internet TV Avalanche Augurs Changes in Program Packaging </h1>
                            <div class="icon_wrap">
...
By Gary Arlen<BR>October 20, 2010
<P>In an artistic timing coincidence, <A href="http://discover.sonystyle.com/internettv/#/home" target=_blank>Sony's Google TV set</A> debuted last week within days of a Federal Communications Commission's action on "video navigation devices."&nbsp; While government bureaucrats are preparing a laborious reevaluation of their "CableCARD" rules – now being called an "AllVid" proceeding – the marketplace is plunging ahead with an avalanche of Internet-connected TV sets, set-top boxes plus other gear and systems that will open up viewing options to a world as big as the Web. </P>
<P>Sony's "Internet TV" line of products, which integrates <A href="http://www.google.com/tv/" target=_blank>Google TV software</A>, appeared a few weeks after the first such device, <A href="http://www.logitech.com/en-us/smartTV?WT.mc_id=google_googletv_redirect_052010&geo=US" target=_blank>Logitech's "Revue" </A>set top box. They'll both rely on the Google TV platform, which has already snagged important programming relationships such as HBO GO (the "TV Everywhere" version of HBO for authenticated customers), content from Turner networks including TBS, TNT, CNN and Cartoon Network and from NBC-Universal plus Amazon's video-on-demand titles and Netflix content.&nbsp;&nbsp; </P>
<P>The revamped <A href="http://www.apple.com/appletv/" target=_blank>Apple TV</A> system also trickled into the market last month.&nbsp; And coming up in the weeks ahead are the <A href="http://www.boxee.tv/" target=_blank>Boxee </A>and <A href="http://sezmi.com/" target=_blank>Sezmi&nbsp; </A>systems, which will join pioneers such as Roku and TiVO in delivering a pastiche of broadcast and broadband video programming. </P>
<P>On top of all these options is an array of promising and anticipated services that will expand "over-the-top" (OTT) viewing choices. They range from Internet video services delivered through Microsoft's Xbox 360 to aggregated content (including local and network TV shows) available via the new, and controversial, <A href="http://www.ivi.tv/" target=_blank>ivi.tv </A>services and <A href="http://www.filmon.com/tv/" target=_blank>Filmon</A>.<BR><BR>And again, in keeping with the "timing is everything" mantra, the global dimensions of this OTT tsunami keep rising.&nbsp; Liberty Global, the company controlled by cable mogul John Malone, unveiled more details last week of its plan to offer an all-Internet Protocol set-top box next year in Europe. Liberty has lined up Samsung to make a home multimedia gateway and a blue-chip roster of technology partners, including Intel and the Digital Living Network Alliance (DLNA).<BR><BR><STRONG>Truly Hybrid TV <BR></STRONG>Beyond the infrastructure and distribution factors, this avalanche of Internet TV ventures augurs a massive – albeit evolutionary – shift in the media ecosystems. Today's intriguing widgets and interactive components will morph into fundamental components of the next viewing experience. To be sure, it's unlikely that linear TV viewing will disappear.&nbsp; Some of the companies – those listed above and the dozens of others that are being hatched today – may not survive, but their legacy will be the "proof of concept" they are introducing.&nbsp;&nbsp;<BR><BR>In today's "attention economy," the Internet TV ventures face hurdles ranging from consumer awareness and interest to programmers' skepticism. They also will confront legal challenges, such as the lawsuits filed against ivi.tv by broadcast networks.&nbsp;<BR><BR>Buying consumer awareness will be expensive – especially as the start-ups seek to differentiate themselves from each other and from cable TV packaging. Pricing will remain a challenge, as viewers figure out if Web á là carte fees (such as the iTunes or Netflix online video options) are preferable to a flat subscription price. Even systems – such as the connected TV sets from Sony, Samsung, Panasonic and many others – that leverage viewers' existing use of Web video will face problems.&nbsp; The rosy predictions (such as Forrester's forecast of 43 million U.S. homes with connected TV sets by 2015) confront the reality that today, fewer than one in five families that already own such a device actually use it to watch Web video or widgets. Most of them don't even know that their set can access such digital features, according to several studies.&nbsp;<BR><BR>On the other hand, a recent <A href="http://www.emarketer.com/blog/index.php/stats-33-adults-online-watch-fulllength-tv-shows" target=_blank>eMarketer study </A>found that nearly 59 million U.S. adults have watched full-length TV shows online, typically on their laptop or desktop computers or increasing on mobile handsets. Indicators suggest that 56% of online video viewers will watch such long-form shows next year – up from just 42% two years ago. One reason for that kind of growth will be the availability of living-room OTT content.&nbsp;&nbsp;&nbsp;&nbsp;<BR><BR>Hollywood and Sixth Avenue – that is the motion picture and television industry, which have a lot at stake in this OTT evolution – are showing proper concern, but also trying to secure their positions. Last month, as Apple TV and Google TV gleaned endless headlines, Marci Ryvicker, a Wells Fargo Securities analyst, listed <A href="http://www.rbr.com/tv-cable/27624.html" target=_blank>six obstacles </A>facing OTT's ambitions to displace current cable, satellite and telco-delivered TV services. She cited the bandwidth limitations (for now) for carrying high-definition TV and the contractual restrictions that existing carriers have with studios. Also on her list is sports content, which is "mostly linear" and is a major ingredient (despite its cost) on most legacy video delivery systems.&nbsp;<BR><BR>Despite these hurdles, this is obviously a critical moment in the long-promised evolution of television.&nbsp; The sheer size of the assault reinforces the inevitability of broadband TV viewing.&nbsp;<BR><BR>Next comes the real challenge: fine-tuning the programming to monetize this vast emerging platform. </P>
<HR>

<P><EM>Gary Arlen is President of Arlen Communications Inc., a Bethesda, MD, research firm; he is co-producer of <A href="http://www.cesweb.org/conferenceProgram/conference-tracks.asp#4384">Media Money Makers</A>, a conference on media monetization in the digital era, at the 2011 CES on January 6-7. </EM></P>
<P>&nbsp;</P>

    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/EM/ContentBrief/internet-TV.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
