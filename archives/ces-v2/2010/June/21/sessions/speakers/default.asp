...
Are you an expert in consumer electronics? Do you have the know-how when it comes to technology and trends? If so, we need you. The CES Call for Speakers is now open. To submit your interest, please visit the <A href="http://speaker.ce.org/index.cfm?do=cnt.page&pg=1003">Speaker Ready Room</A> management tool, and complete your submission form by 5 p.m. (EST) Wendesday, July 21.
<P>2011 International CES topics will include:</P>
<P></P>
<H3>Home Entertainment &amp; Lifestyle Technologies</H3>
<UL>
<LI class=text>In Search of TV's Next Big Thing </LI>
<LI class=text>3DTV Report Card: Next Frontier in Home En ctertainment </LI>
<LI class=text>The Great Slate Debate </LI>
<LI class=text>It's a TV. It's a Computer. No, it's a... </LI>
<LI class=text>2011: Year of the Connected Home</LI></UL>
...
<LI class=text>Predicting the Next iPod</LI></UL>
...
<LI class=text>Who Will Win the Mobile TV Race? </LI>
<LI class=text>Video Calling Gets Ready for Prime Time </LI>
<LI class=text>From Smart Phones to Smart Homes </LI>
<LI class=text>Handheld Wars: Winners</LI></UL>
<H3>Issues &amp; Attitudes</H3>
<UL class=text>
<LI class=text>Apps, Apps Everywhere </LI>
<LI class=text>Keeping Tech Simple </LI>
<LI class=text>Kings of Convergence</LI></UL>
<H3>In-Vehicle Technology</H3>
<UL class=text>
<LI class=text>In-Vehicle Tech: Finding the Opportunities</LI></UL>
<H3>Technology and The Environment</H3>
<UL class=text>
<LI class=text>A Computer on Wheels: Meet the Electric Car</LI></UL>
<H3>Just the Facts: Research, Reports, Revelation</H3>
<UL class=text>
<LI class=text>Presentations on recent CE research topics.</LI></UL>
