...
<head><!-- PageID 2049 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Location Based Services</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
       ...
       <!-- Start Search/MyCES Row -->
            ...
            <li class="selected"><a href="/exhibits/displays/LBS.asp">Location Based Services</a></li>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibits/default.asp" class="footer">Exhibits</a>&nbsp;&gt;&nbsp;<a href="/exhibits/displays/default.asp" class="footer">CE Spotlights</a>&nbsp;&gt;&nbsp;Location Based Services</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibits/displays/LBS.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>Location Based Services</h1>
                                                               
                        

<STRONG>What?</STRONG><BR><IMG hspace=6 src="/images/content/LBS_Logo.jpg" align=right vspace=8>This CE Spotlight serves as the premiere location for providers of custom technologies, services and advertising sent to portable and in-car navigation devices, based on their current locations.&nbsp; <BR><BR>Expect to find: 
<UL class=text>
<LI class=text>Portable and in-car navigation devices and services </LI>
<LI class=text>GPS services </LI>
<LI class=text>Digital mapping for vehicular navigation </LI>
<LI class=text>Personalization of mobile services, based on location</LI></UL><BR><STRONG>Where?<BR></STRONG>LVCC, North Hall<BR><BR><STRONG>Who?</STRONG><IMG height=26 hspace=6 src="/images/content/magGlass.gif" width=23 align=middle><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&assoids=2810170" target=_blank>View the complete exhibitor lineup.</A><BR><BR><BR><STRONG>Interested in exhibiting in this space? </STRONG><A href="/docs/2010_Locations_Bases_Services_TZ_Sheet.pdf" target=_blank><STRONG>Download this flyer for details.</STRONG></A> 

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibits/displays/LBS.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
