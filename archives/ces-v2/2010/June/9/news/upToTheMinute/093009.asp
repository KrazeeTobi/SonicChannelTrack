...
<head><!-- PageID 3392 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2010 CES: September 30, 2009</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
       ...
       <!-- Start Search/MyCES Row -->
            ...
            <li class="selected"><a href="/news/upToTheMinute/093009.asp">September 30, 2009</a></li>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/news/default.asp" class="footer">News</a>&nbsp;&gt;&nbsp;<a href="/news/upToTheMinute/default.asp" class="footer">CES Up to the Minute</a>&nbsp;&gt;&nbsp;September 30, 2009</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/news/upToTheMinute/093009.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<IMG border=0 hspace=5 align=right src="/images/photos/Vegas.jpg" width=100 height=149>Several CES hotels are offering early bird and reduced rates for CES attendees. The Las Vegas Hilton has slashed its peak rate from $249 to $209 for a standard room. And with the early bird rates being offered at two CityCenter hotels, you can afford to stay at the newest address on the Strip! <BR><BR>Check the <A href="/hotelTravel/hotel.asp">complete list of official CES hotels</A>. Plus, many <A href="/hotelTravel/airlines.asp">airlines that offer service to Las Vegas are giving you a chance to save</A> when you fly.<BR><BR>New to the Vegas scene. <A href="/hotelTravel/lasVegas.asp">Get tips on how to make the most of one of the nation's most exciting cities.</A>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<A href="/awards/bestOfCES.asp"><IMG height=175 hspace=5 src="/images/content/Best_of_CES_logo.jpg" width=91 align=left border=0></A>CNET's expert editors will hit the deck running at the 2010 International CES to find the best, new products. They’ll comb through thousands of devices to find the most innovative gadgets that will set the standard by which they will measure all other products in the coming year. In the end, they will nominate 27 products in nine categories, plus a Best in Show winner. It's <A href="/awards/bestOfCES.asp">CNET's Best of CES</A>. <BR><BR>Also, from the top 27 products, the CNET audience watching online will award a People’s Voice winner. Don’t miss the live award show on Saturday at the CNET Stage in the Las Vegas Convention Center's South Hall lobby. <BR><BR>For more information on the awards visit, <A href="http://www.cnet.com/best-of-ces" target=_blank>www.cnet.com/best-of-ces</A>.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
