...
<html>
<head>
	<title>2010 International CES:&nbsp;Locate Exhibitor</title>
	...
	<script language="Javascript">
		...
		if(opener){			
			...
			window.opener.document.forms["form_login"].forgot_password_button.disabled=false;
...
<IMG SRC="../../images/eims_banner.jpg" width="439" BORDER="0">
...
<form><tr><td colspan='2' align='middle'><input type='button' class='formData' name='btnNewSearch' value='New Search' onClick="window.location='default.asp';"></td></tr></form>
</table>
</tr>
</table>
