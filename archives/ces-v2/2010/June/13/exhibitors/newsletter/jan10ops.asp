...
<head><!-- PageID 3757 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: January 2010 Operations</title>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/jan10.asp" class="footer">January 2010</a>&nbsp;&gt;&nbsp;January 2010 Operations</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/newsletter/jan10ops.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>January 2010 Operations</h1>
                                                               
                        
<div align="center">

    [ <a href="/exhibitors/newsletter/jan10.asp">News</a> ]
...
<div class="sub-content-header">Welcome to the 2010 International CES!</div>
<br />

Yesterday, every exhibitor received the official CES Exhibitor Welcome Kit in their booth. If you did not receive one, please let your floor manager know. If you would prefer an electronic copy you can <A href="/docs/Exhibitor_Welcome_Kit.pdf" target=_blank>download&nbsp;it today</A>.<BR><BR>We hope you have a great show!<BR>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
