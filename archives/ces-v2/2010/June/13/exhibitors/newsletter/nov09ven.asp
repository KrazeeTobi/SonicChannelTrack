...
<head><!-- PageID 3445 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: November 2009 Venetian Corner</title>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/nov09.asp" class="footer">November 2009</a>&nbsp;&gt;&nbsp;November 2009 Venetian Corner</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/newsletter/nov09ven.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>November 2009 Venetian Corner</h1>
...
<div class="sub-content-header">Venetian Suites: Advance Warehouse and Direct to Show Site/POV Shipment Options</div>
<br />

As in the past, GES is our official general contractor. All freight shipments for the exhibit suites must be sent in advance to the GES warehouse by Monday, December 28, 2009. However, if you are unable to send your freight to the advance warehouse, there are several direct to show site/POV options for Monday, January 4 and Tuesday, January 5. For detailed information on this, please reference section 6 in your <A href="http://www.ges.com/ecomm/2010/Q1/11-04894VTS/" target=_blank>Venetian Tower Suites Exhibitor Manual</A>.<BR><BR>&nbsp;NOTE: Empty cartons/container/cases CANNOT be stored within your exhibit suite during the show. You will be responsible for tagging your empty containers with "empty" stickers so that GES can retrieve and store them for you during the show. Additionally, wooden crates are not permitted on the suite levels.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3500"></a>

<div class="sub-content-header">Venetian Suites: Move-out</div>
<br />
...
<div class="sub-content-header">Venetian Meeting Room Exhibits: Advance Warehouse and Direct to Show Site/POV Shipments</div>
<br />

As in the past, GES is our official general contractor. All freight shipments for the Venetian meeting rooms must be sent in advance to the GES warehouse by Monday, December 28, 2009. However, if you are unable to send your freight to the advance warehouse, there are several direct to show site/POV options for Tuesday, January 5 (only). For detailed information on this, please refer to section 2 of your <A href="http://www.ges.com/ecomm/2010/Q1/11-04894VMR/" target=_blank>Venetian Meeting Room Exhibitor Manual</A>.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3498"></a>

<div class="sub-content-header">Venetian Meeting Room Exhibits: Move-out</div>
<br />
...
<STRONG>Below are a few key upcoming deadlines. For a full list, be sure to reference your <A href="http://www.cesweb.org/exhibitors/manual/default.asp#3050">checklist</A>. <BR><BR></STRONG>Venetian Tower exhibit suites: 
<UL class=text>
<LI class=text>November 2 – deadline to submit your credit card authorization/bed removal notification form (required form) </LI>
<LI class=text>November 2 – deadline to submit your request forms and diagrams to have furniture moved within your exhibit suite (required form) </LI>
<LI class=text>November 2 – deadline to submit your request forms for multiple guest authorizations and cleaning services (required forms) </LI>
<LI class=text>November 30 – CES shipments/freight may begin arriving at the GES warehouse (note: Venetian exhibitor shipments must be received by December 28, 2009 in order to receive the advance material handling rate)</LI></UL>Venetian meeting room exhibitors: 
<UL class=text>
<LI class=text>November 30 – deadline to submit your security order form </LI>
<LI class=text>November 30 – CES shipments/freight may begin arriving at the GES warehouse (note: Venetian exhibitor shipments must be received by December 28, 2009, in order to receive the advance material handling rate) </LI>
<LI class=text>December 1 – deadline to order complimentary cleaning services </LI>
<LI class=text>December 4 – deadline to order complimentary hotel furnishings through Venetian Conference Management</LI></UL>If you are a Venetian exhibitor and would like assistance with your order forms, or just have general questions, contact <A href="mailto:gberube@ce.org">Gaiya Berube</A>, CES operations manager.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
