...
<head><!-- PageID 3281 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: September 2009 Venetian Corner</title>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/sep09.asp" class="footer">September 2009</a>&nbsp;&gt;&nbsp;September 2009 Venetian Corner</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/newsletter/sep09ven.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>September 2009 Venetian Corner</h1>
...
<div class="sub-content-header">Venetian Exhibitors: Your Exhibitor Manual is Now Available!</div>
<br />

The <A href="/exhibitors/manual/default.asp" target=_blank>Venetian Exhibitor Manual</A> is now available for all Venetian suite and meeting room exhibitors <A href="/exhibitors/manual/default.asp" target=_blank>exclusively online this year</A>. This manual contains shipping information, move-in and move-out details, vendor orders forms and much more — all specific to Venetian exhibitors! There are several new and improved regulations and policies that have been implemented for the 2010 show. Please be sure to read through your manual and contact Gaiya Berube with any questions or comments at <A href="mailto:gberube@CE.org">gberube@CE.org</A> or 703-907-7685.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3301"></a>

<div class="sub-content-header">Venetian Tower Exhibit Suites — Changes to Security Deposit Policy</div>
<br />

Based on feedback we received after the 2009 show, we are pleased to tell you that the security deposit required for each exhibit suite has been reduced to $1,500 (from $2,500).<BR><BR>To take advantage of this reduced deposit, you need to sign and submit your new Venetian Exhibit Suite Addendum to the CES Contract, along with the Credit Card Authorization Form. Tim Cassidy, CES sales coordinator, e-mailed each of you these forms in July. However, if you have not received them or want to confirm that he has received your signed versions, please feel free to contact Tim at <A href="mailto:tcassidy@CE.org">tcassidy@CE.org</A> or 703-907-5245.<BR>
