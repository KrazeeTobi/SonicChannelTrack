...
<head><!-- PageID 3173 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: August 2009 Venetian Corner</title>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/aug09.asp" class="footer">August 2009</a>&nbsp;&gt;&nbsp;August 2009 Venetian Corner</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/newsletter/aug09ven.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>August 2009 Venetian Corner</h1>
...
<div class="sub-content-header">Venetian Tower Exhibit Suites — Changes and Updates</div>
<br />

Based on feedback we received after the 2009 show, we are pleased to tell you about some positive changes relative to your exhibiting experience in the Venetian Tower exhibit suites: 
<UL class=text>
<LI class=text>In all suite types, the bathrooms and suite bedroom closet will be used as storage for the majority of “movable” suite furnishings, while still maintaining access to the toilet and one sink.</LI>
<LI class=text>The security deposit required for each exhibit suite has been reduced to $1,500 (from $2,500).</LI>
<LI class=text>Suite inspections (which ensure all set-ups are Fire Marshal compliant) will only take place during pre- and post-show hours. These inspections will not interrupt any exhibitor activity, meetings or be disruptive in any manner.</LI></UL>For a full list of frequently asked questions and additional information, please be sure to reference your space selection packet.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3205"></a>

<div class="sub-content-header">Move-in and Move-out Information</div>
<br />

It’s never too early to begin planning your CES shipment. To assist you with your move-in and move-out planning, we have created <A href="/docs/MI-MO_Procedures_for_Venetian_exhibitors.pdf" target=_blank>a schedule for you to follow</A>. <BR><BR>Please be sure to share this schedule with your freight carriers and EACs. If you have any questions, please contact <A href="mailto: gberube@ce.org">Gaiya Berube</A> or call 703-907-7685.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3204"></a>

<div class="sub-content-header">Exhibitor Manual Available Next Month</div>
<br />

The Venetian Exhibitor Manual (applicable to suite and meeting room exhibitors) will be <A href="/exhibitors/manual/default.asp" target=_blank>available exclusively online</A> this year. The manual will be available in early September and will contain shipping information, move-in and move-out details, vendor orders forms and much more! In the meantime, if you have any questions, please contact <A href="mailto: gberube@ce.org">Gaiya Berube</A>.
