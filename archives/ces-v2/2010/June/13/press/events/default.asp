...
<head><!-- PageID 337 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Press Events</title>
...
Before and during the International CES, a variety of events are held specifically for members of the press. See below for the kinds of events you can expect&nbsp;at the 2010 International CES, January 7-10, and check back later this year for specific time, date and location information.<BR><BR>Plus, look at the <A href="/events/default.asp">other events the Consumer Electronics Association holds throughout the year</A>.
...
<div class="sub-content-header">State of the Consumer Tech Industry and 2010 CES Trends to Watch</div>
<br />

<STRONG>2-3 p.m. Tuesday, January 5, 2010<BR>Bellini 2105, The Venetian<BR></STRONG><BR>At the onset of CES, there are two questions on everyone’s mind: What does the year ahead look like? And what lasting trends will emerge from the next several days?&nbsp; Before the doors open for the most important tech event in the country, get a glimpse into what everyone will be talking about in the year to come.&nbsp;Attend this presentation by CEA analysts to gain an understanding of the business trends, market forces and consumer dynamics behind the technology on display at the 2010 International CES.<BR>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="2090"></a>

<div class="sub-content-header">State of the Global CE Industry</div>
<br />

<STRONG>3-4 p.m. Tuesday, January 5, 2010<BR>Bellini 2105, The Venetian<BR><BR></STRONG>Worldwide revenue for consumer electronics (CE) is expected to reach $681 billion mark in 2009, despite a downed world economy. Countries with fast-growing economies and large emerging middle classes, such as the BRIC countries (Brazil, Russia, India and China), will lead the way in new CE revenue growth. This session provide a comprehensive look at global CE market trends.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<STRONG><IMG hspace=8 vspace=6 align=right src="/images/content/CES_Unveiled_event.gif" width=250 height=49>4-7 p.m. Tuesday, January 5, 2010<BR>The Venetian Ballroom, The Venetian</STRONG><BR><BR>Get to CES early to uncover the top tech newsmakers. Be the first to see the New Year's products at CES Unveiled. Media, analysts and bloggers can get a pre-show look at who will be making news headlines at CES Unveiled. Catch all the latest products in one room. Plus, get a sneak peek at International CES product debuts and the Innovations Design and Engineering Showcase honorees — before the show officially opens. <BR><BR><STRONG>2010 Exhibitors:<BR><BR></STRONG>
<TABLE border=0 cellSpacing=1 cellPadding=1 width="85%">
<TBODY>
<TR>
<TD vAlign=top>
<P>3M <BR>Accenture<BR>Advanced Micro Devices, Inc. <BR>Archerfish <BR>Beejive, Inc. <BR>Best Buy <BR>Bluetrek<BR>Compulab, Ltd. <BR>Continental<BR>dexim-Santom Ltd. <BR>DisplayLink Corp. <BR>D-Link Systems, Inc.<BR>Dual Electronics<BR>Edifier Enterprises Canada Inc.<BR>Entourage Systems, Inc. <BR>Eton Corporation<BR>Fulton Innovation <BR>Gefen/Xantech<BR>GIGLE Networks<BR>Hannspree<BR><BR></P>
<P>&nbsp;</P></TD>
<TD vAlign=top>
<P>HD Radio<BR>HDMI Licensing, LLC<BR>iGo<BR>In Win Development<BR>Inada Massage Chair <BR>Interactive Toy Concepts <BR>Klipsch Group, Inc.<BR>LaCie<BR>Lenovo <BR>Lexmark International<BR>Light Blue Optics <BR>Liquid Image Co, LLC<BR>Logitech<BR>Marvell Semiconductors<BR>Microvision<BR>Mitsubishi Digital Electronics<BR>mPower Technologies, Inc.<BR>MSI Computer</P></TD>
<TD vAlign=top>
<P>Open Mobile Video Coalition<BR>Oregon Scientific<BR>PARROT&nbsp;<BR>PFC, LLC (ZOMM) <BR>Pocket Radar<BR>Powermat<BR>Powertech Industrial Co., Ltd.<BR>PURE <BR>Samsung Mobile<BR>SD Association<BR>Seagate Technology<BR>SENSIO Technologies<BR>Sharper Image <BR>syabas Popcorn hour <BR>USB Implementers Forum <BR>UK Technology<BR>Vestalife<BR>VNA GROUP</P></TD></TR></TBODY></TABLE><STRONG><BR><A href="http://www.virtualpressoffice.com/showJointPage.do?page=jp&np=T&showId=1215381717766" target=_blank>Exhibitor News via Virtual Press Office/Business Wire</A></STRONG>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="1610"></a>

<div class="sub-content-header">Press Day</div>
<br />

<STRONG>Wednesday, January 6,&nbsp;2010<BR></STRONG><BR><IMG height=75 src="/images/content/CES_Press_Day_140.gif" width=140 align=right>Press Day is a MUST attend for CES media as major corporate, product and news announcements will be made. Press Day&nbsp;wraps up&nbsp;just in time for the preshow CES keynote address. <A href="/press/events/exhibitorPressEvents.asp">See a building list of exhibitor press events.</A><BR><BR><A href="/docs/2010_CES_Press_Day_Map.pdf" target=_blank>Download the 2010 CES Press Day schedule and map.</A>&nbsp;<EM>(Last updated: December 14, 2009)</EM>    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/press/events/default.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
