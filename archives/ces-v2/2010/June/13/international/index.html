...
<head><!-- PageID 495 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: International Resources</title>
...
<div class="right-blue-box" align="center">
    <div class="right-blue-box-header">CES Educational Sessions</div>
    
    <div>
        Fill your schedule with the knowledge you need to succeed in the consumer electronics industry.<BR><BR><A href="/sessions/default.asp">View the 2010 CES keynotes and educational sessions (in English).</A>
    </div>
</div>
<div class="right-blue-box" align="center">
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <A href="/docs/2K10VisaInterviewTips_Fly.pdf" target=_blank>Download the visa tip sheet (pdf).<BR></A>Let us help guide you through the visa process.<BR><BR>
    </div>
</div>
<div class="right-blue-box" align="center">
...
The International CES, the launchpad of new technology, is a major global event that attracts consumer technology professionals from all over the world. Connect with decision makers, press members and analysts. Investigate new technology and see innovative products at CES. <A href="/docs/2010_CES_Fact_Sheet.pdf" target=_blank>Learn about the show's history, current product categories, future dates and more (pdf).</A>
...
<A href="/international/travel.asp">Travel and Visa Information</A><BR>Use this helpful information as you travel into and out of the United States.<BR><BR><A href="/international/delegations.asp">Delegation Group Program</A><BR>The International CES attracts a large international audience because of its successful delegation program. Learn how to create or join a delegation in your country or region.<BR><BR><A href="/international/services.asp">International Services<BR></A>Translators, special networking receptions, dedicated work areas, meeting rooms and more are among the many benefits international attendees receive.<BR><BR><A href="/docs/2009_CES_Fact_Sheet_-_4.16.pdf" target=_blank>General Information (pdf)</A><BR>Learn about the show's history, current product categories, future dates and more.<BR>    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/international/default.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
