...
<head><!-- PageID 2933 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: SINOCES</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
       ...
       <!-- Start Search/MyCES Row -->
            ...
            <li class="selected"><a href="/events/sinoces.asp">SINOCES</a></li>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/events/default.asp" class="footer">Events</a>&nbsp;&gt;&nbsp;SINOCES</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/events/sinoces.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<H2>July 8-11, 2010<BR>Qingdao, China</H2>
<P><IMG height=60 hspace=5 src="/images/content/SINOCES_LOGO_180.jpg" width=180 align=right>According to CEA/GfK Market Research, the Chinese market will account for 13% of global consumer electronics (CE) retail revenue in 2010 with revenue expected to top $88 billion USD. <A href="http://www.sinoces.com/" target=_blank>SINOCES</A>, China's largest exhibition for consumer technology, is the gateway to this market, offering opportunities for leading consumer electronics businesses from China and abroad to view and showcase the latest technologies and cutting edge products. <BR><BR>Interested in exhibiting? <A lang=SINOCES title="SINOCES " href="mailto:kstake@ce.org?subject=SINOCES" target=_blank hreflang=SINOCES>Contact a business development representative.</A><BR>Interested in attending? <A href="http://www.sinoces.com/en/index.aspx" target=_blank>Register online now.</A></P>
<P>The U.S. Department of Commerce is organizing a pavilion on the show floor showcasing products and services from U.S.-based companies. <A href="/docs/DOC_Flyer.pdf" target=_blank>Learn more&nbsp; about this exciting opportunity</A>. <BR><BR><IMG height=200 hspace=5 src="/images/photos/Haier.jpg" width=300 align=left>SINOCES is a collaboration between the Consumer Electronics Association (CEA)®, producer of the International CES® , the China Electronic Chamber of Commerce (CECC) and the Qingdao Municipal People's Government. SINOCES is also certified by the U.S. Department of Commerce export trade promotion program. <BR><BR>More than 80,000&nbsp;CE professionals from China and around the globe are expected to visit the more than 500 exhibitors displaying their latest products and technologies at SINOCES. If your company is in China or looking to expand to China, SINOCES is the must attend event for 2010.&nbsp;<BR><BR>Please <A lang=SINOCES title=SINOCES href="mailto:kstake@ce.org?subject=SINOCES" target=_blank hreflang=SINOCES>contact</A> a business development representative&nbsp; to learn how your company can participate in China's premier consumer electronics show for industry professionals.<BR><BR>
...
<TR>
<TD>
<H3>Product Categories at SINOCES</H3>
<LI>Home Entertainment – Audio systems, digital TVs, DVD players, DVRs, portable media players and gaming systems. </LI>
<LI>Smart Home Products – Home security systems, smart appliances and home networking. </LI>
<LI>Mobile Office – Computers, accessories, software solutions, and portable devices. </LI>
<LI>Mobile Communications – Wireless, broadband and GPS. </LI>
<LI>Automotive Electronics – Audio, navigation and telematics. </LI>
<LI>Storage Solutions and Software Applications – Flash memory devices, operation systems, inlaid development, e-commerce, etc. </LI>
<LI>Security and Protection Products – Home intelligence &amp; security, monitors, flat intercom devices, video monitoring, network safety, etc. 
<P>SINOCES will feature eight TechZones that are dedicated areas on the show floor showcasing similar products. These include: </P>
<P>•&nbsp;Industrial Design Zone<BR>•&nbsp;eReader Zone<BR>•&nbsp;3D TV Zone<BR>•&nbsp;3G Telecommunication Zone<BR>•&nbsp;Home Appliance to the Countryside Zone<BR>•&nbsp;E-Commerce Zone<BR>•&nbsp;Green Zone<BR>•&nbsp;Government Procurement Zone</P></LI></TD></TR></TBODY></TABLE></P>
<H3>SINOCES Conferences and Forums</H3>
<P><IMG height=200 hspace=5 src="/images/photos/SINOCES_1.jpg" width=300 align=right>Want to learn about the latest trends and issues facing the CE industry in China and abroad? There will be more than 20 conference sessions at the 2010 SINOCES. Make plans to attend conference sessions that interest you or your company. Sessions include:</P>
<P>•&nbsp;SINO-US Joint Commission on Commerce &amp; Trade (JCCT) Conference<BR>•&nbsp;International Forum on Sustainability of Consumer Electronics<BR>•&nbsp;China Home Appliance Forum Schemes<BR>•&nbsp;China-UK CE Innovation Seminar</P><A href="http://www.sinoces.com/en/index.aspx" target=_blank>Visit the SINOCES site</A>&nbsp;for complete details on all 2010 conference program offerings and to register for the show.&nbsp; <BR>&nbsp;<BR>
...
<div class="sub-content-header">Innovations at SINOCES</div>
<br />

The International CES <A href="http://www.cesweb.org/awards/innovations/default.asp" target=_blank>Best of Innovations 2010 Product Showcase</A> will be on returning to SINOCES. The Innovations Display offers SINOCES attendees a unique opportunity to see some of the most innovative technology products in the world. This year, more than 25 Best of Innovations winners and Innovations Honorees from the 2010 Innovations Design and Engineering Awards program will be on display at SINOCES.
<P>&nbsp;A complete list of products that will be on display will be posted soon.</P>
<P>&nbsp;</P>    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/events/sinoces.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
