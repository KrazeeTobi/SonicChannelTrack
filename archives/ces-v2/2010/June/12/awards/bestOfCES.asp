...
<head><!-- PageID 309 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: CNET Best of CES</title>
...
<IMG hspace=5 align=right src="/images/content/BOCA_2010_badge_awards_RGB.jpg" width=120 height=226>Finalists announced:&nbsp; 10 a.m. Friday, January 8 <BR>Award show: 11 a.m. Saturday, January 9 <BR>LVCC, South Hall 3 Lobby, CNET Stage<BR><BR>CNET's expert editors hit the deck running at the 2010 International CES to find the best, new products.&nbsp; They combed through thousands of devices to find the most innovative gadgets that will set the standard by which they will measure all other products in the coming year. In the end, they nominated 27 products in nine categories, plus a Best in Show winner. Also, from the top 27 products, the CNET audience watched online&nbsp;to see who earned&nbsp;People’s Voice winner.<BR><BR><A href="http://ces.cnet.com/best-of-ces/" target=_blank><STRONG>See the finalists and winners.</STRONG></A><STRONG>&nbsp;<BR></STRONG><BR><BR>
