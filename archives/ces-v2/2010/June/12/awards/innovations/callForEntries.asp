...
<head><!-- PageID 313 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Call for Entries</title>
...
// javascript for e-mail this page tool - gets the url of the page the user is on before the e-mail page tool button is clicked
	...
	<!-- Start FORM -->
	If you would like to be added to the Innovations 2011 mailing list, fill out the form below. We'll notify you when we begin accepting entries. (<font style="color:red"><b>* </b></font> Denotes required field.)<br />
	...
	<h2>Sign up to receive Innovations 2011 Call for Entries updates</h2><br />
