...
<head><!-- PageID 742 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2010 CES: Awards Categories</title>
...
<IMG align=right src="/images/content/2k10_BOI_SAMPLE.jpg" width=114 height=152>Check out some of the&nbsp;<EM><FONT color=#00008b><STRONG><EM><FONT color=#00008b>NEW </FONT></EM></STRONG></FONT></EM>Software and Online Content categories for 2010!
<P>Looking for specific product examples? <A href="/docs/2K10Innovations_Guide.pdf" target=_blank>Download the 2010 Awards Category Guide.</A></P>
...
<P><STRONG>Electronic Gaming Hardware</STRONG><BR>Products (hardware) designed to allow one or more users to interact with electronic games. </P>
<P><STRONG><EM><FONT color=#00008b>NEW! </FONT></EM>Electronic Gaming Software<BR></STRONG>Software designed to allow one or more users to interact with electronic games. This category includesgaming software and web-based software.</P>
...
<P><STRONG><EM><FONT color=#00008b>NEW! </FONT></EM>Online Audio/Video Content Delivery<BR></STRONG>Any audio or video that can be transmitted via the Internet. Conent can be streaming or accessed through downloading.</P>
<P><STRONG><STRONG><EM><FONT color=#00008b>NEW! </FONT></EM></STRONG>Online Retail<BR></STRONG>The buying and selling of products or services via the Internet.</P>
...
<P><STRONG><STRONG><EM><FONT color=#00008b>NEW! </FONT></EM></STRONG>Social Networks<BR></STRONG>A web-based system of linking individuals or groups together. Users should be able to creae a profile for&nbsp; themselves and connect with other members. The system should also provide a variety of ways for users to communicate, network, or share information. </P>
