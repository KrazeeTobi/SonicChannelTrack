...
<head><!-- PageID 1415 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Tech & Engineering Emmy Awards</title>
...
<A href="http://emmyonline.tv/tech/" target=_blank><IMG height=112 hspace=8 src="/images/content/Emmys_200.gif" width=200 align=right border=0></A>Reception and Dinner<BR>6:30 p.m. January 7, 2010<BR>Mandalay Bay Hotel<BR><BR>The National Academy of Television Arts and Sciences (NATAS) has presented the <A href="http://emmyonline.tv/tech/" target=_blank>Emmy® Awards for Outstanding Achievement in Engineering /Technical Development</A> since 1948. For the&nbsp;fourth year, the Awards&nbsp;were&nbsp;presented at the International CES. 
<P>A list of honorees follows and is also available on the National Television Academy’s website at <A href="http://www.emmyonline.tv/tech" target=_parent>www.emmyonline.tv/tech</A>:</P><STRONG>NIELSEN CORPORATION</STRONG> <BR>For its Audience Measurement Technology System 
<P><STRONG>ARBITRON</STRONG> <BR>For its Audience Measurement Technology</P>
<P><STRONG>PORTAPROMPT</STRONG> <BR>For its Pioneering Development in Electronic Prompting</P>
<P><STRONG>COMPU=PROMPT</STRONG> <BR>For its Pioneering Development in Electronic Prompting</P>
<P><STRONG>L3</STRONG> <BR>For its Pioneering Development of MSDC High Power Amplifiers</P>
<P><STRONG>FOX</STRONG> <BR>For its Pioneering Efforts in Development, Implementation of Network Distribution workflows for ATSC DTV Development</P>
<P><STRONG>PBS (The Public Broadcasting Service)</STRONG> <BR>For its Pioneering Efforts in Development, Implementation of Network Distribution workflows for ATSC DTV Development</P>
<P><STRONG>THE FEDERAL COMMUNICATIONS COMMISSION</STRONG> <BR>For The Development of NTSC Television</P>
<P><STRONG>CEA (Radio Manufacturers Association)</STRONG> <BR>For The Development of NTSC Television </P>
<P><STRONG>THE NTSC</STRONG> <BR>For The Development of NTSC Television</P>
<P><STRONG>HBO (Home Box Office)</STRONG> <BR>For Pioneering Development of Automatic Transmitter Identification for Satellite Television Communications</P>
<P><STRONG>ELMER MUSSER</STRONG> <BR>For Pioneering Development of Automatic Transmitter Identification for Satellite Television Communication<BR><BR>Awards are presented to an individual, company, or to a scientific or technical organization for developments and/or standardization involved in engineering technologies which either represent an extensive improvement on existing methods or are so innovative in nature that they materially have affected the transmission, recording, or reception of television.<BR><BR>
...
<TR>
<TD>
<H3><IMG height=156 hspace=5 src="/images/photos/JerryLewis-solo.jpg" width=125 align=right>Emmys to Honor Jerry Lewis at Upcoming CES</H3>The Board of Trustees of the National Academy of Television Arts &amp; Sciences is proud to honor and recognize the humanitarian efforts of Jerry Lewis who, since 1966, has masterfully used the medium of television during his annual MDA Labor Day Telethon to raise $1 billion for Muscular Dystrophy research and equipment. <BR><BR>Jerry will be presented with the Academy’s most prestigious honor at the 61st annual Technology &amp; Engineering Emmy Awards to be held January 7, 2010, at the Mandalay Bay, Las Vegas in conjunction with CES. </TD></TR></TBODY></TABLE><BR><BR>Who won in 2009? Check below, and visit the <A href="http://www.emmyonline.tv/tech/" target=_blank>National Television Academy's website</A>&nbsp;for more details.</P>
<UL class=text>
<LI class=text>Serial Interface and Protocols for Server/VTR Control: Harris Corporation and Sony </LI>
<LI class=text>Delivery Confirmation Systems: XOrbit and Scripps Networks </LI>
<LI class=text>Development and Standardization of File Formats for Video and Audio: the Society of Motion Picture and Television Engineers (SMPTE) and Thomson Grass Valley </LI>
<LI class=text>Pioneering Development of MPEG-4 AVC Systems for HDTV: Tandberg Television and DirecTV </LI>
<LI class=text>Pioneering RF Combiners for Adjacent Channels on Common Antenna Systems: Harris, Micro Communications Inc. (MCI) and Radio Frequency Systems (RFS) </LI>
<LI class=text>Ongoing Live Global HD Cinemacasting: the Metropolitan Opera Association </LI>
<LI class=text>Help in Developing HDMI: Silicon Image, Thomson, Toshiba, Sony, Matsushita, Hitachi, Philips, Molex, Japan Aviation Electronics (JAE) and Intel </LI>
<LI class=text>Standardization of the ATSC Digital System: the Advisory Committee on Advanced Television Service, the Advanced Television System Committee, the Advanced Television Test Center and the Advanced Television Evaluation Laboratory </LI>
<LI class=text>MPEG-4 AVC Standard: Video Coding Expert Group (VCEG) and Moving Picture Experts Group (MPEG)</LI></UL><A href="/events/default.asp">See more events.</A>

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/awards/techEmmys.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
