...
<head><!-- PageID 481 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: News</title>
...
<H3><A href="/news/exhibitorNews.asp">Exhibitor News</A></H3>Stay informed on product lauches and other announcements from official CES exhibitors.<BR><BR>
<H3><A href="/press/imageGallery/default.asp">Video Gallery</A></H3>Watch highlights from prior International CES's to get geared up for the 2010 show (January 7-10).<BR><BR>
<H3><A href="/news/topTrends.asp">Top Trends at 2010 CES</A></H3>CEA Research Director and Economist Shawn DuBravac talks about what developments playing out at the 2010 CES might emerge as game changers in the years to come. <BR><BR>
<H3><A href="/press/imageGallery/default.asp">Image Gallery</A></H3>CES attracts the who’s who and best of the best in the consumer electronics (CE) industry. Plus, more than 24,000 industry and corporate buyers use CES as a means to compare and evaluate new products. But that's enough talk. Let us show you.<BR><BR>
<H3><A href="/news/upToTheMinute/default.asp">CES Up to the Minute</A></H3>This online newsletter is another great way to get late-breaking developments on the world's largest consumer technology tradeshow.<BR><BR>
<H3><A href="/press/default.asp">For the Press</A></H3>Are you a member of the media that's covering CES? Then this is the place for you.&nbsp;See events, contacts and services tailored for press and analysts.

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/news/default.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
