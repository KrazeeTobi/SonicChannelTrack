...
<head><!-- PageID 3201 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Top Trends at 2010 CES</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
       ...
       <!-- Start Search/MyCES Row -->
            ...
            <li class="selected"><a href="/news/topTrends.asp">Top Trends at 2010 CES</a></li>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/news/default.asp" class="footer">News</a>&nbsp;&gt;&nbsp;Top Trends at 2010 CES</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/news/topTrends.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>Top Trends at 2010 CES</h1>
                                                               
                        

<IMG height=110 hspace=7 src="/images/photos/ShawnDuBravac_photo.jpg" width=79 align=left border=0>Each January, CES emerges as the platform for product launches and entirely new product categories. 2010 is shaping up to be no different. <BR><BR>Here's a quick shot from <STRONG>CEA Research Director and Economist Shawn DuBravac</STRONG> about what developments playing out at the 2010 CES might emerge as game changers in the years to come.&nbsp;Look here for more trends as the show draws near. <EM>Last updated: July 22, 2009.<BR></EM><BR><BR>
<H3>2010 CES Marks the Year of the App.</H3><A href="/events/default.asp"><IMG height=69 hspace=5 src="/images/content/AppsShowdown.jpg" width=200 align=right border=0></A>Apps came on in a very big way in 2009, but the momentum is just beginning. From Facebook to the iPhone, the app is emerging as a key venue for accessing content in an easy and intuitive way. 2009 CES brought us one of the first looks at apps for the TV and we expect to see the app flood the <A href="/exhibits/facilities/default.asp">show floor</A> in 2010. Throughout 2009, many companies have worked to attract developers to their platforms we expect to see the fruit of these labors revealed at the 2010 CES. Apps will be everywhere at CES this year and only the discerning eye will be able to see the choice winners and game changers. Ultimately, this story is about control of content and information flow. Beyond apps, look for developments in other areas (like software) that will work to streamline managing the flow of content across devices. At CES this January, attend the&nbsp;<A href="/events/default.asp">Mobile Apps Showdown</A>, which&nbsp;features the top 10 apps in five categories (Education, Lifestyle, Entertainment, Productivity and IT), chosen by Robin Raskin and the editors and readers of <A href="http://www.NetShelter.net" target=_blank>NetShelter.net</A>.<BR><BR><BR>
<H3>iPhone Wonderland and Battle for the Palm.</H3><IMG height=108 hspace=7 src="/images/photos/iloungelogo_whiteback.jpg" width=120 align=left border=0>With a dedicated section of CES for the first-time ever, we expect to see major announcements coming from the <A href="/exhibits/displays/ilounge.asp">iLounge Pavilion</A> at the 2010 CES. Companies across the globe, continue to look for ways to leverage the popularity and success of the iPhone. But at the same time, the Palm Pre — released at the 2009 CES to rave reviews — is finding its own success in the marketplace as are other mobile devices. Don't expect the iLounge Pavilion to steal all of the thunder around the 2010 CES. There will be major announcements elsewhere within the mobile phone environment. We expect to see app store launches — building off the first trend listed above and trying to bring relevancy and increased usefulness to mobile platforms. We expect to see new portable products launches as well. We expect to see this play out on both the hardware and software side. Beyond the phone, look for other portable products. The 2009 show only gave a hint of what's to come for mobile phones, netbooks, e-readers, and <A href="/digitalImaging/default.asp">digital imaging</A>.<BR><BR>
<H3>Green is the New Black.</H3><IMG height=80 hspace=5 src="/images/content/Sustainable.jpg" width=200 align=right border=0>The green story will change in a major way at CES. To some degree this story has historically been altruistic — do what is right because it is right. But being kind to the environment has taken an important step forward and there are several catalysts that will propel the category forward at CES. Consumers want more from their devices when they are on the go — which means they need power that can keep up with both their increased needs as well as the huge jump in increased computer power today's portable devices bring to the table. The government is getting behind this movement with their wallet which is shining new light on overall green trends. VCs — leery of a deteriorating economy — continue to invest their own dollar here as well. Green trends at the 2010 CES will step beyond just eco-friendly design and packaging. Green will be big at 2010 CES because it makes sense financially and is gaining traction within the marketplace. Look for unique and compelling use of LED and e-ink, and check out <A href="/exhibits/displays/sustaintablePlanet.asp">Sustainable Planet</A>.<BR><BR>
<H3>Software will be Biggest Incognito Category at the 2010 CES.</H3><IMG height=102 hspace=5 src="/images/content/Win7f.jpg" width=74 align=left border=0>The launch of Windows 7 is opening to a crescendo of excitement. Early pre-orders are selling out across the globe. Will we see new hardware offerings trying to take advantage of Windows 7 capabilities? Certainly, we will see other OS emerge as major stories at CES — from the mobile environment to in-the-home applications.<BR><BR>

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/news/topTrends.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
