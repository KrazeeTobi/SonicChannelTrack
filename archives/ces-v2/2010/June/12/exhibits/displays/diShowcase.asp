...
<head><!-- PageID 764 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Digital Imaging Showcase</title>
...
<STRONG>What?<BR></STRONG><IMG height=49 hspace=8 src="/images/content/digImagShowcase.jpg" width=220 align=right vspace=8>Digital imaging — and high quality digital cameras in particular — remain a central focus for consumers, as household penetration of digital cameras reaches nearly 80 percent.&nbsp; <BR><BR>The Digital Imaging Showcase will feature more than 37,000 square feet of exhibit space, up from 25,000 at the 2009 CES, with more than 60 participating exhibitors. This dedicated exhibit area will highlight all aspects of the imaging product category, including cameras and capture devices, storage, software, printers, kiosks, bags and accessories. <BR><BR><STRONG>Where?</STRONG><BR>LVCC, South Hall 3<BR><BR><STRONG>Who?</STRONG><BR>Top imaging companies, such as ATP, Kodak, Iomega, Tiffen, Wacom and Wynit, will be featured at the 2010 CES. Other major imaging companies exhibiting at the 2010 CES include Canon, Casio, Fuji, JVC, Lowepro, Nikon, Olympus, Panasonic, Samsung and Sony. <BR><BR><IMG height=26 hspace=6 src="/images/content/magGlass.gif" width=23 align=middle><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&assoIds=2810020" target=_blank>View the complete exhibitor lineup</A> in the Digital Imaging Showcase.<BR><BR>
...
<TR>
<TD>
<H3><IMG height=100 hspace=5 src="/images/content/digitalimg_icons_sm.gif" width=100 align=right>More Digital Imaging at CES</H3>If you're in the digital imaging market, look for this icon while you're at CES, and <A href="/digitalImaging/default.asp">see what else we have in store for you.</A><BR><BR>If you haven't registered yet, what are you waiting for? <A href="/register">Save $100 by registering before you arrive in Las Vegas.</A></TD></TR></TBODY></TABLE><BR><STRONG>Interested in exhibiting in this space?</STRONG> E-mail <A href="mailto:exhibit@CESweb.org">exhibit@CESweb.org</A> to inquire.

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibits/displays/diShowcase.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
