...
<head><!-- PageID 3071 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Living in Digital Times</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
       ...
       <!-- Start Search/MyCES Row -->
            ...
            <li class="selected"><a href="/exhibits/displays/livingDigital.asp">Living in Digital Times</a></li>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibits/default.asp" class="footer">Exhibits</a>&nbsp;&gt;&nbsp;<a href="/exhibits/displays/default.asp" class="footer">CE Spotlights</a>&nbsp;&gt;&nbsp;Living in Digital Times</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibits/displays/livingDigital.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>Living in Digital Times</h1>
                                                               
                        

<H2>Focus on Technology for Life's Transitions<IMG hspace=6 vspace=8 align=right src="/images/photos/LDT_Logo.jpg" width=222 height=68></H2>Living in Digital Times turns the concept of a traditional&nbsp;exhibit upside-down as it focuses on technology that's relevant to particular lifestyles. After successful launches of Kids@Play and the Silvers Summit, Living in Digital Times is launching the Digital Health Summit, Mommy Tech, and HigherEd Tech&nbsp;in its new location at the 2010 CES.<BR><BR><STRONG>Location</STRONG><BR>LVCC, North Hall&nbsp;<br /><br />
<div class="page_header_block">
    <div class="blue_box">
        ...
        <li><a href="#3074">Digital Health Conference Program and TechZone</a></li><!---->
        
        <li><a href="#3077">HigherEd TECH Conference Program and TechZone</a></li><!---->
        
            </ul>
        
            <ul>
        
        <li><a href="#3076">Kids@Play Conference Program and TechZone</a></li><!---->
        
        <li><a href="#3078">Mommy Tech Conference Program and TechZone</a></li><!---->
        
            </ul>
        
            <ul>
        
        <li><a href="#3075">Silvers Summit Conference Program and TechZone</a></li><!---->
...
<div class="sponsorshipTitle">HigherEd TECH Conference Program and TechZone</div>
<br /><IMG height=130 hspace=6 src="/images/content/Higher_Ed_Tech_200.gif" width=200 align=right>Connected. That sums up the modern college experience in one word, and it’s quickly changing the face of higher education. Ever on the lookout for newer, better, faster and more innovative technology, whatever the next big trend in consumer electronics is going to be, it's a virtual lock that college kids will be among the first adopters of consumer technology.<BR><BR>How do you stay atop this rapidly changing, rapidly expanding market? HigherEd TECH,&nbsp;the only event of its kind at CES, offers the opportunity to survey the latest trends, products, and services for today’s students and for the institutions that serve them.<BR><BR><IMG height=26 hspace=6 src="/images/content/magGlass.gif" width=23 align=middle><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810140">View a list of&nbsp;HigherEd TECH&nbsp;exhibitors.</A>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sponsorshipTitle">Kids@Play Conference Program and TechZone</div>
<br /><IMG height=178 hspace=5 src="/images/content/KidsatPlay.jpg" width=250 align=right>Today's kids have grown up in a digital world. Babies cut their first teeth on remote controls. Toddlers bang on keyboards before they can walk. By the time they reach high school, these same kids will likely dabble in video production, explore virtual worlds and own a drawer-full of prized personal consumer electronics. From storybooks to Facebook, it's the way they learn, communicate, and entertain themselves.<BR><BR>If you're a retailer, content provider, distributor, game developer, educator, policy maker or manufacturer of CE devices that appeal to this important market, join us as we explore the way being digital today creates a smarter world tomorrow.<BR><BR><IMG height=26 hspace=6 src="/images/content/magGlass.gif" width=23 align=middle><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810150">View a list of exhibitors in this TechZone.</A>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sponsorshipTitle">Mommy Tech Conference Program and TechZone</div>
<br /><IMG height=65 hspace=6 src="/images/content/Mommy_Tech_200.jpg" width=200 align=right>Mommy Tech is a focused lifestyle exhibit and conference&nbsp;at CES. This premiere&nbsp;destination&nbsp;focuses exclusively on the newest innovations and tools of the trade, spotlighting key trends impacting the $90 billion dollar Mommy market. This area of the Living in Digital Times CE Spotlight at CES promotes and enlightens product creators, manufacturers, distributors and service providers to the opportunities, partnerships, business models, distribution channels and standards guidance that reach and influence Mommy spending habits and preferences.<BR><BR>Empowering moms with technology that helps them juggle priorities, stay connected with their own families and other moms, and savor their multiple roles in life is the central theme of Mommy Tech.<BR><BR><IMG height=26 hspace=6 src="/images/content/magGlass.gif" width=23 align=middle><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810180">View a list of&nbsp;Mommy Tech&nbsp;exhibitors.</A>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sponsorshipTitle">Silvers Summit Conference Program and TechZone</div>
<br /><IMG height=63 hspace=6 src="/images/content/SilversSummit_250.jpg" width=250 align=right>There are about 78 million boomers in the US (450 million worldwide) born between 1946 and 1964 — and they're hitting their peak earning and spending. Whether they're playing brain games for fun, monitoring their homes, visiting their grandkids via video conferencing or navigating the back road in their GPS enabled SUVs, this generation is maximizing the benefits of the digital age.<BR><BR>Silvers Summit showcases the products and services that keep boomers engaged, entertained, connected and healthy. Visit this destination to meet with distributors, journalists, research firms and manufacturers that will demonstrate the products and services that help mature consumers maintain a high quality of life.<BR><BR><IMG height=26 hspace=6 src="/images/content/magGlass.gif" width=23 align=middle><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810200">View a list of Silvers Summit exhibitors.</A>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibits/displays/livingDigital.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
