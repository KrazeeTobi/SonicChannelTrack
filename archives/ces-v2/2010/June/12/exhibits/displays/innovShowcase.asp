...
<head><!-- PageID 854 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Innovations Showcase</title>
...
<STRONG>What:</STRONG><IMG height=141 hspace=6 src="/images/content/2k10_Innovations_SAMPLE.jpg" width=108 align=right vspace=8><BR>The Innovations 2010 Design and Engineering Awards acknowledge the year's most outstanding developments in engineering and design in consumer electronics, and you can see it all at the Innovations 2010 Design and Engineering Awards Showcase. Make your way to this showcase on the CES show floor to see the <A href="/awards/innovations/2010honorees.asp">Innovations honorees</A> firsthand.<BR><BR><STRONG>About:<BR></STRONG><A href="/awards/innovations/2010honorees.asp">Innovations honorees</A> represent life and industry-changing products introduced into the marketplace. See the award program's honorees in this cutting-edge showcase. <A href="/awards/innovations/default.asp">Learn more about the CES Innovations Awards.</A><BR><BR><STRONG>Where?<BR></STRONG>LVCC, Grand Lobby

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibits/displays/innovShowcase.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
