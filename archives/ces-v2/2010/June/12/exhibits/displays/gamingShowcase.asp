...
<head><!-- PageID 760 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Gaming Showcase</title>
...
<STRONG>What?</STRONG><BR><IMG height=91 hspace=6 src="/images/content/gamingshowcase.jpg" width=200 align=right vspace=8>Get ready for the largest Gaming Showcase in CES history, and get ready to see advancements in online gaming and gaming-related product debuts all in one centralized location. <BR><BR>More than 13,000 square feet of exhibit space in the Las Vegas Convention Center’s North Hall is your prime destination if gaming matters to your business. There you’ll find gaming hardware and software – from online PC and HD gaming, plasma HDTV to surround sound and power conditioning hardware. <BR><BR>Major gaming exhibitors at CES include: D-Box, DDR (Dance, Dance Revolution), Guillemot, Iron Will Creations, Microsoft - Games for Windows and Tritton. <BR><BR><STRONG>Where?</STRONG><BR>LVCC, Norh Hall<BR><BR><STRONG>Who?</STRONG><IMG height=26 hspace=6 src="/images/content/magGlass.gif" width=23 align=middle><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&assoIds=2810050" target=_blank>View the complete exhibitor lineup</A> in the Gaming Showcase.<BR><BR>
...
<TR>
<TD>
<H3><IMG height=100 hspace=5 src="/images/content/gaming_icons_sm.gif" width=100 align=right>More&nbsp;Gaming Technology&nbsp;at CES</H3>If you're in the gaming and digital entertainment market, look for this icon while you're at CES, and <A href="/gaming/default.asp">see what else we have in store for you.</A><BR><BR>If you haven't registered yet what are you waiting for? <A href="/register">Save $100 by registering before you arrive in Las Vegas.</A></TD></TR></TBODY></TABLE><BR><BR></A><STRONG>Interested in exhibiting in this space?</STRONG> E-mail <A href="mailto:exhibit@CESweb.org">exhibit@CESweb.org</A> to inquire.

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibits/displays/gamingShowcase.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
