...
<head><!-- PageID 385 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Wireless World</title>
...
<STRONG>What?</STRONG><BR><IMG height=71 hspace=6 src="/images/content/wirelessWorld.jpg" width=220 align=right vspace=8>You can leave the wires at home for this one!&nbsp;Want to see the latest handsets and accessories? Want to access the entire value chain from manufacturers to distribution? Then Wireless World at CES is where you need to be. <BR><BR>See&nbsp;handsets, other products and services from prominent industry leaders like Nokia, Qualcomm, Broadcomm, Blackberry and more. Within Wireless World, you'll find the <A href="/exhibits/displays/techZones.asp#388">Wireless Mobility Brought to You By Qualcomm TechZone</A> and the entire value chain — from manufacturers to distribution to content and accessories.<BR><BR><STRONG>Where?</STRONG><BR>LVCC, South Hall 3<BR><BR><STRONG>Who?</STRONG><IMG height=26 hspace=6 src="/images/content/magGlass.gif" width=23 align=middle><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810360" target=_blank>See a list of Wireless World exhibitors.</A><BR><BR>
...
<TR>
<TD>
<H3><IMG height=100 hspace=5 src="/images/content/wireless_icons_sm.gif" width=100 align=right>More Wireless Technology at CES</H3>If you're in the wireless market, look for this icon while you're at CES, and <A href="/wireless/default.asp">see what else we have in store for you.</A><BR><BR>If you haven't registered yet, what are you waiting for? <A href="/register">Save $100 by registering before you arrive in Las Vegas.</A></TD></TR></TBODY></TABLE><BR><BR><STRONG>Interested in exhibiting in this space?</STRONG> E-mail <A href="mailto:exhibit@CESweb.org">exhibit@CESweb.org</A> to inquire.

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibits/displays/wirelessWorld.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
