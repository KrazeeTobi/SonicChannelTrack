...
<head><!-- PageID 1093 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Content Professional</title>
...
NBC Universal, CBS Interactive and Sony&nbsp;returned to the 2010 International CES along with an anticipated record number of content-focused exhibitors and attendees. Top executives from a range of major content companies, including ESPN, HULU, Nielsen, TiVo and the Walt Disney Company&nbsp;attended and spoke at CES.<BR><BR>Big name exhibitors in CES’ Experience 3D TechZone included Mitsubishi, Technicolor , Hyundai, Fujifilm and Sensio. In fact, 3D&nbsp;was on display throughout the entire show floor. In addition, the Open Mobile Video Coalition sponsored a Mobile DTV TechZone, complete with latest names from within this category.<BR>
<H3>Up Next at CES</H3>
<P><A href="http://cesweb.org/sessions/search/results.asp?categoryID=1879"><IMG height=221 hspace=5 src="/images/content/Up_Next_at_CESco.gif" width=245 align=right border=0>UP NEXT at CES</A> is a series of sessions at CES that cuts through the new media hype and presents real-world strategies for monetizing all forms of media content across the most promising platforms. <A href="http://cesweb.org/sessions/search/results.asp?categoryID=1879">UP NEXT</A> is where the best creative, business and technical talent shares and compares the smartest ways to produce, promote and profit from media content, featuring: <BR><BR><BR></P>
<UL class=text>
...
<P></P>
<P>
<H3>Content Exhibitors</H3>
<P>CES attracts hundreds of exhibitors whose products and services&nbsp;revolve around&nbsp;the development, enhancement, storage and/or distribution of content. This year's content exhibitor list? Still impressive: NBC Universal. Sony Pictures Television. Sling. DirectTV. EchoStar. Blockbuster, and TV Guide and Sony Pictures. <A href="http://myces.bdmetrics.com/Browse-Consumer-Electronics-Exhibitors-by-Category.aspx">Browse the 2010 International CES exhibitor directory for a complete list.</A><BR><BR></P>
<H3>Spotlight on Content</H3>
<P>Content at the International CES reache far beyond our exhibitors&nbsp;with a number of <A href="/exhibits/displays/default.asp">CE Spotlights</A>, <A href="/exhibits/displays/techZones.asp">TechZones</A> and <A href="/events/default.asp">events</A> to pique the interest of content professionals.&nbsp; </P>
<UL class=text>
<LI class=text><A href="/exhibits/displays/innovShowcase.asp">Innovations Design and Engineering Showcase</A> </LI>
<LI class=text><A href="/exhibits/displays/ilounge.asp">iLounge Pavilion</A> </LI>
<LI class=text><A href="/exhibits/displays/livingDigital.asp">Living in Digital Times CE Spotlight</A> </LI>
<LI class=text><A href="/exhibits/displays/techZones.asp#388">Wireless Mobility brought to you by Qualcomm</A> </LI></UL>
<P><BR></P>
<P>
...
<TR>
<TD>
<H3>By the Numbers</H3>Seventy-five percent&nbsp;of CES attendees agree that CES is the most important single event to attend for companies involved in the consumer electronics industry. Each CES attendee conducts an average of 12 meetings with buyers, investors, analysts and media, making CES the most efficient travel budget saver imaginable.&nbsp; <A href="https://cms.ce.org/register">Get</A> read for the 2011 International CES, January 6-9, 2011, Las Vegas, Nev.</TD></TR></TBODY></TABLE></P>
<P><BR></P>

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/prof-content.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
...
//YWATracker.setDocumentGroup("Professions");
