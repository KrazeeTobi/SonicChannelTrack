...
<head><!-- PageID 1146 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2010 CES: Información de viajes y visas</title>
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        ...
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Resources</a>&nbsp;&gt;&nbsp;<a href="/international/spanish/default.asp" class="footer">Español</a>&nbsp;&gt;&nbsp;Información de viajes y visas</div>
                    </div>
...
<P><STRONG>¿Necesita una visa? <BR></STRONG><A href="https://evisaforms.state.gov/ds156.asp?lang=1" target=_blank>Ahora puede completar el formulario de solicitud de visado en línea.</A></P>
<P><STRONG>¿Necesita ayuda?</STRONG> <BR><A href="/docs/2K10VisaInterviewTips_Fly_SP.pdf" target=_blank>Descargue nuestra Hoja de consejos para obtener una visa</A>, que consta de instrucciones detalladas, direcciones de sitios web y otra información para ayudarlo a completar satisfactoriamente su proceso de solicitud de visado. <BR><BR>A partir del 12 de enero de 2009, se requiere que las personas que visiten los Estados Unidos procedentes de países bajo el programa de exención de visa, se registren en línea y obtengan la autorización para su ingreso como parte del nuevo <A href="http://www.dhs.gov/xnews/releases/pr_1212498415724.shtm " target=_blank>Sistema Electrónico de Autorización de Viajes (en inglés)</A>. <BR></P>
<H2>Viajes</H2>
