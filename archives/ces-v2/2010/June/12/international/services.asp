...
<head><!-- PageID 497 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: International Services</title>
...
<H3>International Registration Area</H3><EM>LVCC, North Hall 4<BR>Las Vegas Hilton, Ballrooms D-G<BR><BR></EM>A special registration area for international attendees is located in the main registration area in the LVCC, North Hall 4 and the Las Vegas Hilton, Ballrooms D-G. In these two areas, international visitors can register on-site, pick up a badge holder (which is required to enter the show), or get special language assistance from multilingual interpreters available to help with registration questions. <BR><BR>
<H3>International Commerce Center (ICC)</H3><EM>NEW LOCATION: LVCC, North Hall, Booth #5235<BR></EM><BR>Now located in the LVCC, North Hall, Booth #5235, the ICC is the place for international visitors and exhibitors to stay in touch with the office at Internet stations, reserve and use private meeting rooms, enjoy light refreshments, or just relax. Conveniently located near the International Gateway and close to International Registration, the ICC can be your "office away from home" while you are at CES.<BR><BR>
<H3>International Reception</H3>All international attendees, exhibitors and press are invited to the CES International Reception. This reception is for international visitors only. Don’t miss this opportunity to meet new people, discuss business with colleagues, or develop new business partners. We look forward to seeing you there!<BR><BR>
<H3>Interpreters</H3>A multilingual staff is available in the ICC and the International Registration areas in the LVCC, North Hall 4 and Las Vegas Hilton, Ballrooms D-G. Interpreters are available to assist you in several languages, including Spanish, French, Chinese, Japanese, and Korean. In the International Registration areas, look for the counter entitled, “Interpretation Services” if you need assistance. <BR><BR>
<H3>International Buyer Program</H3>The International CES is a proud participant in the International Buyer Program, sponsored by the U.S. Department of Commerce, International Trade Administration. International Trade Specialists from the U.S. Department of Commerce are available in the&nbsp;ICC (LVCC, North Hall, Booth #5235) to provide matchmaking assistance and export trade counseling to international attendees and exhibitors. </EM>

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/international/services.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
