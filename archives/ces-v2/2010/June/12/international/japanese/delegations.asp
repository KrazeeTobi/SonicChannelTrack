...
<div class="right-blue-box" align="center">
    ...
    <div>
        <UL>
<LI><A href="http://www.cesweb.org/shared_files/edm/2010CES/International/Interimbrch_09%20FNL.pdf" target=_blank>英語版総合パンフレット（PDF）</A></LI>
<LI><A href="/docs/2010FACTSHEET_Japanese.pdf" target=_blank>日本語版CESファクトシート（PDF）</A></LI>
<LI><A href="http://www.cesweb.org/shared_files/edm/2010CES/International/2010_Program_Description.pdf" target=_blank>代表団リーダーと代表者の特典（英語版PDF</A>）</LI></UL>
    </div>
</div>
                    </div>
