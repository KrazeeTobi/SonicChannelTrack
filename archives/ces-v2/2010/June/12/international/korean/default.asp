...
<div class="right-blue-box" align="center">
    <div class="right-blue-box-header">CES 교육 세션</div>
    
    <div>
        소비자 가전 산업에서 성공하기 위해 필요한 지식으로 귀하의 스케줄을 채우십시오.<BR><BR><A href="/sessions/default.asp">2010 CES기조연설 및 교육세션 보기 (영어본).</A>
    </div>
</div>
...
신기술의 발사대라고 할 수 있는 인터내셔널 CES는 130개국에서 온 100,000명 이상이 참가하는 주요 국제 이벤트입니다. 의사 결정자들, 언론인들 및 분석가들을 만나실 수 있습니다. 신기술을 탐색하고 2000여 이상의 전시자들의 혁신적인 제품들을 관람하십시오. <A href="/docs/2010FACTSHEET_Korean.pdf" target=_blank>전시회의 역사, 현재 제품 부문, 향후 날짜 및 더 많은 정보를 보실 수 있습니다. </A>
...
<div class="sub-content-header">새로운 장소: 국제 상업 센터 (International Commerce Center, ICC)</div>
<br />

<EM>라스베가스 컨벤션 센터 (LVCC), North Hall, 부스번호# 5235<BR><BR></EM>라스베가스 컨벤션 센터의 North Hall의 부스번호 5235에 위치해 있는 국제 상업 센터 (ICC)는 국제 방문자들과 전시자들이 인터넷 스테이션에서 사무실과 연락을 취하고, 개인적인 회의실을 예약하고 사용할 수 있으며, 가벼운 음료와 간식을 즐기거나 휴식을 취할 수 있는 장소입니다. ICC는 인터내셔널 게이트웨이와 인터내셔널 등록장소에 가까이 위치하고 있어, CES에 계시는 동안 귀하의 현지 사무실로 사용하실 수 있습니다. &nbsp; &nbsp; <BR><BR><A href="/docs/ICC_bread_crumb_map.pdf" target=_blank>다운로드 새 ICC는 위치를지도.</A> &nbsp; &nbsp; <BR><BR><A href="http://cesweb.org/international/korean/services.asp">국제 참석자들에게 제공하는 서비스에 관한 자세한 내용을 보십시오.</A>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />
...
<A href="http://cesweb.org/international/korean/travel.asp">여행 및 비자 정보</A><BR>미국을 방문하는 데 도움이 되는 이 정보를 사용하십시오.<BR><BR><BR><A href="/international/korean/delegations.asp">대표단 프로그램</A><BR>International CES는 성공적인 대표단 프로그램을 갖추고 수많은 해외 방문객들을 불러들이고 있습니다. 여러분 국가나 지역의 대표단을 만들거나 대표단에 참여하는 방법을 알아보십시오.
