...
<div class="right-blue-box" align="center">
    ...
    <div>
        <UL>
<LI><A href="http://www.cesweb.org/shared_files/edm/2010CES/International/Interimbrch_09%20FNL.pdf" target=_blank>영어본 개관 안내책자 (pdf)</A></LI>
<LI><A href="/docs/2010FACTSHEET_Korean.pdf" target=_blank>번역된 CES 개황 보고서 (pdf)</A></LI>
<LI><A href="http://www.cesweb.org/shared_files/edm/2010CES/International/2010_Program_Description.pdf" target=_blank>대표단 리더와 대표단 사절들을 위한 혜택 (영어본pdf)</A></LI></UL>
    </div>
</div>
                    </div>
