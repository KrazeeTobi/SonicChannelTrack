...
<head><!-- PageID 1137 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Programme Groupe Délégation</title>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <UL>
<LI><A href="http://www.cesweb.org/shared_files/edm/2010CES/International/Interimbrch_09%20FNL.pdf" target=_blank>Aperçu général, brochure en anglais (pdf)</A></LI>
<LI><A href="/docs/2010_CESFACTSHEET_French.pdf" target=_blank>Feuille d’information CES traduite (pdf)</A></LI>
<LI><A href="http://www.cesweb.org/shared_files/edm/2010CES/International/2010_Program_Description.pdf" target=_blank>Avantages pour les chefs de délégation et les délégués (pdf en anglais)</A></LI></UL>
    </div>
</div>
                    </div>
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        ...
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Resources</a>&nbsp;&gt;&nbsp;<a href="/international/french/default.asp" class="footer">Français</a>&nbsp;&gt;&nbsp;Programme Groupe Délégation</div>
                    </div>
...
Vous souhaitez amener un groupe de votre pays au Salon CES International ? En tant que chef de délégation, vous pouvez permettre à vos clients de mieux profiter de leur visite du salon en les aidant à décider des exposants à rencontrer, mais aussi simplifier l’aspect logistique de leur voyage. La CEA propose un programme de groupe avantageux, pour les chefs de délégation comme pour les participants.<BR><BR>L’inscription gratuite au salon est parmi les nombreux avantages dont profiteront les participants au programme de délégation. Si vous vous joignez à une délégation et que vous vous inscrivez avant le 30 septembre, nous renoncerons aux frais d’inscription de 100 USD.<BR><BR>Remarque : Votre inscription en tant que chef de délégation ne suffit pas pour vous inscrire au salon. <A href="/register">Vous devez également remplir le processus d'inscription officiel pour recevoir vos documents officiels.<BR></A><BR><BR><STRONG>Détails du programme<BR></STRONG>Pour s’inscrire en tant que chef de délégation :
<UL class=text>
...
<LI class=text>Les délégations doivent être constituées d’un minimum de 15 membres. Les membres de groupes inférieurs à 15 participants doivent s’inscrire en tant que participants individuels.<BR></LI></UL>
...
<LI class=text>Accès à trois centres de commerce international (ICC) où les visiteurs et les exposants internationaux peuvent rester en contact avec leurs activités professionnelles grâce à des stations Internet, réserver et utiliser des salles privées, profiter de légers rafraîchissements, ou tout simplement se détendre. Les ICC peuvent vous servir de bureau à distance quand vous êtes au CES. </LI>
<LI class=text>Accès à des spécialistes du commerce international du Département américain du commerce qui peuvent aider les participants et les exposants internationaux à trouver des correspondants et des consultants en matière de commerce d'exportation.<BR></LI></UL>
...
<LI class=text>Entrée gratuite à Exhibits Plus. </LI>
...
<LI class=text>Invitation à la réception CES International.&nbsp; <BR></LI></UL>
<P></P>
<P><B><SPAN lang=FR style="COLOR: #333333">Programme des acheteurs internationaux du Département américain du commerce</SPAN></B><SPAN lang=FR style="COLOR: #333333"><BR><IMG height=158 src="/images/content/doc_logo(1).JPG" width=155 align=right>CES International est fier de participer au Programme des acheteurs internationaux (International Buyer Program - IBP), sponsorisé par l'Administration du commerce international du Département du commerce des États-Unis. De nombreux spécialistes commerciaux étrangers emmènent des délégations au CES dans le cadre de l'IBP. <A href="http://www.export.gov/eac/index.asp" target=_blank>Cherchez le service commercial de votre pays.</A>&nbsp;</SPAN></P>
<P>Si vous avez des questions sur l’inscription en tant que chef de délégation ou souhaitez contacter une délégation de votre pays, veuillez contacter la CEA à <A href="mailto:delegations@CE.org">delegations@CE.org</A>.<BR></P>

    

                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/international/french/delegations.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
