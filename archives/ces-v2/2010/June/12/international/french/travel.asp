...
<head><!-- PageID 1131 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Voyage et visa</title>
...
Informations utiles sur l’entrée aux États-Unis et la sortie du pays. <BR>
<H2>Visa</H2>
<P><STRONG>Vous avez besoin d’un visa ?</STRONG> <BR><A href="https://evisaforms.state.gov/ds156.asp?lang=1" target=_blank>Vous pouvez désormais remplir votre demande de visa en ligne.</A> </P>
<P><STRONG>Vous avez besoin d’aide ? <BR></STRONG><A href="/docs/2K10VisaInterviewTips_Fly_FR.pdf" target=_blank>Téléchargez notre fiche de conseils pour les visas</A>, qui contient des instructions détaillées, les adresses de sites web importants et d’autres informations destinées à faciliter votre demande de visa.<BR><BR>À partir du 12 janvier 2009, les visiteurs provenant de pays exemptés de visa qui se rendent aux É.-U. doivent s’inscrire en ligne et être autorisés pour l’entrée dans le cadre du nouveau <A href="http://www.dhs.gov/xnews/releases/pr_1212498415724.shtm " target=_blank>système électronique d'autorisation de voyage (en anglais), Electronic System for Travel Authorization (in English).</A><BR><BR></P>
<H2>Voyage</H2>
