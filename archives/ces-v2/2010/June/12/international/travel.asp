...
<head><!-- PageID 501 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Travel & Visas</title>
...
<STRONG>Do you need a visa?</STRONG><BR><A href="https://evisaforms.state.gov/ds156.asp?lang=1" target=_blank>You can now complete the visa application form online.</A><BR><BR><STRONG>Need help?</STRONG><BR><A href="/docs/2K10VisaInterviewTips_Fly.pdf" target=_blank>Download our Visa Tip Sheet (pdf)</A> for step-by-step instructions, website addresses and other information to make your visa application process successful.<BR><BR>Effective January 12, 2009, visitors to the U.S. from visa-waiver countries are required to register online and be authorized for entry as part of the new <A href="http://www.dhs.gov/xnews/releases/pr_1212498415724.shtm " target=_blank>Electronic System for Travel Authorization (in English)</A>.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />
