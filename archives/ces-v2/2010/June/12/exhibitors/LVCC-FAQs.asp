...
<head><!-- PageID 2124 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2010 CES: Las Vegas Convention Center</title>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/faq/default.asp" class="footer">FAQs</a>&nbsp;&gt;&nbsp;<a href="/faq/venueFAQs.asp" class="footer">FAQs by Venue</a>&nbsp;&gt;&nbsp;Las Vegas Convention Center</div>
                    </div>
...
Yes. Fire marshal approval is required every year, regardless of whether or not the booth design has been changed or altered. Make sure to have your floor plans approved by the deadline of October 30, 2009.<br><!--Can I hang truss or other structural equipment outside of my booth? -->
...
In order to have a non-official vendor service your booth at CES, you and they will need to provide the following information to CES Operations no later than December 11: 
<UL>
...
Please refer to the <A href="/exhibitors/manual/default.asp">color-coded target move-in or target move-out floor plans</A>. Or, you can contact GES at 702-515-5970 or 866-814-1705 or send an e-mail to <A href="mailto:CESfreight@ges.com">CESfreight@ges.com</A>.

<P>&nbsp;</P><br><!--How do I change my target date?-->
...
All exhibit halls will be dark for one day this year. No exhibitor activity will be permitted on Friday, January 1, 2010.&nbsp; December 31 will be dark for a half day, with all exhibitor activity stopping at noon.<br><!--When can my contractors/vendors access the show floor for move out?-->
...
<P>PLEASE NOTE: Exhibitor move-out is now targeted, so be sure to reference your <A href="/exhibitors/manual/default.asp">target move-out floor plan and corresponding information</A> so as to have a successful experience.<BR></P><br>
