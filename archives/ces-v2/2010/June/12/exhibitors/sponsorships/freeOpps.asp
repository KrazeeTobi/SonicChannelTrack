...
<head><!-- PageID 654 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2010 CES: Free Opportunities</title>
...
<br /><IMG hspace=8 src="/images/photos/2010_Exhibitor_Invitation_72dpi.jpg" align=right>Consider one of the least expensive, most effective methods to get your company name in front of attendees: invitations that allow your most important guests free advance registration for the International CES up until December 15. If they register on-site, they'll still save $100 off the $200 on-site registration with the invitation from you.<BR><BR>
<H3>Electronic Invitations</H3>Now it's even easier to invite your guests to register for CES. <A href="/exhibitors/sponsorships/invitations.asp">Login with your exhibitor credentials&nbsp;and access an electronic invitation</A> to send with an e-mail to your customers. This invitation will still allow them the same great registration discounts as the printed version. 
<BLOCKQUOTE>Need help getting started? Try this: 
<OL type=1>
<LI>Send an e-mail to your customers. Include your company name and booth information and any announcement you might have about the products or services you plan to display at the International CES. <EM>Tip: Include your logo to boost your brand!</EM> </LI>
<LI>Attach this electronic invitation. Already designed by CEA, this invite provides attendees with the basic tools to register and plan for the show.</LI></OL></BLOCKQUOTE><BR>
<H3>Printed Invitations</H3>Request up to 1,000 invitations to send to your best customers and prospects, and we'll cover the printing and production costs. Order your exhibitor invitations online at <A href="http://cesinvites.hbp.com/" target=_blank>http://CESinvites.hbp.com/</A>. You have the option of ordering customized invitations, including your company name and booth information, for an additional cost. We'll mail your invitation order to you or you may opt to use our recommended turnkey mailhouse services to mail the invitations directly to your VIPs.<BR><BR><STRONG>Deadline</STRONG><BR>To have printed invitations delivered to contacts before the show, invitations must be ordered by December 4, 2010. <BR><BR><B>Sponsorship Investment</B><BR>Incredible ROI, at little to no cost!<BR><BR><B>Contact</B><BR>Marketing, International CES<BR>E-mail: <A href="mailto:invitations@CE.org">invitations@CE.org</A>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
