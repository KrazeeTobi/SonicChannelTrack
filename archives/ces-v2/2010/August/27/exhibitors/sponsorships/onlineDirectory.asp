...
<div class="page_header_block">
    <div class="blue_box">
        ...
        <li><a href="#4144">BRONZE PACKAGE</a></li><!---->
        ...
        <li><a href="#4141">EXCLUSIVE - Facility Overview Banner Package</a></li><!---->
        
        <li><a href="#4140">LIMITED - Individual Hall Sponsor Package</a></li><!---->
        
        <li><a href="#4139">LIMITED - Floor Plan Banner Package - STANDARD</a></li><!---->
        
            </ul>
        
            <ul>
        
        <li><a href="#4138">LIMITED - Floor Plan Banner Package - PREMIUM</a></li><!---->
        
        <li><a href="#4156">Interactive Floor Plan "MyCES Page" Banner Package (limit 1)</a></li><!---->
...
<div class="sponsorshipTitle">BRONZE PACKAGE:&nbsp;<span class="lt_blue">$395</span></div>
<br /><UL>
<LI>Add your company logo or trademark on your online listing </LI>
<LI>Ability to add press releases to your online listing </LI>
<LI>Access to sales leads and floor plan statistics </LI>
<LI>On average, exhibitors at this level receive up to 2x more impressions</LI></UL>
...
<br /><UL>
<LI>3 display panels to showcase your products online through images/descriptions </LI>
<LI>Included in the 'Featured Exhibitor Search' </LI>
<LI>All Bronze package attributes included (see below) </LI>
<LI>On average, exhibitors at this level receive 2.5-3x more impressions</LI></UL>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<br /><UL>
<LI>5 total display panels (2 multimedia/flash presentations &amp; 3 product images/descriptions) </LI>
<LI>Priority placement in the online directory search results </LI>
<LI>‘Corner Peel’ graphic highlighting your booth on the floor plan </LI>
<LI>All Silver &amp; Bronze package attributes included (see below) </LI>
<LI>On average, exhibitors at this level receive 4-5x more impressions</LI></UL>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sponsorshipTitle">EXCLUSIVE - Facility Overview Banner Package:&nbsp;<span class="lt_blue">$16,500</span></div>
<br /><UL>
<LI>One exclusive banner* (360 x45 pixel) position available on the Facility Overview Map </LI>
<LI>Banner prints anytime the Facility Overview Map is printed </LI>
<LI>Includes all Gold Package attributes (see below) </LI>
<LI>Live link directs attendees to your sponsor listing on the floor plan </LI>
<LI>On average, banner sponsors generate 5x more impressions</LI></UL>*all banner ads must be static (no animation)
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sponsorshipTitle">LIMITED - Individual Hall Sponsor Package:&nbsp;<span class="lt_blue">$17,500 per hall sponsor</span></div>
<br /><UL>
<LI>One exclusive hall sponsorship banner* (360 x45 pixel) available per hall </LI>
<LI>Language above banner may read "Official Hall Sponsor" </LI>
<LI>Banner will print anytime the hall is printed </LI>
<LI>Includes all Gold Package attributes (see below) </LI>
<LI>Live link directs attendees to your sponsor listing on the floor plan </LI>
<LI>On average, banner sponsors generate&nbsp;five times more impressions</LI></UL>*all banner ads must be static (no animation) and we ask that the sponsor be an exhibitor in the hall
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sponsorshipTitle">LIMITED - Floor Plan Banner Package - STANDARD:&nbsp;<span class="lt_blue">$25,000</span></div>
<br /><UL>
<LI>A standard banner* (360 x 45 pixels) sponsorship featured on the base of the Interactive Floor Plan </LI>
<LI>Order of banner displays will be after the two ‘Premium Banners’ in order of purchase date (banners rotate every 7 seconds) </LI>
<LI>Includes Gold Package attributes (see below) </LI>
<LI>Live link directs attendees to your sponsor listing on the floor plan </LI>
<LI>On average, banner sponsors generate 5x more impressions</LI></UL>*All Banner ads must be static (no animation)
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
...
<div class="sponsorshipTitle">LIMITED - Floor Plan Banner Package - PREMIUM:&nbsp;<span class="lt_blue">$27,500</span></div>
<br /><UL>
<LI>Guarantees you one of the first two positions (out of a possible 12) in the banner rotation </LI>
<LI>A premium banner* (360 x 45) which displays on every page of the interactive floor plans, banners display in pairs of two and rotate every six seconds. </LI>
<LI>Two different company’s banners appear at one time – rotating every&nbsp;seven seconds. </LI>
<LI>Includes all Gold Package attributes (see below) </LI>
<LI>Live link directs attendees to your sponsor listing on the floor plan </LI>
<LI>On average, banner sponsors generate&nbsp;five times&nbsp;more impressions</LI></UL>*all banner ads must be static (no animation)
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sponsorshipTitle">Interactive Floor Plan "MyCES Page" Banner Package (limit 1):&nbsp;<span class="lt_blue">$40,000</span></div>
<br />One exhibitor at this level will stand out in every way. Includes all of the features of the Gold Package PLUS: One exclusive sponsorship banner will be prominently displayed on the opening splash screen of interactive floor plan.&nbsp;Language above the banner may read: "Official Interactive Floor Plan Sponsor."&nbsp;Banner directs attendees to your&nbsp;five panel video/image&nbsp;and text listing on the floor plans.&nbsp;Statistics are available for tracking.&nbsp;Static banner (no animation).&nbsp;Banner specs: 666 x 80 pixels.
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>    
