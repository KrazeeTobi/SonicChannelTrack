...
<head><!-- PageID 3953 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: International Gateway</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li ><a href="/showFloor/innovations-showcase.asp">Innovations Design and Engineering Showcase</a></li>
        
            <li class="selected"><a href="/showFloor/international-gateway.asp">International Gateway</a></li>
        </ul>
                            <br />
                        </div>
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/showFloor/default.asp" class="footer">Show Floor</a>&nbsp;&gt;&nbsp;International Gateway</div>
                        </div>
                        <div class="headerbox">
...
<IMG hspace=5 align=right src="/images/content/Internatinal_Gateway.jpg" width=200 height=115>Go global and expand your worldwide network by visiting the International Gateways at CES. Located in the <A href="/showFloor/by-hall.asp">Las Vegas Convention Center, North Hall and the Las Vegas Hilton,</A> the International Gateway features more than 800 exhibitors showcasing the latest innovative technologies and products from around the world. <BR><BR><STRONG>Where?</STRONG><BR><A href="/showFloor/by-hall.asp">LVCC, North Hall and the Las Vegas Hilton</A>
<P><STRONG>Who?</STRONG><BR>See a list of Interational Gateway exhibitors.</P>
<P><STRONG>Interested in exhibiting in this space?</STRONG><BR><A href="/exhibitors/space/contactRep.asp">Contact a CES exhibit sales representative.</A></P>

    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/showFloor/international-gateway.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
