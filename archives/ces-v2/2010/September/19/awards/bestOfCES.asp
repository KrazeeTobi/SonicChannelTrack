...
<IMG hspace=5 align=right src="/images/content/CNET_BestOfCES_140.jpg" width=140 height=288>CNET's expert editors are revving up to hit the deck running at the 2011 International CES to find the best, new products.&nbsp; They're already eager to&nbsp;get their&nbsp;hands on thousands of devices to find the most innovative gadgets that will set the standard by which they will measure all other products in the coming year. In the end, they&nbsp;will nomiate a few dozen or soproducts in nine categories, plus a Best in Show winner. Also, from the top products, the CNET audience&nbsp;have their say to&nbsp;dub the&nbsp;People’s Voice winner.<BR><BR><BR>
