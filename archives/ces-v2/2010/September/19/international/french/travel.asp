...
<P><STRONG>Vous avez besoin d’aide ? <BR></STRONG><A href="/docs/French_FR_6443_2K11VisaTips_Press_Ready.pdf" target=_blank>Téléchargez notre fiche de conseils pour les visas</A>, qui contient des instructions détaillées, les adresses de sites web importants et d’autres informations destinées à faciliter votre demande de visa.<BR><BR>À partir du 20 janvier, les voyageurs vers les États-Unis en provenance d’un pays visé par le <A href="http://travel.state.gov/visa/temp/without/without_1990.html#countries" target=_blank>Visa Waiver Program</A> pourraient se voir refuser l’embarquement par les compagnies aériennes s’ils ne respectent pas les exigences du programme Electronic System for Travel Authorization du Département de la sécurité intérieure des États-Unis. Maintenant, les voyageurs internationaux vers les États-Unis doivent consulter le site <A href="https://esta.cbp.dhs.gov" target=_blank>Web de l'ESTA </A>et remplir une demande avant d’entrer dans le pays par les airs ou la mer. Si elle est approuvée, l’autorisation est valide pour deux ans et peut être renouvelée. Les voyageurs n’ont plus à remplir un formulaire I-94W avant chaque voyage.<BR></P>
<H2>Voyage</H2>
