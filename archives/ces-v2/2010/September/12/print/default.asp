...
<body class="home" id="home">
    ...
    <div id="ctacontainer">
        ...
        <div id="exhibit"> <a href="/exhibitors/space/default.asp" title="Exhibit at CES"><img src="/print/images/framework/cesweb_exhibit1.png" alt="Exhibit at CES" name="cesweb_exhibit" onMouseOver="over(9)" onMouseOut="out(9)" /></a></div>
                ...
                <div style="display: none;">/print/cesgreening.asp/print/registration.asp/print/searchResults.asp/print/error404.asp/print/partners.asp/print/contactus.asp/print/sitemap.asp/print/privacyPolicy.asp/print/aboutces.asp/print/myCES.asp/print/aboutcea.asp</div>
                <div id="nav-bar">
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/print/news/default.asp" class="sublink"><!-- <img src="/print/images/framework/secondarynav_news.gif" /> --></a></li>
            ...
            <ul id="sub-sub-news3990" style="display: none;" onmouseout="setSubMenuTimer()">
                    ...
                    <li onmouseover="showSubMenu('news3990','show')"><a href="/print/news/up-to-minute-default.asp">CES Up to the Minute</a></li>
...
<div id="slideshow" >
    ...
    <A href="http://cesweb.org/showFloor/techzones.asp#3866"><img src="/print/images/homepage/CESweb-991X336-CHA_2.jpg"></A>
    ...
    <A href="/print/awards/innovations/callForEntries.asp"><img src="/print/images/homepage/Awards_Innovations_CFE.jpg"></A>
    <div class="slideCaption"><p><A href="/print/awards/innovations/callForEntries.asp">What's the best engineering and design innovation happening in consumer technology this year?</A><BR>
    <A href="/print/awards/innovations/callForEntries.asp">Maybe it's yours. >></a></div></p>
</li><li>
    
    <A href="/register"><img src="/print/images/homepage/Campaign_City1.jpg"></A>
    <div class="slideCaption"><p><A href="/register">September is the last month to register for free for the 2011 International CES. Sign up now! </A><BR>
    <A href="/register">Register.>></a></div></p>
</li><li>
    
    <A href="http://cesweb.org/exhibitors/default.asp"><img src="/print/images/homepage/ShowFloor_General8.jpg"></A>
    ...
    <A href="/print/awards/bestOfCES.asp"><img src="/print/images/homepage/CESweb_CNET.jpg"></A>
    <div class="slideCaption"><p><A href="/print/awards/bestOfCES.asp">CNET reporters are getting ready to scour CES for the Best of CES  >></A><BR>
    <A href="/print/awards/bestOfCES.asp"></a></div></p>
</li>
            </ul>
        </div>
    </div>
...
<div id="mid-bar">
    ...
    <a href="http://www.cesweb.org/stumbleupon" target="_blank"><img height="25" border="0" width="25" alt="stumbleupon" src="/print/images/framework/stumbleupon.gif"></a> 
...
<TD><A href="http://ces11.mapyourshow.com/search.cfm?search=featured" target=_blank><IMG src="/print/images/content/featured-exhibitors.jpg" border=0></A></TD>
