...
<P target="_blank"><SPAN class=text><A href="https://evisaforms.state.gov/ds156.asp?lang=1" target=_blank>ビザをお求めですか？現在、オンラインでビザ申請書をご記入いただけます。</A><BR><BR><A href="/docs/Japanese_JP_6443_2K11VisaTips_PRESS_READY.pdf" target=_blank>ヘルプが必要な場合は、弊社のビザ関連説明書をダウンロードし</A>、順を追った説明やウェブサイトアドレスなどの情報でビザ申請手続きの助力を得てください。<BR><BR>１月２０日より、<A href="http://travel.state.gov/visa/temp/without/without_1990.html#countries" target=_blank>ビザ免除プログラム</A>対象国から米国行きの旅行者は、米国国土安全保障省による旅行許可プログラムの電子システムを遵守しない場合、搭乗を拒否される場合があります。米国行きの海外旅行者は、<A href="https://esta.cbp.dhs.gov" target=_blank>ESTA ウェブサイトをご覧になり</A>、空路または海路による入国前に申請書に記入する必要があります。許可は２年間有効であり、更新が可能です。旅行ごとのI-94W書式への記入は必要なくなりました。</SPAN></P>
