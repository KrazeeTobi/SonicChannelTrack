...
<head><!-- PageID 4151 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <title>International CES - January 8-11, 2009 - August 2010 Venetian</title>
...
<br />
Since much of the Venetian Tower Exhibitor Manual content does not apply to Venetian Hospitality Suite exhibitors, we’ve created a section on CESweb exclusively for you! Be sure to review this <A href="/print/exhibitors/showPlanning/venetian-show-planning.asp">information</A> as you make your plans for CES.<BR><BR>Additional information can also be found in section 11 of the <A href="/print/exhibitors/showPlanning/exhibitor-manual.asp">Venetian Tower Exhibitor Manual</A>. Remember, Hospitality Suites are to be used for meetings or for hospitality purposes only. Exhibits may be constructed or installed and GES is not permitted to deliver freight to these suites.<BR><BR>Please contact <A href="mailto: gberube@ce.org">Gaiya Berube</A> with any questions you may have.<BR>
