...
<h2>签证信息</h2>
<SPAN class=text><STRONG><SPAN class=subhead>您需要签证吗？</SPAN><BR></STRONG><A href="https://evisaforms.state.gov/ds156.asp?lang=1" target=_blank>现在您可以上网填写签证申请表 。</A> <BR><BR><SPAN class=subhead><STRONG>需要帮助吗？<BR></STRONG></SPAN>有关按部就班的说明、网站地址和使您成功通过签证申请程序的其他信息，请下载 <A href="/print/docs/6680_ChineseVisaTip6.9.pdf" target=_blank>Visa Tip Sheet&nbsp; （签证提示单）。<BR></A><BR>来自 免签证计划 国家的入境美国旅行者，如果没有遵照美国国土安全部的旅游授权电子系统之指示，有可能被航空公司拒绝登机。该项规定自1月 20日起生效。现在，入境美国的国际旅行者必须在乘坐飞机或船入境美国之前，先登录 <A href="http://travel.state.gov/visa/temp/without/without_1990.html#countries" target=_blank>ESTA Web site</A> 网站，填妥申请表。如果获得批准，该项授权两年有效，并可以续签。旅行者每次旅行之前不再需要填写 I-94W 表。<A href="从 2009年1月12 日起，免签证国家的访美人员需上网登记并获得入境许可，这将成为新的旅游授权电子系统 (英文版)的一部分。 Link to: http://www.dhs.gov/xnews/releases/pr_1212498415724.shtm " target=_blank></A></SPAN>
<h2>旅行</h2>
<SPAN class=text><SPAN class=subhead><STRONG>需要知道如何抵达国际消费电子产品展 CES吗? <BR></STRONG></SPAN><A href="/print/hotelTravel/default.asp">请访问： travel section of CESweb.org&nbsp;(in English)</A> 以了解最理想的飞机票价、租车费率以及有关现场交通信息。<BR><BR><SPAN class=subhead><STRONG>需要知道住宿旅馆信息吗?</STRONG></SPAN><BR><A href="/print/hotelTravel/hotel.asp">访问:&nbsp; hotel section of CESweb.org (in English)</A> 网站的旅馆部分，预订团体和个人的旅馆住房。</SPAN>
