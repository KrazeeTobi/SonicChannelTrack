...
<head><!-- PageID 1137 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <title>International CES - January 8-11, 2009 - Programme Groupe Délégation</title>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <UL target="_blank">
<LI><A href="/print/docs/Interim_Brochure.pdf" target=_blank>Aperçu général, brochure en anglais (pdf) </A></LI>
<LI><A href="/print/docs/France_6673_2011CESfacts_FR_PRESS_READY(1).pdf" target=_blank>Feuille d’information CES traduite (pdf) </A></LI>
<LI><A href="/print/docs/2011_DL_Program_Description(2).pdf" target=_blank>Avantages pour les chefs de délégation et les délégués (pdf en anglais)</A></LI></UL>
    </div>
</div>
                    </div>
