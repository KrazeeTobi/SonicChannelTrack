...
<head><!-- PageID 2224 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Other Inquiries</title>
...
<body class="home" id="home">
    ...
    <div id="ctacontainer">
        ...
        <div id="register"><a href="/registration.asp" title="Register for CES"><img src="/images/framework/cesweb_register1.png" alt="Register" name="cesweb_register" onMouseOver="over(8)" onMouseOut="out(8)" /></a></div>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/showFloor/default.asp" class="sublink"><!-- <img src="/images/framework/secondarynav_exhibits.gif" /> --></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show')" class="link"><a href="/showFloor/innovation-movement.asp">Innovation Movement</a></li>
                
                    <li onmouseover="showDropDown('exhibits','show')" class="link"><a href="/showFloor/innovations-showcase.asp">Innovations Design and Engineering Showcase</a></li>
                
                    <li onmouseover="showDropDown('exhibits','show')" class="link"><a href="/showFloor/international-gateway.asp">International Gateway</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <a href="/stumbleupon" target="_blank"><img height="25" border="0" width="25" alt="digg" src="/images/framework/stumbleupon.gif"></a> 
...
<a class="back_to_top" href="#top">[back to top]</a>    
    ...
    <div>
        ...
        <ul>
            ...
            <li><a href="/conferenceProgram/conference-tracks.asp">More than 20 partners offer hundreds of conference sessions</li>
