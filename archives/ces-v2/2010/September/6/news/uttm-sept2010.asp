...
<head><!-- PageID 4259 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: September 1, 2010</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/news/default.asp" class="footer">News</a>&nbsp;&gt;&nbsp;<a href="/news/newsletters.asp" class="footer">Newsletters</a>&nbsp;&gt;&nbsp;<a href="/news/up-to-minute-default.asp" class="footer">CES Up to the Minute</a>&nbsp;&gt;&nbsp;September 1, 2010</div>
                        </div>
                        <div class="headerbox">
...
<IMG hspace=5 align=left src="/images/photos/MeetingRooms.jpg" width=165 height=125>Need a quiet place to meet with clients? Looking for alternatives to traditional booth space? You're in luck! CES features cost-effective options that provide a private, exclusive and quiet atmosphere to conduct business. Choose anything from suites in The Venetian or Las Vegas Hilton to meeting room space right on the show floor. 
<UL class=text>
...
<A href="/news/080410.asp">August 4, 2010</A><BR><A href="/news/CES-up-to-minute.asp">July 26, 2010</A>    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/news/uttm-sept2010.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
