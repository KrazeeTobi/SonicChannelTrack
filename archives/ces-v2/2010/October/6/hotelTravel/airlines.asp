...
<head><!-- PageID 3255 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Airline Discounts</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/hotelTravel/default.asp" class="footer">Hotel/Travel</a>&nbsp;&gt;&nbsp;Airline Discounts</div>
                        </div>
                        <div class="headerbox">
...
<IMG hspace=5 align=right src="/images/photos/Airlines190X136.jpg" width=190 height=136>Pack your bags and get ready for the world's largest consumer technology tradeshow, returning to Las Vegas in January 2011. <A href="/register">Register now</A>, and start thinking about flights early to get the best rate. <BR><BR>CES has partnered with the below airlines to bring you savings. Check this list often, as it will be updated as airlines are confirmed. 
...
AirTran is offering a 10 percent&nbsp;discount on the lowest available one-way fare to CES attendees and exhibitors. The discount is valid on travel to and from&nbsp;Las Vegas January 3-12. To book your travel, call 866-683-8368 and mention event code LAS010611 and event name 2011 CES. All discount travel reservations must be booked via the reservations phone number listed here; reservations cannot be made online. 
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<IMG hspace=5 align=right src="/images/content/AA-logo.jpg" width=175 height=24>American Airlines (AA) is offering a 5% discount to CES attendees and exhibitors. The discount is valid on travel to Las Vegas January 3-12*. Visit <A href="http://www.aa.com/">http://www.aa.com/</A> and enter 7211AG in the Promotion Code field. Tickets may also be purchased by calling 1-800-433-1790; please note, a $20 fee applies to tickets booked via phone. 
<P>*Note: Discount not valid in conjunction with any other discount; the use of AA codeshare requires that one segment of the itinerary be on AA equipment; discount not valid on Zone fares. <BR></P>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="4033"></a>

<div class="sub-content-header">Continental Airlines</div>
<br />

<IMG hspace=5 align=right src="/images/content/continentalAir.jpg" width=160 height=33>Continental Airlines is offering CES attendees and exhibitors discounts of 2-10 percent&nbsp;off published Zone fares. The discount is valid on travel to Las Vegas January&nbsp;3-12. Call your travel professional or Continental MeetingWorks at 800-468-7022 for reservations. Refer to Z Code ZJBU and Agreement Code 670378. Please note: There is a $20 fee for reservations made via MeetingWorks or any Continental Airlines ticketing facility.
<P>To avoid the $20 fee and to save an additional 3 percent, book your own reservations at <A href="http://www.continental.com/">http://www.continental.com/</A>. Choose your flight times and access your meeting discounts by inserting&nbsp;ZJBU670378 in the Offer Code box. <BR></P>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="4082"></a>

<div class="sub-content-header">Frontier/Midwest Airlines</div>
<br />

<STRONG>Frontier/Midwest Airlines is offering CES attendees and exhibitors a 10 percent&nbsp;discount</STRONG> off any available published* fare for tickets purchased at least sixty (60) days in advance. A 6% discount applies for tickets purchased within sixty (60) days. The discount is valid on travel to Las Vegas January 3-12. To book,&nbsp;you must&nbsp;call Midwest&nbsp;Groups&nbsp;department&nbsp;on <SPAN style="FONT-SIZE: 12pt; FONT-FAMILY: 'Times New Roman','serif'">888-601-4296 </SPAN>and provide the code CMZ1770. Agents are available Monday through Friday from 8:30 a.m. to 5 p.m. Central time.<BR><BR><SPAN ="smalltext">*Note: Discount is not applicable on flights that contain a Northwest airlines codeshare or other codeshare segment. Published fares are widely distributed and generally available. An unpublished or private fare is one that is restricted and only available to a specific group, such as Corporate Discounts, Land and Air Packages, or special last minute “internet-only” specials limited to select flights and dates.</SPAN>    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/hotelTravel/airlines.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
