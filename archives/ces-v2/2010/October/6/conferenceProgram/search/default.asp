...
<BR><div><label for='categoryID' title='Category'><strong>Program Track</strong>: </label><img width="10" height="2" src="/images/framework/spacer.gif"/><select id='categoryID' name='categoryID' tabindex='10'><option value='' selected='selected'>--- ALL ---</option><optgroup label='Program Track'><option value='2051'>Broadband Unlimited</option><option value='2010'>Cable Conference at CES</option><option value='1977'>CEA Research Summit at International CES</option><option value='1976'>CES Government 2011</option><option value='1979'>CONNECTIONS Summit</option><option value='2003'>Content in the Cloud</option><option value='2052'>Digital Health Summit </option><option value='1981'>Digital Hollywood</option><option value='1985'>Emerging Technology</option><option value='2048'>Flash Forward: Flash Memory Storage Solutions for Mobile Devices and Data Hungry Applications</option><option value='2049'>HigherEdTECH Summit</option><option value='1991'>Home Entertainment and Lifestyle Technologies</option><option value='2055'>IEEE: International Conference on Consumer Electronics (ICCE) </option><option value='1996'>In-Vehicle Technology</option><option value='1998'>Issues and Attitudes</option><option value='1999'>Just the Facts: Research, Reports and Revelations</option><option value='2000'>Keynotes</option><option value='2001'>Kids@Play and MommyTech</option><option value='2050'>Media Money Makers</option><option value='2006'>Silvers Summit</option><option value='2025'>SmartPhones and Tablet Conference</option><option value='2053'>Sports and Fitness Tech</option><option value='2007'>Storage Visions™ 2011</option><option value='2008'>SuperSessions</option><option value='2054'>Tech Policy Summit</option><option value='2009'>Technology and The Environment</option><option value='1978'>The Tweet House Presents: Social Media Success Stories</option><option value='2012'>THX Education Program: Home Theater and THX - Home Theater 1</option><option value='2015'>Wireless Communications</option></optgroup></select></div><BR><div><label for='speakerID' title='Speaker'><strong>Speaker</strong>:</label><img width="50" height="2" src="/images/framework/spacer.gif"/><select id='speakerID' name='speakerID' tabindex='15'><option value='' selected='selected'>--- ALL ---</option><option value='13814'>Belmont, Veronica</option><option value='13944'>Bocko, Peter</option><option value='13963'>Horn, John</option><option value='13956'>Inns, David</option><option value='13955'>Inouye, Brian</option><option value='13836'>Miller, Michael</option><option value='13953'>Pastorino, Paolo</option><option value='13959'>Rowley, Todd</option><option value='13841'>Rubin, Ross</option><option value='13943'>Villalpando, Edgar</option></select></div><BR><div><label for='locationID' title='Location'><strong>Location</strong>: </label><img width="46" height="2" src="/images/framework/spacer.gif"/><select id='locationID' name='locationID' tabindex='20'><option value='' selected='selected'>--- ALL ---</option><option value='1037'>Las Vegas Hilton</option><option value='1046'>LVCC, North Hall</option><option value='1047'>LVCC, South Hall</option></select></div><BR><div><label for='startsOnDate' title='Date'><strong>Date</strong>: </label><img width="69" height="2" src="/images/framework/spacer.gif"/><select id='startsOnDate' name='startsOnDate' tabindex='25'><option value='' selected='selected'>--- ALL ---</option><BR><BR><option value='2011-01-05'>1/5/2011</option><option value='2011-01-06'>1/6/2011</option><option value='2011-01-07'>1/7/2011</option><option value='2011-01-08'>1/8/2011</option><option value='2011-01-09'>1/9/2011</option></select></div><BR>
	<div>
