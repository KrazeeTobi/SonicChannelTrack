...
<head><!-- PageID 1415 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Tech & Engineering Emmy Awards</title>
...
<STRONG>Reception: 6:30 p.m. Thursday, Jan 6, 2011 <BR>Dinner: 7:30 p.m. <BR>The Venetian, Marcello Ballroom, Level 4 <BR></STRONG><BR><IMG border=0 hspace=8 align=right src="/images/content/Emmys_200.gif" width=200 height=112>The National Academy of Television Arts and Sciences (NATAS) has presented the <A href="http://emmyonline.tv/tech/" target=_blank>Emmy® Awards for Outstanding Achievement in Engineering /Technical Development</A> since 1948. For the&nbsp;fifth consecutive&nbsp;year, the awards&nbsp;will be&nbsp;presented at the International CES.<BR><BR>To buy tickets or for more information, contact Lauren Saverine at <A href="mailto:lsaverine@emmyonline.tv">lsaverine@emmyonline.tv</A> or 212-484-9440. 
<P>While you're awaiting the upcoming ceremony, rest your eyes on&nbsp;this list of the past ceremony's honorees. Plus, you can get more great information on the National Television Academy’s website at <A href="http://www.emmyonline.tv/tech" target=_parent>www.emmyonline.tv/tech</A>:</P>
<P><STRONG>NIELSEN CORPORATION</STRONG> <BR>For its Audience Measurement Technology System </P>
...
<P><STRONG>ELMER MUSSER</STRONG> <BR>For Pioneering Development of Automatic Transmitter Identification for Satellite Television Communication<BR><BR>Awards are presented to an individual, company, or to a scientific or technical organization for developments and/or standardization involved in engineering technologies which either represent an extensive improvement on existing methods or are so innovative in nature that they materially have affected the transmission, recording, or reception of television.<A >See more events.</A></P>
