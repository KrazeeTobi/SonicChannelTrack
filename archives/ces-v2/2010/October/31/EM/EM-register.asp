...
<head><!-- PageID 4506 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
...
<body class="home" id="home">
    ...
    <div id="ctacontainer">
        ...
        <div id="register"><a href="/EM/EM-register.asp" title="Register"><img src="/images/framework/cesweb_register1.png" alt="Register" name="cesweb_register" onMouseOver="over(8)" onMouseOut="out(8)" /></a></div>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <a href="/EM/default.asp"></a>
    <ul>
    
    <!--/EM/default.asp-->
    
            <li ><a href="/EM/ContentBrief/default.asp">Content Brief</a></li>
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/EM/default.asp" class="footer">Entertainment Matters</a>&nbsp;&gt;&nbsp;Register</div>
                        </div>
                        <div class="headerbox">
                       <h1>Register</h1>
                            <div class="icon_wrap">
...
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Entertainment Matters Email Request Form</title>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#createUser").live("click", function(ev) {
                ...
                var userSuccessfullyAddedMessage = "Congrats! You've been added to the Entertainment Matters mailing list.";
                var userAlreadyExistsMessage = "Looks like you're already on our mailing list!";
                var genericErrorMessage = "I'm sorry, there was an error. Please check your data and try again.";
...
<body>
    <div align="center">
        <table width="570" border="0" style="border: double #1a7fab" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <table class="main">
                        <tr align=left>
                            <td>
                                Registration for Entertainment Matters at CES will open in early November. <BR /><BR /><B>Enter your e-mail address below to be notified when registration is live.</B> 
                                <table class="form" id="Table1">
                                    <tr>
                                        ...
                                        <td>
                                            <img src="http://www.cesweb.org/images/framework/spacer.gif" height="1" width="455" border="0" alt="spacer" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
        ...
        <input type="hidden" id="lyrisInstance" value="0" />
        <!-- this value must match a list name on the corresponding lyris instance //-->
        <input type="hidden" id="lyrisList" value="em-interest" />
