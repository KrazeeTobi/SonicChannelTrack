...
<br /><A href="/docs/LVCC_Hilton_Deadline_Checklist(3).pdf" target==_blank>View the complete LVCC and Hilton Deadline Checklist</A>. This document includes all the dates you will need to place your orders and it's easy to print out to help you stay on track.
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
