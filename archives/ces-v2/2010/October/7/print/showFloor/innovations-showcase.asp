...
<head><!-- PageID 3958 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <title>International CES - January 8-11, 2009 - Innovations Design and Engineering Showcase</title>
...
<script type="text/javascript" src="/print/utilities/jquery.flow.1.2.auto"></script>

<script type="text/javascript" src="/print/utilities/jquery.colorbox-min"></script>

<script type="text/javascript" src="/print/utilities/jflickrfeed.min"></script>

<script type="text/javascript" src="/print/utilities/jquery.easing.1.2"></script>

<script type="text/javascript" src="/print/utilities/jquery.anythingslider"></script>

<script type="text/javascript" src="/print/utilities/jquery.countdown"></script>

<script type="text/javascript" src="/print/utilities/jquery.jfeed"></script>

<script type="text/javascript" src="/print/utilities/jquery.jgfeed"></script>
...
<body>
    ...
    <div id="ctacontainer">
        ...
        <div id="register"><a href="/registration.asp" title="Register for CES"><img src="/print/images/framework/cesweb_register1.png" alt="Register" name="cesweb_register" onMouseOver="over(8)" onMouseOut="out(8)" /></a></div>
...
<P>See the showcase in the <A href="/print/showFloor/by-hall.asp">Grand Lobby of the LVCC. </A></P><BR><BR>
<TABLE border=0 cellSpacing=1 cellPadding=1 width="100%">
<TBODY>
<TR>
<TD width="32%"><IMG src="/print/images/photos/INN190X136_2.jpg"></TD>
<TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
<TD width="32%"><IMG src="/print/images/photos/INN190X136_1.jpg"></TD>
<TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
<TD width="32%"><IMG src="/print/images/photos/INN190X136_3.jpg"></TD></TR>
<TR>
