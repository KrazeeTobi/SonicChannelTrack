...
<head><!-- PageID 4136 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <title>International CES - January 8-11, 2009 - Online Directory Sponsorships</title>
...
One exhibitor at this level will stand out in every way. Includes all of the features of the Gold Package PLUS: One exclusive sponsorship banner will be prominently displayed on the opening splash screen of interactive floor plan.&nbsp;Language above the banner may read: "Official Interactive Floor Plan Sponsor."&nbsp;Banner directs attendees to your&nbsp;five panel video/image&nbsp;and text listing on the floor plans.&nbsp;Statistics are available for tracking.&nbsp;Static banner (no animation).&nbsp;Banner specs: 666 x 80 pixels.
