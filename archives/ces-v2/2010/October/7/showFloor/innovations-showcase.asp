...
<head><!-- PageID 3958 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Innovations Design and Engineering Showcase</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li ><a href="/showFloor/innovation-movement.asp">Innovation Movement</a></li>
        
            <li class="selected"><a href="/showFloor/innovations-showcase.asp">Innovations Design and Engineering Showcase</a></li>
        
            <li ><a href="/showFloor/international-gateway.asp">International Gateway</a></li>
        </ul>
                            <br />
                        </div>
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/showFloor/default.asp" class="footer">Show Floor</a>&nbsp;&gt;&nbsp;Innovations Design and Engineering Showcase</div>
                        </div>
                        <div class="headerbox">
...
<TD vAlign=top><SPAN class=smallText><BR></SPAN></TD></TR></TBODY></TABLE><BR><BR>
    ...
    <div>
        ...
        <ul>
            ...
            <li><a href="/news/exhibitorNews.asp">Follow CES on Facebook</li>
            <li><a href="/news/coverage.asp">See all the latest CES news</li>
        </ul>
    </div>
    <div>
        <img src="/images/framework/sitelink_confprogram.gif" alt="SESSION HIGHLIGHTS">
        <ul>
            <li><a href="http://cesweb.org/sessions/search/results.asp?categoryID=1879">Want to speak at CES? Submit your application now</li>
            <li><a href="/conferenceProgram/conference-tracks.asp">2011 conference program lineup announced October 1</li>
            <li><a href="/KnowledgeTracks.asp">See services available to CES speakers</li>
        </ul>
    </div>
    <div>
        <img src="/images/framework/sitelink_events.gif" alt="EVENTS & AWARDS">
        <ul>
            <li><a href="/awards/techEmmys.asp">CEA offers events beyond CES</li>
            <li><a href="/events/mobile-apps-showdown.asp">Innovators: It's time to enter i-stage competition</li>
            <li><a href="/awards/innovations/2010honorees.asp">Best of CES, Innovations return to CES</li>
        </ul>
    </div>
    <div>
