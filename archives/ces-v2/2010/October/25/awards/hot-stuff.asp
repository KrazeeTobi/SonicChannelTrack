...
<head><!-- PageID 4460 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Hot Stuff</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/awards/hot-stuff.asp">Hot Stuff</a></li>
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/awards/default.asp" class="footer">Awards</a>&nbsp;&gt;&nbsp;Hot Stuff</div>
                        </div>
                        <div class="headerbox">
                       <h1>Hot Stuff</h1>
                            <div class="icon_wrap">
...
<IMG hspace=5 align=right src="/images/content/HotStuff_125.gif" width=125 height=189>Get ready for the inaugural 2011 CES Hot Stuff Awards. Here you'll find&nbsp;the 10 new product launches at CES that most impress&nbsp;<EM>Stuff</EM> magazine’s panel of gadget experts. They will pick the most desirable, most exciting and most innovative products from the show, choices perfectly reflecting <EM>Stuff's </EM>editorial mantra of “gadget joy.” <BR><BR>The 2011 CES Hot Stuff Awards will be reported on <A href="http://www.stuff.TV" target=_blank>stuff.TV</A> and across the magazine’s 29 international editions, reaching over eight million consumers worldwide.<BR><BR>Check out other <A href="/exhibitors/sponsorships/awards.asp">award programs at the 2011 International CES</A>, January 6-9, 2011, in Las Vegas, Nev.

    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/awards/hot-stuff.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
