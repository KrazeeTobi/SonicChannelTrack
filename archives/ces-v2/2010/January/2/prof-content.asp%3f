...
<div class="right-blue-box" align="center">
    <div class="right-blue-box-header">Content Quick Guide</div>
    
    <div>
        If you're a <A href="/docs/2010_QG_Content.pdf" target=_blank>content professional, download this quick guide</A> for a quick list of must-go, must-attend places and events at CES.
    </div>
</div>
<div class="right-blue-box" align="center">
...
<IMG height=125 hspace=6 src="/images/photos/p12.jpg" width=165 align=left border=0> 
<H2>Content at CES is Hot. Listen Here.</H2>NBC Universal, CBS Interactive and Sony are returning to the 2010 International CES along with an anticipated record number of content-focused exhibitors and attendees. Top executives from a range of major content companies, including ESPN, HULU, Nielsen, TiVo and the Walt Disney Company, will attend and speak at CES.<BR><BR>Big name exhibitors in CES’ Experience 3D TechZone include Mitsubishi, Technicolor , Hyundai, Fujifilm and Sensio. In fact, 3D will be on display throughout the entire show floor. In addition, the Open Mobile Video Coalition is sponsoring a Mobile DTV TechZone, complete with latest names from within this category.<BR><A href="https://cms.ce.org/register">Register before you get to Las Vegas to save $100 off the $200 on-site registration fee.</A><BR><BR>
<H3>Up Next at CES</H3><A href="http://cesweb.org/sessions/search/results.asp?categoryID=1879"><IMG height=221 hspace=5 src="/images/content/Up_Next_at_CESco.gif" width=245 align=right border=0>UP NEXT at CES</A> is a series of sessions that cuts through the new media hype and presents real-world strategies for monetizing all forms of media content across the most promising platforms. <A href="http://cesweb.org/sessions/search/results.asp?categoryID=1879">UP NEXT</A> is where the best creative, business and technical talent shares and compares the smartest ways to produce, promote and profit from media content, featuring: <BR><BR><BR>
<UL class=text>
...
<P class=text><A href="http://cesweb.org/sessions/search/results.asp?categoryID=1879">Learn more by watching a series of informative podcasts.</A></P>
<P class=text></P>
<P></P>
<P>
<H2>Up Next at CES Reception and CBS Television City Tour</H2>
<P></P>
<P>We cordially invite you to attend the Up Next at CES Reception, co-sponsored by CEA and Nielsen, following the sessions on Thursday, January 7, from 6-7 p.m. in the LVCC, North Hall, Booth N237. Then join us for a rare behind-the-scenes tour of Television City, CBS's state-of-the-art audience research facility in the MGM Grand hotel, immediately following the reception. Discover how researchers recruit, assign and test each visitor's reaction to programming, promotion and advertising using the latest methodology. Transportation to the MGM Grand will be provided. Space is limited and available on a first come, first serve basis, so be sure to fill out the sign-up form available outside of the session room on Thursday. Co-sponsored by CEA and Nielsen.<BR><BR></P>
...
<TR>
<TD>
<H3>How to Pick Your Sessions</H3>If you've already registered for CES: <A href="https://cms.ce.org/register">Login with your registration credentials</A>, and pick the sessions you want to attend.<BR><BR>If you haven't registered yet: <A href="https://cms.ce.org/register">Register now</A>, and start picking your sessions. </TD></TR></TBODY></TABLE><BR>
<H3>Content Exhibitors</H3>CES attracts hundreds of exhibitors whose products and services&nbsp;revolve around&nbsp;the development, enhancement, storage and/or distribution of content. This year's content exhibitor list? Still impressive: NBC Universal. Sony Pictures Television. Sling. DirectTV. EchoStar. Blockbuster, and TV Guide and Sony Pictures. <A href="http://myces.bdmetrics.com/Browse-Consumer-Electronics-Exhibitors-by-Category.aspx">Browse the 2010 International CES exhibitor directory for a complete list.</A><BR><BR>
<H3>Spotlight on Content</H3>Content at the 2010 International CES reaches far beyond our exhibitors. We've also got a number of <A href="/exhibits/displays/default.asp">CE Spotlights</A>, <A href="/exhibits/displays/techZones.asp">TechZones</A> and <A href="/events/default.asp">events</A> to pique the interest of content professionals. While you're at CES, don't forget to check out: 
<UL class=text>
<LI class=text><A href="/exhibits/displays/innovShowcase.asp">Innovations 2010 Design and Engineering Showcase</A> </LI>
