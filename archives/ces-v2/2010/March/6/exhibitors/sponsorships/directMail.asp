...
<head><!-- PageID 648 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    ...
    <title>2010 CES: Direct Mail/Online Ads</title>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/sponsorships/default.asp" class="footer">Promotional Opportunities</a>&nbsp;&gt;&nbsp;Direct Mail/Online Ads</div>
                    </div>
...
<br /><IMG height=228 src="/images/photos/onlinead.jpg" width=350 align=right>The official online source for all International CES information, CESweb.org attracts thousands of qualified, consumer technology professionals each day. Online ads, especially when placed on well-trafficked, highly visible pages, can be one of the most effective and affordable marketing vehicles today. Receive online space during the show's busiest online time — September through January.<BR><BR>Ads can appear on pages such as:<BR>&nbsp;<BR>Audio Page: <A href="http://cesweb.org/audio">http://CESweb.org/audio</A><BR>Digital Imaging Page: <A href="http://cesweb.org/digitalImaging">http://CESweb.org/digitalImaging</A><BR>Emerging Technology Page: <A href="http://cesweb.org/emergingTech">http://CESweb.org/emergingTech</A><BR>Gaming Page: <A href="http://cesweb.org/gaming">http://CESweb.org/gaming</A><BR>High-Performance Audio Page: <A href="http://cesweb.org/highPerfAudio">http://CESweb.org/highPerfAudio</A><BR>Home Networking/Systems Page: <A href="http://CESweb.org/homenetworking">http://CESweb.org/homeNetworking</A><BR>Home Theater/Video Page: <A href="http://CESweb.org/hometheater">http://CESweb.org/homeTheater</A><BR>In-Vehicle Technology Page: <A href="http://CESweb.org/invehicle">http://CESweb.org/inVehicle</A><BR>Wireless Page: <A href="http://CESweb.org/wireless">http://CESweb.org/wireless</A><BR><BR>Banner ads will run September 1, 2010-February 1, 2011. <BR><BR>Technical Specifications of Banner Ads: We accept the following formats: GIF and JPG.<BR><BR><STRONG>Marketing Investment<BR></STRONG>CES Exhibitors: $7,500 <BR><BR><STRONG>Contact<BR></STRONG>Manager, Promotional Opportunities, CES<BR>Phone: 703-907-4324<BR>E-mail: <A href="mailto:byb@CE.org">byb@CE.org</A><BR>&nbsp;
...
<br />Communicate with CES attendees through full, dedicated HTML e-mail blasts. These blasts are created entirely by you and will be sent out directly by CES on your behalf. Through each e-mail blast, you will have the opportunity to reach more than 200,000 readers including 2011 CES pre-registrants, 2010 attendees, prospects, international attendees, VIP buyers and more. 
<P><STRONG>Marketing Investment<BR></STRONG>$15,000+</P>
<P><STRONG>Restrictions:</STRONG><STRONG></P>
<UL class=text>
<LI class=text></STRONG>Must be a an International CES exhibitor</STRONG> </LI></STRONG>
<LI class=text>Promotion must pertain to exhibitor’s presence at the CES, and include CES logo, show dates and website. All images and files must be housed on exhibitor’s own server. CEA will not be able to house your images for you.</LI></UL><BR><STRONG>Contact</STRONG><BR>Manager, Promotional Opportunities, CES<BR>Phone: 703-907-4324<BR>E-mail: <A href="mailto:byb@CE.org">byb@CE.org</A>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibitors/sponsorships/directMail.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
