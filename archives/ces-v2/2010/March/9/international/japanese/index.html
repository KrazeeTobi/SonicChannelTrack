...
<head><!-- PageID 1168 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: 日本語</title>
...
<div class="right-blue-box" align="center">
    <div class="right-blue-box-header">CES教育セッション</div>
    
    <div>
        家電業界で成功するために必要な知識でスケジュールを埋め尽くしてください。<BR><BR><A href="/sessions/default.asp">2010 CES基調演説と教育セッション（英語）をご覧ください。</A>
    </div>
</div>
<div class="right-blue-box" align="center">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        ...
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Resources</a>&nbsp;&gt;&nbsp;日本語</div>
                    </div>
...
新技術の公開の場であるInternational CESは、130か国から10万人を超える来場者が集う世界的規模の主要イベントです。政策決定者、報道関係者やアナリストと交流しましょう。2,000を上回る出展社の新技術をチェックし、画期的な製品をご覧ください。<A href="/docs/2010FACTSHEET_Japanese.pdf" target=_blank>ショーの来歴、現在の製品カテゴリ、今後の予定などもご確認ください。</A>
...
<div class="sub-content-header">新会場： ICC（国際商業センター）</div>
<br />

<EM>LVCC、北ホール、ブース番号5235</EM><BR><BR>LVCCの北ホール、ブース番号5235に新たに設置されたICCは、海外のビジターや出展社がインターネットステーションでオフィスと連絡を取り合ったり、プライベートな会議室を予約・利用したり、軽食をとったり、くつろいだりする場所です。国際ゲートウェイに近く、国際登録所にも隣接した便利な場所にあるため、CES滞在中の「出張オフィス」として利用できます。<A href="/docs/ICC_bread_crumb_map.pdf" target=_blank>をダウンロードして、新しいICCの場所にマップされます。</A> 
<P><A href="http://cesweb.org/international/japanese/services.asp">海外からの出席者向けのサービスに関する詳細は、こちらでご確認ください。<BR></A></P>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />
...
<A href="http://cesweb.org/international/japanese/travel.asp">旅行とビザ情報</A><BR>米国の出入国の際に役立つ情報です。<BR><BR><A href="/international/japanese/delegations.asp">代表団プログラム</A><BR>ご好評をいただいている代表団プログラムにより、国際CESでは国外からも多数の参加者が集まります。あなたの国や地域で代表団を組織する方法、代表団に参加する方法についてはこちらをご覧ください。
<P><A href="/international/japanese/services.asp">国際サービス</A><BR>外国からの参加者の方へは、通訳者、特別なネットワーク作りのためのレセプション、専用の作業エリア、会議室など、その他多数のサービスをご用意しています。<BR><BR><A href="/docs/2009FACTSHET_q6_JA.pdf" target=_blank>一般情報<BR></A>展示会の沿革、現在の製品カテゴリ、今後の予定など、各国語で紹介します！ </P>
<P>&nbsp;</P>    

                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/international/japanese/default.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
