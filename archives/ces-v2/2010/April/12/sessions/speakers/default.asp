...
<head><!-- PageID 317 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Call for Speakers</title>
...
Thank you for your interest in a 2010 International CES speaking opportunity. 
<H5>The Call for Speakers has officially closed. <A href="/sessions/speakers/cfsFAQ.asp">Questions about your submission?</A> </H5>
<P><A href="http://www.cesweb.org/CFS-signup">Sign up to be&nbsp;put on a back-up list</A> for reference in case of speaker cancellations. This year's topics include:<BR></P>
<P></P>
<H3>Home Entertainment &amp; Lifestyle Technologies</H3>
<UL>
<LI>Pay TV’s Days Numbered? </LI>
<LI>Defining Internet TV </LI>
<LI>3DTV: Hope or Hype? </LI>
<LI>The New User Interface: Who Needs Buttons and Dials? </LI>
<LI>TV Displays: How Long Will LCD Stay King? </LI>
<LI>Sizing Up the Small Screen </LI>
<LI>Streaming Salvation to the Music Industy </LI>
<LI>Beyond Point-and-Shoot: A Glimpse into the Future of Digital Imaging! </LI>
<LI>Netbooks: Here to Stay or Passing Fancy? </LI>
<LI>Taking iLife to the Next Level </LI></UL>
<H3>Wireless Communications</H3>
<UL>
<LI>4G: The Next Big Thing in Mobile Phones? </LI>
<LI>Superphones: One Device to Rule Them All? </LI>
<LI>Why Is the Smartphone OS Ecosystem So Complex? </LI>
<LI>Wireless Entertainment: Untethering the TV </LI>
<LI>TV to Go </LI>
<LI>GPS Navigation: What’s Down the Road?</LI></UL>
<H3>Emerging Technology</H3>
<UL>
<LI>Emerging Tech: Hot or Not? </LI>
<LI>Power to the People: Advances in Charging and Battery Technology </LI>
<LI>Location-Based Services: The Next Social Networking Frontier? </LI></UL>
<H3>International/ Issues &amp; Attitudes</H3>
<UL>
<LI>A Global Meeting of the Telco Minds</LI></UL>
<H3>In-Vehicle Technology</H3>
<UL>
<LI>Broadband in Your Car</LI></UL>
<H3>SuperSession</H3>
<UL>
<LI>Staying Competitive in Turbulent Times </LI></UL>
<H3>Just the Facts: Research, Reports, Revelation</H3>
<UL>
<LI>Presentations on recent CE research topics.&nbsp;The Just the Facts&nbsp;submission process ended on July 8, 2009.</LI></UL>

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/sessions/speakers/default.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
...
<!--/sessions/speakers/JTF-info.asp--><!--/sessions/speakers/JTF.asp-->-->
