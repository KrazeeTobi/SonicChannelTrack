...
<head><!-- PageID 852 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Innovation Movement</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
       ...
       <!-- Start Search/MyCES Row -->
            ...
            <li class="selected"><a href="/exhibits/displays/expCEA.asp">Innovation Movement</a></li>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibits/default.asp" class="footer">Exhibits</a>&nbsp;&gt;&nbsp;<a href="/exhibits/displays/default.asp" class="footer">CE Spotlights</a>&nbsp;&gt;&nbsp;Innovation Movement</div>
                    </div>
                    ...
                    <div id="inner-content-long">
                        <h1>Innovation Movement</h1>
                                                               
                        

<STRONG><IMG height=90 hspace=5 src="/images/content/InnovMvt.jpg" width=170 align=right>What?<BR></STRONG>Innovation is vital to our economy and is the key to a prosperous American future. Innovation requires attracting the best and brightest to the U.S., free trade, reducing the federal deficit, encouraging entrepreneurship, a flexible workforce and a government valuing the contribution of business. <BR><BR>The Innovation Movement is a community of industry professionals, entrepreneurs and all Americans who believe innovation will promote American global leadership and economic recovery and growth. Visit The Innovation Movement booth in the Grand Lobby and <A href="http://innovation-movement.com" target=_blank>join today!</A><BR><BR><STRONG>Where?</STRONG><BR>LVCC, Grand Lobby

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibits/displays/expCEA.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
