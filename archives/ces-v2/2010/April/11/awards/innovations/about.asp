...
<head><!-- PageID 314 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2010 CES: About Innovations</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
       ...
       <!-- Start Search/MyCES Row -->
            ...
            <li ><a href="/awards/innovations/honoreeUtilities.asp">Honoree Benefits</a></li>
...
<TD width="50%">August 24, 2009</TD></TR>
<TR>
<TD>Early-bird Deadline</TD>
<TD>September 4, 2009</TD></TR>
<TR>
<TD>DEADLINE EXTENDED</TD>
<TD>September 29, 2009*</TD></TR>
<TR>
<TD>Innovations Judging</TD>
<TD>October 2-14, 2009</TD></TR>
<TR>
<TD>Entrants Notified</TD>
<TD>October 23, 2009</TD></TR>
<TR>
<TD>Innovations Honorees Announced</TD>
<TD>November 10, 2009**</TD></TR></TBODY></TABLE><BR><SPAN class=smallText>*This is the final deadline. Access to the site will be disabled at&nbsp;11:59&nbsp;p.m. (EST) Friday, September 25, 2009. <BR><BR>**Innovations Honorees will be announced in New York at the 2010 International CES Press Preview. If a company does not wish to have their product announced, companies should indicate&nbsp;so on the online entry form, or by e-mail by October 30, 2009. The Innovations Awards Team will do its best to delay the product announcement until the opening of International CES.&nbsp;However, we can make no guarantees. <BR></SPAN><BR>
<H4>Program Fees (Per Entry)</H4><BR>Submit your entries before September 4, 2009, and save $200. Entry fees are non-refundable.<BR><BR>
<TABLE cellSpacing=0 cellPadding=3 width="80%" border=1>
<TBODY>
<TR>
<TD>&nbsp;</TD>
<TD vAlign=top><STRONG>Early-bird Entry Fee<BR>(Deadline: Sept. 4)</STRONG> </TD>
...
<br />The Innovations 2010 online entry process is easy to use. It includes: 
<UL class=text>
...
<LI class=text>Video link tool</LI></UL><BR>Apply online between August 24 and September 25, 2009.
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<LI class=text>Receive additional exposure by displaying your product in the Innovations Design and Engineering Awards Showcase at the 2010 International CES (for official International CES exhibitors only). </LI>
...
<P class=text>Download all of the <A href="/docs/2K10Innovations_Benefits.pdf" target=_blank>2010 Innovations Honoree Benefits</A></P>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<br />If you've recently introduced a product that has raised the standard of consumer electronics innovation, chances are it deserves an Innovations 2010 Design and Engineering Award. <BR><BR>Entries must qualify for each of the following criteria: 
<P></P>
<UL class=text>
<LI class=text>Products entered must fit within one of the official award categories. </LI>
<LI class=text>Products entered must be available for sale or accessible&nbsp;to the public in U.S. retail outlets or on the Internet between March 1, 2009, and April 30, 2010. </LI>
<LI class=text>Entries must be submitted, in full, via the online entry process.&nbsp;&nbsp; </LI>
<LI class=text>One sample of all International CES exhibitor products (mock-ups or the final product) selected as Innovations honorees must be available for display in the Innovations Showcase at the 2010 International CES, January 7-10, in Las Vegas, Nevada. Best of Innovations honorees and Eco-Design and Sutstainable Technology Honorees will allow CEA to hold one sample of the product or mockup for up to one year, for display at other CEA-related events.</LI></UL>
<P><A title="Innovations 2010 Rules and Guidelines" href="/docs/2K10Innovations_Rules.pdf" target=_blank>Download a complete copy of the Innovations 2010 Design and Engineering Awards Rules and Eligibility</A></P>
<P>Honorees will be announced at the 2010 International CES Press Preview event in New York, November 10, 2009, and will be included in the launch of the honoree portion of the International CES website (see contest rules).</P>
<P>Non-exhibitors may also enter the Innovations 2010 competition; however, restrictions apply if selected as an honoree (see contest rules).</P>
<P>Entrants agree to these rules:</P>
<UL class=text>
<LI class=text>Products entered must fit within one of the official award categories. </LI>
<LI class=text>Products entered must be available for sale or accessible to the public at U. S. retail outlets or on the Internet between March 1, 2009, and April 30, 2010. </LI>
<LI class=text>Honorees will be announced at the 2010 International CES Press Preview event in New York, November 10, 2009, and will be included in the launch of no later than October 30, 2009.&nbsp;&nbsp; </LI>
...
<LI class=text>One sample of all International CES exhibitor products (prototypes, mock ups or the final product) selected as Innovations honorees must be available for display in the Innovations Design and Engineering Awards Showcase at the 2010 International CES, January 7-10, in Las Vegas, Nevada. Best of Innovations honorees and Eco-Design and Sutstainable Technology Honorees will allow CEA to hold one sample of the product or mockup for up to one year, for display at other CEA-related events </LI>
<LI class=text>Non-International CES exhibitors may enter the Innovations 2010 competition. However, non-exhibitor honoree product will not be included for display in the Innovations 2010 Design and Engineering Showcase and will not be listed in the on-site honoree directory if the company has fully paid for an exhibit space by October 30, 2009, they can be listed in the onsite directory and the product displayed in the Innovations Design and Engineering Showcase.&nbsp;&nbsp;However, if the company has fully paid for an exhibit space by October 30, 2009, they can be listed in the onsite directory and the product displayed in the Innovations Design and Engineering Showcase. </LI>
<LI class=text>Entries must be submitted, in full, via the online entry process. </LI>
...
<TR>
<TD vAlign=top>
<P>Audio Accessories<BR>Audio Components<BR>Computer Accessories<BR>Computer Hardware<BR>Computer Peripherals<BR>Digital Imaging<BR>Eco-Design and Sustainable Technology <BR>Electronic Gaming Hardware<BR><EM><FONT color=#00008b>NEW! </FONT></EM>Electronic Gaming Software<BR>Enabling Technologies <BR>Headphones<BR>Health and Wellness<BR></P></TD>
<TD vAlign=top>
<P>High-Performance Audio<BR>Home Appliances<BR>Home Networking<BR>Home Theater Accessories<BR>Home Theater Speakers<BR>In-Vehicle Audio<BR>In-Vehicle Accessories<BR>In-Vehicle Control/OEM Integration<BR>In-Vehicle Navigation/Telematics/ITS<BR>In-Vehicle Video<BR>Integrated Home Systems<BR>Multi-Room Audio/Video<BR><BR><BR></P></TD>
<TD vAlign=top>
<P><FONT color=#00008b><EM>NEW! </EM><FONT color=#000000>Online Audio/Video Content Delivery</FONT><BR><EM>NEW! </EM></FONT><FONT color=#000000>Online Retail<BR></FONT>Personal Electronics<BR>Portable Media Accessories<BR>Portable Media Players<BR>Portable Power<BR><EM><FONT color=#00008b>NEW! </FONT></EM>Social Networking<BR>Video Accessories<BR>Video Components<BR>Video Displays <BR>Wireless Handsets Accessories<BR>Wireless Handsets</P></TD></TR></TBODY></TABLE><BR>Need more information? View&nbsp;awards category definitions&nbsp;by downloading the <A title="2010 Innovations Category Guide" href="/docs/2K10Innovations_Guide.pdf" target=_blank>2010 Innovations Awards Category Guide</A>, detailing examples of products for each category.
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<LI>Complete and submit your entry form online between Monday, August 24 and Friday, September 25, 2009. </LI>
...
<LI class=text>Don't submit an entry that will not be commercially available by April 30, 2010. </LI>
<LI class=text>Don't submit an entry that has been available in the United States at retail before March 1, 2009. </LI>
<LI class=text>Up to five different views of your product can be uploaded during the entry process. Show off that awesome design! Take advantage of it!</LI></UL><BR><STRONG>Remember:</STRONG> If you are selected as an honoree and a 2010 International CES exhibitor, you are required to make your product available for the Innovations Showcase during the 2010 International CES, January 7-10, 2010.
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<LI class=text>How the design and innovation of this product directly compare to other products in the market place<BR></LI></UL><BR>Judges review and evaluate each ECO-DESIGN and SUSTAINABLE TECHNOLOGIES entry based on summaries of the following criteria:<BR><BR>
<UL class=text>
