...
<head><!-- PageID 2224 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Other Inquiries</title>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/faq/default.asp" class="footer">FAQs</a>&nbsp;&gt;&nbsp;<a href="/faq/venueFAQs.asp" class="footer">FAQs by Venue</a>&nbsp;&gt;&nbsp;Other Inquiries</div>
                    </div>
...
Yes. CES exhibitors can rent space for <STRONG>one day only </STRONG>at the Las Vegas Hilton. The fee to rent the&nbsp;meeting room is $250 per room for four or less hours; anything rented for more than four hours is $500 per room. You can request space at either of these properties by completing the <A href="/docs/2010_CES_Meeting_Room_Application.pdf" target=_blank>2010 CES one day meeting space application (pdf).</A> <BR><BR>Please note that the space at the Las Vegas Hilton&nbsp;is available for one day only; this space <STRONG>cannot</STRONG> be rented for multiple days. If you wish to rent meeting space for the duration of the show, please contact Pam Sydnor in CES Sales (<A href="mailto:psydnor@CE.org">psydnor@CE.org</A>). <br>
<a class="back_to_top" href="#top">[back to top]</a>    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibitors/other-FAQs.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
