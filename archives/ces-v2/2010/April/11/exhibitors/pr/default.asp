...
<head><!-- PageID 358 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: PR Help</title>
...
Eighty-five percent of all CES exhibitors cite press/media coverage as one of the most important reasons for attending the show. It's easy to see why PR is oftentimes the highest priority for exhibitors at the International CES. The more than 5,000 media who cover CES each year are able to get a company's name into the minds of millions of consumers with the simple stroke of a keyboard. Let us help you reach the media.<BR><BR>
...
<TR>
<TD>
<H3>MAJOR CES ANNOUNCEMENT: PRESS KIT PROCESS&nbsp;GOES GREEN</H3>
<P>This year, the International CES press kit area is going green! To reduce our environmental footprint and in accordance with media feedback, the LVCC press room will only house electronic exhibitor press kits. If you area 2010 CES exhibitor, you&nbsp;are welcome to bring in a one-page spec sheet that lists media contacts and the URL that houses the electronic press kit.&nbsp;You can also bring in USB drives and CDs. Printed press materials greater than one page in length should be stored in your booth.&nbsp;</P></TD></TR></TBODY></TABLE><BR>
<H3><A href="/exhibitors/pr/exhibitorPRnl.asp">Exhibitor PR Newsletter</A></H3>This monthly newsletter helps you keep your public relations efforts in check with valuable tips, deadline reminders and breaking news.<BR><BR>
<H3><A href="/exhibitors/pr/prList.asp">Pre-Registered Media/Analyst List</A></H3><STRONG>Login required<BR></STRONG>View a list of media and analysts who are pre-registered for the 2010 International CES and the CES Unveiled pre-CES press events.&nbsp; <BR><BR><BR>
<TABLE style="BORDER-RIGHT: #9f9f9f 1px solid; BORDER-TOP: #9f9f9f 1px solid; BORDER-LEFT: #9f9f9f 1px solid; BORDER-BOTTOM: #9f9f9f 1px solid" cellPadding=8 width="100%" border=0>
<TBODY>
<TR>
<TD><B>Essential PR Tip</B><BR><A href="https://myces.bdmetrics.com/ExhibitorPortal/EventLogin.aspx" target=_blank>Update your PR contact information</A> so journalists and broadcasters can find you. You must do this through your company's&nbsp;<A href="https://myces.bdmetrics.com/ExhibitorPortal/EventLogin.aspx" target=_blank>MyCES Exhibitor Portal</A>. (Note: Exhibitor login credentials were e-mailed to the main exhibitor representative we have on file. If you're not sure who this contact is, <A href="mailto:acarney@CE.org">e-mail Allison Carney</A>.)</TD></TR></TBODY></TABLE>

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibitors/pr/default.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
