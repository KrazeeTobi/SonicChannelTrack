...
<head><!-- PageID 3304 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: September 2, 2009</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
       ...
       <!-- Start Search/MyCES Row -->
            ...
            <li class="selected"><a href="/news/upToTheMinute/090209.asp">September 2, 2009</a></li>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/news/default.asp" class="footer">News</a>&nbsp;&gt;&nbsp;<a href="/news/upToTheMinute/default.asp" class="footer">CES Up to the Minute</a>&nbsp;&gt;&nbsp;September 2, 2009</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/news/upToTheMinute/090209.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>September 2, 2009</h1>
                                                               
                        

CES is about 100 days away, but the deadline for free registration is coming up soon. <A href="/register">Register for the 2010 CES by October 1 to save up to $200</A>. And in the meantime, see what's coming together on the CES show floor. Robotics, eBooks and other future-shaping technologies are coming to Las Vegas on January 7.
...
<div class="sub-content-header">Is CES the Right Tradeshow for You?</div>
<br />

You may have heard that CES attracts in the ballpark of 110,000 attendees from 140 countries, but WHO are they exactly? Are you right for CES? <BR>First, you need to be in the consumer technology industry. Plus, you need to be over 16. Attendees include: manufacturers, retailers, content providers and creators, broadband developers, wireless carriers, cable and satellite TV providers, installers, engineers, corporate buyers, government leaders, financial analysts and the media.<BR><BR>The International CES features products — and the companies that create them — from many different consumer technology markets. The show floor is organized by color-coded zones, allowing attendees to easily find each exhibitor as they navigate through the largest consumer technology tradeshow. If you do business in one of these markets, CES is likely THE place for you to network, investigate new technology and strike deals for the upcoming year.<BR><BR>
<TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
<TD vAlign=top>Accessories<BR>Audio Hardware &amp; Software<BR>Blank Media<BR>Bluetooth Technology<BR>Broadband Technology<BR>Car Audio<BR>Computer Hardware &amp; Software<BR>Content Distribution<BR>Content Production<BR>Digital Car<BR>Digital Hollywood<BR></TD>
<TD vAlign=top>Digital TV/HDTV<BR>E-Commerce&nbsp; Electronic Gaming<BR>Global Positioning Systems<BR>Handheld Information Devices<BR>High-performance Audio <BR>Home Appliances<BR>Home/Personal Healthcare<BR>Home Security &amp; Automation<BR>Home Theater &amp; Custom InstallationInternet Applications &amp; Services<BR>In-Vehicle Technology<BR>MP3/Internet Audio&nbsp; Personal Electronics<BR></TD>
<TD vAlign=top>Photography/Digital Imaging<BR>Retail Resources<BR>Robotics<BR>Satellite Systems<BR>Small Office/Home Office<BR>Speech Technology<BR>Telematics &amp; Vehicle Navigation<BR>Telephony Equipment<BR>Video Hardware &amp; Software<BR>Wi-Fi Technology<BR>Wireless/Mobile Communications<BR></TD></TR></TBODY></TABLE>There's only a month left for free registration. <A href="/register">Register now</A> to get your Exhibits Plus pass for access to all exhibits, TechZones, SuperSessions and keynote addresses.<BR>The fee structure for admission to all exhibits, TechZones, SuperSessions, keynotes and selected conference sessions has changed. Please take note of these important dates:
<UL class=text>
<LI class=text>Before October 1, 2009: $0 </LI>
<LI class=text>October 1, 2009-January 2, 2010:&nbsp; $100 </LI>
<LI class=text>After 5:01 p.m. EST, January 2, 2010: On-site $200 </LI></UL>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3316"></a>

<div class="sub-content-header">What’s New on the CES Show Floor</div>
<br />

You know the consumer technology industry changes quickly - almost as quickly as a teenager can text these days. And as a direct reflection of the industry it represents, the CES show floor is constantly evolving and adapting, too. CES veterans know to expect something new each year. Let us give you a glimpse into what’s in the works that’s never been on the show floor before.<BR><BR><A href="/exhibits/displays/techZones.asp"><IMG border=0 hspace=5 align=right src="/images/content/techzone-120.gif" width=120 height=28></A>Beyond traditional exhibit space and exhibitors, the CES show floor, which includes the Las Vegas Convention Center and the Hilton, and The Venetian, also features CE Spotlights and TechZones, market-specific areas that truly feel like mini tradeshows. With about 10 CE Spotlights and 20 TechZones slated for 2010, you have a great opportunity to dive into some thriving tech niches and get to know who’s up-and-coming and what technology’s on the horizon.<BR><BR><STRONG>New TechZones for 2010:</STRONG><BR>
<TABLE border=0 cellSpacing=1 cellPadding=1 width="75%">
<TBODY>
<TR>
<TD vAlign=top><A href="http://cesweb.org/exhibits/displays/techZones.asp#3151">Digital Health </A><BR><A href="http://cesweb.org/exhibits/displays/techZones.asp#3270">eBooks</A><BR><A href="http://cesweb.org/exhibits/displays/techZones.asp#3247">Experience 3D</A><BR><A href="http://cesweb.org/exhibits/displays/techZones.asp#3155">HigherEd Tech</A><BR><BR></TD>
<TD vAlign=top><A href="http://cesweb.org/exhibits/displays/techZones.asp#3157">Industrial Design <BR>Mommy Tech</A><BR><A href="http://cesweb.org/exhibits/displays/techZones.asp#3008">Netbooks</A> <BR></TD></TR></TBODY></TABLE><BR><A href="/exhibits/displays/techZones.asp">See a full list of TechZones</A>.<BR><BR><STRONG>New CE Spotlights for 2010:</STRONG><BR>
<TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
<TD>
<P align=center><A href="/exhibits/displays/ehx.asp"><IMG border=0 align=middle src="/images/content/spot-ehx.jpg" width=130 height=35></A></P></TD>
<TD>
<P align=center>&nbsp;<A href="/exhibits/displays/livingDigital.asp"><IMG border=0 align=middle src="/images/content/spot-digTimes.jpg" width=130 height=40></A></P></TD>
<TD>
<P align=center>&nbsp;<A href="/exhibits/displays/sustaintablePlanet.asp"><IMG border=0 align=middle src="/images/content/spot-susPlanet.jpg" width=130 height=55></A></P></TD></TR>
<TR>
<TD>
<P align=center><A href="/exhibits/displays/ilounge.asp"><IMG border=0 align=middle src="/images/content/spot-iLounge.jpg" width=70 height=63></A></P></TD>
<TD>
<P align=center><A href="/exhibits/displays/LBS.asp"><IMG border=0 align=middle src="/images/content/spot-lbs.jpg" width=90 height=40></A></P></TD>
<TD>&nbsp;</TD></TR></TBODY></TABLE><BR><A href="/exhibits/displays/default.asp">See all the CE Spotlights</A>.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3315"></a>

<div class="sub-content-header">Innovations 2010 Wants Your Brilliant Designs </div>
<br />

<A href="/awards/innovations/default.asp"><IMG border=0 hspace=5 align=left src="/images/content/2010_innovations.jpg" width=98 height=150></A>You don't have to be a CES exhibitor to grab the spotlight at CES. <A href="/awards/innovations/default.asp">The International CES® Innovations 2010 Design and Engineering Awards</A> is the most impressive and renowned awards program in the consumer technology industry. Receive all the recognition your brilliant new designs and products deserve by entering the competition at CESweb.org/Innovations. The Call for Entries is open through September 25, but enter by September 4 to save $200 on the entry fee.<BR><BR>Thousands of industry leaders and press flock to CES to witness the "next big thing" at the <A href="/awards/innovations/default.asp">Innovations 2010 Design and Engineering Awards Showcase</A>. Being an Innovations Honoree provides you with incredible opportunities, special recognition in the CE industry and worldwide exposure for your company and products. Visit CESweb.org/Innovations for complete details, benefits and to enter your product today.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3314"></a>

<div class="sub-content-header">CES Buzz of the Week: eBooks TechZone</div>
<br />

<IMG height=28 hspace=5 src="/images/content/techzone-120.gif" width=120 align=left border=0>The eBooks TechZone at the 2010 International CES features an evolving product and service category that has been moving steadily into the mainstream over the past several years. This category includes the eBook, eBook reader device and eBook reader. The eBook reader device allows consumers to carry thousands of books, newspapers and other media in one device.<BR><BR>Do you make eBooks technology? Consider exhibiting in the eBooks TechZone. <A href="/exhibitors/space/default.asp">Space is still available</A>, but it won’t last long.<BR><BR><A href="/exhibits/displays/techZones.asp">See a complete list of TechZones slated for the 2010 CES.</A>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3313"></a>

<div class="sub-content-header">Money-Saving Tip: Continental Airlines Offers CES Attendees Travel Discount</div>
<br />

We know the economy has impacted everybody's wallet. So in each issue of CES Up to the Minute, we'll give you at least one way to save money. This time around, here's our advice: Fly Continental. Continental Airlines is offering CES attendees and exhibitors discounts of 2-10% off published Zone fares. <BR><BR><IMG border=0 hspace=5 align=right src="/images/content/ContinentalAirlines.gif" width=150 height=41>The discount is valid on travel to Las Vegas January 4-7 and returning January 10-13. Call your travel professional or Continental MeetingWorks at 800-468-7022 for reservations. Refer to Z Code ZGBQ and Agreement Code DKG7TQ. Please note: There is a $20 fee for reservations made via MeetingWorks or any Continental Airlines ticketing facility.<BR><BR>To avoid the $20 fee and to save an additional 3 percent, book your own reservations at <A href="http://www.continental.com/">http://www.continental.com/</A>. Choose your flight times and access your meeting discounts by inserting ZBGQDKG7TQ in the Offer Code box.<BR><BR><A href="/hotelTravel/airlines.asp">See what other airlines are offering cheaper fares for CES goers</A>.<BR>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3312"></a>

<div class="sub-content-header">Robotics Trends to Sponsor Robotics TechZone at CES</div>
<br />

<IMG border=0 hspace=5 align=right src="/images/content/Robotics.gif" width=120 height=107>For companies to maximize their potential for success in the consumer robotics market, as well as grow the market as a whole, they must be able to identify, meet with and educate prospective customers and partners more effectively and rapidly than their competitors.&nbsp; <BR><BR><A href="http://cesweb.org/exhibits/displays/techZones.asp#3237">The CES Robotics TechZone</A> was designed specifically to do just that. It presents a unique opportunity for companies and individuals to become active participants in a new technology industry poised for massive growth&nbsp;- consumer robotics.<BR><BR>If you like this <A href="/exhibits/displays/techZones.asp">TechZone</A>, you may also like to see what else is going on in <A href="/emergingTech/default.asp">emerging technology</A>.<BR>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3309"></a>

<div class="sub-content-header">Stay at the Newest Las Vegas Address - Opening December 2009!</div>
<br />

<A href="http://www.citycenter.com/" target=_blank><IMG height=107 hspace=5 src="/images/content/CityCenter.gif" width=150 align=left border=0>CityCenter</A>, an extraordinary urban resort destination brought to life by <A href="http://www.citycenter.com/press_room/press_room_architects.aspx" target=_blank>eight world-renowned architects</A>, will be defined by magnificent design, renowned for premier experiences and unrivaled as the address to live and live it up. Created with a vision to bring a new level of environmental consciousness to the world-famous Strip, CityCenter will be <A href="http://www.citycenter.com/vision/vision_sustainable.aspx" target=_blank>one of the world's largest sustainable developments </A>when it opens late 2009. CES h<IMG height=121 hspace=5 src="/images/content/Aria.gif" width=150 align=right border=0>as partnered with two CityCenter properties, ARIA and Vdara. <BR><BR><A href="http://www.arialasvegas.com/" target=_blank>ARIA Resort & Casino</A> will feature an unprecedented combination of <A href="http://www.citycenter.com/vision/vision_sustainable.aspx" target=_blank>sustainable design</A>, creative personalized attention, exclusive guestroom technology and spectacular <A href="http://www.arialasvegas.com/amenities/" target=_blank>amenities</A>. ARIA will feature an array of dining experiences, from the casual comfort of bistros and cafes to culinary masterpieces from <A href="http://www.prnewswire.com/cgi-bin/stories.pl?ACCT=109&STORY=/www/story/09-18-2008/0004887904&EDATE=" target=_blank>world-renowned chefs </A>and restaurateurs including Masayoshi Takayama, Shawn McClain, Michael Mina, Julian Serrano, Jean-Georges Vongerichten, Sirio Maccioni, Jean-Philippe Maury and The Light Group. <BR><BR><IMG height=94 hspace=5 src="/images/content/VdaraHotelSpa.gif" width=150 align=left border=0><A href="http://www.vdara.com/" target=_blank>Vdara Hotel</A> is an internationally inspired all-suite hotel and spa designed for those who love the excitement of Las Vegas but prefer to enjoy it in an exclusive, non-gaming, smoke-free and sustainable environment. Physically connected to Bellagio and adjacent to <A href="http://www.arialasvegas.com/" target=_blank>ARIA Resort &amp; Casino</A>, Vdara will offer access to all of the entertainment, gaming, shopping, dining and nightlife at CityCenter and in Las Vegas, while also providing a retreat from it all. Characterized by open floor plans and horizontal windows, the accommodations will deliver expansive views of the city and mountains; each will feature a gourmet kitchen as an added convenience. Martin Heierling, the internationally acclaimed innovator behind Bellagio's AAA Four Diamond restaurant Sensi, will serve as executive chef for all of Vdara's food and beverage offerings. Silk Road, a modern trans-ethnic restaurant, will transform as the day evolves, from fresh and vibrant at daybreak to hip and sexy at nightfall. Bar Vdara, an eclectic lobby lounge, will be a setting inspired by nature that works as well for a morning espresso as it does for a late-night cocktail. <BR>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3308"></a>

<div class="sub-content-header">Search the Exhibitor Directory with MyCES</div>
<br />

<A href="http://myces.bdmetrics.com/account/login.aspx "><IMG border=0 hspace=5 align=left src="/images/content/MyCES_172.gif" width=172 height=67></A>Are you looking for a specific exhibiting company you want to see at CES? The MyCES tool can help you find all the exhibitors that are of interest to you. From the MyCES homepage, simply type in the exhibitor’s name and let MyCES search the CES exhibitor directory to find who you’re looking for.&nbsp; Then add them to your Event Plan so you don’t miss them at the show.&nbsp; <A href="http://www.cesweb.org/myCES.asp">Learn about MyCES</A>.<BR><BR>Let the MyCES planning tool work for you to maximize your time at CES and help make your business successful.<BR><BR><A href="http://myces.bdmetrics.com/account/login.aspx ">Create your 2010 MyCES account today!</A><BR><BR>Already have a MyCES account? <A href="http://myces.bdmetrics.com/account/login.aspx ">Login now</A>.<BR>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3307"></a>

<div class="sub-content-header">Hot Tech Trends Revealed at Industry Forum </div>
<br />

<A href="http://www.ce.org" target=_blank><IMG border=0 hspace=5 align=right src="/images/content/CEA.gif" width=150 height=53></A>Get an early glimpse at the hot trends that will emerge at the 2010 International CES and how these trends will change the landscape in the years to come at the "Hot Tech Trends" session at CEA's Industry Forum, October 18-21 in Phoenix, AZ. Industry Forum brings together hundreds of top executives and decision-makers from leading retail, manufacturer and service provider companies.&nbsp; <A href="http://www.ce.org/events/default.asp?siteUrl=%20http://speaker.ce.org/index.cfm?do=cus.eventSchedule|style=0|meetingID=1123|meetingContentType=meetingSchedule " target=_blank>View the full conference schedule</A> and <A href="http://www.ce.org/Events/default.asp?siteUrl=%20http://speaker.ce.org/index.cfm?do=cus.meeting|meetingID=1123|style=0|meetingContentType=registration" target=_blank>register today</A>.    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/news/upToTheMinute/090209.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
