...
<head><!-- PageID 2041 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2010 CES: An Eco-Friendly Electronics Show</title>
...
<H2>The World's Coolest Trade Show is Working to Be the Greenest</H2>With the help of our partners, including GES, Aramark, the Las Vegas Convention Center (LVCC) and The Venetian, CES attendees now have more opportunities than ever to recycle while conducting a year's worth of business in one prime, environmentally friendly location.<BR><BR>
<H3>Green Exhibits and Conference Sessions&nbsp;at the 2010 International CES</H3>The 2010 International CES will again feature the <A href="http://www.cesweb.org/exhibits/displays/sustaintablePlanet.asp">Sustainable Planet Spotlight</A>, our largest exhibition of green products ever on the CES show floor. Sustainable Planet highlights the latest products that make it possible for every person on this planet to stay connected, informed and live sustainable lifestyles through: 
<UL class=text>
...
<LI class=text>Wireless convergence </LI></UL>We're also proud to once again offer the <A href="http://www.cesweb.org/sessions/search/results.asp?categoryID=1861">Technology and The Environment Knowledge Track</A>, a series of conference sessions uncovering how the industry is boosting efficiencies, educating consumers and refining recycling before obsolete gadgets hit the graveyard. <BR><BR>
<H3>Local Environmental Investments</H3>The Consumer Electronics Association has invested more than $100,000 to develop a recycling program in the Las Vegas area working with <A href="http://www.ccsd.net/" target=_blank>Clark County Schools</A>, the fifth largest school district in the country. The fund has already created a recycling and environmental education program for students and faculty at more than 40 schools in the Las Vegas area.<BR><BR>CEA has also donated $50,000 to the Las Vegas Metropolitan Police Department, Convention Center Area Command, to purchase T-3 Motion electric vehicles and accessories. Electric police vehicles will reduce use of fossil fuel powered vehicles and help the environment, the police and the local community. <BR><BR><BR><SPAN style="FONT-SIZE: 12pt; TEXT-DECORATION: none; text-underline: none">
<H3>Offset Your Air Travel to CES (And Help Build&nbsp;A Clean Energy Future)</H3></SPAN>
<P><IMG hspace=10 vspace=20 align=right src="/images/content/EarthEra_Logo(1).jpg" width=150 height=67>CEA is once again taking many steps to reduce the carbon footprint of the International CES. One such way is by partnering with EarthEra to carbon balance the energy use of all show space and hotel rooms with 100 percent&nbsp;wind energy. </SPAN>Please join our environmental efforts by <A href="http://www.earthera.com/cestraveloffsets.aspx" target=_blank>offsetting your air travel to Las Vegas</A> using certified carbon offsets from EarthEra. CEA chose this program because EarthEra uses 100 percent of the revenue to build new renewable energy facilities. </SPAN></P><STRONG>
...
<H3>Exhibitors: Make Your Booth Space an Eco-Space</H3>GES offers several eco-friendly booth packages to help make small responsible changes that amount to a big difference. Check out our <A href="/docs/GES_Sustainable_Exhibit_Solutions_Order_Form.pdf" target=_blank>Sustainable Exhibit Solutions Order Form</A>, including: 
<UL class=text>
...
<LI class=text>Eco-friendly carpet</LI></UL><BR>
<H3>Reuse Your Booth at the Greener Gadgets Conference</H3>Companies interested in having their booths crated and transported to the <A href="http://www.greenergadgets.com/">Greener Gadgets Conference</A> in February may inquire about special promotional rates by contacting <A href="mailto:exhibits@CESweb.org">exhibits@CESweb.org</A>. <BR><BR>
...
<LI class=text>All press kits, including those provided by exhibitors in the Official CES Press Room</LI></UL>Additionally, the CES PreShow Planner has seen a reduction of more than 28,000 copies, a 32 percent decrease in total print run. The CES Conference Directory was reduced o an insert in the Show Guide, saving 55,000 copies. CEA is proud to use environmentally friendly soy-based ink on the 2010 International CES printed publications. All remaining hard copy materials meet the standards of the Sustainable Forest Initiative and Forest Stewardship Council and are printed on recycled paper.<BR><BR><STRONG>CES uses <A href="http://www.aramark.com/ContentTemplate.aspx?PostingID=392&ChannelID=223" target=_new>Aramark</A> catering services, which is:</STRONG> 
<UL class=text>
...
<LI class=text>Optimizes electronic communication to decrease dependence on paper communication methods.</LI></UL><A href="/docs/LVCVA_Going_Green_PDF.PDF" target=_blank>Learn more about greening at the LVCC.</A> <BR><STRONG><BR>CES utilizes conference venues like <A href="http://www.venetian.com/" target=_blank>The Venetian</A>, which:</STRONG> 
<UL class=text>
