...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
       ...
       <!-- Start Search/MyCES Row -->
            ...
            <li class="selected"><a href="/news/upToTheMinute/123009.asp">December 30, 2009</a></li>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/news/default.asp" class="footer">News</a>&nbsp;&gt;&nbsp;<a href="/news/upToTheMinute/default.asp" class="footer">CES Up to the Minute</a>&nbsp;&gt;&nbsp;December 30, 2009</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/news/upToTheMinute/123009.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<H3></A><A href="/exhibitors/space/default.asp"><IMG height=28 src="/images/content/techzone-120.gif" width=120 align=right border=0>CES TechZones</A><A href="/exhibitors/space/default.asp"></H3></A><BR><A href="/exhibitors/space/default.asp">CES TechZones</A> group new technology markets together and feature up-and-coming products, services and companies. <A href="/exhibits/displays/techZones.asp">Choose from over 15 themed areas.</A>CE Spotlights are much like mini tradeshows, offering diverse exhibits for a variety of consumer technology markets.<BR><BR>
<H3><A href="/exhibits/displays/default.asp">CE Spotlights</A></H3>
<TABLE cellSpacing=1 cellPadding=6 width="100%" border=0>
<TBODY>
<TR>
<TD vAlign=top width="50%"><A href="/exhibits/displays/diShowcase.asp"><IMG height=29 hspace=6 src="/images/content/spot-imaging.jpg" width=130 vspace=6 border=0></A><BR><A href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</A>: Featuring all aspects of the imaging product category, including cameras and capture devices, storage, software, printers, kiosks, bags and accessories.</TD>
<TD vAlign=top width="50%"><A href="/exhibits/displays/intGateway.asp"><IMG height=58 hspace=6 src="/images/content/spot-gateway.jpg" width=100 vspace=6 border=0></A><BR><A href="/exhibits/displays/intGateway.asp">International Gateway</A>: Featuring more than 800 exhibitors showcasing the latest innovative technologies and products from around the world. </TD></TR>
<TR>
<TD vAlign=top><A href="/exhibits/displays/ehx.asp"><IMG hspace=6 src="/images/content/spot-ehx.jpg" vspace=8 border=0></A><BR><A href="/exhibits/displays/ehx.asp">EHX@CES</A>: Featuring custom and consumer electronics products and services for designers, installers and integrators who service the residential and commercial markets.</TD>
<TD vAlign=top><A href="/exhibits/displays/livingDigital.asp"><IMG hspace=6 src="/images/content/spot-digTimes.jpg" vspace=8 border=0></A><BR><A href="/exhibits/displays/livingDigital.asp">Living in Digital Times</A>: Featuring technology that's relevant to particular lifestyles, including Kids@Play, Silvers Summit, Digital Health Summit, Mommy Tech, and HigherEd Tech.</TD></TR>
<TR>
<TD vAlign=top><A href="/exhibits/displays/gamingShowcase.asp"><IMG hspace=6 src="/images/content/spot-gaming.jpg" vspace=8 border=0></A><BR><A href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</A>: Featuring gaming hardware and software with the entire range of consumer electronics products — from online PC and HD gaming, plasma HDTV and home theater furniture to surround sound and power conditioning hardware.</TD>
<TD vAlign=top><A href="/exhibits/displays/LBS.asp"><IMG hspace=6 src="/images/content/spot-LBS.jpg" vspace=8 border=0></A><BR><A href="/exhibits/displays/LBS.asp">Location Based Services</A>: Featuring the latest technologies used to deliver highly personalized mobile services, based on location, allowing the mobile network operator to offer differentiation and increased profitability.</TD></TR>
<TR>
<TD vAlign=top><A href="/exhibits/displays/ilounge.asp"><IMG hspace=6 src="/images/content/spot-iLounge.jpg" vspace=8 border=0></A><BR><A href="/exhibits/displays/ilounge.asp">iLounge Pavilion</A>: Featuring the latest and greatest third-party accessories and software for Apple's iPod, iPhone, and Macintosh platforms&nbsp;— from electronic plug-ins to fashionable cases, speakers, headphones, and exciting new games and applications. </TD>
<TD vAlign=top><A href="/exhibits/displays/sustaintablePlanet.asp"><IMG hspace=6 src="/images/content/spot-susPlanet.jpg" vspace=8 border=0></A><BR><A href="/exhibits/displays/sustaintablePlanet.asp">Sustainable Planet</A>: Featuring products and services making it possible for every person on this planet to stay connected, informed and live sustainable lifestyles.</TD></TR>
<TR>
<TD vAlign=top><A href="/exhibits/displays/innovShowcase.asp"><IMG height=82 src="/images/content/spot-Innov.jpg" width=55 vspace=8 border=0></A><BR><A href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</A>: Featuring the honorees of the Innovations 2010 Design and Engineering Awards, acknowledging the year's most outstanding developments in consumer electronics engineering and design. </TD>
<TD vAlign=top><A href="/exhibits/displays/wirelessWorld.asp"><IMG hspace=6 src="/images/content/spot-wworld.jpg" vspace=8 border=0></A><BR><A href="/exhibits/displays/wirelessWorld.asp">Wireless World</A>: Featuring products and services from prominent wireless industry leaders across the entire value chain — from manufacturers to distribution to content and accessories. </TD></TR></TBODY></TABLE>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
