...
<head><!-- PageID 3731 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: December 16, 2009</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
       ...
       <!-- Start Search/MyCES Row -->
            ...
            <li class="selected"><a href="/news/upToTheMinute/121609.asp">December 16, 2009</a></li>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/news/default.asp" class="footer">News</a>&nbsp;&gt;&nbsp;<a href="/news/upToTheMinute/default.asp" class="footer">CES Up to the Minute</a>&nbsp;&gt;&nbsp;December 16, 2009</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/news/upToTheMinute/121609.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>December 16, 2009</h1>
                                                               
                        

Mobile digital TV reception is becoming a reality in 2010, and you can see it firsthand at CES, January 7-10, in Las Vegas, Nevada. Read about this and other emerging technologies in this edition of CES Up to the Minute, and get ready for the world’s largest consumer technology tradeshow.
...
<div class="sub-content-header">Tune in to CESTV: Latest Episodes Cover the Las Vegas Hilton</div>
<br />

You don’t need a remote control to find CESTV. Just point your browser to CESweb.org to watch the latest in a series of videos that get you in the know for the 2010 International CES. Learn what technology to expect, what trends are emerging and where you need to go on the show floor for the consumer electronics products that matter to you. <A href="http://CESweb.org">Watch CESTV now.</A>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3749"></a>

<div class="sub-content-header">Free Over-the-Air Mobile Digital TV Reception Gear to Debut at CES</div>
<br />

<IMG height=111 hspace=5 src="/images/content/2k10CES_TZ_MDTV_web.jpg" width=200 align=right>In 2010, the first viewers of live, local broadcast mobile DTV signals will tune in with new portable TVs, laptop receivers, netbooks and other products introduced at the <A href="http://cesweb.org/exhibits/displays/techZones.asp#3460">Mobile DTV TechZone</A>, sponsored by the <A href="http://www.omvc.org" target=_blank>Open Mobile Video Coalition</A>. V<BR><BR>isit the LVCC, Central Hall, Booth #10749 to see on-the-go products from LG, Samsung and a variety of other manufacturers.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3748"></a>

<div class="sub-content-header">Pick Your Sessions: Virtual Conference Brochure Launches</div>
<br />

<A href="http://digital.virtualmarketingpartners.com/vmp/CES/2010-conference-sessions/index.php" target=_blank><IMG height=129 hspace=5 src="/images/content/2010_conference_sessions_pagecurl.gif" width=100 align=right border=0></A>Each year at CES, you have the opportunity to fill your schedule with sessions and your brain with the knowledge you need to succeed in the consumer electronics industry. Trying to decide which sessions are right for you? <A href="http://digital.virtualmarketingpartners.com/vmp/CES/2010-conference-sessions/index.php" target=_blank>Check out the virtual 2010 CES Conference Brochure</A>. Flip through the pages – all online – to choose from more than 250 individual sessions. Roughly 800 experts cover the trends, deliver technical training, share forecasts and more.<BR><BR><STRONG>Best Value: Ultimate and All-Access Passes<BR></STRONG>All Access Pass - $849 advance/$949 on-site<BR>Includes all CES Knowledge Track sessions and more than 20 CES Partner Programs.<BR><BR><STRONG>Ultimate Pass - $549 advance/$849 on-site</STRONG><BR>Includes all CES Knowledge Track sessions and the following Partner Programs: Digital Hollywood, Cable Conference at CES, CES Game Power, CES Mobile Entertainment and CES Reinventing Advertising. <BR><BR>
...
<div class="sub-content-header">CES Partner Programs: Top Five Picks of the Week</div>
<br />

<A href="/sessions/PartnerPrograms.asp">More than 20 partners</A> are busy as we speak crafting their curriculum for hundreds of conference sessions. Take a look online for the full lineup, and whet your knowledge whistle with these top five picks:<BR><BR><A href="http://cesweb.org/sessions/search/results.asp?categoryID=1833">Digital Hollywood</A><BR>Personalized, portable and profitable. Those are the big ideas in entertainment now, and they're certain to drive the future of this multibillion dollar industry. Digital Hollywood brings you an extraordinary overview of how content, consumers and competition coexist in the entertainment space. Reserve your seat now.
<P><A href="http://cesweb.org/sessions/search/results.asp?categoryID=1829">CES Mobile Entertainment<BR></A>Wherever people and content coexist, mobile is at the heart of the action. Find out where new partnerships are being formed, what new revenue streams are on the horizon, what consumers are asking for next and how apps have become an industry unto themselves. <BR><BR><A href="http://cesweb.org/sessions/search/results.asp?categoryID=1827">CES Game Power Conference</A><BR>Gaming has captured the imagination and won the loyalty of every demographic. There's a game for every taste, every skill level and every price point. It all adds up to millions spending billions on the undisputed powerhouse of entertainment.<BR><BR><A href="http://cesweb.org/sessions/search/results.asp?categoryID=1830">CES Reinventing Advertising</A><BR>These insightful sessions shine a light on how advertisers and clients are using new technologies, platforms and devices to make the message more compelling and make sure it's seen.<BR><BR><A href="http://cesweb.org/sessions/search/results.asp?categoryID=1862">Cable Conference at CES</A><BR>The explosion of content on cable gives consumers more choices than ever and has opened new possibilities for content creators. New this year, these sessions promise to become a mainstay in the CES Partner Program lineup.<BR></P>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3746"></a>

<div class="sub-content-header">Dogs, Surfers and Hip Hop Grab the Attention of CES Goers</div>
<br />

Who needs fancy film crews and million-dollar budgets to capture the attention of 110,000+ consumer technology professionals? Not these CES exhibitors. Davis Instruments, ShopJimmy.com, Sleek Audio, Bell’O and Ooma broke creative barriers with props like pets and surfboards to garner your attention and win the inaugural “Visit Me at CES” 2010 exhibitor video contest. Each of these five 2010 CES exhibiting companies receive one month of free exposure with their winning videos. <A href="http://CESweb.org/contest">Watch the top five exhibitor videos now. </A>
<P></P>
<P><A href="http://CESweb.org/contest">Bell’O<BR>Davis Instruments – Save Fluffy- Save Yourself<BR>OOma<BR>ShopJimmy.com – A Day in the Life<BR>Sleek Audio – Lossless at Sea</A></P>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3745"></a>

<div class="sub-content-header">MyCES Tutorial Video:  How to Get the Most from the MyCES Personal Planner</div>
<br />

<IMG height=67 hspace=5 src="/images/content/MyCES_172.gif" width=172 align=left>If you’re new to the MyCES planning tool, or you need a couple tips on how to maximize its effectiveness, take a few minutes to watch this informative <A href="http://myces2010.bdmetrics.com/ShowSpecificFiles/myces2010/MyCES.wmv">MyCES Tutorial Video</A> and discover how the MyCES Personal Planner can help you organize your time at CES. Make your four days at the show the most productive days of your whole year. 
<UL class=text>
<LI class=text><A href="http://www.cesweb.org/myCES.aspx">Learn more about about MyCES.</A></LI>
<LI class=text><A href="http://myces.bdmetrics.com/account/login.aspx">Create your 2010 MyCES account today!</A></LI>
<LI class=text>Already have a MyCES account? <A href="http://myces.bdmetrics.com/account/login.aspx">Login now.</A></LI></UL>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3744"></a>

<div class="sub-content-header">CNET 30 Days of Innovation: A Countdown to CES</div>
<br />

<IMG height=122 hspace=5 src="/images/content/CNET_Logo_WEB.jpg" width=125 align=right>CNET counts down to the 2010 International CES by profiling 30 young, innovative companies that are new to the show. Take a look at some of these head turners, and look at <A href="http://CESweb.org/30days">CESweb.org/30days</A> each non-holiday business day for a new profile.<BR>
<UL class=text>
<LI class=text><A href="http://cesweb.org/30days">Pocket Radar for tattletales, athletic coaches</A> </LI>
<LI class=text><A href="http://cesweb.org/30days">Build muscle, charge your phone with YoGen</A> </LI>
<LI class=text><A href="http://cesweb.org/30days">Maplock drives off GPS thieves</A> </LI>
<LI class=text><A href="http://cesweb.org/30days">IP2 eyes low-cost mobile service for developing countries</A><BR></LI></UL>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3743"></a>

<div class="sub-content-header">Virtual Preshow Planner Now Available</div>
<br />

Plan your trip to CES, gain knowledge about this year’s show and find out what’s new and hot with the virtual <A href="http://www.CESweb.org/preshowplanner">Preshow Planner</A>. This valuable tool includes TechZones, CE Spotlights, awards and events, show services information, conference sessions, an exhibitor list and more!
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3742"></a>

<div class="sub-content-header">Get Your News from 2010 CES Official Media Partners</div>
<br />

If you’re looking for what’s happening in HD, what’s moving the mobile market, what’s capturing the attention of digital imaging product purchasers or anything else that’s happening at CES and in the consumer technology industry, look to the official 2010 CES media partners: 
<UL class=text>
<LI class=text><A href="http://engadget.com/" target=_blank>Engadget</A></LI>
<LI class=text><A href="http://www.variety.com/">Variety</A></LI>
<LI class=text><A href="www.me-mag.com" target=_blank>Mobile Electronics</A></LI>
<LI class=text><A href="http://www.customretailer.net/" target=_blank>CustomRetailer</A></LI>
<LI class=text><A href="http://www.picturebusinessmag.com/" target=_blank>Picture Business</A></LI>
<LI class=text><A href="http://www.rcrwireless.com/" target=_blank>RCR Wireless News</A></LI>
<LI class=text><A href="http://www.soundandvisionmag.com/" target=_blank>Sound &amp; Vision</A></LI>
<LI class=text><A href="http://www.sohu.com/" target=_blank>sohu.com</A></LI>
<LI class=text><A href="http://www.pcworld.com/" target=_blank>PC World</A> </LI></UL><BR>Want more? <A href="http://CESweb.org">Visit CESweb.org</A> for show information, or CE.org for industry trends and more.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3633"></a>

<div class="sub-content-header">A New Addition to Your Social Media Circle</div>
<br />

<IMG height=121 hspace=5 src="/images/content/CES_Social_Circle_200.jpg" width=200 align=left>Expand your social circle at the world's largest and coolest display of consumer technology. Keep on top of the global conversation buzzing about the brightest CE stars of 2010. Visit the CES Social Circle, a powerful social networking aggregator, beginning in December to catch the momentum unveiled around tech's must-see and must-have new hits. The site, created in partnership with Jess3, will analyze trends from Twitter, YouTube, Flickr and across the blogosphere, providing real time data on the products, brands and personalities behind the annual stage for innovation.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3741"></a>

<div class="sub-content-header">ARIA at CityCenter Opens Today!</div>
<br />

Stay at the newest address on the Las Vegas Strip: CityCenter. CES rates still available at ARIA and other CES hotels. See <A href="http://www.cesweb.org/hotel">www.CESweb.org/hotel</A> for a full list.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<A href="/exhibits/displays/ehx.asp"><IMG height=35 hspace=5 src="/images/content/spot-ehx.jpg" width=130 align=right border=0></A>New for 2010, EHX@CES is powered by CE Pro to bring the <A href="/exhibits/displays/ehx.asp">EHX experience of a dedicated custom electronics exhibition to CES</A>. Gain insight from expert editors, attend can’t-miss training sessions, and participate in an exclusive meet-and-greet with industry leading writers and analysts, all taking place at CE Pro Headquarters! Visit <A href="/register">CESweb.org /register</A> to register, and check the “Visit EHX@CES” box.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3634"></a>

<div class="sub-content-header">Bistro CES: A New Way to Eat and Meet at CES</div>
<br />

<IMG height=57 hspace=5 src="/images/content/CESBistroLogo_sm.gif" width=200 align=right>Need to reserve a table for lunch but don’t have time to go off-site? Want a better dining experience than grabbing a hot dog and soft drink? Bistro CES provides an excellent opportunity for uninterrupted, face-to-face time with your customers and business colleagues coupled with a private, well-catered dining experience right on the show floor. Tables of 4 or 10 can be reserved in advance of the show for lunch, so you can be sure to always have a convenient place to eat, meet and network. Your table reservation includes buffet lunch tickets, so you can skip the lines and get right down to business.<BR><BR>Visit <A href="http://bistroces.com" target=_blank>http://bistroces.com</A> for complete details and to make your reservations today.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3739"></a>

<div class="sub-content-header">Enhance Your CES Experience with Follow Me</div>
<br />

<H3>The new mobile application for your Smartphone</H3>
<P>FOLLOW ME is a first-of-its-kind interactive Smartphone application designed specifically for the tradeshow industry featuring real-time show alerts and interactive floor maps.&nbsp; <A href="http://cesweb.org/followme.asp">Learn more. </A></P>    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/news/upToTheMinute/121609.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
