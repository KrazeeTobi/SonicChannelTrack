...
<head><!-- PageID 368 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
...
<A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&prodoffeIds=2810030,2810170,2810500,2811140,2811520,2812010"><IMG height=100 hspace=6 src="/images/content/audio_icons_LG.gif" width=100 align=right border=0></A>Consumers demand simpler home audio solutions that fit their lifestyle and home decor. Meanwhile, the audio industry responds to consumer demands for portability and easy access to media via MP3 player docking speaker systems and audio products that stream music from a networked PC and from Internet radio stations. <BR><BR>CES is the place to investigate trends like these and&nbsp;new technology emerging in the audio industry and many other consumer technology markets. The International CES returns to Las Vegas on January 6, 2011.
