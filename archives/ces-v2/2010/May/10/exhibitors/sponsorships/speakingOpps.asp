...
<head><!-- PageID 650 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Speaking Opportunities</title>
...
<br />Share your knowledge, and build your reputation as a leader in the consumer electronics industry. Visit the <A href="/sessions/speakers/default.asp">Call for Speakers</A> section for information on International CES speaking opportunities.<BR><BR><STRONG>Call for Speakers Opens:<BR></STRONG>June 16, 2010<BR><STRONG><BR>Deadline:</STRONG><BR>Submissions Due:&nbsp;July 21, 2010<BR><BR><B>Contact:</B><BR>Speaking Opportunities Coordinator, Conferences, International CES<BR>E-mail: <A href="mailto:CFS@CE.org">CFS@CE.org</A><BR><BR>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibitors/sponsorships/speakingOpps.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
