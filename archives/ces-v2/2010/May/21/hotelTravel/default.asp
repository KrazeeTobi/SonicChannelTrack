...
<head><!-- PageID 421 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Hotel/Travel</title>
...
<div class="right-box-no-border" align="center">
    ...
    <br/><IFRAME height=370 src="http://www.cesweb.org/hotelTravel/airfarewatch.asp" frameBorder=0 width=170 scrolling=no></IFRAME><BR><BR>
</div>
<div class="right-box-no-border" align="center">
    <a target="_blank" href="/ads/hktdc.asp"><div align="center"><img border="0" src="/images/content/HKTDC-advertisement.gif"></div></a>
    
</div>
<div class="right-blue-box" align="center">
    <div class="right-blue-box-header">Dateline: Las Vegas</div>
    
    <div>
        Read <A href="http://www.lvcva.com/press/media-resources/monthly-news-briefs.jsp?pressId=763" target=_blank>Dateline: Las Vegas</A> to get the latest developments in hotels, restaurants, shows and other amenities in the city CES calls home.<BR><BR>
    </div>
</div>
                    </div>
...
<H3><A href="/hotelTravel/airlines.asp">Airline Discounts </A></H3>CES has partnered with many major airlines to bring you flight discounts.<BR><BR>
...
<H3><A href="/hotelTravel/cars.asp">Transportation and&nbsp;Parking&nbsp;</A></H3>Cabs abound in Vegas, but parking is harder to come by. Find pointers and car rental info here.<BR><BR>
