...
<head><!-- PageID 3098 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2010 CES: 2011 CES Block Request Form</title>
...
<tr>
	<td colspan="2"><font style="color:red"><b>* </b></font> Please select an official 2011 International CES hotel. (Availability subject to change. Last updated May, 2010.)<br />
	This list will be updated as hotels are confirmed/sell out.</td></tr>
...
<tr>
	<td width="33%" valign="top" class="text">
		...
		<input type="radio" name="hotel" value="Encore">Encore at Wynn ($259/$189)<br />
		...
		<input type="radio" name="hotel" value="LVHilton">Las Vegas Hilton (10 room min.) ($219/$99)<br>
		<input type="radio" name="hotel" value="Venetian">Venetian (10 room min.) ($269/$159)<br>
		<input type="radio" name="hotel" value="Wynn">Wynn ($249/$179)<br>
