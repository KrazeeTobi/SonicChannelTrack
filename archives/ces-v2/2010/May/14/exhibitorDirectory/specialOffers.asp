...
<head><!-- PageID 2631 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Special On-Site Offers</title>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div>Special On-Site Offers</div>
                    </div>
...
We know CES can be among the most important days of your business year. It's where you can&nbsp;explore product offerings from&nbsp;<A href="/default.asp">2,700 consumer technology companies</A>&nbsp;and boost your own business. Lucky for you,&nbsp;many exhibitors vie for your attention&nbsp;with on-site special offers*, giveaways and chances to win. Here are some examples:<BR><BR>
