...
<div class="right-box-no-border" align="center">
    <a target="_blank" href="http://i-stage.ce.org"><div align="center"><img border="0" src="/images/content/istage200x250.gif"></div></a>
...
<A href="http://digital.virtualmarketingpartners.com/vmp/CES/2010-conference-sessions/index.php" target=_blank></A><STRONG>Knowledge That Drives Business</STRONG><BR><BR>If it's emerging, groundbreaking or market-leading, it's covered in the&nbsp;International CES conference program. Take your pick from more than 300 conference sessions, and fill your schedule with the knowledge you need to succeed in the consumer electronics industry. <BR><BR>
...
<TR>
<TD>
<H3>Speak at CES</H3>Now's the time to <A href="/conferenceProgram/speakers/default.asp">submit your application to be an official 2011 CES speaker</A>. If you're an expert on a consumer technology topic, chances are, we have a session covering it.<A href="/conferenceProgram/speakers/default.asp">CES is taking entries until July 21, 2010. </A></TD></TR></TBODY></TABLE><BR><BR><BR>
...
<TD vAlign=top><SPAN class=smallText></SPAN></TD>
<TD>&nbsp;</TD>
<TD vAlign=top><SPAN class=smallText><BR></SPAN></TD></TR></TBODY></TABLE>The conference program lineup from the 2011 will be&nbsp;available October 1, and you'll be able to choose from:<BR><BR><BR>
<H3><A href="/events/keynotes.asp">Conference Tracks</A></H3>CES and more than a dozen distinguised partners craft a variety of tracks that cover every aspect of the highly competitive, multibillion-dollar CE industry, and put you on the inside track to everything new.<BR><BR><BR>
<H3><A href="/conferenceProgram/SuperSessions.asp">SuperSessions</A></H3>Rise above the clutter and take away the real deal on the subjects that matter most.&nbsp;Get unbelievable amounts of thought-provoking information and insight into an-easy-to-digest format. And do it all for free in these sessions.<BR><BR><BR>
<H3><A href="/conferenceProgram/speakers/speakerServices.asp">Speaker Services</A></H3>Official International CES speakers receive automatic registration, access to Internet-enabled computers and the opportunity to help shape the consumer technology industry. <BR><BR><BR>
<H3><A href="/conferenceProgram/speakers/default.asp">Call for Speakers</A></H3>Apply to speak at the world's largest consumer technology tradeshow now. Deadline: July 21, 2010.
