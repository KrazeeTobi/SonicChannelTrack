...
<H3>글로벌 네트워크과 잠재력을 쌓으십시오.</H3>귀하의 비지니스를 성공할 수 있는 방향으로 이끌어 줄 거래를 성사시키십시오. 130여개국 이상에서 120,000명 이상의 참가자들이 신기술의 발사대인 CES에 참가할 것으로 예상되고 있습니다. 2,500개 이상의 전시사들이 20,000여개 이상의 제품들을 선보이는 CES는 소비자 가전 업계에 있어서 1년중 가장 흥미진진한 4일이될 것입니다. 9월30일까지 등록하시면 등록비 $100을 절약하실 수 있습니다. <A href="/register">지금 등록하십시오.</A><BR><A href="/docs/2010FACTSHEET_Korean.pdf" target=_blank></A><BR><BR><IMG align=middle src="/images/photos/International_Horizontal_1.jpg" width=480 height=162> 
<P></P>
