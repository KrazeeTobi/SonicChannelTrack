...
<H3>Développez des possibilités et des réseaux mondiaux</H3>Concluez les affaires qui propulseront votre entreprise dans la bonne direction. Plus de 120 000 participants de 130 pays sont attendus au CES, la plateforme de lancement des nouvelles technologies. Avec plus de 2 500 exposants qui présentent plus de 20 000 nouveaux produits, le CES vous offre les quatre jours les plus captivants de l’année pour l’industrie des technologies de consommation. <A href="/register">Inscrivez-vous d’ici le 30 septembre</A> pour économiser les frais d’inscription de 100 $. <A href="/register">Inscrivez-vous maintenant.</A><BR><A href="/docs/2010_CESFACTSHEET_French.pdf" target=_blank></A><BR><BR><IMG align=middle src="/images/photos/International_Horizontal_1.jpg" width=480 height=162>
