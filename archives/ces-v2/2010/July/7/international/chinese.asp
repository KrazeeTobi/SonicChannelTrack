...
<head><!-- PageID 1226 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        您知道具有 15 名或以上的国际参加者的代表团可免费登记参加 Exhibits Plus ？<BR><A href="/international/chinese/delegations.asp">欲知详情</A>。 <BR>
        <br /><br />
    </div>
</div>
<div class="right-blue-box" align="center">
    ...
    <div>
        ...
        <br /><br />
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;汉语</div>
                        </div>
                        <div class="headerbox">
                       <h1>汉语</h1>
                            <div class="icon_wrap">
...
<H3>建立全球网络和挖掘潜力</H3>达成交易，使您的业务向正确方向推进。预计来自130多个国家的 120,000 名以上的参加者将参加国际消费电子产品展 CES - 新技术的发射台。2,500 多家参展厂商将展示 20,000 多件新产品，国际消费电子产品展 CES 提供消费者电子产品行业每年最令人兴奋的四天。九月三十日之前登记 ，节省100 美元的登记费。<A href="/register">现在就登记。</A><BR><A href="/docs/2010FACTSHEET_Simplified_Chinese.pdf" target=_blank></A><BR><BR><IMG align=middle src="/images/photos/International_Horizontal_1.jpg" width=480 height=162>
...
<P><A href="/international/chinese/services.asp">国际服务<BR></A>国际参加者会得到许多特殊礼遇，其中包括提供口译服务、专门为您安排的与同行沟通交流招待会、指定的工作区及会议室等。<BR><BR><A href="/docs/Simplified_Chinese_6673_2011CESfacts_SCH_PRESS_READY(1).pdf" target=_blank>一般信息</A><BR>了解关于展会的历史、目前产品目录、未来展会日期等信息 —全部被译成您的语言！ </P>    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/international/chinese.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
