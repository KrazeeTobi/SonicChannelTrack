...
<head><!-- PageID 1839 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Speaker Services</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/conferenceProgram/default.asp" class="footer">Conference Program</a>&nbsp;&gt;&nbsp;Speaker Services</div>
                        </div>
                        <div class="headerbox">
...
<LI class=text>LVCC South Hall S208/209</LI></UL><BR><BR><BR>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<LI class=text>VGA switch box </LI></UL><STRONG><BR>Presentation materials<BR></STRONG>Speakers who wish to use visuals during their conference session must provide their own laptops and are encouraged to use the CES PowerPoint template, which will be available for download in the Fall.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
