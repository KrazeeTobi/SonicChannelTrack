...
<head><!-- PageID 4002 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/events/istage.asp">i-stage</a></li>
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/events/default.asp" class="footer">Events</a>&nbsp;&gt;&nbsp;i-stage</div>
                        </div>
                        <div class="headerbox">
                       <h1>i-stage</h1>
                            <div class="icon_wrap">
...
<H3>A Whole New Stage for Development</H3>
<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
<TBODY>
<TR>
<TD vAlign=top>i-stage is the proving ground for next-gen technologies – a chance for developing products, services and apps to show off their selling points and duke it out to be tech's next promising powerhouse.<BR><BR>The competition is free to enter and a direct route to <A href="http://i-stage.ce.org/?page_id=56" target=_blank>more than $50,000 in prizes </A>and a dynamic debut right here at the International CES, the annual big bang of innovation.<BR><BR>
<H4>Is Your Startup Our Next Success Story?</H4><A href="http://cea.mblast.com/ws/wfaward/rsp/welcome.asp?GUID=204881&ContactType=Nominee" target=_blank>Entries for&nbsp;the&nbsp;October 18 event in San Francisco are now open.</A><BR><BR>Want to catch a glimpse of the competitors? <A href="http://www.ce.org/events/default.asp?siteUrl=http://speaker.ce.org/index.cfm?do=cus.meeting|meetingID=1421" target=_blank>Register to attend</A> i-stage or join us for our full Industry Forum program in San Francisco.</TD>
<TD vAlign=top align=left><!-- Start of Brightcove Player -->
...
<OBJECT id=myExperience88213489001 class=BrightcoveExperience align=right><PARAM NAME="bgcolor" VALUE="#FFFFFF"><PARAM NAME="width" VALUE="218"><PARAM NAME="height" VALUE="186"><PARAM NAME="playerID" VALUE="26356940001"><PARAM NAME="publisherID" VALUE="26269122001"><PARAM NAME="isVid" VALUE="true"><PARAM NAME="dynamicStreaming" VALUE="true"><PARAM NAME="@videoPlayer" VALUE="88213489001"></OBJECT><!-- 
...
<DIV class=smallText align=center><A href="http://link.brightcove.com/services/player/bcpid26356940001?bctid=88213489001" target=_blank>[View larger video.]</A></DIV></TD></TR></TBODY></TABLE>

    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/events/istage.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
