...
<head><!-- PageID 3920 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Mobile Apps Showdown</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/events/mobile-apps-showdown.asp">Mobile Apps Showdown</a></li>
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/events/default.asp" class="footer">Events</a>&nbsp;&gt;&nbsp;Mobile Apps Showdown</div>
                        </div>
                        <div class="headerbox">
...
<IMG border=0 hspace=5 align=right src="/images/content/apps_showdown_icon.jpg" width=266 height=95>There’s a mobile application born every minute (or so it seems), but which ones will rise to the top? See for yourself at the Mobile Apps Showdown. Sponsored by Living in Digital Times and NetShelter, the showdown features all mobile apps entries on the web inviting readers to comment (and BUY). Top voted apps will be showcased, culminating in a rousing final faceoff. If you’re interested in participating in this high-profile event, send an e-mail to <A href="mailto:info@mobileappshowdown">info@mobileappshowdown</A>.

    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/events/mobile-apps-showdown.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
