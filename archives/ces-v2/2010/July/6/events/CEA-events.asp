...
<head><!-- PageID 3918 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: CEA Events</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/events/default.asp" class="footer">Events</a>&nbsp;&gt;&nbsp;CEA Events</div>
                        </div>
                        <div class="headerbox">
                       <h1>CEA Events</h1>
                            <div class="icon_wrap">
...
CEA sponsors a variety of events - for the entire industry and individual niches within it - to educate the masses and unite manufacturers, retailers and market movers. From SNOCES to the CEA Industry Forum and Fall Conference, CEA works year 'round to grow and shape the future of consumer electronics. Check out upcoming CEA Events:<BR><BR>
<H3><IMG border=0 align=right src="/images/content/cea-events.jpg" width=353 height=370><BR><A href="http://www.sinoces.com/cn/index.htm" target=_blank>SINOCES </A></H3>July 8-11, 2010<BR>Qingdao <BR><BR><BR>
<H3><A href="http://www.CE.org/industryforum" target=_blank>Industry Forum</A> </H3>October 17-20, 2010<BR>San Francisco, CA <BR><BR><BR>
<H3>Digital Hollywood Fall </H3>October 18-21, 2010<BR>Santa Monica, CA 
<H3><BR><A href="http://i-stage.ce.org/" target=_blank>i-stage </A></H3>October 18, 2010<BR>San Francisco, CA 
<H3><BR>Technology &amp; Standards Fall Forum </H3>October 18-21, 2010<BR>San Francisco, CA <BR><BR><BR>
<H3><A href="http://www.ce.org/halloffame">Consumer Electronics Hall of Fame</A></H3>October 19, 2010<BR>San Francisco, CA <BR>
<H3><BR><A href="http://www.televisionconference.com/" target=_blank>Future of Television East </A></H3>November 19, 2010<BR>New York,NY 

    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/events/CEA-events.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
