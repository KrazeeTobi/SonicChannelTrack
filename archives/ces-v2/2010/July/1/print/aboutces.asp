...
<TABLE border=0 cellSpacing=8 width=590 align=center>
<TBODY>
<TR>
...
<TR>
<TD width=190>
<P>Audio <BR>Automotive Electronics<BR>Computer Hardware &amp; Software<BR>Connected Home<BR>Content Distribution<BR><BR></P></TD>
<TD width=10></TD>
<TD vAlign=top width=190>
<P>Digital Health and Fitness<BR>Digital Imaging<BR>Electronic Gaming<BR>Emerging Technology<BR>Entertainment/Content<BR></P></TD>
<TD width=10></TD>
<TD vAlign=top width=190>Internet-Based Multimedia Systems<BR>Lifestyle Electronics<BR>Telecommunications Infrastructure<BR>Video <BR>Wireless &amp; Wireless Devices</TD></TR></TBODY></TABLE>
