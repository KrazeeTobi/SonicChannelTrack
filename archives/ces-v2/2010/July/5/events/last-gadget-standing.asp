...
<head><!-- PageID 3922 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Last Gadget Standing</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/events/default.asp" class="footer">Events</a>&nbsp;&gt;&nbsp;Last Gadget Standing</div>
                        </div>
                        <div class="headerbox">
...
A perennial attendee favorite, Last Gadget Standing challenges contenders to give the product demo of their lives. At stake: bragging rights as the product "most likely to change the face of technology." See all the winners strut their stuff in this inventive, fast-paced competition.<BR><BR><STRONG>Watch&nbsp;the 2010 CES Last Gadget Standing&nbsp;now:</STRONG><BR><BR><EMBED src=http://player.stickam.com/flashVarMediaPlayer/187252515 width=300 height=200 type=application/x-shockwave-flash wmode="transparent" allowFullScreen="true" allowScriptAccess="always"></EMBED><BR>

    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/events/last-gadget-standing.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
