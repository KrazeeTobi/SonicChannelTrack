...
<tr class="">
    <td valign="top">
        <a href="https://reservations.mgmmirage.com/bookingengine.aspx?pid=930&host=offer&code=CESM11" target="_blank"><span class="smallText">ARIA Resort & Casino</span></a></td>
...
<tr class="alternateRows">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText">Enter Offer Code CES11</span></td>
</tr>
<tr class="">
    <td valign="top">
...
<tr class="alternateRows">
    <td valign="top">
        <a href="https://resweb.passkey.com/go/2011CES" target="_blank"><span class="smallText">Encore at Wynn</span></a></td>
        <td valign="top"><span class="smallText">$259</span></td>
        <td valign="top"><span class="smallText">$259<BR></span></td>        
        <td valign="top"><span class="smallText">$259<BR></span></td>        
        <td valign="top"><span class="smallText">$259<BR></span></td>
...
<tr class="alternateRows">
    <td valign="top">
        <span class="smallText">Hard Rock Hotel & Casino Las Vegas run of house</span></a></td>
        <td valign="top"><span class="smallText">Rate TBD</span></td>
        <td valign="top"><span class="smallText"></span></td>        
        <td valign="top"><span class="smallText"></span></td>        
        <td valign="top"><span class="smallText"></span></td>
        <td valign="top"><span class="smallText"></span></td>        
        <td valign="top"><span class="smallText">Check back soon for details on rate and how to book<BR></span></td>
</tr>
<tr class="">
    <td valign="top">
        <span class="smallText">Hard Rock Hotel & Casino Las Vegas HRH All suite tower</span></a></td>
        <td valign="top"><span class="smallText">Rate TBD</span></td>
        <td valign="top"><span class="smallText"></span></td>        
        <td valign="top"><span class="smallText"></span></td>        
        <td valign="top"><span class="smallText"></span></td>
        <td valign="top"><span class="smallText"></span></td>        
        <td valign="top"><span class="smallText">Check back soon for details on rate and how to book</span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="http://www.hilton.com/en/hi/groups/personalized/LASLVGV-CESH11-20110101/index.jhtml?WT.mc_id=POG" target="_blank"><span class="smallText">Hilton Grand Vacations Suites- Las Vegas studio</span></a></td>
        <td valign="top"><span class="smallText">$219</span></td>
        <td valign="top"><span class="smallText">$219</span></td>        
        <td valign="top"><span class="smallText">$219</span></td>        
        <td valign="top"><span class="smallText">$129</span></td>
        <td valign="top"><span class="smallText">$99</span></td>        
        <td valign="top"><span class="smallText">No code needed online
<P><BR>&nbsp;</P></span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href="http://www.hilton.com/en/hi/groups/personalized/LASLVGV-CESH11-20110101/index.jhtml?WT.mc_id=POG" target="_blank"><span class="smallText">Hilton Grand Vacations Suites- Las Vegas one bedroom suite</span></a></td>
        <td valign="top"><span class="smallText">$249</span></td>
        <td valign="top"><span class="smallText">$249</span></td>        
        <td valign="top"><span class="smallText">$249</span></td>        
...
<tr class="alternateRows">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText">Enter Group ID 635911</span></td>
</tr>
<tr class="">
    <td valign="top">
...
<tr class="">
    <td valign="top">
        <a href="https://gc.synxis.com/rez.aspx?Hotel=23893&Chain=507&arrive=1/6/2011&depart=1/9/2011&adult=1&child=0&group=1S12OY" target="_blank"><span class="smallText">Mandarin Oriental Las Vegas</span></a></td>
        <td valign="top"><span class="smallText">$295</span></td>
        <td valign="top"><span class="smallText">$295</span></td>        
        <td valign="top"><span class="smallText">$295</span></td>        
        <td valign="top"><span class="smallText">$295</span></td>
        <td valign="top"><span class="smallText">$295</span></td>        
...
<tr class="alternateRows">
    <td valign="top">
        <a href="https://reservations.mgmmirage.com/bookingengine.aspx?pid=MCH&host=group&code=XCES11" target="_blank"><span class="smallText">Monte Carlo*</span></a></td>
        <td valign="top"><span class="smallText">$84.95</span></td>
        <td valign="top"><span class="smallText">$144.95</span></td>        
        <td valign="top"><span class="smallText">$144.95</span></td>        
        <td valign="top"><span class="smallText">$124.95</span></td>
        <td valign="top"><span class="smallText">$59.95</span></td>        
        <td valign="top"><span class="smallText">&nbsp;No code needed online; rates shown include $9.95 daily resort fee*<BR></span></td>
</tr>
<tr class="">
    <td valign="top">
...
<tr class="">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText">n/a for individuals<BR></span></td>        
        <td valign="top"><span class="smallText">n/a for individuals<BR></span></td>        
        <td valign="top"><span class="smallText">n/a for individuals<BR></span></td>
        <td valign="top"><span class="smallText">n/a for individuals<BR></span></td>        
        <td valign="top"><span class="smallText">CES rate is $289, however, hotel only accepts groups of 10 or more rooms. <BR><A href="/hotelTravel/blockRequest.asp">See group block request form for details.<BR></A></span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
...
<tr class="alternateRows">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText">$129</span></td>
        <td valign="top"><span class="smallText">$79</span></td>        
        <td valign="top"><span class="smallText">Enter Special Offer Code 2011CES; early bird rate must be booked by September 30; $20 daily resort fee optional*</span></td>
</tr>
<tr class="">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText">$144</span></td>
        <td valign="top"><span class="smallText">$114</span></td>        
        <td valign="top"><span class="smallText">No code needed online; rates shown include daily $12.99 resort fee*</span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
...
<tr class="">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText">$170</span></td>        
        <td valign="top"><span class="smallText">Check back soon for details on how to book; rates shown include $15 daily resort fee*</span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
...
<tr class="alternateRows">
    <td valign="top">
        <a href="https://resweb.passkey.com/go/2011CES" target="_blank"><span class="smallText">Wynn Las Vegas</span></a></td>
        <td valign="top"><span class="smallText">$249</span></td>
        <td valign="top"><span class="smallText">$249</span></td>        
        <td valign="top"><span class="smallText">$249</span></td>        
        <td valign="top"><span class="smallText">$249</span></td>
...
<LI><STRONG>Excalibur</STRONG>: $9.95 daily resort fee includes automatic telephone access charge which will allow guests to place telephone calls from their guest rooms as follows: (a) unlimited local telephone calls from the convenience of your hotel room, (b) reduced rate long distance domestic calls from hotel rooms, (access charges are subject to change for local and long distance phone calls).&nbsp; Resort Fee also includes fitness center access each day of guests’ stay and a one time voucher for 2 well drinks in any casino bar and a pass for 2 games per stay at Excalibur’s Midway entertainment venue.&nbsp; </LI>
...
<LI><STRONG>Luxor</STRONG>: $9.95 daily resort fee includes in-room Internet service (wired), daily newspaper, two bottles of water, Nurture Fitness Center Admission, unlimited local, domestic long distance and toll-free telephone calls. </LI>
...
<LI><STRONG>Tropicana</STRONG>: $12.99 daily resort fee includes in-room Internet access, two (2) drinks at any lounge, unlimited local&nbsp;guestroom calls, incoming faxes, and daily fitness center access </LI>
