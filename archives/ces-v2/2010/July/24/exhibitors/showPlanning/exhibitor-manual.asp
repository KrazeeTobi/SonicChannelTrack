...
Welcome to the CES Exhibitor Manual page! Check back in September to view the brand new 2011 CES Exhibitor Manuals! This page will house the LVCC/Hilton, Venetian Meeting Room and Venetian Suites versions. It will also house our "mini-manuals" for those of you exhibiting in a TechZone or CES Meeting Place at the 2011 show. <A href="http://www.ges.com/ecomm/2010/Q1/11-04894/" target==_blank>Click here</A> to view the 2010 version of the Manual. Please note that all GES pricing will remain the same so you can use it to start budgeting!<BR><BR>For quesitons about the LVCC/Hilton Exhibitor Manual, contact Katie Swearingen at <A href="mailto:kswearingen@ce.org">kswearingen@ce.org</A>. For questions about the Venetian Manuals, contact Gaiya Berube at <A href="mailto:gberube@ce.org">gberube@ce.org</A>.
<P>&nbsp;</P>
<P>&nbsp;</P>
