...
<head><!-- PageID 1174 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    <title>International CES - January 8-11, 2009 - 国際サービス</title>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        <DIV align=center><A href="http://biz.knt.co.jp/pm/ces/index.htm" target=_blank><IMG border=0 src="/print/images/content/CES_Japanese_Site.gif" width=150 height=45></A></DIV>
        <br /><br />
    </div>
</div>
                    </div>
