...
<head><!-- PageID 4804 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: TAO: The Official CES Party</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/events/tao.asp">TAO: The Official CES Party</a></li>
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/events/default.asp" class="footer">Events</a>&nbsp;&gt;&nbsp;TAO: The Official CES Party</div>
                        </div>
                        <div class="headerbox">
                       <h1>TAO: The Official CES Party</h1>
                            <div class="icon_wrap">
...
<STRONG><IMG hspace=5 align=right src="/images/content/TAOlogo.jpg" width=200 height=146>Friday, January 7, The Venetian <BR></STRONG>Complimentary Admission and Open Bar: 10-11 p.m. (Party is by invitation only. Complimentary Admission on Saturday and Sunday nights is available to all CES attendees.) Join us at one of Vegas’ hottest nightclubs, <A href="http://www.taolasvegas.com/tao.normal.html" target=_blank>TAO</A>, for the Official CES Party on Friday night, January 7.<BR><BR>Enjoy expedited access into the night club from the outside promenade and a well open bar from 10-11 p.m. For bottle service/table reservations in advance, please e-mail <A href="mailto:Bob.Shindelar@taogroup.com">Bob.Shindelar@taogroup.com</A>. <BR><BR><IMG hspace=5 align=left src="/images/content/LAVO_Logo_Italian_HiRes.jpg" width=256 height=75>In addition, all CES attendees receive complimentary admission into TAO, located in The Venetian, on Saturday night, and to <A href="http://www.palazzo.com/lavo.aspx" target=_blank>LAVO</A>, located in The Palazzo, on Sunday night. <A href="/docs/TAOLAVO_CES.pdf">Print your pass here!&nbsp;</A>&nbsp; <BR><BR>Note: All guests must be 21+ with ID and compliant with dress code for admission. 

    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/events/tao.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
