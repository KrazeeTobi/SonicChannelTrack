...
<head><!-- PageID 4556 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Exhibitor Staff Guide</title>
...
<DT target="_blank">
<P>Download the entire <A href="/docs/2011_Exhibitor_Staff_Guide.pdf" target=_blank>2011 International CES Exibitor Staff Guide</A> or by sections to ensure&nbsp;your booth staff and other members of your exhibito team have all the knowledge they need to makes your CES experience a success.</P>
<TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
<TD vAlign=top>
<UL class=text target="_blank">
<LI class=text><A href="/docs/Show_Services.pdf" target=_blank>Show Services</A> </LI>
<LI class=text><A href="/docs/2011_CES_Show_Locations_Map(1).pdf" target=_blank>Show Locations Map</A> </LI>
<LI class=text><A href="/docs/The_Venetian_HPA_Exhibits.pdf" target=_blank>Venetian/HPA Exhibits&nbsp;Map</A> </LI>
<LI class=text><A href="/docs/Shuttle_Schedule.pdf" target=_blank>Shuttle Schedule and Map</A> </LI>
<LI class=text><A href="/docs/Satellite_Parking_Map(1).pdf" target=_blank>Satellite Parking Map</A> </LI></UL></TD>
<TD vAlign=top>
<UL class=text>
<LI class=text><A href="/docs/Events_Awards_Flyer_web.pdf" target=_blank>CES Awards and Events</A> </LI>
<LI class=text><A href="/docs/7381_2K11KeynoteFly_NoCrop.pdf" target=_blank>Keynote Speakers </A></LI>
<LI class=text><A href="/docs/Exhibitor_Services.pdf" target=_blank>Exhibitor Services</A></LI></UL></TD>
<TD vAlign=top>
<UL class=text>
<LI class=text><A href="/docs/Badge_Holder_Pickup.pdf" target=_blank>Badge Holder Pickup</A> </LI>
<LI class=text><A href="/docs/Dining_in_Vegas.pdf" target=_blank>Dining in Vegas</A>&nbsp; </LI>
<LI class=text><A href="/docs/Emergency_Information.pdf">Emergency Information</A></LI></UL></TD></TR></TBODY></TABLE>

    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibitors/resources/staff-guide.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
