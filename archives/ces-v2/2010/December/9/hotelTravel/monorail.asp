...
<head><!-- PageID 473 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Las Vegas Monorail</title>
...
<IMG height=100 hspace=5 src="/images/content/monorail_logo.gif" width=100 align=left><IMG height=192 hspace=8 src="/images/content/Monorail_closeup_150.jpg" width=150 align=right>Running from 7 to 3 a.m. Friday through Sunday (7 to 2 a.m. Monday through Thursday), the Las Vegas Monorail connects the Las Vegas Convention Center to a variety of hotels, including MGM Grand, Bally's, Flamingo, and Harrah's. Traveling at a top speed of 50 mph, the monorail is often the quickest travel option to and from the International CES.<BR><BR>In 15 minutes or less, Monorail riders can travel to and from the Las Vegas Convention Center and the Las Vegas Strip in a safe, clean, and climate-controlled environment. Let the Monorail be your transportation solution. <BR><BR>Hop on for a one-way trip or pick up a seven day convention pass for the freedom to travel at your leisure. Avoid the hassles of traffic congestion and waiting in lines. 
<P><STRONG>Discount passes <BR></STRONG>CES has partnered with the Las Vegas Monorail to bring you savings. <A href="https://tickets.lvmonorail.com/ces2011aibfdks9ifbck82n/ " target=_blank>Visit the dedicated CES discount page</A> to purchase tickets in advance. <BR>It's never too early to purchase Monorail tickets, as they do not expire until one year after date of issue. Discount tickets must be purchased by December 23, 2010. </P>
<P style="TEXT-ALIGN: center">2011 CES Monorail rates:<BR>One ride ticket: $5<BR>One-day pass: $12<BR>Three-day pass: $24 (reduced from $28)<BR>Seven-day convention pass: $50 (reduced from $65)<BR></P>
