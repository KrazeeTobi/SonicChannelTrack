...
<head><!-- PageID 3896 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: EAC Dashboard</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/exhibitors/default.asp-->
            ...
            <li class="selected"><a href="/exhibitors/showPlanning/eac-dashboard.asp">EAC Dashboard</a></li>
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/showPlanning/default.asp" class="footer">Show Planning</a>&nbsp;&gt;&nbsp;EAC Dashboard</div>
                        </div>
                        <div class="headerbox">
                       <h1>EAC Dashboard</h1>
                            <div class="icon_wrap">
...
<H3>Tips and Information for Exhibitor Appointed Contractors at CES</H3>Everything you need to know about EACs at CES. <BR><BR>
<H3>New: Important Information for EACs at CES</H3></STRONG>Effective November 1, 2010, the Las Vegas Convention and Visitors Authority (LVCVA) will be requiring the ESCA Exhibition Industry Worker Identification System (WIS) badge in order to gain access to their facilities. <A href="http://www.cesweb.org/exhibitors/showPlanning/hot-topics.asp" target==_blank>Get more information here.</A> 
<H3>EAC Online Tool</H3>CES Operations uses an online tool for Exhibitors to register their EACs, and for EACs to manage their requirements for CES. Any EAC that needs access to the CES show floor must upload their current information into this tool. A subcontracted EAC must also register and provide a Certificate of Insurance with the required coverage. Information should be provided no later than Friday, December 10, 2010. Exhibitors: Use the online tool at <A href="http://www.cesweb.org/MyEAC">http://www.cesweb.org/MyEAC</A> to authorize your EAC as working on your booth at CES. Please follow up with your EAC to ensure that they are meeting their requirements as well.<BR><BR>EACs: Use the online registration tool at <A href="http://www.cesweb.org/EAC">www.CESweb.org/EAC</A> to register your company as an official EAC at CES. This tool helps you to manage your required information, submit your EAC Agreement and Certificate of Insurance, and track updates to your client listing. You must agree to all EAC Rules and Regulations as listed in our Exhibitor Manual and in the on-line tool.<BR><BR>General Information Exhibitor Appointed Contractors (EACs) are independent contractors hired by exhibiting companies. They can include booth designers, builders or supervisors, independent display companies, delivery personnel or technicians, etc. <BR><BR>An EAC will be granted access to the show floor once the following criteria are met: 
<UL class=text>
<LI class=text>The Exhibitor must register their EAC through the CES online tool. This serves as the confirmation that the EAC is authorized to work in their booth. </LI>
<LI class=text>The EAC, and its subcontractors if applicable, must agree to the International CES terms and conditions and post a valid Certificate of Insurance through the EAC online tool. </LI>
<LI class=text>The EAC must send in an original Certificate of Insurance to the Consumer Electronics Association.</LI></UL>
<H3>Certificate of Insurance</H3>Through the term of the 2011 International CES, December 27, 2010 – January 13, 2011, the EAC must maintain comprehensive general liability insurance against claims for bodily injury or death and property damage occurring in or upon or resulting from the premises leased by CES. Such insurance shall include contractual liability and product liability covered with the following limits: 
<UL class=text>
<LI class=text>Comprehensive General Liability insurance with amounts no less than $1,000,000 each occurrence, $2,000,000 aggregate, combined single limit for bodily injury and property damage including coverage for personal injury, contractual, and complete operations coverage included. </LI>
<LI class=text>Comprehensive Automobile Liability coverage with limits no less than $2,000,000 each occurrence combined single limit for bodily injury and property damage, including coverage for owned, non-owned and hired vehicles, including loading and unloading operators. </LI>
<LI class=text>Workers' Compensation, Employee and Employers' Liability coverage in full compliance with all laws covering clients’ employees. </LI></UL><STRONG>
<H3>Additional Insured</H3>
<P></STRONG>For exhibits at the LVCC: The Consumer Electronics Association, GES Exposition Services and the Las Vegas Convention Center must be named as Additional InsuredS<BR>For exhibits at the Hilton: The Consumer Electronics Association, GES Exposition Services and the Las Vegas Hilton must be named as Additional Insured.<BR>For exhibits at the Venetian: The Consumer Electronics Association,&nbsp;Global Experience Specialists (GES)&nbsp;and the The Venetian/Palazzo must be named as additional insureds.<BR></P><STRONG>
<H3>Original Certificates of Insurance must be sent to the above name parties at:</H3>
<P></STRONG>CEA (Uploaded via on-line tool): CES Operations; 1919 South Eads Street, Arlington, VA 22202<BR>GES: 7000 Lindell Road, Las Vegas, NV 89118 <BR>LVCC: Director of Facilities, Las Vegas Convention and Visitors Authority, 3150 Paradise Road, Las Vegas, NV 89109 <BR>Las Vegas Hilton: Attn:&nbsp;Ken Ratigan&nbsp;3000 Paradise Road, Las Vegas, NV 89109<BR>Venetian: Attn: John Quach, <A href="mailto:john.quach@venetian.com">john.quach@venetian.com</A> &nbsp;</P>
<P>A sample Certificate of Insurance can be found in the Exhibitor Manual in section #5, EAC's.</P>
<H3>GES and LVCC Requirements</H3><STRONG>Las Vegas Convention Center (LVCC) Requirements</STRONG><BR>EACs intending to work in the LVCC must have approval from the venue. All requirements must be met before commencing work at the LVCC. The requirements are listed below and can also be found at: <A href="http://www.lvcva.com/meetings/meeting-venues/convention-centers/info/lvcc-requirements.jsp" target=_blank ywaOnclickOverride="true">http://www.lvcva.com/meetings/meeting-venues/convention-centers/info/lvcc-requirements.jsp</A>. The Las Vegas Convention and Visitors Authority requires a $250 annual fee from all Independent Service Contractors providing service at the LVCC,&nbsp;a Clark County Businss License, a Nevada State Industrial Insurance Sysem Account must be established, and a valid Certificate of Insurance must be provided.<BR><BR><STRONG>GES Requirements<BR></STRONG>GES requires notification from Exhibitors in the event that an EAC will be working on your display. Please turn in the GES Notice of Intent to Use Exhibitor Appointed Contractor form, found in section #5 of the Exhibitor Manual, along with your insurance certificate. 
<H3></H3>

    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibitors/showPlanning/eac-dashboard.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
