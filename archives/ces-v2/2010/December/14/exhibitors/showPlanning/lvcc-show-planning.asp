...
<head><!-- PageID 3900 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: LVCC/Hilton Exhibitor Show Planning Resources</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/exhibitors/default.asp-->
            ...
            <li class="selected"><a href="/exhibitors/showPlanning/lvcc-show-planning.asp">LVCC/Hilton Exhibitor Show Planning Resources</a></li>
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/showPlanning/default.asp" class="footer">Show Planning</a>&nbsp;&gt;&nbsp;LVCC/Hilton Exhibitor Show Planning Resources</div>
                        </div>
                        <div class="headerbox">
                       <h1>LVCC/Hilton Exhibitor Show Planning Resources</h1>
                            <div class="icon_wrap">
...
<div class="page_header_block">
    <div class="blue_box">
        ...
        <li><a href="#4119">Official Show Vendors</a></li><!---->
        
        <li><a href="#3980">2011 Target Freight Move-In and Move-Out Floorplans Available Now</a></li><!---->
        
            </ul>
        
            <ul>
        
        <li><a href="#3983">Deadline Checklist</a></li><!---->
        
            </ul>
        
            <ul>
        
        <li><a href="#3982">International Shipping Information</a></li><!---->
...
<div class="sponsorshipTitle">Official Show Vendors</div>
<br />We know you can sometimes be bombarded with information and marketing materials claiming they are affiliated with the International CES. In order to make it easier for you, we’re listing each of our official contractors and vendors so there is never any confusion. <A href="/docs/Official_Suppliers_7_-_15.pdf" target==_blank>Download the full list here</A>, and If you have any questions, contact Katie Swearingen at </SPAN><A href="mailto:kswearingen@ce.org">kswearingen@CE.org</A>.
...
<br />Select your hall or venue below to download your target move-in and move-out floorplans. Target plans change as the show floor changes, so check back every two weeks for the latest version.&amp;nbsp;For inquiries about changing your target date, contact GES at <A href="mailto:CESfreight@GES.com">CESfreight@GES.com</A>, or contact <A href="mailto:kswearingen@ce.org">Katie Swearingen</A>&nbsp;with any other questions. <BR><BR>North Hall:&nbsp; <A href="http://marketing.ges.com/kits/2011_CES_TargetMaps/CES-1101-lvcc-MI-N.pdf" target==_blank>Move-in</A>/&nbsp;<A href="http://marketing.ges.com/kits/2011_CES_TargetMaps/CES-1101-lvcc-MO-N.pdf" target==_blank>Move-out&nbsp;</A> <BR>Central Hall: <A href="http://marketing.ges.com/kits/2011_CES_TargetMaps/CES-1101-lvcc-MI-C.pdf" target==_blank>Move-in</A>/ <A href="http://marketing.ges.com/kits/2011_CES_TargetMaps/CES-1101-lvcc-MO-C.pdf" target==_blank>Move-out</A> <BR>Upper Level Meeting Rooms: <A href="http://marketing.ges.com/kits/2011_CES_TargetMaps/CES-1101-lvcc-MI-UMR.pdf" target==_blank>Move-in</A>/ <A href="http://marketing.ges.com/kits/2011_CES_TargetMaps/CES-1101-lvcc-MO-UMR.pdf" target==_blank>Move-out</A> <BR>South Hall 1: <A href="http://marketing.ges.com/kits/2011_CES_TargetMaps/CES-1101-lvcc-MI-S1.pdf" target==_blank>Move-in</A>/ <A href="http://marketing.ges.com/kits/2011_CES_TargetMaps/CES-1101-lvcc-MO-S1.pdf" target==_blank>Move-out</A><BR>South Hall 2: <A href="http://marketing.ges.com/kits/2011_CES_TargetMaps/CES-1101-lvcc-MI-S2.pdf" target==_blank>Move-in</A>/ <A href="http://marketing.ges.com/kits/2011_CES_TargetMaps/CES-1101-lvcc-MO-S2.pdf" target==_blank>Move-out</A><BR>South Hall 3: <A href="http://marketing.ges.com/kits/2011_CES_TargetMaps/CES-1101-lvcc-MI-S3.pdf" target==_blank>Move-in</A>/ <A href="http://marketing.ges.com/kits/2011_CES_TargetMaps/CES-1101-lvcc-MO-S3.pdf" target==_blank>Move-out</A><BR>South Hall 4: <A href="http://marketing.ges.com/kits/2011_CES_TargetMaps/CES-1101-lvcc-MI-S4.pdf" target==_blank>Move-in</A>/ <A href="http://marketing.ges.com/kits/2011_CES_TargetMaps/CES-1101-lvcc-MO-S4.pdf" target==_blank>Move-out</A><BR>Las Vegas Hilton: <A href="http://marketing.ges.com/kits/2011_CES_TargetMaps/CES-1101-lvcc-MI-H.pdf" target==_blank>Move-in</A>/ <A href="http://marketing.ges.com/kits/2011_CES_TargetMaps/CES-1101-lvcc-MO-H.pdf" target==_blank>Move-out</A>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sponsorshipTitle">Deadline Checklist</div>
<br />View the complete <A href="http://ges.com/ecomm/2011/q1/11-05117/pdf/Deadline.pdf" target==_blank>LVCC and Hilton Deadline Checklist</A>. This document includes all the dates you will need to place your orders and it's easy to print out to help you stay on track.
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sponsorshipTitle">International Shipping Information</div>
<br /><STRONG>New US Customs regulations apply to all ocean freight shipments to the USA. Importer Security Filing (ISF) – Important changes since CES 2010</STRONG><BR><BR>Department Homeland Security has introduced measures to identify ocean cargo may pose security threat before loaded on board a vessel bound for USA. The new regulation requires that specific information about cargo, was manufactured, shipped it, where it is destined USA and who importer is, be filed with US Customs (CBP) in advance of the goods being shipped. <BR><BR>The details required as part of this process are standard in the commercial shipping process. The difference with this regulation is that these details must be filed before a shipment is made overseas. This will impact all overseas exhibitors shipping materials to the USA by sea freight. If these steps are not taken, US Customs and Border Protection (CBP) may impose a fine of up to $10,000 per shipment. This&nbsp;has been in effect&nbsp;since The following information - the Importer Security Filing (ISF) - must be filed with US Customs (CBP) at least 24 hours before the vessel sails from the overseas port:<BR><BR>Agility Fairs &amp; Events is&nbsp;our official international freight forwarder and Customs broker. </SPAN. departure. If 24 hours sails, shipment not subject fine by (CBP)<BR days 10 least at Events &amp; Fairs Agility details above communicate agent your or you important forwarder, freight another through exhibits ship choose SPANIf network. sent shipments exhibitor all filing ISF complete will < the Customs US filed be and USA is it that for vessel a board on loaded before may to>Additional information is available at <A href="http://www.cbp.gov/" target=_blank>http://www.cbp.gov/</A> or by contacting Agility Fairs and Events USA at <A href="mailto:expousa@agilitylogistics.com">expousa@agilitylogistics.com</A> <BR>Agility Fairs & Events USA<BR>Email: <A href="mailto:mchurchill@agilitylogistics.comPh">Margaret Churchill</A><BR>Phone: 404-815-8816<BR>Fax: 404-724-9135
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibitors/showPlanning/lvcc-show-planning.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
