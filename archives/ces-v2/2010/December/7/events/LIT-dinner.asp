...
<TR>
<TD>
<H3>Netflix CEO Reed Hastings to Keynote 2011 CES LIT Dinner</H3>
<P><IMG hspace=5 align=right src="/images/content/reed_hastings.jpg" width=144 height=205><A href="http://www.netflix.com/" target=_blank>Netflix</A> CEO Reed Hastings will do a fireside chat with <A href="http://www.ce.org" target=_blank>Consumer Electronics Association (CEA)</A> CEO Gary Shapiro that will open the annual Leaders in Technology Dinner at CES. The LIT dinner&nbsp;honors the technologists, entrepreneurs and policymakers instrumental in furthering technology innovation.<BR><BR>"Reed Hastings is a true leader in technology, a talented entrepreneur who had an innovative vision for creating new ways to bring entertainment into consumers' homes," said Gary Shapiro, president and CEO of CEA. "Through Reed's leadership, Netflix continues to innovate, partnering with CE companies to deliver the connected TV experiences. We are thrilled to have him keynote the 2011 CES LIT dinner and look forward to hearing where Netflix is headed next." </P>
<P>Reed Hastings co-founded <A href="http://www.netflix.com" target=_blank>Netflix</A> in 1997 and launched the subscription service in 1999. Netflix grew to one million subscribers in less than four years. Today the company has 16.9 million members. In&nbsp;10 of the last 11 surveys since 2005 Netflix has been ranked number one in customer satisfaction across all of ecommerce by independent researcher ForeSee Results. In 2005, Time magazine added Hastings to its "Time 100" list of the most influential global citizens. Hastings received a BA from Bowdoin College in 1983 and an MSCS degree from Stanford University in 1988. He holds several patents. Between Bowdoin and Stanford, Reed served in the U.S. Peace Corps as a high school math teacher in Swaziland. </P></TD></TR></TBODY></TABLE>
