...
<link type="text/css" rel="stylesheet" href="/css/74F7D8B561134C5D8CC0D19C1C676C87.css" />
...
<script type="text/javascript" src="/utilities/0633CDB96A3B4E149F314459FBDE6EAB.js"></script>
...
//END BLOG     
    ...
    <style type="text/css">
        ...
        .ui-tabs .ui-tabs-nav li:hover {border:none; background:url("/images/framework/CESweb_tab_hover.png") no-repeat bottom right;z-index:1;margin: 0px 0px 0px -26px; padding: 0px 21px;}
        
        .ui-tabs .ui-tabs-nav li.news {border:none; background:url("/images/framework/news.png") no-repeat bottom center;z-index:1; margin: 0px 0px 0px -26px; padding: 0px 21px 0px 23px;color:#fff;}
        ...
        .ui-tabs .ui-tabs-nav li.news.ui-tabs-selected  {background:url("/images/framework/news_active.png") no-repeat bottom center;z-index:100;margin: 0px 0px 0px -26px; padding: 0px 21px 0px 23px;color:#000;}
        .ui-tabs .ui-tabs-nav li.news.ui-tabs-selected a {color:#000;}
        .ui-tabs .ui-tabs-nav li.blog {border:none; background:url("/images/framework/blog.png") no-repeat bottom center;z-index:1;color:#fff;margin: 0px 0px 0px -23px; padding: 0px 29px;}
        ...
        .ui-tabs .ui-tabs-nav li.blog.ui-tabs-selected  {background:url("/images/framework/blog_active.png") no-repeat bottom center;z-index:100;margin: 0px 0px 0px -23px; padding: 0px 29px;color:#000;}
        .ui-tabs .ui-tabs-nav li.blog.ui-tabs-selected a {color:#000;}
        .ui-tabs .ui-tabs-nav li.video {border:none; background:url("/images/framework/blog.png") no-repeat bottom center;z-index:1;margin: 0px 0px 0px -33px; padding: 0px 24px 0px 22px;color:#fff;}
        ...
        .ui-tabs .ui-tabs-nav li.video.ui-tabs-selected  {background:url("/images/framework/blog_active.png") no-repeat bottom center;z-index:100;margin: 0px 0px 0px -33px; padding: 0px 24px;color:#000;}
        .ui-tabs .ui-tabs-nav li.video.ui-tabs-selected a {color:#000;}
        .ui-tabs .ui-tabs-nav li.photos {border:none; background:url("/images/framework/blog.png") no-repeat bottom center;z-index:90;color:#fff;margin: 0px 0px 0px -36px; padding: 0px 23px;}
        ...
        .ui-tabs .ui-tabs-nav li.photos.ui-tabs-selected  {background:url("/images/framework/blog_active.png") no-repeat bottom center;z-index:100;color:#000;margin: 0px 0px 0px -36px; padding: 0px 24px;}
        .ui-tabs .ui-tabs-nav li.photos.ui-tabs-selected a {color:#000;}
        .ui-tabs .ui-tabs-nav li.myces {border:none; background:url("/images/framework/blog.png") no-repeat bottom center;z-index:90;color:#fff;margin: 0px 0px 0px -34px; padding: 0px 20px;}
        ...
        .ui-tabs .ui-tabs-nav li.myces.ui-tabs-selected  {background:url("/images/framework/blog_active.png") no-repeat bottom center;z-index:100;color:#000;margin: 0px 0px 0px -34px; padding: 0px 22px;}
...
<div id="slideshow" >
    ...
    <A href="http://www.cesweb.org/news/rssNews.asp#4585"><img src="/images/homepage/GaryBook_Preorder.jpg"></A>
    <div class="slideCaption"><p><A href="http://www.cesweb.org/news/rssNews.asp#4585">New book from CEA president and CEO now available for pre-order.</A><BR>
    <A href="http://www.cesweb.org/news/rssNews.asp#4585">View a sneak peek.  >></a></div></p>
</li><li>
    
    <A href="http://digital.virtualmarketingpartners.com/vmp/CES/attendee-promo-2011/index.php"><img src="/images/homepage/HP_CES_AttendeeVirtualBrochure.jpg"></A>
    <div class="slideCaption"><p><A href="http://digital.virtualmarketingpartners.com/vmp/CES/attendee-promo-2011/index.php">Find out what's at the center of technology.</A><BR>
    <A href="http://digital.virtualmarketingpartners.com/vmp/CES/attendee-promo-2011/index.php">Flip through the virtual CES attendee brochure. >></a></div></p>
</li><li>
    
    <A href="http://www.cesweb.org/contest"><img src="/images/homepage/VisitMeHP.jpg"></A>
    <div class="slideCaption"><p><A href="http://www.cesweb.org/contest">CES exhibitors have a future in technology, and they may have futures in movie making, too!</A><BR>
    <A href="http://www.cesweb.org/contest">Video contest winners announced! >></a></div></p>
</li><li>
    
    <A href="http://www.EMatCES.com"><img src="/images/homepage/EntertainmentMatters_CelebrityAd_Nov21.jpg"></A>
    <div class="slideCaption"><p><A href="http://www.EMatCES.com">The entertainment and technology industries go hand in hand.</A><BR>
    <A href="http://www.EMatCES.com">Attend Entertainment Matters at CES. >></a></div></p>
</li><li>
    
        <A id="691270137001" class="cboxVideo" href="#"><img src="/images/homepage/CESTV_HiltonVEN.jpg"></A>
    <div class="slideCaption"><p><A id="691270137001" class="cboxVideo" href="#">CESTV: The Venetian and Las Vegas Hilton</A><BR>
    <A id="691270137001" class="cboxVideo" href="#">Everything you need to know, from press events and keynotes to the International Gateway >></a></div></p>
</li><li>
    
    <A href="http://www.cesweb.org/awards/mashable-awards.asp"><img src="/images/homepage/HP_Mashable_ces_slider_final.jpg"></A>
    <div class="slideCaption"><p><A href="http://www.cesweb.org/awards/mashable-awards.asp">Mashable Awards come to CES. </A><BR>
    <A href="http://www.cesweb.org/awards/mashable-awards.asp">Tickets on sale now. >></a></div></p>
</li><li>
    
    <A href="http://www.ceatechenthusiast.com/?utm_source=CES%2BWebsite&utm_medium=ces%2Bhome%2Bpage&utm_term=1k&utm_campaign=CES%2BHome%2BPage%2BCall%2BOut"><img src="/images/homepage/TEPromo.jpg"></A>
    <div class="slideCaption"><p><A href="http://www.ceatechenthusiast.com/?utm_source=CES%2BWebsite&utm_medium=ces%2Bhome%2Bpage&utm_term=1k&utm_campaign=CES%2BHome%2BPage%2BCall%2BOut">Are you a tech enthusiast?</A><BR>
    <A href="http://www.ceatechenthusiast.com/?utm_source=CES%2BWebsite&utm_medium=ces%2Bhome%2Bpage&utm_term=1k&utm_campaign=CES%2BHome%2BPage%2BCall%2BOut">Make it official with a new CEA membership progam. >></a></div></p>
</li>
            </ul>
        </div>
    </div>
...
<LI id=blog_4_button class=up><A onclick="return blogActive('blog_4');" href="">4</A></LI></UL></DIV>
    ...
    <!-- Photos -->
    <H3>Photos from the 2010 International CES</H3><IFRAME src="http://www.cesweb.org/hp/photos.asp" frameBorder=0 width=680 scrolling=no height=460></IFRAME>
</div><div id="fragment-5">
    <!-- myces -->
    
    <!-- MyCES -->
    <IMG align=left src="/images/content/MY_CES_2k10.gif" width=128 height=85>We've made some improvements to the MyCES planning tool that we think you're going to like. You can still search for exhibitors and products that you're interested in seeing at CES and add them to your show agenda. And now you can see exactly where those exhibitors and products are located on the show floor using the new
<SCRIPT language=javascript src="http://www.mapyourshow.com/includes/floorplan.js"></SCRIPT>
 <A onclick=" OpenMapYourShowMax(this.href,this.target);return false" href=" http://www.mapyourshow.com/shows/index.cfm?SHOW_ID=CES11&alt_entry=true&curr_pri=facility&curr_sec=OO" target=floorplan>Interactive Floor Plans! </A>
<P>With the new MyCES Planner, you can&nbsp;create a personalized show agenda that allows you to:</P>
<UL>
...
<TBODY>
<TR>
<TH colSpan=5><IMG src="/images/content/myCES-top.jpg"></TH></TR>
<TR>
<TH colSpan=5>&nbsp;</TH></TR>
<TR>
<TH colSpan=5>&nbsp;</TH></TR>
<TR align=middle>
<TD><A href="http://ces11.mapyourshow.com" target=_blank><IMG border=0 src="/flash/dir-search.jpg" width=110 height=113></A></TD>
<TD><A href="http://ces11.mapyourshow.com/search.cfm?search=featured" target=_blank><IMG border=0 src="/images/content/featured-exhibitors.jpg"></A></TD>
<TD><A href="http://ces11.mapyourshow.com/search.cfm?search=category" target=_blank><IMG border=0 src="/images/content/product-search.jpg" width=126 height=112></A></TD>
<TD><A href="http://ces11.mapyourshow.com/myshow/login.cfm" target=_blank><IMG border=0 src="/images/content/myplanner.jpg" width=126 height=128></A></TD>
<TD>
<SCRIPT language=javascript src="http://www.mapyourshow.com/includes/floorplan.js"></SCRIPT>
<A onclick=" OpenMapYourShowMax(this.href,this.target);return false" href=" http://www.mapyourshow.com/shows/index.cfm?SHOW_ID=CES11&alt_entry=true&curr_pri=facility&curr_sec=OO" target=floorplan><IMG border=0 src="/images/content/floor-maps.jpg"></A></TD></TR>
<TR>
<TD></TD>
<TD align=center></TD>
<TD></TD>
...
<TH colSpan=5>&nbsp;</TH></TR>
<TR>
<TH colSpan=5><IMG src="/images/content/myCES-bottom.jpg"></TH></TR></TBODY></TABLE>
</div>
    </div>
</div>
<!-- End Tab Structure ---><div id="sidelinks">
    <img style="padding-bottom: 3px;" src="/images/framework/cesweb_intltab.png">
    <a href="/exhibitors/default.asp" title="For Exhibitors"><img src="/images/framework/cesweb_exhibitors1.png" alt="Exhibitors" name="cesweb_exhibitors" onMouseOver="over(10)" onMouseOut="out(10)" style="padding-bottom:3px;" /></a>
    <a href="/press/default.asp" title="For Press"><img src="/images/framework/cesweb_press1.png" alt="Press" name="cesweb_press" onMouseOver="over(11)" onMouseOut="out(11)"  style="padding-bottom:3px;" /></a>
    <a href="/international/default.asp" title="For Visitors"><img src="/images/framework/cesweb_visitors1.png" alt="Visitors" name="cesweb_visitors" onMouseOver="over(12)" onMouseOut="out(12)" style="padding-bottom:3px;"/></a>
    <a href=http://www.EMatCES.com/ title="Entertainment Matters"><img src="/images/framework/EMatCES1.jpg" alt="Entertainment Matters" name="entertainment_matters" onMouseOver="over(13)" onMouseOut="out(13)" style="padding-bottom:3px;"/></a>

</div><img style="padding-top: 10px;" src="/images/framework/cesweb_twittertab.png"><br />
<div id="twitter"></div>
            </div>
        </div>
    </div>
