...
<head><!-- PageID 379 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Show Floor</title>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <P align=center><A href="http://ce.org" target=_blank><IMG border=0 hspace=3 align=top src="/images/content/cea-logo-sm.gif" width=139 height=55></A><BR>
<P align=left>The International CES is produced by the <A href="http://www.ce.org/" target=_blank>Consumer Electronics Association (CEA)</A>, the preeminent trade association promoting growth in the consumer technology industry.</P>
    </div>
</div>
<div class="right-blue-box" align="center">
    ...
    <div>
        <A href="/docs/2011_CES_Show_Locations_Map.pdf" target=_blank>Download a birds-eye map</A> of the International CES exhibit halls: the Las Vegas Convention Center/Las Vegas Hilton and the The Venetian. <BR><BR><A href="/docs/2011_CES_Show_Locations_Map.pdf" target=_blank><IMG border=0 src="/images/content/2010_show_locations_map_thumb.jpg" width=180 height=130></A><BR><BR>
    </div>
</div>
                        </div>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;Show Floor</div>
                        </div>
                        <div class="headerbox">
                       <h1>Show Floor</h1>
                            <div class="icon_wrap">
...
<IMG hspace=10 align=right src="/images/photos/09floor2.jpg" width=190 height=127>CES reflects the dynamic consumer electronics industry by evolving along with it. We reshape CES each year to keep the show fresh and relevant to its attendees. Get familiar with the ins and outs of the 2011 International CES show floor in the way that best suits you:<BR><BR>
<H3><A href="/showFloor/by-hall.asp">By Exhibit Hall</A></H3>CES uses two large venues and covers more space than 35 (American) football fields. Get nice, easy-to-scan lists of show floor destinations based on different areas of the Las Vegas Convention Center/Las Vegas Hilton and The Venetian.<BR><BR>
<H3><A href="/showFloor/by-product.asp">By Product Category</A></H3>CES represents 15 product categories. If you have a particular consumer technology market in mind, use this list to see where you'll find it on the show floor.<BR><BR>
<H3><A href="/showFloor/techzones.asp">CES TechZones</A></H3>The spotlight shines brightly on several key vertical markets. Immerse yourself in them through&nbsp;20 CES TechZones showcasing&nbsp;emerging products and companies. <BR><BR>
<H3><A href="/showFloor/Floor-Plans.asp">Floor Plans</A></H3>Check out the&nbsp;2011 International CES&nbsp;interactive floor plans.&nbsp;<BR><BR>
<H3><A href="/followme.asp">Follow Me</A></H3>"Follow Me" is an interactive smartphone application designed specifically for the tradeshow industry, featuring real-time show alerts and interactive floor maps.<BR><BR><BR><BR><BR><STRONG>Interested in exhibiting at CES?</STRONG> <A href="/exhibitors/space/contactRep.asp">Contact a CES sales representative.</A>
