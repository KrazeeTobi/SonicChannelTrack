...
<head><!-- PageID 4147 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: August 2010</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/exhibitors/default.asp-->
            ...
            <li class="selected"><a href="/exhibitors/newsletter/aug10.asp">August 2010</a></li>
...
by Brandon Moffitt</p>
    ...
    <!-- article end -->
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;August 2010</div>
                        </div>
                        <div class="headerbox">
                       <h1>August 2010</h1>
                            <div class="icon_wrap">
...
<div align="center">
    ...
    [ <a href="/exhibitors/newsletter/aug10ops.asp">Operations</a> ]
...
<IMG hspace=5 align=right src="/images/photos/laptop(1).jpg" width=125 height=109>Once again CES will present exhibitors with the CES Exhibitor Workshop webcast series. This free, four-part webcast series starts in September and will provide exhibitors with the CliffsNotes you need to succeed at CES. From marketing and PR tips and logistics information to our vendors GES and Map Your Show, the series covers it all.<BR><BR>Also, if you register for the workshop, you’ll receive access to the CES official vendor discount codes to receive discounts from some of our official CES vendors.&nbsp;&nbsp;<BR><BR>Here are the dates and descriptions for all webcasts: Registration is now open! <BR><BR><STRONG>Using MyCES to Gain that Competitive Edge</STRONG><BR>September 9, 2010 – 2 p.m. EST<BR>Join us for a free Webcast to learn how MyCES can provide your company with new opportunities to showcase your product line to targeted prospects pre, during and post show. <A href="/exhibitors/resources/workshop.asp">Register now</A>.<BR><BR><STRONG>Optimize Your Marketing Resources and Get the Most Press Coverage<BR></STRONG>September 28, 2010 – 2 p.m. EST<BR>The CES Marketing and Communications teams will provide you with free tools that will help to market your booth and get the press coverage you need for a successful show.&nbsp;<A href="/exhibitors/resources/workshop.asp">Register now</A>.<BR><BR><STRONG>Discovering CES Operations and Booth Logistics</STRONG><BR>October 14, 2010 – 2 p.m. EST<BR>The CES Operations Team will help make your booth planning easier with tips on navigating the show, securing hotel reservation, and setting up and staying within our rules and regulations, security, fire marshal, and other CES tips. <A href="/exhibitors/resources/workshop.asp">Register now</A>.<BR><BR><STRONG>Meet GES</STRONG> <BR>October 28, 2010 – 2 p.m. EST<BR>A panel of GES experts will be available to discuss show planning needs.&nbsp; Topics that will be covered include shipping, order deadline dates, electrical, union jurisdiction, and any further needs you may have of GES to ensure the successful execution of your show.&nbsp;<A href="/exhibitors/resources/workshop.asp">Register now</A>.<BR>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />
...
<IMG hspace=5 align=right src="/images/content/2k11_Innovations_SAMPLE_med.jpg" width=114 height=170>The CE industry is charged up with innovative designs and products, and thousands of industry leaders and press flock to CES each year to witness the "<A href="/exhibitors/newsletter/2010honorees.asp">next big thing</A>." Is your product powered on and ready to top the list?<BR><BR>The <A href="/awards/innovations/default.asp">International CES® Innovations 2011 Design and Engineering Awards</A> is the most impressive and renowned awards program in the consumer technology industry. Being an Innovations Honoree can provide you with incredible opportunities, special recognition in the CE industry and worldwide exposure for your company and products.<BR><BR><STRONG>NEW for 2011:</STRONG> Innovations 2011 is introducing two brand <A href="/awards/innovations/categories.asp">new entry categories</A>—Major Home Appliances and Portable Home Appliances. <BR><BR>The <A href="/exhibitors/newsletter/D5D11BBD8870442983DE9C4C7703BE65.htm">Call for Entries</A> opens on August 23 and you can save $200 by preparing your entry now and submitting before September 8.<BR><BR>Not <A href="/awards/innovations/about.asp">eligible to enter</A> this year? <A href="/exhibitors/sponsorships/awards.asp">Sponsor the program </A>to gain incredible exposure in the months leading up to CES and see your company featured among the most creative in the industry at the Innovations Showcase. <BR><BR>The Innovations <A href="/awards/innovations/callForJudges.asp">Call for Judges</A> is open now. If you're an independent designer or an engineer, we want you! Qualified exhibitors are eligible to judge categories in which their employers have not entered products. Be the first to see the newest products in the CE industry.<BR>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />
...
<IMG hspace=5 align=right src="/images/photos/Globe1.jpg" width=200 height=200>Interested in exporting? Plan to participate in our Exporting Exhibitor Program. The program is complimentary for all CES exhibitors. Benefits include: 
<P></P>
<UL>
