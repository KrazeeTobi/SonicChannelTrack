...
<div class="right-blue-box" align="center">
    ...
    <div>
        <UL class=blue_box>
<LI class=blue_box><A href="/exhibitors/newsletter/dec10.asp">
<DIV class=sub-content-header>Space Selection Packets and Operations News!</DIV></A>&nbsp;</LI></UL>Find this story and more in this month's <A href="/exhibitors/newsletter/dec10.asp">Exhibitor's Source newsletter.<BR></A><BR>
    </div>
</div>
...
<P class=text><STRONG>Maximize-your-marketing budget idea:<BR><A href="http://www.cesweb.org/exhibitors/sponsorships/pressOpportunitites.asp#792">Exhibit&nbsp;at CES Unveiled: The Official <BR>Press Event of the International CES</A></STRONG></P></TD>
<TD>&nbsp;</TD>
<TD vAlign=top>
<UL>
...
<div class="sub-content-header">Enhance Your Online Directory Listing with MYS - New Discounts!</div>
<br />

<IMG hspace=5 align=right src="/images/content/MYS_Logo.jpg" width=144 height=127>New for the 2011 show, CES is partnering with Map Your Show (MYS) to provide this year's&nbsp;online <A href="/exhibitors/default.asp">Exhibitor Directory</A> and floor plan. These easy-to-use interactive applications are sure to please both exhibitors and attendees alike as they make their plans for this year’s show.&nbsp;<BR><BR>There’s still plenty of time for you to access these qualified sales leads.&nbsp; You can purchase a Leads Package today - a $795 value – for only $395!&nbsp; This cost-effective purchase lets you begin contacting these prospects as well as any future ones added in the weeks to come.&nbsp;Online traffic will significantly increase in the coming weeks.&nbsp; Don’t&nbsp; miss this opportunity. <A href="/exhibitors/sponsorships/default.asp">Enhance your online directory listing today with these newly discounted packages</A>. <BR><BR><IMG align=left src="/images/content/MY_CES_2k10.gif" width=128 height=85>In addition to displaying basic contact and product information, you&nbsp;have the opportunity to highlight you&nbsp;listings with pictures, videos or even Flash presentations. Creating eye-catching presentations is a surefire way to snag the attention of attendees who will be using MyCES as they create their agendas for the 2011 show. Attendees will populate their planners with sessions they wish to attend along with, of course, a list of all their must-see exhibitors.<BR><BR>If at any time you have any questions regarding the Online Exhibitor Directory, Floor Plan or Exhibitor Dashboard, you can e-mail MYS at <A href="mailto:help@mapyourshow.com">help@mapyourshow.com</A> or give them a call at 888-527-8823.<BR><BR>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />
...
<IMG hspace=5 align=right src="/images/content/FollowMe.jpg" width=100 height=99>Follow Me, the official CES mobile application, is ripe with opportunities for exhibitors to get their brand out in front of the more than 120,000 CES attendees expected at this year’s show. 

<P>Attendees will look to Follow Me for its interactive maps and MyCES schedules. <STRONG>Get your booth noticed!</STRONG> For just $25, you can add your logo and make documents available to attendees. The application will be available after the show, giving attendees access to your information year-round.&nbsp; <A href="http://www.cesweb.org/docs/Follow_Me-ExhibitorAdInfoSheet.pdf" target=_blank>Check out this flyer</A> for more sponsorship and package information.<BR></P>
<P></P>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />
...
<IMG height=49 hspace=5 src="/images/content/CES_Unveiled_event.gif" width=250 align=right>There are so many reasons to exhibit at CES Unveiled, but here are 10 we think might pique you interest: ABC, CBS, CNBC and NBC, CNET, Consumer Reports, ESPN, Financial Times, Fox, The New York Times and the Wall Street Journal.<BR><BR>Intrigued yet?<BR><BR>CES Unveiled in Las Vegas,&nbsp; January 4,&nbsp;offers valuable opportunity to promote your products two days before CES opens its doors. Already, we expect more than 800 at Unveiled in Vegas.<BR><BR>A simple tabletop set-up makes it easy for your team to network with the top industry and consumer media, build relationships, and generate coverage. CES Unveiled events are the best way to get the press buzzing about your products before the show. Sign up today to take advantage of all these pre-event promotional opportunities!
<P>Contact: <A href="mailto: CESUnveiled@CE.org" target=_blank>mailto: CESUnveiled@CE.org</A>. Visit <A href="http://www.CESweb.org/CESUnveiled" target=_blank>CESweb.org/CESUnveiled</A> for more information.</P>    
