...
<IMG border=0 align=right src="/docs/LastGadgetStanding.gif" width=300 height=188>A perennial attendee favorite, Last Gadget Standing challenges contenders to give the product demo of their lives. At stake: bragging rights as the product "most likely to change the face of technology." See all the winners strut their stuff in this inventive, fast-paced competition.<BR><BR><STRONG>Watch&nbsp;the 2010 CES Last Gadget Standing&nbsp;now:</STRONG><BR><BR><EMBED height=200 type=application/x-shockwave-flash width=300 src=http://player.stickam.com/flashVarMediaPlayer/187252515 allowScriptAccess="always" allowFullScreen="true" wmode="transparent"></EMBED><BR>
