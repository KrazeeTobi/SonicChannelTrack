...
<head><!-- PageID 3985 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
...
<IMG src="/images/photos/Events.jpg"></A><BR>From showdowns to Tweetups and everything in between, CES has something for everyone. Take a look at these events slated for the 2011 International CES, January 6-9, and <A href="http://cms.ce.org/register">register now.<BR><BR>
<H3><A href="/events/keynotes.asp">Keynote Addresses</A></H3>The biggest names in the industry take center stage to share insight and oftentimes bring along big-time celebrities to entertain, too.<BR><BR><BR>
<H3><A href="/events/press-events.asp">Press Events</A></H3>A variety of events&nbsp;give media members&nbsp;several opportunities to get first-looks at&nbsp;the new products launching at CES.&nbsp;<BR><BR><BR>
<H3><A href="/events/last-gadget-standing.asp">Last Gadget Standing</A></H3>A perennial attendee favorite, Last Gadget Standing challenges contenders to give the product demo of their lives. <BR><BR><BR>
<H3><A href="/events/tweetup.asp">CES Tweetup</A></H3>International CES&nbsp;Twitter followers are invited to meet the CEA Social Media Team and other members of our online community at the Official CES Tweetup, hosted by the Las Vegas Hilton. <BR><BR><BR>
<H3><A href="/events/CEA-events.asp">CEA Events</A></H3>See what else the producer of CES has for you throughout the year.<BR><BR><BR><BR><A href="http://feeds.cesweb.org/CESrss" target=_blank><IMG border=0 hspace=0 src="/images/content/RSS-small.jpg" width=16 height=16></A> <A href="http://feeds.cesweb.org/CESrss" target=_blank>Subscribe to the CES news feed</A> to be the first to hear about upcoming CES event announcements.</A>
