...
<head><!-- PageID 1251 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Call for Judges</title>
...
<FONT size=3><STRONG>The call for judges closed on August 27, 2010. We are no longer accepting applications.</STRONG><BR></FONT><BR>If you're a member of the press, an independent designer or an engineer, we want you! 
<UL class=text>
...
<LI class=text>Do you consider yourself a knowledgeable consumer electronics design professional, with expertise in any of the 35&nbsp;<A href="/docs/2K11Innovations_Guide6.30.pdf" target=_blank>Innovations 2011 awards categories</A>? </LI>
...
<P><BR>The Innovations Design and Engineering Awards program, sponsore by PCWorld,&nbsp;recognizes the most innovative consumer electronics products&nbsp;the 35&nbsp;categories and has become a hallmark for the best-designed products in consumer technology. Download the <A href="/docs/2K11Innovations_Guide6.30.pdf" target=_blank>awards category guide </A>that includes examples of eligible products within a category to assist you in selecting the categories you feel most qualified to judge.</P>
...
Each awards category is judged by a three-member panel consisting of an independent industrial designer, independent engineer or industry analyst and a member of the trade press. The judging process is conducted online and will begin October 4, 2010, and end on October 15, 2010. We have determined that it takes approximately 10-15 minutes to evaluate an entry. Judges will be required to judge a minimum of two categories. In 2010, the categories contained an average of 20 entries.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<LI class=text>Special ribbon to wear on-site at CES to designate your status as an Innovations Judge <BR></LI></UL>
<BLOCKQUOTE>
<TABLE border=0 cellSpacing=1 cellPadding=1 width="60%">
<TBODY>
<TR>
<TD vAlign=top><BR><A href="http://www.idsa.org" target=_blank></A></TD>
<TD vAlign=top><STRONG>Powered by mBlast</STRONG><BR><A href="http://www.mblast.com" target=_blank><IMG border=0 vspace=10 src="/images/content/mblast.gif" width=200 height=36></A></TD></TR></TBODY></TABLE></BLOCKQUOTE>    
