...
<IMG height=189 hspace=5 src="/images/content/HotStuff_125.gif" width=125 align=right>The 2011 CES Hot Stuff Awards consists of Stuff's editors'&nbsp;10 favorite gadgets to launch at the 2011 CES. They'll be picking the most desirable, most exciting and most innovative products from the show, with every chosen product exhibiting what we call 'gadget joy' — an elusive quality that makes a product thrilling to gadget fans around the world. The 10 winners will be announced at CES on the afternoon of Thursday, January 6.<BR><BR>Check out other <A href="/exhibitors/sponsorships/awards.asp">award programs at the 2011 International CES</A>, January 6-9, 2011, in Las Vegas, Nev.
