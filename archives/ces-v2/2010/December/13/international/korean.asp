...
<head><!-- PageID 1154 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
...
<div class="right-blue-box" align="center">
    ...
    <div>
        ...
        <br /><br />
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;한국어 </div>
                        </div>
                        <div class="headerbox">
                       <h1>한국어 </h1>
                            <div class="icon_wrap">
...
<H3>글로벌 네트워크과 잠재력을 쌓으십시오.</H3>130여개국 이상에서 120,000명 이상의 참가자들이 신기술의 발사대인 CES에 참가할 것으로 예상되고 있습니다. 2,500개 이상의 전시사들이 20,000여개 이상의 제품들을 선보이는 CES는 소비자 가전 업계에 있어서 1년중 가장 흥미진진한 4일이될 것입니다.&nbsp; <A href="/register">지금 등록하십시오.</A><BR><A href="/docs/2010FACTSHEET_Korean.pdf" target=_blank></A><BR><BR><IMG align=middle src="/images/photos/International_Horizontal_1.jpg" width=480 height=162> 
<P>&nbsp;</P>
<H3>CES: 기술과 교육</H3>
<P>CES는 혁신적인 기술을 전시하는 것 뿐만 아니라 그 이상의 것들을 제공합니다. CES 컨퍼런스 프로그램은 소비자 가전 업계의 모든 면을 다루는 <A href="/conferenceProgram/default.asp">300개 이상의 세션</A>을 포함하고 있습니다. 게다가 늘 무료로 제공되는 슈퍼세션(SuperSessions)은 광범위한 시장에서의 다양한 트렌드를 배울 수 있는 기회를 제공할 것입니다.</P>
<P>올해의 기조연설자들 중에는 마이<A href="/events/keynotes.asp">크로소프트</A>사의 Steve Ballmer사장, 버라이즌 (Verizon)사의 Ivan Seidenberg사장, 아우디 (Audi)사의 Rupert Stadler 회장, 삼성의 윤보근 사장, 포드사의 Allan Mulally사장 등이 있습니다. 슈퍼세션과 기조연설에 Exhibits Plus 배지를 가지고 무료로 참석하실 수 있으며 사전 등록을 하실 필요는 없지만 자리가 한정되어 있으니 일찍 행사장에 도착하십시오. 모든 기조연설은 중국어, 한국어, 일본어로 통역이 됩니다. <BR></P>
...
<P><A href="/international/korean/services.asp">해외 방문객 서비스<BR></A>통역사, 특별 네트워크 리셉션, 효율적인 업무 공간, 회의실 등 해외 방문객을 위한 다양한 서비스가 제공됩니다.<BR><BR><NOBR><A href="/docs/Korean_6673_2011CESfacts_KO_PRESS_READY(1).pdf" target=_blank>一般信息<BR></A></NOBR>了解关于展会的历史、目前产品目录、未来展会日期等信息 —全部被译成您的语言！ </P>    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/international/korean.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
