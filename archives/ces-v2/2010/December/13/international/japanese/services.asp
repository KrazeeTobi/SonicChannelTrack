...
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        <DIV align=center><A href="http://biz.knt.co.jp/pm/ces/index.htm" target=_blank><IMG border=0 src="/images/content/CES_Japanese_Site.gif" width=150 height=45></A></DIV>
        <br /><br />
    </div>
</div>
                        </div>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/japanese.asp" class="footer">日本語</a>&nbsp;&gt;&nbsp;国際サービス</div>
                        </div>
                        <div class="headerbox">
                       <h1>国際サービス</h1>
                            <div class="icon_wrap">
