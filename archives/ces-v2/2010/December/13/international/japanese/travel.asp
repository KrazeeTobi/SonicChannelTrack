...
<div class="right-blue-box" align="center">
    ...
    <div>
        ...
        <br /><br />
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/japanese.asp" class="footer">日本語</a>&nbsp;&gt;&nbsp;旅行とビザ情報</div>
                        </div>
                        <div class="headerbox">
                       <h1>旅行とビザ情報</h1>
                            <div class="icon_wrap">
...
<P target="_blank"><SPAN class=text><A href="https://ceac.state.gov/genniv/ " target=_blank>ビザをお求めですか？現在、オンラインでビザ申請書をご記入いただけます。</A><BR><BR><A href="/docs/Japanese_JP_6443_2K11VisaTips_PRESS_READY.pdf" target=_blank>ヘルプが必要な場合は、弊社のビザ関連説明書をダウンロードし</A>、順を追った説明やウェブサイトアドレスなどの情報でビザ申請手続きの助力を得てください。<BR></SPAN></P><BR>
...
<TR>
<TD>
<H3>ビザ免除プログラムでの参加者への重要なお知らせ</H3>2010年9月8日から、すべてのESTA（電子渡航認証システム）登録申請または更新は、当日あるいはそれ以降はクレジットカードもしくはデビットカードにて、14ドルの手数料をお支払いいただくことになります。現在のESTA申請は、有効期限日まで有効です。詳細については、<A href="http://cbp.gov/xp/cgov/travel/id_visa/esta/" target=_blank>国土安全保障省、税関国境警備局ウェブサイトのESTAウェブページ</A>をご覧ください。</A></TD></TR></TBODY></TABLE><BR>
