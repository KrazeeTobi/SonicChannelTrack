...
<head><!-- PageID 1168 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
...
<div class="right-blue-box" align="center">
    ...
    <div>
        ...
        <br /><br />
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;日本語</div>
                        </div>
                        <div class="headerbox">
                       <h1>日本語</h1>
                            <div class="icon_wrap">
...
<H3>世界規模のネットワークとその将来性の構築</H3>
<P>新規テクノロジーの出発点となるCESに、１３０カ国以上から１２万人以上の参加者が見込まれます。２，５００以上の出展社が２０，０００件以上の新製品を展示するCESは、消費者エレクトロニクス業界にとって今年度で最も心踊る４日間となるでしょう。<A href="/register">今すぐご登録ください。<BR></A><IMG align=middle src="/images/photos/International_Horizontal_1.jpg" width=480 height=162><BR><BR></P>
<H3>CES: テクノロジーと教育</H3>
<P>CES は革新的なテクノロジーの展示だけではありません。CES カンファレンス プログラムには、家電業界のすべての分野を網羅する<A href="/conferenceProgram/default.asp">300以上のセッション</A>が盛り込まれています。さらに、常時無料のスーパーセッションでは、広範囲にわたる様々なトレンドについて学習する機会を提供致します。</P>
<P>今年の<A href="/events/keynotes.asp">基調講演者の顔触れ</A>は、マイクロソフト社のSteve Ballmer氏、Verizon社のIvan Seidenberg氏、Audi社のRupert Stadler氏、Samsung社のBoo-Keun Yoon氏、Ford社のAlan Mulally氏です。スーパーセッションと基調講演は、エグジビッツ プラス（Exhibits Plus）バッジをお持ちの方には無料で、事前登録の必要はありませんが、座席には限りがありますので、お早めに到着されるようご計画ください。基調講演はすべて、中国語、韓国語、日本語で通訳されます。<BR></P>
...
<P><A href="/international/japanese/services.asp">国際サービス</A><BR>外国からの参加者の方へは、通訳者、特別なネットワーク作りのためのレセプション、専用の作業エリア、会議室など、その他多数のサービスをご用意しています。<BR><BR><A href="/docs/Japanese_6673_2011CESfacts_JPN_PRESS_READY(1).pdf" target=_blank>一般情報</A><BR>展示会の沿革、現在の製品カテゴリ、今後の予定など、各国語で紹介します！ </P>
<P>&nbsp;</P>    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/international/japanese.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
