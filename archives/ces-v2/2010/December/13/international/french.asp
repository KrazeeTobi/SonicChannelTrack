...
<head><!-- PageID 1129 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
...
<div class="right-blue-box" align="center">
    ...
    <div>
        ...
        <br /><br />
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;Français</div>
                        </div>
                        <div class="headerbox">
                       <h1>Français</h1>
                            <div class="icon_wrap">
...
<H3>Développez des possibilités et des réseaux mondiaux</H3>Plus de 120 000 participants de 130 pays sont attendus au CES, la plateforme de lancement des nouvelles technologies. Avec plus de 2 500 exposants qui présentent plus de 20 000 nouveaux produits, le CES vous offre les quatre jours les plus captivants de l’année pour l’industrie des technologies de consommation. <A href="/register">Inscrivez-vous maintenant.</A><BR><A href="/docs/2010_CESFACTSHEET_French.pdf" target=_blank></A><BR><BR><IMG align=middle src="/images/photos/International_Horizontal_1.jpg" width=480 height=162><BR><BR>
<H3>CES : Technologie et éducation</H3>CES est plus qu’une démonstration de la technologie novatrice. <A href="/conferenceProgram/default.asp">Le programme de la conférence CES</A> comprend plus de 300 séances qui couvrent toutes les facettes de l’industrie de l’électronique de consommation. De plus, les SuperSessions toujours gratuites vous donnent la possibilité d’en apprendre davantage sur de nombreuses tendances dans une vaste gamme de marchés. 
<BR>Cette année, <A href="/events/keynotes.asp">nous comptons parmi nos conférenciers</A> Steve Ballmer de Microsoft, Ivan Seidenberg de Verizon, Rupert Stadler d’Audi, Boo-Keun Yoon de Samsung et Alan Mulally de Ford. Les SuperSessions et les présentations des conférenciers sont gratuites avec votre badge Exhibits Plus et vous n’avez pas besoin de vous inscrire à l’avance, mais prévoyez d’arriver tôt, les places sont limitées. Toutes les conférences sont traduites en chinois, en coréen et en japonais. <BR>
