...
<head><!-- PageID 1146 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Información de viajes y visas</title>
    ...
    <div class="right-blue-box-blue-interior">
        <ul>
            ...
            <li><a href="/international/korean/travel.asp">한국어</a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/spanish.asp" class="footer">Español</a>&nbsp;&gt;&nbsp;Información de viajes y visas</div>
                        </div>
                        <div class="headerbox">
...
Encuentre aquí información útil para entrar y salir de los EE. UU. <BR>
...
<TR>
<TD>
<H3>Aviso importante para los participantes que viajan bajo el Programa de Exención de Visado</H3>Todas las solicitudes o renovaciones de inscripción en el Sistema Electrónico de Autorización de Viaje (ESTA, por sus siglas en inglés) recibidas a partir del 8 de septiembre de 2010, fecha inclusive, requerirán del pago de una cuota de US$14 por tarjeta de crédito o débito. Las inscripciones en el programa ESTA ya procesadas seguirán vigentes hasta su fecha de caducidad. Para obtener información adicional, sírvase <A href="http://cbp.gov/xp/cgov/travel/id_visa/esta/" target=_blank>visitar la página del programa ESTA en el sitio Web del Departamento de Seguridad Nacional, Servicio de Aduanas y Protección Fronteriza</A>.</A></TD></TR></TBODY></TABLE></P>
<H2>Viajes</H2>
