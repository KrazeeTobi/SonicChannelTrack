...
<A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&prodoffeIds=2810110,2810530,2811170,2811220,2811530,2812680"><IMG height=100 hspace=4 src="/images/content/digitalimg_icons_sm.gif" width=100 align=right border=0></A>Digital cameras still remain a major component of the American CE product mix. With seven-in-ten households reporting ownership of a digital camera, one might wonder what is next for this category. Consumers upgrade their existing cameras for more megapixels and a host of new options including GPS, face detection, information tagging and touch screen features. <BR><BR>If digital imaging matters to you, use the International CES to learn, network and investigate new technology emerging in the digital imaging industry and many other consumer technology markets. The International CES returns to Las Vegas, Nev.,&nbsp;on January 6, 2011.
