...
<head><!-- PageID 483 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    ...
    <title>2010 CES: Video Gallery</title>
...
<OBJECT class=BrightcoveExperience id=myExperience><PARAM NAME="wmode" VALUE="transparent"><PARAM NAME="bgcolor" VALUE="#FFFFFF"><PARAM NAME="width" VALUE="695"><PARAM NAME="height" VALUE="540"><PARAM NAME="playerID" VALUE="59348424001"><PARAM NAME="publisherID" VALUE="26269122001"><PARAM NAME="isVid" VALUE="true"><PARAM NAME="isUI" VALUE="true"></OBJECT><!-- End of Brightcove Player -->
<DIV align=right><SPAN class=smallText>Video Player by </SPAN><A href="http://www.brightcove.com/" target=_blank><IMG height=31 src="/images/content/brightcove_logo.gif" width=125 align=absMiddle border=0></A></DIV>
...
<A href="/press/imageGallery/default.asp">Download images from the 2009 International CES.</A>    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/news/media/default.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
