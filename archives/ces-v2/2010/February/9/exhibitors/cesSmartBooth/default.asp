...
<head><!-- PageID 362 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    ...
    <title>2010 CES: MyCES Exhibitor Portal</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li class="selected"><a href="/exhibitors/cesSmartBooth/default.asp">MyCES Exhibitor Portal</a></li>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;MyCES Exhibitor Portal</div>
                    </div>
                    ...
                    <div id="inner-content-long">
                        <h1>MyCES Exhibitor Portal</h1>
                                                               
                        

The <A href="https://myces.bdmetrics.com/exhibitorportal/" target=_blank>MyCES Exhibitor Portal</A> is your gateway into the MyCES online directory as well as the printed Official International CES Show Directory. <BR><BR><IMG hspace=8 align=right src="/images/content/portalListing.jpg" width=262 height=190>Every CES exhibitor receives a FREE <A href="https://myces.bdmetrics.com/exhibitorportal/" target=_blank>MyCES Exhibitor Portal</A> that allows you to: 
<UL class=text>
<LI class=text>Complete your company information for the printed Official International CES Show Directory. </LI>
<LI class=text>Add additional information beyond your print listing that will be searched and viewed online. </LI>
<LI class=text>Be found online by attendees and buyers searching the Internet. </LI>
<LI class=text>Detect how many buyers of your products and services have registered for CES. </LI></UL><BR>
<H4>What is MyCES, and why do I need a listing?</H4>Every registered CES attendee automatically receives a login to the MyCES online show portal. There they can search for exhibitors and products; receive recommendations based on their personal profile; and create individual event plans and walking maps.<BR><BR>In addition to appearing on CESweb.org, your company's MyCES directory listing is crawled by major Internet search engines. So, by establishing and enhancing your online presence in MyCES, you extend your reach and impact from a few days in the exhibit hall to all year long.<BR><BR><A href="https://myces.bdmetrics.com/exhibitorportal/" target=_blank>Login to your FREE MyCES Exhibitor Portal*</A> today to take advantage of these benefits and more. <EM>The sooner you update your information; the sooner attendees will find you.</EM> <BR><BR>
<H4>What else can I do?</H4><IFRAME height=205 src="http://vidego.multicastmedia.com/player.php?p=k7ze6kq4" frameBorder=0 width=240 allowTransparency scrolling=no align=right hspace=8></IFRAME>Want to further extend your reach? Consider an<STRONG> Exhibitor Microsite</STRONG> and convert your directory listing into a comprehensive resource featuring your products, news, even video – plus an information request form for year-round lead generation.<BR><BR>Learn more about this and other <A href="/exhibitors/sponsorships/myCES-ops.asp">MyCES marketing opportunities</A>, or contact Ed Gorey at 410-402-1070, <A href="mailto:ed.gorey@bdmetrics.com">ed.gorey@bdmetrics.com</A>.<BR><BR><SPAN class=smallText><BR>*Note: Login required. Your company's credentials were e-mailed to the main exhibitor representative we have on file. For assistance e-mail <A href="mailto:Support@BDMetrics.com">Support@BDMetrics.com</A> or call 800-931-5103 and select option 1.</SPAN>

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibitors/cesSmartBooth/default.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
