...
<head><!-- PageID 3098 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: 2010 CES Block Request Form</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
            ...
            <li class="selected"><a href="/hotelTravel/blockRequest.asp">2010 CES Block Request Form</a></li>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/hotelTravel/default.asp" class="footer">Hotel/Travel</a>&nbsp;&gt;&nbsp;<a href="/hotelTravel/hotel.asp" class="footer">Hotel Reservations</a>&nbsp;&gt;&nbsp;2010 CES Block Request Form</div>
                    </div>
                    ...
                    <div id="inner-content-long">
                        <h1>2010 CES Block Request Form</h1>
...
// javascript for e-mail this page tool - gets the url of the page the user is on before the e-mail page tool button is clicked
	...
	<script language="JavaScript" src="/hotelTravel/blockRequest/include/js/calendar2_2010.js"></script>
	<script>
...
function validForm(passedForm)
	{
		...
		alert("Your requested dates must be between 12/26/09 and 1/16/10.")
		passedForm.input7.focus
		return false
		}
		...
		if (((radio_value=="LVHilton")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="Mandalay")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="THE")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="Trump")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="Renaissance")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="Venetian")&&(passedForm.number_of_rooms.value < 10)))
			{
		...
		if (((radio_value!="LVHilton")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="Mandalay")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="THE")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="Trump")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="Renaissance")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="Venetian")&&(passedForm.number_of_rooms.value < 20)))
			{
...
<strong>Request a group block <font style=color:#CC0000>FOR THE 2010 INTERNATIONAL CES</font> with a simple three-step process.</strong>
<ol>
...
<p align=center><strong>To view 2010 CES rates, <A href="http://www.cesweb.org/hotelTravel/hotel.asp">click here</A></strong>.</p>
...
<tr>
	<td colspan="2"><font style="color:red"><b>* </b></font> Please select an official 2010 International CES hotel. (Availability subject to change. Last updated November, 2009.)</td></tr>
...
<tr>
	<td width="33%" valign="top" class="text">
		...
		<!--<input type="radio" name="hotel" value="HGVCHilton">HGVC at LV Hilton<br>-->
		<!--<input type="radio" name="hotel" value="HGVCStrip">HGVC on LV Strip<br>-->
	...
	<td width="33%" valign="top" class="text">
		...
		<!--<input type="radio" name="hotel" value="Platinum">Platinum<br>-->
	...
	<td width="33%" valign="top" class="text">		
		...
		<!--<input type="radio" name="hotel" value="Trump">Trump International Hotel Las Vegas (10 room min.)<br>-->
		<!--<input type="radio" name="hotel" value="Venetian">Venetian (10 room min.)<br>-->
		<!--<input type="radio" name="hotel" value="Vdara">Vdara<br>-->
		<!--<input type="radio" name="hotel" value="Westin">Westin <br>-->
	</td>
</tr>
</table>
<BR />
...
<tr>
	<td>
		...
		<ul>
		    ...
		    <li>Palms Place
		    <li>Planet Hollywood
		    <li>Platinum Hotel & Spa 
		    <li>Signature at MGM Grand 
		    <li>THEhotel at Mandalay Bay 
		    <li>Treasure Island 
		    <li>Tropicana
		    <li>Trump International Hotel Las Vegas
		    <li>Vdara
		    <li>Venetian
		    <li>Westin
		</ul>
...
<tr>
	<td colspan=2>Please indicate the first and last nights of your block and the maximum number of rooms needed on your night of highest occupancy. <font style=color:#CC0000><strong>Show days are January 7-10, 2010.</strong></font><br>
	</td>
</tr>
