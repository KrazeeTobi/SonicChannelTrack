...
<head><!-- PageID 386 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    ...
    <title>2010 CES: CES TechZones</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
            ...
            <li ><a href="/exhibits/displays/ehx.asp">EHX@CES</a></li>
        
            <li ><a href="/exhibits/displays/expCEA.asp">Innovation Movement</a></li>
        
            <li ><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
        
            <li ><a href="/exhibits/displays/ilounge.asp">iLounge Pavilion</a></li>
        
            <li ><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
        
            <li ><a href="/exhibits/displays/intGateway.asp">International Gateway</a></li>
        
            <li ><a href="/exhibits/displays/livingDigital.asp">Living in Digital Times</a></li>
        
            <li ><a href="/exhibits/displays/LBS.asp">Location Based Services</a></li>
        
            <li ><a href="/exhibits/displays/sustaintablePlanet.asp">Sustainable Planet</a></li>
        
            <li ><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
        
            </ul></li>
        
            <li ><a href="/exhibits/facilities/default.asp">Facility Details and Maps</a>
        </ul>
                        <br />
...
<IMG alt=TechZone hspace=12 src="/images/framework/techzone_logo.gif" align=right>Located throughout the entire CES show floor, these themed areas draw you in and then surround you with emerging products and the companies that were innovative enough to bring this mind-blowing technology to consumers the world over. <BR>
<br/>
...
<table class="sponsorship_opportunities">
    ...
    <tr  class="alternateRows">
        <td><a href="#3151">Digital Health TechZone</a></td><!---->
    ...
    <tr >
        <td><a href="#3270">eBooks TechZone</a></td><!---->
        <td>LVCC, Central Hall</td>
        <td> International Digital Publishing Forum</td>
    </tr>
    
    
    <tr  class="alternateRows">
        <td><a href="#3247">Experience 3D TechZone</a></td><!---->
        <td>LVCC, Central Hall</td>
        <td>3D@Home Consortium</td>
    </tr>
    
    
    <tr >
        <td><a href="#3623">Femto TechZone</a></td><!---->
    ...
    <tr  class="alternateRows">
        <td><a href="#3318">HDMI TechZone</a></td><!---->
        <td>LVCC, South Hall 1</td>
        <td>HDMI Licensing, LLC</td>
    </tr>
    
    
    <tr >
        <td><a href="#2316">HD-PLC TechZone</a></td><!---->
        <td>LVCC, South Hall 1</td>
        <td>HD-PLC Association</td>
    </tr>
    
    
    <tr  class="alternateRows">
        <td><a href="#3155">Higher Ed TECH TechZone</a></td><!---->
        <td>LVCC, North Hall</td>
        <td>Living in Digital Times</td>
    </tr>
    ...
    <tr >
        <td><a href="#3458">HomePlug TechZone</a></td><!---->
        <td>LVCC, South Hall 1</td>
        <td>HomePlug Powerline Alliance, Inc.</td>
    </tr>
    
    
    <tr  class="alternateRows">
        <td><a href="#3482">i-stage TechZone</a></td><!---->
        <td>LVCC, North Hall</td>
        <td></td>
    </tr>
    ...
    <tr >
        <td><a href="#3156">Kids@Play TechZone</a></td><!---->
        <td>LVCC, North Hall</td>
        <td>Living in Digital Times</td>
    </tr>
    ...
    <tr  class="alternateRows">
        <td><a href="#3481">Lifestyle Gadgets TechZone</a></td><!---->
        <td>LVCC, North Hall</td>
        <td></td>
    </tr>
    ...
    <tr >
        <td><a href="#3460">Mobile DTV TechZone</a></td><!---->
        <td>LVCC, Central Hall</td>
        <td>Open Mobile Video Coalition</td>
    </tr>
    
    
    <tr  class="alternateRows">
        <td><a href="#3157">Mommy Tech TechZone</a></td><!---->
        <td>LVCC, North Hall</td>
        <td>Living in Digital Times</td>
    </tr>
    ...
    <tr >
        <td><a href="#3008">Netbooks TechZone</a></td><!---->
    ...
    <tr  class="alternateRows">
        <td><a href="#3459">PC Gaming Alliance TechZone</a></td><!---->
        <td>Gaming Showcase, LVCC, North Hall</td>
        <td>PC Gaming Alliance</td>
    </tr>
    
    
    <tr >
        <td><a href="#3237">Robotics TechZone</a></td><!---->
        <td>LVCC, North Hall</td>
        <td>Robotics Trends</td>
    </tr>
    
    
    <tr  class="alternateRows">
        <td><a href="#3480">Safe Driver TechZone</a></td><!---->
        <td>LVCC, North Hall</td>
        <td>  </td>
    </tr>
    ...
    <tr >
        <td><a href="#3158">Silvers Summit TechZone</a></td><!---->
        <td>LVCC, North Hall</td>
        <td>Living in Digital Times</td>
    </tr>
    ...
    <tr  class="alternateRows">
        <td><a href="#747">USB TechZone</a></td><!---->
        <td>LVCC South Hall 3</td>
        <td>USB-IF</td>
    </tr>
    ...
    <tr  class="alternateRows">
        <td><a href="#513">ZigBee TechZone</a></td><!---->
        <td>LVCC South Hall 1 </td>
...
<div class="sub-content-header">Digital Health TechZone</div>
...
<div class="sub-content-header">eBooks TechZone</div>

<span class="techzones-indented">LVCC, Central Hall</span>
<br />

<span class="techzones-indented">Sponsor(s):  International Digital Publishing Forum</span>
<br/><br/>
<IMG hspace=5 vspace=5 align=right src="/images/content/2k10_CES_TZ_ebooks_web.jpg" width=200 height=137>There's no need to read between the lines when it comes to understanding this emerging consumer electronics category. Just make your way to CES, and you'll learn everything you need to know. The eBooks TechZone at the 2010 International CES features an evolving product and service category that has been moving steadily into the mainstream over the past several years. This category includes the eBook, eBook reader device and eBook reader. The eBook reader device allows consumers to carry thousands of books, newspapers and other media in one device.<BR>[Exhibitors: <A href="/docs/2010_eBooks_TZ_Sheet.pdf" target=_blank>Download this flyer for more information and pricing.</A>]<BR><BR><IMG hspace=6 align=middle src="/images/content/magGlass.gif" width=23 height=26><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810030"><STRONG>See a list of eBooks TechZone exhibitors.</STRONG></A>
<br /><img width="1" height="10" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br /><img width="1" height="16" src="/images/framework/spacer.gif"/><br />
...
<div class="sub-content-header">Experience 3D TechZone</div>
...
<br/><br/>
<IMG align=right src="/images/content/CES-451_TZ_Experience_3D_(web_without_TZ).jpg" width=300 height=122>The 3D experience makes content pop, and it's coming to CES. The Experience 3D TechZone features next-gen innovators who make 3D a reality in the home, including content creators, service providers and TV manufacturers.&nbsp; See the future of TV at the Experience 3D TechZone. In partnership with 3D@Home Consortium.<BR>[Exhibitors: <A href="/docs/2010_Experience_3D_TechZone_Sheet.pdf" target=_blank>Download this flyer for more information.</A>]<BR><BR><IMG hspace=6 align=middle src="/images/content/magGlass.gif" width=23 height=26><STRONG><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810110">See a list of Experience 3D TechZone exhibitors.</A></STRONG>
<br /><img width="1" height="10" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br /><img width="1" height="16" src="/images/framework/spacer.gif"/><br />
...
<div class="sub-content-header">Femto TechZone</div>

<span class="techzones-indented">LVCC, South Hall 3</span>
<br />

<span class="techzones-indented">Sponsor(s): Femto Forum</span>
<br/><br/>
<IMG align=right src="/images/content/2k10_CES_TZ_Femto_web.jpg" width=200 height=154>The small, low cost cellular base stations known as femtocells allow service providers to extend service coverage where wireless access would otherwise be limited or unavailable. Coverage and capacity (data rate speed) improvements are significant, and opportunities for new services are emerging. Visit the Femto TechZone to learn how femtocells enhance home and office network environments. Meet with a variety of experts from the Femto Forum, which comprises 120 organizations, including 55 wireless operators who collectively represent over 1.4 billion subscribers. Learn more about a technology that is moving rapidly toward homes all over the world.<BR><BR><IMG hspace=6 align=middle src="/images/content/magGlass.gif" width=23 height=26><STRONG><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810230">See a list of Femto TechZone exhibitors.</A></STRONG>
<br /><img width="1" height="10" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br /><img width="1" height="16" src="/images/framework/spacer.gif"/><br />
...
<div class="sub-content-header">HDMI TechZone</div>
...
<LI class=text>Semiconductors</LI></UL><BR>[Exhibitors: <A href="/docs/HDMI_TechZone_Sheet_-_FINAL.pdf" target=_blank>Download this flyer for more information.</A>]
<br /><img width="1" height="10" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br /><img width="1" height="16" src="/images/framework/spacer.gif"/><br />
...
<div class="sub-content-header">HD-PLC TechZone</div>

<span class="techzones-indented">LVCC, South Hall 1</span>
<br />

<span class="techzones-indented">Sponsor(s): HD-PLC Association</span>
<br/><br/>
<IMG hspace=5 align=right src="/images/content/2k10_CES_TZ_HDPLC_gen(1).jpg" width=200 height=100>High Definition Power Line Communication (HD-PLC) is one of the best power line technologies for the stable transmission of data because of its high performance, speed and HD capacity. With HD-PLC you can create home networks for Internet, high-definition video and audio, camera monitoring, and more, all without extra wiring. Forget about walls between rooms anymore. No need to worry about making holes for wiring or about walls reducing transmission speed. Simply plug into a wall outlet with your HD-PLC adaptor, and create your home network.<BR><BR><IMG hspace=6 align=middle src="/images/content/magGlass.gif" width=23 height=26><STRONG><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810250">See a list of HD-PLC TechZone exhibitors.</A></STRONG>
<br /><img width="1" height="10" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br /><img width="1" height="16" src="/images/framework/spacer.gif"/><br />
...
<div class="sub-content-header">Higher Ed TECH TechZone</div>
...
<span class="techzones-indented">Sponsor(s): Living in Digital Times</span>
<br/><br/>
<IMG hspace=5 align=right src="/images/content/Higher_Ed_Tech_200.gif" width=200 height=130>Connected. That sums up the modern college experience in one word, and it’s quickly changing the face of higher education. Ever on the lookout for newer, better, faster and more innovative technology, whatever the next big trend in consumer electronics is going to be, it’s a virtual lock that college kids will be among the first adopters of consumer technology.<BR><BR>How do you stay atop this rapidly changing, rapidly expanding market? The Higher Ed Tech Summit and Exhibit, which exists within the <A href="/exhibits/displays/livingDigital.asp">Living in Digital Times CE Spotlight</A>, offers the opportunity to survey the latest trends, products, and services for today’s students and for the institutions that serve them.<BR>[Exhibitors: <A href="/docs/HEdTech_sell-sheet_FINAL.pdf" target=_blank>Download this flyer for more information.</A>]<BR><BR><IMG hspace=6 align=middle src="/images/content/magGlass.gif" width=23 height=26><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810140"><STRONG>See a list of HigherEd TECH TechZone exhibitors.</STRONG></A>
<br /><img width="1" height="10" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br /><img width="1" height="16" src="/images/framework/spacer.gif"/><br />
...
<div class="sub-content-header">HomePlug TechZone</div>
...
<div class="sub-content-header">i-stage TechZone</div>
...
<br/><br/>
<IMG hspace=5 align=right src="/images/content/2k10_TZ_IS_web.jpg">The i-stage TechZone features the winner and finalists of CEA's annual i-stage competition, among the most jaw-dropping products, apps and services from other leading start-ups across the globe. This area on the show floor is specifically for products in their initial stages of development looking to gain exposure to press, investors and venture capitalists.<BR>[Exhibitors: <A href="/docs/2010_i-stage_TZ_Sheet.pdf" target=_blank>Download this flyer for more information and pricing</A>.]<BR><BR><IMG hspace=6 align=middle src="/images/content/magGlass.gif" width=23 height=26><STRONG><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810280">See a list of i-stage TechZone exhibitors.</A></STRONG>
<br /><img width="1" height="10" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br /><img width="1" height="16" src="/images/framework/spacer.gif"/><br />
...
<div class="sub-content-header">Kids@Play TechZone</div>
...
<div class="sub-content-header">Lifestyle Gadgets TechZone</div>
...
<br/><br/>
<IMG hspace=5 align=right src="/images/content/2k10_CES_TZ_LG_web.jpg" width=200 height=38>Technology isn't just reserved for computers, cell phones and home theater systems. It's pervasive in all aspects life. The all-new Lifestyle Gadgets TechZone is the perfect place to see innovative personal electronics. Whether it is digital camera binoculars and dive masks, personal weather stations or flashlight cameras, this area is perfect to view the latest consumer tech gadgets.<BR><BR><IMG hspace=6 align=middle src="/images/content/magGlass.gif" width=23 height=26><STRONG><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810160">See a list of Lifestyle Gadgets TechZone exhibitors.</A></STRONG>
<br /><img width="1" height="10" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br /><img width="1" height="16" src="/images/framework/spacer.gif"/><br />
...
<div class="sub-content-header">Mobile DTV TechZone</div>

<span class="techzones-indented">LVCC, Central Hall</span>
<br />

<span class="techzones-indented">Sponsor(s): Open Mobile Video Coalition</span>
<br/><br/>
<IMG align=right src="/images/content/2k10CES_TZ_MDTV_web.jpg" width=200 height=111>The broadcast industry's most innovative effort to garner new viewers — mobile digital television (DTV) — will be on full display at International CES&reg; 2010. The Open Mobile Video Coalition, representing more than 800 TV stations across the country, will sponsor the CES Mobile DTV Tech Zone in the central hall of the LVCC.&nbsp; Consumer electronics retailers and manufacturers are invited to see the latest consumer devices that will enable viewers to watch their favorite live local and national TV programs wherever they are — on portable DTVs, mobile phones, personal media players, portable computers, in-car screens and other devices. Leading manufacturers including LG Electronics, Samsung, Harris Corporation, and Dell, are expected demonstrate devices and transmission equipment bringing the excitement of mobile DTV to American consumers in 2010.<BR>[Exhibitors: <A href="/docs/Mobile_DTV_TechZone_Sheet_-_FINAL.pdf" target=_blank>Download this flyer for information.</A>] <BR><BR><IMG hspace=6 align=middle src="/images/content/magGlass.gif" width=23 height=26><STRONG><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810300">See a list of Mobile DTV TechZone exhibitors.</A></STRONG>
<br /><img width="1" height="10" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br /><img width="1" height="16" src="/images/framework/spacer.gif"/><br />
...
<div class="sub-content-header">Mommy Tech TechZone</div>
...
<span class="techzones-indented">Sponsor(s): Living in Digital Times</span>
<br/><br/>
<IMG hspace=5 align=right src="/images/content/Mommy_Tech_200.jpg" width=200 height=65>Mommy Tech is a focused lifestyle exhibit and conference at CES. This premiere destination focuses exclusively on the newest innovations and tools of the trade, spotlighting key trends impacting the $90 billion dollar Mommy market. This area of the <A href="/exhibits/displays/livingDigital.asp">Living in Digital Times CE Spotlight </A>at CES promotes and enlightens product creators, manufacturers, distributors and service providers to the opportunities, partnerships, business models, distribution channels and standards guidance that reach and influence Mommy spending habits and preferences.<BR><BR>Empowering moms with technology that helps them juggle priorities, stay connected with their own families and other moms, and savor their multiple roles in life is the central theme of Mommy Tech.<BR>[Exhibitors: <A href="/docs/MTech_sell-sheet_FINAL.pdf" target=_blank>Download this flyer for more information.</A>]<BR><BR><IMG hspace=6 align=middle src="/images/content/magGlass.gif" width=23 height=26><STRONG><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810180">See a list of Mommy Tech TechZone exhibitors.</A></STRONG>
<br /><img width="1" height="10" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br /><img width="1" height="16" src="/images/framework/spacer.gif"/><br />
...
<div class="sub-content-header">Netbooks TechZone</div>
...
<br/><br/>
<IMG align=right src="/images/content/CES-442_TZ_NetBooks.jpg" width=200 height=39>This rapidly evolving segment of mobile computing devices is quickly blurring the lines between laptops and smartphones. The Netbooks TechZone features the chipsets, OEMs/devices, ODMS, service providers and applications associated with netbooks and also features analysts and alliances associated with these products. <BR>[Exhibitors: <A href="/docs/2010_Netbooks_TZ_Sheet.pdf" target=_blank>Download this flyer for details and pricing.</A>]<BR><BR><IMG hspace=6 align=middle src="/images/content/magGlass.gif" width=23 height=26><STRONG><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810120">See a list of Netbooks TechZone exhibitors.</A></STRONG>
<br /><img width="1" height="10" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br /><img width="1" height="16" src="/images/framework/spacer.gif"/><br />
...
<div class="sub-content-header">PC Gaming Alliance TechZone</div>

<span class="techzones-indented">Gaming Showcase, LVCC, North Hall</span>
<br />

<span class="techzones-indented">Sponsor(s): PC Gaming Alliance</span>
<br/><br/>
<IMG align=right src="/images/content/2k10_CES_TZ_PCG_web.jpg" width=200 height=92>The personal computer is the most popular platform for gaming worldwide.&nbsp; PC gaming is a multi-billion dollar industry that continues to grow and innovate with exciting new developers, big exclusives and regular releases every year. Come see the hottest PC gaming hardware and software for 2010.<BR><BR>The PC Gaming Alliance (PCGA) provides an open forum where companies cooperate to develop and promote solutions that drive the PC gaming industry forward. <A href="http://www.pcgamingalliance.org" target=_blank>www.pcgamingalliance.org</A>.<BR><BR><IMG hspace=6 align=middle src="/images/content/magGlass.gif" width=23 height=26><STRONG><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810320">See a list of PC Gaming Alliance TechZone exhibitors.</A></STRONG>
<br /><img width="1" height="10" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br /><img width="1" height="16" src="/images/framework/spacer.gif"/><br />
...
<div class="sub-content-header">Robotics TechZone</div>
...
<div class="sub-content-header">Safe Driver TechZone</div>
...
<span class="techzones-indented">Sponsor(s):   </span>
<br/><br/>
<IMG hspace=5 align=right src="/images/content/2k10_CES_TZ_SD_web.jpg" width=200 height=51>Distracted driving is a problem…but what are the solutions?&nbsp;With the increasing public focus on distracted driving, this TechZone is an amazing opportunity to see new technologies that empower drivers to use their in-vehicle electronics in a safe and responsible way. The Safe Driver Techzone will feature products that will assist in auto collision avoidance, land drift assistance, parking, speed monitoring, hands-free, text-to-voice, driver drowsiness detection and much more.<BR>[Exhibitors: <A href="/docs/Safe_Driver_TechZone_Sheet_-_Final.pdf" target=ioMain>Download this flyer for details and pricing.</A>]<BR><BR><IMG hspace=6 align=middle src="/images/content/magGlass.gif" width=23 height=26><STRONG><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810330">See a list of Safe Driver TechZone exhibitors.</A></STRONG>
<br /><img width="1" height="10" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br /><img width="1" height="16" src="/images/framework/spacer.gif"/><br />
...
<div class="sub-content-header">Silvers Summit TechZone</div>
...
<span class="techzones-indented">Sponsor(s): Living in Digital Times</span>
<br/><br/>
<IMG hspace=5 align=right src="/images/content/SilversSummit_250.jpg" width=250 height=63>There are about 78 million boomers in the US (450 million worldwide) born between 1946 and 1964 — and they're&nbsp; hitting their peak earning and spending. Whether they're playing brain games for fun, monitoring their homes, visiting their grandkids via video conferencing or navigating the back road in their GPS enabled SUVs, this generation is maximizing the benefits of the digital age.<BR><BR>Located within the <A href="/exhibits/displays/livingDigital.asp">Living in Digital Times CE Spotlight</A>, the Silvers Summit showcases the products and services that keep boomers engaged, entertained, connected and healthy. Visit this destination to meet with distributors, journalists, research firms and manufacturers that will demonstrate the products and services that help mature consumers maintain a high quality of life.<BR>[Exhibitors: <A href="/docs/SILVERS_2010.pdf" target=_blank>Download this flyer for details and pricing.</A>] <BR><BR><IMG hspace=6 align=middle src="/images/content/magGlass.gif" width=23 height=26><STRONG><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810200">See a list of Silvers Summit TechZone exhibitors.</A></STRONG>
<br /><img width="1" height="10" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br /><img width="1" height="16" src="/images/framework/spacer.gif"/><br />
...
<div class="sub-content-header">USB TechZone</div>
...
<br/><br/>
<IMG hspace=5 align=right src="/images/content/2k10_CES_TZ_USB_web.jpg" width=200 height=134>USB technology makes "plug and play" a reality and accommodates our busy workstyles and lifestyles. The impact of USB connectivity on small office/home offices, our PCs, printers, scanners, PDAs and digital cameras is huge.<BR><BR><IMG hspace=6 align=middle src="/images/content/magGlass.gif" width=23 height=26><STRONG><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810340">See a list of USB TechZone exhibitors.</A></STRONG>
<br /><img width="1" height="10" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br /><img width="1" height="16" src="/images/framework/spacer.gif"/><br />
...
<br/><br/>
<IMG align=right src="/images/content/CES-447_TZ_Wireless-Mobility.jpg" width=200 height=69>This TechZone hosts a special exhibition of state-of-the-art mobile devices and applications. <BR><BR><IMG hspace=6 align=middle src="/images/content/magGlass.gif" width=23 height=26><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810350"><STRONG>See a list of Wireless Mobility TechZone exhibitors.</STRONG></A><BR><BR>Demonstrations include: 
<UL class=text>
...
<div class="sub-content-header">ZigBee TechZone</div>
...
<br/><br/>
<IMG hspace=5 align=right src="/images/content/ZigBee.jpg" width=200 height=119>ZigBee gives consumers new ways to control lighting, HVAC, water, appliances and security systems from anywhere. ZigBee is the wireless connection used by sensors (security, rain gauges, lights) and control devices (thermostats, timers, remote controls) ideally suited for the home. ZigBee is focused on giving consumers reliable, low-cost products featuring easy installation. Discover the possibilities in the ZigBee TechZone at the 2010 International CES. <BR><BR>The ZigBee Alliance is an association of companies working together to enable reliable, cost effective, low-power, wirelessly networked, monitoring and control products based on an open global standard. The ZigBee Alliance membership comprises technology providers and original equipment manufacturers worldwide. Membership is open to all. Additional information can be found at <A href="http://www.zigbee.org" target=_blank>www.zigbee.org</A>.<BR><BR><IMG hspace=6 align=middle src="/images/content/magGlass.gif" width=23 height=26><STRONG><A href="http://myces.bdmetrics.com/CompanySearch.aspx?configId=1&sctid=3&assoids=2810370">See a list of ZigBee TechZone exhibitors.</A></STRONG>
<br /><img width="1" height="10" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibits/displays/techZones.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
