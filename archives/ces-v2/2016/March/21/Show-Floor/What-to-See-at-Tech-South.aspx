      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          ...
          <div class="article-content-area">
             ...
             <div style="padding: 20px;" class="text-center-xs pull-right-sm"><img src="/CES/media/2014/For%20Exhibitors/C_space_vert_1-(1).jpg?ext=.jpg" ></div>
<h2 class='page-intro'>ARIA, Cosmopolitan and Vdara</h2>
<p class="intro">In 2016 CES introduced its newest official show location: Tech South. This new location hosted a variety of C Space activities, including conference sessions, networking events, exhibits and meeting rooms &mdash; all geared toward the advertising and marketing community at CES.</p>  
