...
<meta property="og:url" content="http://www.cesweb.org/Show-Floor/Marketplaces/App-Economy.aspx" />
<meta property="og:title" content="App Economy" />
...
<meta name="twitter:title" content="App Economy">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Show-Floor/Marketplaces/App-Economy.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>App Economy</h1>
          <span style="font-family: archer-book; font-size: 36px; color: #8d9a93; margin-top: -10px; position: relative; top: -15px; left: 2px;">presented by APPNATION VII
            ...
            <div class="row">
              <div class="col-sm-40">
                <ul>
                  ...
                  <li><a href="/Show-Floor.aspx" class="CMSBreadCrumbsLink">Show Floor</a> </li><li class="bread-div">|</li><li> <a href="/Show-Floor/Marketplaces.aspx" class="CMSBreadCrumbsLink">Marketplaces</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">App Economy</span>
</li>
          ...
          <div class="row article-content-area">
             ...
             <div style="padding: 20px;" class="text-center-xs pull-right-sm"><img src="/getmedia/58b95220-4b4a-4e83-8351-78f82df405ed/AppEconomy_collage_Sponsor_1.aspx?width=500&height=472&ext=.jpg" ></div>
<h2 class='page-intro'>Sands, Level 1, Hall G</h2>
<p class="intro">APPNATION VII focused on the exploding app economy and best practices around app acquisition, monetization, data management, leveraging apps for consumer engagement, and it explored the business case for Internet of Things (IoT) app development.<br />
<br />
See <a href="http://ces16.mapyourshow.com/7_0/search.cfm?srch-type=pavilion&amp;srch-query=AppNation&amp;srch-showresults=true&amp;CFID=159315027&amp;CFTOKEN=e29e25bfbf738014-FC25BD17-C676-4B79-8B04DB50144AE9E7" target="_blank">the exhibitors</a> who participated in App Economy at CES 2016.</p>  
