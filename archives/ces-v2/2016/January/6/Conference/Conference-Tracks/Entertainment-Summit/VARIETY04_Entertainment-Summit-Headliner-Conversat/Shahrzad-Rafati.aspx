...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Entertainment-Summit/VARIETY04_Entertainment-Summit-Headliner-Conversat/Shahrzad-Rafati.aspx" />
<meta property="og:title" content="Shahrzad  Rafati" />
...
<meta name="twitter:title" content="Shahrzad  Rafati">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Entertainment-Summit/VARIETY04_Entertainment-Summit-Headliner-Conversat/Shahrzad-Rafati.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>Shahrzad Rafati</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<h2>Shahrzad Rafati</h2>
<h3>Founder and CEO<br />BroadbandTV</h3>
<div style="float: left;">
  <img src="/CES/media/2014/Conference/SpeakerHeadshots/Shahrzad-_Rafati_BroadbandTV.jpg?ext=.jpg" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Shahrzad Rafati">
</div>
<div style="margin: 10px;">
  <p>Shahrzad Rafati is the founder and CEO of BroadbandTV Corp., a leading media and technology company that drives success for online video creators by leveraging its proprietary technology and massive online reach. Recognized by Fast Company as one of the 100 Most Creative People in Business, Shahrzad is accredited with pioneering both the technology and business model that made peace between big entertainment entities like the NBA and their fans that were uploading premium content online.<br /><br />Shahrzad has been the spirited drive and energy that has propelled BroadbandTV to success. She has personally driven successful deals with major media companies, telcos, professional sports leagues and Internet giants. In 2013, Shahrzad closed a strategic partnership and investment with RTL Group, Europe&rsquo;s largest entertainment network, and a unit of Bertelsmann, one of the world&rsquo;s largest media companies. At the time, the $36 million investment marked the largest private placement into an Internet media company in Canada since 2007.<br /><br />Shahrzad has been broadly recognized by numerous industry and community groups for her contributions to the media industry, and entrepreneurship. In 2013 Shahrzad was awarded Executive of The Year by The Digi Awards, named Ernst &amp;Young&rsquo;s, Pacific Emerging Entrepreneur of the Year, voted Business In Vancouver&rsquo;s CEO of The Year and BroadbandTV was Playback Magazine&rsquo;s Digital Company of The Year.<br /><br />In addition to BroadbandTV achievements, Shahrzad actively pursues ways to encourage social change. She is also the co-founder of the world&rsquo;s first Chopra Yoga in partnership with Dr. Deepak Chopra.</p>
</div>
