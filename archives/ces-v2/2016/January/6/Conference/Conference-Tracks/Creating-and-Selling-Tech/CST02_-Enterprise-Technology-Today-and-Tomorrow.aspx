...
<head id="head"><title>
	CST02_ Enterprise Technology: Today and Tomorrow - CES 2016
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Creating-and-Selling-Tech/CST02_-Enterprise-Technology-Today-and-Tomorrow.aspx" />
<meta property="og:title" content="CST02_ Enterprise Technology: Today and Tomorrow" />
...
<meta name="twitter:title" content="CST02_ Enterprise Technology: Today and Tomorrow">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Creating-and-Selling-Tech/CST02_-Enterprise-Technology-Today-and-Tomorrow.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1> Enterprise Technology: Today and Tomorrow</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<div>
    <h2> Enterprise Technology: Today and Tomorrow</h2>
    <p><b>$ Additional Registration Required</b></p>
    <div class="leftTrackColumn col-sm-18 col-md-15">      
      <div class="waysToBuy">
        <div id="addToCartCST02" class="cartItem"></div>
      </div>
    </div>
  ...
  <a href="#" title="Add to Calendar" class="addthisevent" data-track="_gaq.push(['_trackEvent','AddThisEvent','click','ate-calendar'])">
                                            ...
                                            <span class="title"> Enterprise Technology: Today and Tomorrow</span>
                                            <span class="description">Enterprise Technologies are making IT systems faster, cheaper, more efficient, and easier to use. &nbsp;From cloud computing and virtualization software to data and network security, what are the implications for these key software trends?</span> 
    ...
    <div class="paragraphText">Enterprise Technologies are making IT systems faster, cheaper, more efficient, and easier to use. &nbsp;From cloud computing and virtualization software to data and network security, what are the implications for these key software trends?</div>
</div>  
</div>
<ul class="sessionSpeaker"><div id="GroupedData">
	  
<div class=""><strong>Moderator:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Creating-and-Selling-Tech/CST02_-Enterprise-Technology-Today-and-Tomorrow/Diane-Brady.aspx">
  <strong>Diane Brady</strong></a>,&nbsp;Speaker, Journalist, Media Innovator, dB omnimedia
</li></div></div><div class=""><strong>Speaker:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Creating-and-Selling-Tech/CST02_-Enterprise-Technology-Today-and-Tomorrow/RJ-Mahadev.aspx">
  <strong>RJ Mahadev</strong></a>,&nbsp;Cisco IoT Service Solutions, Cisco Systems
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Creating-and-Selling-Tech/CST02_-Enterprise-Technology-Today-and-Tomorrow/Heidi-Messer.aspx">
  <strong>Heidi Messer</strong></a>,&nbsp;Chairman and Co-Founder, Collective[i]
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Creating-and-Selling-Tech/CST02_-Enterprise-Technology-Today-and-Tomorrow/Anthony-Bartolo.aspx">
  <strong>Anthony Bartolo</strong></a>,&nbsp;Technical Evangelist, Microsoft Corporation
</li></div></div>
</div> 
</ul>
