...
<head id="head"><title>
	TREND08_Robots in the Real World - CES 2017
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Top-Tech-Trends/TREND08_Robots-in-the-Real-World.aspx" />
<meta property="og:title" content="TREND08_Robots in the Real World" />
...
<meta name="twitter:title" content="TREND08_Robots in the Real World">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Top-Tech-Trends/TREND08_Robots-in-the-Real-World.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>Robots in the Real World</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<div>
  ...
  <a href="#" title="Add to Calendar" class="addthisevent" data-track="_gaq.push(['_trackEvent','AddThisEvent','click','ate-calendar'])">
                                            ...
                                            <span class="title">Robots in the Real World</span>
                                            <span class="description">A robot that greets you in a range of surprising places, from store aisles and hotel hallways to your own living room. The session will discuss the unique ways robots are being used and how they create new market opportunities.</span> 
    ...
    <div class="paragraphText">A robot that greets you in a range of surprising places, from store aisles and hotel hallways to your own living room. The session will discuss the unique ways robots are being used and how they create new market opportunities.</div>
</div>  
</div>
<ul class="sessionSpeaker"><div id="GroupedData">
	  
<div class=""><strong>Speaker:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Top-Tech-Trends/TREND08_Robots-in-the-Real-World/Cynthia-Breazeal.aspx">
  <strong>Cynthia Breazeal</strong></a>,&nbsp;Founder and Chief Scientist, Jibo, Inc.
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Top-Tech-Trends/TREND08_Robots-in-the-Real-World/Colin-Angle.aspx">
  <strong>Colin Angle</strong></a>,&nbsp;Chairman of the Board, CEO and Co-Founder, iRobot
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Top-Tech-Trends/TREND08_Robots-in-the-Real-World/Jim-Lawton.aspx">
  <strong>Jim Lawton</strong></a>,&nbsp;Chief Product and Marketing Officer, Rethink Robotics
</li></div></div>
</div> 
</ul>
