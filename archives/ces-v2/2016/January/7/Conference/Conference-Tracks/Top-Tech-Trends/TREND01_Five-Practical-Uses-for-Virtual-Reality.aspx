...
<head id="head"><title>
	TREND01_Five Practical Uses for Virtual Reality - CES 2016
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Top-Tech-Trends/TREND01_Five-Practical-Uses-for-Virtual-Reality.aspx" />
<meta property="og:title" content="TREND01_Five Practical Uses for Virtual Reality" />
...
<meta name="twitter:title" content="TREND01_Five Practical Uses for Virtual Reality">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Top-Tech-Trends/TREND01_Five-Practical-Uses-for-Virtual-Reality.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>Five Practical Uses for Virtual Reality</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<div>
    <h2>Five Practical Uses for Virtual Reality</h2>
    <p><b>$ Additional Registration Required</b></p>
    <div class="leftTrackColumn col-sm-18 col-md-15">      
      <div class="waysToBuy">
        <div id="addToCartTREND01" class="cartItem"></div>
      </div>
    </div>
  ...
  <a href="#" title="Add to Calendar" class="addthisevent" data-track="_gaq.push(['_trackEvent','AddThisEvent','click','ate-calendar'])">
                                            ...
                                            <span class="title">Five Practical Uses for Virtual Reality</span>
                                            <span class="description">VR might seem inextricably linked to gaming, but the technology actually has many practical applications including education, healthcare, sports, retail and entertainment. Learn about real-world examples of how and where VR is being used to make a difference.</span> 
    ...
    <div class="paragraphText">VR might seem inextricably linked to gaming, but the technology actually has many practical applications including education, healthcare, sports, retail and entertainment. Learn about real-world examples of how and where VR is being used to make a difference.</div>
</div>  
</div>
<ul class="sessionSpeaker"><div id="GroupedData">
	  
<div class=""><strong>Speaker:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Top-Tech-Trends/TREND01_Five-Practical-Uses-for-Virtual-Reality/Jason-Jerald.aspx">
  <strong>Jason Jerald</strong></a>,&nbsp;Co-Founder and Principal Consultant, NextGen
</li></div></div>
</div> 
</ul>
