...
<head id="head"><title>
	DHTH11_Data in Action - CES 2016
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Digital-Health-Summit/DHTH11_Data-in-Action.aspx" />
<meta property="og:title" content="DHTH11_Data in Action" />
...
<meta name="twitter:title" content="DHTH11_Data in Action">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Digital-Health-Summit/DHTH11_Data-in-Action.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>Data in Action</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<div>
    ...
    <div class="leftTrackColumn col-sm-18 col-md-15">      
      <div class="waysToBuy">
        <div id="addToCartDHTH11" class="cartItem"></div>
      </div>
    </div>
  ...
  <a href="#" title="Add to Calendar" class="addthisevent" data-track="_gaq.push(['_trackEvent','AddThisEvent','click','ate-calendar'])">
                                            ...
                                            <span class="title">Data in Action</span>
                                            <span class="description">We&rsquo;ve come to expect simply moving data from here to there as commonplace. Yet the complexities can make or break delivering a successful digital health experience to the end user. Watch us showcase the true meaning of data with superhuman powers.
    ...
    <div class="paragraphText">We&rsquo;ve come to expect simply moving data from here to there as commonplace. Yet the complexities can make or break delivering a successful digital health experience to the end user. Watch us showcase the true meaning of data with superhuman powers.
<ul>
	<li>Data: Digital Health&#39;s Secret Weapon</li>
</ul>
</div>
</div>  
</div>
...
<div class=""><strong>Speaker:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Digital-Health-Summit/DHTH11_Data-in-Action/Drew-Schiller.aspx">
  <strong>Drew Schiller</strong></a>,&nbsp;Co-Founder and CTO, Validic
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Digital-Health-Summit/DHTH11_Data-in-Action/Gillian-Christie.aspx">
  <strong>Gillian Christie</strong></a>,&nbsp;Health Innovation Analyst, The Vitality Group
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Digital-Health-Summit/DHTH11_Data-in-Action/Ray-Lee.aspx">
  <strong>Ray Lee</strong></a>,&nbsp;Head of Product Management, Proteus Digital Health
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Digital-Health-Summit/DHTH11_Data-in-Action/John-Reites.aspx">
  <strong>John Reites</strong></a>,&nbsp;Head of Digital Health Acceleration, Quintiles
</li></div></div>
</div> 
</ul>
