      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          ...
          <div class="row article-content-area">
             ...
             <div style="padding: 20px;" class="text-center-xs pull-right-sm"><img src="/getattachment/Show-Floor/Marketplaces/Augmented-Reality-(1)/AugmentedReality_CES.jpg.aspx?width=500&height=342&ext=.jpg" ></div>
<h2 class='page-intro'>LVCC, South Hall 2</h2>
<p class="intro">Discover where digital information and the real world connect to create a unique and all-inclusive experience. Through specially designed hardware and software full of cameras, sensors, algorithms and more, your perception of reality can be instantly altered in context with your environment: sports scores on TV during a match, path of trajectory overlaid on an image, gaming, construction plans and more.&nbsp;<br />
<br />
See <a href="http://ces16.mapyourshow.com/search.cfm?srch-type=pavilion&amp;srch-query=Augmented%20Reality&amp;srch-showresults=true" target="_blank">the exhibitors</a> disrupting today&#39;s world through this superimposed technology.</p>  
