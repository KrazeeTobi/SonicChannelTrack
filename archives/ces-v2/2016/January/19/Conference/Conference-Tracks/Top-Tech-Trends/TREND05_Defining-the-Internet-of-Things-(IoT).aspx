...
<head id="head"><title>
	TREND05_Defining the Internet of Things (IoT) - CES 2017
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Top-Tech-Trends/TREND05_Defining-the-Internet-of-Things-(IoT).aspx" />
<meta property="og:title" content="TREND05_Defining the Internet of Things (IoT)" />
...
<meta name="twitter:title" content="TREND05_Defining the Internet of Things (IoT)">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Top-Tech-Trends/TREND05_Defining-the-Internet-of-Things-(IoT).aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>Defining the Internet of Things (IoT)</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<div>
  ...
  <a href="#" title="Add to Calendar" class="addthisevent" data-track="_gaq.push(['_trackEvent','AddThisEvent','click','ate-calendar'])">
                                            ...
                                            <span class="title">Defining the Internet of Things (IoT)</span>
                                            <span class="description">The Internet of Things is growing by leaps and bounds as we rapidly approach the day when connectivity is considered standard. Learn how the all-encompassing world of IoT is segmented into its constituent parts and which consumer and business categories show the most promise.</span> 
    ...
    <div class="paragraphText">The Internet of Things is growing by leaps and bounds as we rapidly approach the day when connectivity is considered standard. Learn how the all-encompassing world of IoT is segmented into its constituent parts and which consumer and business categories show the most promise.</div>
</div>  
</div>
<ul class="sessionSpeaker"><div id="GroupedData">
	  
<div class=""><strong>Speaker:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Top-Tech-Trends/TREND05_Defining-the-Internet-of-Things-(IoT)/Chris-Boross.aspx">
  <strong>Chris Boross</strong></a>,&nbsp;President, Thread Group and Technical Product Marketing Manager, Nest Labs, Thread Group
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Top-Tech-Trends/TREND05_Defining-the-Internet-of-Things-(IoT)/Julie-Bauer.aspx">
  <strong>Julie Bauer</strong></a>,&nbsp;President, Consumer Electronics, Panasonic
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Top-Tech-Trends/TREND05_Defining-the-Internet-of-Things-(IoT)/Arun-Bansal.aspx">
  <strong>Arun Bansal</strong></a>,&nbsp;SVP and Head of Business Unit Radio, Ericsson
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Top-Tech-Trends/TREND05_Defining-the-Internet-of-Things-(IoT)/Casey-Carl.aspx">
  <strong>Casey Carl</strong></a>,&nbsp;Chief Strategy and Innovation Officer, Target
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Top-Tech-Trends/TREND05_Defining-the-Internet-of-Things-(IoT)/Bridget-Karlin-(1).aspx">
