...
<head id="head"><title>
	CSTORY01_C Space Storyteller: Spotify and Chef Morimoto - CES 2016
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/C-Space-Storytellers/CSTORY01_C-Space-Storyteller-Spotify-and-Chef-Mor.aspx" />
<meta property="og:title" content="CSTORY01_C Space Storyteller: Spotify and Chef Morimoto" />
...
<meta name="twitter:title" content="CSTORY01_C Space Storyteller: Spotify and Chef Morimoto">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/C-Space-Storytellers/CSTORY01_C-Space-Storyteller-Spotify-and-Chef-Mor.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>C Space Storyteller: Spotify and Chef Morimoto</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<div>
    <h2>C Space Storyteller: Spotify and Chef Morimoto</h2>
  ...
  <a href="#" title="Add to Calendar" class="addthisevent" data-track="_gaq.push(['_trackEvent','AddThisEvent','click','ate-calendar'])">
                                            Add to Calendar 
                                            <span class="start">1/5/2016 2:45:00 PM</span> 
                                            <span class="end">1/5/2016 3:15:00 PM</span> 
                                            <span class="timezone">America/Los_Angeles</span> 
                                            <span class="title">C Space Storyteller: Spotify and Chef Morimoto</span>
                                            <span class="description">Spotify&#39;s Chief Revenue Officer Jeff Levick sits down with renowned chef Masaharu Morimoto to discuss how innovation, inspiration and passion have played key roles throughout his career.</span> 
    ...
    <div class="paragraphText">Spotify&#39;s Chief Revenue Officer Jeff Levick sits down with renowned chef Masaharu Morimoto to discuss how innovation, inspiration and passion have played key roles throughout his career.</div>
</div>  
</div>
<ul class="sessionSpeaker"><div id="GroupedData">
	  
<div class=""><strong>Moderator:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/C-Space-Storytellers/CSTORY01_C-Space-Storyteller-Spotify-and-Chef-Mor/Jeff-Levick.aspx">
  <strong>Jeff Levick</strong></a>,&nbsp;Chief Revenue Officer, Spotify
</li></div></div>
</div> 
</ul>
