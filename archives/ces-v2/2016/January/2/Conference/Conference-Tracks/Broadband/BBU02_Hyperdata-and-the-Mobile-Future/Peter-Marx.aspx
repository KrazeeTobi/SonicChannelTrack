...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Broadband/BBU02_Hyperdata-and-the-Mobile-Future/Peter-Marx.aspx" />
<meta property="og:title" content="Peter Marx" />
...
<meta name="twitter:title" content="Peter Marx">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Broadband/BBU02_Hyperdata-and-the-Mobile-Future/Peter-Marx.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>Peter Marx</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<h2>Peter Marx</h2>
<h3>CTO<br />City of Los Angeles</h3>
<div style="float: left;">
  <img src="/CES/media/2014/Conference/SpeakerHeadshots/Peter_Marx_City-of-Los-Angeles.jpeg?ext=.jpeg" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Peter Marx">
</div>
<div style="margin: 10px;">
  <p>Mayor Garcetti today appointed Peter Marx as the city's first Chief Innovation Technology Officer. A key part of Mayor Garcetti's back to basics agenda, Marx will oversee the implementation of new tools and technologies across L.A. city government better solve problems for residents and make City Hall work more efficiently and effectively. In addition, he will partner with L.A.'s growing tech industry to deploy innovative technology and promote local job creation. <br /><br />Among his first projects will be improving MyLA311 for one stop customer service; revamping the City's scores of web sites to make them more useful and user-friendly; and capitalize on sharing and analyzing data to upgrade performance throughout City government in the same way LAPD's COMPSTAT system has been used to drive down crime.<br /><br />"Incredibly talented, a force in the tech community, and an L.A. native to boot, Peter was my top choice from a very strong pool of applicants," said Mayor Garcetti. "I'm thrilled to have him on the team and look forward to working with him to better serve Angelenos and foster the already strong tech ecosystem here in the City of Angels. Harnessing technology is critical to the future of our economy and improving city services."<br /><br />"I'm looking forward to working with the Mayor to take the city of the future further into the future," said Peter Marx<br /><br />Before joining the Mayor's Office, Marx served as the Vice President of Business Development at Qualcomm Labs, Inc., commercializing a variety of emerging technologies. Previously, Marx was the Vice President of the Technology and Digital Studio at Mattel, Inc. where the company received a Webby award, the highest award for excellence in online content. Marx managed Analog Protocol, a media-technology consultancy; served as the Chief Technology Officer for Vivendi-Universal Games and Vice President of Emerging Technologies for Universal Studios; and held engineering and producer positions at Electronic Arts. Early in his career, he served as an engineer on a variety of telemedicine, digital video, radiological imaging, and biomedicine applications for UCLA and 3M Company.</p>
</div>
