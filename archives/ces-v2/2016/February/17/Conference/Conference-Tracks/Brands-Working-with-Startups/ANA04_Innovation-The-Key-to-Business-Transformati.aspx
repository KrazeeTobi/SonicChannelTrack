...
<head id="head"><title>
	ANA04_Innovation: The Key to Business Transformation Success - CES 2017
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Brands-Working-with-Startups/ANA04_Innovation-The-Key-to-Business-Transformati.aspx" />
<meta property="og:title" content="ANA04_Innovation: The Key to Business Transformation Success" />
...
<meta name="twitter:title" content="ANA04_Innovation: The Key to Business Transformation Success">
...
<body class="LTR KOKR ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Brands-Working-with-Startups/ANA04_Innovation-The-Key-to-Business-Transformati.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>Innovation: The Key to Business Transformation Success</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<div>
    <h2>Innovation: The Key to Business Transformation Success</h2>
    
    <div class="leftTrackColumn col-sm-18 col-md-15">      
      <div class="waysToBuy">
        <div id="addToCartANA04" class="cartItem"></div>
      </div>
    </div>
  ...
  <a href="#" title="Add to Calendar" class="addthisevent" data-track="_gaq.push(['_trackEvent','AddThisEvent','click','ate-calendar'])">
                                            Add to Calendar 
                                            <span class="start">2016-01-07 오전 9:00:00</span> 
                                            <span class="end">2016-01-07 오전 9:30:00</span> 
                                            <span class="timezone">America/Los_Angeles</span> 
                                            <span class="title">Innovation: The Key to Business Transformation Success</span>
                                            <span class="description">Today&rsquo;s ever-changing consumer behavior is forcing the Entertainment Industry to go through profound changes in the creation, marketing and distribution of its content. Learn how WB leverages innovation as the solution to pivot old models into new paradigms.</span> 
    ...
    <div class="paragraphText">Today&rsquo;s ever-changing consumer behavior is forcing the Entertainment Industry to go through profound changes in the creation, marketing and distribution of its content. Learn how WB leverages innovation as the solution to pivot old models into new paradigms.</div>
</div>  
</div>
<ul class="sessionSpeaker"><div id="GroupedData">
	  
<div class=""><strong>Speaker:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Brands-Working-with-Startups/ANA04_Innovation-The-Key-to-Business-Transformati/Sebastian-Slek.aspx">
  <strong>Sebastien Slek</strong></a>,&nbsp;Executive Director, Time Warner Global Sourcing, Marketing, Warner Bros. Entertainment, Inc.
</li></div></div>
</div> 
</ul>
