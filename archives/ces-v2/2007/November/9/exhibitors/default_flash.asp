...
<div class="section_title">Procrastination: The Great Equalizer</div>
<span class="text">
...
<TD width=4></TD>
<TD vAlign=top>
<P>There are more than a dozen exhibitor deadlines in November and another three dozen next month. Don’t let them overwhelm you. First, take a deep breath. Then, read Dan's tips on how to avoid procrastination and make it all palatable.&nbsp;<BR><BR>Read more in <A href="/exhibitors/newsletter/default.asp">the most recent Exhibitor's Source newsletter</A>.</P></TD></TR></TBODY></TABLE><BR>
...
<tr> 
    ...
    <td width="180" valign="top" class="white_box_bg"><SPAN class=section_title>CE Resource Center</SPAN> <BR>Keep up on the consumer electronics industry.<BR><BR><STRONG><SPAN class=text_colored><STRONG>Must Surf:</STRONG></SPAN><BR></STRONG><A href="http://www.mygreenelectronics.org/" target=blank><IMG height=33 src="/images/general/MGE.gif" width=120 border=0></A><BR><BR><STRONG><SPAN class=text_colored><STRONG>Must Do:</STRONG></SPAN><BR></STRONG><A href="http://www.ce.org/Research/Sales_Stats/1891.asp" target=_new>Participate in the <EM>CE Industry Forecast</EM></A><BR><BR><STRONG><SPAN class=text_colored><STRONG>Must Read:</STRONG></SPAN><BR></STRONG><A href="http://www.ce.org/Press/CEA_Pubs/135.asp"><EM>5 Technology Trends to Watch</EM></A><STRONG><BR><BR><STRONG><SPAN class=text_colored><STRONG>Must Go:</SPAN> <BR></STRONG></STRONG></STRONG><A href="http://www.ce.org/events/event_info/default.asp?eventID=PARA2008" target=_new>2008 PARA Conference</A></td>
