...
function validForm(passedForm)
	{
		...
		if ((radio_value != "LVHilton") && (passedForm.number_of_rooms.value < 20))
			{
		...
		if ((radio_value == "LVHilton") && (passedForm.number_of_rooms.value < 10))
			{
...
<ol>
<li>If you require <strong>20* rooms or more</strong>, use this form to submit your request to a participating International CES hotel. (*The Las Vegas Hilton is accepting blocks of 10 rooms.)
...
<tr>
	<td colspan="2"><span class="required">*</span> Please select an official 2008 International CES hotel. (Availability subject to change. Last updated March 2007.)</td>
</tr>
