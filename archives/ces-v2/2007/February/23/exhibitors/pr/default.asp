...
<html>
<head><!-- PageID 295 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;PR Help</title>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue295', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue295', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue295" id="leftAddedValue295" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Public Relations Help<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<IMG height=110 hspace=6 src="/images/ces_photos/07floor7-150.jpg" width=150 align=right>It's easy to see why PR is oftentimes an exhibitor's highest priority at the International CES. The 4,500 press members and 2,200 financial and trade analysts who cover CES each year can get a company's name into the minds of millions with a stroke of a pen. Boost your PR efforts with the International CES PR Kit, the pre-registered media/analyst list and other resources posted here periodically.
</span>
...
<span class="text">
<A href="/exhibitors/pr/pr_kit/default.asp"><STRONG>Exhibitor PR/IR Kit</STRONG></A> <BR>The exhibitor PR/IR kit offers a wealth of tips and advice to assist you in your ongoing public relations and investor relations efforts for the show. It's never too early to start your CES PR strategy.<BR><BR><STRONG><A href="/exhibitors/pr/media_list/default.asp">Pre-Registered Media/Analyst List</A>&nbsp;</STRONG>(login required)<BR>View a list of media and analysts who are pre-registered for the 2007 International CES and the CES Unveiled pre-CES press events.
</span>
<a name="4151"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Hot PR Tips</div>
<span class="text">
<UL>
<LI><STRONG>Update your PR contact information</STRONG> so journalists and broadcasters can find you easily. Do this through your <A href="https://myces2007.bdmetrics.com/exhibitorPortal/EventLogin.aspx" target=_blank>SmartBooth Entry Portal</A>. (Note: Your company's login credentials were e-mailed to the main exhibitor representative we have on file. If you're not sure who this contact is, e-mail <A href="mailto:acarney@ce.org">Allison Carney</A>.) <BR><BR></LI>
<LI><STRONG>Blog, and build your CES marketing momentum.</STRONG>&nbsp;<A href="http://www.parnassusventures.com/" target=_new>Parnassus Ventures</A> is the parent company of the business blogging conference, Blog Business Summit, and draws on extensive blogosphere experience to offer a wide variety of services, including: 
<UL>
<LI>blogger evaluations </LI>
<LI>blogger engagement/events </LI>
<LI>sponsored blogs like <A href="http://inflighthq.com/" target=_new>inFlightHQ</A> and <A href="http://bigbusinessjet.com/" target=_new>Big Business Jet</A> </LI>
<LI>solid blog marketing strategy</LI></UL><BR><A href="http://www.parnassusventures.com/index.php/contact/" target=_new>Contact Parnassus</A> for blog-related business assistance. </LI></UL>
</span>
<!-- text for main page -->
</div>
