...
<html>
<head><!-- PageID 3774 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;Tech & Engineering Emmy Awards</title>
...
<span class="text">
<IMG height=223 hspace=6 src="/images/general/EmmyTech_CES.jpg" width=293 align=right border=0 relativehref="/images/general/EmmyTech_CES.jpg">The prestigious Technology&nbsp;&amp; Engineering Emmy® Awards&nbsp;presented for the&nbsp;first time&nbsp;at CES, honoring&nbsp;achievements in two areas: Science&nbsp;&amp; Technology for Television, which includes broadcast, cable and satellite distribution, and secondly, Advanced Media Technology encompassing interactive television, gaming technology, and for the first time, the Internet, cellphones, private networks, and personal media players. In addition, for the first time, Emmy Awards were presented for the best use of Advanced Media Technology by commercials as well as programmers.<BR><BR><BR><BR><SPAN class=section_title>Science, Engineering &amp; Technology Awards for Broadcast Television</SPAN> 
<UL>
<LI>The Emmy Award for Pioneering Development of On Screen Display (OSD) for Setup, Control and Configuration of Consumer Television Equipment: <STRONG>RCA-TTE</STRONG> </LI>
<LI>The Emmy Award for Streaming Media Architectures and Components: <STRONG>Microsoft, Adobe Systems Inc., RealNetworks, Apple</STRONG> </LI>
<LI>The Emmy Award for Pioneering Development for Combining Multiple Transport Streams Which Are Already Encoded, Using Rate-Shaping and Statistical Re-multiplexing: <STRONG>Terayon Communication Systems, Inc.</STRONG> </LI>
<LI>The Emmy Award for Development and Implementation of Automatically Assembled Dynamic Customized TV Advertising Visible World: <STRONG>The Weather Channel</STRONG> </LI>
<LI>The Emmy Award for Technology Advances in Serial Digital Interface Solutions, Enabling Over 20 Years of Seamless Studio and Broadcast Infrastructure Migration: <STRONG>Gennum Corporation</STRONG> </LI>
<LI>The Emmy Award for Privately Owned and Operated International Satellite Company Primarily for International Video Services: <STRONG>Rene Anselmo, PanAmSat</STRONG></LI></UL><SPAN class=section_title><BR>Science, Engineering &amp; Technology Awards for Digital Television</SPAN> 
<UL>
<LI>The Emmy Award for Outstanding Achievement in Advanced Media Technology for the Synchronous Enhancement of Original Television Content: <STRONG>DirecTV Interactive Sports – DirecTV</STRONG> </LI>
<LI>The Emmy Award for Outstanding Achievement in Advanced Media Technology for the Non-Synchronous Enhancement of Original Television Content: <STRONG>The-N.com Video Mixer – The N </STRONG></LI>
<LI>The Emmy Award for Outstanding Achievement in Advanced Media Technology for the Creation of Non-Traditional Programs or Platforms: <STRONG>The Slingbox – Sling Media</STRONG> </LI>
<LI>The Emmy Award for Outstanding Innovation and Achievement in Advanced Media Technology for the Best Use of Personal Media Display and Presentation Technology: <STRONG>Xross Media Bar – Sony Computer Entertainment</STRONG> </LI>
<LI>The Emmy Award for Outstanding Innovation and Achievement in Advanced Media Technology for the Best Use of "On Demand" Technology Over Private (closed) Networks: <STRONG>Time Warner Cable’s Start Over – Time Warner Cable, Concurrent Computer Corp., Big Band Networks, Harmonic Inc., Scientific Atlanta</STRONG> </LI>
<LI>The Emmy Award for Outstanding Innovation and Achievement in Advanced Media Technology for the Best Use of "On Demand" Technology Over the Public (open) Internet: <STRONG>Stim TV – NPOWR</STRONG> </LI>
<LI>The Emmy Award for Outstanding Innovation and Achievement in Advanced Media Technology for Best Use by Commercials in Creation and Use in Non Traditional Platforms and Technologies: <STRONG>TiVo Interactive Advertising Platform – TiVo Inc.</STRONG> </LI>
<LI>The Emmy Award for Peripheral Development and Technological Impact of Video Game Controllers:<STRONG> Nintendo, for the D-pad innovation on the NES/Famicon controller. Sony Computer Entertainment America, for the Dual Shock Analog Controller. </STRONG></LI>
<LI>The Emmy Award for Development of 3D Software Engines: <STRONG>John Carmack – id Software</STRONG> </LI>
<LI>The Emmy Award for Pioneering Work in Near and Real-Time Fully Programmable Shading Via Modern Graphics Processors: <STRONG>Microsoft, AMD, NVIDIA Corporation</STRONG></LI></UL>
</span>
...
<div class="section_title">Lifetime Achievement Award</div>
<span class="text">
Receiving the Lifetime Achievement Award that evening&nbsp;was <STRONG>Eddy Hartenstein, former Vice Chairman, The DIRECTV Group, Inc.,</STRONG> who built DIRECTV from its inception into a world class provider of digital television entertainment as well as directed Hughes Communications’ expansion in commercial satellites supporting the broadcast and cable industries. <BR><BR>Among the companies to receive Emmy Awards were Adobe, Apple, Gennum Corporation, Microsoft, RCA, RealNetworks, Terayon Communications Systems, Visible World, The Weather Channel and posthumously Rene Anselmo, founder of PanAmSat.
</span>
<!-- text for main page -->
</div>
