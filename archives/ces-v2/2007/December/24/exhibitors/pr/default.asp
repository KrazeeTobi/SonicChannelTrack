...
<html>
<head><!-- PageID 295 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;PR Help</title>
...
<tr> 
    ...
    <td width="130" valign="top" class="box10_3margin"><A href="http://www.cesweb.org/exhibitors/smartbooth/default.asp"><IMG height=23 src="/images/general/SmartBooth_122.gif" width=122 border=0></A><BR><BR><STRONG>What is CES SmartBooth?</STRONG><BR>CES SmartBooth is the official exhibitor portal into the 2008 International CES online community. <BR><BR>Registered press and attendees are currently using their MyCES Personal Planners to search for exhibitors that have entered information into their SmartBooth Entry Portal. <EM>Will they find you?<BR></EM><BR><A href="http://www.cesweb.org/exhibitors/smartbooth/default.asp">Create your CES SmartBooth.</A><br></td>
...
<span class="text">
<IMG height=110 hspace=6 src="/images/ces_photos/07floor7-150.jpg" width=150 align=right>It's easy to see why PR is oftentimes an exhibitor's highest priority at the International CES. The 4,500 press members and 2,200 financial and trade analysts who cover CES each year can get a company's name into the minds of millions with a stroke of a pen. Let us help you.<BR><BR><A href="/exhibitors/pr/media_list/default.asp"><STRONG>Pre-Registered Media/Analyst List</STRONG> </A>(login required)<BR>View a list of media and analysts who are pre-registered for the 2008 International CES and the CES Unveiled pre-CES press events. <BR><BR><A href="/exhibitors/pr/PRkit.asp"><STRONG>2008 Exhibitor PR Kit</STRONG></A>&nbsp;<BR>This manual includes&nbsp;preliminary promotion ideas, comprehensive communications strategies, press conference&nbsp;information and much more.<BR><BR><A href="/exhibitors/pr/PRnewsletter_jul07.asp"><STRONG>Exhibitor PR Newsletter</STRONG></A><BR>This monthly newsletter helps you keep your public relations efforts in check with valuable tips, deadline reminders and breaking news.</span>
...
<div class="section_title">Hot PR Tip</div>
<span class="text">
<STRONG><A href="https://myces.bdmetrics.com/ExhibitorPortal/EventLogin.aspx">Update your PR contact information</A></STRONG> so journalists and broadcasters can find you easily. Do this through your <STRONG>SmartBooth Entry Portal.</STRONG> (Note: Your company's login credentials were e-mailed to the main exhibitor representative we have on file. If you're not sure who this contact is, e-mail <A href="mailto:acarney@ce.org">Allison Carney</A>.) 
</span>
<!-- text for main page -->
</div>
