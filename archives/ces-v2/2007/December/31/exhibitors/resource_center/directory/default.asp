...
<html>
<head><!-- PageID 399 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;Update Your Directory / SmartBooth Listing</title>
...
<div class="body_title">Update Your 2008 Directory Listing and SmartBooth Profile<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
The <EM>Official International CES Show Directory</EM> is the easiest way for CES attendees and leading industry members to find information about your company and products.<BR><BR><SPAN style="FONT-FAMILY: "><A href="https://myces.bdmetrics.com/exhibitorportal" target=blank>Login</A> to your free </SPAN><A href="http://www.cesweb.org/smartbooth" target=blank>CES SmartBooth Entry Portal*</A> today to complete your: 
<UL>
<LI>Comprehensive online directory listing on CESweb.org </LI>
<LI>Printed listing in the <EM>Show Guide</EM> and on-site <EM>Official International Show Directory </EM>(must be&nbsp;completed by October 19) </LI>
<LI>CES SmartBooth profile, which allows registered attendees and press to search for your company and product information using the MyCES Personal Planner web portal</LI></UL>
<P>*<STRONG>Note:</STRONG> Login required. Your company's credentials were e-mailed to the main exhibitor representative we have on file. <SPAN class=text1>For assistance, e-mail <A href="mailto:Support@BDMetrics.com">Support@BDMetrics.com</A> or call (800) 931-5103 and select option 2.</SPAN></P>
<P><SPAN class=text1><A href="http://www.cesweb.org/smartbooth" target=blank>Click here</A> to learn more about CES SmartBooth and how this powerful <SPAN class=text1><SPAN>web-based prospecting and measurement tool allows you to continue your show investment before, during and after CES.</SPAN></SPAN></SPAN></P></span>
