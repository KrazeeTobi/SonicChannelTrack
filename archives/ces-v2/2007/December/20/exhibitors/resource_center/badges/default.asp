...
<html>
<head><!-- PageID 1546 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;Order Exhibitor & Top 10 Buyer Badges</title>
...
<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
Order Exhibitor & Top 10 Buyer Badges<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container4562")) { document.getElementById("fourth_row_container4562").style.display = "";}
        //-->
    </script>
...
<div class="body_title">Order Exhibitor & Top 10 Buyer Badges<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<SPAN class=section_title>Exhibitor registration for the 2008 International CES is now open.</SPAN> <BR><BR>Register your exhibitor booth personnel and/or top&nbsp;10 buyers. You will need to login with your&nbsp;customer number located in the upper right corner of your booth invoice.<BR><BR>For assistance, please e-mail <A href="mailto:exhreg@CE.org">exhreg@CE.org</A>.<BR><BR><A href="/exhibitors/resource_center/badges/login.asp">Register now.</A> 
<P></P></span>
