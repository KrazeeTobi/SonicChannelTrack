...
<html>
<head><!-- PageID 5019 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;December 2007 Promotions</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/dec2007pro.asp';
    
        var parentLinks=new Array('dummy','/exhibitors/default.htm','/exhibitors/newsletter/default.asp','/exhibitors/newsletter/dec2007.asp');
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue5019', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue5019', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue5019" id="leftAddedValue5019" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<br><div align="center">
    ...
    [ <a href="/exhibitors/newsletter/dec2007.asp">News</a> ]
 &nbsp; 

    [ <strong>Promotions</strong> ]
 &nbsp;

    [ <a href="/dec2007ev.asp">Events</a> ]
 &nbsp;

    [ <a href="/dec2007ops.asp">Operations</a> ]
...
<div class="section_title">Tech-EM Releases New White Paper on Data-Mining</div>
<span class="text">
<A href="http://tech-em.com" target=_blank><IMG height=51 src="/images/partners/TechnologyEM.gif" width=150 align=right border=0></A>New online portal <A href="http://tech-em.com" target=_blank>Tech-EM.com</A> has released a white paper dissecting the growing role of data-mining in tradeshow and event marketing portfolios.&nbsp;The white paper, released online and available free for download, gives marketers and trade show managers a deep dive into how to collect, analyze and use data to enhance the performance of tradeshow programs. Ensure you're doing all you really need to do at the upcoming CES show by leveraging some of the case studies and best practices outlined in this document, which features insights from such global brands as Xerox, Panasonic, and GE Water. <A href="http://tech-em.com/node/111" target=_blank>Read it now.</A>
</span>
<a name="5056"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Promote Your Company with Print Advertising</div>
<span class="text">
<IMG height=44 src="/images/partners/ctpg_reverse_NAPCO_120.jpg" width=120 align=right>The Consumer Technology Publishing Group (CTPG) of North American Publishing Co. publishes the leading industry magazines in both the trade and consumer marketplace — Dealerscope, CustomRetailer, E-Gear, Picture Business, and Home Furnishings Business. In addition, the group produces tailored publications for industry groups and is the custom publisher of the official Pre-Show Planner, Show Directory and Addendum, and Directory for the International CES®. Please visit <A href="http://www.dealerscope.com/mediakit" target=_blank>http://www.dealerscope.com/mediakit</A> for full details.
</span>
<a name="5055"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Give Better</div>
<span class="text">
<SPAN class=subhead>Gifts In Kind International (GIKI) Product Donation Program <BR></SPAN><IMG height=27 src="/images/partners/gikilogo_120.gif" width=120 align=right>CEA has partnered with GIKI to provide members access to a wide array of donation services.&nbsp;With 25 years of experience in product giving, GIKI provides donation services to CEA members at no cost, and distributes products to 150,000 charities that improve the lives of people in need. Learn about the benefits of donating products—visit&nbsp;the GIKI&nbsp;booth (LVCC, North Hall Lobby #L8/L9). <BR>
</span>
<a name="5054"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">CES Green Sponsorships</div>
<span class="text">
<IMG height=144 src="/images/ces_photos/Green_Screen_03_sm.jpg" width=120 align=right>Demonstrate to the more than 140,000 CES attendees your company’s concerns about the environment. Position yourself as a leader in environmental preservation by sponsoring the CES Carbon Offset Program, show recycling bins or CES badges recycling program.<BR><BR><STRONG>Sponsorship Investment<BR></STRONG><A href="/exhibitors/promotions/sponsorships.asp#4972">Read more.</A><BR>Call for details! <BR>Contact<BR>Business Development Manager<BR>Phone: (703) 907-7795<BR>
</span>
<a name="5053"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Make Your Brand Stand out at the International CES</div>
<span class="text">

<P>Take advantage of <A href="/exhibitors/promotions/default.asp">CES promotional opportunities</A> that put your brand out front. Think about sponsoring e-mail stations located in prominent areas throughout the show, including the LVCC Grand Lobby, which also features the CES Store. Also there are still opportunities available to&nbsp;sponsor a Press Bag Giveaway or Blogger Lounge. <BR><BR>Make your company name a standout by becoming a sponsor of one of the many opportunities available.&nbsp;For more information e-mail <A href="mailto:byb@CE.org">byb@CE.org</A> or phone (703) 907-7688. <BR></P>
</span>
<a name="5074"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Which are Official Show Publications and Which are Not?</div>
<span class="text">
We recently received some questions regarding the official show publications for the International CES, and we wanted to be sure and we would like to clear up any confusion.<BR><BR>There are eight official publications for the 2008 International CES. Each of these publications, listed below, is produced for us by one of several of our key media partners.<BR><BR>These are the only publications and show dailies that are endorsed by and produced at the request of the International CES. 
<UL>
<LI>CE Vision Magazine, produced by Consumer Electronics Association </LI>
<LI>Pre-Show Planner, produced by the Consumer Technology Publishing Group </LI>
<LI>Show Guide and Directory Addendum, produced by the Consumer Technology Publishing Group </LI>
<LI>Directory, produced by the Consumer Technology Publishing Group </LI>
<LI>CES Show Daily, produced by TWICE </LI>
<LI>CES Mobile Today,&nbsp; produced by Mobile Electronics Magazine </LI>
<LI>The Engineer’s Guide to CES, produced by Penton Media </LI>
<LI>
<P><SPAN style="FONT-FAMILY: ">Frommer’s 2008 International CES in Las Vegas Travel Guide, p</SPAN><SPAN style="FONT-FAMILY: ">roduced by Wiley Publishing</SPAN></P></LI></UL>
<P><STRONG>Please note:</STRONG> The Consumer Electronics Daily News is not an official show publication. We realize&nbsp;many of you have received calls or solicitations from this company stating they are one of our partners. This publication is not created at the request of the International CES, nor is it distributed on-site at the show with the rest of the show publications.<BR><BR><A href="/docs/FINAL_2008_CES_Official_Show_Publications_Letter.pdf" target=_blank>Get more information on our official show publications.</A></P>
<P>&nbsp;</P>
</span>
...
<tr>
    ...
    <!-- article start -->
    <p>
    <strong>You Know You're a CES Exhibitor When...</strong><br> by Dan Cole</p>
    <p>Continued from <a href="/exhibitors/newsletter/nov2007.asp">first page</a>.</p>
    4. You don’t remember the last time you watched the 6 o’clock news, but you’ve kept close tabs on all the key industry reporters, pitching them on your new products and hot CES news.&nbsp; Each week you check the latest pre-registered media list from CES to see which new reporters are flocking to the show.<BR><BR>3. You may not have fine-tuned how to tell your spouse that you really can’t handle having your mother-in-law stay at your place for three weeks during the holidays, but you’ve found just the right phrases and pitch points for CES.&nbsp; You’ve prepped your speakers and booth staff so that everyone stays on message.<BR><BR>2. The copy center man has become your best friend.&nbsp; You’ve prepared comprehensive show kits and binders for all your staff so they know where to be, when to be there, who to meet, what to say and why your booth will rock the industry at CES.<BR><BR>1. You might have a new 2008 calendar on your desk, but you’re only concerned with putting big red stars around Space Selection Day.&nbsp; You know you won’t miss your timeslot to reserve your booth space for the 2009 International CES.<BR><BR>Happy Holidays from the entire CES Sales &amp; Business Development Team!&nbsp; May 2008 be your best and most successful year yet!<BR>
    <!-- article end -->
