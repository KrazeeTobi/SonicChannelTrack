...
<span class="text">
This new Industry Insider event is a high-profile program focusing on technology partnerships and investments that support successful development projects in emerging countries. 
<P><B><SPAN style="FONT-FAMILY: ">This program consists of two keynotes and three panels: </SPAN></B><BR><BR><SPAN class=subhead>Keynote</SPAN><BR>Hear how governments and the private sector are partnering to leverage technology to combat poverty and illiteracy and promote environmental preservation.<BR><SPAN class=subhead><BR>Technology’s Role in Long-Term Development</SPAN><BR>This panel of global leaders will discuss how technology and innovation are overcoming barriers and expanding opportunities for individuals and communities in emerging economies, and how those changes can be sustained long term. <SPAN class=subhead><BR><BR>Technology in Practice</SPAN><BR>Five companies will demonstrate innovative solutions and products for developing markets. <BR><SPAN class=subhead><BR>Building a Better Tomorrow with Technology</SPAN><BR>Private companies, governments and non-governmental organizations will explore how technology can be used to improve daily life.&nbsp; This panel will touch on healthcare, education and environment.<BR><SPAN class=subhead><BR>Keynote: Nicholas Negroponte, Founder of the MIT Media Lab and One Laptop Per Child&nbsp;Project</SPAN>&nbsp;<BR><BR>“Nicholas Negroponte is the perfect person to deliver this address and help us launch this important new emerging markets and technology program at the International CES,” said Gary Shapiro, president and CEO, CEA. “As the International CES expands it reach globally and draws government leaders from across the globe, it creates an important forum for discussion on how best to leverage technology to foster long term growth and development in emerging countries.&nbsp; Nicholas’ One Laptop Per Child project is a terrific example of how technology can help educate and empower children in the developing world.”</P><B><B>
<P><STRONG>Confirmed speakers include: </P>
<UL>
<LI></STRONG></B></B>Shawn DuBravac, Economist, Consumer Electronics Association (CEA)</STRONG></B></B></STRONG></B></B> </LI></STRONG></B></B>
...
<LI>Dan Shine, Program Director, 50x15 Initiative and President, 50x15 Foundation </LI>
<LI>William Swope, Vice President General Manager Corporate Affairs Group, Intel Corporation </LI>
<LI><SPAN>James Utzschneider, General Manager, Unlimited Potential Group, Microsoft Corporation</SPAN> </LI>
<LI>Tae Yoo, Senior Vice President Corporate Affairs, Cisco Systems, Inc.&nbsp;</LI></UL>
</span>
<!-- text for main page -->
</div>
