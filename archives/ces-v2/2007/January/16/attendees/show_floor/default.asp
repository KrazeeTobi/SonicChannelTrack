...
<html>
<head><!-- PageID 15 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue15', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue15', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue15" id="leftAddedValue15" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Show Floor<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
Here's where to get familiar with the layout of the&nbsp;largest&nbsp;consumer technology tradeshow. From digital device and entertainment companies to&nbsp;wireless and mobile technology creators — 2,700 exhibitors from around the world&nbsp;make CES the global meeting ground for consumer electronics. <BR><BR>Make sure to add <A href="/attendees/show_floor/sands.asp">The Venetian</A> to your must-see destinations at CES this year. This new home for <A href="/attendees/markets/hpaht.asp">high-performance audio & home theater</A> is adjacent to the <A href="/attendees/show_floor/sands.asp">Sands Expo and Convention Center</A>. Learn about these and other <A href="/attendees/show_floor/areas.asp">CES exhibit areas</A>.<BR><BR><STRONG>NEW THIS YEAR:</STRONG> If you need to make a local (Las Vegas) or&nbsp;800&nbsp;telephone call, you can do it for free at any Las Vegas Convention Center payphone.
</span>
...
<span class="text">
<A href="/attendees/show_floor/areas.asp"><STRONG>Exhibit Areas</STRONG></A><BR>See what's happening at the Las Vegas Convention Center, the Las Vegas Hilton and the Sands/Venetian.<BR><BR><A href="/attendees/show_floor/maps/default.asp"><STRONG>Venue Maps</STRONG></A><BR>Need a visual? Download and print the location map. Make sure to check out the Sands Expo and Convention Center/The Venetian.<BR><BR><SPAN class=subhead><A href="/attendees/show_floor/techzones/default.asp">TechZones</A></SPAN><BR>International CES TechZones&nbsp;deliver you the&nbsp;newest of the new technology for a variety of different product categories.<BR><BR><A href="/attendees/show_floor/displays.asp"><STRONG>Special Displays</STRONG><BR></A>Keep your eyes peeled for any of these special displays scattered around almost every part of the show floor.<BR><BR><STRONG><A href="/attendees/show_floor/floor_plans/default.asp">Floor Plans</A></STRONG><BR><SPAN class=text>Download an aerial view of the 2007 International CES show floor with our interactive floor plans, updated frequently.</SPAN>
</span>
<!-- text for main page -->
</div>
...
<tr> 
    ...
    <td width="180" valign="top" class="white_box_bg"><DIV align=right><IMG src="/images/general/40anniv.gif"></DIV><SPAN class=section_title>1972: A Look Back</SPAN> 
<UL>
<LI>First scientific hand-held calculator introduced ($395) </LI>
<LI>First cellular phone call is made in New York City </LI>
<LI><EM>M*A*S*H</EM> debuts on CBS</LI></UL><BR><A href="/attendees/special_events/default.asp">What was happening at CES?</A></td>
...
<tr> 
    <td width="5" valign="top" background="/global_images2005/1.0.box_L.gif"><img height="5" width="5" src="/global_images2005/spacer.gif" vspace="1"></td>
    <td width="180" valign="top" class="white_box_bg"><DIV align=center><IMG src="/images/ces_photos/05-floor.jpg"></DIV><BR><SPAN class=text_colored>Strike your B2B relationships at the International CES.</SPAN></td>
    <td width="5" background="/global_images2005/1.0.box_R.gif"><img height="5" width="5" src="/global_images2005/spacer.gif"></td>
</tr>
<tr> 
    <td width="5" height="14"><img height="14" width="5" src="/global_images2005/1.0.box_BL.gif" align="top"></td>
