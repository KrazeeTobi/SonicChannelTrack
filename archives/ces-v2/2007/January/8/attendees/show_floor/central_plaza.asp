...
<html>
<head><!-- PageID 1928 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;CES Central Plaza</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/show_floor/central_plaza.asp';
...
<span class="text">
<IMG src="/images/general/icon_Central_Plaza_large_june05.gif"><BR><BR>Located directly in front of the Las Vegas Convention Center, the CES Central&nbsp;Plaza&nbsp;houses: 
<UL>
<LI>Outdoor exhibits, including Gibson Audio and Yahoo! </LI>
<LI>Exhibitor registration </LI></UL><BR><STRONG><IMG height=83 src="/images/general/CES_Concierge.gif" width=150 align=right><A href="/attendees/show_floor/areas/concierge.asp">CES Concierge Center<BR></A></STRONG>Located directly in front of the Las Vegas Convention Center, this large concierge-style area hosts a variety of services. There’s no better way to start your busy four days than a cup of coffe and a smiling team ready to help you with just about anything you need. Get a back massage, make restaurant reservations, book a personal walking tour of the show... <BR>
...
<LI>Shoeshine service </LI></TD>
<TD>&nbsp; 
<LI>Wireless Internet access </LI>
<LI>Las Vegas reservations service </LI>
<LI>MyCES Personal Planner kiosks </LI>
<LI>Foreign language interpretation </LI>
<LI>ADA services </LI>
<LI><A href="/attendees/show_floor/areas/concierge.asp">...and more.</A></LI></TD></TR></TBODY></TABLE>
<P>The <A href="/attendees/show_floor/areas/concierge.asp">CES Concierge Center</A> is your one-stop pavilion for all your CES navigation needs. <BR><STRONG><BR>NextGen&nbsp;Home Experience</STRONG><BR>Sponsored by CEA's TechHome Division, the NextGen Home Experience&nbsp;highlights the practical application of home automation and whole house broadband for the next generation of homeowners. <BR><BR><STRONG><IMG height=96 hspace=6 src="/images/general/mecp_SMALL.gif" width=65 align=right>MECP Installer Training and MECP Select Products Installer&nbsp;Challenge<BR></STRONG>Come watch as the best-of-the-best installers compete in a four-day mobile installation contest to build the best car and receive installer training as well.</P>
</span>

<!-- text for main page -->
</div>
<!--/attendees/show_floor/areas/concierge.asp-->
