...
<TITLE>2007 International CES:&nbsp;Innovations 2007 Awards Logo Purchase</TITLE>
...
<tr bgcolor="#E2F0F5">
	...
	<td align="center" valign="top"><br><span class="section_title">INNOVATIONS 2007 AWARDS LOGO PURCHASE</span></td>
	<td align="center"><img src="/attendees/awards/innovations/submission/images/innovations.gif" hspace="10"></td>
</tr>
<tr><td colspan="3">
<!--
<br><br>
This site is temporarily closed in preparation for the Innovations 2007 Awards Program. If you wish to purchase an Innovations 2007 Honoree logo, please e-mail <a href="mailto:innovations@ce.org">innovations@CE.org</a>.  Thank you.
<br><br><br><br><br><br><br><br><br><br>
-->
<div class="body_title">Login</div><br>

<B>CONGRATULATIONS INNOVATIONS HONOREE!</b><br>
You can now purchase Innovations logos to use in promotional materials and product packages. Please follow the <a href="InnovationsLogoUsageGuidelines.pdf" target="_blank">guidelines</a> for using our logos. Please log in using the same username and password from your entry submissions. 
<br /><br />
Logos are available in EPS, PSD, JPEG, and TIFF formats for $25 each. GIF format is available free of charge. Purchase a complete set for $75 and save $25! If you have any questions, please e-mail <a href="mailto:innovations@ce.org">innovations@ce.org</a>.
<br /><br />
<strong>UPDATE:</strong> Due to an overwhelming response, the Innovations 2007 Showcase in the Sands stage schedule is now full. Be sure to visit the Innovations Showcase (Sands, booth #68747) to hear from this year's honorees.
<br /><br />
...
<form name="frm_submit" action="honoree_login_validation.asp" method="post">
	...
	<tr>
		...
		<td><input type="text" name="uname" size="30" maxlength="50"></td>
	</tr>
	<tr>
		<td align="right">Password</td>
		<td><input type="password" name="pword" size="30" maxlength="25"></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2"><img src="/global_images2005/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		<td>&nbsp;</td>
		<td><b>Forgot your password?</b><br>E-mail <a href="mailto:innovations@ce.org?subject=innovations login help">innovations@ce.org</a></td>
	</tr>
</form>
</table>
