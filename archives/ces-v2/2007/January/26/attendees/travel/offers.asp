...
<html>
<head><!-- PageID 3524 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;Special Hotel Offers</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/travel/offers.asp';
    
        var parentLinks=new Array('dummy','/attendees/default.htm','/attendees/travel/default.asp','/attendees/travel/hotel.asp');
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue3524', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue3524', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue3524" id="leftAddedValue3524" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Special Hotel Offers<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<IMG height=101 src="/images/ces_photos/lasVegas.jpg" width=175 align=right>Hotels sell out fast when the world’s largest consumer technology tradeshow hits Las Vegas. If your job or market segment is listed below, take advantage of a limited-time offer for available rooms at select properties. <BR><BR><A href="/register">Register for the 2007 International CES today</A>, and then book your room by contacting&nbsp;a hotel and using its corresponding promotional code.
</span>
...
<div class="section_title">Content Technology Professionals</div>
<span class="text">
Rooms are waiting for professionals in the content&nbsp;technology community. Availability is limited, so call now before they're gone.<BR><BR>
<TABLE cellSpacing=1 cellPadding=1 width="75%" border=0>
<TBODY>
<TR>
<TD><STRONG>Hotel</STRONG><BR>The Venetian<BR>Palms<BR>Rio All Suites</TD>
<TD><STRONG>Phone Number</STRONG><BR>(800) 283-6423<BR>(866) 725-6773<BR>(888) 746-6955<BR></TD>
<TD><STRONG>Group Code</STRONG><BR>RCESAD<BR>ACESSUB<BR>SRCONT7<BR></TD></TR></TBODY></TABLE><BR><SPAN class=subhead>Do you qualify for this promotion?</SPAN><BR>You do if your job or business falls under any of these categories:<BR><BR>
<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
<TBODY>
<TR>
<TD>Art direction firms<BR>Cable television providers <BR>Computer graphics <BR>Digital satellite radio <BR>Direct broadcast satellite TV<BR>Download services <BR>Entertainment marketing<BR>Film and video editors <BR>Final online editing<BR>Graphic designers</TD>
<TD>Graphics and animations<BR>Raw content loggers<BR>Mastering and duplication <BR>Mixing<BR>Movie studios <BR>Multimedia artists/animators <BR>Postproduction houses <BR>Production companies<BR>Production companies<BR>Production music/stock footage</TD>
<TD vAlign=top>Publishers <BR>Record labels <BR>Recording studios <BR>Server/render farms <BR>Software/game developers <BR>Special effects generation <BR>Television networks <BR>Terrestrial radio broadcasters <BR>Terrestrial&nbsp;TV broadcasters</TD></TR></TBODY></TABLE>
</span>
<a name="3631"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Independent Dealers/Retailers</div>
<span class="text">
Rooms are waiting for independent dealer/retailers. Remember, availability is limited; put this high on your to-do list.<BR><BR>
<TABLE cellSpacing=1 cellPadding=1 width="75%" border=0>
<TBODY>
<TR>
<TD><STRONG>Hotel<BR></STRONG>Flamingo<BR>Harrah's</TD>
<TD><STRONG>Phone Number</STRONG><BR>(800) 835-5686<BR>(888) 458-8471</TD>
<TD><STRONG>Group Code</STRONG><BR>SFCES7D<BR>SB1RET7<BR></TD></TR></TBODY></TABLE>
</span>
<!-- text for main page -->
</div>
