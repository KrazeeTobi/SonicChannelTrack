...
<html>
<head><!-- PageID 4170 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->
...
function validForm(passedForm)
	{
		...
		if (passedForm.number_of_rooms.value < 10)
			{
			alert("10 is the minimum number of rooms you may request for a group block.");
			passedForm.number_of_rooms.focus();
			return false;
			}
...
<ol>
<li>If you require <strong>10 rooms or more</strong>, use this form to submit your request to a participating International CES hotel.
<li>The hotel will respond to you within 30 days regarding rates and availability.
...
<tr>
	<td colspan="2"><span class="required">*</span> Please select an official 2008 International CES hotel. (Availability subject to change. Last updated December 2006.)</td>
</tr>
...
<tr>
	...
	<input type="radio" name="hotel" value="Paris">Paris<br>
		<input type="radio" name="hotel" value="Rio">Rio<br>
	</td>
</tr>
</table>
...
<tr>
		<td class="rowlabel"><span class="required">*</span> Max Number of Rooms&nbsp;</td><td><input type="text" size="15" id=text5 name="number_of_rooms"><span class="text_colored">&nbsp;&nbsp;<strong>(You must enter 10 or more.)</strong></span><br>
		</td>
</tr>
