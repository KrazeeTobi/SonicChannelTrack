...
<html>
<head><!-- PageID 337 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;Block Request Form</title>
...
<tr>
   ...
   <a href="/default.htm">Home</a>&nbsp;&gt;&nbsp;<a href="/attendees/default.htm">Attendees</a>&nbsp;&gt;&nbsp;<a href="/attendees/travel/default.asp">Hotel/Transit</a>&nbsp;&gt;&nbsp;Block Request Form
...
function validForm(passedForm)
	{
		...
		alert("Your requested dates must be between 12/26/06 and 1/16/07.")
		passedForm.input7.focus
		return false
		}
	
		if((year=="2006")&&(month != "12")){
		alert("Your requested dates must be between 12/26/06 and 1/16/07.")
		passedForm.input7.focus
		return false
		}		
			
		if((year=="2006")&&(month == "12")&& (day < "26")){
		alert("Your requested dates must be between 12/26/06 and 1/16/07.")
		passedForm.input7.focus
		return false
		}
		
		if((year=="2007")&&(month != "01")){
		alert("Your requested dates must be between 12/26/06 and 1/16/07.")
		passedForm.input7.focus
		return false
		}		
			
		if((year=="2007")&&(month == "01")&& (day > "16")){
		alert("Your requested dates must be between 12/26/06 and 1/16/07.")
		passedForm.input7.focus
		return false
		}
		...
		if (passedForm.number_of_rooms.value < 20)
			{
			alert("20 is the minimum number of rooms you may request for a group block.");
			passedForm.number_of_rooms.focus();
			return false;
			}
...
<tr>
	<td colspan="2"><span class="required">*</span> Please select an official 2007 International CES hotel. (Availability subject to change. Last updated September 2006.)</td>
</tr>
...
<!--	<input type="radio" name="hotel" value="HGVCHilton">Hilton Grand Vacations Club at Hilton<br>-->
		<!--<input type="radio" name="hotel" value="HGVCStrip">Hilton Grand Vacations Club on Strip<br>-->
		<!--<input type="radio" name="hotel" value="Imperial">Imperial Palace<br>		-->
...
<!--	<input type="radio" name="hotel" value="MonteCarlo">Monte Carlo Resort and Casino<br>	-->
		...
		<!--<input type="radio" name="hotel" value="Platinum">Platinum Hotel and Spa<br>-->

		<!--<input type="radio" name="hotel" value="Renaissance">Renaissance Las Vegas<br>	-->
...
<tr><td>&nbsp;</td></tr>
<tr>
	<td colspan="3"><font color="#999999"><b>Unavailable (Sold Out) Blocks</b></font></td>
</tr>
<tr>
	<td>
		<font color="#999999">
		<ul>
			<li>AmeriSuites Las Vegas
			<li>Bally's
			<li>Bellagio
			<li>Caesars Palace
			<li>Flamingo Las Vegas
			<li>Harrah's
			<li>Hilton Grand Vacations Club at Hilton&nbsp;
			<li>Hilton Grand Vacations Club on Strip
			<li>Imperial Palace
			<li>Las Vegas Hilton	
			<li>Luxor
			<li>Mandalay Bay
...
<tr>
	<td colspan=2>Please indicate the first and last nights of your block and the maximum number of rooms needed on your night of highest occupancy. <span class="text_colored">Show days are January 8-11, 2007.</span><br>
	</td>
</tr>
