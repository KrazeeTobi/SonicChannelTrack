...
<html>
<head><!-- PageID 4650 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;CES Meeting Place Exhibitors</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/exhibitors/manual/meetingPlace.asp';
...
CES Meeting Place Exhibitors<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container4649")) { document.getElementById("fourth_row_container4649").style.display = "";}
        //-->
    </script>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue4650', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue4650', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue4650" id="leftAddedValue4650" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">CES Meeting Place Exhibitors<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">

<P>This year, we have created a packet of information specific to your space at the CES Meeting Place – it’s your one-stop shop for all your CES set-up information.&nbsp; Please review all the materials in the PDF that pertains&nbsp;to your&nbsp;location&nbsp;as soon as possible to familiarize yourself with your exhibit space and order forms.</P>
<UL>
<LI><A href="/docs/CES_Meeting_Place_-_LVCC_South_4_Hall(1).pdf" target=_blank>LVCC South Hall – CES Meeting Place</A> </LI>
<LI><A href="/docs/CES_Meeting_Place_-_LVCC_North_Hall.pdf" target=_blank>LVCC North Hall – CES Meeting Place</A> </LI>
<LI><A href="/docs/CES_Meeting_Place_Packet_-_Sands_Finalpdf.pdf" target=_blank>Sands&nbsp;Expo and Convention Center&nbsp;– CES Meeting Place</A></LI></UL>
</span>
