...
<span class="text">
<SPAN class=section_title><A href="http://myces2007.bdmetrics.com/portal" target=_blank><IMG height=93 src="/images/general/MyCES_240.gif" width=240 align=right border=0></A>Building Your Perfect Show<BR></SPAN><BR>Starting in July, it will be time to&nbsp;create your MyCES Personal Planner, a portal that&nbsp;lets you connect online – before the show – with the exhibitors and attendees who hold the answers to your specific questions.<BR><BR>When you <A href="/register">register for CES</A>, you also can provide an e-mail address just for MyCES – or use the same one you use to register for CES as long as it's unique to only you. Your MyCES e-mail address&nbsp;provides access to your personalized portal, where you can search the entire community of CES exhibitors, attendees, products and educational sessions. Find information that matches your specific&nbsp;objectives, and make the most of your four days at the show.&nbsp;&nbsp;&nbsp;<BR><BR>The MyCES Personal Planner is a powerful tool that helps you: 
<UL>
