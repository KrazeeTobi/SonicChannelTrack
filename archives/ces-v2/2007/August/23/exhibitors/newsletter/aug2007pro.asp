...
<html>
<head><!-- PageID 4533 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;August 2007 Promotions</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/exhibitors/newsletter/aug2007pro.asp';
    
        var parentLinks=new Array('dummy','/exhibitors/default.htm','/exhibitors/newsletter/default.asp','/exhibitors/newsletter/aug2007.asp');
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue4533', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue4533', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue4533" id="leftAddedValue4533" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<br><div align="center">
    ...
    [ <a href="/exhibitors/newsletter/aug2007.asp">News</a> ]
 &nbsp; 

    [ <strong>Promotions</strong> ]
 &nbsp;

    [ <a href="/exhibitors/newsletter/aug2007ev.asp">Events</a> ]
 &nbsp;

    [ <a href="/exhibitors/newsletter/aug2007ops.asp">Operations</a> ]
...
<div class="section_title">Reserve Your Product-Specific Exhibit Space Today</div>
<span class="text">
<EM><SPAN style="FONT-STYLE: normal; FONT-FAMILY: "><IMG hspace=3 src="/images/partners/TechZone.jpg" align=right vspace=5>If you're from a small new company or represent an emerging technology, consider participation in one of the more than 20 <A href="http://www.cesweb.org/exhibitors/space/techzones.asp"><STRONG>2008 International CES TechZones</STRONG></A>. Here, attendees learn more about up-and-coming players in <A href="http://www.cesweb.org/exhibitors/space/techzones.asp#techzone1948">consumer VoIP</A>, <A href="http://www.cesweb.org/exhibitors/space/techzones.asp#techzone4372">HomePlug technologies</A>, <A href="http://www.cesweb.org/exhibitors/space/techzones.asp#techzone4373">IPTV</A>, <A href="http://www.cesweb.org/exhibitors/space/techzones.asp#techzone4517">location-based services</A> and <A href="http://www.cesweb.org/exhibitors/space/techzones.asp">more</A>. Jump start your CES exhibit experience in one of these and other market-specific areas.<BR><BR></SPAN></EM><EM><SPAN style="FONT-STYLE: normal; FONT-FAMILY: ">For more information, please contact </SPAN></EM><SPAN class=text1><SPAN>(703) 907-7645 or <A href="mailto:exhibit@CE.org">exhibit@CE.org</A>.</SPAN></SPAN>
</span>
<a name="4555"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Connect With The Press—Send Us Your PR Contact</div>
<span class="text">
<SPAN style="FONT-FAMILY: "><IMG src="/images/ces_photos/Press.jpg" align=right vspace=5>Make sure the media can find you at CES. When using your CES SmartBooth Entry Portal to enter your listing for the online and on-site (print) Official Show Directory, be sure to list your company’s exhibitor PR contact. W</SPAN><SPAN class=text1><SPAN>e will send your PR contact important show information and will direct any inquiries we receive regarding your company and/or products. Additionally, your PR contact’s information will be posted on CESweb.org, accessed by hundreds of thousands of CE professionals year-round, including thousands of industry press and analysts. Don’t wait, access </SPAN></SPAN><SPAN style="FONT-FAMILY: ">your <SPAN><A href="https://myces.bdmetrics.com/exhibitorportal">CES SmartBooth Entry Portal</A></SPAN> now and add/update your PR Contact information</SPAN><SPAN class=text1><SPAN>.<BR><BR></SPAN></SPAN><SPAN class=text1><SPAN>Questions? Contact Allison Carney at </SPAN></SPAN><SPAN class=text1><SPAN><A href="mailto:acarney@ce.org">acarney@ce.org</A></SPAN></SPAN><SPAN class=text1><SPAN>.</SPAN></SPAN>
</span>
<a name="4556"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Exhibitor PR Newsletter</div>
<span class="text">
The Exhibitor PR Newsletter is a monthly distribution designed to help you keep your public relations efforts in check with valuable tips, deadline reminders and breaking news. Check it out to see the latest CES press events and discover ways to maximize your company's media exposure all year long. Use the following link to register, and your PR contact will begin to receive these important CES newstips.<BR><A href="http://www.cesweb.org/exhibitors/pr/default.asp" target=_blank>www.CESweb.org/exhibitors/pr/default.asp</A>
</span>
<a name="4557"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Promote Your Company Using A Shuttle Bus For Maximum Exposure</div>
<span class="text">
<IMG height=57 src="/images/partners/CMAC-logo.gif" width=70 align=right>Drive your exposure to new heights at CES. Be the headliner. Show off your brand and become the star of the show. Be the first brand attendees see starting right at their hotels, before they even go to the halls. CMAC is the official and only CES shuttle bus service that transports everyone to and from the hotels, and between all convention venues. CMAC transports everyone to the show by the busload. They are an eager, captive audience for your advertised message multiple times per day.<BR><BR><STRONG>Exterior Bus Signs &amp; Wraps</STRONG> These moving billboards saturate the convention centers and all of Las Vegas with your special message all day long. Choices include window signs, side banners of varying sizes and even full bus wraps for the ultimate impact. <A href="/exhibitors/promotions/onsite.asp#565" target=_blank>View a sample.</A>&nbsp;&nbsp;<BR><BR><STRONG>Interior Bus Promotions</STRONG> Blanket the inside with header advertising signs, color graphics on crisp white linen headrest covers, literature or gift distributions and even audio messages.&nbsp; No where else do the attendees sit captive for 10 to 15 minutes with only your message staring them in the face. <A href="/exhibitors/promotions/onsite.asp#565" target=_blank>View a sample.</A> &nbsp; <BR><BR><STRONG>Hotel Lobby Signs</STRONG><BR>Have your full color ad make your brand the first to greet attendees as they arrive at their hotels and every time they check these bus schedules for route number and departure times. &nbsp; Special packages and custom programs available: 
<UL>
<LI>LVCC Shuttle Loop Sponsorships </LI>
<LI>Sands/Venetian Express Sponsorship </LI>
<LI>Registration Express Sponsorship </LI>
<LI>Golf Cart Intraconnect Sponsorship </LI>
<LI>Hotel Shuttle Sponsorships <BR>&nbsp;</LI></UL>Contact Bob Kaplan at (866) 210-8489 or <A href="mailto:bobk@cmac.net">bobk@cmac.net</A>&nbsp; for more information.<BR>
</span>
...
<tr>
    ...
    <!-- article start -->
    <p>
    <strong>Leverage CES to Promote Your Brand Worldwide</strong><br> by Dan Cole</p>
    <p>Continued from <a href="/exhibitors/newsletter/aug2007.asp">first page</a>.</p>
    With our ShowTime Program, CS officers set up appointments for their buyer delegations with exhibitors who expressed an interest in exporting to that delegation’s specific country. This program represents another great way to make sales without traveling overseas. 
<P></P>
<P style="tab-stops: 1.0in"><SPAN style="FONT-FAMILY: ">For our international guests, CES helps them through the visa process by providing valuable tips on acquiring a visa. We also offer three International Commerce Centers (ICC) for business services. </SPAN><SPAN style="FONT-FAMILY: ">A multi-lingual staff is available on-site in all ICC locations, the International Registration area on the lower level of the South Hall and the Concierge Center. The interpreters are fluent in several languages, including Spanish, German, French, Chinese, Japanese, Korean, Italian and Portuguese.&nbsp; </SPAN></P>
<P><SPAN style="FONT-FAMILY: ">To help you meet some of these attendees, enjoy the International Reception on the opening night of the show and network with exhibitors and attendees from around the world. </SPAN></P>
<P><SPAN style="FONT-FAMILY: ">Then once the show is over, there’s no need to have your international efforts wait until the next CES. Look to participate in HomeTech Middle East and SINOCES in 2008. Both shows have </SPAN><SPAN style="FONT-FAMILY: ">U.S. Pavilions and opportunities for sponsorships and advertising.&nbsp; </SPAN></P>
<P><SPAN style="FONT-FAMILY: ">CEA’s own <I>CE Vision</I> magazine also informs industry executives around the world about the latest CE trends and technologies. It’s the only CE-focused trade magazine that has a global reach. Promote your brand through advertising and editorial in the magazine.</SPAN></P>
<P><SPAN style="FONT-FAMILY: ">Use CES and CEA’s programs year-round to jumpstart and extend your brand on a global scale.&nbsp; Need more info? Check out the international sections of <A href="http://www.cesweb.org/international/default_flash.asp">CESweb.org</A> and <A href="http://www.ce.org/International/default.asp">CE.org</A> for numerous ideas on how to take your brand to the next level. And, of course, feel free to contact me or any of the CES account managers if you have any questions. We look forward to helping you.</SPAN></P>
    <!-- article end -->
    <img src="/images/general/dan_cole_sig.gif"><br>Dan Cole</td>
</tr>
</table>
    <br><br><br>
    </td>
