...
function validForm(passedForm)
	{
		...
		if (((radio_value=="Mandalay")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="THE")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="Renaissance")&&(passedForm.number_of_rooms.value < 10)))
			{
