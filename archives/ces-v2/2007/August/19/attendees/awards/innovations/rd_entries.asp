...
<html>
<head><!-- PageID 1785 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;Call for Entries</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/awards/innovations/rd_entries.asp';
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue1785', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue1785', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue1785" id="leftAddedValue1785" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Innovations 2008 Design and Engineering Awards Call for Entries<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->
...
<div class="section_title">Sign up to receive Innovations 2008 Call for Entries updates</div>
<span class="text">
<SPAN class=subhead>New and improved&nbsp;online entry&nbsp;tool!</SPAN><BR>We've made it easier to submit multiple entries to the Innovations 2008 program.&nbsp;Check out the new online entry tool with a customized, user-friendly interface when Call for Entries opens in September. <BR><BR><A href="/docs/2k8_Innovations_Rules.pdf">Download a copy of the 2008 Rules and Eligibility (pdf).</A>
...
<!-- text for main page -->
	...
	<!-- Start FORM -->
	If you would like to be added to the Innovations 2008 mailing list, fill out the form below. We'll notify you when we begin accepting entries. (<span class="required">*</span> Denotes required field.)<br>
	<form name="registration_form" action="/attendees/awards/innovations/rd_entries.asp" method="post" onSubmit="return validate_reg_form();">
	<img src="/global_images2005/spacer.gif" alt="" width="100%" height="5" hspace="0" vspace="0" border="0"><br>
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<!--
	<tr>
		<td colspan=3>
		<img src="/global_images2005/1.0/1.0.line.gif" alt="-----------------------------------------------" width="100%" height="2" hspace="0" vspace="0" border="0"><br>
		<img src="/global_images2005/spacer.gif" alt="" width="100%" height="4" hspace="0" vspace="0" border="0"><br>(<span class="required">*</span> Denotes a required field.)
		</td>
	</tr>
	...
	<tr>
		...
		<td rowspan="6" align="right"><img src="/images/partners/IDSA_125.gif"></td>
	</tr>
	...
	<tr><td height="4"></td></tr>	
	<tr>
		<td class="rowlabel"><span class="required">* </span>State/Province&nbsp;&nbsp; </td>
		<td><input  type="text" size="35" name="state" class="formData" value=""></td>
		<td>&nbsp;</td>
	</tr>
	<tr><td height="4"></td></tr>	
	<tr>
		<td class="rowlabel"><span class="required">* </span>Postal Code&nbsp;&nbsp; </td>
	...
	<tr>
		...
		-->
		<td colspan="2">**Your privacy is important to us. Please review our <a href="http://www.cesweb.org/privacy_policy.asp">privacy policy</a> for details.</td>
	</tr>
	</table>
	</form>
