...
<html>
<head><!-- PageID 343 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;Contact an International CES Sales Representative</title>
...
if (myForm.email.value == '')
	{	
		alert('Please enter a email addresss.' );
		myForm.email.focus();
		return false;
	}
