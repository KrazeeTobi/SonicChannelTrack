...
<html>
<head><!-- PageID 3156 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;May 2006, Page 2</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/exhibitors/newsletter/may2k6_pg2.asp';
    
        var parentLinks=new Array('dummy','/exhibitors/default.htm','/exhibitors/newsletter/default.asp','/exhibitors/newsletter/may2k6_pg1.asp');
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue3156', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue3156', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue3156" id="leftAddedValue3156" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<span class="text">
<SPAN class=subhead><A name=may06_09><SPAN class=subhead></SPAN></A>Hotel Program Update</SPAN><BR>If you want to secure a group block at the hotel you stayed in during the 2006 International CES, now is the time to contact the hotel directly. <BR><BR>CES is currently negotiating hotel contracts for the 2007 CES, but many hotels are already accepting group block reservations for those groups that need 20 or more sleeping rooms.&nbsp;Use the <A href="/rd_block_request.asp" target=_blank>online group block request form</A>&nbsp;to submit your request today! Please note that this form is used for requests only. Your request goes directly to the hotel; the hotel then has 3 business days to respond with rates and availability. Submitting this request <B>does not guarantee</B> a reservation or availability. You MUST hear back from the hotel in order to confirm. </SPAN>
<P><SPAN class=subhead><A name=may06_10><SPAN class=subhead></SPAN></A>Help Us Help You: Order in Advance</SPAN><BR>Although many of our vendors showed marked improvement for services provided at CES in January, we raise the bar every year in terms of providing exceptional customer service to our exhibitors. <BR><BR>However, one of the biggest challenges is that many vendors receive exhibitor orders after the published deadline or on-site, which has a substantial impact on their ability to effectively plan for labor and equipment. The unfortunate outcome affects all exhibitors big and small, seasoned or newcomers to CES. So please plan accordingly (or work with your display house/EAC) and make sure your orders are turned in by the deadline date published on the order forms in the Exhibitor Manual. Taking steps like this produces a smoother show experience, saving you time, money and headaches during move in.</P>
<P><SPAN class=subhead><A name=may06_11><SPAN class=subhead></SPAN></A>Attention:&nbsp; LVCC Meeting Room Exhibitors!</SPAN><BR>Did you know that sub-flooring (temporarily installed flooring) is not allowed inside LVCC meeting rooms? Laying carpet over the existing meeting room carpet is permitted, but other flooring materials, regardless of area or size, are strictly prohibited for fire and safety reasons. Plan your meeting room display accordingly to avoid any kind of last minute challenges and frustration. <BR><BR>If you are exhibiting in an LVCC meeting room and have further questions about this policy, please contact Monte Edralin at <A href="mailto:medralin@lvcva.com">medralin@lvcva.com</A> or Gail Sparks-Riegel at <A href="mailto:gsparks@CE.org">gsparks@CE.org</A>.</P>
<P><SPAN class=subhead><A name=may06_12><SPAN class=subhead></SPAN></A>Specialized Event Services (SES) Exhibitor Tips</SPAN><BR>For exhibitors at the Sands Expo and Convention Center or The Venetian, SES is the exclusive in-house provider of telecommunications, Internet, electrical, cleaning, hanging applications, video signal distribution, compressed air, water and drainage.<BR><BR>Learn how to save time and money when placing your SES orders with these <A href="/docs/SandsHelpfulHintsElectricalNeeds.pdf">helpful hints</A>.</P>
<P><SPAN class=subhead><A name=may06_13><SPAN class=subhead></SPAN></A>Sands SES Survey Winners!</SPAN><BR>Thank you to those exhibitors who filled out the Sands SES survey. Congratulations to Scott Shelton of Multi-Link, Inc. and Don Helfstein of NetZero! Scott and Don both won a $250 AMEX gift card for participating in the Sands SES survey sweepstakes. <BR><BR>All of the survey feedback we received was incredibly valuable, and we are now working with SES to determine the focus of our improvement efforts.</P>
<P><SPAN class=subhead><A name=may06_14><SPAN class=subhead></SPAN></A>Shuttle Bus Advertising Sponsorships<BR></SPAN>Drive your exposure to new heights at CES. Be the first brand attendees see starting right at their hotels, before they even go to the halls. CMAC is the official and only CES shuttle bus service that transports everyone to and from the hotels, and between all convention venues. CMAC transports everyone to the show by the busload. They are our eager, captive audience for your advertised message multiple times per day.</P>
<P><SPAN class=subhead><A name=may06_15><SPAN class=subhead></SPAN></A>Exterior Bus Signs &amp; Wraps </SPAN><BR>These moving billboards saturate the convention centers and all of Las Vegas with your special message all day long. Choices include window signs, side banners of varying sizes and half or full bus wraps for the ultimate impact. </P>
<P><SPAN class=subhead><A name=may06_16><SPAN class=subhead></SPAN></A>Interior Bus Promotions</SPAN> <BR>Blanket the inside with header advertising signs, color graphics on crisp white linen headrest covers, literature or gift distributions and even audio messages. Nowhere else do the attendees sit captive for 10 to 15 minutes with only your message staring them in the face.</P>
<P><SPAN class=subhead><A name=may06_17><SPAN class=subhead></SPAN></A>Hotel Lobby Signs </SPAN><BR>Have your full color ad greet attendees at their hotels every time they check these bus schedules for route # and departure times.<BR><BR>Special packages and custom programs available.</P>
<UL>
...
<P><SPAN class=subhead><A name=may06_18><SPAN class=subhead></SPAN></A>Exhibitor One-Day Meeting Rooms <BR></SPAN>Contracted exhibitors can reserve meeting room space for one-day meetings/events at the Las Vegas Hilton or the Riviera Hotel. Availability is on a first-come, first-served basis. Room rental fee is $250/room for a meeting that is four hours or less; anything over four hours is $500/room. Contact Noelle Becker at <A href="mailto:nbecker@CE.org">nbecker@CE.org</A> for further information. <BR><BR>Need space for more than one day or at the Sands or The Venetian? Contact CES sales at <A href="mailto:psydnor@CE.org">psydnor@CE.org</A> for availability and rates. </P>
</span>
<p><img src="/global_images2005/spacer.gif" alt="" width="1" height="16" hspace="0" vspace="0" border="0"></p>
<div align="center">

    [ <a href="/exhibitors/newsletter/may2k6_pg1.asp">page 1</a> ]
 &nbsp; 
...
<!--April 2006 CES Celebrates 40 Years-->
...
<tr> 
    ...
    <td width="180" valign="top" class="white_box_bg"><A name=may06_19></A><SPAN class=subhead>CES Celebrates 40 Years!<BR></SPAN>We’re looking forward to celebrating a very special anniversary at the 2007 International CES. Believe it or not, it’s been 40 years since CES burst onto the consumer electronics scene in New York City in 1967!&nbsp; 
<P>From that day on, CES has shaped the CE industry, growing stronger and better every year. We want everyone to share in the celebration, so stay tuned for information on how you can get involved with the 40th anniversary during the show.</P></SPAN></td>
...
<!--April 2006 Exhibitors Helping Exhibitors-->
...
<tr> 
    <td width="5" valign="top" background="/global_images2005/2.0.box_L.gif"><img height="5" width="5" src="/global_images2005/spacer.gif" vspace="1"></td>
    <td width="180" valign="top" class="white_box_bg"><A name=may06_20></A><SPAN class=subhead>Exhibitors Helping Exhibitors</SPAN><BR>Want to gain valuable knowledge about CES from those who know best - your fellow exhibitors? Check out our “Exhibitors helping Exhibitors” feature in each month of the <EM>Exhibitor’s Source</EM>.&nbsp; The column features advice and tips from members of our Exhibitor Advisory Board (EAB). Look for it here starting in the June issue!</td>
    <td width="5" background="/global_images2005/2.0.box_R.gif"><img height="5" width="5" src="/global_images2005/spacer.gif"></td>
</tr>
<tr> 
    <td width="5" height="14"><img height="14" width="5" src="/global_images2005/2.0.box_BL.gif" align="top"></td>
