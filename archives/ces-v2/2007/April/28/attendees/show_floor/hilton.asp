...
<html>
<head><!-- PageID 1929 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/show_floor/hilton.asp';
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue1929', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue1929', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue1929" id="leftAddedValue1929" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Las Vegas Hilton<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<IMG src="/images/general/icons_hilton_lg.gif"><BR><BR>The Las Vegas Hilton serves as the gateway for attendees to connect with international exhibitors&nbsp;and provides&nbsp;a home base for the ever-popular <A href="/attendees/conferences/insiders.asp">Industry Insider Series</A>. Specifically, you'll find: 
<UL>
<LI>Booth #s 50,000-61,999<BR><BR></LI>
<LI><STRONG><IMG height=69 hspace=6 src="/images/general/IntGateway120.gif" width=120 align=right>International Gateway - International Exhibitors</STRONG><BR>The International Gateway represents the global scope of CES, housing more than 400 non US-based exhibitors that contribute to the overall growth of consumer technology. Check out&nbsp;the listing of <A href="/attendees/directory/default.asp">2007 International CES exhibitors</A>.<BR><BR></LI>
<LI><STRONG>Industry&nbsp;Insiders&nbsp;in the Hilton Theater</STRONG><BR>Catch a glimpse of where consumer electronics is headed—and get it from some of the biggest names in the industry. See this and other <A href="/attendees/conferences/default.asp">conference sessions</A>.<BR><BR></LI>
<LI><STRONG>International Commerce Center (ICC) - Satellite Location<BR></STRONG>Available to all international attendees and exhibitors, the International Commerce Center is a great meeting ground and place to check e-mail, enjoy light refreshments and have questions about the show answered by the multilingual staff.<BR><A href="/international/english/services.asp">See more international services.</A><BR><BR></LI>
<LI><STRONG>Satellite Registration<BR></STRONG>Satellite registration area for exhibitors and attendees (domestic and international). Money-saving tip: <A href="/register">Register online now!</A></LI></UL>
</span>
