...
<html>
<head><!-- PageID 3125 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;Feb 2006, Page 2</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/exhibitors/newsletter/feb2k6_pg2.asp';
    
        var parentLinks=new Array('dummy','/exhibitors/newsletter/feb2k6_pg2.asp','/exhibitors/newsletter/feb2k6_pg1.asp');
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue3125', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue3125', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue3125" id="leftAddedValue3125" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="section_title">Where in the World is CES?</div>
<span class="text">
<P align=center><IMG src="/images/general/whereintheworld.gif"></P>
<P>Do you have what it takes to wow the International CES with your creative ability and show your love for CES? Are you ready to have a little fun during your globe-spanning business trips? Have you ever wondered how vendor wear can turn you into a star?</P>
<P>If you answered yes to any of these questions, you’ll want to enter the “Where in the World is CES?” photo competition!</P>
<P>Simply submit a photo of yourself wearing your CES space selection T-shirt in outrageous, fun or creative locations around the world. A team of carefully assembled CES judges will determine the five best photos. You’ll receive great CES prizes if you make the cut! Your photo (along with a cyber high-five to your company) also will be featured in a column of this monthly newsletter.</P>
<P>E-mail the image to Katie Swearingen at <A href="mailto:kswearingen@ce.org">kswearingen@ce.org</A> (minimum 75 dpi .jpg preferred). You can also mail a hard copy, although we will not be able to return it to you.</P>
<P>
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
<TBODY>
<TR>
<TD>&nbsp;<IMG src="/images/ces_photos/Canada.jpg"></TD>
<TD>&nbsp;<IMG src="/images/ces_photos/Washington.jpg"></TD></TR>
<TR>
<TD>&nbsp;<IMG src="/images/ces_photos/NewYork.jpg"></TD>
<TD>&nbsp;<IMG src="/images/ces_photos/India.jpg"></TD></TR></TBODY></TABLE></P>
</span>
<a name="3132"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Operations Wrap-up</div>
<span class="text">
<SPAN class=section_title><SPAN class=subhead><A name=feb06_0601><SPAN class=section_title><SPAN class=subhead></SPAN></SPAN></A>GES<BR></SPAN></SPAN>Over the course of the past year, both GES and CES looked very closely at the most common exhibitor issues and how to improve them for this year. From this research, the following actions were taken to improve service:
<OL type=1>
<LI>GES provided additional exhibitor support by pairing each CES Floor Manager with a GES Zone Manager. These zone managers could check the status of an order, address concerns/problems, review final invoices and offer other much-needed assistance.&nbsp; </LI>
<LI>New pricing structures were developed to maximize time for electrical installation and improve efficiency to save you money. Incentive electrical labor rates were offered for advance work performed prior to January 1. </LI>
<LI>TSE developed a new “Sure Price” program to furnish LVCC exhibitors with a guaranteed price for all electrical services.&nbsp; </LI>
<LI>TSE hired additional supervisors to help manage the show floor and improve service. </LI>
<LI>GES and CES worked closely with the International Brotherhood of Electrical Workers (IBEW) on adjusting union dispatch rules and improving training to better accommodate exhibitors.</LI></OL>
<P>As a result of these efforts, exhibitor move-in was a much smoother process this year.</P>
<P><SPAN class=subhead><A name=feb06_0602><SPAN class=subhead></SPAN></A>Smart City</SPAN><BR>Smart City also took exhibitor issues very seriously and took many strides to improve their services to exhibitors, including:</P>
<UL>
<LI>Creating many exhibitor-friendly materials such as Telephone, Network and Cabling FAQs and more information regarding the wireless situation during CES. </LI>
<LI>Reaching out to exhibitors, calling all that had ordered with us in the past to help facilitate their order. </LI>
<LI>Adding Smart City floor managers who serviced specific areas and exhibitors on the show floor and visited every booth who had ordered our services throughout move in and the show. </LI>
<LI>Creating a CES Hotline, directly connecting exhibitors to the LVCC Smart City staff for questions both pre-show and on-site. </LI>
<LI>Hiring additional technicians to better facilitate installation of exhibitor orders and requirements. </LI>
<LI>Flying in Smart City managers from other facilities to oversee installation, including a data manager, operations manager and customer service manager in each hall. </LI>
<LI>Opening the wireless system so it could be accessed for free. </LI>
<LI>Offering a 5% discount to CES Exhibitor Workshop attendees and those who sent in a complete order before the end of November</LI></UL>
<P><SPAN class=subhead><A name=feb06_0603><SPAN class=subhead></SPAN></A>Monorail</SPAN><BR>With five stations along the Strip plus the Las Vegas Convention Center and the Las Vegas Hilton, many attendees and exhibitors found this mode of transportation the best way to navigate CES. </P>
<P><SPAN class=subhead><A name=feb06_0604><SPAN class=subhead></SPAN></A>Sands Express</SPAN><BR>The Sands Express was a huge success in its inaugural year! The shuttles carried more than 75,000 exhibitors, attendees, and press to and from the Sands and the Las Vegas Convention Center. Total wait and travel time was less than 20 minutes.</P>
<P><SPAN class=subhead><A name=feb06_0605><SPAN class=subhead></SPAN></A>Taxi passenger link program</SPAN><BR>Thanks to the taxi passenger link program at all CES facilities, wait times were reduced. Look for this service to make a repeat performance at future CES shows.</P>
<P><SPAN class=subhead><A name=feb06_0606><SPAN class=subhead></SPAN></A>Success at the Sands!</SPAN><BR>The addition of the Sands Expo and Convention Center was a huge success this year. CES filled Halls B and C with exhibits, as well as many of the Venetian meeting rooms and suites. Attendees filled the halls, taking advantage of the 8 a.m. early opening each day. </P>
<P>Since this was our first time back at this facility in several years, our operations team worked closely with the Sands and Specialized Event Services (SES) to meet exhibitor expectations. SES performed well, and as this was a learning curve year for the facility and SES, services will only be enhanced now that they understand the nature of CES, our exhibitors and our audience.</P>
</span>
<p><img src="/global_images2005/spacer.gif" alt="" width="1" height="16" hspace="0" vspace="0" border="0"></p>
<div align="center">

    [ <a href="/exhibitors/newsletter/feb2k6_pg1.asp">page 1</a> ]
 &nbsp; 
