...
<html>
<head><!-- PageID 638 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;PR/IR Contact Information</title>
...
<a href="/exhibitors/pr/pr_kit/default.asp">Exhibitor PR Kit</a><br>
    ...
    <span class="nav_fourth" id="fourth_row_container628" style="display: none;">
        ...
        //-->
            </script>PR/IR Contact Information
        <br>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue638', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue638', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue638" id="leftAddedValue638" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">PR/IR Contact Information<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<SPAN class=section_title>IMPORTANT!<BR></SPAN><BR>The 2007 International CES is about more than your booth. It is a chance to brand your company name and maximize your opportunities before, during and after CES. To assist your public relations staff with your CES investment, we send information throughout the year about promotional opportunities as part of your CES Exhibitor Package. <BR><BR>The contacts you list will be individuals to whom we will direct any inquiries we receive regarding your company or products. The contact information will be posted on CESweb.org for access by the media and other visitors to the CES website. <BR><BR><STRONG>Update your PR contact information</STRONG> so journalists and broadcasters can find you easily. <A href="https://myces2007.bdmetrics.com/exhibitorPortal/EventLogin.aspx" target=_blank>Do this through your SmartBooth Entry Portal.</A> (Note: Your company's login credentials were e-mailed to the main exhibitor representative we have on file. If you're not sure who this contact is, e-mail <A href="mailto:acarney@ce.org">Allison Carney</A>.) <BR><BR><B>Keep in mind that the PR plan does not work if the messenger is unable to deliver the message.</B> 
</span>
