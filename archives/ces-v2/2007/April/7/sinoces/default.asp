...
<html>
<head><!-- PageID 2324 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;SINOCES</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/sinoces/default.asp';
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue2324', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue2324', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue2324" id="leftAddedValue2324" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">SINOCES<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<A href="http://www.sinoces.com/" target=_blank><IMG height=117 hspace=14 src="/images/partners/SINOCES.gif" width=180 align=right border=0></A>The China International Consumer Electronics Show (SINOCES) is China’s most prominent consumer electronics exhibition.&nbsp;As an influential, annual&nbsp;CE event,&nbsp;SINOCES serves as a good platform for consumer electronics companies to&nbsp;gain global exposure for&nbsp;their new products,&nbsp;new technologies, brand&nbsp;and vision.<BR><BR>CEA is partnering with the China Electronic Chamber of Commerce (CECC) to expand the international scope of SINOCES to help&nbsp;strengthen trade and business opportunities between the U.S. consumer technology industry and China. <BR><BR>It's never to early to plan for the&nbsp;2007 SINOCES, July 6-9, 2007, and&nbsp;go global.<BR><BR><SPAN class=subhead><SPAN class=section_title><SPAN class=subhead><A href="/sinoces/exhibiting.asp">Exhibit at SINOCES.</A> <BR><BR><A href="http://www.sinoces.com/2006/en/index.aspx" target=new>Attend SINOCES.</A></SPAN></SPAN></SPAN>
</span>
...
<div class="section_title">Show details</div>
<span class="text">
<SPAN class=subhead>Exhibit Dates<BR></SPAN>Friday, July 6 - Monday, July 9, 2007<BR><BR><SPAN class=subhead><IMG height=87 hspace=8 src="/images/partners/qingdao.jpg" width=160 align=right>Location</SPAN><BR>Qingdao International Convention Center<BR>Shandong Province, Qingdao, China<BR><BR>Qingdao, a coastal city in east China, is on one of three peninsulas—Shandong Peninsula—along China’s east (northeast) coast. <BR><BR><SPAN class=subhead>Exhibitor Profile</SPAN><BR>The 2006 event attracted more than 62,000 attendees from across the globe, including 5,300 attendees traveling from outside China. Industry professionals experienced the latest products from more than 390 global exhibitors, across a sold-out show floor comprised of 35,000 square meters of exhibit space, up from 24,000 square meters in 2005.&nbsp;Key global exhibitors highlighting their new products on the show floor included Haier,&nbsp;Intel and Sony. Several major international retailers were in attendance including Best Buy, Carrefour, Karstadt Metro, Obi, Quelle, Radio Shack and Walmart.&nbsp;&nbsp;&nbsp;<BR><BR><SPAN class=subhead>Product Categories<BR>
<TABLE cellSpacing=1 cellPadding=4 width="100%" border=0>
<TBODY>
<TR>
<TD>Accessories<BR>Audio<BR>Digital TV<BR>Electronic Gaming<BR>Handheld Information Devices&nbsp;</TD>
<TD>Home Appliances<BR>Home Entertainment<BR>Home Networking<BR>Mobile Storage Products<BR>Personal Electronics</TD>
<TD>Photography/Digital Imaging<BR>Portable Office Devices<BR>Video Hardware &amp; Software<BR>Wi-Fi Technology<BR>Wireless/Mobile Communications</TD></TR></TBODY></TABLE></SPAN><BR><SPAN class=subhead><IMG height=135 src="/images/ces_photos/sinoces_opening.jpg" width=180 align=right>Forums during SINOCES</SPAN> 
<UL>
<LI>Information Appliances Forum Asia (IAFA) </LI>
<LI>3G Summit Forum </LI>
<LI>AVS Forum </LI>
<LI>Consumer Electronics Summit Meeting </LI>
<LI>Flat-panel TV Industry Forum </LI>
<LI>Asia Electronic Forum</LI></UL><BR><SPAN class=subhead>Sponsors</SPAN><BR>Ministry of Commerce, P.R.China<BR>Ministry of Information Industry, P.R.China<BR>Ministry of Science and Technology, P.R.China<BR>Shandong Provincial People’s Government <BR><BR><SPAN class=subhead>Overseas Sponsor</SPAN><BR>The <A href="http://www.ce.org/" target=_blank>Consumer Electronics Association (CEA), </A>the producer of International CES. <BR><BR><BR>For more information, please visit <A href="http://www.sinoces.com/" target=_blank>http://www.sinoces.com/</A>.
</span>
<!-- text for main page -->
</div>
<!--/sinoces/exhibiting.asp-->
