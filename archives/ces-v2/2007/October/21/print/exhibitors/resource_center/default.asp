...
<span class="text">
<IMG height=110 hspace=6 src="/print/images/ces_photos/07floor-150.jpg" width=150 align=right>Downloads, deadlines and other exhibitor information can be found here at the International CES&nbsp;Exhibitor Resource Center.&nbsp;<BR><BR>New! <A href="/print/docs/2008_International_CES_Exhibitor_Overview.pdf" target=_blank>Download the 2008 International CES Exhibitor Overview</A> to learn how the world's largest consumer technology tradeshow can bolster your business.<BR></span>
...
<TBODY>
<TR>
<TD vAlign=top width=285><STRONG><A href="/print/exhibitors/resource_center/badges/default.asp">Order Exhibitor and Top&nbsp;10 Buyer Badges</A><BR></STRONG>Register your exhibitor booth personnel and/or top&nbsp;10 buyers.<STRONG><BR><BR><A href="/print/exhibitors/resource_center/checklist.asp">Deadline Checklist</A></STRONG><BR>This list keeps you organized with to-do items for your exhibit experience. <BR><BR><A href="/print/exhibitors/resource_center/directory/default.asp"><STRONG>Update Your Directory/SmartBooth Listing</STRONG></A><BR>Update your profile so attendees can find you before, during and after the 2008 International CES.<BR><BR><SPAN class=subhead><A href="/print/exhibitors/resource_center/logos/default.asp">International CES Logos</A></SPAN> (Login required.)<BR>Use the International CES logo on marketing materials to promote your exhibit.</TD>
<TD width=20>&nbsp;</TD>
<TD vAlign=top width=285><SPAN class=subhead><A href="/print/exhibitors/resource_center/downloads.asp">Downloads</A><BR></SPAN>Here's where to find attendee survey/audit results, exhibitor overview information and more.<BR><BR><A href="/print/exhibitors/resource_center/affinity.asp"><STRONG>CEA Affinity Program</STRONG></A><BR>CEA Members: Inquire about priority pre-show ordering and special pricing on select GES products and services.<BR><BR><A href="/print/exhibitors/resource_center/EAB.asp"><STRONG>Exhibitor Advisory Board</STRONG></A><BR>The CES Exibitor Advisory Board (EAB) offers guidance regarding any facet of your exhibiting experience.</TD></TR></TBODY></TABLE>
</span>
<!-- text for main page -->
</div>
