...
<html>
<head><!-- PageID 1666 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;by Market</title>
...
<tr>
   ...
   <a href="/default.htm">Home</a>&nbsp;&gt;&nbsp;by Market
...
<div>
<form action="/attendees/conferences/search/session_by_market_list.asp"  method=post><table cellpadding=3 cellspacing=1 border=0><tr><td><span class='subhead'>Choose a market from the drop-down list.</span></td></tr><tr height=7><td></td></tr><tr><td colspan=1><select class=formdata name=ID_category><option value=0>Choose a Market&nbsp;&nbsp;<option value="902">Audio<option value="903">Digital Imaging<option value="904">Emerging Technology<option value="905">Gaming<option value="909">High-performance Audio and Home Theater<option value="906">Home Networking<option value="907">Home Theater/Video<option value="908">In-Vehicle Technology<option value="901">Wireless Communications</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
<!--
<br>
