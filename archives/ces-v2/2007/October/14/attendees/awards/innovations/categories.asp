...
<html>
<head><!-- PageID 4525 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;Awards Categories</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/awards/innovations/categories.asp';
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue4525', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue4525', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue4525" id="leftAddedValue4525" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Innovations 2008 Design and Engineering Awards Categories<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">

<P>Looking for specific product examples? Download the 2008 <A href="/docs/2K8InnovationsCategoryGuide_web.pdf" target=_blank>awards category guide</A>.<BR><BR><SPAN class=subhead>Audio Accessories<BR></SPAN>Products designed to enable, enhance, connect and/or maintain home audio systems and components.<BR><BR><SPAN class=subhead>Audio Components<BR></SPAN>Products designed to deliver, control, store and/or manage audio content including records, tapes, disc-based audio, MP3, and hard drive storage.<BR><BR><SPAN class=subhead>Computer Accessories<BR></SPAN>Products designed primarily around single use functionality to enable, enhance, connect, power and/or maintain desktop and/or portable computer systems. <BR><BR><SPAN class=subhead>Computer Hardware<BR></SPAN>Includes all desktop and portable computer systems capable of accepting user input, storing and retrieving data, displaying or outputting a video signal and are capable of running application software. Does not include products whose primary purpose is making and receiving phone calls.<BR><BR><SPAN class=subhead>Computer Peripherals</SPAN><BR>Products designed to connect to, and extend the functionality of desktop or portable computer systems. Examples include products which provide printing, network and user input and output display.<BR><BR><SPAN class=subhead>Digital Imaging</SPAN><BR>Products designed to enhance the visual experience and/or allow the user to capture, store and edit still or movie video images.<BR><BR><SPAN class=subhead>Eco-Design and Sustainable Technology <SPAN class=text_colored><SPAN class=subhead>NEW!</SPAN><BR></SPAN></SPAN>Innovative features incorporated into consumer electronics products that make them safe for the environment and sustainable,&nbsp;efficient and clean energy use, manufacturing processes that reduce use of environmentally relevant substances (lead, mercury), durability/end-of-life (reuse, refurbish, remanufacture, recycle), resource conservation, solar power, use of recylced inputs, untraditional forms of power, and modes for providing technology/connectivity to developing communities.<BR><BR><SPAN class=subhead>Electronic Gaming</SPAN><BR>Products designed to allow one or more users to interact with electronic games. Examples include consoles, controls, storage devices and network connectivity accessories.<BR><BR><SPAN class=subhead>Enabling Technologies</SPAN><BR>Software embedded in silicon designed to provide functionality to finished products or subassemblies.<BR><BR><SPAN class=subhead>Furniture</SPAN><BR>Items designed to facilitate the use of consumer electronics products and/or the collection and organization of individual components. The category also includes items designed to store, manage, and/or display collections of recorded media.<BR><BR><SPAN class=subhead>Headphones</SPAN><BR>Devices which allow users to listen to audio content (music, radio, video soundtracks, live TV broadcasts, and telephone conversations). The devices may incorporate microphones for user voice response or input.<BR><BR><SPAN class=subhead>Healthcare NEW!<BR></SPAN>Products designed to test, monitor, or analyze the health, well-being, fitness, and/or medical condition of an individual or provide therapeutic benefit. Products should have significant electronic functionality as a central part of the item’s operation<BR><BR><SPAN class=subhead>High-Performance Audio</SPAN><BR>Separate audio components and speakers which provide for optimal performance and sound reproduction. Items are typically produced in very limited quantity and are handcrafted.<BR><BR><SPAN class=subhead>Home Appliances</SPAN><BR>Products designed to provide home heating and cooling, food storage and preparation, and home cleaning.<BR><BR><SPAN class=subhead>Home Networking</SPAN><BR>Products and accessories which enable users to maintain a wired or wireless data network for the purpose of providing file, print and Internet access sharing. Systems may also include products and software which provide for remote and conditional access.<BR><BR><SPAN class=subhead>Home Theater Speakers</SPAN><BR>Includes speakers whose primary purpose is incorporation into a home theater system.<BR><BR><SPAN class=subhead>Home Theater Accessories</SPAN><BR>Items enable home theater component connectivity, power quality, mounting,storage and content management.<BR><BR><SPAN class=subhead>In- Vehicle Accessories</SPAN><BR>Products designed to enable, enhance, connect and/or maintain in-vehicle audio, video, and navigation systems, and components.<BR><BR><SPAN class=subhead>In-Vehicle Audio</SPAN><BR>Products and components designed to be part of an in-vehicle audio system.<BR><BR><SPAN class=subhead>In-Vehicle Control/OEM Integration</SPAN><BR>Products and components designed to facilitate the integration of aftermarket and OEM audio, video, and navigation systems in vehicles.<BR><BR><SPAN class=subhead>In-Vehicle Navigation/Telematics/ITS</SPAN><BR>Products and components designed to be part of an in-vehicle navigation and/or information retrieval and transmission service.<BR><BR><SPAN class=subhead>In-Vehicle Video</SPAN><BR>Products and components designed to be part of an in-vehicle video system.<BR><BR><SPAN class=subhead>Integrated Home Systems <BR></SPAN>Products and components designed to be used as complete systems or subsystems in the home to control the distribution of and access to audio and video content. Systems also control lighting, energy and environmental systems, and security access.<BR><BR><SPAN class=subhead>Multi-Room Audio/Video<BR></SPAN>Systems specifically designed to allow users to centralize content and then redistribute via multiple simultaneous discrete streams to multiple locations in a home.<BR><BR><SPAN class=subhead>Personal Electronics</SPAN><BR>Products designed around single function or multi-function uses which operate individually or in conjunction with other products.<BR><BR><SPAN class=subhead>Portable Media Accessories<BR></SPAN>Products designed to enable, enhance, connect, carry, and/or maintain portable media players.<BR><BR><SPAN class=subhead>Portable Media Players<BR></SPAN>Products incorporating integrated storage and playback capability for audio and/or video content. Products have the capability to connect to desktop and portable computer systems to exchange content.<BR><BR><SPAN class=subhead>Portable Power</SPAN><BR>Devices designed to facilitate the powering and/or charging of consumer electronic products. <BR><BR><SPAN class=subhead>Telephones </SPAN><BR>Products designed to provide access to telephony services in the home and/or office.<BR><BR><SPAN class=subhead>Video Accessories</SPAN><BR>Products designed to enable, enhance, connect and/or maintain home video systems and components.<BR><BR><SPAN class=subhead>Video Components</SPAN><BR>Systems or components designed to provide for playback, storage, and/or distribution of video signals and content in the home.<BR><BR><SPAN class=subhead>Video Displays<BR></SPAN>Devices whose primary purpose is the display of video content not including items marketed and sold primarily as computer monitors.<BR><BR><SPAN class=intro_copy>Wireless Handsets Accessories</SPAN><BR>Products designed to enable, enhance, connect, carry, and/or maintain wireless handsets.<BR><BR><SPAN class=subhead>Wireless Handsets</SPAN><BR>Items marketed primarily for the ability to provide wireless calling capability. The products in this category, in addition to having voice calling features, may also incorporate wireless data and Internet access features along with built-in camera and media playback functionality.</P></span>
