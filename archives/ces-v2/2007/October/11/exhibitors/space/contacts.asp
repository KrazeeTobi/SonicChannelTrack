...
<html>
<head><!-- PageID 342 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;Business Development Contacts</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/exhibitors/space/contacts.asp';
...
Business Development Contacts<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container341")) { document.getElementById("fourth_row_container341").style.display = "";}
        //-->
    </script>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue342', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue342', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue342" id="leftAddedValue342" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">International CES Business Development Contacts<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<DIV class=section_title>Working With You</DIV>Let us help you select the most ideal exhibit space for your company at the world's leading consumer technology event. <BR><BR><A href="/exhibitors/space/rd_contact_rep.asp">Fill out our online form</A> to indicate your space needs.<BR><BR>To speak directly with an International CES representative, please call (703) 907-7645.<BR><BR>
<TABLE cellSpacing=1 cellPadding=1 width=560 align=center border=0>
<TBODY>
<TR>
<TD><IMG src="/images/ces_photos/2007_CES_business_dev_group.jpg"></TD></TR>
<TR>
<TD vAlign=top><SPAN class=text_colored>The CES Business Development Team joined by members of other CEA departments during the 2008 International CES exhibit space selection process at the '07 show. From top left:&nbsp;Wendy Hudak, Tira Gordon, Shari Gray, Brian Moon, Ryan Strowger, Chris Amos, Jason Stookey, Ryan Brown, Antonicia Bishop. Bottom left: Liz Tardif, Mary Cole, Robin Hatfield, Tara Zimmer, Pamela Sydnor, Dan Cole, Angela Newburn, Kirk Smallwood, Carole Russo, Sylvia DeVore.</SPAN></TD></TR></TBODY></TABLE></span>
...
<P><SPAN>The acronym <B><SPAN style="FONT-WEIGHT: bold">S.U.R.E.</SPAN></B> describes our values as an organization and the value we bring to our relationship with you. Our marketing partnership with you is built on a <B><SPAN style="FONT-WEIGHT: bold">Sense of Urgency, Responsiveness and Empathy</SPAN></B>, because we measure our success by your success.</P>
<UL>
<LI></SPAN><SPAN>We are dedicated not to the mastery of perfection, but to the pursuit of excellence.</SPAN></LI>
<LI><SPAN></SPAN><SPAN>We initiate and cultivate beneficial relationships that foster smarter decisions in the CE industry through innovative, revenue-generating client experiences and solutions.</SPAN></LI>
<LI><SPAN></SPAN><SPAN>By virtue of our commitment to fostering goodwill, we are always aware that we serve at the pleasure of our customers.</SPAN></LI></UL>
</span>
<!-- text for main page -->
</div>
<!--/exhibitors/space/rd_contact_rep.asp-->
