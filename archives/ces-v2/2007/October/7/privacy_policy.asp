...
<html>
<head><!-- PageID 722 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;Privacy Policy</title>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue722', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue722', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue722" id="leftAddedValue722" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Privacy Policy<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<SPAN class=section_title>Please Read Carefully Prior To Using This Website</SPAN>
<P>The Consumer Electronics Association (“CEA”) is committed to protecting the privacy and security of your personal information.&nbsp; We want&nbsp; to share with you how we treat personal information about you that we receive in connection with this Website.</P>
<P>Also, please bear in mind that use of this Website is governed by the <STRONG>Terms of Use</STRONG> posted on the Website.&nbsp; As noted in those Terms of Use, although we operate internationally, CEA is a corporation organized under the laws of the Commonwealth of Virginia, in which CEA has its headquarters.&nbsp; The servers that host this Website are located in the United States, and any personal details you provide us will be processed by CEA in the United States.&nbsp; CEA expressly excludes any representation or warranty, express or implied, with respect to the information available on this Website.&nbsp; CEA makes no representation about any third-party websites that may be accessed via links from this Website.&nbsp; By using this Website, you agree that the laws of the Commonwealth of Virginia, without regard to its conflict of laws principles, will govern all matters between you and CEA with respect to your use of this Website.</P></span>
...
<div class="section_title">Use of cookies and web beacons</div>
<span class="text">
...
<P>Depending on the type of browser you are using, your browser may be set to alert you of cookies.&nbsp; You do not have to accept all cookies sent to you by this Website; however, depending on the particular cookie you reject, you may not be able to use some of the features of this Website.&nbsp; To disable all cookies,&nbsp;<A href="http://www.aboutcookies.org/Default.aspx?page=2" target=_blank>follow these instructions</A>&nbsp;for the type of browser you are using.</P>
<P>We may also employ software technology known as “web beacons” or “clear GIFs” which helps us keep track of what content on our Website is effective.&nbsp; Web beacons are small graphics with a unique identifier that are used to track the online movements of Internet users.&nbsp; Web beacons are embedded in the web pages you review, so they are not stored on your hard drive.&nbsp; The web beacons we use do not track or collect any personally identifiable information about you and they are in no way linked to your personally identifiable information.</P>
</span>
<a name="728"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Links to other sites</div>
<span class="text">
...
<div class="section_title">Security of information and disclosures</div>
<span class="text">
...
<div class="section_title">Changes to the Privacy Policy</div>
<span class="text">
...
<div class="section_title">Contacting us</div>
<span class="text">
If you have any questions or concerns relating to this Privacy Policy, please contact us by e-mail at <A href="mailto:CEA@CE.org">CEA@CE.org</A> or by phone at 1-866-858-1555.
</span>
<!-- text for main page -->
</div>
