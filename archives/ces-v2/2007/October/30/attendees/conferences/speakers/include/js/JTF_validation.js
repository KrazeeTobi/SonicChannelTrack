...
function countWords(text){
			if((navigator.appName.indexOf("Netscape") != -1)
				...
				return("This functionality requires version 4.0 or above of\neither Netscape or Internet Explorer.");
			}
		}
//end wordcount
...
function validate_cfs_form(){
	...
	*/
	...
	var stringResearchTopic = document.speakers_form.researchTopic.value;
	var stringResearchDate = document.speakers_form.researchDate.value;
	
	var stringElements = document.speakers_form.topElements.value;
	/*var elementsCharCount = stringElements.length;*/
	var elementsWordCount = countWords(stringElements);	
	...
	var stringValue = document.speakers_form.topicValue.value;
	var valueWordCount = countWords(stringValue);
	...
	*/
	...
	if (stringResearchTopic.length == 0) {
		alert ("Please provide a suggested research topic.");
		speakers_form.researchTopic.focus();
		return false;
	}
	
	if (stringResearchDate.length == 0) {
		alert ("Please provide the research completion date.");
		speakers_form.researchDate.focus();
		return false;
	}
	
	if (stringElements.length == 0) {
		alert ("Please provide an abstract of the suggested research topic.");
		speakers_form.topElements.focus();
		return false;
	}
	
	if (elementsWordCount > 110) {
		alert ("Please limit the abstract to 100 words.");
		return false;
	}

	if (stringValue.length == 0) {
		alert ("Please explain the topic value CES conference attendees.");
		speakers_form.topicValue.focus();
		return false;
	}
	
	if (valueWordCount > 110) {
		alert ("Please limit the topic value to 100 words.");
		return false;
	}
	...
	*/
	...
	if (biographyWordCount > 110) {
		alert ("Please limit the biography to 100 words.");
		return false;
	}
	...
	*/
	...
	if (companyWordCount > 80) {
		alert ("Please limit the company background to 75 words.");
		return false;
	}
