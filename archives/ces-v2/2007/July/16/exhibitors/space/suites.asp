...
<html>
<head><!-- PageID 606 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;CES Meeting Place</title>
...
CES Meeting Place<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container605")) { document.getElementById("fourth_row_container605").style.display = "";}
        //-->
    </script>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue606', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue606', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue606" id="leftAddedValue606" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">CES Meeting Place<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
These&nbsp;hospitality suites&nbsp;let you conduct&nbsp;meetings without the usual distractions of the&nbsp;traditional exhibit&nbsp;space&nbsp;buzz or set up a controlled product display area&nbsp;on the show floor.
</span>
...
<div class="section_title">Terrific space customized by you</div>
<span class="text">
<IMG height=146 hspace=6 src="/images/ces_photos/MeetingPlace.jpg" width=200 align=right> If you're an existing exhibitor who needs more space, or a newcomer who wants to be a part of the International CES success story, the CES Meeting Place can work for you.<BR><BR><SPAN class=subhead>You can:</SPAN><BR>
<UL>
...
<LI>Copier </LI>
<LI>Fax </LI>
<LI>Coffee and water service</LI></UL><BR>Reserve a suite now. Contact an International CES <A href="/exhibitors/space/rd_contact_rep.asp">business development representative</A> today.
</span>
<!-- text for main page -->
</div>
