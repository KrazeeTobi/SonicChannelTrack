...
<a href="/exhibitors/pr/default.asp">Exhibitor PR Kit</a><br>
    ...
    <img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
               <script language="JavaScript">
              <!--
                  if (checkActiveNav("/exhibitors/pr/default.asp") && document.getElementById("fourth_row_container4510")) { document.getElementById("fourth_row_container4510").style.display = "";}
              //-->
              </script> <img src="/global_images2005/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
<a href="/exhibitors/pr/4505.asp">CES Exhibitor PR Newsletter</a><br>
    ...
    <img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
               <script language="JavaScript">
              <!--
                  if (checkActiveNav("/exhibitors/pr/4505.asp") && document.getElementById("fourth_row_container4504")) { document.getElementById("fourth_row_container4504").style.display = "";}
              //-->
              </script> 
        <img src="/global_images2005/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
