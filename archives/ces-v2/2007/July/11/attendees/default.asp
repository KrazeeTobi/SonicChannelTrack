...
<!-- /left column -->
    ...
    <tr>
        ...
        <td class="attendees9" valign="top">Registration is now open for the 2008 CES. Sign up for your free Exhibits Plus Pass today.
    ...
    <tr>
        ...
        <td width="3" class="attendees9"><img src="/global_images2005/spacer.gif" width="3" height="1"></td>
        <td class="attendees9" valign="top">Reserve a room or block of rooms now. Remember, many hotels sell out months before the January show.
        <br><a href="/attendees/travel/hotel.asp">Find the hotel that's right for you.</a></span></td>
    </tr>
    </table>
    <!--/Center space call-outs with image-->   
...
<div class="section_title">CES Now Accepting Speaker Entries</div>

<span class="text">
<IMG height=100 src="/images/speakers/yahoo_tech_speaker.jpg" width=150 align=right>CEOs rank CES as one of their top 10 most desired speaking opportunities, according to Burson-Marsteller’s Most Valued Podium survey. Join&nbsp;300 expert speakers to discuss hot industry topics over four days.<BR><BR><A href="/attendees/conferences/speakers/rd_speaker_form.asp">Submit an application.</A><BR>
</span>
<a name="4249"></a>
