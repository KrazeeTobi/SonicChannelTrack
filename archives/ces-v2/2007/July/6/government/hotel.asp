...
<html>
<head><!-- PageID 2714 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;Hotel/Travel</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/government/hotel.asp';
...
Hotel/Travel<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container2713")) { document.getElementById("fourth_row_container2713").style.display = "";}
        //-->
    </script>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue2714', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue2714', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue2714" id="leftAddedValue2714" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Hotel/Travel<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<SPAN class=subhead>Hotel</SPAN><BR>This year’s CES Government conference will be held January 10-11, 2007, at The Flamingo Las Vegas.&nbsp;A block of rooms for conference attendees is available starting January 9, 2007. Enjoy a discounted room rate of $144. But book now; this rate is only available until Dec. 1, 2006, and rooms are at a premium during the International CES.<BR><BR>The Flamingo Las Vegas<BR>3555 Las Vegas Boulevard South<BR>Las Vegas, NV 89109<BR>Reservations: (800) 835-5686<BR>Please reference CES Government code SFCES7P <BR><BR>Set on the famous four corners of Las Vegas Boulevard and Flamingo Road, this hotel combines heart-pounding Las Vegas excitement with hospitality and service that's second to none. Visit <A href="http://www.flamingolasvegas.com" target=_blank>www.flamingolasvegas.com</A> for more information.<BR><BR>Interested in other hotels?&nbsp;<A href="/attendees/travel/hotel.asp">Check the availability of other Las Vegas hotels.</A> <BR><BR><SPAN class=subhead>Transportation</SPAN><BR>The hotel is approximately 15 minutes from McCarran Airport. Taxi cabs are available at the hotel entrance. Valet and self-parking are also available at the hotel with applicable fee.<BR><BR>Interested in other parts of the International CES? Use the&nbsp;<A href="/attendees/travel/shuttle.asp">International CES shuttle service</A>&nbsp;to get around.
</span>
