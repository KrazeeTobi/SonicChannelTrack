...
<html>
<head><!-- PageID 2674 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/government/sponsorships.asp';
...
Sponsorships<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container2673")) { document.getElementById("fourth_row_container2673").style.display = "";}
        //-->
    </script>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue2674', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue2674', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue2674" id="leftAddedValue2674" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Sponsorships<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
Show your leadership in the community. Sponsor CES Government today.<BR><BR>CES Government offers several sponsorship options — all exhibitor sponsorships allow exhibit space inside&nbsp; the conference room — a unique opportunity with the conference sessions in the center of the integrated and innovative exhibits.&nbsp; This setup allows for all conference participants — sponsors, attendees, and speakers — to share the same space during the conference program, ensuring maximum visibility. and networking opportunity. <BR><BR>In addition, sponsorships are available for:&nbsp;
<UL>
<LI>CES Government Technology Leadership Awards Luncheon</LI>
<LI>VIP dinners</LI>
<LI>Hosting morning networking breakfasts</LI></UL>
<P>For specific sponsorship details and information, please contact Caroline Boyd at (804) 359-1631 or <A href="mailto:cboyd@cesgovernment.com">cboyd@cesgovernment.com</A>.<BR></P><EM></EM>
</span>
