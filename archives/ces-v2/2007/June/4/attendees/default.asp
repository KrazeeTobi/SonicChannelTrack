...
<tr> 
    <td width="5" height="50" valign="top" background="/global_images2005/1.0.box_L.gif"><img height="10" width="5" src="/global_images2005/spacer.gif" vspace="1"></td>
    <td width="130" valign="top" class="box10_3margin"><A href="http://www.hometechexpo.com " target=_blank><IMG height=46 src="/images/general/hometech_120.jpg" width=120 border=0 relativehref="/images/general/hometech_120.jpg"></A><BR><BR><SPAN class=text_colored><STRONG>Registration now open</STRONG><BR></SPAN>May 13-15, 2007<BR>Dubai, United Arab Emirates<BR><A href="http://hometechexpo.com" target=_blank>hometechexpo.com</A> <br></td>
    <td width="5" height="50" background="/global_images2005/1.0.box_R.gif"><img height="5" width="5" src="/global_images2005/spacer.gif"></td>
</tr>
<tr> 
    <td width="5" height="14"><img height="14" width="5" src="/global_images2005/1.0.box_BL.gif" align="top"></td>
...
<!-- /left column -->
    ...
    <tr>
        <td class="attendees9"><img src="/images/ces_photos/cea_90.jpg" border="0" width="90" height="70" vspace="3"></td>
        <td width="3" class="attendees9"><img src="/global_images2005/spacer.gif" width="3" height="1"></td>
        <td class="attendees9" valign="top">Beyond CES, the Consumer Electronics Association produces a host of other events to help strengthen your connections and your business.
        <br><a href="http://www.ce.org/Events/default.asp">See the CEA events calendar.</a></span></td>
    </tr>
    <tr>
        <td height="2" class="attendees9"><img src="/global_images2005/spacer.gif" width="1" height="2"></td>   
    </tr>
    <tr>
        <td class="attendees9"><img src="/images/ces_photos/dell_90.jpg" border="0" width="90" height="70" vspace="3"></td>
        <td width="3" class="attendees9"><img src="/global_images2005/spacer.gif" width="3" height="1"></td>
        <td class="attendees9" valign="top">Watch all free 2007 International CES conference sessions, including keynotes and Industry Insiders.
        <br><a href="/about_ces/multimedia.asp">Check out the CES multimedia library.</a></span></td>
    </tr>
    </table>
    <!--/Center space call-outs with image-->   
