...
<span class="text">
The <EM>Official International CES Show Directory</EM> is the easiest way for CES attendees and leading industry members to find information about your company and products.<BR><BR>Beginning in July, use this wizard to complete your: 
<UL>
<LI>Comprehensive online directory listing on CESweb.org </LI>
<LI>Printed listing in the Show Guide, Official Show Directory and Addendum (must be&nbsp;completed by October 19) </LI>
...
<BR><A href="https://myces.bdmetrics.com/exhibitorPortal/EventLogin.aspx" target=_blank>Login to update your directory and CES SmartBooth profiles.</A> Note: Your company's login credentials were e-mailed to the main exhibitor representative we have on file.-->
</span>
