...
<title>2007 International CES:&nbsp;2008 Block Request Form</title>
...
(*Mandalay Bay, THEHotel at Mandalay, and the Renaissance Hotel are accepting blocks of 10 rooms.) 
<br><br>
...
<tr>
	<td colspan="2"><span class="required">*</span> Please select an official 2008 International CES hotel. (Availability subject to change. Last updated May 2007.)</td>
</tr>
...
<tr>
	...
	<!--
		...
		<ul>
			...
			<li>Paris
			<li>Platinum Hotel and Spa
			<li>Renaissance Las Vegas
			<li>Riviera Hotel and Casino
			<li>Sahara Hotel
			<li>Signature at MGM Grand
			<li>Treasure Island
			<li>Westin Casuarina Las Vegas
		</ul>
		</font>
	-->
	</td>
