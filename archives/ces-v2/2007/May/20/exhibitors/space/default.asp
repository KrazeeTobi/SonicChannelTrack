...
<html>
<head><!-- PageID 22 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;Exhibit Space</title>
...
<span class="text">
<IMG height=110 hspace=6 src="/images/ces_photos/07floor2-150.jpg" width=150 align=right>2007 is shaping up to be a pivotal year for CE, thanks to content and time-shifting technologies, market crossover and the "mobile-ization" of technology. It's a dynamite time for our industry, and the CES show floor is your ground floor for business.<BR><BR>Contact a business development representative today to learn about securing show floor space.&nbsp;Also consider other ways to boost your&nbsp;CES&nbsp;success&nbsp;like <A href="/exhibitors/promotions/default.asp">promotional opportunities</A>.
</span>
...
<span class="text">
Use our <A href="/docs/2007CESExhibitorOverview.pdf" target=_blank>Exhibitor Overview (pdf)</A> to learn more about who attends the International CES and why, and then look below to see what kind of exhibit space works best for you. <BR><BR><SPAN class=subhead><A href="/exhibitors/space/areas.asp">Exhibit Booth Space</A></SPAN><BR>Divided into easy-to-navigate categories, the show floor's design offers your company maximum exposure to the attendees you need to meet. <BR><BR><SPAN class=subhead><A href="/exhibitors/space/techzones.asp">TechZones</A></SPAN><BR><IMG height=27 hspace=6 src="/images/general/techzone_small.gif" width=120 align=right>Showcase your company in a high-energy&nbsp;areas devoted to&nbsp;developing technologies and new companies in a variety of CE markets.<BR><BR><SPAN class=subhead><A href="/exhibitors/space/suites.asp">Meeting Place</A></SPAN><BR>Conduct private meetings and product demonstrations in hard-walled CES Meeting Place hospitality suites—right on the show floor! Customize your space and receive many services.<BR><BR><SPAN class=subhead>Other Meeting Room Options</SPAN><BR>Hilton hospitality suites, Renaissance Hotel meeting rooms&nbsp;and permanent convention center meeting rooms provide other options for exhibitors. Contact an International CES <A href="/exhibitors/space/contacts.asp">business development representative</A> to review availability.
</span>
<!-- text for main page -->
</div>
...
<tr> 
    ...
    <td width="180" valign="top" class="white_box_bg"><DIV align=right><IMG src="/images/general/40anniv.gif"></DIV><SPAN class=section_title>1967: A Look Back</SPAN> 
<UL>
...
<tr> 
    <td width="5" valign="top" background="/global_images2005/2.0.box_L.gif"><img height="5" width="5" src="/global_images2005/spacer.gif" vspace="1"></td>
    <td width="180" valign="top" class="white_box_bg"><SPAN class=subhead>Secure your space today<BR></SPAN>Download the International CES <A href="/docs/2007CES_Space_Contract.pdf" target=_blank>Space Agreement (pdf)</A> and contact a <A href="/exhibitors/space/contacts.asp">sales representative</A> to review options and availability.</td>
    <td width="5" background="/global_images2005/2.0.box_R.gif"><img height="5" width="5" src="/global_images2005/spacer.gif"></td>
</tr>
<tr> 
    <td width="5" height="14"><img height="14" width="5" src="/global_images2005/2.0.box_BL.gif" align="top"></td>
...
<SPAN class=section_title>Exhibitor benefits</SPAN><BR>
<UL>
<LI>Post contacts, logos, and more on CESweb.org </LI>
<LI>Company listing in show directory (print, online, PDA beaming stations) </LI>
<LI>International CES logo use in marketing materials </LI>
<LI>Receive our monthly exhibitor newsletter </LI>
...
<LI>Keynote session attendance </LI>
...
<LI>One hour of electrical assistance for booths under 400 nsf. </LI>
<LI>Nightly booth vacuuming </LI>
<LI>Unlimited buyer invitations </LI>
<LI>10 exhibitor badges (or 5 per 100 s.f.) </LI>
