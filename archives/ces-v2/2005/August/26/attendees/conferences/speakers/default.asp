...
<title>2006 International CES:&nbsp;Speaking Opportunities</title>
...
<span class="text">
<IMG height=98 hspace=8 src="/images/ces_photos/05-supersession2_130.jpg" width=130 align=left>More than 130,000 industry professionals from 110 countries tap into four days of conference sessions at the International CES.&nbsp;It is the educational showcase for financial analysts, venture capitalists, developers, consumer technology manufacturers, corporate buyers and retailers. A speaking position in the CES conference program is your opportunity to reach this audience. <BR><BR><STRONG><BR>You may apply for&nbsp;a speaking opportunity</STRONG> at the 2006 International CES for you, your company or your client by answering the 2006 International CES <A href="/attendees/conferences/speakers/rd_speaker_form.asp">CALL FOR SPEAKERS. </A>The deadline is <STRONG>Friday, August 12, 2005.<BR><BR></STRONG>The 2006 International CES will host conference sessions addressing wireless technology, home networking, mobile electronics, emerging technologies, retailing trends, e-commerce, digital content and much more. Please see the <A href="/attendees/conferences/speakers/rd_speaker_form.asp">online entry form</A> for a full list of conference subjects. <BR><BR>All submissions should include a&nbsp;75 to 100-word biography, a photo, and at least three key points you can address for each session selected. Should you be chosen to speak at the 2006 International CES, your bio and photo will be posted on CESweb.org.&nbsp;<BR><BR>E-mail <A href="mailto:CFS@CE.org">CFS@CE.org</A>&nbsp;if you have questions regarding the submission process.
</span>
...
<div class="subhead" style="padding-top:3px; padding-bottom:7px">Suggested topics for the 2006 International CES conference program include: </div>
<span class="text">
<TABLE width="90%" border=0>
<TBODY>
<TR>
<TD vAlign=top width="34%"><SPAN class=text>Automotive Computing<BR>Bluetooth<BR>Broadband<BR>Computer Accessories<BR>Copy Protection<BR>Data Casting<BR>Digital Imaging<BR>Digital Radio<BR>Digital Audio and Video<BR>Digital Video Recording<BR>E-Commerce<BR>Electronic Gaming<BR>E-Marketing<BR>Flash Memory/Compact Storage<BR></SPAN></TD>
<TD vAlign=top width="32%"><SPAN class=text>Handheld Computing<BR>HDTV<BR>High Performance Audio<BR>Home Automation<BR>Home IT Networking<BR>In-Car Navigation<BR>Interactive TV<BR>Internet Accessories<BR>Internet Appliances<BR>Internet Audio<BR>Linux<BR>Mobile Accessories<BR>Mobile Data Services<BR>Multichannel Audio<BR></SPAN></TD>
<TD vAlign=top width="34%"><SPAN class=text>PC-based Digital Audio<BR>Personal Global Positioning<BR>Portable Digital Music<BR>Product Development<BR>Satellite Technology<BR>Satellite Telephony<BR>Set-Top Boxes<BR>Smart Cards<BR>Smart Phones<BR>Speech Recognition<BR>Video Game Consoles<BR>Wireless Communications<BR>Wireless Home Networking<BR>Wireless Web<BR></SPAN></TD></TR></TBODY></TABLE><BR>Because of the number of sessions and the need for a balanced program, a limited number of presenters will be accepted. We consider all proposals based on industry representation, professionalism, prior public speaking experience and session topic relevance. <BR><BR>Those selected to participate in the conferences program receive a <A href="/attendees/conferences/speakers/speaker_services.asp">variety of resources</A> to enhance their 2006 International CES experience. <BR><BR><STRONG>NOTE: All speaker candidates will be notified of their acceptance status on or before September 23, 2005.</STRONG> 
</span>
<!-- text for main page -->
</div>
