...
<html>
<head><!-- PageID 2022 - generated by RedDot 5.6 - 5.6.1.9 - Y-9bp -->
...
<span class="text">
<IMG height=36 hspace=6 src="/images/partners/fastest_geek_ExTech.gif" width=220 align=right>Fastest Geek is the ultimate challenge to test PC-building skills. Contestants must compete against each other to build a fully functioning PC in the fastest time during regional "heat" events. The winner of each heat competes in a final match to determine who will be the Fastest Geek.&nbsp;See the action within Innovations Plus in the <A href="/attendees/show_floor/areas/central_plaza.asp">CES Central Plaza</A>. <BR><BR>
</span>
<a name="2031"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
