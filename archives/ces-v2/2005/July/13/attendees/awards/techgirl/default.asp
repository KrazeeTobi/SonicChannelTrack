...
<title>2006 International CES:&nbsp;Technology Is A Girl's Best Friend</title>
...
<br><br>
<span class="subhead">2005 Honorees</span><br>
Located in the Experience CEA: One Digital World display (LVCC Grand Lobby), the <em>Technology Is A Girl's Best Friend</em> showcase featured the winning products of 2005. A combination of journalists from top women's media outlets and technology reporters judged product entries based on form, function, overall ease of use, and how these products enhance the daily lives of female consumers.
<br><br>
<strong>Scroll down the list of honorees from the 2005 International CES or view them by product category:</strong>
		...
		<tr><a name="Audio"></a>
		    ...
		    <td valign="top" class="text" width="440"><img src="/global_images2005/spacer.gif" alt="" width="440" height="4" hspace="0" vspace="0" border="0"><br>
				...
				<tr>
					...
					The Rio Forge packs a heavy punch with its amazing sound quality, rugged athletic design and industry leading battery life. This player can go just about anywhere.<br><br><br>
		...
		<tr><a name="Audio"></a>
		    ...
		    <td valign="top" class="text" width="440"><img src="/global_images2005/spacer.gif" alt="" width="440" height="4" hspace="0" vspace="0" border="0"><br>
				...
				<tr>
					...
					Denon's elegant D-M51DVS DVD Receiver System includes an integrated DVD/receiver, two satellite speakers and a subwoofer, and features Dolby Virtual Speaker technology for a realistic 5.1 surround sound listening experience.<br><br><br>
		...
		<tr><a name="Computer/IT"></a>
		    ...
		    <td valign="top" class="text" width="440"><img src="/global_images2005/spacer.gif" alt="" width="440" height="4" hspace="0" vspace="0" border="0"><br>
				...
				<tr>
					...
					The BenQ M310 Wireless Mini Optical Mouse is ideal for portability. It features an ambidextrous style and wireless receiver that tucks away in the built-in Smart Receiver Storage Compartment. <br><br><br>
		...
		<tr><a name="Computer/IT"></a>
		    ...
		    <td valign="top" class="text" width="440"><img src="/global_images2005/spacer.gif" alt="" width="440" height="4" hspace="0" vspace="0" border="0"><br>
				...
				<tr>
					...
					The world's smallest flash drive stores one gigabyte and connects directly to any USB port.  Includes credit card sized protective carrying case, partitioning security software, and optional USB adapter.<br><br><br>
		...
		<tr><a name="Digital Imaging"></a>
		    ...
		    <td valign="top" class="text" width="440"><img src="/global_images2005/spacer.gif" alt="" width="440" height="4" hspace="0" vspace="0" border="0"><br>
				...
				<tr>
					...
					PictureMate by Epson (C11C556001) is the first true personal photo lab, allowing users to print beautiful, durable lab-quality photos at home for the same per print cost as the lab.<br><br><br>
		...
		<tr><a name="Digital Imaging"></a>
		    ...
		    <td valign="top" class="text" width="440"><img src="/global_images2005/spacer.gif" alt="" width="440" height="4" hspace="0" vspace="0" border="0"><br>
				...
				<tr>
					...
					Stylish digital web camera featuring 1.3 Mega pixel photos, 8MB memory for mobile photography, rechargeable lithium ion battery, color LCD display, and convenient mirror so you always look your best!<br><br><br>
		...
		<tr><a name="Electronic Gaming"></a>
		    ...
		    <td valign="top" class="text" width="440"><img src="/global_images2005/spacer.gif" alt="" width="440" height="4" hspace="0" vspace="0" border="0"><br>
				...
				<tr>
					...
					The GameCom Halo(tm) 2 headset for Xbox(r) Live(tm) combines a cool, comfortable and innovative "ear-gonomic" design with a noise-canceling microphone for greater speech accuracy to enhance your gaming experience! <br><br><br>
		...
		<tr><a name="Electronic Gaming"></a>
		    ...
		    <td valign="top" class="text" width="440"><img src="/global_images2005/spacer.gif" alt="" width="440" height="4" hspace="0" vspace="0" border="0"><br>
				...
				<tr>
					...
					2.1 X-Chrome panel Sicuro Gaming Speaker RW-375XL delivers a powerful and crispy clear sound quality, and unique Techno lighting effect that rocks your gaming experience!<br><br><br>
		...
		<tr><a name="Home Networking"></a>
		    ...
		    <td valign="top" class="text" width="440"><img src="/global_images2005/spacer.gif" alt="" width="440" height="4" hspace="0" vspace="0" border="0"><br>
				...
				<tr>
					...
					NevoSL is a powerful universal controller that intuitively delivers complete audio visual and digital media control for the networked home. <br><br><br>
		...
		<tr><a name="Home Networking"></a>
		    ...
		    <td valign="top" class="text" width="440"><img src="/global_images2005/spacer.gif" alt="" width="440" height="4" hspace="0" vspace="0" border="0"><br>
				...
				<tr>
					...
					RC9800i - Simple, yet revolutionary control; Control all A/V devices: past, present and future; Control all media content with a few simple clicks; Quick, clean and easy setup<br><br><br>
		...
		<tr><a name="Mobile Electronics"></a>
		    ...
		    <td valign="top" class="text" width="440"><img src="/global_images2005/spacer.gif" alt="" width="440" height="4" hspace="0" vspace="0" border="0"><br>
				...
				<tr>
					...
					The A10 (CV1090N/CV1090G) is the world's first video system with Built-In Video Games and Dual-Zone Screen/Source controller. Provides numerous entertainment options and meets the growing needs of today's active families.<br><br><br>
...
Portable entertainment center   10.2" Screen, built in Speakers, Dual headphone jacks and full function remote control. Plus all cables, car adapter and battery.<br><br><br>
		...
		<tr><a name="Video"></a>
		    ...
		    <td valign="top" class="text" width="440"><img src="/global_images2005/spacer.gif" alt="" width="440" height="4" hspace="0" vspace="0" border="0"><br>
				...
				<tr>
					...
					The ARCHOS Pocket Video Recorder AV400 is the industry's first portable digital video recorder with television recording and scheduling capabilities, and audio, photo and data storage in one pocket-sized device<br><br><br>
		...
		<tr><a name="Video"></a>
		    ...
		    <td valign="top" class="text" width="440"><img src="/global_images2005/spacer.gif" alt="" width="440" height="4" hspace="0" vspace="0" border="0"><br>
				...
				<tr>
					...
					Sony's DVDirect allows users to convert their camcorder or VHS tapes into DVDs with the simple push of a button -- and without a computer.  It's a memory preservation machine.<br><br><br>
		...
		<tr><a name="Wireless"></a>
		    ...
		    <td valign="top" class="text" width="440"><img src="/global_images2005/spacer.gif" alt="" width="440" height="4" hspace="0" vspace="0" border="0"><br>
				...
				<tr>
					...
					Cellboost MT1: The disposable, "anytime" recharger for cellular phones. Lightweight and convenient, Cellboost provides an average of 60 minutes of INSTANT talktime. Talk and charge simultaneously, with Cellboost.<br><br><br>
...
Combining Microsoft's software applications and Audiovox's dependable hardware, the SMT-5600 is one of the most unassuming yet powerful devices available.<br><br><br>
