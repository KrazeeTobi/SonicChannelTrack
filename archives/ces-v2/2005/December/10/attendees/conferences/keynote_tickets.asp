...
<html>
<head><!-- PageID 3059 - generated by RedDot 5.6 - 5.6.1.9 - Y-9bp -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2006 International CES:&nbsp;Keynote Ticket Requests</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/conferences/keynote_tickets.asp';
    
        var parentLinks=new Array('dummy','/attendees/default.htm','/attendees/conferences/default.asp','/attendees/conferences/keynotes.asp');
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue3059', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue3059', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue3059" id="leftAddedValue3059" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Keynote Ticket Requests<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
Thank you for your interest in the <A href="/attendees/conferences/keynotes.asp">2006 International CES Keynote Addresses</A>. Tickets are no longer available for any of the productions.<BR><BR>Please note:&nbsp;You can watch&nbsp;live broadcast of each address on-site&nbsp;in Las Vegas Hilton Ballrooms D and E as well as Las Vegas Hilton Meeting Rooms 7-14.
</span>
...
<div class="section_title">How do I redeem my ticket?</div>
<span class="text">
If you requested&nbsp;keynote tickets during keynote registration, you will receive an e-mail confirmation by December 23 to let you know if you&nbsp;received a seat.<BR><BR>After you&nbsp;receive an electronic confirmation,&nbsp;you must print and redeem it on-site. Tickets must be picked up at the Will Call Desk located in the Las Vegas Hilton in Conference Room 2&nbsp;during these times:<BR>9 a.m. - 6 p.m. Wednesday, January 4, 2006<BR>8 a.m. - 6 p.m. Thursday, January 5, 2006 <BR><BR><SPAN class=subhead>Keynote Ticket Pick-Up Deadlines:</SPAN><BR>Tickets must be picked up by the following times. If not, the attendee’s assigned seat will be released for general admission.&nbsp;<BR><BR>
<TABLE cellSpacing=1 cellPadding=1 width="70%" border=0>
<TBODY>
<TR>
<TD><STRONG>Keynote Address</STRONG><BR>Bill Gates, Microsoft <BR>Howard Stringer, Sony&nbsp; <BR>Paul Otellini, Intel&nbsp; <BR>Terry Semel, Yahoo!&nbsp; <BR>Larry Page, Google&nbsp; </TD>
<TD><STRONG>Final Pickup Time</STRONG><BR>by 4 p.m. Wednesday, January 4<BR>by 6 p.m. Wednesday, January 4&nbsp; <BR>by 3 p.m. Thursday, January 5&nbsp; <BR>by 6 p.m. Thursday, January 5&nbsp; <BR>by 6 p.m. Thursday, January 5&nbsp; </TD></TR></TBODY></TABLE><BR><STRONG>Note to Press:</STRONG> Press members do not need to register online or possess a ticket for entry. Press members are the ONLY attendees who do not need to possess an admission ticket to gain entry. However, you must have valid press credentials, a CES badge and a CES badgeholder for admittance.
</span>
<a name="3079"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">How do I guarantee my seat?</div>
<span class="text">
Doors will open 45 minutes prior to the start of each keynote. Las Vegas Hilton Theater ushers will be available to assist you in finding your assigned seat. There are a few things to ensure you entry process to keynote addresses is smooth and easy. 
<OL type=1>
<LI>Bring your ticket to the appropriate keynote address.</LI>
<LI>Bring your CES badge <STRONG>AND</STRONG> official CES badgeholder.</LI>
<LI>You must be in your seat <STRONG>at least 15 minutes</STRONG> prior to the start time to guarantee your seat. If you are not seated at this time you will lose your seat.</LI></OL>
</span>
<a name="3078"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">What if I didn't get a ticket?</div>
<span class="text">
Las Vegas Hilton Ballrooms D and E and Meeting Rooms 7-14 will be used for general admission seats. If you do not have a ticket you will be directed to this area. Should seats in the Hilton Theater remain open you may be offered the option of moving to the theater.<BR><BR>Additionally, you may want to stop by the <A href="/attendees/show_floor/areas/concierge.asp">CES Concierge Center</A> to see live feeds of the keynote addresses. This new service center is located in CES Central Plaza, directly in front of the Las Vegas Convention Center.<BR><BR>Back to <A href="/attendees/conferences/keynotes.asp">CES Keynote Address</A> descriptions.
</span>
<!-- text for main page -->
</div>
