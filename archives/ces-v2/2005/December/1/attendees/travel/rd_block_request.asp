...
function validForm(passedForm)
	{
		...
		alert("Your requested dates must be between 12/26/05 and 1/14/06.")
		passedForm.input7.focus
		return false
		}
	
		if((year=="2005")&&(month != "12")){
		alert("Your requested dates must be between 12/26/05 and 1/14/06.")
		passedForm.input7.focus
		return false
		}		
			
		if((year=="2005")&&(month == "12")&& (day < "26")){
		alert("Your requested dates must be between 12/26/05 and 1/14/06.")
		passedForm.input7.focus
		return false
		}
...
<tr>
	<td colspan="2"><span class="required">*</span> Please select an official 2006 International CES hotel. (Availability subject to change. Last updated 11/28/05.)</td>
</tr>
...
<tr>
	<td width="200" valign="top" class="text">
		...
		<input type="radio" name="hotel" value="Circus Circus">Circus Circus<br>
	...
	<td width="230" valign="top" class="text">
		<!--<input type="radio" name="hotel" value="Harrahs">Harrah's<br>-->
		<!--<input type="radio" name="hotel" value="HGVCStrip">Hilton Grand Vacations Club (LV Strip)<br>-->
	...
	<td width="160" valign="top" class="text">
...
<tr>
	<td>
		...
		<ul>
			<li>Alexis Park
			<li>AmeriSuites Las Vegas<br>
			<li>Bally's<br>
			<li>Bellagio
			<li>Caesars Palace<br>
			<li>Excalibur Hotel and Casino
			<li>Flamingo
			<li>Harrah's
			<li>Hilton Grand Vacations Club (LV Hilton)<br>
		</ul>
		</font>
	</td>
	<td valign="top">
		<font color="#999999">
		<ul>
			<li>Hilton Grand Vacations Club (LV Strip)
			<li>Las Vegas Hilton<br>
			<li>Luxor</li>
			<li>Mandalay Bay</li>
			<li>MGM Grand</li>
			<li>Mirage<br>
			<li>Monte Carlo Resort and Casino<br>
			<li>New Frontier Hotel
		</ul>
		</font> 	
	</td>
	<td valign="top">
		...
		<ul>
			...
			<li>Paris<br>
			<li>Renaissance Las Vegas<br>
			<li>Riviera Hotel and Casino</li>
			<li>Sahara Hotel</li>
			<li>Treasure Island<br>
...
<tr>
	<td colspan=2>Please indicate the first and last nights of your block and the maximum number of rooms needed on your night of highest occupancy. <span class="text_colored">Show days are January 5-8, 2006.</span><br>
	</td>
</tr>
