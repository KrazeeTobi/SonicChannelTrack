...
<title>2006 International CES:&nbsp;by Facility</title>
...
<div>
<form action="/attendees/conferences/search/session_by_facility_list.asp" method=post><table cellpadding=3 cellspacing=1 border=0><tr><td><span class='subhead'>Choose a facility from the drop-down list.</span></td></tr><tr height=7><td></td></tr><tr><td colspan=1><select class=formdata name=faevfacility><option value=0>Choose a Facility&nbsp;&nbsp;<option value="CES Central Plaza">CES Central Plaza<option value="Gold Exhibits@LVCC">Gold Exhibits@LVCC<option value="LVCC North Hall">LVCC North Hall<option value="LVCC South Hall">LVCC South Hall<option value="Sands">Sands<option value="Venetian">Venetian</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
<!--
<br>
