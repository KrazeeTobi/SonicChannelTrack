...
<html>
<head><!-- PageID 217 - generated by RedDot 5.6 - 5.6.1.9 - Y-9bp -->
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/conferences/speakers/default.asp';
...
Speaking Opportunities<br>
    ...
    <span class="nav_fourth" id="fourth_row_container60" style="display: none;">
        ...
        <span class="nav_fourth_arrow"><b>&gt;</b> &nbsp;</span><a href="/attendees/conferences/speakers/rd_speaker_form.asp">Call for Speakers Form</a>
              <script language="JavaScript">
              <!--
                  if (checkActiveNav("/attendees/conferences/speakers/rd_speaker_form.asp") && document.getElementById("fourth_row_container60")) { document.getElementById("fourth_row_container60").style.display = "";}
              //-->
              </script><br>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue217', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue217', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue217" id="leftAddedValue217" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<span class="text">
More than 130,000 industry professionals from 110 countries came to Las Vegas to see the cutting edge in consumer technology at the 2005 International CES, featuring four days of conference sessions, keynote speeches and exhibits. It is the showcase for financial analysts, venture capitalists, developers, consumer technology manufacturers, corporate buyers and retailers. A speaking position in the CES conference program is your opportunity to reach this audience. <BR><BR><STRONG>You may secure a speaking opportunity</STRONG> at the 2006 International CES for you, your company or your client by answering the 2006 International CES CALL FOR SPEAKERS. <BR><BR>The 2006 International CES will host conference sessions addressing wireless technology, home networking, mobile electronics, emerging technologies, retailing trends, e-commerce, digital content and much more. Please see the online entry form for a full list of conference subjects. <BR><BR>All submissions should include a&nbsp;75 to 100-word biography, a photo, and at least three key points you can address for each session selected. Should you be chosen to speak at the 2006 International CES, your bio and photo will be posted on CESweb.org.&nbsp;<BR><BR>E-mail <A href="mailto:CFS@CE.org">CFS@CE.org</A>&nbsp;if you have questions regarding the submission process.
</span>
