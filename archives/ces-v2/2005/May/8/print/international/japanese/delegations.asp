...
<span class="text">
国際CESでは、見本市への団体のリクルートや派遣をできる限り容易にすべく努力をしております。皆様のお取り組みを成功裡に導き、団体の一員として参加される代表の方々が旅行で得られる付加価値や奨励品にご満足いただけるようお手伝いいたします。 <BR><BR>正式な代表団リーダーになりたい方は、Elena Grant (<A href="mailto:egrant@ce.org">egrant@CE.org</A>) までEメールでお問い合わせください。
</span>
