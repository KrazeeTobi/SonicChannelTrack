...
<td height="486">
		...
		<PARAM NAME=movie VALUE="../global_includes/flash/main.swf?selectedColor=4&path=../global_includes/flash/">
		<PARAM NAME=quality VALUE=high>
		<PARAM NAME=salign VALUE=LT>
		<PARAM NAME=bgcolor VALUE=#FFFFFF>
		<EMBED src="../global_includes/flash/main.swf?selectedColor=4&path=../global_includes/flash/" quality=high salign=LT bgcolor=#FFFFFF
...
<tr>
   ...
   <span class="attendees_markets" style="display:block;margin-top:1em">ATTENDEES/PRESS</span>
   <p style="margin:1em 0;">Big news abounds as CES draws near.    
   <br><span class="homepagelink"><a href="/attendees/conferences/default.asp">Google co-founder and Michael Dell each plan to speak at CES.</a></span>
   <br><span class="homepagelink"><a href="/attendees/awards/innovations/rd_2006honorees.asp">2006 Innovations Design and Engineering Awards Honorees announced.</a></span> 
   </p>
   </td>
   ...
   <p style="margin:1em 0;">There is plenty to do in November and December! Let us help you stay organized.
   <br><span class="homepagelink"><a href="/exhibitors/resource_center/checklist.asp">See approaching deadlines, such as the CNET Best of CES entry cut-off date.</a></span>
   <br><span class="homepagelink"><a href="/exhibitors/pr/media_list/default.asp">Pre-registered media/analyst list now available!</a></span>
   </p>
   </td>
   <td width="22"></td>
</tr>
...
<tr>
   ...
   <td valign="top" style="color:#ffffff" width="272"><img src="/global_images2005/spacer.gif" width="272" height="1"><span class="attendees_markets" style="display:block;margin-top:1em">You asked. We listened.</span>
   <p style="margin:1em 0;">Introducing MyCES, the online personal planner that finds the knowledge, people, and products that most closely match your objectives.
   <br><span class="homepagelink"><a href="/MyCES">Build your personalized itinerary with MyCES.</a></span>
   </p><br><br>
   </td>

   <td width="22"></td>

   <td valign="top" style="color:#ffffff" width="272"><img src="/global_images2005/spacer.gif" width="272" height="1"><span class="attendees_markets" style="display:block;margin-top:1em">Radically increase your ROI.</span>
   <p style="margin:1em 0;">CES SmartBooth automatically finds your key leads from the MyCES community and drives them to your booth. It's lead-generation gone high-tech.    
   <br><span class="homepagelink"><a href="/SmartBooth">Let CES SmartBooth work for you.</a></span>
   </p><br><br>
   </td>
   <td width="22"></td>
</tr>
