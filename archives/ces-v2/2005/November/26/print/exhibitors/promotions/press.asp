...
<tr>
    ...
    <br><SPAN class=subhead>Growing&nbsp;Event! New Opportunities!</SPAN><BR>Be the first to grab the headlines at CES! Reach more than 625 members of the press and analysts from 23 countries, two days before CES opens. With more than 1.3 million net square feet of exhibits to cover during CES, a CES Unveiled tabletop exhibit is your chance to get critical press attention before the competition arrives in Las Vegas. <BR><BR>4-7 p.m. <IMG height=54 src="/print/images/promotions/CESUnveiled.gif" width=275 align=right>Tuesday, January 3, 2006<BR>Sands Expo and Convention Center Venetian Hotel, Bellini Ballroom<BR>Event sponsor: Verizon<BR><BR><SPAN class=subhead>Exclusivity</SPAN><BR>Debut the year's hottest products—two days before CES officially opens. 
<UL>
<LI>Exclusive demonstrations and networking opportunities. </LI>
<LI>Upscale cocktails and hors d'oeuvres. </LI>
<LI><EM>Exhibit with the <A href="/print/attendees/awards/innovations/default.asp">Innovations Design and Engineering Showcase</A> honorees!</EM></LI></UL><BR><SPAN class=subhead>Pure Quality</SPAN><BR>Only credentialed media and analysts are allowed to attend this exclusive event. <BR><BR>Meet the major players from the international trade and consumer press-print, broadcast and online-in one easy location, <EM>while the event is filmed for CES' satellite video news release</EM> for distribution to broadcast stations nationwide. Show them your products. Confirm and make additional press appointments to visit your booth during the show!<BR><BR><SPAN class=subhead>Put on on a Riveting Performance</SPAN><BR>CES Unveiled will not conflict with keynote addresses or other important events. The event will be held&nbsp;close &nbsp;to the International CES Sands Press Room, where the press will register, use the business facilities and enjoy a needed snack. <BR><BR><B>
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
<TBODY>
<TR>
<TD><STRONG>Sponsorship Investment<BR></STRONG>Call for details! <BR><BR><STRONG>Contact</STRONG> <BR>Ryan Strowger<BR>Manager, Business Development <BR>703-907-7679<BR>E-mail: <A href="mailto:rstrowger@ce.org">rstrowger@ce.org</A></TD>
<TD vAlign=top align=right><IMG src="/print/images/partners/verizon_75.gif"><BR>Event sponsor</TD></TR></TBODY></TABLE></B>
...
<tr>
    ...
    <td width="290"><span class="section_title">Silver Sponsor - $5,000; Gold Sponsors - $7,500</span></td>
</tr>
<tr>
    <td colspan=3>
    
    <br>Have your company visible to more than 150 of the top CES press months before the 2006 International CES even starts! Sponsor an exhibitor display or suite at the annual pre-CES press conference and reception in New York City and get a head start on your competition. It's a great way to start out the busy CES season and be recognized as one of the top players at the show. Extending beyond regular evening activities, we'll have extra exhibitor display time and suite visits for two hours before the press conference and reception, plus an exhibitor-only executive luncheon. <BR><BR><B>Silver Sponsorship Benefits</B> 
<UL>
...
<LI>Company press kit can be given out onsite at company tabletop </LI>
...
<P><STRONG>Gold&nbsp;Sponsorship Benefits</STRONG> </P>
<UL>
<LI>Everything Silver Sponsors receive plus the items below </LI>
...
<LI>6-foot x 3-foot banner behind tabletop</LI></UL><BR><B>Sponsorship&nbsp;Investment</B><BR>Sponsor to provide logo, press materials for kit, products and staffing for tabletop distplay.&nbsp; <BR>$5k for Sliver sponsors; $7.5k for Gold Sponsors<BR><BR><B>Contact</B><BR>Manager, Promotional Opportunities, CES<BR>Phone: (703) 907-7688<BR>E-mail: <A href="mailto:byb@ce.org">byb@ce.org</A>
    <br><img src="/print/global_images2005/spacer.gif" width="1" height="5" border="0"><br>[<a href="#">back to top</a>]   
    </td> 
</tr><tr><a name="667"></a>
    <td colspan="5">
...
<tr>
    ...
    <br><SPAN class=subhead>News Release Distribution/Electronic Press Kits</SPAN><BR><BR>The 2006 International CES Online Media Center from Virtual Press Office and Business Wire is a <I>must</I> for your media outreach strategy. Journalists and interested parties have complete real-time access to breaking exhibitor news releases via Business Wire and electronic press kits via Virtual Press Office. <BR><BR>The Virtual Press Office/Business Wire CES Online Media Center will be listed on every computer screen in the working press room. Select one of VPO/Business Wire's custom news distribution/management packages from the <A href="http://www.virtualpressoffice.com/CES/order/orderForm.jsp">online order form</A>. <BR><BR><B>Business Wire</B> provides the broadest exposure and distribution of your news releases and provides a media usage report, tracking who has accessed your news release. <BR><BR><B>Virtual Press Office</B> creates an electronic version of your press kit and puts it in front of journalists online reducing the costs associated with hard copy kits.&nbsp;<BR><BR><B>Sponsorship Investment</B><BR>News Release Distribution via Business Wire: $200+<BR>Electronic Press Kit via Virtual Press Office: $500+ <BR><BR><B>Deadlines</B><BR>For submitting files for the online press kit: January 2, 2006<BR>Press releases may be submitted for wire distribution at any time. <BR><BR><B>Contacts</B><BR>
<TABLE>
<TBODY>
<TR>
...
<LI>Recognition on CESweb.org </LI>
<LI>Mention on sponsorship page in CES press kit </LI>
<LI>Description and logo in pre-CES press emails </LI></UL><BR><B>Sponsorship&nbsp;Investment</B><BR>$20,000+ (exclusive) <BR>Sponsor to provide equipment.
    <br><img src="/print/global_images2005/spacer.gif" width="1" height="5" border="0"><br>[<a href="#">back to top</a>]   
    </td> 
</tr>
</table>
