...
<tr>
    ...
    <td class="attendees9" valign="top">With so much space to cover and only four days to do it, now's the time to get familiar with the CES layout.
    <br><a href="/attendees/show_floor/default.asp">Get to know the show.</a></span></td>
</tr>
<tr>
...
<div class="section_title">TechZones Feature New Technology at 2006 Show</div>
<span class="text">
<IMG height=27 src="/images/partners/techzone_small.gif" width=120 align=right>If any of these technology markets&nbsp;matter to your business, then&nbsp;you need to know about CES TechZones.<BR>
<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
<TBODY>
<TR>
<TD vAlign=top>
<LI>Automotive aftermarket </LI>
<LI>Bluetooth (at the Sands!) </LI>
<LI>Blu-Ray </LI>
<LI>Cardio entertainment (at the Sands!) </LI>
<LI>Connected home entertainment </LI>
<LI>Consumer VoIP (at the Sands!) </LI>
<LI>Digital car/telematics </LI>
<LI>DLNA (at the Sands!) </LI>
<LI>Home networking</LI></TD>
<TD>
<LI>Home studio </LI>
<LI>IPTV (at the Sands!) </LI>
<LI>Portable audio (at the Sands!) </LI>
<LI>Portable power (at the Sands!) </LI>
<LI>Robotics (at the Sands!) </LI>
<LI>SD cards </LI>
<LI>USB (at the Sands!) </LI>
<LI>WiMedia Ultrawideband </LI>
<LI>ZigBee (at the Sands!)</LI></TD></TR></TBODY></TABLE><BR><A href="/attendees/show_floor/techzones/default.asp">Take me to the TechZones.</A>
</span>
