    ...
    <table cellspacing="0" cellpadding="0" border="0">
     ...
     <tr>
      <td width="375" colspan="3"><img src="/global_images2005/spacer.gif" width="1" height="10"></td>
        ...
        <tr>
            <td><img src="/global_images2005/spacer.gif" width="10" height="2"><br><img src="/images/ces_photos/HP_funnel.jpg" border="0" width="90" height="72" vspace="3"></td>
            <td width="3" ><img src="/global_images2005/spacer.gif" width="10" height="1"></td>
            <td valign="top" style="color:#ffffff">Beyond CES, you can join industry peers, government leaders and prominent media members to discuss important consumer technology issues.
                <span class="homepagelink"><a href="/attendees/default.htm">See other Consumer Electronics Association (CEA) events.</a></span></td>
        </tr>
    </table>
   </td>
