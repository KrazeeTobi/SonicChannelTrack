...
<span class="text">
Need to get to the International CES? Need to get around Vegas while attending the International CES? Then&nbsp;make sure to check back in the summertime to learn the best ways to get the best airfare and car rental rates.
</span>
...
<LI>Skycaps </LI>
<LI>SpeedCheck kiosks located at the Las Vegas Convention and Visitors Authority and throughout McCarran International Airport (SpeedCheck is available only for carry-on luggage)<BR><BR></LI></UL></LI>
