  ...
  <tr>
   ...
   <td width="375" valign="top"><img src="/global_images2005/spacer.gif" width="10" height="18"><br>
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td><img src="/global_images2005/spacer.gif" width="10" height="2"><br><img src="/images/ces_photos/HP_Carly_Gwyn_Mini.jpg" border="0" width="90" height="70" vspace="3"></td>
            <td width="3" ><img src="/global_images2005/spacer.gif" width="10" height="1"></td>
            <td  valign="top" style="color:#ffffff">What you waiting for? Maybe Gwen Stefani's new camera created by HP, due out this spring.
                <span class="homepagelink"><a href="/attendees/default.htm">See more show highlights.</a></span></td>
        </tr>
     <tr>
      <td width="375" colspan="3"><img src="/global_images2005/spacer.gif" width="1" height="10"></td>
     </tr>
        <tr>
            <td><img src="/global_images2005/spacer.gif" width="10" height="2"><br><img src="/images/ces_photos/Moto_Snowboard_mini.jpg" border="0" width="90" height="70" vspace="3"></td>
            <td width="3" ><img src="/global_images2005/spacer.gif" width="10" height="1"></td>
            <td valign="top" style="color:#ffffff">Catch some serious snowboard action at the CES Central Plaza, just outside the Las Vegas Convention Center.
                <span class="homepagelink"><a href="/attendees/show_floor/areas/default.asp">Check out all exhibit areas.</a></span></td>
        </tr>
    </table>
   </td>
