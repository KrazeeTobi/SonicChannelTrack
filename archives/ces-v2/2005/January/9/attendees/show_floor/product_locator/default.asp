...
<title>2005 International CES:&nbsp;Product Locator</title>
...
Product Locator<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container171")) { document.getElementById("fourth_row_container171").style.display = "";}
        //-->
    </script>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue200', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue200', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue200" id="leftAddedValue200" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Product Locator<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
<form name="NewProdCatSearch" action="/attendees/show_floor/product_locator/search_results.asp" method="GET">
<table width="100%" cellspacing="0" cellpadding="0" border="0">
<tr>
