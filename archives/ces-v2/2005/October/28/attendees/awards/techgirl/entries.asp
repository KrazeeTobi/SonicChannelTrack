...
<html>
<head><!-- PageID 2909 - generated by RedDot 5.6 - 5.6.1.9 - Y-9bp -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2006 International CES:&nbsp;2006 Call for Entries</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/awards/techgirl/entries.asp';
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue2909', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue2909', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue2909" id="leftAddedValue2909" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<TD><SPAN class=text_colored>END</SPAN></TD></TR></TBODY></TABLE><BR><SPAN class=subhead><BR>BEFORE YOU BEGIN:</SPAN><BR>For your reference, the steps required to complete the submission process are detailed below. Please review them and gather the necessary data before beginning.<BR><BR><SPAN class=subhead>Please be advised that you will NOT have the ability to revisit or edit a previously submitted entry.<BR></SPAN><BR><STRONG>Steps 1 &amp; 2: Manufacturer Information</STRONG> 
<UL>
<LI>Manufacturing Company (must be a 2006 International CES exhibitor) name and basic contact information (address, phone, e-mail, etc.)</LI></UL><BR><STRONG>Step 3: Product Information</STRONG> 
<UL>
<LI>Product category: Choose from Audio, Computers, Digital Imaging, Laptop Bags,&nbsp;Mobile/Automotive Electronics, Portable Audio, Television, or Wireless </LI>
...
<UL>
<LI>Must be&nbsp;two different views of the product (.GIF or&nbsp;.JPG&nbsp;only) </LI>
...
<LI>Describe the product's unique and novel features and functions. (limit 250 words) </LI>
...
<UL>
<LI>Provide a synopsis of your product, including the name and model number. (limit 30 words)<BR></LI></UL><BR><BUTTON onclick="location='http://www.cesweb.org/attendees/awards/techgirl/showcase/techgirl_exhibitor_select.asp'">Enter now</BUTTON>
</span>
