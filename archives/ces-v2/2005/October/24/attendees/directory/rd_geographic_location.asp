...
<html>
<head><!-- PageID 307 - generated by RedDot 5.6 - 5.6.1.9 - Y-9bp -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2006 International CES:&nbsp;by Geographic Area</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/directory/rd_geographic_location.asp';
...
<a href="/attendees/directory/rd_product_category.asp">by Product Category</a><br>
    ...
    <img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
               <script language="JavaScript">
              <!--
                  if (checkActiveNav("/attendees/directory/rd_product_category.asp") && document.getElementById("fourth_row_container179")) { document.getElementById("fourth_row_container179").style.display = "";}
              //-->
...
<a href="/attendees/directory/rd_brand_name.asp">by Brand Name</a><br>
    ...
    <img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
               <script language="JavaScript">
              <!--
                  if (checkActiveNav("/attendees/directory/rd_brand_name.asp") && document.getElementById("fourth_row_container184")) { document.getElementById("fourth_row_container184").style.display = "";}
              //-->
              </script> <img src="/global_images2005/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
<a href="/attendees/directory/rd_pavilion.asp">by TechZone</a><br>
    ...
    <img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
               <script language="JavaScript">
              <!--
                  if (checkActiveNav("/attendees/directory/rd_pavilion.asp") && document.getElementById("fourth_row_container180")) { document.getElementById("fourth_row_container180").style.display = "";}
              //-->
              </script> <img src="/global_images2005/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
by Geographic Area<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container181")) { document.getElementById("fourth_row_container181").style.display = "";}
        //-->
    </script>
    ...
    <img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
               <script language="JavaScript">
              <!--
                  if (checkActiveNav("/attendees/directory/rd_geographic_location.asp") && document.getElementById("fourth_row_container181")) { document.getElementById("fourth_row_container181").style.display = "";}
              //-->
              </script> <img src="/global_images2005/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
<a href="/attendees/directory/rd_export_nation.asp">by Export Region</a><br>
    ...
    <img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
               <script language="JavaScript">
              <!--
                  if (checkActiveNav("/attendees/directory/rd_export_nation.asp") && document.getElementById("fourth_row_container183")) { document.getElementById("fourth_row_container183").style.display = "";}
              //-->
              </script> <img src="/global_images2005/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
<a href="/attendees/directory/rd_publicly_traded.asp">by Financial Exchange</a><br>
    ...
    <img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
               <script language="JavaScript">
              <!--
                  if (checkActiveNav("/attendees/directory/rd_publicly_traded.asp") && document.getElementById("fourth_row_container182")) { document.getElementById("fourth_row_container182").style.display = "";}
              //-->
              </script> 
        <img src="/global_images2005/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue307', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue307', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue307" id="leftAddedValue307" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">2006 International CES Exhibitor Directory<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
<br>
<form name="searchByGeographicLocation" action="/attendees/directory/rd_geographic_location_search_results.asp?page=1" method="POST">

<table width="100%" cellpadding="0" cellspacing="0" border="0">

<tr>
	<td><img src="/global_images2005/spacer.gif" height="1" width="160" border="0"></td>
	<td><img src="/global_images2005/spacer.gif" height="1" width="430" border="0"></td>	
</tr>
...
<tr>
	<td><img src="/global_images2005/spacer.gif" height="8" width="1" border="0"></td>
	<td><img src="/global_images2005/spacer.gif" height="8" width="1" border="0"></td>	
</tr>
...
<tr>
	<td><img src="/global_images2005/spacer.gif" height="12" width="1" border="0"></td>
	<td><img src="/global_images2005/spacer.gif" height="12" width="1" border="0"></td>	
</tr>
...
<td class="rowlabel">Show Location&nbsp;&nbsp;</td>
	<td><select multiple name="venueArea" class="formData" size="5">
	<option value="unselected" selected>**********************All**********************</option>
			<option value="91">North Hall</option>
		<option value="93">Central Hall</option>
		<option value="86">South Hall 1</option>
		<option value="87">South Hall 2</option>
		<option value="88">South Hall 3</option>
		<option value="89">South Hall 4</option>
