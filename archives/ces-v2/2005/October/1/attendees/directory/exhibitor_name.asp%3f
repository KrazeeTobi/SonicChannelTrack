...
<a href="exhibitor_name.asp?getall=yes" target="new">Download an Excel report</a> containing the full list of 2006 International CES exhibitors (name and booth information only).
<br>
...
<div class="section_title">Browse the 2006 International CES Exhibitor Directory</div>
	...
	<br>
		...
		<tr>
			...
			<td colspan="2">
			<select multiple name="venueArea" class="formData" size="5">
				<option value="unselected" selected>
				**********************All**********************
				</option>
						<option value="83">Alexis Park</option>
		<option value="95">CES Central Plaza</option>
		<option value="97">CES North Plaza</option>
		<option value="96">CES South Plaza</option>
		<option value="100">Hilton</option>
		<option value="101">Hilton Suites</option>
		<option value="93">LVCC Central</option>
		<option value="92">LVCC Mtg Rm</option>
		<option value="91">LVCC North 1-4</option>
		<option value="89">LVCC Outdoor</option>
		<option value="86">LVCC South 1</option>
		<option value="87">LVCC South 2</option>
		<option value="88">LVCC South 3</option>
		<option value="89">LVCC South 4</option>
		<option value="103">Renaissance</option>
		<option value="98">Sands/Innovations Plus</option>
		<option value="104">Venetian</option>
