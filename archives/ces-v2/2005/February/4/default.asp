  ...
  <tr>
   ...
   <td width="375" valign="top"><img src="/global_images2005/spacer.gif" width="10" height="18"><br>
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
            <td><img src="/global_images2005/spacer.gif" width="10" height="2"><br><img src="/images/ces_photos/Randomguymini.jpg" border="0" width="90" height="70" vspace="3"></td>
            <td width="3" ><img src="/global_images2005/spacer.gif" width="10" height="1"></td>
            <td  valign="top" style="color:#ffffff">The 2005 show proves that what happens in Vegas doesn't stay in Vegas. In fact, what happened here over four days has positive, global impact.
                <span class="homepagelink"><a href="/attendees/default.htm">See more 2005 International CES highlights.</a></span></td>
        </tr>
     <tr>
      <td width="375" colspan="3"><img src="/global_images2005/spacer.gif" width="1" height="10"></td>
     </tr>
        <tr>
            <td><img src="/global_images2005/spacer.gif" width="10" height="2"><br><img src="/images/ces_photos/randomproduct.jpg" border="0" width="90" height="70" vspace="3"></td>
            <td width="3" ><img src="/global_images2005/spacer.gif" width="10" height="1"></td>
            <td valign="top" style="color:#ffffff">Thousands of new product introductions at the 2005 International CES exemplify the current momentum of the consumer electronics industry. 
                <span class="homepagelink"><a href="/press/news/rd_release_list.asp">Read the show wrap-up release.</a></span></td>
        </tr>
    </table>
   </td>
