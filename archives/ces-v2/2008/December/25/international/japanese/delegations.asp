...
<head><!-- PageID 1172 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: 代表団プログラム</title>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        <H4>代表団リーダーにとって重要な日程</H4>
<UL>
<LI><STRONG>11月17日（月）<BR></STRONG>2009年の代表団リーダーの登録期限終了</LI>
<LI><STRONG>12月1日（月）<BR></STRONG>宿泊料無料のホテルルームを申し込む（50名以上の代表団メンバー、または15名以上の政府関係者を引率する代表団リーダーに限定）</LI>
<LI><STRONG>12月1日（月）</STRONG><BR>郵送によるIDバッチ申し込み期限終了</LI>
<LI><STRONG>12月12日（金）</STRONG><BR>代表団リーダーディナー予約期限終了</LI>
<LI><STRONG>12月12日（金）<BR></STRONG>代表団リーダーはIDバッチの受取り時間を予約</LI>
<LI><STRONG>1月2日（金）<BR></STRONG>事前登録は米東部標準時間午後5時（太平洋標準時午後２時）に終了</LI>
<LI><STRONG>1月8日（木）</STRONG><BR>インターナショナル・レセプション - 海外からの参加者全員を招待</LI>
<LI><STRONG>1月10日（土）</STRONG><BR>代表団リーダーのディナー<BR></LI></UL>
        <br /><br />
    </div>
</div>
...
<P>グループの代表者、或いは業界団体にて、ＣＥＳ(Consumer Electronics Show)参加へご興味のある方は、<BR>どうぞお気軽に当事務局まで<A href="delegations@ce.org" target=_blank>お問合せください</A>。<BR></P>
