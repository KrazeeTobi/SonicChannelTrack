...
<head><!-- PageID 590 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: In-Vehicle Technology</title>
...
<body>
<script src="http://feeds.feedburner.com/MycesNewsInvehicleTechnology?format=sigpro" type="text/javascript" ></script><noscript><p>Subscribe to RSS headline updates from: <a href="http://feeds.feedburner.com/MycesNewsInvehicleTechnology"></a><br/>Powered by FeedBurner</p> </noscript>
</body>
</html>
...
<IMG height=100 src="/images/content/invehicle_icons_sm.gif" width=100 align=right>Even in economic uncertainty, Americans tend to embrace new products that&nbsp;add convenience and entertainment to their lives.&nbsp;With products like in-car phones, HD and satellite radio, mobile video&nbsp;and GPS systems, the mobile electronics industry&nbsp;addresses&nbsp;those desires. <A href="/register">Register today for the 2009 International CES</A> to learn, network and investigate new technology in the&nbsp;in-vehicle technology industry. <BR><BR>To find in-car electronics on the CES show floor, look for the icon (hint: Las Vegas Convention Center, North Hall).<BR><BR><EM><SPAN class=smallText>Source: Digital America, a CEA publication.</SPAN></EM>
...
<div class="sub-content-header">In-vehicle Technology Sessions</div>
<br />
...
<LI class=text>Progress of Vehicle Infrastructure Integration (VII) Efforts </LI>
<LI class=text>Vehicle Communications </LI>
<LI class=text>How Transportation Technology Can Limit the Impact of Future Climate Change </LI>
<LI class=text>Inventory Management: How To Stop Stashing Cash in the Back Room </LI>
<LI class=text>Affordable Advertising: Breaking the Mold Without Breaking the Bank </LI>
<LI class=text>Full Speed Ahead: Making a Splash in the Marine 12-Volt Market </LI>
<LI class=text>Going Beyond the Dashboard: Business Opportunities in OEM Integration </LI>
<LI class=text>Connect2Car: The Automobile’s Convergence with Consumer Electronics</LI></UL>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />
...
<LI class=text>LVCC North Hall</LI></UL>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />
...
<UL class=text>
<LI class=text>Wiring </LI>
<LI class=text>GPS technology </LI>
<LI class=text>Mobile video </LI>
<LI class=text>Security </LI>
<LI class=text>Appearance products </LI>
<LI class=text>Aftermarket accessories </LI>
<LI class=text>Head units </LI>
<LI class=text>Sub-woofers </LI>
<LI class=text>Speakers </LI>
<LI class=text>Wireless technology for vehicles</LI></UL><BR><A href="/exhibitorDirectory/default.asp">Check out the 2009 International CES Exhibitor Directory.</A>    
                    </div>
                    <div id="inner-content-right">
                        <br />
