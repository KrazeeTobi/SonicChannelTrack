...
<head><!-- PageID 2515 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: Live Discussion by CES Operations</title>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/hotelTravel/default.asp" class="footer">Hotel/Travel</a>&nbsp;&gt;&nbsp;Live Discussion by CES Operations</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/hotelTravel/CESOps-discussion1.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>Live Discussion by CES Operations</h1>
                                                               
                        

<iframe src='http://www.coveritlive.com/index2.php/option=com_altcaster/task=viewaltcast/altcast_code=8d77acf801/height=460/width=540/scrolling=no' scrolling='no' frameBorder='0' height='460' width='540'></iframe>    
                    </div>
                    <div id="inner-content-right">
                        <br />
