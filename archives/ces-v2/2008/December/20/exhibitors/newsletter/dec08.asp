...
<head><!-- PageID 2543 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: December 2008</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li ><a href="/exhibitors/newsletter/nov08.asp">November 2008</a></li>
        
            <li ><a href="/exhibitors/newsletter/oct08.asp">October 2008</a></li>
        
            <li ><a href="/exhibitors/newsletter/sep08.asp">September 2008</a></li>
...
<tr>
    ...
    <!-- article start -->
    <p><strong>The 2009 International CES: Final Checklist</strong><br> by Dan Cole</p>
    <p>With all of the hectic preparations surrounding the upcoming 2009 International CES and the current economic uncertainty, I believe most of us welcomed the brief respite that is the Thanksgiving holiday. As much as your schedule and business obligations will allow, I hope&nbsp; you enjoyed&nbsp; this time with family and friends. Turned off the news and enjoyed a good football game. Indulged in some turkey, dressing and pumpkin pie, shared amusing stories around the dinner table.&nbsp; Whatever you did, I hope you took this opportunity to rest, recharge and refocus. <BR><BR>The next time you hear from me, the 2009 International CES will be gearing up. Every year after returning from Las Vegas, my team conducts a post-show debrief. Only several days removed from the fervor of the show, I remind them that “before you know it, we will be boarding planes to head back out to CES again.” For all of us, that time is now. If you haven't tied up your loose ends, it's not too late.&nbsp; Here is a “final checklist” to make sure nothing slips through the cracks.<BR><BR>Make sure to finalize your directory listing. The main print directory has been finalized and has been shipped off to print, but there is still time to make adjustments to the online directory through CESweb.org.&nbsp; We also produce a printed directory addendum which is distributed onsite and captures last minute changes and additions to the exhibitor directory. And don't forget to maximize your exposure in over 1.4 million unique ways with an advanced listing package through the CES Smartbooth web portal. <BR><BR>Get those service orders in! They say the early bird gets the worm and at CES, they also save some money as well.&nbsp; By December 15th, most service orders must be completed to avoid late charges including booth carpet, hardwall booth packages, GES/GEM system rentals and I &amp; D labor.&nbsp; Others like electrical and hanging signs are due as early as December 8th.</p>
    <!-- article end -->
    <p>Continued on <a href="/exhibitors/newsletter/dec08pro.asp">next page</a>.<br></p>
    </span>
    </td>
</tr>
</table>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;December 2008</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/newsletter/dec08.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<div align="center">
    ...
    [ <a href="/exhibitors/newsletter/dec08pro.asp">Promotions</a> ]

    [ <a href="/exhibitors/newsletter/dec08ev.asp">Events</a> ]

    [ <a href="/exhibitors/newsletter/dec08ops.asp">Operations</a> ]
...
<div class="sub-content-header">Last Chance to Get Your Best Customers to CES for FREE </div>
<br />

<IMG height=168 hspace=10 src="/images/content/EX_invite.jpg" width=130 align=right vspace=10>You'll be at CES this January, but the question is: Will your buyers and other key customers be there, too? <BR><BR>Make sure they are – and help them duck the registration fee – by sending them official <A href="/exhibitors/sponsorships/freeOpps.asp" target=_blank>2009 CES Exhibitor Invitations</A>. This <A href="/exhibitors/sponsorships/freeOpps.asp" target=_blank>invitation</A>, which contains a special priority code, provides your guest with FREE advance registration to the International CES up until December 15, 2008. Budget savings have never been more important. Free registration could be the deciding factor for your customers to register and attend CES. <A href="/exhibitors/sponsorships/freeOpps.asp" target=_blank>Download this invitation</A> now or order printed invites (free of charge) today.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="2563"></a>

<div class="sub-content-header">CES Hotel Rates Starting as Low as $116 Per Night</div>
<br />

<IMG height=206 hspace=10 src="/images/photos/Vegas_200.jpg" width=200 align=right vspace=5>Pre-registration for the 2009 CES remains strong, and we are encouraging&nbsp;everyone, including exhibitors,&nbsp;to reserve hotel rooms as soon as possible.<BR><BR>CEA continues to work with the Las Vegas hotels to ensure our attendees receive the best rates available. Several CES partner hotels have recently reduced room prices. Visit <A href="/hotelTravel/hotel.asp" target=_blank>CESweb.org/hotel</A> to take advantage of many rate reductions and special offers at hotels on the Strip and throughout the city. <BR><BR>Rates available until December 1 or until rooms sell out, so book today! Peak nights typically cover Jan 7-10, and shoulder nights typically cover Jan 4-6 and 11-12; check individual hotel reservation sites for exact dates. 
<UL class=text>
<LI class=text><STRONG>Alexis Park</STRONG>: peak reduced from $169 to $129 </LI>
<LI class=text><STRONG>Circus Cir</STRONG>cus: peak reduced from $126 to $116 </LI>
<LI class=text><STRONG>Excalibur</STRONG>: peak reduced from $219 to $141 for standard rooms; $239 to $161 for renovated rooms </LI>
<LI class=text><STRONG>Hilton Grand Vacations Club at LV Hilton and on LV Strip</STRONG>: one free Continental breakfast certificate per night for one-bedroom suites </LI>
<LI class=text><STRONG>Luxor</STRONG>: peak reduced from $235 to $185 </LI>
<LI class=text><STRONG>Mandalay Bay</STRONG>: January 8 and 9 is $314; January 7 &amp; 10 reduced from $314 to $229; January 11 reduced from $314 to $146 </LI>
<LI class=text><STRONG>Monte Carlo</STRONG>: peak reduced from $275 to $220 on January 8 and 9; $190 on January 7 and 10 </LI>
<LI class=text><STRONG>Palm/Palms Place</STRONG>: free fitness club access at Palms Spa – $20 value – by showing room key and saying “I'm with CES” </LI>
<LI class=text><STRONG>Planet Hollywood</STRONG>: peak reduced from $319 to $289; plus $20 off purchase of $100 or more at Koi Restaurant and Lounge </LI>
<LI class=text><STRONG>Tropicana</STRONG>: peak reduced from $149 to $129 </LI>
<LI class=text><STRONG>Trump International Hotel &amp; Tower</STRONG>: one bedroom suites reduced from $499 to $340 on peak and $250 off peak; Studio sites reduced from $365 to $240 on peak and $150 off-peak</LI></UL>
<P class=text>All rate reductions listed above are retroactive for previous CES bookings.The following hotels also still have availability during CES. Visit <A href="/hotelTravel/hotel.asp" target=_blank>CESweb.org/hotel</A> for rates and booking information:<BR>&nbsp; </P>
<P class=text>
<TABLE cellSpacing=1 cellPadding=1 width="75%" border=0>
<TBODY>
<TR>
<TD>Bally's<BR>Bellagio<BR>Caesars Palace<BR>Encore at Wynn<BR>Fairfield Inn &amp; Suites Las Vegas South&nbsp;<BR>Hard Rock&nbsp;<BR>Holiday Inn Express South<BR>Hooter's Casino Hotel<BR>Hyatt Place&nbsp;&nbsp;<BR>Las Vegas Hilton<BR>Mandalay Bay</TD>
<TD>Mirage<BR>MGM Grand&nbsp;<BR>New York New York&nbsp;<BR>Paris&nbsp;<BR>Platinum Hotel &amp; Spa<BR>Residence Inn Las Vegas South&nbsp;<BR>Rio&nbsp;<BR>Signature at MGM Grand&nbsp;<BR>Treasure Island&nbsp;<BR>The Venetian&nbsp;<BR>Westin Casuarina </TD></TR></TBODY></TABLE></P>
...
<div class="sub-content-header">Exhibitor Staff Guides Now Available!</div>
<br />

Are you putting together a 2009 International CES on-site staff guide for your company?&nbsp; If so, we just made it a lot easier for you to create a guide for your colleagues to use on-site. Please visit our <A href="/exhibitors/resources/A92402F9C8E7404CB0D8151FA0E3B99E.htm" target=_blank>web-site</A> to choose from an array of helpful documents – from badge holder pickup information to a list of suggested restaurants – or simply print out a <A href="/exhibitors/resources/A92402F9C8E7404CB0D8151FA0E3B99E.htm" target=_blank>complete staff guide</A> that we have put together for you at the top of the page. You may want to include a personalized cover, your booth number and company contact information.&nbsp; Otherwise, we have taken care of the rest for you.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="2596"></a>

<div class="sub-content-header">CES Mobile Goes Live - December 8</div>
<br />

CES Mobile is a new mobile phone-based tool that allows exhibitors and attendees to search the online exhibitor directory, view exhibitor listings, build a “Mobile Exhibitor Plan,” find sessions, book a taxi or find a local restaurant. If you have a Windows Mobile&reg;, Palm&reg;, Blackberry&reg;, iPhone&reg;, Symbian&reg; or Java/J2ME handheld device, you can access the tool by simply texting* CESMobile to 41411 to download the application. iPhone users can access the application in their browser after texting CESMobile to 41411.<BR><BR>Navigating CES has never been easier!<BR><BR>*Standard text message and data rates apply.<BR>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="2561"></a>

<div class="sub-content-header">Celebrities at the 2009 International CES</div>
<br />

<IMG height=175 hspace=5 src="/images/photos/brianwilliams1.jpg" width=200 align=right vspace=5>NBC Universal will again be the Official Broadcast Partner of the International CES, broadcasting live from the show floor. They will be on hand with select NBC Universal broadcast and cable entities such as: The Today Show, the NBC Evening News with Brian Williams, Access Hollywood and financial expert Maria Bartiromo. <BR><BR>Sony Pictures Television (SPT) will also return to the 2009 International CES show floor in full force, showcasing its wide variety of content across all platforms. In celebration of the 25th anniversary of Jeopardy!, SPT will film daily episodes of Celebrity Jeopardy! on a specially built set on the CES show floor. They will record 11 Jeopardy! episodes throughout CES, on a 16,000-square-foot stage that will become the new set for the game show, in front of an audience of 600. Dr. Oz, a frequent medical guest star on The Oprah Winfrey Show, will also appear in the SPT booth, promoting his new syndicated talk show.<BR><BR>Do you have celebrities making appearances at your booth? Are you planning on live musical performances? Let us know ASAP by e-mailing <A href="mailto:acarney@CE.org" target=_blank>acarney@CE.org</A> so we can post your information on CESweb.org, offering you additional company and booth exposure at no additional cost.<BR>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="2560"></a>

<div class="sub-content-header">Go Global</div>
<br />

<IMG height=159 hspace=10 src="/images/content/USCS.jpg" width=150 align=right vspace=5>Are you a U.S. based exhibitor interested in exporting?&nbsp; <BR><BR>The U.S. Department of Commerce’s Commercial Service, in cooperation with CEA, is offering meetings between U.S. exhibitors and consumer electronics industry specialists from U.S. embassies around the world who will be attending the 2009 International CES. If you would like help finding trade partners and succeeding in international markets, then sign up for the <A href="/docs/GMIP_for_CES_2009_w_Detailed_Information.pdf" target=_blank>U.S. Commercial Service’s Global Market Insight Program.</A> [link to GMIP pdf attached]
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="2559"></a>

<div class="sub-content-header">World’s Coolest Tradeshow is Working to Be the Greenest</div>
<br />

<IMG height=46 hspace=10 src="/images/content/planetmetrics_logo.jpg" width=150 align=right vspace=10>For more than 40 years, CES has been the place to go for cutting-edge consumer technology. It is, after all, the Consumer Electronics Show. But with such increasing importance being placed on the impact technology has on the environment, the E in CES could just as well stand for “eco-friendly.”<BR><BR>With the help of important partners, including GES, Aramark, the Las Vegas Convention Center (LVCC) and the Sands Expo and Convention Center, CES exhibitors now have more opportunities than ever to recycle while conducting a year's worth of business in one prime, environmentally friendly location. CES is also working with Planet Metrics to calculate it's carbon footprint and investigate opportunities for reforestation and other environmental projects in Nevada.<BR><BR>GES offers several eco-friendly booth packages to help make small responsible changes that amount to a big difference. Check out our <A href="http://www.cesweb.org/docs/GES_Sustainable_Exhibit_Solutions_Order_Form.pdf" target=_blank>Sustainable Exhibit Solutions Order Form</A>, including:<BR>
<UL class=text>
<LI class=text>Insert panels which are <A href="http://www.fscus.org/" target=_blank>Forest Stewardship Council (FSC)</A> certified and are formaldehyde-free</LI>
<LI class=text>Shelves and counters made from formaldehyde-free particle board</LI>
<LI class=text>Eco-friendly carpet</LI></LI></UL><A href="/cesgreening.asp" target=_blank>See all the efforts to minimize CES' environmental footprint.</A>
