...
<head><!-- PageID 361 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: Sponsorships</title>
...
<br /><br />Let us help you identify what CES sponsorship opportunities ensure you meet - and exceed - your company's marketing goals. <A href="/exhibitors/sponsorships/contactRep.asp">Contact a CES promotions representative today</A>.
</div>
...
<UL class=text>
<LI class=text>CEA Mobile Division Reception </LI>
<LI class=text>CEA Digital Imaging Division Reception </LI>
<LI class=text>CEA Wireless Division Reception</LI></UL><BR><STRONG>Sponsorship Benefits</STRONG> 
<UL class=text>
<LI class=text>Product literature distribution in a highly trafficked area </LI>
<LI class=text>Logo recognition in the official CES Directory, on-site, on the reception invitation and on CESweb.org </LI>
...
<UL class=text>
<LI class=text>Minimum of 30 e-mail stations, located in the LVCC Grand Lobby and South Lobby </LI>
<LI class=text>Prominent, eye-catching signs </LI>
<LI class=text>Directional signs lead to the e-mail stations from all venues feature your logo </LI>
...
<UL class=text>
<LI class=text>More than 30 interactive floor plan/product locator stations, located in the LVCC Grand Lobby, North Lobby and two South Lobbies and Sands Expo and Convention Center </LI>
<LI class=text>Sponsor signs, including branded directional signs leading to the kiosks from all venues</LI>
<LI class=text>Sponsor's website or International CES booth message as the homepage</STRONG></LI></UL><BR><B>Sponsorship Investment</B><BR>Average fee: $55,000. Pricing varies, per quantities of kiosks placed.<BR>Price includes Internet, electrical, freestanding structures and graphics.<BR><BR><B>Contact</B><BR>Manager, Promotional Opportunities, International CES<BR>Phone: 703-907-4324 <BR>E-mail: <A href="mailto:byb@CE.org">byb@CE.org</A></TD>
<TD width=10>&nbsp;</TD>
...
<UL class=text>
<LI class=text>Telephones and fax machines </LI>
...
<LI class=text>Complimentary refreshments from 2-4 p.m.</LI></UL><BR>The extremely popular International Reception, held the first night of the show, is included in this sponsorship package. The event averages an attendance of 500 each year. Invitations are mailed in advance and also are distributed on-site in the International Registration area and the ICC.<BR><BR>This promotional opportunity extends far beyond the walls of the centers and reception room. Get months of exposure when you receive: 
<UL class=text>
<LI class=text>Recognition in all pre-show and on-site materials referencing the ICCs </LI>
<LI class=text>Signs and banners in the ICCs </LI>
<LI class=text>The opportunity to display literature in the ICCs </LI>
<LI class=text>Your homepage up on the Internet stations in the ICCs </LI>
<LI class=text>Electronic direct mail to all pre-registered international attendees (20,000) with your logo and information included </LI>
<LI class=text>Your logo on the invitation for the international reception. Invitations are distributed to international attendees </LI>
<LI class=text>Reception sponsor recognition on CESweb.org </LI>
<LI class=text>Name and logo on reception invitation </LI>
<LI class=text>Banners and signs at reception and on directions to the reception </LI>
<LI class=text>Opportunities to distribute and display literature within the reception room </LI>
<LI class=text>Recognition during remarks by CEA at reception</LI></UL><BR><STRONG>A great thing about this promotional opportunity:<BR></STRONG>Reaching CE professionals from 140 countries without leaving the country.<BR><BR>
<TABLE>
<TBODY>
<TR>
...
<LI class=text>Your logo on the invitation for the international reception. Invitations are distributed to international attendees </LI>
<LI class=text>Reception sponsor recognition on CESweb.org </LI>
<LI class=text>Name and logo on reception invitation Banners and signage at reception and on directions to the reception </LI>
<LI class=text>Opportunities to distribute and display literature within the reception room </LI>
...
<UL class=text>
<LI class=text></STRONG>Recognition in dinner welcome remarks made by Gary Shapiro, president and CEO of CEA</STRONG> </STRONG></STRONG></STRONG></STRONG></LI></STRONG>
<LI class=text>Logo on 1,500 dinner invitations </LI>
<LI class=text>Logo on the dinner program </LI>
<LI class=text>Logo recognition on title presentation slide for the multimedia presentation shown before the dinner </LI>
<LI class=text>Logo recognition on signage at the dinner and directional signage for the dinner </LI>
<LI class=text>Ten complimentary dinner registrations, including one seat for an appropriate company executive at an honoree table </LI>
<LI class=text>Opportunity to purchase up to 10 additional dinner tickets at $250 each </LI>
<LI class=text>At sponsor option and cost, branding opportunity to place executive gift on dinner tables (gift subject to current Federal gift limits and CEA approval)</LI></UL><BR><STRONG>LIT Dinner Reception - $10,000</STRONG> 
<UL class=text>
<LI class=text>Logo and acknowledgement in the dinner program </LI>
<LI class=text>Logo and acknowledgement on invitation </LI>
...
<LI class=text>Logo placement in dinner program </LI>
<LI class=text>Logo placement on cocktail napkins during reception<BR></LI></UL><BR><STRONG>LIT Dinner Wine - $10,000</STRONG> 
<UL class=text>
<LI class=text>Logo and acknowledgement in the dinner program </LI>
<LI class=text>Logo and acknowledgement on invitation </LI>
<LI class=text>Recognition in dinner welcome remarks made by Gary Shapiro, president and CEO of CEA </LI>
<LI class=text>Five complimentary dinner registrations, including one seat for an appropriate company executive at an honoree table </LI>
<LI class=text>Logo on pre-event promotional pieces, including the invitation</LI></UL><BR><STRONG>LIT Dinner Dessert Reception - $10,000</STRONG> 
<UL class=text>
<LI class=text>Logo and acknowledgement in the dinner program </LI>
<LI class=text>Logo and acknowledgement on invitation </LI>
<LI class=text>Recognition in dinner welcome remarks made by Gary Shapiro, president and CEO of CEA </LI>
<LI class=text>Five complimentary dinner registrations, including one seat for an appropriate company executive at an honoree table </LI>
<LI class=text>Logo on pre-event promotional pieces, including the invitation </LI>
<LI class=text>Logo placement on cocktail napkins during reception<BR></LI></UL><STRONG><BR>A great thing about these promotional opportunities: <BR></STRONG>The unprecedented chance to brand your company to the most elite and influential CE and government leaders. <BR><BR><STRONG>Investment Options</STRONG><BR>Call for details! <BR><BR><STRONG>Contact</STRONG><BR>Manager, CES Promotional Opportunities<BR>Phone: 703-907-4324 <BR>E-mail: <A href="mailto:byb@CE.org">byb@CE.org</A>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<LI class=text>Sponsor signs on both sides of each car (approximately 50 cars) </LI>
