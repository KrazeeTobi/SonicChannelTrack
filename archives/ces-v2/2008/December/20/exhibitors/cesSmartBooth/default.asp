...
<head><!-- PageID 362 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: CES SmartBooth</title>
...
<UL class=text>
<LI class=text>Complete your company information for the online MyCES directory and the printed Official International CES <EM>Show Directory</EM>. </LI>
<LI class=text>Be found online by attendees leading up to the show and buyerssearching the Internet. </LI>
<LI class=text>Detect how many buyers of your products and services have registered for CES.&nbsp; </LI>
<LI class=text>Attract the right attendees your booth and schedule face-time with your top prospects. </LI></UL><BR>In addition, you can select other <A href="/docs/MyCESPromo_Opp_Flyer.pdf" target=_blank>SmartBooth tools to further increase brand awareness with an enhanced Smartbooth Marketing Package (pdf)</A>. Contact&nbsp;<A href="mailto: tim.rader@bdmetrics.com" target=_blank>Tim&nbsp;Rader </A>at 410-402-1056.<BR><BR>As 2009 International CES approaches, SmartBooth automatically: 
<UL class=text>
<LI class=text>Identifies your best prospects from the list of pre-registered attendees </LI>
<LI class=text>Adds your company to attendees' "Exhibitors to Visit" list </LI>
<LI class=text>Highlights your booth on attendees' Personal Walking Maps </LI>
<LI class=text>Delivers your custom message, invitation or announcements to highly qualified leads</LI></UL>
...
<UL class=text>
<LI class=text>Your company logo added to your online listing. </LI>
<LI class=text>Unlimited online company information text in addition to the 300 character print directory company description. </LI>
<LI class=text>Highlight your new produts and company announcements with online press releases. </LI>
<LI class=text>Unlimited product listings.</LI></UL><BR>Order an Enhanced Listing when you create your profile in your MyCES Exhibitor Portal. <BR><BR><A href="https://myces.bdmetrics.com/exhibitorportal" target=_blank>Login to your free MyCES Exhibitor Portal</A>* today to take advantage of these benefits and more. The sooner you update your information, the sooner attendees can find you.<BR><BR>For more information on other MyCES and SmartBooth opportunities, check out the <A href="/docs/Promo_Opps_Flyer_Update_-_8.27.08.pdf" target=_blank>2009 MyCES Promotional Opportunity Flyer (pdf)</A>.<BR><BR><SPAN class=smallText>*Note: Login required. Your company's credentials were e-mailed to the main exhibitor representative we have on file. For assistance e-mail <A href="mailto:Support@BDMetrics.com">Support@BDMetrics.com</A> or call 800-931-5103 and select option 1.</SPAN>
