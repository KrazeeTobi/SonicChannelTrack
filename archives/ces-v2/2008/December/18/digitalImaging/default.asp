...
<head><!-- PageID 572 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: Digital Imaging</title>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <P align=center><A href="/exhibits/displays/diShowcase.asp"><IMG height=35 src="/images/content/Digital_Imaging_Showcase_sm.jpg" width=175 border=0></A><BR><BR></P>
    </div>
</div>
<div class="right-blue-box" align="center">
...
<IMG height=100 src="/images/content/digitalimg_icons_sm.gif" width=100 align=right>The digital imaging market continues to grow in 2008, as more young people care about digital photography and purchase digital cameras, more consumers capture images and digital cameras look to go wireless (again). If digital imaging matters to you, <A href="/register">register today for the 2009 International CES</A> to learn, network and investigate new technology emerging in the digital imaging industry and many other consumer technology markets. <BR><BR>Looking for digital imaging technology on the CES show floor? Look for the digital imaging icon, and download and print the <A href="/docs/2K9_DI_QuickGuide.pdf" target=_blank>CES&nbsp;Digital Imaging&nbsp;Quick Guide</A> to help you as you navigate 1.7 million square feet of exhibit space.
...
<div class="sub-content-header">Digital Imaging Sessions</div>
<br />
...
<UL class=text>
<LI class=text><A href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</A></LI>
<LI class=text>LVCC South Hall 3</LI></UL>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />
...
<UL class=text>
<LI class=text>Camera phones, digital cameras and digital camcorders </LI>
<LI class=text>Power, batteries and accessories </LI>
<LI class=text>Embedded technologies </LI>
<LI class=text>Storage media, Flash memory, memory cards and disc media </LI>
<LI class=text>Graphics and software editing </LI>
<LI class=text>Photo printers and consumables </LI>
<LI class=text>Photo printing, publishing and posting services </LI>
<LI class=text>Image and video software</LI></UL><BR><A href="/exhibitorDirectory/default.asp">Check out the 2009 International CES Exhibitor Directory.</A>    
                    </div>
                    <div id="inner-content-right">
                        <br />
