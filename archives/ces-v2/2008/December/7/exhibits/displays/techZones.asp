...
<head><!-- PageID 386 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: CES TechZones</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
            ...
            <li ><a href="/exhibits/displays/00A158C1EA5D4CF489E71D44EB7FCA1B.htm">International Gateway</a></li>
            ...
            <li ><a href="/exhibits/displays/5DF05031547C4A26A0E6AD9883F1CE12.htm">Location Based Services</a></li>
        
            <li ><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
        
            <li ><a href="/exhibits/displays/652A6D6D64324447A6D6B7C82A88147B.htm">Sustainable Planet</a></li>
...
<table class="sponsorship_opportunities">
    ...
    <tr >
        <td><a href="#2585">Casual Gaming</a></td><!---->
        <td>South Hall 2</td>
        <td>MumboJumbo</td>
    </tr>
    ...
    <tr  class="alternateRows">
        <td><a href="#2451">Digital Health</a></td><!---->
    ...
    <tr >
        <td><a href="#1614">Mobile Broadband</a></td><!---->
    ...
    <tr  class="alternateRows">
        <td><a href="#2101">Robotics TechZone</a></td><!---->
        <td>Sands Expo and Convention Center</td>
    ...
    <tr  class="alternateRows">
        <td><a href="#2047">Stevie Wonder and Friends</a></td><!---->
        <td>Sands Expo and Convention Center</td>
        <td> National Federation of the Blind and Sendero Group</td>
    </tr>
...
<div class="sub-content-header">Casual Gaming</div>

<span class="techzones-indented">South Hall 2</span>
<br />

<span class="techzones-indented">Sponsor(s): MumboJumbo</span>
<br/>

<IMG height=120 src="/images/photos/MumboJumboLogo2.jpg" width=158 align=right><BR>The Casual Gaming TechZone at the 2009 International CES, sponsored by MumboJumbo, features companies showcasing the latest titles and games in one of the fastest growing segments in the gaming industry.&nbsp;See companies such as MumboJumbo, Static 2358, and Merit Entertainment all in one location, the Casual Gaming TechZone, within the <A href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</A> in South Hall 2.<BR><BR>
<a class="back_to_top" href="#">[back to top]</a>
        <img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sub-content-header">Digital Health</div>

<span class="techzones-indented">Sands Expo and Convention Center </span>
<br />

<span class="techzones-indented">Sponsor(s): Meridian Health</span>
<br/>

<IMG height=118 src="/images/content/MH_blu-darkblu2.jpg" width=226 align=right><BR>The Digital Health TechZone sponsored by Meridian Health features emerging technologies and innovative companies using home and person-based options for disrupting the traditional delivery of health and wellness services.&nbsp;See the transformation and creation of new consumer centric connections between patients and healthcare providers.&nbsp;It’s about solving the right problems with best solutions for maximum impact.<BR><BR>
<a class="back_to_top" href="#">[back to top]</a>
        <img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sub-content-header">Mobile Broadband</div>
...
<IMG height=208 src="/images/content/MBtm_bmk_bk_port_rgb_small.jpg" width=244 align=right><BR>Experience mobile broadband today!<BR><BR>Consumers now have a new Mobile Broadband future - thanks to the GSM-Association initiative creating a new category of always-connected Mobile Broadband devices. The initiative has united 16 of the worlds best known IT and mobile companies under the new service mark helping consumers easily identify ‘ready to run’ Mobile Broadband devices.<BR><BR>The GSMA Mobile Broadband TechZone brings mobile broadband to life. See real life examples from around the world of the speed of Mobile Broadband in action.<BR><BR>Experience the global phenomenon that is mobile broadband live today.<BR>
<a class="back_to_top" href="#">[back to top]</a>
        <img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sub-content-header">HD-PLC</div>
...
<BR>High Definition Power Line Communication (HD-PLC) is one of the best power line technologies for the stable transmission of data because of its high performance, speed and HD capacity. With HD-PLC you can create home networks for Internet, high-definition video and audio, camera monitoring, and more, all without extra wiring. Forget about walls between rooms anymore. No need to worry about making holes for wiring or about walls reducing transmission speed. Simply plug into a wall outlet with your HD-PLC adaptor, and create your home network.<BR><BR>
<a class="back_to_top" href="#">[back to top]</a>
        <img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<IMG height=132 src="/images/photos/istage235.jpg" width=235 align=right><BR>The most disruptive, next-gen tech products, applications and services clamored for a chance to demo at i-stage, the proving ground for revolutionary new technologies, and now they’ve arrived at CES! The contenders represent staggering leaps in gaming, social media, mobile retail, security, telecommunications and 3D video development and have each been vetted by a panel of industry judges at their live demonstrations in Las Vegas.<BR><BR>
<a class="back_to_top" href="#">[back to top]</a>
        <img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sub-content-header">SD Card</div>

<span class="techzones-indented">LVCC South Hall 3</span>
<br />

<span class="techzones-indented">Sponsor(s): SD Card Association</span>
<br/>

<IMG height=59 src="/images/photos/SDA-Logo.jpg" width=132 align=right><BR>The SD Card Association is an open industry standards organization established in January 2000 by Panasonic, SanDisk and Toshiba, and is supported by a consortium of over 1,200 companies. SDA’s mission is to set industry standards and promote SD Memory Card acceptance in a variety of applications.&nbsp; Website: <A href="http://www.sdcard.org">www.sdcard.org</A>.<BR>
<a class="back_to_top" href="#">[back to top]</a>
        <img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sub-content-header">Stevie Wonder and Friends</div>

<span class="techzones-indented">Sands Expo and Convention Center</span>
<br />

<span class="techzones-indented">Sponsor(s):  National Federation of the Blind and Sendero Group</span>
<br/>

<IMG height=64 src="/images/photos/Sendero-Group-logo.jpg" width=95 align=right><IMG height=53 src="/images/photos/NFB-logo.jpg" width=128 align=right><BR>Meet Stevie Wonder and technology friends and see examples of electronics blind people use in contrast with many they cannot.&nbsp; Try dialing your cell phone with your eyes closed. Learn how minor design improvements can add millions of blind and visually impaired customers to your markets.&nbsp;&nbsp;&nbsp; <BR>
<a class="back_to_top" href="#">[back to top]</a>
        <img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<IMG height=78 src="/images/content/CES-295_TEAC-Logo.jpg" width=220 align=right><BR>
<P>The Technology and Emerging Countries (TEC) TechZone features pioneering technologies that contribute to the social and cultural development of underdeveloped and developing countries. The high-tech industry is facilitating<BR>and growing educational, social and entrepreneurial capacity in growing economies. The TEC TechZone will display the innovations that make it possible<BR> for every person on this planet to make use of technology and benefit from growing CE advances.<BR><BR><STRONG>Exhibitors: </STRONG><A href="/docs/Technology_and_Emerging_Countries_TechZone_Sheet_FINAL.pdf"><STRONG>There's still space available to exhibit in this TechZone!</STRONG></A><BR><BR><BR><BR></P>
<a class="back_to_top" href="#">[back to top]</a>
        <img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
