...
<ul class="text">    
    ...
    <!--/print/faq/5BB2B2112C1C4F3D9D4FE599259C71C8.htm-->
    <li class="text"><a href="#1763">What awards programs are offered at CES?</a></li>
    
    <!--/print/faq/E605BE74AA164E799C533205586F185F.htm-->
...
The International CES features more than 2,700 consumer technology exhibitors in 30 product categories. <A href="/print/exhibitorDirectory/default.asp">Visit&nbsp;the online CES Exhibitor Directory.</A> You can search the directory in a variety of ways, including company name, brand name and venue.<BR><BR>On-site, pick up a copy of the show guide, and the official International CES Directory with updated exhibitor information.<BR><BR>Plus, use <A href="/print/myCES.asp">MyCES</A> to securely and anonymously search for products and vendors, set up meetings and efficiently plan your time at the show. 
<br><img src="/print/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><BR>
...
<UL class=text>
<LI class=text><A href="/print/awards/innovations/default.asp">International CES Innovations Design and Engineering Awards</A><BR>Contact <A href="mailto:Innovations@CE.org">Innovations@CE.org</A> for more information&nbsp;&nbsp; </LI>
<LI class=text><A href="/print/awards/bestOfCES.asp">CNET Best of CES Awards</A><BR>Contact <A href="mailto:bestofces@cnet.com">bestofces@cnet.com</A> for more information&nbsp; </LI>
<LI class=text><A href="/print/awards/GMA.asp">Global Media Awards<BR></A>Contact <A href="mailto:ppillitteri@natasonline.com">ppillitteri@natasonline.com</A> for more information </LI>
<LI class=text><A href="/print/awards/techEmmys.asp">The Technology &amp; Engineering Emmy Awards<BR></A>Call 212-586-8424 for more information</LI></UL>
<br><img src="/print/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><BR>
...
Get ready for <A href="/print/events/default.asp">concerts, competitions, celebrity appearances and other events that happen at CES</A> — even before the show&nbsp;officially opens its doors.<BR><BR>Plus, use <A href="/print/myCES.asp">MyCES</A> to search for products and vendors, set up meetings and efficiently plan your time at the show.
<br><img src="/print/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><BR>
...
You have two options if your preferred hotel is sold out. You can consult the <A href="/print/hotelTravel/hotel.asp">online CES hotel program</A>, where rates tend to be lower, and look for alternate properties near where you want/need to stay.&nbsp; For example, although the CES block for The Venetian&nbsp;sold out&nbsp;in the fall preceding the&nbsp;2008 International CES, many other hotels nearby participated in the CES hotel program and had available rooms, including Treasure Island, Mirage, Harrah’s and Imperial Palace. <BR><BR>You can also contact your preferred hotel(s) directly to book a room, although if their CES block is sold out, you will likely end up paying higher prices. <A href="/print/hotelTravel/default.asp">Get more hotel information.</A> 
<br><img src="/print/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><BR>
...
CES offers <A href="/print/hotelTravel/shuttle.asp">complimentary shuttle service</A>. One system runs back and forth between the Las Vegas Convention Center and all <A href="/print/hotelTravel/hotel.asp">official CES hotels</A>. Another system runs back and forth between the same official CES hotels and the Sands Expo and Convention Center/The Venetian, home to <A href="/print/emergingTech/default.asp">emerging technology</A> exhibitors, <A href="/print/highPerfAudio/default.asp">high-performance audio & home theater</A> exhibitors, many <A href="/print/exhibits/displays/default.asp">CE Spotlights</A>, including market-specific <A href="/print/exhibits/displays/techZones.asp">CES TechZones</A>.<BR><BR><A href="/print/hotelTravel/shuttle.asp">Get more shuttle information, including detailed routes on a print-and-go map.&nbsp;</A><BR>
<br><img src="/print/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><BR>
...
<A href="/print/sessions/default.asp">The International CES Conference Program</A> is divided into the exclusive International CES Knowledge Track and several Partner Programs — strategic master classes brought to you by some of the biggest industry names.<BR><BR>Additionally, the International CES offers a personal planning tool to tailor your show experience. <A href="/print/myCES.asp">Use MyCES</A> to search for conference sessions, products and exhibitors that match your particular business interests.
<br><img src="/print/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><BR>
...
In one word: SAVINGS. Enjoy big discounts when you <A href="/print/sessions/default.asp">register for your conference sessions</A> by January 4, 2009. Plus,&nbsp;getting an accurate headcount of&nbsp;session attendees&nbsp;helps us&nbsp;make the room more inviting and prepare accordingly.
<br><img src="/print/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><BR>
