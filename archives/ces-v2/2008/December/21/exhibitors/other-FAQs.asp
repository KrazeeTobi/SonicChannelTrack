...
<head><!-- PageID 2224 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: Other Inquiries</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li class="selected"><a href="/exhibitors/other-FAQs.asp">Other Inquiries</a></li>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/venueFAQs.asp" class="footer">FAQs by Venue</a>&nbsp;&gt;&nbsp;Other Inquiries</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/other-FAQs.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<a name="top"></a> 
    ...
    <a href="#2227">General Information</a>&nbsp;|&nbsp;<!--/exhibitors/1438E320952543A4A16F3A7E397017C9.htm-->
...
<div class="sub-content-header">General Information</div>
    ...
    <!--Is there meeting space available for CES exhibitors to use?-->

  <br/>
<h3>Is there meeting space available for CES exhibitors to use?</h3>
Yes. CES exhibitors can rent space for <STRONG>one day only </STRONG>at either the Las Vegas Hilton or the Riviera Hotel. The fee to rent the&nbsp;meeting room is $250 per room for four (4) or less hours; anything rented for more than four (4) hours is $500 per room. You can request space at either of these properties by completing the <A href="/docs/2009_CES_Application_for_mtg_rooms_082008.pdf" target=_blank>2009 CES one day meeting space application (pdf). <BR></A><BR>Please note that the space at the Las Vegas Hilton and the Riviera is available for one day only; this space <STRONG>cannot</STRONG> be rented for multiple days. If you wish to rent meeting space for the duration of the show, please contact Pam Sydnor in CES Sales (<A href="mailto:psydnor@CE.org">psydnor@CE.org</A>). <BR>
<img src="/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>[<a href="#top">back to top</a>]<BR>
<img src="/images/framework/divider-line-long.gif">    
                    </div>
                    <div id="inner-content-right">
                        <br />
