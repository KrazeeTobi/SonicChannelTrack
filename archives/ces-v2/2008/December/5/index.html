...
<head><!-- PageID 297 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 International CES, January 8-11: Home</title>
...
<h2><img src="/images/framework/title-sessionSpotlight.gif" alt="Conference Spotlight"></h2>

<div class="news-container">
    <table>
    <tr><td vAlign="top" width=100">

<img src="/images/photos/HP-icon-gaming.jpg">
</td>
<td vAlign="top" width="360">
    <p class="homedate">December 04, 2008</p>
    <h3><a class="footer" href="http://www.cesweb.org/sessions/search/trackDetail.asp?ID_track=CESGP_CES09">CES Game Power Conference</a></h3>
    See how gaming grabs every demographic with high-intensity graphics, massive user communities, new consoles and handsets, and wider broadband acceptance for more mobile applications. 
    <br /><br />
</td></tr><tr><td vAlign="top" width=100">

<img src="/images/photos/HP-icon-hometheater.jpg">
</td>
<td vAlign="top" width="360">
    <p class="homedate">December 02, 2008</p>
    <h3><a class="footer" href="http://cesweb.org/sessions/search/trackDetail.asp?ID_track=HEL_CES09">Home Entertainment &amp; Lifestyle Technologies</a></h3>
    From new Internet-based TV protocols to health-monitoring robots, wireless and lifestyle technologies radically change the way consumers perceive and use home entertainment media, content and devices.
    <br /><br />
</td></tr>
    </table>
</div>
...
<td vAlign="top" width="360">
    <p class="homedate">December 02, 2008</p>
    <h3><a class="footer" href="/prof-buyer.asp">Buyers Call CES a Must-Attend Event</a></h3>
    Buyers prepare to meet face to face with key vendors and decision makers to see new technologies that drive the CE industry.
    <br /><br />
</td></tr><tr><td vAlign="top" width=100">

<img src="/images/photos/r-Innovations.jpg">
</td>
<td vAlign="top" width="360">
    <p class="homedate">November 18, 2008</p>
    <h3><a class="footer" href="/awards/innovations/2009honorees.asp">Innovations Honorees Announced</a></h3>
    This list features sheer genius and the most inventive design and engineering-focused consumer technology products. Touchscreen desktop PC and next-generation portable MP3/DVD player rank among the best.
    <br /><br />
</td></tr>
    </table>
</div>
...
<iframe src='http://vidego.multicastmedia.com/player.php?v=f4f7cph3' scrolling='no' frameBorder='0' height='195' width='237'></iframe>

<img src="/images/framework/spacer.gif" border=0><BR><img src="/images/framework/ces-blog.gif" alt="CEA Digital Dialogue"><br/>
