...
<head><!-- PageID 1973 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: Sessions by Date</title>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/sessions/default.asp" class="footer">Sessions</a>&nbsp;&gt;&nbsp;<a href="/sessions/search/default.asp" class="footer">Search for Sessions</a>&nbsp;&gt;&nbsp;<a href="/sessions/search/byDate.asp" class="footer">By Date</a>&nbsp;&gt;&nbsp;Sessions by Date</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/sessions/search/dateList.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
</SCRIPT><table cellpadding=3 cellspacing=1 border=0><tr height=7><td></td></tr><tr><td><strong>No date was selected. Please <a href=byDate.asp>try again</a>.</strong></td></tr></table>
