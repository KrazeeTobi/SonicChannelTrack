...
<head><!-- PageID 368 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: Audio</title>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        <A href="http://digital.virtualmarketingpartners.com/vmp/cea/building-knowledge-teaser/" target=_blank><IMG height=129 hspace=8 src="/images/content/conf_brochure.gif" width=100 align=right border=0></A>Curl up with the <A href="http://digital.virtualmarketingpartners.com/vmp/cea/building-knowledge-teaser/" target=_blank>2009 CES Conference Brochure</A>, revealing 200+ sessions held this January. CES continues its greening efforts by presenting this informative brochure exclusively on the Internet.
        <br /><br />
    </div>
</div>
<div class="right-blue-box" align="center">
...
<body>
<script src="http://feeds.feedburner.com/MycesNewsMusicAndAudio?format=sigpro" type="text/javascript" ></script><noscript><p>Subscribe to RSS headline updates from: <a href="http://feeds.feedburner.com/MycesNewsMusicAndAudio"></a><br/>Powered by FeedBurner</p> </noscript>
</body>
</html>
...
<IMG height=100 src="/images/content/audio_icons_LG.gif" width=100 align=right>Disruptive technologies are rocking the "legacy" audio industry as competition accelerates between new music sources and such established sources as CDs, DVDs and AM/FM radio. <A href="https://cms.ce.org/register">Register today for the 2009 International CES</A> to&nbsp;investigate new technology emerging in the audio industry and many other consumer technology markets. <BR><BR>Hint: Looking for audio technology at CES? Look for the audio icon on the show floor.
...
<UL class=text>
<LI class=text>Audio networking solutions </LI>
<LI class=text>Stereo and multi-room audio equipment and source controllers </LI>
<LI class=text>Amplifiers and in-ceiling, in-wall, surround and outdoor speakers </LI>
<LI class=text>Digital music </LI>
<LI class=text>Audio hardware and software </LI>
<LI class=text>Digital terrestrial and satellite radio tuners </LI>
<LI class=text>MP3/WMA/AAC players, docks and D/A converters </LI>
<LI class=text>Multi-channel and home theater audio systems</LI></UL><BR><A href="/exhibitorDirectory/default.asp">Check out the 2009 International CES Exhibitor Directory.</A>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />
...
<UL class=text>
<LI class=text>LVCC Central Hall audio company exhibits </LI>
<LI class=text><A href="/exhibits/displays/techZones.asp#388">DisplayPort TechZone (Sands)</A> </LI>
<LI class=text><A href="/exhibits/displays/innovShowcase.asp">Innovations Design and Engineering Showcase (Sands)</A></LI></UL>    
                    </div>
                    <div id="inner-content-right">
                        <br />
