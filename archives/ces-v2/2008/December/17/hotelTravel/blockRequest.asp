...
<head><!-- PageID 479 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: Block Request Form</title>
...
(*The Las Vegas Hilton, Mandalay Bay and THEhotel at Mandalay Bay are accepting block requests for 10 or more rooms.) 
<br><br />
...
<tr>
	<td colspan="2"><font style="color:red"><b>* </b></font> Please select an official 2009 International CES hotel. (Availability subject to change. Last updated December, 2008.)</td></tr>
...
<tr>
	<td width="33%" valign="top" class="text">
        <input type="radio" name="hotel" value="AlexisPark">Alexis Park ($129)<br>
		...
		<input type="radio" name="hotel" value="Circus">Circus Circus ($116)<br>
		<input type="radio" name="hotel" value="Excalibur">Excalibur ($141-161)<br>
		...
		<input type="radio" name="hotel" value="HGVCHilton">HGVC at LV Hilton ($269-299)<br>
		...
		<!--<input type="radio" name="hotel" value="Imperial">Imperial Palace ($165)<br>-->
	...
	<td width="33%" valign="top" class="text">
		...
		<input type="radio" name="hotel" value="Luxor">Luxor ($185)<br>
		...
		<input type="radio" name="hotel" value="MonteCarlo">Monte Carlo ($220)<br>
		...
		<input type="radio" name="hotel" value="PlanetHollywood">Planet Hollywood ($289)<br>
	</td>
	<td width="33%" valign="top" class="text">		
		...
		<input type="radio" name="hotel" value="Tropicana">Tropicana ($129)<br>
		<input type="radio" name="hotel" value="Trump">Trump International Hotel & Tower ($240/$340)<br>
...
<tr>
	<td>
		...
		<ul>
		    ...
		    <li>Flamingo Las Vegas ($219-269)
		    <li>Harrah's ($259)
			<li>Hyatt Place ($189)
			<li>Imperial Palace ($165)
			<li>Mirage ($307) 
			<li>New York New York ($250)
			<li>Paris ($309) 
			<li>Renaissance ($359)
			<li>Rio ($275)
			<li>Riviera ($159)
