...
<head><!-- PageID 314 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: About Innovations</title>
...
<br /><TABLE cellSpacing=0 cellPadding=3 width="80%" border=1>
<TBODY>
<TR>
...
<TR>
<TD><STRONG>EXTENDED&nbsp;DEADLINE</STRONG></TD>
<TD><STRONG>September 26, 2008*</STRONG></TD></TR>
<TR>
...
<TD>November 11, 2008**</TD></TR></TBODY></TABLE><BR><SPAN class=smallText>*This is the final extended deadline. Access to the site will be disabled at&nbsp;11:59PM (EST) Friday, September 26, 2008. <BR><BR>**Innovations Honorees will be announced in New York at the 2009 International CES Press Preview. If a company does not wish to have their product announced, CEA must be notified via e-mail by November 3, 2008. The Innovations Awards Team will do its best to delay the product announcement until the opening of International CES.&nbsp;However, we can make no guarantees. <BR></SPAN><BR>
<H4>Program Fees (Per Entry)</H4><BR>Submit your entries before September 5, 2009, and save $200. Entry fees are non-refundable.<BR><BR>
...
<LI class=text>Improved photo submission requirements </LI>
<LI class=text>Live help via online chat </LI></UL><BR>Apply online between August 18 and September 24, 2008.
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<br /><UL class=text>
<LI class=text>Earn the right to place the coveted Innovations logo on your product's packaging and advertising. </LI>
<LI class=text>Receive additional exposure by displaying your product in the Innovations Design and Engineering Awards Showcase at the prestigious Innovations Plus area located in the Sands Expo and Convention Center at the 2009 International CES (for official International CES exhibitors only). </LI>
...
<LI class=text>Display signage in your booth acknowledging your Innovations honoree status. </LI>
<LI class=text>Receive a beautiful Innovations 2009 Design &amp; Engineering award to display in your booth and in your company's trophy case. </LI>
<LI class=text>Receive a listing in the Innovations 2009 on-site directory (for official International CES Exhibitors only). </LI>
...
<LI class=text>Benefit from inclusion in IDSA's quarterly design publication. </LI>
...
<LI class=text>Take advantage of advertising opportunities in CEA's <EM>CE VISION</EM> magazine. Innovations honorees receive substantial discounts. <A href="mailto:jstookey@CE.org">Contact Jason Stookey</A> for more information.</LI></UL>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<LI class=text>Products entered must be available for sale to the public in U.S. retail outlets or on the Internet between March 1, 2008, and February 28, 2009. </LI>
...
<UL class=text>
<LI class=text>Products entered must fit within one of the official award categories. </LI>
<LI class=text>Products entered must be available for sale to the public at U. S. retail outlets or on the Internet between March 1, 2008, and February 28, 2009. </LI>
<LI class=text>Honorees will be announced at the 2009 International CES Press Preview event in New York, November 11, 2008, and will be included in the launch of no later than November 3, 2008.&nbsp;&nbsp; </LI>
...
<LI class=text>Entries must be paid using a credit card. Checks will no longer be accepted. </LI>
...
<TR>
<TD vAlign=top>
<P>Audio Accessories<BR>Audio Components<BR>Computer Accessories<BR>Computer Hardware<BR>Computer Peripherals<BR>Digital Imaging<BR>Eco-Design and Sustainable Technology <BR>Electronic Gaming<BR>Enabling Technologies <BR>Furniture<BR>Headphones<BR></P></TD>
<TD vAlign=top>
<P>Health and Wellness<BR>High-Performance Audio<BR>Home Appliances<BR>Home Networking<BR>Home Theater Accessories<BR>Home Theater Speakers<BR>In-Vehicle Audio<BR>In-Vehicle Accessories<BR>In-Vehicle Control/OEM Integration<BR>In-Vehicle Navigation/Telematics/ITS<BR>In-Vehicle Video<BR><BR></P></TD>
<TD vAlign=top>Integrated Home Systems<BR>Multi-Room Audio/Video<BR>Personal Electronics<BR>Portable Media Accessories<BR>Portable Media Players<BR>Portable Power<BR>Telephones<BR>Video Accessories<BR>Video Components<BR>Video Displays <BR>Wireless Handsets Accessories<BR>Wireless Handsets</TD></TR></TBODY></TABLE><BR>Need more information? View&nbsp;awards category definitions or <A href="/docs/2K9_Innovations_Category_Guide_FINAL.pdf">download the 2009 awards category guide</A>, detailing examples of products for each category.
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<LI class=text>Don't submit an entry that will not be commercially available by February 28, 2009. </LI>
<LI class=text>Don't submit an entry that has been available in the United States at retail before March 1, 2008. </LI>
<LI class=text>Up to five different views of your product can be uploaded during the entry process. Show off that awesome design! Take advantage of it!</LI></UL><BR><STRONG>Remember:</STRONG> If you are selected as an honoree and a 2009 International CES exhibitor, you are required to make your product available for the Innovations Showcase during the 2009 International CES, January 8-11, 2009.
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<LI class=text>Why the product deserves the Innovations award, including specifics regarding its unique/novel features and features that consumers would find attractive<BR></LI></UL><BR>Judges review and evaluate each ECO-DESIGN entry based on summaries of the following criteria:<BR><BR>
<UL class=text>
...
<LI class=text>Why the product deserves the Innovations award, including specifics regarding its unique/novel features and features that consumers would find attractive</LI></UL>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<UL class=text>
<LI class=text>If a company does not wish to have their product announced for any reason other than stated above; CEA has the right to remove the award designation. The product will be considered as a non-entry. The company will have the right to submit the product as a new entry at the next year's Call for Entries provided it still meets the initial entry submission qualifications.&nbsp; </LI>
<LI class=text>If a company wishes to have the product honoree announcement delayed until the opening of the International CES, written notification must be received by the Innovations Awards Team at <A href="mailto:Innovations@CE.org">Innovations@CE.org</A> no later than November 3, 2008. The Innovations Awards Team will do its best to delay the product announcement until the opening of International CES.&nbsp;However, we can make no guarantees.</LI></UL><B>What are the requirements for accepting this award?</B> 
<UL class=text>
<LI class=text>Companies whose products will be displayed "live" must supply the necessary auxiliary equipment, including all cables, connectors, and program sources, along with copyright-cleared audio and video programs. (Note: The playback source of such programming will not be out for public display unless that product has been selected for an award.) </LI>
<LI class=text>Only International CES-supplied descriptive signage will be displayed in the Showcase. </LI>
<LI class=text>Best of Innovations honoree will be required to provide two products. One will be displayed in the Showcase at the Sands Expo and Convention Center in Innovations Plus and the other will be displayed at Experience CEA in the Grand Lobby of the Las Vegas Convention Center. </LI>
<LI class=text>Best of Innovations honorees will allow CEA to hold one sample, for up to one year, for display at other CEA-related events. </LI></UL><BR><B>Are there sponsorship opportunities for Innovations?</B><BR>Yes. There are currently <A href="/exhibitors/sponsorships/awards.asp">three ways to sponsor Innovations</A>.
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
