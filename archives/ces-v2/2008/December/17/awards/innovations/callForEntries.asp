...
<head><!-- PageID 313 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: Call for Entries</title>
...
// javascript for e-mail this page tool - gets the url of the page the user is on before the e-mail page tool button is clicked
	...
	<!-- Start FORM -->
	If you would like to be added to the Innovations 2010 mailing list, fill out the form below. We'll notify you when we begin accepting entries. (<font style="color:red"><b>* </b></font> Denotes required field.)<br />
	...
	<h2>Sign up to receive Innovations 2010 Call for Entries updates</h2><br />
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan="2">**Your privacy is important to us. Please review our <a href="/privacyPolicy.asp">privacy policy</a> for details.</td>
	</tr>
	</table>
	</form>
