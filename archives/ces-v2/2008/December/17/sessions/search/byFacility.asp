...
<head><!-- PageID 1997 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: By Facility</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
            ...
            <li class="selected"><a href="/sessions/search/byFacility.asp">By Facility</a></li>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/sessions/default.asp" class="footer">Sessions</a>&nbsp;&gt;&nbsp;<a href="/sessions/search/default.asp" class="footer">Search for Sessions</a>&nbsp;&gt;&nbsp;By Facility</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/sessions/search/byFacility.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
</SCRIPT><br><form action="facilityList.asp" method=post><table cellpadding=3 cellspacing=1 border=0><tr><td><b>Choose a facility from the drop-down list.</b></td></tr><tr height=7><td></td></tr><tr><td colspan=1><select class=formdata name=faevfacility><option value=0>Choose a Facility&nbsp;&nbsp;<option value="Las Vegas Hilton">Las Vegas Hilton<option value="LVCC, North Hall">LVCC, North Hall<option value="LVCC, South Hall">LVCC, South Hall<option value="The Flamingo Hotel">The Flamingo Hotel<option value="The Venetian">The Venetian</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
<!--
<br>
...
<!--/sessions/search/facilityList.asp-->
