...
<head><!-- PageID 1160 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: 해외 방문객 서비스</title>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <reddot:cms>
    <if>
        <query valuea="Context:Pages.GetPage(Guid:84FDD9AF48F14DA7ADB81C9ABDB8D6AB).Elements.GetElement(con_SubNav).Value[Int:0].Elements.GetElement(list_Navigation).Value.Count" operator=">" valueb="Int:0" >
        <htmltext>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news2649','show')" class="link_with_children"><a href="/news/30daysInnovation.asp">30 Days of Innovation</a>
...
<P><SPAN class=subhead><STRONG>국제 상업 센터 (ICCs)</STRONG></SPAN><BR></SPAN><STRONG>LVCC, South Hall Connector, Room S224/225<BR>Las Vegas Hilton, Hilton Center, Booth 40028<BR>샌즈 엑스포 와 컨벤션 센터 위층 로비</STRONG><BR>국제 카머스 센터들은인터넷 스테이션, 개인 상담실의 예약과 사용, 가벼운 식음료, 또는 휴식을 취할수 있는 장소와 함께 국제 방문객과 전시자들이 서로 만날수 있게 하는 장소입니다. ICC는 세곳이 있으며 귀하가 CES에 와 있는 동안 원거리 사무실 기능을 해드립니다. <BR><BR><STRONG>국제 환영회</STRONG><BR>1월 8일 목요일 오후 6-7:30분<BR>LVCC, South Hall Connector, Room S222<BR>모든 국제 참가자들, 전시업체들, 그리고 보도진은 CES 국제 환영회에 초대됩니다. 오직 국제 참가자들만을 위힌 행사입니다. 참석하셔서, 새로운 사람들을 만나고, 업계 동료들과 사업 이야기도 나누고, 새로운 비즈니스 파트너도 개발하십시오. 환영회에서 만나뵙기 희망합니다!<BR><BR></SPAN><STRONG>통역사</STRONG><BR>인터내셔널 컨벤션 센터 안 국제 등록 장소 세 곳 모두에 통역사들이 배치될 것입니다:즉 , South Hall 2, Sands, Hall B. 한국어, 스페인어, 독일어, 불어, 중국어(북경어와 광둥어), 일어, 이탈리아어, 포르투갈 통역사들이 배치됩니다. 도움이 필요하시면 국제 등록 데스크에서 “Interpretation Services” (통역 서비스)라고 표시한 곳을 찾으십시오. 통역사들은 또한 Central Plaza 안에 Information Center에도 배치됩니다.&nbsp; <BR><BR><SPAN style="FONT-FAMILY: "><SPAN class=subhead><STRONG>MyCES 퍼스널 플래너 – 완벽한 쇼를 위한 준비</STRONG><BR></SPAN><IMG hspace=6 src="/images/content/MyCES-172.gif" align=right>MyCES Personal Planner는 귀하가 방문을 원하는 회의 세션과 전시장을 볼수 있고, 만나고 싶어 하는 새로운 사업 파트너를 만날수 있으며, CES에 있는 동안 시간을 최대로 활용할수 있도록&nbsp; 당신 자신의 지도와 의제를 만들수 있게 해드리는 인터넷 활용 도구입니다.&nbsp; <A href="http://www.cesweb.org/myCES.asp">자세한 정보(영어로 제공).</A><BR><BR><A href="http://myces.bdmetrics.com/Default.aspx" target=_blank>지금 완벽한 쇼를 위한 준비를 시작하십시오.</A><BR><BR><SPAN class=text><STRONG><SPAN class=subhead>국제 구매자 프로그램</SPAN><BR></STRONG>국제 CES는 미 연방 상무부, 국제 무역청이 후원하는 국제 구매 프로그램의 자랑스런 회원입니다. 국제 참관자와 전시자들에게 수출 카운슬링을 해주고 짝짓기에 도움을 주기위해 미 상무부의 국제 무역 전문가들이 ICC 본회의장 (LVCC, South Hall Connector, Room S224/225) 에&nbsp; 대기중입니다. <BR></SPAN></SPAN></P></SPAN>
