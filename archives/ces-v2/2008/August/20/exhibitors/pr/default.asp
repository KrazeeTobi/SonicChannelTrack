...
<head><!-- PageID 358 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - PR Help</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions358','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions358" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions358','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards358','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards358" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards358','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards358','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards358','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards358','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards358','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
                
                    <li onmouseover="showSubMenu('awards358','show')"><a href="/awards/innovations/D2D617DFADC443ACA9538362B618E34E.htm">Honoree Utilities</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits358','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits358" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits358','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits358','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits358','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits358','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits358','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits358','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits358','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits358','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits358','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel358','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel358" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel358','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news358','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news358" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news358','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news358','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news358','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li class="selected"><a href="/exhibitors/pr/default.asp">PR Help</a>
        
                <ul>
            
            <li ><a href="/exhibitors/pr/AA41DB443B9D4CF99CA7A7DAE89B914D.htm">Pre-registered Media/Analyst List</a></li>
        
            <li ><a href="/exhibitors/pr/90E91590D5794197BCEB5E1237BB7472.htm">Exhibitor PR Kit</a></li>
        
            <li ><a href="/exhibitors/pr/20D6B46FDB5442988186F0108B3A90A7.htm">Exhibitor PR Newsletter</a></li>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;PR Help</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/pr/default.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
Eighty-five&nbsp;percent of all CES exhibitors cite press/media coverage as one of the most important reasons for attending the show. It's easy to see why PR is oftentimes the highest priority for exhibitors at the International CES. The 4,500 press and 1,900 analysts who cover CES each year are able to get a company's name into the minds of millions of consumers with the simple stroke of a keyboard. Let us help you reach the media.<BR><BR><STRONG><A href="/exhibitors/pr/AA41DB443B9D4CF99CA7A7DAE89B914D.htm">Pre-Registered Media/Analyst List</A> (login required) - Available&nbsp;in November '08<BR></STRONG>View a list of media and analysts who are pre-registered for the 2009 International CES and the CES Unveiled pre-CES press events. List becomes available in early November. <BR><BR><STRONG><A href="/exhibitors/pr/90E91590D5794197BCEB5E1237BB7472.htm">2009 Exhibitor PR Kit</A> - Available in&nbsp;late August&nbsp;'08<BR></STRONG>This manual includes preliminary promotion ideas, comprehensive communications strategies, press conference information, sample press releases and everything you need to know about best practices for effectively reaching the media.
<P><STRONG><A href="/exhibitors/pr/20D6B46FDB5442988186F0108B3A90A7.htm">Exhibitor PR Newsletter</A> - Available in August '08<BR></STRONG>This monthly newsletter helps you keep your public relations efforts in check with valuable tips, deadline reminders and breaking news. Newsletters begin in August.<BR>&nbsp;<BR><STRONG>Essential PR Tip</STRONG><BR><A href="https://myces.bdmetrics.com/ExhibitorPortal/EventLogin.aspx" target=_blank>Update your PR contact information</A> so journalists and broadcasters can find you. You must do this through your company's <A href="https://myces.bdmetrics.com/ExhibitorPortal/EventLogin.aspx" target=_blank>SmartBooth Entry Portal</A>. (Note: Exhibitor login credentials were e-mailed to the main exhibitor representative we have on file. If you're not sure who this contact is, <A href="mailto:acarney@CE.org">e-mail Allison Carney</A>.) <BR></P>
