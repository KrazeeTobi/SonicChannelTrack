...
<head><!-- PageID 364 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Exhibit at CES</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions364','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions364" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions364','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards364','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards364" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards364','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards364','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards364','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards364','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards364','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
                
                    <li onmouseover="showSubMenu('awards364','show')"><a href="/awards/innovations/D2D617DFADC443ACA9538362B618E34E.htm">Honoree Utilities</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits364','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits364" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits364','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits364','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits364','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits364','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits364','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits364','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits364','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits364','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits364','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel364','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel364" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel364','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news364','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news364" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news364','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news364','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news364','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;Exhibit at CES</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/space/default.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
Exceptional quality. Record-breaking numbers. By every measure&nbsp;- attendee quality, media attention, markets represented and special events&nbsp;- CES is incomparable. <A href="/exhibitors/space/contactRep.asp">Contact a CES business development representative today</A> to learn about securing show floor space. <BR><BR>If your space is secured for 2009, consider other ways to <A href="/exhibitors/sponsorships/default.asp">capitalize at CES with various promotional opportunities</A>.<br /><br />
<div class="page_header_block">
    <div class="blue_box">
        ...
        <li><a href="#828">Traditional Booth Space</a></li><!---->
        
        <li><a href="#829">CES TechZones</a></li><!---->
        
            </ul>
        
            <ul>
        
        <li><a href="#830">CES Meeting Place (Meeting Rooms)</a></li><!---->
        
            </ul>
        
            <ul>
        
        <li><a href="#831">Business Development Contacts</a></li><!---->
...
<div class="sponsorshipTitle">Traditional Booth Space</div>

<br /><IMG height=125 src="/images/photos/p43.jpg" width=165 align=right>The International CES makes it easy for attendees to meet the right exhibitors.&nbsp;Generally, International CES venues are divided into market categories, promising that no company is overlooked. <BR><BR>
<H3>Sands Expo and Convention Center/The Venetian</H3>High-performance audio &amp; home theater<BR>Emerging technology products<BR><BR>
<H3>Las Vegas Convention Center (LVCC)/Las Vegas Hilton</H3>
<P>
<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
<TBODY>
<TR>
<TD vAlign=top><STRONG>North Hall<BR></STRONG>Mobile electronics<BR>Car audio/video <BR>In-vehicle information systems <BR>Satellite radio <BR>Vehicle navigation <BR>Vehicle security&nbsp;<BR><BR><STRONG>South Hall</STRONG><BR>Home information and wireless<BR>Home theater/home systems, satellite<BR>Breakthrough technologies <BR>Information technology <BR>Gaming/entertainment products and solutions <BR>Home information <BR>Home systems <BR>Home theater <BR>Satellite systems <BR>Telephony <BR>Wireless accessories <BR>Wireless communications</TD>
<TD vAlign=top><STRONG>Central Hall<BR></STRONG>Audio/video<BR>Audio accessories <BR>Audio components <BR>Blank media <BR>Photographic equipment <BR>Portable audio <BR>Speakers <BR>Video hardware&nbsp;<BR><BR><STRONG>The Las Vegas Hilton</STRONG><BR>The International Gateway (international exhibits)</TD></TR></TBODY></TABLE></P>
...
<div class="sponsorshipTitle">CES TechZones</div>

<br /><IMG height=125 src="/images/photos/TechHome_TechZone.jpg" width=165 align=right>Consider exhibiting in one of more than a dozen <A href="/exhibits/displays/techZones.asp">CES TechZones</A>, highly trafficked areas that feature emerging technology for a variety of consumer technology markets. Find one that&nbsp;matches your market, or if you'd like to learn about creating a new TechZone for this year's show for your must-have emerging technology, contact a business development representative today at 703-907-7645.<BR><BR>Are you in the digital gaming business? Consider exhibiting in <A href="/docs/Gaming_Showcase_Flyer.pdf" target=_blank>The CES Gaming Showcase (pdf).</A>
...
<LI>Stay close to the show floor action!</LI></UL>Reserve a suite now. Contact an International CES business development representative today. Call 703-907-7645. <BR><BR>
<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
<TBODY>
<TR>
<TD vAlign=top width="40%">The CES Meeting Place package includes: 
<UL>
...
<LI>A sign to denote your suite</LI></UL></TD>
<TD vAlign=top width="60%">A suite entitles you access to the Networking Center, including: 
<UL>
<LI>A reception desk </LI>
<LI>Internet stations </LI>
<LI>Phone lines with calling card access </LI>
<LI>Fax and copier </LI>
<LI>Coffee and water service</LI></UL></TD></TR></TBODY></TABLE>
...
<div class="sponsorshipTitle">Business Development Contacts</div>

<br />Let us help you select the most ideal exhibit space for your company at the world's leading consumer technology event. <A href="/exhibitors/space/contactRep.asp">Fill out our online form to indicate your space needs.</A><BR><BR>To speak directly with an International CES representative, please call 703-907-7645.
