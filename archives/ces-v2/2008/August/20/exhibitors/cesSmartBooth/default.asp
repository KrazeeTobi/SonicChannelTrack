...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
            ...
            <ul id="sub-sub-awards362" style="display: none;" onmouseout="setSubMenuTimer()">
                    ...
                    <li onmouseover="showSubMenu('awards362','show')"><a href="/awards/innovations/D2D617DFADC443ACA9538362B618E34E.htm">Honoree Utilities</a></li>
...
<P>For more information on other MyCES and SmartBooth opportunities, check out the <A href="/docs/MyCESPromo_Opp_Flyer.pdf" target=_blank>2009 MyCES Promotional Opportunity Flyer (pdf)</A>.</P>
