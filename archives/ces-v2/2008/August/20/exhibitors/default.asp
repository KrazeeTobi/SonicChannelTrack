...
<head><!-- PageID 332 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - For Exhibitors</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions332','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions332" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions332','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards332','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards332" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards332','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards332','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards332','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards332','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards332','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
                
                    <li onmouseover="showSubMenu('awards332','show')"><a href="/awards/innovations/D2D617DFADC443ACA9538362B618E34E.htm">Honoree Utilities</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits332','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits332" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits332','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits332','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits332','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits332','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits332','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits332','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits332','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits332','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits332','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel332','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel332" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel332','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news332','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news332" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news332','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news332','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news332','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<div class="right-blue-box" align="center">
    <img src="/images/framework/rightcolumn_exhibitornews.gif">
    
    <div>
        <DT target="_blank">
<P><STRONG>News:</STRONG><BR><A href="http://www.cesweb.org/exhibitors/newsletter/aug08.asp" target=_blank>Exhibitor registration is now open.</A></P>
<P><STRONG>Promotions:</STRONG><BR><A href="/exhibitors/newsletter/aug08pro.asp">The Innovations 2009 call for entries starts August 18.</A></P>
<P><STRONG>Events:</STRONG><BR><A href="/exhibitors/newsletter/aug08ev.asp">Mark off most of your exhibit to-dos in one day.</A></P>
<P><STRONG>Operations:<BR></STRONG><A href="/exhibitors/newsletter/aug08ops.asp">Now that you’re thinking CES, it’s time to think audio visual.</A></P>
<P>All this and more in this month's <A href="/exhibitors/newsletter/jul08.asp">Exhibitor's Source.</A><BR><BR></P>
    </div>
</div>
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        <A href="http://www.cesweb.org/global_includes/asp/streamingmedia.asp?url=http://content.ce.org/2009CESVideos/2009_CES_Sales_6.11_fin.mov" target=_blank><IMG height=128 src="/images/content/exhibSalesVidStill.jpg" width=180 border=0></A><BR><BR>Why is it important for consumer technology companies of all sizes and from all vertical markets to exhibit at CES?<BR><BR><A href="http://content.ce.org/2009CESVideos/2009_CES_Sales_6.11_fin.mov" target=_blank>Watch this high-energy video and learn.</A>
        <br /><br />
    </div>
</div>

<div class="right-blue-box" align="center">
    <img src="/images/framework/rightcolumn-resourcecenter.gif">
    
    <div>
        Keep up on the consumer electronics industry.
<P><STRONG>Must Attend:<BR></STRONG><A href="http://www.ce.org/i-stage" target=_blank>i-stage: the Springboard to CES</A></P>
<P><STRONG>Must Surf:</STRONG><BR><A href="http://www.digitaltips.org" target=_blank>DigitalTips.org</A></P>
<P><STRONG>Must Buy:<BR></STRONG><A href="http://www.mygreenelectronics.org" target=_blank>Green Electronics</A></P>
<P><STRONG>Must Join:<BR></STRONG><A href="http://www.digitalfreedom.org/" target=_blank>Digital Freedom</A><BR><BR><STRONG>Must Install:</STRONG><BR><A href="http://www.techhome.com">TechHome</A><BR><BR></P>
    </div>
</div>

<div class="right-blue-box" align="center">
    <img src="/images/framework/rightcolumn_visionmag.gif" alt="CE Vision Magazine">
    
    <div>
        <P style="TEXT-ALIGN: center"><IMG src="/images/content/Huang.jpg"><BR>&nbsp;</P>
<P>CE Vision tracks the digital technology trends, policy and business news that matter to you.<BR><A href="http://www.ce.org/vision" target=_blank>Read and advertise in this industry publication.</A></P>
    </div>
</div>
                    </div>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;For Exhibitors</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/default.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<img src="/images/framework/exhibMain.jpg" width="454" height="229"><br /><br />
<img src="/images/framework/divider-line.gif" width="454" height="15"><br />


<img src="/images/framework/title-moreheadlines.gif" width="454" height="29">

<br /><br />


<img style="float: left; padding-right: 8px;" alt="" src="/images/content/exh-CES.jpg" />
<a class="footer" href="/exhibitors/resources/workshop.asp"><b>Register Now for the Free CES Exhibitor Workshop</b></a>
<br/>

This one-day workshop (October 22)&nbsp;allows you to meet with CES experts, plan your exhibiting logistics, discover promotional opportunities, learn marketing and PR tips and receive discounts from vendors — all for free.<br /><br />



<a class="footer" href="/awards/innovations/callForJudges.asp"><b>Innovations 2009 Design and Engineering Awards Call for Judges Now Open </b></a>
<br/>

Lots of ideas make it off the drawing board,&nbsp;but only YOU get to decide which make it to Innovations. If you're a member of the trade press, an independent designer or an engineer, you could judge one of the CE industry's most lauded awards programs.<br /><br />



<a class="footer" href="/exhibitors/resources/advisoryBoard.asp"><b>New Chair and Vice Chair Named</b></a>
<br/>

The CES Exibitor Advisory Board (EAB) offers guidance regarding any facet of your exhibiting experience. Sanyo's David Berkus and HP's Glenda Brungardt recently accepted chair and vice chair roles.<br /><br />



<a class="footer" href="/exhibitors/space/default.asp"><b>Exhibit Space Still Available</b></a>
<br/>

Some TechZone exhibit space is still available for January '09 CES. Use this as traditional booth space or to complement what you already have.<br /><br />



<a class="footer" href="/exhibitors/sponsorships/onsiteAdvertising.asp"><b>Think Big, Think Banners</b></a>
<br/>

Pick a prime location now for giant, attention-grabbing banners that hang outside the Las Vegas Convention Center.
...
<div class="sub-content-header">Got America's Next Top Gadget? Prove It.</div>
<br />

<A href="http://www.ce.org/i-stage" target=_blank><IMG height=99 hspace=8 src="/images/content/istage175.jpg" width=175 align=right border=0></A>What if you could make your worldwide debut at the International CES, all expenses paid? <A href="http://www.ce.org/i-stage" target=_blank>i-stage invites all purveyors of the new and the cool</A> — cool devices, cool services, cool applications — to the only competition that springboards you to the spotlight.
        <br /><img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="1346"></a>

<div class="sub-content-header">Get Your Exhibit in Shape</div>
<br />

<A href="http://www.Tech-EM.com" target=_blank><IMG height=150 hspace=8 src="/images/content/Tech_em_banner.jpg" width=115 align=right border=0></A>Get your exhibit in shape for the 2009 International CES. Give us an hour and we'll arm you with CES changes and updates, exhibitor trends and case studies, design ideas and booth technologies, tips for increasing traffic and leads and more. Produced in conjunction with <A href="http://www.tech-em.com/" target=_blank>Tech-EM.com</A> and Event Marketer magazine.<BR><BR><A href="http://content.ce.org/2009CESVideos/exhibitorWebinar/109118.wmv" target=_blank>Listen to the CES Chalk Talk webinar.</A>    
                    </div>
                    <div id="inner-content-right">
                        <br />
