...
<head><!-- PageID 337 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Press Events</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions337','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions337" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions337','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards337','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards337" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards337','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards337','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards337','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards337','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards337','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
                
                    <li onmouseover="showSubMenu('awards337','show')"><a href="/awards/innovations/D2D617DFADC443ACA9538362B618E34E.htm">Honoree Utilities</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits337','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits337" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits337','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits337','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits337','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits337','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits337','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits337','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits337','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits337','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits337','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel337','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel337" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel337','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news337','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news337" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news337','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news337','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news337','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/press/default.asp" class="footer">For The Press</a>&nbsp;&gt;&nbsp;Press Events</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/press/events/default.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<H2>CES New York Press Preview featuring CES Unveiled@NY</H2><BR>November&nbsp;11,&nbsp;2008<BR>The Metropolitan Pavilion<BR>New York, NY <BR><BR>Hear the latest CES news&nbsp;and&nbsp;learn about new technology trends.&nbsp;Get a sneak peek of the products that will be on display in Las Vegas in January and&nbsp;also may turn consumer heads this holiday season.&nbsp;&nbsp;<A href="http://registration.experient-inc.com/ShowCES086/Default.aspx" target=_blank>Register for the CES New York Press Preview now.</A><BR><BR><BR>
<H2>CES Unveiled: The Official Press Event of the International CES </H2><BR><IMG height=125 src="/images/photos/p10.jpg" width=165 align=right>4-7 p.m. Tuesday, January 6, 2009<BR>The Sands/Venetian, Venetian Ballroom <BR>Las Vegas, Nevada<BR><BR>Get to CES early to uncover the top tech newsmakers.&nbsp; Be the first to see the New Year’s products at CES Unveiled.&nbsp;<BR><BR>With more than 2,700 exhibitors to cover at CES, media, analysts and bloggers can get a pre-show look at who will be making news headlines in 2009 at CES Unveiled.&nbsp; Catch all the latest products in one room.&nbsp; Plus, get a sneak peek at the 2009 International CES product debuts and the Innovations Design and Engineering Showcase honorees — before the show officially opens. <BR><BR>Enjoy cocktails and hors d’oeuvres, while checking out exclusive tabletop demonstrations and networking with today's hottest tech companies.&nbsp; <BR><BR><BR>**Press are encouraged to arrive in Las Vegas mid-day on Tuesday, January 6, for CES Unveiled, other press-specific events on Tuesday afternoon and Press Day on Wednesday, January 7.
...
<div class="sub-content-header">Press Day - Wednesday, January 7</div>
<br />

<IMG height=75 src="/images/content/CES_Press_Day_140.gif" width=140 align=right>With more than 90 percent&nbsp;of registered media members attending Press Day in 2008, the schedule of events is always highly anticipated, and the <A href="/press/events/exhibitorPressEvents.asp">2009 Press Day Schedule is now posted</A>!<BR><BR>Media can expect another streamline schedule this year, with 12 of the 13 exhibitors participating hosting their events on the first and second floors of the Venetian. Want to know where to go and how to get there? <A href="/docs/Press_Day_Map.pdf" target=_blank>Download the 2009 International CES Press Day map.</A><BR><BR>Press Day is a MUST attend for CES media as major corporate, product and news announcements will be made! Press Day&nbsp;begins at 8 a.m. Wednesday, January 7, and wraps up at 5 p.m., just in time for the preshow CES keynote address.<BR>    
                    </div>
                    <div id="inner-content-right">
                        <br />
