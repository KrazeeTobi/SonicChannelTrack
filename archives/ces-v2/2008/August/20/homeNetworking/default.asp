...
<head><!-- PageID 584 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Home Networking</title>
    <link type="text/css" rel="stylesheet" media="all" href="/css/styles.css" />
    
    <meta http-equiv="Content-Type" content="text/html;charset=utf-8" />
    <meta name="description" content="Home networking installers and integrators can receive specialized training and can investigate new home networking technology at the International CES, the world's largest consumer technology tradeshow and educational forum.">
    <meta name="keywords" content="• Home networking, wireless home network, wireless home networking, Cable modems, DSL modems, WiMAX modems, hubs, routers, switches, IP music, video providers, broadband providers, media receivers, structured wired cables, VoIP hardware, VoIP software">
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions584','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions584" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions584','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards584','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards584" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards584','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards584','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards584','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards584','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards584','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
                
                    <li onmouseover="showSubMenu('awards584','show')"><a href="/awards/innovations/D2D617DFADC443ACA9538362B618E34E.htm">Honoree Utilities</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits584','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits584" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits584','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits584','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits584','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits584','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits584','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits584','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits584','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits584','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits584','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel584','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel584" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel584','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news584','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news584" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news584','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news584','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news584','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
            ...
            <div id="main-content">
                <div id="main-content-column1">
                    <div class="greenbox-bg">
                        <img src="/images/framework/sidebar-header-homenetwork.gif">
                        
    <a href="/homeNetworking/default.asp"></a>
    <ul>
    
    <!--/homeNetworking/default.asp-->
...
<div class="right-box-no-border" align="center">
    <img src="/images/framework/homenetwrk_icons_LG.gif" alt="Home Networking" width="176" height="175">
</div>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;Home Networking</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/homeNetworking/default.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-left">
                        <h1>Home Networking</h1>
                                                               
                        

Propelled by the proliferation of broadband and inexpensive PC networking gear, including Wi-Fi wireless gateways and routers, home networking has been one of the biggest success stories in the consumer technology arena in the past decade. <BR><BR>Now, experts say, the home networking market is entering a new phase in its evolution driven largely by Internet-connected CE products and related Web-based services. As you plan your time for the 2009 International CES, consider these trends: 
<UL>
<LI>The breadth of products connected to home networks, including wireless home&nbsp;networks,&nbsp;will continue to increase, encompassing a greater variety of CE devices and a new generation of PC-connected digital media adapters and "extenders." </LI>
<LI>Service providers will play a major role in expanding the penetration of home networks and multimedia- or entertainment-oriented networking products centered on the delivery of Web-based content, primarily video. </LI>
<LI>Energy management concerns will continue to drive the installation of networked home automation systems. </LI>
<LI>Wireless technologies including ZigBee, Z-Wave, WiMAX and femtocells will proliferate as key wireless home networking infrastructure technologies. </LI>
<LI>Though there will be important technological advances in home networking in 2008, many of these will be evolutionary, not revolutionary.</LI></UL><A href="/register">Register today for the 2009 International CES</A> to learn, network and investigate new technology&nbsp;in the&nbsp;home networking industry and many other consumer technology markets. It's free if you sign up before November 1. <BR><BR><EM><SPAN class=smallText>Source: Digital America, a CEA publication.</SPAN></EM><EM><SPAN class=smallText><BR></SPAN></EM>
...
<div class="sub-content-header">Just for Home Networking Professionals</div>
<br />

&nbsp;While all consumer technology markets converge at CES, it's still easy to find specific segments that matter to you. If&nbsp;home networking&nbsp;technology is your primary interest, start by exploring these parts of the CES show floor:
<UL>
<LI><A href="/exhibits/displays/techZones.asp#753">HomePlug TechZone</A> </LI>
<LI>LVCC South Halls 3-4</LI></UL>
        <br /><img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="876"></a>

<div class="sub-content-header">Home Networking Products at CES</div>
<br />

At the International CES, prepare to meet and do business with manufacturers, distributors and service providers of: 
<UL>
...
<P><A href="/exhibitorDirectory/default.asp">Check out the International CES Exhibitor Directory.</A></P>    
                    </div>
                    <div id="inner-content-right">
                        <br />
