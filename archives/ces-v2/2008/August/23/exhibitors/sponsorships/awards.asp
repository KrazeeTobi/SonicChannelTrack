...
<head><!-- PageID 685 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Award Programs</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions685','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions685" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions685','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards685','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards685" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards685','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards685','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards685','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards685','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards685','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
                
                    <li onmouseover="showSubMenu('awards685','show')"><a href="/awards/innovations/D2D617DFADC443ACA9538362B618E34E.htm">Honoree Utilities</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits685','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits685" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits685','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits685','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits685','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits685','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits685','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits685','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits685','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits685','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits685','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel685','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel685" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel685','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news685','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news685" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news685','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news685','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news685','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li class="selected"><a href="/exhibitors/sponsorships/awards.asp">Award Programs</a></li>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/sponsorships/default.asp" class="footer">Promotional Opportunities</a>&nbsp;&gt;&nbsp;Award Programs</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/sponsorships/awards.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<div class="page_header_block">
    <div class="blue_box">
        ...
        <li><a href="#715">CNET's Best of CES</a></li><!---->
        
            </ul>
        
            <ul>
        
        <li><a href="#712">Innovations Design and Engineering Awards</a></li><!---->
...
<div class="sponsorshipTitle">CNET's Best of CES</div>

<br />CNET's Best of CES Awards recognize the top products debuting at the International CES. Winners in 12 categories, including Best of Show and People's Voice designations,&nbsp;are selected from companies exhibiting at the show. CES exhibitors are encouraged to submit their products to CNET for consideration. <A href="http://www.cnet.com/4520-13403_1-6722486-1.html" target=_blank>Visit CNET.com for details and submission information</A>.
...
<div class="sponsorshipTitle">Innovations Design and Engineering Awards:&nbsp;<span class="lt_blue">$10,000-$15,000</span></div>

<br />Tie your logo and brand to the part of the show floor that draws the most press coverage at CES. Better yet, tie your logo to winners! Considered among the most prestigious awards programs in the CE industry, the Innovations Design and Engineering Awards is a developed, recognized brand. Sponsor the awards stage on-site at CES, or gain months of brand recognition when you serve as the premier sponsor of the entire program.<BR><BR>NOTE: Innovations sponsorship opportunities are also available to companies that are not part of the awards program. <BR><BR><STRONG>Premier Sponsor of the Innovations Design and Engineering Awards - $15,000</STRONG><BR>As a premier sponsor of the Innovations Awards, align your company with some of the most innovative products to come to market in the new year. Sponsorship package includes your logo on the following*: 
<UL>
<LI><A href="/awards/innovations/default.asp">www.CESweb.org/innovations</A> </LI>
<LI>Call for Entries materials </LI>
...
<LI>Buck slips in honoree booths promoting the Innovations People's Choice Award </LI>
<LI>General International CES show signage </LI>
<LI>General International CES promotional materials, such as the CES Pre-show Planner, CES Directory and CES Show Guide</LI></UL><STRONG>Sponsor of the Innovations Design and Engineering Awards Stage - $10,000</STRONG><BR>Put your company logo on the stage where honorees present product demos throughout the show, drawing captive audiences. Sponsorship package includes your company logo on the following*: 
<UL>
<LI><A href="/awards/innovations/default.asp">www.CESweb.org/innovations</A> </LI>
<LI>Innovations Stage backdrop </LI>
<LI>Innovations Stage podium </LI>
<LI>General International CES promotional materials, such as the CES Pre-show Planner, CES Directory and CES Show Guide</LI></UL>Additionally, stage sponsors can participate in a 10-minute speaking opportunity on the stage each day of the show. This includes set up and removal time. The sponsor may demo a product, but electricity will not be available for product demos/displays. Sponsors can place one literature kiosk or publication bin with sponsor literature next to the stage in the Innovations Showcase. <BR><BR>*All sponsorship package deliverables are deadline permitting. <BR><BR><STRONG>A great thing about these promotional opportunities: <BR></STRONG>Letting your logo hang around all those winners.
