...
<head><!-- PageID 368 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Audio</title>
    <link type="text/css" rel="stylesheet" media="all" href="/css/styles.css" />
    
    <meta http-equiv="Content-Type" content="text/html;charset=utf-8" />
    <meta name="description" content="Learn, network and investigate new technology emerging in the audio industry at CES. CES features more than 550 companies in the audio industry, including manufacturers of wireless speakers, multi-room audio equipment, amplifiers and networking solutions.">
    <meta name="keywords" content="Portable audio, car audio, Wireless speakers, satellite radio, Audio networking solutions, Stereo equipment, multi-room audio equipment, source controllers,  Amplifiers, in-ceiling, in-wall, surround and outdoor speakers, Digital music, Audio hardware">
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions368','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions368" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions368','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards368','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards368" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards368','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards368','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards368','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards368','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards368','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
                
                    <li onmouseover="showSubMenu('awards368','show')"><a href="/awards/innovations/D2D617DFADC443ACA9538362B618E34E.htm">Honoree Utilities</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits368','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits368" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits368','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits368','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits368','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits368','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits368','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits368','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits368','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits368','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits368','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel368','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel368" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel368','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news368','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news368" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news368','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news368','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news368','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <a href="/audio/default.asp"><img src="/images/framework/sidebar-header-audio.gif"></a>
    <ul>
...
<div class="right-box-no-border" align="center">
    <img src="/images/framework/audio_icons_LG.gif" alt="Audio" width="176" height="175">
</div>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;Audio</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/images/photos/default.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<h2>Turning Up the Volume at CES</h2>

Disruptive technologies are rocking the "legacy" audio industry as competition accelerates between new music sources and such established sources as CDs, DVDs and AM/FM radio.&nbsp;Here's what's happening in the world of audio*: 
<UL>
<LI>Factory-level sales of traditional home audio gear rose 6 percent. </LI>
<LI>Sales of home audio components are regaining their faded glory. </LI>
<LI>The MP3/portable media player market has matured. </LI>
<LI>Apple's iPhone underscored the growing convergence of MP3 players and cellular phones. </LI>
<LI>The music industry has begun to embrace the long-vilified unrestricted MP3 format for authorized music downloads. </LI>
<LI>The digital HD radio format will enjoy a breakthrough year in 2008. </LI>
<LI>Sales of custom-installed multi-room audio and other home systems continue to rise. </LI>
<LI>Satellite radio's subscriber base keeps on growing, bolster the car audio and home audio markets.</LI></UL><A href="https://cms.ce.org/register">Register today for the 2009 International CES</A> to learn, network and investigate new technology emerging in the audio industry and many other consumer technology markets. It's free if you sign up before November 1. <BR><BR><SPAN class=smallText><EM>*Source: Digital America, a CEA publication. Most statistics reflect 2007 numbers.</EM></SPAN>
...
<div class="sub-content-header">Audio Products at CES</div>
<br />

The International CES is the place to see (and hear) manufacturers and suppliers of: 
<UL>
...
<LI>Multi-channel and home theater audio systems</LI></UL><A href="/exhibitorDirectory/default.asp">Check out the 2009 International CES Exhibitor Directory.</A>
        <br /><img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="393"></a>

<div class="sub-content-header">Just for Audio Professionals</div>
<br />

While all consumer technology markets converge at CES, it's still easy to find&nbsp;specific segments that matter to you. If audio technology is your primary interest, start by exploring these parts of the CES show floor: 
<UL>
<LI>LVCC Central Hall audio company exhibits </LI>
<LI><A href="/exhibits/displays/techZones.asp#388">DisplayPort TechZone (Sands)</A> </LI>
<LI><A href="/exhibits/displays/innovShowcase.asp">Innovations Design and Engineering Showcase (Sands)</A></LI></UL>    
                    </div>
                    <div id="inner-content-right">
                        <br />
