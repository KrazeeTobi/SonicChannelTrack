...
<head><!-- PageID 360 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Exhibitor Manual</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions360','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions360" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions360','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards360','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards360" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards360','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards360','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards360','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards360','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards360','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits360','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits360" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits360','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits360','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits360','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits360','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits360','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits360','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits360','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits360','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits360','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel360','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel360" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel360','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news360','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news360" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news360','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news360','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news360','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li class="selected"><a href="/exhibitors/manual/default.asp">Exhibitor Manual</a>
        
                <ul>
            
            <li ><a href="/exhibitors/meetingPlace.asp">CES Meeting Place Exhibitors</a></li>
        
            <li ><a href="/exhibitors/techzoneExhibitors.asp">TechZone Exhibitors</a></li>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;Exhibitor Manual</div>
                    </div>
                    ...
                    <div id="inner-content-left">
                        <h1>Exhibitor Manual</h1>
                                                               
                        

If you're looking for all the details, reminders, policies and procedures for your 2009 International CES exhibiting experience, you've come to the right place.&nbsp;The 2009 CES&nbsp;Exhibitor Manual will be here soon.&nbsp;<BR><BR>We are in the process of finalizing a new contract with GES.&nbsp;This new agreement will yield lower rates for 2009 and beyond,&nbsp;and we hope to provide you&nbsp;this new information and the new manual by September 15. <BR><BR>If you don't want to wait until then, feel free to <A href="http://www.ges.com/ecomm/2008/ces08/">reference last year's Exhibitor Manual (pdf)</A>.<BR><BR>Download the 2009 target freight maps below to determine your targeted move-in and move-out dates for the 2009 International CES. Please note: These maps are updated on occasion and&nbsp;dates are subject to change.<BR><BR>Once you have determined your target freight dates, you can make shipping plans accordingly. This also helps you determine personnel scheduling and hotel reservation requirements for the show. If you have any questions regarding the target maps, please contact your operations liaison below.<BR><BR>Download the <A href="/docs/2009InternationalCESTarget_Information.pdf" target=_blank>overall target move-in and move-out</A> information (including the Marshalling Yard map) now.&nbsp; Then&nbsp;select the map below that corresponds to&nbsp;your booth&nbsp;location to determine your dates. 
<UL>
<LI>Las Vegas Hilton [<A href="/docs/CES-0901-lvcc_MI-H_7-31-08.pdf">move-in</A> | <A href="/docs/CES-0901-lvcc_MO-H_7-31-08.pdf">move-out</A>] </LI>
<LI>LVCC Central Hall [<A href="/docs/CES-0901-lvcc_MI-C_7-31-08.pdf">move-in</A> | <A href="/docs/CES-0901-lvcc_MO-C_7-31-08.pdf">move-out</A>] </LI>
<LI>LVCC North Hall [<A href="/docs/CES-0901-lvcc_MI-N_7-31-08.pdf">move-in</A> | <A href="/docs/CES-0901-lvcc_MO-N_7-31-08.pdf">move-out</A>] </LI>
<LI>LVCC North Hall Upper Level Meeting Rooms [<A href="/docs/CES-0901-lvcc_MI-UMR_7-31-08.pdf">move-in</A> | <A href="/docs/CES-0901-lvcc_MO-UMR_7-31-08.pdf">move-out</A>] </LI>
<LI>LVCC South Hall 1 [<A href="/docs/CES-0901-lvcc_MI-S1_7-31-08.pdf">move-in </A>| <A href="/docs/CES-0901-lvcc_MO-S1_7-31-08.pdf">move-out</A>] </LI>
<LI>LVCC South Hall 2 [<A href="/docs/CES-0901-lvcc_MI-S2_7-31-08.pdf">move-in </A>| <A href="/docs/CES-0901-lvcc_MO-S2_7-31-08.pdf">move-out</A>] </LI>
<LI>LVCC South Hall 3 [<A href="/docs/CES-0901-lvcc_MI-S3_7-31-08.pdf">move-in</A> | <A href="/docs/CES-0901-lvcc_MO-S3_7-31-08.pdf">move-out</A>] </LI>
<LI>LVCC South Hall 4 [<A href="/docs/CES-0901-lvcc_MI-S4_7-31-08.pdf">move-in</A> | <A href="/docs/CES-0901-lvcc_MO-S4_7-31-08.pdf">move-out</A>] </LI>
<LI>Sands [<A href="/docs/CES-0901-secc_MI_7-31-08.pdf" target=blank>move-in </A>| <A href="/docs/CES-0901-secc_MO7-31-08.pdf" target=blank>move-out</A>]<BR><STRONG></STRONG></LI></UL>
<P><STRONG>Target Map Inquiries<BR></STRONG>Please contact <A href="mailto:CESfreight@GES.com">CESfreight@GES.com</A>.<BR><BR><STRONG>Operations Contacts<BR></STRONG>Las Vegas Convention Center and Las Vegas Hilton - <A href="mailto:kswearingen@ce.org">Katie Swearingen</A>, 703-907-7637 <BR>Sands Expo and Convention Center - <A href="mailto:msproehnle@ce.org">Martha Sproehnle</A>, 703-907-5243<BR>The Venetian - <A href="mailto:gberube@ce.org">Gaiya Berube</A>, 703-907-7685</P>
