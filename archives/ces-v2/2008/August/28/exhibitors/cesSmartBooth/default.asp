...
<head><!-- PageID 362 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - CES SmartBooth</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions362','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions362" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions362','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards362','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards362" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards362','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards362','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards362','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards362','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards362','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits362','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits362" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits362','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits362','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits362','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits362','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits362','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits362','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits362','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits362','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits362','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel362','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel362" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel362','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news362','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news362" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news362','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news362','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news362','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li class="selected"><a href="/exhibitors/cesSmartBooth/default.asp">CES SmartBooth</a></li>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;CES SmartBooth</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/cesSmartBooth/default.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>CES SmartBooth</h1>
                                                               
                        

<A href="https://myces.bdmetrics.com/exhibitorportal" target=_blank><IMG height=51 hspace=10 src="/images/content/SmartBooth_260trans.gif" width=260 align=right border=0></A>CES SmartBooth is a powerful, web-based prospecting and measurement tool that allows you to maximize and continue your show investment before, during and after CES. <BR><BR>Every CES exhibitor receives a free <A href="https://myces.bdmetrics.com/exhibitorportal/" target=_blank>MyCES Exhibitor Portal</A> that allows you to:
<UL>
<LI>Complete your company information for the online MyCES directory and the printed Official International CES <EM>Show Directory</EM>. </LI>
<LI>Be found online by attendees leading up to the show and buyerssearching the Internet. </LI>
<LI>Detect how many buyers of your products and services have registered for CES.&nbsp; </LI>
<LI>Attract the right attendees your booth and schedule face-time with your top prospects. </LI></UL>
<P>In addition, you can select other <A href="/docs/MyCESPromo_Opp_Flyer.pdf" target=_blank>SmartBooth tools to further increase brand awareness with an enhanced Smartbooth Marketing Package (pdf)</A>. Contact&nbsp;<A href="mailto: tim.rader@bdmetrics.com" target=_blank>Tim&nbsp;Rader </A>at 410-402-1056.<BR><BR>As 2009 International CES approaches, SmartBooth automatically: </P>
<UL>
<LI>Identifies your best prospects from the list of pre-registered attendees </LI>
<LI>Adds your company to attendees' "Exhibitors to Visit" list </LI>
<LI>Highlights your booth on attendees' Personal Walking Maps </LI>
<LI>Delivers your custom message, invitation or announcements to highly qualified leads</LI></UL>
<P><STRONG>NEW FOR 2009</STRONG> - Promote your brand and increase your online visibility with an Enhanced Listing. Over 1.4 million searches and 5.7 million page views were conducted by members of the MyCES community last year. Make sure your company is found and viewed in the best light with an Enhanced Listing ($495). With an Enhanced Listing you get the following:</P>
<UL>
<LI>Your company logo added to your online listing. </LI>
<LI>Unlimited online company information text in addition to the 300 character print directory company description. </LI>
<LI>Highlight your new produts and company announcements with online press releases. </LI>
<LI>Unlimited product listings.</LI></UL>
<P>Order an Enhanced Listing when you create your profile in your MyCES Exhibitor Portal.</P>
<P><A href="https://myces.bdmetrics.com/exhibitorportal" target=_blank>Login to your free MyCES Exhibitor Portal</A>* today to take advantage of these benefits and more. The sooner you update your information, the sooner attendees can find you.</P>
<P>For more information on other MyCES and SmartBooth opportunities, check out the <A href="/docs/Promo_Opps_Flyer_Update_-_8.27.08.pdf" target=_blank>2009 MyCES Promotional Opportunity Flyer (pdf)</A>.</P>
<P><SPAN class=smallText>*Note: Login required. Your company's credentials were e-mailed to the main exhibitor representative we have on file. For assistance e-mail <A href="mailto:Support@BDMetrics.com">Support@BDMetrics.com</A> or call 800-931-5103 and select option 1.</SPAN></P>
