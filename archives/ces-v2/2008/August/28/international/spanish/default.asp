...
<head><!-- PageID 1110 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Espa&ntilde;ol</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions1110','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions1110" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions1110','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards1110','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards1110" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards1110','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards1110','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards1110','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards1110','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards1110','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits1110','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits1110" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits1110','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1110','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1110','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1110','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1110','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1110','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1110','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1110','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1110','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel1110','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel1110" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel1110','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news1110','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news1110" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news1110','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news1110','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news1110','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li ><a href="/international/spanish/delegations.asp">Programa de grupos de delegaciones</a></li>
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        ...
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Resources</a>&nbsp;&gt;&nbsp;Espa&ntilde;ol</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/international/spanish/default.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<h2>Esto es Tiempo para Registrarse</h2>

Con&eacute;ctese con l&iacute;deres empresariales, miembros de la prensa y analistas. Investigue la nueva tecnolog&iacute;a. Inf&oacute;rmese sobre los pr&oacute;ximos e innovadores productos a trav&eacute;s de m&aacute;s de 2.700 expositores. CES presenta 30 categor&iacute;as de productos, entre ellas, audio, imagen digital, home theater, redes hogare&ntilde;as, tecnolog&iacute;a para el veh&iacute;culo e inal&aacute;mbrica. Si usted est&aacute; en el negocio de consumo de productos electr&oacute;nicos, nada se compara con el CES&reg; Internacional, del jueves 8 al domingo 11 de enero de 2009, en Las Vegas, Nevada, EE.UU. Aproveche la inscripci&oacute;n gratuita hasta el 1 de noviembre de 2008. <A href="https://cms.ce.org/register">Reg&iacute;strese ahora.</A><BR><A href="/register"></A>
...
<div class="sub-content-header">Esto es el A&ntilde;o para Usted</div>
<br />

El CES Internacional se ha convertido en un important&iacute;simo evento global que atrae a m&aacute;s de 130.000 asistentes de 140 pa&iacute;ses. Si est&aacute; pensando en viajar a CES desde fuera de EE.UU., entonces, &eacute;ste es el a&ntilde;o para usted. Debido al valor del d&oacute;lar estadounidense, los viajes internacionales a EE.UU. son ahora m&aacute;s accesibles de lo que han sido en a&ntilde;os. <A href="/docs/SP_Visa_Interview_Tips_FNL.pdf" target=_blank>Obtenga m&aacute;s informaci&oacute;n sobre el viaje y la visa.</A>
        <br /><img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="1257"></a>

<div class="sub-content-header">Informaci&oacute;n para el visitante internacional</div>
<br />

<A >Programa de grupos de delegaciones<BR></A>La Exposici&oacute;n Internacional CES atrae a una enorme audiencia internacional por su programa de delegaciones exitoso. Aprenda c&oacute;mo organizar una delegaci&oacute;n en su pa&iacute;s o regi&oacute;n o c&oacute;mo sumarse a una.
<P><A href="/international/spanish/services.asp">Servicios internacionales<BR></A>Entre la gran cantidad de beneficios que se ofrecen a los participantes internacionales se encuentran los int&eacute;rpretes, las recepciones especiales para hacer contactos, las &aacute;reas de trabajo dedicadas, las salas de reuniones y muchos m&aacute;s.</P>
<P><A href="/docs/2009FACTSHET_q6_ES.pdf" target=_blank>Informaci&oacute;n general (pdf)</A><BR>&iexcl;Aprenda sobre la historia de la exposici&oacute;n, las categor&iacute;as actuales de productos, las pr&oacute;ximas fechas y mucho m&aacute;s en su idioma! </P>    
                    </div>
                    <div id="inner-content-right">
                        <br />
