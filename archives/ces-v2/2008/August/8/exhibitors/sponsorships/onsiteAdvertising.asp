...
<head><!-- PageID 636 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions636','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions636" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions636','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards636','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards636" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards636','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards636','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards636','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards636','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards636','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits636','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits636" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits636','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits636','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits636','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits636','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits636','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits636','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits636','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits636','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits636','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel636','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel636" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel636','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news636','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news636" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news636','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news636','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li class="selected"><a href="/exhibitors/sponsorships/onsiteAdvertising.asp">On-site Advertising</a></li>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/sponsorships/default.asp" class="footer">Promotional Opportunities</a>&nbsp;&gt;&nbsp;On-site Advertising</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/sponsorships/onsiteAdvertising.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<div class="page_header_block">
    <div class="blue_box">
        ...
        <li><a href="#716">The CE Channel - Be Seen And Heard At CES</a></li><!---->
...
<div class="intertitle">
    <br />
    Let us help you identify what 2008 International CES sponsorship opportunities ensure you meet&nbsp;- and exceed - your company's marketing goals. <A href="/exhibitors/sponsorships/contactRep.asp">Contact a CES promotions representative today.</A><BR>
</div>
...
<br />Undoubtedly among the most prominent on-site promotional opportunities at CES, banners guarantee exposure to more than 130,000 consumer technology professionals. Exterior banners are often the first impression CES attendees have of their experience at the show. Interior banners grab attention and become the most talked about forms of marketing. They're used as directional guides ("Go past the Intel banner in the South Hall corridor."), meeting points ("Meet me under the TI banner in the Grand Lobby.") and what many other marketing campaigns at CES are measured by. Think big, think banners. 
<P><STRONG>Marketing Investment<BR></STRONG>$4,000-$25,000 for LVCC North, Central and South Hall Interior Banners and Kiosks</P>
<P><STRONG>Contact<BR></STRONG>Manager, Promotional Opportunities, International CES<BR>Phone: 703-907-4307<BR>E-mail: <A href="mailto:byb@CE.org">byb@CE.org</A> </P>
<TABLE cellSpacing=4 cellPadding=0 border=0>
<TBODY>
<TR target="_blank">
<TD vAlign=top><A href="/images/content/08-119-0_2797b.jpg" target=_blank><IMG height=122 src="/images/content/08-119-0_2797a.jpg" width=200 border=0><BR>Click for larger image.</A><BR><STRONG>Shuttle Bus Banner and Kiosk Example<BR></STRONG><BR></TD>
<TD width=4></TD>
<TD vAlign=top><A href="/images/promotions/08-119-0_2880b.jpg" target=_blank><IMG height=140 src="/images/content/08-119-0_2880a.jpg" width=200 border=0><BR>Click for larger image.</A><BR><STRONG>Grand Lobby Interior Banner Example</STRONG></TD></TR>
<TR>
<TD vAlign=top><A href="/images/promotions/08-119-0_2849b.jpg" target=_blank><IMG height=121 src="/images/content/08-119-0_2849a.jpg" width=200 border=0><BR>Click for larger image.</A><BR><STRONG>North Hall Exterior Banner Example</STRONG><BR><BR><BR></TD>
<TD width=4></TD>
<TD vAlign=top><A href="/images/promotions/08-119-0_2895b.jpg" target=_blank><IMG height=121 src="/images/content/08-119-0_2895a.jpg" width=200 border=0><BR>Click for larger image.</A><BR><STRONG>South Hall&nbsp;Patio&nbsp;Banner Example<BR></STRONG><BR><BR></TD></TR>
<P>
<TR>
<TD vAlign=top><A href="/images/promotions/08-119-0_2827b.jpg" target=_blank><IMG height=121 src="/images/content/08-119-0_2827a.jpg" width=200 border=0><BR>Click for larger image.</A><BR><STRONG>South Hall Connector&nbsp;Banner Example</STRONG><BR></TD>
<TD width=4></TD>
<TD vAlign=top><A href="/images/promotions/08-119-0_2893b.jpg" target=_blank><IMG height=122 src="/images/content/08-119-0_2893a.jpg" width=200 border=0><BR>Click for larger image.</A><BR><STRONG>South Hall Exterior Banner Example</STRONG></TD></TR></P></TBODY></TABLE>
<P></P>
...
<br />Put your technology to work with this in-kind sponsorship opportunity. Supply computers and printers for the e-mail stations, MyCES Personal Planner stations, and computers and printers used in other high-visibility show management locations such as the CES Concierge Center, information counters and registration areas. Sponsor provides equipment and technical support.
<P><STRONG>Marketing Investment</STRONG><BR>Sponsorship value up to $50,000, depending on how much equipment is supplied (actual cost to sponsor is zero, as this is an in-kind sponsorship).</P>
<P><STRONG>Contact</STRONG><BR>Manager, Promotional Opportunities, International CES<BR>Phone: 703-907-4307<BR>E-mail: <A href="mailto:byb@CE.org">byb@CE.org</A> </P>
...
<div class="sponsorshipTitle">Outdoor Promotional Opportunity Space:&nbsp;<span class="lt_blue">$10,000+</span></div>

<br />Space is available for promotional displays, outside and in the lobby areas, for static promotional products such as custom inflatables, cars, interactive kiosks and more. Have an idea? Call us! 
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
<TBODY>
<TR>
<TD vAlign=top>
<P><BR><B>Marketing Investment</B><BR>$10,000 - $20,000<BR><BR><B>Contact</B><BR>Manager, Promotional Opportunities, International CES<BR>Phone: 703-907-4307<BR>E-mail: <A href="mailto:byb@CE.org">byb@CE.org</A><BR></P>
<TD width=200><A href="/images/content/onsite-inflatable-large.jpg" target=_blank><IMG height=140 src="/images/content/onsite-inflatable-small.jpg" width=200 border=0><BR>Click for larger image.</A></TD></TR></TBODY></TABLE>
...
<br /><SPAN class=section_title>Reach your target audience with shuttle-related advertising programs on the popular International CES shuttles. With almost 40,000 riders a day, vehicle graphics and headrest covers provide impact and visibility. Custom audio and video programs get attendees' undivided attention before they arrive at the convention center. Let our expertise help drive attendees to your booth! </SPAN>
<P><SPAN class=section_title><STRONG>Marketing Investment</STRONG><BR>$5,000+</SPAN></P>
<P><SPAN class=section_title><STRONG>Deadline</STRONG><BR>Reservations due November 19 </SPAN></P>
<P><SPAN class=section_title><STRONG>Contacts</STRONG><BR>Bob Kaplan, Director of Promotional Marketing<BR>Phone: 800-616-2622<BR>E-mail: <A href="mailto:bobk@cmac.net">mailto:bobk@cmac.net</A></SPAN></P>
<TABLE cellSpacing=0 cellPadding=0 border=0>
<TBODY>
<TR target="_blank">
<TD vAlign=top><A href="/images/content/ads_shuttleBusWrap_large.jpg" target=_blank><IMG height=99 src="/images/content/ads_shuttleBusWrap.jpg" width=200 border=0><BR>Click for larger image.<BR></A>Exterior Bus Wrap</A><BR><BR></TD>
<TD width=10>&nbsp;</TD>
<TD vAlign=top><A href="/images/content/ads_shuttleBusHeadrest_large.jpg" target=_blank><IMG height=100 src="/images/content/ads_shuttleBusHeadrest.jpg" width=200 border=0><BR>Click for larger image.<BR></A>Interior Bus Headrest</A></TD></TR></TBODY></TABLE>
...
<div class="sponsorshipTitle">The CE Channel - Be Seen And Heard At CES:&nbsp;<span class="lt_blue">Call for details</span></div>

<br /><SPAN class=section_title><IMG src="/images/content/hotice.gif" align=right>Deliver your marketing and sales message with the power of television on The CE Channel, airing on TV in 72,000 hotel rooms during CES with video coverage of the show. For more information go to <A href="http://www.thecechannel.tv/" target=_blank>http://www.thecechannel.tv/</A> or call Steve Nelson at 413-623-2221. </SPAN>
<P></P>
