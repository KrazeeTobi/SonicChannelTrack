...
<head><!-- PageID 336 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions336','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions336" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions336','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards336','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards336" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards336','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards336','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards336','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards336','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards336','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits336','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits336" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits336','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits336','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits336','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits336','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits336','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits336','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits336','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits336','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits336','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel336','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel336" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel336','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news336','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news336" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news336','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news336','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<H3><IMG height=125 hspace=8 src="/images/photos/p15.jpg" width=165 align=right>Media and Analyst Assistance</H3>If you are a reporter or an analyst and have questions about the show, please contact <A href="mailto:tdunion@ce.org">Tara Dunion </A>at 703-907-7419 or <A href="mailto:sszabo@ce.org">Sarah Szabo </A>at 703-907-4368.<BR><BR>On-site, you can reach the CES Communications Staff in the Press Room by calling 702-943-3521.<BR><BR>For registration, please contact the CES Media/Analyst Center at 703-907-4365.<BR><BR>
<H3>Broadcast Media Assistance</H3>CES provides Web, radio and TV broadcast media with state-of-the-art technology to help you cover the show. We can tailor a small reporting studio for you or help you find an exciting spot on the show floor and provide the equipment for a 5-minute stand-up for your anchors. Whatever your needs, CES will help you get your story.<BR><BR>For more information, contact the CES Broadcast Office at 703-907-7419.<BR><BR>
...
<P><A href="mailto:cslater@CE.org" target=_blank>Carolyn Slater</A> <BR>Manager: CEA Publications<BR>703-907-7945<BR><BR><A href="mailto:mchisholm@CE.org" target=_blank>Mark Chisholm</A><BR>Coordinator: CEA Publications<BR>703-907-5229<BR><BR><BR><A href="mailto:mhenning@CE.org" target=_blank>Meghan Henning</A><BR>Senior Manager: International Trade, Spectrum, Multichannel Video, Specialty Retail, Technology Standards<BR>703-907-7654<BR></P></TD>
<TD vAlign=top>
<P><A href="mailto:clerro@CE.org" target=_blank>Colleen Lerro</A><BR>Senior Communications Coordinator: Accessories, Digital Imaging<BR>703-907-7080</P>
<P><A href="mailto:skidera@CE.org" target=_blank>Steve Kidera<BR></A>Coordinator: Industry Statistics, Market Research<BR>703-907-4358&nbsp; &nbsp;<BR><BR><A href="mailto:mpollock@CE.org" target=_blank>Megan Pollock<BR></A>Senior Manager: HDTV, Intellectual Property, V-Chip, Women and Technology 703-907-7668 <BR><BR><A href="mailto:jbemisderfer@CE.org" target=_blank>Jennifer Bemisderfer</A><BR>Senior Manager: In-Vehicle Electronics, Recycling, Energy Efficiency, Environmental Policy <BR>703-907-4322<BR><BR><A href="mailto:lhubbard@CE.org" target=_blank>Laura Hubbard</A><BR>Manager: Audio, Multi-Room Audio Video, TechHome, Builder Initiative, Small Business Council <BR>703-907-4326</P></TD></TR></TBODY></TABLE>
