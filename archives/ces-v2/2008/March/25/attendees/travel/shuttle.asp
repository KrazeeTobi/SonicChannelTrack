...
<a href="/attendees/travel/hotel.asp">Hotel Reservations</a><br>
    ...
    <span class="nav_fourth" id="fourth_row_container335" style="display: none;">
        ...
        <span class="nav_fourth_arrow"><b>&gt;</b> &nbsp;</span><a href="/attendees/travel/rd_block_request2009.asp">2009 Block Request Form</a>
              <script language="JavaScript">
              <!--
                  if (checkActiveNav("/attendees/travel/rd_block_request2009.asp") && document.getElementById("fourth_row_container335")) { document.getElementById("fourth_row_container335").style.display = "";}
              //-->
              </script><br>
...
<span class="text">
The International CES offers complimentary shuttle service on show days.&nbsp; One system&nbsp;runs back and forth between the Las Vegas Convention Center and all official CES hotels.&nbsp;&nbsp;The other&nbsp;system runs back and forth&nbsp;between the same official CES&nbsp;hotels and the Sands Expo and Convention Center/The Venetian, home to Innovations Plus and other emerging technology displays and exhibitors.<BR><BR>Check back in early June for a complete shuttle schedule. </span>
