...
<html>
<head><!-- PageID 1926 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;LVCC South Halls/Ground</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/show_floor/south12.asp';
...
<a href="/attendees/show_floor/areas.asp">Exhibit Areas</a><br>
    ...
    <span class="nav_fourth" id="fourth_row_container3747" style="display: none;">
        ...
        //-->
            </script>LVCC South Halls/Ground
        <br>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue1926', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue1926', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue1926" id="leftAddedValue1926" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Las Vegas Convention Center, South Halls 1-2, Ground Level<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<IMG src="/images/general/icon_South_Hall1and2_large_june05.gif"><BR><BR>For those who are interested in the latest in home theater and home networking, Las Vegas Convention Center’s South Halls 1 and 2 are the halls you need to explore. <BR><BR>South Hall opens at 9 a.m. Monday, January&nbsp;7 (one hour early). Here you'll find: 
<UL>
<LI>South Hall 1 - Booth #s 20000-22999 </LI>
<LI>South Hall 2 - Booth #s 25000-27999 </LI>
...
<LI>Conference registration&nbsp;(Money-saving tip: <A href="https://cms.ce.org/register">Register now</A>.) <BR><BR></LI>
<LI>Satellite systems exhibits <BR><BR></LI>
<LI>Home systems exhibits, featuring:<BR>- Home data networking<BR>- Integrated home systems <BR><BR></LI>
<LI>Home theater exhibits, featuring: <BR>- Audio receivers and components<BR>- Custom installation<BR>- Video<BR><BR></LI>
<LI><IMG height=69 src="/images/general/KeyAtt_Gaming_150.gif" width=150 align=right>Gaming Showcase - New Key Attraction!<BR>The Gaming Showcase at the 2008 International CES features gaming hardware and software with the entire range of consumer electronics products — from online PC and HD gaming, plasma HDTV and home theater furniture to surround sound and power conditioning hardware.<BR><BR><BR></LI>
<LI>Specialty Dealer Days - New Key Attraction!<BR><SPAN class=text_colored>Produced by<BR></SPAN><IMG height=72 src="/images/general/eh_pub_logo_150.gif" width=150 align=left>CES is offering independent retailers, custom integrators and installers a special program of networking opportunities, product previews, conference sessions, keynote tickets, a special lounge on the show floor… and <A href="/attendees/show_floor/specialtydealer.asp">much more</A>!</LI></UL></span>
...
<span class="text">
<IMG height=6 src="/global_images2005/spacer.gif"><BR><IMG height=27 src="/images/partners/techzone_small.gif" width=120><BR><IMG height=18 src="/global_images2005/spacer.gif"><BR>
<STRONG>Advanced Display Technologies<BR></STRONG><IMG height=78 src="/images/partners/ADT-DigitalSearchLogo.gif" width=100 align=right>Sponsor: DisplaySearch <BR>The Advanced Display Technologies TechZone showcases the latest developments in all advanced display technologies from around the world covering a-Si TFT LCDs, LTPS TFT LCDs, AMOLEDs, PMOLEDs, PDPs, flexible, reflective and 3D displays for a wide variety of applications ranging from mobile phones to TVs and more. <BR><BR><STRONG><BR><IMG height=79 src="/images/partners/BLURAY_LG.gif" width=150 align=right>Blu-ray Disc™<BR></STRONG>Sponsor: Blu-Ray Disk Association <BR>Meeting the need for high-definition video, the Blu-ray Disc is here.&nbsp; Blu-ray offers five to 10&nbsp; times more storage capacity than DVD, offering room for interactive and bonus features for Hollywood movies or more room for storing personal, digital assets such as photos, music, data and video. 
<STRONG><BR>HD DVD <BR></STRONG>Sponsor: HD DVD Promotion Group <BR>The high-definition wait is over. HD DVD is here, providing six times the resolution of standard DVD with full 1080p resolution and 7.1 surround sound, making images crisper and audio pitch-perfect. 
<STRONG><BR><BR><BR><IMG height=39 src="/images/partners/HDMI_140x39.gif" width=140 align=right>HDMI<BR></STRONG>Utilizing only a single, intelligent cable, HDMI provides an all-digital interface that supports all audio and video formats.<BR><BR><STRONG><IMG height=36 src="/images/partners/HomePlug_logo.GIF" width=150 align=right>HomePlug</STRONG><BR>Sponsor: HomePlug Alliance <BR>HomePlug is an industry alliance comprised of industry leaders at each level of the value chain, including: service and content, retail, hardware, software, silicon and technology.<BR>
<STRONG>Sustainable Technologies<BR></STRONG>Sponsor: U.S. Agency for International Development &amp; U.S. Department of State Digital Freedom Initiative <BR>The Sustainable Technologies TechZone features environmentally and economically sustainable technologies which contribute to the social and cultural growth of the developing world. 
<BR><STRONG><BR><IMG height=84 hspace=6 src="/images/partners/TechHome_small.gif" width=90 align=right>TechHome<BR>Sponsor: CEA's TechHome Division</STRONG><BR>See the newest advances in tomorrow's smart home. Check out the networked home products that increase efficiency, conserve energy or make consumers' home lives easier. <BR><BR><BR><STRONG>ZigBee</STRONG>
<STRONG>Sponsor: The ZigBee Alliance<BR></STRONG><IMG height=56 src="/images/partners/zigbee_sm110.gif" width=110 align=right>ZigBee is the wireless connection used by sensors (security, rain gauges, lights) and control devices (thermostats, timers, remote controls) ideally suited for the home. <STRONG><BR></STRONG><BR><A href="/attendees/show_floor/techzones/default.asp">See all CES TechZones.</A>
</span>
<!-- text for main page -->
</div>
