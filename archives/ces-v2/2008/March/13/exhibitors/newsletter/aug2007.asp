...
<html>
<head><!-- PageID 4531 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;August 2007</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/exhibitors/newsletter/aug2007.asp';
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue4531', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue4531', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue4531" id="leftAddedValue4531" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="section_title">Exhibitor Registration Is Now Open</div>
<span class="text">
<SPAN style="FONT-FAMILY: "><A href="http://www.cesweb.org/exhibitors/resource_center/badges/default.asp" target=_blank>It's time to register</A> your booth staff and top&nbsp;10 buyers.&nbsp;Register by December 11, 2007,&nbsp;to have your badges mailed&nbsp;to you.<BR><BR></SPAN><SPAN style="FONT-FAMILY: ">Questions? Contact International CES Exhibitor Registration Customer Service at (866) 233-7968 or <A href="mailto:exhreg@CE.org">exhreg@CE.org</A>.</SPAN>
</span>
<a name="4560"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Major Improvements Planned For McCarran Airport</div>
<span class="text">
<SPAN style="FONT-FAMILY: ">The Clark County Department of Aviation is embarking on a $12 million construction project aimed at alleviating baggage claim headaches at Las Vegas' McCarran International Airport. McCarran will also use radio frequency transmitters to track luggage. McCarran is one of two airports in the world that uses this type of tags. <A href="/attendees/travel/default.asp">More travel/transit information.</A></SPAN>
</span>
...
<tr>
    ...
    <!-- article start -->
    <p><strong>Leverage CES to Promote Your Brand Worldwide</strong><br> by Dan Cole</p>
    <p><SPAN style="FONT-FAMILY: ">This summer CEA celebrates the success of two international events: HomeTech Middle East and SINOCES. HomeTech brought CE to the forefront of the Middle East when it was held in Dubai of the United Arab Emirates in May. Last month, SINOCES in Qingdau, China had its best show ever. For both events, CEA helps its members exhibit overseas and also widely promotes its own CES brand to encourage more international visitors to come to what has become the world’s largest technology trade show held in Las Vegas.</SPAN>
<P><SPAN style="FONT-FAMILY: ">HomeTech Middle East and SINOCES are just two key steps in how we promote CES year-round on a worldwide basis. As a result of our powerful marketing campaign, we welcomed our largest international attendance ever in 2007 with more than 27,000 attendees from 140 countries, an increase of six percent over 2006 figures. A total of 48 formal delegations attended CES in 2007, including six attending for the first time from Australia, Dominican Republic, United Arab Emirates, Germany, Morocco and Peru.&nbsp; </SPAN></P>
<P><SPAN style="FONT-FAMILY: ">And if that was not enough, consider the fact that 1,228 international journalists representing 73 different countries came to the show in 2007, a stat up 28 percent from 2006.</SPAN></P>
<P style="tab-stops: 0in"><SPAN style="FONT-FAMILY: ">This influx of international attendees puts CES – and more importantly, YOU – on a powerful global stage. You can leverage CES to catapult your brand internationally. Exhibitors that are interested in expanding their reach abroad or investigating doing business abroad can take advantage of the programs from the Department of Commerce (DOC) U.S. Commercial Services (CS) that CES offers in Las Vegas. </SPAN></P>
<P style="tab-stops: 0in"><SPAN style="FONT-FAMILY: ">Check a box in your SmartBooth registration to indicate if you are interested in exporting or importing. If you check this box, we ask for some additional information. Then, in preparation for the show, we pull these exhibitors and their exhibitor listings and create an Export Interest Directory. This directory is made available to DOC staff who then recruits overseas buyers for the show. It’s a great opportunity for small to medium-sized businesses that want access to international markets, but don’t have the funds to travel around the world and look for customers and distributors.</SPAN></P></p>
    <!-- article end -->
    <p>Continued on <a href="/exhibitors/newsletter/aug2007pro.asp">next page</a>.<br></p>
    </td>
</tr>
</table>
    <br><br><br>
