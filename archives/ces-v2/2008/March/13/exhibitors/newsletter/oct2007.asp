...
<html>
<head><!-- PageID 4747 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;October 2007</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/exhibitors/newsletter/oct2007.asp';
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue4747', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue4747', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue4747" id="leftAddedValue4747" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<br><div align="center">
 ...
 &nbsp; 
    ...
    [ <a href="/oct2007pro.asp">Promotions</a> ]
 &nbsp;

    [ <a href="/oct2007ev.asp">Events</a> ]
 &nbsp;

    [ <a href="/oct2007ops.asp">Operations</a> ]
...
<div class="section_title">New CES Exhibitor Communication Tool - Coming Thursday, October 4</div>
<span class="text">
On Thursday, October 4, 2007,&nbsp;CEA will send you an e-mail regarding our new desktop communication tool, CES Alert. This tool will&nbsp;allow us to send messages directly to your desktop – eliminating any doubt that the message is from the International CES. This would not replace any of the tools we currently have, it&nbsp;would simply complement what we are already doing and allow us to keep you informed without having to send more e-mails.<BR><BR><IMG src="/images/general/CESAlert.jpg" align=right>On Thursday,&nbsp;you will be asked to download this application to your desktop and will be provided with a username and password needed to complete the download. After successfully downloading CES Alert, a small CES icon will be added to the taskbar along the bottom&nbsp;of your desktop.&nbsp;When a CES Alert message is sent, a bubble will pop up to alert you;&nbsp;when you click on the bubble, the full&nbsp;message will appear in the form you see&nbsp;here&nbsp;to the right of this article.&nbsp;Many people are familiar with <A title=WeatherBug href="http://weather.weatherbug.com/" target=blank>WeatherBug®</A>,&nbsp;and this will work in a very similar manner. <BR><BR>Once you complete your download, you should receive your first message welcoming you to CES Alert. After that, you will begin to receive messages as they are posted. Messages will include important exhibitor information like show news and approaching deadlines so be sure to check these alerts as they come in!
</span>
<a name="4770"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Take The Guesswork Out Of Navigating Las Vegas — Let CES Do It For You</div>
<span class="text">

<P><IMG height=130 src="/images/general/2k8_CES_CEA_150.gif" width=150 align=right>CES will once again be running <A href="/attendees/travel/shuttle.asp">complimentary shuttles</A> to and from all <A href="/attendees/travel/hotel.asp">official CES hotels</A>. These free shuttles will run Sunday, January 6 through Thursday, January 10. Take the Sands/Venetian Express to visit the high-performance audio & home theater exhibits at The Venetian. This service operates every 10 minutes, Sunday through Thursday. <BR><BR><A href="/attendees/travel/shuttle.asp">Download the latest shuttle map and schedule here</A>.<BR><BR></P>
</span>
<a name="4771"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">International Exhibitors – Schedule Your Visa Interviews Now</div>
<span class="text">
Wait times for a visa interview can be several weeks or more in many countries, especially during peak travel periods. Place your request for a letter of invitation to attend the 2008 International CES as soon as possible, and <A href="/international/english/travel.asp">learn more here</A>.
</span>
<a name="4772"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Learn How to Expand Your Business Overseas With ShowTime</div>
<span class="text">

<P>The U.S. Department of Commerce’s Commercial Service (USCS), in cooperation with the International CES, will present their well-respected ShowTime program at the 2008 CES. ShowTime provides U.S. exhibitors with information on doing business overseas and gives you the opportunity to meet one-on-one with USCS Technology Industry Specialists from U.S. embassies around the world.<BR><BR>With a network of trade specialists in more than 80 countries worldwide, the Commercial Service provides a number of benefits to small and midsized U.S. businesses. Highlights include:</P>
<UL>
<LI>Introductions to international partners and distributors </LI>
<LI>Counseling and advocacy, including how to do business in their country </LI>
<LI>Trade events that promote products or services to qualified buyers </LI>
<LI>World-class market research</LI></UL>
<P>ShowTime will be held Tuesday and Wednesday, January 8 and 9, 2008. Please indicate your interest in exporting when completing your International CES Official Show Directory listing, powered by CES SmartBooth. Your name will be included in our Export Interest Directory, which is sent to Commercial Specialists around the world. Stay tuned for updates on ShowTime.<BR></P>
</span>
...
<tr>
    ...
    <!-- article start -->
    <p><strong>Catapult Your Brand onto a Worldwide Stage</strong><br> by Dan Cole</p>
    <p><SPAN style="FONT-FAMILY: "><SPAN style="FONT-FAMILY: ">Media attention is one of the top reasons companies choose to participate in CES every year. No other industry event brings together as many big names in media. More than 4,500 members of the media and 2,200 analysts come to CES in January to see what the industry has to offer.</SPAN></SPAN>
<P><SPAN style="FONT-FAMILY: "><SPAN style="FONT-FAMILY: ">How you position your company at CES will mold how the media think of you all year long. With this many media in one location, it’s one of your best opportunities to get your brand featured on a worldwide stage. </SPAN></SPAN></P>
<P><SPAN style="FONT-FAMILY: "><SPAN style="FONT-FAMILY: ">While CES can seem vast, it is the best time for you to get personal with the media.&nbsp; Reporters and analysts want to meet with you one-on-one. But, their calendars fill up fast and you need to start contacting them now to set expectations and&nbsp;start setting appointments with your key media by early December.</SPAN></SPAN></P>
<P><SPAN style="FONT-FAMILY: "><SPAN style="FONT-FAMILY: ">Begin by sending out press releases in October about the news you plan to make at the show or what kind of vision you have for the industry for 2008. Use Virtual Press Office and BusinessWire, the two CES news distribution partners, to help you get the word out.&nbsp; They constantly review their media lists to make sure the right reporter is getting the right kind of news. Plus, with their services, you can add multimedia materials to your press release. You even can build your press kit online. Small tip: remember to put your booth number on all your press materials. </SPAN></SPAN></P>
<P><SPAN style="FONT-FAMILY: "><SPAN style="FONT-FAMILY: ">Beginning November 1, make sure to take advantage of our CES pre-registered media/analyst list&nbsp;posted on CESweb.org. Before the show, this list is the best way to contact press covering your specific product categories. Make sure you update your listing by October 19 to maximize your exposure and to receive our monthly exhibitor PR newsletter sent exclusively to exhibitor PR contacts.</SPAN></SPAN></P></p>
    <!-- article end -->
    <p>Continued on <a href="/oct2007pro.asp">next page</a>.<br></p>
    </td>
</tr>
</table>
    <br><br><br>
