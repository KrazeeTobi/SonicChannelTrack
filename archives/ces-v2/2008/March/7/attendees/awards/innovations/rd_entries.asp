...
<div class="section_title">Sign up to receive Innovations 2009 Call for Entries updates</div>
<span class="text">
...
<!-- text for main page -->
	...
	<!-- Start FORM -->
	If you would like to be added to the Innovations 2009 mailing list, fill out the form below. We'll notify you when we begin accepting entries. (<span class="required">*</span> Denotes required field.)<br>
