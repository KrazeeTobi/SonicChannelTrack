...
<html>
<head><!-- PageID 5158 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;January 2008 Promotions</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/jan2008pro.asp';
    
        var parentLinks=new Array('dummy','/exhibitors/default.htm','/exhibitors/newsletter/default.asp','/exhibitors/newsletter/jan2008.asp');
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue5158', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue5158', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue5158" id="leftAddedValue5158" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<br><div align="center">
    ...
    [ <a href="/exhibitors/newsletter/jan2008.asp">News</a> ]
 &nbsp; 

    [ <strong>Promotions</strong> ]
 &nbsp;

    [ <a href="/jan2008ev.asp">Events</a> ]
 &nbsp;

    [ <a href="/jan2008ops.asp">Operations</a> ]
...
<span class="text">
<IMG height=55 src="/images/general/CES_SmartBooth.jpg" width=203 align=right>How well is your company showing on the International CES search engine?&nbsp;Finding the answer is as easy as 1, 2, 3…<BR><BR>1.&nbsp;Click on this link: <A href="http://myces.bdmetrics.com/" target=_blank>http://myces.bdmetrics.com/</A>. <BR>2.&nbsp;Enter any keyword that relates to your business in the search bar located towards the top left hand side of the page (wireless, GPS, etc.). <BR>3.&nbsp;Check out the results of your search. The list of results that you see is what attendees see. Where is your company?<BR><BR>If you do not see your company or you do not like where you are on that list, call or e-mail Gary Zgorski, your MyCES specialist, at (240) 401-9549 or <A href="mailto:gzgorski@bdmetrics.com">gzgorski@bdmetrics.com</A>.<BR>
</span>
<a name="5201"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Tech-EM Offers Free Booth Portraits for Exhibitors</div>
<span class="text">
<IMG height=51 src="/images/partners/TechnologyEM.gif" width=150 align=right>Tech-EM is a headin' to the Consumer Electronics Show with a full plate of activities for exhibit managers. The site, which offers tradeshow managers news and best practices, is bringing award-winning photographer Kit Noble (<A href="http://www.noblespaces.com" target=_blank>noblespaces.com</A>) to the CES show and offering exhibit managers <A href="http://tech-em.com/ces-activity-form" target=_blank>free portraits</A>&nbsp;of their booths. No charge... really! Tech-EM will come by for an exhibit portrait and give you not only the digital files but also a photo print in a limited-edition Tech-EM and CEA frame. <BR><BR>What else? A free show daily just for exhibit and event marketers delivered right to you at your booth on Tuesday, Wednesday and Thursday. Each issue&nbsp;gives you a taste of some of the exhibit programs on and off the floor, some best practices, and advice. And for the first time ever, Tech-EM and Event Marketer magazine will converge on CES to uncover the Best 50 Booths. The winners, compiled over several days by our reporters and writers, will be announced via Webinar in January and profiled in a whopping 25-page feature in Event Marketer magazine. Sign up for your FREE booth portrait as well as the Daily Dose and Best 50 Booth competition <A href="http://tech-em.com/ces-activity-form" target=_blank>right here</A>.&nbsp; 
</span>
...
<tr>
    ...
    <!-- article start -->
    <p>
    <strong>Make Your CES Success Last All Year</strong><br> by Dan Cole</p>
    <p>Continued from <a href="/exhibitors/newsletter/nov2007.asp">first page</a>.</p>
    <SPAN style="FONT-FAMILY: "><SPAN style="FONT-FAMILY: ">Throughout CES, you can find new avenues to keep your brand top-of-mind with key decision-makers all the way to next January. Take CEA’s <A href="http://www.ce.org/Press/CEA_Pubs/3501.asp" target=_blank><EM>CE Vision</EM></A>&nbsp;magazine for example. <EM>CE Vision</EM> circulation’s includes the very top decision-makers from our CES attendee database. CEA delivers insightful knowledge and exclusive research to these 23,000 readers throughout the year to make sure they know how they can grow their businesses both at the show and year-round. Magazine advertisers benefit by reaching CE executives around the world and reinforcing their brands and messaging across the CE spectrum.<BR><BR></SPAN></SPAN><SPAN style="FONT-FAMILY: "><SPAN style="FONT-FAMILY: ">At our new consumer showcase event in June in the heart of New York’s Financial District, <A href="http://www.digitaldowntown-nyc.com/" target=_blank>Digital Downtown</A>&nbsp;brings your products and message directly to highest concentration of wealthy buyers and influencers in the world.&nbsp; They do not have to come to you -- or travel to a convention center. Your company will be in the home of a concentrated luxury-buying audience as well as titans of the stock, equity and international investment markets.&nbsp; It's the place to influence the influencers.&nbsp; For publicly traded companies (or companies that want to go public), it is the best place to build your business profile before the financial community.&nbsp; <BR><BR></SPAN></SPAN><SPAN style="FONT-FAMILY: "><SPAN style="FONT-FAMILY: ">Lastly, remember your timeslot next week to reserve your booth space for the 2009 International CES.&nbsp; Next year’s CES will be here before we know it, and you’ll want to start the ball rolling again to another year of success.<BR><BR></SPAN></SPAN><SPAN style="FONT-FAMILY: "><SPAN style="FONT-FAMILY: ">Thank you for playing such a key role in the International CES! Happy New Year! </SPAN></SPAN>
<P>&nbsp;</P>
    <!-- article end -->
