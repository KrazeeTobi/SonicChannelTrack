...
<head><!-- PageID 1997 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - By Facility</title>
...
</SCRIPT><br><form action="facilityList.asp" method=post><table cellpadding=3 cellspacing=1 border=0><tr><td><b>Choose a facility from the drop-down list.</b></td></tr><tr height=7><td></td></tr><tr><td colspan=1><select class=formdata name=faevfacility><option value=0>Choose a Facility&nbsp;&nbsp;<option value="LVCC, North Hall">LVCC, North Hall<option value="LVCC, South Hall">LVCC, South Hall<option value="The Flamingo Hotel">The Flamingo Hotel<option value="The Venetian">The Venetian</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
<!--
<br>
