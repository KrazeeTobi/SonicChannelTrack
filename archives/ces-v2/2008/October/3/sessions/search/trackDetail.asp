...
<head><!-- PageID 1969 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Track / Partner Program Details</title>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/sessions/default.asp" class="footer">Sessions</a>&nbsp;&gt;&nbsp;<a href="/sessions/search/default.asp" class="footer">Search for Sessions</a>&nbsp;&gt;&nbsp;<a href="/sessions/search/byTrack.asp" class="footer">By Track / Partner Program</a>&nbsp;&gt;&nbsp;Track / Partner Program Details</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/sessions/search/trackDetail.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>Track / Partner Program Details</h1>
...
</SCRIPT><b>No track was selected. Please <a href=byTrack.asp>try again</a>.</b>
