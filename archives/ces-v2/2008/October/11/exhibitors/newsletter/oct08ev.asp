...
<head><!-- PageID 1887 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: October 2008 Events</title>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/oct08.asp" class="footer">October 2008</a>&nbsp;&gt;&nbsp;October 2008 Events</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/newsletter/oct08ev.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<div class="sub-content-header">Two Weeks and Counting: FREE Exhibitor Workshop Maximizes Your Show Experience - Registration Ends October 15</div>
<br />


<P><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial"><IMG height=122 hspace=10 src="/images/photos/2007ExhibitorWorkshop1.jpg" width=165 align=right vspace=10>Attend our FREE* 2009 Exhibitor Workshop on October 22, 2008, at the Las Vegas Convention Center in Las Vegas, NV. </SPAN></P>
<P><B><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial">Just Announced!<BR>Exhibitor Workshop Expert Panel<BR></SPAN></B><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial">Veteran CES exhibitors <B>Howie Cooperstein </B>of Bell’O International Corp., <B>Laura Leeper</B> of Cisco Systems, Inc. and <B>Allen Reichard</B> of AMD will share their CES exhibiting knowledge and experience. </SPAN></P>
<P><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial">Don’t delay! <A href="https://www.cesweb.org/exhibitors/resources/workshop/rd_registration.asp" target=_blank>Register online</A> and view the full <A href="/exhibitors/resources/workshopAgenda.asp" target=_blank>workshop agenda</A> as well as a list of <A href="/exhibitors/resources/workshop.asp" target=_blank>vendors offering exclusive discounts</A> to workshop participants. </SPAN></P>
<P><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial">Plus, you’ll also want to attend for the keynote speaker, Glenda Brungardt, tradeshow/event manager from Hewlett-Packard, the GES Expert Panel and the CES Power Hour, where we’ll fill you in on everything you need to know to make your 2009 CES a success -- all in 60 minutes! Please also join us on Tuesday, October 21 for our special GES facility tour.</SPAN></P>
<P><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial"><A href="https://www.cesweb.org/exhibitors/resources/workshop/rd_registration.asp" target=_blank>Register now!</A></SPAN></P>
<P><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial">Questions? Please contact Jaime Gershberg at <A href="mailto:jgershberg@CE.org" target=_blank>jgershberg@CE.org</A> or 703-907-4331.</SPAN></P>
<P><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial">*There is a registration fee of $50 when you sign up. However, you will be fully refunded within 30 days of the workshop after confirmation of your workshop attendance.</SPAN></P>
        <br /><img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="2064"></a>

<div class="sub-content-header">Be A Part of the Technology and Emerging Countries TechZone</div>
<br />


<P><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial"><IMG height=53 hspace=10 src="/images/content/TEC.gif" width=150 align=right vspace=10>Are you a manufacturer or organization that offers products and/or services to support the spread of technology in emerging countries? Take advantage of the opportunity to showcase your products at the 2009 International CES as part of the <A href="/exhibits/displays/techZones.asp" target=_blank>Technology and Emerging Countries (TEC) TechZone</A>. </SPAN></P>
<P><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial">Participating companies will display the innovations that make it possible for every person on this planet to make use of technology and benefit from growing CE advances. Foundations and NGOs engaged in disseminating this technology to rural communities are also encouraged to participate.</SPAN></P>
<P><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial">For more information on how you can capitalize on this unique opportunity, contact Chris Amos at 703-907-7640 or <A title=mailto:camos@CE.org href="mailto:camos@CE.org" target=_blank>camos@CE.org</A>.</SPAN></P>
        <br /><img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="2062"></a>

<div class="sub-content-header">Submit Mark of Excellence 2009 Entries by Oct. 14 to Get Early-bird Rate </div>
<br />


<P><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial"><IMG height=115 hspace=10 src="/images/content/MOE.jpg" width=100 align=right vspace=10>Each year, manufacturers, distributors, and systems integrators compete in the Mark of Excellence Awards to receive the recognition they deserve. With 35 of the most lucrative categories in the industry there is no question why this awards program is among the most influential. For over a decade independent experts within the industry come together to judge these entries, scrutinizing over each of them before crowing the final victors.<BR><BR>Research has shown companies who enter and win awards receive recognition, creditability and broader marketing. Don’t miss out on the opportunity winning a Mark of Excellence award could bring to your company. Visit our <A href="http://www.ce.org/MarkofExcellence" target=_blank>Mark of Excellence website</A> to start crafting your 2009 award winning entry. It’s never too early to plan for success.</SPAN></P>
<P><SPAN style="FONT-SIZE: 10pt; FONT-FAMILY: Arial">Enter your submission by October 14, 2008, and receive the early-bird entry fee!&nbsp; </SPAN></P>
