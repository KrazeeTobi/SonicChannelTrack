...
<P><STRONG>Wireless Handsets</STRONG><BR>Items marketed primarily for the ability to provide wireless calling capability. The products in this category, in addition to having voice calling features, may also incorporate wireless data and Internet access features along with built-in camera and media playback functionality.<BR></P><BR><BR>
