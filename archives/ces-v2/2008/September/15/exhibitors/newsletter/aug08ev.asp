...
<head><!-- PageID 1496 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - August 2008 Events</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions1496','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions1496" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions1496','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards1496','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards1496" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards1496','show')"><a href="/awards/innovations/D2D617DFADC443ACA9538362B618E34E.htm">Honoree Utilities</a></li>
                
                    <li onmouseover="showSubMenu('awards1496','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards1496','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards1496','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards1496','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards1496','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits1496','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits1496" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits1496','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1496','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1496','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1496','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1496','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1496','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1496','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1496','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1496','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel1496','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel1496" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel1496','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news1496','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news1496" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news1496','show')"><a href="/news/upToTheMinute/090308.asp">September 3, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news1496','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news1496','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news1496','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/aug08.asp" class="footer">August 2008</a>&nbsp;&gt;&nbsp;August 2008 Events</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/newsletter/aug08ev.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<div align="center">
    ...
    [ <a href="/exhibitors/newsletter/aug08pro.asp">Promotions</a> ]
...
<div class="sub-content-header">2009 Exhibitor Workshop – Tips, Tricks and Savings to Maximize your Tradeshow Experience</div>
<br />

<IMG height=133 hspace=10 src="/images/photos/Workshop(1).jpg" width=200 align=right vspace=10>Want to make the most of your 2009 International CES experience? Attend our <B><A href="/exhibitors/resources/workshop.asp">FREE<SPAN style="FONT-WEIGHT: normal"> 2009 Exhibitor Workshop</SPAN></A></B> on October 22, 2008, at the Las Vegas Convention Center in Las Vegas, NV. This one-day workshop will provide knowledge from the experts, exclusive official show vendor discounts, tours of the show facilities, and tips for how to use CES to drive traffic to your booth and grow your own consumer technology business.<BR><BR><A href="https://www.cesweb.org/exhibitors/resources/workshop/rd_registration.asp" target=_blank>Register online</A> for $50, and we will <B>fully refund</B> the fee within 30 days of the workshop after confirmation of your workshop attendance.<BR><BR>Considering flying in a bit early to go behind the scenes with your exhibition services experts.&nbsp;On October 21, we will&nbsp;provide workshop&nbsp;attendees with an optional tour of&nbsp;the Las Vegas GES facility and warehouse to get a&nbsp;first-hand look at freight, material handling, graphics – everything that GES does to make your CES a success.&nbsp;The tour is a great way to understand the ins and outs of GES.<BR><BR>The Renaissance Las Vegas Hotel is offering rooms at a discounted rate of $209 per night. <A href="http://marriott.com/lasbr?groupCode=cescesa&app=resvlink" target=_blank>Book online</A> or call the Renaissance Hotel at 800-750-0980 and reference the CES Exhibitor Workshop. Don’t delay! Make your reservations by September 22, 2008, to receive the discounted rate.<BR><BR>Questions? Please contact Jaime Gershberg at <A href="mailto:jgershberg@CE.org" target=_blank>jgershberg@CE.org</A> or 703-907-4331.
        <br /><img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="1527"></a>

<div class="sub-content-header">Register Today for CEA's Industry Forum. Early-Bird Rates Expire August 7.</div>
<br />

Join us in Las Vegas October 19-22 for <A href="http://www.ce.org/events/event_info/default.asp?eventID=FALL08" target=_blank>CEA's Industry Forum</A>, a three-day conference designed to inform and connect leaders in the CE industry. This year's event will feature the premiere of <B><A href="http://www.ce.org/i-stage/" target=_blank>i-stage</A></B>, a competition for the newest and coolest technologies coming to market. The winner will receive $50,000 and a free booth at the <A href="http://www.cesweb.org/default.asp" target=_blank>2009 International CES</A>. In addition to i-stage, Industry Forum will feature educational programming and keynote speeches from the <B>Hon. Shelley Berkley</B> (D-NV), <I>Business Week</I> columnist <B>Jeneanne Rae,</B> organizational leadership psychologist <B>Edgar Papke </B>and strategic growth expert <B>Joe Pine</B>. The early-bird registration deadline is approaching. Don't wait until the last minute. Register by August 7 and save up to $125 on your conference registration fees. Register online at <A href="http://www.ce.org/events/event_info/default.asp?eventID=FALL08" target=_blank>CE.org/industryforum</A>.
        <br /><img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="1526"></a>

<div class="sub-content-header">Enter The Global Media Awards Today</div>
<br />

<IMG height=100 hspace=10 src="/images/content/GMA.jpg" width=200 align=right vspace=10>CEA is proud to partner with the National Academy of Television Arts &amp; Sciences (NATAS) to launch the first Global Media Awards™ for creative and technical achievement in all media. Enter today in order to be acknowledged in&nbsp;this exciting new&nbsp;competition in&nbsp;one of the following seven categories:&nbsp;website/Internet, platform, user experience/program guide, short and long form content, advertising and repurposed linear/traditional content. Entries are being received&nbsp;from around the world with nominations being announced in Las Vegas during the CEA Industry Forum, October 19-22, 2008.<BR><BR>Winners will be announced&nbsp;the opening evening of the International CES in Las Vegas on January&nbsp;8, 2009. Entrants in the inaugural ceremony will also be offered a one year 2009 membership in the Global Media Academy whose honorary&nbsp;chairman is Bob Wright and vice chairman is&nbsp;Sir Howard Stringer. Entries must be postmarked by September 12, 2008.<BR><BR><B>Enter today at <A href="http://www.globalmediaawards.org" target=_blank>globalmediaawards.org</A>.</B>
        <br /><img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="1525"></a>

<div class="sub-content-header">Get Amped-Up for EHX Fall 08</div>
<br />

<IMG height=83 hspace=10 src="/images/content/EHX(1).jpg" width=150 align=right vspace=10>Get Amped-Up for <A href="http://www.ehxweb.com/" target=_blank>EHX Fall 08</A>, November 4-7, 2008. EHX is <I>the</I> only industry event for custom electronics professionals sponsored by CEA. <B>(CEA Members save $2/sq ft.!)<BR><BR></B>Be part of the packed expo floor with over 175 exhibitors. Meet professionals focused on selling and installing your products.<BR><BR>For more information, contact George Keegan, <A href="mailto:gkeegan@ehpub.com" target=_blank>gkeegan@ehpub.com</A>.
