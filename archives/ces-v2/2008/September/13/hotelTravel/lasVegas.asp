...
<head><!-- PageID 425 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions425','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions425" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions425','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards425','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards425" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards425','show')"><a href="/awards/innovations/D2D617DFADC443ACA9538362B618E34E.htm">Honoree Utilities</a></li>
                
                    <li onmouseover="showSubMenu('awards425','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards425','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards425','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards425','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards425','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits425','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits425" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits425','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits425','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits425','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits425','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits425','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits425','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits425','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits425','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits425','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel425','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel425" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel425','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news425','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news425" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news425','show')"><a href="/news/upToTheMinute/090308.asp">September 3, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news425','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news425','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news425','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
            ...
            <li ><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
            ...
            <li class="selected"><a href="/hotelTravel/lasVegas.asp">Las Vegas Travel Tips</a></li>
        </ul>
                        <br />
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/hotelTravel/default.asp" class="footer">Hotel/Travel</a>&nbsp;&gt;&nbsp;Las Vegas Travel Tips</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/hotelTravel/lasVegas.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<div class="page_header_block">
    <div class="blue_box">
        ...
        <li><a href="#711">Restaurant Reservations</a></li><!---->
...
<br />We know traveling in this economy is&nbsp;tough, but there are ways to curb costs. In fact, attending CES is one of the smartest business trips you can make.&nbsp;With more than 2,700 exhibitors and 130,000 consumer technology professionals, it could be THE ONE business trip you make (rather than making several trips to different cities to meet with different decision makers).<BR><BR>Here are ways to get the best deal on airfare to the International CES:<BR><BR>1. Buy your ticket now. A 14-day advance used to be good enough, but with oil prices in such flux – with many speculating that the prices will only continue to rise – locking in airfare now is likely prudent. <BR><BR>2. Travel midweek. Tuesdays through Thursdays are generally a less expensive times to fly, and lucky for you, the 2009 International show begins Thursday and ends Sunday (January 8-11). Consider staying the entire duration of the show to get the best airfare. <BR><BR>3. Often flights that depart very early or late in the day are more affordable than mid-day flights.<BR><BR>4. Shop around. If you are booking on a travel website, compare them against&nbsp;the official airline’s Web site, too. Plus, travel sites don’t feature every airline that flies into Las Vegas.<BR>
...
<div class="sponsorshipTitle">Restaurant Reservations</div>

<br />Like hotels, Las Vegas restaurants tend to book up quickly during CES, so place your dining reservations well in advance. CES has partnered with Dine Direct to offer attendees and exhibitors a complimentary dining reservation service for any of the restaurants in Las Vegas. <BR><BR>Whether it's a party of two or a group of 200, take advantage of this free service by visiting Dine Direct online at <A href="http://www.dinedirectlasvegas.com/" target=_blank>www.dinedirectlasvegas.com/</A>. <BR><BR>Once a reservation request is received, Dine Direct calls the restaurants on your behalf to make arrangements, then provides you with a confirmation letter including the details of your reservation.
...
<br />While at CES, you have plenty to do, see and organize. So let us provide your transportation and give you one less thing to coordinate. The <A href="/hotelTravel/shuttle.asp">CES shuttle</A> runs daily during the show between the Las Vegas Convention Center and all official CES hotels. CES also provides discounts on <A href="/hotelTravel/cars.asp">car rentals</A>. <BR><BR>Please remember <A href="/hotelTravel/cars.asp">parking is very limited at CES</A> this year. Make your transportation choices wisely and let us be your chauffeur! <BR><BR>Other Las Vegas transportation options include: 
<UL>
<LI>Limos </LI>
...
<br />Since Las Vegas is a service-based city, tipping is a big, big deal. Just ask the IRS. You may not be too sure how much to tip and when. So here's a quick rundown. 
<UL>
<LI><STRONG>Bellmen:</STRONG> They usually receive $1 a bag, but an extra tip is suggested if you use them to make show reservations, hail cabs or provide other additional assistance. </LI>
<LI><STRONG>Taxi drivers:</STRONG> These folks drive like mad to get you where you're going, they help you with your bags, and provide a little chit-chat along the way. About 15 percent of your total fare should make up for their efforts. </LI>
<LI><STRONG>Valet parking and maid service attendants:</STRONG> We suggest $1 to $2 each day. </LI>
<LI><STRONG>Dealers:</STRONG> Tipping a dealer is a little trickier. You can give the dealer a tip in between hands or spins, and this tip can range from $1 to as much as you want to give. You also can wait until the end of your session and tip the dealer then. </LI>
<LI><STRONG>Keno and bingo runners:</STRONG> $1 every few rounds is acceptable and suggested even if you aren't winning. </LI>
<LI><STRONG>Cocktail waitresses:</STRONG> About $2 per round is sufficient for a small group (2-3 people). Increase for larger groups. Don't fail to tip, even if your drinks are comped. </LI>
<LI><STRONG>Change person:</STRONG> Don't forget to slip a few bucks to these helpful folks — especially if you win. Don't try to palm off a $5 tip for a Megabucks win; it's insulting. </LI></UL>These are just suggestions — and you're always welcome to tip more! <BR><BR>
<H3>CES quick tip:</H3><B>Taking the CES shuttle requires zero dollars. That includes no tipping!</B>
...
<br />Looking for a deal on a Vegas show? Want that all-you-can-eat buffet at half the price? Keep checking back. As we hear of the best deals in the city during CES show days, we'll put them right here for you.<BR><BR>
<H3>Calling all Las Vegas businesses:</H3>If you are interested in offering a special discount to 2009 goers, e-mail <A href="mailto:CEShotels@CE.org">CEShotels@CE.org</A> in the following format: <BR><BR>Your venue here<BR>Your location here (if applicable)<BR>Your discount and description here<BR>Your contact information here
