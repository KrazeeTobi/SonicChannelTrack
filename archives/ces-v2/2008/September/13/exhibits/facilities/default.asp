...
<head><!-- PageID 381 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Facility Details and Maps</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions381','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions381" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions381','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards381','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards381" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards381','show')"><a href="/awards/innovations/D2D617DFADC443ACA9538362B618E34E.htm">Honoree Utilities</a></li>
                
                    <li onmouseover="showSubMenu('awards381','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards381','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards381','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards381','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards381','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits381','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits381" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits381','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits381','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits381','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits381','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits381','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits381','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits381','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits381','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits381','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel381','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel381" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel381','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news381','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news381" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news381','show')"><a href="/news/upToTheMinute/090308.asp">September 3, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news381','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news381','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news381','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<LI>CES Store </LI>
<LI>Experience CEA</LI></UL></TD>
<TD width=10 height=1></TD>
<TD vAlign=top><SPAN class=subhead>
<H3>North Hall Upper &amp; Lower Level Meeting Rooms</H3></SPAN>
<UL>
...
<LI><A href="/exhibits/displays/techZones.asp">International CES TechZones</A></LI></UL></TD>
<TD></TD>
<TD vAlign=top>
<H3>North Hall and North Plaza</H3>
<UL>
<LI>Booth #s 100-6999 and L3-L21 </LI>
<LI><A href="/exhibits/displays/techZones.asp">International CES TechZones</A> </LI>
<LI>In-vehicle technology exhibits </LI></UL></TD></TR>
<TR>
<TD width=1 colSpan=3 height=10></TD></TR>
<TR>
<TD vAlign=top>
<H3>South Halls 1-2, Ground Level</H3>
<UL>
...
<LI>Satellite system exhibits</LI></UL></TD>
<TD></TD>
<TD vAlign=top>
<H3>South Halls 3-4, Upper Level</H3>
<UL>
...
<LI><A href="/exhibits/displays/wirelessWorld.asp">Wireless World</A></LI></UL></TD></TR>
<TR>
<TD width=1 colSpan=3 height=10></TD></TR>
<TR>
<TD vAlign=top>
<H3>South Hall Connector </H3>
<UL>
...
<LI>Show office</LI></UL></TD>
<TD></TD>
<TD vAlign=top>
<H3>Las Vegas Hilton</H3>
<UL>
<LI>Booth #s 40,000-66,020 </LI>
<LI>International Commerce Center (Satellite Location) </LI>
<LI>International Gateway </LI>
<LI>Industry Insider Series in Hilton Theater (lineup announced in September) </LI>
<LI>Satellite Registration</LI></UL></TD></TR></TBODY></TABLE><BR>&nbsp; 
<H2>Sands Expo and Convention Center/The Venetian</H2><IMG height=129 src="/images/content/ExteriorSands.jpg" width=200 align=right>The Sands Expo and Convention Center/The Venetian opens at 8 a.m. each day of the show, one hour earlier than the LVCC and the Las Vegas Hilton. <BR><BR>The Venetian features more than 200 high-performance audio &amp; home theater exhibitors. The Sands is where you'll find emerging technology exhibits and Innovations Design and Engineering Showcase. <A href="/hotelTravel/shuttle.asp"><BR><BR>Take the free CES shuttle</A> to get to this exciting 2009 International CES venue. <BR><BR><BR><BR>
<UL>
<LI>CES Unveiled: The Official Press Event of the International CES </LI>
<LI>Keynote addresses and many more conference sessions (posted in September) </LI>
<LI>Live "Into Tomorrow with Dave Graveline" broadcasts </LI>
<LI>The Technology &amp; Engineering Emmy Awards </LI>
<LI><A href="/exhibits/displays/techZones.asp">International CES TechZones </A></LI>
<LI><A href="/myCES.asp">MyCES kiosks</A> </LI>
<LI>CES Store </LI>
<LI>Press room and press conferences </LI>
<LI>2009 Exhibit Space Selection room </LI>
<LI>Exhibitor suites and meeting rooms </LI>
<LI><A href="/international/services.asp">International Commerce Center (satellite location)</A> </LI>
