...
<head><!-- PageID 1096 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Engineer</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions1096','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions1096" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions1096','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards1096','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards1096" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards1096','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards1096','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards1096','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards1096','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards1096','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits1096','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits1096" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits1096','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1096','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1096','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1096','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1096','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1096','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1096','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1096','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1096','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel1096','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel1096" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel1096','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news1096','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news1096" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news1096','show')"><a href="/news/upToTheMinute/090308.asp">September 3, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news1096','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news1096','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news1096','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
            ...
            <div id="main-content">
                <div id="main-content-column1">
                    <div class="greenbox-bg">
                        <img src="/images/framework/sidebar-header-iama.gif">
...
<div class="right-blue-box" align="center">
    <div class="right-blue-box-header">Engineers Wanted</div>
    
    <div>
        <IMG height=142 src="/images/content/innov2009.jpg" width=95 align=right>Lots of ideas make it off the drawing board, but only a select few decide which make it to the Innovations Design and Engineering Awards. If you're an engineer, you could judge one of the CE industry's most lauded awards programs.<BR><BR><A href="/awards/innovations/callForJudges.asp">Be an Innovations judge.</A>
    </div>
</div>
<div class="right-blue-box" align="center">
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;Engineer</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/prof-engineer.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
Are you an engineer? Then the future of technology is likely forefront in your mind. Come see the future revealed in Las Vegas in January at the most important emerging technology event of the year: the 2009 International CES. With more than 2,700 exhibitors vying to capture your attention, this is the event where you will see far-out ideas come to fruition.<BR><BR>The world's largest consumer technology tradeshow is also the most impressive collection of consumer electronics (CE) companies, innovators and products in 30 categories. Meet manufacturers and distributors of: 
<UL>
<LI><IMG height=125 hspace=5 src="/images/photos/p11.jpg" width=165 align=right>Robotics </LI>
<LI>Biometrics </LI>
...
<H3>Emerging Technology Exhibitors</H3>Location-based services, mobile Internet, WiMAX and other emerging technologies span every product category at the International CES.<BR><BR><A href="/exhibitorDirectory/default.asp">Browse the 2009 International CES exhibitor directory</A> for a complete list.&nbsp;<BR><BR>
<H3>International CES TechZones: Emerging Technology</H3><A href="/exhibits/displays/techZones.asp"><IMG height=46 hspace=8 src="/images/content/techzone_logo.gif" width=200 align=right border=0></A>Do you want to see the emerging technology that's changing the face (and the inside) of consumer technology? Look for the&nbsp;International CES TechZones spread throughout the show floor. The TechZones are areas of market-specific technology featuring prominent industry-standards groups as well as new technology companies read to show off to you their products-to-be. <A href="/exhibits/displays/techZones.asp">See the most up-to-date list of CES TechZones.</A><BR><BR>
<H3>Sessions for Every Engineer</H3>No matter what your area of expertise, the CES Conference Program has something for every engineer. From RFID to IPv6 to disruptive technologies, CES covers it all. There is even a specific Emerging Technology Knowledge Track specifically designed for engineers. Starting in September, you can choose from the complete list of 2009 conference sessions, including those hosted by partners.<BR><BR>
<H3><IMG height=142 hspace=8 src="/images/content/innov2009.jpg" width=95 align=right>Ingenuity as You've Never Seen it Before</H3>Witness the latest technology surfacing in the CE market at the International CES Innovations 2009 Design and Engineering Awards Showcase. You saw them here first: Sony's PlayStation 3, the Motorola Magenta RAZR, Kodak's EasyShare digital camera. What will be revealed in '09?<BR><BR><A href="/awards/innovations/default.asp">Have a product that you want to submit into the competition?</A><BR><BR>
<H3>Start Planning for CES Now!</H3><A href="/register">Register before November 1 for free and avoid any registration fees.<BR></A><A href="/hotelTravel/hotel.asp">Book your room (or room block) now</A> to secure low-rates now.
