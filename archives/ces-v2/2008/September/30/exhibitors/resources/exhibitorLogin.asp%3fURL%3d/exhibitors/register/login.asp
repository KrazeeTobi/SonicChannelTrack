...
<head><!-- PageID 1336 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Exhibitor Login</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions1336','show')" class="link_with_children"><a href="/sessions/search/default.asp">Search for Sessions</a>
                
            <ul id="sub-sub-sessions1336" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions1336','show')"><a href="/sessions/search/byTrack.asp">By Track / Partner Program</a></li>
                
                    <li onmouseover="showSubMenu('sessions1336','show')"><a href="/sessions/search/bySpeaker.asp">By Speaker</a></li>
                
                    <li onmouseover="showSubMenu('sessions1336','show')"><a href="/sessions/search/byFacility.asp">By Facility</a></li>
                
                    <li onmouseover="showSubMenu('sessions1336','show')"><a href="/sessions/search/byDate.asp">By Date</a></li>
                
                    <li onmouseover="showSubMenu('sessions1336','show')"><a href="/sessions/search/byTime.asp">By Time</a></li>
                
            </ul></li>
        
                    <li onmouseover="showDropDown('sessions','show')" class="link"><a href="/sessions/speakers/speakerServices.asp">Speaker Services</a></li>
                
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions1336','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions1336" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions1336','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards1336','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards1336" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards1336','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards1336','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards1336','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards1336','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards1336','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits1336','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits1336" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits1336','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1336','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1336','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1336','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1336','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1336','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1336','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1336','show')"><a href="/exhibits/displays/5DF05031547C4A26A0E6AD9883F1CE12.htm">Location Based Services</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1336','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1336','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel1336','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel1336" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel1336','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news1336','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news1336" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news1336','show')"><a href="/news/upToTheMinute/091708.asp">September 17, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news1336','show')"><a href="/news/upToTheMinute/090308.asp">September 3, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news1336','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news1336','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news1336','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/resources/default.asp" class="footer">Resources & Downloads</a>&nbsp;&gt;&nbsp;Exhibitor Login</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/resources/exhibitorLogin.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<script language="javascript1.2" src="/exhibitors/include/js/select_exhibitor.js"></script>
<!-- text for main page -->
<b>Directions:</b><br>
<ol>
...
<FORM name="form_login" method=POST action="/exhibitors/resources/exhibitorLogin.asp">
<img src="/images/framework/spacer.gif" height="1" width="20" border="0" align="left">
<TABLE border="0" cellpadding="0" cellspacing="0">        
	...
	<tr><td height="4"><img src="/images/framework/spacer.gif" height="6" width="1"></td></tr>
	
	<TR>  
		<TD align="right">Exhibitor&nbsp;&nbsp;</TD>
		<TD>
			...
			<input type="hidden" name="URL" value="/exhibitors/register/login.asp">
		</TD>
	</TR>   
	<tr><td colspan="2"><img src="/images/framework/spacer.gif" height="4" width="0"></td></tr>
	
	<TR>
		<TD align="right">Customer Number&nbsp;&nbsp;</TD>
		<TD><input type=text size=10 name=TIMMS_ID maxlength=25 disabled="true"><span class="smallText">&nbsp;&nbsp;(Located on your show invoice)</span></TD>
	</TR> 
	<tr><td colspan="2"><img src="/images/framework/spacer.gif" height="6" width="1"></td></tr>
	
	<TR>
		<TD></td>
		<td><input type=submit value=Login id=submit1 name=submit1 disabled="true">
		    <input type="button" value="Get Cust No." name="forgot_password_button" disabled="true" onclick="openNewWindow('/exhibitors/include/asp/eims_id_request.asp?exhibitor_id=' + form_login.ExhibitorID.value);"><br>
		</TD>
	</TR>  
	<tr><td colspan="2"><img src="/images/framework/spacer.gif" height="4" width="1"></td></tr>   
	<tr><td colspan="2"><span class="smallText">(Don't know your Customer Number? Click the "Get Cust No." button, and we'll e-mail it to the contact on file.)</span></td></tr>
	<tr><td colspan="2"><img src="/images/framework/spacer.gif" height="4" width="1"></td></tr>   
	
</TABLE>
</FORM>

<b>NOTE:</b> This login requires a JavaScript-enabled browser. We recommend using Internet Explorer version 6.0 or higher.
<br><br>
<b>Questions? Need help?</b> E-mail us at <a href="mailto:exhreg@CE.org">exhreg@CE.org</a>.
