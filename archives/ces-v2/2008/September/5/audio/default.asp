...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
            ...
            <ul id="sub-sub-news368" style="display: none;" onmouseout="setSubMenuTimer()">
                    ...
                    <li onmouseover="showSubMenu('news368','show')"><a href="/news/upToTheMinute/090308.asp">September 3, 2008</a></li>
...
Disruptive technologies are rocking the "legacy" audio industry as competition accelerates between new music sources and such established sources as CDs, DVDs and AM/FM radio. <BR><BR><A href="https://cms.ce.org/register">Register today for the 2009 International CES</A> to learn, network and investigate new technology emerging in the audio industry and many other consumer technology markets. It's free if you sign up before November 1.
