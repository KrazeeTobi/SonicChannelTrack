...
<head><!-- PageID 593 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Wireless </title>
    <link type="text/css" rel="stylesheet" media="all" href="/css/styles.css" />
    
    <meta http-equiv="Content-Type" content="text/html;charset=utf-8" />
    <meta name="description" content="CES is the largest consumer technology tradeshow in the world, featuring more than 500 wireless exhibitors and 2,700 exhibitors overall. Buyers of wireless technology need to attend the CES to stay competitive in the marketplace.">
    <meta name="keywords" content="• Wireless technology, Cellular phones, PDAs, Handheld computers, Wireless notebooks, tablet PCs, wearable computing devices, pen-based computing, infrared and wireless distribution systems, laptop computers, wireless networking, wireless Internet">
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions593','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions593" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions593','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards593','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards593" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards593','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards593','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards593','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards593','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards593','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits593','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits593" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits593','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits593','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits593','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits593','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits593','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits593','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits593','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits593','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits593','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel593','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel593" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel593','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news593','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news593" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news593','show')"><a href="/news/upToTheMinute/090308.asp">September 3, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news593','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news593','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news593','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
            ...
            <div id="main-content">
                <div id="main-content-column1">
                    <div class="greenbox-bg">
                        <img src="/images/framework/sidebar-header-wireless.gif">
                        
    <a href="/wireless/default.asp"></a>
    <ul>
...
<div class="right-box-no-border" align="center">
    <img src="/images/framework/wireless_icons_LG.gif" alt="Wireless" width="176" height="175">
</div>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;Wireless </div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/wireless/default.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
While this likely comes as no surprise to consumer technology professionals, there's a major benchmark happening this year: The number of mobile phone users will overtake the number of non-users for the first time, according to the U.N. telecoms agency. Simply put, that means more than half the people on the planet now have cell phones. In 2000, only 12 percent of the global population had a mobile phone. What else is happening in the wireless market this year? Well, take a look at these trends: 
<UL>
<LI>Smartphones post solid gains. </LI>
<LI>Touchscreen mania sets in as competitors chase iPhone. </LI>
<LI>Location-based services set for take-off. </LI>
<LI>The next big thing: NAV on mobile phones. </LI>
<LI>High-speed networks promise faster Internet access. </LI>
<LI>New mobile TV formats undergo field trials. </LI>
<LI>A slow down is expected in standard handset sales. </LI></UL><A href="/register">Register today for the 2009 International CES</A> to learn, network and investigate new technology in the wireless industry and many other consumer technology markets. It's free if you sign up before November 1. <BR><BR><EM><SPAN class=smallText>Source: Digital America, a CEA publication.</SPAN></EM>
...
<div class="sub-content-header">Just for Wireless Technology Professionals</div>
<br />

While all consumer technology markets converge at CES, it's still easy to find specific segments that matter to you. If&nbsp;wireless technology is your primary interest, start by exploring these parts of the CES show floor:
<UL>
<LI><A href="/exhibits/displays/techZones.asp#388">Discover Wireless Mobility TechZone</A></LI>
<LI><A href="/exhibits/displays/techZones.asp#745">Wireless Distribution TechZone</A></LI>
<LI><A href="/exhibits/displays/techZones.asp#746">WiMedia TechZone</A></LI>
...
<div class="sub-content-header">Wireless Products at CES</div>
<br />

Use the International CES to plug into the wireless technology market. Meet manufacturers, suppliers and providers of: 
<UL>
...
<LI>Security </LI>
<LI>Wireless or mobile solutions software</LI>
<LI>Wireless networking devices</LI>
<LI>Wireless Internet solutions</LI></UL>
