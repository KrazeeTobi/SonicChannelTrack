...
<head><!-- PageID 590 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - In-Vehicle Technology</title>
    <link type="text/css" rel="stylesheet" media="all" href="/css/styles.css" />
    
    <meta http-equiv="Content-Type" content="text/html;charset=utf-8" />
    <meta name="description" content="CES is the largest consumer technology tradeshow and features more mobile and/or in-vehicle technology manufacturers than any other event. Mobile technology buyers and other CE professionals can explore 2,700 exhibits over four days in Las Vegas.">
    <meta name="keywords" content="• mobile electronics, mobile video, GPS systems, wiring, GPS technology, mobile video, mobile security, mobile appearance products, aftermarket accessories, head units, sub-woofers, speakers, wireless technology for vehicles, in-vehicle technology">
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions590','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions590" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions590','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards590','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards590" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards590','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards590','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards590','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards590','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards590','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits590','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits590" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits590','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits590','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits590','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits590','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits590','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits590','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits590','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits590','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits590','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel590','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel590" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel590','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news590','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news590" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news590','show')"><a href="/news/upToTheMinute/090308.asp">September 3, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news590','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news590','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news590','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
            ...
            <div id="main-content">
                <div id="main-content-column1">
                    <div class="greenbox-bg">
                        <img src="/images/framework/sidebar-header-invehicletec.gif">
                        
    <a href="/inVehicle/default.asp"></a>
    <ul>
    
    <!--/inVehicle/default.asp-->
...
<div class="right-box-no-border" align="center">
    <img src="/images/framework/invehicle_icons_LG.gif" alt="In-Vehicle Technology" width="176" height="175">
</div>
<div class="right-blue-box" align="center">
    <div class="right-blue-box-header">2009 CES Show Hours</div>
    
    <div>
        10 a.m.-6 p.m. Thursday, Jan. 8*<BR>9 a.m.-6 p.m. Friday, Jan. 9<BR>9 a.m.-6 p.m. Saturday, Jan. 10<BR>9 a.m.-4 p.m. Sunday, Jan. 11<BR><BR>The Venetian Tour Suites open same hours as LVCC and Hilton. Sands Expo and Convention Center is open 8 a.m.-5 p.m. Thursday-Saturday and 8 a.m.-3 p.m. Sunday.<BR><BR><SUB><SUP>*LVCC South Hall opens 9 a.m. opening day.</SUP></SUB>
    </div>
</div>
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        <DIV align=center><A href="http://www.ce.org/i-stage" target=_blank><IMG height=99 src="/images/content/istage175.jpg" width=175 border=0></A></DIV><STRONG>Who's got America's next top gadget?</STRONG><BR><A href="http://www.ce.org/i-stage/" target=_blank>Attend the i-stage competition to see contestants make or break their latest innovations in the pitch of a lifetime. Be there.</A>
        <br /><br />
    </div>
</div>
                    </div>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;In-Vehicle Technology</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/inVehicle/default.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-left">
                        <h1>In-Vehicle Technology</h1>
                                                               
                        

The in-car mobile entertainment industry has continued to drive forward, apparently without too much impact from economic concerns. According to CEA research, aftermarket in-car CE sales jumped 21.5 percent in 2007 to $11.4 billion. CEA projects that growth will continue in 2008 with a 13 percent hike, which comes to $12.8 billion for the category.<BR><BR>Even in economic uncertainty, Americans tend to embrace new products that will add convenience as well as entertainment to their lives. And with products like in-car phones, HD and satellite radio, mobile video&nbsp;and GPS systems, the mobile electronics industry certainly addresses both of those desires. Here's what else to expect this year, which makes the need to attend CES more powerful than ever: 
<UL>
<LI>Sales revenue for mobile entertainment devices should rise about 13 percent in 2008. </LI>
<LI>The aftermarket auto sound category should rise slightly despite a possible decline in satellite radio sales. </LI>
<LI>Consumers may spend even more time in their automobiles, fueling greater interest in in-car devices. </LI>
<LI>HD radio is showing strong signs of life with automakers now installing devices at factory and local stations expanding broadcast service. </LI>
<LI>Sales of OEM (original equipment manufacturer) integration products will continue to rise, possibly accounting for more than 50 percent of category revenue by 2009. </LI>
<LI>Security products could see an expansion this year as drivers look to safeguard their new in-car entertainment features.</LI></UL><A href="/register">Register today for the 2009 International CES</A> to learn, network and investigate new technology in the&nbsp;in-vehicle technology industry and many other consumer technology markets. It's free if you sign up before November 1.<BR><BR><EM><SPAN class=smallText>Source: Digital America, a CEA publication.<BR><BR></SPAN></EM>
...
<div class="sub-content-header">Just for In-vehicle (Mobile) Technology Professionals</div>
<br />

While all consumer technology markets converge at CES, it's still easy to find specific segments that matter to you. If&nbsp;car electronics and other in-vehicle and technology&nbsp;are among&nbsp;your primary interests, start by exploring these parts of the CES show floor:
<UL>
<LI><A href="/exhibits/displays/techZones.asp#752">Location Based Services (LBS) TechZone</A> </LI>
<LI>LVCC North Hall</LI></UL>
        <br /><img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="878"></a>

<div class="sub-content-header">In-vehicle Products at CES</div>
<br />

The International CES is where major mobile and car technology companies converge to make deals and make history. Meet manufacturers and suppliers of: 
<UL>
<LI>Wiring </LI>
...
<P><A href="/exhibitorDirectory/default.asp">Check out the 2009 International CES Exhibitor Directory.</A></P>    
                    </div>
                    <div id="inner-content-right">
                        <br />
