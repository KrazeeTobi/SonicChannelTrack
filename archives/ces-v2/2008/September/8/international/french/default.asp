...
<head><!-- PageID 1129 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Fran&ccedil;ais</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions1129','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions1129" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions1129','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards1129','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards1129" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards1129','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards1129','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards1129','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards1129','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards1129','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits1129','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits1129" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits1129','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1129','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1129','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1129','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1129','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1129','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1129','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1129','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1129','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel1129','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel1129" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel1129','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news1129','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news1129" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news1129','show')"><a href="/news/upToTheMinute/090308.asp">September 3, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news1129','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news1129','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news1129','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li ><a href="/international/french/delegations.asp">Programme Groupe D&eacute;l&eacute;gation</a></li>
...
<div align="center" class="right-blue-box">
    <div class="right-blue-box-blue-interior">
        <ul>
            ...
            <li><a href="/international/spanish/default.asp">Español</a></li>
            
            <li><a href="/international/french/default.asp">Français</a></li>
            
            <li><a href="/international/chinese/default.asp">汉语</a></li>
            
            <li><a href="/international/japanese/default.asp">日本語</a></li>
            
            <li><a href="/international/korean/default.asp">한국어</a></li>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        Certified by:<BR><IMG src="/images/content/IBPlogo.gif"><BR>The Commercial Service logo is a registered trademark of the U.S. Department of Commerce, used with permission. 
        <br /><br />
    </div>
</div>
                    </div>
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        ...
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Resources</a>&nbsp;&gt;&nbsp;Fran&ccedil;ais</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/international/french/default.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<div class="sub-content-header">C'est le Temps pour Inscrivez</div>
<br />

Prenez contact avec des d&eacute;cideurs, des membres des m&eacute;dias et des analystes. Enqu&ecirc;tez sur la nouvelle technologie. D&eacute;couvrez les produits innovateurs qui vont bient&ocirc;t sortir chez plus de 2 700 exposants. CES accueille 30 cat&eacute;gories de produits, y compris audio, imagerie num&eacute;rique, cin&eacute;ma maison, domotique, technologie dans les v&eacute;hicules et sans fil. Rien n'est comparable au salon CES International, du jeudi 8 au dimanche 11 janvier 2009, &agrave; Las Vegas, Nevada, &Eacute;tats-Unis si vous &ecirc;tes un professionnel de l'&eacute;lectronique grand public. Profitez de vous inscrire gratuitement jusqu'au 1er novembre 2008. <A href="/register">Inscrivez-vous d&egrave;s maintenant.</A> 
        <br /><img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="1265"></a>

<div class="sub-content-header">Ceci est l'An pour Vous</div>
<br />

Le CES International est devenu un &eacute;v&eacute;nement mondial majeur qui attire plus de 130 000 participants de quelque 140 pays. Si vous envisagez de venir aux &Eacute;tats-Unis pour assister au CES, cette ann&eacute;e est un excellent choix. &Eacute;tant donn&eacute; la valeur du dollar am&eacute;ricain, le voyage aux &Eacute;tats-Unis vous co&ucirc;tera moins cher que les ann&eacute;es pr&eacute;c&eacute;dentes. <A href="/docs/FR_Visa_Interview_Tips_FNL.pdf" target=_blank>Obtenez des informations suppl&eacute;mentaires concernant le voyage et le visa.</A>
        <br /><img width="1" height="30" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="1266"></a>

<div class="sub-content-header">Information pour les visiteurs &eacute;trangers</div>
<br />

<A href="/international/french/delegations.asp">Programme de groupes de d&eacute;l&eacute;gation<BR></A>Le Salon CES International attire un large public international gr&acirc;ce &agrave; son excellent programme de d&eacute;l&eacute;gation. D&eacute;couvrez comment cr&eacute;er ou rejoindre une d&eacute;l&eacute;gation dans votre pays ou dans votre r&eacute;gion.
<P><A href="/international/french/services.asp">Services internationaux<BR></A>Parmi les nombreux avantages offerts aux participants internationaux, il faut citer des interpr&egrave;tes, des r&eacute;ceptions sp&eacute;ciales de prises de contact, des espaces de travail, des salles de r&eacute;union, etc.<BR><BR><A href="/docs/2009FACTSHET_q6_FR.pdf" target=_blank>Informations g&eacute;n&eacute;rales</A>&nbsp;(pdf)<BR>D&eacute;couvrez l’histoire du Salon, les cat&eacute;gories de produits, les dates des futurs salons, etc.</P>    
                    </div>
                    <div id="inner-content-right">
                        <br />
