...
<head><!-- PageID 331 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - For The Press</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions331','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions331" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions331','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards331','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards331" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards331','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards331','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards331','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards331','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards331','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits331','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits331" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits331','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits331','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits331','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits331','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits331','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits331','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits331','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits331','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits331','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel331','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel331" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel331','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news331','show')" class="link_with_children"><a href="/news/upToTheMinute/default.asp">CES Up to the Minute</a>
                
            <ul id="sub-sub-news331" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('news331','show')"><a href="/news/upToTheMinute/090308.asp">September 3, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news331','show')"><a href="/news/upToTheMinute/082008.asp">August 20, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news331','show')"><a href="/news/upToTheMinute/080608.asp">August 6, 2008</a></li>
                
                    <li onmouseover="showSubMenu('news331','show')"><a href="/news/upToTheMinute/072308.asp">July 23, 2008</a></li>
...
<div class="right-blue-box" align="center">
    <img src="/images/framework/rightcolumn_imagegallery.gif">
    
    <div>
        <STRONG>Need pictures for your stories?<BR></STRONG><A href="/press/imageGallery/default.asp">Download images from the 2008 International CES.</A><BR><BR>
<P style="TEXT-ALIGN: center"><IMG src="/images/photos/p48.jpg"><A href="/press/imageGallery/default.asp"></A><BR><BR></P>
    </div>
</div>
                    </div>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;For The Press</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/press/default.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<img src="/images/framework/pressMain.jpg" width="454" height="229"><br /><br />
<img src="/images/framework/divider-line.gif" width="454" height="15"><br />


<img src="/images/framework/title-moreheadlines.gif" alt="Breaking News" width="454" height="29">

<br /><br />



<a class="footer" href="/press/events/default.asp"><b>Register for CES New York Press Preview Now</b></a>
<br/>

On Nov. 11, get a sneak peek of the products that will be on display in Las Vegas in January and also may turn consumer heads this holiday season.&nbsp;See the exhibitors who have already signed up for this always popular press event.<BR><br /><br />



<a class="footer" href="/press/events/exhibitorPressEvents.asp"><b>Press Day Schedule and Map Now Online</b></a>
<br/>

Press Day is a MUST attend for attending media as major corporate, product and news announcements will be made! Press Day&nbsp;begins 8 a.m. Wednesday, January 7, and wraps up just in time for the preshow CES keynote address.<br /><br />



<a class="footer" href="/pressReg"><b>Press Registration Now Open for the 2009 International CES</b></a>
<br/>

Press members and analysts can register now for the January show. The sooner your register, the sooner you can stay connected to CES developments, including pre-show press events.
...
<div class="sub-content-header">Find CES on Facebook and Twitter</div>
<br />

<A href="http://www.facebook.com/pages/International-CES/9181619833" target=_blank><IMG height=34 hspace=8 src="/images/content/facebook-110.gif" width=110 align=right vspace=4 border=0></A>New this year, check out the <A href="http://www.facebook.com/pages/International-CES/9181619833" target=_blank>International CES Page on Facebook</A>. Become a fan to connect with other professionals that share your interests and stay informed on what's being planned for the upcoming 2009 International CES. Facebook is a registered trademark of Facebook, Inc.<BR><BR><STRONG>Tweet! Tweet! CES is Now on Twitter</STRONG> <BR><A href="http://twitter.com/2009CES" target=_blank><IMG height=31 hspace=8 src="/images/content/twitter-120.gif" width=120 align=right border=0></A>Twitter is a free service that lets you keep in touch with people using the web, your phone or IM. <A href="http://twitter.com/2009CES" target=_blank>Join today to start receiving updates</A> about the 2009 International CES.     
                    </div>
                    <div id="inner-content-right">
                        <br />
