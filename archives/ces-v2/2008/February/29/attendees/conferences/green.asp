...
<html>
<head><!-- PageID 4969 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;CES is Going Green</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/conferences/green.asp';
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue4969', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue4969', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue4969" id="leftAddedValue4969" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">CES is Going Green<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">

<P><IMG height=200 src="/images/ces_photos/Green_Screen_03.jpg" width=180 align=right>The International CES has committed to <A href="http://www.cesweb.org/green">reducing its impact</A> on the environment wherever we can and offsetting what we cannot avoid.&nbsp;Any damage caused to the environment by the show's carbon output will be compensated through CES' donations to renewable energy, energy efficiency and reforestation projects. <BR><BR><A href="http://www.carbonfund.org/ces" target=_new><IMG height=84 src="/images/general/cfproducts.gif" width=114 align=left border=0></A>In addition to offsetting the carbon emissions of all CES venues, freight, shuttle buses and hotel rooms,&nbsp;CES will provide attendees the opportunity to offset their airline travel via Carbonfund.org. <A href="http://www.carbonfund.org/ces" target=_new>Make a small donation to&nbsp;offset your CES carbon footprint. </A><BR><BR><SPAN class=subhead>Did you know…</SPAN>&nbsp;</P>
<UL type=disc>
<LI style="LINE-HEIGHT: 13.4pt; tab-stops: list .5in"><SPAN style="FONT-FAMILY: ">Recycling bins will be placed across the show floor this year to divert cans, cups, glass products and paper</SPAN> </LI>
<LI style="LINE-HEIGHT: 13.4pt; tab-stops: list .5in"><SPAN style="FONT-FAMILY: ">All CES flyers are printed on recycled paper using soy inks </SPAN></LI>
<LI style="LINE-HEIGHT: 13.4pt; tab-stops: list .5in"><SPAN style="FONT-FAMILY: ">Remaining show publications and flyers will be recycled at the close of the event</SPAN> </LI>
<LI style="LINE-HEIGHT: 13.4pt; tab-stops: list .5in"><SPAN style="FONT-FAMILY: "></SPAN>Attendee food containers and utensils are biodegradable, made from hemp, corn byproduct or other organic materials </LI>
...
<LI>Recycled carpet will be used in some convention spaces at the LVCC</LI></UL>
<P><A href="http://www.planetgreen.com" target=_new><IMG height=61 hspace=5 src="/images/partners/PG2.jpg" width=130 align=right border=0></A>Special thanks to our partner,&nbsp;Discovery Communications’ Planet Green – the first 24-hour eco-lifestyle channel dedicated to making a difference by providing tools, information and content that will enlighten, empower and most importantly, entertain. Planet Green’s platforms include leading eco-lifestyle website <A href="http://www.treehugger.com/" target=_new>TreeHugger.com</A> and the recently launched solutions-oriented <A href="http://www.planetgreen.com/" target=_new>PlanetGreen.com</A>.&nbsp;</P>
<P><SPAN class=section_title>Green Conference Programming</SPAN><BR>CES includes a growing list of conference sessions concerning green electronics, including:&nbsp;</P>
<UL>
<LI><A href="/attendees/conferences/search/session_detail.asp?ID_session=SS7">Keeping CE off the Curb</A> </LI>
<LI><A href="/attendees/conferences/search/session_detail.asp?ID_session=IA9&ID_track=IA_CES08">Tech's Greener Pastures</A> </LI>
<LI><A href="/attendees/conferences/search/session_detail.asp?ID_session=IA13&ID_track=IA_CES08">Sustainability 101: How CE Industry Leaders are Setting an Example in Environmental Stewardship</A> </LI>
<LI><A href="/attendees/conferences/search/session_detail.asp?ID_session=IA11&ID_track=IA_CES08">A Powerful Force: Energy Efficiency</A> </LI>
<LI><A href="http://www.cesweb.org/attendees/conferences/search/session_detail.asp?ID_session=IA16">Complying with the Patchwork: A Primer on State Electronics Recycling Requirements<BR></A></LI></UL></span>
