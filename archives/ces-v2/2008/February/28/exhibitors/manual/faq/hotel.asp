...
<br><br>
<strong>A: </strong>Many CES hotels are already sold out of the CES rate. That does not mean you cannot reserve at your favorite hotel. This means that there may still be rooms at a hotel, but at a higher (prevailing) rate. Please check <A href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</A> for a complete list of hotels. <BR><BR>If you are looking for a group block (20 or more rooms), please see the <A href="/rd_block_request.asp">group block request form</A> under the Hotel/Transit section of CESweb.org. 
