...
<title>2008 International CES:&nbsp;About CES</title>
...
<span class="text">
With more than four decades of success, the International CES reaches across global markets, connects the industry and enables CE innovations to grow and thrive. <BR><BR>The International CES is produced by the <A href="http://www.ce.org" target=_new>Consumer Electronics Association</A> (CEA),&nbsp;the preeminent trade association promoting growth in the consumer technology industry. CEA represents more than 2,100 corporate members involved in the design, development, manufacturing, distribution and integration of consumer electronics products. All profits from CES are reinvested into industry services, including technical training and education, industry promotion, engineering standards development, market research and legislative advocacy.</span>
...
<span class="text">
<A href="/about_ces/multimedia.asp"><STRONG>Multimedia&nbsp;Library</STRONG></A><BR>Wanting another avenue to get all of your CES information? Find webcasts, podcast feeds and blog information here.<BR><BR><A href="/about_ces/fact_sheet.asp"><STRONG>CES Fact Sheet</STRONG></A><BR>From exhibitor profiles to how the CES came to be, scroll through the CES Fact Sheet&nbsp;for information on the largest annual consumer technology show in the world. 
</span>
<!-- text for main page -->
</div>
...
<tr> 
    ...
    <td width="180" valign="top" class="white_box_bg"><SPAN class=section_title>CES Image Gallery<BR></SPAN><BR><IMG src="/images/ces_photos/floor2_172.jpg"><BR><BR>Need pictures? Visit the CES press section. <A href="/press/images/default.asp">Go.</A></td>
...
<tr> 
    <td width="5" valign="top" background="/global_images2005/1.0.box_L.gif"><img height="5" width="5" src="/global_images2005/spacer.gif" vspace="1"></td>
    <td width="180" valign="top" class="white_box_bg"><SPAN class=subhead>Your questions answered</SPAN><BR>For a list of frequently asked questions regarding the&nbsp;International CES, visit our FAQs section, divided into categories for <A href="/faqs/general.asp">attendees</A>, <A href="/faqs/exhibitors.asp">exhibitors</A>, <A href="/faqs/speakers.asp">speakers</A>, and <A href="/faqs/press.asp">journalists/analysts</A>.<BR></td>
    <td width="5" background="/global_images2005/1.0.box_R.gif"><img height="5" width="5" src="/global_images2005/spacer.gif"></td>
</tr>
<tr> 
    <td width="5" height="14"><img height="14" width="5" src="/global_images2005/1.0.box_BL.gif" align="top"></td>
