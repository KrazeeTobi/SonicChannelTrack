...
<html>
<head><!-- PageID 197 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;Floor Plans</title>
...
Floor Plans<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container35")) { document.getElementById("fourth_row_container35").style.display = "";}
        //-->
    </script>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue197', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue197', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue197" id="leftAddedValue197" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">2008 International CES Floor Plans<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
Interactive floor plans, updated frequently, provide an aerial view of the entire 2008 International CES. <BR><BR><A href="/expocadvr2/shows/ces08/start.html" target=_blank><B>Download the floor plans</B></A>, powered by ExpoCad, for a comprehensive glimpse of the 2008 International CES show layout. <SPAN class=text_colored>Please be patient while the floor plans and full exhibitor list load. This may take a few moments.</SPAN> <BR><BR><SPAN class=subhead>General directions for use</SPAN>
<UL>
...
<OL type=1>
<LI>In Internet Explorer, go to Tools &gt; Internet Options. Click on the Advanced Tab (<A href="/docs/vr2_troubleshoot.pdf" target=_blank>download graphic</A>). </LI>
...
<LI>Restart your computer before reloading the floor plans.</LI></OL></TD></TR></TBODY></TABLE><BR>Exhibitors, if you have questions regarding your booth space, please call CES Sales at (703) 907-7645.</span>
