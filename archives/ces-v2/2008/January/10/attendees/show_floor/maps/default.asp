...
<html>
<head><!-- PageID 196 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;Venue Maps</title>
...
Venue Maps<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container167")) { document.getElementById("fourth_row_container167").style.display = "";}
        //-->
    </script>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue196', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue196', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue196" id="leftAddedValue196" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Venue Maps<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->
...
<div class="section_title">Navigating to High-Performance Audio & Home Theater Exhibitors</div>
<span class="text">
<IMG height=53 alt="High-performance Audio &amp; Home Theater Icon" hspace=5 src="/images/general/HPAHT.gif" width=21 align=left longDesc="Look for this icon on the CES show floor to find high-performance audio &amp; home theater exhibitors.">Let us help you find&nbsp;the more than 250 high-performance audio &amp; home theater&nbsp;exhibits at the 2008 International CES. <A href="/docs/2008_CES_Venetian_HPAHT_map.pdf" target=_blank>Download this map (pdf)</A> to easily navigate your way to the companies exhibiting at The Venetian.
</span>
<a name="238"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">International CES Location Map</div>
<span class="text">
Locate registration, shuttle bus routes, parking and much more, including the new destinations at Sands Expo and Convention Center/The Venetian. Download and print an <A href="/docs/2k8CESLocationmap.pdf" target=_blank>Adobe PDF version of the International CES Location map</A>.<BR>Updated:&nbsp;December 18, 2007 
<P align=center><A href="/docs/2k8CESLocationmap.pdf" target=_blank><IMG src="/images/general/2k8CESLocationmap_thumbnail.jpg"></A></P>
</span>
<!-- text for main page -->
</div>
