...
<!-- /left column -->
    ...
    <tr>
        ...
        <td width="3" class="exhibitor9"><img src="/global_images2005/spacer.gif" width="3" height="1"></td>
        <td class="exhibitor9" valign="top">The pre-registered media/analyst list&nbsp;for the 2008 CES&nbsp;helps with your PR efforts.
...
<div class="section_title">CES is S.U.R.E. to Help</div>

<span class="text">
The acronym S.U.R.E. describes our values as an organization and the value we bring to our relationship with every customer. Our marketing partnership with you is built on a Sense of Urgency, Responsiveness and Empathy, because we measure our success by your success. Let CES help you with your needs. <A href="/exhibitors/space/contacts.asp">Contact a business development representative today.</A>
</span>
<a name="5248"></a>
