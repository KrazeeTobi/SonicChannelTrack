...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions381','show')" class="first_link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
...
<IMG height=133 hspace=8 src="/images/content/lvcc.jpg" width=200 align=right>Yes, CES is the world's largest consumer technology tradeshow. But more importantly, it's really several shows within a show. Enter one part of the show floor to find more in-vehicle technology exhibitors than any other event. Step into another area to discover the world of home theater and video. See what happens at the International CES in each of its venues — the Las Vegas Convention Center/Las Vegas Hilton and the Sands Expo and Convention Center/The Venetian.<BR><BR>Need a visual? The show locations map will be available in late July.<BR><BR>
