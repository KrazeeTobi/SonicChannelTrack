...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions338','show')" class="first_link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
...
<P>Press, analysts and bloggers: <A href="http://registration.experient-inc.com/ShowCES091/Default_Press.aspx" target=_blank>It's time to register for the 2009 International CES.</A> Remember, if you sign up before November 1, you'll avoid&nbsp;the $100 registration fee.</P>
