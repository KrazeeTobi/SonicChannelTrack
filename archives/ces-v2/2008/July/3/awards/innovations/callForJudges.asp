...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions1251','show')" class="first_link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
...
If you're a member of the press, an independent designer or an engineer, we want you! Are you able to volunteer a little of your time to judge one of the most prestigious awards programs in the consumer electronics industry? Do you consider yourself a knowledgeable consumer electronics design professional, with expertise in any of the 34 <A href="/awards/innovations/categories.asp">Innovations 2009 awards categories</A>? Do you have at least five years of experience in the CE industry through the media or as an industry analyst or professional? <BR><BR>The call for judges opens July 21, 2008.<BR><BR>The Innovations Design and Engineering Awards program recognizes the most innovative consumer electronics products in 34 categories and has become a hallmark for the best-designed products in consumer technology. Download the awards category guide that includes examples of eligible products within a category to assist you in selecting the categories you feel most qualified to judge. <BR><BR>Each awards category is judged by a three-member panel consisting of an independent industrial designer, independent engineer or industry analyst and a member of the trade press. The judging process is conducted online and will begin October 8, 2008 and end on October 19, 2008. We have determined that it takes approximately 10-15 minutes to evaluate an entry. Judges will be required to judge a minimum of two categories. In 2008, the categories contained an average of 20 entries.<BR><BR>
<P>
<TABLE cellSpacing=1 cellPadding=1 width="60%" border=0>
<TBODY>
<TR>
<TD vAlign=top><STRONG>Endorsed by IDSA</STRONG><BR><A href="www.idsa.org"><IMG height=66 src="/images/content/IDSA.gif" width=100 vspace=5></A></TD>
<TD vAlign=top><STRONG>Powered by mBlast</STRONG><BR><A href="www.mblat.com"><IMG height=36 src="/images/content/mblast.gif" width=200 vspace=10></A></TD></TR></TBODY></TABLE></P>
