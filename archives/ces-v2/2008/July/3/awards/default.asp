...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions306','show')" class="first_link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
...
<H4><A href="/awards/innovations/default.asp">International CES Innovations Design and Engineering Awards</A></H4>Waterproof hard drives? Gutter-cleaning robots? While you never know what products you'll see at the year's most outstanding developments in engineering and design,&nbsp;one thing's for sure:&nbsp;It's innovation exemplified.&nbsp;<BR><BR>
...
<H4><A href="/awards/GMA.asp">Global Media Awards</A></H4>This new awards program focuses on technology and content programming at the 2009 International CES and comes from a recent partnership with the Consumer Electronics Association (CEA) and the National Academy of Television Arts and Sciences (NATAS).<BR><BR>
<H4>The Technology &amp; Engineering Emmy Awards&nbsp;(Information coming soon)</H4>The red carpet comes to CES. The Technology &amp; Engineering Emmy Awards honor achievements in Science &amp; Technology for Television and Advanced Media Technology, which includes awards for best use by commercials as well as programmers.<BR>
<P></P>    
                    </div>
                    <div id="inner-content-right">
                        <br />
