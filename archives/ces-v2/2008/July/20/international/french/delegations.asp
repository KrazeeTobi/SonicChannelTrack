...
<head><!-- PageID 1137 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Programme Groupe D&eacute;l&eacute;gation</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions1137','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions1137" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions1137','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards1137','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards1137" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards1137','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards1137','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards1137','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards1137','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards1137','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits1137','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits1137" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits1137','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1137','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1137','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1137','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1137','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1137','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1137','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1137','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1137','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel1137','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel1137" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel1137','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
            ...
            <div id="main-content">
                <div id="main-content-column1">
                    <div class="greenbox-bg">
                        <img src="/images/framework/sidebar-header-intresources.gif">
                        
    <a href="/international/french/default.asp"></a>
    <ul>
    
    
            <li ><a href="/international/french/travel.asp">Voyage et visa</a></li>
        
            <li class="selected"><a href="/international/french/delegations.asp">Programme Groupe D&eacute;l&eacute;gation</a></li>
        
            <li ><a href="/international/french/services.asp">Services internationaux</a></li>
        <!--/international/french/default.asp-->
...
<div align="center" class="right-blue-box">
    <div class="right-blue-box-blue-interior">
        <ul>
            ...
            <li><a href="/international/chinese/services.asp">汉语</a></li>
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        ...
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Resources</a>&nbsp;&gt;&nbsp;<a href="/international/french/default.asp" class="footer">Français</a>&nbsp;&gt;&nbsp;Programme Groupe D&eacute;l&eacute;gation</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/international/french/delegations.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-left">
                        <h1>Programme Groupe D&eacute;l&eacute;gation</h1>
                                                               
                        

Vous souhaitez amener un groupe de votre pays au Salon CES International ? En tant que chef de d&eacute;l&eacute;gation, vous pouvez permettre &agrave; vos clients de mieux profiter de leur visite du salon en les aidant &agrave; d&eacute;cider des exposants &agrave; rencontrer, mais aussi simplifier l’aspect logistique de leur voyage. La CEA propose un programme de groupe avantageux, pour les chefs de d&eacute;l&eacute;gation comme pour les participants.<BR><BR>La date limite d'inscription pour les chefs de d&eacute;l&eacute;gation 2009 est le 16 novembre 2008. <BR><BR>L'inscription des d&eacute;l&eacute;gations commence le 3 juillet. L'inscription des visiteurs individuels est ouverte d&egrave;s &agrave; pr&eacute;sent.<BR><BR><BR><STRONG>D&eacute;tails du programme<BR></STRONG>Pour s’inscrire en tant que chef de d&eacute;l&eacute;gation :
<UL>
<LI>Le programme de d&eacute;l&eacute;gation est r&eacute;serv&eacute; exclusivement aux participants qui viennent de l’ext&eacute;rieur des &Eacute;tats-Unis. </LI>
<LI>Les d&eacute;l&eacute;gations doivent &ecirc;tre constitu&eacute;es uniquement de professionnels de l’industrie de l’&eacute;lectronique grand public. </LI>
<LI>Les d&eacute;l&eacute;gations doivent &ecirc;tre constitu&eacute;es d’un minimum de 15 membres. Les membres de groupes inf&eacute;rieurs &agrave; 15 participants doivent s’inscrire en tant que participants individuels.<BR></LI></UL>
<P><STRONG>Avantages r&eacute;serv&eacute;s aux chefs de d&eacute;l&eacute;gation</STRONG></P>
<UL>
<LI>Prise en charge de l’h&ocirc;tel pour les chefs de d&eacute;l&eacute;gation de 50 membres (15 pour les d&eacute;l&eacute;gations gouvernementales). Les groupes doivent confirmer leur participation quatre semaines avant le Salon CES afin de garantir la disponibilit&eacute;. </LI>
<LI>Bulletin d’information communiquant les toutes derni&egrave;res informations concernant le programme, le salon CES et les dates limites pour b&eacute;n&eacute;ficier des avantages du programme. </LI>
<LI>Occasion de voyager avec d'autres professionnels de l'&eacute;lectronique grand public de votre pays. </LI>
<LI>Acc&egrave;s &agrave; trois centres de commerce international (ICC) o&ugrave; les visiteurs et les exposants internationaux peuvent rester en contact avec leurs activit&eacute;s professionnelles gr&acirc;ce &agrave; des stations Internet, r&eacute;server et utiliser des salles priv&eacute;es, profiter de l&eacute;gers rafra&icirc;chissements, ou tout simplement se d&eacute;tendre. Les ICC peuvent vous servir de bureau &agrave; distance quand vous &ecirc;tes au CES. </LI>
<LI>Acc&egrave;s &agrave; des sp&eacute;cialistes du commerce international du D&eacute;partement am&eacute;ricain du commerce qui peuvent aider les participants et les exposants internationaux &agrave; trouver des correspondants et des consultants en mati&egrave;re de commerce d'exportation.<BR></LI></UL>
<P><STRONG>Avantages r&eacute;serv&eacute;s aux membres des d&eacute;l&eacute;gations</STRONG></P>
<UL>
<LI>Liste des exposants exportateurs ou int&eacute;ress&eacute;s par l’exportation vers le pays et/ou la r&eacute;gion du groupe. </LI>
...
<LI>Invitation &agrave; la r&eacute;ception CES International.&nbsp; <BR></LI></UL>
<P></P>
<P><B><SPAN lang=FR style="COLOR: #333333">Programme des acheteurs internationaux du D&eacute;partement am&eacute;ricain du commerce</SPAN></B><SPAN lang=FR style="COLOR: #333333"><BR><IMG height=158 src="/images/content/doc_logo(1).JPG" width=155 align=right>CES International est fier de participer au Programme des acheteurs internationaux (International Buyer Program - IBP), sponsoris&eacute; par l'Administration du commerce international du D&eacute;partement du commerce des &Eacute;tats-Unis. De nombreux sp&eacute;cialistes commerciaux &eacute;trangers emm&egrave;nent des d&eacute;l&eacute;gations au CES dans le cadre de l'IBP. <A href="http://www.export.gov/eac/index.asp" target=_blank>Cherchez le service commercial de votre pays.</A>&nbsp;</SPAN></P>
<P>Si vous avez des questions sur l’inscription en tant que chef de d&eacute;l&eacute;gation ou souhaitez contacter une d&eacute;l&eacute;gation de votre pays, veuillez contacter la CEA &agrave; <A href="mailto:delegations@CE.org">delegations@CE.org</A>.<BR></P>
