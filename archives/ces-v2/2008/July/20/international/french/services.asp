...
<head><!-- PageID 1139 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Services internationaux</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions1139','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions1139" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions1139','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards1139','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards1139" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards1139','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards1139','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards1139','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards1139','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards1139','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits1139','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits1139" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits1139','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1139','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1139','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1139','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1139','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1139','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1139','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1139','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1139','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel1139','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel1139" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel1139','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li class="selected"><a href="/international/french/services.asp">Services internationaux</a></li>
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        ...
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Resources</a>&nbsp;&gt;&nbsp;<a href="/international/french/default.asp" class="footer">Français</a>&nbsp;&gt;&nbsp;Services internationaux</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/international/french/services.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<STRONG>Programme des acheteurs internationaux <BR></STRONG>CES International est fier de participer au Programme des acheteurs internationaux (International Buyer Program), sponsoris&eacute; par l'Administration du commerce international du D&eacute;partement du commerce des &Eacute;tats-Unis. Des sp&eacute;cialistes du commerce international du D&eacute;partement du commerce des &Eacute;tats-Unis sont &agrave; disposition au principal Centre de commerce international (ICC) (LVCC, South Hall Connector, Salle S224/225) pour aider &agrave; trouver des correspondants et des consultants en commerce d'exportation au profit des participants et exposants internationaux. <BR><BR><STRONG>Zone d'inscription internationale <BR></STRONG>LVCC, South Hall 2 (Premier arr&ecirc;t des navettes des h&ocirc;tels) <BR>Sands, R&eacute;ception, niveau inf&eacute;rieur <BR>Une zone d'inscription r&eacute;serv&eacute;e sp&eacute;cialement &agrave; l'intention des participants internationaux est situ&eacute;e dans la zone d'inscription principale du LVCC, South Hall 2 et au Sands. Dans ces deux endroits, les visiteurs internationaux peuvent s'inscrire sur place, prendre un porte badge (obligatoire pour entrer au salon) et obtenir l'aide d'interpr&egrave;tes en plusieurs langues s'ils ont des questions concernant l'inscription.<BR><BR><STRONG>Centres de commerce international (ICC) <BR></STRONG>LVCC, South Hall Connector, Salle S224/225<BR>Las Vegas Hilton, Hilton Center, Stand 40028<BR>Sands Expo and Convention Center, R&eacute;ception, niveau sup&eacute;rieur Les Centres de commerce international (ICC) sont des endroits permettant aux visiteurs et exposants internationaux de garder le contact avec leur bureau gr&acirc;ce &agrave; des stations Internet, de r&eacute;server et d'utiliser des salles de r&eacute;union priv&eacute;es, de profiter de rafra&icirc;chissements l&eacute;gers ou tout simplement de se d&eacute;tendre. Il existe trois Centres de commerce international qui peuvent vous tenir lieu de bureau quand vous &ecirc;tes au CES. 
<P><BR><STRONG><IMG hspace=6 src="/images/content/MyCES-172.gif" align=right>MyCES Personal Planner – Pour organiser une exposition parfaite</STRONG><BR>Le MyCES Personal Planner est un outil bas&eacute; sur l'Internet qui vous permet de cr&eacute;er une carte et un emploi du temps personnalis&eacute;s vous indiquant les exposants que vous voulez voir et les sessions de conf&eacute;rence auxquelles vous souhaitez assister et identifiant les nouveaux partenaires d'affaires que vous voulez rencontrer, ce qui vous aide &agrave; profiter au maximum de votre temps &agrave; CES. <A href="/myCES.asp">En savoir plus (en anglais).</A></P>
<P><A href="http://www.myces.bdmetrics.com" target=_blank>Planifiez un salon parfait d&egrave;s aujourd’hui.</A></P>
<P><STRONG>Services de traduction</STRONG><BR>Une &eacute;quipe multilingue est &agrave; votre disposition dans tous les ICC, dans la zone d’inscriptions internationales au rez-de-chauss&eacute;e du South Hall et au Concierge Center. Les interpr&egrave;tes parlent couramment les langues suivantes : Espagnol, Allemand, Fran&ccedil;ais, Chinois, Japonais, Cor&eacute;en, Italien et Portugais. Veuillez profiter de ces services si vous avez des questions au sujet du salon. </P>
