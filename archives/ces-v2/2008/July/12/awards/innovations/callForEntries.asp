...
<head><!-- PageID 313 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Call for Entries</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions313','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions313" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions313','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards313','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards313" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards313','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards313','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards313','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards313','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards313','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits313','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits313" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits313','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits313','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits313','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits313','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits313','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits313','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits313','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits313','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits313','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel313','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel313" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel313','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news313','show')" class="link_with_children"><a href="/press/default.asp">For The Press</a>
                
            <ul id="sub-sub-news313" style="display: none;" onmouseout="setSubMenuTimer()">
            ...
            <ul id="sub-sub-news" style="display: none;" onmouseout="setSubMenuTimer()">
                    ...
                    <li onmouseover="showSubMenu('news313','show')"><a href="/press/imageGallery/default.asp">Image Gallery</a></li>
                
                    <li onmouseover="showSubMenu('news313','show')"><a href="/press/imageGallery/people.asp">People and Events</a></li>
                
                    <li onmouseover="showSubMenu('news313','show')"><a href="/press/imageGallery/floor.asp">Show Floor Buzz</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
            ...
            <li class="selected"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://blog.ce.org" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/awards/default.asp" class="footer">Awards</a>&nbsp;&gt;&nbsp;<a href="/awards/innovations/default.asp" class="footer">CES Innovations Awards</a>&nbsp;&gt;&nbsp;Call for Entries</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/awards/innovations/callForEntries.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
// javascript for e-mail this page tool - gets the url of the page the user is on before the e-mail page tool button is clicked
	...
	<!-- Start FORM -->
	If you would like to be added to the Innovations 2009 mailing list, fill out the form below. We'll notify you when we begin accepting entries. (<font style="color:red"><b>* </b></font> Denotes required field.)<br />
	<form name="registration_form" action="/awards/innovations/callForEntries.asp" method="post" onSubmit="return validate_reg_form();">
	<img src="/images/framework/spacer.gif" alt="" width="100%" height="5" hspace="0" vspace="0" border="0"><br />
	<img alt="separator" src="/images/framework/divider-line-long.gif"/>
	<h2>Sign up to receive Innovations 2009 Call for Entries updates</h2><br />
	<table width="100%" cellpadding="0" cellspacing="0" border="0">

		
	<tr>
		<td align="right"><font style="color:red"><b>* </b></font>First Name&nbsp;&nbsp;</td>
		<td><input type="text" size="35" name="first_name" class="formData" value=""></td>
		<td rowspan="12" align="right"><img src="/awards/innovations/images/innov2009.jpg" alt="Innovations Awards"></td>
	</tr>
	<tr><td height="4"></td></tr>
	<tr>
		<td align="right"><font style="color:red"><b>* </b></font>Last Name&nbsp;&nbsp; </td>
		<td><input type="text" size="35" name="last_name" class="formData" value=""></td>
		<td>&nbsp;</td>
	</tr>
	<tr><td height="4"></td></tr>
	<tr>
		<td align="right">Job Title&nbsp;&nbsp; </td>
		<td><input  type="text" size="35" name="title" class="formData" value=""></td>
		<td>&nbsp;</td>
	</tr>
	<tr><td height="4"></td></tr>	
	<tr>
		<td align="right"><font style="color:red"><b>* </b></font>Company Name&nbsp;&nbsp; </td>
		<td><input  type="text" size="35" name="company" class="formData" value=""></td>
		<td>&nbsp;</td>
	</tr>
	<tr><td height="4"></td></tr>	
	<tr>
		<td align="right"><font style="color:red"><b>* </b></font>Address 1&nbsp;&nbsp; </td>
		<td><input  type="text" size="35" name="address1" class="formData" value=""></td>
		<td>&nbsp;</td>
	</tr>
	<tr><td height="4"></td></tr>	
	<tr>
		<td align="right">Address 2&nbsp;&nbsp; </td>
		<td><input  type="text" size="35" name="address2" class="formData" value=""></td>
		<td>&nbsp;</td>
	</tr>
	<tr><td height="4"></td></tr>	
	<tr>
		<td align="right"><font style="color:red"><b>* </b></font>City&nbsp;&nbsp; </td>
		<td><input  type="text" size="35" name="city" class="formData" value=""></td>
		<td>&nbsp;</td>
	</tr>
	<tr><td height="4"></td></tr>	
	<tr>
		<td align="right"><font style="color:red"><b>* </b></font>State/Province&nbsp;&nbsp; </td>
		<td><input  type="text" size="35" name="state" class="formData" value=""></td>
		<td>&nbsp;</td>
	</tr>
	<tr><td height="4"></td></tr>	
	<tr>
		<td align="right"><font style="color:red"><b>* </b></font>Postal Code&nbsp;&nbsp; </td>
		<td><input  type="text" size="35" name="zip" class="formData" value=""></td>
		<td>&nbsp;</td>
	</tr>
	<tr><td height="4"></td></tr>	
	<tr>
		<td align="right"><font style="color:red"><b>* </b></font>Country&nbsp;&nbsp; </td>
		<td><input  type="text" size="35" name="country" class="formData" value=""></td>
		<td>&nbsp;</td>
	</tr>
	<tr><td height="4"></td></tr>	
	<tr>
		<td align="right"><font style="color:red"><b>* </b></font>E-mail&nbsp;&nbsp; </td>
		<td><input  type="text" size="35" name="email" class="formData" value=""></td>
		<td>&nbsp;</td>
	</tr>
	<tr><td height="4"></td></tr>	
	<tr>
		<td align="right"><font style="color:red"><b>* </b></font>Phone&nbsp;&nbsp; </td>
		<td><input  type="text" size="35" name="phone" class="formData" value=""></td>
		<td>&nbsp;</td>
	</tr>
	<tr><td height="4"></td></tr>	
	<tr>
		<td>&nbsp;</td>
		<td colspan="2"><input type="checkbox" size="35" name="future_contact" value="1" class="formData">&nbsp;&nbsp;Add me to the International CES distribution list for future CES updates!**</td>
	</tr>
