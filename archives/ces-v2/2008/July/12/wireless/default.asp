...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news593','show')" class="link_with_children"><a href="/press/default.asp">For The Press</a>
            ...
            <ul id="sub-sub-news" style="display: none;" onmouseout="setSubMenuTimer()">
                    ...
                    <li onmouseover="showSubMenu('news593','show')"><a href="/press/imageGallery/default.asp">Image Gallery</a></li>
                
                    <li onmouseover="showSubMenu('news593','show')"><a href="/press/imageGallery/people.asp">People and Events</a></li>
                
                    <li onmouseover="showSubMenu('news593','show')"><a href="/press/imageGallery/floor.asp">Show Floor Buzz</a></li>
