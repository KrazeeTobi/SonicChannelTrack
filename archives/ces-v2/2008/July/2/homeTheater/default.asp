...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions587','show')" class="first_link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
...
<UL>
<LI>Household penetration of home theater systems rise. </LI>
...
<LI>"Virtual" surround sound systems proliferate. </LI>
<LI>One-piece amplified speaker systems called "sound bars" emerge. </LI>
<LI>Price declines enhance TV purchase appeal. </LI>
...
<LI>Telephone companies continue laying fiber lines for expanded offerings.</LI></UL><A href="/register">Register today for the 2009 International CES</A> to learn, network and investigate new technology&nbsp;in the home theater and video industries as well as many other consumer technology markets. It's free if you sign up before November 1.<BR><BR><SPAN class=smallText><EM>Source: Digital America, a CEA publication.</EM></SAN></SPAN>
...
<P>While all consumer technology markets converge at CES, it's still easy to find specific segments that matter to you. If home theater and video technology&nbsp;are your primary interests, start by exploring these parts of the CES show floor:</P>
<UL>
...
<P>At the International CES, meet manufacturers and suppliers of: </P>
<UL>
