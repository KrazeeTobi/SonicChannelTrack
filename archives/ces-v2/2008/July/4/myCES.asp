...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions538','show')" class="first_link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
...
<P><A href="http://myces.bdmetrics.com/account/login.aspx" target=_blank><IMG height=93 src="/images/content/MyCES_240.gif" width=240 align=right border=0></A>MyCES Personal Planner helps you connect with the exhibitors, products and sessions YOU want to see at the show! MyCES is now a year-round tool that keeps you in touch with the industry even after CES is over. Use your MyCES portal&nbsp;every day&nbsp;to stay in touch with the latest consumer electronics (CE) news.&nbsp;Plus, keep up-to-date on company information about the exhibitors and their products you saw (or plan to see) at CES.<BR><BR>With MyCES Personal Planner you can:</P>
<UL>
