...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions542','show')" class="first_link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
...
<br /><P><SPAN class=text><SPAN class=subhead>Las Vegas, Nevada, USA</SPAN><BR></P>
<UL>
...
<br /><P>Manufacturers, developers and suppliers of consumer technology hardware, content, technology delivery systems and related products and services. Browse the online <A href="/exhibitorDirectory/default.asp">International CES Exhibitor Directory</A>, or <A href="/exhibitors/space/default.asp">learn how your company can exhibit at CES</A>.</P>
...
<br /><P>The International CES is the industry's largest educational forum to help companies expand their businesses and understand new technology. Approximately 200 conferences and more than 300 expert speakers encompass International CES conferences, Industry Insiders and SuperSessions to discuss hot industry trends and topics.<BR><BR>Keynote presentations feature executives from the world's largest and most successful companies and result in remarkable media coverage for the speakers. CEOs rank the CES as one of their top 10 most desired speaking opportunities, according to a Burson-Marsteller Most Valued Podium survey. Check CESweb.org in late September for the complete conference schedule.</P>
...
<br /><P>The International CES is sponsored, produced and managed by the <A href="http://www.CE.org" target=_blank>Consumer Electronics Association (CEA)</A>. Show proceeds are used to fund industry services.</P>
...
<br /><P>Consumer Electronics Association (CEA)<BR>1919 South Eads Street<BR>Arlington, VA 22202 USA <BR>Phone: 866-233-7968 (USA), 301-631-3983 (International)<BR>Fax: 703-907-7601<BR><A href="mailto:CESinfo@CE.org">CESinfo@CE.org</A> <BR><A href="http://www.CE.org" target=_blank>http://www.CE.org</A></P>
