...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions368','show')" class="first_link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
...
<UL>
<LI>Consumers valued portability in their music-playback gear by almost 2:1 in factory-level dollar volume. </LI>
<LI>New music sources entered the home audio mainstream. </LI>
<LI>The MP3 player spawned a new audio product, the MP3 player speaker dock. </LI>
