...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions304','show')" class="first_link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
...
The International CES is the consumer technology industry's largest educational forum to help companies expand their businesses and understand new technology. <BR><BR>
<H3>Did You Know?</H3>
<UL>
...
<LI>The CES conference program encompasses more than 200 conference sessions with 500 expert speakers discussing hot industry trends and topics.<BR></LI></UL>Want to see the 2009 International CES Conference Program lineup? It's coming this September. <BR><BR>
<H3><IMG height=125 hspace=8 src="/images/photos/p18.jpg" width=165 align=right>Calling All Speakers</H3>Want to BE part of the 2009 International CES Conference Program lineup? <A href="/sessions/speakers/default.asp">Call for speakers is now open.</A>
