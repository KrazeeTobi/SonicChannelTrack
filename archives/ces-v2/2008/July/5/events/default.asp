...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions305','show')" class="first_link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        <P align=center><A href="http://www.ce.org/i-stage" target=_blank><IMG height=99 src="/images/content/istage175.jpg" width=175 border=0></A><BR></P><A href="http://www.ce.org/i-stage/" target=_blank>
<P><STRONG>Think you've got America's next top gadget? Prove it, and win a turnkey exhibit at the 2009 International CES.</STRONG></A></P>
        <br /><br />
    </div>
</div>
                    </div>
