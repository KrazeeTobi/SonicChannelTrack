...
<head><!-- PageID 587 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Home Theater/Video</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions587','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions587" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions587','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards587','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards587" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards587','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards587','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards587','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards587','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards587','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits587','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits587" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits587','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits587','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits587','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits587','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits587','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits587','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits587','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits587','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits587','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel587','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel587" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel587','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news587','show')" class="link_with_children"><a href="/press/default.asp">For The Press</a>
                
            <ul id="sub-sub-news587" style="display: none;" onmouseout="setSubMenuTimer()">
            ...
            <ul id="sub-sub-news" style="display: none;" onmouseout="setSubMenuTimer()">
                    ...
                    <li onmouseover="showSubMenu('news587','show')"><a href="/press/imageGallery/default.asp">Image Gallery</a></li>
                
                    <li onmouseover="showSubMenu('news587','show')"><a href="/press/imageGallery/people.asp">People and Events</a></li>
                
                    <li onmouseover="showSubMenu('news587','show')"><a href="/press/imageGallery/floor.asp">Show Floor Buzz</a></li>
...
<div class="right-box-no-border" align="center">
    <img src="/images/framework/hometheat_icons_LG.gif" alt="Home Theater/Video" width="176" height="175">
</div>
...
Home theater is still a big picture with big sound. It puts viewers in the middle of the action by delivering movie and TV show soundtracks in multi-channel surround sound. And to afford one, you don't have to trade oil futures.<BR><BR>The long-coming shift to all digital TV broadcasting and the subsequent end of analog television transmissions is in its final year in 2008. Despite a soft - some say recessionary&nbsp;- economic climate, TV sales are expected to see sustained sales growth ahead, according to CEA forecasts.<BR><BR>The pending cut-off of analog broadcasting in February 2009 and a massive multi-industry effort to alert consumers to this change should generate increased sales of digital television sets, government-subsidized digital-to-analog TV converter boxes, and/or increase the adoption of multi-channel television services. Here are other trends to consider as you plan to attend the 2009 International CES. 
<UL>
<LI>Household penetration of home theater systems, including wireless home theater,&nbsp;rise. </LI>
<LI>Almost 100 HDTV channels are available to U.S. consumers. </LI>
<LI>Sales and rentals of video software for home theater use exceed movie theater box office revenue. </LI>
<LI>The first HTiB with an integrated Blu-ray player hits the market. </LI>
<LI>Ever-thinner flat-panel TVs deliver thinner sound. </LI>
<LI>"Virtual" surround sound systems proliferate, as do home audio components. </LI>
<LI>One-piece amplified speaker systems called "sound bars" emerge. </LI>
<LI>Price declines enhance TV and home theater accessories purchase appeal. </LI>
<LI>Flash memory storage grows for video. </LI>
<LI>DBS companies advance aggressive HDTV build-out plans in 2008. </LI>
<LI>Companies transition to MPEG4. </LI>
<LI>Major cable companies embrace DVR set-top boxes. </LI>
<LI>Personal media players move to mainstream. </LI>
<LI>Telephone companies continue laying fiber lines for expanded offerings.</LI></UL><A href="/register">Register today for the 2009 International CES</A> to learn, network and investigate new technology&nbsp;in the home theater and video industries as well as many other consumer technology markets. It's free if you sign up before November 1.<BR><BR><SPAN class=smallText><EM>Source: Digital America, a CEA publication.<BR><BR><BR></EM></SAN></SPAN>
...
<UL>
<LI><A href="/exhibits/displays/techZones.asp#389">Advanced Display Technologies TechZone</A></LI>
<LI><A href="/exhibits/displays/techZones.asp#754">HDMI TechZone</A></LI>
