...
<head><!-- PageID 1156 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - 여행 및 비자 안내</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions1156','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions1156" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions1156','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards1156','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards1156" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards1156','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards1156','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards1156','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards1156','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards1156','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits1156','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits1156" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits1156','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1156','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1156','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1156','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1156','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1156','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1156','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1156','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1156','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel1156','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel1156" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel1156','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <a href="/international/korean/default.asp"></a>
    <ul>
    
    
            <li class="selected"><a href="/international/korean/travel.asp">여행 및 비자 안내</a></li>
        
            <li ><a href="/international/korean/delegations.asp">대표단 프로그램</a></li>
        
            <li ><a href="/international/korean/services.asp">해외 방문객 서비스</a></li>
        <!--/international/korean/default.asp-->
...
<div align="center" class="right-blue-box">
    <div class="right-blue-box-blue-interior">
        <ul>
            ...
            <li><a href="/international/spanish/travel.asp">Español</a></li>
            
            <li><a href="/international/french/travel.asp">Français</a></li>
            
            <li><a href="/international/chinese/travel.asp">汉语</a></li>
            
            <li><a href="/international/japanese/travel.asp">日本語</a></li>
            
            <li><a href="/international/korean/travel.asp">한국어</a></li>
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        ...
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Resources</a>&nbsp;&gt;&nbsp;<a href="/international/korean/default.asp" class="footer">한국어 </a>&nbsp;&gt;&nbsp;여행 및 비자 안내</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/international/korean/travel.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<SPAN class=text>미국 출입국 시 유용한 정보입니다. </SPAN>


<h2>비자 안내</h2>

<SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: "><SPAN class=subhead><STRONG><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">비자가</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">필요하십니까</SPAN></SPAN><SPAN class=text1><SPAN>?</SPAN></SPAN></STRONG></SPAN></SPAN></SPAN><SPAN class=text1><SPAN><BR></SPAN></SPAN><A href="https://evisaforms.state.gov/ds156.asp?lang=1"><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">이제</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">비자</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">신청서를</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">온라인으로</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">접수시킬</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">수</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">있습니다</SPAN></SPAN></A><SPAN class=text1><SPAN><A href="https://evisaforms.state.gov/ds156.asp?lang=1">. <BR></A><BR></SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: "><SPAN class=subhead><SPAN class=text1><STRONG><SPAN lang=KO style="FONT-FAMILY: ">도움이</SPAN><SPAN lang=KO> </SPAN></STRONG></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: "><STRONG>필요하십니까</STRONG></SPAN><SPAN><STRONG>?</STRONG><BR></SPAN></SPAN></SPAN></SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">단계별</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">설명을</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">제공하는</SPAN><SPAN lang=KO> </SPAN></SPAN><A href="/docs/KO-Visa_Interview_Tips_FNL.pdf" target=_blank><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">비자</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">안내서</SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">를</SPAN><SPAN lang=KO> </SPAN></SPAN></A><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">다운로드</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">하십시오</SPAN><SPAN>.&nbsp; </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">비자</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">신청</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">절차에</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">대한</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">웹사이트</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">주소와</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">각종</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">정보가</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN lang=KO style="FONT-FAMILY: ">제공됩니다</SPAN><SPAN>.</SPAN></SPAN>


<h2>여행</h2>

<SPAN class=text><STRONG><SPAN class=subhead>CES 여행에 도움이 필요하십니까?</SPAN><BR></STRONG><A href="/hotelTravel/default.asp">CESweb.org의 여행 섹션 (영어 사이트)</A>를 방문하시면 최상의 항공 요금과 렌트카 요금은 물론 교통편에 대한 정보를 찾아보실 수 있습니다.<BR><BR><STRONG><SPAN class=subhead>숙박 안내가 필요하십니까?</SPAN><BR></STRONG><A href="/hotelTravel/hotel.asp">CESweb.org의 호텔 섹션 (영어 사이트)</A>를 방문하시면 단체 및 개인 예약을 하실 수 있습니다.</SPAN>
