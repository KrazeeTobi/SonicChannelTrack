...
<head><!-- PageID 1232 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - 国际服务</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions1232','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions1232" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions1232','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards1232','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards1232" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards1232','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards1232','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards1232','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards1232','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards1232','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits1232','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits1232" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits1232','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1232','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1232','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1232','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1232','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1232','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1232','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1232','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits1232','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel1232','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel1232" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel1232','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li ><a href="/international/chinese/travel.asp">旅行和签证信息</a></li>
        
            <li ><a href="/international/chinese/services.asp">代表团团体方案</a></li>
        
            <li class="selected"><a href="/international/chinese/delegations.asp">国际服务</a></li>
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        ...
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Resources</a>&nbsp;&gt;&nbsp;<a href="/international/chinese/default.asp" class="footer">汉语</a>&nbsp;&gt;&nbsp;国际服务</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/international/chinese/delegations.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<SPAN class=text><SPAN class=subhead><STRONG>全球采购商计划 <BR></STRONG></SPAN>国际CES荣列美国商务部国际贸易署发起的全球采购商计划参与者之列。美国商务部的国际贸易专家将在国际商务中心（拉斯维加斯会议中心，南厅连接大厅S224/225室）为各国参展人员和展商提供对接和外贸咨询服务。<BR><BR><SPAN class=subhead><STRONG>国际注册区域</STRONG></SPAN><BR>拉斯维加斯会议中心南2厅（酒店往返巴士第一站）<BR>金沙会展中心下层门厅<BR>外国参展人员专用注册区位于拉斯维加斯会议中心南2厅和金沙会展中心的主注册区。在这两个注册区，外国访客可现场注册、领取胸章套夹（参展时需要），现场还专门配有多国语言翻译可帮助处理注册问题。<BR><BR><STRONG><SPAN class=subhead>国际商务中心 (ICC)</SPAN><BR>拉斯维加斯会议中心南厅连接大厅S224/225室<BR>拉斯维加斯希尔顿饭店希尔顿中心40028展位<BR>金沙会展中心上层门厅</STRONG><BR>国际商务中心供外国访客和展商通过互联网与公司保持联络、预定和使用专用会议室、享用小点或放松之用。共有三个国际商务中心，它们将是您在参展期间的“异地办公室”。 <BR><BR><SPAN class=subhead><STRONG>MyCES Personal Planner（个人规划程序） – 为您安排完美的会展</STRONG></SPAN><BR><IMG hspace=6 src="/images/content/MyCES-172.gif" align=right>MyCES Personal Planner（个人CES计划器）是一个基于互联网的工具，您可利用它生成个性化的待访展商和会议活动地图与日程，还可用于识别出您想会面的业务伙伴，从而帮助您充分利用参加CES的时间。<A href="/myCES.asp">了解详情 (in English).</A> <BR><A href="http://myces.bdmetrics.com/" target=_blank>今天就开始为您安排一个完美的会展</A>。<BR><BR><SPAN class=subhead><B><SPAN lang=ZH-CN style="LAYOUT-GRID-MODE: line; FONT-FAMILY: ">翻译服务</SPAN></B></SPAN><BR>通晓多种语言的现场工作人员可以在所有 ICC 所在地以及南楼（South Hall ）低层的国际来宾登记报到处和接待员中心（ Concierge Center）找到。 口译员可以流利地讲说以下语言：西班牙语、德语、法语、汉语、日语、韩语、意大利语和葡萄牙语。 <SPAN lang=ZH-CN style="LAYOUT-GRID-MODE: line; FONT-FAMILY: ">若在展会期间遇到问题</SPAN><SPAN lang=ZH-CN style="LAYOUT-GRID-MODE: line; FONT-FAMILY: ">，</SPAN><SPAN lang=ZH-CN style="LAYOUT-GRID-MODE: line; FONT-FAMILY: ">请充分利用这些服务。</SPAN></SPAN>
