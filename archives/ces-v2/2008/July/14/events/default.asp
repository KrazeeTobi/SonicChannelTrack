...
<head><!-- PageID 305 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>International CES - January 8-11, 2009 - Events</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/sessions/default.asp" class="sublink"><img src="/images/framework/secondarynav_sessions.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show'); showSubMenu('sessions305','show')" class="link_with_children"><a href="/sessions/speakers/default.asp">Call for Speakers</a>
                
            <ul id="sub-sub-sessions305" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('sessions305','show')"><a href="/sessions/speakers/cfsFAQ.asp">Submission FAQs</a></li>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><img src="/images/framework/secondarynav_awards.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('awards','show'); showSubMenu('awards305','show')" class="first_link_with_children"><a href="/awards/innovations/default.asp">CES Innovations Awards</a>
                
            <ul id="sub-sub-awards305" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('awards305','show')"><a href="/awards/innovations/2008honorees.asp">Innovations Honorees</a></li>
                
                    <li onmouseover="showSubMenu('awards305','show')"><a href="/awards/innovations/about.asp">About Innovations</a></li>
                
                    <li onmouseover="showSubMenu('awards305','show')"><a href="/awards/innovations/categories.asp">Awards Categories</a></li>
                
                    <li onmouseover="showSubMenu('awards305','show')"><a href="/awards/innovations/callForEntries.asp">Call for Entries</a></li>
                
                    <li onmouseover="showSubMenu('awards305','show')"><a href="/awards/innovations/callForJudges.asp">Call for Judges</a></li>
...
<ul id="sub-exhibits" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('exhibits','show')" class="top"><a href="/exhibits/default.asp" class="sublink"><img src="/images/framework/secondarynav_exhibits.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('exhibits','show'); showSubMenu('exhibits305','show')" class="first_link_with_children"><a href="/exhibits/displays/default.asp">CE Spotlights</a>
                
            <ul id="sub-sub-exhibits305" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('exhibits305','show')"><a href="/exhibits/displays/techZones.asp">CES TechZones</a></li>
                
                    <li onmouseover="showSubMenu('exhibits305','show')"><a href="/exhibits/displays/content.asp">Content@CES</a></li>
                
                    <li onmouseover="showSubMenu('exhibits305','show')"><a href="/exhibits/displays/diShowcase.asp">Digital Imaging Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits305','show')"><a href="/exhibits/displays/expCEA.asp">Experience CEA</a></li>
                
                    <li onmouseover="showSubMenu('exhibits305','show')"><a href="/exhibits/displays/gamingShowcase.asp">Gaming Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits305','show')"><a href="/exhibits/displays/innovShowcase.asp">Innovations Showcase</a></li>
                
                    <li onmouseover="showSubMenu('exhibits305','show')"><a href="/exhibits/displays/kidsatPlay.asp">Kids@Play Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits305','show')"><a href="/exhibits/displays/silversSummit.asp">Silvers Summit</a></li>
                
                    <li onmouseover="showSubMenu('exhibits305','show')"><a href="/exhibits/displays/wirelessWorld.asp">Wireless World</a></li>
...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><img src="/images/framework/secondarynav_hotel.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show'); showSubMenu('hotel305','show')" class="first_link_with_children"><a href="/hotelTravel/hotel.asp">Hotel Reservations</a>
                
            <ul id="sub-sub-hotel305" style="display: none;" onmouseout="setSubMenuTimer()">
        
                    <li onmouseover="showSubMenu('hotel305','show')"><a href="/hotelTravel/blockRequest.asp">Block Request Form</a></li>
...
<ul id="sub-news" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('news','show')" class="top"><a href="/news/default.asp" class="sublink"><img src="/images/framework/secondarynav_news.gif" /></a></li>
                    ...
                    <li onmouseover="showDropDown('news','show'); showSubMenu('news305','show')" class="link_with_children"><a href="/press/default.asp">For The Press</a>
                
            <ul id="sub-sub-news305" style="display: none;" onmouseout="setSubMenuTimer()">
            ...
            <ul id="sub-sub-news" style="display: none;" onmouseout="setSubMenuTimer()">
                    ...
                    <li onmouseover="showSubMenu('news305','show')"><a href="/press/imageGallery/default.asp">Image Gallery</a></li>
                
                    <li onmouseover="showSubMenu('news305','show')"><a href="/press/imageGallery/people.asp">People and Events</a></li>
                
                    <li onmouseover="showSubMenu('news305','show')"><a href="/press/imageGallery/floor.asp">Show Floor Buzz</a></li>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        <DIV align=center><A href="http://www.ce.org/i-stage" target=_blank><IMG height=99 src="/images/content/istage175.jpg" width=175 border=0></A></DIV><STRONG>Think you've got America's next top gadget?</STRONG><BR><A href="http://www.ce.org/i-stage/" target=_blank>Prove it, and win a turnkey exhibit at the 2009 International CES.</A>
        <br /><br />
    </div>
</div>
                    </div>
...
It's not all business at the International CES. We manage to throw in enough parties, receptions and friendly competitions to keep the adrenalin going. And with more than 2,700 exhibitors pitching in with celebrity appearances and fun of their own, the CES events calendar rivals what you'd see on any Hollywood starlet's PDA.<BR><BR>Events are added here between now and showtime. Check back soon for 2009 International CES information, and in the meantime, <A href="http://www.sinoces.com/en/index.aspx" target=_blank>make plans to attend SINOCES</A>. <BR><BR>
<H2>SINOCES</H2><A href="http://www.sinoces.com/en/index.aspx" target=_blank><IMG height=60 src="/images/content/SINOCES_LOGO_180.jpg" width=180 align=right border=0></A>If your company is already in China or looking to expand to China, The China International Consumer Electronics Show (SINOCES) is a must-attend event for 2008. Join 70,000 consumer electronics professionals and 450 exhibitors for a chance to gain global exposure for new products, new technologies, brand and vision. <BR><BR>SINOCES demonstrates the globalization of China's consumer electronics industry and provides a platform for CE professionals who want to conduct business within China and around the globe. <BR><BR>SINOCES is a collaboration between the Consumer Electronics Association (CEA), producer of the International CES, the China Electronic Chamber of Commerce and the Qingdao Municipal Peoples' Government. The successful partnership between SINOCES and International CES, the world's largest tradeshow for consumer technology, has attracted great attention from the global consumer electronics industry, international press and foreign governments. <BR<BR>Plan for the 2008 SINOCES, July 10-13, 2008, and go global. <A href="http://www.sinoces.com/en/index.aspx" target=_blank>SINOCES registration is now open.</A> <BR><BR>
<H3>Show details</H3>Exhibit Dates<BR>Thursday-Sunday, July 10-13, 2008 <BR><BR>
<H3>Location</H3><IMG height=87 src="/images/content/qingdao_map.jpg" width=160 align=right>Qingdao International Convention Center<BR>Shandong Province, Qingdao, China <BR><BR>Qingdao, a coastal city in east China, is on one of three peninsulas—Shandong Peninsula—along China's east (northeast) coast. <BR><BR>
<H3>Exhibitor and Attendee Profile</H3>The 2007 SINOCES attracted more than 65,000 visitors and 400 exhibitors from China and 30 international markets. Companies such as Haier, Intel, Sony, Toshiba, Hisense and Apple highlighted new products on the show floor. World leaders in retail such as Best Buy, Carrefour, RadioShack, Metro and Walmart, attended SINOCES to find the latest products for their international stores. <BR><BR>
<H3>Product Categories</H3>
<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
<TBODY>
<TR>
<TD vAlign=top>Accessories<BR>Audio<BR>Digital TV<BR>Electronic Gaming<BR>Handheld Information Devices </TD>
<TD vAlign=top>Home Appliances<BR>Home Entertainment<BR>Home Networking<BR>Mobile Storage Products<BR>Personal Electronics Photography/Digital Imaging<BR></TD>
<TD vAlign=top>Portable Office Devices<BR>Video Hardware &amp; Software<BR>Wi-Fi Technology<BR>Wireless/Mobile Communications </TD></TR></TBODY></TABLE>
<P></P>
<H3>Forums during SINOCES</H3><IMG height=120 src="/images/content/sinoces07_180.jpg" width=180 align=right>Mobile TV Technical Seminar <BR>Symposium on Environmental Protection Testing for Chinese-made Electronic Products <BR>China Digital Flat Panel TV Market Development Forum <BR>Retail on Air - Internet/TV Retail Sales <BR>China International New Media Terminal Device &amp; Application <BR><BR>
<H3>Sponsors</H3>Ministry of Commerce, P.R.China<BR>Ministry of Information Industry, P.R.China<BR>Ministry of Science and Technology, P.R.China<BR>Shandong Provincial People's Government <BR><BR>
<H3>Overseas Sponsor</H3>The Consumer Electronics Association (CEA), the producer of International CES.<BR><BR><A href="http://www.sinoces.com/en/index.aspx" target=_blank>For more information, please visit http://www.SINOCES.com/.</A>
<br />
