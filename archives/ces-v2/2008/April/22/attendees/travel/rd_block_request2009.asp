...
<html>
<head><!-- PageID 337 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;2009 Block Request Form</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/travel/rd_block_request2009.asp';
...
<a href="/attendees/travel/hotel.asp">Hotel Reservations</a><br>
    ...
    <span class="nav_fourth" id="fourth_row_container335" style="display: none;">
        ...
        //-->
            </script>2009 Block Request Form
        <br>
...
<div class="body_title">2009 Room Block Request<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
// javascript for e-mail this page tool - gets the url of the page the user is on before the e-mail page tool button is clicked
	...
	<script language="JavaScript" src="/attendees/travel/include/js/calendar2_2009.js"></script>
	<script>
...
<br><br>
(<span class="required">*</span> Denotes a required field.)</span>
<!--<form name="block_request" method=post action="" onSubmit="return validForm(this);" >-->
<form name="block_request" method=post action="/attendees/travel/rd_block_request_confirmation2009.asp" onSubmit="return validForm(this);" >
...
<tr>
	<td colspan="2"><span class="required">*</span> Please select an official 2009 International CES hotel. (Availability subject to change. Last updated March, 2008.)</td></tr>
...
<tr>
	...
	<td width="215" valign="top" class="text">
...
<tr>
		<td class="rowlabel"><span class="required">*</span> Max Number of Rooms&nbsp;</td><td><input type="text" size="15" id=text5 name="number_of_rooms"><span class="text_colored">&nbsp;&nbsp;<strong>(You must enter 20 or more.)</strong></span><br>
		</td>
</tr>
...
<tr>
	...
	<br><br>
	<strong>NOTE: This is a REQUEST only. Submitting this form does NOT confirm or guarantee a reservation or availability. You MUST receive a response from the hotel in order for your request to be confirmed. </strong>
	</td>
</tr>
