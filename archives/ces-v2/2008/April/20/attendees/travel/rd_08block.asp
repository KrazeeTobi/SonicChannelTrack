...
<html>
<head><!-- PageID 4170 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;2008 Block Request Form</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/travel/rd_08block.asp';
...
<a href="/attendees/travel/hotel.asp">Hotel Reservations</a><br>
    ...
    <span class="nav_fourth" id="fourth_row_container335" style="display: none;">
        ...
        //-->
            </script>2008 Block Request Form
        <br>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue4170', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue4170', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue4170" id="leftAddedValue4170" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">2008 International CES Room Block Request Form<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
// javascript for e-mail this page tool - gets the url of the page the user is on before the e-mail page tool button is clicked
	...
	<script language="JavaScript" src="/attendees/travel/include/js/calendar2_2008.js"></script>
	<script>
...
function validForm(passedForm)
	{
		...
		alert("Your requested dates must be between 12/26/07 and 1/16/08.")
		passedForm.input7.focus
		return false
		}
		...
		if (((radio_value=="Mandalay")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="THE")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="Meridian")&&(passedForm.number_of_rooms.value < 10)))
			{
		...
		if (((radio_value!="Mandalay")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="THE")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="Renaissance")&&(passedForm.number_of_rooms.value < 20)))
			{
...
<strong>Request a group block <font style=color:#CC0000>FOR THE 2008 INTERNATIONAL CES</font> with a simple three-step process.</strong>
<ol>
...
(*Mandalay Bay and THEHotel at Mandalay are accepting blocks of 10 rooms.) 
<br><br>
...
<form name="block_request" method=post action="/attendees/travel/rd_08block_confirmation.asp" onSubmit="return validForm(this);" >
...
<tr>
	<td colspan="2"><span class="required">*</span> Please select an official 2008 International CES hotel. (Availability subject to change. Last updated July 2007.)</td></tr>
...
<tr>
	<td width="190" valign="top" class="text">
        <input type="radio" name="hotel" value="AlexisPark">Alexis Park ($208)<br>
		<!--<input type="radio" name="hotel" value="Amerisuites">Amerisuites ($189)<br>-->
		<!--<input type="radio" name="hotel" value="Ballys">Bally's ($229)<br>-->
		<!--<input type="radio" name="hotel" value="Bellagio">Bellagio ($339)<br>-->
		<!--<input type="radio" name="hotel" value="Caesars">Caesars Palace ($320)<br>-->
		<input type="radio" name="hotel" value="Circus">Circus Circus ($120)<br>
		<input type="radio" name="hotel" value="Excalibur">Excalibur ($219/$239)<br>
		<!--<input type="radio" name="hotel" value="Flamingo">Flamingo Las Vegas ($189)<br>-->
		<!--<input type="radio" name="hotel" value="Harrahs">Harrah's ($235)<br>-->
	...
	<td width="210" valign="top" class="text">
		...
		<!--<input type="radio" name="hotel" value="Imperial">Imperial Palace ($160)<br>-->
		<!--<input type="radio" name="hotel" value="LVHilton">Las Vegas Hilton ($309)<br>-->
		...
		<input type="radio" name="hotel" value="Mandalay">Mandalay Bay ($299)<br>
		<input type="radio" name="hotel" value="Meridian">Meridian Las Vegas ($329-499)<br>
		<!--<input type="radio" name="hotel" value="MGM">MGM Grand ($269)<br>-->
		<!--<input type="radio" name="hotel" value="Mirage">Mirage ($298)<br>-->
		<!--<input type="radio" name="hotel" value="Palms">Palms ($299)<br>-->
		<!--<input type="radio" name="hotel" value="NYNY">New York New York ($239)<br>-->
		<!--<input type="radio" name="hotel" value="Paris">Paris ($279)<br>-->
		<!--<input type="radio" name="hotel" value="Renaissance">Renaissance ($349)<br>-->
		<!--<input type="radio" name="hotel" value="Rio">Rio ($265)<br>-->
		<!--<input type="radio" name="hotel" value="Riviera">Riviera ($138)<br>-->
		<input type="radio" name="hotel" value="MonteCarlo">Monte Carlo ($269)<br>
	...
	<td width="190" valign="top" class="text">		
		...
		<input type="radio" name="hotel" value="THE">THEHotel at Mandalay ($339)<br>
		<!--<input type="radio" name="hotel" value="Sahara">Sahara ($136)<br>-->
		<!--<input type="radio" name="hotel" value="Treasure">Treasure Island ($240)<br>-->
		<!--<input type="radio" name="hotel" value="Westin">Westin ($249)<br>-->
	</td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
...
<tr>
	<td colspan=2>Please indicate the first and last nights of your block and the maximum number of rooms needed on your night of highest occupancy. <font style=color:#CC0000><strong>Show days are January 7-10, 2008.</strong></font><br>
	</td>
</tr>
