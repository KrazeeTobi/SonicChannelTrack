...
<html>
<head><!-- PageID 3375 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;Leaving Las Vegas</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/travel/leaving.asp';
...
Leaving Las Vegas<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container3374")) { document.getElementById("fourth_row_container3374").style.display = "";}
        //-->
    </script>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue3375', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue3375', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue3375" id="leftAddedValue3375" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Leaving Las Vegas<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
When the International CES comes to a close, we hate to see you go. But even so, we have a variety of ways to make your departure easy and convenient.</span>
...
<div class="section_title">Airline Check-in Kiosks</div>
<span class="text">
Print your boarding passes up to 24 hours in advance. SpeedCheck, the nation’s first multiple-airline check-in system, is now available at Las Vegas Convention Center and McCarran Airport. Access your departing airline’s check-in system and print your boarding passes before heading to the airport at five kiosk locations in the LVCC Grand Lobby, Central Lobby, North Hall 3 Lobby and South Hall 1 Lobby. <BR><BR><SPAN class=text_colored>Participating Airlines</SPAN> <BR>
<TABLE cellSpacing=1 cellPadding=1 width="50%" border=0>
<TBODY>
<TR>
<TD>AirTran<BR>Alaska<BR>Aloha<BR>America West<BR>American<BR>Continental<BR>Delta<BR>Frontier<BR></TD>
<TD>JetBlue<BR>Midwest<BR>Northwest<BR>Song<BR>Southwest<BR>United<BR>US Airways<BR></TD></TR></TBODY></TABLE>
</span>
<a name="3380"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<span class="text">
Shuttle service to McCarran International Airport will be available every 30 minutes the last two days of the show.&nbsp;The ticket price for this service is $5 per person, one-way. The shuttle service to McCarran is available from the Las Vegas Convention Center and the tour bus loading area at the Sands Expo and Convention Center.&nbsp;<A href="/attendees/travel/shuttle.asp">Visit the CES shuttle page</A> to view and download the complete shuttle bus schedule. 
</span>
<a name="3379"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Bags to Go now services five major airlines</div>
<span class="text">
Now you can stay at CES longer and head to the airport later!&nbsp; If you are flying Delta,&nbsp;Southwest Airlines, Ted, United Airlines, or US Airways, <STRONG>Bags to Go </STRONG>is a convenient service that has been implemented at The Venetian and the Las Vegas Convention Center (LVCC).&nbsp; <STRONG>Bags to Go </STRONG>enables you to check-in your luggage through to your final destination and also gives you the option of printing your boarding pass in advance.&nbsp; To take advantage of this service you must check luggage three hours prior to your flight and have an e-ticket.&nbsp; Southwest charges a fee of $20 per person for this service and you may check up to three&nbsp;bags.&nbsp; Delta,&nbsp;Ted, United Airlines, and US Airways also charge $20 per person but only allow you to check two bags. <BR><BR>At The Venetian, <STRONG>Bags to Go </STRONG>is located on Level 1 of the meeting space, next to the Package Center. At the LVCC, <STRONG>Bags to Go</STRONG> is located in the Grand Concourse, across from Central Hall 3. <BR><BR>For additional information, please call Bags to Go at (702) 414-4689.<BR><A href="http://www.southwest.com/help/offsite_checkin_faq.html" target=_blank></A>
</span>
<!-- text for main page -->
</div>
