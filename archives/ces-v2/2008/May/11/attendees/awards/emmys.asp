...
<html>
<head><!-- PageID 3774 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;Tech & Engineering Emmy Awards</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/awards/emmys.asp';
...
<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
Tech & Engineering Emmy Awards<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container3773")) { document.getElementById("fourth_row_container3773").style.display = "";}
        //-->
    </script>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue3774', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue3774', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue3774" id="leftAddedValue3774" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Technology & Engineering Emmy Awards<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<IMG height=80 src="/images/partners/Emmys_07.gif" width=105 align=right>Launched in 1948, Technology and Engineering Awards honor development and innovation in broadcast technology and recognize companies, organizations and individuals for breakthroughs in technology that have a significant effect on television engineering.&nbsp;The awards are given&nbsp;to an individual, a company, or to a scientific or technical organization for developments and/or standardization involved in engineering technologies&nbsp;that either represent so extensive an improvement on existing methods or are so innovative in nature that they materially have affected the transmission, recording, or reception of television. For more information visit&nbsp;<A href="http://www.emmyonline.org/tech" target=_blank>www.emmyonline.org/tech</A>.<BR><STRONG><BR>For sponsorships: <BR></STRONG>Sheryl Katz<BR><A href="mailto:skatz@emmyonline.tv">skatz@emmyonline.tv</A><BR>212-484-9436</span>
...
<span class="text">
<SPAN class=subhead>Science, Engineering &amp; Technology Awards for Broadcast Television</SPAN><BR>The National Television Academy presented Emmy® Awards for Technology &amp; Engineering for six achievements, selected by a panel of industry experts. 
<P><STRONG>The Emmy Award for Pioneering Development of On Screen Display (OSD) for Setup, Control and Configuration of Consumer Television Equipment<BR></STRONG>RCA-TTE <BR><BR><STRONG>The Emmy® Award for Streaming Media Architectures and Components</STRONG><BR>- Microsoft <BR>- Adobe Systems Inc. <BR>- RealNetworks <BR>- Apple </P>
<P><STRONG>The Emmy Award for Pioneering Development for Combining Multiple Transport Streams Which Are Already Encoded, Using Rate-Shaping and Statistical Re-multiplexing</STRONG><BR>Terayon Communication Systems, Inc.<BR><BR><STRONG>The Emmy Award for Development and Implementation of Automatically Assembled Dynamic Customized TV Advertising</STRONG><BR>Visible World <BR>The Weather Channel<BR><BR><STRONG>The Emmy Award for Technology Advances in Serial Digital Interface Solutions, Enabling Over 20 Years of Seamless Studio and Broadcast Infrastructure Migration</STRONG><BR>Gennum Corporation <BR><BR><STRONG>The Emmy Award for Privately Owned and Operated International Satellite Company Primarily for International Video Services</STRONG><BR>Rene Anselmo, PanAmSat<BR><BR><SPAN class=subhead>Science, Engineering &amp; Technology Awards for Digital Television</SPAN><BR>The National Television Academy also announced Emmy winners in seven Science, Technology &amp; Engineering for Digital Television categories. The seven categories included nominations in the areas of interactive television, On Demand television, the Internet, and personal media display and presentation technology. <BR><BR><STRONG>The Emmy Award for Outstanding Achievement in Advanced Media Technology for the Synchronous Enhancement of Original Television Content</STRONG><BR>DirecTV Interactive Sports – DirecTV <BR><BR><STRONG>The Emmy Award for Outstanding Achievement in Advanced Media Technology for the Non-Synchronous Enhancement of Original Television Content</STRONG><BR>The-N.com Video Mixer – The N<BR><BR><STRONG>The Emmy Award for Outstanding Achievement in Advanced Media Technology for the Creation of Non-Traditional Programs or Platforms<BR></STRONG>The Slingbox – Sling Media <BR><BR><STRONG>The Emmy Award for Outstanding Innovation and Achievement in Advanced Media Technology for the Best Use of Personal Media Display and Presentation Technology</STRONG><BR>Xross Media Bar – Sony Computer Entertainment<BR><BR><STRONG>The Emmy Award for Outstanding Innovation and Achievement in Advanced Media Technology for the Best Use of “On Demand” Technology Over Private (closed) Networks</STRONG><BR>Time Warner Cable’s Start Over – Time Warner Cable, Concurrent Computer Corp., Big Band Networks, Harmonic Inc., Scientific Atlanta.<BR><BR><STRONG>The Emmy Award for Outstanding Innovation and Achievement in Advanced Media Technology for the Best Use of “On Demand” Technology Over the Public (open) Internet</STRONG><BR>Stim TV – NPOWR<BR><BR><STRONG>The Emmy Award for Outstanding Innovation and Achievement in Advanced Media Technology for Best Use by Commercials in Creation and Use in Non Traditional Platforms and Technologies</STRONG> <BR>TiVo Interactive Advertising Platform – TiVo Inc.<BR><BR><STRONG>The Emmy Award for Peripheral Development and Technological Impact of Video Game Controllers</STRONG><BR>Nintendo, for the D-pad innovation on the NES/Famicon controller. <BR>Sony Computer Entertainment America, for the Dual Shock Analog Controller.<BR><BR><STRONG>The Emmy Award for Development of 3D Software Engines</STRONG><BR>John Carmack <BR>id Software<BR><BR><STRONG>The Emmy Award for Pioneering Work in Near and Real-Time Fully Programmable Shading Via Modern Graphics Processors</STRONG><BR>Microsoft <BR>AMD <BR>NVIDIA Corporation </P>
</span>
<!-- text for main page -->
</div>
