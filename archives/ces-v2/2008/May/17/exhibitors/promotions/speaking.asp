...
<html>
<head><!-- PageID 576 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
...
Share your knowledge, and build your reputation as a leader in the consumer electronics industry. <BR>Visit the <A href="/exhibitors/promotions/default.asp">Speaking Opportunities</A> section for information on the Call for Speakers for&nbsp;the International CES conference program.<BR><BR><STRONG>Call for Speakers Opens:<BR></STRONG>Early June<BR><BR><STRONG>Deadline</STRONG><BR>Submissions&nbsp;Due: July 1<BR><BR><B>Contact</B><BR>Speaking Opportunities Coordinator, Conferences, International CES<BR>E-mail: <U><A href="mailto:CFS@CE.org">CFS@CE.org</A></U>
<br><br>
