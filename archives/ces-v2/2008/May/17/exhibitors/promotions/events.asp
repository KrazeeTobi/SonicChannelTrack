...
<html>
<head><!-- PageID 579 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;Industry Events</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/exhibitors/promotions/events.asp';
...
Industry Events<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container578")) { document.getElementById("fourth_row_container578").style.display = "";}
        //-->
    </script>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue579', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue579', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue579" id="leftAddedValue579" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Industry Events<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
    
<div class="text">  
<!-- text for main page -->

Maximize the power of your brand through CEA sponsorship opportunities. Your sponsorship of CEA's high-level events throughout the year will introduce you to the world's most influential consumer electronics industry innovators and leading press. <A href="http://www.ce.org/events/sponsorship_opps.asp" target=_blank>Visit CE.org for more information</A> on these and other CEA industry events, and e-mail <A href="mailto:byb@CE.org">byb@CE.org</A>&nbsp;to learn about sponsorship opportunities.&nbsp;&nbsp;<BR><BR><SPAN class=section_title><IMG height=90 src="/images/partners/CESHometech.gif" width=120 align=right>International CES/Hometech<BR></SPAN><A href="http://www.hometechexpo.com/" target=_blank></A>Dubai International Convention and Exhibition Centre<BR>Dubai, United Arab Emirates<BR>May 25-27, 2008<BR>Save the date!&nbsp;Hometech Middle East provides remarkable direct channel access to booming markets in the Middle East, North Africa, India and parts of Eastern Europe. To learn more about exhibiting at next year's Hometech Middle East, e-mail <A href="mailto:exhibit@CE.org">exhibit@CE.org</A>.<BR><BR><BR><SPAN class=section_title><IMG height=120 hspace=10 src="/images/partners/d2finallogo.4.10.gif" width=175 align=right>Digital Downtown</SPAN><BR>New York, NY<BR>June 12-14, 2008<BR>Join lower Manhattan's consumer technology expo, designed to serve the one-on-one information needs of high-income consumers who need a convenient way to learn about the latest new products without leaving the Financial District — or even their office complex.<BR><BR><BR><BR>
<P><SPAN class=section_title><IMG height=35 hspace=6 src="/images/partners/sinoces_105.gif" width=105 align=right>SINOCES<BR></SPAN>Qingdao International Convention Center<BR>Shandong Province, Qingdao, China<BR>July 10-13, 2008<BR></B>The China International Consumer Electronics Show (SINOCES) is China’s most prominent consumer electronics exhibition. As an influential, annual CE event, SINOCES serves as a good platform for consumer electronics companies to gain global exposure for their new products, new technologies, brand and vision. Learn more about <A href="/sinoces/exhibiting.asp">exhibiting at SINOCES</A>.<BR><BR><SPAN class=section_title><IMG height=66 src="/images/partners/EHXFall08.gif" width=120 align=right>EHX Fall 2008</SPAN><BR>Long Beach, CA<BR>November 4-7, 2008<BR>EHX continues to cover the entire spectrum of the custom electronics industry to help optimize your business opportunity and to foster new industry connections to provide total solutions. </P>
<P><BR><BR><SPAN class=section_title>CES New York Press Preview featuring CES Unveiled@NY</SPAN><BR>The Metropolitan Pavilion<BR>New York, NY<BR>November 11, 2008<BR>Unveiled@NY is held at the Pre-CES New York Press Preview in November. Get your products in front of the press in time for the holiday selling season and to jumpstart your CES success. This is your best venue to network with the top media during the crucial weeks leading up to the holidays and the&nbsp;2009 International CES. E-mail <A href="mailto:exhibit@CE.org">exhibit@CE.org</A>.</P>
<P><B>For sponsorship opportunities available for any of these events, contact:<BR></B>Manager, Promotional Opportunities, CES<BR>Phone: 703-907-7688<BR>E-mail: <A href="mailto:byb@CE.org">byb@CE.org</A></P>
<br><br>
