...
<html>
<head><!-- PageID 377 - published by RedDot 7.5 - 7.5.0.33 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2008 International CES:&nbsp;Call for Speakers</title>
...
<br><br>
Thank you for your interest in the 2008 International CES&reg; conference program. If you have questions regarding the submission process, please e-mail <a href="mailto:CFS@ce.org">CFS@CE.org</a>.
	<br><br>
...
<!--
Submit your proposal for a speaking opportunity at the 2008 International CES. The deadline is <strong>Friday, July 13, 2007</strong>.
<br>Fields marked with <span class="required"> * </span> are <b>required</b>; your submission will not be processed without a response.

<br><br>

<strong><font style=color:#cc0033>ATTN INDUSTRY ANALYSTS: </font></strong>Share your research, analysis and predictions in the <strong>Just the Facts track</strong>. <a href="rd_JTFspeaker_form.asp">Apply now.</a>
<br><br>
...
<tr>
	...
	<img src="/global_images2005/1.0/1.0.line.gif" alt="-----------------------------------------------" width="590" height="2" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
	<span class="subhead">Proposed 2008 International CES Program Topics</span>
	</td>
</tr>
...
<table width="100%" cellpadding="1" cellspacing="0" border="0">
	...
	<tr>
		...
		<br>
		<input type="checkbox" name="topics" value="1. IPTV: The Television of Tomorrow?">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic1')">IPTV: The Television of Tomorrow?</a><br>
		<input type="checkbox" name="topics" value="2. Preparing for the Analog Shutoff">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic2')">Preparing for the Analog Shutoff</a><br>
		<input type="checkbox" name="topics" value="3. The New Definition of TV">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic3')">The New Definition of TV</a><br>
		<input type="checkbox" name="topics" value="4. Home Theater in 3D">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic4')">Home Theater in 3D</a><br>
		<input type="checkbox" name="topics" value="5. Home Entertainment and the Home PC">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic5')">Home Entertainment and the Home PC</a><br>
		<input type="checkbox" name="topics" value="6. Back on the Air: Mobile TV">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic6')">Back on the Air: Mobile TV</a><br>
		<input type="checkbox" name="topics" value="7. The Drive for Gaming in 2007">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic7')">The Drive for Gaming in 2007</a><br>
		<input type="checkbox" name="topics" value="8. Downloading and Streaming HD over the Air - Home Video's Future">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic8')">Downloading and Streaming HD over the Air - Home Video's Future</a><br>
		<input type="checkbox" name="topics" value="9. The Golden Age of Digital Imaging ">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic9')">The Golden Age of Digital Imaging</a><br>
		<input type="checkbox" name="topics" value="10. Bringing Automation Homem">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic10')")>Bringing Automation Home</a><br>
		<input type="checkbox" name="topics" value="11. Accessory to Success: The Power of Add-Ons">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic11')">Accessory to Success: The Power of Add-Ons</a><br>
		<input type="checkbox" name="topics" value="12. Innovation Through Design">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic12')">Innovation Through Design</a><br>
		<input type="checkbox" name="topics" value="13. World of Wireless">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic13')">World of Wireless</a><br>
		<input type="checkbox" name="topics" value="14. The High-End Audio Demo in an iPod World">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic14')">The High-End Audio Demo in an iPod World</a><br>
		<input type="checkbox" name="topics" value="15. Installation: Is it for the Average Joe?">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic15')">Installation: Is it for the Average Joe?</a><br>
		</td>
		<td valign="top">
		<br>
		<input type="checkbox" name="topics" value="16. Mobile on the Move: What's in Store for Car Electronics">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic16')">Mobile on the Move: What's in Store for Car Electronics</a><br>
		<input type="checkbox" name="topics" value="17. Market Navigation for the Navigation Market">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic17')">Market Navigation for the Navigation Market</a><br>
		<input type="checkbox" name="topics" value="18. What's This Button Do? Ease-of-Use and the Consumer">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic18')">What's This Button Do? Ease-of-Use and the Consumer</a><br>
		<input type="checkbox" name="topics" value="19. The True Cost of DRM: What Can't We Do Now?">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic19')">The True Cost of DRM: What Can't We Do Now?</a><br>
		<input type="checkbox" name="topics" value="20. The New Face of America's Elections">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic20')">The New Face of America's Elections</a><br>
		<input type="checkbox" name="topics" value="21. Taking the Blogosphere Seriously">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic21')">Taking the Blogosphere Seriously</a><br>
		<input type="checkbox" name="topics" value="22. Keeping CE off the Curb Through E-Cycling">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic22')">Keeping CE off the Curb Through E-Cycling</a><br>
		<input type="checkbox" name="topics" value="23. Tech's Greener Pastures">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic23')">Tech's Greener Pastures</a><br>
		<input type="checkbox" name="topics" value="24. Finding Private Equity">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic24')">Finding Private Equity</a><br>
		<input type="checkbox" name="topics" value="25. The Power of Social Networking">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic25')">The Power of Social Networking</a><br>
		<input type="checkbox" name="topics" value="26. Making Room for the Boom: CE for Aging Consumer">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic26')">Making Room for the Boom: CE for Aging Consumer</a><br>
		<input type="checkbox" name="topics" value="27. Mobile TV: Looks Great. How Do You Sell It?">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic27')">Mobile TV: Looks Great. How Do You Sell It?</a><br>
		<input type="checkbox" name="topics" value="28. The Top 10 Technologies You Never Heard Of">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic28')">The Top 10 Technologies You Never Heard Of</a><br>
		<input type="checkbox" name="topics" value="29. Finding the Right Bandwidth">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic29')">Finding the Right Bandwidth</a><br>
		<input type="checkbox" name="topics" value="30. Display Trends: What's next?">&nbsp;<a href="javascript:openNewWindow('/attendees/conferences/speakers/sessionDesc.asp?desc=topic30')">Display Trends: What's next?</a><br>
		</td>
	</tr>
...
<tr>
	<td colspan=2><strong>Please attach a photo.</strong> <span class="text_colored">(TIF or JPEG files only - minimum 300 dpi, 5x7)</span></td>
</tr>
...
<tr>
	<td colspan=2><b>Submitting a Proposal:</b><br>You will receive an e-mail confirmation of receipt after completing the above application. All proposals are due <strong>Friday, July 13, 2007</strong>. If you are submitting a proposal after July 2007, you will only be contacted by CES if you receive an invitation, but will be added to our back-up list as a resource for last-minute speaker cancellations and future CEA events.
	<br><br>
	<strong>Speaker Substitution:</strong><br> Speakers are selected based on the name in the submission. Please make sure that you have the appropriate speaker identified prior to submitting your proposal.
	<br><br>
	<strong>Financial Support and Speaker Benefits:</strong><br>Please note that International CES speakers are responsible for their own travel expenses, however all speakers are provided with complimentary registration to the 2008 International CES. This registration allows you access to the show floor and speakers lounge. 
	</td>
</tr>
...
<!--/attendees/conferences/speakers/FAQs.asp-->
<!--/attendees/conferences/speakers/rd_JTFspeaker_form.asp-->
