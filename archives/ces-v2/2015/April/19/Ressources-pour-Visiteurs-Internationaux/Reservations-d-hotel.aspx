...
<head id="head"><title>
	Hotel Reservations - 2016 International CES, January 6-9
...
<section>
        ...
        <div class="container clearfix above">
            <div class="one-sixth-leftnav">
                <div class="leftnav">
                    <ul><li><a href="/International/Travel-Visas">Travel & Visas</a><li class="left-current"><a href="/International/Hotel-Reservations">Hotel Reservations</a><ul></ul><li><a href="/International/Delegation-Group-Program">Delegation Group Program</a><li><a href="/International/International-Services">International Services</a></ul>
                    ...
                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                             ...
                             <li class="bread-div">|</li><li><a href="/International.aspx" class="CMSBreadCrumbsLink">International </a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">Hotel Reservations</span>
</li>
...
<h2>Reserve Your Room for CES</h2>
<p class="intro">To assist you in your travel plans, visit&nbsp;<a href="/Register-Plan/Hotel.aspx">CESweb.org/hotel</a>&nbsp;(in English) for the full list of official CES hotels and rates.</p>  

<p>
	To obtain the CES rate, all rooms must be booked directly by selecting the link provided for your preferred hotel. You will be directed to that hotel&rsquo;s reservation page where you can make your hotel reservation.<br />
	<br />
	If you need a block of 20 or more rooms, you may <a href="/Register-Plan/Hotel/Reserve-a-Room-Block.aspx">submit a request directly to your hotel(s) of choice.</a> Your request will be sent directly to the hotel(s), and the hotel(s) will have three business days to respond with pricing and availability.<br />
	<br />
	Please note: The International CES does not use a housing bureau or third party agency for hotel accommodations or any other travel arrangements. Any claims by any company stating otherwise are not true. Please be sure you are booking directly through the links on our <a href="/Register-Plan/Hotel.aspx">website</a> or direct with a specific hotel property.<br />
	<br />
	Any questions? Please email&nbsp;<a href="mailto:CEShotels@CE.org">CEShotels@CE.org</a>.</p>
<br />
...
//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
    <script type="text/javascript"> 
      //<![CDATA[
