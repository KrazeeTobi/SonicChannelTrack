...
<head id="head"><title>
	Kira Boyko - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Intel-Software-Aspire-to-Inspire/INTEL02_Quickly-Develop-Cross-Platform-Application/Kira-Boyko" />
<meta property="og:title" content="Kira Boyko" />
...
<meta name="twitter:title" content="Kira Boyko">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Intel-Software-Aspire-to-Inspire/INTEL02_Quickly-Develop-Cross-Platform-Application/Kira-Boyko.aspx" id="form">
...
<h2>Kira Boyko</h2>
<h3>Product Manager<br />Intel</h3>
<div style="float: left;">
  <img src="/CES/media/2014/Conference/SpeakerHeadshots/Kira_Boyko_Intel.jpg?ext=.jpg" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Kira Boyko">
</div>
<div style="margin: 10px;">
  Kira Boyko is the Product Manager for Intel’s Media Client and Mobile Developer Products, which includes the Media SDK, Media RAW Accelerator, Audio (all for Windows* client) and Media for Mobile (iOS*, Android* and WinRT), all part of Intel® INDE. Kira is passionate about delivering tools and products needed by developers to create differentiated, highly performant user experience across devices. Kira holds a B.A. from the Walter Cronkite School of Broadcast Journalism and Barrett the Honors College at Arizona State University, and certificates in Product Management and Strategy in Competitive Markets from UC Berkeley Haas School of Business.<br>
</div>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
    <script type="text/javascript"> 
      //<![CDATA[
