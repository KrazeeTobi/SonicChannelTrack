...
<head id="head"><title>
	Grant Clauser - 2016 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/SuperSessions/Super06_The-Evolution-of-the-Smart-Home/Grant-Clauser.aspx" />
<meta property="og:title" content="Grant Clauser" />
...
<meta name="twitter:title" content="Grant Clauser">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/SuperSessions/Super06_The-Evolution-of-the-Smart-Home/Grant-Clauser.aspx" id="form">
...
<h2>Grant Clauser</h2>
<h3>Technology Editor<br />Electronic House</h3>
<div style="float: left;">
  <img src="" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Grant Clauser">
</div>
<div style="margin: 10px;">
  Technology and Web Editor, Electronic House Grant Clauser has been covering home electronics for 15 years with editorial roles in several consumer and trade magazines. He's done ISF-level damage to hundreds of reviewed products and has had training from THX, the Home Acoustics Alliance, Control4 and Sencore. His latest book is Necessary Myths. Follow him on Twitter @geclauser.<br>
</div>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJODc3OTc4NjAwD2QWAgIBEGRkFgICBQ9kFgJmD2QWAmYPZBYCAg0PZBYCZg9kFgICAg9kFgJmD2QWAmYPZBYEAgMPZBYCZg8PFgIeCEJhbm5lcklEAuoCZGQCDw9kFgJmDw8WAh4HVmlzaWJsZWhkZGSuLmiKAemQP1P6JUoq3gIS6Tb5CaI9UZ4oFqSB5DAv3g==" />
    <script type="text/javascript"> 
      //<![CDATA[
