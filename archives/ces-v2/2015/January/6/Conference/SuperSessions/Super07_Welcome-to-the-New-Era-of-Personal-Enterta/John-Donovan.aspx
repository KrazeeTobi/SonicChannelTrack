...
<head id="head"><title>
	John Donovan - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/SuperSessions/Super07_Welcome-to-the-New-Era-of-Personal-Enterta/John-Donovan" />
<meta property="og:title" content="John Donovan" />
...
<meta name="twitter:title" content="John Donovan">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/SuperSessions/Super07_Welcome-to-the-New-Era-of-Personal-Enterta/John-Donovan.aspx" id="form">
...
<h2>John Donovan</h2>
<h3>Senior Executive Vice President - AT&T Technology & Operations<br />AT&T Inc.</h3>
<div style="float: left;">
  <img src="/CES/media/2014/Conference/SpeakerHeadshots/John_Donovan_AT-T-Inc.jpg?ext=.jpg" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="John Donovan">
</div>
<div style="margin: 10px;">
  John Donovan, Senior Executive Vice President—AT&amp;T Technology and Operations (ATO), is responsible for AT&amp;T’s global network and its best-in-class mobile broadband network along with creating a modern, software-defined, and cloud-based technology ecosystem to support them.<br><br>Mr. Donovan is driving AT&amp;T’s global leadership position in the technological transition to separate hardware and software and virtualizing network elements to the cloud. His responsibilities also include oversight of the company’s global information, software development, network technology and Big Data strategy; IT and digital planning, engineering, implementation and operations; network planning, construction and operations including security; field operations, installation and maintenance; global supply chain; and corporate fleet operations.<br><br>Donovan previously served as Chief Technology Officer for AT&amp;T, overseeing the company's global technology direction and innovation road map, including product development, network and engineering operations, AT&amp;T Labs and the security and intellectual property organizations.<br><br>Under Donovan's leadership, AT&amp;T has turbo-charged its innovation programs and now is recognized as an industry leader in working with application developers and others to make AT&amp;T's network open to collaboration and innovation.<br><br>Donovan previously was executive vice president of product, sales, marketing and operations at VeriSign Inc., a technology company that provides Internet infrastructure services. At VeriSign, Donovan was responsible for leading its global sales organization, driving the expansion of broad solutions offerings, and integrating a global professional services capability.<br><br>Before that, he was chairman and CEO of inCode Telecom Group Inc., where he helped shape strategic direction and positioning for wireless network operators around the globe. Previously, Mr. Donovan was a partner with Deloitte Consulting, where he was the Americas Industry Practice director for telecom.<br><br>Donovan serves on the Board of Directors for Palo Alto Networks. He has authored two books, The Value Enterprise, published in January 1998, and Value Creating Growth, published in 1999. Donovan received a B.S.E.E. from the University of Notre Dame and earned an M.B.A. in finance from the University of Minnesota.
</div>
