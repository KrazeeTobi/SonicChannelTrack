...
<head id="head"><title>
	Dennis  Miloseski - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/SuperSessions/Super05_The-Business-of-the-Smart-Watch/Dennis-Miloseski" />
<meta property="og:title" content="Dennis  Miloseski" />
...
<meta name="twitter:title" content="Dennis  Miloseski">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/SuperSessions/Super05_The-Business-of-the-Smart-Watch/Dennis-Miloseski.aspx" id="form">
...
<h2>Dennis Miloseski</h2>
<h3>Vice President, Design<br />Samsung</h3>
<div style="float: left;">
  <img src="/CES/media/2014/Conference/SpeakerHeadshots/Dennis_-Miloseski_Samsung.jpg?ext=.jpg" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Dennis Miloseski">
</div>
<div style="margin: 10px;">
  As Vice President, Head of Studio for Samsung Design America and Head of Samsung Mobile UXCA, Mr. Miloseski oversees Strategy, Design, User Experience, Industrial Design, and Engineering operations across Samsung's Mobile Experience and North American Design offices. Mr. Miloseski is responsible for shipping new category creating products globally, bringing hardware, software and services together in new ways to revolutionize the way we interact with technology and the world around us.&nbsp; Recent notable products from Mr. Miloseski at Samsung include the Samsung Gear S, Samsung Gear Circle, Samsung Gear Fit,and the Samsung Level Headphone Line-up.<br><br>Prior to Samsung, Mr. Miloseski was part of the design leadership team at Google. He joined Google in 2007 and managed the user experience teams responsible for launching end-to-end experiences for products such as Gmail and Google Apps. During his later tenure at Google, Mr. Miloseski was Head of Design for special projects across various Google, YouTube, Video, and TV projects. He was awarded an OC Award by the executive team and the exclusive Founder’s Award by Larry Page and SergeyBrin for his outstanding contributions to innovation at Google.<br><br>As an industry thought leader - Mr. Miloseski's work and perspectives have been published in Forbes, Fast Company, VentureBeat, CNET, Business Week, and the Wall Street Journal. As an industry speaker, he has given keynote addresses at venues such as CES, GigaOM Mobilize, Engadget Expand, IPTV World, and Fast.Co Innovation. As one of the new faces of Samsung in Silicon Valley, Mr. Miloseski's efforts are to help Samsung establish itself as a first-mover when it comes to new products, creating industry disruption for the company.<br>
</div>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJODc3OTc4NjAwD2QWAgIBEGRkFgICBQ9kFgJmD2QWAmYPZBYCAg0PZBYCZg9kFgICAg9kFgJmD2QWAmYPZBYEAgMPZBYCZg8PFgIeCEJhbm5lcklEAtkBZGQCDw9kFgJmDw8WAh4HVmlzaWJsZWhkZGT/yc0QGIcqN42HS498KnGMFXGoQkk3XjYqq1FaxzWvEw==" />
    <script type="text/javascript"> 
      //<![CDATA[
