...
<head id="head"><title>
	Richard  Huddy - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/SuperSessions/Super04_Future-of-Gaming/Richard-Huddy" />
<meta property="og:title" content="Richard  Huddy" />
...
<meta name="twitter:title" content="Richard  Huddy">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/SuperSessions/Super04_Future-of-Gaming/Richard-Huddy.aspx" id="form">
...
<h2>Richard Huddy</h2>
<h3>Chief Gaming Scientist<br />AMD</h3>
<div style="float: left;">
  <img src="/CES/media/2014/Conference/SpeakerHeadshots/Richard-_Huddy_AMD_1.jpg?ext=.jpg" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Richard Huddy">
</div>
<div style="margin: 10px;">
  Richard Huddy is AMD’s “Chief Gaming Scientist” and reports in to the Office of the CTO. He holds confidential communication responsibilities with AMD’s leading game developer partners to ensure that the interest of games developers remains front and center in AMD’s GPU designs.&nbsp; Richard also spends a significant amount of his time evangelizing AMD’s technologies and products to help external observers to make better informed judgments on AMD.<br><br>Richard has a background in 3D graphics extending back to the early days of gaming APIs and is a frequent speaker at GDC, Siggraph and other graphics related events.
</div>
