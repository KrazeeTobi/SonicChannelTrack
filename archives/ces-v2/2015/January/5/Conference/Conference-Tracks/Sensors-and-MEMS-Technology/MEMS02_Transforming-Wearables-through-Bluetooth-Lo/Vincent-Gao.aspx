...
<head id="head"><title>
	Vincent Gao - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Sensors-and-MEMS-Technology/MEMS02_Transforming-Wearables-through-Bluetooth-Lo/Vincent-Gao" />
<meta property="og:title" content="Vincent Gao" />
...
<meta name="twitter:title" content="Vincent Gao">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Sensors-and-MEMS-Technology/MEMS02_Transforming-Wearables-through-Bluetooth-Lo/Vincent-Gao.aspx" id="form">
...
<h2>Vincent Gao</h2>
<h3>Technical Program Manager<br />Bluetooth Special Interest Group (SIG)</h3>
<div style="float: left;">
  <img src="/CES/media/2014/Conference/SpeakerHeadshots/Vincent_Gao_Bluetooth-Special-Interest-Group-(SIG).jpg?ext=.jpg" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Vincent Gao">
</div>
<div style="margin: 10px;">
  Vincent Gao is the Technical Program Manager at the Bluetooth Special Interest Group (SIG). In this role, he works with the worldwide developers on adopting the latest Bluetooth technology and moving it forward. He’s also in several Bluetooth workgroups, focusing on the next generation of the Bluetooth standard. Vincent has more than 20 years of professional software development experience on embedded, handset, and the Web. He’s passionate about connecting the physical devices to the vast digital world.
</div>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
    <script type="text/javascript"> 
      //<![CDATA[
