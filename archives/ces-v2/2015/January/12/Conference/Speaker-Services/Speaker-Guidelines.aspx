...
<head id="head"><title>
	Speaker Guidelines - 2016 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Speaker-Services/Speaker-Guidelines" />
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Speaker-Services/Speaker-Guidelines.aspx" id="form">
...
<section>
        ...
        <div class="container clearfix above">
            <div class="one-sixth-leftnav">
                <div class="leftnav">
                    <ul><li><a href="/Conference/Keynotes">Keynote Addresses</a><li><a href="/Conference/Purchase-Passes">Purchase Conference Passes</a><li><a href="/Conference/Shopping-Cart">Shopping Cart</a><li><a href="/Conference/Session-Schedule-Brochure">Conference Program Schedule </a><li><a href="/Conference/Speaker-Search">Speaker Search</a><li><a href="/Conference/SuperSessions">SuperSessions</a><li><a href="/Conference/Conference-Tracks">Conference Tracks</a><li><a href="/Conference/Become-a-Speaker">Become a Speaker</a><li class="left-up"><a href="/Conference/Speaker-Services">Speaker Services</a><ul><li class="left-current"><a href="/Conference/Speaker-Services/Speaker-Guidelines">Speaker Guidelines</a><ul></ul></ul><li><a href="/Conference/Speaker-Guidelines">Speaker Guidelines</a></ul>
                    ...
                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                             ...
                             <li class="bread-div">|</li><li><a href="/Conference.aspx" class="CMSBreadCrumbsLink">Conference</a> </li><li class="bread-div">|</li><li> <a href="/Conference/Speaker-Services.aspx" class="CMSBreadCrumbsLink">Speaker Services</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">Speaker Guidelines</span>
</li>
...
<p class="intro">These helpful tips will help you prepare for speaking at the 2015 International CES.&nbsp;</p>  
...
<ul>
	...
	<li>
		Press and analysts are admitted to conference sessions free of charge.&nbsp;There are no specific press services offered for speakers.&nbsp;If your company is exhibiting at CES, we do have&nbsp;<a href="http://www.cesweb.org/Exhibitor/Media-and-PR-Opportunities">public relations resources</a>&nbsp;available.&nbsp;</li>
	<li>
	...
	<li>
		Handouts can be uploaded to the official&nbsp;<a href="http://cesweb.org/Show-Floor/CES-Mobile-App">International CES app</a>.&nbsp;More details will be available later this fall.</li>
	<li>
	...
	<li>
		All CES speakers have access to the&nbsp;Speaker Ready Rooms. Located in the LVCC, North Hall, Room&nbsp;N263 and in The Venetian, Casanova 501, these room are equipped with Wi-Fi and refreshments and is the perfect spot to meet up your fellow panelists.</li>
	<li>
		Each speaker receives up to 5 complimentary session tickets to attend other conference sessions. This can be picked up in the Speaker Ready Rooms when retrieving speaker badges.</li>
</ul>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
    <script type="text/javascript"> 
      //<![CDATA[
