...
<head id="head"><title>
	Robin Thurston - 2016 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Fitness-Tech/FIT05_Healthy-Interaction/Robin-Thurston" />
<meta property="og:title" content="Robin Thurston" />
...
<meta name="twitter:title" content="Robin Thurston">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Fitness-Tech/FIT05_Healthy-Interaction/Robin-Thurston.aspx" id="form">
...
<h2>Robin Thurston</h2>
<h3>President MapMyFitness, SVP Under Armour Connected Fitness<br />Under Armour</h3>
<div style="float: left;">
  <img src="/CES/media/2014/Conference/SpeakerHeadshots/Robin_Thurston_Under-Armour.jpeg?ext=.jpeg" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Robin Thurston">
</div>
<div style="margin: 10px;">
  As President of MapMyFitness, Robin is responsible for the company’s strategic vision while continually working to position it at the vanguard of leading health and fitness technology platforms. MapMyFitness is a wholly owned subsidiary of Under Armour, Inc. and was acquired in November 2013 for $150M.<br><br>Robin competed extensively on the U.S. national junior cycling circuit in the 1980’s. Ten years later he became a professional cyclist, moved to Switzerland and joined the Swiss Helvetica-Lugano team.&nbsp; He spent four years racing in Europe.<br><br>After a 2006 cycling vacation, Robin recognized the need for a resource to map and locate training routes and connect with other cyclists worldwide. Back in the U.S., he partnered with Jeff Kalikstein and Kevin Callahan, and MapMyFitness was born. The concept of using an online map to record activity into training logs was the first of its kind, essentially giving birth to the fitness technology movement. MapMyFitness was the first-ever health and fitness app built for Android OS and, subsequently, the iPhone.<br><br>Prior to co-founding MapMyFitness, Robin worked in investment management. He attained a B.S. in Finance from the Metropolitan State College of Denver and a M.S. in Finance from the University of Colorado Denver.
</div>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
    <script type="text/javascript"> 
      //<![CDATA[
