...
<head id="head"><title>
	Speaker Services - 2016 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Speaker-Services" />
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Speaker-Services.aspx" id="form">
...
<section>
        ...
        <div class="container clearfix above">
            <div class="one-sixth-leftnav">
                <div class="leftnav">
                    <ul><li><a href="/Conference/Keynotes">Keynote Addresses</a><li><a href="/Conference/Purchase-Passes">Purchase Conference Passes</a><li><a href="/Conference/Shopping-Cart">Shopping Cart</a><li><a href="/Conference/Session-Schedule-Brochure">Conference Program Schedule </a><li><a href="/Conference/Speaker-Search">Speaker Search</a><li><a href="/Conference/SuperSessions">SuperSessions</a><li><a href="/Conference/Conference-Tracks">Conference Tracks</a><li><a href="/Conference/Become-a-Speaker">Become a Speaker</a><li class="left-current"><a href="/Conference/Speaker-Services">Speaker Services</a><ul><li><a href="/Conference/Speaker-Services/Speaker-Guidelines">Speaker Guidelines</a></ul><li><a href="/Conference/Speaker-Guidelines">Speaker Guidelines</a></ul>
            ...
            <div class="three-fourth">
                <div class="body-content">
                    ...
                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                             ...
                             <li class="bread-div">|</li><li><a href="/Conference.aspx" class="CMSBreadCrumbsLink">Conference</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">Speaker Services</span>
</li>
                    ...
                    <div class="article-content-area">
                       ...
                       <p>
	CES offers a variety of services for its conference speakers, including help with show registration and audio-visual equipment. If you require additional assistance or have questions, contact&nbsp;<a href="mailto:amasal@ce.org">Austin Masal</a>.<br />
	<br />
	<strong>Registration and Badge Pick-up</strong><br />
	As a speaker, you will be registered for the International CES automatically. Upon your arrival, please pick up your badge at any of our <a href="http://cesweb.org/Register-Plan/Badge-Pick-Up-and-Registration-Locations">badge pick up locations</a>, or at&nbsp;either of our two Speaker Ready Rooms.<br />
	<br />
	<strong>On-site Speaker Ready Rooms</strong><br />
	CES speakers have access to our on-site Speaker Ready Rooms. Take advantage of these areas to orient yourself with the program location, fine-tune your presentation and network with your peers. Below are the locations and hours of the Speaker Ready Rooms:<br />
	&nbsp;<br />
	<strong>Las Vegas Convention Center (LVCC), North Hall Upper Level, Room N263</strong><br />
	Sunday, January 4 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Noon &ndash; 5 PM<br />
	Monday, January 5 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 7:30 AM &ndash; 5 PM<br />
	Tuesday, January 6 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;7:30 AM &ndash; 5 PM<br />
	Wednesday, January 7 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;7:30 AM &ndash; 5 PM<br />
	Thursday, January 8 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 7:30 AM &ndash; 5 PM<br />
	&nbsp;<br />
	<strong>The Venetian, Level 1, Casanova 501 </strong><br />
	Tuesday, January 6 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 7:30 AM &ndash; 5 PM<br />
	Wednesday, January 7 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 7:30 AM &ndash; 5 PM<br />
	Thursday, January 8 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;7:30 AM &ndash; 5 PM<br />
	&nbsp;<br />
	Speaker Ready Room Amenities include:</p>
<ul>
	<li>
	...
	<li>
		Show Directories and event schedules</li>
	<li>
		Copier</li>
	<li>
		Beverage service</li>
...
<p>
	<br />
	<strong>Conference Session AV Equipment</strong><br />
	The standard AV available for each conference session includes:</p>
<ul>
	<li>
		LCD data projector&nbsp;<em>(1024x 768 resolution; 4:3 aspect ratio)&nbsp;</em>and screen&nbsp;</li>
	<li>
		Podium with microphone</li>
	<li>
		Shared table microphones for panelists</li>
	<li>
		VGA switch box</li>
	<li>
		8 x 8 screen</li>
...
<p>
	All other AV equipment must be ordered and approved by December 3, 2014. A/V equipment cannot be ordered on-site.<br />
	<br />
	Laptops are NOT available, nor can additional AV equipment be ordered on-site.<br />
	<em>*Mac users:&nbsp;Notify&nbsp;</em><a href="mailto:khackett@ce.org"><em>Kacie</em> <em>Hackett</em></a><em>&nbsp;if you will be using a Mac computer so that we can coordinate the appropriate adapters.</em><br />
	<br />
	Use of the&nbsp;International CES&nbsp;Conference PowerPoint Template&nbsp;is strongly encouraged when creating slide presentations.&nbsp;The template will be available on this page later in the fall.<br />
	&nbsp;<br />
	Please view the <a href="http://cesweb.org/Conference/Speaker-Guidelines">Speaker Guidelines</a> prior to your session(s) at CES.<br />
	&nbsp;</p>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJODc3OTc4NjAwD2QWAgIBEGRkFgICBQ9kFgJmD2QWAmYPZBYCAg0PZBYCZg9kFgICAg9kFgJmD2QWAmYPZBYCAgMPZBYCZg8PFgIeCEJhbm5lcklEAuoCZGRkTI6JgLY9dWTpJFwRSlrRhnejq2upAkfL1Y9d9wRQwgk=" />
    <script type="text/javascript"> 
      //<![CDATA[
