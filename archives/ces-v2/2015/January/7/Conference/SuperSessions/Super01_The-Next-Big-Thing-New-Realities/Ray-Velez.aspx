...
<head id="head"><title>
	Ray Velez - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/SuperSessions/Super01_The-Next-Big-Thing-New-Realities/Ray-Velez" />
<meta property="og:title" content="Ray Velez" />
...
<meta name="twitter:title" content="Ray Velez">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/SuperSessions/Super01_The-Next-Big-Thing-New-Realities/Ray-Velez.aspx" id="form">
...
<h2>Ray Velez</h2>
<h3>Global Chief Technology Officer<br />Razorfish</h3>
<div style="float: left;">
  <img src="/CES/media/2014/Conference/SpeakerHeadshots/Ray_Velez_Razorfish.jpg?ext=.jpg" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Ray Velez">
</div>
<div style="margin: 10px;">
  Ray Velez is Razorfish's Global Chief Technology Officer. He runs the technology organization for Razorfish company-wide, providing overall strategic direction internationally. His background includes senior architectural consulting in web and enterprise systems and architectures and strategic IT planning. Ray has applied his expertise on several of Razorfish’s largest implementations for clients and has trained and developed curriculums in various technologies and Agile methodologies. He also drives the strategic technology partnerships and how they help drive our client delivery. <br><br>Ray’s experience includes 15-plus years in technology, having served as a senior architectural consultant at Scient and Cambridge Technology Partners. His selected client list includes: Ford Motor Company, Mercedes-Benz, Intel, AT&amp;T, and CondéNet among others. He is also a co-author of Converge: Transforming Business at the Intersection of Marketing and Technology.<br>
</div>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJODc3OTc4NjAwD2QWAgIBEGRkFgICBQ9kFgJmD2QWAmYPZBYCAg0PZBYCZg9kFgICAg9kFgJmD2QWAmYPZBYEAgMPZBYCZg8PFgIeCEJhbm5lcklEAtkBZGQCDw9kFgJmDw8WAh4HVmlzaWJsZWhkZGSy7DbDAk+vHe/8tq7pCy3dFfk4Yk2wgBeuwhTLLB4TlA==" />
    <script type="text/javascript"> 
      //<![CDATA[
