...
<head id="head"><title>
	Marni Walden - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/SuperSessions/Super07_Welcome-to-the-New-Era-of-Personal-Enterta/Marni-Walden" />
<meta property="og:title" content="Marni Walden" />
...
<meta name="twitter:title" content="Marni Walden">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/SuperSessions/Super07_Welcome-to-the-New-Era-of-Personal-Enterta/Marni-Walden.aspx" id="form">
...
<h2>Marni Walden</h2>
<h3>EVP and President, Product and New Business Innovation<br />Verizon</h3>
<div style="float: left;">
  <img src="" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Marni Walden">
</div>
<div style="margin: 10px;">
  Marni Walden is executive vice president and president - product and new business innovation. She is in charge of a new company wide organization that will leverage all of Verizon’s assets to quickly develop innovative products across the company’s wireless, wireline, IP and cloud networks and platforms.<br><br>The organization, Product and New Business Innovation, also has responsibility for developing and nurturing new and emerging businesses such as telematics, and the video assets of upLynk, EdgeCast and Intel Media. Verizon acquired these assets in 2013.<br><br>Previously, Walden was executive vice president and chief operating officer for Verizon Wireless, the largest wireless company in the United States, with responsibility for the company's nationwide operations and delivery of industry-leading performance for consumer and business customers.<br><br>Before that, she was Verizon Wireless’ vice president and chief marketing officer, responsible for all marketing initiatives and the management and development of mobile products and services. This included brand management, media buying, agency management and website integration across the entire company.<br><br>Walden also has served as president of Verizon Wireless’ Midwest area, responsible for operations spanning 15 states. In addition she has served as president of the company’s Southern California region, president of the Desert Mountain region, and as branch director for AirTouch Cellular in Colorado and Wyoming. She received a Bachelor of Arts degree from California State University at Chico State.
</div>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJODc3OTc4NjAwD2QWAgIBEGRkFgICBQ9kFgJmD2QWAmYPZBYCAg0PZBYCZg9kFgICAg9kFgJmD2QWAmYPZBYEAgMPZBYCZg8PFgIeCEJhbm5lcklEAtkBZGQCDw9kFgJmDw8WAh4HVmlzaWJsZWhkZGScgRxVIL2rBOn0Nyq3Z7xmDfX/a6UMACJvYqNQVrNZvg==" />
    <script type="text/javascript"> 
      //<![CDATA[
