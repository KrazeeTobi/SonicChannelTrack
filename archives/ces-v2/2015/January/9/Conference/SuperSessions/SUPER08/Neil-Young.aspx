...
<head id="head"><title>
	Neil Young - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/SuperSessions/SUPER08/Neil-Young" />
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/SuperSessions/SUPER08/Neil-Young.aspx" id="form">
...
<h2>Neil Young</h2>
<h3>CEO<br />PonoMusic</h3>
<div style="float: left;">
  <img src="" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Neil Young">
</div>
<div style="margin: 10px;">
  Neil Young is the CEO, founder and the vision, force, energy, and voice of PonoMusic.<br><br>Neil Young's career can only be classified as unclassifiable.&nbsp; Each new path he's taken us on has been joyously unpredictable.&nbsp; As an artist, he's risen to prominence as a musician, filmmaker, producer, director, author, activist, humanitarian and visionary who's helped advance the formats with which we listen to music.<br>
</div>
