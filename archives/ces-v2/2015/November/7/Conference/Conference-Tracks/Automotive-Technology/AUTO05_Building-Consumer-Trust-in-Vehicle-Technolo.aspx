...
<head id="head"><title>
	AUTO05_Building Consumer Trust in Vehicle Technology - CES 2016
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Automotive-Technology/AUTO05_Building-Consumer-Trust-in-Vehicle-Technolo.aspx" />
<meta property="og:title" content="AUTO05_Building Consumer Trust in Vehicle Technology" />
...
<meta name="twitter:title" content="AUTO05_Building Consumer Trust in Vehicle Technology">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Automotive-Technology/AUTO05_Building-Consumer-Trust-in-Vehicle-Technolo.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>Building Consumer Trust in Vehicle Technology</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<div>
    <h2>Building Consumer Trust in Vehicle Technology</h2>
    <div class="leftTrackColumn col-sm-18 col-md-15">      
      <div class="waysToBuy">
        <div id="addToCartAUTO05" class="cartItem"></div>
      </div>
    </div>
  <div class="col-sm-42 col-md-45">
    <img class="sessionLogo" src="/getmedia/b9acaf46-f248-480c-bdc5-f7fd51b718b2/CES-1286-JDPower-red.aspx?width=196&height=42&ext=.jpg">
  ...
  <a href="#" title="Add to Calendar" class="addthisevent" data-track="_gaq.push(['_trackEvent','AddThisEvent','click','ate-calendar'])">
                                            ...
                                            <span class="title">Building Consumer Trust in Vehicle Technology</span>
                                            <span class="description">Trust takes years to build, seconds to break and forever to repair. The automotive industry is introducing automated technology that has user trust at its heart. Hear what J.D. Power says about consumer trust and adoption of auto technologies.</span> 
    ...
    <div class="paragraphText">Trust takes years to build, seconds to break and forever to repair. The automotive industry is introducing automated technology that has user trust at its heart. Hear what J.D. Power says about consumer trust and adoption of auto technologies.</div>
</div>  
</div>
<ul class="sessionSpeaker"><div id="GroupedData">
	  
<div class=""><strong>Speaker:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Automotive-Technology/AUTO05_Building-Consumer-Trust-in-Vehicle-Technolo/Kristin-Kolodge.aspx">
  <strong>Kristin Kolodge</strong></a>,&nbsp;Executive Director, Driver Interaction and Human Machine Interface (HMI), J.D. Power
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Automotive-Technology/AUTO05_Building-Consumer-Trust-in-Vehicle-Technolo/Renee-Stephens.aspx">
  <strong>Renee Stephens</strong></a>,&nbsp;Vice President, US Auto Quality, J.D. Power
</li></div></div>
</div> 
</ul>
