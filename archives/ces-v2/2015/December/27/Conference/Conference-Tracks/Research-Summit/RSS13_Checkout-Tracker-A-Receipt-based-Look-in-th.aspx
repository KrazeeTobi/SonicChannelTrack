...
<head id="head"><title>
	RSS13_Checkout Tracker: A Receipt-based Look in the Cart - CES 2016
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Research-Summit/RSS13_Checkout-Tracker-A-Receipt-based-Look-in-th.aspx" />
<meta property="og:title" content="RSS13_Checkout Tracker: A Receipt-based Look in the Cart" />
...
<meta name="twitter:title" content="RSS13_Checkout Tracker: A Receipt-based Look in the Cart">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Research-Summit/RSS13_Checkout-Tracker-A-Receipt-based-Look-in-th.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>Checkout Tracker℠: A Receipt-based Look in the Cart</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<div>
    <h2>Checkout Tracker℠: A Receipt-based Look in the Cart</h2>
  ...
  <div class="col-sm-42 col-md-45">
    <img class="sessionLogo" src="/CES/media/2014/Conference/Logos/NPD_Logo_RGB_Positive_72_sm_1.png?ext=.png">
    <p class="sessionInfo h3">
      12&#45;12:30 PM January 5<br />
  ...
  <a href="#" title="Add to Calendar" class="addthisevent" data-track="_gaq.push(['_trackEvent','AddThisEvent','click','ate-calendar'])">
                                            Add to Calendar 
                                            <span class="start">1/5/2016 12:00:00 PM</span> 
                                            <span class="end">1/5/2016 12:30:00 PM</span> 
                                            <span class="timezone">America/Los_Angeles</span> 
                                            <span class="title">Checkout Tracker℠: A Receipt-based Look in the Cart</span>
                                            <span class="description">NPD reveals comprehensive information on consumer buying behavior at the cart level, based on receipt data for both online and brick-and-mortar consumer technology purchases. Understand opportunities to study the same consumers over time, analyze competing shopping carts and identify purchase patterns.</span> 
    ...
    <div class="paragraphText">NPD reveals comprehensive information on consumer buying behavior at the cart level, based on receipt data for both online and brick-and-mortar consumer technology purchases. Understand opportunities to study the same consumers over time, analyze competing shopping carts and identify purchase patterns.</div>
</div>  
</div>
<ul class="sessionSpeaker"><div id="GroupedData">
	  
<div class=""><strong>Speaker:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Research-Summit/RSS13_Checkout-Tracker-A-Receipt-based-Look-in-th/Liz-Cutting.aspx">
