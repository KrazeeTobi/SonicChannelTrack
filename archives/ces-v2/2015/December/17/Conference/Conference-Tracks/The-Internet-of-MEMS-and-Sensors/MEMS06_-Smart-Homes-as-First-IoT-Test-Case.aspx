...
<head id="head"><title>
	MEMS06_ Smart Homes as First IoT Test Case - CES 2016
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/The-Internet-of-MEMS-and-Sensors/MEMS06_-Smart-Homes-as-First-IoT-Test-Case.aspx" />
<meta property="og:title" content="MEMS06_ Smart Homes as First IoT Test Case" />
...
<meta name="twitter:title" content="MEMS06_ Smart Homes as First IoT Test Case">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/The-Internet-of-MEMS-and-Sensors/MEMS06_-Smart-Homes-as-First-IoT-Test-Case.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1> Smart Homes as First IoT Test Case</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<div>
    <h2> Smart Homes as First IoT Test Case</h2>
  ...
  <a href="#" title="Add to Calendar" class="addthisevent" data-track="_gaq.push(['_trackEvent','AddThisEvent','click','ate-calendar'])">
                                            ...
                                            <span class="title"> Smart Homes as First IoT Test Case</span>
                                            <span class="description">With smart devices like Nest working with wearables to control everything from the ceiling fan in your bedroom to the spoiled milk in your refrigerator, smart homes are an IoT case study for applications enabled by MEMS and sensors.</span> 
    ...
    <div class="paragraphText">With smart devices like Nest working with wearables to control everything from the ceiling fan in your bedroom to the spoiled milk in your refrigerator, smart homes are an IoT case study for applications enabled by MEMS and sensors.</div>
</div>  
</div>
<ul class="sessionSpeaker"><div id="GroupedData">
	  
<div class=""><strong>Speaker:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/The-Internet-of-MEMS-and-Sensors/MEMS06_-Smart-Homes-as-First-IoT-Test-Case/Ian-Chen.aspx">
  <strong>Ian Chen</strong></a>,&nbsp;Systems, Applications, Software and Algorithms Marketing, NXP Semiconductors
</li></div></div>
</div> 
</ul>
