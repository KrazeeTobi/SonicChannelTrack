...
<head id="head"><title>
	FIT06_FitnessTech to Connected Health - CES 2016
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/FitnessTech-Summit/FIT06_FitnessTech-to-Connected-Health.aspx" />
<meta property="og:title" content="FIT06_FitnessTech to Connected Health" />
...
<meta name="twitter:title" content="FIT06_FitnessTech to Connected Health">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/FitnessTech-Summit/FIT06_FitnessTech-to-Connected-Health.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>FitnessTech to Connected Health</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<div>
    <h2>FitnessTech to Connected Health</h2>
  ...
  <a href="#" title="Add to Calendar" class="addthisevent" data-track="_gaq.push(['_trackEvent','AddThisEvent','click','ate-calendar'])">
                                            ...
                                            <span class="end">1/6/2016 5:00:00 PM</span> 
                                            <span class="timezone">America/Los_Angeles</span> 
                                            <span class="title">FitnessTech to Connected Health</span>
                                            <span class="description">Devices featuring sleep analysis, virtual coaching and injury prevention are leading the way for&nbsp;professional athletes and weekend warriors alike. New and ingenious methods of data collection are&nbsp;leading to superior training capabilities as well as healthier lifestyles.

	Spotlight Session: Fitbit
	Victory and Technology
	&nbsp;
</span> 
    ...
    <div class="paragraphText">Devices featuring sleep analysis, virtual coaching and injury prevention are leading the way for&nbsp;professional athletes and weekend warriors alike. New and ingenious methods of data collection are&nbsp;leading to superior training capabilities as well as healthier lifestyles.
<ul>
...
<div class=""><strong>Presenter:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/FitnessTech-Summit/FIT06_FitnessTech-to-Connected-Health/Jeremy-Kaplan.aspx">
  <strong>Jeremy Kaplan</strong></a>,&nbsp;Editor in Chief, Digital Trends
</li></div></div><div class=""><strong>Moderator:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/FitnessTech-Summit/FIT06_FitnessTech-to-Connected-Health/Ted-Vickey.aspx">
  <strong>Ted Vickey</strong></a>,&nbsp;Sr. Advisor for Disruptive Health Technologies, Canyon Ranch Institute
</li></div></div><div class=""><strong>Speaker:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/FitnessTech-Summit/FIT06_FitnessTech-to-Connected-Health/Davyeon-Ross.aspx">
  <strong>Davyeon Ross</strong></a>,&nbsp;Co-Founder and COO, Shottracker
</li><li>
  
  <strong>Kow Ping</strong>,&nbsp;Director, Well Being Digital
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/FitnessTech-Summit/FIT06_FitnessTech-to-Connected-Health/Martin-Matak.aspx">
  <strong>Martin Matak</strong></a>,&nbsp;President and Founder, VERT
</li><li>
  
  <strong>Amy McDonough</strong>,&nbsp;VP, Fitness Wellness, Fitbit, Inc.
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/FitnessTech-Summit/FIT06_FitnessTech-to-Connected-Health/Dwight-Phillips.aspx">
  <strong>Dwight Phillips</strong></a>,&nbsp;Business Development Director, Kuaiwear
</li></div></div>
</div> 
</ul>
