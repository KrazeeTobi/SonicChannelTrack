...
<head id="head"><title>
	CON01_Monetization Strategies for IoT and the Connected Home - CES 2016
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/CONNECTIONS™-Summit/CON01_Monetization-Strategies-for-IoT-and-the-Conn.aspx" />
<meta property="og:title" content="CON01_Monetization Strategies for IoT and the Connected Home" />
...
<meta name="twitter:title" content="CON01_Monetization Strategies for IoT and the Connected Home">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/CONNECTIONS™-Summit/CON01_Monetization-Strategies-for-IoT-and-the-Conn.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1> Monetization Strategies for IoT and the Connected Home</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<div>
    <h2> Monetization Strategies for IoT and the Connected Home</h2>
  ...
  <a href="#" title="Add to Calendar" class="addthisevent" data-track="_gaq.push(['_trackEvent','AddThisEvent','click','ate-calendar'])">
                                            Add to Calendar 
                                            <span class="start">1/6/2016 9:15:00 AM</span> 
                                            <span class="end">1/6/2016 10:25:00 AM</span> 
                                            <span class="timezone">America/Los_Angeles</span> 
                                            <span class="title"> Monetization Strategies for IoT and the Connected Home</span>
                                            <span class="description">The connected home needs to offer a cohesive user experience across all sectors&mdash;from security to controls to energy. This session addresses potential smart home partnerships, integration challenges, and new business and channel strategies for connected home solutions.</span> 
    ...
    <div class="paragraphText">The connected home needs to offer a cohesive user experience across all sectors&mdash;from security to controls to energy. This session addresses potential smart home partnerships, integration challenges, and new business and channel strategies for connected home solutions.</div>
</div>  
</div>
<ul class="sessionSpeaker"><div id="GroupedData">
	  
<div class=""><strong>Moderator:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/CONNECTIONS™-Summit/CON01_Monetization-Strategies-for-IoT-and-the-Conn/Tom-Kerber.aspx">
  <strong>Tom Kerber</strong></a>,&nbsp;Director of Research, Parks Associates
</li></div></div><div class=""><strong>Speaker:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/CONNECTIONS™-Summit/CON01_Monetization-Strategies-for-IoT-and-the-Conn/Nate-Williams.aspx">
  <strong>Nate Williams</strong></a>,&nbsp;Chief Revenue Officer, August
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/CONNECTIONS™-Summit/CON01_Monetization-Strategies-for-IoT-and-the-Conn/Seth-Frader-Thompson.aspx">
  <strong>Seth Frader-Thompson</strong></a>,&nbsp;Co-Founder and President, EnergyHub
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/CONNECTIONS™-Summit/CON01_Monetization-Strategies-for-IoT-and-the-Conn/Steve	-Thompson.aspx">
  <strong>Steve Thompson</strong></a>,&nbsp;VP, IoT, Business Development, PlumChoice
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/CONNECTIONS™-Summit/CON01_Monetization-Strategies-for-IoT-and-the-Conn/Kevin-Garton.aspx">
  <strong>Kevin Garton</strong></a>,&nbsp;CMO, Zonoff
</li><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/CONNECTIONS™-Summit/CON01_Monetization-Strategies-for-IoT-and-the-Conn/Amena-Ali.aspx">
  <strong>Amena Ali</strong></a>,&nbsp;Sr. VP and GM - WeatherBug Home, WeatherBug - Earth Networks
</li></div></div>
</div> 
</ul>
