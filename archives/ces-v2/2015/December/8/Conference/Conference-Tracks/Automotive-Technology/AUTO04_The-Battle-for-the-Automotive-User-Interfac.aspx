...
<head id="head"><title>
	AUTO04_The Battle for the Automotive User Interfact - CES 2016
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Automotive-Technology/AUTO04_The-Battle-for-the-Automotive-User-Interfac.aspx" />
<meta property="og:title" content="AUTO04_The Battle for the Automotive User Interfact" />
...
<meta name="twitter:title" content="AUTO04_The Battle for the Automotive User Interfact">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Automotive-Technology/AUTO04_The-Battle-for-the-Automotive-User-Interfac.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>The Battle for the Automotive User Interface</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<div>
    <h2>The Battle for the Automotive User Interface</h2>
    <p><b>$ Additional Registration Required</b></p>
    <div class="leftTrackColumn col-sm-18 col-md-15">      
      <div class="waysToBuy">
        <div id="addToCartAUTO04" class="cartItem"></div>
      </div>
    </div>
  ...
  <a href="#" title="Add to Calendar" class="addthisevent" data-track="_gaq.push(['_trackEvent','AddThisEvent','click','ate-calendar'])">
                                            ...
                                            <span class="title">The Battle for the Automotive User Interface</span>
                                            <span class="description">With an eye toward isolating the perfect user interface, proponents of voice, touch and gesture make the case for each approach and discuss what works best for specific tasks and which UI solution has the best chance for market success.&nbsp;</span> 
    ...
    <div class="paragraphText">With an eye toward isolating the perfect user interface, proponents of voice, touch and gesture make the case for each approach and discuss what works best for specific tasks and which UI solution has the best chance for market success.&nbsp;</div>
</div>  
</div>
<ul class="sessionSpeaker"><div id="GroupedData">
	  
<div class=""><strong>Moderator:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Automotive-Technology/AUTO04_The-Battle-for-the-Automotive-User-Interfac/Johnathan-Rettinger.aspx">
  <strong>Jon Rettinger</strong></a>,&nbsp;President and Editorial Director, TechnoBuffalo
</li></div></div><div class=""><strong>Speaker:</strong><div class=""><li>
  <a class="bio-link" href="/Conference/Conference-Tracks/Automotive-Technology/AUTO04_The-Battle-for-the-Automotive-User-Interfac/Eric-Brown.aspx">
  <strong>Eric Brown</strong></a>,&nbsp;Director, Interaction Design, Designworks. A BMW Group Company
</li><li>
  
  <strong>Justin Ebert</strong>,&nbsp;Sr. Director, Automotive Cockpit, NVIDIA
</li></div></div>
</div> 
</ul>
