...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/CONNECTIONS™-Summit/CON06_Personalization-and-Big-Data-Securing-Consu/Sagar-Savla.aspx" />
<meta property="og:title" content="Sagar Savla" />
...
<meta name="twitter:title" content="Sagar Savla">
...
<body class="LTR Safari Chrome Safari47 Chrome47 ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/CONNECTIONS™-Summit/CON06_Personalization-and-Big-Data-Securing-Consu/Sagar-Savla.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>Sagar Savla</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<h2>Sagar Savla</h2>
<h3>Data Science Engineer<br />Facebook</h3>
<div style="float: left;">
  <img src="/CES/media/2014/Conference/SpeakerHeadshots/Sagar-Savla_10-20-2015-3-58-13-AM.png?ext=.png" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Sagar Savla">
</div>
<div style="margin: 10px;">
  <p><span style="font-weight: 400;">Sagar is a breaker-of-all-things-data at Facebook. He mines and analyzes data to bring insights on to the table, directing strategic decisions in diverse and eclectic products that help connect the world. Prior to Facebook, he worked at PayPal where he built fraud and anomaly detection in graphs. He's also worked at unicorn startups like Lyft where he used data science to build an in-house dispatch system.</span></p>
<p><span style="font-weight: 400;">Before working in the industry, he worked at Georgia Institute of Technology where he streamlined financial accounting processes and chalked out a industry-best-practices for mobile experiences of cultural events. As a student, he also led the cross functional career services department at his alma mater in Bombay connecting graduates with the right companies and careers. He has conducted multiple seminars on Ethical Hacking evangelizing good computer and information security. He also has won multiple awards for his work in tech competitions and hackathons with mobile apps live in the App Stores. He's dabbled in products on multiple platforms like Android, iOS, PlayStation, Java Mobile and even the Kindle.</span></p>
<p><span style="font-weight: 400;">He has a Masters' from Georgia Tech with research in fields of Machine Learning, User Experience and Privacy Policies. He is co-author of Uxonomy: UX for Modern Engineers.</span></p>
</div>
