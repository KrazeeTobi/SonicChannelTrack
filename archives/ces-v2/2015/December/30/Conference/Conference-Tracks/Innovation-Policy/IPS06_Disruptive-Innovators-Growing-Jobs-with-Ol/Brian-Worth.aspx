...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Innovation-Policy/IPS06_Disruptive-Innovators-Growing-Jobs-with-Ol/Brian-Worth.aspx" />
...
<meta name="twitter:title" content="Brian Worth">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Innovation-Policy/IPS06_Disruptive-Innovators-Growing-Jobs-with-Ol/Brian-Worth.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>Brian Worth</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<h2>Brian Worth</h2>
<h3>Federal Public Policy Manager<br />Uber</h3>
<div style="float: left;">
  <img src="" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Brian Worth">
</div>
<div style="margin: 10px;">
  <div class="page" title="Page 1">
<div class="layoutArea">
<div class="column">
<p>Worth currently serves as the Federal Public Policy Manager for Uber. He is responsible for advocating Uber&rsquo;s pro-growth, market-driven business model to all federal stakeholders and interested parties.</p>
<p>Prior to joining Uber, Worth served as the Director of Coalitions for House Majority Whip Kevin McCarthy (R-CA). In this role, he was responsible for coordinating outreach to key organizations that were interested in legislation being considered by the U.S. House of Representatives.</p>
<p>Worth is graduated from Miami University, and resides in Arlington, Virginia, with his wife, two boys, labradoodle, and mini-van.</p>
</div>
</div>
</div>
</div>
