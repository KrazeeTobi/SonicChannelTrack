...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Innovation-Policy/IPS06_Disruptive-Innovators-Growing-Jobs-with-Ol/Arun-Sundararajan.aspx" />
<meta property="og:title" content="Arun Sundararajan" />
...
<meta name="twitter:title" content="Arun Sundararajan">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Innovation-Policy/IPS06_Disruptive-Innovators-Growing-Jobs-with-Ol/Arun-Sundararajan.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>Arun Sundararajan</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<h2>Arun Sundararajan</h2>
<h3>Professor of Business; Rosen Faculty Fellow<br />New York University</h3>
<div style="float: left;">
  <img src="/CES/media/2014/Conference/SpeakerHeadshots/Arun-Sundararajan_11-25-2015-6-50-02-PM.jpg?ext=.jpg" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Arun Sundararajan">
</div>
<div style="margin: 10px;">
  <p>Arun Sundararajan is Professor and the Robert L. and Dale Atkins Rosen Faculty Fellow at New York University's Leonard N. Stern School of Business. He is also an affiliated faculty member at NYU's Center for Data Science and NYU&rsquo;s Center for Urban Science+Progress. His research program studies how digital technologies transform business and society. His current scholarly research focuses on peer-to-peer markets, the sharing economy, digital trust, social media and brand, digital labor, new institutions, regulation, social networks and online privacy.</p>
<p>Professor Sundararajan has published over 50 scientific papers in peer-reviewed academic journals and conferences and given over 200 presentations worldwide. His research has been recognized by six Best Paper awards, two Google Faculty awards and a variety of grants. He has served on numerous editorial boards for scholarly journals. He has provided expert views about the digital economy as part of Congressional testimony and to a variety of federal, state and city government bodies including the Presidential Council of Advisors on Science and Technology, the National Economic Council, the Federal Reserve Bank, the White House and the Federal Trade Commission.</p>
<p>Professor Sundararajan's recent op-eds and expert commentary have appeared in TIME Magazine, the New Yorker, the New York Times, the Washington Post, Le Monde, El Pais, Wired, TechCrunch, the Wall Street Journal, the Financial Times and Harvard Business Review, and on broadcast media in over a dozen countries. He has served as director of NYU Stern&rsquo;s IS Doctoral Program since 2007, is one of the founders of the Workshop on Information in Networks, is the founder of the Peer Collaborative, is a member of the&nbsp;City of New York's Technology Advisory Group, and is an advisor to Cisco Systems, OuiShare, the Center for Global Enterprise and the National League of Cities. He holds degrees from the Indian Institute of Technology, Madras and the University of Rochester.</p>
<p>Professor Sundararajan&rsquo;s new book about crowd-based capitalism will be published by the MIT Press in Spring 2016. Find out more at http://oz.stern.nyu.edu, and follow him on Twitter @digitalarun</p>
</div>
