...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Broadband/BBU01_Rise-of-Big-Data-and-the-Internet/Carol-Flannagan.aspx" />
<meta property="og:title" content="Carol Flannagan" />
...
<meta name="twitter:title" content="Carol Flannagan">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Broadband/BBU01_Rise-of-Big-Data-and-the-Internet/Carol-Flannagan.aspx" id="form">
   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>Carol Flannagan</h1><span id='TrackSubhead' class='presentedBy'></span>
...
<h2>Carol Flannagan</h2>
<h3>Director<br />University of Michigan Transportation Research Institute (UMTRI)</h3>
<div style="float: left;">
  <img src="/CES/media/2014/Conference/SpeakerHeadshots/Carol-Flannagan_10-16-2015-9-21-46-AM.jpg?ext=.jpg" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Carol Flannagan">
</div>
<div style="margin: 10px;">
  <p>Dr. Carol Flannagan is Interim Director of the University of Michigan Transportation Research Instutite (UMTRI), co-Director of UMTRI&rsquo;s data center (Center for the Management of Information for Safe and Sustainable Transportation, or CMISST), an Associate Research Scientist in the Biosciences group. She earned an M.A. in Statistics and a Ph.D. in Mathematical Psychology from the University of Michigan. Dr. Flannagan&rsquo;s work in transportation research encompasses analysis of a wide variety of transportation-related data, including naturalistic driving, FOT, crash, and injury outcome data. She has developed innovative approaches to data and information integration, including linking analysis of driving and crash datasets, as well as linking crash and medical outcome data. Much of her work with driving data has been focused on promoting appropriate use of statistics, promoting data access, and exploring promising new approaches.</p>
</div>
