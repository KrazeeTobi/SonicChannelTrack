      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          ...
          <div class="row article-content-area">
             ...
             <div class="text-center-xs pull-right-lg"><img src="/getmedia/f5820d9f-cdfe-4cff-8a22-fbe11cec71c0/APPNATION-VII-Logo.aspx?width=400&height=70&ext=.jpg" ></div>
<h2 class='page-intro'>Sands, Level 1, Hall G</h2>
<p class="intro">APPNATION VII focuses on the exploding app economy and best practices around app acquisition, monetization, data management, leveraging apps for consumer engagement, and explores the business case for Internet of Things (IoT) app development.<br />
<br />
<br />
Check back soon to see what exhibitors will be participating in App Economy.</p>  
