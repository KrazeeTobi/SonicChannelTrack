...
<head id="head"><title>
	Videos - 2016 International CES, January 6-9
...
<div class="breadcrumbs">
    <ul>
        <li>
            <a id="p_lt_ctl06_pageplaceholder_p_lt_ctl02_WebPartZone_WebPartZone_zone_UStudioVideoGrid_1_1_hypBChome" href="../">Home</a></li>
...
<input type="hidden" name="p$lt$ctl06$pageplaceholder$p$lt$ctl02$WebPartZone$WebPartZone_zone$UStudioVideoGrid_1_1$hidPageNumber" id="hidPageNumber" value="0" />
<input type="hidden" name="p$lt$ctl06$pageplaceholder$p$lt$ctl02$WebPartZone$WebPartZone_zone$UStudioVideoGrid_1_1$hidPageSize" id="hidPageSize" value="10" />
<input type="hidden" name="p$lt$ctl06$pageplaceholder$p$lt$ctl02$WebPartZone$WebPartZone_zone$UStudioVideoGrid_1_1$hidDestinationURL" id="hidDestinationURL" value="/api/v2/studios/OhYr3WpdgEMj/destinations/DliGIusJiD1C" />
<input type="hidden" name="p$lt$ctl06$pageplaceholder$p$lt$ctl02$WebPartZone$WebPartZone_zone$UStudioVideoGrid_1_1$hidDestinationID" id="hidDestinationID" value="DliGIusJiD1C" />
<input type="hidden" name="p$lt$ctl06$pageplaceholder$p$lt$ctl02$WebPartZone$WebPartZone_zone$UStudioVideoGrid_1_1$hidDefaultCat" id="hidDefaultCat" />
<input type="hidden" name="p$lt$ctl06$pageplaceholder$p$lt$ctl02$WebPartZone$WebPartZone_zone$UStudioVideoGrid_1_1$hidCats" id="hidCats" value="CESTV, Keynote, C Space" />
<input type="hidden" name="p$lt$ctl06$pageplaceholder$p$lt$ctl02$WebPartZone$WebPartZone_zone$UStudioVideoGrid_1_1$hidDetailPage" id="hidDetailPage" value="/News/CES-TV/Video-Detail" />
...
<script src="/CMSPages/GetResource.ashx?scriptfile=%2fces%2fjs%2fscripts.js" type="text/javascript"></script><script src="/CMSPages/GetResource.ashx?scriptfile=%2fces%2fjs%2fenquire%2fenquire.min.js" type="text/javascript"></script><script src="/CMSPages/GetResource.ashx?scriptfile=%2fces%2fjs%2fdropkick%2fdropkick.min.js" type="text/javascript"></script><script src="/CMSPages/GetResource.ashx?scriptfile=%2fces%2fjs%2fdropkick%2fdropkick.jquery.js" type="text/javascript"></script><script src="/CMSPages/GetResource.ashx?scriptfile=%2fces%2fjs%2fvideo-scripts.js" type="text/javascript"></script>  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
    <script type="text/javascript"> 
      //<![CDATA[
