...
<head id="head"><title>
	What to See at Tech West - 2016 International CES, January 6-9
...
<section>
        ...
        <div class="container clearfix above">
            <div class="one-sixth-leftnav">
                <div class="leftnav">
                    <ul><li><a href="/Show-Floor/Exhibit-or-Sponsor">Exhibit or Sponsor</a><li><a href="/Show-Floor/What-to-See-at-Tech-East">What to See at Tech East</a><li class="left-current"><a href="/Show-Floor/What-to-See-at-Tech-West">What to See at Tech West</a><ul><li><a href="/Show-Floor/What-to-See-at-Tech-West/Innovations-Design-and-Engineering-Showcase">Innovation Awards Showcase</a></ul><li><a href="/Show-Floor/What-to-See-at-C-Space">What to See at C Space</a><li><a href="/Show-Floor/Exhibit-Hours">Exhibit Hours</a><li><a href="/Show-Floor/Maps">Maps</a><li><a href="/Show-Floor/Exhibit-Directory">Exhibitor Directory</a><li><a href="/Show-Floor/Show-Floor-Tours">Show Floor Tours</a><li><a href="/Show-Floor/Marketplaces">Marketplaces</a></ul>
                    ...
                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                             ...
                             <li class="bread-div">|</li><li><a href="/Show-Floor.aspx" class="CMSBreadCrumbsLink">Show Floor</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">What to See at Tech West</span>
</li>
...
<h2>Sands Expo (Sands), The Venetian, The Palazzo, Wynn Las Vegas and Encore at Wynn (Wynn/Encore)</h2>
<p class="intro">Tech West will be a must see for buyers, distributors, press, industry analysts and key decision makers. Featuring the innovative power behind tomorrow&#39;s industry, Tech West encompasses revolutions in fitness and health, the Internet of things, sensors and other high-growth technologies changing the way we live, work and play. Tech West will serve the titans of tech, promising startups and everything in between.</p>  

<h3>
	<strong>SANDS</strong></h3>
<ul>
	<li>
		Marketplaces such as:</li>
</ul>
<ul style="margin-left: 40px;">
	<li>
		<a href="/Show-Floor/Marketplaces/3D-Printing.aspx">3D Printing</a>, presented by <em>TCT Magazine + Personalize</em></li>
	<li>
		<a href="/Show-Floor/Marketplaces/Education-Technology.aspx">Education &amp; Technology</a>, presented by Living in Digital Times</li>
	<li>
		<a href="/Show-Floor/Marketplaces/Eureka-Park.aspx">Eureka Park</a>, presented by the National Science Foundation and UP Global</li>
	<li>
		<a href="/Show-Floor/Marketplaces/Family-Technology.aspx">Family &amp; Technology</a>, presented by Living in Digital Times</li>
	<li>
		<a href="/Show-Floor/Marketplaces/Fitness.aspx">Fitness &amp; Technology</a>, presented by Living in Digital Times</li>
	<li>
		<a href="/Show-Floor/Marketplaces/Health-Wellness.aspx">Health &amp; Wellness</a>, presented by the Digital Health Summit</li>
	<li>
		<a href="/Show-Floor/Marketplaces/Kids-Technology.aspx">Kids &amp; Technology</a>, presented by Living in Digital Times</li>
	<li>
		<a href="/Show-Floor/Marketplaces/Lifelong-Tech.aspx">Lifelong Tech</a>, presented by Living in Digital Times</li>
	<li>
		<a href="/Show-Floor/Marketplaces/Robotics.aspx">Robotics</a>, presented by <em>Robotics Trends</em></li>
	<li>
		<a href="/Show-Floor/Marketplaces/Sensors.aspx">Sensors</a>, presented by the MEMS Industry Group</li>
	<li>
		<a href="/Show-Floor/Marketplaces/Smart-Home.aspx">Smart Home</a>, presented by Bosch</li>
	<li>
		<a href="/Show-Floor/Marketplaces/Smart-Watches.aspx">Smart Watches</a></li>
	<li>
		<a href="/Show-Floor/Marketplaces/University-Innovations.aspx">University Innovations</a></li>
	<li>
		<a href="/Show-Floor/Marketplaces/Wearables.aspx">Wearables</a>, presented by Living in Digital Times</li>
	<li>
		<a href="/Show-Floor/Marketplaces/ZigBee.aspx">Zigbee</a>, presented by the Zigbee Alliance</li>
</ul>
<ul>
	<li>
		<a href="http://www.CESweb.org/conferences">Conferences</a></li>
</ul>
<ul>
	<li>
		<a href="http://ces15.mapyourshow.com/6_0/search.cfm?srch-type=booth&amp;srch-query=LVCC&amp;srch-showresults=true">Exhibits</a>&nbsp;showcasing product categories such as:
		<ul>
			<li>
				3D printing</li>
			<li>
				Fitness and sports</li>
			<li>
				Health and biotech</li>
			<li>
				Robotics</li>
			<li>
				Sensors</li>
...
<ul>
	<li>
		<a href="/Show-Floor/What-to-See-at-Tech-West/Innovations-Design-and-Engineering-Showcase.aspx">Innovation Awards Showcase</a></li>
	<li>
		Meeting Place</li>
	<li>
		Press Rooms</li>
...
<ul>
	<li>
		<a href="/Show-Floor/Marketplaces/High-Resolution-Audio.aspx">High-Resolution Audio </a>Marketplace</li>
	<li>
		Exhibits showcasing <a href="http://ces15.mapyourshow.com/6_0/search.cfm?srch-type=category&amp;srch-query=81&amp;srch-showresults=true&amp;CFID=51464755&amp;CFTOKEN=8989e35a5a7cd02-07A3DA7D-C548-33C5-092BAEB39751F604" target="_blank">high-performance audio</a></li>
	<li>
		Meeting Rooms</li>
	<li>
		Select keynote addresses</li>
</ul>
<h3>
	<strong>WYNN/ENCORE</strong></h3>
<ul>
	<li>
		Hospitality Suites</li>
</ul>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
    <script type="text/javascript"> 
      //<![CDATA[
