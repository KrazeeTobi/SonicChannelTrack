...
<head id="head"><title>
	CEA Member Benefits - 2016 International CES, January 6-9
...
<meta property="og:image" content="http://www.cesweb.org/CES/media/2014/landing pages/why attend ces/why_cea-member-benefits.png?width=410&height=235&ext=.png">
<!-- open graph -->
...
<meta name="twitter:image" content="http://www.cesweb.org/CES/media/2014/landing pages/why attend ces/why_cea-member-benefits.png?width=410&height=235&ext=.png">
...
<section>
        ...
        <div class="container clearfix above">
            <div class="one-sixth-leftnav">
                <div class="leftnav">
                    <ul><li><a href="/Why-CES/Experience-the-International-CES">Experience Innovation at CES</a><li><a href="/Why-CES/2014-Attendee-Audit">CES By the Numbers</a><li class="left-current"><a href="/Why-CES/CEA-Member-Benefits">CEA Member Benefits</a><ul></ul></ul>
            ...
            <div class="three-fourth">
                <div class="body-content">
                    ...
                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                             ...
                             <li class="bread-div">|</li><li><a href="/Why-CES.aspx" class="CMSBreadCrumbsLink">Why CES?</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">CEA Member Benefits</span>
</li>
                    ...
                    <div class="article-content-area">
                       ...
                       <div class="feature-float-left"><img src="/CES/media/2014/landing%20pages/for%20exhibitors/exhibitors_member-bens.png?width=380&height=215&ext=.png" ></div>
<h2>CEA Member Benefits for CES Exhibitors and Attendees </h2>
<p class="intro">CEA&nbsp;<a href="http://www.ce.org/Membership/Join-CEA/Regular-Membership/Benefits-at-the-International-CES.aspx" target="_blank">members</a>&nbsp;get incredible benefits on-site at CES. To start, members get a $100 discount on registration and an Exhibit Plus Pass if they register before Nov. 30, 2014. They also receive a 25 percent discount on conference passes, exclusive access to member lounges with private meeting rooms, refreshments and lots of seating, plus an invitation to the CEA Member Cocktail Party.</p>  
...
<ul>
	...
	<li>
		<p>
			CEA Staff will be available in the member lounges for assistance.</p>
	</li>
</ul>
<p>
	<br />
...
<ul>
	<li>
		Las Vegas Convention Center (LVCC), North Hall, Upper Level, Outside&nbsp;Room N250</li>
	<li>
		LVCC, South Hall Connector, Room S220</li>
	<li>
		The Venetian, Tower Suite 30-140</li>
	<li>
		Sands, Hall G, Level 1 (NEW LOCATION)</li>
</ul>
<p>
	Member Packet</p>
<ul>
	<li>
		<p>
			Free LVCC member parking pass*</p>
	</li>
	<li>
		<p>
			Tickets to the VIP Networking Luncheon*</p>
	</li>
	<li>
		<p>
			Special recognition on badges, plaques and directory listings</p>
	</li>
</ul>
<p>
	<br />
	Exhibit Space Discount/Selection Priority and Other Exclusive Resources</p>
<ul>
	<li>
		<p>
			$100 discount on registration and an Exhibit Plus Pass until Nov. 30, 2014</p>
	</li>
	<li>
		<p>
			25 percent discount on conference passes</p>
	</li>
	<li>
		Exhibitor discounts on booth space* (To receive the CES membership discount, the exhibiting company must become a member with fully paid dues within 60 days of submitting the CES Application and Exhibit Space Contract or by July 1, 2014, whichever is the sooner of those two dates. Discount not available after July 1, 2014. International and startup members do not qualify for exhibit space discounts.</li>
</ul>
<ul>
	<li>
		Member priority for 2015 International CES space and on booth change waiting list*</li>
	<li>
		<p>
			Up to 60 percent discount on&nbsp;<a href="/Events-Awards/CES-Innovations-Awards.aspx">Innovation Design and Engineering Awards&nbsp;</a>entry fees</p>
	</li>
	<li>
		<p>
			&nbsp;20 percent discount on CES attendee postal list rentals*</p>
	</li>
	<li>
		<p>
			&nbsp;Free International CES press list*</p>
	</li>
	<li>
		<p>
			10 percent discount on BusinessWire U.S. news distribution circuits</p>
	</li>
</ul>
<p>
	*Exhibiting member companies only<br />
	<br />
	<br />
	CEA Member Cocktail Party<br />
	6&ndash;8 p.m. Tuesday, January 6, 2015<br />
	LVCC, South Hall 1 Lobby, Aces (formerly the International Food Market)<br />
	CEA Members and their guests are welcome.<br />
	&nbsp;<br />
	Visit&nbsp;<a href="http://www.ce.org/join" target="_blank">CE.org/join</a>,&nbsp;contact&nbsp;<a href="mailto:membership@CE.org">membership@CE.org</a> or call 703-907-7600 for questions about CEA membership.</p>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
    <script type="text/javascript"> 
      //<![CDATA[
