   ...
   <div class="page-area">
      ...
      <div class="col-sm-60 col-md-offset-2 col-md-46">
        <div class="body-content">
          <h1>Sports Tech</h1>
          <span style="font-family: archer-book; font-size: 36px; color: #8d9a93; margin-top: -10px; position: relative; top: -15px; left: 2px;">presented by SFIA<img alt="" src="/CES/media/2014/landing%20pages/show%20floor/marketplace_logos/SFIA.gif" style="float: right;" />
