...
<script type="text/javascript">
    ...
    function loadExternalScripts() {
        ...
        $.getScript('/cesweb/media/CESWeb/assets/js/ConferenceProgram/jquery-cookie.js', function () {
            //alert("Loaded helpers");
        });
        $.getScript('/cesweb/media/CESWeb/assets/js/ConferenceProgram/dateFormat.js', function () {
            //alert("loaded dateFormat");
        });
        $.getScript('/cesweb/media/CESWeb/assets/js/ConferenceProgram/datejs.js', function () {
            //alert("loaded datajs");
        });
        //$.getScript('/cesweb/media/CESWeb/assets/js/ConferenceProgram/tracks.js', function(){
        //alert("Loaded helpers");
        //});
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "GET",
            contentType: "application/json; charset=utf-8",
            url: "/cesweb/serviceCalls/ConferenceSessions/getSuperSessions.ashx",
            dataType: "json",
            async: false,
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<div>
    <span style="text-align: left; background-color: rgb(255, 255, 255); ">The conference program at CES is all about delivering maximum value, and the SuperSessions always prove it. While waiting for the 2013 announcements, <a href="/News/Multimedia-Gallery.aspx">take a look back at the fantastic 2012 line-up</a>!</span>
</div>&nbsp;</div>
</div>
</div>
