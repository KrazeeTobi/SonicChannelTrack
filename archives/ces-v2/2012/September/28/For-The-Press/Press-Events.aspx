...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
$(document).ready(function(){
   $('#print-link').click(function(e) {
      e.preventDefault();
      var w = window.open();
      var html = "<style>body { font: normal 12px/17px Arial, Helvetica, Sans-Serif; } h2 { font-size: 24px; font-weight: bold; margin: 20px 0px 10px 0px; } img { display: block; margin: 15px 5px; } .subslider { margin: 0px 0px 40px 0px; } .techzone > span { display: block; margin: 0px 0px 10px 0px; } </style>";
	...
	<tbody>
		<tr>
			<td style="width:155px;">
				<strong>12:15-1 p.m.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong></td>
			<td style="width:431px;">
				<strong>CEA Market Research Presentation</strong></td>
		</tr>
		<tr>
			<td style="width:155px;">
				<strong>1-2 p.m.</strong></td>
			<td style="width:431px;">
				<strong>2013 International CES Press Conference </strong></td>
		</tr>
		<tr>
			<td style="width:155px;">
				<strong>2-5 p.m.</strong></td>
			<td style="width:431px;">
				<strong>CES UnveiledSTOCKHOLM Networking Reception</strong></td>
		</tr>
	</tbody>
</table>
<br />
	...
	<tbody>
		<tr>
			...
			<td style="width:431px;">
				...
				2nd Floor- The Metropolitan Suite</td>
		</tr>
		<tr>
			<td style="width:155px;">
				<strong>4-5 p.m.</strong></td>
			<td style="width:431px;">
				<strong>2013 International CES Press Conference with Innovations Award Announcement</strong><br />
				2nd Floor - The Metropolitan Suite</td>
		</tr>
		<tr>
			<td style="width:155px;">
			...
			<td style="width:431px;">
				<strong>CES Unveiled NEW YORK Showcase and Networking Reception</strong><br />
