...
<head id="head"><title>
	2013 International CES, January 8 - 11 - 酒店预订
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/chinese/hotels.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='chinese'><a href='/For-International-Visitors/chinese.aspx'>汉语</a></li><li class='hotels end'><a href='/For-International-Visitors/chinese/hotels.aspx'>酒店预订</a></li></ul>
...
<div>
    为了协助您的旅行计划，CES经协商在几家优选的拉斯维加斯大饭店以折扣价格取得了房间。<br />
<br />
详细的饭店和价格表清单请参见<a href="/Hotel-Travel/Hotel-Reservations.aspx">www.CESweb.org/hote</a>l（英文）。若要利用CES价格，您必须访问<a href="/Hotel-Travel/Hotel-Reservations.aspx">www.CESweb.org/hotel</a>并选择饭店名称后，直接向该饭店订房间。选择饭店名称时，您会直接转到该饭店的预约网页，输入您的信用卡信息。由于大受欢迎，大部分的CES饭店房间现已售完，或者以CES优惠价格的提供的房间已售空。<br />
<br />
如果需要订20个以上的房间，您可以访问<a href="/Hotel-Travel/Hotel-Reservations.aspx">http://www.cesweb.org/hotelTravel/blockRequest.asp</a>，直接向您选择的饭店提交申请。您的申请将直接传送到该饭店，饭店将在3个营业日以内回应。<br />
<br />
清注意：我们没有CEA/CES住宿代办机构或办事处。任何声称是CES的官方住宿代办机构的住宿代办机构/办事处皆属不实。<br />
<br />
有任何问题吗？请电邮<a href="mailto:CEShotels@CE.org">CEShotels@CE.org</a>.
</div>&nbsp;</div>
</div>
</div>
