...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Servicios Internacionales
...
<a name="181"><span style="display: none">Área de Inscripción Internacional</span></a>
<div class="sub-content-header">Área de Inscripción Internacional</div>

<p><div>
	<em>LVCC, Central Plaza Main Registration (principal de registracion)<br />
	The Venetian, nivel 2</em><br />
	<br />
	Una área especial de registro para asistentes internacionales que se ubica en el área principal del LVCC, Central Plaza y The Venetian. En estas dos áreas, visitantes internacionales se pueden registrar en el sitio, conseguir un porta gafete (el cual es obligatorio para ingresar a la muestra) u obtener ayuda de idiomas de traductores multilingües disponibles para ayudar con las preguntas de inscripción</div>
<br />
</p>
<hr class="separator" /><a name="182"><span style="display: none">International Commerce Centers (ICC)</span></a>
<div class="sub-content-header">International Commerce Centers (ICC)</div>

<p>Los ICCs son los lugares para que los visitantes y expositores se mantengan en contacto con sus oficinas desde las estaciones de internet, reserve y utilice las salas de juntas privadas, disfrute los refrigerios o simplemente descanse.<br />
</p>
<hr class="separator" /><a name="183"><span style="display: none">Recepción Internacional</span></a>
<div class="sub-content-header">Recepción Internacional</div>

<p><p style="text-align: left; background-color: rgb(255, 255, 255); ">
	<em>LVCC (Centro de Convenciones de las Vegas), South Hall Connector (Pasaje a la Sala Sur), Salón S222</em></p>
<span style="text-align: left; background-color: rgb(255, 255, 255); ">Todos los participantes internacionales, los expositores y la prensa están invitados a la Recepción de la Exposición Internacional CES. Esta recepción es para visitantes internacionales únicamente. No se pierda esta oportunidad de conocer a personas nuevas, debatir sobre negocios con colegas o generar nuevos socios comerciales. Durante la recepción de este año, el Departamento de Comercio de EE.UU. patrocinará un programa de búsqueda de oportunidades para empresas estadounidenses que desean comerciar con empresas en el extranjero. &iexcl;Esperamos verlo allí!</span></p>
<hr class="separator" /><a name="184"><span style="display: none">Intérpretes</span></a>
<div class="sub-content-header">Intérpretes</div>

<p>Un equipo multilingüe está disponible en los centros de comercio internacionales y en las áreas de inscripción tanto en LVCC Central Plaza y en The Venetian. Habrá intérpretes disponibles para ayudarle en varios idiomas, incluyendo español, francés, chino, japonés y coreano. En las áreas de registro internacional, busque el mostrador llamado&nbsp; &ldquo;Interpretation Services&rdquo; (servicios de interpretación) si requiere ayuda. &iquest;Necesita contratar un intérprete para una junta? &nbsp;A continuación dos proveedores de dicho servicio:<br />
<ul>
	<li>
...
<hr class="separator" /><a name="185"><span style="display: none">Programa de compradores internacionales</span></a>
<div class="sub-content-header">Programa de compradores internacionales</div>

<p><span style="text-align: left; background-color: rgb(255, 255, 255); ">International CES es un participante orgulloso del Programa de compradores internacionales, patrocinado por la Administración Comercial Internacional del Departamento de Comercio de EE. UU. Los especialistas comerciales internacionales del Departamento de Comercio de EE. UU. están disponibles en el ICC principal (LVCC, Conector South Hall, Salas S224/225), a fin de proporcionar asistencia de enlace empresarial y asesoramiento comercial de exportación a los asistentes y expositores internacionales.</span></p>
