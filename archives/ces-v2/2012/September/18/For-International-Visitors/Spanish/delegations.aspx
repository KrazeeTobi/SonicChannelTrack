...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Programa de grupos de delegaciones
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/Spanish/delegations.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='spanish'><a href='/For-International-Visitors/Spanish.aspx'>Español</a></li><li class='delegations end'><a href='/For-International-Visitors/Spanish/delegations.aspx'>Programa de grupos ...</a></li></ul>
...
<div id="inner-content-long">
    ...
    <div id="inner-content-left">
        &iquest;Te interesa traer a un grupo de profesionales de la industria al CES internacional? CEA tiene un programa formal delegacional establecido que proporciona muchos beneficios para los líderes de delegación y sus miembros de la delegación. Como líder de la delegación usted ayudará a sus clientes a maximizar el valor de su viaje a CES ayudándoles a planear qué ver y con quién reunirse en la muestra.<br />
<br />
La inscripción gratis es uno de los beneficios que aparecen en la lista de beneficios para participantes del programa delegacional. Si se une a una delegación y se registra en CES después del 31 de agosto, la cuota de registro por adelantado de $100 no tendrá que darla.<br />
<br />
...
--><script type="text/javascript" src="http://admin.brightcove.com/js/BrightcoveExperiences.js"></script><object class="BrightcoveExperience" id="myExperience1834350801001"><param name="bgcolor" value="#FFFFFF" /><param name="width" value="486" /><param name="height" value="412" /><param name="playerID" value="26356940001" /><param name="playerKey" value="AQ~~,AAAABh3C_dE~,zBkXqCU8KVYYG5utII4f8nND4rqBAlFX" /><param name="isVid" value="true" /><param name="dynamicStreaming" value="true" /><param name="@videoPlayer" value="1834350801001" /></object><!-- 
...
<br />
<strong>Detalles del programa </strong><br />
<ul>
	<li>
		El programa de la delegación es exclusivamente para asistentes que están fuera de los Estados Unidos.<br />
		&nbsp;</li>
	<li>
		Las delegaciones deben de consistir de profesionales del negocio dentro de la industria de consumidores electrónicos.<br />
		&nbsp;</li>
	<li>
		Las delegaciones deben tener un mínimo de 15 miembros. Grupos más pequeños de 15 asistentes se deberán registrar como asistentes en forma individual.</li>
</ul>
<strong>Beneficios para los líderes de delegaciones</strong><br />
<ul>
	<li>
		Estancia gratis en el hotel para líderes delegacionales que traigan 50 personas a CES (15 para grupos de gobierno). Los grupos deben estar confirmados con cuatro (4) semanas de anticipación al CES o no se puede garantizar la habitación.<br />
		&nbsp;</li>
	<li>
		Boletín electrónico con la más reciente información sobre el programa de delegación y CES, i ncluyendo fechas importantes y fechas límites para recibir los beneficios del programa.<br />
		&nbsp;</li>
	<li>
		Folletos de promoción y plantillas electrónicas para ayudarle en sus esfuerzos de reclutamiento.<br />
		&nbsp;</li>
	<li>
		El logo del CES para agregar a material promocional (el material de mercadotecnia debe ser previamente aprobado por CES).<br />
		&nbsp;</li>
	<li>
		Exhibiciones gratuitas más el pase (le proporciona acceso al piso de exhibición, a nuestros &nbsp; discursos de apertura, a la Súper-Sesión, y selectas sesiones de conferencias.)<br />
		&nbsp;</li>
	<li>
		Capacidad en línea para registrar miembros de la delegación, hacer cambios o agregar nuevos miembros.<br />
		&nbsp;</li>
	<li>
		Invitación a la cena de agradecimiento a Líderes de delegación CES que se lleva a cabo durante CES.<br />
		&nbsp;</li>
	<li>
		&nbsp;Acceso al Centro Internacional de Comercio (ICC), disponible exclusivamente para asistentes y expositores extranjeros. Obsequios de cortesía incluyen estaciones gratis de internet, refrigerios, acceso a traductores, y salas de juntas privadas.<br />
		&nbsp;</li>
	<li>
		Invitación a la recepción de establecimiento global de contactos y recepción internacional donde puede disfrutar comida y bebida de cortesía mientras conoce y hace contactos con otros asistentes &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; internacionales.</li>
</ul>
Por favor tome nota: <a href="/Register.aspx">Registrarse</a> como líder de delegación no lo registra en la muestra. Debe completar el proceso formal de registro al CES Internacional para estar registrado y recibir sus credenciales.<br />
<br />
<strong>Beneficios para los miembros de delegaciones</strong>
<ul>
	<li>
		Exhibiciones de cortesía más el pase (le permite acceso al piso de exhibiciones, a nuestros discursos de apertura, a la Súper-Sesión, y selectas sesiones de conferencias.)<br />
		&nbsp;</li>
	<li>
		Acceso a especialistas internacionales de comercio del departamento de comercio de los Estados Unidos, quienes proporcionan asistencia para hacer contactos y orientación para el comercio de exportación a asistentes y expositores internacionales.<br />
		&nbsp;</li>
	<li>
		Invitación a la recepción internacional y para hacer contactos global de CES.<br />
		&nbsp;</li>
	<li>
		Lista de expositores quienes exportan o indican interés en exportar al país y / o región del mundo de donde es el grupo.<br />
		&nbsp;</li>
	<li>
		Acceso al Centro Internacional de Comercio (ICC), disponible exclusivamente para asistentes y expositores extranjeros. Obsequios de cortesía incluyen estaciones gratis de internet, refrigerios, acceso a traductores, y salas de juntas privadas.<br />
		&nbsp;</li>
	<li>
		Oportunidad de viajar con otros profesionales de la industria de consumidores de electrónica de su país.<br />
		&nbsp;</li>
	<li>
		Invitación a la recepción de establecimiento global de contactos y recepción internacional donde puede disfrutar comida y bebida de cortesía mientras conoce y hace contactos con otros asistentes &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; internacionales.</li>
</ul>
<strong>Programa de comprador internacional del departamento de comercio de Estados Unidos</strong><br />
<br />
...
<br />
Los especialistas industriales y comerciales de servicio ubicados en su embajada o consulado le pueden ayudar con su registro a la muestra, ayudarle a localizar los productos que busca comprar en la muestra, y asistirle en establecer juntas con usted y negocios de los EE. UU. Como parte del IBP, muchos especialistas comerciales extranjeros guían delegaciones al CES.<br />
<a href="http://www.export.gov/eac/index.asp" target="_blank">Ubique la oficina del Servicio Comercial en su país.</a><br />
<br />
Para preguntas o dudas en cuanto al programa de delegaciones CES, favor de contactar <a href="mailto:delegations@ce.org?subject=Delegation%20Program">delegations@CE.org</a>.<br />
<br />
...
<li><a href="/For-International-Visitors/Espanol"></a></li>
	...
	<li>
		<a href="/cesweb/media/CESWeb/Documents/International/CES_General_Overview_Brochure_Spanish.pdf" target="_blank">Folleto del Resumen General en idioma inglés (PDF)</a></li>
	<li>
		<a href="/cesweb/media/CESWeb/Documents/International/CES_FactSheet_Spanish.pdf" target="_blank">Traducción de la Hoja Informativa de la Exposición International CES (PDF)</a></li>
	<li>
		<a href="/cesweb/media/CESWeb/Documents/International/CES_Multilanguage_Delegation_Brochure.pdf" target="_blank">Folleto multilingüe para delegaciones</a></li>
	<li>
		<a href="/cesweb/media/CESWeb/Documents/International/CES_Delegation_Program_Benefits.pdf" target="_blank">Beneficios para líderes de delegación y delegados (PDF en inglés)</a></li>
	<li>
		<a href="http://bcove.me/ix8fopyx" target="_blank">De información de vídeo CES para mostrar los potenciales delegados </a></li>
</ul>
</div>
    </div>
