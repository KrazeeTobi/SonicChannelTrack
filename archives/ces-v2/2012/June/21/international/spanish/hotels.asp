...
<head><!-- PageID 5377 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Reservas de Hotel</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/spanish/hotels.asp">Reservas de Hotel</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/spanish.asp" class="footer">Español</a>&nbsp;&gt;&nbsp;Reservas de Hotel</div>
                        </div>
                         <div class="headerbox">
        ...
        <img alt="" style="margin: 5px; float: right;"  src="/images/photos/Vegas_200.jpg" />Para ayudarle a hacer sus planes de viaje, CES ha negociado tarifas de hotel con descuento en ciertos hoteles de Las Vegas. <br />
        <br />
        Visite <a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a> (disponible en inglés) para ver la lista completa de hoteles y tarifas. Para obtener la tarifa de CES, se deben hacer todas las reservaciones de habitación directamente en el hotel. Visite <a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a> y seleccione el nombre de un hotel. Se conectará directamente con la página de reservaciones de ese hotel, donde podrá ingresar la información de su tarjeta de crédito.
        <p>Debido a su gran popularidad, la mayor parte de los hoteles CES tienen cupo lleno o han vendido por completo las tarifas de descuento CES. Para apoyar las reservaciones de última hora, CES ha incorporado una lista de hoteles de reserva. No existe servicio de transporte del CES hacia/desde estos hoteles. Puede ver la lista completa en la parte inferior de <a href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a> (en inglés).<br />
        <br />
        Si necesita 20 habitaciones o más, puede solicitarlas directamente de su hotel preferido visitando <a  href="http://www.cesweb.org/hotelTravel/blockRequest.asp">http://www.cesweb.org/hotelTravel/blockRequest.asp</a>. Su solicitud se transmitirá directamente al hotel y el hotel tendrá un plazo de tres días hábiles para responder.<br />
        <br />
        ...
        <br />
        ¿Tiene alguna pregunta? Sírvase enviar un mensaje electrónico a <a  href="mailto:CEShotels@CE.org">CEShotels@CE.org</a>.</p>
