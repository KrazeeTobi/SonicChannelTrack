...
<div class="alert-box">                        
        ...
        <p>NEW! <a  target="_blank" href="/docs/2012_CES_Audit.pdf">Independent audit of 2012 CES (pdf) now available.</a></p>
   ...
   <h2>Exhibit at CES</h2>
    ...
    <p>
        ...
        <ul class="text">
            <li class="text">Reach 6,000 media and analysts </li>
            <li class="text">Network among 150,000+ CE professionals </li>
   ...
   <h2>Exhibitor's Source</h2>
    ...
    <p>
        <a  href="http://www.cesweb.org/exhibitors/newsletter/default.asp">Monthly</a>:
        <ul class="text">
