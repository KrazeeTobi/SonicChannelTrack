...
<head><!-- PageID 364 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Exhibit at CES</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/exhibitors/default.asp-->
            ...
            <li class="selected"><a href="/exhibitors/space/default.asp">Exhibit at CES</a></li>
        
            <li ><a href="/exhibitors/space/ExhibitatTheVenetian.htm">Exhibit at The Venetian</a></li>
        
            <li ><a href="/exhibitors/space/contactRep.asp">Contact a Sales Rep</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;Exhibit at CES</div>
                        </div>
                         <div class="headerbox">
...
Exceptional quality. Record-breaking numbers. By every measure — attendee quality, media attention, markets represented and special events — CES is incomparable. It’s all in the numbers – take a look at our independently verified <A href="/docs/8408_FINAL2011AuditSummary_wTWICE_Web.pdf" target=_blank>Attendee Audit Summary</A>for details on our audience profile.<BR><BR>We have options available for whatever your marketing strategy may dictate.&nbsp;If you want to demonstrate your technologies to all domestic and international attendees, then Open Booth Space may be your best bet.&nbsp;Or maybe you want to meet and entertain your existing clients in a more private setting, then Meeting Place or Suites may be optimal. If you have a new product or service that you’d like to feature in one of our “technology incubators”, then our TechZones could provide you tremendous value!<BR><BR>Review the options below, and <A href="/exhibitors/space/contactRep.asp">contact a CES business development representative today</A> to learn about securing your presence at the show.<BR><BR>



<div class="blue_box" id="5257">
    <ul>
        
        
        <li><a class="sub-page-slider-link" href="#5258">Open Booth Space</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5259">TechZones</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5260">Outdoor Exhibit Space</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5261">CES Meeting Place</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5263">Ballroom Space</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5264">Suites</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5265">Meeting Rooms</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5266">Business Development Contacts</a></li>
...
<script type="text/javascript">
    var SecondItems = $("#5257 ul:first li:nth-child(3n+2)");
    var ThirdItems = $("#5257 ul:first li:nth-child(3n)");

    $("#5257 ul:eq(1)").append(SecondItems);
    $("#5257 ul:eq(2)").append(ThirdItems);
    $("#5257 ul:eq(2)").append($("#5257 .sub-page-slider-link-show-all").parent());

    $(document).ready(function() {
        $("#5257 .sub-page-slider-link-show-all").click();
    });
</script>
...
<div class="sub-page-slider">
    <div class="sub-page-slider-nav">
        ...
        <div class="sub-page-slider-top-header">Exhibit at CES</div>
        <div class="sub-page-slider-bottom-header"></div>
        <div class="push"></div>    
    </div>
    <div>
        <div class="sub-slide" id="5258">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Open Booth Space</h2>
    </div>
    <IMG align=right src="/images/photos/p43.jpg" width=165 height=125>The International CES makes it easy for attendees to meet the right exhibitors.&nbsp;Traditional exhibit space is available in all halls of the Las Vegas Convention Center. Minimize your expense and keep things easy with turnkey (finished) booth packages, or create your own. <BR><BR>Generally, International CES venues are divided into market categories, promising that no company is overlooked. <BR><BR><B>Las Vegas Convention Center (LVCC)/The Venetian</B><BR><BR>
<TABLE border=0 cellSpacing=0 cellPadding=3 width="90%">
<TBODY>
<TR>
<TD vAlign=top>
<P>Audio/video<BR>Audio accessories <BR>Audio components <BR>Blank media <BR>Breakthrough technologies <BR>Car audio/video <BR>Gaming/entertainment products and solutions <BR>Home information and wireless<BR>Home theater/home systems, satellite<BR>Home information <BR>Home systems <BR>Home theater <BR>In-vehicle technology<BR>In-vehicle information systems <BR>Information technology </P></TD>
<TD vAlign=top>Photographic equipment <BR>Portable audio <BR>Satellite systems <BR>Speakers<BR>Telephony <BR>The International Gateway (international exhibits)<BR>Vehicle navigation <BR>Vehicle security&nbsp;<BR>Video hardware&nbsp;<BR>Wireless accessories <BR>Wireless communications<BR><BR></TD></TR></TBODY></TABLE><BR>Reserve your space now. <A href="mailto:exhibit@cesweb.org?subject=I'm%20interested%20in%20booth%20CES%20space">Send us an e-mail</A> to get started, or call 703-907-7645. 
    <br />
    <br />
</div><div class="sub-slide" id="5259">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">TechZones</h2>
    </div>
    <IMG align=right src="/images/photos/TechHome_TechZone.jpg" width=165 height=125>Consider exhibiting in one of more than a dozen CES TechZones, themed areas featuring hot products, technologies and solutions such green technologies, iPhone, iPod and Mac-specific products, 3D displays, electric vehicles, and tablets/eBooks. Select from turnkey (furnished) packages, or use your existing booth property. Plus, enjoy all the benefits received by traditional booth space exhibitors.<BR><BR>Check out all of our <A href="/showFloor/techzones.asp">2012 CES TechZones</A>. <BR><BR><A href="mailto:exhibit@cesweb.org?subject=I'm%20interested%20in%20a%20TechZone">Send us an e-mail</A> to get started, or call 703-907-7645.
    <br />
    <br />
</div><div class="sub-slide" id="5260">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Outdoor Exhibit Space</h2>
    </div>
    <UL class=text>
<LI class=text><IMG align=right src="/images/photos/Outdoor_01.jpg" width=165 height=125>Compliment existing space or create a unique main space directly in front of the Las Vegas Convention Center </LI>
<LI class=text>Can include canopied, tented or domed exhibit structures </LI>
<LI class=text>Ideal for mobile and experiential marketing vehicles and trailers </LI>
<LI class=text>All the benefits&nbsp;received by&nbsp;indoor booth space exhibitors</LI></UL>Explore your CES exhibit options. <A href="mailto:exhibit@cesweb.org?subject=I'm%20interested%20in%20outdoor%20CES%20space">Send us an e-mail</A> to get started.
    <br />
    <br />
</div><div class="sub-slide" id="5261">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">CES Meeting Place</h2>
    </div>
    <IMG style="MARGIN-LEFT: 8px" hspace=8 align=right src="/images/photos/MeetingRooms.jpg" width=165 height=125>These&nbsp;modular meeting rooms built <STRONG>right on the show floor</STRONG> let you conduct meetings without the usual distractions of the traditional exhibit space buzz or set up a controlled product display area on the show floor. If you're an existing exhibitor who needs more space, or a newcomer who wants to be a part of the International CES success story, the CES Meeting Place can work for you. You can: 
<UL class=text>
...
<LI class=text>Stay close to the show floor action!</LI></UL>Reserve space in the CES&nbsp;Meeting Place&nbsp;now. <A href="mailto:exhibit@cesweb.org?subject=I'm%20interested%20in%20a%20CES%20Meeting%20Place">Send us an e-mail</A> to get started, or call 703-907-7645. <BR><BR><STRONG>The CES Meeting Place package includes:</STRONG>
<UL>
<LI>10' high perimeter walls </LI>
<LI>Locking door </LI>
<LI>Carpet in your suite </LI>
<LI>Standard furniture </LI>
<LI>Discounts on specialty furniture </LI>
<LI>A sign to denote your suite </LI>
<LI>Countless configurations</LI></UL>
    <br />
    <br />
</div><div class="sub-slide" id="5263">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Ballroom Space</h2>
    </div>
    <UL class=text>
<LI class=text><IMG align=right src="/images/photos/Ballroom_01.jpg" width=165 height=125>Ballrooms available at the upscale Venetian Hotel </LI>
<LI class=text>Allows companies to hold private, exclusive meetings and events </LI>
<LI class=text>Still part of the official CES campus, but is separate from the show floor </LI>
<LI class=text>Enables companies to host clients and prospects, creating your own unique showroom or lounge </LI></UL>
Explore your CES exhibit options. <A href="mailto:exhibit@cesweb.org?subject=I'm%20interested%20in%20a%20CES%20ballroom">Send us an e-mail</A> to get started.
    <br />
    <br />
</div><div class="sub-slide" id="5264">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Suites</h2>
    </div>
    
        <ul class="text">
            <li class="text"><img alt="" height="125" width="165" style="float: right;"  src="/images/photos/Suite.jpg" />At the Hilton, The Venetian, Renaissance and Wynn/Encore hotels </li>
            <li class="text">Close proximity to&nbsp;many parts of the show floor; pick suite space closest to your product category for maximum convenience </li>
            <li class="text">Great compliment to any booth space </li>
            <li class="text">Great for ancillary meetings off the show floor </li>
            <li class="text">All the benefits received by traditional booth space exhibitors with the same affordability as non-CES suite space</li>
        </ul>
        <strong>
        <br />
        Pricing</strong>:<br />
        Prices vary based on suite type and location. For more information regarding suite configurations and options.<br />
        <br />
        Suite Options:
        <ul>
            <li><a  href="/docs/2012_Venetian_Hospitality_Flyer.pdf" target="_blank">Venetian Hospitality</a></li>
            <li><a  href="/docs/Venetian_Exhibit_Suites_Flyer_(Floor_31).pdf" target="_blank">Venetian Exhibit</a></li>
            <li><a  href="/docs/Hilton_Flyer_2012.pdf" target="_blank">Hilton</a></li>
            <li><a  href="/docs/2012_CES_WynnEncore_Brochure.pdf" target="_blank">Wynn/Encore</a></li>
            <li><a  href="/docs/CES-2012-Venetian-Suites-Renaissance.pdf" target="_blank">Renaissance</a> (SOLD OUT)</li>
        </ul>
        <p>Explore your CES exhibit options. <a mailto:exhibit@cesweb.org?subject="I&quot;m%20interested%20in%20a%20CES%20suite&quot;" href="mailto:exhibit@cesweb.org?subject=I' reddotinternalurl=">Send us an e-mail</a> to get started.</p>
    
    <br />
    <br />
</div><div class="sub-slide" id="5265">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Meeting Rooms</h2>
    </div>
    <UL>
<LI>These are permanent meeting rooms that are part of the Las Vegas Convention Center structure. Various sizes are available to suit your needs. </LI>
<LI>These private spaces allow you to create an environment most conducive to your meetings or demonstrations, and allow you to control traffic flow and access as you see fit.</LI>
<LI>Receive all the benefits received by traditional booth space exhibitors</LI></UL>
<P>Explore your CES exhibit options. <A href="mailto:exhibit@cesweb.org?subject=I'm%20interested%20in%20a%20CES%20meeting%20room">Send us an e-mail</A> to get started.</P>
    <br />
    <br />
</div><div class="sub-slide" id="5266">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Business Development Contacts</h2>
    </div>
    Let us help you select the most ideal exhibit space for your company at the world's leading consumer technology event. <A href="/exhibitors/space/contactRep.asp">Fill out our online form to indicate your space needs.</A><BR><BR>To speak directly with an International CES Sales representative, please call 703-907-7645.
    <br />
    <br />
</div>
    </div>
...
<!--/exhibitors/space/ExhibitinEurekaPark.htm-->
