...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <p>Conference sessions included in the back-up submission form for the 2013&nbsp;International CES Call for Speakers are:</p>
        ...
        <p>For more information, please consult the <a  href="/conferenceProgram/speakers/cfsFAQ.asp">Call for Speakers FAQ</a>.</p>
