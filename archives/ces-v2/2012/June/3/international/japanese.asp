...
<head><!-- PageID 1168 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/japanese.asp">日本語</a>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;日本語</div>
                        </div>
                         <div class="headerbox">
                            <h1>日本語</h1>
                        </div><br />
        ...
        <h3>業界最高峰の頭脳が集まる</h3>
        <p>毎年、最先端の技術革新が一堂に会します。世界最大の消費者向け技術展示会のために、私達にラスベガス、ネバダ州、米国で1月8月11日（火〜金曜日）、2013年、参加してください。登録は7月にオープンします。</p>
...
<div class="sub-content-header">国際ビジターインフォメーション</div>
<br />


        <p><a  href="http://cesweb.org/international/japanese/travel.asp">旅行とビザ情報</a><br />
        米国の出入国の際に役立つ情報です。<br />
        <br />
        <a  href="/international/japanese/hotels.asp">ホテル予約<br />
        </a>皆様の旅行プランをお手伝いするため、CESではラスベガス選りすぐりのホテルと交渉し、割引料金を提供しています。 <br />
        <br />
        <a  href="/international/japanese/delegations.asp">表団プログラム</a><br />
        ご好評をいただいている代表団プログラムにより、国際CESでは国外からも多数の参加者が集まります。あなたの国や地域で代表団を組織する方法、代表団に参加する方法についてはこちらをご覧ください。</p>
        <p><a  href="/international/japanese/services.asp">国際サービス</a><br />
        外国からの参加者の方へは、通訳者、特別なネットワーク作りのためのレセプション、専用の作業エリア、会議室など、その他多数のサービスをご用意しています。<br />
        <br />
        <a  target="_blank" href="/docs/HI_RES_JPN_2K12_CESfactSheet_Web.pdf">一般情報<br />
        </a>展示会の沿革、現在の製品カテゴリ、今後の予定など、各国語で紹介します！ <br />
        <br />
        <a  href="/international/japanese/shuttles.asp">シャトルサービス<br />
        </a>インターナショナルCESでは、4日間の開催期間中、無料シャトルサービスが提供されます。</p>
        <p><a  target="_blank" href="/images/content/ADVANCE_DOMESTIC_REGISTRATION-final-JP.pdf">参加者登録フォーム</a><br />
        登録にヘルプが必要な場合は、<a  target="_blank" href="/docs/ADVANCE_DOMESTIC_REGISTRATION-final-JP.pdf">日本語版の参加者登録フォームのコピーをダウンロードしてください</a>。各国語版の登録フォームも有効ではありますが、<a  href="http://cesweb.org/register">正確なデータ処理を期すために、なるべくオンラインでご登録いただけますようお願い致します</a>。</p>
        <p>&nbsp;</p>
        <p> </p>
        <p> </p>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        15名以上の海外参加者からなる代表団には、「展示プラス」登録が優遇されるのをご存知ですか？ <A href="/international/japanese/delegations.asp">詳しくはこちら.</A> 
        <br /><br />
    </div>
</div>
<div class="right-blue-box" align="center">
