...
<head><!-- PageID 499 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Delegation Group Program</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;Delegation Group Program</div>
                        </div>
                         <div class="headerbox">
        ...
        Are you interested in bringing a group from your country to the International CES? As a delegation leader, you will help your clients maximize the value of their trip to the International CES by helping them plan what to see and who to meet at the show, while arranging the logistics of travel. CEA has a formal delegation program in place that provides benefits for both delegation leaders and members.<br />
        <br />
        Free show registration is among the list of  benefits for delegation program participants. If you join a delegation and <a  href="/register">register for CES</a> after August 30, the $100 registration fee will be waived.<br />
        <br />
        Please note: Registering as a delegation leader does not register you for the show. You must <a  href="/register">complete the formal International CES registration process</a> to register and receive your credentials. <br />
        <br />
        ...
        <object id="myExperience1128810977001" class="BrightcoveExperience">
        <param name="bgcolor" value="#FFFFFF" />
        <param name="width" value="460" />
        <param name="height" value="390" />
        <param name="playerID" value="26356940001" />
        <param name="playerKey" value="AQ~~,AAAABh3C_dE~,zBkXqCU8KVYYG5utII4f8nND4rqBAlFX" />
        <param name="isVid" value="true" />
        <param name="dynamicStreaming" value="true" />
        <param name="@videoPlayer" value="1128810977001" /> </object><!--  This script tag will cause the Brightcove Players defined above it to be created as soon as the line is read by the browser. If you wish to have the player instantiated only after the rest of the HTML is processed and the page load is complete, remove the line. -->
        ...
        <ul class="text">
            ...
            <li class="text">Delegations must have a minimum of 15 members. Groups smaller than fifteen must register individually as attendees. </li>
        </ul>
        ...
        <ul class="text">
            ...
            <li class="text">Invitation to CES Delegation Leader Dinner. </li>
        </ul>
        ...
        <ul class="text">
            ...
            <li class="text">Access to International Trade Specialists from the U.S. Department of Commerce who provide matchmaking assistance and export trade counseling to international attendees and exhibitors. </li>
        </ul>
        <h3>U.S. Department of Commerce International Buyer Program</h3>
        <img width="155" height="158" alt="" style="float: right; margin-left: 8px; margin-right: 8px;"  src="/images/content/doc_logo(1).JPG" />The International CES is a proud participant of the U.S. Department of Commerce’s International Buyer Program (IBP). Through the U.S. Commercial Service’s network of offices in U.S. Embassies and Consulates worldwide, the IBP recruits pre-screened foreign buyer delegations and brings them to selected tradeshows in the United States, connecting U.S. companies with international buyers.   Commercial service trade specialists located in your local embassy or consulate can assist you with show registration, help you locate the products you are looking to purchase at the show and assist in setting up meetings with you and U.S. businesses. The International CES proudly participates in the International Buyer Program (IBP), sponsored by the Commercial Service of the U.S. Department of Commerce. As part of the IBP, many foreign commercial specialists lead delegations to CES. <a  target="_blank" href="http://www.export.gov/eac/index.asp">Locate the Commercial Service office in your country.<br />
        </a>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        ...
        <ul>
            <li><a  target="_blank" href="/docs/2012_General_Overview_Brochure.pdf">General Overview English Language Brochure (pdf) </a></li>
            <li><a  target="_blank" href="/docs/2012_CES_Fact_Sheet_FINAL_5.9.2011.pdf">CES Fact Sheet (pdf) </a></li>
            <li><a  target="_blank" href="/docs/DP_Brochure_Web.pdf">Multi-language Delegation Brochure</a></li>
            <li><a  target="_blank" href="/docs/2012_Program_Description_FNL.pdf">Benefits for Delegation Leaders and Delegates (pdf in English)</a> </li>
            <li><a  target="_blank" href="http://content.ce.org/2k12CESI/2k12CES_DEL_02_1Mb.mov.zip">Informational CES video to show potential delegates (.mov)</a> </li>
        </ul>
