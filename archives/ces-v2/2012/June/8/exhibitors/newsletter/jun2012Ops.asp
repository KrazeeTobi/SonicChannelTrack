...
<head><!-- PageID 6392 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: June 2012 Operations</title>
...
function innovationActive (id) {      
    ...
    <script language="javascript" src="/flashDetect.js" type="text/javascript"></script>
    <script language="javascript" src="/emailPage.js" type="text/javascript"></script>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/jun2012.asp" class="footer">June 2012</a>&nbsp;&gt;&nbsp;June 2012 Operations</div>
                        </div>
                        <div class="headerbox">
                            <h1>June 2012 Operations</h1>
...
<div align="center">
    ...
    [ <a href="/exhibitors/newsletter/jun2012.asp">News</a> ]
...
<div class="sub-content-header">Budgeting for the 2013 Show</div>
<br />


        The 2013 International CES will have some changes that we want to make sure you are aware of as you begin to plan and budget for next year.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Show Date Pattern</div>
<br />


        The 2013 International CES will take place Tuesday, January 8 through Friday, January 11, 2013. This weekday show pattern is the same pattern as last year, with some move-in and move-out days falling over the weekend. To assist with your budget planning, GES will once again offer blended rates for material handling and electrical labor.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">GES Rates</div>
<br />


        GES rates will increase next year by up to three percent for all general services including furniture, carpet, rigging, graphics and electrical services.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Material Handling (Drayage)</div>
<br />


        GES will offer a blended material handling rate, so whether your target date falls on a weekday or weekend, you will pay the same flat rate.<br />
        <br />
        <strong>LVCC/LVH Rates: <br />
        </strong>
        <table>
            <tbody>
                <tr>
                    <td>Advance shipment, crated:  </td>
                    <td>$56.09 per 100 lbs (cwt), 300 lbs minimum </td>
                </tr>
                <tr>
                    <td>Direct shipment, crated:</td>
                    <td>$41.07 per 100 lbs (cwt), 300 lbs minimum </td>
                </tr>
                <tr>
                    <td>Direct shipment, uncrated:</td>
                    <td>$50.28 per 100 lbs (cwt), 300 lbs minimum</td>
                </tr>
            </tbody>
        </table>
        <p><strong>Venetian Exhibit Space (Hall D, Venetian Ballroom, Venetian Meeting Rooms):</strong></p>
        <table>
            <tbody>
                <tr>
                    <td>Advance freight to warehouse:  </td>
                    <td>$41.07 per 100 lbs, ($123.21, 300 lbs minimum) </td>
                </tr>
                <tr>
                    <td>Direct freight to show site:</td>
                    <td>$69.53 per 100 lbs, ($208.59, 300 lbs minimum)</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
        ...
        <p><strong>Venetian Exhibit Suites:<br />
        </strong>
        <table>
            <tbody>
                <tr>
                    <td>Advance freight to warehouse: </td>
                    <td>$56.41per 100 lbs, ($169.23, 300 lbs minimum)</td>
                </tr>
                <tr>
                    <td>Direct freight to show site:</td>
                    <td>$77.54 per 100 lbs, ($232.62, 300 lbs minimum) </td>
                </tr>
                <tr>
                    <td>Back to warehouse fee:</td>
                    <td>$17.74 per 100 lbs, ($53.22, 300 lbs minimum)</td>
                </tr>
            </tbody>
        </table>
        </p>
...
<div class="sub-content-header">Target Freight Floor Plans</div>
<br />


        <a  href="http://www.cesweb.org/exhibitors/showPlanning/lvcc-show-planning.asp#5027">Target freight floor Plans</a> are now available. CES has a targeted freight plan for both move-in and move-out, meaning you are assigned a specific date for both. Exhibitor freight must arrive on your specific target move-in date in order to avoid off target charges. Please be sure you know your target date as you start to plan for CES. Target plans are updated every two weeks as our floor plans change. If you have any questions or need to request a target change, e-mail <a  href="mailto:CESfreight@ges.com">CESfreight@ges.com</a>.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Book Your Blocks of 20 or More Hotel Rooms Now! </div>
<br />


        It’s time to book your Las Vegas hotels for the 2013 International CES. <a  href="http://www.cesweb.org/hotelTravel/blockRequest.asp">Request your room block now</a> to ensure your entire booth staff is able to stay at the same property. Using our online request form, you can request room blocks of 20 rooms* or more. If you are booking 20 rooms or less, the CES hotels won’t begin accepting reservations for individuals until later this month. Don’t worry: We’ll send you an alert when they’re ready to go. <br />
        <br />
        <em>*Select hotels are accepting requests of 10 or more rooms, as noted on the group block request form.<br />
        <br />
        </em><strong>Money-Saving Tip: </strong>CES offers complimentary shuttle service to the LVCC from all official CES hotels. Book with one of these hotels to avoid cab fare and ride our shuttles instead. CES also makes it easy for you to get to the Venetian with the Venetian Express running to/from the LVCC.<br />
        <br />
        We continue to work with Las Vegas properties to provide you with additional hotel options at fair rates. As hotels are confirmed, the list will be updated. Should you have any questions, please contact <a href="mailto:CEShotels@CE.org">CEShotels@CE.org</a>.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Get your Monorail Unlimited Day Passes now for only $9.00! </div>
<br />


        <img alt="" style="float: right;"  src="/images/content/monorail_logo.gif" />This hot summer deal won’t last long. Act now to save $3.00 off the regular price of a Unlimited Day Pass. Why buy now? Because tickets are good up to one year from date of purchase. Don’t delay! <a  target="_blank" href="https://tickets.lvmonorail.com/ces2013/">Get your tickets now</a> to get in on the action before this deal expires on June 30. <br />
        <br />
        Reminder: the Monorail does not service the Venetian.
