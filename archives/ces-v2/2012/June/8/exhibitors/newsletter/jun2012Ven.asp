...
<head><!-- PageID 6399 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: June 2012 Venetian</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/jun2012.asp" class="footer">June 2012</a>&nbsp;&gt;&nbsp;June 2012 Venetian</div>
                        </div>
                        <div class="headerbox">
                            <h1>June 2012 Venetian</h1>
...
<div class="sub-content-header">It's that time</div>
<br />

<P>"It's that time again! Time to begin planning for your CES exhibit at The Venetian. It's our goal to make sure you are prepared, as well. Check out the information below to assist you."</P><br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
<br />
...
<br />
        ...
        The 2013 GES material handling rates are as follows:<br />
        <br />
        ...
        <table>
            <tbody>
                <tr>
                    <td>Advance freight to warehouse: </td>
                    <td>$56.41 per 100 lbs ($169.23, 300 lbs minimum) </td>
                </tr>
                <tr>
                    <td>Direct freight to show site:</td>
        ...
        <br />
        Please note: The advance warehouse rate is less expensive than the direct rate for Venetian exhibitors. Be sure to take advantage of this benefit!
        <p>All rates will be listed in your <a  href="http://www.cesweb.org/exhibitors/showPlanning/venetian-show-planning.asp#4232">2013 Venetian Exhibitor Manual</a>, available in September. There will be three separate manuals for exhibitors in Venetian exhibit/meeting space, exhibit suites and hospitality suites.</p>
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Move-in Schedule </div>
<br />


        • Hall D exhibitors: Friday, January 4; please reference your target freight floor plan to determine your targeted move-in time <br />
        <br />
        • Venetian Ballroom exhibitors: Sunday, January 6; please reference your target freight floor plan to determine your targeted move-in time <br />
        <br />
        ...
        <br />
        If you have questions, please contact <a  href="mailto:gberube@CE.org">Gaiya Berube</a>.<br />
        <br />
