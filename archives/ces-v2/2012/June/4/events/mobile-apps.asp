...
<head><!-- PageID 5502 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Mobile Apps Showdown</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/events/mobile-apps.asp">Mobile Apps Showdown</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/events/default.asp" class="footer">Events</a>&nbsp;&gt;&nbsp;Mobile Apps Showdown</div>
                        </div>
                         <div class="headerbox">
        ...
        <p><img alt="" style="float: right;"  src="/images/content/MobileAppsShowdown_200_pw.jpg" /><strong>12:30 p.m. Thursday, Jan. 12, 2012<br />
        LVCC, North Hall, Room N255-N257</strong></p>
        <p>Mobile apps were put to the test during the Mobile Apps Showdown at 2012 CES! Apps producers had two minutes to demo their app, and an applause-o-meter measured audience enthusiasm to determine the winners. <br />
        <br />
        And the winner is...</p>
