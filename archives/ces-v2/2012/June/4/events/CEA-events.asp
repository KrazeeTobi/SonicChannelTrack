...
<head><!-- PageID 3918 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: CEA Events</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/events/CEA-events.asp">CEA Events</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/events/default.asp" class="footer">Events</a>&nbsp;&gt;&nbsp;CEA Events</div>
                        </div>
                         <div class="headerbox">
                            <h1>CEA Events</h1>
                        </div><br />
