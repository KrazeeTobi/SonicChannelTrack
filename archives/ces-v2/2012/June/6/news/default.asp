...
<head><!-- PageID 481 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
            ...
            <div id="page-bottom">
                <div id="main-content">
                    ...
                    <div id="main-content-header">
                        <img src="/images/content/Subhead_News.jpg">
                    </div>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;News</div>
                        </div>
...
Approximately 20,000 new consumer technology products launch each year at CES. That generates a lot of buzz, a lot of news and a lot of press. <BR><BR>



<div class="alert-box">                        
    
        <p><a  href="http://www.cesweb.org/press/CES-B-roll.htm">B-roll HD footage now available for download.</a></p>
    
</div>

<div class="alert-box">                        
    
        <p>Looking for preliminary 2012 CES numbers and details? <a  href="http://www.cesweb.org/news/releaseDetail.asp?id=12284">Read the show-closing release.</a></p>
    
</div><div class="grid-box">
   <h2>Media Coverage</h2>
    
    
    <p>CES generate thousands of stories from media institutions around the world. <A href="/news/coverage.asp">See some of them here.</A></p>
</div><div class="grid-box">
   <h2>Multimedia Gallery</h2>
    
    
    <p>Get videos, podcasts and pictures in the <A href="/news/multimedia-gallery.asp">CES&nbsp;multimedia library.</A></p>
   ...
   <h2>CES Press Releases</h2>
    
    
    <p><A href="/news/releases.asp">Print-worthy announcements keep you up to speed.</A></p>
</div><div class="grid-box">
   <h2>Exhibitor Releases</h2>
    
    
    <p>Stay informed on product launches and other <A href="/news/exhibitorNews.asp">announcements from official CES exhibitors.</A></p>
</div><div class="grid-box">
   <h2>News Feed</h2>
    
    
    <p><IMG style="MARGIN-LEFT: 2px" hspace=2 align=left src="/images/content/rss.gif" width=30 height=30>Subscribe to the <A href="/news/rssNews.asp">CES RSS News Feed</A> to get CES news to appear in your aggregator.</p>
</div><div class="grid-box">
   <h2>Newsletters</h2>
    
    
    <p><A href="/news/newsletters.asp">Online newsletters deliver late-breaking developments</A> on the world's largest consumer technology tradeshow.</p>
</div><div class="grid-box">
   <h2>Press Services</h2>
    
    
    <p>Are you a member of the media that's covering CES? Then this is the place for you. <A href="/press/services/default.asp">See&nbsp;luncheons and other&nbsp;at-your-disposal offerings&nbsp;tailored for press and analysts.</A> </p>
</div><div class="promo-box">
    
    
       
    <A href="http://www.CESweb.org/blog"><img src="/docs/226_DD_02.jpg" width="227" height="200"></A>
</div>
                            <script type="text/javascript">
