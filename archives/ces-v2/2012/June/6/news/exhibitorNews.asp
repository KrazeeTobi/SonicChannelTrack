...
<head><!-- PageID 487 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Exhibitor Releases</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/news/exhibitorNews.asp">Exhibitor Releases</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/news/default.asp" class="footer">News</a>&nbsp;&gt;&nbsp;Exhibitor Releases</div>
                        </div>
                         <div class="headerbox">
                            <h1>Exhibitor Releases</h1>
                        </div><br />
...
<script type="text/javascript" src="http://api.businesswire.com/contentapi/start/2012-International-CES"></script>
<noscript><iframe id="bwFrame" src="http://api.businesswire.com/contentapi/noscript/2012-International-CES" width="450px" height="800px" scrolling="yes" style="border:0px;overflow-x:hidden;"/></noscript>
</body> </html>
