...
<head><!-- PageID 493 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
            ...
            <div id="page-bottom">
                <div id="main-content">
                    ...
                    <div id="main-content-header">
                        <img src="/images/content/Subhead_FAQ.jpg">
                    </div>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;FAQs</div>
                        </div>
        ...
        <img width="165" height="125" alt="" style="float: right;"  width="165" height="125" src="/images/photos/p60.jpg" />Our frequently asked questions (FAQs) are organized by category to make your information search easier. Browse these categories for quick and easy access to all the information important to you.<br />
        <br />
        <p><strong>Getting Help</strong> <br />
        If you need help in the meantime, please feel free to email us at <a  href="mailto:CESinfo@CE.org">CESinfo@CE.org</a>. We return most e-mails within 48 hours. </p>
        <p><strong>First-timer ResourCES<br />
        </strong>Are you gearing up for your first CES? <a  href="/faq/first-timer.htm">Let us help you look like a pro in no time.</a> </p>
    

<div class="grid-box">
   <h2>FAQs by Category</h2>
    
    
    <p><A href="http://cesweb.org/faq/generalFAQs.asp">General FAQs</A><BR><A href="http://2012.cesweb.org/faq/pressFAQs.asp">Press FAQs</A><BR><A href="http://cesweb.org/faq/exhibitorFAQs.asp">Exhibitor FAQs</A><BR><A href="http://cesweb.org/faq/speakerFAQs.asp">Speaker FAQs</A><BR><A href="http://cesweb.org/faq/venueFAQs.asp">FAQs by Venue</A><BR></p>
</div>


        <p><strong>2012 International CES Exhibit Hours<br />
        ...
        <p><strong></strong></p>
        <p><strong>International CES Customer Service<br />
        </strong>To speak with a customer service representative, call our Customer Service Center at 866-233-7968. We are available to answer calls during normal business hours (9 a.m. to 5 p.m. EST Monday through Friday). </p>
    


<div id="inner-content-footer-info">
    <h2><a href="/exhibitors/space/default.asp" target="_blank">See your options.</a></h2>
</div>
                            <script type="text/javascript">
