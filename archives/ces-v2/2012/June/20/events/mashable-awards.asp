...
<head><!-- PageID 4503 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <p><img alt="" style="float: right;"  src="/images/content/MashBash_ces_2011_logo.jpg" />The Mashable team and their loyal followers flocked en masse and in force to the brand new <a  target="_blank" href="http://www.mirage.com/nightlife/1oak.aspx">1OAK Nightclub</a> during CES to celebrate the best of digital — from the Mashable Awards winners to the trends and companies at CES.<br />
        <br />
        As one of the first parties at 1OAK, it didn't disappoint with its one-of-a-kind night of networking, dancing and more in true Mashable style. </p>
        <p><a  target="_blank" href="http://www.mashable.com/2012/01/17/mashable-mashbash-ces-2012-photos/"  >Check out the pics, vids and recap.</a></p>
        <p>About Mashable: <a  target="_blank" href="http://www.mashable.com">Mashable</a> is the largest independent online news site dedicated to covering digital culture, social media and technology. With more than 50 million monthly pageviews and 4+ million followers across social media, Mashable has one of the most engaged online news communities. Founded in 2005, Mashable is headquartered in New York City with an office in San Francisco.</p>
