...
<head><!-- PageID 425 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Las Vegas Travel Tips</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/hotelTravel/default.asp" class="footer">Hotel/Travel</a>&nbsp;&gt;&nbsp;Las Vegas Travel Tips</div>
                        </div>
                         <div class="headerbox">
...
<div class="blue_box" id="5064">
    <ul>
        
        
        <li><a class="sub-page-slider-link" href="#5194">Airfare Recommendations</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5068">Las Vegas Weather</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5065">Getting Around: CES Foots the Bill</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5066">Vegas.com Tipping Tips</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5195">Book Restaurants, Spas, Golf, Show Tickets and More!</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5196">Discounts and Coupons</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5197">Las Vegas on YouTube</a></li>
...
<script type="text/javascript">
    var SecondItems = $("#5064 ul:first li:nth-child(3n+2)");
    var ThirdItems = $("#5064 ul:first li:nth-child(3n)");

    $("#5064 ul:eq(1)").append(SecondItems);
    $("#5064 ul:eq(2)").append(ThirdItems);
    $("#5064 ul:eq(2)").append($("#5064 .sub-page-slider-link-show-all").parent());

    $(document).ready(function() {
        $("#5064 .sub-page-slider-link-show-all").click();
    });
</script>
...
<div class="sub-page-slider">
    <div class="sub-page-slider-nav">
        ...
        <div class="sub-page-slider-top-header">Las Vegas Travel Tips</div>
        <div class="sub-page-slider-bottom-header"></div>
        <div class="push"></div>    
    </div>
    <div>
        <div class="sub-slide" id="5194">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Airfare Recommendations</h2>
    </div>
    <BR><SPAN style="MARGIN: 0px 0px 10px 10px; FLOAT: right">
<SCRIPT type=text/javascript src="http://afwdwidget.airfarewatchdog.com/?2973" align="right"></SCRIPT>
</SPAN><SPAN style="MARGIN: 0px 0px 10px 10px; FLOAT: left">We know traveling in this economy is tough, but there are ways to curb costs. In fact, attending CES is one of the smartest business trips you can make. Make it THE ONE business trip you make (rather than making several trips to different cities to meet with different decision makers).<BR><BR>Here are ways to get the best deal on airfare to the International CES:<BR><BR>
<OL type=1>
...
<LI><STRONG>Travel midweek.</STRONG> Tuesdays through Thursdays are generally a less expensive times to fly, and lucky for you, the 2012 International show begins Tuesday and ends Friday (January 10-13). Consider staying the entire duration of the show to get the best airfare. Also, flights that depart very early or late in the day are often more affordable than mid-day flights. </LI>
<LI><STRONG>Shop around.</STRONG> If you are booking on a travel website, compare them against the official airline's website, too. Plus, travel sites don't feature every airline that flies into Las Vegas.</LI></OL></SPAN>
    <br />
    <br />
</div><div class="sub-slide" id="5068">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Las Vegas Weather</h2>
    </div>
    <DIV>
<SCRIPT src="http://voap.weather.com/weather/oap/USNV0049?template=GENXH&amp;par=1007191792&amp;unit=0&amp;key=01d333e407dde316d59086a436368d20"></SCRIPT>
    ...
    <br />
    <br />
</div><div class="sub-slide" id="5065">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Getting Around: CES Foots the Bill</h2>
    </div>
    <P>While at CES, you have plenty to do, see and organize. So let us provide your transportation and give you one less thing to coordinate. The <A href="http://2012.cesweb.org/hotelTravel/shuttle.asp">CES shuttle</A> runs daily during the show between the Las Vegas Convention Center and all official CES hotels. CES also provides discounts on <A href="http://2012.cesweb.org/hotelTravel/cars.asp">car rentals</A>. <BR><BR>Please remember <A href="http://2012.cesweb.org/hotelTravel/cars.asp">parking is very limited at CES</A> this year. Make your transportation choices wisely and let us be your chauffeur! <BR><BR>Other Las Vegas transportation options include: limos, taxis (fares range from $10-15 per trip), buses and private cars.</P>
    <br />
    <br />
</div><div class="sub-slide" id="5066">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Vegas.com Tipping Tips</h2>
    </div>
...
<LI class=text><STRONG>Change person:</STRONG> Don't forget to slip a few bucks to these helpful folks — especially if you win. Don't try to palm off a $5 tip for a Megabucks win; it's insulting. </LI></UL>These are just suggestions — and you're always welcome to tip more! <BR><BR><B>CES quick tip: </B>Taking the <A href="http://2012.cesweb.org/hotelTravel/shuttle.asp">CES shuttle</A> requires zero dollars. That includes no tipping! <BR>
    <br />
    <br />
</div><div class="sub-slide" id="5195">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Book Restaurants, Spas, Golf, Show Tickets and More!</h2>
    </div>
    <BR>Like hotels, Las Vegas restaurants tend to book up quickly during CES, so place your dining reservations well in advance. CES has partnered with Destinations Direct to offer attendees and exhibitors a complimentary dining reservation service for any of the restaurants in Las Vegas. Destinations Direct can also help you&nbsp;purchase show tickets, plan golf outings and make appointments for spa services. <BR><BR>Whether it's a party of two or a group of 200, take advantage of this free service by visiting Destinations Direct online at <A href="http://www.dinedirectlasvegas.com/" target=_blank>www.dinedirectlasvegas.com/</A>. <BR><BR>Once a reservation request is received, Destination Direct calls the restaurant/spa/golf course&nbsp;on your behalf to make arrangements, then provides you with a confirmation letter including the details of your reservation. <BR>
    <br />
    <br />
</div><div class="sub-slide" id="5196">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Discounts and Coupons</h2>
    </div>
    
        <p>Looking for a deal on a Vegas show? Want that all-you-can-eat buffet at half the price? Keep checking back. As we hear of the best deals in the city during CES show days, we'll put them right here for you.  <br />
        <br />
        Go to the CES transportation page to learn about <a  href="/hotelTravel/cars.asp">car rental discounts.</a></p>
        <p ><strong>Aria</strong></p>
        <p>UNION at the Aria is offering a 20% discount(off the entire bill, including alcohol) to CES Guests when showing their convention badge.</p>
        <p> </p>
        <p><strong>Bellagio</strong></p>
        <p>FIX at the Bellagio is offering a 20% discount (off the entire bill, including alcohol) to CES Guests when showing their convention badge.</p>
        <p> </p>
        <p><strong>The Mirage</strong></p>
        <p>STACK at The Mirage is offering a 20% discount (off the entire bill, including alcohol) to CES Guests  when showing their convention badge.</p>
        <p> </p>
        <p><strong>Monte Carlo</strong></p>
        <p>Diablo’s &amp; BRAND at Monte Carlo are offering a 20% discount (off the entire bill, including alcohol) to CES Guests when showing their convention badge.</p>
        <p> </p>
        <p><strong>Treasure Island</strong></p>
        <p>Treasure Island is offering all CES Attendes the following deals upon presenting their CES credentials and photo ID. </p>
        <p>Isla – Free CES Margarita OR Empanada Appetizer with purchase of entrée</p>
        <p>Steak House – Free round of drinks (house wine or well cocktails) for parties of 8 or more</p>
        <p>Gilley’s – Special CES Reverse Happy Hour – Buy 1 Get 1 Free Drinks from 10p - Close</p>
        <p>  </p>
        <p><strong>Westin Casuarina <br />
        <br />
        </strong>The Westin is offering all CES Attendes and Exhibitors 2 for 1 show tickets for one of the following shows: Barbra &amp; Frank “The concert that never was” or The Red Skelton Tribute. Show your CES badge</p>
        <p>The Westin is offering all CES Guests the following value adds durring their stay:</p>
        <p> </p>
        <p>• 20% Discount on Spa Services</p>
        <p>• Access to Westin Workout room</p>
        <p>• Access to the Spa steam &amp; dry saunas</p>
        <p>• Triple Starwood Points- guest must provide SPG# upon check in</p>
        <p>• Complimentary Westin Unwind- Hosted beer &amp; wine reception daily</p>
        <p>• Complimentary local &amp; 800 calls</p>
        <p>• $10.00 Promotional Play Coupon to be provided at check in</p>
        <p>• Free Cocktail with purchase of appetizer in Lobby Lounge (limit one per qualified room)</p>
        <br />
        <table style="border: #9f9f9f 1px solid;" cellpadding="8">
            <tbody>
                <tr>
                    <td>
                    <h3>
                    <p>Calling all Las Vegas Businesses and Hotels!</p>
                    </h3>
                    If you are interested in offering a special discount to 2012 CES goers, e-mail <a  href="mailto:CEShotels@CE.org">CEShotels@CE.org</a> in the following format: <br />
                    <br />
                    Your venue here<br />
                    Your location here (if applicable)<br />
                    Your discount and description here<br />
                    Your contact information here </td>
                </tr>
            </tbody>
        </table>
    ...
    <br />
    <br />
</div><div class="sub-slide" id="5197">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Las Vegas on YouTube</h2>
    </div>
    <BR>Did you know the Las Vegas Convention and Visitors Authority (LVCVA) has a YouTube page? Check out their two videos on what's new in Las Vegas: 
