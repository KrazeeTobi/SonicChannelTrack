...
<head><!-- PageID 742 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Awards Categories</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/awards/default.asp" class="footer">Awards</a>&nbsp;&gt;&nbsp;<a href="/awards/innovations/default.asp" class="footer">CES Innovations Awards</a>&nbsp;&gt;&nbsp;Awards Categories</div>
                        </div>
                         <div class="headerbox">
        ...
        <strong><img alt="" style="float: right;"  src="/images/photos/8832_InnovationsMontage.jpg" /></strong>
        <p>Check back soon for our new 2013 categories!</p>
        <p>Looking for specific product examples? <a  target="_blank" href="/images/photos/8691_Category_Guide.pdf">Download the 2012 Awards Category Guide.</a><strong><br />
        <br />
        </strong></p>
...
<div class="blue_box" id="5077">
    <ul>
        
        
        <li><a class="sub-page-slider-link" href="#5078">A - G</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5080">H - I</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5081">M - P</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5241">S - W</a></li>
...
<script type="text/javascript">
    var SecondItems = $("#5077 ul:first li:nth-child(3n+2)");
    var ThirdItems = $("#5077 ul:first li:nth-child(3n)");

    $("#5077 ul:eq(1)").append(SecondItems);
    $("#5077 ul:eq(2)").append(ThirdItems);
    $("#5077 ul:eq(2)").append($("#5077 .sub-page-slider-link-show-all").parent());

    $(document).ready(function() {
        $("#5077 .sub-page-slider-link-show-all").click();
    });
</script>
...
<div class="sub-page-slider">
    <div class="sub-page-slider-nav">
        ...
        <div class="sub-page-slider-top-header">2012 Innovations Awards Categories</div>
        <div class="sub-page-slider-bottom-header"></div>
        <div class="push"></div>    
    </div>
    <div>
        <div class="sub-slide" id="5078">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">A - G</h2>
    </div>
    <STRONG>Audio Components <BR></STRONG>Products designed to deliver, control, store and/or manage audio content including records, tapes, disc-based audio, MP3 and hard drive storage. 
<P><STRONG>Computer Accessories<BR></STRONG>Products designed to enable, enhance, connect, power and/or maintain desktop or portable computer systems.&nbsp;<BR><STRONG>&nbsp;<BR>Computer Hardware &amp; Components<BR></STRONG>All desktop, notebook, and portable computer systems, as well as their internal components, EXCEPT for tablets, netbooks, and e-readers. Please note that tablets, netbooks, and e-readers have their own category.&nbsp;</P>
<P><STRONG>Computer Peripherals<BR></STRONG>Products designed to connect to and extend the functionality of desktop or portable computer systems. Examples include (but are not limited to) products that provide printing, networking, user input, and display.&nbsp;</P>
<P><STRONG>Digital Imaging <BR></STRONG>Products designed to enhance the visual experience and/or allow the user to capture, store and edit still images or video.&nbsp;</P>
<P><STRONG>Eco-Design and Sustainable Technologies &nbsp;<BR></STRONG>Innovative features incorporated into consumer electronics products that make them safe for the environment, i.e., efficient and clean energy use; manufacturing processes that reduce use the of environmentally relevant substances (e.g., lead, mercury); durability/end-of-life (reuse, refurbish, remanufacture, recycle); resource conservation.<BR><STRONG>&nbsp;<BR></STRONG><EM>Note: This category can include any type of consumer electronics product or component, as long as the product has an emphasis on environmentally-friendly design or function.<BR></EM><BR><STRONG>Embedded Technologies <BR></STRONG>Silicon chips and integrated components designed to provide functionality to finished products or subassemblies.&nbsp;</P>
<P><STRONG>Gaming Hardware &amp; Accessories<BR></STRONG>Products (hardware) designed to allow one or more users to interact with electronic games.<BR><STRONG>&nbsp;<BR></STRONG><BR></P>
<P></P>
    <br />
    <br />
</div><div class="sub-slide" id="5080">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">H - I</h2>
    </div>
    <STRONG>Headphones</STRONG>&nbsp;<BR>Devices that allow users to listen to audio content, such as music, radio, video, TV, gaming, and/or telephone conversations. The devices may incorporate microphones for user voice response or input, and do not have to be designed for use with any specific type of device. 
<P><STRONG>Health and Wellness&nbsp;<BR></STRONG>Products designed to test, monitor, or analyze the health, well-being, fitness and/or medical condition of an individual or provide therapeutic benefit. Products must have significant electronic functionality as a central part of the item’s operation.<BR><STRONG>&nbsp;<BR>High Performance Home Audio<BR></STRONG>Separate audio components and speakers that provide for optimal performance and sound reproduction. Items are typically produced in limited quantities and are often handcrafted.<BR><BR><STRONG>Home Networking<BR></STRONG>Products and accessories that enable users to maintain a wired or wireless data network, with the most typical applications being file, print and internet access sharing. Systems may also include products and software that provide for remote or conditional access.&nbsp;</P>
<P><STRONG>Home Theater Audio/Video Accessories <BR></STRONG>Products designed to enable, enhance, connect, and/or maintain home audio/video systems and components.<BR><BR><STRONG>Home Theater Speakers <BR></STRONG>Includes speakers whose primary purpose is incorporation into a home theater system.<BR><BR><STRONG>Integrated Home Systems<BR></STRONG>Products and components designed to be used as complete systems or subsystems in the home to control the distribution of and access to audio and video content. Systems also control lighting, energy and environmental systems and security access.<BR><BR><STRONG>In-Vehicle Accessories<BR></STRONG>Products designed to enable, enhance, connect, and/or maintain in-car audio, video and navigation systems, and components.<BR><BR><STRONG>In-Vehicle Audio/Video<BR></STRONG>Products and components designed to be part of an in-vehicle audio and video system.<BR><STRONG>&nbsp;<BR>In-Vehicle Navigation/Control/Telematics<BR></STRONG>Products and components designed to be part of an in-car navigation, information retrieval and transmission service, or facilitate the integration of audio, video, and navigation systems.&nbsp;</P>
    <br />
    <br />
</div><div class="sub-slide" id="5081">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">M - P</h2>
    </div>
    <P><STRONG>Major Home Appliances<BR></STRONG>Products whose primary function is to be used in the home. These products are designed to provide home heating and cooling, comfort, aesthetics, convenience, and home cleaning. Products should have significant electronic functionality as a central part of the item’s operation.<BR><BR><STRONG>Multi-Room Audio/Video<BR></STRONG>Systems specifically designed to allow users to centralize and redistribute content via simultaneous discrete streams to multiple locations in a home.<BR><BR><STRONG>Online Audio/Video Content &amp; Delivery<BR></STRONG>Any audio or video content that can be transmitted via the Internet. Also, any product designed to access, organize, or store online A/V content. Content can be streamed via the internet in real-time, or downloaded.<BR><BR><STRONG>Personal Electronics<BR></STRONG>Products whose primary function is achieved by being worn, carried, or used by a particular person. These products may assist with ease of living, time keeping, data reference/calculation, or many other functions of daily life.&nbsp;</P>
<P><STRONG>Portable Home Appliances <BR></STRONG>Products whose primary function is to be used in the home. These products are designed to provide food storage and preparation, comfort, aesthetics, convenience, and home cleaning. Products should have significant electronic functionality as a central part of the item’s operation.<BR><BR><STRONG>Portable Media Players<BR></STRONG>Products incorporating integrated storage and playback capability for audio and/or video content. Products have the capability to connect to desktop and portable computer systems to exchange content.<BR><STRONG>&nbsp;<BR>Portable Multimedia Accessories<BR></STRONG>Products designed to enable, enhance, connect, carry, and/or maintain portable media players.&nbsp;</P>
<P><STRONG>Portable Power<BR></STRONG>Devices designed to facilitate the powering and/or charging of consumer electronic products.<BR><BR></P>
    <br />
    <br />
</div><div class="sub-slide" id="5241">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">S - W</h2>
    </div>
    <P><STRONG>NEW! Software &amp; Mobile Apps<BR></STRONG>Programs or operating systems meant to be used on a computer system or mobile device.</P>

<P><STRONG>NEW! Tablets, E-Readers &amp; Netbooks<BR>&nbsp;<BR>Video Components<BR></STRONG>Systems or components designed to provide playback, storage, and/or distribution of video signals and content in the home.<BR><STRONG>&nbsp;<BR>Video Displays <BR></STRONG>Devices whose primary purpose is the display of video content not including items marketed and sold primarily as computer monitors.<BR><STRONG>&nbsp;<BR>Wireless Handsets<BR></STRONG>Items marketed primarily for the ability to provide wireless calling capability. The products in this category, in addition to having voice calling features, may also incorporate wireless data and Internet access features along with built in camera and media playback functionality.<BR><STRONG>&nbsp;<BR>Wireless Handset Accessories<BR></STRONG>Products designed to enable, enhance, connect, carry, and/or maintain wireless handsets.<BR><BR></P>
    <br />
    <br />
</div>
    </div>
