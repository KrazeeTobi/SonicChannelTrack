...
<head><!-- PageID 379 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7">
   <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="The CES exhibits and attractions reflect the dynamic consumer electronics industry: learn about CE Pro@CES, Digital Health Summit, iLounge Pavilion and other CES TechZones. ">
    <meta name="keywords" content="consumer electronics spotlights, Digital Health Summit, CEPro@CEES, CES TechZones, CES facilities, CES maps, CES floor plans, CES show floor">

    <title>2012 CES: Show Floor</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
            ...
            <div id="page-bottom">
                <div id="main-content">
                    ...
                    <div id="main-content-header">
                        <img src="/images/content/Subhead_ShowFloor.jpg">
                    </div>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;Show Floor</div>
                        </div>
                                                
                        <div id="inner-content-long">
                                                                   
                            <div class="grid-box">
   <h2>By Exhibit Hall</h2>
    
    
    <p>
        CES uses two large venues and covers more space than 35 (American) football fields. <a  href="/showFloor/by-hall.asp">Get nice, easy-to-scan lists of show floor destinations</a> based on different areas of the LVCC/Las Vegas Hilton and The Venetian.
    </p>
</div><div class="grid-box">
   <h2>By Product Category</h2>
    
    
    <p><A href="/showFloor/by-product.asp">CES represents 15 product categories.</A> If you have a particular consumer technology market in mind, use this list to see where you'll find it on the show floor.</p>
</div><div class="promo-box">
    
    
       
    <A href="http://www.cesweb.org/docs/2012_CES_ShowLocationsMap.pdf"><img src="/docs/2012-CES-Show-Locations-Map_226x200.jpg" width="227" height="200"></A>
</div><div class="grid-box">
   <h2>CES Tech Zones</h2>
    
    
    <p><IMG style="MARGIN-LEFT: 2px" border=0 hspace=2 align=right src="/images/content/techzone_mini.gif" width=65 height=15>The spotlight shines brightly on several key vertical markets. Immerse yourself in them through 20+ <A href="/showFloor/techzones.asp">CES TechZones</A> showcasing emerging products and companies.</p>
</div><div class="grid-box">
   <h2>Follow Me</h2>
    
    
    <p><A href="/followme.asp"><IMG style="MARGIN-LEFT: 2px" border=0 hspace=2 align=right src="/images/content/Follow-Me_mini.gif" width=55 height=54>Get the CES app!</A> "Follow Me" is an interactive smartphone application designed specifically for the tradeshow industry, featuring real-time show alerts and interactive floor maps.</p>
</div><div class="promo-box">
    
    
       
    <A href="http://www.CESweb.org/blog"><img src="/docs/226_DD_01.jpg" width="227" height="200"></A>
</div>
<div id="inner-content-footer-info">
    <h2><a href="/faq/default.asp" target="_blank">read more</a></h2>
</div>
                            <script type="text/javascript">
