...
<head><!-- PageID 360 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Show Planning/Exhibitor Manual</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/exhibitors/default.asp-->
            ...
            <li class="selected"><a href="/exhibitors/showPlanning/default.asp">Show Planning/Exhibitor Manual</a>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;Show Planning/Exhibitor Manual</div>
                        </div>
                         <div class="headerbox">
        ...
        If you're looking for all the details, reminders, policies and procedures for your 2012 International CES exhibiting experience, you've come to the right place.<br />
        <br />
        <h3><a  href="/exhibitors/showPlanning/hot-topics.asp">Hot Topics</a></h3>
        Here you'll find all the breaking operations news such as policy changes and other timely information. <br />
        <br />
        <h3><a  href="/exhibitors/showPlanning/lvcc-show-planning.asp">LVCC and Hilton Exhibitor Manual and Show Resources</a></h3>
        The LVCC/Hilton Exhibitor Manual, Exhibitor tools, meetings, deadlines and regulations and other need-to-know information gives you a a one-stop-shop for quick facts.<br />
        <br />
        <h3><a  href="/exhibitors/showPlanning/venetian-show-planning.asp">Venetian Exhibitor Manual and Venetian Exhibitor Resources</a></h3>
        The Venetian Exhibitor Manuals, exhibitor tools, show hours, deadline checklists, key regulations and other need-to-know information keeps Venetian exhibitors prepared and organized. <br />
        <br />
        <h3><a  href="/exhibitors/showPlanning/international-exhibitors.asp">International Exhibitors</a></h3>
        Exhibitors not based in the U.S. can find information specific to their exhibit planning here.<br />
        <br />
        <h3><a  href="/exhibitors/showPlanning/eac-dashboard.asp">EAC Dashboard</a></h3>
        Check here to find everything Exhibitors and Exhibitor Appointed Contractors need to know at CES from our online tool to tips and information. <br />
        <br />
        <h3><a  href="/exhibitors/showPlanning/GES-information.asp">GES Information</a></h3>
        GES, our general contractor, shares tips and information.
        <h3><a  href="/exhibitors/showPlanning/FreemanAV.asp">Vendor Information</a> </h3>
        Check here for information and news from official show vendors.
