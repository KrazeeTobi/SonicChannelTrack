...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/日本語.aspx" id="form">
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='日本語 end'><a href='/For-International-Visitors/日本語.aspx'>日本語</a></li></ul>
...
<p>
    <a href="/For-International-Visitors/日本語/旅行とヒサ情報.aspx">旅行とビザ情報</a><br />
    米国の出入国の際に役立つ情報です。
</p><p>
    <a href="/For-International-Visitors/日本語/ホテル予約.aspx">ホテル予約</a><br />
    皆様の旅行プランをお手伝いするため、CESではラスベガス選りすぐりのホテルと交渉し、割引料金を提供しています。
</p><p>
    <a href="/For-International-Visitors/日本語/代表団フロクラム.aspx">代表団プログラム</a><br />
    ご好評をいただいている代表団プログラムにより、国際CESでは国外からも多数の参加者が集まります。あなたの国や地域で代表団を組織する方法、代表団に参加する方法についてはこちらをご覧ください。
</p><p>
    <a href="/For-International-Visitors/日本語/国際サーヒス.aspx">国際サービス</a><br />
    外国からの参加者の方へは、通訳者、特別なネットワーク作りのためのレセプション、専用の作業エリア、会議室など、その他多数のサービスをご用意しています。
</p><p>
    <a href="/For-International-Visitors/日本語/一般情報.aspx">一般情報</a><br />
    展示会の沿革、現在の製品カテゴリ、今後の予定など、各国語で紹介します！ 
</p><p>
    <a href="/For-International-Visitors/日本語/シャトルサーヒス.aspx">シャトルサービス</a><br />
