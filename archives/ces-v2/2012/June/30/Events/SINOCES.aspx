...
<head id="head"><title>
	2013 International CES, January 8 - 11 - SINOCES
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Events/SINOCES.aspx" id="form">
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='events first'><a href='/Events.aspx'>Events</a></li><li class='sinoces end'><a href='/Events/SINOCES.aspx'>SINOCES</a></li></ul>
...
Interested in attending?&nbsp;<a href="http://www.sinoces.com/english/index.php/member-register?gid=3&amp;" target="_blank">Register online now.</a><br />
<table border="0" cellpadding="1" cellspacing="1" width="100%">
	<tbody>
		<tr>
			<td style="width:225px;">
				<img alt="" src="/cesweb/media/CESWeb/image%20gallery/SINOCES_ShowFloor.jpg" style="width: 196px; height: 196px; " /></td>
			<td>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td style="width:225px;">
				<img alt="" src="/cesweb/media/CESWeb/image%20gallery/SINOCES_Meeting.jpg" style="width: 196px; height: 196px; " /></td>
			<td>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td style="width:226px;">
				<img alt="" src="/cesweb/media/CESWeb/image%20gallery/SINOCES_ConferenceProgram.jpg" style="width: 196px; height: 196px; " /></td>
		</tr>
		<tr>
			<td>
				&nbsp;</td>
...
SINOCES is a collaboration between the Consumer Electronics Association (CEA)&reg;, producer of the International CES&reg; and the Qingdao Municipal People&rsquo;s Government.&nbsp;<br />
<br />
...
<h2>
	SINOCES Conferences and Forums</h2>
In addition to featuring world-class exhibitors, SINOCES will feature more than 20 conference sessions and other events focused on different facets of the CE industry.&nbsp;<a href="http://www.sinoces.com/" target="_blank">Visit www.SINOCES.com</a>&nbsp;for complete details on all 2012 conference program offerings and to register for the show.<br />
