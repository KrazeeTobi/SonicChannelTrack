...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Delegation Group Program
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/Delegation-Group-Program.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='delegation-group-program end'><a href='/For-International-Visitors/Delegation-Group-Program.aspx'>Delegation Group ...</a></li></ul>

</div>
<div id="inner-content-long">
 
    <div class="headerbox">
        <h1>Delegation Group Program</h1>
    </div>
    <div id="inner-content-left">
        Are you interested in bringing a group of industry professionals to the International CES? CEA has a formal delegation program in place that provides many benefits for delegation leaders and their delegation members. As a delegation leader, you will help your clients maximize the value of their trip to CES by assisting them plan what to see and who to meet at the show.&nbsp;Delegation leader registration closes on December 1, please <a href="mailto:delegations@ce.org">contact us</a> with questions or concerns.<br />
<br />
Free show registration is among the list of benefits for delegation program participants. If you join a delegation and register for CES after August 31, the $100 advance registration fee will be waived.&nbsp;<br />
<br />
...
<ul>
	<li>
		The delegation program is exclusive to attendees from outside the United&nbsp; States.<br />
		&nbsp;</li>
	<li>
		Delegations must consist of business professionals within the consumer electronics industry.<br />
		&nbsp;</li>
	<li>
		Delegations must have a minimum of 15 members. Groups smaller than 15 must register individually as attendees.</li>
</ul>
<h2>
	Benefits for Delegation Leaders</h2>
<ul>
	<li>
		Free hotel stay for delegation leaders who bring 50 individuals to CES (15 for government groups.) Groups must be confirmed four (4) weeks before CES or room is not guaranteed.<br />
		&nbsp;</li>
	<li>
		Electronic newsletter with the latest information on the delegation program and CES, including important dates and deadlines to receive program benefits.<br />
		&nbsp;</li>
	<li>
		Promotional brochures and electronic templates to assist in recruitment efforts.<br />
		&nbsp;</li>
	<li>
		The CES logo to add to promotional materials (marketing materials must be pre-approved by CES.)<br />
		&nbsp;</li>
	<li>
		Complimentary Exhibits Plus Pass (Allows access to exhibit show floor, keynote addresses, SuperSession and select conference sessions.)<br />
		&nbsp;</li>
	<li>
		Online capability to register delegation members, make changes or add new members.<br />
		&nbsp;</li>
	<li>
		Invitation to the CES Delegation Leader Appreciation Dinner hosted during CES.<br />
		&nbsp;</li>
	<li>
		Access to the International Commerce Center (ICC), available exclusively for international attendees and exhibitors. Amenities include complimentary Internet stations, refreshments, access to translators and private meeting rooms.<br />
		&nbsp;</li>
	<li>
		Invitation to the Global Matchmaking and International Reception where you can enjoy complimentary food and beverage while networking with other international attendees.</li>
</ul>
Please note: <a href="/Register.aspx">Registering</a> as a delegation leader does not register you for the show. You must complete the formal International CES registration process to register and receive your credentials.<br />
<br />
<h2>
	Benefits for Delegation Members</h2>
<ul>
	<li>
		Complimentary Exhibits Plus Pass (Allows access to exhibit show floor, keynote addresses, SuperSession and select conference sessions.)<br />
		&nbsp;</li>
	<li>
		Access to International Trade Specialists from the U.S. Department of Commerce who provide matchmaking assistance and export trade counseling to international attendees and exhibitors.<br />
		&nbsp;</li>
	<li>
		Invitation to the CES Global Matchmaking and International Reception.<br />
		&nbsp;</li>
	<li>
		List of exhibitors who export or indicate an interest in exporting to the group&#39;s country and/or region of the world.<br />
		&nbsp;</li>
	<li>
		Access to the International Commerce Center (ICC), available exclusively for international attendees and exhibitors. Amenities include complimentary Internet stations, refreshments, access to translators and private meeting rooms.<br />
		&nbsp;</li>
	<li>
		Opportunity to travel with other consumer electronics industry professionals from your country.<br />
		&nbsp;</li>
	<li>
		Invitation to the Global Matchmaking and International Reception where you can enjoy complimentary food and beverage while networking with other international attendees.</li>
</ul>
<h2>
	U.S. Department of Commerce International Buyer Program</h2>
The International CES is a proud participant of the U.S. Department of Commerce&rsquo;s International Buyer Program (IBP). Through the U.S. Commercial Service&rsquo;s network of offices in U.S. Embassies and Consulates worldwide, the IBP recruits pre-screened foreign buyer delegations and brings them to selected tradeshows in the United States, connecting U.S. companies with international buyers.&nbsp;&nbsp;<br />
<br />
Commercial service trade specialists located in your local embassy or consulate can assist you with show registration, help you locate the products you are looking to purchase at the show and assist in setting up meetings with you and U.S. businesses. As part of the IBP, many foreign commercial specialists lead delegations to CES. <a href="http://www.export.gov/eac/index.asp" target="_blank">Locate the Commercial Service office in your country.</a><br />
<br />
For questions or concerns related the CES Delegation Program, please contact <a href="mailto:delegations@ce.org?subject=Delegation%20Program">delegations@CE.org</a>.<br />
...
<li><a href="/For-International-Visitors/Espanol"></a></li>
    ...
    <div class="right-blue-box" align="center">
        <div class="right-blue-box-header">Delegation Leader Tools</div>
        <div style="padding: 15px;"><ul>
	<li>
		<a href="/cesweb/media/CESWeb/Documents/International/CES_General_Overview_Brochure_International.pdf" target="_blank">General Overview English Language Brochure (.pdf)</a></li>
	<li>
		<a href="/cesweb/media/CESWeb/Documents/International/CES_FactSheet_English.pdf" target="_blank">CES Fact Sheet (.pdf)</a></li>
	<li>
		<a href="/cesweb/media/CESWeb/Documents/International/CES_Delegation_Brochure.pdf" target="_blank">Multi-language Delegation Brochure (.pdf)</a></li>
	<li>
		<a href="/cesweb/media/CESWeb/Documents/International/CES_Delegation_Program_Benefits.pdf" target="_blank">Benefits for Delegation Leaders and Delegates (pdf in English)</a></li>
	<li>
		<a href="http://bcove.me/3q0qg61i" target="_blank">Informational CES video &nbsp;to show potential delegates</a></li>
</ul>
</div>
    </div>
