...
<head id="head"><title>
	2013 International CES, January 8 - 11 - PR Help
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-Exhibitors/PR-Help.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='pr-help end'><a href='/For-Exhibitors/PR-Help.aspx'>PR Help</a></li></ul>
...
<div>
	Eighty-five percent of all CES exhibitors cite press/media coverage as one of the most important reasons for attending the show. It&#39;s easy to see why PR is oftentimes the highest priority for exhibitors at the International CES. The more than 6,000 media and bloggers who cover CES each year are able to get a company&#39;s name into the minds of millions of consumers with the simple stroke of a keyboard. Let us help you reach the media.<br />
	<br />
	Check back soon for media lists, but in the meantime, check out the Exhibitor PR Kit (below) and the <a href="/News/Newsletters/Exhibitor-PR-Newsletter.aspx">Exhibitor PR Newsletter</a>.</div>

<h3><a href="/For-Exhibitors/PR-Help/Exhibitor-PR-Kit.aspx">Exhibitor PR Kit</a></h3>
<p>The manual includes valuable ideas on preliminary promotion, comprehensive communications strategies, press conference and publicity tips, press kit information and much more. </p>

<h2>
	<strong>Essential PR Tip</strong></h2>
<div>
	Update your PR contact information so journalists and broadcasters can find you. You must do this through your company&#39;s MyCES Exhibitor Portal. (Note: Exhibitor login credentials were emailed to the main exhibitor representative we have on file. If you&#39;re not sure who this contact is, email Krista Silano at <a href="mailto:afried@CE.org">ksilano@CE.org</a>.<br />
	&nbsp;</div>
&nbsp;</div>
</div>
</div>
