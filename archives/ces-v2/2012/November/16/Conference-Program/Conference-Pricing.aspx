...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Conference Pricing
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Conference-Program/Conference-Pricing.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='conference-program first'><a href='/Conference-Program.aspx'>Conference Program</a></li><li class='conference-pricing end'><a href='/Conference-Program/Conference-Pricing.aspx'>Conference Pricing</a></li></ul>
...
.blueButton
{
 background-color: #fff; color:#009BB6; width: 140px; display: block; padding: 5px; border: solid 1px #111; font-weight: bold; text-align: center;
}
...
<div>
	<h2>
		2013 Conference Pricing Overview</h2>
	<p>
		Advance Pricing: October 1 - 5pm EST, January 2, 2013<br />
		On-site Pricing: 5:01 p.m. EST, January 2, 2013 &ndash; January 11, 2013<br />
		<br />
		<a href="#allaccess">All Access Pass</a> | <a href="#entertainment">Entertainment Matters Pass</a> | <a href="#cepass">CE Pass</a> | <a href="#individual">Individual Sessions</a><br />
		<a href="#fullday">Full Day Conference Programs</a>&nbsp;| <a href="#halfday">Half Day Conference Programs</a>&nbsp;| <a href="#multiday">Multi-Day Conference Programs</a>&nbsp;| <a href="#free">Free Sessions</a><br />
		<a href="#thx">THX Certificate Registration</a> | <a href="#partners">Programs that Require Separate Registrations</a><br />
		<br />
		CEA Members save 25% on all conference passes. Contact <a href="mailto:membership@CE.org">membership@CE.org</a> for the priority code.<br />
		<br />
		The All Access, Entertainment Matters and CE passes include:<br />
		Free conference sessions, SuperSessions and Keynotes</p>
</div>
<!-- outer container div tag -->
<div style="width: 720px; height: auto; overflow: hidden;">
	<!-- begin content div tags -->
	<div class="pricingcols" id="pricingLeft">
		<div class="passnameprice">
			<strong><a name="allaccess"></a>All Access Pass</strong><br />
		...
		<div class="laundrylist">
			<ul>
				<li class="first">
					Broadband Unlimited</li>
				<li>
					Business Insights</li>
				<li>
					Cable Conference at CES</li>
				<li>
					CEPro Forum at CES</li>
				<li>
					CONNECTIONS Summit</li>
				<li>
					Content and Disruptive Technologies</li>
				<li>
					Content in the Cloud</li>
				<li>
					Digital Health Summit</li>
				<li>
					Digital Hollywood</li>
				<li>
					Emerging Technology</li>
				<li>
					Games Summit at CES</li>
				<li>
					HigherEdTECH</li>
				<li>
					Home Entertainment</li>
				<li>
					The International Academy of Web Television Presents: The Digital Entertainment Transformation</li>
				<li>
					In-Vehicle Technology</li>
				<li>
					Lifestyle Technologies</li>
				<li>
					MacTech Insight</li>
				<li>
					MEMS and the Consumer Connection</li>
				<li>
					PMA@CES Conference Sessions</li>
				<li>
					Connect2Car</li>
				<li>
					Silvers Summit</li>
				<li>
					Smartphones and Tablets Conference</li>
				<li>
					Tweet House Presents: Innovations in Social Business</li>
				<li>
					<em>Variety&#39;s</em> Entertainment Summit: Film &amp; Technology</li>
				<li>
					<em>Variety&#39;s</em> Entertainment Summit: TV &amp; Technology</li>
				<li>
					Wireless Communications</li>
			</ul>
		</div>
	</div>
	<div class="pricingcols" id="pricingLeftCenter">
		<div class="passnameprice">
			<strong><a name="entertainment"></a>Entertainment Matters Pass</strong><br />
			Advance: $750 | On-site: $1,000<br />
			<div style="margin-right: 10px; margin-bottom: 10px;">
		...
		<div class="laundrylist">
			<ul type="disc">
				...
				<li>
					Tweet House Presents: Innovations in Social Business</li>
				<li>
					<em>Variety</em>&rsquo;s Entertainment Summit: Film &amp; Technology</li>
				<li>
					<em>Variety</em>&rsquo;s Entertainment Summit: TV &amp; Technology</li>
				<li>
					Wireless Communications</li>
			</ul>
		</div>
	</div>
	<div class="pricingcols" id="pricingRightCenter">
		<div class="passnameprice">
			<strong><a name="cepass"></a>CE Pass</strong><br />
			Advance: $500 | On-site: $700<br />
			<div style="margin-right: 10px; margin-bottom: 10px;">
	...
	<div class="pricingcols" id="pricingRight">
		<div class="passnameprice">
			<strong><a name="individual"></a>Individual Sessions</strong><br />
			Advance $150 | On-site $300<br />
			One (1) session within:</div>
		<div class="laundrylist">
			<ul type="disc">
				<li class="first">
					Business Insights</li>
	...
	<!-- end out container div tag below here --><!-- container div tag 2 -->
	<div style="width: 720px; height: auto; overflow: hidden;">
		<!-- begin content div tags -->
		<div class="pricingcols" id="pricingLeftlower">
			<div class="passnameprice">
				<strong><a name="fullday"></a>Full Day Conference Programs</strong><br />
				Advance: $350 | On-site: $500<br />
				Includes:</div>
			<div class="laundrylist">
				<ul type="disc">
					<li class="first">
					...
					<li>
						The International Academy of Web Television Presents: The Digital Entertainment Transformation</li>
					<li>
						MacTech Insight: Your Expert Peek Inside the Apple Market</li>
					<li>
						Silvers Summit</li>
				</ul>
			</div>
		</div>
		<div class="pricingcols" id="pricingLeftCenterlower">
			<div class="passnameprice">
				<strong><a name="halfday"></a>Half Day Conference Programs</strong><br />
				Advance: $200 | On-site: $350<br />
				Includes:</div>
			<div class="laundrylist">
				<ul type="disc">
					<li class="first">
					...
					<li>
						MEMS and the Consumer Connection</li>
					<li>
						Tweet House Presents: Innovation in Social Business</li>
					<li>
						<em>Variety</em>&rsquo;s Entertainment Summit: Film &amp; Technology</li>
					<li>
						<em>Variety</em>&rsquo;s Entertainment Summit: TV &amp; Technology</li>
		...
		<div class="pricingcols" id="pricingRightCenterLower">
			<div class="passnameprice">
				<strong><a name="multiday"></a>Muti-Day Conference Programs</strong><br />
				Advance: $450 | On-site: $600<br />
				Includes:</div>
			<div class="laundrylist">
				<ul type="disc">
					<li class="first">
					...
					<li>
						Digital Hollywood</li>
					<li>
						Smartphone and Tablet Conference</li>
					<li>
						PMA@CES Conference Sessions</li>
				</ul>
			</div>
		</div>
		<div class="pricingcols" id="pricingRightlower">
			<div class="passnameprice">
				<strong><a name="free"></a>FREE tracks and sessions</strong><br />
				Includes:</div>
			<div class="laundrylist">
				<ul type="disc">
					<li class="first">
						Keynotes and&nbsp; SuperSessions</li>
					<li>
						CEA Research Summit</li>
					<li>
						Developer University at CES</li>
					<li>
						Fitness Tech</li>
					<li>
						How to Rock the Chain Buyer Meeting</li>
					<li>
						Innovation Policy Summit</li>
					<li>
						Just the Facts: Research, Reports and Revelations</li>
					<li>
						Kids@Play and MommyTech</li>
					<li>
						PMA@CES Official Business Keynotes</li>
					<li>
						The Rise of the Next Mobile Internet: New Networks, Devices, Demands</li>
				</ul>
			</div>
		</div>
		<!-- end out container 2 div tag below here --></div>
	<br />
	<div class="pricingcols" id="certprograms" style="width: 700px;">
		<div class="passnameprice">
			<a name="thx"></a>THX Certification Program<br />
			Advance: $500 | On-site: $550</div>
	</div>
	<div class="pricingcols" id="partners" style="width: 700px;">
		<a name="partners"></a>
		<div class="passnameprice">
			Programs that Require Separate Registration</div>
		<div style="padding: 10px;">
			<table align="left" border="1" cellpadding="2" cellspacing="0" width="675">
				<tbody>
					<tr class="passnameprice">
						<td>
							Conference Name</td>
						<td align="center" valign="top" width="200">
							Registration Link</td>
					</tr>
					<tr class="tablelist">
						<td>
							IEEE: International Conference on Consumer Electronics (ICCE)</td>
						<td align="center">
							<a href="http://registration3.experientevent.com/showCES131/Default_ICCE.aspx">ICCE Registration</a></td>
					</tr>
					<tr class="tablelist">
						<td valign="top">
							<p>
								CES Government 2013</p>
						</td>
						<td>
							<p align="center">
								<a href="http://www.CESGovernment.com" target="_blank">CESGovernment.com</a></p>
						</td>
					</tr>
					<tr class="tablelist">
						<td>
							<p>
								Second Screen Summit at CES</p>
						</td>
						<td>
							<p align="center">
								<a href="http://www.2ndscreensociety.com/CES" target="_blank">2ndscreensociety.com/CES</a></p>
						</td>
					</tr>
					<tr class="tablelist">
						<td valign="top">
						...
						<td valign="top">
							<p align="center">
								<a href="http://www.storagevisions.com" target="_blank">storagevisions.com</a></p>
						</td>
					</tr>
					<tr class="tablelist">
						<td valign="top">
							Smart Homes and Digital Consumers: Sponsored by J.D. Power and Associates</td>
						<td style="text-align: center; vertical-align: top;">
							<div>
								<a href="http://marketingforms.jdpa.com/forms/SmartHomesDigitalConsumersWorkshop" target="_blank">Smart Homes &amp; Digital Consumers</a></div>
						</td>
					</tr>
				</tbody>
			</table>
