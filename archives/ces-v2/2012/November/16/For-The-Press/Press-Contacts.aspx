...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Press Contacts
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-The-Press/Press-Contacts.aspx" id="form">
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='press-contacts end'><a href='/For-The-Press/Press-Contacts.aspx'>Press Contacts</a></li></ul>
...
<div style="clear: both;">
  <h3>CEA Communications Staff</h3>
  <div style="width: 50%; float: left; padding-bottom: 15px;">
   <a href="mailto:tdunion@ce.org">Tara Dunion</a><br />
   Sr. Director, CES Communications<br />
   703-907-7419
</div>

<div style="width: 50%; float: left; padding-bottom: 15px;">
   <a href="mailto:afried@ce.org">Allison Fried</a><br />
   Manager, International Communications<br />
   703-907-7603
</div>

<div style="width: 50%; float: left; padding-bottom: 15px;">
   <a href="mailto:ecorley@ce.org">Erica Corley</a><br />
   Manager, Public Relations<br />
   703-907-7621
</div>

<div style="width: 50%; float: left; padding-bottom: 15px;">
   <a href="mailto:ksilano@CE.org">Krista Silano</a><br />
   Communications Coordinator, Event PR<br />
   703-907-4331
</div>

<div style="width: 50%; float: left; padding-bottom: 15px;">
   <a href="mailto:jjoseph-ce.org"></a><br />
   Senior Vice President, Communications and Strategic Relationships<br />
...
<div style="clear: both; padding: 25px 0 25px 0;">
  <h3>Industry and Statistics Contacts</h3>
  <table border="0" cellspacing="2" cellpadding="2" width="100%">
<tbody><div style="width: 50%; float: left; padding-bottom: 15px;">
   <a href="mailto:laphillips@CE.org">Laurie Ann Phillips</a><br />
   Senior Director, Industry & Policy Communications<br />
   703-907-7654
</div>

<div style="width: 50%; float: left; padding-bottom: 15px;">
   <a href="mailto:mchisholm@ce.org">Mark Chisholm</a><br />
   Specialist, CEA Publications<br />
   703-907-5229
</div>

<div style="width: 50%; float: left; padding-bottom: 15px;">
   <a href="mailto:cstevens@CE.org">Cindy Stevens</a><br />
   Sr. Director, CEA Publications<br />
   
</div>

<div style="width: 50%; float: left; padding-bottom: 15px;">
   <a href="mailto:lhubbard@CE.org">Laura Hubbard</a><br />
   Sr. Manager, Division and Policy Communications<br />
   703-907-4326
</div>

<div style="width: 50%; float: left; padding-bottom: 15px;">
   <a href="mailto:gellis@CE.org">Grace Ellis</a><br />
   Innovation Movement Coordinator<br />
   
</div>

<div style="width: 50%; float: left; padding-bottom: 15px;">
   <a href="mailto:skidera@CE.org">Stephen Kidera</a><br />
   Manager, Industry Communications<br />
   703-907-4358
</div>

<div style="width: 50%; float: left; padding-bottom: 15px;">
   <a href="mailto:snevels@ce.org">Samantha Nevels</a><br />
   Coordinator, Policy Communications<br />
   
</div>

<div style="width: 50%; float: left; padding-bottom: 15px;">
   <a href="mailto:dcassagnol@CE.org">Danielle Cassagnol</a><br />
   Coordinator, Industry Communications<br />
