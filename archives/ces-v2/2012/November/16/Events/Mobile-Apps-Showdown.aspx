...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Mobile Apps Showdown
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Events/Mobile-Apps-Showdown.aspx" id="form">
...
<div>
    <img alt="" src="/cesweb/media/CESWeb/Events/MAS_2013-web.jpg" style="width: 204px; height: 123px; float: right;" /><strong>12:30 p.m. Thursday, January 10<br />
LVCC, North Hall, Room N255</strong><br />
&nbsp;<br />
Are you ready for a showdown? Pit your mobile app against the competition during the Mobile Apps Showdown at the 2013 CES! App producers will have two minutes to demo their app, and an applause-o-meter will measure audience enthusiasm to determine the winners. Two winners will be selected, one based on a live vote at CES and the other based on online voters at the website. Guest emcees Gary Dell&#39;Abate and Jon Hein from the Howard Stern Show will host the event.
</div>&nbsp;</div>
</div>
</div>
