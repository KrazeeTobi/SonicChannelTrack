...
<head id="head"><title>
	2013 International CES, January 8 - 11 - R&#233;servations d&#39;h&#244;tel
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/French/hotels.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='french'><a href='/For-International-Visitors/French.aspx'>Français</a></li><li class='hotels end'><a href='/For-International-Visitors/French/hotels.aspx'>Réservations d'hôtel</a></li></ul>
...
<div>
    Pour vous aider à planifier aisément votre voyage, CES a négocié des prix de chambre réduits auprès de certains hôtels sélectionnés de Las Vegas.<br />
<br />
Pour consulter la liste complète des hôtels et des tarifs correspondants, visitez&nbsp;<a href="/Hotel-Travel/Hotel-Reservations.aspx">www.CESweb.org/hotel </a>(les renseignements sont en anglais). Pour obtenir le tarif CES, toutes réservations de chambres doivent être faites directement auprès de l&rsquo;hôtel, en passant par le site&nbsp;<a href="/Hotel-Travel/Hotel-Reservations.aspx">www.CESweb.org/hotel</a> et en y sélectionnant le nom de l&rsquo;hôtel choisi. Vous serez alors amené directement à la page des réservations de l&rsquo;hôtel, ou vous pourrez entrer votre numéro et les renseignements de carte de crédit nécessaires.&nbsp;Puisque la majorité des hôtels officiels du CES sont déjà réservés ou réservés au tarif CES, une liste d&rsquo;hôtels secondaires (sans service de navette au CES) a été ajoutée sur le site Web de CES.&nbsp;<br />
<br />
Si vous désirez réserver un groupe de 20 chambres ou plus, vous pouvez alors soumettre cette demande directement à l&rsquo;hôtel choisi (ou aux hôtels choisis) en visitant le site <a href="/Hotel-Travel/Hotel-Reservations.aspx">www.cesweb.org/hotelTravel/blockRequest.asp</a>. Votre demande sera directement transmise à l&rsquo;hôtel ou aux hôtels ; les hôtels disposent de trois jours ouvrables pour vous répondre.<br />
<br />
Remarque : Il n&rsquo;existe ni agence, ni bureau de logement CEA/CES. Si certains se font passer pour le&nbsp; bureau ou l&rsquo; agence de logement de CES, sachez que ces offres de services sont fausses et inauthentiques.<br />
<br />
Vous avez des questions à nous poser ? Veuillez les adresser par courrier électronique, en anglais, à <a href="mailto:CEShotels@CE.org">CEShotels@CE.org</a>.<br />
<p>
	&nbsp;</p>
