...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Voyage et visa
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/French/travel.aspx" id="form">
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='french'><a href='/For-International-Visitors/French.aspx'>Français</a></li><li class='travel end'><a href='/For-International-Visitors/French/travel.aspx'>Voyage et visa</a></li></ul>
...
<div id="inner-content-left">
    Informations utiles sur l&rsquo;entrée aux États-Unis et la sortie du pays.
    <hr class="separator" />
<h3></h3>

<span class="paragraphHeader">H&#244;tels</span>
<p><a href="/Hotel-Travel/Hotel-Reservations.aspx">Consultez la section Hôtels de CESweb.org&nbsp;(en anglais)</a> pour vos réservations individuelles ou de groupe.</p>

<span class="paragraphHeader">Vous voulez savoir comment vous rendre au CES ?</span>
<p><a href="/Hotel-Travel.aspx">Consultez la section Voyage de CESweb.org&nbsp;(en anglais)</a> pour obtenir les meilleurs prix pour votre billet d&rsquo;avion et votre location de voiture, mais aussi pour planifier vos déplacements locaux.</p>


    <hr class="separator" />
<h3></h3>

<span class="paragraphHeader">Vous avez besoin d’aide ? </span>
<p><a href="/cesweb/media/CESWeb/Documents/International/CES_VisaTips_French.pdf" target="_blank">Téléchargez notre fiche de conseils pour les visas</a>, qui contient des instructions détaillées, les adresses de sites web importants et d&rsquo;autres informations destinées à faciliter votre demande de visa.</p>

<span class="paragraphHeader">Vous avez besoin d’un visa ? </span>
<p><a href="https://ceac.state.gov/genniv/" target="_blank">Vous pouvez désormais remplir votre demande de visa en ligne.</a></p>


    <div style="border:#9f9f9f 1px solid; padding: 5px;"><h3>
	Avis important pour les participants qui voyagent en vertu du Visa Waiver Program</h3>
Toutes les demandes d&rsquo;inscription ou de renouvellement faites sur le système électronique d&rsquo;autorisation de voyage (Electronic System for Travel Authorization, ESTA) nécessitent un paiement de 14 dollars US par carte de crédit ou de débit. Les enregistrements actuels au ESTA resteront valides jusqu&rsquo;à leur date d&rsquo;échéance. Pour obtenir de plus amples renseignements, cliquez sur le lien suivant&nbsp;<a href="http://cbp.gov/xp/cgov/travel/id_visa/esta/" target="_blank">consultez la page de l&rsquo;ESTA sur le site Web du Département de la Sécurité intérieure, des Douanes et de la Protection des frontières.</a></div>
</div>
