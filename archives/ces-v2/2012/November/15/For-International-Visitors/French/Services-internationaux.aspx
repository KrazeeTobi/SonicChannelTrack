...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Services internationaux
...
<a name="192"><span style="display: none">Zone d'inscription internationale </span></a>
<div class="sub-content-header">Zone d'inscription internationale </div>

<p><em>LVCC, Central Plaza Main Registration (inscription principale)<br />
The Venetian, niveau 2</em><br />
<br />
Une aire d&rsquo;inscription spéciale pour les participants internationaux est située dans l&rsquo;aire d&rsquo;inscription principale du LVCC, Central Plaza et de l&rsquo;hôtel-casino The Venetian. Dans ces deux aires, les visiteurs internationaux peuvent s&rsquo;inscrire sur place, récupérer un badge (qui est requis pour assister au salon), ou obtenir de l&rsquo;aide linguistique particulière des interprètes multilingues disponibles pour répondre aux questions liées à l&rsquo;inscription.&nbsp;<br />
</p>
<hr class="separator" /><a name="196"><span style="display: none">International Commerce Centers (ICC)</span></a>
<div class="sub-content-header">International Commerce Centers (ICC)</div>

<p>Les ICC sont l&rsquo;endroit par excellence pour les visiteurs et les exposants internationaux qui souhaitent garder le contact avec le bureau, utiliser les postes Internet, réserver et utiliser les salles de réunions privées, profiter d&rsquo;une boisson désaltérante ou tout simplement se détendre.&nbsp;<br />
</p>
<hr class="separator" /><a name="195"><span style="display: none">Réception internationale</span></a>
<div class="sub-content-header">Réception internationale</div>

<p><p>
	<em>LVCC, South Hall Connector, Salle S222</em></p>
Tous les participants, les exposants et la presse internationale sont invités à la réception internationale du CES, réservée exclusivement aux visiteurs internationaux. Ne manquez pas cette occasion de rencontrer des gens nouveaux, de discuter affaires avec des collègues ou de mettre sur pied de nouveaux partenariats commerciaux. Cette année, le Département américain du Commerce organisera un programme de jumelage pour les entreprises qui souhaitent faire affaires à l&rsquo;étranger lors de cette réception. Nous vous y attendons avec impatience !</p>
<hr class="separator" /><a name="194"><span style="display: none">Interprètes</span></a>
<div class="sub-content-header">Interprètes</div>

<p>Des employés multilingues sont disponibles dans les ICC et les aires d&rsquo;inscription internationale du LVCC, Central Plaza et de l&rsquo;hôtel The Venetian. Des interprètes seront disponibles pour vous aider dans plusieurs langues, dont l&rsquo;espagnol, le français, le chinois, le japonais et le coréen. Sur les aires d&rsquo;inscription internationale, recherchez le comptoir intitulé Interpretation Services (Services d&rsquo;interprétation) si vous avez besoin d&rsquo;aide. Vous souhaitez engager un interprète pour vous aider lors d&rsquo;une réunion&nbsp;? Vous trouverez ci-dessous deux firmes qui offrent ce service&nbsp;:<br />
<ul>
	<li>
...
<hr class="separator" /><a name="193"><span style="display: none">Programme des acheteurs internationaux</span></a>
<div class="sub-content-header">Programme des acheteurs internationaux</div>

<p>CES International est fier de participer au Programme des acheteurs internationaux (International Buyer Program), sponsorisé par l&#39;Administration du commerce international du Département du commerce des États-Unis. Des spécialistes du commerce international du Département du commerce des États-Unis sont à disposition au principal Centre de commerce international (ICC) (LVCC South Hall Connector, Salle S224/225) pour aider à trouver des correspondants et des consultants en commerce d&#39;exportation au profit des participants et exposants internationaux. </p>
