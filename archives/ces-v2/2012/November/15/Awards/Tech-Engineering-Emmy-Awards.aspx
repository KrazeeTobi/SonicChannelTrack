...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Technology &amp; Engineering Emmy&#174; Awards
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Awards/Tech-Engineering-Emmy-Awards.aspx" id="form">
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='awards first'><a href='/Awards.aspx'>Awards</a></li><li class='tech-engineering-emmy-awards end'><a href='/Awards/Tech-Engineering-Emmy-Awards.aspx'>Technology & ...</a></li></ul>
...
<div>
    <img alt="" src="/cesweb/media/CESWeb/Awards%20and%20Events/Emmys_200.gif" style="width: 200px; height: 112px; float: right; margin: 5px; " /><strong>Thursday, January 10, 2013<br />
6:30 p.m. Reception<br />
7:30 p.m. Dinner<br />
The Bellagio, Bellagio Ballroom</strong><br />
<br />
...
<br />
<strong>Winners announced! </strong>Companies and people in the consumer technology and digital entertainment fields are honored each year. The&nbsp;<a href="http://www.emmyonline.tv/mediacenter/tech_2k12_winners.html" target="_blank">individuals and companies to be honored at the 2013 event</a> include:<br />
<br />
...
<br />
<strong>Eco-system for Real Time Presentation of TV Content to Mobile Devices without the use of Specialized Television Hardware:</strong><br />
<ul>
	<li>
		Apple</li>
</ul>
<br />
<strong>The Development and Commercialization of Analog Local Cable Video Ad Insertion:</strong><br />
<ul>
	<li>
		Cablevision Systems</li>
</ul>
<ul>
	<li>
		Channelmatic</li>
...
<strong>The Development and Commercialization of Cable Interconnects for Local Video Ad Insertion</strong>:<br />
<ul>
	<li>
		Time Warner Cable</li>
</ul>
<ul>
	<li>
		NCC Media</li>
</ul>
<strong>The Development and Commercialization for Digital Infrastructure for Local Cable Ad Insertion:</strong><br />
<ul>
	<li>
		DEC</li>
</ul>
...
<br />
<strong>Pioneering On-Screen Interactive Program Guides:</strong><br />
<ul>
	<li>
		Starsight (now Rovi Corporation)</li>
</ul>
<strong>Pioneering Development of Event Driven Control Room Automation Systems for Production of Live Television Shows, which Encompasses Full Control of Robotic Cameras, Audio, Graphics and Video Sources:</strong>
<ul>
	<li>
		Parkervision (Grass Valley)</li>
</ul>
<strong>Pioneering Development and Deployment of Aspect Ratio Control Technologies and Systems For Letterbox Images within Consumer Devices:</strong>
<ul>
	<li>
		Warner Brothers</li>
</ul>
...
<strong>Development of Electronic Mastering System for Large Scale Content Customization, Transcoding and Distribution:</strong><br />
&nbsp;
<ul>
	<li>
		Warner Brothers</li>
...
<ul>
	<li>
		CBS Worldwide Distribution</li>
</ul>
<strong>Pioneering Development of Multi-Room DVR:</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<ul>
	<li>
		Time Warner Cable</li>
</ul>
...
<strong>IRND Filter Technology for Digital Motion Picture Cameras:</strong><br />
<ul>
	<li>
		The Tiffen Company</li>
</ul>
<ul>
	<li>
		Schneider Optics Inc.</li>
</ul>
<strong>Improvements to Large Format CMOS Imagers for Use in High Definition Broadcast Video Cameras:</strong><br />
<ul>
	<li>
		Arnold &amp; Richter Cine Technik (ARRI)</li>
</ul>
<ul>
	<li>
		Canon USA, INC</li>
