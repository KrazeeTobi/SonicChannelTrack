...
<head id="head"><title>
	2013 International CES, January 8 - 11 - 日本語
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='japanese end'><a href='/For-International-Visitors/japanese.aspx'>日本語</a></li></ul>
...
<div id="inner-content-left">
    <h3>
	業界最高峰の頭脳が集まる</h3>
毎年、最先端のイノベーションが一堂に会する場所。2013年1月8～11日 (火～金)、米国ネバダ州ラスベガスで開催される世界最大の消費者向けテクノロジートレードショーにご参加ください。展示企業3,000社が最新の製品とテクノロジーを展示し、すべての出会いが発見につながり、新製品が誕生し、興奮が渦巻く場所。<a href="http://www.cesweb.org/Events/Keynotes.aspx">CES基調講演</a>では、業界でもっともダイナミックなキーマンの話を直接聞くことができます。300本の<a href="http://www.cesweb.org/Conference-Program.aspx">カンファレンスセッション</a>には合計800人のワールドクラス講演者が登場し、2013年に貴社がサクセスをつかむための洞察を得ることができます。<a href="http://registration3.experientevent.com/showCES131/Default.aspx">ご登録は今すぐに</a>！<br />

    
<p>
    <a href="/For-International-Visitors/japanese/travel.aspx">旅行とビザ情報</a><br />
    米国の出入国の際に役立つ情報です。
</p><p>
    <a href="/For-International-Visitors/japanese/hotels.aspx">ホテル予約</a><br />
    皆様の旅行プランをお手伝いするため、CESではラスベガス選りすぐりのホテルと交渉し、割引料金を提供しています。
</p><p>
    <a href="/For-International-Visitors/japanese/delegations.aspx">代表団プログラム</a><br />
    ご好評をいただいている代表団プログラムにより、国際CESでは国外からも多数の参加者が集まります。あなたの国や地域で代表団を組織する方法、代表団に参加する方法についてはこちらをご覧ください。
</p><p>
    <a href="/For-International-Visitors/japanese/services.aspx">国際サービス</a><br />
    外国からの参加者の方へは、通訳者、特別なネットワーク作りのためのレセプション、専用の作業エリア、会議室など、その他多数のサービスをご用意しています。
</p><p>
    <a href="/For-International-Visitors/japanese/一般情報.aspx">一般情報</a><br />
    展示会の沿革、現在の製品カテゴリ、今後の予定など、各国語で紹介します！ 
</p><p>
    <a href="/For-International-Visitors/japanese/shuttles.aspx">シャトルサービス</a><br />
    インターナショナルCESでは、4日間の開催期間中、無料シャトルサービスが提供されます。
</p><p>
    <a href="/For-International-Visitors/japanese/初めてこ参加の方のための情報.aspx">初めてご参加の方のための情報 </a><br />
    毎年このイベントには、テクノロジー最先端のイノベーターたちが集います。 この4日間、ラスベガスはさらに明るく輝きます。 CES初参加の方のプランをお手伝いし、ご参加を有意義なものにしていただくため、役立つ「初めてご参加の方のための情報」のリストをまとめました。
</p>
...
<li><a href="/For-International-Visitors/Espanol"></a></li>
    ...
    <div class="right-blue-box" align="center">
        <div style="padding: 15px;">15名以上の海外参加者からなる代表団には、「展示プラス」登録が優遇されるのをご存知ですか？&nbsp;<br />
<br />
<a href="/For-International-Visitors/日本語/代表団フロクラム.aspx">詳しくはこちら.</a>&nbsp;</div>
    </div>
    <!--<div class="right-blue-box" align="center">
