...
<head id="head"><title>
	2013 International CES, January 8 - 11 - 한국어
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/Korean.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='korean end'><a href='/For-International-Visitors/Korean.aspx'>한국어</a></li></ul>
...
<div id="inner-content-left">
    <h3>
	업계 최고의 두뇌들이 이곳에 옵니다</h3>
해마다 최첨단 혁신 아이디어의 산물은 모두 한 곳에 모입니다. 2013년 1월 8-11일(화요일-금요일), 미국 네바다주의 라스베이거스에 오셔서 저희와 함께 세계 최대의 소비자 제품 테크놀로지 박람회를 관람하십시오. 3,000채에 달하는 전람업체가 최신 제품과 테크놀러지를 선보이는 이 박람회에서는 우연히 접한 제품이나 테크놀로지가 모두 놀라운 발견으로 연결되며, 각양각색의 신제품이 출시되고 현장에 있는 모든 이의 흥분은 고조될 것입니다. <a href="http://www.cesweb.org/Events/Keynotes.aspx">CES 기조연설</a>에 참가하여 업계에서 가장 활동적인 최고경영자들의 연설을 들으십시오. 300개의 <a href="http://www.cesweb.org/Conference-Program.aspx">컨퍼런스 세션</a>에는 800명의 세계 정상급 연사들이 아이디어와 트렌드를 소개할 것이니, 어떻게 하면 2013년에 귀하의 회사가 성공적인 입지에 우뚝 설 것인지 다양한 탁견을 알아보십시오. <a href="http://registration3.experientevent.com/showCES131/Default.aspx">지금 등록하십시오</a>!<br />

    
<p>
    <a href="/For-International-Visitors/Korean/travel.aspx">여행 및 비자 안내</a><br />
    미국을 방문하는 데 도움이 되는 이 정보를 사용하십시오. 
</p><p>
    <a href="/For-International-Visitors/Korean/hotels.aspx">호텔 예약</a><br />
    CES는 귀하의 여행 계획에 편의를 제공하기 위해 할인가격으로 일부 라스베이거스 호텔 객실을 확보해 두었습니다. 
</p><p>
    <a href="/For-International-Visitors/Korean/delegations.aspx">대표단 프로그램</a><br />
    International CES는 성공적인 대표단 프로그램을 갖추고 수많은 해외 방문객들을 불러들이고 있습니다. 여러분 국가나 지역의 대표단을 만들거나 대표단에 참여하는 방법을 알아보십시오.
</p><p>
    <a href="/For-International-Visitors/Korean/services.aspx">해외 방문객 서비스</a><br />
    통역사, 특별 네트워크 리셉션, 효율적인 업무 공간, 회의실 등 해외 방문객을 위한 다양한 서비스가 제공됩니다.
</p><p>
    <a href="/For-International-Visitors/Korean/一般信息.aspx">一般信息</a><br />
    了解关于展会的历史、目前产品目录、未来展会日期等信息 —全部被译成您的语言！
</p><p>
    <a href="/For-International-Visitors/Korean/shuttles.aspx">왕복 운행</a><br />
    인터내셔널 CES는 4일간의 인터내셔널 CES 전람회 기간 중 매일 무료 셔틀 서비스를 제공합니다.
</p><p>
    <a href="/For-International-Visitors/Korean/처음-참가자들을-위한-유용한-정보.aspx">처음 참가자들을 위한 유용한 정보 </a><br />
    매년, 전세계 첨단 기술 혁신가들을 한 곳으로 집합시키는 큰 이벤트가 있습니다. 그리고 그 이벤트가 개최되는 나흘 동안, 라스베이거스의 분위기는 한층 더 고조되고 빛납니다. 귀하가 최초의 CES 참가를 성공적으로 계획하실 수 있도록 ≪처음 참가자들을 위한 유용한 정보≫를 종합하여 제공해 드립니다.
</p>
...
<li><a href="/For-International-Visitors/Espanol"></a></li>
    ...
    <div class="right-blue-box" align="center">
        <div style="padding: 15px;"><span style="color: rgb(30, 53, 114); font-size: 11px; line-height: 16px; text-align: left; background-color: rgb(255, 255, 255); ">15명 이상의 인터내셔널 참가자로 구성된 대표단은 Exhibits Plus 무료 등록 혜택을 받는다는 것을 알고 계셨습니까?&nbsp;</span><a href="http://cesweb.org/international/korean/delegations.asp"><span style="font-size: 11px; line-height: 16px; text-align: left; background-color: rgb(255, 255, 255);">자세</span></a><a href="/For-International-Visitors/한국어/대표단-프로그램.aspx"><span style="font-size: 11px; line-height: 16px; text-align: left; background-color: rgb(255, 255, 255);">한 내용보기.</span><span style="color: rgb(30, 53, 114); font-size: 11px; line-height: 16px; text-align: left; background-color: rgb(255, 255, 255); ">&nbsp;&nbsp;</span></a></div>
    </div>
    <!--<div class="right-blue-box" align="center">
