...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Show Floor Tours 
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='show-floor first'><a href='/Show-Floor.aspx'>Show Floor</a></li><li class='show-floor-tours end'><a href='/Show-Floor/Show-Floor-Tours.aspx'>Show Floor Tours </a></li></ul>
...
<div>
  <div style="text-align: center; ">
	<h1 style="font-size: 30px; color: rgb(51, 51, 51); background-color: rgb(255, 255, 255); text-align: left; ">
		Show Floor Tours</h1>
	<br />
	<span style="font-size:16px;"><strong>Get The Most Out of 2013 International CES<sup>&reg;</sup>!</strong></span></div>
<div style="text-align: center; ">
	<span style="font-size:16px;">Take an Official Two-Hour Guided Floor Tour<br />
	Produced by the Consumer Electronics Association (CEA)<sup>&reg;</sup><br />
	in partnership with Shelly Palmer Digital Leadership&trade;</span></div>
<div>
	<br />
	Experience a curated, two-hour guided tour of the most relevant and exciting exhibits on the 2013 International CES show floor. Shelly Palmer and his experienced tour guides will help you identify and understand key technologies and services, differentiate offerings and create action items and strategic take-aways from the show.<br />
	<br />
	<strong>Choose the Tour That&#39;s Best for You:</strong></div>
<img alt="" src="/cesweb/media/CESWeb/Show%20Floor%20Pictures/Show-Floor-Tours_1.jpg" style="width: 236px; height: 206px; float: right; margin: auto 5px;" />
<ul>
	<li>
		<em>2013 International CES General Overview Tour</em><br />
		Covers a little bit of everything &ndash; simply the best way to experience the show.</li>
</ul>
<ul>
	<li>
		<em>Specialty Tours</em><br />
		Includes a general overview with an emphasis on specific product categories, as listed below:
		<ul>
			<li>
				Connected Home and Digital Health and Fitness Tour</li>
			<li>
				Wireless and Wireless Devices Tour (Smart Phones and Tablet-Focused)</li>
			<li>
				Technology for Investors and Financial Professionals Tour</li>
			<li>
				Retailers and Buyers Tour</li>
		</ul>
	</li>
</ul>
<div>
	<strong>Tour Experience Includes:</strong></div>
<ul>
	<li>
...
<div>
	Tours leave from the North Lobby of the Las Vegas Convention and World Trade Center (LVCC) several times each day. We will do our best to accommodate your schedule. Space is limited and tours fill up quickly.</div>
<div>
	&nbsp;</div>
<div>
	...
	&nbsp;</div>
<div>
	Tours are only available for registered 2013 International CES attendees. If you haven&rsquo;t already done so, <a href="http://registration3.experientevent.com/showCES131/Default.aspx" target="_blank">register for the 2013 CES</a>.</div>
<div>
	&nbsp;</div>
<strong>Already registered for CES? </strong><br />
<br />
Log in to your registration record at <a href="http://www.CESweb.org/Register">CESweb.org/Register</a> and follow the onscreen prompts to update your registration to include Guided Tours.
<div>
	<br />
	<strong>About Shelly Palmer Digital Leadership Series&trade;</strong><br />
	<br />
	<img alt="" src="http://staging.cesweb.org/cesweb/media/CESWeb/Show%20Floor%20Pictures/shellypalmersamplelogo-2.jpg" style="width: 168px; height: 30px; float: left; " /></div>
<div>
	<br />
	<br />
	The goal of the Shelly Palmer Digital Leadership Series&trade; is to help you succeed in a connected&nbsp;world. For over 10 years, we have been curating and leading tours at International CES for some of the world&#39;s largest companies. A list of references is available upon request.<br />
	<br />
	<div>
		<strong>Questions?</strong><br />
		&nbsp;</div>
	<div>
		Contact&nbsp;<a href="mailto:CEStours@shellypalmer.com?subject=CES%20Show%20Floor%20Tours">CEStours@shellypalmer.com</a>.</div>
</div>
<br />
