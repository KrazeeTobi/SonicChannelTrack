...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Hotel/Travel
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<img alt="" src="/getattachment/1d5587bf-f988-4ba9-bf9e-a53a6bfbe26c/.aspx" />
  </div><div class="left">
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='hotel-travel first end'><a href='/Hotel-Travel.aspx'>Hotel/Travel</a></li></ul>

</div>
<div id="inner-content-long">

<div class="grid-box ">
    <h2><a href='/Hotel-Travel/Hotel-Reservations.aspx'>Hotel Reservations</a></h2>
    <div>
        <img style='float:right;padding: 2px 5px 10px 10px;' src='/cesweb/media/CESWeb/Thumbnails%20(Green%20Box)/Strip_Thumb.jpg'  />
        The only thing more important than registering for CES is&nbsp;booking hotel and flight accommodations for CES.
    </div>
</div>
<div class="grid-box ">
    <h2><a href='/Hotel-Travel/CES-Block-Request-Form.aspx'>Room Block Request</a></h2>
    <div>
        
        If you require&nbsp;<strong>20 rooms or more</strong>, use this form to submit your request to a participating International CES hotel.
    </div>
</div>
<div class="grid-box  end">
    <h2><a href="/Hotel-Travel/Airline-Discounts.aspx">Airline Discounts</a></h2>
    <div>
        <img style='float:right;padding: 2px 5px 10px 10px;' src='/cesweb/media/CESWeb/Thumbnails%20(Green%20Box)/Airplane_thumb.jpg?width=60&height=75&ext=.jpg'  />
        We know traveling in this economy is tough, but there are ways to curb costs. Here are ways to get the best deal on airfare to the International CES.
    </div>
</div>
<div class="grid-box ">
    <h2><a href='/Hotel-Travel/CES-Shuttle-Service.aspx'>CES Shuttle Service</a></h2>
    <div>
        
        Travel from your hotel to the show, and get around all CES venues &mdash; for free.
    </div>
</div>
<div class="grid-box ">
    <h2><a href='/Hotel-Travel/Las-Vegas-Monorail.aspx'>Las Vegas Monorail</a></h2>
    <div>
        
        Traveling at a top speed of 50 mph, the monorail is often the quickest travel option to and from the International CES.
    </div>
</div>
<div class="grid-box  end">
    <h2><a href='/Hotel-Travel/Transportation,-Parking,-and-Car-Rental.aspx'>Transportation / Parking</a></h2>
    <div>
        
        Find pointers on airport shuttles, satellite parking and more here.
    </div>
</div>
<div class="grid-box ">
    <h2><a href="/Hotel-Travel/Las-Vegas-Travel-Tips.aspx">Las Vegas Travel Tips</a></h2>
    <div>
        <img style='float:right;padding: 2px 5px 10px 10px;' src='/cesweb/media/CESWeb/Thumbnails%20(Green%20Box)/VegasSign_thumb.jpg?width=60&height=75&ext=.jpg'  />
        What&#39;s the weather? What&#39;s the tipping policy? Use this Vegas travel guide to help you.
    </div>
</div>
<div class="promo-box ">
<a href="/About-CES.aspx"><img src="/cesweb/media/CESWeb/226x200%20Banner%20Ads/Save_the_date_226x200.jpg" width="227" height="200"></a>
</div>
 &nbsp;</div>
</div>
</div>
