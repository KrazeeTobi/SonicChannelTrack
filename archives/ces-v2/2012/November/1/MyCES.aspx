...
<head id="head"><title>
	2013 International CES, January 8 - 11 - MyCES
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/MyCES.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<img alt="" src="/cesweb/media/CESWeb/MY_CES_2k10.gif" style="width: 128px; height: 85px; float: left; " />With the MyCES Planner, you can&nbsp;create a personalized show agenda that allows you to:<br />
<ul>
	<li>
...
<a href="http://www.mapyourshow.com/shows/index.cfm?SHOW_ID=CES13&amp;alt_entry=true&amp;curr_pri=agenda&amp;curr_sec=_myabout">If you already have a MyCES account</a>, take advantage of these tools and start planning your show today!&nbsp;<a href="http://ces13.mapyourshow.com/5_0/myshow/login.cfm/">If you don&rsquo;t have a MyCES account, create one today</a>, watch the 2013 CES come to life as we add new exhibitors, events and announcements,&nbsp;and start planning your show today!<br />
<br />
<table border="0" cellpadding="0" cellspacing="0">
	<tbody>
		...
		<tr align="middle">
			<td>
				<a href="http://ces13.mapyourshow.com"><img alt="" src="/cesweb/media/CESWeb/dir-search(1).jpg" style="width: 95px; height: 87px; border-width: 0px; border-style: solid; " /></a></td>
			<td>
				<a href="http://ces13.mapyourshow.com/5_0/exhibitor_results.cfm?type=list&amp;list=featured"><img alt="" src="/cesweb/media/CESWeb/featured-exhibitors(1).jpg" style="width: 95px; height: 87px; border-width: 0px; border-style: solid; " /></a></td>
			<td>
				<a href="http://ces13.mapyourshow.com/5_0/advanced_search.cfm?by=category"><img alt="" src="/cesweb/media/CESWeb/product-search(2).jpg" style="width: 95px; height: 87px; border-width: 0px; border-style: solid; " /></a></td>
			<td>
				<a href="http://ces13.mapyourshow.com/5_0/myshow/login.cfm"><img alt="" src="/cesweb/media/CESWeb/myplanner(1).jpg" style="width: 95px; height: 87px; border-width: 0px; border-style: solid; " /></a></td>
			<td>
				<a href="http://www.mapyourshow.com/shows/index.cfm?Show_ID=CES13" onclick="OpenMapYourShowMax(this.href,this.target);return false" target="floorplan"><img alt="" src="/cesweb/media/CESWeb/maps(2).jpg" style="width: 95px; height: 87px; border-width: 0px; border-style: solid; " /></a></td>
			<td>
				<a href="http://ces13.mapyourshow.com/sessions"><img alt="" src="/cesweb/media/CESWeb/conferences.jpg" style="width: 95px; height: 87px; border-width: 0px; border-style: solid; " /></a></td>
			<td>
				&nbsp;</td>
		</tr>
		<tr>
