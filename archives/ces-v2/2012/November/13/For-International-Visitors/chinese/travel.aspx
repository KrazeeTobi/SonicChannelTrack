...
<head id="head"><title>
	2013 International CES, January 8 - 11 - 旅行和签证信息
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/chinese/travel.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='chinese'><a href='/For-International-Visitors/chinese.aspx'>汉语</a></li><li class='travel end'><a href='/For-International-Visitors/chinese/travel.aspx'>旅行和签证信息</a></li></ul>
...
<span class="paragraphHeader">需要知道住宿旅馆信息吗?</span>
<p><a href="/Hotel-Travel/Hotel-Reservations.aspx">访问:&nbsp; hotel section of CESweb.org (in English)</a>&nbsp;网站的旅馆部分，预订团体和个人的旅馆住房。</p>

<span class="paragraphHeader">需要知道如何抵达国际消费电子产品展 CES吗? </span>
<p><a href="/Hotel-Travel.aspx">请访问： travel section of CESweb.org&nbsp;(in English)</a>&nbsp;以了解最理想的飞机票价、租车费率以及有关现场交通信息。</p>


    <hr class="separator" />
<h3></h3>

<span class="paragraphHeader">您需要签证吗？</span>
<p><a href="https://ceac.state.gov/genniv/" target="_blank">现在您可以上网填写签证申请表 。</a>&nbsp;</p>

<span class="paragraphHeader">需要帮助吗？</span>
<p>有关按部就班的说明、网站地址和使您成功通过签证申请程序的其他信息，请下载&nbsp;<a href="/cesweb/media/CESWeb/Documents/International/CES_VisaTips_Chinese.pdf" target="_blank">Visa Tip Sheet&nbsp; （签证提示单）。</a></p>


    <div style="border:#9f9f9f 1px solid; padding: 5px;"><h3>
	对于根据免签证计划旅行的参加者之重要通知</h3>
所有电子旅行审批系统（ESTA）登记申请或更新都需要用信用卡或借记卡支付14美金的费用。该规定自2010年9月8日起生效。现有ESTA 登记至其逾期日之前仍旧有效。有关详情请&nbsp;<a href="http://cbp.gov/xp/cgov/travel/id_visa/esta/" target="_blank">访问美国国土安全部海关与边境保护局网站上的 ESTA 网页</a>。<br />
</div>
</div>
