...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Show Floor
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<img alt="" src="/getattachment/498b6c84-caf7-4473-bd01-b2f3a16006f3/.aspx" />
  </div><div class="left">
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='show-floor first end'><a href='/Show-Floor.aspx'>Show Floor</a></li></ul>

</div>
<div id="inner-content-long">

<div class="grid-box ">
    <h2><a href='/Show-Floor/By-Exhibit-Halls.aspx'>By Exhibit Hall</a></h2>
    <div>
        <img style='float:right;padding: 2px 5px 10px 10px;' src='/cesweb/media/CESWeb/Thumbnails%20(Green%20Box)/CES_thumb.gif'  />
        CES uses two large venues and covers more space than 35 (American) football fields.&nbsp;Get nice, easy-to-scan lists of show floor destinations&nbsp;based on different areas of the LVCC/LVH and The Venetian.
    </div>
</div>
<div class="grid-box ">
    <h2><a href='/Show-Floor/By-Product-Category.aspx'>By Product Category</a></h2>
    <div>
        
        CES represents 15 product categories.&nbsp;If you have a particular consumer technology market in mind, use this list to see where you&#39;ll find it on the show floor.
    </div>
</div>
<div class="grid-box  end">
    <h2><a href="/Show-Floor/CES-TechZones.aspx">CES TechZones</a></h2>
    <div>
        <img style='float:right;padding: 2px 5px 10px 10px;' src='/cesweb/media/CESWeb/Thumbnails%20(Green%20Box)/techzone_thumb.gif?width=65&height=15&ext=.gif'  />
        The spotlight shines brightly on several key vertical markets. Immerse yourself in them through 20+&nbsp;CES TechZones&nbsp;showcasing emerging products and companies.
    </div>
</div>
<div class="grid-box ">
    <h2><a href="/Show-Floor/CES-Mobile-App.aspx">CES Mobile App</a></h2>
    <div>
        
        If you have a tablet or smartphone, or any other handheld web-enabled device, you can build your schedule and plan your time at CES on the go &ndash; anywhere, anytime!
    </div>
</div>
<div class="grid-box ">
    <h2><a href="/www.mapyourshow.com/shows/index.cfm-SHOW_ID-CES13-alt_entry-true-curr_pri-facility-curr_sec-OO">Floor Plans</a></h2>
    <div>
