...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Call for Speakers
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Conference-Program/Call-for-Speakers.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='conference-program first'><a href='/Conference-Program.aspx'>Conference Program</a></li><li class='call-for-speakers end'><a href='/Conference-Program/Call-for-Speakers.aspx'>Call for Speakers</a></li></ul>
...
<div>
The&nbsp;Call for Speakers for the 2013 CES has officially closed.&nbsp; If you would like to submit to our back-up list, please visit the&nbsp;&nbsp;<a href="http://speaker.ce.org/index.cfm?do=cnt.page&amp;pg=1003">Speaker Ready Room</a>&nbsp;to utilize our submission management tool.&nbsp; We will keep your submission on file to use as a resource for any CES speaker cancellations.<br />
<br />
<table border="0" cellpadding="1" cellspacing="1" width="100%">
	<tbody>
		<tr>
			<td style="width:225px;">
				<img alt="" src="/cesweb/media/CESWeb/image%20gallery/CES_Conferences.jpg" style="width: 190px; height: 136px; " /></td>
			<td>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td style="width:225px;">
				<img alt="" src="/cesweb/media/CESWeb/image%20gallery/CES_Conferences2.jpg" style="width: 190px; height: 136px; " /></td>
			<td>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td style="width:226px;">
				<img alt="" src="/cesweb/media/CESWeb/image%20gallery/CES_Conferences3.jpg" style="width: 190px; height: 136px; " /></td>
		</tr>
		<tr>
			<td>
				&nbsp;</td>
...
Conference sessions included in the back-up submission form for the 2013&nbsp;International CES Call for Speakers are:<br />
<strong>Business Insights</strong><br />
<ul>
	<li>
		Bring Your Own Device: Strategies for Securing Information in the Enterprise</li>
	<li>
		The Future of Brick and Mortar in an Online World</li>
	<li>
		I&nbsp;Know Where You Are and What You Just Bought</li>
</ul>
<strong>Content and Disruptive Technology</strong><br />
<ul>
	<li>
		Rise of the Second Screen: What it Means to Engage the Viewer</li>
	<li>
		Reinventing TV Through Streaming</li>
	<li>
		Anytime Anywhere Content</li>
	<li>
		How the Cloud is Changing Hardware</li>
	<li>
		Privacy and Security in the Cloud</li>
</ul>
<strong>Emerging Technology</strong><br />
<ul>
	<li>
		User Interface: What it Will Look Like in&nbsp;Five years</li>
	<li>
		The Download on New Display Technologies</li>
</ul>
<strong>Home Entertainment</strong><br />
<ul>
	<li>
		The Latest and Greatest in Smart TV</li>
	<li>
		Smart TV Content:&nbsp;Three Things You Need to Know to Make a Deal</li>
	<li>
		Next Gen TV: Building a 4K Ecosystem</li>
	<li>
		Three&nbsp;Trends That are Redefining the User Interface</li>
	<li>
		Game Changer: Mobile Devices and Casual Gaming</li>
</ul>
<strong>In-Vehicle Technology</strong><br />
<ul>
	<li>
		Dashboard Tech:&nbsp;Five Hot Trends Coming Down the Pike</li>
	<li>
		Are Automakers Running the Aftermarket off the Road?</li>
</ul>
<strong>Just the Facts: Research, Reports,</strong>&nbsp;<strong>Revelations</strong><br />
<ul>
	<li>
		Presentations on recent CE research topics</li>
</ul>
<strong>Lifestyle Technologies</strong><br />
<ul>
	<li>
		Where Tech Meets Fashion</li>
	<li>
		Will Tablets Rule the World?</li>
	<li>
		Connected Lifestyle Hit Parade: Winning Products and Apps</li>
	<li>
		Smart Appliances: Opportunities for Energy Consumption</li>
	<li>
		Digital Health: Retailing&#39;s Next Frontier?</li>
	<li>
		Creating a Mass Market for Digital Health Electronics</li>
</ul>
<strong>Wireless Communications</strong><br />
<ul>
	<li>
		Six Wireless Technologies You Never Heard of But Need to Know About</li>
	<li>
		The Battle of Mobile Wallet: Which Platform Will Prevail?</li>
	<li>
		Hotspot 2.0: What it Means for Wireless</li>
	<li>
		Tips to Winning the Mobile Advertising Game</li>
	<li>
		Smartphone Trends: Current and Future</li>
</ul>
For more information, please consult the&nbsp;<a href="/Conference-Program/Call-for-Speakers/Submission-FAQs.aspx">Call for Speakers FAQ.</a><br />
