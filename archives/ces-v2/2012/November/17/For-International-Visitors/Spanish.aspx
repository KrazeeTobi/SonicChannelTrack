...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Espa&#241;ol
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/Spanish.aspx" id="form">
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='spanish end'><a href='/For-International-Visitors/Spanish.aspx'>Español</a></li></ul>
...
<div id="inner-content-left">
    <h3>
	Las mentes más brillantes de la industria se reúnen aquí</h3>
Las innovaciones más avanzadas se reúnen todos los años para sorprendernos en un mismo lugar. Maravíllese en la mayor exposición mundial de tecnología para consumidores, del martes 8 al viernes 11 de enero de 2013, en Las Vegas, Nevada, EE.&nbsp;UU. Habrá 3000 expositores demostrando sus últimos productos y tecnologías, en un lugar donde cada encuentro casual se convierte en un descubrimiento, donde finalmente se develan los nuevos productos y el entusiasmo es contagioso. Asista a las <a href="http://www.cesweb.org/Events/Keynotes.aspx">conferencias magistrales del CES</a> para enterarse de las novedades que tienen para compartir algunos de los ejecutivos más dinámicos de la industria. Las 300 <a href="http://www.cesweb.org/Conference-Program.aspx">conferencias</a> contarán con 800 expositores de renombre mundial e información única sobre cómo posicionar su empresa para el éxito en 2013. &iexcl;<a href="http://registration3.experientevent.com/showCES131/Default.aspx">Regístrese ya</a>!<br />

    
<p>
    <a href="/For-International-Visitors/Spanish/travel.aspx">Informaci&#243;n de viajes y visas</a><br />
    Use esta útil información a medida que viaje hacia o de regreso de Estados Unidos.
</p><p>
    <a href="/For-International-Visitors/Spanish/hotels.aspx">Reservas de Hotel</a><br />
    Para ayudarle a hacer sus planes de viaje, CES ha negociado tarifas de hotel con descuento en ciertos hoteles de Las Vegas.
</p><p>
    <a href="/For-International-Visitors/Spanish/delegations.aspx">Programa de grupos de delegaciones</a><br />
    La Exposición Internacional CES atrae a una enorme audiencia internacional por su programa de delegaciones exitoso. Aprenda cómo organizar una delegación en su país o región o cómo sumarse a una.
</p><p>
    <a href="/For-International-Visitors/Spanish/services.aspx">Servicios Internacionales</a><br />
    Entre la gran cantidad de beneficios que se ofrecen a los participantes internacionales se encuentran los intérpretes, las recepciones especiales para hacer contactos, las áreas de trabajo dedicadas, las salas de reuniones y muchos más.
</p><p>
    <a href="/For-International-Visitors/Spanish/Informacion-general-(pdf).aspx">Informaci&#243;n general (pdf)</a><br />
    ¡Aprenda sobre la historia de la exposición, las categorías actuales de productos, las próximas fechas y mucho más en su idioma! 
</p><p>
    <a href="/For-International-Visitors/Spanish/shuttles.aspx">Servicio de Transporte</a><br />
    La Exposición Internacional CES ofrece un servicio gratuito de minibuses durante los cuatro días de la exposición.
</p><p>
    <a href="/For-International-Visitors/Spanish/Recursos-para-nuevos-visitantes.aspx">Recursos para nuevos visitantes </a><br />
    Para que su planificación y primera visita al CES sea un éxito, hemos preparado para usted una Lista de recursos para nuevos visitantes.
</p>
...
&iquest;Sabía usted que las delegaciones de 15 o más concurrentes extranjeros reciben la inscripción complementaria Exhibits Plus?<br />
<br />
<a href="/About-CES.aspx">Infórmese más.</a>&nbsp;</div>
    </div>
    <!--<div class="right-blue-box" align="center">
        <div class="right-blue-box-header"></div>
        <div style="padding: 15px;"></div>
    </div>-->
    <div class="right-blue-box" align="center">
        <div>Certified By:<br />
<img alt="" src="/cesweb/media/CESWeb/Logos/International/International_IBPLogo.gif" style="width: 80px; height: 87px; " /><br />
The Commercial Service logo is a registered trademark of the U.S. Department of Commerce, used with permission.</div>
    </div>
</div>
