...
<head><!-- PageID 5396 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/korean/shuttles.asp">왕복 운행</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/korean.asp" class="footer">한국어 </a>&nbsp;&gt;&nbsp;왕복 운행</div>
                        </div>
                         <div class="headerbox">
                            <h1>왕복 운행</h1>
                        </div><br />
        ...
        <img alt="" style="float: right;"  src="/images/photos/CESshuttle190X136.jpg" />CES는 귀하의 시간과 돈을 절약해 드립니다! CES의 공식 호텔에 숙박하고 호텔과 라스베이거스 컨벤션 센터 및 월드 트레이드 센터(LVCC)를 왕래하는 무료 버스를 탑승하여 택시 이용 및 렌트카 비용을 절약하십시오. CES는 LVCC 주위 및 LVCC와 베네시안 호텔(The Venetian) 사이의 무료 셔틀 버스도 제공합니다. 전람회 마지막 2일에는 편리한 무료 셔틀 버스 서비스를 이용하여 공항으로 가십시오.<br />
        <br />
        <h3>셔틀 서비스</h3>
        인터내셔널 CES는 4일간의 인터내셔널 CES 전람회 기간 중 매일 무료 셔틀 서비스를 제공합니다. 저희는 또한 귀하가 네트워킹과 거래를 성공적으로 성사시킨 후 집으로 돌아갈 때 공항까지 편안하게 가실 수 있도록 도와드립니다.<br />
        <a  target="_blank" href="/docs/2012ShuttleMap_CESweb.pdf">여기서 다운로드. <br />
        <br />
        <br />
        </a>
        <h3>라스베이거스 컨벤션 센터 순환 셔틀</h3>
        라스베이거스 컨벤션 센터의 한 쪽에서 다른 쪽으로 이동할 필요가 있는 경우, 순환 셔틀을 이용하여 시간을 절약하고 피곤한 다리를 잠시 쉬게 하십시오. 셔틀 버스는 10분 간격으로 운행되며 컨벤션 센터의 5개 주요 장소에 정차합니다.<br />
        <br />
        <h3>라스베이거스 골프차 서비스</h3>
        라스베이거스 컨벤션 센터에서 무료 골프차 서비스를 이용하여 전람 시간 동안 센트럴 홀 5에서 사우스 홀 1-2의 뒷쪽으로 이동하십시오. <br />
        <br />
        <h3>베네시안 익스프레스</h3>
        익스프레스 셔틀 버스는 프레스데이 및 전람회 기간 중 베네시안 호텔과 라스베이거스 컨벤션 센터 사이를 10분 간격으로 운행됩니다. 고품질의 음향과 홈 시어터, 그리고 신흥 테크놀러지에 관심이 있으시면 베네시안 익스프레스를 이용하는 것을 잊지마십시오. <br />
        <br />
        <h3>공항 셔틀 서비스</h3>
        ...
        <p>라스베이거스 컨벤션 센터(LVCC)로 친구나 동료를 마중 나오거나 태워다 주십니까? 교통혼잡을 피하고 더 안전한 승객 승/하차를 보장하기 위해 LVCC 실버 3 주차장(Silver 3 Lot)과 골드 주차장(Gold Lot)의 일부분이 개인차량(POV) 이용 구역으로 지정되었습니다. 사우스 홀에 되도록 가까이 가시려면 Paradise Road 쪽으로 들어와서 실버 3 주차장을 이용하십시오. 노스 홀과 센트럴 홀에 가시려면 Convention Center Drive 쪽으로 들어와서 Paradise Road와 Convention Center Drive 코너에 있는 골드 주차장을 이용하십시오.</p>
        <p>참고: 운전자는 반드시 차에 남아 있어야 합니다. 주차불가.</p>
        <p> </p>
