...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <p><b>I submitted a proposal but never received a confirmation. What happened?</b><br />
        The confirmation should have come via email from <a  href="mailto:CFS@CE.org">CFS@CE.org</a> to the e-mail address submitted online. If you did not receive a confirmation, please check your junk mailbox. If you still cannot find the confirmation email, it is likely we did not receive your submission, and you should try again. If you continue to experience difficulties, please contact <a  href="mailto:CFS@CE.org">CFS@CE.org</a>. <br />
        <br />
        <b>Which session topic is most appropriate for our proposed speaker?</b><br />
        Please read the session descriptions next to the categories on the website and choose a session that best fits your expertise.  Session descriptions will be available on May 1, 2012.<br />
        <br />
        <b>Are speakers allowed to mention their products and services during their presentations?</b><br />
        ...
        <br />
        <b>Are the speaking opportunities at CES for keynote speakers or for panel discussions? </b><br />
        Keynote speaking opportunities are by invitation only. <a  href="/conferenceProgram/speakers/default.asp">The CES Call for Speakers</a> comprises <em>CES-produced </em>conference sessions, largely formatted as moderator/panel. <br />
        <br />
        <b>Is there any chance the deadline will be extended or that a short extension of a few days could be given?</b><br />
        In fairness to all prospects, the deadline is strictly enforced. </p>
        <p><strong>How do I submit for SuperSessions?<br />
        </strong>Submissions for CES-produced SuperSessions, when offered, are included in the CES Call for Speakers. <br />
        <br />
        <b>If one company executive is qualified to speak for more than one category, is it possible to submit more than one application?</b><br />
        Yes. <br />
        <br />
        <b>Are all of the speaking opportunities for panels? If so, are these discussion format or individual presentations from speakers?</b><br />
        The majority of our conference sessions are moderated panel discussions without formal presentations. <br />
        <br />
        <b>On the speaker submission form, is the word limit for the "speaker objective" a 100-word limit per topic selected or 100 words overall?</b><br />
        This word limit is overall. <br />
        <br />
        <b>How many sessions can be selected in one submission? </b><br />
        ...
        <br />
        <b>Do you prefer CES speakers to be executives, such as VPs or above? Do you also accept technologists or marketing professionals?</b><br />
        ...
        <br />
        <b>What if we want to suggest a topic not listed on the CES Call for Speakers form?</b><br />
        ...
        All Call for Speakers entries will be answered by September 2012.  </p>
        <p><b>Who is the target audience? Are sessions open to the general public? Are there any sessions tailored to exhibitors only?</b><br />
        ...
        <br />
        <b>How do I get an attendee list?</b><br />
        Attendee lists are not released publicly. <br />
        <br />
        <b>May I change the name of the speaker submitted?</b><br />
