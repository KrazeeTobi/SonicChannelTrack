...
<head><!-- PageID 5394 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/korean/hotels.asp">호텔 예약</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/korean.asp" class="footer">한국어 </a>&nbsp;&gt;&nbsp;호텔 예약</div>
                        </div>
                         <div class="headerbox">
                            <h1>호텔 예약</h1>
                        </div><br />
        ...
        <p><img alt="" style="margin: 5px; float: right;"  src="/images/photos/Vegas_200.jpg" />CES는 귀하의 여행 계획에 편의를 제공하기 위해 할인가격으로 일부 라스베이거스 호텔 객실을 확보해 두었습니다. <br />
        <br />
        호텔 및 가격 목록은 <a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a>을 참고하십시오(영어로 제공). CES 할인가격을 획득하려면 모든 객실은 반드시 <a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a>을 방문하여 호텔이름을 선택한 다음 직접 해당 호텔을 통해서 예약해야 합니다. 귀하는 해당 호텔의 예약 페이지로 안내되어 귀하의 신용카드 정보를 입력할 수 있게 됩니다. </p>
        <p>폭발적인 호응으로 대부분의 CES 호텔 객실은 현재 매진되거나 할인요금의 CES 객실이 매진된 상태입니다. 마지막 순간에 호텔 예약을 하시는 분들을 위해 CES는 추가 호텔 리스트를 작성하였습니다. 이러한 추가 호텔에는 CES 셔틀버스 서비스가 제공되지 않습니다. <a href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a> (영어로) 맨 아래에 있는 완전한 리스트를 참고하십시오.<br />
        <br />
        20개 이상의 객실이 필요한 경우, <a  href="http://www.cesweb.org/hotelTravel/blockRequest.asp">http://www.cesweb.org/hotelTravel/blockRequest.asp</a>을 방문하여 원하는 호텔(들)을 선택한 다음 직접 예약 신청을 제출할 수 있습니다. 귀하의 신청은 해당 호텔(들)로 직접 전송되며, 호텔은 3일의 영업일 이내에 응답할 것입니다.<br />
        <br />
