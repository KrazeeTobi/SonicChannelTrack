...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        The Call for Speakers for the 2013 International CES will open on May 1, 2012 and remain open until June 12, 2012.  Available sessions for submission may also be viewed at that time, and all submissions must be processed online using the <a  href="http://speaker.ce.org/index.cfm?do=cnt.page&pg=1003">Speaker Ready Room</a> management tool.<br />
        <br />
        ...
        <p>The Call for Speakers process encompasses only those sessions produced by CES.  CES conferences sessions at the 2012 International CES included:</p>
        <p><strong>Business Insights</strong></p>
        <ul>
            <li>The Consumerization of IT: How Consumer Innovation is Influencing Business</li>
            <li>Electronics Retailing in the 21st Century</li>
        </ul>
        <p><strong>Emerging Technology</strong></p>
        <ul>
            <li>CE Innovation: Going Where No One Has Gone Before</li>
            <li>Bringing the Cloud Down to Earth</li>
            <li>Smart Appliances: Ready for Prime Time?</li>
            <li>The Evolving User Interface: What’s Next?</li>
            <li>Beyond the Flat Screen</li>
            <li>Portable Power: The Quest for Longer-Lasting Batteries</li>
        </ul>
        <p><strong>Home Entertainment &amp; Lifestyle Technologies</strong></p>
        <ul>
            <li>Tablets: Where Do We Go From Here?</li>
            <li>3DTV: From Theater to Living RoomCameras and Camcorders: Adapting in the Age of Smartphones</li>
            <li>Defining the Smart-Home Market</li>
            <li>Game On</li>
            <li>Making Smart TV Smarter</li>
            <li>Navigating the Connected Home</li>
            <li>Subscription Wars</li>
            <li>3D on the Go</li>
        </ul>
        ...
        <p><strong>Just the Facts: Research, Reports, Revelation</strong></p>
        <ul>
            <li>Presentations on recent CE research topics</li>
        </ul>
        <p><strong>Wireless Communications</strong></p>
        <ul>
            <li>Mobile Payment Basics: How the Technology Works</li>
            <li>To 4G or Not to 4G</li>
            <li>Smartphones: Hot Features and Trends</li>
            <li>Planet of the Apps</li>
            <li>Mobile Payment Basics: How the Business Works</li>
            <li>Handheld Wars: Winners and Losers</li>
        </ul>
