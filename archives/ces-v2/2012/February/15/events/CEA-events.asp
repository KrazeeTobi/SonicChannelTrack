...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <br />
        Mark your calendars for the 2013 CES, which takes place in Las Vegas, Nev., January 8-11 (Tuesday, Friday), 2013, and SINOCES, China's premier consumer electronics event, held each July.<br />
        <br />
        <a  target="_blank" href="http://www.ce.org/Events/default.asp">Check out upcoming CEA events</a> such as:<br />
        <p><img width="353" height="370" alt="" style="border: 0px solid; float: right;"  width="353" height="370" src="/images/content/cea-events.jpg" /><strong>CEA Economic Retreat <br />
        </strong>February 28-March 2, 2012 <br />
        The Lodge at Vail <br />
        Vail, CO</p>
        <p><strong>CES on the Hill <br />
        </strong>April 24, 2012 <br />
        House Office Building – Rayburn (B-357) <br />
        Washington, DC</p>
        <p><strong>Digital Patriots Dinner <br />
        </strong>April 25, 2012 <br />
        Smithsonian American Art Museum <br />
        Robert &amp; Arlene Kogod Courtyard <br />
        Washington, DC</p>
        <p><strong>Spring Technology &amp; Standards Forum <br />
        ...
        New York, NY</p>
        <p><strong>CEA Line Shows <br />
        </strong>June 27-28, 2012 <br />
        New York, NY</p>
        <p><strong>iStage Competition <br />
        </strong>June 2012 <br />
        New York, NY</p>
        <p><strong>SINOCES</strong><br />
        July 5-8<br />
        Qingdo, China</p>
        ...
        California</p>
        <p><strong>CES New York Press Preview featuring CES Unveiled @ NY <br />
        </strong>November 12, 2012 <br />
        Metropolitan Pavilion <br />
        New York, NY</p>
        <p><strong>2013 International CES</strong><br />
