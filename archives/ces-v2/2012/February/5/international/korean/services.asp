...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        </strong>모든 국제 참가자들, 전시업체들, 그리고 보도진은 CES 국제 환영회에 초대됩니다. 오직 국제 참가자들만을 위힌 행사입니다. 참석하셔서, 새로운 사람들을 만나고, 업계 동료들과 사업 이야기도 나누고, 새로운 비즈니스 파트너도 개발하십시오. 올해는, 미 상무부에서 본 리셉션에서 해외에서 사업하기를 원하는 미국 회사들과 연결해 주는 프로그램을 주관할 것입니다. 환영회에서 만나뵙기 희망합니다!<br />
        </p>
        </span></p>
