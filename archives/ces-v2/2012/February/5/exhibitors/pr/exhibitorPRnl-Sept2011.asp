...
<head><!-- PageID 5761 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Exhibitor PR Newsletter - September</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/news/default.asp" class="footer">News</a>&nbsp;&gt;&nbsp;<a href="/news/newsletters.asp" class="footer">Newsletters</a>&nbsp;&gt;&nbsp;<a href="/news/exhibitorPRnl-Oct11.asp" class="footer">Exhibitor PR Newsletter</a>&nbsp;&gt;&nbsp;Exhibitor PR Newsletter - September</div>
                        </div>
                         <div class="headerbox">
                            <h1>Exhibitor PR Newsletter - September</h1>
                        </div><br />
...
<P>Questions? Contact Allison Fried at <A href="mailto:afried@CE.org">afried@CE.org</A>. <BR><BR><STRONG>CES Online Exhibitor Workshop</STRONG><A href="/exhibitors/resources/exhibitor-workshop.asp"><BR>The Exhibitor Workshop series</A> is your one-stop shop for all things related to exhibiting at the 2012 International CES. We know that first-timers and veterans alike need some assistance navigating the various aspects of exhibiting at the world’s largest consumer technology tradeshow. <BR><BR>With our free four-part web-cast series we provide you with tools to help you market and promote your brand, receive ultimate press coverage, as well as turn you into a pro when dealing with booth<BR>planning, logistics and contractor relationships. You’ll also have the chance to learn about our vendor, Map Your Show, who will be supplying our online directory and interactive floor plans. Make sure you sign up in advance to attend the following sessions in September:</P>
<UL class=text>
...
<LI class=text>Wednesday, January 11, 2012 – Day Two Press conferences or events may be held with written notification before, during or after show hours. However, events held on the show floor before or after show hours require advanced security forms and hired security guards. </LI></UL>
...
<LI class=text>October 28: Deadline for CES Unveiled@NY exhibitor listing for the NY program guide </LI></UL>
<P><STRONG>Past issues</STRONG></P>
<UL>
<P><A href="/exhibitors/pr/exhibitorPRnl-Aug2011.asp"><STRONG>August 2011</STRONG></A></P></UL>
