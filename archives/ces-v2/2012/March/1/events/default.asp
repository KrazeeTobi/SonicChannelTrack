...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
   ...
   <h2>Keynote Addresses</h2>
    ...
    <p>
        CES announces <a  href="/events/keynotes.asp">keynote speakers</a> throughout the last half of the year. In the meantime, watch videos from the most recent CES keynoters.
    </p>
</div><div class="promo-box">
    
    
       
    <A href="http://www.ce.org/Events/default.asp?siteUrl= http://speaker.ce.org/index.cfm?do=cus.meeting|meetingID=1482"><img src="/docs/HP_CESHill.jpg" width="227" height="200"></A>
</div><div class="grid-box">
