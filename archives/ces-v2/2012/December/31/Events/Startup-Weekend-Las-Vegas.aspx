...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Startup Weekend Las Vegas
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Events/Startup-Weekend-Las-Vegas.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<div class="headerbox">
      <h1>Startup Weekend Las Vegas</h1>
</div>
<div style="float: right;">
    
</div>
<div>
    <strong>January 4-6<img alt="" src="/cesweb/media/CESWeb/Events/CES-897-Startup-Weekend.jpg" style="float: right; margin: 10px;" /><br />
InNEVation Center, 3<sup>rd</sup> Floor</strong><br />
<br />
Startup Weekend&nbsp;is coming to CES! Startup Weekend&nbsp;is a 501(c)3 non-profit that brings together the entrepreneurial, web development and design communities for one weekend with one goal: going from idea to launch!&nbsp;The weekend is easily broken down into <strong>Pitch</strong>, <strong>Build</strong>,&nbsp;<strong>Present</strong>.&nbsp;Friday is pitch night&nbsp;when anyone with an idea gets one minute to pitch to the crowd. The crowd votes on the top 8-10 ideas and they start to form teams and build. They build all day Saturday&nbsp;until Sunday afternoon (with some awesome meals mixed in). Finally,&nbsp;Sunday is launch day&nbsp;where teams will have the opportunity to present their ideas to investors, industry leaders.&nbsp;The winning team will exhibit at CES Unveiled LAS VEGAS: The Official Press Event of the International CES that evening! Register and work with your partners like never before: <a href="http://swlv.eventbrite.com/">swlv.eventbrite.com</a> or <a href="http://lasvegas.startupweekend.org/">lasvegas.startupweekend.org</a><br />
