var hrefHref = '/Conference-Program/Session-Schedule.aspx'; var hrefTitle = 'Shop for Conference Sessions'; var imgSrc = '/cesweb/media/CESWeb/assets/js/ConferenceProgram/images/cesweb_shop1.png';
...
function enableCart() {
	...
	if (cart.getCartItems().length > 0) {
			...
			imgSrc = '/cesweb/media/CESWeb/assets/js/ConferenceProgram/images/cesweb_cart1.png';
