...
<div>
	...
	<tbody>
		<tr>
			<td>
				<h2>
					<strong>Brand Matters Keynote:</strong></h2>
				<p>
					Marketing in the Cloud<br />
					11 a.m. Wednesday, January 9<br />
					LVH Theater</p>
			</td>
			<td>
				<img alt="" src="/getmedia/ed59260a-2455-4689-ad80-0a75de2e19bc/BrandMatters_1.aspx?width=200&amp;height=86" style="width: 200px; height: 86px; float: left; margin: 5px;" />
				<div>
					&nbsp;</div>
			</td>
		</tr>
...
<table border="0" cellpadding="1" cellspacing="1" style="width: 500px;">
	<tbody>
		<tr>
			<td>
				<h2>
					Brand Matters SuperSession:</h2>
				<p>
					How Are Your Consumers REALLY Engaging With Digital Media?<br />
					3-5 p.m. Wednesday, January 9<br />
					LVH Theater</p>
			</td>
			<td>
				<h2>
					<img alt="" src="/cesweb/media/CESWeb/Logos/MediaLink-Logo3.jpg" style="float: right; margin: 10px 20px;" /></h2>
			</td>
		</tr>
	</tbody>
</table>
<p>
	MediaLink, in collaboration with The Intelligence Group, will bring together a panel of real young people who will be asked about their media consumption habits, and in the process begin to unearth the social, cultural, technology and media forces that are making them increasingly elusive for most marketers.&nbsp; Immediately following this consumer panel, senior management from major digital media, marketing, and/or emerging media platform companies will respond in REAL-TIME to what they just heard from their consumers!</p>
