...
<P>Eighty-five percent of all CES exhibitors cite press/media coverage as one of the most important reasons for attending the show. It's easy to see why PR is oftentimes the highest priority for exhibitors at the International CES. The more than 5,000 media and bloggers who cover CES each year are able to get a company's name into the minds of millions of consumers with the simple stroke of a keyboard. Let us help you reach the media.</P>
<H3><A href="http://www.cesweb.org/exhibitors/pr/prList.asp">Pre-Registered Press/Industry Analyst List</A></H3>
<P>Get a head start on your PR efforts and brand building with this list (updated weekly). You will need your 2012 CES exhibitor ID to access it.</P>
