...
<head><!-- PageID 5373 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/hotels.asp">Hotel Reservations</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;Hotel Reservations</div>
                        </div>
                         <div class="headerbox">
        ...
        <img alt="" style="margin: 5px; float: right;"  src="/images/photos/Vegas_200.jpg" />To assist you in your travel plans, CES negotiated discounted room rates at select Las Vegas hotels. <br />
        <br />
        See <a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a> (in English) for the full list of hotels and rates. To obtain the CES rate, all rooms must be booked directly with the hotel by visiting <a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a> and selecting a hotel name. You will be taken directly to that hotel’s reservation page where you can enter your credit card information.
        <p>Due to overwhelming popularity, most CES hotels are now sold out or sold out of the discounted CES rate. To assist with last minute hotel reservations, CES has added a list of overflow hotels. There is no CES shuttle service to/from these hotels. See full list at the bottom of <a href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a> (in English).<br />
        <br />
        If you need a block of 20 or more rooms, you may submit a request directly to your hotel(s) of choice by visiting <a  href="http://www.cesweb.org/hotelTravel/blockRequest.asp">http://www.cesweb.org/hotelTravel/blockRequest.asp</a>. Your request will go directly to the hotel(s), and the hotel will have three business days to respond.<br />
        <br />
