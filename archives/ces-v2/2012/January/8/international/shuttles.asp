...
<head><!-- PageID 5374 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/shuttles.asp">CES Shuttle Service</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;CES Shuttle Service</div>
                        </div>
                         <div class="headerbox">
        ...
        <p><img alt="" style="float: right;"  src="/images/photos/CESshuttle190X136.jpg" />CES saves you time and money! Save money on taxis and car rentals by staying at an official CES hotel and taking the free buses to/from the Las Vegas Convention and World Trade Center (LVCC). CES also provides free shuttles around the LVCC and between the LVCC and The Venetian. On the last two show days, enjoy complimentary shuttle service to the airport.</p>
        <h3>Shuttle Service</h3>
        <p>The International CES offers complimentary shuttle service on all four days of the International CES. We'll even help you get to the airport as you head home after several successful days of networking and deal making.<br />
        <br />
        <a  target="_blank" href="/docs/2012ShuttleMap_CESweb.pdf">Download it here.</a> </p>
        <h3>Las Vegas Convention Center Shuttle Loop</h3>
        ...
        <h3>Las Vegas Convention Center Golf Cart Intraconnect</h3>
        ...
        <h3>Venetian Express</h3>
        <p>Express shuttle service runs every 10 minutes between The Venetian and the LVCC, Press Day and all show days. If high-performance audio &amp; home theater and emerging technology interest you, hop aboard the Venetian Express. </p>
