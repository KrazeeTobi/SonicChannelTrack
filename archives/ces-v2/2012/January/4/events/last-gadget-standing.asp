...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <p>A perennial attendee favorite, Last Gadget Standing challenges contenders to give the product demo of their lives. At stake: bragging rights as the product "most likely to change the face of technology." See all the winners strut their stuff in this inventive, fast-paced competition. Guest emcees Gary Dell'Abate and Jon Hein from the Howard Stern Show will host the event. <br />
        <br />
