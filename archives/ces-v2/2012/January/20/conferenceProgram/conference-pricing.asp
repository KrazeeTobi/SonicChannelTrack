...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        The 2012 CES Conference Program unites, educates and illuminates trends critical to consumer technology professionals. See the pricing below, and <a  href="http://cesweb.org/conferenceProgram/default.asp">start browsing</a> sessions and tracks delivered by industry experts.<br />
        <br />
...
<div class="sub-page-slider">
    ...
    <div class="keynote-header-bak">
        ...
        <p style="clear: both;"><strong><img alt="" style="float: right;"  src="/images/content/CES_EntertainmentMatters_200pw2.jpg" />Advance: $650 <br />
        On-site: $950</strong></p>
        <p>Includes: </p>
        <ul class="text">
            <li class="text">Business Insights  </li>
            <li class="text">Cable Conference at CES </li>
            ...
            <li class="text">Home Entertainment and Lifestyle Technologies </li>
            <li class="text">In-Vehicle Technology</li>
            <li class="text">The International Academy of Web Television: Awards and Beyond</li>
    ...
    <div class="keynote-header-bak">
        ...
        <p class="text"><strong>Please note: Free conference tracks/sessions listed above are seated on a first-come, first-served basis. Pre-reigistration does not guarantee a seat.<br />
        <br />
        </strong>Looking for track details? <a  href="/conferenceProgram/conference-tracks.asp">Get them here.</a></p>
