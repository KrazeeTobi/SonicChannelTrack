...
<div class="grid-box">
   <h2>Today's Top Picks</h2>
    ...
    <p>
        <ul>
            <li><a  href="http://www.cesweb.org/conferenceProgram/conference-track.htm?track=dhth">Digital Health </a></li>
            <li><a  href="http://www.cesweb.org/conferenceProgram/conference-track.htm?track=jedec">Memory Matters </a></li>
            <li><a  href="http://www.cesweb.org/conferenceProgram/conference-track.htm?track=kpmt">Kids@Play and MommyTech </a></li>
            <li><a  href="http://www.cesweb.org/conferenceProgram/conference-track.htm?track=ul">Energy and the Smart Grid Home</a></li>
        </ul>
    </p>
