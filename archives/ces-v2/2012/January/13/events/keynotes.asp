...
<P><A href="http://bcove.me/c4lburdn" target=_blank>Watch the video.</A></P>
    ...
    <div class="keynote-right-col">
        ...
        <P><STRONG>Robert Kyncl, vice president of global content partnerships at YouTube,</STRONG> delivered the Entertainment Matters keynote address at the 2012 International CES.<BR><BR><!-- Start of Brightcove Player -->
<DIV style="DISPLAY: none"></DIV><!--
By use of this code snippet, I agree to the Brightcove Publisher T and C 
found at https://accounts.brightcove.com/en/terms-and-conditions/. 
-->
...
<DIV align=center>
<OBJECT id=myExperience1386749476001 class=BrightcoveExperience><PARAM NAME="bgcolor" VALUE="#FFFFFF"><PARAM NAME="width" VALUE="486"><PARAM NAME="height" VALUE="412"><PARAM NAME="playerID" VALUE="26356940001"><PARAM NAME="playerKey" VALUE="AQ~~,AAAABh3C_dE~,zBkXqCU8KVYYG5utII4f8nND4rqBAlFX"><PARAM NAME="isVid" VALUE="true"><PARAM NAME="dynamicStreaming" VALUE="true"><PARAM NAME="@videoPlayer" VALUE="1386749476001"></OBJECT></DIV><!-- 
This script tag will cause the Brightcove Players defined above it to be created as soon
as the line is read by the browser. If you wish to have the player instantiated only after
the rest of the HTML is processed and the page load is complete, remove the line.
-->
<SCRIPT type=text/javascript>brightcove.createExperiences();</SCRIPT>
<!-- End of Brightcove Player --><BR><BR>Kyncl has been a driving force in bringing even more original entertainment to YouTube's existing channel lineup. At the Entertainment Matters keynote, Kyncl and friends will discuss the tremendous opportunity for the web as a distribution vehicle, and how we envision the entertainment ecosystem evolving over time. The keynote is slated for 10 a.m. Thursday, January 12, in the Las Vegas Hilton Theater.<BR><BR>Entertainment Matters at CES is sponsored by Variety and Ericsson, with the Screen Actors Guild as an associate sponsor. Back for a second year, Entertainment Matters at CES is designed by and for Hollywood's film, television and digital communities and will feature exhibits, events and conference programs for entertainment professionals interested in the convergence of content and technology.<BR><BR>Entertainment industry professionals interested in registering for Entertainment Matters at CES should visit <A href="http://www.EMatCES.com">EMatCES.com</A>. 
<P><A href="/docs/youtube-transcript.pdf" target=_blank>Read the transcript.</A></P>

<P><A href="http://bcove.me/2scfhmlz" target=_blank>Watch the video.</A></P>
    </div>
</div>
    </div>
</div>
