...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        CEA sponsors a variety of events - for the entire industry and individual niches within it — to educate the masses and unite manufacturers, retailers and market movers. CEA works non-stop to grow and shape the future of consumer electronics. <a  target="_blank" href="http://www.ce.org/Events/default.asp">Check out upcoming CEA events</a> such as:<br />
