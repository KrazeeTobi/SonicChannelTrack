...
<head><!-- PageID 3985 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
            ...
            <div id="page-bottom">
                <div id="main-content">
                    ...
                    <div id="main-content-header">
                        <img src="/images/content/Subhead_Events.jpg">
                    </div>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;Events</div>
                        </div>
...
<div class="alert-box">                        
        ...
        <p>Print and go: <a  target="_blank" href="/docs/AwardsEvents.pdf">2012 CES Awards and Events flyer</a> gives you a quick rundown.</p>
    
</div><div class="grid-box">
   <h2>ESPN 3D Events</h2>
    
    
    <p>
        <img alt="" style="float: right;"  src="/images/content/ESPN3D_mini.jpg" />Football, boxing and ESPN's first studio program telecast in 3D. <a  href="/events/ESPN-events.htm">Watch them at CES!</a>
    </p>
</div><div class="promo-box">
    
    
       
    <A href="/press/events/exhibitorPressEvents.asp"><img src="/docs/Exhibitor226x200.jpg" width="227" height="200"></A>
</div><div class="grid-box">
   <h2>Last Gadget Standing</h2>
    
    
    <p>
        <a  href="/events/last-gadget-standing.asp"><img alt="" style="float: right;"  src="/images/content/CES-617-LGS_mini.jpg" />Last Gadget Standing</a> challenges contenders to give the product demo of their lives. Guest emcees Gary Dell'Abate and Jon Hein from the Howard Stern Show will host the event.<br />
        <br />
        <br />
    </p>
</div><div class="grid-box">
   <h2>Keynote Addresses</h2>
    ...
    <p>The biggest names in the industry take center stage to share insight and oftentimes bring along big-time celebs to entertain, too. CES announces <A href="/events/keynotes.asp">keynote speakers</A> throughout the last half of the year.</p>
</div><div class="grid-box">
   <h2>Mark of Excellence</h2>
    
    
    <p>
        <img alt="" style="float: right;"  src="/images/content/MOE_TechHome_mini.jpg" />New this year: <a  href="/events/mark-of-excellence.htm">A reception in honor of the 2011 Mark of Excellence System Integrator finalists and winners </a>during the 2012 CES.
    </p>
</div><div class="grid-box">
   <h2>MashBash</h2>
    ...
    <p>
        <a  href="/awards/mashable-awards.asp"><img alt="" style="float: right;"  src="/images/content/MashBash_mini.jpg" />Join the Mashable team</a> at the brand new 1OAK Nightclub during CES to celebrate the best of digital.
    </p>
</div><div class="grid-box">
   <h2>Mobile Apps Showdown</h2>
    
    
    <p>
        <img alt="" style="float: right;"  src="/images/content/MobileAppsShowdown_mini.jpg" />Apps producers have two minutes to demo their app, and an applause-o-meter measures audience enthusiasm to determine the winners. <a  href="/events/mobile-apps.asp">Who has the chops to survive showdown?</a>
    </p>
</div><div class="grid-box">
   <h2>CES Closing Party</h2>
    
    
    <p>
        <img alt="" style="float: right;"  src="/images/content/Tao_mini.jpg" />Join us at one of Vegas’ hottest nightclubs, TAO, for the <a  href="/events/tao-htm.htm">Official CES Closing Party</a> on the last night of CES, Friday, January 13.
    </p>
</div><div class="promo-box">
    
    
       
    <A href="http://www.cevision.org/"><img src="/docs/2011_Vision)NovDec.jpg" width="227" height="200"></A>
</div><div class="promo-box">
    
    
       
    <A href="http://www.cesweb.org/events/keynotes.asp"><img src="/docs/226X200_Keynotes_Locations.jpg" width="227" height="200"></A>
</div><div class="promo-box">
    
    
       
    <A href="http://www.ford.com/technology/sync/features/sync-app-link/"><img src="/docs/Ford-CES.jpg" width="227" height="200"></A>
</div><div class="grid-box">
   <h2>CEA Events</h2>
    
    
    <p><A href="/events/CEA-events.asp"><IMG style="MARGIN-LEFT: 2px" border=0 hspace=2 align=right src="/images/content/CEA_mini.gif" width=65 height=22>See what else the producer of CES</A> has for you throughout the year.</p>
</div>
...
<div class="sub-content-header">Looking for Awards Programs?</div>
<br />


        Keep track of burgeoning technology through a variety of <a  href="/awards/default.asp">awards programs that take place at CES</a>. <br />
        <br />
         
        <table style="width: 700px; height: 203px;">
            <tbody>
                <tr>
                    <td> 
                    <p style="text-align: center;"><a  href="/awards/innovations/default.asp"><img width="49" height="75" alt="" style="border: 0px solid;"  width="49" height="75" src="/images/content/CES_203_2k12_Innovations_Award_sm.jpg" /></a></p>
                    </td>
                    <td> <a  href="/awards/bestOfCES.asp"><img width="103" height="59" alt="" style="border: 0px solid;"  width="103" height="59" src="/images/content/cnet.gif" /></a></td>
                    <td> 
                    <p style="text-align: center;"><a  href="/awards/techEmmys.asp"><img width="107" height="60" alt="" style="border: 0px solid; vertical-align: middle;"  width="107" height="60" src="/images/content/Emmys-sm.jpg" /></a></p>
                    </td>
                    <td><a  href="/awards/hot-stuff.htm"> <img alt="" style="vertical-align: middle;"  src="/images/content/Hot_Stuff_50pw.jpg" /></a></td>
                </tr>
                <tr>
                    <td> <a  href="/awards/iawtv.asp"><img alt="" style="vertical-align: middle;"  src="/images/content/IAWTV_100.jpg" /></a></td>
                    <td> <a  href="/awards/pmda-awards.asp"><img width="138" height="65" alt="" style="vertical-align: middle;"  width="138" height="65" src="/images/content/PMDA_logo_150.jpg" /></a></td>
                    <td> <a  href="/awards/CES-stars.htm"><img alt="" style="vertical-align: middle;"  src="/images/content/Stars_of_CES_100pw.JPG" /></a></td>
                    <td> </td>
                </tr>
            </tbody>
        </table>
