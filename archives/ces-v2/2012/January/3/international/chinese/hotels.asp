...
<head><!-- PageID 5385 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/chinese/hotels.asp">酒店预订</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/chinese.asp" class="footer">汉语</a>&nbsp;&gt;&nbsp;酒店预订</div>
                        </div>
                         <div class="headerbox">
                            <h1>酒店预订</h1>
                        </div><br />
        ...
        <p><img alt="" style="margin: 5px; float: right;"  src="/images/photos/Vegas_200.jpg" />为了协助您的旅行计划，CES经协商在几家优选的拉斯维加斯大饭店以折扣价格取得了房间。<br />
        <br />
        详细的饭店和价格表清单请参见<a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a>（英文）。若要利用CES价格，您必须访问<a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a>并选择饭店名称后，直接向该饭店订房间。选择饭店名称时，您会直接转到该饭店的预约网页，输入您的信用卡信息。</p>
        <p>由于大受欢迎，大部分的CES饭店房间现已售完，或者以CES优惠价格的提供的房间已售空。为了协助最后一刻预订饭店的人士，CES添加了位于市区外的饭店清单。CES不提供来/往于这些饭店的接驳服务。请参见<a href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a>（英文版）下端的完整清单。<br />
        <br />
        如果需要订20个以上的房间，您可以访问<a  href="http://www.cesweb.org/hotelTravel/blockRequest.asp">http://www.cesweb.org/hotelTravel/blockRequest.asp</a>，直接向您选择的饭店提交申请。您的申请将直接传送到该饭店，饭店将在3个营业日以内回应。<br />
        <br />
