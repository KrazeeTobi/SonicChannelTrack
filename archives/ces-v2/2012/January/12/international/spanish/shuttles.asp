...
<head><!-- PageID 5378 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Servicio de Transporte</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/spanish/shuttles.asp">Servicio de Transporte</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/spanish.asp" class="footer">Español</a>&nbsp;&gt;&nbsp;Servicio de Transporte</div>
                        </div>
                         <div class="headerbox">
        ...
        <img alt="" style="float: right;"  src="/images/photos/CESshuttle190X136.jpg" />¡CES le ahorra tiempo y dinero! Alójese en un hotel oficial de CES y tome los autobuses gratuitos desde y hacia el Las Vegas Convention and World Center (LVCC) para ahorrar dinero en taxis y alquiler de automóviles. CES también ofrece un servicio gratuito de minibuses que recorren el LVCC y viajan entre el LVCC y TheVenetian. Durante los últimos dos días de la exposición, disfrute de un servicio gratuito de minibuses al aeropuerto. <br />
        <br />
        <h3>Servicio de transporte en minibús</h3>
        La Exposición Internacional CES ofrece un servicio gratuito de minibuses durante los cuatro días de la exposición. Podemos también ayudarle a llegar al aeropuerto cuando esté listo para regresar a casa al cabo de varios exitosos días de establecer redes de contacto y hacer buenos negocios.<br />
        <br />
        <a  target="_blank" href="/docs/2012ShuttleMap_CESweb.pdf">Descárguelo aquí. <br />
        <br />
        </a>
        <h3>Recorrido en minibús alrededor del Las Vegas Convention Center </h3>
        Si necesita trasladarse de un lugar del Las Vegas Convention Center a otro, use este servicio de transporte en minibús para ahorrar dinero y descansar los pies. El minibús pasa cada 10 minutos y hace parada en cinco lugares clave alrededor del edificio.<br />
        <br />
        <h3>Servicio de conexión en carrito de golf Golf Cart Intraconnect en el Las Vegas Convention Center</h3>
        Use el servicio gratuito Golf Cart Intraconnect del Las Vegas Convention Center para trasladarse de la parte posterior del salón principal Central Hall 5 a la parte posterior de los salones sur South Halls 1 y 2 durante las horas de la exposición. <br />
        <h3>Servicio de transporte Venetian Express</h3>
        El servicio de transporte expreso en minibús entre el hotel The Venetian y el LVCC pasará cada 10 minutos el Día de la prensa (Press Day) y todos los días de la exposición. Si le interesa el audio y cine en casa de alto rendimiento y las tecnologías emergentes, suba a bordo del Venetian Express. <br />
        <br />
        <h3>Servicio de transporte en minibús al aeropuerto</h3>
        <p>Hay servicio de transporte disponible al Aeropuerto Internacional McCarran desde el Las Vegas Convention Center y el hotel The Venetian (en la zona de abordaje de autobuses). El costo del viaje de ida es US$5 por persona y el servicio estará disponible cada 30 minutos durante los últimos dos días de la exposición.</p>
        <h3>
        <p>Lugares asignados para recoger/dejar pasajeros </p>
        </h3>
        <p>¿Va usted a recoger o dejar a algún amigo o colega en el LVCC? Para descongestionar el tráfico y que sea más seguro el dejar y recoger pasajeros, se han señalado partes designadas del Silver 3 Lot (Lote 3 Plateado) y del Gold Lot (Lote Dorado) del LVCC como áreas para vehículos particulares (POV). Para un ingreso más cercano a las Salas Sur, planee utilizar el Lote 3 Plateado entrando por Paradise Road. Para ingresar a las Salas Norte y Central, planee utilizar el Lote Dorado en la esquina de las calles Paradise y Convention Center Drive, entrando por Convention Center Drive.</p>
        <p>Nota: Los conductores deberán permanecer en sus automóviles; no se permite estacionarse.</p>
        <p> </p>
