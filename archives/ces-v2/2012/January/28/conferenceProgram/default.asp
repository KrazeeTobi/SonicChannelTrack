...
<div class="grid-box">
   <h2>Audio Recordings</h2>
    ...
    <p>Miss a conference session you wanted to see? Did you sit in on a dynamic panel discussion that you’d like to hear again? <a  href="http://mobiltape.com/client/CES-Consumer-Electronics-Show/">Conference session audio recordings are available for purchase!</a></p>
