...
<head><!-- PageID 304 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
   ...
   <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <title>2012 CES: Conference Program</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
            ...
            <div id="page-bottom">
                <div id="main-content">
                    ...
                    <div id="main-content-header">
                        <img src="/images/content/Subhead_Conferences.jpg">
                    </div>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;Conference Program</div>
                        </div>
...
<div class="alert-box">                        
        ...
        <p>Reminder: Conference Program Advance Registration closes 5 p.m. EST December 30th!</p>
   ...
   <h2>Today's Top Picks</h2>
    ...
    <p>
        <ul>
            <li><a  href="http://www.cesweb.org/conferenceProgram/conference-track.htm?track=silvers">Silvers Summit</a></li>
            <li><a  href="http://www.cesweb.org/conferenceProgram/SuperSessions.asp">SuperSessions</a></li>
            <li><a  href="http://www.cesweb.org/conferenceProgram/conference-track.htm?track=ips">Innovations Policy Summit</a></li>
            <li><a  href="http://www.cesweb.org/conferenceProgram/conference-track.htm?track=conf">CONNECTIONS</a></li>
        </ul>
    </p>
</div><div class="grid-box">
   <h2>Conference Brochure</h2>
    ...
    <p>
        <li>Pick up a copy on-site!</li>
        <li>View the <a  href="http://digital.virtualmarketingpartners.com/vmp/CES/conference-brochure-2012/index.php">Virtual Conference Brochure</a></li>
        <li>See the most up-to-date <a  href="http://cesweb.org/conferenceProgram/speaker-directory.htm">speaker info</a>
        <ul></ul>
            </li>
        </p>
</div><div class="grid-box">
   <h2>Tell Us What You Think</h2>
    ...
    <p>
        You can now tell us what you think of the conference sessions you attend in real-time through the conference survey tool on the <a  href="http://www.cesweb.org/showFloor/followme.asp">CES mobile app, Follow Me.</a>
    </p>
</div><div class="grid-box">
   <h2>Session Schedule</h2>
    ...
    <p>
        Watch the 2012 Conference Program come to life with <a  href="/conferenceProgram/sessions.htm">this session schedule</a>. Scroll and search to see times, dates and locations of conference sessions to plan your time at CES.
    </p>
</div><div class="grid-box">
   <h2>Conference Tracks</h2>
    ...
    <p>
        <img width="60" height="75" alt="" style="border: 0px solid; float: left; margin-left: 2px; margin-right: 2px;"  width="60" height="75" src="/images/content/Conf_Crowd_01.jpg" /><a  href="/conferenceProgram/conference-tracks.asp">Groups of sessions covering every aspect of the competitive, multibillion-dollar CE industry</a> put you on the inside track to everything new.
    </p>
</div><div class="promo-box">
    
    
       
    <A href="http://www.pantum.com"><img src="/docs/g.gif" width="227" height="200"></A>
</div><div class="grid-box">
   <h2>SuperSessions</h2>
    
    
    <p>Rise above the clutter and take away the real deal on the subjects that matter most. Get unbelievable amounts of thought-provoking information and insight into an-easy-to-digest format. <A href="/conferenceProgram/SuperSessions.asp">And do it all for free in these sessions.</A></p>
</div><div class="grid-box">
   <h2>Speaker Directory</h2>
    
    
    <p>
        <a  href="/conferenceProgram/speaker-directory.htm">See who's speaking at the 2012 CES</a>. Search or view by speaker name or company.
    </p>
</div><div class="grid-box">
   <h2>Conference Pricing</h2>
    ...
    <p>
        CES offers a variety of passes to fit every conference attendee's need. <a  href="/conferenceProgram/conference-pricing.asp">Check out this bulleted list of prices</a> to keep you under budget.
    </p>
</div><div class="grid-box">
   <h2>Speaker Services</h2>
    
    
    <p>Official International CES speakers receive complimentary registration, access to Internet-enabled c<A href="test"></A>omputers <A href="/conferenceProgram/speakers/speakerServices.asp">and more</A>.</p>
</div><div class="promo-box">
...
<!--/conferenceProgram/1F19B2B23A004A90B6369C59B4457FC3.htm--><!--/conferenceProgram/conference-track.htm--><!--/conferenceProgram/cart.htm--><!--/conferenceProgram/5B1E09B241E4497F9623589F17ADC189.htm--><!--/conferenceProgram/502EA0C6EC9F462089E381201AD884B9.htm--><!--/conferenceProgram/8B1C6F77874B41F8A7DE54CD6E08ED5E.htm--><!--/conferenceProgram/searchResults.htm-->
