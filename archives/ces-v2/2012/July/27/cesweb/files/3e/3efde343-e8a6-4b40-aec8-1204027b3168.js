$(document).ready(function(){
    ...
    var url = '';
    $.getScript(url+'/assets/js/interestHome.aspx');
    
    $.getScript(url+'/assets/js/mainNav.js');
    
    $.getScript(url+'/assets/js/jquery-twitter.aspx', function(){
        if($('#twitter').length != 0){
        $("#twitter").getTwitter({
        userName: "intlces",
        numTweets: 20,
    ...
    $.getScript(url+'/assets/js/jquery-flow-1-2-auto.aspx');
    $.getScript(url+'/assets/js/jquery-colorbox-min.aspx',function(){
        $(document).bind('cbox_complete', function(){
                setTimeout($('#colorbox').show(), 1500);
        });
    });
    $.getScript(url+'/assets/js/jflickrfeed-min.aspx',function(){
        $.getScript(url+'/assets/js/setup.aspx');
    });
    
    
    $.getScript(url+'/assets/js/jquery-easing-1-3.aspx', function(){
        $.getScript(url+'/assets/js/home_slider.aspx', function(){                                                    
    ...
    /*$.getScript(url+'/assets/js/jquery-jfeed.aspx' ,function(){
         jQuery.getFeed({
                url: '/Home/rssNews.aspx',
    ...
    $.getScript(url+'/assets/js/jquery-jgfeed.aspx', function(){
            ...
            for(i=0; i< inames.length; i++) {
                ...
                switch (i)
                {
                    ...
                    case 12:
                        ...
                        break;
                    case 13:
                        flipped[i].src = '/assets/images/EMatCES2.aspx';
                        break;
                    default:
                }
            }
