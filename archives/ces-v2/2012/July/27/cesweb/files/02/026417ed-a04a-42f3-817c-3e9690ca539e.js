$(document).ready(function(){
	...
	setTimeout(function(){
		...
		if ( event.which == 13 ) {
			...
			var url = "/Search.aspx?searchmode=anyword&searchtext=" + searchbox;
			window.location = url;
		}
	...
	var url='';
	$.getScript(url+'/assets/js/mainNav.aspx');
	$.getScript(url+'/assets/js/rollOver.aspx');
//	$.getScript(url+'/assets/js/flashDetect.aspx');
	$.getScript(url+'/assets/js/emailPage.aspx');
	
	$.getScript(url+'/assets/js/jquery-expander.aspx', function(){
	...
	for(var i = 1;i <= 3;i++){
		$(".preload").append('<img src="/assets/images/arrow_left'+i+'.aspx" style="display: none;" />');
		$(".preload").append('<img src="/assets/images/arrow_right'+i+'.aspx" style="display: none;" />/>');
	}
	...
	$(".sub-page-slider-right").mousedown(function(){
		$(this).css({"background":"url('/assets/images/arrow_right3.aspx') no-repeat 0px 0px"});
	}).mouseup(function(){
		$(this).css({"background":"url('/assets/images/arrow_right2.aspx') no-repeat 0px 0px"});
		$(this).hover(function(){
			$(this).css({"background":"url('/assets/images/arrow_right2.aspx') no-repeat 0px 0px"});
		},function(){
			$(this).css({"background":"url('/assets/images/arrow_right1.aspx') no-repeat 0px 0px"});
		});
	});
	$(".sub-page-slider-left").mousedown(function(){
		$(this).css({"background":"url('/assets/images/arrow_left3.aspx') no-repeat 0px 0px"});
	}).mouseup(function(){
		$(this).css({"background":"url('/assets/images/arrow_left2.aspx') no-repeat 0px 0px"});
		$(this).hover(function(){
			$(this).css({"background":"url('/assets/images/arrow_left2.aspx') no-repeat 0px 0px"});
		},function(){
			$(this).css({"background":"url('/assets/images/arrow_left1.aspx') no-repeat 0px 0px"});
		});
	});
...
if (document.images) {
	...
	for(i=0; i< inames.length; i++) {
		...
		{
			case 0:
				flipped[i].src = '/assets/images/cesweb_menu_exhibitor2.aspx';
				break;
			case 1:
				flipped[i].src = '/assets/images/cesweb_menu_conference2.aspx';
				break;
			case 2:
				flipped[i].src = '/assets/images/cesweb_menu_events2.aspx';
				break;
			case 3:
				flipped[i].src = '/assets/images/cesweb_menu_awards2.aspx';
				break;
			case 4:
				flipped[i].src = '/assets/images/cesweb_menu_showfloor2.aspx';
				break;
			case 5:
				flipped[i].src = '/assets/images/cesweb_menu_hoteltravel2.aspx';
				break;
			case 6:
				flipped[i].src = '/assets/images/cesweb_menu_news2.aspx';
				break;
			case 7:
				flipped[i].src = '/assets/images/cesweb_menu_faq2.aspx';
				break;
			case 8:
				flipped[i].src = '/assets/images/cesweb_register2.aspx';
				break;
			case 9:
				flipped[i].src = '/assets/images/cesweb_exhibit2.aspx';
				break;
			case 10:
				flipped[i].src = '/assets/images/cesweb_exhibitors2.aspx'
				break;
			case 11:
				flipped[i].src = '/assets/images/cesweb_press2.aspx';
				break;
			case 12:
				flipped[i].src = '/assets/images/cesweb_visitors2.aspx';
				break;
			case 13:
				flipped[i].src = '/assets/images/EMatCES2.jpg';
				break;
			default:
				break;
		}
