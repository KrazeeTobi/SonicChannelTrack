...
<head><!-- PageID 471 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Transportation, Parking and Car Rental</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li ><a href="/hotelTravel/blockRequest.asp">2013 CES Block Request Form</a></li>
            ...
            <li class="selected"><a href="/hotelTravel/cars.asp">Transportation, Parking and Car Rental</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/hotelTravel/default.asp" class="footer">Hotel/Travel</a>&nbsp;&gt;&nbsp;Transportation, Parking and Car Rental</div>
                        </div>
                         <div class="headerbox">
...
<TBODY>
<TR>
<TD vAlign=top>Cabs abound in Vegas, but parking is a bit harder to come by. Find pointers on&nbsp;airport shuttles, satellite parking&nbsp;and more here. Knowing what to expect when it comes to getting around Las Vegas is the best way to save time and avoid long lines!&nbsp;</TD>
<TD vAlign=top><IMG hspace=5 align=right src="/images/photos/GenTransp190X136.jpg" width=190 height=136></TD></TR></TBODY></TABLE>



<div class="blue_box" id="5189">
    <ul>
        
        
        <li><a class="sub-page-slider-link" href="#5772">Designated Passenger Pick-up/Drop-off </a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5191">Airport Shuttles and Limos</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5190">Car Rental Discounts</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5192">Taxi Service</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5193">Parking</a></li>
...
<script type="text/javascript">
    var SecondItems = $("#5189 ul:first li:nth-child(3n+2)");
    var ThirdItems = $("#5189 ul:first li:nth-child(3n)");

    $("#5189 ul:eq(1)").append(SecondItems);
    $("#5189 ul:eq(2)").append(ThirdItems);
    $("#5189 ul:eq(2)").append($("#5189 .sub-page-slider-link-show-all").parent());

    $(document).ready(function() {
        $("#5189 .sub-page-slider-link-show-all").click();
    });
</script>
...
<div class="sub-page-slider">
    <div class="sub-page-slider-nav">
        ...
        <div class="sub-page-slider-top-header">Transportation, Parking and Car Rental</div>
        <div class="sub-page-slider-bottom-header"></div>
        <div class="push"></div>    
    </div>
    <div>
        <div class="sub-slide" id="5772">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Designated Passenger Pick-up/Drop-off </h2>
    </div>
    
        Are you picking up or dropping off a friend or colleague at the LVCC? To alleviate traffic congestion and make it safer to drop off and pick up passengers, designated portions of the LVCC Silver 3 Lot and Gold Lot have been designated as privately owned vehicle (POV) areas. For access closest to South Halls, plan to use the Silver 3 Lot by entering off of Paradise Road. For access to North and Central Halls, plan to use the Gold Lot at the corner of Paradise and Convention Center Drive by entering off of Convention Center Drive. <br />
        <br />
        Note: Drivers must remain with their cars; no parking allowed.
    
    <br />
    <br />
</div><div class="sub-slide" id="5191">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Airport Shuttles and Limos</h2>
    </div>
    
        <p>CES does not offer shuttle service from McCarran Airport. However, there are several companies that do. Limo service is also available. Limos and shuttles are located on the west side of baggage claim, outside door exits 7-13. A full list of limo/shuttle companies can be found on <a  href="http://www.mccarran.com/03_shuttles_01.asp">http://www.mccarran.com/03_shuttles_01.asp</a>. A partial list is below. <br />
        <br />
        Please note CES does not endorse or represent any of the companies listed. <br />
        <br />
        <strong>Ambassador/Ritz<br />
        </strong>The fastest most efficient way to get to Las Vegas Strip or Downtown Hotels. Transportation is on a Share-A-Ride Basis. Service is also available to off-Strip locations.<br />
        <a  target="_blank" href="http://www.shuttlelasvegas.com/">http://www.shuttlelasvegas.com/</a> <br />
        <br />
        <strong>Bell Trans<br />
        </strong>Bell Trans offers share-a-ride Airport Shuttle Service to and from McCarran International Airport and hotels/motels located on (and near) the Las Vegas Strip and Downtown Areas. <br />
        <a  target="_blank" href="http://www.bell-trans.com/shuttle.php">http://www.bell-trans.com/shuttle.php</a> <br />
        <br />
        <strong><img alt="" style="float: right;"  src="/images/content/mwtvLogo.jpg" />MWTravelVegas.com<br />
        </strong>Offers private car, limousine and buses direct to your hotel. Book early for availability. Shuttle service is available. Prearrange your airport service and avoid the long lines. Included in your service is, meet and greet, assistance with your luggage and escort to your vehicle. Individual and group rates. <a  href="http://www.mwtravelvegas.com">www.mwtravelvegas.com</a> <br />
        <br />
        <strong>V Transportation<br />
        </strong>V Transportation can provide you with party bus and limousine transportation services. We specialize in group transfers between all points and places in and near Las Vegas such as McCarran International Airport, hotel casino resorts, and the Las Vegas Convention Center. Please visit our website or call us at 877-417-1312 for more information.<br />
        <a  href="http://www.VPartyBus.com">http://www.VPartyBus.com</a></p>
    
    <br />
    <br />
</div><div class="sub-slide" id="5190">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Car Rental Discounts</h2>
    </div>
    
        <p><a  href="test"></a><strong>Dollar Rent A Car- the Official Rental car of CES <a  target="_blank" href="http://www.dollar.com/default.aspx?corpdiscnbr=CM2355"><img alt="" style="float: right;"  src="/images/content/DOL-10-off-button2.jpg" /></a></strong><a  target="_blank" href="http://www.dollar.com/default.aspx?corpdiscnbr=CM2355"><strong><br />
        </strong></a>Save 10 percent with Dollar Rent a Car, the official car rental company of the 2012 CES. <br />
        <br />
        This URL must be used in order to view and receive the discount:  <span style="color: #1f497d;"><a  href="http://www.dollar.com/default.aspx?corpdiscnbr=CM2355">www.dollar.com/default.aspx?corpdiscnbr=CM2355</a></span></p>
    
    <br />
    <br />
</div><div class="sub-slide" id="5192">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Taxi Service</h2>
    </div>
    Hail a cab at the taxi stands at all CES show locations, including the North Hall and South Hall of the Las Vegas Convention Center (LVCC), the front entrance of the Hilton,&nbsp;and the front entrance of The Venetian. <BR><BR>Taxi fares cost approximately $10-12 per trip from McCarran International Airport, the LVCC or&nbsp;The Venetian&nbsp;to Las Vegas Boulevard hotels ("The Strip"). Taxi fares from the LVCC or The Venetian to McCarran International Airport cost approximately $15 per trip. CES also offers an <A href="/hotelTravel/shuttle.asp">airport shuttle</A> on Saturday and Sunday for $5.<BR>
    <br />
    <br />
</div><div class="sub-slide" id="5193">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Parking</h2>
    </div>
    Parking is limited. We strongly encourage International CES attendees to take advantage of the <A href="/hotelTravel/shuttle.asp">complimentary CES shuttle bus</A> from official hotels.<BR><BR><STRONG>Las Vegas Convention Center:</STRONG><BR>If you need to, park in the Gold Lot at the LVCC located on the corner of Paradise Road and Convention Center Drive for $10 a day. There are also several satellite parking lots around the convention center, including the neighboring Las Vegas Hilton and Renaissance Las Vegas.&nbsp;&nbsp;Coming soon:&nbsp;a map and list of LVCC satellite (overflow) parking lots. &nbsp;<BR><BR><STRONG>The Venetian:<BR></STRONG>The Venetian offers complimentary on-site parking to all hotel guests on a first-come, first-served basis. <BR><BR><STRONG>Cell Phone Waiting Lot:</STRONG><BR>The Blue Lot at the Las Vegas Convention Center is available for private charter staging. In the event that the Blue Lot fills, CES has established a cell phone waiting area in the Green Lot. Please note this cell phone waiting area is for cars, limos and small coaches; large coaches are not permitted. Drivers must wait with their vehicles. 
<P></P>
<P><STRONG>Other Satellite/Hotel Lots:<BR></STRONG>Most hotels on the Las Vegas Strip offer free on-site parking. If you wish, you may park your car at a hotel serviced by the <A href="/hotelTravel/monorail.asp">LV Monorail </A>and then take the Monorail to the Las Vegas Convention Center. Please note, the monorail does not go to The Venetian. Please see the <A href="/hotelTravel/monorail.asp">LV Monorail section of CESweb</A> for more information on pricing and schedules.</P>
    <br />
    <br />
</div>
    </div>
