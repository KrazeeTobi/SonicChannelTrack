...
<head><!-- PageID 5499 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Last Gadget Standing</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/events/last-gadget-standing.asp">Last Gadget Standing</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/events/default.asp" class="footer">Events</a>&nbsp;&gt;&nbsp;Last Gadget Standing</div>
                        </div>
                         <div class="headerbox">
        ...
        <p><img alt="" style="float: right;"  src="/images/content/CES-617-LGS_200_pw.jpg" /><strong>10:30 a.m. Thursday, Jan. 12, 2012<br />
        LVCC, North Hall, Room N255-N257</strong></p>
        <p>A perennial attendee favorite, Last Gadget Standing challenges contenders to give the product demo of their lives. At stake: bragging rights as the product "most likely to change the face of technology." Guest emcees Gary Dell'Abate and Jon Hein from the Howard Stern Show hosted the event. </p>
        <p>So who won? <a  href="http://www.lytro.com/">The Lytro camera</a> has been named the winner of Last Gadget Standing. </p>
...
<div class="sub-content-header">Last Gadget Standing Finalists</div>
<br />
