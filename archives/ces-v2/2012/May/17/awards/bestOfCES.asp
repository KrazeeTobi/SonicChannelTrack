...
<head><!-- PageID 309 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: CNET Best of CES</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/awards/default.asp" class="footer">Awards</a>&nbsp;&gt;&nbsp;CNET Best of CES</div>
                        </div>
                         <div class="headerbox">
...
A team of editors led the way by picking the most trail blazing, innovative and category-defining products at the 2012 International CES. 
<H3>Best of CES 2012 Award Winners<IMG style="FLOAT: right" alt="" src="/images/photos/CNET_Best_of_CES2.jpg"></H3>
<P><STRONG>Best of Show: LG 55EM9600 OLED TV <BR></STRONG>The first 55-inch OLED TV announced as shipping in 2011, and the only one to get an actual model number and public ship date ("Q3"), the 55EM9800 promises the superb all-around performance of OLED (absolute black levels, ultra-fast panel and excellent viewing angles) in an ultra-thin panel.</P>
<P><STRONG>People's Voice: Razer Project Fiona <BR></STRONG>Razer's Project Fiona concept gaming tablet, shown at CES 2012, suggests that Windows 8 is a serious player in portable gaming, and that Razer is serious about moving into manufacturing computers.</P>
<P><STRONG>Cameras: Fujifilm X-Pro1<IMG style="FLOAT: right" alt="" src="/images/photos/Best_of_CES_2012.jpg"><BR></STRONG>Fujifilm bolsters its reputation as a quality camera company with the new X-Pro 1, its first mirrorless model. Targeted at professionals, the camera incorporates several innovations, including a promising new sensor and lovely hybrid viewfinder, all in a sleek retro design.</P>
<P><STRONG>Car Tech: QNX CAR 2 mobile apps platform<BR></STRONG>QNX shows us its vision for the future of dashboard technologies, including an innovative application of NFC technology to instantly and automatically Bluetooth pair a smartphone, Ultra HD voice technology that brings stereo CD quality audio to phone calls, and an apps integration for both front and backseat passengers.</P>
<P><STRONG>Cell phones: Nokia Lumia 900<BR></STRONG>Nokia uses the Consumer Electronics Show to hold a coming-out party for its new Windows Phone-based Lumia 900, with a 4.3-inch AMOLED screen and dual cameras.<IMG style="FLOAT: right" alt="" src="/images/photos/CNET_best_of_CES3.jpg"></P>
<P><STRONG>Emerging Tech: MakerBot Replicator<BR></STRONG>The MakerBot Replicator one-ups the Cube 3D with "dualstrusion" technology, meaning it can print objects in multiple colors and materials. Pre-orders available now for $1,999, shipping in 6 weeks.</P>
<P><STRONG>Home Theater: Simple.TV<BR></STRONG>The Simple.TV DVR might just be the next-big thing for cable-cutters. It's improbably a DVR without a built-in hard drive or video output, instead letting you supply your own hard drive, then stream live and recorded over-the-air TV to the Simple.TV app available on iPad, Roku, Boxee, Google TV. Simple.TV can stream your live and recorded over-the-air TV outside your home network (Slingbox-style), as long as you sign up for the $5/month premium service. Think of it like your own personal cloud for your over-the-air TV.</P>
<P><STRONG>PCs: HP Envy 14 Spectre<BR></STRONG>The newly announced HP Spectre is the most glass-covered laptop we've ever seen, with it's all-glass lid and palm rest. At a CES devoid of many eye-popping laptops, the Spectre could be the most stylish of the bunch. Beats Audio is included on this premium ultrabook, along with an inset analog wheel for volume control, NFC support, and HP Wireless Audio.</P>
<P><STRONG>Software and apps: BlueStacks for Windows 8<BR></STRONG>Windows 8 just got a kick in the apps via BlueStacks. The program, which will ship pre-installed on select Windows 8 machines, will bring the entire Android marketplace to Microsoft's nascent OS. So when Windows 8 launches, more than 400,000 Android apps will be at your fingertips.</P>
<P><STRONG>Networking: D-Link Amplifi HD Media Router 3000<BR></STRONG>When released later this month, D-Link's Amplifi HD Media Router 3000 DIR-857 router will be the first on the market that supports USB 3.0, concurrent 450Mbps dual-band with cloud-based and HD Fuel feature that power media streaming.</P>
<P><STRONG>Tablets: Asus Memo 370T<BR></STRONG>This quad-core, Android 4.0 tablet proves that premium performance doesn't require a premium price. In spite of its $250 asking price, this tablet comes stock with 1GB of system RAM, 16GB of storage, an 8 megapixel camera, HDMI output, and a 1,280x800 resolution IPS screen.</P>
<P><STRONG>TVs: LG 55EM9600 OLED TV<BR></STRONG>The first 55-inch OLED TV announced as shipping in 2011, and the only one to get an actual model number and public ship date ("Q3"), the 55EM9800 promises the superb all-around performance of OLED (absolute black levels, ultra-fast panel and excellent viewing angles) in an ultra-thin panel.</P>
