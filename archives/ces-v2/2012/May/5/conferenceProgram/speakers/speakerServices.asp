...
<head><!-- PageID 1839 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Speaker Services</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/conferenceProgram/speakers/speakerServices.asp">Speaker Services</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/conferenceProgram/default.asp" class="footer">Conference Program</a>&nbsp;&gt;&nbsp;Speaker Services</div>
                        </div>
                         <div class="headerbox">
...
Consumer technology professionals from more than 130 countries come to the International CES to engage with its full lineup of expert speakers and panelists. Share your knowledge and gain critical name recognition as a CES speaker or panelist.<BR><BR>Official International CES speakers receive automatic registration, access to Internet-enabled computers and the opportunity to help shape the consumer technology industry.
...
<br />
        ...
        <img alt=""  src="/images/photos/speaker_crowd.jpg" style="float: right;" />As a speaker, you will be registered for the International CES automatically. Upon your arrival, please pick up your badge in the Speaker Ready Room:
        <ul class="text">
            <li class="text">LVCC, North Hall Upper Level, Room&nbsp;N263 </li>
        </ul>
        <br />
        <br />
        <br />
...
<div class="sub-content-header">On-site Speaker Ready Room</div>
<br />


        <img alt="" height="136" width="190"  src="/images/photos/speakers.jpg" style="float: right; margin-left: 8px; margin-right: 8px;" />CES speakers have access to our Speaker Ready Room. Take advantage of this area to orient yourself with the program location, fine tune your presentation and network with your peers. The Speaker Ready Room is located in the Las Vegas Convention Center above the North Hall exhibits in Room N263. <br />
        Amenities include:
        <ul class="text">
            ...
            <li class="text">Beverage service </li>
        </ul>
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
...
<IMG hspace=8 align=right src="/images/photos/sessionEquip.jpg" width=190 height=127>The standard A/V available for each conference session includes: 
<UL class=text>
...
<LI class=text>VGA switch box </LI></UL><STRONG><BR>Presentation materials<BR></STRONG>Speakers who wish to use visuals during their conference session must provide their own laptops and are encouraged to use the CES PowerPoint template, which will be available for download in the Fall.<br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
<br />
...
<div class="sub-content-header">Conference Staff Assistance</div>
<br />

<A href="mailto:amcmaster@CE.org">Amanda McMaster, Senior Manager, CES Conferences</A><BR><BR><A href="mailto:kbennett@ce.org">Kim Bennett, Senior Coordinator, Conferences</A>
                            <script type="text/javascript">
