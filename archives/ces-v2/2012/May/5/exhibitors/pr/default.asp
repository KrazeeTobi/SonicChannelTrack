...
<head><!-- PageID 5483 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;PR Help</div>
                        </div>
                         <div class="headerbox">
                            <h1>PR Help</h1>
                        </div><br />
        ...
        <p>Eighty-five percent of all CES exhibitors cite press/media coverage as one of the most important reasons for attending the show. It's easy to see why PR is oftentimes the highest priority for exhibitors at the International CES. The more than 6,000 media and bloggers who cover CES each year are able to get a company's name into the minds of millions of consumers with the simple stroke of a keyboard. Let us help you reach the media.</p>
        <h3><a  href="http://www.cesweb.org/exhibitors/pr/prList.asp">Pre-Registered Press/Industry Analyst List</a></h3>
        <p>Get a head start on your PR efforts and brand building with this list (updated weekly). You will need your CES exhibitor ID to access it.</p>
        <h3><a  href="/exhibitors/pr/prKit.asp"></a><a  href="/exhibitors/pr/prKit.asp">Exhibitor PR Kit</a> </h3>
        <p>This manual includes valuable ideas on preliminary promotion, comprehensive communications strategies, press conference and publicity tips, press kit information and much more.</p>
        <h3><a  href="http://cesweb.org/news/exhibitorPRnl-Oct11.asp">Exhibitor PR Newsletter</a></h3>
        <p>This monthly newsletter helps you keep your public relations efforts in check with valuable tips, deadline reminders and breaking news.</p>
        <p>&nbsp;</p>
        <table style="border: #9f9f9f 1px solid;" border="0" cellpadding="8" width="100%">
            <tbody>
                <tr>
                    <td><b>Essential PR Tip</b><br />
                    <a  href="https://ces12.exh.mapyourshow.com">Update your PR contact information</a> so journalists and broadcasters can find you. You must do this through your company's <a  href="https://ces12.exh.mapyourshow.com">MyCES Exhibitor Portal</a>. (Note: Exhibitor login credentials were e-mailed to the main exhibitor representative we have on file. If you're not sure who this contact is, <a  href="mailto:afried@CE.org">e-mail Allison Fried</a>.)</td>
                </tr>
            </tbody>
        </table>
