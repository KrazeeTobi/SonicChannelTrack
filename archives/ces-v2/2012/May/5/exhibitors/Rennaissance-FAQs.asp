...
<head><!-- PageID 2214 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Renaissance Hotel</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/faq/default.asp" class="footer">FAQs</a>&nbsp;&gt;&nbsp;<a href="/faq/venueFAQs.asp" class="footer">FAQs by Venue</a>&nbsp;&gt;&nbsp;Renaissance Hotel</div>
                        </div>
                         <div class="headerbox">
...
<P>The hotel has blocked specific suite numbers for CES’ use, but cannot guarantee a specific suite due to unforeseen circumstances, which may occur prior to an exhibitor’s check-in.&nbsp; Suite numbers will be given at time of check-in.&nbsp; </P><br><!--How will my customers find me if I can’t provide them a suite number prior to show opening?-->

<br><h4>How will my customers find me if I can’t provide them a suite number prior to show opening?</h4>
<P>CES will be posting signage in the Renaissance lobby, directing people to exhibitor suites. Further, the hotel concierge will have a daily list of occupied suites to direct guests.</P><br><!--Since we have paid CES for our suite, we will not need to provide any form of payment to the Renaissance, correct?-->

<br><h4>Since we have paid CES for our suite, we will not need to provide any form of payment to the Renaissance, correct?</h4>
<P>Although CES will have collected payment for your suite ahead of time, a credit card will be needed upon check-in to cover incidentals such as food service, telephone, room and tax for early arrival and late departure fees.</P><br>
...
<P>For both suites and meeting space, all food&nbsp;and beverage requirements for group events must be pre-ordered through the hotel Catering Department by December 3, 2010. Please call 702-784-5751 to arrange your food and beverage requirements. Ordering on-site will be subject to delays of up to four hours.</P><br>
...
<P>The hotel is unable to add or remove any furniture from suites. Exhibitors may not ship or bring outside furniture (couches, televisions, coffee tables, etc.), as the hotel does not have freight elevators accessible to suites to deliver such large items. For a full listing of furniture within your suite, please contact the Renaissance Las Vegas Meetings and Conventions Department at 702-784-5751.</P><br><!--Can I rent furniture for my meeting space?-->

<br><h4>Can I rent furniture for my meeting space?</h4>
<P>Exhibitors may order furniture for standard rooms sets (tables, chairs) from the Hotel at no charge. For requirements outside of a normal room set (i.e. stage, podium) please contact Janice Lenke in the Renaissance Las Vegas Meetings and Conventions Department at 702-784-5752.</P><br>
