...
<head><!-- PageID 473 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Las Vegas Monorail</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/hotelTravel/default.asp" class="footer">Hotel/Travel</a>&nbsp;&gt;&nbsp;Las Vegas Monorail</div>
                        </div>
                         <div class="headerbox">
...
<FONT face="Courier New"></FONT>&nbsp;<IMG style="MARGIN-LEFT: 5px" hspace=5 align=left src="/images/content/monorail_logo.gif" width=100 height=100><IMG style="MARGIN-LEFT: 8px" hspace=8 align=right src="/images/content/Monorail_closeup_150.jpg" width=150 height=192>Running from 7 to 3 a.m. Friday through Sunday (7 to 2 a.m. Monday through Thursday), the Las Vegas Monorail connects the Las Vegas Convention Center to a variety of hotels, including MGM Grand, Bally's, Flamingo, and Harrah's. Traveling at a top speed of 50 mph, the monorail is often the quickest travel option to and from the International CES.<BR><BR>In 15 minutes or less, Monorail riders can travel to and from the Las Vegas Convention Center and the Las Vegas Strip in a safe, clean, and climate-controlled environment. Let the monorail be your transportation solution. <BR><BR>Hop on for a one-way trip or pick up a seven day convention pass for the freedom to travel at your leisure. Avoid the hassles of traffic congestion and waiting in lines. CES&nbsp;and&nbsp;the&nbsp;Las Vegas Monorail have partnered to&nbsp;save you money. Buy your tickets online by <STRONG>December 27</STRONG> and save! It's never to early to&nbsp;purchase, as tickets are good for&nbsp;one year after date&nbsp;of purchase. <A href="https://tickets.lvmonorail.com/ces2012clbasdsfhewc" target=_blank>See the CES&nbsp;discount page&nbsp;to&nbsp;purchase tickets. </A>
<P><STRONG>2012 CES Discounted Monorail Ticket Fares </STRONG></P>
<UL class=text>
<LI class=text>One Ride Ticket: $5 (no discount)</LI>
<LI class=text>One-Day Pass: $12 (no discount)</LI>
<LI class=text>Three-Day Pass: $24 (normally $28)</LI>
<LI class=text>Seven-Day Convention Pass: $50</LI></UL>
<P>Note: Discount is only on select ticket types as noted.</P>
