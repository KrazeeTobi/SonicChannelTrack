...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
   ...
   <h2>SINOCES</h2>
    ...
    <p>
        <a  href="/events/sinoces.asp"><img width="65" height="20" alt="" style="border: 0px solid; float: right; margin-left: 2px; margin-right: 2px;"  width="65" height="20" src="/images/content/SINOCES_mini.gif" />SINOCES</a> kicks off July 5 in Qingdao, China, and showcases entertainment and content technology, digital imaging products, lifestyle electronics, automotive electronics and more.
    </p>
</div><div class="promo-box">
    
    
       
    <A href="http://www.ceweekny.com/"><img src="/docs/CEweek_226x200_fin.jpg" width="227" height="200"></A>
</div><div class="grid-box">
   <h2>Keynote Addresses</h2>
    ...
    <A href="http://www.cealineshows.com/"><img src="/docs/LineShow_226x200.jpg" width="227" height="200"></A>
</div><div class="promo-box">
    
    
       
    <A href="/exhibitors/space/default.asp"><img src="/docs/226_ExhCES_02.jpg" width="227" height="200"></A>
</div>
