...
<head><!-- PageID 648 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Direct Mail/Online Ads</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/exhibitors/default.asp-->
            ...
            <li class="selected"><a href="/exhibitors/sponsorships/directMail.asp">Direct Mail/Online Ads</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/sponsorships/default.asp" class="footer">Promotional Opportunities</a>&nbsp;&gt;&nbsp;Direct Mail/Online Ads</div>
                        </div>
                         <div class="headerbox">
...
More than&nbsp;one million pieces of direct mail and more than four million impressions of electronic direct mail to 200,000 unique readers keep International CES attendees up-to-date. Reach CES' online community&nbsp;through these opportunities.<br /><br />
<div class="page_header_block">
    <div class="blue_box">
        ...
        <li><a href="#2939">Dedicated EMail Blasts</a></li><!---->
...
<br />
        <p>The official online source for all International CES information, CESweb.org attracts thousands of qualified, consumer technology professionals each day. Online ads, especially when placed on well-trafficked, highly visible pages, can be one of the most effective and affordable marketing vehicles today. Receive online space during the show's busiest online time — September through January.<br />
        <br />
        Ads can appear on pages such as:<br />
        <br />
        Main conference program page: <a  href="http://cesweb.org/conferenceProgram/default.asp">http://cesweb.org/conferenceProgram/default.asp</a><br />
        Main events page: <a  href="http://cesweb.org/events/default.asp">http://cesweb.org/events/default.asp</a><br />
        Main show floor page: <a  href="http://cesweb.org/showFloor/default.asp">http://cesweb.org/showFloor/default.asp</a><br />
        Main hotel/travel page: <a  href="http://cesweb.org/hotelTravel/default.asp">http://cesweb.org/hotelTravel/default.asp</a><br />
        Main press page: <a  href="http://cesweb.org/press/default.asp">http://cesweb.org/press/default.asp</a><br />
        Main FAQs page: <a  href="http://www.cesweb.org/faq/default.asp">http://www.cesweb.org/faq/default.asp</a>.<br />
        <br />
        Banner ads may run September 1, 2012-February 1, 2013.<br />
        <br />
        Technical Specifications of Banner Ads: We accept the following formats: GIF and JPG.<br />
        <br />
        <strong>Marketing Investment<br />
        </strong>CES Exhibitors: $7,500 <br />
        <br />
        <strong>Contact<br />
        </strong>Manager, Promotional Opportunities, CES<br />
        Phone: 703-907-4324<br />
        Email: <a  href="mailto:byb@CE.org">byb@CE.org</a><br />
         </p>
...
<br />
        How do you guarantee CES attendees see your logo and company name? Place it alongside the one item that officially makes them CES attendees in the first place: the show badge.<br />
        <br />
        Starting in September, CES begins mailing badges to pre-registrants. By the end of December, more than 85,000 qualified CE professionals — many of them high-level decision makers and executives — have received their show credentials. Put your company logo, tagline, booth number and website address on the recognizable insert that accompanies the domestic and international attendee badge mailer. What a great way to brand early and notify attendees about your booth number, product offerings and potential giveaways.<br />
        <br />
        With four months of critical pre-show brand exposure, the deadline for this promotional opportunity comes early. Don't delay.<br />
        <br />
        A great thing about this promotional opportunity: It drives great booth traffic and drives website traffic four months before CES.<br />
        <br />
...
<br />
        <img alt="" style="float: right;"  src="/images/content/UTTM_SponsorSample.gif" />CES Up to the Minute is the regularly scheduled attendee newsletter that deploys to our attendees and prospects. Take advantage of this promotional opportunity by adding your message to our Partner Spotlight - the exhibitor advertisement section of the newsletter. Exhibitor advertisements are limited to 50 words, logo and URL. Through each newsletter you have the opportunity of reaching more than 200,000 readers, including 2013 pre-registered attendees, 2012 attendees, prospects, international attendees, VIP buyers and more.
        <p>Don’t miss out on this opportunity to include a logo, URL and 50 words about your company and product in our regularly scheduled attendee newsletter, CES Up to The Minute. Call now for details.</p>
        <a  target="_blank" href="/docs/2013_CES_Up_To_The_Minute_Sponsorship_Flyer.pdf">Download the flyer for more information and drop date options</a>.<br />
        <br />
        <strong>Marketing Investment</strong><br />
        CES Exhibitors: $5,000 for one newsletter sponsorship; $8,000 for two. <br />
        Exclusive Opportunities Available <br />
        <br />
        <strong>Contact</strong><br />
        Manager, Promotional Opportunities, CES<br />
        Phone: 703-907-4324<br />
...
<br />
        ...
        $1,000+<br />
        Cost per Thousand: $200 per 1000 names<br />
        ...
        <ul class="text">
            ...
            <li class="text">All mailings must go through a third-party mail house</li>
        </ul>
        <b>Contact<br />
        </b>Melissa Hopson, Experient<br />
        <a href="mailto:Melissa.hopson@experient-inc.com">Melissa.hopson@experient-inc.com</a><br />
        866-221-7921 or 240-439-2307
...
<br />
        <p>Send a dedicated email blast, fully branded by your company to CES attendees through our dedicated HTML email blasts. These blasts are created entirely by you and will be sent out directly by CES on your behalf. Through each e-mail blast, you will have the opportunity to reach more than 200,000 readers including 2013 CES pre-registrants, 2012 verified attendees, prospects, international attendees, VIP buyers and more. <br />
        <br />
        <a  target="_blank" href="/images/content/2012_CES_Attendee_EDM_Opportunities_Flyer.pdf">Download the flyer for more information and drop date options</a>. <br />
        <br />
        <strong>Marketing Investment</strong><br />
        $15,000+<br />
        <br />
        ...
        <ul class="text">
            <li class="text">Must be an International CES exhibitor </li>
            <li class="text">Promotion must pertain to exhibitor’s presence at the International CES, and include CES logo, show dates and website. All images and files must be housed on exhibitor’s own server. CEA will not be able to house your images for you.</li>
        </ul>
        <p><strong>Contact<br />
        </strong>Manager, Promotional Opportunities, CES<br />
        Phone: 703-907-4324<br />
