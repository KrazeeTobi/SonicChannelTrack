...
<head><!-- PageID 1358 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Exhibitor's Source Newsletter</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;Exhibitor's Source Newsletter</div>
                        </div>
                         <div class="headerbox">
                        ...
                        <div id="inner-content-long">
                            ...
                            <script type="text/javascript">
<!--
window.location = "/exhibitors/newsletter/jan12.asp"
//-->
</script>
                            <script type="text/javascript">
