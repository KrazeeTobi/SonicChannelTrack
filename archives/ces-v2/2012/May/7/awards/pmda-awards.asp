...
<head><!-- PageID 5742 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: PMDA Awards</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/awards/pmda-awards.asp">PMDA Awards</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/awards/default.asp" class="footer">Awards</a>&nbsp;&gt;&nbsp;PMDA Awards</div>
                        </div>
                         <div class="headerbox">
                            <h1>PMDA Awards</h1>
                        </div><br />
        ...
        <strong><img alt="" style="float: right;"  src="/images/content/PMDA_logo_A.jpg" />Awards Ceremony and After-Party<br />
        7:30 p.m. <br />
        January 9, 2012 <br />
        Haze Night Club, Aria Hotel<br />
        <br />
        </strong>The PhotoImaging Manufacturers and Distributors Association (PMDA), the photo industry's preeminent trade organization, will honor six individuals for their outstanding contributions to the imaging industry at their annual PMDA Awards Ceremony and after-party.
        <ul class="text">
            <li class="text">Person of the Year: Sir Howard Stringer – chairman, chief executive officer and president, Sony Corporation </li>
            <li class="text">Visionary Award: Jeffery Housenbold – president and CEO, Shutterfly </li>
            <li class="text">Lifetime Achievement Award : Mona Kelly – photo and front end consultant </li>
            <li class="text">Photographer of the Year: Carol Guzy – Pulitzer Prize Winner, The Washington Post </li>
            <li class="text">Technical Achievement Award: Tatsuo Konno – Canon Inc. </li>
            <li class="text">PMA/DIMA Lifetime Achievement Award: Dr. George Smith – Nobel Prize in Physics </li>
        </ul>
        <p>For more highlights on the successful event, visit <a  href="http://www.pmda.com">pmda.com</a>. </p>
