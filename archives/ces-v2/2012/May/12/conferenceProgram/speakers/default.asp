...
<head><!-- PageID 317 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Call for Speakers</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/conferenceProgram/speakers/default.asp">Call for Speakers</a>
        
                <ul>
            
            <li ><a href="/conferenceProgram/speakers/cfsFAQ.asp">Submission FAQs</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/conferenceProgram/default.asp" class="footer">Conference Program</a>&nbsp;&gt;&nbsp;Call for Speakers</div>
                        </div>
                         <div class="headerbox">
        ...
        Join the ranks of expert speakers who share their knowledge and insight at the International CES. The <a  href="http://speaker.ce.org/index.cfm?do=cnt.page&amp;pg=1003">Call for Speakers for the 2013 CES is now open.</a> Running from May 1 through 5 p.m. EDT June 12, 2012, all submissions must be processed online using the <a  href="http://speaker.ce.org/index.cfm?do=cnt.page&pg=1003">Speaker Ready Room</a> management tool.<br />
        <br />
        <table border="0" cellspacing="1" cellpadding="1" width="100%">
            <tbody>
                <tr>
                    ...
                    <td>     </td>
                    <td style="width: 32%;"><img alt=""  src="/images/photos/190X136_1.jpg" /></td>
                </tr>
                <tr>
        ...
        <p>The <a  href="http://speaker.ce.org/index.cfm?do=cnt.page&amp;pg=1003">Call for Speakers process</a> encompasses only those sessions produced by CES. CES conferences sessions in the 2013 International CES Call for Speakers include:</p>
        <p><strong>Business Insights</strong></p>
        <ul>
            <li>Bring Your Own Device: Strategies for Securing Information in the Enterprise</li>
            <li>The Future of Brick and Mortar in an Online World</li>
            <li>I Know Where You Are and What You Just Bought</li>
        </ul>
        <p><strong>Disruptive Technologies</strong></p>
        <ul>
            <li>Rise of the Second Screen: What it Means to Engage the Viewer</li>
            <li>Reinventing TV Through Streaming</li>
            <li>Anytime Anywhere Content</li>
            <li>How the Cloud is Changing Hardware</li>
            <li>Privacy and Security in the Cloud</li>
        </ul>
        <p><strong>Emerging Technology</strong></p>
        <ul>
            <li>User Interface: What it Will Look Like in Five years</li>
            <li>The Download on New Display Technologies</li>
        </ul>
        <p><strong>Home Entertainment</strong></p>
        <ul>
            <li>The Latest and Greatest in Smart TV</li>
            <li>Smart TV Content: Three Things You Need to Know to Make a Deal</li>
            <li>Next Gen TV: Building a 4K Ecosystem</li>
            <li>Three Trends That are Redefining the User Interface</li>
            <li>Game Changer: Mobile Devices and Casual Gaming</li>
        </ul>
        <p><strong>In-Vehicle Technology</strong></p>
        <ul>
            <li>Dashboard Tech: Five Hot Trends Coming Down the Pike</li>
            <li>Are Automakers Running the Aftermarket off the Road?</li>
        </ul>
        <p><strong>Just the Facts: Research, Reports,</strong> <strong>Revelations</strong></p>
        <ul>
            <li>Presentations on recent CE research topics</li>
        </ul>
        <p><strong>Lifestyle Technologies</strong></p>
        <ul>
            <li>Where Tech Meets Fashion</li>
            <li>Will Tablets Rule the World?</li>
            <li>Connected Lifestyle Hit Parade: Winning Products and Apps</li>
            <li>Smart Appliances: Opportunities for Energy Consumption</li>
            <li>Digital Health: Retailing's Next Frontier?</li>
            <li>Creating a Mass Market for Digital Health Electronics</li>
        </ul>
        <p><strong>Wireless Communications</strong></p>
        <ul>
            <li>Six Wireless Technologies You Never Heard of But Need to Know About</li>
            <li>The Battle of Mobile Wallet: Which Platform Will Prevail?</li>
            <li>Hotspot 2.0: What it Means for Wireless</li>
            <li>Tips to Winning the Mobile Advertising Game</li>
            <li>Smartphone Trends: Current and Future</li>
        </ul>
        <p><a  href="http://speaker.ce.org/index.cfm?do=cnt.page&amp;pg=1003">Apply to be a CES speaker today.</a> For more information, please consult the <a  href="/conferenceProgram/speakers/cfsFAQ.asp">Call for Speakers FAQ</a>.</p>
...
<!--/conferenceProgram/speakers/JTF-info.asp--><!--/conferenceProgram/speakers/JTF.asp-->
