...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <p>The 2012 International CES hosted a variety of events specifically for members of the press, including: CEA Market Research events and CES Unveiled: The Official Press Event of the 2012 International CES. Press Day kicked off on Monday January 9. </p>
        <p>A full list of exhibitor press events can be found <a  href="http://www.cesweb.org/press/events/exhibitorPressEvents.asp">here.<br />
        <br />
        </a>
        <tbody />
            <tr />
                <td style="width: 32%;" />&gt;<img alt=""  src="/images/content/190X136pconf.jpg" />
                <td />     
                <td style="width: 32%;" /><img alt=""  src="/images/content/190X136pconf2.jpg" />
                <td />     
                <td style="width: 32%;" /><img alt=""  src="/images/content/190X136pconf3.jpg" /> 
                <tr />
                    <td valign="top" /><span class="smallText"></span>
                    <td />  
                    <td valign="top" />
                    <td /> 
                    <td valign="top" /><span class="smallText"><br />
                    </span></p>
                    <p>&lt;&lt; <strong>Scroll for more CES press events by clicking on the arrows below.</strong> &gt;&gt;</p>
        ...
        <table style="width: 599px; height: 458px;">
            <tbody>
                <tr>
                    ...
                    <td>Interactive Toy Concepts</td>
                    <td>PURE</td>
                </tr>
                <tr>
                    <td>Accenture</td>
                ...
                <tr>
                    <td>Behringer </td>
                    <td>Kaijet Technology International Limited </td>
                ...
                <tr>
                    ...
                    <td>LiftMaster</td>
                    <td>ST Electronics (Info-Security) Pte Ltd</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>Wireless Accessory Solutions, LLC</td>
                </tr>
                <tr>
                    <td>Haier</td>
                ...
                <tr>
                    ...
                    <td>Other World Computing (OWC) </td>
                    <td>Zensorium</td>
                </tr>
                <tr>
                    <td>Herbert Reichter Germany/iGrip </td>
                    <td>Parrot</td>
                    <td>ZOMM, LLC</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>Powertech Industrial Co., Ltd.</td>
                    <td></td>
                </tr>
            </tbody>
        </table>
...
<P>&nbsp;</P>
    ...
    <div class="keynote-right-col">
        ...
        <p>Press Day is a MUST attend for CES media as major corporate, product and news announcements will be made. Press Day always wraps up just in time for the preshow CES keynote address.<br />
        <br />
        <a  href="http://www.cesweb.org/press/events/exhibitorPressEvents.asp">See the ever-growing list of exhibitor press events.</a> </p>
