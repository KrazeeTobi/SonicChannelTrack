...
<head><!-- PageID 5869 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: December 2011</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/exhibitors/default.asp-->
            ...
            <li class="selected"><a href="/exhibitors/newsletter/dec11.asp">December 2011</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;December 2011</div>
                        </div>
                         <div class="headerbox">
                            <h1>December 2011</h1>
                        </div><br />
...
<div align="center">
    ...
    [ <a href="/exhibitors/newsletter/dec11ops.asp">Operations</a> ]

    [ <a href="/exhibitors/newsletter/dec11ven.asp">Venetian Corner</a> ]
...
<div class="sub-content-header">Exhibitor Staff Guide is Now Available</div>
<br />


        <img alt="" style="float: right;"  src="/images/content/2012Exhibitor_StaffGuide.jpg" />Are you putting together a 2012 International CES on-site staff guide for your company? If so, we just made it a lot easier for you to create a guide for your colleagues to use on-site. Choose from an array of helpful documents – from badge holder pickup information to a list of suggested restaurants – or simply print out a complete staff guide that we have put together for you. You may want to include a personalized cover, your booth number and company contact information. Otherwise, we have taken care of the rest for you! <br />
        <br />
        <a  href="/exhibitors/resources/staff-guide.asp">Download the staff guide now</a>.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Be on the Look Out For Your Space Selection Packets</div>
<br />


        Be on the lookout in mid-December for your 2013 International CES space selection packets. These packets will be mailed to you and will include your scheduled space selection date, time and space selection number as well as web links to other space selection information such as floor plans.<br />
        <br />
        As a current CES exhibitor, you already know why CES is an important investment for your company. Next year's show in 2013 is no exception! If you want to boost your brand awareness, increase your ROI and connect with C-level decision makers, don’t miss this great opportunity to select your space for 2013. We’ll see you in 2012, and have a great show!
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Announce Celebrity Appearances and Special Events</div>
<br />


        <img alt="" style="float: right;"  src="/images/photos/LadyGaga_Polaroid.jpg" />Is your company planning a special concert with a popular chart-topper? How about an autograph session with Hollywood royalty or a product demonstration with a sports legend? If so, let us know! We can assist you with special security arrangements, staging requirements, catering requests or anything else you need to make your event a success. We’ll help you publicize it by including details on CESweb.org, in news releases and in the press room. Many exhibitors that host special events or celebrities choose not to announce their events until closer to the show and we will certainly accommodate those requests. We will also be happy to designate it as strictly invitation-only. <a  target="_blank" href="http://www.cesweb.org/docs/Sec5_Press_Conference_Request.pdf">Download this form to submit</a>.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Provide Us With Your Opinion</div>
<br />


        The Consumer Electronics Association (CEA)®, the producer of the International CES, is currently developing a panel of exhibitors. As a panel member, you will receive exciting feedback opportunities via online surveys or teleconferences/webinars that will be used as a supplement to CEA understanding your needs as a CES exhibitor. As a panelist, you would be directly interacting with show management on current and planned CES activities and initiatives to improve the show. <br />
        <br />
        CEA is seeking exhibitors interested in providing feedback in the following areas: <br />
        A. CESweb.org website, including the 2013 CES marketing campaign and the online directory listing process <br />
        B. Attracting attendees to your booth, including exhibitor invitations provided by CES <br />
        C. Best ways for show management to relay information to appropriate exhibiting personnel, including the CES Exhibitor Newsletter and the exhibitor workshop webcasts <br />
        D. CES Official Vendors, including new GES programs, Freeman A/V, Aramark<br />
        <br />
        Please email the following contact information to <a  href="mailto:exhibitoradvisoryboard@ce.org?Subject=CES%20Exhibitor%20Panel">exhibitoradvisoryboard@ce.org</a> to register for the CES Exhibitor Panel. Rest assured the information you provide will only be used in regard to this panel. <br />
        <br />
        Name: <br />
        Title: <br />
        Company: <br />
...
<div class="sub-content-header">Exporting Made Easy at CES</div>
<br />


        <img alt="" style="float: right;"  src="/images/content/USCS.jpg" />Are you a U.S. company interested in identifying new markets and reaching an international audience at CES? We’ve made it easy for you! CES is partnering with U.S. Department of Commerce to produce two exciting export focused platforms: the<a  target="_blank" href="http://export.gov/industry/infocomm/cesgmip038151.asp"> Global Market Insight Program</a> and the <a  target="_blank" href="http://export.gov/industry/infocomm/cesgmir038150.asp">Global Matchmaking and International Reception</a>. By participating in these programs, you can achieve multiple objectives, including: indentifying new markets, export counseling, increased export sales, marketing and business development initiatives. You'll also meet and prospect new customers, network with foreign buyers, foreign market experts and industry professionals. <a  target="_blank" href="http://www.cesweb.org/exhibitors/resources/export-assistance.asp">Learn more about these exciting programs</a>.
...
<tr>
    <td>
    <p align="center"><img src="/images/content/Michelle_Griffin.jpg" alt="Karen Chupka"><br>
    <span class="smallText">
    <strong>Michelle Griffin</strong><br>
   Senior Manager, Marketing</p>
    <hr align="center" width="90%" size="1" noshade color="#999999">
    <!-- article start -->
    <p><strong>Can’t Miss Last Minute Deadlines and Tips for CES</strong><br> 
by Michelle Griffin</p>
    <p>
        <p>It’s already December, and the 2012 International CES is only one month away. We are so excited for the 2012 CES, and we cannot wait to see all of you in Vegas in January. Remember, this year’s show runs on a Tuesday through Friday schedule (unlike the past few years). Additionally, we have more exhibits at The Venetian, including the new Eureka Park and PMA@CES that will run alongside Venetian mainstays like high-performance audio exhibitors and the Innovations Design and Engineering Awards Showcase. <br />
        With the craze of the holidays and with normal tradeshow prep in full swing, it’s easy to let important tasks slip through the cracks. Be sure you don’t fall behind! Here are three handy tips to help you along the way.<br />
        <br />
        1) <strong>Review the Deadline Checklist</strong>. Managing deadlines can be difficult. However, we’ve made it easy for you. Check out the <a  target="_blank" href="http://www.cesweb.org/docs/LVCC_Hilton_Deadline_Checklist%286%29.pdf">Deadline Checklist</a> that our Operations team meticulously assembled for you. Here, you’ll find the work order due dates for all official CES vendors. Some important deadlines coming up include the GES discount deadlines on both December 12 and December 21. Security orders and Freeman AV forms are due December 12 as well. Refer to it often. This <a  target="_blank" href="http://www.cesweb.org/docs/LVCC_Hilton_Deadline_Checklist%286%29.pdf">checklist</a> will become your right-hand helper in the next month.<br />
        <br />
        ...
        <br />
        3) <strong>Prepare and Distribute Your Paperless CES Press Kits.</strong> Both the LVCC and Venetian press rooms will house electronic exhibitor press kits for the 2012 International CES. This means you are welcome to put your paper-saving press kits in two areas (USB, disc or online format that you host and make known with a one-page spec sheet (8.5" x 11” max) that lists media contacts and the URL where your electronic press kit is located). Printed press materials greater than one page in length should be stored in the exhibitor’s booth. Make sure your press kit is marked clearly with the company’s name and CES booth number. Press kits are a one-stop source for the media to get information about your company and products. Information included in kits should be kept simple and to the point; remember, journalists are working fast and are after hard news.<br />
        <br />
        For more information concerning operations and logistics at CES, check the Operations <a  target="_blank" href="http://www.cesweb.org/exhibitors/showPlanning/default.asp">show planning pages</a> on CESweb.org. Also, for more PR tips be sure to refer to your <a  target="_blank" href="http://www.cesweb.org/docs/2012_Exhibitior_PR_Kit_08.30.11.pdf">Exhibitor PR Kit</a>.<br />
        <br />
        Sincerely,<br />
        <br />
        Michelle Griffin </p>
