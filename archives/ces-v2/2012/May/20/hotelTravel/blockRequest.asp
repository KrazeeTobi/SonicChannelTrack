...
<head><!-- PageID 3098 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: 2013 CES Block Request Form</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div>2013 CES Block Request Form</div>
                        </div>
                         <div class="headerbox">
                            <h1>2013 CES Block Request Form</h1>
                        </div><br />
...
// javascript for e-mail this page tool - gets the url of the page the user is on before the e-mail page tool button is clicked
	...
	<script language="JavaScript" src="/hotelTravel/blockRequest/include/js/calendar2_2013.js"></script>
	<script>
...
function validForm(passedForm)
	{
		...
		alert("Your requested dates must be between 12/26/12 and 1/16/13.")
		passedForm.input7.focus
		return false
		}
		...
		if (((radio_value=="LVH")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="Mandalay")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="MonteCarlo")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="THE")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="Trump")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="Renaissance")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="Venetian")&&(passedForm.number_of_rooms.value < 10)))
			{
		...
		if (((radio_value!="LVH")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="Mandalay")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="MonteCarlo")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="THE")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="Trump")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="Renaissance")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="Venetian")&&(passedForm.number_of_rooms.value < 20)))
			{
...
<strong>Request a group block <font style=color:#CC0000>FOR THE 2013 INTERNATIONAL CES</font> with a simple three-step process.</strong>
<ol>
<li>If you require <strong>20 rooms or more</strong>, use this form to submit your request to a participating International CES hotel. <BR />
...
<form name="block_request" method="post" action="/hotelTravel/blockRequest/rd_13blockConfirmation.asp" onSubmit="return validForm(this);" >
...
<tr>
	<td colspan="2"><font style="color:red"><b>* </b></font>Please select an official 2013 International CES hotel. (Availability subject to change. Last updated April, 2012.)
This list will be updated as hotels are confirmed/sell out.  <br/>Rates denoted with an * include mandatory resort fees. To view a list of resort fee inclusions, please <a href="blockRequest/2013CESresortfeeinclusions.pdf" target="_blank">click here</a> to view the PDF.
</td></tr>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
<tr colspan="2"><td><h3>Hotel name (off-peak/peak rate)</h3></td></tr>
<tr>
	<td width="50%" valign="top" class="text">
        <input type="radio" name="hotel" value="AlexisPark">Alexis Park ($89 flat)<br>
		<input type="radio" name="hotel" value="Aria">ARIA Resort & Casino ($215/$300*)<br>
		<input type="radio" name="hotel" value="Bellagio">Bellagio ($252/$342*)<br>
		<input type="radio" name="hotel" value="BestWestern">Best Western Mardi Gras ($49/$109)<br>
		<input type="radio" name="hotel" value="Circus">Circus Circus ($58.95/$103.95*)<br>
		<input type="radio" name="hotel" value="Encore">Encore at Wynn ($279)<br />
		<input type="radio" name="hotel" value="Excalibur">Excalibur ($80/$137*)<br>
		<input type="radio" name="hotel" value="HGVCStrip">Hilton Grand Vacations Suites- LV Strip ($95/$199 Studio; $125/$249 1 BR)<br>
		<input type="radio" name="hotel" value="LVH">LVH (formerly LV Hilton)($109/$245)<font style="color:red">**</font><br>
		<input type="radio" name="hotel" value="Luxor">Luxor ($98/$158*)<br>
		<input type="radio" name="hotel" value="Mandalay">Mandalay Bay ($152/$278*)<font style="color:red">**</font><br>
		<input type="radio" name="hotel" value="MGM">MGM Grand ($152/$264*)<br>
		<input type="radio" name="hotel" value="Mirage">Mirage ($172/$278*)<br>
		
	</td>
	<td width="50%" valign="top" class="text">
        
		<input type="radio" name="hotel" value="MonteCarlo">Monte Carlo ($115/$178*)<font style="color:red">**</font><br>
		<input type="radio" name="hotel" value="NYNY">NewYork NewYork ($123/$197*)<br>
		<input type="radio" name="hotel" value="Platinum">Platinum Hotel  & Spa ($195 flat)<br>
		<input type="radio" name="hotel" value="Renaissance">Renaissance Las Vegas ($139/$309)<font style="color:red">**</font><br />
		<input type="radio" name="hotel" value="Riviera">Riviera ($140)<br>
		<input type="radio" name="hotel" value="Signature">Signature at MGM ($162/$274*)<br>
		<input type="radio" name="hotel" value="THE">THEhotel at Mandalay ($171/$300*)<font style="color:red">**</font><br>
		<input type="radio" name="hotel" value="Treasure">Treasure Island ($209 early bird- book by 8/31)<br>
		<input type="radio" name="hotel" value="Tropicana">The NEW Tropicana Las Vegas ($128/$158)<br>
		<input type="radio" name="hotel" value="Trump">Trump International Hotel Las Vegas ($249)<br>
		<input type="radio" name="hotel" value="Vdara">Vdara ($192/$278*)<br>
		<input type="radio" name="hotel" value="Venetian">Venetian ($342*)<font style="color:red">**</font><br>
		<input type="radio" name="hotel" value="Westin">Westin Casuarina ($144/$225*)<br>
		<input type="radio" name="hotel" value="Wynn">Wynn ($269)<br>
...
<BR />
<font style="color:red"><b>**</b></font>This hotel accepts groups of 10 or more.
<br/>
<!--<table>
<tr>
...
<tr>
	<td>
		...
		<ul>
		    ...
		    <li>ARIA</li>
		    <li>Bellagio</li>
		    <li>Cosmopolitan Las Vegas</li>
		    <li>Encore at Wynn</li>
		    <li>Excalibur</li>
		    <li>Hilton Grand Vacations Club Las Vegas</li>
		    <li>Hilton Grand Vacations Club on the LV Strip</li>
		    <li>Las Vegas Hilton</li>
		    <li>Luxor</li>
		    <li>Mandalay Bay</li>
		    <li>MGM Grand </li>
		    <li>New York New York</li>
		    <li>Platinum Hotel & Spa</li>
		    <li>Renaissance</li>
		    <li>Signature at MGM Grand</li>
		    <li>THEhotel at Mandalay Bay</li>
		    <li>Treasure Island</li>
		    <li>Tropicana Las Vegas</li>
		    <li>Trump International Hotel Las Vegas</li>
		    <li>Vdara</li>
		    <li>Venetian</li>
		    <li>Westin Casuarina</li>
...
<tr>
	<td colspan=2>Please indicate the first and last nights of your block and the maximum number of rooms needed on your night of highest occupancy. <font style=color:#CC0000><strong>Show days are January 8-11, 2013.</strong></font><br>
	</td>
</tr>
