...
<head><!-- PageID 1131 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Voyage et visa</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/french.asp" class="footer">Français</a>&nbsp;&gt;&nbsp;Voyage et visa</div>
                        </div>
                         <div class="headerbox">
        ...
        <p>Informations utiles sur l’entrée aux États-Unis et la sortie du pays. </p>
        <h2>Voyage</h2>
        <p><strong>Vous voulez savoir comment vous rendre au CES ?</strong><br />
        <a  href="/hotelTravel/default.asp">Consultez la section Voyage de CESweb.org</a> (en anglais) pour obtenir les meilleurs prix pour votre billet d’avion et votre location de voiture, mais aussi pour planifier vos déplacements locaux.</p>
        <p><strong>Hôtels</strong><br />
        <a  href="/hotelTravel/hotel.asp">Consultez la section Hôtels de CESweb.org</a> (en anglais) pour vos réservations individuelles ou de groupe. </p>
        <h2>Visa</h2>
        <p><strong>Vous avez besoin d’un visa ?</strong> <br />
        <a  target="_blank" href="https://ceac.state.gov/genniv/ ">Vous pouvez désormais remplir votre demande de visa en ligne. </a></p>
        <p><strong>Vous avez besoin d’aide ? <br />
        </strong><a  target="_blank" href="/docs/French_2K12VisaTips.pdf">Téléchargez notre fiche de conseils pour les visas</a>, qui contient des instructions détaillées, les adresses de sites web importants et d’autres informations destinées à faciliter votre demande de visa.</p>
        <table style="border: #9f9f9f 1px solid;" border="0" cellpadding="8" width="100%">
            <tbody>
                <tr>
                    <td>
                    <h3>Avis important pour les participants qui voyagent en vertu du Visa Waiver Program</h3>
                    Toutes les demandes d’inscription ou de renouvellement faites sur le système électronique d’autorisation de voyage (Electronic System for Travel Authorization, ESTA) nécessitent un paiement de 14 dollars US par carte de crédit ou de débit. Les enregistrements actuels au ESTA resteront valides jusqu’à leur date d’échéance. Pour obtenir de plus amples renseignements, cliquez sur le lien suivant <a  target="_blank" href="http://cbp.gov/xp/cgov/travel/id_visa/esta/">consultez la page de l’ESTA sur le site Web du Département de la Sécurité intérieure, des Douanes et de la Protection des frontières.</a></td>
                </tr>
            </tbody>
        </table>
        <p> </p>
