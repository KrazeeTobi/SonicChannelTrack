...
<head><!-- PageID 1228 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li ><a href="/international/chinese/delegations.asp">代表团团体方案</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/chinese.asp" class="footer">汉语</a>&nbsp;&gt;&nbsp;旅行和签证信息</div>
                        </div>
                         <div class="headerbox">
                            <h1>旅行和签证信息</h1>
                        </div><br />
...
<P><SPAN class=text>以下信息有助于您出入境美国。</SPAN></P>


<h2>旅行</h2>

<P><SPAN class=text><SPAN class=subhead><STRONG>需要知道如何抵达国际消费电子产品展 CES吗? <BR></STRONG></SPAN><A href="/hotelTravel/default.asp">请访问： travel section of CESweb.org&nbsp;(in English)</A> 以了解最理想的飞机票价、租车费率以及有关现场交通信息。<BR><BR><SPAN class=subhead><STRONG>需要知道住宿旅馆信息吗?</STRONG></SPAN><BR><A href="/hotelTravel/hotel.asp">访问:&nbsp; hotel section of CESweb.org (in English)</A> 网站的旅馆部分，预订团体和个人的旅馆住房。</SPAN></P>


<h2>签证信息</h2>

<P><SPAN class=text><STRONG><SPAN class=subhead>您需要签证吗？</SPAN><BR></STRONG><A href="https://ceac.state.gov/genniv/ " target=_blank>现在您可以上网填写签证申请表 。</A> <BR><BR><SPAN class=subhead><STRONG>需要帮助吗？<BR></STRONG></SPAN>有关按部就班的说明、网站地址和使您成功通过签证申请程序的其他信息，请下载 <A href="/docs/ChineseVisaTip.pdf" target=_blank>Visa Tip Sheet&nbsp; （签证提示单）。<BR></A></SPAN></P><BR>
...
<TR>
<TD>
<H3>对于根据免签证计划旅行的参加者之重要通知</H3>
<P style="LINE-HEIGHT: 116%"><SPAN style="LINE-HEIGHT: 116%; FONT-FAMILY: SimSun; COLOR: black" lang=ZH-CN>所有电子旅行审批系统</SPAN><SPAN style="LINE-HEIGHT: 116%; FONT-FAMILY: SimSun; COLOR: black" lang=ZH-CN>（</SPAN><SPAN style="LINE-HEIGHT: 116%; FONT-FAMILY: 'Times New Roman','serif'; COLOR: black">ESTA</SPAN><SPAN style="LINE-HEIGHT: 116%; FONT-FAMILY: SimSun; COLOR: black" lang=ZH-CN>）</SPAN><SPAN style="LINE-HEIGHT: 116%; FONT-FAMILY: SimSun; COLOR: black" lang=ZH-CN>登记申请或更新都需要用信用卡或借记卡支付</SPAN><SPAN style="LINE-HEIGHT: 116%; FONT-FAMILY: SimSun; COLOR: black">14</SPAN><SPAN style="LINE-HEIGHT: 116%; FONT-FAMILY: SimSun; COLOR: black" lang=ZH-CN>美金的费用。</SPAN>该规定自2010年9月8日起生效。现有ESTA 登记至其逾期日之前仍旧有效。有关详情请 <A href="http://cbp.gov/xp/cgov/travel/id_visa/esta/" target=_blank>访问美国国土安全部海关与边境保护局网站上的 ESTA 网页</A>。</A></P></TD></TR></TBODY></TABLE><BR>
