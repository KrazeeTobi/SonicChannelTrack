...
<head><!-- PageID 1232 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/chinese/services.asp">国际服务</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/chinese.asp" class="footer">汉语</a>&nbsp;&gt;&nbsp;国际服务</div>
                        </div>
                         <div class="headerbox">
                            <h1>国际服务</h1>
                        </div><br />
        ...
        <p><span class="text"><span class="subhead"><strong>国际注册区域</strong></span><br />
        <em>拉斯维加斯会议中心，中央广场主登记处<br />
        拉斯维加斯希尔顿大酒店舞厅<br />
        </em><br />
        为国际参加者所设的特别登记处，位于拉斯维加斯会议中心中央广场和拉斯维加斯希尔顿大酒店舞厅。 <br />
        在这两个区域，国际来宾可以进行现场登记、领取名牌套（进入展会所必须），或者得到多语种译员的特别语言帮助，他们可以帮助您解决有关登记的问题。 <br />
        <br />
        <br />
        <strong><span class="subhead">国际商务中心 (ICC)<br />
        </span></strong><em>拉斯维加斯会议中心 (LVCC) 南厅连厅，S224/225室</em><br />
        位于拉斯维加斯会议中心南厅连厅S224/225室的国际商务中心，是国际参加者和参展厂商在互联网站亭与自己办公室保持联系，预订和使用私人会议室，品尝点心饮料或只是放松一下的场所。方便地位于国际入口处（International Gateway）附近并与国际登记处毗邻的国际商务中心，可以成为您在国际消费电子展 CES时的“外出办公室”。<br />
        <br />
        <br />
        <strong>国际来宾招待会<br />
        </strong>
        <p><em>拉斯维加斯会议中心，南馆s222室</em></p>
        <p><span class="text">国际消费电子产品展 CES国际来宾招待会，邀请所有国际参加者、参展厂商和媒体赴宴。 招待会仅面向国际参加者。结交新友、与同事讨论业务或发展新的业务合作伙伴，良机莫失！今年在此招待会上，美国商务部将为寻求海外业务的美国公司举办“红娘计划”。 期盼届时与您相见！<br />
        <br />
        <span class="subhead"><strong>口译员</strong><br />
        在拉斯维加斯会议中心中央广场和拉斯维加斯希尔顿大酒店舞厅的国际商务中心和国际登记处区域都有多语种工作人员。 <br />
        口译员随时待命，以数种语言帮助您，包括西班牙语、法语、汉语、日语和韩语。如果您需要协助，请在国际登记处寻找“口译服务”（Interpretation Services）柜台。 <br />
        </span><span style="layout-grid-mode: line;" lang="ZH-CN"><br />
        <span class="text"><span class="subhead"><strong>全球采购商计划 <br />
        </strong></span>国际CES荣列美国商务部国际贸易署发起的全球采购商计划参与者之列。美国商务部的国际贸易专家将在国际商务中心（拉斯维加斯会议中心 (LVCC) 南厅连厅，S224/225室）为各国参展人员和展商提供对接和外贸咨询服务。<br />
        <p> </p>
        </span></span></span></p>
        <p>&nbsp;</p>
        <p> </p>
