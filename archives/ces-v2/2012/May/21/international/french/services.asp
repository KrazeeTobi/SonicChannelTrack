...
<head><!-- PageID 1139 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Services internationaux</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li ><a href="/international/french/delegations.asp">Programme Groupe Délégation</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/french.asp" class="footer">Français</a>&nbsp;&gt;&nbsp;Services internationaux</div>
                        </div>
                         <div class="headerbox">
        ...
        <h3>Zone d'inscription internationale </h3>
        <em>LVCC, Central Plaza – Inscription principale <br />
        Las Vegas Hilton Ballroom<br />
        </em><br />
        Une aire d’inscription spéciale pour les participants internationaux est située dans l’aire d’inscription principale du LVCC, Central Plaza et du Las Vegas Hilton Ballroom. Dans ces deux aires, les visiteurs internationaux peuvent s’inscrire sur place, récupérer un badge (qui est requis pour assister à la foire), ou obtenir de l’aide linguistique particulière des interprètes multilingues disponibles pour répondre aux questions liées à l’inscription. <br />
        <br />
        <h3>Centre de commerce international (ICC) </h3>
        <em>LVCC, South Hall Connector, Salle S224/225<br />
        </em><br />
        Situé dans le LVCC South Hall Connector, Salle S224/225, l’ICC est l’endroit par excellence pour les visiteurs et les exposants internationaux qui souhaitent garder le contact avec le bureau; utilisez les postes Internet, réservez et utilisez les salles de réunions privées, profitez d’une boisson désaltérante ou relaxez, tout simplement. Avantageusement situé près de l’International Gateway (Point d’accès international) et de l’International Registration (Inscription internationale), l’ICC peut être votre « bureau à l’extérieur de la maison » lorsque vous êtes au CES.<br />
        <br />
        <h3>Réception internationale</h3>
        <p><em>LVCC, South Hall Connector, Salle S222</em></p>
        Tous les participants, les exposants et la presse internationale sont invités à la réception internationale du CES, réservée exclusivement aux visiteurs internationaux. Ne manquez pas cette occasion de rencontrer des gens nouveaux, de discuter affaires avec des collègues ou de mettre sur pied de nouveaux partenariats commerciaux. Cette année, le Département américain du Commerce organisera un programme de jumelage pour les entreprises qui souhaitent faire affaires à l’étranger lors de cette réception. Nous vous y attendons avec impatience !<br />
        <br />
        <h3>Interprètes</h3>
        Des employés multilingues sont disponibles dans l’ICC et les aires d’inscription internationale du LVCC, Central Plaza et du Las Vegas Hilton Ballroom. Des interprètes seront disponibles pour vous aider dans plusieurs langues, dont l’espagnol, le français, le chinois, le japonais et le coréen. Aux aires de l’inscription internationale, recherchez le comptoir intitulé Interpretation Services (Services d’interprétation) si vous avez besoin d’aide. <br />
        <br />
        <h3>Programme des acheteurs internationaux </h3>
        CES International est fier de participer au Programme des acheteurs internationaux (International Buyer Program), sponsorisé par l'Administration du commerce international du Département du commerce des États-Unis. Des spécialistes du commerce international du Département du commerce des États-Unis sont à disposition au principal Centre de commerce international (ICC) (LVCC South Hall Connector, Salle S224/225) pour aider à trouver des correspondants et des consultants en commerce d'exportation au profit des participants et exposants internationaux.
