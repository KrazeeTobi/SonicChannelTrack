...
<head><!-- PageID 5381 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Réservations d'hôtel</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/french/hotels.asp">Réservations d'hôtel</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/french.asp" class="footer">Français</a>&nbsp;&gt;&nbsp;Réservations d'hôtel</div>
                        </div>
                         <div class="headerbox">
        ...
        <p><img alt="" style="margin: 5px; float: right;"  src="/images/photos/Vegas_200.jpg" />Pour vous aider à planifier aisément votre voyage, CES a négocié des prix de chambre réduits auprès de certains hôtels sélectionnés de Las Vegas. <br />
        <br />
        Pour consulter la liste complète des hôtels et des tarifs correspondants, visitez <a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a> (les renseignements sont en anglais). Pour obtenir le tarif CES, toutes réservations de chambres doivent être faites directement auprès de l’hôtel, en passant par le site <a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a> et en y sélectionnant le nom de l’hôtel choisi. Vous serez alors amené directement à la page des réservations de l’hôtel, ou vous pourrez entrer votre numéro et les renseignements de carte de crédit nécessaires. </p>
        <p>Par suite d’une très forte demande, la plupart des chambres d’hôtel prévues pour CES sont maintenant louées, et le taux préférentiel consenti pour CES n’est plus disponible. Pour aider les visiteurs qui désirent faire leurs réservations à la dernière minute, CES a ajouté une liste d’hôtels d'accueil supplémentaires. Ces hôtels ne bénéficient pas de service de navette vers, ou en provenance de CES. Vous trouverez la liste complète de ces hôtels au bas de la page <a href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a> (en anglais seulement).<br />
        <br />
        Si vous désirez réserver un groupe de 20 chambres ou plus, vous pouvez alors soumettre cette demande directement à l’hôtel choisi (ou aux hôtels choisis) en visitant le site <a  href="http://www.cesweb.org/hotelTravel/blockRequest.asp">www.cesweb.org/hotelTravel/blockRequest.asp</a>. Votre demande sera directement transmise à l’hôtel ou aux hôtels ; les hôtels disposent de trois jours ouvrables pour vous répondre.<br />
        <br />
        Remarque : Il n’existe ni agence, ni bureau de logement CEA/CES. Si certains se font passer pour le  bureau ou l’ agence de logement de CES, sachez que ces offres de services sont fausses et inauthentiques.<br />
        <br />
