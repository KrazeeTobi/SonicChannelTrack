...
<head><!-- PageID 1158 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/korean.asp" class="footer">한국어 </a>&nbsp;&gt;&nbsp;대표단 프로그램</div>
                        </div>
                         <div class="headerbox">
                            <h1>대표단 프로그램</h1>
                        </div><br />
        ...
        귀국에서 대표단을 이끌고 International CES에 참석하실 의향이 있으십니까? 대표단을 인솔함으로써 귀하는 쇼에서 무엇을 보고 누구를 만날지 미리 계획하여 귀하의 고객이   International CES 여행의 가치를 최대화할 수 있도록 함과 동시에  여행 절차도 마련할수 있습니다.  CEA에서는 대표단 리더와 구성원 모두에게 혜택을 제공하는 공식 대표단 프로그램을 두고 있습니다.<br />
        <br />
        무료 전시회 등록은 대표단 프로그램 참가자들을 위한 혜택 중의 하나입니다. <a  href="/register">8월 30일 이후에 대표단에 참가하고 CES에 </a>등록하는 경우 등록비 100달러는 면제됩니다.<br />
        <br />
        ...
        <br />
        <p><strong>프로그램 세부사항</strong><br />
        대표단 리더의 자격 조건:</p>
        <ul class="text">
            <li class="text">대표단 프로그램은 미국 이외의 참석자로 제한된다. </li>
            <li class="text">대표단은 가전 산업 분야의 전문 사업가로 구성되어야 한다.  </li>
            <li class="text">대표단의 구성원은 15인 이상이어야 한다. 15명 보다 적은 단체는 개인 참석자로 등록해야 한다. </li>
        </ul>
        ...
        <ul class="text">
            ...
            <li class="text">국상무부 국제무역전문가들과 상담하며, 전문가들은 관련 업체 및 참가자들에게 수출지원 및 수출무역관련 컨설팅서비스를 안내해 드립니다. </li>
        </ul>
        ...
        <ul class="text">
            ...
            <li class="text">CES International 리셉션의 초대.  </li>
        </ul>
        <p><strong>미국상무부 국제구매서비스계획<br />
        </strong><img width="155" height="158" alt="" style="float: right;"  src="/images/content/doc_logo(1).JPG" />인터내셔널 CES는 미상무부의 인터내셔널 바이어 프로그램 (U.S. Department of Commerce’s International Buyer Program (IBP))에 참여하고 있습니다. 전세계의 미대사관과 영사관에 있는 미상무부의 사무소 네트워크를 통해, IBP는 미리 심사를 거친 해외 바이어 대표단을 모집하고 이들을 미국에서 열리는 무역전시회 중 선정된 무역전시회에 인솔해와서 미국 기업들과 해외 바이어들을 연결시켜줍니다.<br />
        <br />
        귀하의 지역내 대사관이나 영사관의 상무 서비스 무역 스페셜리스트는 전시회 등록을 지원해 주며, 귀하가 전시회에서 구매하고자 하는 상품을 찾을 수 있도록 도와주며, 귀하가 미국 사업자들과 만날 수 있는 자리를 마련하는 것을 지원해 드릴 수 있습니다. 인터내셔널 CES는 미상부무의 상무 서비스에 의해 후원을 받는 인터내셔널 바이어 프로그램 (IBP)에 참여하고 있습니다. IBP의 일원으로, 많은 해외 상무 스페셜리스트들이 CES에 대표단을 인솔해서 옵니다. 귀하 국가에서 상무 서비스 사무소<a  target="_blank" href="http://www.export.gov/eac/index.asp">(Commercial Service office)를 찾아보십시오.</a></p>
        <p>대표단 리더가 되기위한 문의사항 또는 귀국의 International CES 대표단을 찾으시려면 CES의 <a  href="mailto:delegations@CE.org" ywaOnclickOverride="true">delegations@CE.org</a>로 이메일을 보내주십시오.</p>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        ...
        <ul class="text">
            <li class="text"><a  target="_blank" href="/docs/2012_General_Overview_Brochure.pdf">영어본 개관 안내책자 (pdf) </a></li>
            <li class="text"><a  target="_blank" href="/docs/HI_RES_KO_2K12_CESfactSheet_Web.pdf">번역된 CES 개황 보고서 (pdf) </a></li>
            <li class="text"><a  target="_blank" href="/docs/DP_Brochure_Web.pdf">다국어 대표단 안내 책자</a> </li>
            <li class="text"><a  target="_blank" href="/docs/2012_Program_Description_FNL.pdf">대표단 리더와 대표단 사절들을 위한 혜택 (영어본pdf)</a> </li>
            <li class="text"><a  target="_blank" href="http://content.ce.org/2k12CESI/2k12CES_DEL_02_1Mb.mov.zip">잠재적인 규모를 보여주 정보 CES 비디오 (.mov)</a> </li>
        </ul>
