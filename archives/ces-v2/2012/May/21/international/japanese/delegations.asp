...
<head><!-- PageID 1172 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li ><a href="/international/japanese/hotels.asp">ホテル予約</a></li>
            ...
            <li ><a href="/international/japanese/shuttles.asp">シャトルサービス</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/japanese.asp" class="footer">日本語</a>&nbsp;&gt;&nbsp;代表団プログラム</div>
                        </div>
                         <div class="headerbox">
                            <h1>代表団プログラム</h1>
                        </div><br />
        ...
        <p> </p>
        <p>代表団プログラム参加者の特典には、無料のショー登録が含まれています。派遣団に参加し、8月30日以降にCESに登録なさる場合は、登録料金$100が免除されます。<br />
        <br />
        グループの代表者、或いは業界団体にて、ＣＥＳ(Consumer Electronics Show)参加へご興味のある方は、<br />
        <br />
        ...
        <br />
        <p><strong>プログラムの詳細</strong><br />
        代表団リーダーの資格は以下のとおりです。</p>
        <ul class="text">
            <li class="text">代表団プログラムは米国外の参加者に限る。 </li>
            <li class="text">代表団の構成員は家電業界のビジネス専門家であること。 </li>
            <li class="text">代表団の構成員数は最小15名とする。15名以下の団体は個人参加者として登録すること。 </li>
        </ul>
        ...
        <ul class="text">
            ...
            <li class="text">国際的な出席者と出品者へ交渉の援助と貿易輸出のカウンセリングをする米国商務省の国際貿易専門家へのアクセス。</li>
        </ul>
        ...
        <ul class="text">
            ...
            <li class="text">インターナショナルCESレセプションヘの招待。 </li>
        </ul>
        <p> </p>
        <p style="line-height: 10pt;"><strong>米国商務省の国際的バイヤープログラム</strong><br />
        <img width="155" height="158" alt="" style="float: right;"  src="/images/content/doc_logo(1).JPG" />国際CESは、米国商務省の国際バイヤープログラム（IBP）の誇りある参加者です。世界中の米国大使館や領事館の事務所をつなぐ米国商務サービスネットワークを通じて、IBPは事前に審査された外国バイヤーによる代表団を募集し、厳選された米国の展示会に招待することで、米国企業と国際バイヤーとの橋渡しを行っています。 <br />
        <br />
        地元の大使館または領事館に配属された商務サービスの貿易専門家が、展示会の登録、展示会で購入を希望する製品の探索、米国企業との会合設定を支援します。国際CESは、米国商務省の商務サービスが主催する国際バイヤープログラム（IBP）の誇りある参加者です。IBPの一環として、多くの海外商務専門家たちにより代表団がCESに導かれました。<a  target="_blank" href="http://www.export.gov/eac/index.asp ">在住国にある商務サービス事務所をご確認ください</a>。<br />
        <a  target="_blank" href="http://www.export.gov/eac/index.asp"><br />
        </a></p>
        <p>代表団リーダーについてのご質問や、日本からのインターナショナルCES代表団をお探しの場合は、CEA（<a  href="mailto:delegations@CE.org">delegations@CE.org</a>.）までメールでお問い合わせください。</p>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        ...
        <ul class="text">
            <li class="text"><a  target="_blank" href="/docs/2012_General_Overview_Brochure.pdf">英語版総合パンフレット（PDF）</a> </li>
            <li class="text"><a  target="_blank" href="/docs/HI_RES_JPN_2K12_CESfactSheet_Web.pdf">日本語版CESファクトシート（PDF） </a></li>
            <li class="text"><a  target="_blank" href="/docs/DP_Brochure_Web.pdf">代表団向け各国語版パンフレット</a> </li>
            <li class="text"><a  target="_blank" href="/docs/2012_Program_Description_FNL.pdf">代表団リーダーと代表者の特典（英語版PDF）</a> </li>
            <li class="text"><a  target="_blank" href="http://content.ce.org/2k12CESI/2k12CES_DEL_02_1Mb.mov.zip">潜在的なデリゲートを表示するために、情報CESのビデオ (.mov)</a> </li>
        </ul>
