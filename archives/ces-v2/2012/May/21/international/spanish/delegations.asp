...
<head><!-- PageID 1148 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Programa de grupos de delegaciones</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li ><a href="/international/spanish/travel.asp">Información de viajes y visas</a></li>
        
            <li ><a href="/international/spanish/hotels.asp">Reservas de Hotel</a></li>
            ...
            <li ><a href="/international/spanish/shuttles.asp">Servicio de Transporte</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/spanish.asp" class="footer">Español</a>&nbsp;&gt;&nbsp;Programa de grupos de delegaciones</div>
                        </div>
                         <div class="headerbox">
        ...
        <p>¿Le interesa traer un grupo de su país a International CES? Liderando una delegación, usted puede ayudar a sus clientes a maximizar el valor de su viaje a International CES, ayudándolos a planificar qué desean ver y a quiénes desean conocer en la exposición, mientras realiza los arreglos de la logística del viaje. CEA posee un programa formal para delegaciones, que proporciona beneficios tanto para los líderes como para los miembros de la delegación. </p>
        <p>La inscripción gratuita a la exposición es parte de la lista de beneficios para los participantes del programa de delegaciones. Si participa en una delegación y se registra en CES después del 30 de agosto, se le exonerará del pago de la cuota de inscripción de $100.<br />
        <br />
        Tenga en cuenta: La inscripción como líder de delegación no lo registra a usted para el show; debe también <a  href="/register">completar el proceso de inscripción formal para registrarse</a> y recibir sus credenciales.</p>
        ...
        <p><strong>Detalles del programa <br />
        </strong>Para calificar como líder de una delegación: </p>
        <ul class="text">
            ...
            <li class="text">Las delegaciones deben poseer un mínimo de 15 miembros. Los grupos menores a 15 deben inscribirse individualmente como asistentes. </li>
        </ul>
        ...
        <ul class="text">
            ...
            <li class="text">Tenga acceso a Especialistas de Comercio Internacional del Departamento de Comercio de EE.UU., quienes proporcionarán asistencia de emparejamiento empresarial y asesoramiento sobre comercio de exportación a los asistentes y expositores internacionales. </li>
        </ul>
        ...
        <ul class="text">
            ...
            <li class="text">Invitación a la Recepción Internacional de CES.  </li>
        </ul>
        <p><strong>Programa para el comprador internacional del Departamento de Comercio de EE.UU.</strong> <br />
        <img width="155" height="158" alt="" style="float: right;"  src="/images/content/doc_logo(1).JPG" />International CES se enorgullece en participar en el Programa de Compradores Internacionales (International Buyer Program o IBP) del Departamento de Comercio de Estados Unidos. A través de la red de oficinas del Servicio Comercial de EE.UU. en las embajadas y consulados estadounidenses por todo el mundo, el IBP capta delegaciones extranjeras de compradores preseleccionados y las lleva a ferias comerciales en Estados Unidos, conectando así a empresas estadounidenses con compradores extranjeros. <br />
        <br />
        Los especialistas en el sector comercial de servicios, ubicados en la embajada o consulado locales, le ayudarán a inscribirse en la feria, a ubicar los productos que desea adquirir en la feria y a concertar reuniones con empresas estadounidenses. International CES se enorgullece en participar en el Programa de Compradores Internacionales (IBP), patrocinado por el Servicio Comercial del Departamento de Comercio de EE.UU. Como parte del IBP, muchos especialistas comerciales extranjeros dirigen delegaciones a la Feria CES. <a  target="_blank" href="http://www.export.gov/eac/index.asp">Ubique la oficina del Servicio Comercial en su país.</a></p>
        <p>&nbsp;</p>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        ...
        <ul class="text">
            <li class="text"><a  target="_blank" href="/docs/2012_General_Overview_Brochure.pdf">Folleto del Resumen General en idioma inglés (PDF) </a></li>
            <li class="text"><a  target="_blank" href="/docs/HI_RES_SP_2K12_CESfactSheet_Web.pdf">Traducción de la Hoja Informativa de la Exposición International CES (PDF)</a> </li>
            <li class="text"><a  target="_blank" href="/docs/DP_Brochure_Web.pdf">Folleto multilingüe para delegaciones</a></li>
            <li class="text"><a  target="_blank" href="/docs/2012_Program_Description_FNL.pdf">Beneficios para líderes de delegación y delegados (PDF en inglés)</a> </li>
            <li class="text"><a  target="_blank" href="http://content.ce.org/2k12CESI/2k12CES_DEL_02_1Mb.mov.zip">De información de vídeo CES para mostrar los potenciales delegados (.MOV)</a> </li>
        </ul>
