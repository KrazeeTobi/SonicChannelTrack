...
<head><!-- PageID 1146 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Información de viajes y visas</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/spanish/travel.asp">Información de viajes y visas</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/spanish.asp" class="footer">Español</a>&nbsp;&gt;&nbsp;Información de viajes y visas</div>
                        </div>
                         <div class="headerbox">
        ...
        <p>Encuentre aquí información útil para entrar y salir de los EE. UU. </p>
        <h2>Viajes</h2>
        <p><strong>¿Necesita saber cómo llegar a CES?<br />
        </strong><a  href="/hotelTravel/default.asp">Visite la sección de viaje de CESweb.org (en inglés)</a> para encontrar la mejor tarifa de boleto aéreo y de alquiler de vehículos, así como información sobre el transporte local.</p>
        <p><strong>¿Necesita saber dónde alojarse?<br />
        </strong><a  href="/hotelTravel/hotel.asp">Visite la sección hotel de CESweb.org (en inglés)</a> para realizar reservas grupales e individuales. </p>
        <p>&nbsp;</p>
        <h2>Información sobre visas</h2>
        <p><strong>¿Necesita una visa? <br />
        </strong><a  target="_blank" href="https://ceac.state.gov/genniv/ ">Ahora puede completar el formulario de solicitud de visado en línea.</a></p>
        <p><strong>¿Necesita ayuda?</strong> <br />
        <a  target="_blank" href="/docs/Spanish_2K12VisaTips.pdf">Descargue nuestra Hoja de consejos para obtener una visa</a>, que consta de instrucciones detalladas, direcciones de sitios web y otra información para ayudarlo a completar satisfactoriamente su proceso de solicitud de visado. <br />
        <br />
        A partir del 20 de enero [de 2010], a las personas que viajan a Estados Unidos de países en el programa de exención de visa <a  target="_blank" href="http://travel.state.gov/visa/temp/without/without_1990.html#countries">Visa Waiver Program</a> las aerolíneas podrían denegarles el abordaje si no han cumplido con los requisitos del programa de Sistema Electrónico para Autorización de Viajes (Electronic System for Travel Authorization o ESTA) del Departamento de Seguridad Nacional de EE.UU. Ahora, las personas extranjeras que viajan a Estados Unidos deben dirigirse al <a  target="_blank" href="https://esta.cbp.dhs.gov/">sitio Web de ESTA</a> y llenar una solicitud antes de ingresar a EE.UU. por aire o por mar. De ser aprobada, la autorización tendrá dos años de vigencia y puede ser renovada. Los pasajeros ya no tienen que llenar el formulario I-94W antes de cada viaje.</p>
        <table style="border: #9f9f9f 1px solid;" border="0" cellpadding="8" width="100%">
            <tbody>
                <tr>
                    <td>
                    <h3>Aviso importante para los participantes que viajan bajo el Programa de Exención de Visado</h3>
                    Todas las solicitudes o renovaciones de inscripción en el Sistema Electrónico de Autorización de Viaje (ESTA, por sus siglas en inglés) requieren del pago de una cuota de US$14 por tarjeta de crédito o débito. Las inscripciones en el programa ESTA ya procesadas seguirán vigentes hasta su fecha de caducidad. Para obtener información adicional, sírvase <a  target="_blank" href="http://cbp.gov/xp/cgov/travel/id_visa/esta/">visitar la página del programa ESTA en el sitio Web del Departamento de Seguridad Nacional, Servicio de Aduanas y Protección Fronteriza</a>.</td>
                </tr>
            </tbody>
        </table>
        <p> </p>
