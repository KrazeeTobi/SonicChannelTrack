...
<head><!-- PageID 5252 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: July 2011</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/exhibitors/default.asp-->
            ...
            <li class="selected"><a href="/exhibitors/newsletter/july11.asp">July 2011</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;July 2011</div>
                        </div>
                         <div class="headerbox">
                            <h1>July 2011</h1>
                        </div><br />
...
<div align="center">
    ...
    [ <a href="/july11ops.asp">Operations</a> ]
...
<IMG style="MARGIN-TOP: 5px; MARGIN-LEFT: 5px" hspace=5 vspace=5 align=right src="/images/content/CES_Unveiled_event.gif" width=250 height=49>Pump up your media exposure and sales at one or both of the 2012 International CES Unveiled events.&nbsp; <A href="/exhibitors/sponsorships/pressOpportunitites.asp">Unveiled@NY</A> on November 8 offers an valuable opportunity to promote your products in time for the holiday sales cycle. Two months later, <A href="/exhibitors/sponsorships/pressOpportunitites.asp">Unveiled in Las Vegas</A> on January 8 gives you exclusive access to the press two days before the CES show floor opens.<BR><BR>A simple tabletop setup makes it easy for your team to network with the top industry and consumer media, build relationships and generate coverage. Getting the best PR value in the industry, exhibitors receive: <BR>
<P></P>
<UL>
<LI>Exposure to hundreds of influential, credentialed media and analysts </LI>
<LI>Extensive pre-event promotion to CES’ worldwide media list </LI>
<LI>Contact lists of pre-registered and confirmed media/analysts </LI>
<LI>150-word product description and photo in the Unveiled program guide </LI>
<LI>Your product displayed among Innovations 2012 Design and Engineering Awards Honorees’ products – a must-see for press and analysts</LI></UL>
<P>Sign up today. Contact: <A href="mailto:CESUnveiled@CE.org">CESUnveiled@CE.org</A>. Visit <A href="/exhibitors/sponsorships/pressOpportunitites.asp">CESweb.org/CESUnveiled</A> for more information.</P><br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
<br />
...
<div class="sub-content-header">Innovations 2012 Design and Engineering Awards Call For Judges Opening Soon</div>
<br />

<IMG style="MARGIN-TOP: 0px; MARGIN-LEFT: 5px" hspace=5 align=right src="/images/content/2K12Innovations_SAMPLE.jpg" width=101 height=150>Every year the CE industry lights up with new innovative designs and products, and thousands of industry leaders and press flock to CES to witness the "<A href="/exhibitors/newsletter/2010.asp">next big thing</A>." Do you think you know what’s best? Let the world know!<BR><BR>The Innovations <A href="/exhibitors/newsletter/callForJudges.asp">Call for Judges</A> opens July 25, 2011. If you're an independent designer or an engineer, <A href="/exhibitors/newsletter/callForJudges.asp">we want you</A>! Qualified exhibitors are eligible to judge categories in which their employers have not entered products. Be the first to see the newest products in the CE industry!<BR><BR>The <A href="/awards/default.asp">International CES<SUP>®</SUP> Innovations 2012 Design and Engineering Awards</A> is the most impressive and renowned awards program in the consumer technology industry. Being an Innovations Honoree can provide exhibitors with incredible opportunities, special recognition in the CE industry and worldwide exposure for your company and products. Help out your industry, and <A href="/exhibitors/newsletter/callForJudges.asp">sign up to be a judge</A>.<BR><br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
<br />
...
<div class="sub-content-header">International Exhibitors: Secure Your Travel Visas</div>
<br />

<IMG style="MARGIN-TOP: 0px; MARGIN-LEFT: 5px" hspace=5 align=right src="/images/photos/plane.jpg" width=125 height=84>If you are an exhibitor that requires a visa to enter the U.S., request your letter of invitation and make your appointment for a visa interview early. Wait times for a visa interview can be several weeks or more in many countries, especially during peak travel periods. We strongly urge you to register for CES when exhibitor registration opens on July 25 and request a letter of invitation as soon as possible. For helpful tips on securing your visa, visit <A href="http://www.CESweb.org/International">www.CESweb.org/International</A>.<BR><BR>Also, a recent policy change requires all visitors to the U.S. from visa-waiver countries to register online and be authorized for entry as part of the new Electronic System for Travel Authorization program. <A href="https://esta.cbp.dhs.gov/esta/esta.html?_flowExecutionKey=_cDDA61A31-654F-6D58-BAC3-66311FBF2145_kBE0B84A0-8F01-1354-C6D3-2F137B8661DE" target=_blank>Learn more about this program</A>.<BR><br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
<br />
...
<IMG style="MARGIN-TOP: 0px; MARGIN-LEFT: 5px" hspace=5 align=right src="/images/content/IndustryForum_logo.jpg" width=250 height=56>Registration for the <A href="http://www.ce.org/events/default.asp?siteUrl=http://speaker.ce.org/index.cfm?do=cus.meeting|meetingID=1460" target=_blank>2011 CEA Industry Forum</A> is open! Take advantage of early-bird rates and save up to $175 by <A href="http://www.ce.org/events/default.asp?siteUrl=http://speaker.ce.org/index.cfm?do=cus.meeting|meetingID=1460" target=_blank>registering now</A>. The CEA Industry Forum is a crucial networking and educational event for CE industry professionals. This must-attend event provides the right mix of industry attendees and educational sessions to help you grow your business and remain competitive in the CE industry. <BR><BR>The conference takes place October 23-26 at the <A href="https://resweb.passkey.com/Resweb.do?mode=welcome_ei_new&eventID=3420143" target=_blank>Manchester Grand Hyatt</A> in San Diego, Calif., and includes events such as the CE Hall of Fame dinner, a new health and fitness track and much more. View the <A href="http://www.ce.org/industryforum" target=_blank>full conference schedule</A> and check back often for updates. Buy one registration [insert link] at full price and bring your colleagues for 20 percent off. <BR><BR>Make sure to <A href="https://www.facebook.com/event.php?eid=181069545281283" target=_blank>RSVP on Facebook</A> to let everyone know you’re coming!
...
<tr>
   ...
   Vice President, Marketing</p>
    <hr align="center" width="90%" size="1" noshade color="#999999">
    <!-- article start -->
    <p><strong>Expand Your Show Presence</strong><br> 
by Susan Littleton</p>
    <p>It may be difficult to believe, but we are already halfway through 2011 and only six months from the 2012 International CES, the industry’s largest trade-only event.<BR>By now, your company’s preparations for the 2012 show are well underway. Booth space is confirmed. Hotel rooms and airfare are being booked. You may have even started to schedule meetings with clients, partners and the press. As you continue to prepare for CES, it is important to consider your entire show participation, not just exhibit space. Besides securing the best possible booth, have you explored <A href="/exhibitors/sponsorships/default.asp">additional ways</A> to enhance your organization’s presence at the show?<BR><BR><A href="/exhibitors/sponsorships/sponsorships.asp">Sponsorship opportunities</A> at CES can help your company achieve a more targeted and impactful presence. Our traditional inventory includes everything from broad-exposure items like banners, email stations, badge lanyards and show bags, to more specific, targeted marketing like division reception sponsorships and our VIP buyer program. Onsite advertising is a great way to get your brand in front of the more than 140,000 attendees expected at the show.
&nbsp;
Promotional opportunities also include <A href="/exhibitors/sponsorships/pressOpportunitites.asp">targeted press outreach</A> such as CES Unveiled@NY and CES Unveiled in Las Vegas. The official CES press events attract over 300 media and analysts in New York and more than 800 at the Las Vegas event and is the best way to receive press attention and build buzz before the show. Other opportunities include sponsorships of press and analyst breakfast or lunch, the Online Media Center, media gifts and notepads.
&nbsp;
Advertising is also another great way to get exposure before and during the show.&nbsp;CES offers <A href="/exhibitors/sponsorships/printAdvertising.asp">advertising opportunities</A> in the Official CES Directory and CES Daily print publications as well as in the Preshow Planner and Show Guide. And speaking of the directory, you can also customize and enhance your online directory listing through a bevy of <A href="/exhibitors/sponsorships/default.asp">package options</A> through our vendor Map Your Show.<BR><BR>Most companies focus on their booth as the core of show participation, but our most successful exhibitors pursue a more integrated approach – one that leverages a multi-faceted approach to marketing. And while our traditional inventory of promotions and sponsorships is limited based on renewals, we also encourage you to bring us your own ideas. If there is an attendee segment you'd like to reach, a technology you'd like to promote, or a new product or partnership you'd like to publicize, we would love to discuss ways to develop a customized sponsorship opportunity for your organization.
&nbsp;
If you’re interested in learning more information about all these opportunities, please contact Liz Tardif at <A href="mailto:ltardif@CE.org">ltardif@CE.org</A>.<BR><BR>Sincerely,<BR><IMG src="/images/content/Susan_Littleton_sig.jpg"><BR><BR>Susan Littleton<BR>
<P></P></p>
    <!-- article end -->
    </span>
    </td>
