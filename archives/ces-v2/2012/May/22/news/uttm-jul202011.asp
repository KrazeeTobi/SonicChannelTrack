...
<head><!-- PageID 5306 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: July 20, 2011</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/news/default.asp" class="footer">News</a>&nbsp;&gt;&nbsp;<a href="/news/newsletters.asp" class="footer">Newsletters</a>&nbsp;&gt;&nbsp;<a href="/news/up-to-minute-default.asp" class="footer">CES Up to the Minute</a>&nbsp;&gt;&nbsp;July 20, 2011</div>
                        </div>
                         <div class="headerbox">
                            <h1>July 20, 2011</h1>
                        </div><br />
        ...
        Every January, one place brings together cutting-edge technology companies for four days of innovation. And for those four days, Las Vegas glows brighter.<a  href="http://cesweb.org/register"> Join us at the 2012 International CES</a> as we light the way for the future of technology.
...
<div class="sub-content-header">New Show Dates</div>
<br />


        This year, CES will take place on a new week day schedule, running from Tuesday, January 10 - Friday, January 13. <a  href="http://cesweb.org/faq/default.asp">Learn more about CES with our FAQs.</a>
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Heads up on Deadlines</div>
<br />


        Please take note of these important registration deadlines for the 2012 show. <a  href="http://CESweb.org/register">Register now to save $100.</a>
        <ul>
            <li class="text">By 11:59 p.m. (EST) August 31: FREE</li>
            <li class="text">Midnight September 1 through 5 p.m. EST December 30:	$100</li>
            <li class="text">5:01 p.m. EST December 30 through Jan. 13, 2012: $200</li>
        </ul>
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
...
<div class="sub-content-header">The Early Bird Gets the Room</div>
<br />


        <img alt="" width="147" height="112"  src="/images/photos/Strip_165x125.jpg" style="float: right;" />Book your room now to avoid missing out on your first choice in hotels. <a  href="http://CESweb.org/hotel">Visit CESweb.org/hotel</a> for more information on rates and how to book. <br />
        <br />
        Money saving bonus: Stay at any official CES hotel, and take the free shuttles to and from the Las Vegas Convention and World Trade Center/the Las Vegas Hilton!
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Get in the Zone</div>
<br />


        <img alt=""  src="/images/content/techzone-120.gif" style="float: right;" />Within the 20 <a  href="/news/techZones.asp">TechZones</a> nestled throughout the halls of CES, you’ll see innovation come to life through these groupings of the newest technology markets.<br />
        <br />
        These uniquely themed areas are your one stop shops for all things innovation and inspiration. From destinations focused on the home, to all things health and wellness, and even a splash of automotive – these TechZones have it all. Be sure to check out all the new <a  href="/news/techZones.asp">TechZones at the 2012 CES</a>, including:
        <ul>
            <li class="text">Sustainable Planet</li>
            <li class="text">3D@Home</li>
            <li class="text">PMA@CES (NEW for 2012)</li>
            <li class="text">GoElectricDrive</li>
            <li class="text">Robotics</li>
            <li class="text">Eureka! Park </li>
        </ul>
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
...
<div class="sub-content-header">Industry Forum: Registration Now Open</div>
<br />


        <img alt=""  src="/images/content/IndustryForum.gif" style="float: right;" />Registration for the 2011 CEA Industry Forum is open! Take advantage of early-bird rates and <a target="_blank"  href="http://registration3.experient-inc.com/showCES115/Default.aspx">save up to $175 by registering now</a>. The CEA Industry Forum is a crucial networking and educational event for CE industry professionals. This must-attend event provides the right mix of industry attendees and educational sessions to help you grow your business and remain competitive in the CE industry.
        <p>The conference takes place October 23-26 at the <a target="_blank"  href="https://resweb.passkey.com/Resweb.do?mode=welcome_ei_new&eventID=3420143">Manchester Grand Hyatt</a> in San Diego, CA, and includes events such as the CE Hall of Fame dinner, a new health and fitness track and much more. <a target="_blank"  href="http://ce.org/industryforum">View the full conference schedule</a> and check back often for updates. <a target="_blank"  href="http://(https://www.facebook.com/event.php?eid=181069545281283">Make sure to RSVP on Facebook</a> to let everyone know you’re coming.
        </p>
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
...
<div class="sub-content-header">Declaration of Innovation</div>
<br />


        <img alt=""  src="/images/content/declaration_innovation.gif" style="float: right;" />CEA's Innovation Movement launched <a  href="http://declareinnovation.com/" target="_blank">The Declaration of Innovation</a> this past month. The Declaration is an online pledge for Americans to sign in support of policies that will return innovation to its rightful place as a center of America's economic policy. <br />
        <br />
        You can also find the Declaration on <a  href="http://www.facebook.com/InnovationMovement" target="_blank">CEA's Innovation Movement Facebook page</a>.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Digital Hollywood Fall</div>
<br />


        <img alt=""  src="/images/content/DigitalHollywood2012.gif" style="float: right;" />Digital Hollywood is a premier entertainment and technology conference with over 2,000 leading executives from the entertainment, media and technology industries in attendance. Join us at The Ritz Carlton Hotel, Marina del Rey, California, October 17-20. We are currently booking exhibitors and sponsors. <a  href="http://www.digitalhollywood.com/LAFall11Agenda.html">The agenda is posted and speaker selection has begun!</a>
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Future of Television</div>
<br />


        <img alt=""  src="/images/content/FutureTelevision.gif" style="float: right;" />Join us for in-depth discussions and networking with some of the industry's top leaders at <a  href="http://www.televisionconference.com/east/" target="_blank">Future of Television East</a>&nbsp; on November 17-18, 2011! This is a "must-attend" event for decision-makers from cable and broadcast networks, cable and satellite operators, high-tech and advertising. Early registration rates are available, and speaker and sponsor submissions are now open.
