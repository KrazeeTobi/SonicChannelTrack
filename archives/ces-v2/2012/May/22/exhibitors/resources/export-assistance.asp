...
<head><!-- PageID 3813 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Export Assistance</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/exhibitors/default.asp-->
            ...
            <li class="selected"><a href="/exhibitors/resources/export-assistance.asp">Export Assistance</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/resources/default.asp" class="footer">Resources</a>&nbsp;&gt;&nbsp;Export Assistance</div>
                        </div>
                         <div class="headerbox">
                            <h1>Export Assistance</h1>
                        </div><br />
                        <div id="inner-content-long">
                                                                   
                            
<h2>Expand your Global Reach at CES</h2>
...
<div class="sub-content-header">Global Market Insight Program</div>
<br />


        Are you are looking to export or increase your international sales but not sure where to concentrate your efforts? The U.S. Department of Commerce in cooperation with International CES® has a solution for you! Learn which international markets your product has the greatest chances of being successful in by participating in our Global Market Insight Program. Through this program, you will have the opportunity to present your products and services to a panel of international industry experts who will provide feedback on:
        <ul>
            <li>Finding an appropriate overseas partner </li>
            <li>Effective international sales strategies </li>
            <li>Business opportunities in their market </li>
            <li>Best practices on exporting </li>
        </ul>
        Commercial Specialists from multiple countries will be available for presentation feedback and are recruiting foreign buyer delegations to attend the show.<br />
        <br />
        There is no cost to participate in the Global Market Insight Program, but registration is required and you must be a CEA member or U.S. exhibitor at the 2012 International CES. <a  target="_blank" href="http://export.gov/industry/infocomm/cesgmip038151.asp">Learn more about this program</a>.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">2nd Annual Global Matchmaking & International Reception </div>
<br />


        <strong>6-7:30 p.m. Tuesday, January 10, 2012 <br />
        LVCC, South Hall Connector, Room S222<br />
        <br />
        </strong>CEA is partnering with the U.S. Commercial Service to host the Global Matchmaking and International Reception at 6 p.m. on Monday, January 10. This event connects U.S. consumer electronics companies with hundreds of foreign buyers in a reception setting beyond the show floor - the perfect opportunity for expanding your business into new global markets! <br />
        <br />
        Through exhibiting in the Global Matchmaking and International Reception, you can achieve multiple objectives, including export sales, marketing and business development. You'll also meet and prospect new customers, network with foreign buyers and industry professionals and entertain new contacts, partners and clients in a hospitable and professional venue.<br />
        <br />
        <a  target="_blank" href="http://export.gov/industry/infocomm/cesgmir038150.asp">Learn more about this event and how to purchase your table-top display</a>.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Exporting Exhibitor Program (EEP)</div>
<br />

The EEP is a program for CES exhibitors interested in developing exporting opportunities with international manufacturers, distributors, licensing agents or representatives. As a participating exhibitor in the program, the verified CES international attendee database will be available to you after the show. This is a one-time opportunity to generate a report of international attendees who are interested in meeting new business partners. You can select up to ten countries and ten product categories that match the products and business interests of your company. To participate, simply indicate your desire to seek exporting partners when you complete your online exhibitor profile. <A href=" mailto:jtkelley@CE.org?Subject=" I?m%20Interested%20in%20the%20Exporting%20Exhibitor%20Program?>Contact us with any questions</A>. 
                            <script type="text/javascript">
