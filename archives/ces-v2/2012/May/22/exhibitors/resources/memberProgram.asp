...
<head><!-- PageID 634 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: CEA Member Affinity Program</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/resources/default.asp" class="footer">Resources</a>&nbsp;&gt;&nbsp;CEA Member Affinity Program</div>
                        </div>
                         <div class="headerbox">
...
Save money at tradeshows! If you’re a CEA member who exhibits at the International CES or any other show where GES Exposition Services is the general contractor, then we’ve got a great deal for you.<BR><BR>CEA is pleased to offer a member affinity program along with GES that allows CEA members to take advantage of an array of discounts and special pricing. As part of your CEA membership, you are automatically designated as a GES VIP Exhibitor and are eligible for priority preshow ordering and special discounts and pricing on the select products and service below.<BR><BR>CEA members can participate in this program at CES or any other tradeshow for which GES has been named the general service contractor.<BR><BR><STRONG>Expedited Pre-show Ordering<BR></STRONG>GES has established a dedicated GES VIP Exhibitor Hotline for CEA members, providing priority routing and expedited service at the GES National Servicenter. The GES VIP Exhibitor hotline is 866-531-4051.<BR><BR><B>GES Furnishings and Carpet</B> 
<UL class=text>
<LI class=text>10 percent discount on all standard carpet (13 oz) </LI>
<LI class=text>10 percent discount on custom cut carpet (26 or 50 oz.) for booths 400 sq. ft. or more </LI>
<LI class=text>10 percent discount on all standard furniture and accessories </LI>
<LI class=text>10 percent discount on all specialty furniture items</LI></UL><STRONG>GES Installation &amp; Dismantle (I&amp;D) Services </STRONG>
<UL class=text>
<LI class=text>5 percent discount on all GES I&amp;D services including labor and equipment </LI>
<LI class=text>Receive additional discounts when arranging GES I&amp;D services for multiple shows. Please call the GES hotline for a quote</LI></UL><B>GES Logistics (Shipping)</B> 
<UL class=text>
<LI class=text>10 percent discount on round-trip shipping costs for your booth freight and materials in and out of any GES show [does not include material handling (drayage) services] </LI>
<LI class=text>Receive additional discounts when booking round trip shipping needs for multiple shows (call 866-531-4051 for a quote)</LI></UL><B>GES Exhibit &amp; Design</B> 
<UL class=text>
<LI class=text>Receive free consultation on custom exhibit designs with no obligation</LI></UL><B>Contact GES 
<UL class=text>
<LI class=text></B>Call the GES VIP Exhibitor hotline today at 866-531-4051 to take advantage of CEA member savings </B></B></B></B></B></B></LI></B></UL><B>Terms and Conditions</B> 
<UL class=text>
<LI class=text>Orders must be received prior to each show's advance deadline date. Show site orders will not apply. </LI>
<LI class=text>Exhibitor must contact the hotline to place orders directly. Exhibitor appointed contractors (EACs) are not eligible to place orders on the exhibitor’s behalf. </LI>
<LI class=text>Discounts will be applied to orders received through the GES VIP Hotline only. Fax and Internet orders do not apply. </LI>
<LI class=text>Benefits may not be combined with other offers and specials</LI></UL>
