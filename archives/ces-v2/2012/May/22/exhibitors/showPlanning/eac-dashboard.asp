...
<head><!-- PageID 3896 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: EAC Dashboard</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/showPlanning/default.asp" class="footer">Show Planning/Exhibitor Manual</a>&nbsp;&gt;&nbsp;EAC Dashboard</div>
                        </div>
                         <div class="headerbox">
                            <h1>EAC Dashboard</h1>
                        </div><br />
        ...
        <p><strong>EAC Online Registration and Tools</strong></p>
        <p>CES Operations has a new online tool for Exhibitors to register their EACs, and for EACs to manage their requirements for CES. Any EAC that needs access to the CES show floor must upload their current information into this tool. A subcontracted EAC must also register, designate main contacts and provide a Certificate of Insurance with the required coverage listed in this section. Information should be provided no later than Friday, December 9, 2011.</p>
        <p>&nbsp;</p>
        <ul>
            <li>Exhibitors: Use the online tool at <a  href="http://www.CESweb.org/myEAC">www.CESweb.org/myEAC</a> to authorize your EAC as working on your booth at CES. Please follow up with your EAC to ensure that they are meeting their requirements as well. </li>
            <li>EACs: Use the online registration tool at <a  href="http://www.CESweb.org/eac">www.CESweb.org/eac</a> to register your company as an official EAC at CES. This tool helps you to manage your required information, submit your contact information, EAC Agreement and Certificate of Insurance, and track updates to your client listing. </li>
        </ul>
        For more information, please see the <a  target="_blank" href="http://www.ges.com/eComm/2012/Q1/11-05118/pdf/Sec5.pdf">EAC section</a> of the Exhibitor Manual.<strong>
        <h3>GES and LVCC Requirements</h3>
        Las Vegas Convention Center (LVCC) Requirements</strong><br />
        EACs intending to work in the LVCC must have approval from the venue and must have a valid ESCA WIS badge. All requirements must be met before commencing work at the LVCC. The requirements are listed below and can also be found at: <a  target="_blank" href="http://www.lvcva.com/meetings/meeting-venues/convention-centers/info/lvcc-requirements.jsp" ywaOnclickOverride="true">http://www.lvcva.com/meetings/meeting-venues/convention-centers/info/lvcc-requirements.jsp</a>. The Las Vegas Convention and Visitors Authority requires a $250 annual fee from all Independent Service Contractors providing service at the LVCC, a Clark County Businss License, a Nevada State Industrial Insurance Sysem Account must be established, and a valid Certificate of Insurance must be provided.<br />
        <br />
        <strong>GES Requirements<br />
        </strong>GES requires notification from Exhibitors in the event that an EAC will be working on your display. Please turn in the GES Notice of Intent to Use Exhibitor Appointed Contractor form, found in section #5 of the Exhibitor Manual, along with your insurance certificate.
