...
<head><!-- PageID 5390 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/japanese/hotels.asp">ホテル予約</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/japanese.asp" class="footer">日本語</a>&nbsp;&gt;&nbsp;ホテル予約</div>
                        </div>
                         <div class="headerbox">
                            <h1>ホテル予約</h1>
                        </div><br />
        ...
        <p><img alt="" style="margin: 5px; float: right;"  src="/images/photos/Vegas_200.jpg" />皆様の旅行プランをお手伝いするため、CESではラスベガス選りすぐりのホテルと交渉し、割引料金を提供しています。<br />
        <br />
        ホテルと料金の全リストは<a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a> (英語のみ) をご覧ください。CES向け料金でのご利用には、<a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a>でホテル名を選択し、直接ホテルにご予約いただく必要があります。このサイトから直接ホテルの予約ページに移行し、そこでクレジットカード情報を入力することができます。</p>
        <p>圧倒的な人気から、現在ほとんどのCES提携ホテルは満室、またはCES割引料金の客室も満室になっています。直前のホテル予約にお役立ていただくため、CESでは予備ホテルのリストを追加しました。これらのホテルと会場間のCESシャトルサービスはございません。<a href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a>（英語）の一番下に掲載されている完全リストをご覧ください。<br />
        <br />
        20部屋以上のご予約が必要な場合は、<a  href="http://www.cesweb.org/hotelTravel/blockRequest.asp">http://www.cesweb.org/hotelTravel/blockRequest.asp</a>でご希望のホテル名を直接リクエストしていただいても結構です。お客様のリクエストは直接ホテルに伝えられ、ホテル側から3営業日以内に返答が届きます。<br />
        <br />
