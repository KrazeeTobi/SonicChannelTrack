...
<head><!-- PageID 1174 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/japanese.asp" class="footer">日本語</a>&nbsp;&gt;&nbsp;国際サービス</div>
                        </div>
                         <div class="headerbox">
                            <h1>国際サービス</h1>
                        </div><br />
        ...
        <p><span class="text"><strong><span class="subhead">国際登録エリア<br />
        </span>LVCC、セントラルプラザ本登録所<br />
        ラスベガス・ヒルトンダンスホール<br />
        </strong>海外参加者向けの特別登録所は、LVCC、セントラルプラザ、ラスベガス・ヒルトンダンスホールに位置しています。これら2箇所のエリアで海外からのビジターは、当日登録やバッジホルダーの受取（ショー会場の入場に必要）を行ったり、複数言語を話す通訳の特別支援を受けて、登録に関する質問をしたりできます。<br />
        <br />
        <br />
        <span class="subhead"><strong>ICC（国際商業センター）</strong><br />
        </span><strong>LVCC、南ホールコネクタ、S224/225号室<br />
        </strong>LVCC 南ホールコネクタ、S224/225号室にあるICCは、海外からの訪問者や展示社がインターネットステーションの利用、会議室の予約および使用、軽食をとったり、リラックスできる場所です。国際ゲートウェイに近く、国際登録所にも隣接した便利な場所にあるため、CES滞在中の「出張オフィス」として利用できます。<br />
        <br />
        <strong>インターナショナル・レセプション<br />
        LVCC、サウスホール・コネクタ、S222室<br />
        </strong>海外からの来場者、出展者、メディア関係者の全員がCESのインターナショナル・レセプションに招待されます。本レセプションは海外から参加されている方のみが入場できます。人々との新たな出会い、同僚とのビジネスについての議論や、ビジネスパートナー関係を新たに結ぶ絶好のチャンスである本レセプションに、是非ともご参加ください。今年は、本レセプションにおいて海外での事業展開を模索している米国企業向けに、米国商務省による仲介プログラムが用意されます。会場にて皆様にお目にかかれることを楽しみにしています!<br />
        <br />
        <span class="subhead"><strong>通訳サービス</strong><br />
        ICC、LVCC、セントラルプラザおよびラスベガス・ヒルトンの海外登録所で多言語スタッフがお手伝いします。スペイン語、フランス語、中国語、日本語、韓国語を含む複数言語の通訳サービスで皆様を支援します。通訳サービスをご希望の方は、国際登録エリアの「Interpretation Services（通訳サービス）」カウンターまでお申し付けください。<br />
        </span><span lang="JA">
        <p> </p>
        <p> </p>
        <p> </p>
        <p><span class="text"><span class="subhead"><strong>国際バイヤープログラム<br />
        </strong></span>インターナショナルCESは、米国商務省、国際通商局が後援する国際 バイヤープログラム（IBP）に参加しています。米国商務省の国際貿易スペシャリストがメインICC(LVCC南ホールコネクタ、S224/225号室)に待機しており、海外の来場者や出展社に出会いの場や輸出カウンセリングを提供します。<br />
        </span></p>
        </span>
        <p> </p>
        </span></p>
