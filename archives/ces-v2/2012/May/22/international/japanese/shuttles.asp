...
<head><!-- PageID 5392 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/japanese/shuttles.asp">シャトルサービス</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/japanese.asp" class="footer">日本語</a>&nbsp;&gt;&nbsp;シャトルサービス</div>
                        </div>
                         <div class="headerbox">
                            <h1>シャトルサービス</h1>
                        </div><br />
        ...
        <img alt="" style="float: right;"  src="/images/photos/CESshuttle190X136.jpg" />時間も費用も節約！ CES公式ホテルに滞在すれば、ラスベガスコンベンション &amp; ワールドトレードセンター (LVCC) への送迎無料バスがご利用いただけ、タクシーやレンタカーの費用が節約できます。また、LVCC周辺、およびLVCC－ザ・ベネチアン間往復の無料シャトルもご利用いただけます。ショー終わりの2日間は、空港までの無料シャトルサービスもご利用ください。<br />
        <br />
        <h3>シャトルサービス</h3>
        インターナショナルCESでは、4日間の開催期間中、無料シャトルサービスが提供されます。また、期間中にネットワークづくりやビジネス交渉で成果を上げた後、ご帰宅の際に、空港までのシャトルサービスもご利用いただけます。<br />
        <a  target="_blank" href="/docs/2012ShuttleMap_CESweb.pdf">ダウンロードはこちらから。 <br />
        <br />
        <br />
        </a>
        <h3>ラスベガスコンベンションセンターシャトルループ</h3>
        ラスベガスコンベンションセンターの反対側まで行かなければならないときは、このシャトルをご利用いただくと、時間の節約になり、疲れた足を休めていただくことができます。このシャトルは10分間隔で運行され、ビル周囲の主要ポイント5か所で止まります。<br />
        <h3 >ラスベガスコンベンションセンター連絡ゴルフカート</h3>
        ラスベガスコンベンションセンターではショー開催時間中、セントラルホール5裏とサウスホール1～2裏との間で、無料の連絡ゴルフカートサービスがご利用いただけます。 <br />
        <h3 >ベネチアンエクスプレス</h3>
        報道日およびショー期間中は、ザ・ベネチアンとLVCCとの間でエクスプレスシャトルサービスが10分間隔で運行されます。高性能オーディオ &amp;ホームシアターや新テクノロジーにご興味がおありの方は、このベネチアンエクスプレスをご利用ください。 <br />
        <h3 >空港シャトルサービス</h3>
        <p>ラスベガスコンベンションセンターおよびザ・ベネチアン (バス乗り場) からマッカラン国際空港までのシャトルサービスがご利用いただけます。料金はお一人様片道$5で、ショー終わりの2日間、30分間隔で運行されます。</p>
        <h3>
        <p>乗客の指定乗降場</p>
        </h3>
        <p>LVCCへ友人や同僚の送迎を予定していますか？交通渋滞を緩和し、乗客の送迎をより安全にするため、LVCCのシルバー3ロットとゴールドロットの一部は自家用車（POV）の乗降場に指定されています。サウスホールに最も近い乗降場は、Paradise Road（パラダイス・ロード）から入り、シルバー3ロットをご利用ください。ノースホールおよびセントラルホールの乗降場は、Convention Center Drive（コンベンションセンター・ドライブ）から入り、Paradise Road（パラダイス・ロード）との交差点にあるゴールドロットをご利用ください。</p>
        <p>注：運転者は車内に留まる必要があります。駐車は禁じられています。</p>
        <p> </p>
