...
<head><!-- PageID 1160 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: 해외 방문객 서비스</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/korean.asp" class="footer">한국어 </a>&nbsp;&gt;&nbsp;해외 방문객 서비스</div>
                        </div>
                         <div class="headerbox">
                            <h1>해외 방문객 서비스</h1>
                        </div><br />
        ...
        <p><span class="text"><span class="subhead"><strong>국제 등록 장소</strong><br />
        </span><strong>LVCC, Central Plaza 메인 등록<br />
        Las Vegas Hilton Ballroom<br />
        </strong>인터내셔널 참가자들을 위한 특별 등록 장소는 LVCC, Central Plaza 및 Las Vegas Hilton Ballroom에 있는 메인 등록 장소내에 위치해 있습니다. 이 두 장소에서 국제 방문자들은 현장에서 등록을 하고 배지 홀더 (전시장에 들어가기 위해서 필요합니다)를 받거나 등록 관련 질문에 대해 도움을 줄 수 있는 다국어를 할 수 있는 통역사들의 언어 지원을 받으실 수 있습니다.<br />
        <br />
        <br />
        <span class="subhead">
        <p> </p>
        <p><span class="subhead"><strong>국제 상업 센터 (ICC)<br />
        LVCC, South Hall Connector,  S224/225호실<br />
        </strong>LVCC South Hall Connector의S224/225호실에 위치해 있는 ICC는 인터내셔널 방문자와 전시사들이 인터넷을 이용해 본국의 사무실과 연락을 하고, 사적인 회의실을 예약하고 사용할 수 있으며, 가벼운 다과를 즐기거나 휴식을 취할 수 있는 장소입니다. ICC는 인터내셔널 게이트웨이와 인터내셔널 등록장소에 가까이 위치하고 있어, CES에 계시는 동안 귀하의 현지 사무실로 사용하실 수 있습니다. <br />
        </span></p>
        </span>
        <p> </p>
        <p ><strong>국제 환영회<br />
        라스베이거스 컨벤션 센터 (LVCC), 사우스 홀, S222호실<br />
        </strong>모든 국제 참가자들, 전시업체들, 그리고 보도진은 CES 국제 환영회에 초대됩니다. 오직 국제 참가자들만을 위힌 행사입니다. 참석하셔서, 새로운 사람들을 만나고, 업계 동료들과 사업 이야기도 나누고, 새로운 비즈니스 파트너도 개발하십시오. 올해는, 미 상무부에서 본 리셉션에서 해외에서 사업하기를 원하는 미국 회사들과 연결해 주는 프로그램을 주관할 것입니다. 환영회에서 만나뵙기 희망합니다!</p>
        </span></p>
        <p>&nbsp;</p>
        <p><strong>통역사</strong><br />
        다양한 언어를 구사하는 직원들이 ICC와 LVCC, Central Plaza 및 Las Vegas Hilton Ballroom에 있는 인터내셔널 등록 장소에 배치되어 있습니다. 통역사들은 스페인어, 불어, 중국어, 일본어 및 한국어를 포함한 여러 언어로 지원해 드릴 수 있습니다. 통역사의 지원이 필요하시면, 국제 등록 장소에서, "Interpretation Services (통역 서비스)"라고 쓰여진 카운터를 찾으십시오.<br />
        <br />
        <span><span class="text"><strong><span class="subhead">국제 구매자 프로그램</span><br />
        </strong>국제 CES는 미 연방 상무부, 국제 무역청이 후원하는 국제 구매 프로그램의 자랑스런 회원입니다. 국제 참관자와 전시자들에게 수출 카운슬링을 해주고 짝짓기에 도움을 주기위해 미 상무부의 국제 무역 전문가들이 ICC 본회의장 (라스베가스 컨벤션 센터 (LVCC South Hall Connector, S224/225호실) 에  대기중입니다. <br />
        </span></span></p>
