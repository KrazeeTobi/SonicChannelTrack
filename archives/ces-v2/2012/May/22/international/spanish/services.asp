...
<head><!-- PageID 1150 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Servicios internacionales</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/spanish.asp" class="footer">Español</a>&nbsp;&gt;&nbsp;Servicios internacionales</div>
                        </div>
                         <div class="headerbox">
        ...
        <h3>Área de Inscripción Internacional</h3>
        <em>Centro de Convenciones de las Vegas (LVCC), Central Plaza – Inscripción Principal<br />
        Las Vegas Hilton – Ballroom (Salón de baile)<br />
        <br />
        </em>En el área principal de inscripción de la Central Plaza del LVCC y en el Salón de Baile de Las Vegas Hilton encontrará un área especial de inscripción para los concurrentes extranjeros. En esas dos áreas, los visitantes internacionales pueden inscribirse, obtener un porta gafete (que se requiere para ingresar en la exposición) u obtener ayuda lingüística especializada de intérpretes multilingües, quienes están disponibles para responder preguntas durante la inscripción. <br />
        <br />
        <h3>Centro de Comercio Internacional (ICC, por sus siglas en inglés)</h3>
        <em>LVCC, Conector South Hall, Salas S224/225</em><br />
        <br />
        El ICC está ubicado en el Conector South Hall del LVCC, Salas S224/225 y es el lugar en el que los concurrentes extranjeros y los expositores pueden mantenerse en contacto con sus oficinas a través de estaciones de Internet, reservar y utilizar salones para reuniones privadas, disfrutar de refrigerios o simplemente relajarse. Por estar ubicado convenientemente en las cercanías del International Gateway y cerca del área de Inscripción internacional, el ICC puede ser su “oficina remota” mientras participa en la exposición CES.<br />
        <br />
        <h3>Recepción Internacional</h3>
        <p><em>LVCC (Centro de Convenciones de las Vegas), South Hall Connector (Pasaje a la Sala Sur), Salón S222</em></p>
        Todos los participantes internacionales, los expositores y la prensa están invitados a la Recepción de la Exposición Internacional CES. Esta recepción es para visitantes internacionales únicamente. No se pierda esta oportunidad de conocer a personas nuevas, debatir sobre negocios con colegas o generar nuevos socios comerciales. Durante la recepción de este año, el Departamento de Comercio de EE.UU. patrocinará un programa de búsqueda de oportunidades para empresas estadounidenses que desean comerciar con empresas en el extranjero. ¡Esperamos verlo allí!<br />
        <br />
        <h3>Intérpretes</h3>
        El ICC, las áreas de inscripción para concurrentes extranjeros en la Central Plaza del LVCC, y el Salón de Baile de Las Vegas Hilton disponen de un personal políglota. Los intérpretes están disponibles para ayudar en varios idiomas, entre ellos español, francés, chino, japonés y coreano. En las áreas de Inscripción internacional, busque el mostrador rotulado “Interpretation Services” (Servicios de interpretación) si necesita ayuda. <br />
        <br />
        <h3>Programa de compradores internacionales</h3>
        International CES es un participante orgulloso del Programa de compradores internacionales, patrocinado por la Administración Comercial Internacional del Departamento de Comercio de EE. UU. Los especialistas comerciales internacionales del Departamento de Comercio de EE. UU. están disponibles en el ICC principal (LVCC, Conector South Hall, Salas S224/225), a fin de proporcionar asistencia de enlace empresarial y asesoramiento comercial de exportación a los asistentes y expositores internacionales.
