...
<head><!-- PageID 1415 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Tech & Engineering Emmy Awards</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/awards/default.asp" class="footer">Awards</a>&nbsp;&gt;&nbsp;Tech & Engineering Emmy Awards</div>
                        </div>
                         <div class="headerbox">
        ...
        <img width="200" height="112" alt="" style="border: 0px solid; float: right; margin-left: 8px; margin-right: 8px;"  width="200" height="112" src="/images/content/Emmys_200.gif" /> <strong>Thursday, January 12, 2012<br />
        6:30 p.m. Reception<br />
        7:30 p.m. Dinner<br />
        The Venetian, Delfino 4101, Level 2<br />
        <br />
        </strong>Launched in 1948, The Technology and Engineering Emmy® Awards honor development and innovation in broadcast technology and recognize companies, organizations and individuals for breakthroughs in technology that have a significant effect on television engineering.
        <p>For ticket and sponsorship information, contact Lauren Saverine at 212-484-9440 or by email at <a  href="mailto:lsaverine@emmyonline.tv">lsaverine@emmyonline.tv</a>.</p>
        <p><strong>Winners announced! </strong>Companies and people in the consumer technology and digital entertainment fields are honored each year. The <a  target="_blank" href="http://www.emmyonline.tv/mediacenter/tech_2k11_winners.html">individuals and companies to be honored at the 2012 event</a> include:</p>
        ...
        <ul class="text">
            ...
            <li class="text">Shuji Nakamura, Professor, University of California - Santa Barbara </li>
        </ul>
