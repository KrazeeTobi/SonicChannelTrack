...
<head><!-- PageID 1170 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/japanese.asp" class="footer">日本語</a>&nbsp;&gt;&nbsp;旅行とビザ情報</div>
                        </div>
                         <div class="headerbox">
                            <h1>旅行とビザ情報</h1>
                        </div><br />
...
<P><SPAN class=text>アメリカ合衆国の出入国に際して役立つ情報です。</SPAN></P>


<h2>旅行</h2>

<P><SPAN class=text><STRONG><SPAN class=subhead>CES会場への道順が必要ですか？</SPAN><BR></STRONG><A href="/hotelTravel/default.asp">CESweb.orgのトラベル・セクション [/attendees/travel]（英語）</A>にアクセスし、最もお得な航空運賃やレンタカー料金、および現地の交通情報を見つけてください。<BR><BR><SPAN class=subhead><STRONG>宿泊施設の情報が必要ですか？</STRONG></SPAN><BR><A href="/hotelTravel/hotel.asp">CESweb.orgのホテル・セクション （英語）</A>にアクセスし、団体または個人予約をしてください。</SPAN></P>


<h2>ビザ情報</h2>

<P target="_blank"><SPAN class=text><A href="https://ceac.state.gov/genniv/ " target=_blank>ビザをお求めですか？現在、オンラインでビザ申請書をご記入いただけます。</A><BR><BR><A href="/docs/Japanese_2K12VisaTips.pdf" target=_blank>ヘルプが必要な場合は、弊社のビザ関連説明書をダウンロードし</A>、順を追った説明やウェブサイトアドレスなどの情報でビザ申請手続きの助力を得てください。<BR></SPAN></P><BR>
...
<TR>
<TD>
<H3>ビザ免除プログラムでの参加者への重要なお知らせ</H3>電子渡航認証システム (ESTA) の登録申請又は更新には手数料$14.00が必要です (クレジットカード又はデビットカードでお支払い)。現在のESTA申請は、有効期限日まで有効です。詳細については、<A href="http://cbp.gov/xp/cgov/travel/id_visa/esta/" target=_blank>国土安全保障省、税関国境警備局ウェブサイトのESTAウェブページ</A>をご覧ください。</A></TD></TR></TBODY></TABLE><BR>
