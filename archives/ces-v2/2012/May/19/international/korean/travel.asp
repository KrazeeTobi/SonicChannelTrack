...
<head><!-- PageID 1156 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: 여행 및 비자 안내</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/korean.asp" class="footer">한국어 </a>&nbsp;&gt;&nbsp;여행 및 비자 안내</div>
                        </div>
                         <div class="headerbox">
                            <h1>여행 및 비자 안내</h1>
                        </div><br />
...
<P><SPAN class=text>미국 출입국 시 유용한 정보입니다. </SPAN></P>


<h2>여행</h2>

<P><SPAN class=text><STRONG><SPAN class=subhead>CES 여행에 도움이 필요하십니까?</SPAN><BR></STRONG><A href="/hotelTravel/default.asp">CESweb.org의 여행 섹션 (영어 사이트)</A>를 방문하시면 최상의 항공 요금과 렌트카 요금은 물론 교통편에 대한 정보를 찾아보실 수 있습니다.<BR><BR><STRONG><SPAN class=subhead>숙박 안내가 필요하십니까?</SPAN><BR></STRONG><A href="/hotelTravel/hotel.asp">CESweb.org의 호텔 섹션 (영어 사이트)</A>를 방문하시면 단체 및 개인 예약을 하실 수 있습니다.</SPAN></P>


<h2>비자 안내</h2>

<SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO><SPAN class=subhead><STRONG><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>비자가</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>필요하십니까</SPAN></SPAN><SPAN class=text1><SPAN>?</SPAN></SPAN></STRONG></SPAN></SPAN></SPAN><SPAN class=text1><SPAN><BR></SPAN></SPAN><A href="https://ceac.state.gov/genniv/"><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>이제</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>비자</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>신청서를</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>온라인으로</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>접수시킬</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>수</SPAN></SPAN><SPAN class=text1><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>있습니다</SPAN></SPAN></A><SPAN class=text1><SPAN><A href="https://ceac.state.gov/genniv/">. </A><BR><BR></SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO><SPAN class=subhead><SPAN class=text1><STRONG><SPAN style="FONT-FAMILY: " lang=KO>도움이</SPAN><SPAN lang=KO> </SPAN></STRONG></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO><STRONG>필요하십니까</STRONG></SPAN><SPAN><STRONG>?</STRONG><BR></SPAN></SPAN></SPAN></SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>단계별</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>설명을</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>제공하는</SPAN><SPAN lang=KO> </SPAN></SPAN><A href="/docs/Korean_2K12VisaTips.pdf" target=_blank><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>비자</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>안내서</SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>를</SPAN><SPAN lang=KO> </SPAN></SPAN></A><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>다운로드</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>하십시오</SPAN><SPAN>.&nbsp; </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>비자</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>신청</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>절차에</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>대한</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>웹사이트</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>주소와</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>각종</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>정보가</SPAN><SPAN lang=KO> </SPAN></SPAN><SPAN class=text1><SPAN style="FONT-FAMILY: " lang=KO>제공됩니다</SPAN><SPAN>.</SPAN></SPAN><BR><BR>
...
<TR>
<TD>
<H3>비자 면제 프로그램으로 여행하시는 참가자 여러분들을 위한 중요한 정보</H3>모든 전자여행허가제(ESTA) 등록 신청 또는 갱신은 신용카드나 현금카드로 수수료 14달러 납부해야 합니다. 기존의 전자여행허가 (ESTA)는 만료일까지 유효합니다. 더 자세한 정보를 원하시면&nbsp; <A href="http://cbp.gov/xp/cgov/travel/id_visa/esta/" target=_blank>국토 안보부 (Department of Homeland Security)의 관세 및 국경 보안청 (Customs and Border Protection) 웹사이트에 있는 전자여행허가 (ESTA) 웹페이지를 방문하십시오</A>.</A></TD></TR></TBODY></TABLE>
