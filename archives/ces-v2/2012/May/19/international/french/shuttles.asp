...
<head><!-- PageID 5383 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Service de Navette</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/french/shuttles.asp">Service de Navette</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/french.asp" class="footer">Français</a>&nbsp;&gt;&nbsp;Service de Navette</div>
                        </div>
                         <div class="headerbox">
        ...
        <p>CES vous fait gagner du temps et de l’argent ! Épargnez l’argent des trajets en taxis et des locations de voitures en logeant à l’un des hôtels « officiels CES » et en utilisant les cars gratuits pour vous trajets aller-retour au palais des expositions de Las Vegas, le « Convention and World Trade Center » (LVCC). CES offre également des navettes gratuites qui permettent certains déplacements aux alentours du palais des expositions (le LVCC) et des allers-retours gratuits entre le LVCC et l’hôtel-casino « The Venetian ». De plus, au cours des deux derniers jours de l’exposition, vous pourrez profiter d’un service de navette gratuit vers l’aéroport de Las Vegas.</p>
        <h3>
        <p>Navette</p>
        </h3>
        <p>L’exposition CES offre un service de navette gratuit durant les quatre jours que dure l’exposition International CES. Nous vous aiderons même à vous rendre à l’aéroport lorsque vous rentrerez chez vous après plusieurs jours de réunions et de signatures de contrats prometteurs.</p>
        <p><a  target="_blank" href="/docs/2012ShuttleMap_CESweb.pdf">Téléchargez l’horaire ici.</a></p>
        <h3>
        <p>La navette du Las Vegas Convention Center</p>
        </h3>
        <p>Si vous devez vous rendre d’un bout à l’autre du palais des expositions, le « Convention Center » de Las Vegas, prenez la navette ; elle vous fera gagner du temps et vous permettra de mettre vos pieds au repos. La navette circule toutes les 10 minutes et s’arrête à cinq points principaux choisis autour du palais.</p>
        <h3>
        <p>Le service « Golf Cart Intraconnect » du Las Vegas Convention Center</p>
        </h3>
        <p>Utilisez le service « Intraconnect » gratuit de voiturettes de golf qui circule pendant les heures d’ouverture de l’exposition de l’arrière du Central Hall n° 5 à la partie arrière des « South Halls », les salles 1 et 2 situées au sud du Convention Center.</p>
        <h3>
        <p>Le service Venetian Express</p>
        </h3>
        <p>La navette Express Shuttle passe toutes les 10 minutes, elle relie le casino hôtel « The Venetian » et le Convention Center, tous les jours d’ouverture de l’exposition, et aussi le jour de visite de la presse, « Press Day ». Si les systèmes haute performance et technologies nouvelles en fait de home cinéma et d’audiophilie vous intéressent, prenez le « Venetian Express ».</p>
        <h3>
        <p>Service de navette aéroport</p>
        </h3>
        <p>La navette à destination du McCarran International Airport est disponible au départ du Centre des expositions, le Las Vegas Convention Center et du Casino Hôtel « The Venetian » (à hauteur des arrêts de chargement des cars). L’aller simple coûte 5 dollars par personne et la navette est disponible toutes les demi-heures pendant les deux derniers jours de l’exposition.</p>
        <h3>
        <p>Zones réservées pour l’accueil de passagers à l’arrivée et le dépôt de passagers à l’embarquement</p>
        </h3>
        <p>Déposez-vous, ou allez-vous chercher un ami ou un collègue au Las Vegas Convention Center (LVCC) ? Afin d’atténuer les encombrements et accueillir/déposer les passagers dans de meilleures conditions de sécurité, des sections spécifiques des zones de parking « Silver 3 Lot » et « Gold Lot » du LVCC ont été désignées en tant que zones réservées aux véhicules privés (Privately Owned Vehicles, POV). Pour l’accès le plus proche des pavillons Sud (South Halls), utiliser le parking « Silver 3 » et l’entrée située sur Paradise Road. Pour l’accès le plus proche des pavillons Nord et Central, utiliser le parking « Gold Lot », au coin de Paradise Road et Convention Center Drive et l’entrée située sur Convention Center Drive.</p>
        <p>Remarque : Les conducteurs doivent rester au volant ; le parking n’est pas autorisé.</p>
