...
<head><!-- PageID 1137 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Programme Groupe Délégation</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li ><a href="/international/hotels.asp">Hotel Reservations</a></li>
            ...
            <li ><a href="/international/shuttles.asp">CES Shuttle Service</a></li>
            ...
            <li ><a href="/international/french/hotels.asp">Réservations d'hôtel</a></li>
        
            <li class="selected"><a href="/international/french/delegations.asp">Programme Groupe Délégation</a></li>
        
            <li ><a href="/international/french/services.asp">Services internationaux</a></li>
        
            <li ><a href="/international/french/shuttles.asp">Service de Navette</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;<a href="/international/french.asp" class="footer">Français</a>&nbsp;&gt;&nbsp;Programme Groupe Délégation</div>
                        </div>
                         <div class="headerbox">
        ...
        <p>Vous souhaitez amener un groupe de votre pays au Salon CES International ? En tant que chef de délégation, vous pouvez permettre à vos clients de mieux profiter de leur visite du salon en les aidant à décider des exposants à rencontrer, mais aussi simplifier l’aspect logistique de leur voyage. La CEA propose un programme de groupe avantageux, pour les chefs de délégation comme pour les participants.<br />
        <br />
        L’inscription gratuite au salon est parmi les nombreux avantages dont profiteront les participants au programme de délégation. Si vous vous joignez à une délégation et <a  href="/register">vous inscrivez à CES</a> après le 30 août, les frais d’inscription de 100 dollars US sont supprimés.<br />
        <br />
        Remarque : Votre inscription en tant que chef de délégation ne suffit pas pour vous inscrire au salon. <a  href="/register">Vous devez également remplir le processus d'inscription officiel pour recevoir vos documents officiels.<br />
        </a><br />
        ...
        <span style="display: inline-block;" id="_containermyExperience1128810977001"><object id="myExperience1128810977001" class="BrightcoveExperience" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="460" height="390" type="application/x-shockwave-flash" callback2059="function () {
        ...
        <PARAM NAME="movie" VALUE="http://c.brightcove.com/services/viewer/federated_f9?&amp;width=460&amp;height=390&amp;flashID=myExperience1128810977001&amp;bgcolor=%23FFFFFF&amp;playerID=26356940001&amp;playerKey=AQ~~%2CAAAABh3C_dE~%2CzBkXqCU8KVYYG5utII4f8nND4rqBAlFX&amp;isVid=true&amp;dynamicStreaming=true&amp;%40videoPlayer=1128810977001&amp;autoStart=&amp;debuggerID="></object></span><!--  This script tag will cause the Brightcove Players defined above it to be created as soon as the line is read by the browser. If you wish to have the player instantiated only after the rest of the HTML is processed and the page load is complete, remove the line. -->
        <script type="text/javascript">brightcove.createExperiences();</script>
        <!-- End of Brightcove Player --><br />
        <strong><br />
        Détails du programme<br />
        </strong>Pour s’inscrire en tant que chef de délégation:
        <ul class="text">
            <li class="text">Le programme de délégation est réservé exclusivement aux participants qui viennent de l’extérieur des États-Unis. </li>
            <li class="text">Les délégations doivent être constituées uniquement de professionnels de l’industrie de l’électronique grand public. </li>
            <li class="text">Les délégations doivent être constituées d’un minimum de 15 membres. Les membres de groupes inférieurs à 15 participants doivent s’inscrire en tant que participants individuels. </li>
        </ul>
        <p><strong>Avantages réservés aux chefs de délégation</strong></p>
        <ul>
            <li class="text">Prise en charge de l’hôtel pour les chefs de délégation de 50 membres (15 pour les délégations gouvernementales). Les groupes doivent confirmer leur participation quatre semaines avant le Salon CES afin de garantir la disponibilité. </li>
            <li class="text">Bulletin d’information communiquant les toutes dernières informations concernant le programme, le salon CES et les dates limites pour bénéficier des avantages du programme. </li>
            <li class="text">Occasion de voyager avec d'autres professionnels de l'électronique grand public de votre pays. </li>
            <li class="text">Accès à des spécialistes du commerce international du Département américain du commerce qui peuvent aider les participants et les exposants internationaux à trouver des correspondants et des consultants en matière de commerce d'exportation. </li>
        </ul>
        <p><strong>Avantages réservés aux membres des délégations</strong></p>
        <ul>
            <li class="text">Laisser-passer Plus gratuit pour les expositions. </li>
            <li class="text">Liste des exposants exportateurs ou intéressés par l’exportation vers le pays et/ou la région du groupe. </li>
            <li class="text">Organisateurs pour vous aider à planifier votre agenda pour le salon CES. </li>
            <li class="text">Séminaire/briefing sur place. </li>
            <li class="text">Invitation à la réception CES International.  </li>
        </ul>
        <p> </p>
        <p><b>Programme des acheteurs internationaux du Département américain du commerce</b><br />
        <img width="155" height="158" alt="" style="float: right;"  src="/images/content/doc_logo(1).JPG" />L’International CES est un fier participant de l’International Buyer Program (IBP) du Département du commerce des États-Unis. Par l’entremise du réseau de bureaux de l’U.S. Commercial Service dans les ambassades et les consulats américains du monde entier, l’IBP recrute des délégations d’acheteurs étrangers présélectionnés et les fait participer à des foires commerciales aux États-Unis, ce qui permet de mettre les entreprises américaines en contact avec des acheteurs internationaux. <br />
        <br />
        Les spécialistes du commerce du Commercial Service de votre ambassade ou consulat local peuvent vous aider à vous inscrire à la foire commerciale, à trouver les produits que vous souhaitez acheter lors de la foire et à organiser des réunions entre vous et les entreprises américaines. L’International CES participe fièrement à l’International Buyer Program (IBP), commandité par le Commercial Service du Département du Commerce des États-Unis. Dans le cadre de l’IBP, de nombreux spécialistes commerciaux étrangers dirigent des délégations au CES. <a  target="_blank" href="http://www.export.gov/eac/index.asp">Trouvez le bureau du Commercial Service dans votre pays.</a><br />
        <br />
        Si vous avez des questions sur l’inscription en tant que chef de délégation ou souhaitez contacter une délégation de votre pays, veuillez contacter la CEA à <a  href="mailto:delegations@CE.org">delegations@CE.org</a>.</p>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        ...
        <ul class="text">
            <li class="text"><a  target="_blank" href="/docs/2012_General_Overview_Brochure.pdf">Aperçu général, brochure en anglais (pdf) </a></li>
            <li class="text"><a  target="_blank" href="/docs/HI_RES_FR_2K12_CESfactSheet_Web.pdf">Feuille d’information CES traduite (pdf) </a></li>
            <li class="text"><a  target="_blank" href="/docs/DP_Brochure_Web.pdf">Brochure multilingue pour délégations</a></li>
            <li class="text"><a  target="_blank" href="/docs/2012_Program_Description_FNL.pdf">Avantages pour les chefs de délégation et les délégués (pdf en anglais)</a> </li>
            <li class="text"><a  target="_blank" href="http://content.ce.org/2k12CESI/2k12CES_DEL_02_1Mb.mov.zip">Informationnelle vidéo CES de montrer aux délégués potentiels (.mov)</a> </li>
        </ul>
