...
<head><!-- PageID 497 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: International Services</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;International Services</div>
                        </div>
                         <div class="headerbox">
        ...
        <h3>International Registration Area</h3>
        <p><em>LVCC, Central Plaza Main Registration<br />
        Las Vegas Hilton Ballroom<br />
        <br />
        </em>A special registration area for international attendees is located in the main registration area in the LVCC, Central Plaza and the Las Vegas Hilton Ballroom. In these two areas, international visitors can register on-site, pick up a badge holder (which is required to enter the show), or get special language assistance from multilingual interpreters available to help with registration questions. </p>
        <h3>International Commerce Center (ICC)</h3>
        <em>
        <p>LVCC, South Hall Connector, Room S224/225</p>
        </em>Located in the LVCC South Hall Connector, Room S224/225, the ICC is the place for international visitors and exhibitors to stay in touch with the office at Internet stations, reserve and use private meeting rooms, enjoy light refreshments or just relax. Conveniently located near the International Gateway and close to International Registration, the ICC can be your "office away from home" while you are at CES.
        <h3>International Reception</h3>
        <p><em>LVCC, South Hall Connector, Room S222<br />
        </em></p>
        <p>All international attendees, exhibitors and press are invited to the CES International Reception. This reception is for international visitors only. Don’t miss this opportunity to meet new people, discuss business with colleagues, or develop new business partners. This year, the U.S. Department of Commerce will host a matchmaking program for U.S. companies seeking to do business abroad at this reception. We look forward to seeing you there!</p>
        <h3>Interpreters</h3>
        <p>A multilingual staff is available in the International Commerce Center in Room S224 at the LVCC and the international registration areas in both the LVCC Central Plaza and Las Vegas Hilton Ballroom. Interpreters are available to assist you in several languages, including Spanish, French, Chinese, Japanese, and Korean. In the International Registration areas, look for the counter entitled, “Interpretation Services” if you need assistance. </p>
        <h3>International Buyer Program</h3>
