...
<head><!-- PageID 5370 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Call for Entries</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/awards/default.asp" class="footer">Awards</a>&nbsp;&gt;&nbsp;<a href="/awards/innovations/default.asp" class="footer">CES Innovations Awards</a>&nbsp;&gt;&nbsp;Call for Entries</div>
                        </div>
                         <div class="headerbox">
...
// javascript for e-mail this page tool - gets the url of the page the user is on before the e-mail page tool button is clicked
	...
	<!-- Start FORM -->
	If you would like to be added to the Innovations 2013 mailing list, fill out the form below. We'll notify you when we begin accepting entries. (<font style="color:red"><b>* </b></font> Denotes required field.)<br />
	...
	<h2>Sign up to receive Innovations 2013 Call for Entries updates</h2><br />
	...
	<tr>
		<td>&nbsp;</td>
		<td><input type="checkbox" size="35" name="future_contact" value="1" class="formData">Add me to the International CES distribution list for future CES updates!**</td>
	</tr>
	...
	<tr>
		<td>&nbsp;</td>
		<td>**Your privacy is important to us. Please review our <a href="/privacyPolicy.asp">privacy policy</a> for details.</td>
	</tr>
	</table>
	</form>
