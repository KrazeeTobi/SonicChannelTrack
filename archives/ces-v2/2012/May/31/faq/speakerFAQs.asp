...
<head><!-- PageID 1754 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/faq/default.asp" class="footer">FAQs</a>&nbsp;&gt;&nbsp;Speaker</div>
                        </div>
                         <div class="headerbox">
                            <h1>Speaker</h1>
                        </div><br />
...
No, as an International CES&nbsp;speaker, you will be automatically registered. Your badge will be available for pickup in the Speaker Ready Room (LVCC North Hall, N263) when you arrive on-site.
...
<P>All&nbsp;conference session times and locations&nbsp;are listed online in the&nbsp;Session Schedule. Please note that the schedule is subject to change. Please visit&nbsp;the <A href="/conferenceProgram/default.asp">Conference Program </A>page frequently for updates.<BR><BR>Speakers should coordinate rehearsals and arrival times with their session moderators.</P>
<br><img src="/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><BR>
...
Press and analysts are admitted to conference sessions free of charge.&nbsp;There are no specific press services offered for speakers.&nbsp;If your company is exhibiting at CES, please visit the PR Help for Exhibitors page.
<br><img src="/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><BR>
...
International CES is happy to produce handouts for conference sessions, but we must receive the handout by December 1, 2011. Speakers are responsible for making copies if the handout is not received by CES before December 1, 2011. 
<br><img src="/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><BR>
...
No, you are not required to use the&nbsp;International CES&nbsp;template,&nbsp;however, we strongly encourage it. The official 2012 CES template can be accessed <A href="/images/content/Presentation1.pptx" target=_blank>here</A>. 
<br><img src="/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><BR>
...
<LI class=text>VGA Switch Box </LI></UL>All other A/V equipment must be ordered and approved by October 1, 2011. A/V equipment cannot be ordered on-site.
<br><img src="/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><BR>
...
Yes, the Speaker Ready Room is&nbsp;located in the Las Vegas Convention Center, in the North Hall in room N263. The&nbsp;Speaker Ready Room will be equipped with a computer, access to the Internet, photocopier (for light photocopying only), and telephones.
<br><img src="/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><BR>
...
<P>Once the topics and sessions of the International CES Conference Program have been finalized, we look at the Call for Speakers entries for logical placements. Speakers are then selected based on their topic knowledge and prominence in their field. We also receive moderator recommendations for panelists. </P>Please know our program is largely comprised in panel format. There are rarely solo presenter opportunities.
<br><img src="/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><BR>
...
All Call for Speakers entries will be answered by September 30, 2011.
<br><img src="/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><BR>
