...
<head><!-- PageID 6046 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: January 2012</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/exhibitors/default.asp-->
            ...
            <li class="selected"><a href="/exhibitors/newsletter/jan12.asp">January 2012</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;January 2012</div>
                        </div>
                         <div class="headerbox">
                            <h1>January 2012</h1>
                        </div><br />
...
<div align="center">
    ...
    [ <a href="/exhibitors/newsletter/jan12ops.asp">Operations</a> ]

    [ <a href="/exhibitors/newsletter/jan12ven.asp">Venetian Corner</a> ]
...
<div class="sub-content-header">Annual CEA Member Cocktail Party at the 2012 CES</div>
<br />


        <img alt="" style="float: right;"  src="/images/content/CEA.gif" />One of CEA’s best-attended events each year at CES is the CEA Member Cocktail Party, held at the upcoming show on Tuesday, January 10, 6 – 8 p.m. (PT), at the International Food Market located in the LVCC South Hall 1 Lobby. CEA members and their guests are encouraged to join us for this incredible party.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">CES SuperSession: A Global Perspective on Retail Featuring Brian Dunn, CEO, Best Buy and Gary Shapiro, President and CEO, CEA</div>
<br />


        3-4 p.m. January 11, 2012<img alt="" style="float: right;"  src="/images/content/gary_shapiro.gif" /> <br />
        <img alt="" style="float: right;"  src="/images/content/Dunn_Brian.jpg" />LVCC, North Hall N255-257 <br />
        <br />
...
<div class="sub-content-header">Take Your Show on the Road with These Great Opportunities from CEA</div>
<br />
        ...
        <br />
        <strong><img alt="" style="float: right;"  src="/images/content/2012-CE-Week.jpg" />CE Week featuring CEA Line Shows <br />
...
<tr>
   ...
   Vice President, Sales</p>
    <hr align="center" width="90%" size="1" noshade color="#999999">
    <!-- article start -->
    <p><strong>A Thank You and Good Luck</strong><br> 
by Dan Cole</p>
    <p>
        ...
        <br />
        Our numbers are looking strong, and the feedback we’ve already received from exhibitors like you as well as the press and attendees preparing to do their own work here is stellar.<br />
        <br />
        Media organizations like <a  target="_blank" href="http://www.theverge.com/ces">The Verge</a> and <a  target="_blank" href="http://ces.cnet.com">CNET</a> are already reporting about the products to be unveiled and demoed on the show floor. The buzz is building now and will continue long through and after the show. It’s a flurry of energy that’s unmistakable and offers momentum for the entire year.<br />
        <br />
        While this is all underway, the 2013 CES begins to take shape – happening all in the tactical command center known as the 2013 CES Space Selection Room (LVCC South Hall Connector, Room S223).<br />
        <br />
        While this room is truly the foundation for next year’s show, it also serves as a place to be present: It permits us all a chance to have face time and see the people one-by-one who make the current show happen: YOU. If I don’t have the honor of shaking your hand personally during the space selection process or anytime during the course of the four days at CES, please let this serve as my honest and heart-felt extension of gratitude to you. On behalf of the CES Business Development team and everyone at the Consumer Electronics Association, I would like to say it is a privilege working with you to help shape and grow the consumer electronics industry.<br />
        <br />
        I know the days are long and the stress mounts over the course of the week, and I don’t want to add to that by taking up your time here. What I want to do, though, is to encourage you to take at least a little time each day you’re in Vegas to truly admire our collective work. Take stock of the absolutely awe-inspiring technology and this mass of people who are in constant pursuit of excellence. It’s astounding, and you’re a key part of it.<br />
        <br />
