...
<head><!-- PageID 650 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Speaking Opportunities</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/sponsorships/default.asp" class="footer">Promotional Opportunities</a>&nbsp;&gt;&nbsp;Speaking Opportunities</div>
                        </div>
                         <div class="headerbox">
...
<br />
        Share your knowledge, and build your reputation as a leader in the consumer electronics industry. Visit the <a  href="/conferenceProgram/speakers/default.asp">Call for Speakers</a> section for information on International CES speaking opportunities.<br />
        <br />
        <strong>Call for Speakers Opens:<br />
        </strong>May 1, 2012<br />
        <strong><br />
        Deadline:</strong><br />
        Submissions Due: 5pm EDT, July 12, 2011<br />
        <br />
        <b>Contact:</b><br />
        CES Conferences<br />
        Email: <a  href="mailto:CFS@CE.org">CFS@CE.org</a><br />
        <br />
        <br />
        <img alt="" style="margin-left: 10px; margin-right: 10px;"  src="/images/photos/speaker1.jpg" /><img alt="" style="margin-left: 10px; margin-right: 10px;"  src="/images/photos/speaker2.jpg" /><img alt="" style="margin-left: 10px; margin-right: 10px;"  src="/images/photos/speaker3.jpg" />
