...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <p>Information <br />
        <a  target="_blank" href="http://www.CE.org">CEA</a> is the industry authority on market research and forecasts; consumer surveys; legislative and regulatory news; engineering standards; training resources and more. <br />
        <br />
        <strong>Connections <br />
        </strong>Stay in touch with key industry leaders, government representatives, buyers, the media and others through <a  target="_blank" href="http://www.CE.org">CEA</a> conferences, meetings and online forums. <br />
        <br />
        <strong>Exposure</strong> <br />
        <a  target="_blank" href="http://www.CE.org">CEA</a> owns and produces the International CES, the world's largest consumer technology tradeshow. It unites retail buyers, distributors, manufacturers, industryt analysts, importers, exporters and press from 140 countries. CEA members receive discounted floor space and other benefits when they <a  href="/exhibitors/space/default.asp">exhibit at CES</a>. <br />
        <br />
        <strong>Influence</strong> <br />
        There truly is strength in numbers. The association's united voice before Congress as well as federal and state agencies protects your company's business interests. <br />
        <br />
        <strong>Education</strong> <br />
        CEA's research library, workshops and educational programs, technical training and certification programs are tools for member companies' success. <br />
        <br />
        <strong>Advantage</strong> <br />
        Members using CEA's resources have a built-in lead in today's competitive marketplace. <br />
        <br />
        <strong>Mission Statement</strong><br />
        CEA's mission is to grow the consumer electronics industry.<br />
        <br />
        Not a member yet? <a  target="_blank" href="http://www.ce.org/Membership/JoinCEA/default.aspx">Join CEA today. </a></p>
