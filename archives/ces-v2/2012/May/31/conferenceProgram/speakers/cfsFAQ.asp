...
<head><!-- PageID 1119 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Submission FAQs</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/conferenceProgram/speakers/cfsFAQ.asp">Submission FAQs</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/conferenceProgram/default.asp" class="footer">Conference Program</a>&nbsp;&gt;&nbsp;<a href="/conferenceProgram/speakers/default.asp" class="footer">Call for Speakers</a>&nbsp;&gt;&nbsp;Submission FAQs</div>
                        </div>
                         <div class="headerbox">
        ...
        <p><strong>I submitted a proposal but never received a confirmation. What happened?</strong><br />
        The confirmation should have come via email from <a  href="mailto:CFS@CE.org">CFS@CE.org</a> to the email address submitted online. If you did not receive a confirmation, please check your junk mailbox. If you still cannot find the confirmation email, it is likely we did not receive your submission, and you should try again. If you continue to experience difficulties, please contact <a  href="mailto:CFS@CE.org">CFS@CE.org</a>. <br />
        <br />
        <strong>Which session topic is most appropriate for our proposed speaker?</strong><br />
        Please read the session descriptions next to the categories on the website and choose a session that best fits your expertise.  Session descriptions are available May 1, 2012.<br />
        <br />
        <strong>Are speakers allowed to mention their products and services during their presentations?</strong><br />
        CES does not allow product promotion, but it is understandable that speakers may mention their company's products/services as it relates to the moderator's question. Speakers who abuse the opportunity are likely to be poorly rated in the attendee survey and will not be invited back. <br />
        <br />
        <strong>Are the speaking opportunities at CES for keynote speakers or for panel discussions? </strong><br />
        Keynote speaking opportunities are by invitation only. <a  href="/conferenceProgram/speakers/default.asp">The CES Call for Speakers</a> comprises CEA-produced conference sessions, largely formatted as moderator/panel.  Centering on 25+ sessions targeting some of the hottest topics in technology today and in the future, Call for Speakers sessions, combined with tracks produced by our conference partners, bring the talents and expertise of 900 speakers to the CES conference program that delivers 300 educational sessions to CES attendees covering the full range of topics relevant to the consumer electronics (CE) industry. <br />
        <br />
        <strong>Is there any chance the deadline will be extended or that a short extension of a few days could be given?</strong><br />
        In fairness to all prospects, the deadline is strictly enforced. </p>
        <p><strong>How do I submit for SuperSessions?<br />
        </strong>Submissions for CEA-produced SuperSessions, when offered, are included in the CES Call for Speakers. <br />
        <br />
        <strong>If one company executive is qualified to speak for more than one category, is it possible to submit more than one application?</strong><br />
        Yes. <br />
        <br />
        <strong>What is the general format for the sessions included in Call for Speakers? </strong><br />
        The majority of our CEA-produced conference sessions are moderated panel discussions without formal presentations. <br />
        <br />
        <strong>On the speaker submission form, is the word limit for the "speaker objective" a 100-word limit per topic selected or 100 words overall?</strong><br />
        This word limit is overall. <br />
        <br />
        <strong>How many sessions can be selected in one submission? </strong><br />
        Up to three sessions can be selected per submission. It is possible, however, to submit one proposal now and another for the same person at a later date as long as it is before the CES Call for Speakers deadline. <br />
        <br />
        <strong>Do you prefer CES speakers to be executives, such as VPs or above? Do you also accept technologists or marketing professionals?</strong><br />
        There is no minimum level of title or qualifications for speakers, although the majority of accepted speakers tend to be higher-level. <br />
        <br />
        <strong>What if we want to suggest a topic not listed on the CES Call for Speakers form?</strong><br />
        CEA will carefully select and finalize the topics for the 2013 CES. Topic submissions will be accepted until April 2, 2012, to <a  href="mailto:CFS@CE.org">CFS@CE.org</a>.  <br />
        <br />
        <strong>Are any sessions for media presenters only?</strong><br />
        Submissions are not limited to media only. Please submit for the session that is most appropriate for your expertise. <br />
        <br />
        <strong>Are any sessions for analyst presenters only?</strong><br />
        Yes, speakers can submit to the Just the Facts call for proposals.  <br />
        <strong></strong><strong><br />
        Are speakers required to be part of an exhibiting company?</strong><br />
        Speakers are not required to be from an exhibiting party. <br />
        <br />
        <strong>I submitted a Call for Speakers form. When will I be notified if I was chosen to speak?</strong><br />
        All Call for Speakers entries will be answered by September 28, 2012.  </p>
        <p><strong>Who is the target audience? Are sessions open to the general public? Are there any sessions tailored to exhibitors only?</strong><br />
        ...
        <br />
        <strong>How do I get an attendee list?</strong><br />
        Attendee lists are not released publicly. <br />
        <br />
        <strong>May I change the name of the speaker submitted?</strong><br />
        Proposals for new speakers may be made until 5 p.m. EDT Tuesday, June 12, 2012. Otherwise, speakers are chosen based on the name in the submission. Please make sure you have the appropriate speaker identified prior to submitting your proposal.</p>
