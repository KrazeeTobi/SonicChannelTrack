...
<head><!-- PageID 475 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: CES Shuttle Service</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/hotelTravel/default.asp" class="footer">Hotel/Travel</a>&nbsp;&gt;&nbsp;CES Shuttle Service</div>
                        </div>
                         <div class="headerbox">
        ...
        <a  target="_blank" href="/docs/2012ShuttleMap_CESweb.pdf"><img width="102" height="139" alt="" style="border: 0px solid; float: right; margin-left: 10px; margin-right: 10px;"  width="102" height="139" src="/images/photos/thumb.jpg" /></a>The International CES offers complimentary shuttle service on all four days of the International CES. We'll even help you get to the airport as you head home after several successful days of networking and deal making.<br />
        <br />
        <p><a  target="_blank" href="/docs/2012ShuttleMap_CESweb.pdf"  >Download it here.  </a></p>
        <p> </p>
        <p> </p>
...
<IMG hspace=10 align=left src="/images/photos/CESshuttle190X136.jpg" width=190 height=136>If you need to go from one side of the Las Vegas Convention Center to the other, consider this shuttle to save time and to give your legs a break. The shuttle runs every 10 minutes and stops at five key locations around the building.<BR><BR><BR><BR><br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
<br />
...
<br />
        ...
        Express shuttle service runs every 10 minutes between The Venetian and the LVCC, on Press Day and all show days. If digital imaging/photography interests you, you won’t want to miss the new PMA@CES. And while you’re there, check out the Sustainable Planet and Eureka Park Tech TechZones, plus the always dynamic high-performance audio exhibits and suites.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
Shuttle service to McCarran International Airport is available from the Las Vegas Convention Center and The Venetian (bus loading area). The one-way trip cost is $5 per person and is available every 30 minutes on the last two days of the show.
                            <script type="text/javascript">
