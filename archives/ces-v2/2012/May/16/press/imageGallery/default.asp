...
<head><!-- PageID 334 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Image Gallery</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/press/default.asp" class="footer">For The Press</a>&nbsp;&gt;&nbsp;Image Gallery</div>
                        </div>
                         <div class="headerbox">
                            <h1>Image Gallery</h1>
                        </div><br />
...
<TBODY>
<TR>
<TD vAlign=top width="45%"><A href="/press/imageGallery/2012people-events.htm"><IMG border=0 src="/images/content/keynotes.jpg" width=220 height=155><BR><BR>People and Events<BR></A>See who brings the International CES to life. Big names backing big technology. Powerful leaders discussing powerful issues.</TD>
<TD width=20>&nbsp;</TD>
<TD vAlign=top width="45%"><A href="/press/imageGallery/2012show-floor.htm"><IMG border=0 src="/images/content/show.jpg"><BR><BR>Show Floor Buzz<BR></A>Business connections multiply, the energy amplifies in and around the Las Vegas Convention Center/Hilton and The Venetian, the largest consumer technology tradeshow's venues.</TD></TR></TBODY></TABLE>
