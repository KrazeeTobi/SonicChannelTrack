...
<H2>The World's Coolest Tradeshow is Also the Greenest</H2>The world's coolest tradeshow is also the greenest. In 2010, Trade Show Executive Magazine named the International CES North America's Greenest Show. The magazine also honored CEA with the highly coveted "Leader in Green Initiatives" Gold Grand Award for outstanding green presence in producing the world's largest consumer technology tradeshow. <BR><BR>
<H3>Green Exhibits at CES<IMG style="FLOAT: right" alt="" src="/images/content/Sustainable.jpg"></H3>The <A href="http://www.cesweb.org/showFloor/techzones.asp#3864">Sustainable Planet TechZone</A> showcases the latest in eco-friendly products and energy efficiency technologies. It highlights the latest products that make it possible for every person on this planet to stay connected and informed, and live sustainable lifestyles through advances in green building, alternative energy technologies, green business services and solutions, smart grid technologies, solar and renewable products, sustainable packaging and wireless convergence. <BR>
<H3>Get Charged Up About Electric Vehicles</H3>
<P><IMG style="FLOAT: right" alt="" src="/images/content/GoElecDrive_200.jpg" width=148 height=82>The <A href="http://www.cesweb.org/showFloor/techzones.asp#3835">GoElectricDrive TechZone</A>&nbsp;showcases the full range of high- and low-speed electric vehicles, energy storage devices and charging solutions. Sponsored by the Electric Drive Transportation Association, this TechZone highlights an area of great potential and growth for the industry as electric vehicles are quickly gaining in popularity among consumers seeking to live more sustainably by using alternative transportation.</P>
<H3>Greener Gadgets </H3>
<P><IMG style="FLOAT: right" alt="" src="/images/content/Greener.gif" width=265 height=28>We're seeing a trend with Greener Gadgets in consumer electronics – smaller, more energy efficient and powerful converged devices that are more eco-friendly than ever before. These types of products will be on display at CES, whether it's an ultra-thin and efficient LED TV or the latest tablet that uses very little energy. To learn more about this development, and to use our handy energy calculator and recycling locator, please go to <A href="http://www.GreenerGadgets.org" target=_blank>GreenerGadgets.org</A>.&nbsp;<BR><BR><A href="http://greenergadgets.org" target=_blank></A></P>
<TABLE border=0 cellSpacing=0 cellPadding=3 width="80%">
<TBODY>
<TR>
<TD align=left>
<DIV style="TEXT-ALIGN: left; PADDING-BOTTOM: 0px; MARGIN: 0px; PADDING-LEFT: 0px; WIDTH: 180px; PADDING-RIGHT: 0px; BACKGROUND: url(http://www.greenergadgets.org/widgets/electronics-white.png) left top; HEIGHT: 150px; PADDING-TOP: 0px">
<FORM style="PADDING-BOTTOM: 0px; MARGIN: 0px; PADDING-LEFT: 0px; PADDING-RIGHT: 0px; PADDING-TOP: 0px" action=http://www.greenergadgets.org/recycle.html><INPUT style="BORDER-BOTTOM: medium none; TEXT-ALIGN: center; BORDER-LEFT: medium none; PADDING-BOTTOM: 0px; FONT-STYLE: italic; MARGIN: 120px 11px 0px 25px; PADDING-LEFT: 0px; WIDTH: 71px; PADDING-RIGHT: 0px; DISPLAY: inline; FONT-FAMILY: georgia, 'times new roman', times, serif; FONT-SIZE: 11px; BORDER-TOP: medium none; BORDER-RIGHT: medium none; PADDING-TOP: 0px" value="Enter Zip" name=zip> <INPUT style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; PADDING-BOTTOM: 0px; PADDING-LEFT: 0px; WIDTH: 61px; PADDING-RIGHT: 0px; DISPLAY: inline; BACKGROUND: url(http://www.greenergadgets.org/widgets/blank.gif); HEIGHT: 13px; BORDER-TOP: medium none; CURSOR: pointer; BORDER-RIGHT: medium none; PADDING-TOP: 0px" value="Submit Query" type=submit> </FORM></DIV></TD>
<TD align=right>
<DIV style="MARGIN-TOP: 0px; MARGIN-LEFT: 0px; MARGIN-RIGHT: 0px"><A style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" href="http://www.greenergadgets.org/energycalc.html"><IMG style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; BORDER-TOP: medium none; BORDER-RIGHT: medium none" alt="" src="http://www.greenergadgets.org/widgets/calculator-white.png"></A></DIV></TD></TR></TBODY></TABLE>
<P>&nbsp;</P>
<H2>Attendees: A Smaller Footprint with Bigger Opportunities</H2>The International CES provides our industry an opportunity to convene at one time, in one place, at an eco-friendly blockbuster that minimizes your annual travel. 
<UL class=text>
<LI class=text>By having so many meetings at CES, our attendees collectively avoid 1.28 billion miles in business trips that they otherwise would have to take if not for the International CES. As a result of attending CES and consolidating trips, the estimated net savings in travel miles is 733 million. </LI>
<LI class=text>Each of our attendees has an average of 12 meetings while at CES. </LI>
<LI class=text>Representatives travel from more than 140 different countries, offering a truly global opportunity. </LI></UL>
<H3>How Green is the International CES?</H3>
<P>As part of our efforts to reduce waste and give back to the local Las Vegas community, our green initiatives include the following:<BR><BR>At last year's 2011 International CES: </P>
<UL class=text>
<LI class=text>We recycled 289.6 tons of the solid waste generated at the show and increased our recycle rate from 68 percent to 77 percent, several points higher than the average show at the LVCC. </LI>
<LI class=text>We donated $75,000 to Green Chips, a non-profit organization promoting carbon neutrality, who used the funds to install solar panels at a local Salvation Army facility in Las Vegas. </LI>
<LI class=text>We worked with Repurpose AMERICA to divert 18,000 pounds of magnetic signs, nearly 15,000 square ft of banner material and more than 150 foam core signs from the local landfill with the intention to repurpose these materials and give back to the Las Vegas community. </LI></UL>
<P>At this year's 2012 CES, we plan to: </P>
<UL class=text>
<LI class=text>Continue expanding the use of recyclable carpet, now used for all aisle carpet and in all TechZones, Registration areas and turnkey booth packages. Turnkey packages now also include recyclable panels and graphics printed using soy ink. </LI>
<LI class=text>For the first time, use badge holders that are created from repurposed vinyl show banners . We also plan to collect them post show to repurpose for a third life. </LI>
<LI class=text>Partnering with Global Experience Specialists, produce all indoor show signs and bases using biodegradable cardboard material. </LI>
<LI class=text>Work with Repurpose America again to capture magnetic, vinyl and cardboard show signs with the intention to repurpose and give back to the local community. </LI>
<LI class=text>During the show, announce another charitable contribution to a Las Vegas organization with local efforts in sustainability. </LI>
<LI class=text>Continue cuts in print production which stands at nearly 50 percent of where it was five years ago. For remaining print materials, we print on recycled paper, use soy-based ink and meet the standards of the Sustainable Forest Initiative and Forest Stewardship Council. </LI></UL>
<H3>CES works with&nbsp;Partners Who are Committed to Sustainability</H3>
<UL class-="text">
<LI class=text>With the help of our partners, CES attendees can conduct a year's worth of business while knowing that are doing so in an environmentally friendly location. </LI>
<LI class=text>Aramark catering service uses bulk condiments instead of individual packages, offers attendee food containers and utensils made of biodegradable hemp, corn byproduct or other organic materials, donates surplus food products to local food banks and uses new energy efficient dishwasher that saves 798,034 gallons of water per year. </LI>
<LI class=text>Global Experience Specialists (GES) offers sustainable booth packages and offers a selection of eco-friendly recyclable carpets and biodegradable décor materials, all made from recycled content. Further, they use energy-efficient display lighting, recycle steel and aluminum exhibit structures and run 95 percent of all equipment on clean, natural gas. </LI>
<LI class=text>The Las Vegas Convention Center diverts recyclable materials from landfills (averaging a 70 percent recycle rate for all of its shows), uses a power monitoring system to track electrical power usage and identify areas for improved efficiency and has installed water conservation devices in urinals, toilets and faucets. </LI>
<LI class=text>The Venetian/Palazzo has reduced annual water consumption by more than 97 million, recycles over 55 percent of their solid waste stream, and received silver-certification for the Palazzo by the U.S. Green Building Council's Leadership in Energy and Environmental Design (LEED). </LI></UL>
<H3>CEA Members Among Newsweek's Greenest Corporations</H3><A href="http://www.ce.org/Press/CurrentNews/press_release_detail.asp?id=12178">CEA applauds member companies</A> recognized by Newsweek as among the nation's greenest corporations. IBM, HP, Sprint Nextel and Dell took four of the top five spots on the list, which ranked America's 500 largest corporations according to environmental impact, management and transparency. CEA member companies took seven of the top 15 spots on the list, indicating that they broad ly employing innovative and sustainable practices. 
<H3>CEA Highlights Green Research</H3>From trends in eco-friendly TVs to illuminating detail about consumer attitudes on energy efficiency with consumer electronics, CEA has the latest research. Visit <A href="http://www.CE.org/green">www.CE.org/green</A> for more information.&nbsp;&nbsp; 
