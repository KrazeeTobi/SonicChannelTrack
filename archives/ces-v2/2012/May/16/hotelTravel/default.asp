...
<head><!-- PageID 421 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
   ...
   <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <title>2012 CES: Hotel/Travel</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
            ...
            <div id="page-bottom">
                <div id="main-content">
                    ...
                    <div id="main-content-header">
                        <img src="/images/content/Subhead_HotelTravel.jpg">
                    </div>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;Hotel/Travel</div>
                        </div>
   ...
   <h2>Hotel Reservations</h2>
    ...
    <p>
        <img width="60" height="75" alt="" style="border: 0px solid; float: right; margin-left: 2px; margin-right: 2px;"  width="60" height="75" src="/images/content/Hotel_02.jpg" />The only thing more important than registering for CES is <a  href="/hotelTravel/hotel.asp">booking hotel and flight accommodations for CES</a>.
    </p>
</div><div class="grid-box">
   <h2>Transportation/Parking</h2>
    
    
    <p>Cabs abound in Vegas, but parking is harder to come by. <A href="/hotelTravel/cars.asp">Find pointers and car rental info here.</A></p>
</div><div class="grid-box">
   <h2>CES Shuttle Services</h2>
    
    
    <p>Travel from your hotel to the show and <A href="/hotelTravel/shuttle.asp">get around all CES locations — for free</A>. </p>
</div><div class="grid-box">
   <h2>Airline Discounts</h2>
    
    
    <p><IMG style="MARGIN-LEFT: 2px" border=0 hspace=2 align=left src="/images/content/Airport_02.jpg" width=60 height=75>CES has partnered with many major airlines to bring you <A href="/hotelTravel/airlines.asp">flight discounts</A>.</p>
</div><div class="grid-box">
   <h2>Las Vegas Monorail</h2>
    
    
    <p><A href="/hotelTravel/monorail.asp"><IMG style="MARGIN-LEFT: 2px" border=0 hspace=2 align=right src="/images/content/monorail_mini.gif" width=65 height=65>The monorail</A> takes you from the LVCC to many hotels along the Strip.</p>
</div><div class="promo-box">
    
    
       
    <A href="http://www.cesweb.org/conferenceProgram/speakers/default.asp "><img src="/docs/CFS_2013.jpg" width="227" height="200"></A>
</div><div class="promo-box">
   ...
   <h2>Las Vegas Travel Tips</h2>
    
    
    <p><IMG style="MARGIN-LEFT: 2px" border=0 hspace=2 align=right src="/images/content/Hotel_03.jpg" width=60 height=75>What's the weather? What's the tipping policy?&nbsp;<A href="/hotelTravel/lasVegas.asp">Use this Vegas travel guide&nbsp;to help you.</A></p>
</div>
