...
<head><!-- PageID 5243 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: IAWTV Awards</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/awards/iawtv.asp">IAWTV Awards</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/awards/default.asp" class="footer">Awards</a>&nbsp;&gt;&nbsp;IAWTV Awards</div>
                        </div>
                         <div class="headerbox">
                            <h1>IAWTV Awards</h1>
                        </div><br />
        ...
        <p><img width="260" height="57" alt="" style="float: right; margin-left: 3px; margin-right: 3px;"  width="260" height="57" src="/images/content/IAWTV_260.jpg" /> The red carpet rolled out at the 2012 CES, thanks to the International Academy of Web Television (IAWTV) Awards. The IAWTV Awards is the first award show within the Web television industry to be presented by content creators, for content creators.  From studio content producers to YouTube celebrities, those successfully creating entertainment for digital platforms are celebrated via 33 categories honoring web series and online talent, in front of the camera and behind the scenes.</p>
        <p>The winners for the IAWTV Awards were chosen by majority vote of the active voting membership of the IAWTV from nominees who topped more than<br />
        350 officially submitted web series. The winners were presented with awards celebrating their outstanding achievements across 32 different categories.</p>
        <h3>
