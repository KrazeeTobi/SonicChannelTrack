...
<head><!-- PageID 3681 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Follow Me</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;Follow Me</div>
                        </div>
                         <div class="headerbox">
                            <h1>Follow Me</h1>
                        </div><br />
        ...
        <script type="text/javascript" src="http://www.cesweb.org/HP/js/jquery.cycle.all.min.js"></script>
        <table border="0">
            <tbody>
                <tr>
                    <td valign="top"><img width="104" height="103" alt="" style="float: left; margin-left: 5px; margin-right: 5px;"  width="104" height="103" src="/images/content/Follow-Me-Logo.gif" />
                    <h3>Enhance Your CES Experience</h3>
                    <br />
                    <p>Follow Me, the official mobile app for CES, is a great preshow planning and on-site navigational tool. If you have a smartphone (iPhone, iPod Touch or any other web-based smartphone), you can build your schedule and plan your time at CES on the go – anywhere, anytime! </p>
                    <p><img alt="" style="float: left; margin-left: 5px; margin-right: 5px;"  src="/images/content/2012CES-QR-FM.gif" />Create your show schedule on Follow Me and sync it to your MyCES account or vice versa. Similar to MyCES, with Follow Me you can search the exhibitor directory for companies or products you want to see, add them to your show agenda and even share your agenda with your friends. You can also get important show alerts, late-breaking CES news, view real-time interactive floor maps when they’re available and so much more! </p>
                    <p>Scan this code with your mobile phone to access the official 2012 CES mobile app now! Or point your mobile browser to <a  href="http://m.core-apps.com/2012CES">http://m.core-apps.com/2012CES<strong>.</strong></a></p>
                    <table style="border: #9f9f9f 1px solid;" border="0" cellpadding="8" width="100%">
                        <tbody>
                            <tr>
                                <td>
                                <p><strong><a  href="http://m.core-apps.com/ces-em2012"></a><img width="236" height="271" alt="" style="width: 67px; float: right; height: 67px;"  width="67" height="67" src="/images/content/Final_CES_EM_Icon.png" /> Get the EM App Now<br />
                                </strong><a  href="http://m.core-apps.com/ces-em2012">Follow EM</a>, the official Entertainment Matters app for CES, is a great resource for navigating all things content- and entertainment-related at CES. Use your smartphone to build your schedule and plan your time at CES on the go. Point your mobile browser to <a  href="http://m.core-apps.com/ces-em2012">m.core-apps.com/ces-em2012</a>, create your own username and use password EMCES.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <p><strong>For technical support, please email </strong><a  href="mailto:support@core-apps.com"><strong>support@core-apps.com</strong></a><strong>.<!--<STRONG><BR>Watch a demo:</STRONG> 
<DIV align=center>
<OBJECT width=425 height=344><param NAME="movie" VALUE="http://www.youtube.com/v/J4v7FFzNOR0&amp;hl=en_US&amp;fs=1&amp;"/><param NAME="allowFullScreen" VALUE="true"/><param NAME="allowscriptaccess" VALUE="always"/>
<embed src="http://www.youtube.com/v/J4v7FFzNOR0&hl=en_US&fs=1&" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="425" height="344"></embed></OBJECT></DIV>--></strong></p>
                    </td>
                    <td valign="top">
                    <table style="border: #9f9f9f 1px solid;" border="0" cellpadding="8" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <h3>Get the App</h3>
                                <br />
                                <p>Just point your mobile browser to <a  href="http://m.core-apps.com/2012CES">http://m.core-apps.com/2012CES</a> to download the 2012 Follow Me app today!</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
          ...
          $('#screenshots').cycle({ 
                    ...
                    <div style="margin: 0px 10px; width: 180px; height: 338px;">
                    <div id="screenshots">
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  width="180" height="338" src="http://www.cesweb.org/hp/images/followme/dashboard.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  width="180" height="338" src="http://www.cesweb.org/hp/images/followme/exhibitorlist.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  width="180" height="338" src="http://www.cesweb.org/hp/images/followme/exhibitordirectory.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  width="180" height="338" src="http://www.cesweb.org/hp/images/followme/map1.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  width="180" height="338" src="http://www.cesweb.org/hp/images/followme/friends.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  width="180" height="338" src="http://www.cesweb.org/hp/images/followme/friendsdetail.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  width="180" height="338" src="http://www.cesweb.org/hp/images/followme/hoteltravel.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  width="180" height="338" src="http://www.cesweb.org/hp/images/followme/news.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  width="180" height="338" src="http://www.cesweb.org/hp/images/followme/myprofile.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  width="180" height="338" src="http://www.cesweb.org/hp/images/followme/faq.png" /></div>
                    </div>
                    </div>
                    </td>
                </tr>
