...
<div class="grid-box">
   <h2>Videos & Recordings</h2>
    
    
    <p>
        Miss a conference session? Sit in on a dynamic panel discussion you want to hear again? View select <a  href="http://www.cesweb.org/faq/generalFAQs.asp#sessions">conference session videos</a> or <a  href="http://mobiltape.com/client/CES-Consumer-Electronics-Show/">purchase your audio recordings now</a>!
    </p>
</div><div class="promo-box">
    
    
       
    <A href="http://www.cesweb.org/aboutces.asp"><img src="/docs/Save_the_date_226x200.jpg" width="227" height="200"></A>
   ...
   <h2>Speaker Directory</h2>
    ...
    <p>
        <a  href="/conferenceProgram/speaker-directory.htm">See who spoke at the 2012 CES</a>. Search or view by speaker name or company.
    </p>
</div><div class="grid-box">
