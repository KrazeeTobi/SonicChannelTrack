...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <strong><img alt="" style="float: right;"  src="/images/content/myces.gif" />Stay connected with the Consumer Electronics industry throughout the year with MyCES <br />
        <br />
        </strong>MyCES is an interactive resource that allows CES exhibitors to:
        <ul>
            <li><connect />Develop and Access Sales Leads 365 days/year </li>
            <li>Drive traffic to your booth at CES</li>
        </ul>
        Be sure to fill out your <a  href="/exhibitors/cesSmartBooth/default.asp">free directory listing</a> and consider these upgrade option below to set you a part from the crowd.<br />
        <br />
        For more information about any of these exclusive opportunities, please email <a  href="mailto:brett@mapyourshow?Subject=2012%20CES%20Online%20Directory%20Sponsorships">Brett Glatfelter</a> or call at 908-399-6245.
    <br /><br />
<div class="page_header_block">
    <div class="blue_box">
        ...
        <li><a href="#4144">Leads Package</a></li><!---->
        ...
        <li><a href="#6331">LIMITED – Product Category Banner Package</a></li><!---->
...
<br />
        <ul class="text">
            <li class="text">Includes Leads Package</li>
            ...
            <li class="text">On average, exhibitors at this level receive 4x more traffic to their showroom</li>
        </ul>
...
<br />
        <ul class="text">
            <li class="text">Includes Silver Package</li>
            <li class="text">2 additional display panels capable of multimedia and/or images/descriptions (for a total of 5 panels). </li>
            <li class="text">Priority placement in the online directory search results (listing highlights at the top of the product category, keyword and alpha searchers)</li>
            <li class="text">"Corner Peel" graphic highlighting your booth on the online floor plan </li>
            <li class="text">On average, exhibitors at this level receive 14x's more traffice to their showroom</li>
        </ul>
...
<br />
        <ul>
            <li>Includes Gold Package (see above)</li>
            <li>Exclusive (one per product category) 180 x 150 pixel banner on cesweb.org search results</li>
            <li>Banner links to online showcase</li>
            <li>Guarantees first listing in product category on cesweb.org search results</li>
        </ul>
        <p> *All banner ads must be static (no animation). </p>
...
<br />
        <ul class="text">
            <li class="text">Includes Gold Package</li>
            <li class="text">LIMITED 360 x 45 pixel banner featured on the base of the Interactive Floor Plan </li>
            <li class="text">Banner links to online </li>
        </ul>
...
<div class="sponsorshipTitle">LIMITED - Individual Hall Sponsor Package:&nbsp;<span class="lt_blue">$8,495 per hall sponsor</span></div>
<br />
        <ul class="text">
            <li class="text">Includes Gold Package</li>
            ...
            <li class="text">Banner links to online showcase</li>
        </ul>
        <p class="text">*All banner ads must be static (no animation), and we ask that the sponsor be an exhibitor in the hall. </p>
...
<br />
        <ul class="text">
            <li class="text">Includes Gold Package</li>
            <li class="text">Includes exclusive 900x 80 pixel banner displayed on the Interactive Floor Plan Home Page</li>
            <li class="text">Banner links to online showcase</li>
        </ul>
