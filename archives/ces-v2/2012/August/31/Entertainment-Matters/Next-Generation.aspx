...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Next Generation
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Entertainment-Matters/Next-Generation.aspx" id="form">
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='next-generation end'><a href='/Entertainment-Matters/Next-Generation.aspx'>Next Generation</a></li></ul>
...
As tomorrow&rsquo;s studio chiefs, mega-producers, leading actors, agents and lawyers are today&rsquo;s assistants, CES has created a custom experience for Hollywood&rsquo;s next generation of leaders.<br />
<br />
We&#39;ve designed a program to introduce this important, highly-networked and influential community of professionals to the CES experience. Next Generation Program benefits include:<br />
<ul>
	<li>
		Free access to the CES show floor</li>
	<li>
		Access to discounted block of rooms</li>
	<li>
		Curated/guided tour of the show floor*</li>
	<li>
		Free access to select Entertainment Matters Conference Sessions</li>
	<li>
		Discount on full Entertainment Matters Conference Pass</li>
	<li>
		Access to invite-only evening event</li>
</ul>
* space is limited<br />
<h3>
	Registration&nbsp;for the Next Generation Program will open in September.</h3>
In the meantime, you may request membership by contacting us at&nbsp;<a href="http://www.cesweb.org/EM/mailto">Hollywood@CE.org</a>&nbsp;or 703-907-7618.
</div>
<hr class="separator" />
 &nbsp;</div>
</div>
