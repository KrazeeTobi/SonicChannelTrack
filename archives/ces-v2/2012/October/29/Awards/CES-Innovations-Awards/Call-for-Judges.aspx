...
<head id="head"><title>
	2013 International CES, January 8 - 11 - Call for Judges
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Awards/CES-Innovations-Awards/Call-for-Judges.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<div>
<br />
<strong>The Innovations 2013 Call For Judges is now closed.</strong><br />
<br />
Applications will be accepted until August 17, 2012, and judges will be notified of their selection status in mid-September.<br />
<br />
Each award category is judged by a three-member panel consisting of an independent industrial designer, independent engineer or industry analyst and a member of the trade press. The judging process is conducted online and will begin September 24, 2012, and end on October 5, 2012. We have determined that it takes approximately 10-15 minutes to evaluate an entry. Depending on how many entries are in a category, judging may take anywhere from 3-15 hours to complete.<br />
<br />
<br />
<strong>Innovations Judge Benefits:</strong><br />
<ul>
	<li>
		Be the first to see the newest products in the CE industry</li>
	<li>
		Volunteer and network with other preeminent industry professionals</li>
	<li>
		Invitation to CES Unveiled NEW YORK, where the Innovations Honorees are announced</li>
	<li>
		Invitation to CES Unveiled LAS VEGAS, The Official Press Event of the International CES</li>
	<li>
		Recognition throughout the year on CESweb.org/Innovations</li>
	<li>
		Special ribbon to wear on-site at CES to designate your status as an Innovations Judge</li>
</ul>
<br />
Questions? Contact us at <a href="mailto:Innovations@ce.org">Innovations@ce.org</a>.
</div>
 &nbsp;</div>
</div>
</div>
