...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
    ...
    <p><span style="text-align: left; background-color: rgb(255, 255, 255); ">The conference program at CES is all about delivering maximum value, and the SuperSessions always prove it. Take a peek at this year&#39;s line-up. Remember, seating is first-come first-served, so get there early to grab a place to view the future of technology!</span>
            ...
            <div id="addToCartSS1" class="cartItem"></div>
                            <div style="width: 160px; float: left;">
                                ...
                                <div style="margin-left: 175px; padding-top: 1px; width: 390px;text-align: center!important; height: 100px;">
                                    <h3 style="text-align: center;">The Human Body: The Next Digital Revolution</h3>
                ...
                <p>
             <p>&quot;I sing the body electric&quot; takes on new meaning as digital devices let us monitor body functions from stress levels to our genetic sequences. Predictions are that we'll reach 100 real time biosensors in a single device in the near future. Join four groundbreaking leaders in the field of digital health as we explore what it means to be a human in the digital health revolution.</p>
            </p>
        ...
        <div>
            <div id="addToCartSS2" class="cartItem"></div>
                ...
                <p>
             <p>In today's world, most games are delivered via a PC, dedicated gaming consoles and through an app on a tablet and smartphone. But with CPU 's and GPU's being integrated into servers that are driving the cloud, the days are coming when the full PC experience can be delivered from the cloud to very thin clients. Powerful compute back ends will soon deliver high resolution and even 3D games on simple clients such as Internet connected TV's, tablets and even modest Internet based smartphones and change the way games, High res images and HD video can be delivered and accessed in the near future. Also, if the PC is in the cloud, then the thin client could come in all type of shapes and forms thanks to the next generation of flexible displays that will be ready for primetime in the next 3-5 years. And there will be exciting new viral apps that will deliver cross device apps. This session will explore the various disruptive technologies on the horizon that will change the world of gaming and video delivery and reshape the marketplace for products and services around games, images and video.</p>
            </p>
            <div style="clear: both;">
            </div>
...
<p>Mr. Bajarin serves on multiple conference advisory boards and is a  frequent featured speaker at computer conferences worldwide. He also  serves on technology advisory council&rsquo;s for Lenovo, Toshiba,  Panasonic Solutions Company, Hewlett Packard and Dell.</p>
        ...
        <div>
            <div id="addToCartSS4" class="cartItem"></div>
                            <div style="width: 160px; float: left;">
                                ...
                                <div style="margin-left: 175px; padding-top: 1px; width: 390px;text-align: center!important; height: 100px;">
                                    <h3 style="text-align: center;">CNET's Next Big Thing: Always On, The Constantly Connected Consumer is Here</h3>
                ...
                <p>
             <p>The new consumer is always connected. The cloud and social networks keep his or her experiences synched and available everywhere. This 24/7 connection is persistent and ubiquitous: Every device is part of the network and every experience can be shared. Join experts Molly Wood and Brian Cooley to discover how you can stay connected.</p>
            </p>
            <div style="clear: both;">
            </div>
        ...
        <div>
            <div id="addToCartSS7" class="cartItem"></div>
                            <div style="width: 160px; float: left;">
                                <img style="padding: 10px; width: 146px" src="http://speaker.ce.org/files/content/sponsors/CEA-101_CEA-Logo.jpg" alt="">
                            </div>
                                <div style="margin-left: 175px; padding-top: 1px; width: 390px;text-align: center!important; height: 100px;">
