...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Events/Brand-Matters/CMO-Club.aspx" id="form">
...
<br />
        ...
        <div id="breadcrumb">
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='events first'><a href='/Events.aspx'>Events</a></li><li class='cmo-club end'><a href='/Events/Brand-Matters/CMO-Club.aspx'>CMO Club</a></li></ul>
...
The CMO Club is an exclusive, invitation only VIP program open to a select list of marketing and advertising executives.<br />
<br />
...
&nbsp;<br />
Your CMO Club benefits include:<br />
&nbsp;
<ul>
	<li>
	...
	<li>
		Customized, guided tours of the show floor*</li>
	<li>
		Priority VIP passes to Keynote Addresses*</li>
	<li>
		Access to block of rooms at the Bellagio (thru Nov. 26)</li>
	<li>
		20% discount on the Entertainment Matters Conference Pass</li>
	<li>
		Preshow and on-site service</li>
</ul>
&nbsp;<br />
*Space is limited.<br />
