...
<head id="head"><title>
	2013 International CES, January 8 - 11 - CES Greening
...
<p>The 2012 International CES included an incredible array of green initiatives as part of our efforts to reduce waste and give back to the local Las Vegas community.
<ul>
	<li>
		In our first year doing so, we produced more than 190,000 badge holders made from the previous year&rsquo;s vinyl banners. We collected more than 11,000 badges at show close to repurpose for a third life</li>
	<li>
		&nbsp;We collected 35,700 sq. ft. (20,000 lbs.) of magnetic banners, 28,600 sq. ft. of vinyl banners and more than 16,000 sq. ft. of other show signs and materials</li>
	<li>
		&nbsp;For the first time, we collected nearly 50,000 lbs. of show publications</li>
	<li>
		All of our interior show signs were produced with an eco-friendly Falcon-board material</li>
	<li>
		We recycled 566.54 tons of the solid waste generated at the show and increased our recycle rate from 74 percent to 75 percent. At the LVCC alone, our recycle rate was 78 percent, a few points higher than the average show</li>
	<li>
		We donated $50,000 to Green Chips, a non-profit organization promoting carbon neutrality, which will use the funds to install solar panels at the Las Vegas Rescue Mission. Last year, we donated $75,000 to Green Chips for a similar project at the Salvation Army and saw that project come to fruition in 2011</li>
	<li>
		Finally, we donated $25,000 to Repurpose America for sun shades, one of which was installed at the UNLV Rebel Recycling Center in June 2013</li>
</ul>
...
<ul>
	...
	<li>
		Turnkey packages include recyclable panels and graphics printed using soy ink</li>
	<li>
		Cut print production by nearly 50 percent from five years ago. Remaining print materials are printed on recycled paper, use soy-based ink and meet the standards of the Sustainable Forest Initiative and Forest Stewardship Council</li>
	<li>
		Our press kits are e-friendly as well. Exhibitors must provide paperless kits online, or via USB or DVD&nbsp;</li>
</ul>
</p>
<br><br>
<hr class="separator">
...
<p><a href="http://cesweb.org/techzones" target="_blank">The Sustainable Planet TechZone</a> at The Venetian showcases the latest in eco-friendly products and energy efficiency technologies. It highlights the latest products that make it possible for every person on this planet to stay connected and informed, and live sustainable lifestyles through advances in green building, alternative energy technologies, green business services and solutions, smart grid technologies, solar and renewable products, sustainable packaging and wireless convergence.&nbsp;<br />
</p>
<br><br>
<hr class="separator">
<br>
...
<p>The <a href="http://cesweb.org/techzones" target="_blank">GoElectricDrive TechZone</a> in the LVCC North Hall showcases a full range of high and low-speed electric vehicles, energy storage devices and charging solutions. Sponsored by the Electric Drive Transportation Association, this TechZone highlights an area of great potential and growth for the industry as electric vehicles are quickly gaining in popularity among consumers seeking to live more sustainably by using alternative transportation.<br />
</p>
<br><br>
<hr class="separator">
<br>
...
We&#39;re seeing a trend with Greener Gadgets in consumer electronics &ndash; smaller, more energy efficient and powerful converged devices that are more eco-friendly than ever before. These types of products will be on display at CES, whether it&#39;s an ultra-thin and efficient LED TV or the latest tablet that uses very little energy. To learn more about this development and use our handy energy calculator and recycling locator, please go to <a href="http://www.greenergadgets.org/" target="_blank">GreenerGadgets.org</a>.&nbsp;</p>
<br><br>
<hr class="separator">
<br>
