...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<div style="width: 100%;">
    <div id="p_lt_zoneContent_pageplaceholder_pageplaceholder_lt_zoneCenter_BizForm_viewBiz">
	<div id="p_lt_zoneContent_pageplaceholder_pageplaceholder_lt_zoneCenter_BizForm_viewBiz_ctl00">
		<div id="p_lt_zoneContent_pageplaceholder_pageplaceholder_lt_zoneCenter_BizForm_viewBiz_ctl00_pnlForm" class="FormPanel">
			<div style="text-align: center; ">
	<h1 style="font-size: 30px; color: rgb(51, 51, 51); background-color: rgb(255, 255, 255); text-align: left; ">
		Show Floor Tours</h1>
	<br />
	<span style="font-size:16px;"><strong>Get The Most Out of 2013 International CES&reg; !</strong></span></div>
<div style="text-align: center; ">
	<span style="font-size:16px;">Take an Official 2-hour Guided Floor Tour</span></div>
<div style="text-align: center; ">
	<span style="font-size:16px;">Produced by the Consumer Electronics Association (CEA)&reg; in partnership with Shelly Palmer Digital Leadership&trade;</span></div>
<div>
	&nbsp;</div>
<div>
	Experience a curated, two-hour guided tour of the most relevant and exciting exhibits on the 2013 International CES&reg; show floor. Experienced tour guides will help you identify and understand key technologies and services, differentiate offerings and create action items and strategic take-aways from the show.<br />
	&nbsp;</div>
<div>
	<strong>Choose the Tour That&#39;s Best for You:</strong></div>
<img alt="" src="http://www.cesweb.org/cesweb/media/CESWeb/Show%20Floor%20Pictures/Show-Floor-Tours.jpg" style="width: 236px; height: 206px; float: right; margin: auto 5px; " />
<ul>
	<li>
		2013 International CES&reg; General Overview Tour&nbsp;<br />
...
<div>
	Tours leave from the North Lobby of the Las Vegas Convention and World Trade Center (LVCC) several times each day. We will do our best to accommodate your schedule. Space is limited and tours fill up quickly, so register now!</div>
<div>
	&nbsp;</div>
<div>
	...
	&nbsp;</div>
<div>
	Tours are only available for registered 2013 International CES&reg; attendees. If you haven&rsquo;t already done so, <a href="http://registration3.experientevent.com/showCES131/Default.aspx" target="_blank">register for the 2013 CES</a>.</div>
<div>
	&nbsp;</div>
<div>
	<strong>Notify Me When Tour Registration Opens:</strong><br />
	&nbsp;</div>
<div>
	Enter your email address to be notified when tour registration is available.&nbsp;<br />
	&nbsp;</div>
<table>
	<tbody>
		<tr>
			<td>
				<label id="p_lt_zoneContent_pageplaceholder_pageplaceholder_lt_zoneCenter_BizForm_viewBiz_ctl00_lEmail" class="EditingFormLabel" for="p_lt_zoneContent_pageplaceholder_pageplaceholder_lt_zoneCenter_BizForm_viewBiz_ctl00_Email_txtEmailInput">Email Address:</label></td>
			<td>
				<div class="EditingFormControlNestedControl">
				<input name="p$lt$zoneContent$pageplaceholder$pageplaceholder$lt$zoneCenter$BizForm$viewBiz$ctl00$Email$txtEmailInput" type="text" maxlength="100" id="p_lt_zoneContent_pageplaceholder_pageplaceholder_lt_zoneCenter_BizForm_viewBiz_ctl00_Email_txtEmailInput" class="TextBoxField" />
...
<div>
	<input type="submit" name="p$lt$zoneContent$pageplaceholder$pageplaceholder$lt$zoneCenter$BizForm$viewBiz$ctl00$btnOK" value="OK" id="p_lt_zoneContent_pageplaceholder_pageplaceholder_lt_zoneCenter_BizForm_viewBiz_ctl00_btnOK" class="FormButton" /><br />
	<br />
	<strong>Questions?</strong><br />
	&nbsp;</div>
<div>
	Contact <a href="mailto:CEStours@shellypalmer.com?subject=CES%20Show%20Room%20Tours">CEStours@shellypalmer.com</a>.</div>
