...
<head>
<title>2002 International CES: LVCC Expansion Updates</title>
...
<script language="javascript1.2">
		...
		var pageID = "1.4.3"; //INSERT PAGE ID HERE
	</script>
...
<META NAME="searchZone" CONTENT="generalCESweb"></head>
...
<font class="head">Las Vegas Convention Center Expansion</font><p>


<!-- content starts here --> 
<font class="body"><b>Everything under one roof at the 2002 International CES.</b><p>
The new LVCC South Hall facilities feature two floors of 900,000 sq. ft. gross of exhibit space for:
<p>
<ul>
	<li>Home Information and Wireless</li>
	<li>Home Theater</li>
	<li>Home Systems</li>
...
<tr>
	<td colspan=2><font class="body">Check out the construction progress.  Click on the thumbnails below to view an enlarged image 
	and a detailed description of each.</font>
	</td>
</tr>
	...
	<tr>
		<td width=45%>
			<a href="/show_locations/view_pic_cap.asp?p=/show_locations/images/hard_hat_large.jpg&c=&nbsp;&nbsp;Some_of_our_very_own,_Jayne_Dalton,_Wesley_Moynan_and_Karen_Chupka_are_able<br>&nbsp;_to_see_the_progress_first_hand">
			<img src=/show_locations/images/hard_hat_thumb.jpg border=0 alt="Click to enlarge!!" align=left></a><font class="body"><br>LVCC Expansion Hard-Hat Tour</font>
		</td>

		<td width=45%>
			<a href="/show_locations/view_pic_cap.asp?p=/show_locations/images/LVCC_1_large.jpg&c=2/8/01_-_View_of_the_SW_corner_of_Area_1_just_inside_the_gates_from_Silver_Drive._<br>The_west_truck_ramp_is_visible_on_the_right_side_of_the_photo._Spot_where_photo_<br>taken_is_approximately_where_the_future_bus_parking_will_be.">
			<img src=/show_locations/images/LVCC_1_thumb.jpg border=0 alt="Click to enlarge!!" align=left></a><font class="body"><br>Southwest View, Area 1</font>
		</td>
	...
	<tr>
		<td width=45%>
			<a href="/show_locations/view_pic_cap.asp?p=/show_locations/images/LVCC_2_large.jpg&c=2/8/01_Photo_taken_from_the_roof_of_the_new_South_Expansion_project._Vehicles_<br>traveling_east_and_west_on_Desert_Inn_road_disappear_under_the_new_steel_for_the_<br>Area_6_conference_room._Steel_erection_has_been_completed_for_the_north_side_of_<br>the_project.">
			<img src=/show_locations/images/LVCC_2_thumb.jpg border=0 alt="Click to enlarge!!" align=left></a><font class="body"><br>View from Roof of New South Hall</font>
		</td>

		<td width=45%>
			<a href="/show_locations/view_pic_cap.asp?p=/show_locations/images/LVCC_3_large.jpg&c=2/8/01_View_looking_down_the_east_MSE_truck_ramp._The_top_of_the_ramp,_located_<br>35’_above_the_ground,_will_allow_semi_tractor-trailers_to_drive_up_and_directly_onto_<br>the_second_floor_of_the_new_expansion.">
			<img src=/show_locations/images/LVCC_3_thumb.jpg border=0 alt="Click to enlarge!!" align=left></a><font class="body"><br>View from East MSE Truck Ramp</font>
		</td>
	...
	<tr>
		<td width=45%>
			<a href="/show_locations/view_pic_cap.asp?p=/show_locations/images/LVCC_4_large.jpg&c=2/8/01_The_west_truck_platform,_spanning_from_the_MSE_ramp_on_up_to_the_entrance_<br>doors_for_the_second_floor,_is_being_prepared_for_concrete._The_concrete_slab_for_the_<br>platform_will_be_7_inches_thick,_with_the_step_down_area_of_the_platform_(right_side_of_<br>photo)_being_a_total_thickness_of_12_inches._The_east_half_of_the_platform_was_poured_<br>on_January_31st,_and_is_currently_going_through_its_14_day_curing_cycle.">
			<img src=/show_locations/images/LVCC_4_thumb.jpg border=0 alt="Click to enlarge!!" align=left></a><font class="body"><br>View of West Truck Platform</font>
		</td>
		<td width=45%>
			<a href="/show_locations/view_pic_cap.asp?p=/show_locations/images/LVCC_5_large.jpg&c=2/14/01_As_you_can_see_by_the_photo,_the_crane_erecting_the_west_side_of_this_project_<br>is_now_working_up_against_Silver_Drive._Tomorrow_this_crane_will_be_removed_and_a_<br>smaller_crane_brought_in_to_take_its_place._Room_available_in_this_area_is_too_restrictive_<br>for_a_220_ton_crane._Completion_of_the_steel_is_still_forecasted_for_the_end_of_this_month.">
			<img src=/show_locations/images/LVCC_5_thumb.jpg border=0 alt="Click to enlarge!!" align=left></a><font class="body"><br>West Side Crane, from Silver Drive</font>
		</td>
	...
	<tr>
		<td width=45%>
			<a href="/show_locations/view_pic_cap.asp?p=/show_locations/images/LVCC_6_large.jpg&c=2/14/01_View_looking_east_from_Area_1_second_floor._The_decking_in_this_area_is_not_<br>secured_at_this_time._By_the_first_part_of_next_week_the_deck_will_be_puddle_welded_<br>and_stitch_welded._Some_of_this_work_is_underway._Decking_of_the_roof_in_this_area_<br>should_begin_the_first_of_next_week,_as_well._Rebar_and_concrete_placement_will_be_<br>quick_to_follow.">
			<img src=/show_locations/images/LVCC_6_thumb.jpg border=0 alt="Click to enlarge!!" align=left></a><font class="body"><br>East View of Area 1, Second Floor</font>
		</td>
		<td width=45%>
			<a href="/show_locations/view_pic_cap.asp?p=/show_locations/images/LVCC_7_large.jpg&c=2/14/01_Ironworker_installing_Nelson_studs_to_the_deck_in_area_1._Approximately_<br>2000_of_these_studs_are_installed_throughout_various_areas_of_each_60’_x_300’_section_<br>of_decking._There_are_approximately_7_sections_per_area_quadrants_of_the_new_building,_<br>which_are_referenced_as_area’s_1,_2,_3,_4,_and_6_in_our_field_reports._Area_5_references_<br>the_MSE_ramps_and_truck_platform.">
			<img src=/show_locations/images/LVCC_7_thumb.jpg border=0 alt="Click to enlarge!!" align=left></a><font class="body"><br>Ironworker on Deck in Area 1</font>
		</td>
	...
	<tr>
		<td width=45%>
			<a href="/show_locations/view_pic_cap.asp?p=/show_locations/images/LVCC_8_large.jpg&c=2/14/01_Photo_of_concrete_and_finishers_working_the_new_slab_on_the_second_floor_of_<br>Area_6._In_the_background_you_can_see_the_exterior_sheeting_of_the_existing_C-2_Hall._<br>The_new_facility_will_be_approximately_22_feet_taller_than_the_existing_structure.">
			<img src=/show_locations/images/LVCC_8_thumb.jpg border=0 alt="Click to enlarge!!" align=left></a><font class="body"><br>Concrete Workers on Second Floor, Area 6</font>
		</td>
		<td width=45%>
			<a href="/show_locations/view_pic_cap.asp?p=/show_locations/images/LVCC_9_large.jpg&c=2/14/01_This_is_another_photo_of_the_2nd_floor_concrete_work_in_Area_6._The_section_<br>of_the_concrete_that_has_a_sheen_to_it_is_actually_the_finished_surface_of_the_slab._The_<br>darker_parts_of_the_slab_have_yet_to_harden.">
			<img src=/show_locations/images/LVCC_9_thumb.jpg border=0 alt="Click to enlarge!!" align=left></a><font class="body"><br>Second Floor Concrete Work, Area 6</font>
		</td>
	...
	<tr>
		<td width=45%>
			<a href="/show_locations/view_pic_cap.asp?p=/show_locations/images/LVCC_10_large.jpg&c=2/14/01_Photo_taken_of_a_concrete_finisher_riding_a_trowel_machine_over_a_section_of_<br>concrete_that_has_not_surface_hardened_yet._The_pours_begin_around_6am_in_the_morning_<br>with_final_finish_and_soft_cutting_of_the_slab_by_late_that_evening.">
			<img src=/show_locations/images/LVCC_10_thumb.jpg border=0 alt="Click to enlarge!!" align=left></a><font class="body"><br>Concrete Finisher at Work</font>
		</td>
		<td width=45%>
			<a href="/show_locations/view_pic_cap.asp?p=/show_locations/images/LVCC_large.jpg&c=&nbsp;&nbsp;2/8/01_-_View_of_the_steel_erection_as_they_close_in_on_completing_Area_1._<br>&nbsp;&nbsp;Approximately_80-100’_remains_to_be_erected_before_the_west_section_of_the_<br>&nbsp;&nbsp;building_is_complete._PCL_is_looking_at_the_third_week_of_February_as_the_week_to_<br>&nbsp;&nbsp;close_out_the_steel_erection.">
			<img src=/show_locations/images/LVCC_thumb.jpg border=0 alt="Click to enlarge!!" align=left></a><font class="body"><br>View of Steel Structure, Area 1</font>
		</td>		
	</tr>
