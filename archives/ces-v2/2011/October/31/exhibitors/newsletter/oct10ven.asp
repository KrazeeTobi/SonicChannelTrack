...
<head><!-- PageID 4315 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: October 2010 Venetian</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div>October 2010 Venetian</div>
                        </div>
                         <div class="headerbox">
                            <h1>October 2010 Venetian</h1>
                        </div><br />
...
<STRONG>Key Deadlines for Suite Exhibitors</STRONG><BR>Be sure to review the <A href="http://www.cesweb.org/exhibitors/showPlanning/venetian-show-planning.asp#3945">checklist</A> for Venetian Tower suite exhibitors to stay on track with early-bird discounts and required form deadlines. Here are a few of the key forms that you must submit in order to exhibit: 
<UL>
<LI><STRONG>November 1</STRONG> — Deadline to submit your desired furniture movement/bed removal floorplan</LI>
<LI><STRONG>November 1</STRONG> — Deadline to submit your Venetian Credit Card Authorization form</LI>
<LI><STRONG>November 1</STRONG> — Deadline to submit your Venetian Multiple Guest Authorization form</LI>
<LI><STRONG>November 1</STRONG> — Deadline to submit your Venetian Housekeeping Request form</LI>
<LI><STRONG>November 29-December 27</STRONG> — This is the window for advance freight to arrive at the GES warehouse and receive the advance freight rate, which is less expensive than the direct rate</LI></UL>Late fees will apply to some of these services if not submitted by <STRONG>November 1</STRONG>, so be sure to get your forms in!<BR><BR><STRONG>Furniture Movement and Bed Removal Requests for Suite Exhibitors</STRONG><BR>For the 2011 show, The Venetian is providing a new web-based tool for you to use to submit your exhibit suite furniture movement requests by<STRONG> November 1</STRONG>. This tool allows you to see the exact dimensions of your exhibit suite, dimensions of the furniture, and provides you with the flexibility of moving around furnishings to various desired locations to see what best suits your needs. To learn more about this tool and to submit your desired suite furniture arrangements, please refer to section 3 of your <A href="http://ges.com/eComm/2011/q1/11-05562/" target=_blank>Venetian Tower Suite Exhibitor Manual</A>. <BR><br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
<br />
...
<div class="sub-content-header">Venetian Meeting Room Exhibitor Information</div>
<br />

<STRONG>Key Deadlines for Meeting Room Exhibitors</STRONG><BR>Be sure to review the <A href="http://www.cesweb.org/exhibitors/showPlanning/venetian-show-planning.asp#3944">checklist</A> for Venetian meeting room exhibitors to stay on track with early-bird discounts and required form deadlines. Here are a few of the key upcoming deadlines to keep in mind: 
<P></P>
<UL>
<LI><STRONG>November 1</STRONG> — Floor plans of your meeting room exhibits must be submitted to the Fire Marshal by this date. Any exhibitor who plans to build modular walls and/or exhibitry in their meeting room or plans to set the room with 299+ chairs must receive Fire Marshal approval. For additional information on this, please refer to section 5 of your <A href="http://ges.com/eComm/2011/q1/11-05561/" target=_blank>Venetian Meeting Room Exhibitor Manual</A>. </LI>
<LI><STRONG>November 29-December 27</STRONG> — This is the window for advance freight to arrive at the GES warehouse and receive the advance freight rate, which is less expensive than the direct rate. For additional shipping information, please refer to section 2 of your&nbsp; <A href="http://ges.com/eComm/2011/q1/11-05561/" target=_blank>Venetian Meeting Room Exhibitor Manual</A>. </LI>
<LI><STRONG>November 30</STRONG> — Deadline to receive the early-bird rate on security services. We recommend you hire overnight security in the meeting room exhibits. To order security services, please refer to section 6 of your&nbsp; <A href="http://ges.com/eComm/2011/q1/11-05561/" target=_blank>Venetian Meeting Room Exhibitor Manual</A>.</LI></UL>
<P><STRONG>Cleaning</STRONG><BR>In an effort to keep exhibitor meeting rooms secure, Specialized Event Services (SES) does not automatically provide simple cleaning services during the four show nights. If you would still like to order the complimentary service, you will be required to be present in your meeting room while the cleaning service takes place. Please <A href="mailto:%20gberube@ce.org">send your request via e-mail</A> by <STRONG>December 1, 2010</STRONG>, if you would like to have one or more nights of cleaning service. This simple cleaning service includes trash removal and vacuuming. Any other cleaning services are the financial responsibility of the exhibitor.<BR></P>
