...
<br />
        ...
        <br />
        3. <a  href="/docs/shipping_labels(1).pdf">Find the right labels and addresses</a> depending on your shipping location.<br />
        <br />
        4. Fill out all the <a  href="/docs/Mat_Handling.pdf">GES material handling forms</a>.<br />
        <br />
        5. For set-up and dismantle schedules, view the <a  href="/docs/Clean_Floor(2).pdf">Clean Floor Policy</a>.<br />
        <br />
        If you have questions concerning shipping and freight, please contact GES at <a  href="mailto:CESFreight@ges.com">CESfreight@ges.com</a>, or use their chat feature at <a  href="http://www.ges.com/chat">www.ges.com/chat</a> from 6 a.m. to 1 a.m. PST. <br />
