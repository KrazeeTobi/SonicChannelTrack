...
<head><!-- PageID 5358 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: 2012 Exhibitor Workshop</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/exhibitors/default.asp-->
            ...
            <li class="selected"><a href="/exhibitors/resources/exhibitor-workshop.asp">2012 Exhibitor Workshop</a></li>
...
<script type="text/javascript" src="/utilities/sub_page.js"></script>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/resources/default.asp" class="footer">Resources</a>&nbsp;&gt;&nbsp;2012 Exhibitor Workshop</div>
                        </div>
                         <div class="headerbox">
        ...
        <p>Welcome to the 2012 Exhibitor Workshop, your one-stop shop for all things related to exhibiting at the 2012 International CES. We know that first-timers and veterans alike need some assistance navigating the various aspects of exhibiting at the world’s largest consumer technology tradeshow. After all, the technology industry is driven by change, and you can expect every CES to be slightly different and reinvented.</p>
        <p>With our free four-part web-cast series we provide you with tools to help you market and promote your brand, receive the ultimate press coverage, as well as turn you into a pro when dealing with booth planning, logistics and our contractor GES. You’ll also have the chance to learn about our vendor, Map Your Show, who will be supplying our online directory and interactive floor plans.</p>
        <p><strong>Optimize Your Marketing Resources and Get the Most Press Coverage</strong> <br />
        September 22, 2011 – 2 p.m. EST <br />
        Registration for this event is now closed. Please check back for the archived presentation.<br />
        <br />
        <strong>Meet GES – Official Show Contractor <br />
        </strong>October 11, 2011 – 2 p.m. EST <br />
        A panel of GES experts will discuss shipping deadlines and rigging, booth design and maintenance, electrical issues, union jurisdictions and material handling, and anything else you need to know to ensure your materials reach the show efficiently. <br />
        <a  href="http://www.cesweb.org/exhibitors/resources/workshop/rd_registration2012.asp">Register now!</a>  </p>
        <p><strong>CES Operations – Show Planning and Booth Logistics</strong> <br />
        October 19, 2011 – 2 p.m. EST <br />
        The CES Operations team will help make your booth planning easier with tips on navigating the show, securing hotel reservation, ordering booth services and setting up your booth within show guidelines. <br />
        <a  href="http://www.cesweb.org/exhibitors/resources/workshop/rd_registration2012.asp">Register now!</a></p>
        <h3>Past Presentations Ready for You</h3>
        <a  target="_blank" href="http://consumerelectronics.adobeconnect.com/p51voodcv8m/?launcher=false&fcsContent=true&pbMode=normal"><strong>Using MyCES to Maximize Your ROI </strong></a>
