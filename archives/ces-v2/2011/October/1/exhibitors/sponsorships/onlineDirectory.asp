...
<head><!-- PageID 4136 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Online Directory Sponsorships</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/exhibitors/default.asp-->
            ...
            <li class="selected"><a href="/exhibitors/sponsorships/onlineDirectory.asp">Online Directory Sponsorships</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/sponsorships/default.asp" class="footer">Promotional Opportunities</a>&nbsp;&gt;&nbsp;Online Directory Sponsorships</div>
                        </div>
                         <div class="headerbox">
        ...
        <h4>Generate Leads and Visibility Before, During and After the Show</h4>
        You can access your sales leads at any time by upgrading your listing on the Interactive Floor Plan, plus you'll receive weekly reports of any new leads generated from now until months after the event ends.<br />
        <br />
        Not only will upgrading your listing give you access to sales leads, it will also give you the ability to turn a basic listing into your very own, online showroom. Add videos and/or product images to your listing so attendees can see what you'll have on display before, during&nbsp;and after the event.<br />
        <br />
...
<div class="page_header_block">
    <div class="blue_box">
        ...
        <li><a href="#4144">Basic Leads Package</a></li><!---->
        
        <li><a href="#4143">Silver Package</a></li><!---->
        
            </ul>
        
            <ul>
        
        <li><a href="#4142">Gold Package</a></li><!---->
        
        <li><a href="#4140">LIMITED - Individual Hall Sponsor Package</a></li><!---->
        
            </ul>
        
            <ul>
        
        <li><a href="#4139">LIMITED - Standard Floor Plan Banner Package</a></li><!---->
        
        <li><a href="#4156">Overall Application Banner Package (limit 1)</a></li><!---->
...
<div class="sponsorshipTitle">Basic Leads Package:&nbsp;<span class="lt_blue">$795</span></div>
<br />
        <ul class="text">
            <li class="text">Add your company logo or trademark on your online listing </li>
            <li class="text">Ability to add press releases to your online listing </li>
            <li class="text">Access to sales leads and floor plan statistics </li>
            <li class="text">On average, exhibitors at this level receive up to 2x more impressions</li>
        </ul>
        <a  target="_blank" href="http://ces12.exh.mapyourshow.com/signup">Get more details.</a>
...
<br />
        <ul class="text">
            <li class="text">Three&nbsp;display panels to showcase your products online through images/descriptions </li>
            <li class="text">Included in the 'Featured Exhibitor Search' </li>
            <li class="text">All Basic Leads Package attributes included (see above) </li>
            <li class="text">On average, exhibitors at this level receive 2.5-3x more impressions</li>
        </ul>
...
<br />
        <ul class="text">
            <li class="text">Five&nbsp;total display panels (2 multimedia/flash presentations &amp; 3 product images/descriptions) </li>
            <li class="text">Priority placement in the online directory search results </li>
            <li class="text">'Corner Peel' graphic highlighting your booth on the floor plan </li>
            <li class="text">All Silver&nbsp;and Basic Package attributes included (see above) </li>
            <li class="text">On average, exhibitors at this level receive 4-5x more impressions</li>
        </ul>
...
<div class="sponsorshipTitle">LIMITED - Individual Hall Sponsor Package:&nbsp;<span class="lt_blue">$8,499 per hall sponsor</span></div>
<br />
        <ul class="text">
            <li class="text">One exclusive hall sponsorship banner* (size varies by hall) available per hall </li>
            <li class="text">Language above banner may read "Official Hall Sponsor" </li>
            <li class="text">Banner will print anytime the hall is printed </li>
            <li class="text">Includes all Gold Package attributes (see above) </li>
            <li class="text">Live link directs attendees to your sponsor listing on the floor plan </li>
            <li class="text">On average, banner sponsors generate&nbsp;five times more impressions</li>
        </ul>
...
<div class="sponsorshipTitle">LIMITED - Standard Floor Plan Banner Package:&nbsp;<span class="lt_blue">$7,499</span></div>
<br />
        <ul class="text">
            <li class="text">A standard banner* (360 x 45 pixels) sponsorship featured on the base of the Interactive Floor Plan </li>
            <li class="text">Includes Gold Package attributes (see above) </li>
            <li class="text">Live link directs attendees to your sponsor listing on the floor plan </li>
            <li class="text">On average, banner sponsors generate 5x more impressions</li>
        </ul>
...
<div class="sponsorshipTitle">Overall Application Banner Package (limit 1):&nbsp;<span class="lt_blue">$14,499</span></div>
<br />
        <ul class="text">
            <li class="text">Includes exclusive banner positions displayed on the CES Introduction Pages of the Interactive Floor Plan </li>
            <li class="text">900x 80 pixel banner displayed on the CES introduction pages(banner will be displayed on a white background)</li>
            <li class="text">Includes all Gold Package attributes</li>
            <li class="text">Live link directs attendees to your showroom listing and booth location in the CES Interactive Floor Plan</li>
        </ul>
