...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <br />
        Any questions? Please email <a  href="mailto:CEShotels@CE.org">CEShotels@CE.org</a>.
