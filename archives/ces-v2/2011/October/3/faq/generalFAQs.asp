...
<h3>I missed the advance registration deadline. Can I register on-site?</h3><br>
        ...
        Yes, you may register on-site. The International CES makes it easy. Register at any of the following areas: <br />
        <br />
        Attendee Registraton<br />
        <ul class="text">
            ...
            <li class="text">Venetian Meeting Rooms, Level 2</li>
        </ul>
        Exhibitor Registration opens Saturday, January 7, 2012.<br />
        Press Registration opens Sunday, January 8, 2012.<br />
        Conference Program Registration opens Sunday, January 8, 2012. <br />
        International and Domestic Attendee Registration opens Monday, January 9, 2012. <br />
        <br />
        <br />
        See the listings below for dates, locations and times.
        <p>&nbsp;</p>
        <strong>Attendee Registration (Domestic and International) <br />
        </strong>
        ...
        <br />
        <strong>Exhibitor Temp Badges</strong><br />
        <table border="1" cellspacing="0" cellpadding="2" width="100%">
            <tbody>
                <tr class="alternateRows">
        ...
        <br />
        <strong></strong><strong>Exhibitor Registration</strong> <br />
        <table border="1" cellspacing="0" cellpadding="2" width="100%">
            <tbody>
                <tr class="black">
                    <td style="width: 25%;">Date</td>
        ...
        <table border="1" cellspacing="0" cellpadding="2" width="100%">
            <tbody>
                ...
                <tr>
                    <td>Fri., Jan. 13, 2012</td>
                    <td>
                    <p>LVCC, South Hall Connector, Press Room S229</p>
                    </td>
                    <td>8:30 a.m. - 3 p.m.</td>
                </tr>
            </tbody>
        </table>
