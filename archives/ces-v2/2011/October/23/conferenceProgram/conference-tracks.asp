...
var logger = { 
 ...
 debugItem: function( value ) {
  ...
  return ''
    ...
    $('<link />', {
                    href: 'resources/sessionGrid.css',
                    media: 'screen',
                    rel: 'stylesheet',
                    type: 'text/css',
                    'class': 'gridCss'
	...
	$('.title').live('click', function(event) {
		...
		if ( $('#TrackInfo').height() + $('#TrackInfo').position().top > $('#inner-content-long').height() + $('#inner-content-long').position().top ) {
			var height = $('#TrackInfo').height() + $('#TrackInfo').position().top;
			$('#inner-content-long').height( height );
		}
	});
...
<SCRIPT id=tmplSessionInformation type=text/x-jquery-tmpl>
   <div class="expand" style="text-align: left;" id="SessionDetail${ID}">
    <div class="header">
     <table>
     <tr><td style="width: 160px;">&nbsp;</td>
     <td style="width: 403px;"><div class="" style="text-align: center!important">
