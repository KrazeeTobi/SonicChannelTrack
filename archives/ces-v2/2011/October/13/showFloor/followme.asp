...
<TBODY>
<TR>
<TD vAlign=top><IMG hspace=5 align=left src="/images/content/Follow-Me-Logo.gif" width=104 height=103> 
<H3>Enhance Your CES Experience</H3><BR>"Follow Me" is an interactive smartphone application designed specifically for the tradeshow industry, featuring real-time show alerts and interactive floor maps.<BR><BR><STRONG>Download Follow Me to:</STRONG> 
<UL class=text>
<LI class=text>Organize and schedule your tradeshow information on the fly or download it to your phone. </LI>
<LI class=text>Download exhibitor information rather than carrying marketing materials and brochures around the show. </LI>
<LI class=text>Navigate using interactive show floor maps. </LI>
<LI class=text>Enjoy complimentary coupons from local merchants for discounts and free offers. </LI></UL>
<P><STRONG>Want to learn all about the Follow Me mobile app, or need a quick refresher?<BR><BR></STRONG>Select from the list below and find out how Follow Me can help make your time at CES the best it can be.</P><A href="http://www.youtube.com/watch?v=sdgwozVijvU" target=_blank>Introduction and Dashboard&nbsp;</A><BR><A href="http://www.youtube.com/watch?v=OAJ-l8WfaE8" target=_blank>Your Schedule</A><BR><A href="http://www.youtube.com/watch?v=JPoDHxP58aM" target=_blank>Maps and Exhibitors</A><BR><A href="http://www.youtube.com/watch?v=6DGvuSgI26o" target=_blank>Restaurants, Videos, Photos, and more. . .</A><BR><A href="http://www.youtube.com/watch?v=6HQVUAr6_2Q" target=_blank>Twitter and Follow Me Alerts</A><BR>
...
<embed src="http://www.youtube.com/v/J4v7FFzNOR0&hl=en_US&fs=1&" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="425" height="344"></embed></OBJECT></DIV>--></STRONG></P></TD>
<TD vAlign=top>
...
<H3>Get the App</H3><BR>iPhone and iPod Touch users:<BR><A href="http://bit.ly/2011CES" target=_blank>Download Follow Me app<BR></A><BR>Web-based app (all other smartphones):<BR>Point your mobile browser to <A href="http://m.core-apps.com/2011CES/">http://m.core-apps.com/2011CES/</A>.<BR></TD></TR></TBODY></TABLE><BR>
<SCRIPT type=text/javascript>
          $('#screenshots').cycle({ 
                                            fx:     'scrollLeft',
                                            speed:  'slow', 
...
<DIV style="MARGIN: 0px 10px; WIDTH: 192px; HEIGHT: 349px">
<DIV id=screenshots>
<DIV><IMG border=0 src="http://www.cesweb.org/hp/images/followme/screen1.gif" width=192 height=349></DIV>
<DIV><IMG border=0 src="http://www.cesweb.org/hp/images/followme/screen3.gif" width=192 height=349></DIV>
<DIV><IMG border=0 src="http://www.cesweb.org/hp/images/followme/screen2.gif" width=192 height=349></DIV>
<DIV><IMG border=0 src="http://www.cesweb.org/hp/images/followme/screen4.gif" width=192 height=349></DIV>
<DIV><IMG border=0 src="http://www.cesweb.org/hp/images/followme/screen5.gif" width=192 height=349></DIV>
<DIV><IMG border=0 src="http://www.cesweb.org/hp/images/followme/screen6.gif" width=192 height=349></DIV>
<DIV><IMG border=0 src="http://www.cesweb.org/hp/images/followme/screen7.gif" width=192 height=349></DIV>
<DIV><IMG border=0 src="http://www.cesweb.org/hp/images/followme/screen8.gif" width=192 height=349></DIV>
<DIV><IMG border=0 src="http://www.cesweb.org/hp/images/followme/screen9.gif" width=192 height=349></DIV>
<DIV><IMG border=0 src="http://www.cesweb.org/hp/images/followme/screen10.gif" width=192 height=349></DIV>
<DIV><IMG border=0 src="http://www.cesweb.org/hp/images/followme/screen11.gif" width=192 height=349></DIV>
<DIV><IMG border=0 src="http://www.cesweb.org/hp/images/followme/screen12.gif" width=192 height=349></DIV></DIV></DIV></TD></TR></TBODY></TABLE>
