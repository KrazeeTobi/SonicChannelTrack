...
<head><!-- PageID 5544 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: October 2011 Venetian</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/oct11.asp" class="footer">October 2011</a>&nbsp;&gt;&nbsp;October 2011 Venetian</div>
                        </div>
                         <div class="headerbox">
                            <h1>October 2011 Venetian</h1>
                        </div><br />
...
<div class="sub-content-header">Venetian Exhibit Space Exhibitor Information</div>
<br />


        <strong>Fire Marshal Approved Floor Plans<br />
        <br />
        </strong>Applicable exhibitors must submit their floor plans for approval to the Fire Marshal by October 1. This can be a lengthy process and we highly recommend starting this process early. For additional information on submitting your floor plan and to determine if your exhibit requires Fire Marshal approval, please refer to Section 6 of your Venetian Exhibit Space Exhibitor Manual.<br />
        <br />
        <strong>Specialized Event Services (SES) Cleaning<br />
        <br />
        </strong>Meeting room exhibitors: In an effort to keep exhibitor meeting rooms secure, CES will only provide simple cleaning for your meeting room (nightly vacuuming and small trash removal) upon request only. This service is offered for four (4) nights beginning Monday, January 9. If you would like to request this service, please contact Gaiya Berube, CES operations manager, by December 1.<br />
        <br />
        Hall D and Venetian Ballroom booth exhibitors: You will receive complimentary in-booth simple cleaning for four (4) nights beginning Monday, January 9. This cleaning service includes small trash removal and vacuuming. If you want to decline this service for security reasons, please e-mail Gaiya Berube by December 1.<br />
        <br />
        All other cleaning services over and above the aforementioned services are the responsibility of the exhibitor.<br />
        <br />
        <strong>Key Deadlines<br />
        <br />
        </strong>Be sure to review your checklist to stay on track with early-bird discounts and required form deadlines. Here are a few of the key upcoming deadlines:<br />
        <br />
        • October 1: Applicable exhibitors must submit their floor plans for approval to the Fire Marshal.<br />
        <br />
        • November 21-January 2: The window for advance freight to arrive at the GES warehouse and receive the advance freight material handling rate, which is less expensive than the direct rate.<br />
        <br />
        • November 30: Deadline to receive the early-bird rate on security services. We recommend you hire overnight security.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Venetian Tower Exhibit Suite Information</div>
<br />


        <p><strong>Key Deadlines for Exhibit Suites<br />
        <br />
        </strong>Be sure to review your checklist to stay on track with early-bird discounts and required form deadlines. Here are a few of the key forms that you must submit in order to exhibit:</p>
        <p>• November 1: Deadline to submit your desired furniture movement/bed removal floorplan</p>
        <p>• November 1: Deadline to submit your Venetian Credit Card Authorization form</p>
        <p>• November 1: Deadline to submit your Venetian Multiple Guest Authorization form</p>
        <p>• November 1: Deadline to submit your Venetian Housekeeping Request form</p>
        <p>• November 21-January 2: This is the window for advance freight to arrive at the GES warehouse and receive the advance freight material handling rate, which is less expensive than the direct to show site rate.<br />
        <br />
        Late fees will apply to some of these services if not submitted by November 1.</p>
        <p><strong>Furniture Movement and Bed Removal Requests for Exhibit Suites<br />
        <br />
        </strong>The Venetian is once again providing the Icovia web-based tool for you to use in order to submit your exhibit suite furniture movement requests by November 1. This tool will allow you to see the exact dimensions of your exhibit suite, dimensions of the furniture, and provides you with the flexibility of moving furnishings around to various locations to see what best suits your needs. To submit your desired floor plan, please refer to section 3 of your <a  target="_blank" href="http://www.ges.com/eComm/2012/Q1/11-05833/">Venetian Tower Suite Exhibitor Manual</a>.</p>
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Venetian Hospitality Suite Exhibitor Information</div>
<br />


        <strong>Deliveries and Packages<br />
        <br />
        </strong>No freight shipments are permitted to be delivered to a hospitality suite. Freight, crates, pallets or shipments are not permitted, as hospitality suites cannot be utilized for exhibiting equipment or products. For additional information on this, please refer to Section 3 of you <a  target="_blank" href="http://www.ges.com/eComm/2012/Q1/11-05118H/">Venetian Hospitality Suite Exhibitor Manual</a>.<br />
        <br />
        <strong>Reservation Names<br />
        <br />
        </strong>Each exhibitor is responsible for providing <a  href="mailto:bbaumler@ce.org">Bobby Baumler</a>, CES sales coordinator, with the <a  target="_blank" href="http://www.ges.com/eComm/2012/Q1/11-05118H/pdf/Full-ESM%2018.pdf">individual names</a> that should be listed on the hospitality suite no later than November 15. These individuals will be permitted to check-in to the hospitality suite and obtain keys.<br />
        <br />
        <strong>Check-in and Check-out<br />
        <br />
        </strong>Hospitality suite exhibitors may check-in after 3 p.m. on Sunday, January 8 at the Venetian or Palazzo front desk or the “Invited Guest Check-in” desk. The actual hospitality suite number will be assigned at this time. The suite number cannot be assigned prior to January 8. If you are checking in later than January 8, please advise <a  href="mailto:gberube@ce.org">Gaiya Berube</a> so that your suite is held for you. Exhibitors must check-out by 11 a.m. on Saturday, January 14.
