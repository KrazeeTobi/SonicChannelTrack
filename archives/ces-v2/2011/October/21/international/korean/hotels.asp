...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <br />
        호텔 및 가격 목록은 <a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a>을 참고하십시오(영어로 제공). CES 할인가격을 획득하려면 모든 객실은 반드시 <a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a>을 방문하여 호텔이름을 선택한 다음 직접 해당 호텔을 통해서 예약해야 합니다. 귀하는 해당 호텔의 예약 페이지로 안내되어 귀하의 신용카드 정보를 입력할 수 있게 됩니다. <br />
        <br />
