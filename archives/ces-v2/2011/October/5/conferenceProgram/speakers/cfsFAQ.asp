...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        Please read the session descriptions next to the categories on the website and choose a session that best fits your expertise.  Session descriptions will be available on June 1, 2011.<br />
        <br />
        ...
        Keynote speaking opportunities are by invitation only. <a  href="http://www.cesweb.org/CFS-signup">The CES Call for Speakers</a> comprises <em>CES-produced </em>conference sessions, largely formatted as moderator/panel. <br />
        <br />
        <b>Is there any chance the deadline will be extended or that a short extension of a few days could be given?</b><br />
        In fairness to all prospects, the deadline is strictly enforced. <br />
        <br />
        ...
        Up to three sessions can be selected per <a  href="http://www.cesweb.org/CFS-signup">submission</a>. It is possible, however, to submit one proposal now and another for the same person at a later date as long as it is before the CES Call for Speakers deadline. <br />
        <br />
        ...
        CEA has carefully selected and finalized the topics for the 2012 CES. While we welcome suggestions, it is unlikely that we can accommodate additional sessions at the time of the Call for Speakers launch.  <br />
        <br />
        <b>Are any sessions for media presenters only?</b><br />
        <a  href="http://www.cesweb.org/CFS-signup">Submissions</a> are not limited to media only. Please submit for the session that is most appropriate for your expertise. <br />
        <br />
        ...
        All Call for Speakers entries will be answered by September 30, 2011.  </p>
        ...
        Proposals for new speakers may be made until 5 p.m. EDT, Wednesday, July 6, 2011. Otherwise, speakers are chosen based on the name in the submission. Please make sure you have the appropriate speaker identified prior to <a  href="http://www.cesweb.org/CFS-signup">submitting your proposal.</a></p>
