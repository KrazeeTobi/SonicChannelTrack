...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        The Innovations 2012 Call For Entries closed on September 21, 2011, and we are no longer accepting applications. Please contact us at <a  href="mailto:Innovations@CE.org">Innovations@CE.org</a> if you have any questions.
