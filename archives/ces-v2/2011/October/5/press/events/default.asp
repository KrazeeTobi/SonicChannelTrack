...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/press/default.asp-->
            ...
            <li class="selected"><a href="/press/events/default.asp">Press Events</a></li>
...
<div class="sub-page-slider">
    ...
    <div class="keynote-right-col">
        ...
        <p><img alt="" style="float: right;"  src="/images/content/2k11_NYC_Unveiled1.jpg" />The Consumer Electronics Association is taking CES Unveiled internationally with the new CES Unveiled @ London. This new event is a must-attend preview of hot holiday products, CEA market research presentations focused on global and Western European CE trends, and the latest news about the 2012 International CES. </p>
        ...
        <p>It's now time to <a  target="_blank" href="/docs/CESUnveiled-London-Press-Reg.pdf"><strong>register for CES Unveiled @ London</strong><strong>.</strong></a> Please contact Becky Maurice-Cohen with any questions at +44 (0) 1442 245030 or <a  href="mailto:becky@prpr.co.uk">becky@prpr.co.uk</a>.</p>
        <p>Interested in <a  target="_blank" href="/docs/2012_Unveiled_RateSheet_UK_web_FNL.pdf"><strong>exhibiting or sponsoring?</strong></a></p>
        <p><strong>Event Schedule</strong></p>
        <p><strong>3-4 p.m.</strong> <img alt="" style="float: right;"  src="/images/content/2k11_NYC_Unveiled3.jpg" /><br />
        Holiday Sales and Global End-of-Year Trend Analysis <br />
        Presented by: CEA's market research experts</p>
        <p><strong>4-5 p.m.</strong> <br />
        2012 International CES Press Conference <br />
        Presented by: CEA President and CEO Gary Shapiro and CEA Sr. Vice President, Events and Conferences, Karen Chupka </p>
        <p><strong>5-7 p.m.</strong> <br />
        CES Unveiled @ London Showcase and Networking Reception <br />
        <br />
        <strong>Sponsorship Investment <br />
        </strong>Call for details. Download the <a  href="/docs/2012-Unveiled-London.pdf">Unveiled events brochure</a> for more information.</p>
        <p><strong>Sales Contact: <br />
        </strong>Tira Gordon <br />
        + 1 703-907-4324 <br />
        Email: <a  href="mailto:tgordon@CE.org">tgordon@CE.org</a></p>
