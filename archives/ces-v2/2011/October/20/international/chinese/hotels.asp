...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <br />
        详细的饭店和价格表清单请参见<a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a>（英文）。若要利用CES价格，您必须访问<a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a>并选择饭店名称后，直接向该饭店订房间。选择饭店名称时，您会直接转到该饭店的预约网页，输入您的信用卡信息。<br />
        <br />
