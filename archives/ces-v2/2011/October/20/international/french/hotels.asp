...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <img alt="" style="margin: 5px; float: right;"  src="/images/photos/Vegas_200.jpg" />Pour vous aider à planifier aisément votre voyage, CES a négocié des prix de chambre réduits auprès de certains hôtels sélectionnés de Las Vegas. <br />
        <br />
        ...
        <br />
        Vous avez des questions à nous poser ? Veuillez les adresser par courrier électronique, en anglais, à <a  href="mailto:CEShotels@CE.org">CEShotels@CE.org</a>.
