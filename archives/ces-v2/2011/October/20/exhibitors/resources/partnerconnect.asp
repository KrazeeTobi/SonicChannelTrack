...
<head><!-- PageID 5360 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Partner Connection</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/resources/default.asp" class="footer">Resources</a>&nbsp;&gt;&nbsp;Partner Connection</div>
                        </div>
                         <div class="headerbox">
                            <h1>Partner Connection</h1>
                        </div><br />
        ...
        <strong><span style="font-size: 14px;">Welcome to Your CES Partner Connection!<br />
        <br />
        </span></strong>Here we connect you to our partners who offer exciting ways for you to build your brand and promote your booth leading up and throughout the 2012 International CES. From ad space to lead generation tools, they have it all. Our partners are here to help you get the most out of your exhibiting experience. 
...
<div class="sub-content-header">Entertainment Matters at CES Daily, produced by Variety </div>
<br />


        <img alt="" style="float: right;"  src="/images/content/EM_sponser.jpg" />Announcing a new CES publication! Variety, the leading entertainment trade magazine, will be producing printed dailies at CES dedicated to Entertainment Matters programming, news, events, announcements and special features. The most influential leaders in the industry have turned to Variety for timely, credible and straight foward news and analysis vital to their professions. Now they will have first-hand access at the most important news and announcements impacting the entertainment industry at CES!
        <ul>
            <li>Distribution will be extensive throughout the show via models at key distribution point</li>
            <li>Advertising is available - (front cover and premium spots as well as standard ad units in book)</li>
        ...
        <br />
        Advertising Contact: Linda Buckley Bruno. <a  href="mailto:Linda.buckley@variety.com">Linda.buckley@variety.com</a> 323-617-9429
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Advertise in the Official CES Preshow Planner, Show Guide and Directory</div>
<br />


        <img alt="" style="float: right;"  src="/images/content/CTPG.gif" />CES is going to be a FULL HOUSE! Go all in before the show begins with CEA's Official Preshow Planner, Show Guide, and Directory and win big with increased booth traffic and company visibility. The Preshow Planner is the only preshow publication created solely to help CES attendees plan for their trip (Ad Close: 11.4.11). The Show Guide is the on-site navigational tool for CES (Ad Close: 11-28-11). The Directory is the one piece that contains detailed information regarding CES exhibitors (Ad Close: 11-23-11). Hurry…space is selling out quickly! <br />
        <br />
        Contact: Eric Schwartz, <a  href="mailto:eschwartz@napco.com">eschwartz@napco.com</a>
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Get Noticed in the Official CES Daily</div>
<br />


        <img alt="" style="float: right;"  src="/images/content/Twice_120pw.jpg" />Want your ad seen where buyers go to plan their show route? The Official CES Daily, featuring show news and new product information, is a must-read for show-goers. With huge CES shuttle bus and hotel distribution, the Official CES Daily gets your ad in front of those you want to see it most. <br />
        <br />
        Four Issues. One low price. <br />
        <br />
        Contact Marcia Grand at <a  href="mailto:mgrand@nbmedia.com">mgrand@nbmedia.com</a> 917-281-4710.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Get Your Digital Imaging Products in Front of the Right CES Attendees</div>
<br />


        <img alt="" style="float: right;"  src="/images/content/DI_PSP.jpg" /><img alt="" style="float: right;"  src="/images/content/DI_Daily_Cover.jpg" />With the addition of PMA@CES to the 2012 International CES, we're thrilled to offer two new publications aimed at digital imaging/photography. The official <em>CES Digital Imaging/Photography Preshow Planner</em>, produced by Dealerscope, will help attendees plan their trip to CES, and will contain digital imaging specific content about the show. Distributed along with the December issue of Photo Industry Reporter, it will reach attendees just as they are making their show plans. The official <em>CES Digital Imaging/Photography Daily</em>, produced by <em>Photo Industry Reporter</em>, will be focused specifically on imaging, and feature show information, the latest breaking news and industry information, and will be distributed throughout CES. <br />
        <br />
        Companies interested in advertising in the Daily should contact <a  href="mailto:alevine@photoreporter.com">alevine@photoreporter.com</a>, and those interested in the Preshow Planner should contact <a  href="mailto:rickalbuck@napco.com">rickalbuck@napco.com</a>.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Are You CNET’s Best of CES?</div>
<br />


        <img alt="" style="float: right;"  src="/images/content/BEST-OF-CES.jpg" /><br />
        Have you told CNET about the products you are debuting at CES? Don’t miss out! <a  target="_blank" href="http://www.cnet.com/">CNET</a> editors are looking for the best and your product could be one of them. In its 8th year, the Best of CES Awards are one of the most coveted at the show. <br />
        <br />
        No submission is necessary; pitch your product by following the <a  target="_blank" href="http://www.cnet.com/2723-13403_1-461-8.html">guidelines</a>.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Get on the Air With Dave Graveline </div>
<br />


        <img alt="" style="float: right;"  src="/images/content/graveline.jpg" />Get on the air! “<a  target="_blank" href="http://www.intotomorrow.com/">Into Tomorrow with Dave Graveline</a>” launches their 17th Year at the 2012 International CES. If you’ll be showing new products, be sure to contact Dave’s Producer, <a  href="mailto:rob@graveline.com">Rob Almanza</a>, with details of your announcements. They’ll have three weeks of CES coverage, video highlights, interviews, Video Booth Tours and “Dave’s Top 10 @ CES!”
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Let Attendees Know Where to Find You at CES!</div>
<br />


        <img alt="" style="float: right;"  src="/images/content/experient_logo.jpg" />Don't just hope that prospects will show up at your booth - promote your presence by targeting the right prospects. As the exclusive source for all attendee registration data, we'll help you target the specific demographic and get your message out in advance using the official registration lists. Pinpoint the prospects that are most important to you and give them a compelling reason to visit your booth. International CES attendee mailing lists are only available to CES exhibitors and your direct mail piece must be approved by CES. Contact Melissa Hopson at <a  href="mailto:mailto: melissa.hopson@experient-inc.com">melissa.hopson@experient-inc.com</a> or 866-221-7921 for more information.  
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">HomeToys.com – Bringing You Up to Date News and Articles for the Home Technology Industry</div>
<br />


        <img alt="" style="float: right;"  src="/images/content/HomeToysLogo.jpg" />HomeToys.com is a News and Information Resource for the Home Technology A/V Industry. Daily News Stories, Hot Products, Industry Tools, Hundreds of Articles and more. <br />
        <br />
        Join with 100,000+ industry players and enthusiasts who visit each month to find out how to grow their businesses and expand their knowledge. <a  target="_blank" href="http://www.hometoys.com/">http://www.hometoys.com</a>
