...
<head><!-- PageID 3894 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Hot Topics</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/showPlanning/default.asp" class="footer">Show Planning/Exhibitor Manual</a>&nbsp;&gt;&nbsp;Hot Topics</div>
                        </div>
                         <div class="headerbox">
                            <h1>Hot Topics</h1>
                        </div><br />
...
<div class="page_header_block">
    <div class="blue_box">
        ...
        <li><a href="#5648">Exhibitor Workshop</a></li><!---->
        
        <li><a href="#5649">Be Seen at CES!</a></li><!---->
        
            </ul>
        
            <ul>
        
        <li><a href="#5402">New Way To Save - Exhibitor Provisions Outlet</a></li><!---->
        
        <li><a href="#5650">CES Information Packets </a></li><!---->
        
            </ul>
        
            <ul>
        
        <li><a href="#5400">Exhibitor Manuals Now Available</a></li><!---->
...
<div class="sponsorshipTitle">Exhibitor Workshop</div>
<br />
        <p><strong>Want To Have a Successful CES?<br />
        </strong>Attend one or both of our remaining Exhibitor Workshop presentations which focus on show planning and logistics.</p>
        <p><strong>Meet GES- Official Show Contractor <br />
        </strong>October 11, 2011 – 2 p.m. EST<br />
        A panel of GES experts discuss shipping deadlines and rigging, booth design and maintenance, electrical issues, union jurisdictions and material handling, and anything else you need to know to ensure your materials reach the show efficiently. <a  target="_blank" href="http://www.cesweb.org/exhibitors/resources/workshop/rd_registration2012.asp">Register now</a>.</p>
        <p><strong>CES Operations- Show Planning and Booth Logistics <br />
        </strong>October 19, 2011 – 2p.m. EST <br />
        ...
        <p>Don’t miss this great opportunity to learn the best ways to navigate CES. <a  target="_blank" href="http://www.cesweb.org/exhibitors/resources/workshop/rd_registration2012.asp">Register Today</a>!</p>
...
<div class="sponsorshipTitle">Be Seen at CES!</div>
<br />
        <p><strong>Let attendees know where to find you at CES!<br />
        </strong>Contact last year's show attendees and this year's pre-registered attendees via direct mail before the show doors even open!  We'll help you target the specific demographic of attendees you want to see at your booth. The International CES attendee mailing lists are only available to CES exhibitors and your direct mail piece must be approved by CES.  Contact Melissa Hopson at <a href="mailto:melissa.hopson@experient-inc.com">melissa.hopson@experient-inc.com</a> or 866-221-7921 for more information.</p>
...
<div class="sponsorshipTitle">New Way To Save - Exhibitor Provisions Outlet</div>
<br />
        <p><strong>New Way to Save! Exhibitor Provisions Outlet! <br />
        </strong>Aramark has announced their new Exhibitor Provisions Outlet for the 2012 International CES. Exhibitors will now be able to purchase snacks and bottled water at a deeply discounted rate during the last two days of move-in on January 8 &amp; 9. This is a great way to make sure your staff and guests have plenty of bottled water and food during the show without breaking your budget. <a  target="_blank" href="/docs/CES_Webinar_-_2012.pdf">Check out the details</a> about this program and other Aramark information and deadlines.</p>
...
<div class="sponsorshipTitle">CES Information Packets </div>
<br />
        <p><strong>CES Meeting Place Exhibitor Manual and New TechZone and Turnkey Information Packets <br />
        </strong>We’ve created some new information packets to help our specialized exhibitors at the 2012 CES. Whether you’re a <a  target="_blank" href="http://cesweb.org/docs/2012-CES-Meeting-Place-Exhibitor-Manual.pdf">CES Meeting Place exhibitor</a>, or you will be exhibiting in a <a  target="_blank" href="http://cesweb.org/exhibitors/showPlanning/lvcc-show-planning.asp#5643">Turnkey booth</a>, we’ve got you covered. We have also created packets for TechZone Exhibitors in both the <a  target="_blank" href="http://cesweb.org/exhibitors/showPlanning/lvcc-show-planning.asp#5643">LVCC</a> and the <a  target="_blank" href="http://cesweb.org/exhibitors/showPlanning/venetian-show-planning.asp#5602">Venetian</a>. These packets are designed to supplement our <a  target="_blank" href="http://www.ges.com/eComm/2012/Q1/11-05118/">overall manual</a> and streamline your planning process. For more information please contact Martina Mirabella, CES Operations Coordinator, at <a href="mailto:mmirabella@CE.org">mmirabella@CE.org</a> or 703-907-5243.a</p>
...
<div class="sponsorshipTitle">Exhibitor Manuals Now Available</div>
<br />
        <p><strong>Exhibitor Manuals Now Available<br />
        </strong>The 2012 International CES Exhibitor Manuals are now live! The <a  target="_blank" href="http://www.cesweb.org/exhibitors/showPlanning/lvcc-show-planning.asp#5457">2012 International CES LVCC/Hilton Manual</a> and the <a  target="_blank" href="http://www.cesweb.org/exhibitors/showPlanning/venetian-show-planning.asp">2012 International CES Venetian Manuals</a> are ready and include everything you need to start planning a fabulous CES. Make sure to get started early on your planning.</p>
