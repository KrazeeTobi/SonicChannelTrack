...
//function showCartImage(t) {
//	$(t).find('img').attr('src', $(t).find('img').attr('src').replace('1', '2'));
//};
//function showShopImage(t) {
//	$(t).find('img').attr('src', $(t).find('img').attr('src').replace('2', '1'));
//};
//function showCartImage(t) {
//	$(t).find('img').attr('src', $(t).find('img').attr('src').replace('1', '2'));
//};
