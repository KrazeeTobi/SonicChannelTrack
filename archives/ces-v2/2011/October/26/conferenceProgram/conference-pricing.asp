...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <p>The 2012 CES Conference Program unites, educates and illuminates trends critical to consumer technology professionals. See the pricing below, and <a  href="http://cesweb.org/conferenceProgram/default.asp">start filling your shopping cart</a> with sessions and tracks delivered by industry experts.</p>
...
<LI class=text>SuperSessions and Keynotes </LI></UL>
    ...
    <div class="keynote-header-bak">
        ...
        <ul class="text">
            ...
            <li class="text">Technology and Evolving Countries </li>
            <li class="text">SuperSessions and Keynotes </li>
