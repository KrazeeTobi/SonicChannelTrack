...
<P>Informations utiles sur l’entrée aux États-Unis et la sortie du pays. <BR></P>
<H2>Visa</H2>
<P><STRONG>Vous avez besoin d’un visa ?</STRONG> <BR><A href="https://ceac.state.gov/genniv/ " target=_blank>Vous pouvez désormais remplir votre demande de visa en ligne. </A></P>
<P><STRONG>Vous avez besoin d’aide ? <BR></STRONG><A href="/docs/French_2K12VisaTips.pdf" target=_blank>Téléchargez notre fiche de conseils pour les visas</A>, qui contient des instructions détaillées, les adresses de sites web importants et d’autres informations destinées à faciliter votre demande de visa.<BR><BR>
...
<TR>
<TD>
<H3>Avis important pour les participants qui voyagent en vertu du Visa Waiver Program</H3>Toutes les demandes d’inscription ou de renouvellement faites sur le système électronique d’autorisation de voyage (Electronic System for Travel Authorization, ESTA) nécessitent un paiement de 14 dollars US par carte de crédit ou de débit. Les enregistrements actuels au ESTA resteront valides jusqu’à leur date d’échéance. Pour obtenir de plus amples renseignements, cliquez sur le lien suivant <A href="http://cbp.gov/xp/cgov/travel/id_visa/esta/" target=_blank>consultez la page de l’ESTA sur le site Web du Département de la Sécurité intérieure, des Douanes et de la Protection des frontières.</A></A></TD></TR></TBODY></TABLE></P>
<H2>Voyage</H2>
<P><STRONG>Vous voulez savoir comment vous rendre au CES ?</STRONG><BR><A href="/hotelTravel/default.asp">Consultez la section Voyage de CESweb.org</A> (en anglais) pour obtenir les meilleurs prix pour votre billet d’avion et votre location de voiture, mais aussi pour planifier vos déplacements locaux.</P>
<P><STRONG>Hôtels</STRONG><BR><A href="/hotelTravel/hotel.asp">Consultez la section Hôtels de CESweb.org</A> (en anglais) pour vos réservations individuelles ou de groupe. <BR></P>
