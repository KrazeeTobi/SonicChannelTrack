...
<head><!-- PageID 359 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Resources</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;Resources</div>
                        </div>
                         <div class="headerbox">
                            <h1>Resources</h1>
                        </div><br />
...
<H3><A href="/exhibitors/resources/video-contest.htm">Exhibitor Video Contest</A></H3>Enter the "Visit Me at CES!" Exhibitor Video Contest for a chance to win a month's worth of free promotion on the homepage of CESweb.org!<BR><BR>
<H3><A href="/exhibitors/resources/exhibitor-workshop.asp">CES Exhibitor Workshop</A></H3>With our free four-part web-cast series we provide you with tools to help you market and promote your brand, receive the ultimate press coverage, as well as turn you into a pro when dealing with booth planning, logistics and our contractor GES.<BR><BR>
<H3><A href="/exhibitors/resources/partnerconnect.asp">Partner Connection</A></H3>Here we connect you to our partners who offer exciting ways for you to build your brand and promote your booth leading up and throughout the 2012 International CES. From ad space to lead generation tools, they have it all. <BR><BR>
<H3><A href="/exhibitors/resources/export-assistance.asp">Export Assistance</A></H3>CES offers programs for exhibitors interested in expanding their business in international markets.<BR><BR>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        ...
        <dt target="_blank"><a  href="/docs/8408_FINAL2011AuditSummary_wTWICE_Web.pdf">2011 International CES Attendee Audit Summary (pdf) <br />
        </a><br />
        <a  target="_blank" href="/docs/2012_Space_Contract.pdf">2012 International CES Exhibit Space Contract (pdf)</a> <a  target="_blank" href="/docs/2010_CESauditSUM.pdf"><br />
        </a><br />
        </dt>
...
<!--/exhibitors/resources/spaceselection.asp--><!--/exhibitors/resources/exporting-exhibitors.asp--><!--/exhibitors/resources/2012hpaspaceselection.asp--><!--/exhibitors/resources/2011spaceSelection.asp--><!--/exhibitors/resources/member-packet.asp--><!--/exhibitors/resources/exhibitorLogin.asp-->
