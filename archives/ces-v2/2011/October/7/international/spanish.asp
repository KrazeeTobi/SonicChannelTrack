...
<head><!-- PageID 1110 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/spanish.asp">Español</a>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;Español</div>
                        </div>
                         <div class="headerbox">
                            <h1>Español</h1>
                        </div><br />
...
<H3>Las mentes más brillantes de la industria se reúnen aquí</H3>Cada año, las innovaciones más avanzadas se pueden admirar en un mismo lugar. Acompáñenos del 10 de enero al 13 de enero de 2012 en Las Vegas, Nevada, EE.UU., en la exposición industrial de tecnología de consumo más grande del mundo. <A href="/register">Regístrese hoy mismo</A> y prepárese para estar rodeado de pensadores, creadores, líderes, soñadores e innovadores, y de los productos revolucionarios que ellos crean.
...
<div class="sub-content-header">Información para el visitante internacional</div>
<br />


        <p><a  href="http://cesweb.org/international/spanish/travel.asp">Información sobre traslado y visas</a><br />
        Use esta útil información a medida que viaje hacia o de regreso de Estados Unidos.<br />
        <br />
        <a  href="/international/spanish/hotels.asp"><span class="hps">Reservas de hotel<br />
        </span></a>Para ayudarle a hacer sus planes de viaje, CES ha negociado tarifas de hotel con descuento en ciertos hoteles de Las Vegas. <br />
        <br />
        <a  href="http://www.cesweb.org/international/spanish/delegations.asp">Programa de grupos de delegaciones<br />
        </a>La Exposición Internacional CES atrae a una enorme audiencia internacional por su programa de delegaciones exitoso. Aprenda cómo organizar una delegación en su país o región o cómo sumarse a una.</p>
        <p><a  href="/international/spanish/services.asp">Servicios internacionales<br />
        </a>Entre la gran cantidad de beneficios que se ofrecen a los participantes internacionales se encuentran los intérpretes, las recepciones especiales para hacer contactos, las áreas de trabajo dedicadas, las salas de reuniones y muchos más.</p>
        <p><a  target="_blank" href="/docs/HI_RES_SP_2K12_CESfactSheet_Web.pdf">Información general (pdf)</a><br />
        ¡Aprenda sobre la historia de la exposición, las categorías actuales de productos, las próximas fechas y mucho más en su idioma! <br />
        <br />
        <a  href="/international/spanish/shuttles.asp">Servicio de Transporte<br />
        </a>La Exposición Internacional CES ofrece un servicio gratuito de minibuses durante los cuatro días de la exposición.</p>
        <p><a  target="_blank" href="/docs/ADVANCE_DOMESTIC_REGISTRATION-final_SP.pdf">Formulario de Inscripción Para Participantes<br />
        </a>¿Necesita ayuda para inscribirse? <a  target="_blank" href="/docs/ADVANCE_DOMESTIC_REGISTRATION-final_SP.pdf">Descargue una copia del formulario de inscripción para participantes en su idioma.</a> Tome nota que, aunque este formulario es válido para inscribirse, le recomendamos que <a  href="http://cesweb.org/register">llene la inscripción en línea</a> para garantizar un procesamiento completamente preciso.</p>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        ¿Sabía usted que las delegaciones de 15 o más concurrentes extranjeros reciben la inscripción complementaria Exhibits Plus? <A href="/international/spanish/delegations.asp">Infórmese más.</A> 
        <br /><br />
    </div>
</div>
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        <P>Certified by:<BR><IMG src="/images/content/IBPlogo.gif"><BR>The Commercial Service logo is a registered trademark of the U.S. Department of Commerce, used with permission. </P>
        <br /><br />
    </div>
</div>
                        </div>
