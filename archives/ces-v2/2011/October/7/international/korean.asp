...
<head><!-- PageID 1154 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/korean.asp">한국어 </a>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;한국어 </div>
                        </div>
                         <div class="headerbox">
                            <h1>한국어 </h1>
                        </div><br />
...
<H3>업계 최고의 두뇌들이 이곳에 옵니다</H3>최첨단 혁신성을 매년 한 곳에서 볼 수 있습니다. 2012년 1월 10일–1월 13일, 우리와 함께 미국 네바다 주 라스베이거스에서 세계 최대의 소비자 테크놀로지 전람회에 참가하십시오. <A href="/register">지금 곧 등록하시고 사상가, 창조자, 리더들, 몽상가, 혁신가, 그리고 그들이 만들어낸 인류의 생활을 혁신하는 제품들을 만날 준비를 하십시오.</A>
<P>&nbsp;</P>
...
<br />
        ...
        <p><a  href="http://cesweb.org/international/korean/travel.asp">여행 및 비자 정보</a><br />
        미국을 방문하는 데 도움이 되는 이 정보를 사용하십시오. <br />
        <br />
        <a  href="/international/korean/hotels.asp">호텔 예약<br />
        </a>CES는 귀하의 여행 계획에 편의를 제공하기 위해 할인가격으로 일부 라스베이거스 호텔 객실을 확보해 두었습니다. <br />
        <br />
        <a  href="/international/korean/delegations.asp">대표단 프로그램</a><br />
        International CES는 성공적인 대표단 프로그램을 갖추고 수많은 해외 방문객들을 불러들이고 있습니다. 여러분 국가나 지역의 대표단을 만들거나 대표단에 참여하는 방법을 알아보십시오.</p>
        <p><a  href="/international/korean/services.asp">해외 방문객 서비스<br />
        </a>통역사, 특별 네트워크 리셉션, 효율적인 업무 공간, 회의실 등 해외 방문객을 위한 다양한 서비스가 제공됩니다.<br />
        <br />
        <nobr><a  target="_blank" href="/docs/HI_RES_KO_2K12_CESfactSheet_Web.pdf">一般信息<br />
        </a></nobr>了解关于展会的历史、目前产品目录、未来展会日期等信息 —全部被译成您的语言！<br />
        <br />
        <a  href="/international/korean/shuttles.asp">왕복 운행<br />
        </a>인터내셔널 CES는 4일간의 인터내셔널 CES 전람회 기간 중 매일 무료 셔틀 서비스를 제공합니다.</p>
        <p><a  target="_blank" href="/docs/ADVANCE_DOMESTIC_REGISTRATION-final-KOR.pdf">참가자 등록 양식<br />
        </a>등록에 도움이 필요하십니까? <a  target="_blank" href="/docs/ADVANCE_DOMESTIC_REGISTRATION-final-KOR.pdf">한글판 참가자 등록 양식 사본을 다운로드 하십시오.</a> 주의 요망: <a  href="http://cesweb.org/register">이는 유효한 등록 양식이지만 온라인상에서 등록하실 것을 권합니다</a>. 그러면 귀하의 등록을 가장 정확하게 처리할 수 있습니다.</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p> </p>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        15명 이상의 인터내셔널 참가자로 구성된 대표단은 Exhibits Plus 무료 등록 혜택을 받는다는 것을 알고 계셨습니까? <A href="/international/korean/delegations.asp">자세한 내용보기.</A>&nbsp; 
        <br /><br />
    </div>
</div>
<div class="right-blue-box" align="center">
