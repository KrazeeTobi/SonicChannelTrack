...
<div class="right-blue-box" align="center">
    ...
    <div>
        ...
        <p style="text-align: center;"><a  target="_blank" href="http://ces.cnet.com/"><img width="70" height="70" alt="" style="border: 0px solid; margin-top: 6px; margin-bottom: 6px; vertical-align: middle;"  src="/images/content/cnet-mp.gif" /></a><br />
        <a  target="_blank" href="http://www.napco.com/"><img width="150" height="25" alt="" style="border: 0px solid; margin-top: 8px; margin-bottom: 8px; vertical-align: middle;"  src="/images/content/consumerTech.gif" /></a><br />
        <a  target="_blank" href="http://www.customretailer.net/"><img width="130" height="29" alt="" style="border: 0px solid; margin-top: 6px; margin-bottom: 6px; vertical-align: middle;"  src="/images/content/customRet-mp.gif" /></a><br />
        <a  target="_blank" href="http://www.engadget.com/tag/ces"><img width="120" height="54" alt="" style="border: 0px solid; margin-top: 4px; margin-bottom: 4px; vertical-align: middle;"  src="/images/content/engadget-mp.gif" /></a><br />
        <a  target="_blank" href="http://www.gdgt.com/"></a><br />
        <a  target="_blank" href="http://www.graveline.com/"><img width="115" height="45" alt="" style="border: 0px solid; margin-top: 6px; margin-bottom: 6px; vertical-align: middle;"  src="/images/content/intoTomorrow.gif" /></a><br />
        <a  target="_blank" href="http://www.me-mag.com/"><img width="110" height="39" alt="" style="border: 0px solid; margin-top: 6px; margin-bottom: 6px; vertical-align: middle;"  src="/images/content/mobileElec.gif" /></a><br />
        <a  target="_blank" href="http://www.pcworld.com/"><img width="120" height="33" alt="" style="border: 0px solid; margin-top: 8px; margin-bottom: 8px; vertical-align: middle;"  src="/images/content/pcworld-mp.gif" /></a><!--<BR><img height=42    src="/images/content/picturebiz-mp.gif" width=130 align=middle vspace=6 border=0>--><br />
        <a  target="_blank" href="http://www.rcrwireless.com/"><img width="150" height="22" alt="" style="border: 0px solid; margin-top: 6px; margin-bottom: 6px; vertical-align: middle;"  src="/images/content/rcr-mp.gif" /></a><br />
        <br />
        <a  target="_blank" href="http://www.stuff.tv"><img width="120" height="35" alt="" style="border: 0px solid;"  src="/images/content/Stuff-logo.gif" /></a></p>
        ...
        <br />
        <a  target="_blank" href="http://www.twice.com/"><img width="120" height="42" alt="" style="border: 0px solid; margin-top: 8px; margin-bottom: 8px; vertical-align: middle;"  src="/images/content/twice-mp.gif" /></a><br />
        <br />
        <a  target="_blank" href="http://www.whathifi.com"><img width="140" height="46" alt="" style="border: 0px solid;"  src="/images/content/WHF-logo.gif" /></a><br />
        <br />
        <a  target="_blank" href="http://ce.org/Press/CEA_Pubs/vision2010.asp"><img width="150" height="43" alt="" style="border: 0px solid;"  src="/images/content/CEVision.jpg" /></a></p>
