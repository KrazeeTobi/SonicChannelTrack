...
<head><!-- PageID 626 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Exhibitor PR Kit</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/pr/default.asp" class="footer">PR Help</a>&nbsp;&gt;&nbsp;Exhibitor PR Kit</div>
                        </div>
                         <div class="headerbox">
        ...
        <br />
        <h3><a  target="_blank" href="/docs/2012_Exhibitior_PR_Kit_08.30.11.pdf">2012 International CES Exhibitor PR Kit<br />
        <br />
        </a></h3>
        <a  target="_blank" href="/docs/Sec1_What_To_Keep_in_Mind.pdf"><strong>What to Keep in Mind <br />
        </strong></a>- Publicity Tips <br />
        - Important Deadlines <br />
        - Key Contacts <br />
        - Exhibitor PR Contact Information
        <p><a  target="_blank" href="/docs/Sec2_Things_to_Take_Advantage_of.pdf"><strong>Things to Take Advantage of <br />
        </strong></a>- Exhibitor PR Checklist <br />
        ...
        - 2012 International CES Awards<br />
        <br />
        <a  target="_blank" href="/docs/Sec3_Tools_to_Use.pdf"><strong>Tools to Use <br />
        </strong></a>- PR Writing Samples <br />
        - Press Release <br />
        - Blog Post  <br />
        - Tweet <br />
        - Facebook Post <br />
        ...
        - Press Conference Dos and Don’ts</p>
        <p><a  target="_blank" href="/docs/Sec4_Onsite_Resources.pdf"><strong>On-site Resources to Note <br />
        </strong></a>- Press Rooms and Digital Media Center <br />
        - On-site Interview Rooms</p>
        <p><a  target="_blank" href="/docs/Sec5_Press_Conference_Request.pdf"><strong>Forms to Finalize <br />
        </strong></a>- Press Conference Reservation Request Form <br />
        - Special Event/Celebrity Appearance Form</p>
