...
CEA sponsors a variety of events - for the entire industry and individual niches within it - to educate the masses and unite manufacturers, retailers and market movers. From <A href="/events/sinoces.asp">SINOCES</A> to the CEA Industry Forum and Fall Conference, CEA works year 'round to grow and shape the future of consumer electronics. <A href="http://ce.org/Events/default.asp">Check out upcoming CEA events such as:<BR></A><BR><IMG border=0 align=right src="/images/content/cea-events.jpg" width=353 height=370>&nbsp;
<H3>CEO Summit and Board Retreat </H3>October 1-3, 2011, Stresa, Lake Maggiore, Italy <BR><BR><BR>
<H3>CEA Industry Forum </H3>October 2011 <BR><BR><BR>
<H3>CES New York Press Preview featuring CES Unveiled @ NY </H3>November 2011, New York, NY
