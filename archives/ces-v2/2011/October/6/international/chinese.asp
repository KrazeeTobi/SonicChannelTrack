...
<br />
        ...
        <p><a  target="_blank" href="/docs/ADVANCE_DOMESTIC_REGISTRATION-final-SCH_.pdf">与会者登记表格</a><br />
        登记时需要协助吗？<a  target="_blank" href="/docs/ADVANCE_DOMESTIC_REGISTRATION-final-SCH_.pdf">请下载中文的与会者登记表格一文。</a>请注意，虽然这是有效的登记表格，<a  href="http://cesweb.org/register">建议您填写在线登记表格</a>，以确定我们正确处理您的登记。</p>
