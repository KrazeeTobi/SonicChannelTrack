...
<head><!-- PageID 3986 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: International Visitors</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
            ...
            <div id="page-bottom">
                <div id="main-content">
                    ...
                    <div id="main-content-header">
                        <img src="/images/content/Subhead_IntlVisitors.jpg">
                    </div>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;International Visitors</div>
                        </div>
...
<H3>The Industry’s Brightest Minds Come Here</H3>Every year, the most cutting-edge innovations can be seen in one place. Join us January 10–13 (Tuesday-Friday), 2012, in Las Vegas, Nevada, U.S., for the world’s largest consumer technology tradeshow. <A href="/register">Register now</A>, and be prepared to be surrounded by thinkers, creatives, leaders, dreamers and innovators – and the life-changing products they create.
...
<br />
        ...
        <p><a  href="/international/travel.asp">Travel and Visa Information</a><br />
        Use this helpful information as you travel into and out of the United States.<br />
        <br />
        <a  href="/international/hotels.asp">Hotel Reservations<br />
        </a>To assist you in your travel plans, CES negotiated discounted room rates at select Las Vegas hotels.<br />
        <br />
        <a  href="/international/delegations.asp">Delegation Group Program</a><br />
        The International CES attracts a large international audience because of its successful delegation program. Learn how to create or join a delegation in your country or region.<br />
        <br />
        <a  href="/international/services.asp">International Services<br />
        </a>Translators, special networking receptions, dedicated work areas, meeting rooms and more are among the many benefits international attendees receive.<br />
        <br />
        <a  target="_blank" href="/docs/2012_CES_Fact_Sheet_FINAL_5.9.2011.pdf">General Information (pdf)<br />
        </a>Learn about the show's history, current product categories, future dates and more.<br />
        <br />
        <a  href="/international/shuttles.asp">Shuttle Service<br />
        </a>The International CES offers complimentary shuttle service on all four days of the International CES. </p>
        <p><a  target="_blank" href="/docs/Attendee_Reg_Form_CES.pdf">Attendee Registration Form<br />
        </a>Need assistance with registration? <a  target="_blank" href="/docs/Attendee_Reg_Form_CES.pdf">Download a copy of the attendee registration form in your native language.</a> Please note, while this is a valid registration form, you are encouraged to complete the <a  href="http://cesweb.org/register">online registration</a> to ensure the most accurate processing.</p>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        Did you know you that delegations of 15 or more international attendees receive complimentary Exhibits Plus registration? <A href="/international/delegations.asp">Learn more.</A>
        <br /><br />
    </div>
</div>
<div class="right-blue-box" align="center">
    ...
    <div>
        <P><A href="/exhibitors/default.asp">International exhibitors can find information here.</A> <BR><BR></P>
    </div>
</div>
<div class="right-blue-box" align="center">
