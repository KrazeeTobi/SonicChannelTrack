...
<head><!-- PageID 4519 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Floor Plans</title>
...
<ul id="sub-awards" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('awards','show')" class="top"><a href="/awards/default.asp" class="sublink"><!-- <img src="/images/framework/secondarynav_awards.gif" />--></a></li>
            ...
            <ul id="sub-sub-awards308" style="display: none;" onmouseout="setSubMenuTimer()">
                    ...
                    <li onmouseover="showSubMenu('awards308','show')"><a href="/awards/innovations/2010.asp">2011 Innovations Honorees</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/showFloor/Floor-Plans.asp">Floor Plans</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/showFloor/default.asp" class="footer">Show Floor</a>&nbsp;&gt;&nbsp;Floor Plans</div>
                        </div>
                        <div class="headerbox">
                            <h1>Floor Plans</h1>
                        </div>
...
//-->
    ...
    <div>
        ...
        <ul>
            <li><a href="/events/D27CAB76E49641B1950E77DF6CA09A6F.htm">Register for SINOCES</li>
