...
<head><!-- PageID 4579 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: LIT Dinner</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/events/LIT-dinner.asp">LIT Dinner</a></li>
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/events/default.asp" class="footer">Events</a>&nbsp;&gt;&nbsp;LIT Dinner</div>
                        </div>
                        <div class="headerbox">
                       <h1>LIT Dinner</h1>
                            <div class="icon_wrap">
...
<STRONG><EM>Private Event: By Invitation Only<BR></EM>6:30 p.m. Friday, January 7, 2011<BR>The Wynn<BR></STRONG>The Leaders in Technology (LIT) Program at CES allows high-level public policymakers and technologists to learn from the more than 2,500 exhibitors and thousands of new products that contribute to a dynamic industry that supports $700 billion in retail sales worldwide. The program also provides information and insight to assist officials in evaluating federal policies that affect the consumer technology industry. <BR><BR>The program culminates at the International CES Leaders in Technology Dinner, which is an invitation-only event. For more information on the Leaders in Technology Program please contact Laura Hudson at 703-907-7604.<BR><BR>
...
<TR>
<TD>
<H3>Netflix CEO Reed Hastings and Arianna Huffington to Keynote 2011 CES LIT Dinner</H3>
<P><IMG hspace=5 align=right src="/images/content/reed_hastings.jpg" width=144 height=205>Netflix CEO Reed Hastings will do a fireside chat with Arianna Huffington, co-founder and editor-in-chief of The Huffington Post, that will open the annual Leaders in Technology Dinner at CES. The LIT dinner honors the technologists, entrepreneurs and policymakers instrumental in furthering technology innovation.<BR><BR>"Reed Hastings is a true leader in technology, a talented entrepreneur who had an innovative vision for creating new ways to bring entertainment into consumers' homes," said Gary Shapiro, president and CEO of CEA. "Through Reed's leadership, Netflix continues to innovate, partnering with CE companies to deliver the connected TV experiences. We are thrilled to have him keynote the 2011 CES LIT dinner and look forward to hearing where Netflix is headed next."&nbsp;<BR><BR>Reed Hastings co-founded Netflix in 1997 and launched the subscription service in 1999. Netflix grew to one million subscribers in less than four years. Today the company has 16.9 million members. In 10 of the last 11 surveys since 2005 Netflix has been ranked number one in customer satisfaction across all of ecommerce by independent researcher ForeSee Results. In 2005, Time magazine added Hastings to its "Time 100" list of the most influential global citizens. Hastings received a BA from Bowdoin College in 1983 and an MSCS degree from Stanford University in 1988. He holds several patents. Between Bowdoin and Stanford, Reed served in the U.S. Peace Corps as a high school math teacher in Swaziland.<BR><BR>"Arianna Huffington has become an extremely influential media executive based on her vision for the news and technology industries and her place at the forefront of new media," said Gary Shapiro, president and CEO of CEA. "She is a dynamic speaker and we are thrilled that she’ll be able to join Reed Hastings and our government guests at the 2011 CES." <BR><BR>Huffington launched The Huffington Post, The Internet Newspaper, in May of 2005. Since its inception, The Huffington Post has become one of the most widely-read online news and opinion sites, and has featured guest bloggers such as Barack Obama and Hillary Clinton. In addition to her regular blog posts and newspaper columns, Huffington has written thirteen books, and co-hosts syndicated radio shows, "Left, Right &amp; Center" and "Both Sides Now." In 2006, Time Magazine named Huffington one of the world's 100 most influential people. <BR></P></TD></TR></TBODY></TABLE>

    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/events/LIT-dinner.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
