...
<head><!-- PageID 4793 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: December 29, 2010</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/news/default.asp" class="footer">News</a>&nbsp;&gt;&nbsp;<a href="/news/newsletters.asp" class="footer">Newsletters</a>&nbsp;&gt;&nbsp;<a href="/news/up-to-minute-default.asp" class="footer">CES Up to the Minute</a>&nbsp;&gt;&nbsp;December 29, 2010</div>
                        </div>
                        <div class="headerbox">
                       <h1>December 29, 2010</h1>
                            <div class="icon_wrap">
...
Before you ring in the new year, ring in <A href="/register">$100 worth of savings by registering for the International CES</A>. For $100, you can gain access to 2,500 consumer technology companies all in one place. Prepare to network and see thousands of product launches firsthand.<BR><BR>Plus, now's the time to pick the conference sessions you want to attend. <A href="/conferenceProgram/pricing.asp">Early-bird rates on most sessions are effective until 5:01 p.m. EST December 31.</A>
...
<div class="sub-content-header">CESTV: Social Media</div>
<br />

There's more than one way to get all the late-breaking news before and during CES. <A href="/news/multimedia-gallery.asp">Queue up the latest edition of CESTV</A> to see what social media networks – from Facebook to Twitter – you can use to keep track of trends, news, awards and product launches.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="4811"></a>

<div class="sub-content-header">Use MyCES to Map Your Show</div>
<br />

<IMG hspace=5 align=left src="/images/content/MY_CES_2k10.gif" width=128 height=85>With 1.6 million square feet to cover in four days, you need to know where you're going and the quickest way to get there. MyCES, the online tool that connects you to exhibitors and products that matter most to you also provides <A href="http://www.mapyourshow.com/shows/index.cfm?SHOW_ID=CES11&alt_entry=true&curr_pri=facility&curr_sec=OO">an interactive floor plan that gives you a birds-eye-view of the show floor.</A>
<P>Want a print-and-go map? <A href="/showFloor/by-hall.asp">We have that, too.</A><BR></P>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="4810"></a>

<div class="sub-content-header">Meet Ten Dollar Dinners Host Melissa d' Arabian</div>
<br />

Need something to do on the first night of CES? Here's our pick:<BR><BR><IMG hspace=5 align=right src="/images/content/SN_DIM_TAG.jpg" width=110 height=19>On Thursday, January 6, from 6-7 p.m., relax at the <A href="http://www.cesweb.org/conferenceProgram/conference-tracks.asp#4384">Media Money Makers reception</A> co-sponsored the by Scripps Networks, home of HGTV, DIY Network, Food Network, Cooking Channel, Travel Channel and Great American Country (GAC). Mingle with attendees and speakers, and meet The Next Food Network Star Melissa d’ Arabian, host of Ten Dollar Dinners.<BR><BR><IMG hspace=5 align=right src="/images/content/Nielson_100.jpg" width=100 height=35><IMG hspace=5 align=left src="/images/content/CES_MMM_logo.jpg" width=100 height=54><A href="http://www.cesweb.org/conferenceProgram/conference-tracks.asp#4384">Media Money Makers</A> cuts through the technobabble to reveal reliable business models for monetizing content across the most promising platforms. Hear insights from some of the most successful innovators from Hollywood, Madison Avenue, Wall Street and Silicon Valley. We'll plunge into new media platforms and explore innovative thinking from artists, specialty content and incisive research. Come preview creative collaborations and real–world strategies that can turn your next project into a Media Money Maker. Get your Media Money Makers/Digital Hollywood pass now.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="4809"></a>

<div class="sub-content-header">Coca-Cola, Akamai, IPG, Microsoft and WPP Execs Join Keynote Lineup</div>
<br />
...
<P>The Entertainment Matters keynote panel will be moderated by Michael Kassan, chairman and CEO of MediaLink LLC. Since founding the company in 2004, Kassan has built MediaLink LLC into a leading advisory firm that provides sage counsel to the media, entertainment, and technology industries.&nbsp; </P>
<P><A href="/events/keynotes.asp#4730">Learn more about the panelists.<BR></A></P>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="4808"></a>

<div class="sub-content-header">Home Automation Comes to Life at EHX@CES</div>
<br />

<STRONG><A href="http://www.cesweb.org/showFloor/techzones.asp#3861"><IMG border=0 hspace=5 align=right src="/images/content/EHX(2).jpg" width=150 height=48></A>LVCC, South Hall 1 <BR>Sponsor(s): CE Pro Magazine&nbsp;<BR><BR></STRONG>EHX@CES is the destination for custom electronics integrators within CES. Hosting a comprehensive offering of newest consumer electronics, home automation, lighting and shade control, energy management and retrofit (wireless) control and security devices, EHX@CES is where professional residential and light commercial installers will gather. <A href="http://www.cesweb.org/showFloor/techzones.asp#3861">See a list of exhibitors in this TechZone.</A>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="4807"></a>

<div class="sub-content-header">College Kids Connect with High Tech</div>
<br />

<IMG hspace=5 align=right src="/images/content/CES-276_HigherEdTech_logo.jpg" width=115 height=115>Connected. That sums up the modern college experience in one word, and it’s quickly changing the face of higher education. Ever on the lookout for newer, better, faster and more innovative technology, whatever the next big trend in consumer electronics is going to be, it’s a virtual lock that college kids will be among the first adopters of consumer technology.
<P>How do you stay atop this rapidly changing, rapidly expanding market? The HigherEd Tech Summit and Exhibit offers the opportunity to survey the latest trends, products, and services for today’s students and for the institutions that serve them.</P>
<P><A href="/showFloor/techzones.asp">See more CES TechZones.</A></P>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="4806"></a>

<div class="sub-content-header">Government Officials Invited to CES</div>
<br />

<STRONG><IMG hspace=5 align=right src="/images/content/CES-239_CES-Government.jpg" width=108 height=54>CES Government 2011<BR>Mandalay Bay Resort <BR></STRONG><EM>Invitation only<BR></EM>Join a select group of senior executives for “Protecting Borders,” a riveting two–day discussion of the most pressing security challenges facing government at all levels. The ambitious agenda examines the defense of physical borders, IT infrastructure and communications networks in the U.S. and abroad. <BR><BR>Interested in this event? <A href="http://cesweb.org/conferenceProgram/conference-tracks.asp#4373">See the entire agenda and get contact information to request admittance.</A><BR>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="4803"></a>

<div class="sub-content-header">Receive Complete Home Theater Certification in One Day</div>
<br />

<IMG hspace=5 align=right src="/images/content/CES-216_THX.jpg" width=108 height=43>THX packs 20 years of THX's experience into a single class. THX experts show you how to turn quality home theater components into an exciting, immersive home theater experience for you clients, at any price point. You'll take home the coveted THX Certified Home Theater Professional 1 logo upon successful completion. <A href="http://cesweb.org/conferenceProgram/search/results.asp?categoryID=2012">Learn more, and sign up now.</A>    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/news/uttm-dec292010.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
