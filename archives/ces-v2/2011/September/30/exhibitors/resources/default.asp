...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        The best way to stay organized while getting ready for a tradeshow is to have every resource at your fingertips. This section was designed with that in mind.<br />
        <br />
        <h3><a  href="/exhibitors/resources/spaceselection.asp">2012 Space Selection</a></h3>
        A variety of documents help you facilitate your space selection experience.<br />
        <br />
        <h3><a  href="/exhibitors/resources/exhibitor-workshop.asp">CES Exhibitor Workshop</a></h3>
        With our free four-part web-cast series we provide you with tools to help you market and promote your brand, receive the ultimate press coverage, as well as turn you into a pro when dealing with booth planning, logistics and our contractor GES.<br />
        <br />
        <h3><a  href="/exhibitors/resources/partnerconnect.asp">Partner Connection</a></h3>
        Here we connect you to our partners who offer exciting ways for you to build your brand and promote your booth leading up and throughout the 2012 International CES. From ad space to lead generation tools, they have it all. <br />
        <br />
        <h3><a  href="/exhibitors/resources/export-assistance.asp">Export Assistance</a></h3>
        CES offers programs for exhibitors interested in expanding their business in international markets.<br />
        <br />
        <h3><a  href="/exhibitors/resources/logos.asp">International CES Logos (Login required.)</a></h3>
        Use the International CES logo on marketing materials to promote your exhibit.<br />
        <br />
        <h3><a  href="/exhibitors/resources/memberProgram.asp">CEA Affinity Program</a></h3>
        CEA Members: Inquire about priority pre-show ordering and special pricing on select GES products and services.<br />
        <br />
         
...
<!--/exhibitors/resources/exporting-exhibitors.asp--><!--/exhibitors/resources/2012hpaspaceselection.asp--><!--/exhibitors/resources/2011spaceSelection.asp--><!--/exhibitors/resources/member-packet.asp--><!--/exhibitors/resources/exhibitorLogin.asp-->
