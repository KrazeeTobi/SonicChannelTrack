...
<head><!-- PageID 4151 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: August 2010 Venetian</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div>August 2010 Venetian</div>
                        </div>
                         <div class="headerbox">
                            <h1>August 2010 Venetian</h1>
                        </div><br />
...
<div class="sub-content-header">Venetian Exhibitors: Exhibitor Manual Available Next Month!</div>
<br />

The Venetian Exhibitor Manuals (one specifically for suite exhibitors and one specifically for meeting room exhibitors) will be available exclusively <A href="/exhibitors/newsletter/exhibitor-manual.asp">online</A> this year. The manual will be available in early September and will contain shipping information, move-in and move-out details, vendor orders forms and much more! In the meantime, if you have any questions, please contact <A href="mailto: gberube@ce.org">Gaiya Berube</A>.<br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
<br />
...
<div class="sub-content-header">Venetian HospitalitySuite Exhibitors: Info for You!</div>
<br />

Since much of the Venetian Tower Exhibitor Manual content does not apply to Venetian Hospitality Suite exhibitors, we’ve created a section on CESweb exclusively for you! Be sure to review this <A href="/exhibitors/showPlanning/venetian-show-planning.asp">information</A> as you make your plans for CES.<BR><BR>Additional information can also be found in section 11 of the <A href="/exhibitors/newsletter/exhibitor-manual.asp">Venetian Tower Exhibitor Manual</A>. Remember, Hospitality Suites are to be used for meetings or for hospitality purposes only. Exhibits may be constructed or installed and GES is not permitted to deliver freight to these suites.<BR><BR>Please contact <A href="mailto: gberube@ce.org">Gaiya Berube</A> with any questions you may have.<BR>
