...
<P><SPAN class=text><STRONG><SPAN class=subhead>国際登録エリア<BR></SPAN>LVCC、セントラルプラザ本登録所<BR>ラスベガス・ヒルトンダンスホール<BR></STRONG>海外参加者向けの特別登録所は、LVCC、セントラルプラザ、ラスベガス・ヒルトンダンスホールに位置しています。これら2箇所のエリアで海外からのビジターは、当日登録やバッジホルダーの受取（ショー会場の入場に必要）を行ったり、複数言語を話す通訳の特別支援を受けて、登録に関する質問をしたりできます。<BR><BR><BR><SPAN class=subhead><STRONG>ICC（国際商業センター）</STRONG><BR></SPAN><STRONG>LVCC、南ホールコネクタ、S224/225号室<BR></STRONG>LVCC 南ホールコネクタ、S224/225号室にあるICCは、海外からの訪問者や展示社がインターネットステーションの利用、会議室の予約および使用、軽食をとったり、リラックスできる場所です。国際ゲートウェイに近く、国際登録所にも隣接した便利な場所にあるため、CES滞在中の「出張オフィス」として利用できます。<BR><BR><STRONG>インターナショナル・レセプション<BR></STRONG>海外からの来場者、出展者、メディア関係者の全員がCESのインターナショナル・レセプションに招待されます。本レセプションは海外から参加されている方のみが入場できます。人々との新たな出会い、同僚とのビジネスについての議論や、ビジネスパートナー関係を新たに結ぶ絶好のチャンスである本レセプションに、是非ともご参加ください。今年は、本レセプションにおいて海外での事業展開を模索している米国企業向けに、米国商務省による仲介プログラムが用意されます。会場にて皆様にお目にかかれることを楽しみにしています!<BR><BR><SPAN class=subhead><STRONG>通訳サービス</STRONG><BR>ICC、LVCC、セントラルプラザおよびラスベガス・ヒルトンの海外登録所で多言語スタッフがお手伝いします。スペイン語、フランス語、中国語、日本語、韓国語を含む複数言語の通訳サービスで皆様を支援します。通訳サービスをご希望の方は、国際登録エリアの「Interpretation Services（通訳サービス）」カウンターまでお申し付けください。<BR></SPAN><SPAN style="FONT-FAMILY: " lang=JA></P>
<P><SPAN class=text><SPAN class=subhead><STRONG>国際バイヤープログラム<BR></STRONG></SPAN>インターナショナルCESは、米国商務省、国際通商局が後援する国際 バイヤープログラム（IBP）に参加しています。米国商務省の国際貿易スペシャリストがメインICC(LVCC南ホールコネクタ、S224/225号室)に待機しており、海外の来場者や出展社に出会いの場や輸出カウンセリングを提供します。<BR></SPAN></SPAN></P></SPAN>
