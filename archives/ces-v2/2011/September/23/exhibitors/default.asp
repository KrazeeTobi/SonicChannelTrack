...
<div class="alert-box">                        
   ...
   <h2>Directory Listing</h2>
    ...
    <p>Filling out your <A href="http://ces12.mapyourshow.com/3_0/search.cfm?">MyCES Directory Listing</A> is your gateway into the online and printed exhibitor listings.</p>
</div><div class="grid-box">
   <h2>Exhibitor's Source</h2>
    
    
    <p>
        <a  href="http://www.cesweb.org/exhibitors/newsletter/aug11.asp">In this month's issue</a>:
        <ul class="text">
            <li class="text">Directory Listing Instructions </li>
            <li class="text">Exhibitor Registration Information </li>
            <li class="text">Exporting Opportunities</li>
        </ul>
    </p>
   ...
   <h2>Deadline Checklist</h2>
    ...
    <A href="http://cesweb.org/exhibitors/resources/exhibitor-workshop.asp"><img src="/docs/EXworkshop_Banner.jpg" width="227" height="200"></A>
</div><div class="grid-box">
   <h2>Resources</h2>
