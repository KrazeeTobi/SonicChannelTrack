...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <table border="0">
            <tbody>
                <tr>
                    <td valign="top"><img width="104" height="103" alt="" style="float: left; margin-left: 5px; margin-right: 5px;"  src="/images/content/Follow-Me-Logo.gif" />
                    ...
                    <p>Create your show schedule on Follow Me and sync it to your MyCES account or vice versa. Similar to MyCES, with Follow Me you can search the exhibitor directory for companies or products you want to see, add them to your show agenda and even share your agenda with your friends. You can also get important show alerts, late-breaking CES news, view real-time interactive floor maps when they’re available and so much more! </p>
                    <p><img alt="" style="float: left; margin-left: 5px; margin-right: 5px;"  src="/images/content/2012CES-QR-FM.gif" />Scan this code with your mobile phone to access the official 2012 CES mobile app now! Or point your mobile browser to <a  href="http://m.core-apps.com/2012CES">http://m.core-apps.com/2012CES<strong>.</strong></a></p>
...
<embed src="http://www.youtube.com/v/J4v7FFzNOR0&hl=en_US&fs=1&" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="425" height="344"></embed></OBJECT></DIV>--></strong></p>
          ...
          $('#screenshots').cycle({ 
                    ...
                    <div id="screenshots">
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  src="http://www.cesweb.org/hp/images/followme/dashboard.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  src="http://www.cesweb.org/hp/images/followme/exhibitorlist.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  src="http://www.cesweb.org/hp/images/followme/exhibitordirectory.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  src="http://www.cesweb.org/hp/images/followme/map1.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  src="http://www.cesweb.org/hp/images/followme/friends.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  src="http://www.cesweb.org/hp/images/followme/friendsdetail.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  src="http://www.cesweb.org/hp/images/followme/hoteltravel.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  src="http://www.cesweb.org/hp/images/followme/news.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  src="http://www.cesweb.org/hp/images/followme/myprofile.png" /></div>
                    <div><img width="180" height="338" alt="" style="border: 0px solid;"  src="http://www.cesweb.org/hp/images/followme/faq.png" /></div>
                    </div>
                    </div>
                    </td>
                </tr>
