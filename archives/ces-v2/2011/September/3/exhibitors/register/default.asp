...
<head><!-- PageID 363 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Register Staff/Buyers</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;Register Staff/Buyers</div>
                        </div>
                         <div class="headerbox">
...
<A href="http://www.cesweb.org/exhibitors/register/login.asp">Exhibitor registration for the 2012 International CES is now open.</A> <STRONG>NOTE: You will need to login with your unique exhibitor customer number, located in the upper right corner of your booth invoice. <BR><BR></STRONG>
<H3><A href="http://www.cesweb.org/exhibitors/register/login.asp">Register Your Booth Staff</A></H3>
<P>Each exhibitor is entitled to five badges per 10x10 space with a minimum of 10 badges. Once you have exceeded your allotment there will be a $10 per badge charge. </P>
<P>You may use our single request form to order badges for 1 to 25 booth personnel. If you require more than 25 personnel badges, we suggest that you use our Excel spreadsheet to request all badges at once. <BR><BR>Please contact CES Customer Service at <A href="mailto:exhreg@CE.org">exhreg@CE.org</A> or 866-233-7968 with questions. </P>
<H3><A href="http://www.cesweb.org/exhibitors/register/login.asp">Register Your Top&nbsp;10 Buyers</A></H3>Each exhibiting company can register their top&nbsp;10 buyers for a FREE Exhibits Plus Pass. <BR><BR>Please allow 10 business days for processing. Exhibitor badges will begin mailing in October 2011 in the order they were received. <BR><BR>For questions about the exhibitor or top 10 buyer registration process, please&nbsp;email <A href="mailto:exhreg@CE.org">exhreg@CE.org</A> or call 866-233-7968. <BR>
...
<!--/exhibitors/register/vipBuyer.asp-->
