...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        Please check back in August for information and links for EACs at CES. Our on-line EAC tool will launch in early August, so please be sure to set up your account, upload your certificate of insurance and register in our system.<br />
        <h3>GES and LVCC Requirements</h3>
        <strong>Las Vegas Convention Center (LVCC) Requirements</strong><br />
        EACs intending to work in the LVCC must have approval from the venue and must have a valid ESCA WIS badge. All requirements must be met before commencing work at the LVCC. The requirements are listed below and can also be found at: <a  target="_blank" ywaOnclickOverride="true" href="http://www.lvcva.com/meetings/meeting-venues/convention-centers/info/lvcc-requirements.jsp">http://www.lvcva.com/meetings/meeting-venues/convention-centers/info/lvcc-requirements.jsp</a>. The Las Vegas Convention and Visitors Authority requires a $250 annual fee from all Independent Service Contractors providing service at the LVCC, a Clark County Businss License, a Nevada State Industrial Insurance Sysem Account must be established, and a valid Certificate of Insurance must be provided.<br />
        <br />
