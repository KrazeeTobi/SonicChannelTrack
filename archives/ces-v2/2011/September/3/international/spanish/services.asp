...
<H3>Área de Inscripción Internacional</H3><EM>Centro de Convenciones de las Vegas (LVCC), Central Plaza – Inscripción Principal<BR>Las Vegas Hilton – Ballroom (Salón de baile)<BR><BR></EM>En el área principal de inscripción de la Central Plaza del LVCC y en el Salón de Baile de Las Vegas Hilton encontrará un área especial de inscripción para los concurrentes extranjeros. En esas dos áreas, los visitantes internacionales pueden inscribirse, obtener un porta gafete (que se requiere para ingresar en la exposición) u obtener ayuda lingüística especializada de intérpretes multilingües, quienes están disponibles para responder preguntas durante la inscripción. <BR><BR>
<H3>Centro de Comercio Internacional (ICC, por sus siglas en inglés)</H3><EM>LVCC, Conector South Hall, Salas S224/225</EM><BR><BR>El ICC está ubicado en el Conector South Hall del LVCC, Salas S224/225 y es el lugar en el que los concurrentes extranjeros y los expositores pueden mantenerse en contacto con sus oficinas a través de estaciones de Internet, reservar y utilizar salones para reuniones privadas, disfrutar de refrigerios o simplemente relajarse. Por estar ubicado convenientemente en las cercanías del International Gateway y cerca del área de Inscripción internacional, el ICC puede ser su “oficina remota” mientras participa en la exposición CES.<BR><BR>
<H3>Recepción Internacional</H3>Todos los participantes internacionales, los expositores y la prensa están invitados a la Recepción de la Exposición Internacional CES. Esta recepción es para visitantes internacionales únicamente. No se pierda esta oportunidad de conocer a personas nuevas, debatir sobre negocios con colegas o generar nuevos socios comerciales. Durante la recepción de este año, el Departamento de Comercio de EE.UU. patrocinará un programa de búsqueda de oportunidades para empresas estadounidenses que desean comerciar con empresas en el extranjero. ¡Esperamos verlo allí!<BR><BR>
