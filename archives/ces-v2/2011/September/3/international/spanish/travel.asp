...
<P>Encuentre aquí información útil para entrar y salir de los EE. UU. <BR></P>
<H2>Información sobre visas</H2>
<P><STRONG>¿Necesita una visa? <BR></STRONG><A href="https://ceac.state.gov/genniv/ " target=_blank>Ahora puede completar el formulario de solicitud de visado en línea.</A></P>
<P><STRONG>¿Necesita ayuda?</STRONG> <BR><A href="/docs/Spanish_2K12VisaTips.pdf" target=_blank>Descargue nuestra Hoja de consejos para obtener una visa</A>, que consta de instrucciones detalladas, direcciones de sitios web y otra información para ayudarlo a completar satisfactoriamente su proceso de solicitud de visado. <BR><BR>A partir del 20 de enero [de 2010], a las personas que viajan a Estados Unidos de países en el programa de exención de visa <A href="http://travel.state.gov/visa/temp/without/without_1990.html#countries" target=_blank>Visa Waiver Program</A> las aerolíneas podrían denegarles el abordaje si no han cumplido con los requisitos del programa de Sistema Electrónico para Autorización de Viajes (Electronic System for Travel Authorization o ESTA) del Departamento de Seguridad Nacional de EE.UU. Ahora, las personas extranjeras que viajan a Estados Unidos deben dirigirse al <A href="https://esta.cbp.dhs.gov/" target=_blank>sitio Web de ESTA</A> y llenar una solicitud antes de ingresar a EE.UU. por aire o por mar. De ser aprobada, la autorización tendrá dos años de vigencia y puede ser renovada. Los pasajeros ya no tienen que llenar el formulario I-94W antes de cada viaje.<BR><BR>
...
<TR>
<TD>
<H3>Aviso importante para los participantes que viajan bajo el Programa de Exención de Visado</H3>Todas las solicitudes o renovaciones de inscripción en el Sistema Electrónico de Autorización de Viaje (ESTA, por sus siglas en inglés) requieren del pago de una cuota de US$14 por tarjeta de crédito o débito. Las inscripciones en el programa ESTA ya procesadas seguirán vigentes hasta su fecha de caducidad. Para obtener información adicional, sírvase <A href="http://cbp.gov/xp/cgov/travel/id_visa/esta/" target=_blank>visitar la página del programa ESTA en el sitio Web del Departamento de Seguridad Nacional, Servicio de Aduanas y Protección Fronteriza</A>.</A></TD></TR></TBODY></TABLE></P>
<H2>Viajes</H2>
<P><STRONG>¿Necesita saber cómo llegar a CES?<BR></STRONG><A href="/hotelTravel/default.asp">Visite la sección de viaje de CESweb.org (en inglés)</A>&nbsp;para encontrar la mejor tarifa de boleto aéreo y de alquiler de vehículos, así como información sobre el transporte local.</P>
<P><STRONG>¿Necesita saber dónde alojarse?<BR></STRONG><A href="/hotelTravel/hotel.asp">Visite la sección hotel de CESweb.org (en inglés)</A> para realizar reservas grupales e individuales. </P>
<P>&nbsp;</P>
