...
<head><!-- PageID 4948 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/events/default.asp" class="footer">Events</a>&nbsp;&gt;&nbsp;SINOCES</div>
                        </div>
                         <div class="headerbox">
                            <h1>SINOCES</h1>
                        </div><br />
...
<P><STRONG><IMG style="MARGIN: 5px; FLOAT: right" alt="" src="/images/content/SINOCES.gif">July 7-10, 2011<BR>Qingdao, China<BR><BR></STRONG>According to CEA/GfK data, the Chinese market will account for 15 percent&nbsp;of global consumer electronics retail revenue in 2011 with revenue expected to reach $144 billion. SINOCES serves as a launch pad for both Chinese and U.S. companies looking to introduce their new products into the booming Chinese marketplace. The annual event is also a forum for communication between Chinese companies and their international partners. <BR><BR>Interested in exhibiting? <A href="mailto:kstake%40CE.org?Subject=Exhibiting%20at%20SINOCES">Contact a business development representative.</A><BR>Interested in attending? <A href="http://www.sinoces.com/en/registration_all.aspx" target=_blank>Register online now.</A><BR><BR><BR>
<TABLE border=0 cellSpacing=1 cellPadding=1 width="100%">
<TBODY>
<TR>
<TD style="WIDTH: 32%"><IMG src="/images/photos/196_sinoces_(2).jpg"></TD>
<TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
<TD style="WIDTH: 32%"><IMG src="/images/photos/196_sinoces_(3).jpg"></TD>
<TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
<TD style="WIDTH: 32%"><IMG src="/images/photos/196_sinoces_(4).jpg"></TD></TR>
<TR>
<TD vAlign=top><SPAN class=smallText></SPAN></TD>
<TD>&nbsp;</TD>
<TD vAlign=top><SPAN class=smallText></SPAN></TD>
<TD>&nbsp;</TD>
<TD vAlign=top><SPAN class=smallText><BR></SPAN></TD></TR></TBODY></TABLE>SINOCES is a collaboration between the Consumer Electronics Association (CEA)®, producer of the International CES® and the Qingdao Municipal People’s Government. <BR><BR>More than 80,000 visitors and 500 exhibitors from China and around the globe participated in the 2010 SINOCES. <BR><BR>If your company is in China or looking to expand to China, SINOCES is the must attend event for 2011. Booth space is limited and is selling fast.&nbsp;<A href="mailto:kstake%40CE.org">Please contact a business development representative</A> to learn how your company can participate in China’s premier consumer electronics show for industry professionals.</P>
<H3>Product Categories:</H3>
<UL class=text><L class=texti />
<LI class=text>Automobile Electronics </LI>
<LI class=text>Mobile Communication Equipment </LI>
<LI class=text>Digital Content </LI>
<LI class=text>Mobile Storage Devices </LI>
<LI class=text>Digital Entertainment Products </LI>
<LI class=text>Portable Office Equipment </LI>
<LI class=text>Home Appliances </LI>
<LI class=text>Security and Protection Products </LI>
<LI class=text>Home A/V Products </LI>
<LI class=text>Software Applications and Solutions </LI>
<LI class=text>Home Network </LI></UL>
<H3>SINOCES Conferences and Forums </H3>
<P>In addition to featuring world-class exhibitors, SINOCES will feature more than 20 conference sessions and other events focused on different facets of the CE industry.&nbsp;<A href="http://www.SINOCES.com" target=_blank>Visit www.SINOCES.com</A> for complete details on all 2011 conference program offerings and to register for the show. </P>
