...
<head><!-- PageID 2041 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: An Eco-Friendly Electronics Show</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;An Eco-Friendly Electronics Show</div>
                        </div>
                         <div class="headerbox">
        ...
        <h2>The World’s Coolest Tradeshow is Also the Greenest</h2>
        The world’s coolest tradeshow is also the greenest. Trade Show Executive Magazine named the 2010 International CES North America’s Greenest Show. The magazine also honored CEA with the highly coveted “Leader in Green Initiatives” Gold Grand Award for outstanding green presence in producing the world’s largest consumer technology tradeshow. <br />
        <br />
        With the help of our partners, including Global Experience Specialists, Aramark, the Las Vegas Convention Center (LVCC) and The Venetian/Palazzo, CES attendees can conduct a year's worth of business while knowing that are doing so in an environmentally friendly location.
        <h3>Green Exhibits and Conferences at CES<img alt="" style="float: right;"  src="/images/content/Sustainable.jpg" /></h3>
        The <a  href="http://www.cesweb.org/showFloor/techzones.asp#3864">Sustainable Planet TechZone</a> showcases the latest in eco-friendly products and energy efficiency technologies. It highlights the latest products that make it possible for every person on this planet to stay connected and informed, and live sustainable lifestyles through advances in green building, alternative energy technologies, green business services and solutions, smart grid technologies, solar and renewable products, sustainable packaging and wireless convergence.
        <h3>Get Charged Up About Electric Vehicles</h3>
        <p><img width="130" height="28" alt="" style="float: left; margin-left: 5px; margin-right: 5px;"  width="130" height="28" src="/images/content/Electric_Vehicle_100px.jpg" />The <a  href="http://www.cesweb.org/showFloor/techzones.asp#3835">Electric Vehicle TechZone</a> showcases the full range of high- and low-speed electric vehicles, energy storage devices and charging solutions. This TechZone highlights an area of great potential and growth for the industry as electric vehicles are quickly gaining in popularity among consumers seeking to live more sustainably by using alternative transportation. Major automotive exhibitors like Audi, Ford, GM OnStar and Toyota will be at CES to share their latest automotive electronics innovations. </p>
        <h3>Attendees: A Smaller Footprint with Bigger Opportunities</h3>
        ...
        <ul class="text">
            <li class="text">By having so many meetings at CES, our attendees collectively avoid more than 960 million miles in business trips that they otherwise would have to take if not for the International CES. As a result of attending CES and consolidating trips, the estimated net savings in travel miles is more than 549 million miles. </li>
            <li class="text">Each of our attendees has an average of 12 meetings while at CES. </li>
            <li class="text">Representatives travel from more than 130 different countries, offering a truly global opportunity.</li>
        </ul>
        <h3>How Green is the International CES?</h3>
        The "greening" of International CES has lead to the following:
        <ul class="text">
            <li class="text">Last year, 68 percent, or 372.2 tons, of the total solid waste generated by show attendees was recycled </li>
            <li class="text">Recycling bins, recyclable carpeting and other environment-friendly materials on-site have helped further green the show </li>
            ...
            <li class="text">Since 2008, expanding use of recyclable aisle carpet at the LVCC, now used in all exhibit halls, TechZones and Registration. </li>
            <li class="text">All CES TechZone pods, hardwall and turnkey booth packages will include recyclable carpet and recyclable backwall and counter panels. </li>
            <li class="text">Printed all attendee flyers and CES literature on recycled paper using soy ink </li>
            <li class="text">CEA donated $50,000 to the Las Vegas Metro Police Department to purchase seven Vetrix electric motorcycles which are on the streets of the tourist corridor every day helping to keeping Las Vegas both safe and green. </li>
            <li class="text">This year, CEA donated $75,000 to Green Chips, a non-profit organization promoting carbon neutrality, to support sustainable energy in southern Nevada. <a  target="_blank" href="http://ce.org/Press/CurrentNews/press_release_detail.asp?id=12045">Read more.</a></li>
        </ul>
        <h4>Print Production at the International CES</h4>
        The <a  target="_blank" href="http://www.ce.org/">Consumer Electronics Association</a> has cut its print production for CES by nearly 50 percent in the last five years. Materials have gone virtual, including:
        <ul class="text">
            ...
            <li class="text">All press kits, including those provided by exhibitors in the Official CES Press Room</li>
        </ul>
        <p>Additionally, the CES PreShow Planner has seen a reduction of more than 28,000 copies, a 32 percent decrease in total print run, and the CES Conference directory was reduced to an insert in the Show Guide at 55,000 copies. CEA is proud to be using environmentally friendly soy-based ink on the 2010 International CES printed publications. All remaining hard copy materials meet the standards of the Sustainable Forest Initiative and Forest Stewardship Council and are printed on recycled paper. </p>
        <h4>CES works with Aramark catering service, which: </h4>
        <ul class="text">
            <li class="text">Uses bulk condiments instead of individual packages </li>
            <li class="text">Proudly offers attendee food containers and utensils made of biodegradable hemp, corn byproduct or other organic materials </li>
            <li class="text">Donates surplus food products to local food banks </li>
            <li class="text">Uses new energy efficient dishwasher that saves 798,034 gallons of water per year </li>
            <li class="text">Participates in LVCC recycling efforts including use of newly installed cardboard baler </li>
            <li class="text">Recycles frying oil to be converted to bio-diesel </li>
            <li class="text">Uses green cleaning products </li>
        </ul>
        <h4>CES chooses exhibit venues like the Las Vegas Convention Center, which: </h4>
        <ul class="text">
            <li class="text">Diverts recyclable materials from landfills such as cardboard, paper, metal, wood, carpet padding and plastic, currently averaging a 70 percent recycle rate for all of its shows </li>
            <li class="text">Replaced paper towels, toilet paper, and other paper products with recycled materials </li>
            <li class="text">Uses environmentally-friendly products have replaced over 302,000 gallons of chemicals </li>
            <li class="text">90 percent of the convention center’s fleet is powered by propane or battery </li>
            ...
            <li class="text">Uses a power monitoring system to track electrical power usage and identify areas for improved efficiency </li>
            <li class="text">Uses water conservation devices installed in urinals, toilets and faucets </li>
            <li class="text">Optimizes electronic communication to decrease dependence on paper communication methods</li>
        </ul>
        <h4>CES utilizes conference venues like the Venetian/Palazzo, which: </h4>
        <ul class="text">
            <li class="text">Through conservation efforts, has reduced annual water consumption by more than 97 million gallons; that much water can supply the annual water needs for more than 580 average American households </li>
            <li class="text">Recycles over 55 percent of their solid waste stream, including glass,plastics, aluminum, cardboard and paper, and more than 75 percent of waste from renovation projects is recycled or reused </li>
            <li class="text">Diverts more than 75 percent of food waste to local farms for animal feed or to compost </li>
            <li class="text">Received silver-certification for the Palazzo by the U.S. Green Building Council's Leadership in Energy and Environmental Design (LEED) </li>
            <li class="text">Uses one of the largest solar-thermal systems on the roof to provide hot water for swimming pools, spas, and a portion of domestic hot water </li>
            <li class="text">During the construction of The Palazzo, some 70 percent of waste materials were recycled, diverting nearly 42,000 tons from landfill; the equivalent to a stack of cars approximately 23 miles high </li>
            <li class="text">Through conservation efforts, water consumption has fallen by more than 97 million gallons of water annually; that much water can supply the annual water needs for more than 580 average American households</li>
        </ul>
        <h4>CES works with general service contractor Global Experience Specialists, which: </h4>
        <ul class="text">
            <li class="text">Offers a Sustainable Exhibits booth package, which includes eco-friendly paneling, carpeting, graphics printed with water-soluble ink, and LED lighting (coming soon) </li>
            <li class="text">Offers a selection of eco-friendly carpets that contain 25 percent post industrial recycled content and that are 100 percent recyclable Offers 100 percent recyclable carpet padding as well as biodegradable trash bags, waste baskets and tabletop covers made from 100 percent recycled content </li>
            <li class="text">Uses energy efficient lighting </li>
            <li class="text">Purchases recycled paper and signage products and recycles paper and printer ink cartridges </li>
            <li class="text">Recycles steel and aluminum exhibit structures </li>
            <li class="text">Retreads tires on our trucks </li>
            <li class="text">Runs 95 percent of all equipment on clean, natural gas </li>
            <li class="text">Produces CES exhibitor manual exclusively in online format</li>
        </ul>
        <h3>CEA Members Among Newsweek's Greenest Corporations </h3>
        CEA applauds its member companies recognized by Newsweek as among the nation's greenest corporations.  Dell, HP, IBM and Intel (ranked 1, 2, 3 and 5, respectively) took four of the top five spots on the list, which ranked America's 500 largest corporations according to environmental impact, green policies and reputation. Ten of the top 13 companies were technology corporations.<br />
        Also, CEA member companies including Samsung and Sharp Electronics won ENERGY STAR awards for excellence this year. For a complete list of the winners, please go to: <a  href="http://www.energystar.gov/index.cfm?c=pt_awards.pt_es_awards_2010">http://www.energystar.gov/index.cfm?c=pt_awards.pt_es_awards_2010</a>.
        <h3>CEA Highlights CE Companies’ Sustainability Efforts </h3>
        The CEA 2010 Sustainability Report highlights the industry’s efforts toward environmental accountability. The report benchmarks the industry's progress toward eco-stewardship, from design and energy efficiency to green manufacturing and clean delivery systems. The update also adds a new section showcasing social contributions made by CE companies and the innovative technologies they create. Visit <a  href="http://www.ce.org/green">www.CE.org/green</a> for more information.
