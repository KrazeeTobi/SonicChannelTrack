...
<IMG style="MARGIN-LEFT: 5px" hspace=5 align=right src="/images/photos/PR1.jpg" width=200 height=134>Stay tuned for updates on the cutting-edge programming and conference tracks that will be featured in the 2012 CES Conference Program.&nbsp;<BR><BR>While you're waiting, you may want to: 
<UL class=text>
<LI class=text>Watch the program build gradually by <A href="/conferenceProgram/sessions.htm">checking out the session schedule.</A> </LI>
<LI class=text><A href="/register">Register for the 2012 CES</A>, Jan. 10-13 (Tuesday-Friday).</LI></UL>
<br/>
