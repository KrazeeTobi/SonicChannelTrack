...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        Eighty-five percent of all CES exhibitors cite press/media coverage as one of the most important reasons for attending the show. It's easy to see why PR is oftentimes the highest priority for exhibitors at the International CES. The more than 5,000 media and bloggers who cover CES each year are able to get a company's name into the minds of millions of consumers with the simple stroke of a keyboard. Let us help you reach the media.
        <h3><a  href="/news/exhibitorPRnl-Aug11.asp">Exhibitor PR Newsletter</a></h3>
        ...
        <table style="border: #9f9f9f 1px solid;" border="0" cellpadding="8" width="100%">
            <tbody>
                <tr>
                    ...
                    <a  href="https://ces11.exh.mapyourshow.com">Update your PR contact information</a> so journalists and broadcasters can find you. You must do this through your company's <a  href="https://ces11.exh.mapyourshow.com">MyCES Exhibitor Portal</a>. (Note: Exhibitor login credentials were e-mailed to the main exhibitor representative we have on file. If you're not sure who this contact is, <a  href="mailto:afried@CE.org">e-mail Allison Fried</a>.)</td>
                </tr>
            </tbody>
        </table>
