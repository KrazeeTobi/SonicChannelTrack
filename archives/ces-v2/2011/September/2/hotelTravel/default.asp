...
<div class="alert-box">                        
    <P>Plan on taking a big crew to CES? <A href="/hotelTravel/hotel.asp">Reserve a block of hotel rooms now.</A></P>
</div><div class="grid-box">
    <h2>Hotel Reservations</h2>
    
    
    <p><IMG style="MARGIN-LEFT: 2px" border=0 hspace=2 align=right src="/images/content/Hotel_02.jpg" width=60 height=75>The only thing more important than registering for CES is<A href="/hotelTravel/hotel.asp">booking hotel and flight accommodations for CES</A>. Hotel rooms sell out months in advance, so reserve yours right away.</p>
</div><div class="grid-box">
    ...
    <A href="http://cesweb.org/register"><img src="/docs/Register_OrangeAd.jpg" width="227" height="200"></A>
</div><div class="grid-box">
