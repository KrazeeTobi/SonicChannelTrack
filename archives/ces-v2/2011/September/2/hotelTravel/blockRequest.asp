...
<head><!-- PageID 3098 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: 2012 CES Block Request Form</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/hotelTravel/blockRequest.asp">2012 CES Block Request Form</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/hotelTravel/default.asp" class="footer">Hotel/Travel</a>&nbsp;&gt;&nbsp;<a href="/hotelTravel/hotel.asp" class="footer">Hotel Reservations</a>&nbsp;&gt;&nbsp;2012 CES Block Request Form</div>
                        </div>
                         <div class="headerbox">
                            <h1>2012 CES Block Request Form</h1>
                        </div><br />
...
// javascript for e-mail this page tool - gets the url of the page the user is on before the e-mail page tool button is clicked
	...
	<script language="JavaScript" src="/hotelTravel/blockRequest/include/js/calendar2_2012.js"></script>
	<script>
...
function validForm(passedForm)
	{
		...
		alert("Your requested dates must be between 12/26/11 and 1/16/12.")
		passedForm.input7.focus
		return false
		}
...
<strong>Request a group block <font style=color:#CC0000>FOR THE 2012 INTERNATIONAL CES</font> with a simple three-step process.</strong>
<ol>
...
<form name="block_request" method="post" action="/hotelTravel/blockRequest/rd_12blockConfirmation.asp" onSubmit="return validForm(this);" >
...
<tr>
	<td colspan="2"><font style="color:red"><b>* </b></font>Please select an official 2012 International CES hotel. (Availability subject to change. Last updated August 2011.)
For a list of 2012 hotel rates, <a href="http://www.cesweb.org/hotelTravel/hotel.asp">please visit the main CES hotel page.</a> 
...
<tr>
	<td width="50%" valign="top" class="text">
		...
		<input type="radio" name="hotel" value="BestWestern">Best Western Mardi Gras<br>
		...
		<input type="radio" name="hotel" value="HGVCHilton">Hilton Grand Vacations Club Las Vegas<br>
		<input type="radio" name="hotel" value="HGVCStrip">Hilton Grand Vacations Club on the LV Strip<br>
	...
	<td width="50%" valign="top" class="text">
		...
		<input type="radio" name="hotel" value="MonteCarlo">Monte Carlo<br>
		...
		<!--<input type="radio" name="hotel" value="Renaissance"> (10 room min.)<br />-->
		...
		<input type="radio" name="hotel" value="THE">THEhotel at Mandalay Bay<br>
		<input type="radio" name="hotel" value="Treasure">Treasure Island <br>
		<input type="radio" name="hotel" value="Tropicana">Tropicana Las Vegas<br>
		...
		<!--<input type="radio" name="hotel" value="Wynn">Wynn Las Vegas<br>-->
...
<tr>
	<td colspan=2>Please indicate the first and last nights of your block and the maximum number of rooms needed on your night of highest occupancy. <font style=color:#CC0000><strong>Show days are January 10-13, 2012.</strong></font><br>
	</td>
</tr>
