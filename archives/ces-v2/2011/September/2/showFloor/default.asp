...
<div class="alert-box">                        
    <P>Keynote addresses will be in a new location this year. <A href="/showFloor/by-hall.asp">See more changes to the show floor.</A></P>
</div>

<div class="alert-box">                        
    <P>PMA@CES is new to the <A href="/showFloor/techzones.asp">CES TechZone lineup</A> this year.</P>
</div><div class="grid-box">
    <h2>By Exhibit Hall</h2>
    
    
    <p>CES uses two large venues and covers more space than 35 (American) football fields. <A href="/showFloor/by-hall.asp">Get nice, easy-to-scan lists of show floor destinations</A> based on different areas of the Las Vegas Convention Center/Las Vegas Hilton and The Venetian.</p>
</div><div class="grid-box">
    ...
    <A href="/hotelTravel/hotel.asp"><img src="/docs/226_Hotel_02.jpg" width="227" height="200"></A>
</div><div class="grid-box">
