...
<head><!-- PageID 1226 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/chinese.asp">汉语</a>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;汉语</div>
                        </div>
                         <div class="headerbox">
                            <h1>汉语</h1>
                        </div><br />
...
<P></P>
<H3>产业精英在此聚集</H3>每一年，可以在同一地点看得到最先进的创新。在2012年1月10日到1月13日，请与我们一起参加在美国内华达州的拉斯维加斯举行的世界最大的消费者技术贸易展。<A href="/register">现在就登记，准备届时让有创意的人、思考者、领导人、梦想家、创新改革者，以及由他们创建，能够改变人类生活的产品围绕您。</A>
...
<div class="sub-content-header">国际参加者信息</div>
<br />


        <p><a  href="http://cesweb.org/international/chinese/travel.asp">旅行和签证信息</a><br />
        当您出入境美国时，可使用此有用的信息。<br />
        <br />
        <a  href="/international/chinese/hotels.asp">酒店预订<br />
        </a>为了协助您的旅行计划，CES经协商在几家优选的拉斯维加斯大饭店以折扣价格取得了房间。<br />
        <br />
        <a  href="/international/chinese/delegations.asp">代表团团体方案<br />
        </a>国际消费电子产品展 CES 因为有其成功的代表团方案，吸引了大量的国际观众。了解如何在您的所在国或地区组建或参加代表团。</p>
        <p><a  href="/international/chinese/services.asp">国际服务<br />
        </a>国际参加者会得到许多特殊礼遇，其中包括提供口译服务、专门为您安排的与同行沟通交流招待会、指定的工作区及会议室等。<br />
        <br />
        <a  target="_blank" href="/docs/HI_RES_SCH_2K12_CESfactSheet_Web.pdf">一般信息<br />
        </a>了解关于展会的历史、目前产品目录、未来展会日期等信息 —全部被译成您的语言！ <br />
        <br />
        <a  href="/international/chinese/shuttles.asp">班车服务<br />
        </a>国际CES在为期四天的国际CES展览会期间提供免费穿梭班车服务。</p>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        <P>您知道具有 15 名或以上的国际参加者的代表团可免费登记参加 Exhibits Plus ？<BR><A href="/international/chinese/delegations.asp">欲知详情</A>。 <BR></P>
        <br /><br />
    </div>
</div>
<div class="right-blue-box" align="center">
