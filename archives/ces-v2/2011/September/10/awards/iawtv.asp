...
<IMG style="MARGIN-LEFT: 3px" hspace=3 align=right src="/images/content/IAWTV_260.jpg" width=260 height=57>The International Academy of Web Television (IAWTV) is holding its inaugural IAWTV Awards at the 2012 International CES. The IAWTV Awards is the first award show within the Web television industry to be presented by content creators, for content creators.&nbsp; From studio content producers to YouTube celebrities, those successfully creating entertainment for digital platforms will be celebrated via 33 categories honoring web series and online talent, in front of the camera and behind the scenes.<BR><BR>Stay tuned for more information on how to attend the IAWTV Awards. In the meantime, don't forget to <A href="/register">register for the 2012 CES early to save.</A>
