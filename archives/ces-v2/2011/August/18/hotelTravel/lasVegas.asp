...
<LI class=text><STRONG>Change person:</STRONG> Don't forget to slip a few bucks to these helpful folks — especially if you win. Don't try to palm off a $5 tip for a Megabucks win; it's insulting. </LI></UL>These are just suggestions — and you're always welcome to tip more! <BR><BR><B>CES quick tip: </B>Taking the <A href="http://2012.cesweb.org/hotelTravel/shuttle.asp">CES shuttle</A> requires zero dollars. That includes no tipping! <BR>
    ...
    <BR>Looking for a deal on a Vegas show? Want that all-you-can-eat buffet at half the price? Keep checking back. As we hear of the best deals in the city during CES show days, we'll put them right here for you. 2012 International CES deals will be added in fall 2011. <BR><BR>Go to the CES transportation page to learn about <A href="/hotelTravel/cars.asp">car rental discounts.</A><BR><BR>&nbsp;<BR>
