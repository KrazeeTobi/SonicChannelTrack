...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
            ...
            <div id="page-bottom">
                <div id="main-content">
                    ...
                    <div id="main-content-header">
                        <img src="/images/content/Subhead_ForExhibitors.jpg">
                    </div>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;For Exhibitors</div>
                        </div>
...
<div class="alert-box">                        
    <P>Audit confirms record attendance&nbsp;at&nbsp;2011 CES!&nbsp;<A href="http://www.cesweb.org/exhibitors/newsletter/jun11.asp">This story and more in this month's Exhibitor's Source newsletter.<BR></A></P>
</div><div class="grid-box">
    <h2>Exhibit at CES</h2>
    
    
    <p>
        <a  href="/exhibitors/space/default.asp">Exhibit at CES to:</a>
        <ul class="text">
            <li class="text">Reach 5,000 media and analysts </li>
            <li class="text">Network among 140,000+ CE professionals </li>
            <li class="text">Tailor space to meet your needs</li>
        </ul>
    </p>
</div><div class="grid-box">
    ...
    <p>Filling out your <A href="http://ces11.mapyourshow.com/3_0/search.cfm?">MyCES Directory Listing</A> is your gateway into the online and printed exhibitor listings.</p>
</div><div class="grid-box">
    <h2>Exhibitor's Source</h2>
    
    
    <p><A href="http://www.cesweb.org/exhibitors/newsletter/july11.asp">In this month's issue</A>: 
<UL class=text>
<LI class=text>Boost Sales with CES Unveiled </LI>
<LI class=text>Be an Innovations Judge </LI>
<LI class=text>Operations Update</LI></UL></p>
</div><div class="sideimage">

    
    
    <a href="http://bcove.me/am65hy6d" target=_blank><img src="/images/content/ces-buzz-2012.jpg"></a></div><div class="grid-box">
    <h2>Promotional Opps</h2>
    
    
    <p><A href="/exhibitors/sponsorships/default.asp"><IMG style="MARGIN-LEFT: 2px" border=0 hspace=2 align=right src="/images/content/Promo_Ops_02.jpg" width=60 height=75>Check out options</A> for advertising, sponsorships and&nbsp;on-site marketing to help generate traffic to your booth and boost your brand.</p>
</div><div class="grid-box">
    <h2>Show Planning/Manual</h2>
    
    
    <p><A href="/exhibitors/showPlanning/default.asp">Go here for details, reminders, policies and procedures</A> for your CES exhibiting experience.</p>
</div><div class="grid-box">
    <h2>Deadline Checklist</h2>
    
    
    <p>Never miss a date with this <A href="/exhibitors/deadlines.asp">detailed set of reminders</A>. We'll even add them to your Outlook calendar.</p>
</div><div class="grid-box">
    <h2>CE Vision Magazine</h2>
    
    
    <p><IMG style="MARGIN-LEFT: 5px" hspace=5 align=left src="/images/content/Vision-May-June.jpg" width=75 height=87>CE Vision tracks the digital technology trends, policy and business news that matter to you.<BR><BR><A href="http://www.ce.org/vision">Read this issue.</A> <BR><A href="http://www.ce.org/vision">Advertise in this publication.</A></p>
</div><div class="grid-box">
    <h2>Resources</h2>
    
    
    <p><A href="/exhibitors/resources/default.asp"><IMG style="MARGIN-LEFT: 2px" border=0 hspace=2 align=right src="/images/content/CES_mini.gif" width=65 height=50>This is the spot </A>to find forms, downloadable logos, export assistance information and details on the CEA Member Affinity Program.</p>
</div><div class="grid-box">
    <h2>Register Staff/Buyers</h2>
    
    
    <p>Need to register your booth staff and top 10 buyers? <A href="/exhibitors/register/default.asp">Here's the place to go.</A></p>
</div><div class="advertisement">
    
    
       
    <A href="mailto:rickalbuck@napco.com;ccampbell@napco.com;alevine@photoreporter.com;moswald@napco.com;mragland@napco.com;bschneyer@napco.com?subject=Advertising Message Regarding the 2012 CES Planner, Guide, and/or Directory"><img src="/docs/CESFullHouse_226x200.gif" width="227" height="200"></A>
</div><div class="advertisement">
    
    
       
    <A href="http://cesweb.org/exhibitors/sponsorships/printAdvertising.asp#4131"><img src="/docs/TWICE-226x200.jpg" width="227" height="200"></A>
</div>
                            <script type="text/javascript">
