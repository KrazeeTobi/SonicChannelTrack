...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <br />
        </span></strong>Here we connect you to our partners who offer exciting ways for you to build your brand and promote your booth before and during the big show in January. From ad space to lead generation tools, they have it all. Our partners are here to help you get the most out of your exhibiting experience.  
...
<br />
        ...
        <img alt="" style="float: right;"  src="/images/content/2012Directory_Cover.jpg" />The 2012 CES is going to be a FULL HOUSE! Go all in before the big show begins with CEA's Official Preshow Planner, Show Guide and Conference Brochure, and Show Directory and win big with increased booth traffic and company visibility. The Preshow Planner is the only preshow publication created solely to help CES attendees plan for their trip (Ad Close: 11.4.11). The Show Guide is the on-site navigational tool for CES (Ad Close: 11.28.11). The Show Directory is the one piece that contains detailed information regarding CES exhibitors (Ad Close: Nov. 23, 2011). <br />
        <br />
