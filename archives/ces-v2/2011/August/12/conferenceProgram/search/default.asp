...
<head><!-- PageID 4331 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Search for Sessions</title>
...
<BR><div><label for='categoryID' title='Category'><strong>Program Track</strong>: </label><img width="10" height="2" src="/images/framework/spacer.gif"/><select id='categoryID' name='categoryID' tabindex='10'><option value='' selected='selected'>--- ALL ---</option><optgroup label='Program Track'><option value='2073'>Broadband Unlimited</option><option value='2112'>Business Insights</option><option value='2076'>Cable Conference at CES</option><option value='2077'>CEA Research Summit at International CES</option><option value='2078'>CES Government 2012</option><option value='2081'>CONNECTIONS Summit</option><option value='2084'>Content in the Cloud</option><option value='2086'>Digital Health Summit </option><option value='2087'>Digital Hollywood</option><option value='2093'>Emerging Technology</option><option value='2098'>Flash Forward: Flash Memory Storage Solutions for Mobile Devices and Data Hungry Applications</option><option value='2101'>HigherEd Tech Summit</option><option value='2104'>Home Entertainment and Lifestyle Technologies</option><option value='2106'>IEEE: International Conference on Consumer Electronics (ICCE) </option><option value='2107'>In-Vehicle Technology</option><option value='2113'>Just the Facts: Research, Reports and Revelations</option><option value='2114'>Keynotes</option><option value='2115'>Kids@Play and MommyTech</option><option value='2129'>Silvers Summit</option><option value='2132'>Smartphones and Tablets</option><option value='2134'>Sports and Fitness Tech</option><option value='2135'>Storage Visions™ 2012</option><option value='2136'>SuperSessions</option><option value='2138'>Tech Policy Summit</option><option value='2139'>Technology and The Environment</option><option value='2141'>The Tweet House Presents: Social Media Success Stories</option><option value='2142'>THX Education Program: Home Theater and THX - Home Theater 1</option><option value='2149'>Wireless Communications</option></optgroup></select></div><BR><div><label for='locationID' title='Location'><strong>Location</strong>: </label><img width="46" height="2" src="/images/framework/spacer.gif"/><select id='locationID' name='locationID' tabindex='20'><option value='' selected='selected'>--- ALL ---</option><option value='1046'>LVCC, North Hall</option><option value='1047'>LVCC, South Hall</option><option value='1095'>Venetian</option></select></div><BR><div><label for='startsOnDate' title='Date'><strong>Date</strong>: </label><img width="69" height="2" src="/images/framework/spacer.gif"/><select id='startsOnDate' name='startsOnDate' tabindex='25'><option value='' selected='selected'>--- ALL ---</option><BR><BR><option value='2012-01-08'>1/8/2012</option><option value='2012-01-09'>1/9/2012</option><option value='2012-01-10'>1/10/2012</option><option value='2012-01-11'>1/11/2012</option><option value='2012-01-12'>1/12/2012</option><option value='2012-01-13'>1/13/2012</option></select></div><BR>
	<div>
