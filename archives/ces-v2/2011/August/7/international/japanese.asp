...
<P><A href="http://cesweb.org/international/japanese/travel.asp">旅行とビザ情報</A><BR>米国の出入国の際に役立つ情報です。<BR><BR><A href="/international/japanese/delegations.asp">代表団プログラム</A><BR>ご好評をいただいている代表団プログラムにより、国際CESでは国外からも多数の参加者が集まります。あなたの国や地域で代表団を組織する方法、代表団に参加する方法についてはこちらをご覧ください。</P>
<P><A href="/international/japanese/services.asp">国際サービス</A><BR>外国からの参加者の方へは、通訳者、特別なネットワーク作りのためのレセプション、専用の作業エリア、会議室など、その他多数のサービスをご用意しています。<BR><BR><A href="/docs/HI_RES_JPN_2K12_CESfactSheet_Web.pdf" target=_blank>一般情報<BR></A>展示会の沿革、現在の製品カテゴリ、今後の予定など、各国語で紹介します！ </P>
<P>&nbsp;</P>
                            <script type="text/javascript">
