...
Are you interested in bringing a group from your country to the International CES? As a delegation leader, you&nbsp;will help your clients maximize the value of their trip to the International CES by helping them plan what to see and who to meet at the show, while arranging the logistics of travel. CEA has a formal delegation program in place that provides benefits for both delegation leaders and members.<BR><BR>Free show registration is among the list of&nbsp; benefits for delegation program participants. If you join a delegation and <A href="/register">register for CES</A> after August 30, the $100 registration fee will be waived.<BR><BR>Please note: Registering as a delegation leader does not register you for the show. You must <A href="/register">complete the formal International CES registration process</A> to register and receive your credentials. <BR><BR><!-- Start of Brightcove Player -->
<DIV style="DISPLAY: none"></DIV><!-- By use of this code snippet, I agree to the Brightcove Publisher T and C  found at https://accounts.brightcove.com/en/terms-and-conditions/.  -->
<SCRIPT type=text/javascript src="http://admin.brightcove.com/js/BrightcoveExperiences.js"></SCRIPT>

<OBJECT id=myExperience1017354896001 class=BrightcoveExperience><PARAM NAME="bgcolor" VALUE="#FFFFFF"><PARAM NAME="width" VALUE="460"><PARAM NAME="height" VALUE="390"><PARAM NAME="playerID" VALUE="26356940001"><PARAM NAME="playerKey" VALUE="AQ~~,AAAABh3C_dE~,zBkXqCU8KVYYG5utII4f8nND4rqBAlFX"><PARAM NAME="isVid" VALUE="true"><PARAM NAME="dynamicStreaming" VALUE="true"><PARAM NAME="@videoPlayer" VALUE="1017354896001"></OBJECT><!--  This script tag will cause the Brightcove Players defined above it to be created as soon as the line is read by the browser. If you wish to have the player instantiated only after the rest of the HTML is processed and the page load is complete, remove the line. -->
...
<LI class=text>Delegations must have a minimum of 15 members. Groups smaller than fifteen must register individually as attendees.</LI></UL>
...
<LI class=text>Invitation to CES Delegation Leader Dinner.</LI></UL>
...
<LI class=text>Access to International Trade Specialists from the U.S. Department of Commerce who provide matchmaking assistance and export trade counseling to international attendees and exhibitors.</LI></UL>
<H3>U.S. Department of Commerce International Buyer Program</H3><IMG style="MARGIN-LEFT: 8px" hspace=8 align=right src="/images/content/doc_logo(1).JPG" width=155 height=158>The International CES is a proud participant of the U.S. Department of Commerce’s International Buyer Program (IBP). Through the U.S. Commercial Service’s network of offices in U.S. Embassies and Consulates worldwide, the IBP recruits pre-screened foreign buyer delegations and brings them to selected tradeshows in the United States, connecting U.S. companies with international buyers. &nbsp; Commercial service trade specialists located in your local embassy or consulate can assist you with show registration, help you locate the products you are looking to purchase at the show and assist in setting up meetings with you and U.S. businesses. The International CES proudly participates in the International Buyer Program (IBP), sponsored by the Commercial Service of the U.S. Department of Commerce. As part of the IBP, many foreign commercial specialists lead delegations to CES. <A href="http://www.export.gov/eac/index.asp" target=_blank>Locate the Commercial Service office in your country.<BR></A>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <UL>
<LI><A href="/docs/2012_General_Overview_Brochure.pdf" target=_blank>General Overview English Language Brochure (pdf) </A></LI>
<LI><A href="/docs/2012_CES_Fact_Sheet_FINAL_5.9.2011.pdf" target=_blank>CES Fact Sheet (pdf) </A></LI>
<LI><A href="/docs/2012_Program_Description_FNL.pdf" target=_blank>Benefits for Delegation Leaders and Delegates (pdf in English)</A></LI>
<LI><A href="http://content.ce.org/2k12CESI/2k12CES_DEL_02.mov.zip " target=_blank>Informational CES video to show potential delegates (.mov)</A></LI></UL>
    </div>
</div>
                        </div>
