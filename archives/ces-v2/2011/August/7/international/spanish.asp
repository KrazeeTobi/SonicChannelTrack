...
<P><A href="http://cesweb.org/international/spanish/travel.asp">Información sobre traslado y visas</A><BR>Use esta útil información a medida que viaje hacia o de regreso de Estados Unidos.<BR><BR><A href="http://www.cesweb.org/international/spanish/delegations.asp">Programa de grupos de delegaciones<BR></A>La Exposición Internacional CES atrae a una enorme audiencia internacional por su programa de delegaciones exitoso. Aprenda cómo organizar una delegación en su país o región o cómo sumarse a una.</P>
...
<P><A href="/docs/HI_RES_SP_2K12_CESfactSheet_Web.pdf" target=_blank>Información general (pdf)</A><BR>¡Aprenda sobre la historia de la exposición, las categorías actuales de productos, las próximas fechas y mucho más en su idioma! </P>
                            <script type="text/javascript">
