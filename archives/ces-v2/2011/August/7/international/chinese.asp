...
<P><A href="http://cesweb.org/international/chinese/travel.asp">旅行和签证信息</A><BR>当您出入境美国时，可使用此有用的信息。<BR><BR><A href="/international/chinese/delegations.asp">代表团团体方案<BR></A>国际消费电子产品展 CES 因为有其成功的代表团方案，吸引了大量的国际观众。了解如何在您的所在国或地区组建或参加代表团。</P>
<P><A href="/international/chinese/services.asp">国际服务<BR></A>国际参加者会得到许多特殊礼遇，其中包括提供口译服务、专门为您安排的与同行沟通交流招待会、指定的工作区及会议室等。<BR><BR><A href="/docs/HI_RES_SCH_2K12_CESfactSheet_Web.pdf" target=_blank>一般信息<BR></A>了解关于展会的历史、目前产品目录、未来展会日期等信息 —全部被译成您的语言！ </P>
                            <script type="text/javascript">
