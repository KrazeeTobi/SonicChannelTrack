...
<P><A href="http://cesweb.org/international/korean/travel.asp">여행 및 비자 정보</A><BR>미국을 방문하는 데 도움이 되는 이 정보를 사용하십시오.<BR><BR><BR><A href="/international/korean/delegations.asp">대표단 프로그램</A><BR>International CES는 성공적인 대표단 프로그램을 갖추고 수많은 해외 방문객들을 불러들이고 있습니다. 여러분 국가나 지역의 대표단을 만들거나 대표단에 참여하는 방법을 알아보십시오.</P>
<P><A href="/international/korean/services.asp">해외 방문객 서비스<BR></A>통역사, 특별 네트워크 리셉션, 효율적인 업무 공간, 회의실 등 해외 방문객을 위한 다양한 서비스가 제공됩니다.<BR><BR><NOBR><A href="/docs/HI_RES_KO_2K12_CESfactSheet_Web.pdf" target=_blank>一般信息<BR></A></NOBR>了解关于展会的历史、目前产品目录、未来展会日期等信息 —全部被译成您的语言！ </P>
                            <script type="text/javascript">
