...
<head><!-- PageID 5246 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Call for Judges</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/awards/default.asp" class="footer">Awards</a>&nbsp;&gt;&nbsp;<a href="/awards/innovations/default.asp" class="footer">CES Innovations Awards</a>&nbsp;&gt;&nbsp;Call for Judges</div>
                        </div>
                         <div class="headerbox">
...
<b></b><H3>We are now accepting Innovations judge applications. Submit one below!</H3>
<P>If you're a member of the press, an independent designer or an engineer, we want you! <A href="http://2012.cesweb.org/awards/innovations/test"></A><A href="http://2012.cesweb.org/awards/innovations/test"></A></P>
<UL class=text>
...
<LI class=text>Do you consider yourself a knowledgeable consumer electronics design professional, with expertise in any of the 32&nbsp;<A href="http://cesweb.org/awards/innovations/categories.asp">Innovations 2012 Award Categories?</A> </LI>
<LI class=text>Do you have at least five years of experience in the CE industry through the media or as an industry analyst or professional? </LI></UL>
<P><BR>The Innovations Design and Engineering Awards program recognizes the most innovative consumer electronics products&nbsp;the 32&nbsp;categories and has become a hallmark for the best-designed products in consumer technology. Download the <A href="http://cesweb.org/images/photos/8691_Category_Guide.pdf" target=_blank>awards category guide </A>that includes examples of eligible products within a category to assist you in selecting the categories you feel most qualified to judge.</P><BR>
<DIV class=sub-content-header>Innovations Design and Engineering Judging Process</DIV><BR>
<P>Each awards category is judged by a three-member panel consisting of an independent industrial designer, independent engineer or industry analyst and a member of the trade press. The judging process is conducted online and will begin September 26, 2011, and end on October 7, 2011. We have determined that it takes approximately 10-15 minutes to evaluate an entry. Depending on how many entries are in a category, judging may take anywhere from 3-15 hours to complete.<BR><IMG src="http://cms.ce.org/images/framework/spacer.gif" width=1 height=20></P>
<DIV class=sub-content-header>Innovations Judges' Benefits</DIV><BR>
<UL class=text>
<LI class=text>Be the first to see the newest products in the CE industry </LI>
<LI class=text>Volunteer and network with other preeminent industry professionals </LI>
<LI class=text>Invitation to the CES&nbsp;Unveiled@ NY at the Pre-CES New York Press Preview where the Innovations honorees are announced </LI>
<LI class=text>Invitation to the CES Unveiled, The Official Press Event of the International CES </LI>
<LI class=text>Recognition throughout the year on CESweb.org/Innovations </LI>
<LI class=text>Special ribbon to wear on-site at CES to designate your status as an Innovations Judge <BR></LI></UL><BR>
<H3>Submit an application below. Start by entering your e-mail address and a password. </H3>
<P>Questions? Contact us at <A href="mailto:Innovations@ce.org">Innovations@ce.org</A></P>
<iframe src='https://www.wizehive.com/appform/login/ceacjudges' scrolling='no' style="overflow-x: hidden;" frameBorder='0' height='2450' width='600'></iframe>
                            <script type="text/javascript">
