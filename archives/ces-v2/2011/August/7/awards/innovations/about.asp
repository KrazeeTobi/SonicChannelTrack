...
<LI class=text>How the design and innovation of this product directly compare to other products in the market place</LI></UL>
    ...
    <STRONG>Is there information about Innovations Design and Engineering Awards program available in other languages?<BR></STRONG>Yes. You can get general information about the program in these languages: 
<UL class=text>
