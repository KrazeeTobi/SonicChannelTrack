...
<head><!-- PageID 4291 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2011 CES: Entertainment Matters Entertainment Matters</title>

   
  
<link type="text/css" rel="stylesheet" href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/base/jquery-ui.css" />

<link type="text/css" rel="stylesheet" href="http://www.cesweb.org/css/styles.css" />
<link type="text/css" rel="stylesheet" href="http://www.cesweb.org/css/HPtemplate_css.css" />
<link type="text/css" rel="stylesheet" href="http://www.cesweb.org/css/pyxl_home.css" />
<link type="text/css" rel="stylesheet" href="http://www.cesweb.org/css/sub_page.css" />


<!--[if IE 6]>
<link href="http://www.cesweb.org/css/ie6only_css-int.css" rel="stylesheet" type="text/css" />
<![endif]-->
<script type="text/javascript" src="http://www.cesweb.org/utilities/mainNav.js"></script>
<script type="text/javascript" src="http://www.cesweb.org/utilities/rollOver.js"></script>

<link rel="stylesheet" href="http://www.cesweb.org/EM/css/jquery.tabs.css" type="text/css" media="print, projection, screen">
<link type="text/css" rel="stylesheet" href="http://www.cesweb.org/EM/css/em_styles.css" />
<link rel="stylesheet" type="text/css" href="http://www.cesweb.org/EM/fancybox/jquery.fancybox-1.3.1.css" media="screen" />
<!--[if IE 6]>
    <link rel="stylesheet" type="text/css" href="css/IE6.css" />
<![endif]-->
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4/jquery.min.js"></script>
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/jquery-ui.min.js"></script>
<script type="text/javascript" src="http://www.cesweb.org/EM/fancybox/jquery.fancybox-1.3.1.js"></script>
<script type="text/javascript" src="http://www.cesweb.org/EM/js/jquery.easing.1.2.js"></script>
<script type="text/javascript" src="http://www.cesweb.org/EM/js/jquery.anythingslider.js"></script>
<script src="http://www.cesweb.org/utilities/jquery.countdown.js" type="text/javascript"></script> 
...
<script type="text/javascript">
    ...
    $(function () {
        $('.em_anythingSlider').anythingSlider(0);
        jumpClosed();
    });
    
    function jumpClosed(){    
        $('.em_anythingSlider').anythingSlider({          
...
<!-- <script src="http://www.cesweb.org/EM/js/jquery-1.1.3.1.pack.js" type="text/javascript"></script> -->
<script src="http://www.cesweb.org/EM/js/jquery.history_remote.pack.js" type="text/javascript"></script>
<script src="http://www.cesweb.org/EM/js/jquery.tabs.pack.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function() {
        
        //$('#container-4').tabs({ fxFade: true, fxSpeed: 'fast' }); 
        //$('.tab_content').tabs({ fxFade: true, fxSpeed: 'fast' });
        $('#container-4').tabs({ fxFade: true, fxSpeed: 'fast' });                
    });
</script>
<style>
    .em_anythingSlider .wrapper  {
      overflow:hidden;
    }
</style>    
...
<body class="home" id="home" onload="$('#jump').trigger('click');">
    ...
    <div id="ctacontainer">
        ...
        <div id="register"><a href="/register" title="Register"><img src="/images/framework/cesweb_register1.png" alt="Register" name="cesweb_register" onMouseOver="over(8)" onMouseOut="out(8)" /></a></div>
...
<div id="em_header">
                <a href="http://www.EMatCES.com" title="ENTERTAINMENT MATTERS">
                <img src="http://www.cesweb.org/EM/images/em_masthead.png" alt="ENTERTAINMENT MATTERS" width="940" height="112" />
                </a>
            </div><!-- END: MASTHEAD -->
                
                <!-- BEGIN: LEFT SIDEBAR -->
                <div class="left">
                    <img src="http://www.cesweb.org/EM/images/logo_variety.png" alt="SPONSORS" width="240" height="100" />
                    
                    <!-- BEGIN: REGISTER NOW BUTTON -->
                    <div id="home_registerNow">
                        <a href="/EM/EM-register.asp" title="Register">
                        </a>
                    </div><!-- END: REGISTER NOW BUTTON -->
                    
                    <!-- BEGIN: LEFT SIDEBAR CTA-->
                    <div id="sidebar_CTA">
                        <img src="http://www.cesweb.org/EM/images/sidebar_title.png" alt="" width="184" height="68" />
                        <p><strong>Check back in October<br />
                        for details on:</strong></p><br />
                        <ul id="sidebar_list">
                            <li>Red Carpet Program</li>
                            <li>Hollywood Assistants Program</li>
                            <li>Conference Sessions</li>
                            <li>Special Events</li>
                            <li>And more</li>
                        </ul>
                    </div> <!-- END: LEFT SIDEBAR CTA -->
                    
                    <!-- BEGIN: LEFT SIDEBAR SOCIAL -->
                    <div id="sidebar_social">
                        <a href=http://www.cesweb.org/facebook title="facebook" target="_blank">
                        <img src="http://www.cesweb.org/EM/images/social_facebook.png" alt="facebook" width="40" height="29" />
                        </a>
                        <a href=http://www.cesweb.org/twitter title="twitter" target="_blank">
                        <img src="http://www.cesweb.org/EM/images/social_twitter.png" alt="twitter" width="36" height="29" />
                        </a>
                        <a href="http://www.cesweb.org/linkedin" title="Linked In" target="_blank">
                        <img src="http://www.cesweb.org/EM/images/social_linkedin.png" alt="Linked In" width="36" height="29" />
                        </a>
                        <a href=http://www.cesweb.org/flickr title="flickr" target="_blank">
                        <img src="http://www.cesweb.org/EM/images/social_flickr.png" alt="flickr" width="37" height="29" />
                        </a>
                        <a href=http://www.cesweb.org/youtube title="YouTube" target="_blank">
                        <img src="http://www.cesweb.org/EM/images/social_youtube.png" alt="You Tube" width="33" height="29" style="float:left;clear:none;" />
                        </a>
                    </div><!-- END: LEFT SIDEBAR SOCIAL -->
                    
                    <!-- BEGIN: DROPDOWN NAV -->
                    <!-- <ul id="menu">
                        <li>
                            <a class="exhibits" href="#"></a>
                            <ul>
                                <li><a href="#">Exhibit at CES</a></li>                                
                                <li><a href="#">Directory Listing</a></li>                                
                                <li><a href="#">Promotional Opportunities</a></li> 
                                <li><a href="#">Show Planning</a></li>                                
                                <li><a href="#">Deadline Checklist</a></li>                                
                                <li><a href="#">Resources</a></li>                                
                                <li><a href="#">PR Help</a></li>                                
                                <li><a href="#">Exhibitor's Source Newsletter</a></li>
                            </ul>
                        </li>
                        <li>
                        <a class="press" href="#"></a>
                        </li>
                        <li>
                            <a class="international" href="#"></a>
                            <ul>
                                <li><a href="#">Travel &amp; Visas</a></li>                                
                                <li><a href="#">Delegation Group Program</a></li>
                ...
                <div class="right">
                    ...
                    <div id="em_slideshow" >
                        ...
                        <div class="em_anythingSlider">
                            <div class="wrapper">
                                <ul>
                                    <li>
                                        <img src="http://www.cesweb.org/EM/images/slideshow_01.jpg">
                                    </li>
                                    <li>
                                       <img src="http://www.cesweb.org/EM/images/slideshow_02.jpg">
                                    </li>
                                    <li>
                                      <img src="http://www.cesweb.org/EM/images/slideshow_03.jpg">
                                    </li>
                                    <li>
                                        <img src="http://www.cesweb.org/EM/images/slideshow_04.jpg">
                                    </li>
                                    <li>
                                       <img src="http://www.cesweb.org/EM/images/slideshow_05.jpg">
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div id="tab_container">
                       <div id="container-4">
                           <ul class="tabs">
                               <li>
                                   <a href="#fragment-10">
                                   <img src="http://www.cesweb.org/EM/images/tab_why.png" alt="" width="309" height="28" />
                                   </a>
                               </li>
                           ...
                           <div id="fragment-10">
                                <p>
                                    Entertainment Matters is the new International CES<span id="registration">&reg;</span> program developed for the Hollywood entertainment and content communities. It's your connection to lucrative partnerships and groundbreaking innovations at the world's most influential technology event.
                                    
                                    <ul class="em_logo">
                                        <li>Get the first look at new devices, technologies and platforms that will broadcast your work.</li>
                                        <li>Meet manufacturers, entrepreneurs and emerging creative talent.</li>
                                        <li>Participate in conference programs that reveal key industry trends:<br />
                                        Digital Hollywood&nbsp;&nbsp;|&nbsp;&nbsp;Media Money Makers&nbsp;&nbsp;|&nbsp;&nbsp;CES Cable Conference<br />
                                        Smartphone &amp; Tablets&nbsp;&nbsp;|&nbsp;&nbsp;Content in the Cloud&nbsp;&nbsp;|&nbsp;&nbsp;And more</li>
                                    </ul>
                                </p>
                           </div>
                           <!-- <div id="fragment-11">
                                <p>
                                    Phasellus ipsum tortor, dignissim nec dignissim ac, fermentum non turpis. Maecenas feugiat lectus eu est rhoncus dapibus tempus mi elementum. Phasellus sed nulla non tellus laoreet congue. Proin ac erat mauris. Nulla velit metus, mollis vel ullamcorper sit amet, pretium ac ligula. Sed ac mi sit amet diam imperdiet dapibus sit amet eu nisl. Nullam tortor libero, ornare et aliquet et, accumsan et sem. Morbi eu metus libero, sed vehicula lacus. Maecenas vel molestie purus. Aenean et diam vitae metus imperdiet porta ac eu lacus. Pellentesque libero tortor, pulvinar eu lobortis vel, molestie ut dolor. Cras eget condimentum justo. Proin rhoncus lorem ac felis sodales luctus. Etiam nec ante ac lorem eleifend tincidunt at et mauris. Quisque imperdiet interdum nisl, at eleifend nunc hendrerit vel. Suspendisse vel ligula mi. Duis vel purus nec lectus malesuada vulputate. Curabitur faucibus interdum risus et venenatis. Sed id magna neque, at accumsan quam.
                                </p>
                           </div> -->
                           <div id="tab_below">
                           <a href="/EM/EM-register.asp" title="Register">
