...
<ul id="sub-hotel" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('hotel','show')" class="top"><a href="/hotelTravel/default.asp" class="sublink"><!-- <img src="/images/framework/secondarynav_hotel.gif" /> --></a></li>
                    ...
                    <li onmouseover="showDropDown('hotel','show')" class="first_link"><a href="/hotelTravel/airlines.asp">Airline Discounts</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li ><a href="/events/D27CAB76E49641B1950E77DF6CA09A6F.htm">SINOCES</a></li>
...
<h4>Want to know where consumer technology is headed in 2011? Watch the archived 2011 CES keynote addresses.</h4>
...
<P><A href="http://bcove.me/j6p24hhb" target=_blank>Watch the video.</A></P>
    ...
    <div>
        ...
        <ul>
            <li>Vegas hotels offer discounts for CES attendees</li>
