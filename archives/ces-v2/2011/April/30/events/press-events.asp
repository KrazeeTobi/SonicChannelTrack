...
<head><!-- PageID 3926 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Press Events</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/events/press-events.asp">Press Events</a>
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/events/default.asp" class="footer">Events</a>&nbsp;&gt;&nbsp;Press Events</div>
                        </div>
                        <div class="headerbox">
                       <h1>Press Events</h1>
                            <div class="icon_wrap">
...
Before and during the International CES, a variety of events are held specifically for members of the press. See below for the kinds of events you can expect at the 2011 International CES, January 6-9, and check back later this year for specific time, date and location information.<BR><BR>Plus, look at the <A >other events the Consumer Electronics Association holds throughout the year</A>. 
...
<STRONG>3-4 p.m. Tuesday, January 4, 2011<BR>Bellini 2105, The Venetian<BR><BR></STRONG>Worldwide revenue for consumer electronics (CE) is expected to reach $681 billion mark in 2010, despite a downed world economy. Countries with fast-growing economies and large emerging middle classes, such as the BRIC countries (Brazil, Russia, India and China), will lead the way in new CE revenue growth. This session provide a comprehensive look at global CE market trends.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<STRONG><IMG hspace=8 vspace=6 align=right src="/images/content/CES_Unveiled_event.gif" width=250 height=49>4-7 p.m. Tuesday, January 4, 2011<BR>The Venetian Ballroom, The Venetian</STRONG><BR><BR>Get to CES early to uncover the top tech newsmakers. Be the first to see the New Year's products at CES Unveiled. Media, analysts and bloggers can get a pre-show look at who will be making news headlines at CES Unveiled. Catch all the latest products in one room. Plus, get a sneak peek at International CES product debuts and the Innovations Design and Engineering Showcase honorees — before the show officially opens.<BR>
<P><IMG src="/images/photos/unveiled2.jpg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <IMG src="/images/photos/unveiled1.jpg"></P>&nbsp; <BR><STRONG>2011 Exhibitors Include:</STRONG> 
<P>
<TABLE border=0 cellSpacing=1 cellPadding=1 width="75%">
<TBODY>
<TR>
<TD>
<P>3M<BR>Accenture<BR>Advanced Micro Devices<BR>AERIAL7<BR>Black &amp; Decker Paper Shredders<BR>Blue Microphones<BR>Bodymedia<BR>Cavium Networks<BR>CEA Tech Enthusiast Membership<BR>Celestron<BR>Cinemin (WowWee)<BR>Cobra<BR>Cricket<BR>D-Link<BR>Dexim<BR>Dolby Labs<BR>DriveNTalk<BR>Eton Corporation<BR>Etymotic Research Inc.<BR>foneGEAR<BR>HDMI Licensing<BR>House of Marley<BR>HP<BR>iGo<BR>iHome<BR>Interactive Toy Concepts<BR>Joby<BR>LaCie<BR>Lenovo<BR>Lexmark<BR>Liquid Image<BR></P></TD>
<TD vAlign=top>
<P>Mavizon Technologies<BR>Mitsubishi<BR>mophie<BR>Motion Computing<BR>OnStar<BR>Open Mobile Video Coalition<BR>OrbitSound<BR>Oregon Scientific<BR>Oxygen Audio North America<BR>Parrot<BR>Pomdevices<BR>PURE<BR>Quantenna Communications<BR>RCA<BR>Samsung Electronics America<BR>Samsung Semiconductor<BR>SanDisk<BR>Seagate Technology<BR>Seeker Technologies<BR>SENSIO<BR>SI Products<BR>Sonomax Technologies<BR>Spot, LLC<BR>Technocel<BR>Teleca<BR>Thermador<BR>Toyota<BR>Trane Residential<BR>Tremont Electric<BR>USB Implementers Forum<BR>Withings</P></TD></TR></TBODY></TABLE></P>
<P><STRONG>Thank You to Our Sponsors:</STRONG></P>
<P>HDMI Licensing, LLC<BR>Dexim<BR>iGo</P>
<P>Dexim will also be giving out 800 <A href="http://budurl.com/DeximPFlip">P-Flip™ Foldable Power Docks</A>, so be sure to get there early!<BR></P>
<P><STRONG>Special Appearances:</STRONG></P>
<P><A href="http://www.intotomorrow.com/">Into Tomorrow</A> with Dave Graveline<BR>Live music by <A href="http://www.groovem.com/">Bob Schwartz Quartet</A></P>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<STRONG>Wednesday, January 5,&nbsp;2011<BR></STRONG><BR><IMG align=right src="/images/content/CES_Press_Day_140.gif" width=140 height=75>Press Day is a MUST attend for CES media as major corporate, product and news announcements will be made. Press Day&nbsp;wraps up&nbsp;just in time for the preshow CES keynote address.<BR><BR><A href="/docs/2011PressDayMap.pdf" target=_blank>Download the 2011 CES Press Day Map.</A>    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/events/press-events.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
