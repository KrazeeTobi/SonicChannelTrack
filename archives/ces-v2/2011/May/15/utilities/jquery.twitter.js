	...
	*/
	...
	$.fn.getTwitter = function(options) {
		...
		$.getScript("http://twitter.com/statuses/user_timeline/"+o.userName+".json?callback=twitterCallback2&count="+o.numTweets, function() {
			...
			$("ul#twitter_update_list li span").prepend("<a href='http://twitter.com/intlces'><img src='hp/js/twitter/ces_logo.jpg' width=45 height=30 alt='' style='float:left; padding-right:8px;' /></a>");
		});
	};
