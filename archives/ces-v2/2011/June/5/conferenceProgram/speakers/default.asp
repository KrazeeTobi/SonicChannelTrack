...
<head><!-- PageID 317 - published by Open Text Web Solutions 10.1 - 10.1.1.268 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/conferenceProgram/default.asp" class="footer">Conference Program</a>&nbsp;&gt;&nbsp;Call for Speakers</div>
                        </div>
                        <div class="headerbox">
...
The Call for Speakers for the 2012 International CES is now open and remains open until 5 p.m. EDT Wednesday, July 6. All submissions must be processed online using the <A href="http://speaker.ce.org/index.cfm?do=cnt.page&pg=1003">Speaker Ready Room</A> management tool.<BR><BR>The Call for Speakers process encompasses only those sessions produced by CES. Topics for the 2012 International CES conference program include: 
<P></P>
...
<LI class=text>The Evolving User Interface: What’s Next? <BR></LI></UL>
<P class=text><STRONG>In-Vehicle Technology</STRONG></P>
<UL class=text>
<LI class=text>Cars Online<STRONG>&nbsp;</STRONG></LI></UL>
<P class=text><STRONG>Business Insights</STRONG></P>
<UL class=text>
<LI class=text>Electronics Retailing in the 21st Century </STRONG></STRONG></LI>
<LI class=text>The Consumerization of IT: How Consumer Innovation Is Influencing Business <BR></LI></UL>
...
<P class=text><A href="http://speaker.ce.org/index.cfm?do=cnt.page&pg=1003" target=_blank>Learn more, and submit your information now.</A></P>
