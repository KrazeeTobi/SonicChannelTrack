...
<IMG align=right src="/images/content/CES_203_2k12_Innovations_Award.jpg" width=135 height=192>Check out the new categories for 2012, Software &amp; Mobile Apps and Tablets, E-Readers, &amp; Netbooks!
<P>Looking for specific product examples? <A href="/docs/2K11Innovations_Guide6.30.pdf" target=_blank>Download the 2011 Awards Category Guide.</A><BR><BR><STRONG>Audio Components <BR></STRONG>Products designed to deliver, control, store and/or manage audio content including records, tapes, disc-based audio, MP3 and hard drive storage. </P>
...
<P><STRONG>Gaming Hardware &amp; Accessories<BR></STRONG>Products (hardware) designed to allow one or more users to interact with electronic games.<BR><STRONG>&nbsp;<BR>Headphones&nbsp;<BR></STRONG>Devices that allow users to listen to audio content, such as music, radio, video, TV, gaming, and/or telephone conversations. The devices may incorporate microphones for user voice response or input, and do not have to be designed for use with any specific type of device. </P>
