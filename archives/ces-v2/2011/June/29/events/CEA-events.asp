...
CEA sponsors a variety of events - for the entire industry and individual niches within it - to educate the masses and unite manufacturers, retailers and market movers. From SNOCES to the CEA Industry Forum and Fall Conference, CEA works year 'round to grow and shape the future of consumer electronics. <A href="http://ce.org/Events/default.asp">Check out upcoming CEA events such as:<BR></A><BR><IMG border=0 align=right src="/images/content/cea-events.jpg" width=353 height=370> 
<H3>CEA Economic Retreat</H3>March 1-4, 2011, Snowmass Village, CO<BR><BR><BR>
<H3>CES on the Hill/Digital Patriots Dinner</H3>May 10-11, 2011, Washington, DC<BR><BR><BR>
<H3>CEA Line Shows</H3>June 2011, New York, NY <BR><BR><BR>
