...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/awards/mobile-apps-showdown.asp">Mobile Apps Showdown</a></li>
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/awards/default.asp" class="footer">Awards</a>&nbsp;&gt;&nbsp;Mobile Apps Showdown</div>
                        </div>
                        <div class="headerbox">
...
<SPAN style="COLOR: black"><IMG border=0 align=right src="/docs/MobileAppsShowdown_200.gif" width=200 height=125>CES attendees were ready for&nbsp;a showdown, and they got one this past January. Mobile application makers were pitted against&nbsp;each in two-minute demos against others&nbsp;during the Mobile Apps Showdown at the 2011 CES. An applause-o-meter measured audience enthusiasm to determine the winners. <BR><BR><A href="http://www.mobileappsshowdown.com" target=_blank>And the winners are...</A></SPAN>

    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/awards/mobile-apps-showdown.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
