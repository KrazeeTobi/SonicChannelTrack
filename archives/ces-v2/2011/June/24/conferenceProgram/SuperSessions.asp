...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/conferenceProgram/default.asp" class="footer">Conference Program</a>&nbsp;&gt;&nbsp;SuperSessions</div>
                        </div>
                        <div class="headerbox">
                            <h1>SuperSessions</h1>
                            <div class="icon_wrap">
...
The conference program at CES is all about delivering maximum value, and the always-free SuperSessions prove it. See the 2011 lineup here, and check back in September for 2012 announcements. <BR><BR>Plus, if high-impact, high-value sessions are your thing, plan to attend any or all of the <A href="/events/keynotes.asp">CES keynote addresses</A>.
...
<div class="sub-content-header"><a href="/conferenceProgram/search/sessionDetails.asp?sessionid=4143">Hollywood Creative Masters: A Media Money Makers SuperSession, Produced by Variety</a></div>

<img src="/images/framework/spacer.gif" border="0" width="12"><strong>10-11 a.m. Thursday, January 6, LVCC, North Hall, N255-257</strong><br>

<br><IMG hspace=5 align=right src="/images/content/Variety_sm.gif" width=120 height=33>Top content creators will discuss how digital media has impacted their work, including new opportunities open to them through social networking, transmedia, and mobile platforms. Although today's consumer is splintered across platforms, these creators are managing to build powerful fan bases for their TV shows and movies.<BR><BR><STRONG>Moderator:</STRONG> Chris Morris, Reporter, <EM>Variety<BR></EM><BR><STRONG>Panelists: <BR></STRONG>Gale Anne Hurd, Executive Producer of The Walking Dead and Producer of The Incredible Hulk<BR>Tim Kring, Master Storyteller, Executive Producer of Heroes and Tim Kring's Conspiracy For Good<BR>Tom McGrath, Director of Megamind<BR>Jeff Ross, Executive Producer of Conan<BR>Conrad Green, executive producer of Dancing with the Stars
        <img width="1" height="15" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sub-content-header"><a href="/conferenceProgram/search/sessionDetails.asp?sessionid=4144">Got Game? The State of the Games Industry: View from the Top</a></div>

<img src="/images/framework/spacer.gif" border="0" width="12"><strong>Noon–1 p.m. Thursday, January 6, LVCC, North Hall, N255-257</strong><br>

<br>The worldwide video game industry is poised to reach $70.1 billion by 2015 according to DFC Intelligence, through the combined growth of console, portable, PC, and online video games. Industry leaders discuss the current state of the industry as the business continues its transition towards a digital future. What exciting trends and developments are leading the way?<BR><BR>Moderator: Mike Vorhaus, President, Magid Advisors<BR><BR>Panelists: <BR>Eric Anderson, VP Content and Product Solutions, Samsung Electronics America<BR>Gene Hoffman, CEO, Vindicia<BR>Chris Petrovic, General Manager, Digital Media, GameStop <BR>Timo Soininen, CEO, Habbo Hotel/Sulake<BR>Bill Young, Managing Director, EA Ready, Electronic Arts
        <img width="1" height="15" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sub-content-header"><a href="/conferenceProgram/search/sessionDetails.asp?sessionid=4125">CNET's Next Big Thing: After the Computer</a></div>

<img src="/images/framework/spacer.gif" border="0" width="12"><strong>3-4 p.m. Thursday, January 6, LVCC, North Hall, N255-257</strong><br>

<br><IMG hspace=5 align=right src="/images/content/cnet.gif" width=103 height=59>After a 25 year reign, the era of the personal computer is ending. Tablets, Smartphones and connected home entertainment are the future — and we'll take you there in this dynamic session. For 8 years, CNET has revealed the Next Big Thing to a standing room only crowd at CES. This year, join Brian Cooley, Molly Wood and other industry luminaries to discuss the most dramatic industry transition yet.<BR><BR>Moderators: <BR>Brian Cooley, Editor at Large, CNET<BR>Molly Wood, Executive Editor CNET<BR><BR>Panelists:
Drew Bamford, Director of User Experience, HTC
Nick DiCarlo, VP, Product Planning, Samsung Telecommunications America
Evan Hansen, Editor-in-chief, Wired.com
Robert Kyncl, VP of TV and Film, YouTube
Zander Lurie, Senior Vice President of Strategic Development , CBS
Lindsay Notwell, Executive Director, 4G LTE Strategy &amp; Planning, Verizon
David Pogue, Technology Columnist, New York Times
Joshua Topolsky, Editor-In-Chief, Engadget
Anthony Wood, CEO and Founder, Roku
        <img width="1" height="15" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sub-content-header"><a href="/conferenceProgram/search/sessionDetails.asp?sessionid=3978">Big Thinkers and Disruptive Technologies – Today's Thought Leaders, Tomorrow's Technologies</a></div>

<img src="/images/framework/spacer.gif" border="0" width="12"><strong>10-11 a.m. Friday, January 7, LVCC, North Hall, N255-257</strong><br>

<br>Disruptive technologies often drive the industry. Back by popular demand, this SuperSession brings together big thinkers from CE, computers, media and telecommunications to discuss upcoming innovations and their impact on our digital lives. CES is a powerful venue for launching innovative products and technologies and an acknowledged forum for thought leadership. See it comes to life in this thought-provoking session. <BR><BR>Moderator: Tim Bajarin, President, Creative Strategies Inc.<BR><BR>Panelists:<BR>Mel Coker, Director of Mobile Strategy, AT&amp;T<BR>Ted Theocheung, Vice President of PC &amp; Digital Home Division, Synaptics<BR>Dr. Levy Gerzberg, CEO,&nbsp; Zoran<BR>Joshua Greer, President and Co-Founder, Real D<BR>Mike Rayfield, General Manager, Mobile Business Unit, NVIDIA
        <img width="1" height="15" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sub-content-header"><a href="/conferenceProgram/search/sessionDetails.asp?sessionid=4145">Consumer 360 – Gadgets Everywhere and the Role of Wireless</a></div>

<img src="/images/framework/spacer.gif" border="0" width="12"><strong>3-4 p.m. Friday, January 7, LVCC, North Hall, N255-257</strong><br>

<br>To win in electronics, a 360-degree view of the consumer – across devices, service, and environments – is criticlal. The number of screens is proliferating. The digital/physical intersection is opening. And connectivity to all devices is starting. What will define success for users and industry players in a new consumer 360 world?<BR><BR>Moderator: Rajeev Chand, Managing Director and Head of Research, Rutberg &amp; Company, LLC<BR><BR>Panelists: <BR>Anand Chandrasekher, SVP and GM, Ultra Mobility Group, Intel <BR>John Donovan, Chief Technology Officer, AT&amp;T <BR>Bill Ogle, Chief Marketing Officer, Motorola Mobility <BR>Robert Stephens, Chief Technology Officer, Best Buy; Founder, The Geek Squad &nbsp;    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/conferenceProgram/SuperSessions.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
