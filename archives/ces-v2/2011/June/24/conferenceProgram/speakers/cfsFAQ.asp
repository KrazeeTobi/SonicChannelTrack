...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <a href="http://www.cesweb.org/news/rssNews.asp" target="_blank"><img height="25" border="0" width="25" alt="rss" src="/images/framework/rss.png"></a>
        ...
        <b> I submitted a proposal but never received a confirmation. What happened?</b><br />
        ...
        Please read the session descriptions next to the categories on the website and choose a session that best fits your expertise. <br />
        <br />
        ...
        Keynote speaking opportunities are by invitation only. <a  href="http://www.cesweb.org/CFS-signup">The CES Call for Speakers</a> is for moderator/panelist format sessions. <br />
        <br />
        ...
        <br />
        <b>How do I submit for SuperSessions?</b><br />
        Submissions for SuperSessions are included in the <a  href="http://www.cesweb.org/cfs">CES Call for Speakers</a>. <br />
        <br />
        ...
        CEA has carefully selected and finalized the topics for the 2011 CES. While we welcome suggestions, it is doubtful that we can accommodate additional sessions.  <br />
        <br />
        ...
        <br />
        <b>When will speakers be notified?</b><br />
        Speakers will be notified by the end of September. <br />
        <br />
        <b>Who is the target audience? Are sessions open to the general public? Are there any sessions tailored to exhibitors only?</b><br />
        ...
        Proposals for new speakers may be made until Wednesday, July 6, 2011. Otherwise, speakers are chosen based on the name in the submission. Please make sure you have the appropriate speaker identified prior to <a  href="http://www.cesweb.org/CFS-signup">submitting your proposal.</a>
