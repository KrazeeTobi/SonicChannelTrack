...
<head><!-- PageID 4627 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: D: All Things Digital at CES</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/events/digital-ces.asp">D: All Things Digital at CES</a></li>
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/events/default.asp" class="footer">Events</a>&nbsp;&gt;&nbsp;D: All Things Digital at CES</div>
                        </div>
                        <div class="headerbox">
                            <h1>D: All Things Digital at CES</h1>
                            <div class="icon_wrap">
...
<STRONG><IMG height=24 hspace=5 src="/images/content/All_Things_Digital_logo.jpg" width=200 align=right>Event: 3:30-5:30 Friday, January 7, The Venetian, Marcello Ballroom<BR>Reception: 6-8 p.m., The Venetian, V-bar<BR><EM>By Invitation Only</EM></STRONG>
<P>D: All Things Digital at CES puts the tech industry’s top players to the test during informal, but pointed conversations with Wall Street Journal editors Walt Mossberg and Kara Swisher about the impact digital technology will have on our lives now and in the future.<BR><BR>
<TABLE cellSpacing=1 cellPadding=1 width="95%" border=0>
<TBODY>
<TR>
<TD>&nbsp;<IMG height=124 src="/images/photos/ATD1.JPG" width=187></TD>
<TD><IMG height=124 src="/images/photos/ATD2.JPG" width=187></TD>
<TD><IMG height=124 src="/images/photos/ATD3.JPG" width=187></TD></TR></TBODY></TABLE><BR><BR></P>
<H3>About Walt Mossberg and Kara Swisher</H3>
<P>Widely respected as the co-editors of AllThingsD.com and co-creators of the D: All Things Digital conference, Walt and Kara have a knack for uncovering interesting, often unknown details about how digital deals are being made and where the next wave of innovation may be coming from.<BR><BR>Mossberg appears regularly on television and Internet video as a commentator on technology issues. He is a weekly contributor to the Fox Business Network and has been called “The Most Powerful Columnist in Technology” by Rolling Stone.&nbsp; </P>
<P><BR>&nbsp;</P>

    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/events/digital-ces.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
