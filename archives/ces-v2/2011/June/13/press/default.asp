...
<div class="right-blue-box" align="center">
    ...
    <div>
        <STRONG>Need pictures for your stories?</STRONG> <BR><BR><A href="/press/imageGallery/default.asp"><IMG border=0 src="/images/content/IMG_0388sm(1).jpg"><BR><BR>Download photos from 2011 CES!</A><BR><BR>
    </div>
</div>
...
<div class="sub-content-header">CES Press Qualify for Six Audiotapes from Mobiltape</div>
<br />

<P style="TEXT-ALIGN: left">If you are a member of the press and attended CES, you can request six conference session audio tapes from the 2011 show. After Mobiltape verifies the registration list to ensure your name's on the list, you will receive the complimentary recordings. Need more than six sessions? No problem. They are available for purchase. Call&nbsp;1-800-369-5718.&nbsp;</P>
<P style="TEXT-ALIGN: center"><BR>&nbsp;<IMG hspace=10 align=bottom src="/images/content/Mobiltape.gif" width=311 height=65></P>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />
