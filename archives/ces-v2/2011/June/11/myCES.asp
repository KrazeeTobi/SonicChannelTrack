...
We've made some improvements to the MyCES planning tool that we think you're going to like. You can still search for exhibitors and products that you're interested in seeing at CES and add them to your show agenda. But you can now see where those exhibitors and products are located on the show floor using the new
<SCRIPT language=javascript src="http://www.mapyourshow.com/includes/floorplan.js"></SCRIPT>
 <A onclick=" OpenMapYourShowMax(this.href,this.target);return false" href=" http://www.mapyourshow.com/shows/index.cfm?SHOW_ID=CES11&alt_entry=true&curr_pri=facility&curr_sec=OO" target=floorplan>Interactive Floor Plan</A>.<BR><BR>With the new MyCES Planner, you'll be able to create a personalized show agenda that allows you to: 
<UL class=text>
...
<LI class=text>Print a map of the show floor highlighting your exhibitors of interest &nbsp;<BR><BR>&nbsp; Create a new <A href="http://www.mapyourshow.com/shows/index.cfm?SHOW_ID=CES11&alt_entry=true%20&curr_pri=agenda&curr_sec=_myabout" target=_blank>MyCES account </A>and start planning your show today!<BR></LI></UL>The MyCES Exhibitor Portal is your gateway into the MyCES online directory as well as the printed Official International CES Show Directory.<BR><BR>
...
<TH colSpan=5>&nbsp;</TH></TR>
<TR align=middle>
<TD><IMG src="/flash/dir-search.jpg"></TD>
<TD><IMG src="/images/content/featured-exhibitors.jpg"></TD>
<TD><IMG src="/images/content/product-search.jpg"></TD>
<TD><IMG src="/images/content/myplanner.jpg"></TD>
<TD>
<SCRIPT language=javascript src="http://www.mapyourshow.com/includes/floorplan.js"></SCRIPT>
