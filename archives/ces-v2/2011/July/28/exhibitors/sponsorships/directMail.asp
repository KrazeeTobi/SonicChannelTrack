...
<br /><P>The official online source for all International CES information, CESweb.org attracts thousands of qualified, consumer technology professionals each day. Online ads, especially when placed on well-trafficked, highly visible pages, can be one of the most effective and affordable marketing vehicles today. Receive online space during the show's busiest online time — September through January.<BR><BR>Ads can appear on pages such as:<BR><BR>Main conference program page: <A href="http://cesweb.org/conferenceProgram/default.asp">http://cesweb.org/conferenceProgram/default.asp</A><BR>Main events page: <A href="http://cesweb.org/events/default.asp">http://cesweb.org/events/default.asp</A><BR>Main show floor page: <A href="http://cesweb.org/showFloor/default.asp">http://cesweb.org/showFloor/default.asp</A><BR>Main hotel/travel page: <A href="http://cesweb.org/hotelTravel/default.asp">http://cesweb.org/hotelTravel/default.asp</A><BR>Main press page: <A href="http://cesweb.org/press/default.asp">http://cesweb.org/press/default.asp</A><BR>Main FAQs page: <A href="http://www.cesweb.org/faq/default.asp">http://www.cesweb.org/faq/default.asp</A>.<BR><BR>Banner ads will run September 1, 2011-February 1, 2012.<BR><BR>Technical Specifications of Banner Ads: We accept the following formats: GIF and JPG.<BR><BR><STRONG>Marketing Investment<BR></STRONG>CES Exhibitors: $7,500 <BR><BR><STRONG>Contact<BR></STRONG>Manager, Promotional Opportunities, CES<BR>Phone: 703-907-4324<BR>Email: <A href="mailto:byb@CE.org">byb@CE.org</A><BR>&nbsp;</P>
...
<br /><IMG style="MARGIN-TOP: 10px; MARGIN-LEFT: 10px" hspace=10 vspace=10 align=right src="/images/content/2k7CESEDM.jpg" width=160 height=152>At the International CES, we communicate regularly with our attendees and prospects through our attendee newsletter, <EM>CES Up to the Minute</EM>. Take advantage of this promotional opportunity by adding your message to our exhibitor advertisement section of the newsletter. Exhibitor advertisements are limited to 50 words, logo and URL. Through each newsletter you have the opportunity of reaching more than 200,000 readers, including 2012 pre-registered attendees, 2011 attendees, prospects, international attendees, VIP buyers and more. Include a logo, URL and 50 words about your company and product in our regularly scheduled attendee newsletter, <EM>CES Up to The Minute</EM>. Call now for details.&nbsp;<BR><BR><A href="/images/content/2012_CES_Attendee_EDM_Opportunities_Flyer.pdf" target=_blank>Download the flyer&nbsp;for more information and drop date options</A>.<BR><BR><STRONG>Marketing Investment</STRONG><BR>CES Exhibitors: $5,000 for one newsletter sponsorship; $8,000 for two. <BR>Exclusive Opportunities Available <BR><BR><STRONG>Contact</STRONG><BR>Manager, Promotional Opportunities, CES<BR>Phone: 703-907-4324<BR>Email: <A href="mailto:byb@CE.org">byb@CE.org</A>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br />
<img width="1" height="4" src="/images/framework/spacer.gif"/>
<br />
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
...
<br />The International CES attendee mailing lists, available only to CES exhibitors, help you reach last year's show attendees and those who have pre-registered to attend the International CES. We'll help you target specific demographics of attendees you want to see at your booth. Contact them via direct mail, before the show doors open, and reinforce your messaging to our verified lists.&nbsp;<BR><BR><B>Marketing Investment</B><BR>$1,000+<BR>Cost per Thousand: $200 per 1000 names<BR>Minimum Order: 5,000 names<BR><BR><STRONG>Requirements:</STRONG> 
<UL class=text>
...
<LI class=text>All mailings must go through a third-party mail house</LI></UL><B>Contact</B><BR>Manager, Promotional Opportunities, CES<BR>Phone: 703-907-4324<BR>Email: <A href="mailto:byb@CE.org">byb@CE.org</A>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a><br />
<img width="1" height="4" src="/images/framework/spacer.gif"/>
<br />
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
...
<br /><P>Communicate with CES attendees through full, dedicated HTML e-mail blasts. These blasts are created entirely by you and will be sent out directly by CES on your behalf. Through each e-mail blast, you will have the opportunity to reach more than 200,000 readers including 2012 CES pre-registrants, 2011 verified attendees, prospects, international attendees, VIP buyers and more. <BR><BR><A href="/images/content/2012_CES_Attendee_EDM_Opportunities_Flyer.pdf" target=_blank>Download the flyer for more information and drop date options</A>. <BR><BR><STRONG>Marketing Investment</STRONG><BR>$15,000+<BR><BR><STRONG>Restrictions</STRONG>:<BR></P>
<UL>
...
<P><STRONG>Contact<BR></STRONG>Manager, Promotional Opportunities, CES<BR>Phone: 703-907-4324<BR>Email: <A href="mailto:byb@CE.org">byb@CE.org</A><BR></P>
