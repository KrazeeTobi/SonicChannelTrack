...
<head><!-- PageID 3920 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<P><SPAN style="COLOR: black"><IMG border=0 align=right src="/docs/MobileAppsShowdown_200.gif" width=200 height=125>CES attendees were ready for&nbsp;a showdown, and they got one this past January. Mobile application makers were pitted against&nbsp;each in two-minute demos against others&nbsp;during the Mobile Apps Showdown at the 2011 CES. An applause-o-meter measured audience enthusiasm to determine the winners. <BR><BR><A href="http://www.mobileappsshowdown.com" target=_blank>And the winners are...</A></SPAN></P>
