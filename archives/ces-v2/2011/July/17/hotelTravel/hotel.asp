...
<IMG style="MARGIN-LEFT: 5px" hspace=5 align=right src="/images/photos/Strip_165x125.jpg" width=165 height=125>CES hotels are now accepting reservations for groups (10-20 rooms or more) and individual reservations. <A href="/hotelTravel/blockRequest.asp">Submit your request now for a group</A> block or click the hotel names to book individual reservations. <BR><BR>Please check the hotel's site for rates outside of the dates listed below. Rates and hotels updated as of June 30, 2011. Please note, every effort is made to keep this information up-to-date. However, rates are subject to change, as CES rates sell out. <BR><BR>
<br>
...
<tr class="">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText"><P>$132</P></span></td>
        <td valign="top"><span class="smallText"><P>$289</P></span></td>
        <td valign="top"><span class="smallText"><P>$289</P>
<P></P></span></td>
        <td valign="top"><span class="smallText"><P>$289</P>
<P></P></span></td>        
        <td valign="top"><span class="smallText"><P>$289</P></span></td>        
        ...
        <td valign="top"><span class="smallText"></span></td>        
        <td valign="top"><span class="smallText"><P>This hotel only accepts groups of 10 or more during CES. <A href="/hotelTravel/blockRequest.asp">Please see group block request form</A></P></span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
...
<tr class="">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText"><P>$89</P></span></td>
        <td valign="top"><span class="smallText"><P>$89</P>
<P></P></span></td>
        <td valign="top"><span class="smallText"><P>$159</P></span></td>
        <td valign="top"><span class="smallText"><P>$199</P></span></td>        
        <td valign="top"><span class="smallText"><P>$199</P></span></td>        
        ...
        <td valign="top"><span class="smallText"></span></td>        
        <td valign="top"><span class="smallText"><P>Early bird rates shown. Must book by September 1</P></span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
...
<tr class="alternateRows">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText"><P>$163</P></span></td>
        <td valign="top"><span class="smallText"><P>$279</P></span></td>
        <td valign="top"><span class="smallText"><P>$279</P>
<P></P></span></td>
        <td valign="top"><span class="smallText"><P>$279</P>
...
<tr class="alternateRows">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText"><P>$205</P></span></td>
        <td valign="top"><span class="smallText"><P>$255</P></span></td>
        <td valign="top"><span class="smallText"><P>$255</P></span></td>
        <td valign="top"><span class="smallText"><P>$255</P></span></td>        
        <td valign="top"><span class="smallText"><P>$255</P>
<P></P></span></td>        
        <td valign="top"><span class="smallText"><P>$255</P>
<P></P></span></td>
        <td valign="top"><span class="smallText"><P>$255</P></span></td>
...
<br>
<H4>*Rates include resort services (subject to change)</H4>ARIA room rate includes the following resort services: Internet access (in-room and campus wide at City Center), local and&nbsp;&nbsp;800 Number telephone calls, access to The Spa at ARIA Fitness Center, daily newspaper, airline boarding pass printing<BR><BR>Bellagio room rate includes the following resort services: access to Hotel Fitness Center, wireless Internet in guest rooms, boarding pass printing in Hotel's Business Center, free local calls, free toll free calls<BR><BR>Circus Circus room rate includes the following resort services:&nbsp;In-room internet service (daily), chips and Salsa at the Garden Grill, two free drinks at any Casino bar or Slots of Fun bar,&nbsp;two free ride passes for the Adventure Dome Theme Park,&nbsp;two Fitness passes,&nbsp;two free Midway games, 800/local calls up to 30 minutes maximum per call (daily), Resort Fun Book valued at approximately $100<BR><BR>Excalibur room rate includes the following resort services: In-room wired Internet service, daily newspaper, Fitness Center admission, unlimited local, domestic long distance and toll-free telephone calls<BR><BR>Luxor room rate includes the following resort services:&nbsp;In-room wired Internet service, daily newspaper, Nuture Fitness Center admission, unlimited local, domestic long distance and toll-free telephone calls<BR><BR>Mandalay Bay room rate includes the following resort services: In-room wireless internet, cardio center admission (does not include Spa access), daily newspaper, local and 800-number calls, outgoing faxes and boarding pass printing at the Hotel Business Center.<BR><BR>MGM Grand room rate includes the following resort services:&nbsp;Unlimited internet connection in guest rooms, unlimited local and toll-free telephone calls from guest rooms, $15 beverage credit per stay (for MGM Grand outlets, printing of boarding passes,limited printing, faxing, notary servces at Business Center<BR><BR>Mirage room rate includes the following resort services: Daily newspaper at Impulse and Bell Desk, Cardio Center admission (does not include Spa access), in-room robes, unlimited notary, unlimted incoming fax and 20 outgoing fax services &amp; airline boarding pass printing at The Mirage Business Service Center, unlimited local and toll free telephone calls and in-room internet access<BR><BR>New York New York room rate includes the following resort services:&nbsp;Internet Access in Guestrooms, Daily Fitness CInternet Access in Guest Rooms, Daily Fitness Center Access, Unlimited Local and Toll Free Calls, Use of Calling Cards and Collect Calls from&nbsp;Guest Room, &nbsp;free Boarding Pass Printing, Notary Services, Incoming and Outgoing Faxes (limit of 5 pages total).&nbsp; A Daily Newspaper will be available for pickup at our Essentials store.&nbsp;<BR><BR>Signature at MGM room rate includes the following resort services:&nbsp;Access to Signature Fitness Centers (2 centers, 24/7 access), 2 bottles water in suite/day, In-Room coffee &amp; tea, unlimited Internet connection throughout towers, unlimited local and toll-free telephone calls from suites, daily newspaper, valet parking<BR><BR>THEhotel at Mandalay Bay room rate includes the following resort services:&nbsp;In-room wireless internet, cardio center admission (does not include Spa access), daily newspaper, local and 800-number calls, outgoing faxes and boarding pass printing at the Hotel Business Center.&nbsp;<BR><BR>Vdara room rate includes the following resort services:&nbsp;Internet access (in-room and campus wide at City Center), local and 800 Number telephone calls, access to The Spa at ARIA Fitness Center, daily newspaper, airline boarding pass printing. 
<H4>Housing Agency/Bureau Policy</H4>The Consumer Electronics Association (CEA), producer of the International CES, would like to remind CES attendees and exhibitors that CES does not use or endorse housing agencies or bureaus. CES attendees and exhibitors are to contact the CES hotels directly to receive the contracted CES rate. Claims by housing agencies/bureaus that they are the official CES housing agency are untrue. Please feel free to contact <A href="mailto:CEShotels@CE.org">CEShotels@CE.org</A> for further information.
                            <script type="text/javascript">
