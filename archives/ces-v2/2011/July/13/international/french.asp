...
<P><A href="http://cesweb.org/international/french/travel.asp">Information de voyage et de visa</A><BR>Utiliser ces informations utiles pour les voyages aller-retour vers les États-Unis.<BR><BR><A href="/international/french/delegations.asp">Programme de groupes de délégation<BR></A>Le Salon CES International attire un large public international grâce à son excellent programme de délégation. Découvrez comment créer ou rejoindre une délégation dans votre pays ou dans votre région.</P>
<P><A href="/international/french/services.asp">Services internationaux<BR></A>Parmi les nombreux avantages offerts aux participants internationaux, il faut citer des interprètes, des réceptions spéciales de prises de contact, des espaces de travail, des salles de réunion, etc.<BR><BR><A href="/docs/HI_RES_FR_2K12_CESfactSheet_Web.pdf" target=_blank>Informations générales&nbsp;(pdf)<BR></A>Découvrez l’histoire du Salon, les catégories de produits, les dates des futurs salons, etc.</P>
                            <script type="text/javascript">
