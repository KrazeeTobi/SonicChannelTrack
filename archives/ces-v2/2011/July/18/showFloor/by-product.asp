...
<head><!-- PageID 3948 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: By Product Category</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/showFloor/by-product.asp">By Product Category</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/showFloor/default.asp" class="footer">Show Floor</a>&nbsp;&gt;&nbsp;By Product Category</div>
                        </div>
                         <div class="headerbox">
...
<div class="blue_box" id="5210">
    <ul>
        
        
        <li><a class="sub-page-slider-link" href="#5211">Audio</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5212">Automotive Electronics</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5213">Computer Hardware & Software</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5219">Connected Home</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5220">Content Distribution</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5221">Digital Health and Fitness</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5222">Digital Imaging/Photography</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5223">Electronic Gaming</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5224">Emerging Technology</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5225">Entertainment/Content</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5226">Internet-Based Multimedia Services</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5227">Lifestyle Electronics</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5228">Telecomm/Infrastructure</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5229">Video</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5230">Wireless & Wireless Devices</a></li>
...
<script type="text/javascript">
    var SecondItems = $("#5210 ul:first li:nth-child(2n)");
    var ThirdItems = $("#5210 ul:first li:nth-child(3n)");

    $("#5210 ul:eq(1)").append(SecondItems);
    $("#5210 ul:eq(2)").append(ThirdItems);
    $("#5210 ul:eq(2)").append($("#5210 .sub-page-slider-link-show-all").parent());

    $(document).ready(function() {
        $("#5210 .sub-page-slider-link-show-all").click();
    });
</script>
...
<div class="sub-page-slider">
    <div class="sub-page-slider-nav">
        ...
        <div class="sub-page-slider-top-header">By Product Category</div>
        <div class="sub-page-slider-bottom-header"></div>
        <div class="push"></div>    
    </div>
    <div>
        <div class="sub-slide" id="5211">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Audio</h2>
    </div>
...
<LI class=text>High-performance audio </LI>
<LI class=text><LICLASS=TEXT>Portable audio players</LI></UL>
<H4><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=2|Audio&search=category&sub_cat=2|Audio|AllSubCategories">Featured Exhibitors</A></H4>
<P class=text>&nbsp;</P></TD>
<TD vAlign=top>
<H4>Primary Location</H4>
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2618">LVCC, Central Hall</A></LI>
<LI class=text>The Venetian<BR><BR></LI></UL>
<P></P>
<H4>Additional Locations </H4>
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2616">LVCC, North Hall </A></LI>
<LI class=text><A href="/showFloor/by-hall.asp#2616">LVCC, South Hall 1 </A></LI>
<LI class=text><A href="/showFloor/by-hall.asp#2613">Las Vegas Hilton </A></LI></UL></TD></TR></TBODY></TABLE>
    <br />
    <br />
</div><div class="sub-slide" id="5212">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Automotive Electronics</h2>
    </div>
    <TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
...
<UL class=text>
<LI class=text>Accessories </LI>
<LI class=text>Automotive Electronics</LI></UL><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=1|AutomotiveElectronics&search=category&sub_cat=1|AutomotiveElectronics|AllSubCategories">
<H4>Featured Exhibitors</H4>
<P class=text></A>&nbsp;</P></TD>
<TD vAlign=top>
<H4>Primary Location </H4>
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2616">LVCC, North Hall</A></LI></UL></TD></TR></TBODY></TABLE>
    <br />
    <br />
</div><div class="sub-slide" id="5213">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Computer Hardware & Software</h2>
    </div>
    <TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
...
<LI class=text>Embedded Technology</LI></UL>
<H4><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=3|ComputerHardwareSoftware&search=category&sub_cat=3|ComputerHardwareSoftware|AllSubCategories">Featured Exhibitors</A></H4>
<P class=text>&nbsp;</P></TD>
<TD vAlign=top>
<H4>Primary Location </H4>
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2615">LVCC, South Halls 3-4</A></LI></UL>
<H4>Additional Locations </H4>
<UL class=text>
<LI class=text>LVCC, Central Hall</LI>
<LI class=text><A href="/showFloor/by-hall.asp#2615">LVCC, South Hall 2</A> </LI>
<LI class=text><A href="/showFloor/by-hall.asp#2613">Las Vegas Hilton </A></LI>
<LI class=text><A href="/showFloor/by-hall.asp#2614">The Venetian</A></LI></UL></TD></TR></TBODY></TABLE>
    <br />
    <br />
</div><div class="sub-slide" id="5219">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Connected Home</h2>
    </div>
    <TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
...
<LI class=text>Home Appliances </LI>
<LI class=text>Home Data Networking </LI>
<LI class=text>Integrated Home Systems </LI>
<LI class=text>Small Office/Home Office</LI></UL>
<H4><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=9|ConnectedHome&search=category&sub_cat=9|ConnectedHome|AllSubCategories">Featured Exhibitors</A><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=9|ConnectedHome&search=category&sub_cat=9|ConnectedHome|AllSubCategories"></H4>
<P class=text></A>&nbsp;</P></TD>
<TD vAlign=top>
<H4>Primary Location </H4>
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2615">LVCC, South Halls 1-2</A></LI></UL>
<H4>Additional Locations </H4>
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2615">LVCC,&nbsp;Central Hall</A> </LI>
<LI class=text><A href="/showFloor/by-hall.asp#2616">LVCC, North Hall</A> </LI>
<LI class=text><A href="/showFloor/by-hall.asp#2615">LVCC, South Halls 3-4&nbsp;</A> </LI>
<LI class=text><A href="/showFloor/by-hall.asp#2613">Las Vegas Hilton </A></LI>
<LI class=text><A href="/showFloor/by-hall.asp#2614">The Venetian</A></LI></UL></TD></TR></TBODY></TABLE>
    <br />
    <br />
</div><div class="sub-slide" id="5220">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Content Distribution</h2>
    </div>
    <TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
...
<LI class=text>Broadband </LI>
<LI class=text>Broadcast &amp; Cable </LI>
<LI class=text>Satellite Systems</LI></UL>
<H4><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=7|ContentDistribution&search=category&sub_cat=7|ContentDistribution|AllSubCategories">Featured Exhibitors</A></H4>
<P class=text>&nbsp;</P></TD>
<TD vAlign=top>
<H4>Primary Location </H4>
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2618">LVCC, Central Hall</A></LI></UL>
<H4>Additional Location </H4>
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2614">The Venetian</A></LI></UL></TD></TR></TBODY></TABLE>
    <br />
    <br />
</div><div class="sub-slide" id="5221">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Digital Health and Fitness</h2>
    </div>
    <TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
...
<LI class=text>Fitness </LI>
<LI class=text>Home Healthcare Products</LI></UL>
<H4><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=4|DigitalHealthandFitness&search=category&sub_cat=4|DigitalHealthandFitness|AllSubCategories">Featured Exhibitors</A><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=4|DigitalHealthandFitness&search=category&sub_cat=4|DigitalHealthandFitness|AllSubCategories"></H4>
<P class=text></A>&nbsp;</P></TD>
<TD vAlign=top>
<H4>Primary Location </H4>
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2616">LVCC, North Hall</A></LI></UL>
<H4>Additional Location</H4>
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2618">LVCC, Central Hall</A> </LI></UL></TD></TR></TBODY></TABLE>
    <br />
    <br />
</div><div class="sub-slide" id="5222">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Digital Imaging/Photography</h2>
    </div>
    <TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
...
<LI class=text>Photographic Equipment </LI>
<LI class=text>Video Editing</LI></UL>
<H4><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=11|DigitalImaging&search=category&sub_cat=11|DigitalImaging|AllSubCategories">Featured Exhibitors</A></H4>
<P class=text>&nbsp;</P></TD>
<TD vAlign=top>
<H4>Primary Location </H4>
<UL class=text>
...
<LI class=text><A href="/showFloor/by-hall.asp#2618">LVCC, Central Hall</A> </LI></UL></TD></TR></TBODY></TABLE>
    <br />
    <br />
</div><div class="sub-slide" id="5223">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Electronic Gaming</h2>
    </div>
    <TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
...
<UL class=text>
<LI class=text>Accessories </LI>
<LI class=text>Electronic Gaming</LI></UL>
<H4><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=13|ElectronicGaming&search=category&sub_cat=13|ElectronicGaming|AllSubCategories">Featured Exhibitors</A></H4>
<P class=text>&nbsp;</P></TD>
<TD vAlign=top>
<H4>Primary Location </H4>
<UL class=text>
...
<LI class=text><A href="/showFloor/by-hall.asp#2614">The Venetian</A></LI></UL></TD></TR></TBODY></TABLE>
    <br />
    <br />
</div><div class="sub-slide" id="5224">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Emerging Technology</h2>
    </div>
    <TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
...
<LI class=text>Biotech </LI>
<LI class=text>Emerging Technology </LI>
<LI class=text>Nanotech </LI>
<LI class=text>Robotics</LI></UL>
<H4><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=12|EmergingTechnology&search=category&sub_cat=12|EmergingTechnology|AllSubCategories">Featured Exhibitors</A></H4>
<P class=text><BR>&nbsp;</P></TD>
<TD vAlign=top>
<H4>Primary Location </H4>
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2615">LVCC, South Halls 3-4</A></LI></UL>
...
<LI class=text><A href="/showFloor/by-hall.asp#2614">The Venetian</A></LI></UL></TD></TR></TBODY></TABLE>
    <br />
    <br />
</div><div class="sub-slide" id="5225">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Entertainment/Content</h2>
    </div>
    <TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
...
<H4>Featured Markets </H4>
<UL class=text>
<LI class=text>Content Development </LI>
<LI class=text>Entertainment/Content </LI>
<LI class=text>Mobile Applications</LI></UL>
<H4><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=6|EntertainmentContent&search=category&sub_cat=6|EntertainmentContent|AllSubCategories">Featured Exhibitors</A></H4>
<P class=text><BR>&nbsp;</P></TD>
<TD vAlign=top>
<H4>Primary Location </H4>
<UL class=text>
...
<LI class=text><A href="/showFloor/by-hall.asp#2614">The Venetian</A></LI></UL></TD></TR></TBODY></TABLE>
    <br />
    <br />
</div><div class="sub-slide" id="5226">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Internet-Based Multimedia Services</h2>
    </div>
    <TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
...
<LI class=text>IPTV </LI>
<LI class=text>Online Commerce Products &amp; Services </LI>
<LI class=text>Online/Internet </LI>
<LI class=text>Social Networking </LI>
<LI class=text>VoIP Hardware &amp; Software</LI></UL>
<H4><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=10|InternetBasedMultimediaServices&search=category&sub_cat=10|InternetBasedMultimediaServices|AllSubCategories">Featured Exhibitors</A></H4>
<P class=text><BR>&nbsp;</P></TD>
<TD vAlign=top>
<H4>Primary Location </H4>
<UL class=text>
...
<LI class=text><A href="/showFloor/by-hall.asp#2614">The Venetian</A></LI></UL></TD></TR></TBODY></TABLE>
    <br />
    <br />
</div><div class="sub-slide" id="5227">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Lifestyle Electronics</h2>
    </div>
    <TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
...
<UL class=text>
<LI class=text>Accessories </LI>
<LI class=text>Landline Telephones </LI>
<LI class=text>Lifestyle Electronics </LI>
<LI class=text>Personal Safety &amp; Security Products</LI></UL>
<H4><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=8|LifestyleElectronics&search=category&sub_cat=8|LifestyleElectronics|AllSubCategories">Featured Exhibitors</A></H4>
<P class=text><BR>&nbsp;</P></TD>
<TD vAlign=top>
<H4>Primary Location </H4>
<UL class=text>
...
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2615">LVCC, South Hall 2</A> </LI>
<LI class=text><A href="/showFloor/by-hall.asp">LVCC, South Halls 3-4</A> </LI>
<LI class=text><A href="/showFloor/by-hall.asp#2613">Las Vegas Hilton </A></LI>
<LI class=text><A href="/showFloor/by-hall.asp#2614">The Venetian</A></LI></UL></TD></TR></TBODY></TABLE>
    <br />
    <br />
</div><div class="sub-slide" id="5228">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Telecomm/Infrastructure</h2>
    </div>
    <TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
<TD vAlign=top>
<H4><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=15|TelecommunicationsInfrastructure&search=category&sub_cat=15|TelecommunicationsInfrastructure|AllSubCategories">Featured Exhibitors</A></H4></TD>
<TD vAlign=top>
<H4>Primary Location </H4>
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2615">LVCC, South Hall 3-4</A></LI></UL>
<H4>Additional Locations </H4>
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2613">Las Vegas Hilton </A></LI>
<LI class=text><A href="/showFloor/by-hall.asp#2614">The Venetian</A></LI></UL></TD></TR></TBODY></TABLE>
    <br />
    <br />
</div><div class="sub-slide" id="5229">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Video</h2>
    </div>
    <TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
...
<LI class=text>3D </LI>
<LI class=text>Accessories </LI>
<LI class=text>Embedded Technology </LI>
<LI class=text>Film/Video Production (Professional Grade) </LI>
<LI class=text>Video </LI>
<LI class=text>Video Editing</LI></UL>
<H4><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=5|Video&search=category&sub_cat=5|Video|AllSubCategories">Featured Exhibitors</A></H4>
<P class=text>&nbsp;</P></TD>
<TD vAlign=top>
<H4>Primary Location </H4>
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2615">LVCC,&nbsp;Central Hall</A></LI></UL>
<H4>Additional Locations </H4>
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2618">LVCC, South Hall 1</A> </LI>
<LI class=text><A href="/showFloor/by-hall.asp#2613">Las Vegas Hilton </A></LI>
<LI class=text><A href="/showFloor/by-hall.asp#2614">The Venetian</A></LI></UL></TD></TR></TBODY></TABLE>
    <br />
    <br />
</div><div class="sub-slide" id="5230">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Wireless & Wireless Devices</h2>
    </div>
    <TABLE border=0 cellSpacing=1 cellPadding=1 width="95%">
<TBODY>
<TR>
...
<UL class=text>
<LI class=text>Accessories </LI>
<LI class=text>E-Books </LI>
<LI class=text>Embedded Technology </LI>
<LI class=text>Tables PCs/Netbooks </LI>
<LI class=text>WiFi </LI>
<LI class=text>Wireless and Wireless Devices</LI></UL><STRONG>
<H4><A href="http://ces11.mapyourshow.com/search.cfm?main_cat=14|WirelessandWirelessDevices&search=category&sub_cat=14|WirelessandWirelessDevices|AllSubCategories">Featured Exhbitors</A></H4>
<P class=text></STRONG><BR>&nbsp;</P></TD>
<TD vAlign=top>
<H4>Primary Location </H4>
<UL class=text>
<LI class=text><A href="/showFloor/by-hall.asp#2615">LVCC, South Hall 3-4</A></LI></UL>
