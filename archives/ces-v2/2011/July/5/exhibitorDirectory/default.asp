...
<head><!-- PageID 3830 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: Exhibitor Directory</title>
...
<body class="home" id="home">
    ...
    <div id="ctacontainer">
        ...
        <div id="register"><a href="/register" title="Register for CES"><img src="http://content.ce.org/2011CES/images/framework/cesweb_register1.png" alt="Register" name="cesweb_register" onMouseOver="over(8)" onMouseOut="out(8)" /></a></div>
        <div id="exhibit"> <a href="/exhibitors/space/default.asp" title="Register to Exhibit"><img src="http://content.ce.org/2011CES/images/framework/cesweb_exhibit1.png" alt="Exhibitors" name="cesweb_exhibit" onMouseOver="over(9)" onMouseOut="out(9)" /></a></div>
    </div>
</div>
                <div id="nav-bar">
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
                ...
                <div id="main-content">
                    <div class="left">
                        <div class="greenbox-bg">
                            <img src="http://content.ce.org/2011CES/images/framework/Subnav_ExbtDirect.jpg">
                            <a href="http://ces11.mapyourshow.com"><!--<img src="http://content.ce.org/2011CES/images/framework/sidebar-header-exhibitordir.gif" alt="Exhibitor Directory">--></a><ul></ul>
                            <br />
                        </div>
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;Exhibitor Directory</div>
                        </div>
                        <div class="headerbox">
