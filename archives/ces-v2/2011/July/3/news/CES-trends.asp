...
<head><!-- PageID 4549 - published by Open Text Web Solutions 10 - 10.0.0.57 - 29635 -->
    ...
    <title>2011 CES: CES Trends</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li class="selected"><a href="/news/CES-trends.asp">CES Trends</a></li>
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/news/default.asp" class="footer">News</a>&nbsp;&gt;&nbsp;CES Trends</div>
                        </div>
                        <div class="headerbox">
                       <h1>CES Trends</h1>
                            <div class="icon_wrap">
...
<H3>2011 CES Trends to Watch</H3>
<P><STRONG>Shawn Dubravac, CFA <BR>Chief Economist and Director of Research, Consumer Electronics Association<BR>@twoopinions </STRONG></P>
<P><A href="#4614">Part II: Internet-enabled (everything) and the "app-lification" of CES</A><BR><A href="#4616">Part I: Tablets and 3D<BR></A></P>
...
<div class="sub-content-header">2011 CES Trends to Watch (Part II): Internet-enabled (everything) and the "app-lification" of CES</div>
<br />

We covered two expected CES trends thus far (see Tablets and 3D).&nbsp; Now for two more: Internet-enabled (everything) and the "app-lification" of CES.&nbsp; 
<H3>Internet-enabled (everything)</H3>Last year the big showing for TVs was 3D. But least you forget, these TVs were also Internet-enabled through integrated WiFi or an Ethernet jack in the back. This year I expect these roles to reverse. The bigger story in 2011 will be Internet-delivered offerings. This won’t be about the technical feasibility of bringing the Internet to the TV, this will be about the meaningfulness for the end-user of marrying the TV with the Internet. 
<P>
<P>Bringing the Internet directly to the TV has been long discussed and the merits thereof veraciously debated. But with these TVs just now hitting the mass market, the real battles – and the big questions – begin.&nbsp; With TVs now readily connected to the Internet the question becomes not how or if, but what to do with this new found feature? The real question – a battle for relevancy – is the type of battle that plays out fluently across CES each year.</P>
<P>Here are the types of questions I’ll be exploring at CES: How is the connection being used? Is it only pulling down information and content to the device or is it also sending information and content elsewhere and which of these directional flows is dominating? Is the connection to devices inside the home more important than connections to devices outside the home? How will the device interact with other devices – which will control and which will be controlled? What about Storage? Organization? Discovery?&nbsp; </P>
<P>We’ve focused thus far on TVs, but enabling everything with the Internet by definition encompasses more than just the TV. Because individuals expect their TV to last upwards of 10 years, TVs currently have a low level of obsolescence and a high degree of durability.&nbsp; On average, consumers do not replace them frequently. Because of this, I expect to see an increasing number of set-top boxes (and accompanying services) launch at the 2011 CES.&nbsp; These devices have shorter lifecycles, lower price points, and the millions of unconnected televisions in the marketplace create an instant market for these offerings. In past CES’ we’ve seen the debuts of devices like the SlingBox, the Boxee Box, and a host of connected Blu-Ray players. I expect to see increased innovation in this arena.&nbsp; </P>
<P>Thus far the Internet connection in these devices is largely being used to stream content from outside the home to the connected device.&nbsp; But we know the Internet is what you make of it and CES will highlight&nbsp; what you can make of marrying the TV with the Net.</P>
<P>Beyond TVs and connected set-top devices, the Internet will be ubiquitous at CES this year.&nbsp; Expect to see it garner further inroads into the vehicle, the camera, the printer, and every screen imaginable.&nbsp; </P>
<H3>"app-lification" of CES</H3>Apps continue to influence the tech industry and 2011 will witness the full app-lification of CES.&nbsp; I expect to see apps everywhere. I continue to hear from manufacturers claiming they are moving development resources away from designing new remotes and increasingly focused on app development instead.&nbsp; This theme will permeate CES. I think 2011 will be the first year where not a single hardware category will exist sans apps. Command and control will be a common theme – allowing end-users to control devices from the comfort of…well…another device. 
<P></P>
<P>To be sure, apps will be omnipresent at CES in televisions, tablets and mobile phones.&nbsp; Apps are a conduit for the Web and consistent with the growth of Internet connectivity, I expect to see apps gain significant inroads in cameras, printers, in the vehicle and digital displays like photo frames.&nbsp; I also expect to see apps gain significant inroads at CES into things like mobile and digital health, and sports and fitness. Monitoring will be a theme at this year’s CES and I expect to see apps play an important role enabling individuals to along many facets of monitoring.&nbsp; </P>
<P>Beyond just command and control, I’m looking for apps that will add richness to the end-user experience and I expect to see these emerge at the 2011 CES.&nbsp;&nbsp; </P>
<P>To be continued…… </P>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sub-content-header">2011 CES Trends to Watch (Part I): Tablets and 3D</div>
<br />

While hard to believe, it's that time of year again. When it comes to new products launches – much of what will happen in 2010 has happened. We now turn our attention to the new year when many of tomorrow's products will see the light of day at the 2011 International CES®. With that in mind, I wanted to beat the crowds and provide a glimpse of things as I see them happening. Here are my first two predictions for 2011 CES&nbsp; trends – with more to follow.
<H3>The Year of the Tablet</H3>
<P>Without doubt 2011 will be the year of the tablet. <BR><BR>Apple’s launch of the iPad has left an undeniable print on the mobile computing space. After a decade with minimal success, a tablet computing device is (finally) garnering mass market appeal.<BR><BR>There are many factors driving this trend – not least of which is timing. The global appeal of Apple’s iPad is simultaneously brazening others to enter the fold and compete for this quickly growing market.&nbsp;&nbsp; <BR><BR>While many firms are touting product launches within the tablet sphere for the fourth quarter of 2010, the real action will occur a few weeks after the end of the quarter at CES. This same timeline played out last year with a similar device – eReaders. While we saw scattered product launches in the fourth quarter most were reserved for CES. <BR><BR>At the 2010 International CES we saw a dozen plus new eReaders revealed – with many of these devices just now coming to market. Design cycles as they are mean tablets are really a 2011 story, not as much a 2010 one, and CES will mark the debut for many of these. I have a list of 80+ tablets that have been announced and many of these will see the light of day at the 2011 CES.<BR>With competition heating up, each and every aspect of differentiation will be on the table – OS, screen size, color, and available applications. As a product matures, aspects like screen sizes consolidate. Look at the flat panel market where screens mostly group around 32", 37", 42", 46", 55", etc. But with a nascent category like tablets these normal have yet to be established so everything is on the table (pun intended).&nbsp;&nbsp; <BR><BR>Significant growth for a nascent category will also propel adjacent, but not to be overlooked markets like accessories. Expect to see the 2011 CES explode with not only cases and bags but also a wide selection of items like Bluetooth-enabled devices specifically targeting the tablet space. <BR><BR>Recent research undertaken by CES shows consumers associate the tablet more with the mobile phone than with the computer. This is not widely appreciated but it will influence the tablet-related offerings at CES 2011.</P>
<H3>The Year of 3D – Again </H3>The 2010 CES was certainly defined by 3D. This included 3D content, hardware and services. A plethora of hardware offerings were launched at CES including 3DTVs, Blu-ray players, and AV receivers. But CES also showcased DirecTV’s first public broadcast of 3D and played home to ESPN’s announcement of ESPN 3D. A spec for 3D Blu-ray was released in conjunction with CES – making possible home 3D viewing and Sony showed 3D gaming on the PS3.&nbsp; <BR><BR>The 2011 CES will again play home to the entire 3D ecosystem.&nbsp; CES is well positioned to showcase the continuum of technologies that spreads across categories. 3D is still a very nascent home entertainment technology so 2011 will again represent an important catalyst in the evolution of 3D. Expect to see more 3D than ever before. We’ll start with bigger, more feature-rich 3DTVs – a given.&nbsp; But 3D will expand wider than it did last year.&nbsp; The story of 3D at CES 2011 will be subtlety.&nbsp; We’ll start with 3D eyewear where no standard exists (yet). I expect to see several companies highlighting 3D active shutter eyewear solutions. Autostereoscopic – 3D without the need for eyewear – will be more pronounced this coming year. I also expect to see 3D more pronounced in the rear-seat of the vehicle, in the palm of your hand through mobile devices, and digital signage. <BR><BR>To be continued……    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/news/CES-trends.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
