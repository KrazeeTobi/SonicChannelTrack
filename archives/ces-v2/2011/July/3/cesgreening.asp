...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;An Eco-Friendly Electronics Show</div>
                        </div>
                        <div class="headerbox">
...
<H3>Green Exhibits and Conferences at the 2011 International CES</H3><IMG hspace=5 align=right src="/images/content/earth911.jpg" width=200 height=47>Sponsored by <A href="http://www.earth911.com/" target=_blank>Earth911</A>, the official recycling partner of CEA and CES, the <A href="http://www.cesweb.org/showFloor/techzones.asp#3864">Sustainable Planet TechZone</A>, showcases the latest in eco-friendly products and energy efficiency technologies. It highlights the latest products that make it possible for every person on this planet to stay connected and informed, and live sustainable lifestyles through advances in green building, alternative energy technologies, green business services and solutions, smart grid technologies, solar and renewable products, sustainable packaging and wireless convergence. Topics include: 
<P></P>
<UL class=text>
...
<P><IMG hspace=5 align=left src="/images/content/Electric_Vehicle_100px.jpg" width=130 height=28>New to CES this year is the <A href="http://www.cesweb.org/showFloor/techzones.asp#3835">Electric Vehicle TechZone</A>, occupying 3,500 square feet of dedicated exhibit space in the LVCC, showcasing the full range of high- and low-speed electric vehicles, energy storage devices and charging solutions. This TechZone highlights an area of great potential and growth for the industry as electric vehicles are quickly gaining in popularity among consumers seeking to live more sustainably by using alternative transportation. Major automotive exhibitors like Audi, Ford, GM OnStar and Toyota will be at CES to share their latest automotive electronics innovations. </P>
...
<LI class=text>Representatives travel from more than 130 different countries, offering a truly global opportunity.<BR></LI></UL>
...
<LI class=text>New this year, all CES TechZone pods, hardwall and turnkey booth packages will include recyclable carpet and recyclable backwall and counter panels. </LI>
<LI class=text>Printed all attendee flyers and CES literature on recycled paper using soy ink </LI>
<LI class=text>Last year at the 2010 International CES, CEA donated $50,000 to the Las Vegas Metro Police Department to purchase seven Vetrix electric motorcycles which are on the streets of the tourist corridor every day helping to keeping Las Vegas both safe and green.</LI>
<LI class=text>This year, CEA donated $75,000 to Green Chips, a non-profit organization promoting carbon neutrality, to support sustainable energy in southern Nevada. <A href="http://ce.org/Press/CurrentNews/press_release_detail.asp?id=12045" target=_blank>Read more.</A></LI></UL>
...
<LI class=text>Uses green cleaning products <BR></LI></UL>
...
<H3>CEA Highlights CE Companies’ Sustainability Efforts </H3>Just released, the&nbsp;CEA 2010 Sustainability Report highlights the industry’s efforts toward environmental accountability. An update to CEA’s 2009 landmark report, the 2010 report benchmarks the industry's progress toward eco-stewardship, from design and energy efficiency to green manufacturing and clean delivery systems. The update also adds a new section showcasing social contributions made by CE companies and the innovative technologies they create. Visit <A href="http://www.ce.org/green">www.CE.org/green</A> for more information.

    
                        
                            <br /><br /><br />
                            <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/cesgreening.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
