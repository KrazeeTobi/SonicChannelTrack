...
<head><!-- PageID 4425 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: November 2010 Venetian</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div>November 2010 Venetian</div>
                        </div>
                         <div class="headerbox">
                            <h1>November 2010 Venetian</h1>
                        </div><br />
...
GES will return all empty containers to suite exhibitors between 5:30 p.m. and midnight on Sunday, January 9. Please keep this in mind as you make your travel arrangements so that you leave yourself enough time to repack your outbound shipment. All outbound shipments must be packed and labeled for GES pick-up by 5 p.m. on Monday, January 10. If you have outbound shipment questions on-site, please visit GES in suite 29-205. <BR><BR>Like the 2010 show, all exhibitor freight (with the exception of POVs) will be returned to the warehouse during move-out for repacking, recrating, etc. Back to warehouse fees will apply for all exhibitors. Please see section 6 in your <A href="http://ges.com/eComm/2011/q1/11-05562/" target=_blank>Venetian Tower Suites Exhibitor Manual</A> for additional information and back to warehouse rates.<BR><br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
<br />
...
Below are a few key upcoming deadlines. For a full list, be sure to reference your appropriate c<A href="/exhibitors/showPlanning/venetian-show-planning.asp">hecklist</A>! Be sure to select the list that applies to you—either as a meeting room or suite exhibitor.<BR><BR>Venetian Tower exhibit suites: 
<P></P>
<UL>
<LI>November 1 — Deadline to submit your desired furniture movement/bed removal floor plan </LI>
...
<LI>November 29-December 27 — This is the window for advance freight to arrive at the GES warehouse and receive the advance freight rate, which is less expensive than the direct rate</LI></UL>
<P>Late fees will apply to some of these services if not submitted by November 1, so be sure to get your forms in!<BR><BR>Venetian meeting room exhibitors: 
<UL>
<LI>November 29 — CES shipments/freight may begin arriving at the GES warehouse (note: Venetian exhibitor shipments must be received by December 27, 2010 in order to receive the advance material handling rate, which is less expensive than the direct to show site rate) </LI>
...
<LI>December 3 — Deadline to order complimentary hotel furnishings through Venetian Conference Management</LI></UL>If you are a Venetian exhibitor and would like assistance with your order forms, or just have general questions, contact <A href="mailto: gberube@ce.org" target=_blank>Gaiya Berube</A>, CES operations manager.<BR><br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
<br />
