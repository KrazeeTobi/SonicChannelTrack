...
<head><!-- PageID 5434 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: September 2011 Venetian</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
        ...
        <li><a href="/international/korean.asp">한국어 </a></li>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/sept11.asp" class="footer">September 2011</a>&nbsp;&gt;&nbsp;September 2011 Venetian</div>
                        </div>
                         <div class="headerbox">
                            <h1>September 2011 Venetian</h1>
                        </div><br />
...
<div align="center">
    ...
    [ <a href="/exhibitors/newsletter/sept11.asp">News</a> ]
...
<br />
        ...
        The <a  href="http://www.cesweb.org/exhibitors/showPlanning/venetian-show-planning.asp">Venetian Exhibitor Manuals are now available exclusively online</a>. There are three Venetian manuals — one for exhibit space exhibitors (Hall D, Venetian Ballroom and Venetian meeting rooms), one for Venetian Tower exhibit suite exhibitors and one for hospitality suite exhibitors. Be sure to review the manual that pertains to you!<br />
        <br />
        These manuals contain shipping information, move-in and move-out details, rules and regulations, vendor orders forms and much more — all specific to Venetian exhibitors! Please contact <a  href="mailto:gberube@CE.org">Gaiya Berube</a> with any questions.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<br />
        ...
        </strong>Be sure to review the <a  href="http://www.cesweb.org/exhibitors/showPlanning/venetian-show-planning.asp#3945">checklist for Venetian Tower suite exhibitors</a> to stay on track with advance rate discounts and required form deadlines. Here are a few of the key upcoming deadlines to keep in mind:<br />
        <br />
        • November 1: Deadline to submit your desired furniture movement/bed removal floorplan <br />
        • November 1: Deadline to submit your Venetian Credit Card Authorization form <br />
        • November 1: Deadline to submit your Venetian Multiple Guest Authorization form <br />
        • November 1: Deadline to submit your Venetian Housekeeping Request form <br />
        • November 21-January 2: The window for freight to arrive at the GES warehouse and receive the advance freight rate, which is less expensive than the direct to show site rate <br />
        <br />
        <strong>Furniture Movement and Bed Removal Requests <br />
        </strong>For the 2012 show, The Venetian is once again providing a web-based tool for you to use in order to submit your exhibit suite <strong>furniture movement requests by November 1</strong>. This tool will allow you to see the exact dimensions of your exhibit suite, dimensions of the furniture, and provides you with the flexibility of moving around furnishings to various desired locations to see what best suits your needs. To learn more about this tool and to submit your desired suite furniture arrangements, please refer to section 3 of your <a  href="http://www.cesweb.org/exhibitors/showPlanning/venetian-show-planning.asp#4232">Venetian Tower Suite Exhibitor Manual</a>.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Venetian Exhibit Space Information</div>
<br />


        <strong>Key Deadlines for Hall D, Venetian Ballroom and Venetian Meeting Room Exhibitors<br />
        <br />
        </strong>Be sure to review the <a  href="http://www.cesweb.org/exhibitors/showPlanning/venetian-show-planning.asp#3944">checklist for Venetian exhibit space exhibitors</a> to stay on track with advance rate discounts and required form deadlines. Here are a few of the key upcoming deadlines to keep in mind:
        <ul>
            <li>October 1: Floor plans of your booth or meeting room exhibit must be submitted to the Fire Marshal by this date. For additional information on whether your booth or meeting room floor plan needs to be submitted, please refer to section 6 of your <a  href="http://www.cesweb.org/exhibitors/showPlanning/venetian-show-planning.asp#4232">Venetian Exhibit Space Manual<br />
            </a></li>
            <li>November 21-January 2: The window for freight to arrive at the GES warehouse and receive the advance rate, which is less expensive than the direct to show site rate</li>
            <li>November 30: Deadline to receive the advance rate on security services. We recommend you hire overnight security in the meeting room exhibits. To order security services, please refer to section 8 of your <a  href="http://www.cesweb.org/exhibitors/showPlanning/venetian-show-planning.asp#4232">Venetian Exhibit Space Manual</a></li>
        </ul>
