...
<head><!-- PageID 4132 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: VIP Buyer Gold Program</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/register/default.asp" class="footer">Register Staff/Buyers</a>&nbsp;&gt;&nbsp;VIP Buyer Gold Program</div>
                        </div>
                         <div class="headerbox">
                            <h1>VIP Buyer Gold Program</h1>
                        </div><br />
                        <div id="inner-content-long">
                                                                   
                            

<IMG style="MARGIN-LEFT: 5px" hspace=5 align=right src="/images/content/CES_VIP_Buyers_Program_small.jpg" width=127 height=83>Welcome to the VIP Buyer Gold Program for the 2012 International CES®. We know the four days of CES are very busy and therefore have designed these exclusive benefits to ensure your time at CES is productive. We greatly value your participation and encourage you to take advantage of the following benefits: <FONT size=2>
<H4>ADVANCED REGISTRATION </H4></FONT>Verified VIP Buyers from 2011 have been pre-registered for the 2012 International CES. You only need to log-in using your VIP password to confirm your registration and include your benefit preferences for the 2012 show. <STRONG>Verified buyers should have received their passwords via e-mail or postal mail by August 6, 2011.</STRONG> If you have not received anything from us, please send an e-mail to <A href="mailto:vipbuyer@ce.org">vipbuyer@CE.org</A>. To ensure you receive future communications regarding the VIP Buyer Program, please add <A href="mailto:vipbuyer@ce.org">vipbuyer@CE.org</A> to your approved domain names.&nbsp;&nbsp; 
<P><STRONG></P>
<H3><A href="http://registration3.experient-inc.com/ShowCES121/Default.aspx?Type=VIP">Access Your Registration Now!</A> </H3>
<P></A></STRONG><STRONG>New this year: </STRONG>You must confirm your car service by submitting your flight information with your&nbsp;benefit selections&nbsp;online before November 30, 2011. Your request for airport car service cannot be honored without your detailed flight information. </P>
<H4>AIRPORT CAR SERVICE</H4>
<P>Car service for the 2012 International CES will run from McCarran Airport to your hotel January 8-11. Return trips from your hotel back to McCarran Airport will run January 12-14. <BR><BR><FONT size=2></P></FONT><FONT size=2>
<H4>EVENING CAR SERVICE</H4>
<P></FONT>Complimentary car service will be provided to your hotel at the end of each day from two locations in the Las Vegas Convention Center (LVCC). Simply present your VIP Buyer Car Card at either location during the hours specified below. If you selected Evening Car Service during registration, your VIP Buyer Car Card will be included in your VIP Buyer Kit mailed in November.<BR><BR></P>
<P>
<TABLE border=0 cellSpacing=0 cellPadding=1 width="75%">
<TBODY>
<TR vAlign=top>
<TD vAlign=top><STRONG>Pick Up Points:<BR></STRONG></TD>
<TD>&nbsp;</TD>
<TD vAlign=top><STRONG>Hours of Operation for Return Service:</STRONG></TD></TR>
<TR vAlign=top>
<TD vAlign=top>LVCC, Central Hall,&nbsp;Lobby 5 Patio<BR>LVCC, South Hall, South&nbsp;1 Patio</TD>
<TD>&nbsp;</TD>
<TD vAlign=top>4-7 p.m. Tuesday, January 10<BR>4-7 p.m. Wednesday, January 11<BR>4-7 p.m. Thursday, January 12<BR>2-5 p.m. Friday, January 13</TD></TR></TBODY></TABLE></P>
<P></P>
<H4>VIP LUNCH</H4>
<P>Again this year, the VIP Buyer lunch will be&nbsp;offered the first&nbsp;two days of the show from 11:30 a.m.-2 p.m. Detailed information will be announced in the coming months.</P>
<H4>PRIORITY KEYNOTE SEATING</H4>
<P>Space is reserved and limited to one keynote ticket per person. Attendees with a VIP priority keynote seating ticket will be allowed to enter 30 minutes prior to general admission.&nbsp;Detailed information and the full <A href="/events/keynotes.asp">2012 CES keynote lineup</A> will be announced in the coming months.</P>
<H4>MARKET RESEARCH (Available in September) <BR><BR>SHOW FLOOR PLANS/EXHIBITOR LIST (Available in October) <BR><BR>CES PRE-SHOW PLANNER (Available in December)<BR></H4>
<P>The CES VIP Buyer Program is exclusive to retail companies and manufacturer representatives. Program participants are Senior Buyers, Merchandise Managers and Senior Executives. EA members, exhibitors and/or direct manufacturers are not eligible for program benefits and membership is based on alumni status and company size. Questions regarding this program should be directed to <A href="mailto:vipbuyer@ce.org">vipbuyer@CE.org</A>. </P>
