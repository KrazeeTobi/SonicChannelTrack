...
<head><!-- PageID 4370 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Conference Program Pricing</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div>Conference Program Pricing</div>
                        </div>
                         <div class="headerbox">
...
<SCRIPT type=text/javascript src="http://www.cesweb.org/conferenceProgram/fancybox/jquery.fancybox-1.3.2.js"></SCRIPT>
<LINK rel=stylesheet type=text/css href="http://www.cesweb.org/conferenceProgram/fancybox/jquery.fancybox-1.3.2.css" media=screen>
<SCRIPT language=javascript type=text/javascript>
        $(document).ready(function () {

                $("a#PricingSheet").fancybox({
                    'opacity': true,
                    'overlayOpacity': .7,
                    'overlayColor': '#333',
                    'padding': 10,
...
<P><STRONG>Exhibits Plus Pass</STRONG><BR>October 1, 2010-5 p.m. EST, December 31, 2010:&nbsp;$100<BR>After 5:01 p.m. EST December 31, 2010 -&nbsp;On-site:&nbsp;$200<BR>Allows access to exhibit show floor, keynote addresses, SuperSession and select conference sessions<BR><BR><BR><STRONG>All Access Pass<BR></STRONG>Includes the following tracks:&nbsp;Broadband Unlimited, Cable Conference at CES,&nbsp;CONNECTIONS™ Summit, Content in the Cloud, Digital Health Summit, Digital Hollywood, Emerging Technology, HigherEd Tech Summit, Home Entertainment and Lifestyle Technlogies, Flash Forward: Flash Memory Storage Solutions for Mobile Devices and Data Hungry Applications, In-Vehice Technologies, Issues and Attitudes, Just the Facts: Research, Reports and Revelation, Kids@Play &amp; MommyTech, Media Money Makers, Silvers Summit, Smart Grid Homes, Smartphone and Tablet Conference, Tech Policy Summit, Technology and The Environment,&nbsp;The Tweet House Presents: Social Media Success Stories and Wireless Communications.<BR><BR><BR><STRONG>Entertainment Matters Pass<BR></STRONG>Sponsored by:<BR>
<TABLE border=0 cellSpacing=1 cellPadding=1 width="70%">
<TBODY>
<TR>
<TD><IMG src="/images/content/Variety_200pw.jpg" width=150 height=42></TD>
<TD><IMG src="/images/content/Cricket_200pw.jpg" width=150 height=43></TD></TR></TBODY></TABLE><BR>Includes the following tracks: Cable Conference at CES, Content in the Cloud, Digital Hollywood, Emerging Technology, Home Entertainment and Lifestyle Technologies, In-Vehicle Technology, Issues and Attitudes, Just the Facts: Research, Reports and Revelation,&nbsp;Media MoneyMakers, Smartphone and Tablet Conference, Technology and The Environment,&nbsp;The Tweet House Presents: Social Media Success Stories and Wireless Communications.<BR><BR><BR><STRONG>Media Money Makers/Digital Hollywood Pass</STRONG><BR>Includes Media Money Makers and Digital Hollywood conference tracks.<BR><BR><BR><STRONG>CE Pass<BR></STRONG>Includes the following tracks: Digital Hollywood, Emerging Technology, Home Entertainment and Lifestyle Technologies, In-Vehcile Technology, Issues and Attitudes, Just the Facts: Research, Reports and Revelation, Technology and The Environment, and Wireless Communications<BR><BR><STRONG><BR>Single Session Pass</STRONG><BR>Includes one session within any of the following tracks:&nbsp;Cable Conference at CES, Digital Hollywood, Emerging Technology, Home Entertainment and Lifestyle Technologies, In-Vehcile Technology, Issues and Attitudes, Just the Facts: Research, Reports and Revelation, Media Money Makers, Smartphone and Tablet Conference, Technology and The Environment, and Wireless Communications.</P>
<P>&nbsp;</P>
<DIV style="TEXT-ALIGN: center" id=PricingSheetBlock>
<P><A href="http://www.cesweb.org/conferenceProgram/images/PricingSheet.pdf">Download a PDF of the pricing sheet</A></P><A id=PricingSheet href="http://www.cesweb.org/conferenceProgram/images/PricingSheet.png">Click the image to enlarge<BR><IMG alt="Pricing Sheet" src="http://www.cesweb.org/conferenceProgram/images/PricingSheetScaled.png"> </A></DIV>
