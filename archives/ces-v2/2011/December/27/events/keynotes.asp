...
Want a front-row-seat to the future of technology? Then attend the CES keynote addresses. The ideas and trends you'll hear are as big as the names of the people delivering them. But you can't see them unless you <A href="/register">register for the 2012 CES.</A><BR><BR><STRONG>Note: New this year,&nbsp;keynote addresses will be hosted in two different locations — the Las Vegas Hilton Theater and The Venetian, Level 5, Palazzo Ballroom.&nbsp;<BR></STRONG>&nbsp; 
<TABLE border=0 cellSpacing=1 cellPadding=0 width="100%">
<TBODY>
<TR width="40%">
<TD>&nbsp;<A class=showSlide href="#Steve-Ballmer"><IMG style="BORDER-BOTTOM: 0px solid; BORDER-LEFT: 0px solid; BORDER-TOP: 0px solid; BORDER-RIGHT: 0px solid" alt="" src="/images/content/Steve-Ballmer.gif"></A>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; <A class=showSlide href="#State-of-the-CE-Industry-Address-and-Opening-Technology-and-Evolving-Countries-(TEC)-Keynote"><IMG style="BORDER-BOTTOM: 0px solid; BORDER-LEFT: 0px solid; BORDER-TOP: 0px solid; BORDER-RIGHT: 0px solid" alt="" src="/images/content/Jacobs-Shapiro.gif"></A></TD>
<TD>&nbsp;<A class=showSlide href="#Dr.-Dieter-Zetsche"><IMG style="BORDER-BOTTOM: 0px solid; BORDER-LEFT: 0px solid; BORDER-TOP: 0px solid; BORDER-RIGHT: 0px solid" alt="" src="/images/content/Zetsche.gif" width=132 height=159></A></TD>
<TD>&nbsp;<A class=showSlide href="#Paul-Otellini"><IMG style="BORDER-BOTTOM: 0px solid; BORDER-LEFT: 0px solid; BORDER-TOP: 0px solid; BORDER-RIGHT: 0px solid" alt="" src="/images/content/Otellini.gif"></A></TD></TR>
<TR width="60%">
<TD>&nbsp;<A class=showSlide href="#CES-Innovation-Power-Panel"><IMG style="BORDER-BOTTOM: 0px solid; BORDER-LEFT: 0px solid; BORDER-TOP: 0px solid; BORDER-RIGHT: 0px solid" alt="" src="/images/content/Innovation-Power-Panel.gif"></A></TD>
<TD>&nbsp;<IMG src="/images/content/Vestberg.gif"><A class=showSlide href="#Hans-Vestberg"></A></TD>
<TD>&nbsp;<A class=showSlide href="#Robert-Kyncl"><IMG style="BORDER-BOTTOM: 0px solid; BORDER-LEFT: 0px solid; BORDER-TOP: 0px solid; BORDER-RIGHT: 0px solid" alt="" src="/images/content/Kyncl.gif" sborder="0"></A></TD></TR>
<TR>
<TD colSpan=3><BR><A class=showSlide href="#Brand-Keynote"><IMG border=0 src="/images/content/Brand-keynote.jpg"></A></TD></TR></TBODY></TABLE><BR><BR>
...
<div class="sub-page-slider">
    ...
    <div class="keynote-right-col">
        ...
        <P><STRONG>Microsoft Chief Executive Officer Steve Ballmer</STRONG> will deliver a preshow keynote address at the 2012 International CES in Las Vegas, Nevada. <BR><BR>“We are pleased to welcome Microsoft back to the CES keynote stage,” said Gary Shapiro, president and CEO, CEA. “From mobile to desktop to gaming and beyond, Microsoft has a significant impact on all aspects of the consumer technology industry, and Steve Ballmer's keynote is a great way to kick off the exciting 2012 International CES. We are excited to hear Microsoft’s latest initiatives and Ballmer’s vision for where consumer technology is heading.”<BR><BR>Microsoft has used the CES keynote stage in previous years to unveil innovative new products, including the original Xbox and Avatar Kinect.<BR></P>
    </div>
</div><div class="sub-slide">
    <div class="keynote-header" style="display:none;">
    ...
    <div class="keynote-right-col">
        ...
        <P>Dr.&nbsp;Paul E. Jacobs' keynote will be part of the Technology and Evolving Countries (TEC) Program at the 2012 CES, focused on the role mobile technology plays in global innovation and economic growth in consumer electronics.&nbsp; </P><!-- Start of Brightcove Player -->
...
<DIV align=center>
<OBJECT id=myExperience1316650026001 class=BrightcoveExperience><PARAM NAME="bgcolor" VALUE="#FFFFFF"><PARAM NAME="width" VALUE="280"><PARAM NAME="height" VALUE="237"><PARAM NAME="align" VALUE="right"><PARAM NAME="playerID" VALUE="26356940001"><PARAM NAME="playerKey" VALUE="AQ~~,AAAABh3C_dE~,zBkXqCU8KVYYG5utII4f8nND4rqBAlFX"><PARAM NAME="isVid" VALUE="true"><PARAM NAME="dynamicStreaming" VALUE="true"><PARAM NAME="@videoPlayer" VALUE="1316650026001"></OBJECT></DIV><!-- 
...
<P>Dr. Jacobs' keynote is slated for 8:30 a.m. Tuesday, January 10, in The Venetian, following a State of the CE Industry keynote address delivered by Gary Shapiro, president and CEO, CEA, the U.S. trade association representing more than 2,000 consumer electronics companies and owning and producing the International CES. <BR><BR>Shapiro led the industry in its successful transition to HDTV. He co-founded and chaired the HDTV Model Station and served as a leader of the Advanced Television Test Center (ATTC). He is a charter inductee to the Academy of Digital Television Pioneers, and received its highest award as the industry leader most influential in advancing HDTV. He focused on the need for and led the effort to obtain the 2009 cut-off date of analog broadcasting.&nbsp;He has received annual recognition from The Hill since 2006 as a "top lobbyist" in Washington. Also, Washington Life magazine has named him one of the 100 most influential people in Washington, D.C.&nbsp;</P>
    ...
    <div class="keynote-right-col">
        ...
        <br />
        <strong>Dr. Dieter Zetsche, Chairman of the Board of Management of Daimler AG and Head of Mercedes-Benz Cars</strong>, will deliver a keynote address at the 2012 International CES. The 2012 show marks Mercedes-Benz’ first International CES keynote address. <br />
        <br />
        ...
        <br />
        <strong>Interested in this keynote address? You may also like:<br />
        </strong><a  href="http://www.cesweb.org/showFloor/techzones.asp#5162">GoElectricDrive TechZone</a> <br />
        <a  href="http://www.cesweb.org/showFloor/techzones.asp#5170">Location Based Services TechZone <br />
        </a><a  href="http://www.cesweb.org/showFloor/techzones.asp#5174">The Safe Driver TechZone</a>
    ...
    <div class="keynote-right-col">
        ...
        <p>Paul Otellini, president and chief executive officer of Intel Corporation will deliver his keynote address on Day One of the 2012 CES, Tuesday, January 10, at 4:30 p.m. in The Venetian (Level 5, Palazzo Ballroom).<br />
        <br />
        Paul Otellini became Intel Corporation's fifth chief executive officer in May 2005. Since joining Intel in 1974, Otellini has managed several Intel businesses, including the company's PC and server microprocessor division and the global sales and marketing organization. Under Otellini's leadership, Intel aims to create and extend computing technology to connect and enrich the lives of every person on earth. </p>
    ...
    <div class="keynote-left-col">
        <img src="/images/content/2k12CES_InnovPan.jpg">
    </div>
    <div class="keynote-right-col">
        
        
        <h3>CES Innovation Power Panel</h3>
        <div>Xerox Corp., Verizon Communications and Ford Motor Company</div>
        <h4>9 a.m., Las Vegas Hilton Theater</h4>
        
        <p>Xerox Chairman and CEO Ursula Burns, Verizon President and CEO Lowell McAdam and Ford Motor Company President and CEO Alan Mulally will join the 2012 International CES keynote lineup as participants in the CES Innovation Power Panel. <br />
        <br />
