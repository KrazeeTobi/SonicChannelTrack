...
<head><!-- PageID 4421 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: November 2010</title>
...
<ul id="sub-sessions" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    <li onmouseover="showDropDown('sessions','show')" class="top"><a href="/conferenceProgram/default.asp" class="sublink"><!--<img src="/images/framework/secondarynav_sessions.gif" />--></a></li>
                    ...
                    <li onmouseover="showDropDown('sessions','show')" class="link"><a href="/conferenceProgram/sessions.htm">Session Grid</a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/exhibitors/default.asp-->
            ...
            <li class="selected"><a href="/exhibitors/newsletter/nov10.asp">November 2010</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;November 2010</div>
                        </div>
                        <div class="headerbox">
                            <h1>November 2010</h1>
                        </div>
...
<div align="center">
    ...
    [ <a href="/exhibitors/newsletter/nov10ops.asp">Operations</a> ]

    [ <a href="/exhibitors/newsletter/nov10ven.asp">Venetian Corner</a> ]
...
<div class="sub-content-header">Build Your Buzz! Video Contest Deadline Extension</div>
<br />

<IMG hspace=5 align=right src="/images/photos/clapboard.jpg" width=100 height=96>There’s still time to enter the 2011 International CES “Visit Me at CES” exhibitor video competition. Create an up to one minute long video that lets attendees know why they should visit your booth at CES. The deadline to submit your entry is now <STRONG>midnight November&nbsp;9 (P.T.).<BR></STRONG><BR>Voting will be open to the general public and the top five videos that receive the most votes will be featured on CESweb.org for the entire month of December leading up the show. Also, an announcement with the winners will be made in a CES press release. Don’t miss this great opportunity to build your buzz and get people excited for the 2011 show! <A href="http://www.cesweb.org/contest" target=_blank>Enter today</A>. &nbsp; <BR>&nbsp;<br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
<br />
...
<div class="sub-content-header">Offer Free Registration to Your Valued Customers </div>
<br />

<IMG hspace=5 align=right src="/images/photos/2011_exhibitor_invitation2.jpg" width=200 height=141>Getting your most valued prospects to CES is very important not only to you, but to us as well. That’s why CES is once again providing every exhibitor with ready-to-go, <A href="http://www.cesweb.org/exhibitors/sponsorships/freeOpps.asp#1925">complimentary invitations</A> to use to invite customers to the show. <A href="http://www.cesweb.org/exhibitors/sponsorships/freeOpps.asp#1925">Exhibitor invitations</A> are one of the most cost effective methods of using the branding power of CES to promote your company’s presence. <BR><BR>These invites, produced by CES, offer free advance registration up until <STRONG>December 15, 2010</STRONG>. Also with this invite, the $200 registration fee on-site is cut in half. Choose from electronic or printed versions. Work with our new partner, CGX Solutions, to customize your printed invitations with your choice of graphic, company logo, company name and message. <BR><BR><A href="http://www.cesweb.org/exhibitors/sponsorships/freeOpps.asp#1925">Order your 1,000 free invitations or download the PDF today</A>. <BR><br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
<br />
...
<div class="sub-content-header">Ten Reasons to Exhibit at CES Unveiled Events</div>
<br />

There are so many reasons to exhibit at a CES Unveiled event, but here are 10 we think might pique you interest: 
<UL class=text>
<LI class=text><IMG hspace=5 align=right src="/images/content/CES_Unveiled_event.gif" width=250 height=49>&nbsp;ABC </LI>
<LI class=text>CBS </LI>
<LI class=text>CNBC and NBC </LI>
<LI class=text>CNET </LI>
<LI class=text>Consumer Reports </LI>
<LI class=text>ESPN </LI>
<LI class=text><EM>Financial Times</EM> </LI>
<LI class=text>Fox </LI>
<LI class=text><EM>The New York Times</EM> </LI>
<LI class=text><EM>Wall Street Journal </EM></LI></UL><BR>Intrigued yet?<BR><BR>Unveiled@NY, November 9,&nbsp; and CES Unveiled in Las Vegas,&nbsp; January 4,&nbsp; offer valuable opportunities to promote your products either before the holiday sales cycle or two days before CES opens its doors. Already, over 500 media from the northeast have registered for the CES New York Press Preview featuring Unveiled@NY, and we expect more than 800 at Unveiled in Vegas.<BR><BR>A simple tabletop set-up makes it easy for your team to network with the top industry and consumer media, build relationships, and generate coverage. Getting the best PR value in the industry, exhibitors receive: 
<P></P>
<UL class=text>
...
<LI class=text>150-word product description and photo in the Unveiled program guide within <EM>Consumer Electronics Vision magazine</EM>, which is distributed at the press events, to CE Vision’s 23,000 industry readers and to thousands more on-site at the International CES. </LI>
<LI class=text>Your product displayed among Innovations 2011 Design and Engineering Awards Honorees’ products – a must-see for press and analysts.</LI></UL>
<P>CES Unveiled events are the best way to get the press buzzing about your products before the show. Sign up today to take advantage of all these pre-event promotional opportunities!<BR><BR>Contact: <A href="mailto:CESUnveiled@CE.org">CESUnveiled@CE.org</A>. Visit <A href="www.CESweb.org/CESUnveiled">CESweb.org/CESUnveiled</A> for more information.<BR></P>
<UL></UL><br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Reach New Foreign Markets at CES</div>
<br />

<IMG hspace=5 align=right src="/images/photos/Globe1.jpg" width=200 height=200>CEA is partnering with the U.S. Commercial Service to host the Global Matchmaking and International Reception on Thursday, January 6 at 6 pm. This event will connect U.S. consumer electronics companies with hundreds of foreign buyers in a reception setting beyond the show floor - the perfect opportunity for expanding your business into new global markets!<BR><BR>Through exhibiting in the Global Matchmaking and International Reception, you can achieve multiple objectives, including export sales, marketing and business development. You'll also meet and prospect new customers; network with foreign buyers and industry professionals; and entertain new contacts/partners/clients in a hospitable and professional venue.<BR><BR><A href="http://www.buyusa.gov/ict/gmir_ces_2011.html" target=_blank>Learn more about this event and how to purchase your tabletop display</A>. <BR>
...
<tr>
   ...
   Public Relations Specialist</p>
    ...
    <!-- article start -->
    <p><strong>Maximizing the 2011 International CES Media Machine </strong><br> 
by Allison Fried</p>
    <p><P>The 2011 International CES is just two short months away, and people are talking! Exhibitors, attendees and media are filling their appointment books, booking travel and starting the countdown. The world’s largest consumer technology tradeshow is right around the corner, and with more 5,000 press and bloggers packing their bags, you have to ask yourself, is your company ready?<BR><BR>Press coverage is vital to the marketing strategy of any successful business. CES provides an optimal opportunity to generate media coverage of your company and its products, a value that CES exhibitors continually rank as one of their top reasons for attending the show.<BR><BR>Our media attendees are a “who’s who” of the global press, from the national TV news shows to the top newspapers, radio stations, wire services, trade publications and online outlets, including ABC, the Associated Press, BBC, CBS, CNET, CNBC, LA Times, NBC, <EM>New York Times</EM>, <EM>Wall Street Journal</EM> and the <EM>Washington Post</EM>.<BR><BR>There are plenty of ways for you to reach the media attending the 2011 International CES, and we are here to help. Make sure you check out our <A href="/exhibitors/pr/prKit.asp">2011 CES Exhibitor PR Kit</A>. It is an extremely helpful resource full of tips for drafting press releases, creating eye-catching press kits and learning other great PR tactics that grab the media’s attention.<BR><BR>Our media season officially kicks off on November 9 at the New York Press Preview in New York City. Held in conjunction with CES Unveiled@NY, this event offers press an insider view of the products that will turn heads for the upcoming holiday season and make waves in January at CES. The media buzz continues on January 4 at CES Unveiled in Las Vegas, the official press event of International CES. This event draws more than 800 top-tier press who come for a sneak peak of what will be debuting on the CES show floor that week. If you want reach the media early, these are the places to do it! <BR><BR>Another great way to get in touch with our 5,000 plus media is to create a press kit for our on-site press room, S229 in the South Hall Connector of the LVCC. The press kit area for the 2011 CES will again be exclusively GREEN -- meaning your company’s press kits MUST be electronic. There are a couple of ways you can do this; you can bring in USBs or post a URL along with a one page spec sheet. You may also want to consider posting your news online through our <A href="/news/exhibitorNews.asp">Online Media Center</A>, hosted by BusinessWire. Remember that press kits are the media’s one-stop resource to find out all they need to know about your company and products.<BR><BR>Every year, the International CES spokespeople like me talk with thousands of reporters about hot products and new trends emerging at the show. If you want your product to be included in these discussions, please e-mail photos and details about your hot new product to <A href="mailto:hotproducts@CE.org">hotproducts@CE.org</A>. If you have a TV friendly product and are interested in having it shown on-air, contact Jim Barry, our digital answer man, at <A href="mailto:bosjim@comcast.net">bosjim@comcast.net</A> and send a brief description of your product for consideration. CES is also a great place for small businesses to make a big splash and get noticed. We are looking for innovative small business to profile in the Countdown to CES: 30 Days of Innovation. CNET editors are again working with CEA to highlight companies with extremely innovative NEW products for the 2011 CES. If you are a small business (with revenue under $30 million), you can send Laura Hubbard, <A href="mailto:lhubbard@CE.org">lhubbard@CE.org</A> a short product description and bio about your company/founder and you might just be selected for coverage in CNET.<BR><BR>Another fantastic tool we offer is the option for you to download and use the <A href="/exhibitors/pr/default.asp">CES pre-registered media list </A>(available November 3, 2010). The pre-registered media list contains contact information for all media and bloggers that have registered for the 2011 International CES. It is the perfect way to target select media that are interested in covering your company’s product category. It is password protected with your exhibitor ID number, so make sure you have it ready. If you aren’t sure of your Exhibitor ID number, please contact your Sales Representative.<BR><BR>And yes there is still time for you to schedule a press event. Companies who have major news to announce are encouraged to hold a press conference at CES. Each exhibitor is eligible to reserve one of our CES press conference rooms for free on a first come first serve basis. If you would like to take advantage of this option, please fill out our Press Conference Reservation Form and fax it into me ASAP.&nbsp;<BR><BR>Tell your story to the local media. To gain more regional coverage, participate in the <A href="http://www.cesweb.org/docs/Regional_Media_Outreach_-_2011_PR_Kit.pdf" target=_blank>CES Regional Media Outreach Campaign</A> and submit a quote from a company executive to be included in a press release sent to the media in your area.<BR><BR>Finally, the 2011 CES is all about Social Media! Want to be the first to know the latest CES and consumer electronics (CE) industry news? Visit <A href="http://blog.ce.org/" target=_blank>Digital Dialogue</A> which covers everything related to the CE industry, CEA happenings and of course, everything you need to know about the 2011 International CES. Regularly updated, the CEA blog provides updates on registration, events, keynotes, industry insiders, awards, transportation and more. We encourage guest blogging, and would like to extend an invitation for you to submit a guest blog post for Digital Dialogue. Your blog post can feature your company, products and services but only in an informative way – no straight sales pitches, please! If you would like to share your knowledge and passion for technology, please contact <A href="mailto: cslater@ce.org">Carolyn Slater</A> or 703-907-7945 for more information on becoming a guest blogger.<BR><BR>These are just a few helpful hints for reaching the CES media machine and maximizing your company’s media exposure at the 2011 International CES. Please feel free to contact me directly with any PR questions: <A href="mailto:afried@CE.org">afried@CE.org</A>. <BR></P></p>
    <!-- article end -->
    </span>
    </td>
</tr>
