...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/hotelTravel/default.asp" class="footer">Hotel/Travel</a>&nbsp;&gt;&nbsp;Hotel Reservations</div>
                        </div>
                         <div class="headerbox">
        ...
        <img width="165" height="125" alt="" style="float: right; margin-left: 5px; margin-right: 5px;"  width="165" height="125" src="/images/photos/Strip_165x125.jpg" />CES hotels are now accepting reservations for groups (10-20 rooms or more) and individual reservations. <a  href="/hotelTravel/blockRequest.asp">Submit your request now for a group</a> block or click the hotel names to book individual reservations. <br />
        <br />
        Please check the hotel's site for rates outside of the dates listed below. Rates and hotels updated as of November 29, 2011. Please note, every effort is made to keep this information up-to-date. However, rates are subject to change, as CES rates sell out. <br />
        <br />
        <strong>Note:</strong> As most CES hotels are sold out or sold out of the CES rate, a <a  href="#overflow">list of overflow hotels </a>has been added. There is no CES shuttle service to/from these overflow hotels.
...
<P style="LINE-HEIGHT: 12.75pt; BACKGROUND: white"><SPAN style="FONT-FAMILY: 'arial', 'sans-serif'; COLOR: #333333; FONT-SIZE: 9pt"><SPAN style="FONT-SIZE: 13px">The hotels below are the official 2012 International CES hotels. Complimentary CES shuttle service will be offered to/from these properties only. <A href="/hotelTravel/shuttle.asp">Visit the shuttle page to download a shuttle map and flyer for the 2012 CES. </A></SPAN></SPAN></P>
<P style="LINE-HEIGHT: 12.75pt; BACKGROUND: white"><SPAN style="FONT-FAMILY: 'arial', 'sans-serif'; COLOR: #333333; FONT-SIZE: 9pt"><SPAN style="FONT-SIZE: 13px"><A href="/hotelTravel/blockRequest.asp">Request your group block of 10-20 rooms or more </A>now or click the hotel names below to book individual reservations. </SPAN></SPAN></P>
<P style="LINE-HEIGHT: 12.75pt; BACKGROUND: white"><SPAN style="FONT-FAMILY: 'arial', 'sans-serif'; COLOR: #333333; FONT-SIZE: 9pt"><SPAN style="FONT-SIZE: 13px">For more information on a particular <SPAN style="FONT-FAMILY: arial">property</SPAN>, select the hotel's name to be directed to their website. From there, you can learn more about the hotel's available services and amenities.</SPAN></SPAN></P>
<P style="LINE-HEIGHT: 12.75pt; BACKGROUND: white"><SPAN style="FONT-FAMILY: 'arial', 'sans-serif'; COLOR: #333333; FONT-SIZE: 9pt"><SPAN style="FONT-SIZE: 13px">Note, as most hotels are sold out or sold of the CES rate,&nbsp;a <A href="#overflow">list of overflow hotels</A> has been added. There is no CES shuttle service to/from the overflow hotels. &nbsp;</SPAN></SPAN></P>
<br /><br />
...
<tr class="">
    <td valign="top">
        <a href="http://www.arialasvegas.com" target="_blank"><span class="smallText">ARIA*</span></a></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($199) sold out; prevailing rates apply </p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($279) sold out; prevailing rates apply </p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($279) sold out; prevailing rates apply </p>
    </span></td>
        ...
        <td valign="top"><span class="smallText">
        <p>CES rate ($239) sold out; prevailing rates apply </p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($239) sold out; prevailing rates apply </p>
    </span></td>
...
<tr class="alternateRows">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText">
        <p>CES rate ($219) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($279) sold out; prevailing rate applies </p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($319) sold out; prevailing rate applies </p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($319) sold out; prevailing rate applies</p>
        <p>&nbsp;</p>
        ...
        <td valign="top"><span class="smallText">
        <p>CES rate ($259) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($259) sold out; prevailing rate applies</p>
    </span></td>
...
<tr class="">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText"><P>$99</P></span></td>
        <td valign="top"><span class="smallText"><P>$99</P>
<P></P></span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($99) sold out; prevailing rate applies</p>
        <p>&nbsp;</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($99) sold out; prevailing rate applies </p>
        ...
        <td valign="top"><span class="smallText"><P>$99</P>
<P></P></span></td>        
        <td valign="top"><span class="smallText"><P>$59</P></span></td>
        <td valign="top"><span class="smallText"><P>$59</P></span></td>

        <td valign="top"><span class="smallText"></span></td>        
        <td valign="top"><span class="smallText"><P>Enter your CES travel dates under the Reservations tab to view 2012 CES rates</P></span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText"><P>$56.95</P></span></td>
        <td valign="top"><span class="smallText"><P>$56.95</P>
<P></P></span></td>
        <td valign="top"><span class="smallText"><P>$96.95</P></span></td>
        <td valign="top"><span class="smallText"><P>$96.95</P>
<P></P></span></td>        
        <td valign="top"><span class="smallText"><P>$71.95</P></span></td>        
        <td valign="top"><span class="smallText"><P>$86.95</P></span></td>
        <td valign="top"><span class="smallText"><P>$86.95</P></span></td>
...
<tr class="">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText"><P>$66.95</P></span></td>
        <td valign="top"><span class="smallText"><P>$81.95</P></span></td>
        <td valign="top"><span class="smallText"><P>$106.95</P></span></td>
        <td valign="top"><span class="smallText"><P>$106.95</P></span></td>        
        <td valign="top"><span class="smallText"><P>$81.95</P></span></td>        
        <td valign="top"><span class="smallText"><P>$101.95</P></span></td>
        <td valign="top"><span class="smallText"><P>$101.95</P></span></td>
...
<tr class="alternateRows">
    <td valign="top">
        <a href="http://www.cosmopolitanlasvegas.com" target="_blank"><span class="smallText">Cosmopolitan of Las Vegas</span></a></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($279) sold out; prevailing rates apply </p>
        <p>&nbsp;</p>
    </span></td>
...
<tr class="">
    <td valign="top">
        <a href="http://www.wynnlasvegas.com" target="_blank"><span class="smallText">Encore at Wynn</span></a></td>
        <td valign="top"><span class="smallText">
        <p>Sold out</p>
    </span></td>
        <td valign="top"><span class="smallText">
...
<tr class="alternateRows">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText"><P>$87.50</P></span></td>
        <td valign="top"><span class="smallText"><P>$87.50</P>
<P></P></span></td>
        <td valign="top"><span class="smallText"><P>$127.50</P></span></td>
        <td valign="top"><span class="smallText"><P>$127.50</P>
<P></P></span></td>        
        <td valign="top"><span class="smallText"><P>$87.50</P></span></td>        
        <td valign="top"><span class="smallText"><P>$127.50</P>
<P></P></span></td>
...
<tr class="">
    <td valign="top">
        <a href="http://www1.hilton.com/en_US/hi/hotel/LASLVGV-Hilton-Grand-Vacations-Suites-Las-Vegas-Convention-Center--Nevada/index.do" target="_blank"><span class="smallText">Hilton Grand Vacations Club Las Vegas - Studio</span></a></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($105) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($329) sold out; prevailing rate applies</p>
        <p> </p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($329) sold out; prevailing rate applies</p>
...
<tr class="alternateRows">
    <td valign="top">
        <a href="http://www1.hilton.com/en_US/hi/hotel/LASLVGV-Hilton-Grand-Vacations-Suites-Las-Vegas-Convention-Center--Nevada/index.do" target="_blank"><span class="smallText">Hilton Grand Vacations Club Las Vegas - 1 bedroom</span></a></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($135) sold out; prevailing rate applies</p>
        <p>&nbsp;</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($369) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($369) sold out; prevailing rate applies</p>
    </span></td>
...
<tr class="">
    <td valign="top">
        <a href="http://www1.hilton.com/en_US/hi/hotel/LASVSGV-Hilton-Grand-Vacations-Suites-on-the-Las-Vegas-Strip-Nevada/index.do" target="_blank"><span class="smallText">Hilton Grand Vacations Club on the LV Strip - Studio</span></a></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($95) sold out; prevailing rate applies</p>
        <p>&nbsp;</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($319) sold out; prevailing rate applies</p>
...
<tr class="alternateRows">
    <td valign="top">
        <a href="http://www1.hilton.com/en_US/hi/hotel/LASVSGV-Hilton-Grand-Vacations-Suites-on-the-Las-Vegas-Strip-Nevada/index.do" target="_blank"><span class="smallText">Hilton Grand Vacations Club on the LV Strip - 1 bedroom</span></a></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($125) sold out; prevailing rate applies</p>
        <p>&nbsp;</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($369) sold out; prevailing rate applies</p>
...
<tr class="">
    <td valign="top">
        <a href="http://www.lvhilton.com/" target="_blank"><span class="smallText">Las Vegas Hilton classic room</span></a></td>
        <td valign="top"><span class="smallText">
        <p>Sold out</p>
    </span></td>
        <td valign="top"><span class="smallText">
...
<tr class="alternateRows">
    <td valign="top">
        <a href="http://www.lvhilton.com/" target="_blank"><span class="smallText">Las Vegas Hilton premium room</span></a></td>
        <td valign="top"><span class="smallText">
        <p>Sold out</p>
    </span></td>
        <td valign="top"><span class="smallText">
...
<tr class="">
    <td valign="top">
        <a href="http://www.lvhilton.com/" target="_blank"><span class="smallText">Las Vegas Hilton resorts club room</span></a></td>
        <td valign="top"><span class="smallText">
        <p>Sold out</p>
    </span></td>
        <td valign="top"><span class="smallText">
...
<tr class="alternateRows">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText"><P>$104</P></span></td>
        <td valign="top"><span class="smallText"><P>$104</P>
<P></P></span></td>
        <td valign="top"><span class="smallText"><P>$147</P></span></td>
        <td valign="top"><span class="smallText"><P>$147</P>
<P></P></span></td>        
        <td valign="top"><span class="smallText"><P>$104</P></span></td>        
        <td valign="top"><span class="smallText"><P>$154</P></span></td>
        <td valign="top"><span class="smallText"><P>$154</P></span></td>
...
<tr class="">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText"><P>$157</P></span></td>
        <td valign="top"><span class="smallText"><P>$157</P>
<P></P></span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($257) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($257) sold out; prevailing rate applies</p>
    </span></td>        
        <td valign="top"><span class="smallText"><P>$157</P></span></td>        
        <td valign="top"><span class="smallText"><P>$207</P></span></td>
        <td valign="top"><span class="smallText"><P>$207</P></span></td>
...
<tr class="">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText"><P>$159</P></span></td>
        <td valign="top"><span class="smallText">
        <p>$299</p>
    </span></td>
        <td valign="top"><span class="smallText">
...
<tr class="alternateRows">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText">
        <p>CES rate ($85) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($145) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($235) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($235) sold out; prevailing rate applies</p>
    </span></td>        
        <td valign="top"><span class="smallText">
        <p>CES rate ($174) sold out; prevailing rate applies</p>
    </span></td>        
        <td valign="top"><span class="smallText">
        <p>CES rate ($150) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($115) sold out; prevailing rate applies</p>
    </span></td>
...
<tr class="">
    <td valign="top">
        <a href="https://reservations.mgmmirage.com/bookingengine.aspx?pid=010&host=offer&code=CES2012PR" target="_blank"><span class="smallText">New York New York*</span></a></td>
        <td valign="top"><span class="smallText">
        CES rate ($134) sold out; prevailing rate applies 
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($149) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($249) sold out; prevailing rate applies </p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($249) sold out; prevailing rate applies </p>
    </span></td>        
        <td valign="top"><span class="smallText">
        <p>CES rate ($169) sold out; prevailing rate applies </p>
    </span></td>        
        <td valign="top"><span class="smallText">
        <p>CES rate ($164) sold out; prevailing rate applies </p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($164) sold out; prevailing rate applies </p>
    </span></td>
...
<tr class="alternateRows">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText"><P>$189</P>
<P></P></span></td>
        <td valign="top"><span class="smallText"><P>$189</P>
<P></P></span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($189) sold out; prevailing rate applies</p>
        <p>&nbsp;</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($189) sold out; prevailing rate applies</p>
        ...
        <td valign="top"><span class="smallText"><P>$189</P>
<P></P></span></td>
        <td valign="top"><span class="smallText"><P>$189</P></span></td>
...
<tr class="alternateRows">
    <td valign="top">
        <a href="https://gc.synxis.com/rez.aspx?Hotel=17104&Chain=6946&arrive=1/2/2012&depart=1/3/2012&adult=1&child=0&group=CESAJIB" target="_blank"><span class="smallText">Riviera</span></a></td>
        <td valign="top"><span class="smallText">
        <p style="text-align: left;">CES rate ($79) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($159) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($109) sold out; prevailing rate applies </p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($209) sold out; prevailing rate applies </p>
        <p> </p>
    </span></td>        
        <td valign="top"><span class="smallText">
        <p>CES rate ($149) sold out; prevailing rate applies </p>
        ...
        <td valign="top"><span class="smallText"><P>$109</P>
<P></P></span></td>
        <td valign="top"><span class="smallText"><P>$109</P>
<P></P></span></td>
...
<tr class="">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText">
        <p>CES rate ($297) sold out; prevailing rate applies</p>
    </span></td>        
        <td valign="top"><span class="smallText">
        <p>$219</p>
    </span></td>
        <td valign="top"><span class="smallText"><P>$209</P></span></td>
...
<tr class="alternateRows">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText"><P>$197</P></span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($197) sold out; prevailing rate applies</p>
        <p> </p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($297) sold out; prevailing rate applies</p>
        ...
        <td valign="top"><span class="smallText"><P>$247</P></span></td>
        <td valign="top"><span class="smallText"><P>$247</P></span></td>
...
<tr class="">
    <td valign="top">
        <a href="https://reservations.treasureisland.com/cgi-bin/LANSAWEB?procfun+rn+resnet+res+funcparms+UP%28A2560%29:;CESstnd;?/" target="_blank"><span class="smallText">Treasure Island</span></a></td>
        <td valign="top"><span class="smallText">
        <p>$109</p>
    </span></td>
        <td valign="top"><span class="smallText">
...
<tr class="alternateRows">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText"><P>$55</P></span></td>
        <td valign="top"><span class="smallText"><P>$75</P></span></td>
        <td valign="top"><span class="smallText"><P>$144</P></span></td>
        <td valign="top"><span class="smallText"><P>$144</P></span></td>        
        <td valign="top"><span class="smallText">
        <p>$144</p>
    </span></td>        
        <td valign="top"><span class="smallText"><P>$115</P></span></td>
        <td valign="top"><span class="smallText"><P>$115</P></span></td>
...
<tr class="">
    <td valign="top">
        <a href="http://www.trumplasvegashotel.com" target="_blank"><span class="smallText">Trump International Las Vegas studio suite</span></a></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($109) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($229) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($229) sold out; prevailing rate applies</p>
    </span></td>
...
<tr class="alternateRows">
    <td valign="top">
        <a href="http://www.trumplasvegashotel.com" target="_blank"><span class="smallText">Trump International Las Vegas one bedroom suite</span></a></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($149) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($269) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($269) sold out; prevailing rate applies</p>
    </span></td>
...
<tr class="">
    <td valign="top">
        <a href="http://www.vdara.com" target="_blank"><span class="smallText">Vdara*</span></a></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($177) sold out; prevailing rates apply </p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($257) sold out; prevailing rates apply </p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($257) sold out; prevailing rates apply</p>
    </span></td>
        ...
        <td valign="top"><span class="smallText">
        <p>CES rate ($207) sold out; prevailing rates apply </p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($207) sold out; prevailing rates apply </p>
        <p>&nbsp;</p>
...
<tr class="alternateRows">
    <td valign="top">
        <a href="https://resweb.passkey.com/go/2012CES" target="_blank"><span class="smallText">The Venetian</span></a></td>
        <td valign="top"><span class="smallText">
        <p>$163</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>CES rate ($399) sold out; prevailing rate applies</p>
    </span></td>
        <td valign="top"><span class="smallText">
        <p>Sold out</p>
    </span></td>
...
<tr class="">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText"><P>$129</P></span></td>
        <td valign="top"><span class="smallText"><P>$211</P></span></td>
        <td valign="top"><span class="smallText">
        <p>Sold out</p>
        <p>&nbsp;</p>
    </span></td>
        ...
        <td valign="top"><span class="smallText"><P>$211</P>
<P></P></span></td>        
        <td valign="top"><span class="smallText"><P>$129</P></span></td>
        <td valign="top"><span class="smallText"><P>$129</P></span></td>
        ...
        <td valign="top"><span class="smallText"></span></td>        
        <td valign="top"><span class="smallText">
        <p><a  href="/hotelTravel/E7D6F1163C4C416EBF9040025A1DB705.htm">Click here</a> to view value adds being offered to CES guests</p>
    </span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
...
<br>
        ...
        <h4>*Rates include resort services (subject to change)</h4>
        <p>ARIA room rate includes the following resort services: Internet access (in-room and campus wide at City Center), local and  800 Number telephone calls, access to The Spa at ARIA Fitness Center, daily newspaper, airline boarding pass printing<br />
        <br />
        Bellagio room rate includes the following resort services: access to Hotel Fitness Center, wireless Internet in guest rooms, boarding pass printing in Hotel's Business Center, free local calls, free toll free calls<br />
        <br />
        Circus Circus room rate includes the following resort services: In-room internet service (daily), chips and Salsa at the Garden Grill, two free drinks at any Casino bar or Slots of Fun bar, two free ride passes for the Adventure Dome Theme Park, two Fitness passes, two free Midway games, 800/local calls up to 30 minutes maximum per call (daily), Resort Fun Book valued at approximately $100<br />
        <br />
        Excalibur room rate includes the following resort services: In-room wired Internet service, daily newspaper, Fitness Center admission, unlimited local, domestic long distance and toll-free telephone calls<br />
        <br />
        Luxor room rate includes the following resort services: In-room wired Internet service, daily newspaper, Nuture Fitness Center admission, unlimited local, domestic long distance and toll-free telephone calls<br />
        <br />
        Mandalay Bay room rate includes the following resort services: In-room wireless internet, cardio center admission (does not include Spa access), daily newspaper, local and 800-number calls, outgoing faxes and boarding pass printing at the Hotel Business Center.<br />
        <br />
        MGM Grand room rate includes the following resort services: Unlimited internet connection in guest rooms, unlimited local and toll-free telephone calls from guest rooms, $15 beverage credit per stay (for MGM Grand outlets, printing of boarding passes,limited printing, faxing, notary servces at Business Center<br />
        <br />
        Mirage room rate includes the following resort services: Daily newspaper at Impulse and Bell Desk, Cardio Center admission (does not include Spa access), in-room robes, unlimited notary, unlimted incoming fax and 20 outgoing fax services &amp; airline boarding pass printing at The Mirage Business Service Center, unlimited local and toll free telephone calls and in-room internet access</p>
        <p>Monte Carlo room rate includes the following resort services: In-room Internet; Fitness Center access; USA Today newspaper; local and 800-number calls and complimentary Business Center Services.</p>
        <p>New York New York room rate includes the following resort services: Internet Access in Guestrooms, Daily Fitness CInternet Access in Guest Rooms, Daily Fitness Center Access, Unlimited Local and Toll Free Calls, Use of Calling Cards and Collect Calls from Guest Room,  free Boarding Pass Printing, Notary Services, Incoming and Outgoing Faxes (limit of 5 pages total).  A Daily Newspaper will be available for pickup at our Essentials store. <br />
        <br />
        Signature at MGM room rate includes the following resort services: Access to Signature Fitness Centers (2 centers, 24/7 access), 2 bottles water in suite/day, In-Room coffee &amp; tea, unlimited Internet connection throughout towers, unlimited local and toll-free telephone calls from suites, daily newspaper, valet parking<br />
        <br />
        THEhotel at Mandalay Bay room rate includes the following resort services: In-room wireless internet, cardio center admission (does not include Spa access), daily newspaper, local and 800-number calls, outgoing faxes and boarding pass printing at the Hotel Business Center. <br />
        <br />
        Vdara room rate includes the following resort services: Internet access (in-room and campus wide at City Center), local and 800 Number telephone calls, access to The Spa at ARIA Fitness Center, daily newspaper, airline boarding pass printing. </p>
        <a name="overflow"></a>
        <table style="background-color: #d3d3d3;" border="1" cellspacing="0" bordercolor="#778899" cellpadding="3" width="95%">
            <tbody>
                <tr>
                    <td>
                    <h2>Overflow Hotels</h2>
                    <p>Note, there is no CES shuttle service to/from these hotels. </p>
                    <p><a  target="_blank" href="http://www.theblairhousesuites.com/rates-and-specials"><strong>Blair House Suites Las Vegas<br />
                    </strong></a>344 E. Desert Inn Rd., Las Vegas, NV 89109. This hotel is offering a rate of $135 for a room with two doubles or Deluxe one King bed suite. Click on hotel name to book or call 800-553-9111. Rate includes free wi-fi. </p>
                    <p><a  target="_blank" href="http://www.ichotelsgroup.com/candlewood/hotels/us/en/las-vegas/laspd/hoteldetail"><strong>Candlewod Suites- Las Vegas<br />
                    </strong></a>4034 South Paradise Rd., Las Vegas, NV 89169. This hotel is offering a rate of $180.99 for a studio suite and $199.99 for a one bedroom suite. Call 702-836-3660 to book. </p>
                    <p><a  target="_blank" href="http://www.clarionhotel.com/hotel-las_vegas-nevada-NV092"><strong>Clarion Hotel and Casino<br />
                    </strong></a>305 Convention Center Drive, Las Vegas, NV 89109. This hotel is offering a rate of $129. Call 702-952-8000 to book. </p>
                    <p><a  target="_blank" href="http://www.hiexpress.com/hotels/us/en/las-vegas/lasrr/hoteldetail"><strong>Holiday Inn Express South<br />
                    </strong></a>5760 Polaris Avenue, Las Vegas, NV 89118. This hotel is offering a rate of  $199 plus tax. Rates include high speed, wireless Internet access, fitness center access and a free shuttle to MGM, Mandalay Bay, Town Square and McCarran airport. Call 702-736-0098 to book. </p>
                    <p><a  target="_blank" href="http://www.palms.com"><strong>Palms Casino Resort<br />
                    </strong></a>4321 W. Flamigo Rd., Las Vegas, NV 89103. This hotel is offering a rate of $189 January 9-12, $99 January 8 and $139 January 13-14. Rates do not include $15 resort fee. <a  target="_blank" href="/docs/PALMS_CASINO_RESORT_FEE_Inclusions_Listing.pdf">See this PDF for a list of resort fee inclusions. </a>Call 702-942-7064 to book and reference CES 2012/CACES12</p>
                    <p><a  target="_blank" href="http://www.palms.com"><strong>Palms Place Hotel and Spa<br />
                    </strong></a>4381 W. Flamingo Rd., Las Vegas, NV 89103. This hotel is offering a rate of $199 January 9-12, $109 January 8 and $149 January 13-14. Rates do not include $15 resort fee. <a  target="_blank" href="/docs/PALMS_CASINO_RESORT_FEE_Inclusions_Listing.pdf">See this PDF for resort fee inclusions.</a> Call 702-942-7064 to book and reference CES 2013/PACES12</p>
                    <p><a  target="_blank" href="http://www.ichotelsgroup.com/h/d/sb/1/en/hotel/lasru"><strong>Staybridge Suites Las Vegas<br />
                    </strong></a>5735 Dean Martin Dr., Las Vegas, NV 89118. This hotel is offering a rate of $199 one bedroom suite/$219 deluxe one bedroom suite . Call 702-259-2663 to book. Rates include buffet breakfast all days and dinner Tuesday- Thursday. Call 702-736-0098 to book.</p>
                    </td>
                </tr>
            </tbody>
        </table>
        <p> </p>
        <h4>Housing Agency/Bureau Policy</h4>
