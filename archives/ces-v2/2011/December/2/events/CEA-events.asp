...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        CEA sponsors a variety of events - for the entire industry and individual niches within it - to educate the masses and unite manufacturers, retailers and market movers. From <a  href="/events/sinoces.asp">SINOCES</a> to the CEA Industry Forum and Fall Conference, CEA works year 'round to grow and shape the future of consumer electronics. <a  target="_blank" href="http://www.ce.org/Events/default.asp">Check out upcoming CEA events</a> such as:<br />
        ...
        </strong>February 28-2, 2012 <br />
        The Lodge at Vail <br />
        Vail, CO<br />
        <br />
        <br />
        <strong>2012 Spring Technology &amp; Standards Forum <br />
        </strong>May 14-18, 2012 <br />
        Dallas, TX<br />
        <br />
        <br />
        <strong>CEA Industry Forum <br />
        </strong>October 14-19, 2012 <br />
        The Westin St. Francis <br />
        San Francisco, CA<br />
        <br />
        <br />
        <strong>CEO Summit and Board Retreat <br />
