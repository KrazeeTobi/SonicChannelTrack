...
<div class="alert-box">                        
   ...
   <h2>Exhibitor's Source</h2>
    ...
    <p>
        <a  href="http://www.cesweb.org/exhibitors/newsletter/default.asp">In this month's issue</a>:
        <ul class="text">
            <li class="text">Free CES registration for your guests </li>
            <li class="text">Hiring booth security</li>
            <li class="text">Attendee list rental</li>
        </ul>
    </p>
   ...
   <h2>Register Staff/Buyers</h2>
    ...
    <A href="mailto:linda.buckley@variety.com?subject=CES%20Dailies%20Advertising%20Information"><img src="/docs/CES-DAILIES_226x200.jpg" width="227" height="200"></A>
</div><div class="promo-box">
