...
<head><!-- PageID 1129 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/international/default.asp-->
            ...
            <li class="selected"><a href="/international/french.asp">Français</a>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Visitors</a>&nbsp;&gt;&nbsp;Français</div>
                        </div>
                         <div class="headerbox">
                            <h1>Français</h1>
                        </div><br />
...
<H3>Les plus grands esprits de notre industrie se rencontrent ici</H3>Chaque année, les innovations les plus perfectionnées peuvent être vues sous un même toit. Soyez présent du 10 janvier au 13 janvier 2012 à Las Vegas, au Nevada, USA, au plus important salon des technologies de consommation du monde. <A href="/register">Inscrivez-vous dès à présent</A> et préparez-vous à rencontrer penseurs, créateurs, leaders d’industrie et innovateurs, et avec eux les produits qu’ils créent : des produits destinés à changer nos vies.
...
<div class="sub-content-header">Information pour les visiteurs étrangers</div>
<br />


        <p><a  href="http://cesweb.org/international/french/travel.asp">Information de voyage et de visa</a><br />
        Utiliser ces informations utiles pour les voyages aller-retour vers les États-Unis.<br />
        <br />
        <a  href="/international/french/hotels.asp">Réservations d'hôtel</a> <br />
        ...
        <br />
        <a  href="/international/french/delegations.asp">Programme de groupes de délégation<br />
        </a>Le Salon CES International attire un large public international grâce à son excellent programme de délégation. Découvrez comment créer ou rejoindre une délégation dans votre pays ou dans votre région.</p>
        <p><a  href="/international/french/services.asp">Services internationaux<br />
        </a>Parmi les nombreux avantages offerts aux participants internationaux, il faut citer des interprètes, des réceptions spéciales de prises de contact, des espaces de travail, des salles de réunion, etc.<br />
        <br />
        <a  target="_blank" href="/docs/HI_RES_FR_2K12_CESfactSheet_Web.pdf">Informations générales (pdf)<br />
        </a>Découvrez l’histoire du Salon, les catégories de produits, les dates des futurs salons, etc. <br />
        <br />
        <a  href="/international/french/shuttles.asp">Service de Navette<br />
        </a>L’exposition CES offre un service de navette gratuit durant les quatre jours que dure l’exposition International CES.</p>
        <p><a  target="_blank" href="/images/content/ADVANCE_DOMESTIC_REGISTRATION-FR.pdf">Formulaire d’inscription des Visiteurs</a><br />
        Avez-vous besoin d’aide pour compléter votre formulaire d’inscription ? <a  target="_blank" href="/docs/ADVANCE_DOMESTIC_REGISTRATION-FR.pdf">Téléchargez un exemplaire du formulaire d’inscription des visiteurs dans votre langue maternelle.</a> Veuillez noter que, bien que ce formulaire soit valide, nous vous conseillons de remplir <a  href="http://cesweb.org/register">le formulaire d’inscription en ligne</a>, qui bénéficiera du traitement le plus efficient.</p>
...
<div class="right-blue-box" align="center">
    ...
    <div>
        <br />
        Saviez-vous que les délégations internationales de 15 participants et plus reçoivent une inscription gratuite à Exhibits Plus? <A href="/international/french/delegations.asp">Pour en savoir plus.</A> 
        <br /><br />
    </div>
</div>
<div class="right-blue-box" align="center">
