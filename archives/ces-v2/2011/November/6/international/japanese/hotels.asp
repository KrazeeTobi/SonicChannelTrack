...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <br />
        ホテルと料金の全リストは<a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a> (英語のみ) をご覧ください。CES向け料金でのご利用には、<a  href="http://www.CESweb.org/hotel">www.CESweb.org/hotel</a>でホテル名を選択し、直接ホテルにご予約いただく必要があります。このサイトから直接ホテルの予約ページに移行し、そこでクレジットカード情報を入力することができます。<br />
        <br />
