...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <br />
        Please check the hotel's site for rates outside of the dates listed below. Rates and hotels updated as of November 7, 2011. Please note, every effort is made to keep this information up-to-date. However, rates are subject to change, as CES rates sell out. <br />
        <br />
...
<tr class="alternateRows">
    <td valign="top">
        <a href="https://reservations.mgmmirage.com/bookingengine.aspx?pid=MCH&host=group&code=XCESHR2" target="_blank"><span class="smallText">Monte Carlo*</span></a></td>
        <td valign="top"><span class="smallText">
        <p>$149</p>
    </span></td>
        <td valign="top"><span class="smallText">
