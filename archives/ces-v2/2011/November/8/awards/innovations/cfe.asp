...
<head><!-- PageID 313 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
...
// javascript for e-mail this page tool - gets the url of the page the user is on before the e-mail page tool button is clicked
	...
	<form name="registration_form" action="/awards/innovations/cfe.asp" method="post" onSubmit="return validate_reg_form();">
