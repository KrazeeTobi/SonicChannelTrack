...
<div class="alert-box">                        
        ...
        <p><a  href="/events/mobile-apps.asp">Mobile Apps Showdown creators are now accepting nominations.</a></p>
   ...
   <h2>Last Gadget Standing</h2>
    ...
    <p>
        <a  href="/events/last-gadget-standing.asp"><img alt="" style="float: right;"  src="/images/content/LastGadgetStanding_mini.jpg" />Last Gadget Standing</a> challenges contenders to give the product demo of their lives. Guest emcees Gary Dell'Abate and Jon Hein from the Howard Stern Show will host the event.
    </p>
</div><div class="grid-box">
   ...
   <h2>Mobile Apps Showdown</h2>
    ...
    <A href="http://www.cesweb.org/faq/exhibitorFAQs.asp#1861"><img src="/docs/MmbershipSD_Badge8.22.jpg" width="227" height="200"></A>
</div><div class="promo-box">
