...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <br />
        Note: New this year, keynote addresses will be hosted in two different locations — The Venetian and the Las Vegas Hilton Theater. Select the arrows in the green bar below to see the current keynote lineup and each speaker's respective venue.<br />
        <br />
         
...
<div class="sub-page-slider">
    ...
    <div class="keynote-right-col">
        ...
        <h3>Dr. Paul E. Jacobs</h3>
        <div>Chairman and CEO of Qualcomm</div>
        <h4>8:30 a.m., The Venetian</h4>
        ...
        <p>The TEC Program at CES shines a spotlight on technology's critical role in enabling economic, social and political empowerment opportunities for evolving countries and their citizens. Additional TEC sessions will be announced later this fall. </p>
        <p>To hear Dr. Paul Jacobs' thoughts on the significance of this keynote and what he will cover, please visit his new post on Qualcomm's OnQ blog. </p>
    ...
    <div class="keynote-right-col">
        ...
        <br />
        <strong>Dieter Zetsche, Chairman of the Board of Management of Daimler AG and Head of Mercedes-Benz Cars</strong>, will deliver a keynote address at the 2012 International CES. The 2012 show marks Mercedes-Benz’ first International CES keynote address. <br />
        <br />
    ...
    <div class="keynote-right-col">
        ...
        <h3>Hans Vestberg</h3>
        <div>President and Chief Executive Officer of Ericsson Group</div>
        <h4>1 p.m., The Venetian</h4>
...
<div class="keynoteschedule">
    ...
    <div><strong>6:30 p.m., The Venetian</strong></div>
...
<div class="keynoteschedule">
    ...
    <div><strong>8:30 a.m., The Venetian</strong></div>
    <div>Dr. Paul E. Jacobs</div>
    <div>Chairman and CEO of Qualcomm</div>
</div>
...
<div class="keynoteschedule">
    <h3>Tuesday, January 10, 2012</h3>
    <div><strong>4:30 p.m., The Venetian</strong></div>
...
<div class="keynoteschedule">
    <h3>Wednesday, January 11, 2012</h3>
    <div><strong>1 p.m., The Venetian</strong></div>
