...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li ><a href="/Awards/InnovationAwards/2011honorees.htm">2011 Innovations Honorees</a></li>
    ...
    <div class="icon-wrap">
        ...
        <img width="137" height="168" alt="" style="float: right;"  width="137" height="168" src="/images/content/CES-251_2k12_Innovations_SAMPLE_PC.JPG" />Since 1976, the prestigious Innovations Design and Engineering Awards has given consumer technology manufacturers and developers an opportunity to have their newest products judged by a preeminent panel of independent industrial designers, independent engineers and members of the trade press. It's the place to see, touch, feel and understand the future of consumer technology.<br />
        <br />
        <a  target="_blank" href="http://cea.mblast.com/ws/wfaward/rsp/identification.asp?GUID=204323&ContactType=Nominee&GUIDType="></a>Products chosen as the most impressive in each category are selected as honorees and can be seen at CES in the <a  href="/showFloor/techzones.asp#4115">Innovations Design and Engineering Awards Showcase</a> in the <a  href="http://www.cesweb.org/showFloor/by-hall.asp">Venetian Ballroom.</a>
...
<TD width="50%">August 15, 2011</TD></TR>
<TR>
<TD>Early-bird Deadline</TD>
<TD>August 31, 2011</TD></TR>
<TR>
<TD>Online Entry Process Ends</TD>
<TD>September 16, 2011</TD></TR>
<TR>
<TD>Innovations Judging</TD>
<TD>September&nbsp;26&nbsp;- October 7,&nbsp;2011</TD></TR>
<TR>
<TD>Entrants Notified</TD>
<TD>October 17, 2011</TD></TR>
<TR>
<TD><A href="http://cesweb.org/Awards/InnovationAwards/2011honorees.htm">Innovations Honorees Announced</A></TD>
<TD>November 8, 2011**</TD></TR></TBODY></TABLE><BR>*This is the final deadline. Access to the site will be disabled at&nbsp;11:59&nbsp;p.m. (EST) Friday, September 16, 2011. <BR><BR>**Innovations Honorees will be announced in New York at the 2012 International CES Press Preview. If a company does not wish to have their product announced, companies should indicate&nbsp;so on the online entry form, or by e-mail by October 28, 2011. The Innovations Awards Team will do its best to delay the product announcement until the opening of International CES.&nbsp;However, we can make no guarantees. <BR><BR>
<H4>Program Fees (Per Entry)</H4><BR>Submit your entries before&nbsp;August 31, 2011&nbsp;and save $200.</BLOCKQUOTE></BLOCKQUOTE>
<BLOCKQUOTE>
<BLOCKQUOTE>
<TABLE border=1 cellSpacing=0 cellPadding=3 width="80%">
<TBODY>
<TR>
<TD>&nbsp;</TD>
<TD vAlign=top>Early-bird Entry Fee<BR>(Deadline: August 31) </TD>
...
<TD vAlign=top>$1,200</TD></TR></TBODY></TABLE><BR><A href="http://www.ce.org/Membership/JoinCEA/default.aspx" target=_blank>Become a member of CEA.</A><BR><BR>E-mailed or hard-copy entries not accepted.<BR>E-mailed or hard-copy visuals not accepted.</BLOCKQUOTE></BLOCKQUOTE>
    ...
    The Innovations 2012 online entry process is easy to use. It includes: 
<UL class=text>
...
<LI class=text>Video link tool</LI></UL><BR>Apply online between August&nbsp;15 and September 16, 2011.
    <br />
    <br />
...
<UL class=text>
<LI class=text>Receive additional exposure by displaying your product in the Innovations Design and Engineering Awards Showcase at the 2012 International CES (for official International CES exhibitors only).&nbsp;&nbsp; </LI>
...
<LI class=text>Receive a beautiful Innovations 2012 Design &amp; Engineering award to display in your booth and in your company's trophy case.</LI>
<LI class=text>Receive a listing in the Innovations 2012 on-site directory (for official International CES Exhibitors only). </LI>
...
<LI class=text>Take advantage of advertising opportunities in CEA's CE VISION magazine. Innovations honorees receive substantial discounts. Contact <A href="mailto:Innovations@CE.org">Innovations@CE.org</A> for more information.</LI></UL>
    <br />
    <br />
    ...
    <div class="keynote-header-bak">
        ...
        If you've recently introduced a product that has raised the standard of consumer electronics innovation, chances are it deserves an Innovations 2012 Design and Engineering Award.
        <p> </p>
        ...
        <ul class="text">
            ...
            <li class="text">Products entered must be available for sale or accessible to the public in U.S. retail outlets or on the Internet between April 1, 2011, and April 1, 2012. </li>
            <li class="text">Entries must be submitted, in full, via the online entry process.   </li>
            <li class="text">If you are a CES exhibitor, one sample of your Innovations honoree product (mock-ups or the final product) must be available for display in the Innovations Showcase at the 2012 International CES, from January 10-13, in Las Vegas, Nevada. Best of Innovations Honorees must allow CEA to hold one sample of the product for up to one year, for display at other CEA-related events. </li>
            <li class="text">Download a complete copy of the <a  href="/docs/2K12Innovations_Rules.pdf">Innovations 2012 Design and Engineering Awards Rules and Eligibility</a>. </li>
            <li class="text">Unless indicated otherwise on the application, honorees will be announced at the 2012 International CES Press Preview event in New York, November 8, 2011, and will be included in the launch of the honoree portion of the International CES website (see contest rules).</li>
        </ul>
        <p> </p>
        Companies not exhibiting at CES may also enter the Innovations 2012 competition; however, restrictions apply if selected as an honoree (see contest rules).
        <p> </p>
        ...
        <ul class="text">
            ...
            <li class="text">Products entered must fit within one or more of the official award categories. You are allowed to enter your product into more than one category, if you choose. However, a separate application and payment must be submitted. </li>
            <li class="text">Products entered must be available for sale or accessible to the public at U. S. retail outlets or on the Internet between April 1, 2011, and April 1, 2012. </li>
            <li class="text">Honorees will be announced at the 2012 International CES Press Preview event in New York, November 8, 2011 or the first day of International CES. </li>
            ...
            <li class="text">Non-International CES exhibitors may enter the Innovations 2012 competition. However, non-exhibitor honoree product will not be included for display in the Innovations 2012 Design and Engineering Showcase and will not be listed in the on-site honoree directory in CE VISION, if the company has not fully paid for an exhibit space by October 28, 2011. However, if the company has fully paid for an exhibit space by October 28, 2011, they can be listed in the onsite directory and have their product displayed in the Innovations Design and Engineering Showcase. </li>
            <li class="text">Entries must be submitted, in full, via the online entry process by the Call for Entries deadline, September 16th. </li>
            ...
            <li class="text">All entries must be submitted via the online submission process. E-mailed and hard-copy entries will not be accepted.  </li>
            <li class="text">At least two DIFFERENT product photographs must accompany each entry. Computer renderings are not acceptable. Entries may include up to five photos. Photos must be submitted in a .jpg format. Each photo should be less than 3MB. All photos must be submitted via the online submission process. E-mailed and hard-copy photos will no longer be accepted. </li>
            ...
            <li class="text">Entries must be paid using a credit card. Checks and invoice payments are not accepted. </li>
    ...
    <DT face="Times New Roman"><SPAN style="WIDOWS: 2; TEXT-TRANSFORM: none; TEXT-INDENT: 0px; BORDER-COLLAPSE: separate; FONT: medium 'Times New Roman'; WHITE-SPACE: normal; ORPHANS: 2; LETTER-SPACING: normal; COLOR: rgb(0,0,0); WORD-SPACING: 0px; -webkit-border-horizontal-spacing: 0px; -webkit-border-vertical-spacing: 0px; -webkit-text-decorations-in-effect: none; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px" class=Apple-style-span><SPAN style="TEXT-ALIGN: left; LINE-HEIGHT: 17px; FONT-FAMILY: Arial, Helvetica, sans-serif; FONT-SIZE: 12px" class=Apple-style-span>
<TABLE border=0 cellSpacing=1 cellPadding=1 width="100%">
<TBODY>
<TR>
<TD vAlign=top>
<P style="COLOR: rgb(51,51,51)"><FONT face=Sans-Serif>Audio Components<BR>Computer Accessories<BR>Computer Hardware &amp; Components<BR>Computer Peripherals<BR>Digital Imaging<BR>Eco-Design and Sustainable Technology<SPAN class=Apple-converted-space>&nbsp;</SPAN><BR>Embedded Technologies<BR>Gaming Hardware &amp; Accessories&nbsp;<BR>Headphones<BR>Health and Wellness<BR>High-Performance Home Audio<BR></FONT></P></TD>
<TD vAlign=top>
<P style="COLOR: rgb(51,51,51)"><FONT face=Sans-Serif>Home Networking<BR>Home Theater Audio/Video Accessories<BR>Home Theater Speakers<BR>Integrated Home Systems<BR>In-Vehicle Accessories<BR>In-Vehicle Audio/Video<BR>In-Vehicle Navigation/Control/Telematics<BR>Major Home Appliances<BR>Multi-Room Audio/Video<BR>Online Audio/Video Content &amp; Delivery<BR>Personal Electronics<BR></FONT></P></TD>
<TD vAlign=top>
<P style="COLOR: rgb(51,51,51)"><FONT face=Sans-Serif>Portable Home Appliances<BR>Portable Media Players<BR>Portable Multimedia Accessories<BR>Portable Power<BR><FONT color=#00008b><EM><STRONG>NEW!</STRONG></EM><SPAN class=Apple-converted-space>&nbsp;</SPAN></FONT>Software &amp; Mobile Apps<BR><STRONG><EM><FONT color=#00008b>NEW!</FONT><SPAN class=Apple-converted-space>&nbsp;</SPAN></EM></STRONG>Tablets, E-Readers &amp; Netbooks<BR>Video Components<BR>Video Displays<SPAN class=Apple-converted-space>&nbsp;</SPAN><BR>Wireless Handsets<BR>Wireless Handset Accessories</FONT></P></TD></TR></TBODY></TABLE></SPAN></SPAN><BR>Need more information? View&nbsp;awards category definitions&nbsp;by downloading the <A title="2012 Innovations Category Guide" href="/docs/8691_Category_Guide.pdf" target=_blank>2012 Innovations Awards Category Guide</A>, detailing examples of products for each category.
    <br />
    <br />
...
<LI>Complete, submit, and pay for&nbsp;your entry online between Monday, August&nbsp;15 and Friday, September 16, 2011. </LI>
<LI>E-mailed and/or hard copy submission forms are not accepted.</LI></OL>
<P><STRONG>Remember:</STRONG> You must provide a minimum of two different photos of your product (we encourage more). Computer renderings are not acceptable. Images must be submitted in .jpg format. All photos must be submitted via the online submission process.</P>
    ...
    <div class="keynote-header-bak">
        ...
        <ul class="text">
            ...
            <li class="text">Don't submit an entry that will not be commercially available by April 1, 2012. </li>
            <li class="text">Don't submit an entry that has been commercially available before April 1, 2011. </li>
            ...
            <br />
            Remember: If you are selected as an honoree and a 2012 International CES exhibitor, you are required to make your product available for the Innovations Showcase during the 2012 International CES, January 10-13, 2012.  <strong>Products must arrive at International CES by January 8, 2012.</strong> </li>
        </ul>
