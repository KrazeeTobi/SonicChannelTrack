...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <p><img width="348" height="93" alt="" style="float: right;"  width="348" height="93" src="/images/content/CES_DevUnLogo.png" />The world of apps, APIs and platforms is evolving at an exponential pace with new systems being opened up every day for third party developers and existing systems releasing new version of the SDKs, tools and APIs. How does an app developer keep up to date with all these changes?<br />
        <br />
        Developer University at CES is a unique event brought to you by the Consumer Electronics Association (CEA) where developers can go to one place to learn about the latest developer programs directly from multiple company representatives.<br />
        <br />
        Interested in presenting at the Developer University? Contact Deepak Joseph at <a  href="mailto:djoseph@CE.org">djoseph@CE.org</a>.</p>
        <h3>Event Details</h3>
        Developer University at CES is the venue for OEMs/Platform-Vendors/Service-Providers to showcase their platforms, tools, API and SDKs to developers. The event will cover TV apps, device APIs, third-party API, web apps, desktop apps, mobile apps and more.<br />
        <br />
        <ul class="text">
            <li class="text"><strong>Location:</strong> Las Vegas Convention Center (LVCC), 2012 International CES</li>
            <li class="text"><strong>Event Date:</strong> Thursday, January 12, 2012; 9 a.m.-5 p.m.</li>
            ...
            <li class="text"><strong>How to Attend:</strong> <a  href="http://cesweb.org/register">CES Registration</a> is required to attend this event. In addition, you must <a  target="_blank" href="http://devu.eventbrite.com/">RSVP to this event</a> to guarantee entry</li>
            <li class="text"><strong>Agenda:</strong> coming soon ….(including list of companies)</li>
        </ul>
