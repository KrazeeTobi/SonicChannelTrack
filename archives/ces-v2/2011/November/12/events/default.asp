...
<div class="alert-box">                        
   ...
   <h2>Last Gadget Standing</h2>
    ...
    <p>
        <a  href="/events/last-gadget-standing.asp">Last Gadget Standing</a> challenges contenders to give the product demo of their lives. Guest emcees Gary Dell'Abate and Jon Hein from the Howard Stern Show will host the event.
    </p>
   ...
   <h2>Mark of Excellence</h2>
    ...
    <p>
        New this year: <a  href="/events/mark-of-excellence.htm">A reception in honor of the 2011 Mark of Excellence System Integrator finalists and winners </a>during the 2012 CES.
    </p>
</div><div class="grid-box">
   <h2>Mobile Apps Showdown</h2>
    ...
    <p>
        <p>Apps producers have two minutes to demo their app, and an applause-o-meter measures audience enthusiasm to determine the winners. <a  href="/events/mobile-apps.asp">Who has the chops to survive showdown?</a></p>
    </p>
</div><div class="promo-box">
    
    
       
    <A href="http://www.ce.org/Press/CEA_Pubs/vision2010.asp"><img src="/docs/226_CE_Vision_01.jpg" width="227" height="200"></A>
</div><div class="promo-box">
