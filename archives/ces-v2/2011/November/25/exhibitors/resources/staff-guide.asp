...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        Download the 2012 International CES Exhibitor Staff Guide to ensure your booth staff and other members of your exhibiting team have all the knowledge they need to make your CES experience a success. Choose from an array of helpful documents – from badge holder pickup information to Show Services info – or simply print out a complete staff guide that we have put together for you. <br />
        <table border="0" cellspacing="1" cellpadding="1" width="95%">
            <tbody>
                <tr>
                    <td valign="top">
                    <ul class="text" target="_blank">
                        <li class="text"><a  target="_blank" href="/docs/2012show_services.pdf">Show Services</a> </li>
                        <li class="text"><a  target="_blank" href="/docs/2012show_locations_map.pdf">Show Locations Maps</a></li>
                        <li class="text"><a  target="_blank" href="/docs/Shuttle_Schedule_Map.pdf">Shuttle Schedule and Map</a><a  target="_blank" href="/docs/Satellite_Parking_Map.pdf">
                        <li class="text">Satellite Parking Map</li>
                        </a></li>
                    </ul>
                    </td>
                    <td>
                    <ul class="text" target="_blank">
                        <li class="text"><a  target="_blank" href="/docs/TechZones.pdf">CES TechZones</a> </li>
                        <li class="text">CES Awards and Events </li>
                        <li class="text">Keynote Speakers </li>
                    </ul>
                    </td>
                    <td valign="top">
                    <ul class="text">
                        <li class="text"><a  target="_blank" href="/docs/2012exhibitor_services.pdf">Exhibitor Services</a> </li>
                        <li class="text"><a  target="_blank" href="/docs/2012badge_holder_pickup.pdf">Badge Holder Pickup</a><a  target="_blank" href="/docs/Emergeny_Info.pdf">
                        <li class="text">Emergency Information</li>
                        </a></li>
                    </ul>
                    </td>
                </tr>
