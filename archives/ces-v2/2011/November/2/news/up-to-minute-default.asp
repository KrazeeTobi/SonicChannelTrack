...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        The 2012 International CES is only 11 weeks away! Look below for late-breaking news about the world’s largest consumer technology tradeshow to see what’s up, what’s next and where you need to be when the show doors open January 10, 2012, in Las Vegas, Nevada.<br />
        <br />
        <a  href="http://cesweb.org/register">And if you haven’t registered yet, do it now.</a> The clock’s ticking, and you can save by registering before you get to the show.
...
<br />
        ...
        <img alt="" style="float: right;"  src="/images/content/CES_EntertainmentMatters_200pw2.jpg" />Entertainment Matters, sponsored by Variety and Ericsson, helps entertainment professionals navigate the largest, most influential technology show in the world, through <a  href="http://www.cesweb.org/EM/EM-floor.htm">exhibits</a>, <a  href="http://www.cesweb.org/EM/EM-keynotes-panels.htm">keynotes and panels</a> as well as <a  href="http://www.cesweb.org/EM/EM-events-awards.htm">events</a> critical to the Hollywood community.<br />
        <br />
        In its inaugural year, Entertainment Matters at CES (EM) attracted more than 9,000 content and entertainment professionals to the 2011 International CES, with 32 percent of those attendees holding C-level,VP and other executive titles.<br />
        <br />
...
<div class="sub-content-header">Let’s Get Vertical: Buy the CE Pass</div>
<br />


        For $399, you can gain access to some of the best sessions at CES with the CE Pass. This economical conference program pass includes sessions about general consumer tech business and gets you some up-close-and-personal time with experts in key vertical markets such as digital entertainment, emerging tech, lifestyle technologies, automotive electronics and wireless communications. <a  href="http://www.cesweb.org/conference program/conference-pricing.asp#5631">Check it out</a>, and put this conference pass in your shopping cart today.<br />
        <br />
        First-timer’s tip: Are you going to CES for the first time? This is the pass for you!
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">The Reinvention of an Industry: Entertainment Everywhere </div>
<br />


        <p><img alt="" style="float: right;"  src="/images/content/225-pw_Ericsson.jpg" />Now that TV and films have burst free from the shackles of traditional platforms, how can entertainment companies and artists capitalize on this new-found consumer freedom? Dive deep into this new frontier with industry leaders who will discuss how it's happening during an <a  href="http://www.cesweb.org/conferenceprogram/conference-track.htm?track=ee">insightful session hosted by Ericsson</a>. </p>
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Variety's Entertainment Summit at CES</div>
<br />


        <img alt="" style="float: right;"  src="/images/content/Variety_sm.gif" />It will be standing-room-only as Variety explores technology's impact on the entertainment business. Now that content can be distributed and promoted across multiple platforms and devices, the creative possibilities are endless. <a  href="http://www.cesweb.org/conferenceprogram/conference-track.htm?track=variety">Don't miss this showcase of technology pioneers</a> in film, those creatives and studio executives who are capitalizing on the trends that connect movies to audiences.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Record Number of Auto Companies to Exhibit in 2012</div>
<br />


        Many of the most innovative automotive technologies make their debut at the International CES®, and the 2012 show will continue this tradition. <a  href="http://ces12.mapyourshow.com/5_0/exhibitor_results.cfm?type=parentcategory&parentcategory=18">Manufacturers and other automotive tech companies </a>at the 2012 CES will span more than 95,000 net square feet of exhibit space. CES attendees also will see innovative new electric vehicles and charging solutions on the show floor. The <a  href="http://cesweb.org/showFloor/techzones.asp#5162">GoElectricDrive TechZone</a>, sponsored by the Electric Drive Transportation Association in the North Hall of the Las Vegas Convention and World Trade Center (LVCC), will showcase electric vehicles and their associated charge stations – for homes, condominiums, public facilities – and a range of electric mobility products and services. Also at CES: the <a  href="http://cesweb.org/showFloor/techzones.asp#5174">Safe Driver TechZone</a> and the <a  href="http://cesweb.org/showFloor/techzones.asp#5170">Location Based Services TechZone</a>.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Web TV Market’s First Award Show to be Hosted at CES</div>
<br />


        <img alt="" style="float: right;"  src="/images/content/IAWTV_260.jpg" />The International Academy of Web Television (IAWTV) is holding its inaugural <a  href="http://www.cesweb.org/awards/iawtv.asp">IAWTV Awards at the 2012 International CES</a>. The IAWTV Awards is the first award show within the Web television industry to be presented by content creators, for content creators. From studio content producers to YouTube celebrities, those successfully creating entertainment for digital platforms will be celebrated via 33 categories honoring web series and online talent, in front of the camera and behind the scenes.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Move Fast on the Las Vegas Monorail</div>
<br />


        <a  href="http://www.cesweb.org/hotelTravel/monorail.asp"><img alt="" style="float: right;"  src="/images/content/monorail_logo.gif" />The Las Vegas Monorail</a> provides you with transportation to the LVCC and Las Vegas Hilton more quickly, conveniently and cheaper than ever before! Trains arrive and depart from seven stations on the Strip every few minutes from 7-2 a.m. Monday-Thursday and 7-3 a.m. Friday-Sunday. Stations include the Sahara, Las Vegas Hilton, LVCC, Harrah’s, Flamingo, Bally’s and MGM Grand. Tickets can be purchased for as little as $5 each way; package pricing and group rates are also available. See <a  href="http://www.CESweb.org/travel">www.CESweb.org/travel</a> for details. <br />
        <br />
        Note: There is no monorail stop near The Venetian. Take <a  href="http://www.cesweb.org/hotelTravel/shuttle.asp">The Venetian Express</a> from the LVCC.
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<div class="sub-content-header">Are You a Fan of All Things Tech?</div>
<br />


        You don’t have to be a company to join the Consumer Electronics Association (CEA®)! If you are a fan of all things tech, you will love a CEA Tech Enthusiast membership. For just $9 a year you’ll get:
        <ul class="text">
            <li class="text">Technology product giveaways and discounts</li>
            <li class="text">Exclusive content from tech expert, Rob Pegoraro, formerly of the Washington Post. Rob provides weekly blogs and monthly podcasts on the latest trends in technology</li>
            <li class="text">Savings of up to $120 a year on Verizon’s Bundles for new and existing customers</li>
            <li class="text">Webinars, podcasts, research studies, articles, CE events, “Ask an Expert”</li>
            <li class="text">Discounts from CEA member companies</li>
            <li class="text">Members-only website</li>
        </ul>
        <p>Join today at <a  target="_blank" href="http://CEAte.org">CEAte.org</a>.<br />
        <br />
        <br />
        <a  target="_blank" href="http://CEAte.org"><img alt=""  src="/images/content/LargestTechGroup_728x90.gif" /></a> </p>
    <br />
<img src="/images/framework/spacer.gif" width="1" height="20">
<img src="/images/framework/divider-line-long.gif" height="15" class="divider-line-long">
<img src="/images/framework/divider-line.gif" height="15" class="divider-line">
...
<P><A href="/news/uttm-oct122011.asp">October 12, 2011</A> <BR><A href="/news/uttm-sept282011.asp">September 28, 2011</A><BR><A href="/news/uttm-aug312011.asp">August 31, 2011<BR></A><A href="/news/uttm-aug32011.asp">August 3, 2011<BR></A><A href="/news/uttm-jul202011.asp">July 20, 2011<BR></P></A>
                            <script type="text/javascript">
