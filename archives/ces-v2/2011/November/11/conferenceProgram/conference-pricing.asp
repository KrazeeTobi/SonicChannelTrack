...
<head><!-- PageID 5623 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: Conference Pricing</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
                ...
                <div id="main-content">
                    ...
                    <div class="left">
                        <div class="greenbox-bg">
                            <a href="/conferenceProgram/default.asp"></a>
            ...
            <li class="selected"><a href="/conferenceProgram/conference-pricing.asp">Conference Pricing</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/conferenceProgram/default.asp" class="footer">Conference Program</a>&nbsp;&gt;&nbsp;Conference Pricing</div>
                        </div>
                         <div class="headerbox">
        ...
        The 2012 CES Conference Program unites, educates and illuminates trends critical to consumer technology professionals. See the pricing below, and <a  href="http://cesweb.org/conferenceProgram/default.asp">start filling your shopping cart</a> with sessions and tracks delivered by industry experts.<br />
        <br />
        NOTE: CEA Corporate Members save 20% on all conference passes. Contact <a  href="mailto:membership@CE.org?Subject=CES%20Conference%20Program%20Discount">membership@CE.org</a> for the priority code.
    



<div class="blue_box" id="5625">
    <ul>
        
        
        <li><a class="sub-page-slider-link" href="#5634">Exhibits Plus Pass</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5633">All Access Pass</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5632">Entertainment Matters Pass</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5631">CE Pass</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5630">Single Sessions</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5629">Free Tracks/Sessions</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5628">Conference Tracks – Individual Purchase</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5627">Conference Programs Not Included in All Access Pass</a></li>
        
        
        <li><a class="sub-page-slider-link" href="#5626">Conference Programs – Separate Registration Required</a></li>
...
<script type="text/javascript">
    var SecondItems = $("#5625 ul:first li:nth-child(3n+2)");
    var ThirdItems = $("#5625 ul:first li:nth-child(3n)");

    $("#5625 ul:eq(1)").append(SecondItems);
    $("#5625 ul:eq(2)").append(ThirdItems);
    $("#5625 ul:eq(2)").append($("#5625 .sub-page-slider-link-show-all").parent());

    $(document).ready(function() {
        $("#5625 .sub-page-slider-link-show-all").click();
    });
</script>
...
<div class="sub-page-slider">
    <div class="sub-page-slider-nav">
        ...
        <div class="sub-page-slider-top-header">Conference Pricing</div>
        <div class="sub-page-slider-bottom-header"></div>
        <div class="push"></div>    
    </div>
    <div>
        <div class="sub-slide" id="5634">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Exhibits Plus Pass</h2>
    </div>
    
        <ul class="text">
            <li class="text">September 1, 2011 – 5 p.m. EST, December 30, 2011: $100 </li>
            <li class="text">5:01 p.m. EST, December 30, 2011 – January 13, 2012: $200</li>
        </ul>
        <p class="text">This pass is included with your <a  href="http://CESweb.org/register">2012 CES registration</a>. It allows you access to the exhibit floor, all keynote addresses, SuperSessions and the free conference sessions.</p>
    
    <br />
    <br />
</div><div class="sub-slide" id="5633">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">All Access Pass</h2>
    </div>
    
        <div id="addToCartALL" class="cartItem"></div>
        <strong>Advance: $1200 <br />
        On-site: $1500</strong><br />
        <br />
        Includes:<br />
        <table width="100%">
            <tbody>
                <tr>
                    ...
                    <ul class="text">
                        ...
                        <li class="text">Business Insights </li>
                        <li class="text">Cable Conference at CES </li>
                        <li class="text">CONNECTIONS Summit: Monetizing Connectivity in the Digital Home </li>
                        ...
                        <li class="text">Energy and the Smart Grid Home Presented by UL </li>
                        <li class="text">Games Summit at CES </li>
                    </ul>
                    </td>
                    <td>
                    <ul class="text">
                        <li class="text">Home Entertainment and Lifestyle Technologies </li>
                        <li class="text">In-Vehicle Technology </li>
                        <li class="text">Memory Matters: Memory Solutions for Consumer Products and Mobile Devices </li>
                        <li class="text">PMA@CES Conference Sessions </li>
                        <li class="text">Smartphone and Tablet Conference </li>
                        <li class="text">Tweet House Presents: Social Media Success Stories </li>
                        <li class="text"><em>Variety</em>’s Entertainment Summit at CES </li>
                        <li class="text">Wireless Communications </li>
                        <li class="text">Free conference sessions </li>
                        <li class="text">SuperSessions and Keynotes </li>
                    </ul>
                    </td>
                </tr>
            </tbody>
        </table>
        <p>Looking for track details? <a  href="/conferenceProgram/conference-tracks.asp">Get them here.</a></p>
        <div></div>
    
    <br />
    <br />
</div><div class="sub-slide" id="5632">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Entertainment Matters Pass</h2>
    </div>
    <DIV id=addToCartEMP class=cartItem></DIV>
<P style="CLEAR: both"><STRONG><IMG style="FLOAT: right" alt="" src="/images/content/CES_EntertainmentMatters_200pw2.jpg">Advance: $650 <BR>On-site: $950</STRONG></P>
<P>Includes: </P>
<UL class=text>
<LI class=text>Business Insights&nbsp; </LI>
<LI class=text>Cable Conference at CES </LI>
...
<LI class=text>Home Entertainment and Lifestyle Technologies </LI>
<LI class=text>In-Vehicle Technology </LI>
<LI class=text>The Reinvention of an Industry: Entertainment Everywhere </LI>
<LI class=text>Smartphone and Tablet Conference </LI>
<LI class=text>Tweet House Presents: Social Media Success Stories </LI>
<LI class=text><EM>Variety</EM>’s Entertainment Summit at CES </LI>
<LI class=text>Wireless Communications </LI>
<LI class=text>Free conference sessions </LI>
<LI class=text>SuperSessions and Keynotes </LI></UL>
    <br />
    <br />
</div><div class="sub-slide" id="5631">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">CE Pass</h2>
    </div>
    
        <div id="addToCartCES" class="cartItem"></div>
        <p><strong>Advance: $399 <br />
        On-site: $599</strong></p>
        <p>Includes: </p>
        <ul class="text">
            <li class="text">Business Insights </li>
            <li class="text">Digital Hollywood </li>
        ...
        Looking for track details? <a  href="/conferenceProgram/conference-tracks.asp">Get them here. </a>
    
    <br />
    <br />
</div><div class="sub-slide" id="5630">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Single Sessions</h2>
    </div>
    
        <p><strong>Advance: $150 <br />
        On-site: $300</strong></p>
        <p>One session can be purchased within any of the following Conference Tracks.You do not have to purchase the entire Conference Track if you are only interested in one session. </p>
        <ul class="text">
            <li class="text">Business Insights </li>
            <li class="text">Cable Conference </li>
            <li class="text">CONNECTIONS Summit: Monetizing Connectivity in the Digital Home </li>
            <li class="text">Digital Hollywood </li>
            <li class="text">Emerging Technology </li>
            <li class="text">Home Entertainment and Lifestyle Technologies </li>
    ...
    <br />
    <br />
</div><div class="sub-slide" id="5629">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Free Tracks/Sessions</h2>
    </div>
    
        <ul class="text">
            <li class="text">CEA Research Summit </li>
            <li class="text">Consumer Electronics in the Air </li>
            <li class="text">Connecting Home to Grid with IP Networking </li>
            <li class="text">Fitness Tech </li>
            <li class="text">Getting your Product Sold by Retailers </li>
            <li class="text">HigherEdTECH </li>
            <li class="text">Innovation Policy Summit </li>
            <li class="text">Just the Facts: Research, Reports and Revelations </li>
            <li class="text">Kids@Play and MommyTech </li>
            <li class="text">The Reinvention of an Industry: Entertainment Everywhere </li>
            <li class="text">Silvers Summit </li>
            <li class="text">SuperSessions and Keynotes </li>
            <li class="text">Window to Tomorrow’s Connected Home </li>
        </ul>
        <p class="text">Looking for track details? <a  href="/conferenceProgram/conference-tracks.asp">Get them here.</a></p>
    
    <br />
    <br />
</div><div class="sub-slide" id="5628">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Conference Tracks – Individual Purchase</h2>
    </div>
    
        <p>The following conference tracks can be purchased on an individual basis. Early Bird, Advance and On-site fees vary as indicated below.</p>
        <ul class="text">
            <li class="text">Broadband Unlimited Early-bird: N/A<br />
            Advance: $395<br />
            On-site: $495</li>
            <li class="text">Cable Conference Early-bird: N/A <br />
            Advance: $350<br />
            On-site: $550</li>
            <li class="text">Content in the Cloud Early-bird: $150 thru Nov. 30<br />
            Advance: $200 starting Dec. 1<br />
            On-site: $250 </li>
            <li class="text">CONNECTIONS Summit: Monetizing Connectivity in the Digital Home (Full Pass)  Advance: $595<br />
            On-site: $695 </li>
            <li class="text">Digital Health Summit (Full Pass) Early-bird: $399 thru Nov. 15<br />
            Advance: $449 starting Nov. 16<br />
            On-site: $499 </li>
            <li class="text">Digital Health Summit (Jan. 12 only) Early-bird: $199 thru Nov. 15<br />
            Advance: $249 starting Nov. 16<br />
            On-site: $299 </li>
            <li class="text">Energy and the Smart Grid Home Presented by UL (Full Program) Early-bird: N/A<br />
            Advance: $300 <br />
            On-site: $600 </li>
            <li class="text">Games Summit at CES Early-bird: N/A <br />
            Advance: $395 <br />
            On-site: $495</li>
            <li class="text">Memory Matters: Memory Solutions for Consumer Products &amp; Mobile Devices Early-bird: N/A<br />
            Advance: $125<br />
            On-site: $250</li>
            <li class="text">PMA@CES Conference Sessions Early-bird: N/A<br />
            Advance: $499<br />
            On-site: $599 </li>
        </ul>
        <ul class="text">
            <li class="text">PMA@CES Conference Sessions (Individual Session) Early-bird: N/A<br />
            Advance: $200<br />
            On-site: $350</li>
            <li class="text">Tweet House Presents: Social Media Success Stories Early-bird: N/A<br />
            Advance: $199<br />
            On-site: $225 </li>
            <li class="text">Smartphone and Tablet Conference Early-bird: N/A<br />
            Advance: $425<br />
            On-site: $625 </li>
            <li class="text"><em>Variety</em>’s Entertainment Summit at CES Early-bird: N/A<br />
            Advance: $200<br />
            On-site: $250</li>
        </ul>
        <p class="text">Looking for track details? <a  href="/conferenceProgram/conference-tracks.asp">Get them here.</a></p>
    ...
    <br />
    <br />
</div><div class="sub-slide" id="5627">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Conference Programs Not Included in All Access Pass</h2>
    </div>
    
        <p>The following conference programs are NOT included in the All Access Pass. Early Bird, Advance and On-site fees apply as indicated below. Please note, some programs have limited registration.</p>
        <ul class="text">
            <li class="text"><strong>Andrew Seybold Entrepreneur Boot Camp (Full Program) </strong>Registration limited to 50<br />
            Early-bird: $595 thru Oct. 31<br />
            Advance: $695 starting Nov. 1<br />
            On-site: $695 </li>
            <li class="text"><strong>Andrew Seybold Entrepreneur Boot Camp (Morning Only) </strong> Registration limited to 200<br />
            Early-bird: $250 thru Oct. 31<br />
            Advance: $295 starting Nov. 1<br />
            On-site: $295 </li>
            <li class="text"><strong>Andrew Seybold Entrepreneur Boot Camp (Afternoon Only) </strong>Registration limited to 50<br />
            Early-bird: $425 thru Oct. 31<br />
            Advance: $495 starting Nov. 1<br />
            On-site: $495 </li>
            <li class="text"><strong>ICCE Conference</strong> (Advance and On-site Rates listed consecutively): $740    $840 <br />
            January 13 Only: $300    $300 <br />
            ICCE Member: $565    $665 <br />
            ICCE Member, Jan. 13 only: $250    $250 <br />
            ICCE CE Society Member: $540    $640 <br />
            ICCE CE Affiliate Member: $540     $640 <br />
            ICCE Student Member: $300     $400 <br />
            ICCE Student, Non-member: $350     $450 <br />
            ICCE Life Member: $270     $370 <br />
            Extra Lunch Ticket: $ 45     $50 <br />
            Printed Conference Digest: $50     $70 <br />
            Sunday Night Magician: $65     $75 </li>
            <li class="text"><strong>THX<br />
            </strong>Advance: $500<br />
            On-site: $550 </li>
        </ul>
        <p class="text">Looking for track details? <a  href="/conferenceProgram/conference-tracks.asp">Get them here.</a></p>
    ...
    <br />
    <br />
</div><div class="sub-slide" id="5626">
    
    
    <div class="keynote-header-bak">
        <h2 class="date">Conference Programs – Separate Registration Required</h2>
    </div>
    
        <p>The following conference programs require a separate registration and are NOT included in your CES registration.</p>
        <ul class="text">
            <li class="text"><strong>CES Government Conference<br />
            By Invitation Only. Please Contact <a  href="mailto:kim@connellyworks.com">Kim Andreotta</a> for more information<br />
            </strong>(Rates reflect thru Nov. 10 and after Nov 10, respectively)<br />
            Government rate: $670    $745<br />
            Industry rate: $1,150     $1,150 </li>
            <li class="text"><strong>Storage Visions<br />
            Attendees must register at <a  href="http://www.storagevisions.com"></a><a  href="http://www.storagevisions.com">www.storagevisions.com</a><br />
            </strong>(Rates reflect Advance and On-site, respectively)<br />
            ESA membership &amp; conference registration: $795*    $895 <br />
            Conference registration: $695*    $795 <br />
            Conference registration, January 8 only: $595*    $695 <br />
            Conference registration, January 9 only: $595*    $695 <br />
            Conference registration, ESA members only: $590*    $690 <br />
            ESA Membership only: $195*    $250 <br />
            Storage Visions Exhibits only: FREE    $50 </li>
        </ul>
        <p>*Fee ends December 30, 2011. </p>
        <p>Looking for track details? <a  href="/conferenceProgram/conference-tracks.asp">Get them here.</a></p>
