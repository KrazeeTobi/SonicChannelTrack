...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <div class="icon-wrap">
        ...
        <ul class="text">
            <li class="text">Last year, 77 percent, or 289.6 tons, of the total solid waste generated by show attendees was recycled. Additionally at the 2011 show, CEA worked with Repurpose America, which works to reuse materials at Las Vegas tradeshows, to recycle 18,000 pounds of magnetic signs, nearly 15,000 square feet of banner signs and more than 150 foam boards (3 feet by 8 feet).  Among the other reuses of the these signs, Repurpose America gave a University of Nevada, Las Vegas Chinese cultural club some of the banner signs, who then used them for a fashion show.  Now that’s some sustainable ingenuity!  </li>
            ...
            <li class="text">Last year, CEA donated $75,000 to Green Chips, a non-profit organization promoting carbon neutrality, to support sustainable energy in southern Nevada. <a  target="_blank" href="http://www.ce.org/Press/CurrentNews/press_release_detail.asp?id=12045">Read more.</a> </li>
        </ul>
        <h4>Print Production at the International CES</h4>
        The <a  target="_blank" href="http://www.ce.org/">Consumer Electronics Association</a> has cut its print production for CES by nearly 50 percent in the last five years. Many materials are available online including the International CES Conferences brochure, once 88 pages and distributed to 250,000 and the CES Exhibitor Manual, once thousands of pages for 2,700 exhibitors. Additionally, the CES PreShow Planner has seen a reduction of more than 28,000 copies, a 32 percent decrease in total print run, and the CES Conference directory was reduced to an insert in the Show Guide at 55,000 copies. CEA is proud to be using environmentally friendly soy-based ink on the 2010 International CES printed publications. All remaining hard copy materials meet the standards of the Sustainable Forest Initiative and Forest Stewardship Council and are printed on recycled paper.
        <h4>CES works with Vendors Committed to Sustainability</h4>
        <ul class-="text">
            ...
            <li class="text">The Venetian/Palazzo has reduced annual water consumption by more than 97 million, recycles over 55 percent of their solid waste stream, and received silver-certification for the Palazzo by the U.S. Green Building Council's Leadership in Energy and Environmental Design (LEED).</li>
        </ul>
        ...
        <h3>CEA Highlights Green Research</h3>
        From trends in eco-friendly TVs to illuminating detail about consumer attitudes on energy efficiency with consumer electronics, CEA has the latest research. Visit <a  href="http://www.CE.org/green">www.CE.org/green</a> for more information.  
