...
<SCRIPT type=text/javascript>
            ...
            var shoppingCartList; var output; var m_codeLookup;
...
function buildSuperSessions() {
    $('#SuperSession').html('');
    $.each($(superSessions), function(i, xml) {
        var s = sessionElementToObject( $.parseXML( xml ) );
        $( "#tmplSessionInformation" ).tmpl( s, {
            ...
            $(document).ready(function(){
                ...
                $.ajax({
                    type: "GET",
                    contentType: "application/json; charset=utf-8",
                    url: "/serviceCalls/ConferenceSessions/getSuperSessions.ashx",
                    dataType: "json",
                    async: false,
...
<DIV style="WIDTH: 700px" id=SuperSession></DIV>
<SCRIPT id=tmplSessionInformation type=text/x-jquery-tmpl>
   <div class="expand border" id="SessionDetail${ID}">
    <div class="header">
     <table><tr><td valign="top" style="width: 160px">
     {{if Logo.length > 0}}
       <img style="width:146px;" alt="track"  src="${Logo}" />
      {{/if}}
      {{html formatHelpers.displaySponsorLogos(SponsorLogos)}}
     </td>
     <td style="width: 346px" valign="top"><div class="" style="text-align: center!important">
  ...
  {{if ($data.Presenters.length > 0 || $data.Moderators.length > 0 || $data.Panelists.length > 0)}}
...
<SCRIPT id=tmplSessionInformation-left type=text/x-jquery-tmpl>
   <div class="expand" id="SessionDetail${ID}">
    <div class="header">
     <table><tr><td valign="top" style="width: 160px">
     {{if Logo.length > 0}}
       <img style="width:146px;" alt="track"  src="${Logo}" />
...
<SCRIPT id=tmplSessionInformation-center type=text/x-jquery-tmpl>
   <div class="expand" id="SessionDetail${ID}">
    <div class="header">
