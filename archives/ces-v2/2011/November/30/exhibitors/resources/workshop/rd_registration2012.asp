...
<TABLE width="800" BORDER="0" style="border: 1px #969696 solid" CELLPADDING="0" CELLSPACING="0">
	<tr valign="top">
		<td><img width="800" height="147" src="images/2011_header.jpg" alt="2012 Exhibitor Workshop" border="0"></td>
	</tr>
	<tr>
		<td>
...
<br><br><br><br><br><br>
-->
<h2>Register for the 2012 International CES Exhibitor Workshop<h3>Tips, Tricks and Savings to Maximize Your Tradeshow Experience</h3></h2>
The workshop is <strong>FREE</strong> to all 2012 International CES exhibitors. 
<br><br><br>
...
<tr>
	<td>&nbsp;</td>
	<td valign="top"><input type="checkbox" name="first_timer" ID="Checkbox1">&nbsp;Yes, I will be a first-time exhibitor at the 2012 International CES.</td>
</tr>
...
<tr>
	...
	<span class="title">Using MyCES to maximize your ROI for The 2012 International CES - <strong>Registration is closed.</strong></span><br>
	<img src="/images/framework/spacer.gif" width="24" height="14">September 15, 2011 – 2 p.m. EST
	<blockquote>Join us for a free webcast and learn how to leverage your opportunities on the online exhibitor directory and floor plan before, during AND after the show. Register now!</blockquote>
	</td>
</tr>

<tr>
	<td colspan="2" valign="top"><!--<input type="checkbox" name="session2">-->
	<span class="title">Optimize Your Marketing Resources and Get the Most Press Coverage - <strong>Registration is closed.</strong></span><br>
	<img src="/images/framework/spacer.gif" width="24" height="14">September 22, 2011 – 2 p.m. EST
	<blockquote>The CES Marketing and Communications teams will provide you with free tools that will help to market your booth and get the press coverage you need for a successful show. Register Now!</blockquote>
	</td>
</tr>

<tr>
	<td colspan="2" valign="top"><!--<input type="checkbox" name="session3">-->
	<span class="title">Meet GES – Official Show Contractor of the International CES - <strong>Registration is closed.</strong></span><br>
	<img src="/images/framework/spacer.gif" width="24" height="14">October 11, 2011 – 2 p.m. EST
	<blockquote>A panel of GES experts will discuss shipping deadlines and rigging, booth design and maintenance, electrical issues, union jurisdictions and material handling, and anything else you need to know to ensure your materials reach the show efficiently. Register now!</blockquote>
	</td>
</tr>

<tr>
	<td colspan="2" valign="top"><!--<input type="checkbox" name="session4">-->
	<span class="title">CES Operations – Show Planning and Booth Logistics - <strong>Registration is closed.</strong></span><br>
	<img src="/images/framework/spacer.gif" width="24" height="14">October 19, 2011 – 2 p.m. EST
	<blockquote>The CES Operations team will help make your booth planning easier with tips on navigating the show, securing hotel reservation, ordering booth services and setting up your booth within show guidelines. Register now!</blockquote> 
	</td>
</tr>
</td></tr>
		<tr>
