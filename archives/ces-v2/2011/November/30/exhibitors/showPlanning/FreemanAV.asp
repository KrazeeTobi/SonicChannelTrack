...
<br />
        ...
        <p>                             </p>
        <p><img width="85" height="156" alt="" style="width: 87px; float: right; height: 124px;"  width="87" height="124" src="/images/content/Patrick_headshot_final2.jpg" />For audio visual needs that require a customized solution, contact <strong>Patrick Filomena.</strong>                             </p>
