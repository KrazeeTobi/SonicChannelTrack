...
<P>&nbsp;</P>
    ...
    <div class="keynote-right-col">
        ...
        <p> </p>
        <table style="width: 599px; height: 458px;">
            <tbody>
                <tr>
                    <td>3M Touch Systems</td>
                    <td> Line2 </td>
                    <td> Sonomax Technologies </td>
                </tr>
                <tr>
                    <td>Accenture</td>
                ...
                <tr>
                    ...
                    <td> Treehouse Labs, LLC</td>
                </tr>
                <tr>
                    <td>Fujitsu Limited</td>
                    <td> Optoma Technology</td>
                    <td> USB Implementers Forum</td>
                </tr>
                <tr>
                    <td>Griffin Technology</td>
                    <td> Oregon Scientific</td>
                    <td> Velodyne Acoustics</td>
                </tr>
                <tr>
                    <td>Haier</td>
                    <td> Other World Computing</td>
                    <td> Wireless Accessory Solutions</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Kivic</td>
                    <td> Recon Instruments, Inc.</td>
                    <td> </td>
                </tr>
                <tr>
                    <td>LaCie</td>
                    <td> Samsung Techwin America</td>
                    <td> </td>
                </tr>
                <tr>
                    <td>Lenovo</td>
