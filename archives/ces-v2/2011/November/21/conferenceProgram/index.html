...
<div class="alert-box">                        
   ...
   <h2>Session Schedule</h2>
    ...
    <p>Watch the 2012 Conference Program come to life with <A href="/conferenceProgram/sessions.htm">this session schedule</A>. See the times, dates and locations of conference sessions so you can plan your time at CES.</p>
</div><div class="grid-box">
   <h2>Conference Tracks</h2>
    
    
    <p><IMG style="MARGIN-LEFT: 2px" border=0 hspace=2 align=left src="/images/content/Conf_Crowd_01.jpg" width=60 height=75><A href="/conferenceProgram/conference-tracks.asp">Groups of sessions covering every aspect of the competitive, multibillion-dollar CE industry</A>&nbsp;put you on the inside track to everything new.&nbsp;Coming&nbsp;this Fall. </p>
</div><div class="promo-box">
    
    
       
    <A href="http://cesweb.org/conferenceProgram/conference-tracks.asp"><img src="/docs/Conf_Reg_is_open_9.29.11.jpg" width="227" height="200"></A>
</div><div class="promo-box">
    
    
       
    <A href="/faq/generalFAQs.asp#sessions"><img src="/docs/ConferencerFAQ2.gif" width="227" height="200"></A>
</div><div class="grid-box">
   <h2>SuperSessions</h2>
