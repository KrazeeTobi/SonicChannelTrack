...
<div class="alert-box">                        
        ...
        <p>NEW! <a  href="http://cesweb.org/awards/innovations/default.asp">Innovations Honorees announced!</a> </p>
   ...
   <h2>CNET Best of CES</h2>
    ...
    <p><A href="/awards/bestOfCES.asp"><IMG style="MARGIN-LEFT: 5px" border=0 hspace=5 align=left src="/images/content/CNET_logo_web.gif" width=44 height=36>CNET's expert editors hit the deck running to find the best of the best in new products.</A> They nominate 27 products in nine categories, plus a Best in Show winner. The CNET audience awards a People's Voice winner. </p>
</div><div class="grid-box">
   <h2>Emmy Awards</h2>
