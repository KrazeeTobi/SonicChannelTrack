...
<head><!-- PageID 3427 - published by Open Text Web Solutions 10.1 - 10.1.1.334 - 29635 -->
    ...
    <title>2012 CES: CES Member Packet Submission</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <!--/exhibitors/default.asp-->
            ...
            <li ><a href="/exhibitors/resources/partnerconnect.asp">Partner Connection</a></li>
    ...
    <div class="icon-wrap">
        ...
        <a target="_blank" href="http://www.cesweb.org/news/rssNews.asp"><img src="/images/framework/sub_rss.png" alt="rss"></a>
                    ...
                    <div class="right">
                        <div id="breadcrumb">
                            <div><a href="/default.htm" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/resources/default.asp" class="footer">Resources</a>&nbsp;&gt;&nbsp;CES Member Packet Submission</div>
                        </div>
                         <div class="headerbox">
                            <h1>CES Member Packet Submission</h1>
                        </div><br />
...
function validForm(passedForm)
	{
	var stringFirstName = document.mp_form.FirstName.value;
	var stringLastName = document.mp_form.LastName.value;
	var stringCompany = document.mp_form.Company.value;
	var stringAddress = document.mp_form.Address.value;
	var stringCity = document.mp_form.City.value;
	var stringPhone = document.mp_form.Phone.value;
	
		if (stringFirstName.length == 0) {
			alert("Please enter a first name."); mp_form.FirstName.focus(); return false; } 
	
		if (stringLastName == false) {
			alert("Please enter a last name."); mp_form.LastName.focus(); return false; } 
	
		if (stringCompany == false) {
			alert("Please enter a company name."); mp_form.Company.focus(); return false; } 
	
		if (stringAddress == false) {
			alert("Please enter a street address."); mp_form.Address.focus(); return false; } 
	
		if (stringCity == false) {
			alert("Please enter a city."); mp_form.City.focus(); return false; } 
	
		if (stringPhone == false) {
			alert("Please enter a phone number."); mp_form.Phone.focus(); return false; } 
	
		if (checkemail(passedForm.Email.value)==false) {
			passedForm.Email.focus(); return false; }
...
<!-- text for main page -->
<!--<br><br>
Registration for your 2010 International CES member benefits has closed. 
<br><br>
If you would like to update your company's contact information, please e-mail <a href="mailto:membership@CE.org">membership@CE.org</a>.
<br><br><br><br>-->


<FORM name="mp_form" METHOD="POST" action="" onSubmit="return validForm(this);">

<table width="100%" cellpadding="4" cellspacing="0" border="0" cols="2">	
	<tr>
	<td colspan=2>
	As a CES member exhibitor, your company is eligible to receive the CES Member Packet, which includes a parking pass, lunch tickets and a plaque to display in your 2012 International CES booth.
	<br><br>
	Please submit the following form by <strong>COB Friday, October 28, 2011</strong> to ensure your packet is mailed to the appropriate person within your company.
	<br><br>
	<i>Please provide us with a mailing address. Your packet will be shipped via FedEx in early December.</i><br /><br />
	</td>
	</tr>
	
	<tr>
		<td width="110" align="right">First Name</td>
		<td><input name="FirstName" type="text" size="35" maxlength="255"></td>
	</tr>

	<tr>
		<td align="right">Last Name</td>
		<td><input name="LastName" type="text" size="35" maxlength="255"></td>
	</tr>

	<tr>
		<td align="right">Company Name</td>
		<td><input name="Company" type="text" size="35" maxlength="255"></td>
	</tr>

	<tr>
		<td align="right">Street Address</td>
		<td><input name="Address" type="text" size="35" maxlength="255" ></td>
	</tr>

	<tr>
		<td align="right">City</td>
		<td><input name="City" type="text" size="35" maxlength="255"></td>
	</tr>

	<tr>
		<td align="right">State</td>
		<td>
		    <select name="State">		<option value="unselected">Please Select a State</option>
	...
	<tr>
		...
		<td>
			<select name="Country">		<option value="unselected">Please Select a Country</option>
	...
	<tr>
		...
		<td><input name="ZipCode" type="text" size="23" maxlength="255"></td>
	</tr>
	
	<tr>
		<td align="right">Phone</td>
		<td><input name="Phone" type="text" size="35" maxlength="50"></td>
	</tr>
	...
	<tr>
		<td colspan=2>Your company is entitled to one (1) parking pass per venue. Please select one:</td>
	</tr>
		<tr>
		<td colspan=2>
			<input type="radio" name="ParkingLot" value="LVCC">My company is exhibiting at the Las Vegas Convention Center (LVCC).<br>
			<input type="radio" name="ParkingLot" value="Sands">My company is exhibiting at the Venetian.<br>
			<input type="radio" name="ParkingLot" value="LVCCandSands">My company is exhibiting at both the LVCC and the Venetian.<br>			
		</td>
	</tr>
	...
	<tr>
		<td colspan=2>
		NOTE: Free public parking is provided at the Venetian; therefore, your company will not need a parking pass. If this does not meet your needs, please contact <a href="mailto:membership@CE.org">membership@CE.org</a>.
		<br><br>
		The CES Member Packet will be shipped out and tracked in early December. If you have any questions, feel free to contact <a href="mailto:membership@CE.org">membership@CE.org</a>. E-mails will be returned within two business days.
		</td>
	</tr>
	...
	<tr>
		<td>&nbsp;</td>
		<td>
			<input type="submit" class="" value="Submit" id=submit1 name=submit1>&nbsp;&nbsp;	
			<input type="button" class="" value="Cancel" onclick="window.location='/exhibitors/resources/default.asp';" id=button1 name=button1>
		</td>
	</tr>
</table>	
...
<!--
	<tr>
		<td>&nbsp;</td>
		<td><input type="radio" name="NeedParking" value="Yes" checked>Yes<br>
			<input type="radio" name="NeedParking" value="No">No
		</td>
	</tr>
	...
	<tr>
		<td>&nbsp;</td>
		<td>2. If Yes, for which location would you like a parking pass?</td>
	</tr>

	<tr>
		<td>&nbsp;</td>
		<td>3. Our company has a need for lunch tickets during CES. </td>
	</tr>

	<tr>
		<td>&nbsp;</td>
		<td><input type="radio" name="lunchTix" value="Yes" checked>Yes<br>
			<input type="radio" name="lunchTix" value="No">No
		</td>
	</tr>

	<tr>
		<td colspan=2>Your company is entitled to receive one (1) member plaque to be displayed in your booth at the 2007 International CES.  Please complete the following:</td>
	</tr>

	<tr>
		<td>&nbsp;</td>
		<td>4. Our company would like to display a CEA Member Plaque in our booth. </td>
	</tr>

	<tr>
		<td>&nbsp;</td>
		<td><input type="radio" name="memberPlaque" value="Yes" >Yes<br>
			<input type="radio" name="memberPlaque" value="No" checked>No
		</td>
	</tr>
-->
...
<!--/exhibitors/resources/mp-confirmation.asp-->
