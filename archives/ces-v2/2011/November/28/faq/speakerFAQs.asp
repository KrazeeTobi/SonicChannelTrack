...
<h3>Am I required to use the International CES slide template for the presentation?</h3><br>
        ...
        No, you are not required to use the International CES template, however, we strongly encourage it. The official 2012 CES template can be accessed <a  target="_blank" href="/docs/2k12_CES_Conference_powerpoint_template.potx">here</a>.
