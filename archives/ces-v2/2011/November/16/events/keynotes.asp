...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
        ...
        <div id="container-home">
            ...
            <li ><a href="/events/ESPN-events.htm">ESPN Events</a></li>
        
            <li ><a href="/events/mashable-awards.asp">Mashable Awards</a></li>
...
<div class="sub-page-slider">
    ...
    <div class="keynote-left-col">
        <img src="/images/content/Paul-Jacobs-Qualcomm.gif">
    </div>
    <div class="keynote-right-col">
        ...
        <P>Dr. Jacobs' keynote follows a State of the CE Industry keynote address delivered by Gary Shapiro, president and CEO, CEA. Jacobs' keynote will be part of the Technology and Evolving Countries (TEC) Program at the 2012 CES, focused on the role mobile technology plays in global innovation and economic growth in consumer electronics.&nbsp; </P>
<P>Dr. Paul E. Jacobs was named CEO of Qualcomm in 2005 and was appointed chairman of the Company’s board of directors in 2009. Since joining Qualcomm in 1990, he has spearheaded Qualcomm's efforts to develop and commercialize mobile technology breakthroughs that have contributed significantly to the growth of both the Company and the industry. Noteworthy developments that began under Dr. Jacobs include the first smartphone, the inclusion of GPS capabilities in mobile phones and the creation of the Snapdragon processor. </P>
...
<P>To hear Dr. Paul Jacobs' thoughts on the significance of this keynote and what he will cover, please visit his new post on Qualcomm's OnQ blog. <BR></P>
    </div>
</div><div class="sub-slide">
    <div class="keynote-header" style="display:none;">
        <h2 class="date">Tuesday, January 10, 2012</h2>
