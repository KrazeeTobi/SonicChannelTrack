...
<head>
	...
	<title>2004 International CES:&nbsp;Exhibitor Directory - Search by TechZone</title>
...
<script>	
	...
	{
			CategoryName = eval("document.searchByPavilion." + Category);
			ParentName = eval("document.searchByPavilion." + ParentCategory);
		
			if(Category != 'productCategory')
				{
				if(ParentName.selectedIndex == 0)
					{
					document.searchByPavilion.productCategory.focus();
					CategoryName.selectedIndex = 0;
					document.searchByPavilion.subCategory2.selectedIndex = 0;		
					alert("Please select a market first, followed by a category and then a product.");
					}
				}
			else
				{
					document.searchByPavilion.subCategory1.selectedIndex = 0;
					document.searchByPavilion.subCategory2.selectedIndex = 0;						
				}
	}
...
function changeFocus(FocusItem)
	{
			ItemName =  eval("document.searchByPavilion." + FocusItem)
			ItemName.focus();
	...
	function initCategoriesCheck()
		{
			initCategories(document.searchByPavilion.productCategory);
		}
...
function initCategoriesCheck()
		{			
			...
			var formElement = document.searchByPavilion.productCategory;
...
function productCategoryBodyOnLoad() {
    document.searchByPavilion.reset();
    initCategoriesCheck();
}
</script>
...
<!-- EXHIBIT FLOOR -->
	...
	<a href="/attendees/exhibit_floor/directory/">Exhibitor Directory</a><br>
			...
			<span class="nav_fourth_arrow"><b>></b> &nbsp;</span>by TechZone</a><br>
...
<div class="section_title">Search by International CES TechZone</div>
Search for exhibitors participating in a 2004 International CES Techzone.
<!--Narrow your search by selecting specific product categories you are interested in.-->
<br>
<form name="searchByPavilion" action="pavilion_search_results.asp?page=1" method="POST">
...
<tr>
	<td class="rowlabel">TechZone&nbsp;&nbsp;</td>
	<td><select name="pavilion" class="formData">
		<option value="0" selected>**********************All**********************</option>
			
		<option value="64">Bluetooth</option>	
			
		<option value="79">Broadband to the Home</option>	
			
		<option value="81">Connected Home Entertainment</option>	
			
		<option value="88">Digital Car/Telematics</option>	
			
		<option value="82">Digital Content Storage</option>	
			
		<option value="83">DVD + RW Alliance</option>	
			
		<option value="90">DVD - RAM Promotions Group</option>	
			
		<option value="63">Energy Efficiency/Electronics Recycling</option>	
			
		<option value="84">Flash Forward</option>	
			
		<option value="91">HomePlug Power Alliance</option>	
			
		<option value="85">Launch TechZone</option>	
			
		<option value="61">MP3</option>	
			
		<option value="93">Portable Power</option>	
			
		<option value="74">RWPPI (RW Products Promotion Initiative)</option>	
			
		<option value="76">SD Card</option>	
			
		<option value="73">Tablet PC/Mobile Computing</option>	
			
		<option value="60">TechHome</option>	
			
		<option value="92">UPnP</option>	
			
		<option value="68">USB</option>	
...
<td colspan="3" width="75%"><select name="productCategory" class="formData" onChange="loadSubs(document.searchByPavilion.productCategory, document.searchByPavilion.subCategory1); checkCategory('productCategory','none')">
...
<td colspan="3" width="75%"><select name="subCategory1" class="formData" onFocus="checkCategory('subCategory1', 'productCategory');" onChange=" loadSubs(document.searchByPavilion.subCategory1, document.searchByPavilion.subCategory2);">
<option value="unselected" selected>**********************All**********************</option>
<option>&nbsp;
<option>&nbsp;
<option>&nbsp;
...
<tr>
	<td><img src="/global_images/spacer.gif" height="16" width="160" border="0"></td>
	<td><img src="/global_images/spacer.gif" height="16" width="430" border="0"></td>	
</tr>
