...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Sessions by Market<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<!-- text for main page -->
<div id="1.1.6.8.1">
<table cellpadding=3 cellspacing=1 border=0 width='60%'><tr height=7><td></td></tr><tr><td><strong>No market was selected. Please <a href=search_by_market.asp>try again</a>.</strong></td></tr></table>
<!-- /text for main page -->
