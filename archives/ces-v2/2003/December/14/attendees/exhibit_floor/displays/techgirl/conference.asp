...
<head>
	...
	<title>2004 International CES:&nbsp;Technology is a Girl's Best Friend Conference SuperSession</title>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Technology is a Girl's Best Friend Conference SuperSession<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
...
<table bgcolor="#E5F5FD" width="590" cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
	    ...
	    <td>&nbsp;</td>
		<td valign="top" class="text">
			<span class="nav_fourth_arrow"><b>>&nbsp;&nbsp;</b></span>Conference SuperSession<BR>			
		</td>
	    <td>&nbsp;</td>
	</tr>
	<tr>
...
The 2004 International CES will feature a Technology Is a Girl's Best Friend Conference SuperSession on Friday, January 9, 2004.<br><br>
<a href="/attendees/conferences/search/session_detail.asp?ID_session=SS8&ID_track=SS04&ref=SS8">Shopping Consumer Electronics, Understanding the Female Perspective</a><br>
<span class="text_colored">10:00 a.m. January 9, 2004, LVCC North Hall, Room N253</span><br>
Don't underestimate the power of the female consumer. This session identifies industry shortcomings as it collectively attempts to service this massive, underserved demographic. Original and exclusive focus groups and quantitative research detail what women really think of the CE retail experience, product design and technology use in general. The expert panel is ready to show clear and concrete steps the industry can take to more effectively attract and retain the millions of female consumers.
<br><br>
<img src="/attendees/exhibit_floor/displays/techgirl/images/ebrain.gif" align="left">
Original and exclusive focus group and quantitative research from <a href="http://www.eBrain.com" target="new">eBrain Market Research</a> will be presented detailing what women really think of the CE retail experience, product design and technology use in general. 
<!-- /text for main page -->
</div>
