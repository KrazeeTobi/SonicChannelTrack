...
<head>
	...
	<title>2004 International CES:&nbsp;CNET to Reveal the Next Big Thing in CE</title>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">CNET to Reveal the Next Big Thing in CE<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<!-- text for main page -->
<span class="section_title">Now, next year, and beyond<br><br></span>
<a target="new" href="http://www.cnet.com"><img border="0" align="left" hspace="6" src="/attendees/awards/next_big_thing/images/cnetlogo.gif"></a><!--<a target="new" href="http://www.ZDNet.com"><img align="right" src="/attendees/awards/next_big_thing/images/zdnet.gif" border="0"></a>-->
What technologies and products will become the category killers of tomorrow? Next year? Five years from now? CNET Editor at Large Brian Cooley is setting out on a quest to find out. He's talking to manufacturers, pressing venture capitalists, and peeking into development labs&mdash;all as part of CNET's search for the Next Big Thing in consumer electronics. <br><br>The sojourn will come to its close at CES, where we'll give you a rundown of what he has uncovered in areas including imaging, digital storage, wireless devices, handhelds, personal communications and telephony, digital audio/video/television, and home and personal networking. <br><br>But you'll be more than just a spectator&mdash;he'll be asking you for insights on what will be the stars of CES between 2005 and 2010.
<br><br>
<strong>See this and other <a href="/attendees/conferences/supersessions.asp">2004 International CES SuperSessions</a>.</strong>
<!--
<table cellspacing="0" border="1" cellpadding="0" width="90%">
<tr>
	<td width=50%">
	<span class="section_title">Now, next year, and beyond<br><br></span></td><td width="50%" align="right"><a target="new" href="http://www.cnet.com"><img border="0" src="/attendees/awards/next_big_thing/images/cnetlogo.gif"></a>&nbsp;&nbsp;<a target="new" href="http://www.ZDNet.com"><img src="/attendees/awards/next_big_thing/images/zdnet.gif" border="0"></a><br>
	<br></td></tr>
	<tr><td colspan="2">What technologies and products will become the category killers of tomorrow? Next year? Five years from now? CNET Editor at Large Brian Cooley is setting out on a quest to find out. He's talking to manufacturers, pressing venture capitalists, and peeking into development labs&mdash;all as part of CNET's search for the Next Big Thing in consumer electronics. <br><br>The sojourn will come to its close at CES, where we'll give you a rundown of what he has uncovered in areas including imaging, digital storage, wireless devices, handhelds, personal communications and telephony, digital audio/video/television, and home and personal networking. <br><br>But you'll be more than just a spectator&mdash;he'll be asking you for insights on what will be the stars of CES between 2005 and 2010.
	</td>
	</tr>
	<tr><td colspan="2"><br><strong>See this and other <a href="/attendees/conferences/supersessions.asp">2004 International CES SuperSessions</a>.</strong></td></tr>
</table>
<br>
-->
...
<!--<table width="590" cellspacing="0" cellpadding="0" border="0">
	<tr>
	    <td valign="top" class="text" width="375"><img src="/global_images/spacer.gif" alt="" width="375" height="8" hspace="0" vspace="0" border="0"><br>
			<span class="section_title">The Search Is On<br><br></span>
			<a target="new" href="http://www.cnet.com">CNET</a> and <a target="new" href="http://www.ZDNet.com">ZDNet</a> honor the most promising products and technologies in personal technology and consumer electronics. Produced by AnchorDesk's David Coursey, the program documents the search for the Next Big Thing in a series of online reports that culminate at CES.
			<br><br><br>
		</td>
		<td width="15">&nbsp;</td>
		<td width="200" align="center" valign="middle" bgcolor="#FFFFFF"><img src="images/ZDnet.gif" border="0" align="middle">&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/cnetlogo.gif" border="0" align="middle"></td>
	</tr>
	<tr>
	...
	<tr>
	    <td valign="top" class="text" width="375"><img src="/global_images/spacer.gif" alt="" width="375" height="8" hspace="0" vspace="0" border="0"><br>
			<span class="section_title">And the winner is...<br><br></span>
			<b>802.11 wireless networking</b> gets the big thumbs up for the Next Big Thing&mdash;the emerging technology showcased at the 2003 International CES that is bound to change how people use consumer electronics.
			<br><br>
			Read why <a href="http://www.zdnet.com/anchordesk/filters/sr/0,15242,6014565,00.html" target="new"> it's all about Wi-fi</a>, and check out the <a href="http://news.com.com/2009-1040-979776.html" target="new">other technologies</a> that piqued the interest of CNET roving reporters.
			<br><br><br>
		</td>
		<td width="15"><img src="global_images/spacer.gif" alt="" width="15" height="1" hspace="0" vspace="0" border="0"></td>
		<td valign="middle" bgcolor="#ffffff" class="text" width="200" align="center"><img src="global_images/spacer.gif" alt="" width="200" height="1" hspace="0" vspace="0" border="0"></td>
	</tr>
</table>-->
<!-- /2 column table, containing 150px white column for images -->
<!-- /text for main page -->		
