...
<!-- Rollover script -->	
		...
		/* for graphical rollovers*/
			...
			function introllOver(which,name) 
				{
				var on="/global_images/0.0/random_main1/0.0_" + which + "_r.gif";
				if(document.images) {document.images[which].src=on;}
				else if (document.GetElementById){document.GetElementById(name).src=on;}
				}
			function introllOff(which) 
				{
				var on="/global_images/0.0/random_main1/0.0_" + which + ".gif";
				if(document.images){document.images[which].src=on;}
				else if (document.GetElementById){document.GetElementById(which).src=on;}
				}
...
<!-- logo and banner image row -->	
	<tr>
	    ...
	    <td width="10"></td>
	    <td width="610" colspan="6"><img src="/global_images/0.0/random_main1/0.0.banner.gif" alt="" width="610" height="74" border="0"></td>
	</tr>
<!-- /logo and banner image row -->		
...
<!-- colored row with section color 4 - 5 pixels high --> 
	<tr>
	    ...
	    <td width="140"></td>
	    <td width="10"></td>
	    <td width="610" colspan="6"  background="/global_images/spacer.gif" class="home4"><img src="/global_images/0.0/random_main1/0.0.bc_top.gif" width="610" height="5" hspace="0" vspace="0" border="0"></td>
	 </tr>
<!-- /colored row with section color 4 - 5 pixels high --> 	 
<!-- breadcrumb row -->
	<tr>
	    <td width="10"></td>
			...
			<td width="140"><a href="http://ww4.expocard.com/ces041/default.asp" onmouseover=snrollOver('.register'); onmouseout=snrollOff('.register');><img src="/global_images/0.0/0.0_files/0.0.register.gif" alt="Register" name=".register" id=".register" width="140" height="40" hspace="0" vspace="0" border="0"></a></td>
		
		<td width="10"></td>		

		
			<td width="610" colspan="6" background="/global_images/spacer.gif" class="home5"><img src="/global_images/0.0/random_main1/0.0.bc.gif" width="610" height="40" hspace="0" vspace="0" border="0"></td>
		...
		<!-- checking to see if the page is a main section page or not -->
			...
			<tr>
				...
				-->
				    ...
				    <td width="10" background="/global_images/spacer.gif" class="home9">&nbsp;</td>
				    <td width="380" class="home9" valign="top">
					<a href="/attendees/" onmouseover=introllOver('body'); onmouseout=introllOff('body');><img name='body' src="/global_images/0.0/random_main1/0.0_body.gif" alt="Main body image" width="380" height="224" hspace="0" vspace="0" border="0"></a>
...
<!-- text for main page -->
	...
	<tr>
	    ...
	    <td class="home10"><a href="http://ww4.expocard.com/ces041/default.asp">Register now</a><br>
		<span class="home10_text">Register by Dec. 5 to get your badge in the mail before the show.</span><br><br></td>
	</tr>
	<tr>
	    <td class="home10" valign="top"><b>></b>&nbsp;&nbsp;</td>
	    <td class="home10"><a href="/attendees/exhibit_floor/directory/exhibitor_name.asp">See the lineup</a><br>
		<span class="home10_text">Browse more than 2,300 companies in the exhibitor directory.</span><br><br></td>
	</tr>
	<!--
	<tr>
	    <td class="home10" valign="top"><b>></b>&nbsp;&nbsp;</td>
	    <td class="home10"><a href="/press/news/">Stop the presses</a><br>
		<span class="home10_text">2004 CES will be the largest ever. Read more record-breaking news.</span><br><br></td>
	</tr>
	-->
	<tr>
	    <td class="home10" valign="top"><b>></b>&nbsp;&nbsp;</td>
	    <td class="home10"><a href="/attendees/conferences/">Fill your schedule</a><br>
		<span class="home10_text">See the show's best-ever keynotes, conferences and partner programs.</span></td>
	</tr>						
	</table>
	<br><img src="global_images/spacer.gif" alt="" width="1" height="10" hspace="0" vspace="0" border="0""></span>
