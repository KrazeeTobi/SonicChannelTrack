...
<head>
	...
	<title>2004 International CES:&nbsp;International CES Meeting Place</title>
...
<!-- breadcrumb row -->
	<tr>
	    <td width="10"></td>
	    <td width="140"><a href="http://webtest.expocard.com/ces041/default.asp" onmouseover=snrollOver('.register'); onmouseout=snrollOff('.register');><img src="/global_images/2.0/2.0.register.gif" alt="Register" name=".register" id=".register" width="140" height="40" hspace="0" vspace="0" border="0"></a></td>
	    <td width="10"></td>
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="exhibitor7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">CES Meeting Place<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
...
Take advantage of a unique atmosphere featuring exclusive hospitality suites that deliver a private meeting or display area to suit your needs at the 2004 International CES.  Located right on the show floor, CES Meeting Place hospitality suites provide you an unconventional venue to meet with attendees in a private, comfortable, professional environment.
<br>
...
<div class="section_title">How suite it is</div>
