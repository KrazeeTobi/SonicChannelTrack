...
<head>
	...
	<title>2004 International CES:&nbsp;2004 International CES Exhibit Booth Space</title>
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="exhibitor7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Exhibit Booth Space<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
			

<div id="2.1.2">		
<!-- text for main page -->
The 2004 International CES makes it easy for attendees to meet the right exhibitors. All International CES venues are divided into market categories, promising that no company is overlooked.
<br>
...
<table border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td width="285"><span class="subhead">North Hall<br></span>
			...
			<br>
			<!--<span class="subhead">Grand Lobby</span><br>
			<ul>
				<li>CEA Booth
		...
		<td valign="top" width="285">
			...
			<!--<span class="subhead">South Hall Meeting Room Connector</span><br>
			<ul>
