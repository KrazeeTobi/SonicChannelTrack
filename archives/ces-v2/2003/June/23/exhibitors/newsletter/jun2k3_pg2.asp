...
<!-- table for secondary navigation and form -->
				...
				<tr>
				<td class="exhibitor_second_nav" width="560"><a href='/exhibitors/space/'>Exhibit Space</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='/exhibitors/promotions/'>Promotions</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='/exhibitors/resource_center/'>Resource Center</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href='/exhibitors/manual/'>Exhibitor Manual</a>&nbsp;&nbsp;|&nbsp;&nbsp;Newsletter&nbsp;&nbsp;|&nbsp;&nbsp;<a href='/exhibitors/downloads/'>Downloads</a></td>
...
<span class="subhead">International CES Pre-show Advertising</span><br>
	If you're exhibiting in the International CES, then you're part of a show that places more than 200 ads in over 100 publications in 
	the U.S. and abroad.
	<br><br>
	The International CES has an extensive vertical marketing campaign targeting audio, computing/home networking, emerging technologies, 
	electronic gaming, home theater, mobile electronics, video, digital imaging and wireless attendees.
	<br>
	An acquisition and retention campaign of more than 3 million e-mails reaches more than 350,000 unique prospects. In addition, we 
	reach prospective attendees through our direct mail campaign, which includes a pre-show planner, a conference brochure, targeted 
	postcards, vertical market publications and other promotional campaigns. 
	<br><br>
	If you want to build your brand at the show that makes the biggest impact on the consumer electronics industry, contact us 
	at <a href="mailto:exhibit@CESweb.org">exhibit@CESweb.org</a>.
...
<img src="/global_images/2.0/line.gif" alt="-----------------------------------------------" width="380" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<span class="subhead">NEW! TechZones Coming to CES</span><br>
	You might know them as "pavilions," but we're introducing something bigger and better, known as the "International CES TechZones."
	<br><br>
	<a href="/exhibitors/space/techzones.asp">The International 
	CES TechZones</a> feature the newest technologies, products 
	and companies to meet the consumer electronics industry. Be 
	part of the platform which offers an excellent way to build 
	your brand and meet key OEM contacts. See how these unique 
	exhibit options fit into your strategic plan for 2004. 
	<br><br>
	Current TechZones include Accessibility, Bluetooth, Business Solutions, Digital Car Showroom, 
	Distributed Audio, Energy Efficiency and Electronics Recycling, Embedded 
	Linux, Hi-Tech Fitness, MP3 and Internet Audio, PC Gaming, 
	Portable Power Center, RWPPI, Tablet PC Technologies, Tech 
	HomeTM, The Ultimate Wireless SuperStore and USB. 
	<br><br>
	For more information, please contact <a href="mailto:exhibit@CESweb.org">exhibit@CESweb.org</a>.
...
<img src="/global_images/2.0/line.gif" alt="-----------------------------------------------" width="380" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<span class="subhead">When's the Last Time You Spoke to Your Customers?</span>
	<br>
	Want to get valuable customer feedback—on a limited budget? Make use of the following ideas, which are right at your fingertips. 
	<br><br>
	<strong>E-mail.</strong> Inexpensive and easy. The key is to be brief and to-the-point. 
	Stay in touch with your client base through periodic e-mail 
	contact. Avoid flooding the "in" box! 
	<br><br>
	<strong>Postcards.</strong> Still a quick, less expensive way to grab the attention 
	of a select audience. Postcards are a good tool for announcements, 
	discounts and limited-time offers. 
	<br><br>
	<strong>Comment cards.</strong> How was our service to you? Get direct customer 
	feedback by asking a few pointed questions on a comment card. 
	Remember: Keep it simple, and you'll be likely to get a bigger 
	response. 
	<br><br>
	<strong>Web site.</strong> Make it an easy read. Use headers, bullet points and 
	not too many graphics. Also, make it easy for customers to 
	provide feedback, so they can e-mail comments directly to 
	you. 

<a name="new"></a>
<br>
<img src="/global_images/spacer.gif" alt="" width="1" height="25" hspace="0" vspace="0" border="0"><br>
<div class="calloutborder"><span class="subhead">Welcome New CEA Members!</span><br>
...
<img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<a name="newmembers"></a><div class="calloutborder"><span class="subhead">Welcome New International CES Exhibitors!</span><br>
<table width="90%" border="0" cellpadding="0" cellspacing="0">
		<tr> 
            <td width="45%" valign="top">
			  Adire Audio<br>
              Alpha &amp; Omega Computer<br>
              Artek Premium Ltd.<br>
              Basis Audio, Inc.<br>
              Colluck Co. Ltd.<br>
              Escalante Design<br>
              Kyocera<br>
              ...
              <td width="55%" valign="top">
			  Roadmaster (USA) Corp.<br> 
			  Sonance<br>
              Teleforma TV Mounts International SA CV<br>
              The TW/Keen High Technologies Ltd.<br>
              Three-Five Systems, Inc.<br>
              Ulead<br>
              United States Postal Service<br>
              Vandersteen Audio Inc.<br>
              Viva Audio Devices<br>
              VMPS Ribbon<br>
              What's in Store<br>
              Wizcom Technologies Inc.<br>
              Yuntong Power Co. Ltd.</td>
		</tr>
	</table></div>
		
<br><img src="/global_images/spacer.gif" alt="" width="1" height="15" hspace="0" vspace="0" border="0"><br>
		
<div align="center">[ <a href="jun2k3_pg1.asp">page 1</a> ] &nbsp; [ <strong>page 2</strong> ]</div>					
...
<!-- /text for main page -->
		...
		<img src="/global_images/spacer.gif" alt="" width="1" height="28" hspace="0" vspace="0" border="0""><br>
				<span class="subhead">Direct Mail Tips</span>
<ol>
	  <li>Define your message and benefits.</li>
	  <li>Target your audience.</li>
	  <li>Test on small mailings.</li>
	  <li>Contact current customers several times a year.</li>
	  <li>Call the reader&#8217;s attention with personalization, an attractive offer or appealing artwork.</li>
	  <li>Track leads and orders, so you can analyze response rates.</li>
</ol>

<br>
<img src="/global_images/spacer.gif" alt="" width="1" height="15" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/2.0/line.gif" alt="-----------------------------------------------" width="100%" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<span class="subhead">Book Hotel Reservations Now!</span><br>
<a href="/attendees/travel/hotel.asp">Choose from single or block-room reservations</a> from a variety of official CES hotels to get the best rates in Las Vegas. 
...
<img src="/global_images/2.0/line.gif" alt="-----------------------------------------------" width="100%" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<span class="subhead">Mark Your Calendar!</span><br>
  <b>Exhibitor Workshop</b><br>
...
<img src="/global_images/2.0/line.gif" alt="-----------------------------------------------" width="100%" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<span class="subhead">Operations/Booth Contacts</span><br>
<strong>LVCC North Halls</strong><br>
...
<img src="/global_images/2.0/line.gif" alt="-----------------------------------------------" width="100%" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images/spacer.gif" alt="" width="1" height="15" hspace="0" vspace="0" border="0"><br>
<div align="center"><img src="/exhibitors/newsletter/images/GES_logo.gif" width="110" height="43"></div>
<br>
<span class="subhead">GES Named 2003 Contractor of the Year in <em>EXPO</em> Magazine</span><br>
GES has been named Contractor of the Year in <em>EXPO</em> Magazine&#8217;s 2003 Reader&#8217;s Choice Supplier of the Year awards. EXPO readers, consisting of show managers from across the United States, voted on line...<br>
<a href="http://www.gesexpo.com/whats_new" target="_blank">Read more</a>.
<br><br>
<strong>Contact us at:</strong><br>
	  GES National Servicenter Telephone:<br>
	  (800) 475-2098<br>
	  (702) 263-1500<br>
	  Fax: (866) 329-1437 <br>
