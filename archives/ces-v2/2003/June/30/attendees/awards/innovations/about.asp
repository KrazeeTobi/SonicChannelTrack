...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">About the CES Innovations Awards Showcase<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
			

<div id="1.4.1.1">	
<!-- text for main page -->
<img src="images/innovations_2004.gif" align="right" vspace="0" width="70" height="115" hspace="10" onmousedown='Image_OnMouseDown()' alt="Innovations Design and Engineering Showcase Honors">
