...
<table width="90%" align="center">
	...
	<span class="subhead" style="text-align: left">CES:<br>Die EINZIGE AUSSTELLUNG,<br>die Sie einfach besuchen M&Uuml;SSEN</span><br>
	<span style="color:#004AA0">89% (oder USD 85 Milliarden) der Kaufkraft der Verbraucherelektronik-Branche &ndash; eine fast unglaubliche Zahl! &ndash; war auf der International CES 2002 zu finden.</span><br><br>
...
<span class="pagehead">Internationale Besucher: Allgemeine Informationen</span><br><br>
<span class="head">Denken Sie global.</span><br>
Die International CES vereint mehr der wichtigsten Repr&auml;sentanten der Verbraucherelektronik-Branche als jede andere Handelsmesse ihrer Art. Zur International CES 2003 kamen ungef&auml;hr: 
<ul>
	<li>2.200 Aussteller
	<li>110.000 Besucher
	<li>15.000 Menschen aus &uuml;ber 110 L&auml;ndern
	<li>4.000 Journalisten und 1.000 Branchenanalytiker
</ul>
<br>
<span class="subhead">Die International CES &mdash; schon bald ganz in Ihrer N&auml;he.</span><br>
Informieren Sie sich dar&uuml;ber, welchen Wert Ihnen die International CES zu bieten hat. Schauen Sie bei den folgenden Veranstaltungen auf dem Ausstellungsstand der International CES vorbei: 
<ul>
	<li>IFA (Internationale Funkausstellung): 29. August - 3. September, Berlin, Deutschland
	<li>Hongkong-Elektronikmesse: 13.-14. Oktober, Hongkong
	<li>TAITRONICS: 16.-20. Oktober, Taipei, Taiwan
</ul>
<br>

<span class="subhead">Seien Sie vorbereitet.</span><br>
Machen Sie schon heute Ihre Pl&auml;ne f&uuml;r die International CES 2004. So k&ouml;nnen Sie: 
<ul>
	<li>Fr&uuml;hzeitig <a href="http://www.travel.state.gov/visa_services.html" target="new">ein Visum beantragen</a>.
	<li>Sich ein <a href="http://www.travel.state.gov/DS-0156.pdf" target="new">Antragsformular f&uuml;r ein US-Visum</a> (Formular DS-0156) besorgen.
	<li>Eine <a href="http://www.travel.state.gov/links.html" target="new">US-Botschaft oder ein US-Generalkonsulat</a> ganz in Ihrer N&auml;he finden.
</ul>
<br>

<span class="subhead">Was ist f&uuml;r 2004 besonders interessant?</span><br>
<ul>
<li>Das internationale &bdquo;Premier&ldquo;-Servicepaket ist das beste Ausstellungs- und Konferenzpaket. Mit dem internationalen &bdquo;Premier&ldquo;-Paket erhalten Sie Zutritt zu allen Ausstellungen, Hauptansprachen, SuperSessions und zu &uuml;ber 70 Konferenzsitzungen. Au&szlig;erdem bekommen Sie Eintrittskarten f&uuml;r VIP-Luncheons, den internationalen Empfang und zu vielen anderen Veranstaltungen! Dieses Spezialpaket wird exklusiv unseren internationalen Teilnehmern angeboten, und zwar zum Preis von nur USD 299,00, wenn der Kauf vor dem 5. Dezember 2003 erfolgt.
<br><br>
<li>Die International CES 2004 ist stolz auf die Teilnahme am internationalen K&auml;uferprogramm IBP, als dessen Sponsor der US-Handelsdienst des US-Wirtschaftsministeriums fungiert. Die Teilnehmer an der CES k&ouml;nnen alle Vorteile des globalen Partnervermittlungsprogramms von IBP nutzen und Aussteller kennen lernen, die an Exportm&ouml;glichkeiten au&szlig;erhalb der Vereinigten Staaten interessiert sind. N&auml;here Informationen finden Sie auf der Website des <a href="http://www.usatrade.gov/website/website.nsf" target="new">US-Handelsdienstes</a>.
</ul>
<br>
</div>
<!-- **CONTENT ENDS HERE** -->
	...
	<TD VALIGN="top" width="135" bgcolor="#ffffff">
		...
		<TR>
			...
			<TD class="avshadowmain">
				...
				<div align="center" class="subhead">Merken Sie sich dieses Datum!</div><img src="/global_images/spacer.gif" height="4" border=0><br>	
				...
				<div align="center" style="COLOR:#004aa0">
					...
					<strong>8.-11. Januar 2004<br>Las Vegas, Nevada</strong>
		...
		<TR>
			...
			<TD>
				...
				<span class="subhead">Nichts verpassen.</span><br>
				Bitte <a href="/registration/">geben Sie Ihre E-Mail-Adresse ein</a> damit wir Sie gleich informieren k&ouml;nnen, sobald Anmeldungen zur International CES 2004 akzeptiert werden. 
