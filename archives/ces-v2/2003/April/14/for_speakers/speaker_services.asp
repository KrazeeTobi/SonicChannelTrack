...
<TITLE>2003 International CES: Speaker Services</TITLE>
...
<SCRIPT language="javascript1.2">init('4');</SCRIPT>
...
<TR>
	...
	<TD ALIGN="center" COLSPAN="5" BACKGROUND="/global_images/subtab_bg_speakers.gif" CLASS="subtab_speakers">
		<A HREF="/for_speakers/call_speakers.asp" ONMOUSEOVER="rollover('subtab_speakers_call', subtab_speakers_call_active);" ONMOUSEOUT="rollover('subtab_speakers_call', subtab_speakers_call_standard);"><IMG NAME="subtab_speakers_call" SRC="/global_images/subtab_speakers_call.gif" ALT="Call for Speakers" BORDER="0"></A>
		<!--<A HREF="/for_speakers/speaker_form.asp" ONMOUSEOVER="rollover('subtab_speakers_submission', subtab_speakers_submission_active);" ONMOUSEOUT="rollover('subtab_speakers_submission', subtab_speakers_submission_standard);"><IMG NAME="subtab_speakers_submission" SRC="/global_images/subtab_speakers_submission.gif" ALT="Speaker Submissions" BORDER="0"></A>-->
		<A HREF="/for_speakers/speaker_services.asp" ONMOUSEOVER="rollover('subtab_speakers_services', subtab_speakers_services_active);" ONMOUSEOUT="rollover('subtab_speakers_services', subtab_speakers_services_active);"><IMG NAME="subtab_speakers_services" SRC="/global_images/subtab_speakers_services_active.gif" ALT="Speaker Services" BORDER="0"></A>

<!-- comment out speak@otherceaevents until after ces call for speakers deadline passes
		<A HREF="" ONMOUSEOVER="rollover('subtab_speakers_events', subtab_speakers_events_active);" ONMOUSEOUT="rollover('subtab_speakers_events', subtab_speakers_events);"><IMG NAME="subtab_speakers_events" SRC="/global_images/subtab_speakers_events.gif" ALT="Speak @ Other CEA Events" BORDER="0"></A>
	</TD>
-->
...
<TR>
	...
	<img src="/global_images/ad_campaign/green_orange.jpg"><br><IMG SRC="/global_images/spacer.gif" HEIGHT="10" border="0">
	

	<div align="center"><A HREF="http://www.ce.org" target="new"><IMG SRC="/global_images/CEAproCESart.jpg" BORDER="0"></A></div><br>	
	
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","4.3")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="4.3">
<span class="pagehead">Speaker Services</span><br><br>
<span class="head">Speaker Services @ CES</span><br><br>
<span class="subhead">CES Staff Assistance</span>
<br>
If you are a speaker at CES and have questions that are not answered here, please e-mail Kartraice D. Hooper at <a href="mailto:khooper@CE.org?subject=CES Speaker Question">khooper@ce.org</a> or Cia Morey at <a href="mailto:cmorey@CE.org?subject=CES Speaker Question">cmorey@CE.org</a>.
<br><br>
<span class="subhead">Speaker Registration and Badge Pick-up</span>
<br>
As a speaker at CES, you will be registered automatically. Your badge will be available in the Speaker Ready Rooms upon your arrival. 
<br><br>
<span class="subhead">On-Site Speaker Ready Room</span>
<br>
CES speakers have access to our Speaker Ready Rooms. Take advantage of this opportunity to orient yourself with the program location, fine tune your presentation and network with your peers. 
The Speaker Ready Rooms are located in the Las Vegas Convention above the North Hall exhibits next to room N263 and in the New South Hall Room S117/118.
<br><br>
<span class="subhead">Conference Sessions Audio/Visual Equipment</span>
<br>
The standard A/V in each conference session will be: 
<br><img src="/global_images/bullet.gif" border="0">LCD data projector 
<br><img src="/global_images/bullet.gif" border="0">Podium and podium microphone 
<br><img src="/global_images/bullet.gif" border="0">Microphones for panelists 
<br><img src="/global_images/bullet.gif" border="0">8' x 8' screen 
<br><img src="/global_images/bullet.gif" border="0">VGA switch box 
<br><br>
If you plan to use visuals during your session, all speakers are encouraged to use the <a href="/for_speakers/2k3CESSpeaker.ppt" target="new">CES PowerPoint template</a>. You must provide your own laptop. 
<br><br>
<span class="subhead">Speaker Ready Room Amenities</span>
<br>
In the Las Vegas Convention Center (LVCC) Speaker Ready Rooms, you will find the tools and assistance you need to gather your notes, practice your presentation and quench your thirst at CES. 
<br><img src="/global_images/bullet.gif" border="0">Speaker work area 
<br><img src="/global_images/bullet.gif" border="0">Computers and Internet access 
<br><img src="/global_images/bullet.gif" border="0">Phones/fax machine 
<br><img src="/global_images/bullet.gif" border="0">Show directories and events schedules 
<br><img src="/global_images/bullet.gif" border="0">Copier 
<br><br>
Morning and afternoon snacks, served daily beginning Thursday 9, January 7, through Saturday, January 11 on a first-come, first-served basis. 
<br><br>
<span class="subhead">Show Conferences Staff</span>
<br>
Kelly Ricker, Staff Director
<a href="mailto:kricker@CE.org">kricker@CE.org</a>
<br>
Cia Morey, Manager
<a href="mailto:cmorey@CE.org">cmorey@CE.org</a>
<br>
Anne Legarreta, Manager
<a href="mailto:annel@CE.org">annel@CE.org</a>
<br>
Lisa McKellar, Manager
<a href="mailto:lmckellar@CE.org">lmckellar@CE.org</a>
<br>
Kartraice D. Hooper, Coordinator
<a href="mailto:khooper@CE.org">khooper@CE.org</a>
...
<TR>
	<td>&nbsp;</td>
	<TD CLASS="avshadowspeak"><img src="/global_images/spacer.gif" width="2">&nbsp;</TD>
	<TD CLASS="avshadowspeak"><br>
	<!-- **INSERT ADDED VALUE HERE** -->
	<b>Can't find the speaker information you are looking for?</b>
	<br><br>
	Get answers to some of the most popular questions from speakers in the <a href="/help/speaker_faq.asp">Speaker FAQ</a> list.
	<br><br>
	</TD>
	<TD CLASS="avshadowspeak"><img src="/global_images/spacer.gif" width="2"></TD>
</TR>
