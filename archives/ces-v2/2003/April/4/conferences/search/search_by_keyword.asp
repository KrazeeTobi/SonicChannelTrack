...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.1.4.7")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<BR>
<span class="head">Search by Keyword</span><br><br>
<table cellpadding=3 cellspacing=1 border=0><form action=session_by_keyword_list.asp method=post><tr><td>Enter a Keyword Search String</td></tr><tr height=7><td></td></tr><tr><td align=center><input class=formdata type=text name=srchstring size=50></td></tr><tr><td valign=middle align=center><font class=formidentifier>Search In:&nbsp;&nbsp;<input type=radio name=srchtype value=SS checked>&nbsp;Sessions&nbsp;&nbsp;<input name=srchtype type=radio value=SP>&nbsp;Speakers</font></td></tr><tr height=7><td></td></tr><tr><td align=center><input class=formdata type=submit value=Search>&nbsp;<input class=formdata type=Reset></td></tr><input type=hidden value=CES03></table></form>
