...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.6.2.2.20")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<br>
<span class="head">Online/Internet</span><br><br>
<table width="100%" cellpadding="1" cellspacing="0" border="0">


<tr>
	<td><br><img src="jpgs/products/OLIFLE1.jpg" width="90"  border=0 alt="Audrey"></td>
	<td><br><span class="subhead">3Com Corporation</span><br>
...
<tr><td colspan="2"><span face="body" size="2"><br>
		 The Ergo Audrey™ by 3Com - 3C8300AUWHT-01 (Linen)<br>
	</td>
</tr>
<tr>
...
<tr>
	<td><br><img src="jpgs/products/OLISIL10.jpg" width="90"  border=0 alt="Silicon Portals USB Internet Phone"></td>
	<td><br><span class="subhead">Silicon Portals Inc</span><br>
	<span class="text"><a target="new" href="http://www.siliconportals.com">www.siliconportals.com</a><br>
	<i>In-House Design Team</i><br>
	Silicon Portals USB Internet Phone</span></td>
</tr>
<tr><td colspan="2"><span face="body" size="2"><br>
		 Product Name: Silicon Portals USB Internet Phone Model Number: CP0201 GR Product Title: Internet Phone that 
		 brings Voice over IP to everyone It is an USB phone that allows users to make internet phone calls through 
		 their PC.  Users simply pick up the phone and dial, just like the way they make conventional phone calls.  
		 It also comes with a simple-to-use Graphical User Interface that provides users easy access to the PC phone 
		 book and other call related information.  Users will also enjoy value-added services such as streaming 
		 destination city information and profiles of parties they are calling.  Silicon Portals USB Internet Phone 
		 is to Internet Telephony what Mouse is to Graphical User Interface.<br>
	</td>
</tr>
<tr>
	<td colspan="2"><span face="body" size="2"><br>
		<b>Location: 31225 Riviera</b>
	</td>
</tr>
</table>
<br>
