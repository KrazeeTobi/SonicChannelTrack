...
<TITLE>2003 International CES: Las Vegas Info</TITLE>
...
<TR>
	...
	<TR CLASS="leftsubnav_main" ONCLICK="goto_link('/travel/shuttle.asp');" ONMOUSEOVER="rollover_td('shuttle','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('shuttle','leftsubnav_main');">
		<TD ID="shuttle_cellspacer" CLASS="leftsubnav">&nbsp;</TD>
		<TD ID="shuttle" CLASS="leftsubnav"><A HREF="/travel/shuttle.asp"  CLASS="leftsubnav_main">CES Shuttle</A></TD>
		<TD ID="shuttle_arrowcell" CLASS="leftsubnav"><IMG SRC="/global_images/spacer.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
	<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	...
	<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/travel/vegasinfo.asp');" ONMOUSEOVER="rollover_td('vegas','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('vegas','leftsubnav_main_active');">
		<TD ID="vegas_cellspacer" CLASS="leftsubnav">&nbsp;</TD>
		<TD ID="vegas" CLASS="leftsubnav"><A HREF="/travel/vegasinfo.asp" CLASS="leftsubnav_main_active">Las Vegas Info</A></TD>
		<TD ID="vegas_arrowcell" CLASS="leftsubnav"><IMG SRC="/global_images/context_arrow-new.gif" WIDTH="17" HEIGHT="20"></TD>
	</TR>
		<TR>
		<TD COLSPAN="3"><IMG SRC="/global_images/page_sep_horiz.gif" WIDTH="130" HEIGHT="1"></TD>
	</TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.10.5")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="1.10.5">
<span class="pagehead">Travel :: Las Vegas Info</span><br><br>
<span class="head">Viva Las Vegas!</span>
<BR><BR>
<b>Las Vegas</b> may be the &quot;Entertainment Capital of the
World,&quot; but its reputation for catering to the serious
business traveler deserves equal billing. Superb dining,
sophisticated shopping, and world-class golf and tennis
make the business traveler's experience outside the
2003 International CES almost as enticing as the
showcase itself.
<!-- image here -->
<table WIDTH="442" BORDER="0" CELLPADDING="0" CELLSPACING="0" align="center">
	<tr>
		<td COLSPAN="2"><img SRC="/travel/images/vegas_postcard_top.gif" WIDTH="442" HEIGHT="72"></td>
	</tr>
	<tr>
		<td><img SRC="/travel/images/vegas_postcard_left.gif" WIDTH="227" HEIGHT="115"></td>
		<td><img SRC="/travel/images/vegas_postcard_right.gif" WIDTH="215" HEIGHT="115"></td>
	</tr>
	<tr>
		<td COLSPAN="2"><img SRC="/travel/images/vegas_postcard_bottom.gif" WIDTH="442" HEIGHT="84"></td>
	</tr>
</table>
<br>

<table width="35%" align="right" border="0">
<tr>
	<td>
	<div style="border-style:solid;border-width:1;border-color:666699;background-color:edf4f8;padding:5">
	&quot;CES is an excellent venue to launch a new industry, a new technology, a new product and a new company. Public relations, investor relations, sales contacts, business partnerships - we got to do it all in a quality environment.&quot;</span><br>
	<em>Joseph P. Clayton, President and CEO, Sirius Satellite Radio</em>
	</div>
	</td>
</tr>
</table>
...
Surely, no other single city can boast such a diverse
and unique choice of hotel accommodations and casinos.
That's why more than 30-million people visit every
year - just to immerse themselves in a breathtaking
array of spectacular events, including magic acts, circus
acts, comedy acts and concerts.
<br><br>
Sprung from the rugged Nevada desert that surrounds
it on all sides, Las Vegas is a truly American entertainment
experience. Extend your stay to enjoy this sensational,
one-of-a-kind metropolis. To plan in advance, visit
<a href="http://www.lasvegas24hours.com" target="new">www.lasvegas24hours.com</a>.
<br><br>
While at CES, take advantage of the city! Let us help guide you to some of our favorite  
places and provide resources to make your stay easier and more pleasurable!
<br><br>

<span class="subhead">Las Vegas Weather</span>

<table>
<form method="post" action="http://www.weather.com/cgi-bin/uncgi/zip_city_search.cgi?par=internal&amp;site=magnet&amp;code=289123&amp;promo=english" id=form1 name=form1>
<!--<tr>
	<td>&nbsp;&nbsp;Enter a City or US Zip:</td>
	<td><input type="text" name="destination" size="8" value>&nbsp;<input type="image" src="http://image.weather.com/pics/button_go.gif" width="26" height="23" border="0" alt="go!" value="Go City" id=image1 name=image1></td>
</tr>-->
<tr>
	<td colspan="2">
	<a href="http://oap.weather.com/fcgi-bin/oap/redirect_magnet?loc_id=USNV0049&amp;par=internal&amp;site=magnet&amp;code=289123&amp;promo=english">
	<img border="0" width="270" height="140" SRC="http://oap.weather.com/fcgi-bin/oap/generate_magnet?loc_id=USNV0049&amp;code=289123"></a>
	</td>
</tr>
</form>
</table>
<br>
<span class="subhead">Getting Around: CES Foots The Bill</span>
<br>
While you&#146;re at CES, you will have plenty to do and see &#151; stimulus overload. Let us provide your 
transportation. The <a href="/travel/shuttle.asp">CES shuttle</a> runs every day during the show to and from the Las Vegas 
Convention Center and all official CES hotels. CES also provides discounts on <a href="/travel/airlines_cars.asp">airfare and car rentals</a>.
<br><br>
Please remember there is very limited parking at CES this year. Choose your transportation battles wisely and let us be your chauffeur!<br>
<br>
Other Vegas transportation options include:
<ul>
<li>Limos</li>
<li><a href="/travel/taxi_park.asp">Taxi</a> - (fares range from $8-10 per trip)</li>
<li>Bus</li>
<li>Private Cars </li>
<!-- (check out the  <a href="http://govegas.about.com/travel/govegas/gi/dynamic/offsite.htm?site=http://www.totalvegas.com/limos/limos.html">Party Bus</a> -- we say &quot;Way Cool&quot;)-->
</ul>
<br>
For more details on getting around Vegas, including traffic jam areas and how to save some precious dollars, check out About.com's <a href="http://govegas.about.com/travel/govegas/msubaround.htm" target="new">resources for Las Vegas Visitors</a>.<br>
<BR>
<span class="subhead">Secrets to Vegas from Those in the Know, By Vegas.com</span>
<br>
<strong>Tips on tipping:</strong> Since Las Vegas is a service-based city, tipping is a big, big deal. Just ask the IRS. You may not be too sure how much to tip and when. So here's a quick rundown.<br>
<BR>
<ul>
<li>Bellmen: They usually receive $1 a bag, but an extra tip is suggested if you use them to make show reservations or if they help you with taxis, etc. </li>
...
<li>Change person: Don't forget to slip a few bucks to these helpful folks -- especially if you win. Don't try to palm off a $5 tip for a Megabucks win; it's insulting.</li>
</ul>
<BR>
These are just suggestions -- and you're always welcome to tip more!<br>
<br>
<strong>A CES quick tip:</strong> Taking the CES shuttle requires Zero Dollars! That includes No Tipping!
<br><br>
