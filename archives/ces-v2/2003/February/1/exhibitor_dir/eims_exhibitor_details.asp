...
<!--
	function getBoothDetail(strBoothQueryString)
	{
		var xPoint = window.screen.width / 3;
		var yPoint = window.screen.height / 2;
		var height = window.screen.height / 3;
		var width = window.screen.width / 4;
		var boothURL = "/exhibitor_dir/eims_view_booth_detail.asp?" + strBoothQueryString;
		var strFeatures = "scrollbars=yes,height=" + height + ",width=" + 
			width + ",screenX=" + xPoint + ",screenY=" + yPoint + 
			",left=" + xPoint + ",top=" + yPoint;
			
		window.open(boothURL, "BoothDescription", strFeatures);
	}
//-->
</script>
...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","1.2.0.1")><IMG border="0" SRC="/global_images/page_tool_print2.gif" BORDER="0"></A><br>
	...
	<!-- content begins here, then table data <TD> cell is closed in page_right_column.asp --> 
<!-- **this file includes page_left_column.asp** -->	
		
<!-- **CONTENT STARTS HERE** -->

<!-- content starts here --> 
<div class="text" id="1.2.0.1">
<span class="pagehead">Exhibitor Directory :: Search by Exhibitor</span><br><br>
<div class="head">Company Details</div>
<br>
<!-- include file for exhibitor detail -->

<table border='0' cellspacing='0' cellpadding='0' width='100%'>
<tr><td>&nbsp;</td></tr><tr height='8'><td colspan='2'></td></tr><tr><td valign='top' colspan='2'>
<div class='callout'></td></tr><tr><td width='75%'></div>

URL: <a href='http://' target='new'></a></td><td align='right' valign='top'>&nbsp;</td></tr><tr><td colspan='2' height='20'>&nbsp;</td></tr></table><table border='0' cellspacing='0' cellpadding='0' width='100%'>
<tr><td valign='top' width='27%'><span class=exhibdir>Company Booth(s):</span></td>
<td valign='top'><div class='formPreFilled'>There are no booths listed for this exhibitor.</div>
</td></tr><tr><td colspan='2' height='20'>&nbsp;</td></tr><tr><td valign='top'><div class='exhibdir'>Company Contact(s):</div></td><td colspan='2' height='20'>None listed.</td></tr><tr><td colspan='2' height='20'>&nbsp;</td></tr><tr><td valign='top'><div class='exhibdir'>Brand Name(s):</div></td><td colspan='2' height='20'>None listed.</td></tr><tr><td colspan='2' height='20'>&nbsp;</td></tr><tr><td valign='top' class='exhibdir'>New Product(s) at CES:</td>
<td colspan='2' height='20'>None listed.</td></tr><tr><td colspan='2' height='20'>&nbsp;</td></tr><tr><td valign='top'><span class='exhibdir'>Financial Exchange(s):</span></td><td colspan='2' height='20'>None listed.</td></tr><tr><td colspan='2' height='20'>&nbsp;</td></tr></table>

<!-- comment out booth info

		<!--<table>
			<tr>
				<td><font class='formIdentifier'>See where this exhibitor's booths are at the show: <a href="javascript:parseAndGo('eims_exhibitor_booth_maps.asp?eid=')">click here</a></form></td>
				<td><a href="javascript:parseAndGo('eims_exhibitor_booth_maps.asp?eid=');"><img src="../global_images/viewmap.gif" border=0></a></td>
				<td><font class='formIdentifier'>See where this exhibitor's booths are&nbsp;<a href="javascript:parseAndGo('eims_exhibitor_booth_maps.asp?eid=');">at the show</a>!</form></td>
			</tr>
		</table>
		-->
	...
	<table cellpadding=0 cellspacing=0 border=0 width="100%">
		<tr>
			<td width="27%" valign="top"><span class="exhibdir">Public<br>Relations Contact(s):</span></td>
			
			<td valign="top" width="40%"><span class="formIdentifier">Year-round</span><br>
		None listed.<br><br>
			</td>	
			
			<td valign="top" width="40%"><span class="formIdentifier">On-site (at the show)</span><br>
		None listed.<br><br>
			</td>
	...
	<table cellpadding=0 cellspacing=0 border=0 width="100%">
		<tr>
			<td width="27%" valign="top"><span class="exhibdir">Investor<br>Relations Contact:</span></td>
...
<br>
<a href="javascript:history.back()">Back</a> to search results
<br><br>
	</TD>
