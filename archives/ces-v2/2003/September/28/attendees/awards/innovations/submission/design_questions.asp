...
<head>
	...
	<title>2004 International CES:&nbsp;Innovations 2004 Designer Information</title>
...
function CheckFields(){
	...
	if(document.frm_member.inHouseDesigner.value == ""){
		alert("Please tell us if the Designer is an in-house designer.")
		return false
	}
}
</script>
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Designer Information<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
...
<form name="frm_member" action="design_questions_submit.asp?ia_id=&login_id=" method="post">
	...
	<tr>
		<td>Was an in-house design team used?&nbsp;&nbsp;
...
<table width="100%">
	<tr>
		<td align="center"><input type="submit" name="btn_submit" value="Continue" class="formData"></td>
	</tr>
