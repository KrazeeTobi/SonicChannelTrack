...
<head>
	...
	<title>2004 International CES:&nbsp;Innovations 2004 Manufacturing Company Quick-Find</title>
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Manufacturing Company Quick-Find<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
...
<form name="searchByExhibitorName" action="awards_exhibitor_name_search_results.asp?ia_id=&login_id=" method="post">
<tr cols="4">
