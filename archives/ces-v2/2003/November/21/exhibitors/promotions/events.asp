...
<head>
	...
	<title>2004 International CES:&nbsp;byb+ Industry Events</title>
...
<br>
	    ...
	    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="exhibitor7" valign="top">
			<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Industry Events<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
