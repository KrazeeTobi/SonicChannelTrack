...
<!-- Rollover script -->	
		...
		/* for graphical rollovers*/
			...
			function introllOver(which,name) 
				{
				var on="/global_images/4.0/random_main3/4.0_" + which + "_r.gif";
				if(document.images) {document.images[which].src=on;}
				else if (document.GetElementById){document.GetElementById(name).src=on;}
				}
			function introllOff(which) 
				{
				var on="/global_images/4.0/random_main3/4.0_" + which + ".gif";
				if(document.images){document.images[which].src=on;}
				else if (document.GetElementById){document.GetElementById(which).src=on;}
				}
...
<!-- logo and banner image row -->	
	<tr>
	    ...
	    <td width="10"></td>
	    <td width="610" colspan="6"><img src="/global_images/4.0/random_main3/4.0.banner.gif" alt="" width="610" height="74" border="0"></td>
	</tr>
<!-- /logo and banner image row -->		
...
<!-- colored row with section color 4 - 5 pixels high --> 
	<tr>
	    ...
	    <td width="140"></td>
	    <td width="10"></td>
	    <td width="610" colspan="6"  background="/global_images/spacer.gif" class="international4"><img src="/global_images/4.0/random_main3/4.0.bc_top.gif" width="610" height="5" hspace="0" vspace="0" border="0"></td>
	 </tr>
<!-- /colored row with section color 4 - 5 pixels high --> 	 
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<td width="610" colspan="6" background="/global_images/spacer.gif" class="international5"><img src="/global_images/4.0/random_main3/4.0.bc.gif" width="610" height="40" hspace="0" vspace="0" border="0"></td>
...
<br>
		...
		<tr>
		    ...
		    <td width="380" class="international9" valign="top"><img src="/global_images/spacer.gif" height="8" width="1"><br><div class="body_title"><span class="international9">International Visitors</span><br><img src="/global_images/spacer.gif" height="16" width="1"></div>
...
-->
	...
	<tr>
		...
		<a href="http://ww4.expocard.com/ces041/default.asp">Register now</a> to learn what is happening next in the industry from the people right on the forefront of consumer technology. Hear Bill Gates (Microsoft), Carly Fiorina (HP), Fumio Ohtsubo (Panasonic/Matsushita) and other top-level executives from some of the industry's most powerful companies.
		<br><br>
		...
		<br><br><br>
 		...
 		<td width="10" class="international8"><img src="/global_images/spacer.gif" width="10" height="1"></td>
   		<td width="190" class="international8" valign="top"><img src="/global_images/spacer.gif" width="10" height="10"><br>
		<a href="/about_ces/photos/default.asp"><img src="/global_images/4.0/cabinet.jpg" width="190" height="111" alt="show floor image" border="0"></a>
		<br>
		<a href="/attendees/travel/hotel.asp">Book your hotel room early</a><br>
		Rent one room or get quotes for an entire block. Our new hotel program makes either option easy. 
		<br><br>
		</td>
		<td width="10" class="international8"><img src="/global_images/spacer.gif" width="10" height="1"></td>
