...
The mobile electronics business continues its steady evolution from audio hardware roots to a converging electronics world that encompasses audio, video and multimedia, as well as telematics communications.
<br><br>
Digital satellite radio will make further inroads into American cars and trucks as XM Satellite Radio and Sirius, who now have more than 500,000 subscribers between them, continue to roll out their services nationwide.
<br><br>
Compressed audio&mdash;in the guise of MP3, Windows Media (WMA) and other formats&mdash;undoubtedly will gain more ground this year. Consumers are exercising their right to rip CDs that they have purchased onto PC hard drives and to download music from the Internet for playback in the vehicle and on portable devices. Vehicle audio equipment suppliers will feed this market with hard-disk-based source components and head units that accept solid-state media. Wireless connectivity and networking in the car will expand in 2003, while such traditional audio products as amplifiers and processors will get another boost from the surging mobile entertainment business.
<br><br>
