...
<div id="1.2.1.1">	
<!-- text for main page -->
<!--Navigate the 2004 International CES Exhibitor Directory to locate important exhibitor information including company details, show location and contact information.
<BR><BR>-->
Browse our online exhibitor directory by selecting the letter of the companies you are interested in locating or use the quick find tool to search for exhibitors.
<br>
...
<div class="section_title">Browse the 2004 International CES Exhibitor Directory</div>
	...
	<br>
		...
		<tr>
			<td colspan="3">
			<img src="/global_images/spacer.gif" alt="" width="1" height="35" hspace="0" vspace="0" border="0"><br>
	        <img src="/global_images/1.0/line.gif" alt="-----------------------------------------------" width="590" height="1" hspace="0" vspace="0" border="0"><br>
		...
		<tr><td height="20"><img src="/global_images/spacer.gif" height="20" width="1"></td></td></tr>
		
		<tr>
			<td class="rowlabel">Show Locations&nbsp;&nbsp;</td>
			<td colspan="2">
