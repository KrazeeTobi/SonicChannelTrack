...
<!--
	function zoomToBooth(strBoothNumber)
	{
		var xPoint = window.screen.width / 6;
		var yPoint = window.screen.height / 6;
		var height = window.screen.height / 1.75;
		var width = window.screen.width / 1.75;

		var boothURL = "/exhibitor_dir/eims_exhibitor_booth_maps_zoom.asp?booth_ID=" + strBoothNumber;

		var strFeatures = "scrollbars=yes,height=" + height + ",width=" + 
			width + ",screenX=" + xPoint + ",screenY=" + yPoint + 
			",left=" + xPoint + ",top=" + yPoint;
			
		window.open(boothURL, "BoothZoom", strFeatures);
	}
//-->
</script>
...
<p>
<font face="Arial" size=2>/exhibitor_dir/eims_exhibitor_booth_maps.asp</font><font face="Arial" size=2>, line 66</font> 