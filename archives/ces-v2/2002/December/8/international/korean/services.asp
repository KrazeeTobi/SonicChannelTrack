...
<TR>
	...
	<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0">
		<TR CLASS="leftsubnav_main" ONCLICK="goto_link('/international/korean/default.asp');" ONMOUSEOVER="rollover_td('general','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('general','leftsubnav_main');">
			<TD ID="general_cellspacer">&nbsp;</TD>
			<TD ID="general"><a href="/international/korean/default.asp" CLASS="leftsubnav_main">일반 정보</a></TD>
		...
		<TR CLASS="leftsubnav_main_active" ONCLICK="goto_link('/international/korean/services.asp');" ONMOUSEOVER="rollover_td('services','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('services','leftsubnav_main_active');">
			<TD ID="services_cellspacer">&nbsp;</TD>
			<TD ID="services"><a href="/international/korean/services.asp" CLASS="leftsubnav_main_active">혖E갋� 서비스</a></TD>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="5.7.2">
<span class="pagehead">해외 방문객 :: 참관인 서비스</span>
<br><br>
<span class="head">CES 동안 시간을 최대한 활용하십시오.</span><br><br>
<span class="subhead">해외 참관인 서비스</span><br>
International CES는 전세계 각국의 방문객들을 환영하기 위해 최선의 노력을 다하고 있습니다. CES에 참관하시기 위해 먼 거리를 여행하시고 귀중한 시간을 내어주신 데 대해 진심으로 감사드립니다. CES에서는 여러분들을 최대한 편안히 모시기 위해 많은 서비스를 준비하고 있습니다.<br><br>
<b>국제 교역 센터(ICC)</b><br>
<em><b>센터 두 곳 준비!</b></em><br>
CES 방문을 통해 소기의 목적을 달성할 수 있도록 라스 베이거스 컨벤션 센터의 남쪽 홀과 라스 베이거스 힐튼 호텔에 ICC를 준비하였습니다.  두 ICC 모두 회의실, 복사기, 팩스, 인터넷 연결과 같은 비즈니스 서비스를 제공합니다.  언제든지 안내나 번역 또는 통역 서비스가 가능한 전문 통역 직원의 도움을 받을 수 있습니다.<br><br>
<b><em>ICC 비즈니스 서비스:</em></b><br>
<ul>
	<li>인터넷 스테이션
	<li>비공개 회의실 - 매일 시간 단위로 예약 가능
	<li>팩스 및 복사기
	<li>전화 카드나 신용 카드로 사용할 수 있는 전화
</ul>
<br>
<b><em>ICC 이용 시간:</em></b><br>
<table width="50%">
	<tr>
	<td>
	1월 8일<br>
...
<br>
<b>CES 통역 서비스</b><br>
중국어,일본어, 프랑스어, 독일어, 스페인어의 통역이 필요하신 분은 언제든지 ICC에서 통역사들의 도움을 받을 수 있습니다.<br><br>
<b>수출 희망 출품업체 찾기</b><br>
International CES에서는 해외에 수출을 원하는 출품업체와 해당 업체의 제품 정보를 보유하고 있습니다.  8월부터 웹 사이트에 있는 출품업체 디렉토리를 검색하시면 여러분의 국가에서 진입하고자 하는 수출 희망 출품업체를 찾을 수 있습니다.  CESweb의 Exhibitor Section을 방문하시면 원하는 업체를 찾을 수 있습니다. 출품업체들은 2003년 박람회가 시작될 때까지 지속적으로 제품 목록을 업데이트합니다.<br><br>
<b>국제 리셉션</b><br>
2003년 1월 9일에 열리는 CES 국제 리셉션에 여러분을 초대합니다. 이 리셉션을 통해 수출 희망 출품업체와 기타 여러 국가의 업계 관계자를 만나 교류를 쌓을 수 있습니다.  참가 신청은 현지의 해외 등록(International Registration) 구역에서 신청하거나 라스 베이거스 컨벤션 센터나 라스 베이거스 힐튼에 있는 ICC에서 신청할 수 있습니다.<br><br>
<b>CES 교통편</b><br>
<b><i>공항.</i></b> 라스 베이거스에는 공항을 오가는 셔틀 버스, 렌트카, 택시, 리무진 등 다양한 교통편이 있습니다. 또한 편리하고 쉽게 이용할 수 있는 Strip/Downtown 셔틀 버스와 매일 정해진 노선을 운행하는 대중 교통수단이 잘 갖추어져 있습니다.<br><br>
<b><i>공식 CES 호텔.</i></b> 박람회 개최 동안 편안한 셔틀 버스가 공식 CES 호텔과 라스 베이거스 컨벤션 센터 사이에 매일 운행되며, 또한 컨벤션 센터와 알렉시스 파크(Alexis Park) 호텔 간에도 운행됩니다.<br><br>
<b>라스 베이거스를 처음 방문하십니까?</b><br>
라스 베이거스는 세계에서 가장 매력적인 도시 중 하나로, 다양한 먹거리, 최고의 오락 시설, 카지노, 후버 댐, 그랜드 캐년 등 다양한 볼거리가 있는 관광 도시입니다. <a target="new" href="http://www.lasvegasfreedom.com">Las Vegas Convention & Visitor's Authority</a>는 2002 국제 가전 제품 박람회와 더불어 라스 베이거스에서 기억에 남을 만한 관광할 수 있도록 다양한 정보를 제공합니다.
<br><br>
<a target="new" href="http://www.vegasfreedom.com/play-12.asp">라스 베이거스 지도와 교통 정보</a>에 대한 자세한 내용을 보려면 클릭하십시오.<br><br>
</div>
<!-- **CONTENT ENDS HERE** -->
