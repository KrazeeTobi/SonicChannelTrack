...
<TR>
	...
	<TR CLASS="leftsubnav_main" ONCLICK="goto_link('/about_ces/photos.asp');" ONMOUSEOVER="rollover_td('photos','leftsubnav_main_active');" ONMOUSEOUT="rollover_td('photos','leftsubnav_main');">
		<TD ID="photos_cellspacer">&nbsp;</TD>
		<TD ID="photos"><a href="/about_ces/photos.asp" CLASS="leftsubnav_main">CES Photos</a></TD>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","0.2.3")><IMG SRC="/global_images/mail.gif" BORDER="0"></A><br>
