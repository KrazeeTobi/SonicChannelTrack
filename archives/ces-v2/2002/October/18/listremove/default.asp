...
<TITLE>2003 International CES: &nbsp;Unsubscribe</TITLE>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="0.0"><br>
<span class="head">CES Email List Remove</span><BR><BR>


	<form name="sF" action="/listremove/default.asp" method="post" onSubmit="return validateemail(this)">
	<span class="subhead">To unsubscribe from the list, please enter your email address:</span>
	<br><br>
	<input type="text" name="removeemail" size="30">&nbsp;<input type="submit" value="submit">
