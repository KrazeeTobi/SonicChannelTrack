...
<TR>
	...
	<A HREF=javascript:newWin("/global_include/asp/page_tools/print.asp","2.4.6.3")><IMG SRC="/global_images/page_tool_print.gif" BORDER="0"></A><br>
...
<!-- **CONTENT STARTS HERE** -->
<div class="text" id="2.4.6.3">
<span class="pagehead">General Info :: Exhibitor Workshop</span><br><br>
...
<br>
<span class="callout">Act Now! Registration closes October 4, 2002.</span><br><br>
Guarantee your room at the Las Vegas Hilton for $79/night by booking no later than September 18.
<br><br>

<form action="register.asp" method="POST" name="frm_submit">
<table cellspacing="0" cellpadding="0" width="80%" border="0" align="center">
	<tr>
		<td class="rowlabel">First Name:&nbsp;&nbsp;</td>
		<td><input type="text" name="txt_fname" size="26"></td>	
	
	</tr>
	<tr>
		<td class="rowlabel">Last Name:&nbsp;&nbsp;</td>
		<td><input type="text" name="txt_lname" size="26"></td>	
	
	</tr>
	<tr>
		<td class="rowlabel">Title:&nbsp;&nbsp;</td>
		<td><input type="text" name="txt_title" size="26"></td>	
	
	</tr>
	<tr>
		<td class="rowlabel">Company:&nbsp;&nbsp;</td>
		<td><input type="text" name="txt_company" size="26"></td>	
	
	</tr>
	<tr>
		<td class="rowlabel">Address:&nbsp;&nbsp;</td>
		<td><input type="text" name="txt_address" size="26"></td>	
	
	</tr>
	<tr>
		<td class="rowlabel">City&nbsp;&nbsp;</td>
		<td><input type="text" name="txt_city" size="26"></td>	
	
	</tr>
	<tr>
		<td class="rowlabel">State:&nbsp;&nbsp;</td>
		<td><SELECT NAME="txt_state">
			<option>
	...
	<tr>
		...
		<td><input type="text" name="txt_zip" size="26"></td>	
	
	</tr>
	<tr>
		<td class="rowlabel">Telephone:&nbsp;&nbsp;</td>
		<td><input type="text" name="txt_phone" size="26"></td>	
	
	</tr>
	<tr>
		<td class="rowlabel">Fax:&nbsp;&nbsp;</td>
		<td><input type="text" name="txt_fax" size="26"></td>	
	
	</tr>
	<tr>
		<td class="rowlabel"><font class="required">* </font>E-mail:&nbsp;&nbsp;</td>
		<td><input type="text" name="txt_email" size="26"><br>
		<font class="required">* </font> Required: All further correspondence regarding the Exhibitor<br>&nbsp;&nbsp;&nbsp;Workshop will be sent via e-mail.
		</td>	
	...
	<tr>
		<td align="right" valign="top"><input type="checkbox" name="chk_attending"></td>
		<td> <b>Yes!</b>, Sign me up for the networking happy hour at Z Tejas Grill,<br> October 9, 2002 from 5-6:30 p.m.</td>
	...
	<tr>
		<td align="center"><input type="submit" name="btn_submit" value="Submit" class="formData" onClick="return CheckFields()"></td>
	</tr>
	</table>
