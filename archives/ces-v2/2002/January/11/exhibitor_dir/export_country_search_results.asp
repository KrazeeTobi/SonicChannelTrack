...
<font class="pagehead">Exhibitor Directory - Search Results</font>
<p>&nbsp;<br>
<font class="body">
<!-- content starts here --> 

 <font face="Arial" size=2>
<p>ADODB.Recordset-&gt;Data Components.DCSearchExport.executeSQL@WEB_IIS1-&gt;Data Components.DCSearchExport.search@WEB_IIS1-&gt;Data Components.PCSearchExport.search@WEB_IIS1</font> <font face="Arial" size=2>error '800a0bb9'</font>
<p>
<font face="Arial" size=2>The application is using arguments that are of the wrong type, are out of acceptable range, or are in conflict with one another.</font>
<p>
<font face="Arial" size=2>/exhibitor_dir/export_country_search_results.asp</font><font face="Arial" size=2>, line 52</font> 