...
<head>
	...
	<script language="javascript1.2">
		...
		var pageID = "2.10"; //INSERT PAGE ID HERE
	</script>
...
<font class="head">Exhibitor Manual</font><br>
<br>
<font class="body">
<!-- content starts here --> 
...
A traditional, paper manual will be mailed to all primary exhibitors in August. The exhibitor manual will also be available on CESweb.org in September and will include downloadable order forms (No usernames or passwords will be required for access to this online information!) .<p>

The manual will feature the following information:
<ul>
<li>Important Deadlines</li>
<li>General Information</li>
<li>Show Regulations</li>
<li>Shipping & Material Handling Information</li>
<li>Installation, Dismantle and Labor Information</li>
<li>Booth Equipment Orders: Decorations, Furniture & Signs</li>
<li>Special Services: Photography, Model/Talent, Floral etc.</li>
<li>Venue Specific Information for the LVCC, Hilton and Alexis Park
and much more.</li>
</ul>

If you have any questions about the exhibitor manual, please contact us at <a href="mailto:cesops@ce.org">cesops@ce.org</a>.
