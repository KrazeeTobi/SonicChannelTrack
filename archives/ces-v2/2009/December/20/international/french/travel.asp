...
<P><STRONG>Vous avez besoin d’aide ? <BR></STRONG><A href="/docs/2K10VisaInterviewTips_Fly_FR.pdf" target=_blank>T&eacute;l&eacute;chargez notre fiche de conseils pour les visas</A>, qui contient des instructions d&eacute;taill&eacute;es, les adresses de sites web importants et d’autres informations destin&eacute;es &agrave; faciliter votre demande de visa.<BR><BR>&Agrave; partir du 12 janvier 2009, les visiteurs provenant de pays exempt&eacute;s de visa qui se rendent aux &Eacute;.-U. doivent s’inscrire en ligne et &ecirc;tre autoris&eacute;s pour l’entr&eacute;e dans le cadre du nouveau <A href="http://www.dhs.gov/xnews/releases/pr_1212498415724.shtm " target=_blank>syst&egrave;me &eacute;lectronique d'autorisation de voyage (en anglais), Electronic System for Travel Authorization (in English).</A><BR><BR></P>
<H2>Voyage</H2>
