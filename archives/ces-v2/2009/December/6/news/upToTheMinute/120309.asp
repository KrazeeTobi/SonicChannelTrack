...
<head><!-- PageID 3628 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: December 3, 2009</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
            ...
            <li class="selected"><a href="/news/upToTheMinute/120309.asp">December 3, 2009</a></li>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/news/default.asp" class="footer">News</a>&nbsp;&gt;&nbsp;<a href="/news/upToTheMinute/default.asp" class="footer">CES Up to the Minute</a>&nbsp;&gt;&nbsp;December 3, 2009</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/news/upToTheMinute/120309.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>December 3, 2009</h1>
                                                               
                        

In this edition of CES Up to the Minute, you can cast your vote for some creative exhibitor videos, find out about a cool, new place to hold a lunch meeting at the show and learn how to keep tabs on 30 young, innovative companies that are turning heads.<BR><BR><A href="/register">Register first, though, if you haven’t already.</A> It will save you $100 off the on-site fee, and you can use the money you save for better things like your favorite <A href="http://cesweb.org/hotelTravel/lasVegas.asp#711].">Las Vegas restaurant, show or spa</A>.
...
<div class="sub-content-header">Focus on Technology for Life's Transitions</div>
<br />

<A href="/exhibits/displays/livingDigital.asp"><IMG height=68 hspace=5 src="/images/content/LDT_Logo.jpg" width=222 align=right border=0>Living in Digital Times</A> turns the concept of a traditional exhibit upside-down as it focuses on technology that's relevant to particular lifestyles. After successful launches of Kids@Play and the Silvers Summit, Living in Digital Times is launching the Digital Health Summit, Mommy Tech and HigherEd Tech in its new location at the 2010 CES. This LVCC North Hall destination includes such exhibitors as Princeton Review, Kaplan Higher Education, American Express Open, Black and Decker, Jitterbug and Rosetta Stone. <A href="/exhibits/displays/livingDigital.asp">Get the full download on Living in Digital Times.</A>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3639"></a>

<div class="sub-content-header">Tune Into CESTV: Latest Episodes Cover South Hall and Top Trends</div>
<br />

Get all of your CES news on CESTV. <A href="http://CESweb.org">Visit CESweb.org</A> and queue up the video player to get late-breaking, can’t-miss details for the upcoming 2010 CES. The series of CESTV segments gives you a sneak peek of what to expect by show floor area — from big-name visionary CEOs, new attractions and the down-low on up-and-coming exhibitors.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3638"></a>

<div class="sub-content-header">Only Two More Days to Vote for “Visit Me at CES” Favorites</div>
<br />

CES exhibitors are vying for your attention – and your vote! <A href="http://CESweb.org/contest">Visit CESweb.org/contest</A> to pick your favorite “Visit Me at CES” video by December 4. Five winners will be selected and their videos featured on CESweb.org before and during the show. <A href="http://CESweb.org/contest">Vote now!</A>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3637"></a>

<div class="sub-content-header">CES TechZones: See What’s Driving the Digital Economy</div>
<br />

<IMG height=28 hspace=5 src="/images/content/techzone-120.gif" width=120 align=right>Located throughout the entire CES show floor, <A href="/exhibits/displays/techZones.asp">TechZones</A> are popular, themed areas that draw you in and then surround you with emerging products and the companies that were innovative enough to bring this mind-blowing technology to consumers the world over.<BR<BR>Here are this year’s TechZones, or what we like to call mini-tradeshows. Each feature a variety of exhibitors, demonstrations, product displays and more. <A href="/exhibits/displays/techZones.asp">See in-depth information on all of these TechZones</A>, including show floor locations and sponsors, and get ready to get in the zone.<BR><BR>
<TABLE cellSpacing=1 cellPadding=1 width="85%" border=0>
<TBODY>
<TR>
<TD>Digital Health <BR>eBooks<BR>Experience 3D <BR>Femto<BR>HDMI <BR>HD-PLC <BR>HigherEd Tech</TD>
<TD>HomePlug <BR>i-stage <BR>Kids@Play <BR>Lifestyle Gadgets<BR>Mobile DTV <BR>Mommy Tech <BR>Netbooks </TD>
<TD>PC Gaming Alliance <BR>Robotics <BR>Safe Driver <BR>Silvers Summit <BR>USB <BR>Wireless Mobility<BR>ZigBee</TD></TR></TBODY></TABLE>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3636"></a>

<div class="sub-content-header">CES Knowledge Tracks: Top Five Picks</div>
<br />

<IMG height=125 hspace=5 src="/images/content/CES_Knowledge_Tracks.gif" width=125 align=right>If it’s emerging, groundbreaking or market-leading, it will be covered in this year’s conference sessions. In this issue of CES Up to the Minute, we’re putting the spotlight on five&nbsp;<A href="/sessions/KnowledgeTracks.asp">Knowledge Tracks</A>&nbsp;that will be sure to drive your business in 2010.<BR><BR>
<H3><A href="http://cesweb.org/sessions/search/results.asp?categoryID=1879">Up Next at CES</A></H3>Co-sponsored by CEA and The Nielsen Co.<BR>Up Next at CES is a series of sessions that cuts through the new media hype and presents real-world strategies for monetizing all forms of media content across the most promising platforms. It’s where the best creative, business and technical talent shares and compares the smartest ways to produce, promote and profit from media content. Listen to a series of entertaining preview podcasts to get a feel for the dynamic energy that’ll be rolling from content experts such as CBS’ George Schweitzer and NBCU’s Vivi Zigler during the sessions.<BR><BR>
<H3><A href="http://cesweb.org/sessions/search/results.asp?categoryID=1870">Wireless Communications</A></H3>As the globe becomes more interconnected, wireless devices are leading the way. This track explores the spectrum of advances in wireless phones - 4G, superphones, the smartphone ecosystem - as well as the future of wireless TV and new directions for GPS technology.&nbsp; <BR><BR>
<H3><A href="http://cesweb.org/sessions/search/results.asp?categoryID=1848">In-Vehicle Technology</A></H3>We eat, work, conference, and watch DVDs in our cars. Can computing, social networking and other forms of entertainment be far behind? These innovations are closer than they appear! Look ahead to learn what will be driving this dynamic category in the year to come.&nbsp; <BR><BR>
<H3><A href="http://cesweb.org/sessions/search/results.asp?categoryID=1843">Home Entertainment and Lifestyle</A></H3>Who drives innovation in lifestyle technologies - the companies that produce them or the consumers who use them? From this fascinating, symbiotic relationship, entire subgenres of products have emerged, covering every aspect of home: communication, entertainment, health, work and commerce.<BR><BR>
<H3><A href="http://cesweb.org/sessions/search/results.asp?categoryID=1881">Wireless Retail</A></H3>Staying competitive at the retail level requires smart strategies and ingenious tactics. You need to break through and remain top of mind when consumers are ready to buy. These dynamic sessions take on the hot topics in this exploding category, from guerilla marketing to capitalizing on eco-friendly consumer expectations.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3635"></a>

<div class="sub-content-header">Money-Saving Tip: Complimentary Shuttles from Official CES Hotels</div>
<br />

<A href="/docs/2010_CES_Shuttle_Map_for_CESweb.pdf" target=_blank><IMG height=157 hspace=5 src="/images/content/2010ShuttleBus_Map.jpg" width=100 align=left border=0></A>During CES we offer complimentary shuttle service between the Las Vegas Convention Center and all official CES hotels. No need to add unnecessary cab rides to your expenses, just jump on the CES shuttle and we’ll take you straight to the show. <BR><BR>The list of official CES hotels changes each year, so be sure to check online for the complete list. <A href="/docs/2010_CES_Shuttle_Map_for_CESweb.pdf" target=_blank>Download the CES shuttle map</A> now to find the closest shuttle stop to your hotel.<BR><BR>Want to plan dinner reservations and more while you're at CES? <A href="/hotelTravel/lasVegas.asp">Go here.</A>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3634"></a>

<div class="sub-content-header">Bistro CES: A Nw Way to Eat and Meet at CES</div>
<br />
...
<div class="sub-content-header">CNET in Full Force at CES</div>
<br />

<IMG height=59 hspace=5 src="/images/content/cnet.gif" width=103 align=left>CNET will once again deliver comprehensive coverage of CES. Dozens of expert editors will attend keynotes, participate in <A href="/sessions/SuperSessions.asp">SuperSessions</A>, and scour the show floor for the hottest gadgets. <A href="/awards/bestOfCES.asp">The CNET Best of CES Awards</A> will recognize the best new products. And new this year, find CNET in the <A href="/exhibits/displays/sustaintablePlanet.asp">Sustainable Planet CE Spotlight</A>, moderating a sustainability-focused panel. All of this will result in a 360-degree view capturing CES with everything from blog posts to Twitter updates, slideshows, live video and more at <A href="http://CNET.com" target=_blank>CNET.com</A>.     
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/news/upToTheMinute/120309.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
