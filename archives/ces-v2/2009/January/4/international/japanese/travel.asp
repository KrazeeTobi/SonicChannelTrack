...
<head><!-- PageID 1170 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: 旅行とビザ情報</title>
...
<P target="_blank"><SPAN class=text><A href="https://evisaforms.state.gov/ds156.asp?lang=1" target=_blank>ビザをお求めですか？現在、オンラインでビザ申請書をご記入いただけます。</A><BR><BR><A href="/docs/JP-Visa_Interview_Tips_FNL.pdf" target=_blank>ヘルプが必要な場合は、弊社のビザ関連説明書をダウンロードし</A>、順を追った説明やウェブサイトアドレスなどの情報でビザ申請手続きの助力を得てください。<BR><BR>2009年1月12日から、ビザ免除国から米国へ入国される方は、今回から出張許可電子システム<A href="http://www.dhs.gov/xnews/releases/pr_1212498415724.shtm" target=_blank>（Electronic System for Travel Authorization）の一環として、オンライン登録を行ってから、入国許可を取得することが必要となります（英語）)</A>。</SPAN></P>
