...
<head><!-- PageID 1131 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: Voyage et visa</title>
...
<P><STRONG>Vous avez besoin d’aide ? <BR></STRONG><A href="/docs/FR_Visa_Interview_Tips_FNL.pdf" target=_blank>T&eacute;l&eacute;chargez notre fiche de conseils pour les visas</A>, qui contient des instructions d&eacute;taill&eacute;es, les adresses de sites web importants et d’autres informations destin&eacute;es &agrave; faciliter votre demande de visa.<BR><BR>&Agrave; partir du 12 janvier 2009, les visiteurs en provenance de pays dispens&eacute;s de visa devront s'inscrire en ligne afin d'obtenir l'autorisation d'entrer aux &Eacute;tats-Unis, selon le nouveau <A href="http://www.dhs.gov/xnews/releases/pr_1212498415724.shtm " target=_blank>syst&egrave;me &eacute;lectronique d'autorisation de voyage (en anglais), Electronic System for Travel Authorization (in English).</A><BR><BR></P>
<H2>Voyage</H2>
