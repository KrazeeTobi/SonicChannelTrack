...
<head><!-- PageID 2041 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: An Eco-Friendly Electronics Show</title>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/aboutces.asp" class="footer">About CES</a>&nbsp;&gt;&nbsp;An Eco-Friendly Electronics Show</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/cesgreening.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<H2>The World’s Coolest Trade Show is Working to Be the Greenest</H2>With the help of our partners, including GES, Aramark, the Las Vegas Convention Center (LVCC) and the Sands Expo and Convention Center, CES attendees now have more opportunities than ever to recycle while conducting a year's worth of business in one prime, environmentally friendly location.<BR><BR>
<H3>Green Exhibits and Programming at the 2009 International CES</H3></FONT>The <A href="http://www.cesweb.org/sessions/search/trackDetail.asp?ID_track=GT_CES09" target=_blank>Technology&nbsp;and the Environment Knowledge Tracks</A>&nbsp;are informative sessions that hone in on some of the most important steps forward the industry has taken, from ENERGY STAR&nbsp;advances to best practices in recycling and energy consumption. Don't miss the <A href="http://www.cesweb.org/sessions/search/sessionDetail.asp?ID_session=GT7&ID_track=GT_CES09" target=_blank>Greener Gadgets session</A>, a preview of the <A href="http://www.greenergadgets.com" target=_blank>Greener Gadgets Conference</A> coming this February to New York. <BR><BR>The 2009 International CES will also feature the Sustainable Planet Spotlight area, featuring 20 exhibitors over 3,100 square feet.&nbsp;The exhibition highlights the latest products entering the green spectrum, making it possible for every person on this planet to stay connected, informed and live sustainable lifestyles. <STRONG>NOTE: The <A href="http://www.cesweb.org/exhibits/displays/techZones.asp#1926" target=_blank>Greener Gadgets TechZone</A> and the <A href="http://www.cesweb.org/exhibits/displays/652A6D6D64324447A6D6B7C82A88147B.htm" target=_blank>Sustainable Planet Spotlight</A> have moved to the Central Hall due to an increase in exhibitors.&nbsp;They can be found near the LG booth – look for the Sustainable Planet banner. <BR><BR></STRONG></STRONG></FONT>
<H3>CES Environmental Investments<BR></H3>The Consumer Electronics Association&nbsp;has invested&nbsp;$100,000 to develop a recycling program in the Las Vegas area working with <A href="http://www.ccsd.net/" target=_blank>Clark County Schools</A>, the fifth largest school district in the country. The&nbsp;fund&nbsp;will create a&nbsp;recycling and environmental education initiative for students and faculty. The program is still in development but will include bins for recycling as well as a curriculum component for students. <BR><BR><STRONG>
<H3>Attendees: A Smaller Footprint with Bigger Opportunities</H3></FONT></STRONG>The International CES provides our industry an opportunity to convene at one time, in one place, at an eco-friendly blockbuster summit that minimizes your annual travel. 
<UL>
<LI>By attending CES, our attendees avoid over 700 million miles of business travel – enough to travel from the earth to the sun seven times. </LI>
<LI>Each of our attendees has an average of 12 meetings while at CES and approximately 1.7 million meetings are conducted in total. </LI>
<LI>Representatives travel from over 140 different countries, offering a truly global opportunity.</LI></UL>
<H3>Exhibitors: Make Your Booth Space an Eco-Space</H3>
<P>GES offers several eco-friendly booth packages to help make small responsible changes that amount to a big difference. Check out our <A href="/docs/GES_Sustainable_Exhibit_Solutions_Order_Form.pdf" target=_blank>Sustainable Exhibit Solutions Order Form</A>,&nbsp;including:</P>
<UL>
<LI>Insert panels which are <A href="http://www.fscus.org/" target=_new>Forest Stewardship Council (FSC)</A> certified and are formaldehyde-free </LI>
<LI>Shelves and counters made from formaldehyde-free particle board </LI>
<LI>Eco-friendly carpet</LI></UL>
<H3>Why Go Green?</H3>CEA Senior Vice President Karen Chupka takes a bold stance on <A href="/docs/Chupka_Greening_CES_Feature.pdf" target=_blank>why green is primary in CES' palette.</A><BR><BR>
<H3>How Green was the 2008 International CES?</H3>In our first year of "greening" the International CES, CEA and its partners: 
<UL>
<LI>Recycled 51 percent (121.27 tons) of the total solid waste generated by show attendees. </LI>
<LI>Implemented recycling bins, recycled carpeting and other enviro-friendly materials onsite. </LI>
<LI>Offset more than 20,000 tons of carbon emissions. </LI>
<LI>Worked with the LVCC to replace more than 15,000 gallons of non-sustainable products, eliminating harsh chemicals used to clean and maintain more than 100 restrooms and the convention space daily. </LI>
<LI>Switched to recycled paper products including toilet paper, facial tissue and paper towels in the LVCC. </LI>
<LI>Diverted all light bulbs used by the show from landfills, as well as batteries and other electronics products. </LI>
<LI>Put hazardous waste disposal programs in effect for waste oil, paints and solvents, and instituted a gas recovery program. </LI>
<LI>Proudly offered two-thirds of all attendee food containers and utensils made of biodegradable hemp, corn byproduct or other organic materials. </LI>
<LI>Used recycled carpet in the aisles in the LVCC. </LI>
<LI>Printed all attendee flyers and CES literature on recycled paper using soy ink. </LI>
<LI>Highlighted eco-friendly gadgets through its Sustainable Technology TechZone.</LI></UL>
<H3>A Shade Brighter in '09</H3><IMG height=46 hspace=10 src="/images/content/planetmetrics_logo.jpg" width=150 align=right vspace=10>New in 2009, CES is working with all of its facilities to minimize its impact on the environment and offer more opportunities for attendees and exhibitors to recycle and make responsible green choices. CES is working with <A href="http://www.planetmetrics.com/" target=_new>Planet Metrics</A> to calculate its carbon output and considering local reforestation and environmental projects in Nevada.&nbsp;<BR><BR><STRONG>Print Production at the International CES</STRONG><BR>The Consumer Electronics Association&nbsp;has cut its print production for CES by nearly 50 percent in the last four years.&nbsp;Materials have gone virtual, including: 
<UL>
<LI>The International CES Conferences brochure, once 88 pages and distributed to 250,000 </LI>
<LI>The International CES Conference directory, reduced to an insert in the Show Guide, saving 50 pages at 70,000 copies </LI>
<LI>The CES Exhibitor Manual, once thousands of pages for 2,700 exhibitors</LI></UL>
<P>All remaining hard copy materials meet the standards of the Sustainable Forest Initiative and Forest Stewardship Council and are printed on recycled paper.<BR><BR><STRONG>CES uses <A href="http://www.aramark.com/ContentTemplate.aspx?PostingID=392&ChannelID=223" target=_new>Aramark</A> catering services, which is:</STRONG> </P>
<UL>
<LI>Reducing use of individual serving size condiment packages. </LI>
<LI>Assessing cleaning products and striving to use those recognized as environmentally safe and non-toxic. </LI>
<LI>Boosting purchase of post-consumer content recycled or <A href="http://www.fscus.org/" target=_new>FSC-approved</A> office paper and stationery and recycled ink cartridges. </LI>
<LI>Using biodegradable service ware and 100 percent recycled napkins. </LI>
<LI>Increasing purchases of organic and locally grown or sourced products. </LI>
<LI>Selecting <A href="http://www.energystar.gov/" target=_new>ENERGY STAR&reg;</A> equipment when purchasing new or replacement products</LI></UL>
<P><A href="/docs/Aramark_greening_flyer.pdf" target=_blank>Learn more about Aramark's initiatives.</A> </P>
<P><STRONG>CES chooses exhibit venues like the <A href="http://www.lvcva.com/meetings/meeting-venues/convention-centers/las-vegas-convention.jsp" target=_new>Las Vegas Convention Center</A>, which:</STRONG></P>
<UL>
<LI>Participates in the Environmental Protection Agency’s (EPA) <A href="http://www.epa.gov/osw/partnerships/wastewise/index.htm" target=_new>WasteWise Program</A>. </LI>
<LI>Diverts recyclable materials from landfills such as cardboard, paper, carpet padding and plastic. </LI>
<LI>Is currently averaging a 50 percent recycle rate for all of its shows. </LI>
<LI>Replaced paper towels, toilet paper, and other paper products with recycled materials. </LI>
<LI>Recycles exhibit hall and meeting room materials during all phases of show activity. </LI>
<LI>Recycles engine oil, antifreeze, paint thinner, tires, and various metals as well as recapturing Freon from air conditioning units. </LI>
<LI>Uses a power monitoring system to tracks electrical power usage and identify areas for improved efficiency. </LI>
<LI>Uses water conservation devices installed in urinals, toilets and faucets. </LI>
<LI>Optimizes electronic communication to decrease dependence on paper communication methods.</LI></UL>
<P><A href="/docs/LVCVA_Going_Green_PDF.PDF" target=_blank>Learn more about greening at the LVCC.</A> </P>
<P><STRONG>CES utilizes conference venues like the <A href="http://www.palazzolasvegas.com/" target=_new>Palazzo</A>, which:</STRONG></P>
<UL>
<LI>Received silver-certification by the U.S. Green Building Council's <A href="http://www.usgbc.org/DisplayPage.aspx?CMSPageID=222" target=_new>Leadership in Energy and Environmental Design (LEED)</A>. </LI>
<LI>Conserves enough water to provide each Nevada citizen with 266 eight-ounce glasses of water for a year and saves enough energy to light a 100-watt light bulb for 12,100 years. </LI>
<LI>Offers valet parking for bicycles.</LI></UL>
<P><STRONG>CES work with exhibition contractors <A href="http://www.ges.com/">GES</A>, which:</STRONG></P>
<UL>
<LI>Offers green booth packaging, including eco-friendly paneling, carpeting, graphics printed with water-soluble ink, and LED lighting (coming soon). </LI>
<LI>Runs 95 percent of all equipment on clean, natural gas. No gasoline or diesel. </LI>
<LI>Uses ENERGY STAR&reg; rated lighting. </LI>
<LI>Uses trash cans and liners that are biodegradable and eco-friendly, as well as table top covers from recyclable materials. </LI>
<LI>Uses visqueen products made of 50 percent recycled materials. </LI>
<LI>Eliminated hard copies and implemented the use of an online exhibitor manual. </LI>
<LI>Added recycled carpet in special feature areas such as Registration, TechZones and Innovations Plus.</LI></UL>
<P><STRONG>CES floors additional space at the <A href="http://www.lvcva.com/meetings/meeting-venues/convention-centers/sands-expo-convention.jsp" target=_new>Sands Expo and Convention Center</A>, which:</STRONG> </P>
<UL>
<LI>Recycled 89 percent of materials at its largest show. </LI>
<LI>Recycles copper, aluminum, brass and heavy metals, word, carpet padding, glass and extension cords. </LI>
<LI>Utilizes <A href="http://www.greenseal.org/certification/environmental.cfm" target=_new>Green Seal</A> environmentally friendly cleaning products. </LI>
<LI>Trains with <A href="http://www.ecolab.com/" target=_new>EcoLab</A> to maximize efficiency on saving water, electricity, soap, etc. </LI>
<LI>Donates left over packaged foods to the Las Vegas Mission and left over bulk foods to local farms for animal feed at the end of each trade show. </LI>
<LI>Uses ENERGY STAR&reg; rated fluorescent lights for all meeting, lobby and office space lighting.&nbsp; The florescent bulbs are then recycled through an outside vendor. </LI>
<LI>Implements an office recycling program which takes their ink cartridges, toner cartridges and old cell phone batteries and keeps them out of landfills. </LI>
<LI>Conserves energy by limiting lighting and HVAC levels during non-show days. </LI>
<LI>Shreds all inter-office paper and donates the product for use in a local no-kill pet shelter. </LI>
<LI>Monitors levels of carbon monoxide, sulfur dioxide and nitrous oxide to ensure safe air quality. </LI>
<LI>Installs dimmers on all lighting within the facility to reduce voltage to 220 volts, without affecting brightness and resulting in a monthly energy savings of 20-30 percent. </LI>
<LI>Installs Dyson hand dryers in a number of restrooms to eliminate the use for paper towels.&nbsp; Automatic dispensed foam hand soap is used which eases on the waste of soap and water.</LI></UL>
<P><A href="/docs/Sands_Greening_document_07-22-08.pdf" target=_blank>Learn more about greening the Sands.</A>&nbsp;&nbsp;</P>
