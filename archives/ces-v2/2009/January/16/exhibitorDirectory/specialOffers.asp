...
<head><!-- PageID 2631 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: Special On-Site Offers</title>
...
<body>
    ...
    <ul>
        <li class="dd-exhibitor"><a onmouseover="showDropDown('exhibitor','show')" onmouseout="setMenuTimer()" href="/exhibitorDirectory/default.asp"><img src="/images/framework/mainnav_exhibitor_on.gif" /></a></li>
            ...
            <div id="main-content">
                <div id="main-content-column1">
                    <div class="greenbox-bg">
                        ...
                        <a href="/exhibitorDirectory/default.asp"><img src="/images/framework/sidebar-header-exhibitordir.gif" alt="Exhibitor Directory"></a><ul>
            <li class="selected"><a href="/exhibitorDirectory/specialOffers.asp">Special On-Site Offers</a></li>
        </ul>
                        <br />
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitorDirectory/default.asp" class="footer">Exhibitor Directory</a>&nbsp;&gt;&nbsp;Special On-Site Offers</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitorDirectory/specialOffers.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>Special On-Site Offers</h1>
                                                               
                        

We know CES can be among the most important days of your business year. It's where you can&nbsp;explore product offerings from&nbsp;<A href="/exhibitorDirectory/default.asp">2,700 consumer technology companies</A>&nbsp;and boost your own business. Lucky for you,&nbsp;many exhibitors vie for your attention&nbsp;with on-site special offers*, giveaways and chances to win. Here are some examples:<BR><BR>
<H3>Audio Design Associates (ada)</H3><STRONG>The Venetian, Venetian Tower Suite 30-121</STRONG> <BR>The TPA-1, ADA’s two-channel audiophile thermionic-preamplifier with&nbsp;&nbsp; tube-driven iPod-dock (2009-CES Design and Engineering&nbsp; Innovation Award Honoree) bypasses the iPod’s preamplifier stage line-driving&nbsp; the iPod’s audio through tubes for unparalleled performance.&nbsp; For&nbsp; those ordering both the TPA-1 along with the PF-2150, ADA’s new two-channel high-current MOSFET power amplifier, the matched set that&nbsp; typically retails for $5489 will be offered during CES for just $4999.<BR><BR>
<H3>Avaak, Inc.</H3><STRONG>Sands, IP #233</STRONG><BR>At Avaak's pod, enter to win a free VueCrew membership ($50 value), and be among the first to test the Vue™ personal video network, a live, remote video system that enables consumers to view their family, home or business anytime and anywhere, before it comes to market in spring 2009.&nbsp;Winners&nbsp;will be selected daily.&nbsp; For more information on the VueCrew, visit <A href="http://www.VueZone.com/VueCrew" target=_blank>http://www.VueZone.com/VueCrew</A>.<BR><BR>
<H3>Cables Unlimited</H3><STRONG>LVCC, South Hall 1, Booth #22045 <BR></STRONG>Stop by&nbsp;the Cables Unlimited&nbsp;booth for a chance to win a Wireless USB Kit!&nbsp;Your business card&nbsp;qualifies you for&nbsp;the daily 5 p.m. drawing. Upgrade any existing USB device to Wireless USB. The ultimate solution to bringing Wireless USB connectivity to hard disk drives, printers, hubs&nbsp;and more!<BR><BR>
<H3>Celframe</H3><STRONG>LVCC, South Hall 3, Booth #31959 <BR></STRONG>Gifts for all walk-ins. Free Celframe CRM and Office 2008 SBE Software licenses for 300 eligible companies. Fifty percent off on all orders. Free Celframe Office 2008 Home for the first 100 non-corporate attendees to the booth. Bonanza Prizes - 50" Plasma TV, MacBook Air and 32GB IPod-Touch. Terms and conditions apply.<BR><BR>
<H3>Dakim, Inc.</H3><STRONG>Sands, Booth #2713<BR></STRONG>Dakim BrainFitness is an all–in-one brain exercise system designed to help seniors fight the development of dementia and maintain their brain health and quality of life. With five levels of challenge it can be used by a broad range of seniors. Visit our booth for a $100 off coupon. <BR><BR>
<H3>Digital Foci, Inc.</H3><STRONG>LVCC, South Hall 3, Booth #31846 <BR></STRONG>Digital Foci will offer a CES discount for both dealers and end users. 
<UL class=text>
<LI class=text>Dealers who visit our booth can qualify to receive a 10 percent&nbsp;discount for purchase orders placed before January 31, 2009. </LI>
<LI class=text>End users can get a 20 percent&nbsp;discount coupon to be used at the Digital Foci online store.</LI></UL><BR>
<H3>Evertek Computer Corp.</H3><STRONG>Sands, Booth #71835</STRONG><BR>WIN A FREE 50" PLASMA HDTV! Complete entry form at <A href="http://www.evertek.com/cesFREETV">www.evertek.com/cesFREETV</A>. Submit completed form to the Evertek Sands Booth #71835 during the 2009 International CES for a chance to win a 50” Vizio Plasma HDTV. <BR><BR>
<H3>GammaTech Computer Corporation</H3><STRONG>Booth #72832</STRONG><BR>See the new Durabook line of products, and receive a free gift while supplies last. <BR><BR>
<H3>HomePlug Powerline Alliance</H3><STRONG>LVCC, South Hall 2, Booth #25826</STRONG> <BR>Play the HomePlug Powerline Alliance’s FULL HOUSE Poker Run! Get your first playing card from Booth #25826, and then visit HomePlug-member booths to complete your hand. Return to the HomePlug booth for entry into both daily and grand-prize drawings! Print your Wild Card here: <A href="http://www.homeplug.org/about/fullhouse/">http://www.homeplug.org/about/fullhouse/</A>. <BR><BR>
<H3>HP</H3><STRONG>LVCC, South Hall 3, Booth #31112</STRONG><BR>Stop by HP Booth #31112 and enter for a chance to win one of the following: 
<UL class=text>
<LI class=text>$300 credit from MarketSplash by HP.&nbsp; Get a new logo, business cards, brochure or any other collateral your company needs designed and printed - the options to use this award are many and all will make your business look great! </LI>
<LI class=text>HP MediaSmart Server - enjoy your digital experiences from anywhere over the Internet </LI>
<LI class=text>The HP Mini 1000 - the on-the-go companion for the ultra-mobile consumer </LI>
<LI class=text>HP Calculators - A complete line of calculators for work, school, and home </LI>
<LI class=text>HP Digital Picture Frames - Enjoy and share photos with your family and friends without a computer</LI></UL><BR><BR>
<H3>Innovelis, Inc.</H3><STRONG>LVCC, South Hall 2, Booth #25333</STRONG><BR>FREE SAMPLES: Stop by, say hello and receive your free samples of BudFits and CordFits. BudFits is the most secure and comfortable way to wear iPod and iPhone earbuds. CordFits is an amazing new cord management product that you have to see to believe. It's like a magic trick! <BR><BR>
<H3>NBC Universal</H3><STRONG>LVCC, Central Hall, Booth #12133</STRONG><BR>Join NBCU, the official broadcast partner of CES, and experience live television and digital production with NBC Universal stars. Come in for a chance to get a SanDisk Sansa video player or a SanDisk memory card, and download some great NBCU content FREE!&nbsp; Plus, visit our Sharp NBCU Multimedia Lounge. <BR><BR>
<H3>Parks Associates</H3><STRONG>LVCC, South Hall, Booth #25556<BR></STRONG>Want to understand consumer habits, purchases, and consumption of new media? International Research firm Parks Associates is providing white papers with our latest consumer and industry research at CES.&nbsp; Topics include mobile broadband, advanced TV services, social media, e-health, mobile TV and more. Stop by to get a copy! Plus, come by and visit Parks Associates' boothto receive a complimentary pass to attend our January webcast, a $295 value.<BR><BR><BR>
<H3>Solar Wholesale Direct</H3><STRONG>LVCC, North Hall, Booth #224<BR></STRONG>If you're looking for RENEWABLE energy traces at this CES, visit Solar Tech Wholesale at the Greener Gadgets TechZone. Solar Wholesale collegues will share their fulll line of solar powered gadgets as well as their passion in sustainability. Ask for a FREE solar gift&nbsp;to see&nbsp;magic performed by the Sun. <BR><BR><BR>*Note: All product discounts can be made on orders only. Cash-and-carry purchases are not permitted on the CES show floor.
