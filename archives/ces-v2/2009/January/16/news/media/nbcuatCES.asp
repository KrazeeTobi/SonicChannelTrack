...
<head><!-- PageID 2862 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: NBCU at 2009 CES</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
            ...
            <li class="selected"><a href="/news/media/nbcuatCES.asp">NBCU at 2009 CES</a></li>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/news/default.asp" class="footer">News</a>&nbsp;&gt;&nbsp;<a href="/news/media/default.asp" class="footer">Video Gallery</a>&nbsp;&gt;&nbsp;NBCU at 2009 CES</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/news/media/nbcuatCES.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>NBCU at 2009 CES</h1>
                                                               
                        

<iframe src='http://www.dailymotion.com/swf/kCLYE5hKIIvsPwSP4o' scrolling='no' frameBorder='0' height='381' width='480'></iframe>    
                    </div>
                    <div id="inner-content-right">
                        <br />
