...
<LI class=text>New mobile TV formats undergo field trials.</LI></UL><BR><A href="/register">Register today for the 2009 International CES</A> to learn, network and investigate new technology in the wireless industry.&nbsp; Use this page to learn about what's going on in the wireless category at CES, and <A href="/docs/2K9_Wireless_QuickGuide.pdf" target=_blank>download the CES Wireless Quick Guide</A> for all you need to know on the go.<BR><BR><EM><SPAN class=smallText>Source: Digital America, a CEA publication.</SPAN></EM>
