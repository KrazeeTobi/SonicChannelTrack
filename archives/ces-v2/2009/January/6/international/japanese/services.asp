...
<head><!-- PageID 1174 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: 国際サービス</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li class="selected"><a href="/international/japanese/services.asp">国際サービス</a></li>
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        ...
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Resources</a>&nbsp;&gt;&nbsp;<a href="/international/japanese/default.asp" class="footer">日本語</a>&nbsp;&gt;&nbsp;国際サービス</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/international/japanese/services.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<SPAN class=text><STRONG><SPAN class=subhead>国際登録エリア<BR></SPAN>LVCC、南ホール2（ホテルシャトルバスで最初のストップ）<BR>サンズ、階下ロビー</STRONG><BR>海外からの来場者専用特別登録エリアは、LVCC、南ホール2とサンズのメイン登録エリアにあります。これら2箇所のエリアで海外のビジターは、当日登録、バッチホルダーの受取（ショー会場入場に必要）を行うか、複数言語を話す通訳の特別支援を受けて、登録に関する質問を行うことができます。<BR><BR><SPAN class=subhead><STRONG>国際商業センター (ICC)</STRONG><BR></SPAN><STRONG>LVCC、南ホールコネクタ、S224/225号室<BR>ラスベガスヒルトン、ヒルトンセンター、ブース40028<BR>サンズエキスポおよびコンベンションセンター 階上ロビー</STRONG><BR>国際商業センターは、海外のビジターや出展社がインターネットステーションでオフィスと連絡を取り合ったり、プライベートな会議室を予約・利用し、軽食をとったり、くつろいだりする場所です。CESに滞在中「出張オフィス」として利用できるICCが3箇所あります。<BR><BR><STRONG>インターナショナル・レセプション</STRONG><BR>6PM ～ 7:30PM 1月8日（木）<BR>LVCC、南ホールコネクタ、S222号室<BR>海外からの来場者、出展者、メディア関係者の全員がCESのインターナショナル・レセプションに招待されます。本レセプションは海外から参加されている方のみが入場できます。人々との新たな出会い、同僚とのビジネスについての議論や、ビジネスパートナー関係を新たに結ぶ絶好のチャンスである本レセプションに、是非ともご参加ください。会場にて皆様にお目にかかれることを楽しみにしています!<BR><BR><SPAN class=subhead><STRONG>通訳サービス</STRONG><BR>ICC（国際商工センター）の全３か所に指定された南ホール2、ホールB、ザ・サンズの各国際登録エリアにて、複数言語を話すスタッフが待機しています。スペイン語、ドイツ語、フランス語、中国語（北京語、広東語）、日本語、イタリア語、ポルトガル語、韓国語を含む通訳サービスで皆様のコミュニケーションのご支援をいたします。通訳サービスをご希望の方は、国際登録エリアの「Interpretation Services（通訳サービス）」カウンターまでお申し付けください。また、通訳サービスはセントラルプラザのインフォメーション・センターでもご利用いただけます。<BR><BR></SPAN><SPAN lang=JA style="FONT-FAMILY: "><STRONG><SPAN class=subhead>MyCESパーソナルプラナー – 完璧な展示を構築</SPAN><BR></STRONG><IMG hspace=6 src="/images/content/MyCES-172.gif" align=right>MyCESパーソナルプラナーはウェブベースのツールです。訪れたい出展社やカンファレンスセッションを表示するカスタムマップとアジェンダを作成することができ、会ってみたい新しいビジネスパートナーを識別し、CESでの時間を最大限に活用できるようお手伝いをします。 <A href="/myCES.asp">詳細情報（英語）。</A> 
<P><A href="http://myces.bdmetrics.com/" target=_blank>今日から完璧なショーの構築を開始しましょう</A>。<BR><BR><SPAN class=text><SPAN class=subhead><STRONG>国際バイヤープログラム<BR></STRONG></SPAN>インターナショナルCESは、米国商務省、国際通商局が後援する国際 バイヤープログラム（IBP）に参加しています。米国商務省の国際貿易スペシャリストがメインICC（LVCC、南ホールコネクタ、S224/225号室）に待機しており、海外の来場者や出展社に出会いの場や輸出カウンセリングを提供します。<BR></SPAN></SPAN></P></SPAN>
