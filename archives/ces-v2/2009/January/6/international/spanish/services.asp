...
<head><!-- PageID 1150 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: Servicios internacionales</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li class="selected"><a href="/international/spanish/services.asp">Servicios internacionales</a></li>
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        ...
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/international/default.asp" class="footer">International Resources</a>&nbsp;&gt;&nbsp;<a href="/international/spanish/default.asp" class="footer">Español</a>&nbsp;&gt;&nbsp;Servicios internacionales</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/international/spanish/services.asp', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<H3>&Aacute;rea de Inscripci&oacute;n Internacional</H3>LVCC, South Hall 2 (Primera parada de los autobuses de traslado al hotel) <BR>Sands (Arenas), Recepci&oacute;n en Planta Baja <BR>Un &aacute;rea de inscripci&oacute;n especial para los asistentes internacionales se encuentra en el &aacute;rea de inscripci&oacute;n principal en el LVCC, South Hall 2 y Sands. En estas dos &aacute;reas, los visitantes internacionales se pueden inscribir en el lugar, obtener una credencial (necesaria para ingresar a la exhibici&oacute;n), u obtener ayuda de un idioma espec&iacute;fico de los int&eacute;rpretes multiling&uuml;es disponibles para ayudarlos con las preguntas sobre la inscripci&oacute;n. <BR><BR>
<H3>Centros de comercio internacional (ICC, por sus siglas en ingl&eacute;s)</H3>LVCC, South Hall Connector, Sala S224/225<BR>Las Vegas Hilton, Hilton Center, Stand 40028<BR>Exposici&oacute;n Sands y Centro de Convenciones en Planta Alta<BR>Los Centros Comerciales Internacionales son los lugares destinados para los visitantes y los expositores internacionales para que est&eacute;n en contacto con la oficina en estaciones de Internet, reserven o utilicen salas para reuniones privadas, disfruten de refrescos ligeros o simplemente se relajen. Existen tres ICC que pueden actuar como su “oficina lejos del hogar” mientras se encuentre en la exposici&oacute;n CES. <BR><BR>
<H3>Recepci&oacute;n Internacional</H3>Jueves 8 de enero de 6 a 7:30 p.m. <BR>LVCC, South Hall Connector, Room S222<BR>Todos los participantes internacionales, los expositores y la prensa est&aacute;n invitados a la Recepci&oacute;n de la Exposici&oacute;n Internacional CES. Esta recepci&oacute;n es para visitantes internacionales &uacute;nicamente. No se pierda esta oportunidad de conocer a personas nuevas, debatir sobre negocios con colegas o generar nuevos socios comerciales. &iexcl;Esperamos verlo all&iacute;!<BR><BR>
<H3>Int&eacute;rpretes</H3>Habr&aacute; personal multiling&uuml;e en las tres ubicaciones ICC, las &aacute;reas de Registraci&oacute;n Internacional en South Hall 2 y Sands, Hall B. Los int&eacute;rpretes podr&aacute;n ayudarlo en varios idiomas, incluso espa&ntilde;ol, alem&aacute;n, franc&eacute;s, chino (mandar&iacute;n y canton&eacute;s), japon&eacute;s, italiano, portugu&eacute;s y coreano. En las &aacute;reas de Registraci&oacute;n Internacional, busque el escritorio llamado “Servicios de Interpretaci&oacute;n” si necesita ayuda. Los int&eacute;rpretes tambi&eacute;n est&aacute;n ubicados en el Centro de Informaci&oacute;n en Central Plaza.<BR><BR>
<P></P>
<H3>Gu&iacute;a de planificaci&oacute;n MyCES Personal Planner: C&oacute;mo crear una exposici&oacute;n perfecta </H3><IMG hspace=6 src="/images/content/MyCES-172.gif" align=right>El planificador personal de MyCES es una herramienta basada en Internet, que le permite crear un programa y mapa personalizado que le muestra a los expositores y las sesiones de conferencias que desea visitar, e identifica a los nuevos socios comerciales que desea encontrar, ayudando as&iacute; a maximizar su tiempo en CES <BR><BR><A href="/myCES.asp">M&aacute;s informaci&oacute;n (en ingl&eacute;s).</A><BR><BR><A href="http://myces.bdmetrics.com/" target=_blank>Comience hoy mismo a crear su exposici&oacute;n perfecta.</A><BR><BR>
<H3>Programa de compradores internacionales</H3>International CES es un participante orgulloso del Programa de compradores internacionales, patrocinado por la Administraci&oacute;n Comercial Internacional del Departamento de Comercio de EE. UU. Los especialistas comerciales internacionales del Departamento de Comercio de EE. UU. est&aacute;n disponibles en el ICC principal (LVCC, South Hall Connector, Sala S224/225), a fin de proporcionar asistencia de enlace empresarial y asesoramiento comercial de exportaci&oacute;n a los asistentes y expositores internacionales.
