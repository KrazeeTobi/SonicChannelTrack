...
<head><!-- PageID 634 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: CEA Member Affinity Program</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li class="selected"><a href="/exhibitors/resources/memberProgram.asp">CEA Member Affinity Program</a></li>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/resources/default.asp" class="footer">Resources & Downloads</a>&nbsp;&gt;&nbsp;CEA Member Affinity Program</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/resources/memberProgram.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
As a tradeshow exhibitor, you struggle with two primary issues: minimizing hassle and maximizing ROI. To provide you with hassle-free, cost-effective tradeshow solutions, CES offers a CEA member affinity program in conjunction with GES Exposition Services.<BR><BR>CEA members can take advantage of this program at the International CES and all other tradeshows for which GES Exposition Services has been named official general contractor. In addition to the International CES, some of these other shows include NAB, PMA, E3 and MacWorld.<BR><BR>Each CEA member is automatically designated as a GES VIP Exhibitor and will be eligible for priority pre-show ordering and special pricing on the following select products and services at GES shows.<BR><BR><B>Expedited Pre-Show Ordering<BR></B>GES has established a dedicated GES VIP Exhibitor Hotline for CEA members, providing priority routing at the GES National Servicenter to ensure expedited service. The GES VIP Exhibitor hotline is 866-531-4051.<BR><BR><B>GES Logistics (Shipping)</B> 
<UL class=text>
<LI class=text>Ten percent discount on round-trip shipping costs for your booth freight and materials in and out of any GES show. This does not include material handling services. </LI>
<LI class=text>Receive additional discounts when booking round trip shipping needs for multiple shows. Please call the GES hotline for a quote. </LI></UL><B>GES Furnishings and Carpet</B> 
<UL>
<LI class=text>Ten percent discount on 26 oz. or 50 oz. custom cut carpeting for booth 600 sq. ft. or more on any GES show. </LI>
<LI class=text>Ten percent discount on all specialty furniture items on any GES show.</LI></UL><B>GES Installation &amp; Dismantle (I&amp;D) Services</B> 
<UL>
<LI class=text>Five percent discount on all GES I&amp;D services including labor and equipment. </LI>
<LI class=text>Receive additional discounts when arranging GES I&amp;D services for multiple shows. Please call the GES hotline for a quote.</LI></UL><B>GES Exhibits and Design<BR></B>Receive design and consultation sessions for custom exhibits free of charge and no obligation.<BR><BR><B>Contact GES<BR></B>Call the GES VIP Exhibitor hotline today 866-531-4051 to take advantage of CEA member savings at the International CES. <BR><BR><B>Terms and Conditions</B> 
<OL type=1>
<LI class=text>Orders must be received prior to each show's advance deadline date. Show site orders will not apply. </LI>
<LI class=text>Benefits may not be combined with other offers and specials. </LI>
<LI class=text>Benefits are for exhibitors only. EACs are not eligible. </LI>
<LI class=text>Discounts will be applied to orders received through the GES VIP Hotline only. No Internet or account executive orders apply.</LI></OL>
