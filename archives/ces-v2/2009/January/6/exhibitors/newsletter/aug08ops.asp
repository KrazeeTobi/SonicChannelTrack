...
<head><!-- PageID 1498 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: August 2008 Operations</title>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/aug08.asp" class="footer">August 2008</a>&nbsp;&gt;&nbsp;August 2008 Operations</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/newsletter/aug08ops.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<div class="sub-content-header">Now that You’re Thinking CES, It’s Time to Think Audio Visual! </div>
<br />

<IMG height=87 hspace=10 src="/images/content/Encore.JPG" width=123 align=right vspace=10>It's time to think <A href="http://www.encoreproductions.net/index.html" target=_blank>Encore Productions</A>, too. Encore is the official audio visual (AV) and computer provider for the upcoming CES. A few advantages to choosing Encore: no drayage fees and low AV labor rates.<BR><BR>Now is the time to act! Bring Encore in early to better integrate your AV concepts into your booth design. You’ll also get first dibs at all the hottest and coolest gear from our $30 million inventory, located just minutes from the Las Vegas Convention Center.<BR><BR>The Encore order form will be available in your exhibitor manual, or you can contact: <BR><BR>Encore Productions <BR>702-889-5740<BR><A href="mailto:Tradeshow@encoreproductions.net">Tradeshow@encoreproductions.net</A>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="1533"></a>

<div class="sub-content-header">CES Transportation Update</div>
<br />

Shuttle Schedule - Download this complete <A href="/docs/2K9_ShuttleBusMap_June_16(1).pdf" target=_blank>2009 CES Complimentary Shuttle Bus Schedule (pdf)</A> to plan your trip.<BR><BR>Sands/Venetian Express - This <B>complimentary</B> shuttle runs every 10 minutes directly from the LVCC to the Sands/Venetian from 7:30 a.m. to 6:30 p.m., Wednesday through Saturday, January 7-10, and 7:30 a.m. to 4:30 p.m. Sunday, January 11.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="1532"></a>

<div class="sub-content-header">Exhibitor Manual</div>
<br />

In mid-August, we will roll out the 2009 International CES Online Exhibitor Manual! In keeping with our "greening" efforts, the manual will now be accessible <B>online only</B> at <A href="/exhibitors/manual/default.asp">CESweb.org/manual</A>. Please read and review your manual for CES rules and regulations, shipping information, GES and supplemental services order forms, and a lot more. Be sure to note the deadlines for advanced orders for all your service needs – ordering in advance will save you a lot of time and a lot of money! <A href="/exhibitors/manual/default.asp">Contact the CES operations manager</A> specific to your venue with any questions.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="1531"></a>

<div class="sub-content-header">GES Exposition Services</div>
<br />

<A href="http://www.ges.com/" target=_blank>GES Exposition Services</A> is the official general service contractor of CES. GES provides a huge variety of services from freight and material handling, to labor and graphics. Be sure to review your CES Exhibitor Manual for GES information and order forms that you will need to prepare for the 2009 International CES! New this year – be on the lookout for GES "green booth" options! From graphics and materials to lighting, GES has prepared a booth that is better for our environment. Check out the CES Exhibitor Manual for information and order forms&nbsp;in mid-August.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="1530"></a>

<div class="sub-content-header">Las Vegas Monorail</div>
<br />

For a limited time, the Las Vegas Monorail is offering one day passes for $9 each – 40 percent off the regular price! Tickets are valid through CES and up to one year after purchase date. This special deal is being offered through the month of August, so if you’re looking for great savings for monorail passes at CES, <A href="https://tickets.lvmonorail.com/CES/ces2009/" target=_blank>buy your passes today</A>!<BR><BR>The Las Vegas Monorail is offering a 20 percent discount on all other ticket types, such as two ride and&nbsp;10 ride passes, <A href="https://tickets.lvmonorail.com/CES/ces2009/" target=_blank>if you purchase online</A> by January 7, 2009. New this year is a seven-day convention pass for $60!<BR><BR>Visit <A href="/hotelTravel/default.asp">CESweb.org/travel</A> to see a complete list of hotel and travel services offered by CES.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="1529"></a>

<div class="sub-content-header">Venetian Exhibitors: Move-in and Move-out Information</div>
<br />

It's never too early to begin planning your CES shipment. To assist you with your move-in and move-out planning, we have created a <A href="/docs/MI-MO_Procedures_for_Venetian_exhibitors.pdf" target=_blank>schedule</A> for you to follow.<BR><BR>Please be sure to share this schedule with your freight carriers and EACs. If you have any questions, please contact <A href="mailto:gsims@ce.org" target=_blank>Gaiya Sims</A> or call 703-907-7685.
