...
<head><!-- PageID 3255 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Airline Discounts</title>
                ...
                <div id="main-content-column2">
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/hotelTravel/airlines.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
CES has partnered with the below airlines to bring you discounted airfare to/from Las Vegas. See below for details. For questions or problems booking, please contact <A href="mailto:CEShotels@CE.org">CEShotels@CE.org</A>. 
...
<STRONG><IMG hspace=6 vspace=6 align=right src="/images/content/continentalAir.jpg" width=160 height=33>Continental Airlines is offering CES attendees and exhibitors discounts of 2-10% off published Zone fares.</STRONG> The discount is valid on travel to Las Vegas January 4-7 and returning January 10-13. Call your travel professional or Continental MeetingWorks at 800-468-7022 for reservations. Refer to Z Code ZGBQ and Agreement Code DKG7TQ. Please note: There is a $20 fee for reservations made via MeetingWorks or any Continental Airlines ticketing facility.<BR><BR>To avoid the $20 fee and to save an additional 3 percent, book your own reservations at <A href="http://www.continental.com/">http://www.continental.com/</A>. Choose your flight times and access your meeting discounts by inserting ZBGQDKG7TQ in the Offer Code box.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="3258"></a>

<div class="sub-content-header">jetBlue Airways</div>
<br />

<STRONG><IMG hspace=5 align=right src="/images/content/JetBlue_logo.jpg" width=140 height=72>jetBlue is offering a 5% discount to CES attendees and exhibitors.</STRONG> The discount is valid on travel to Las Vegas January 4-7 and returning January 10-13*. Simply <A href="https://www.jetblueairways.com/cgi-bin/skylights.cgi?promo_search=true" target=_blank>visit JetBlue's reservation page</A>, and enter 2010CES in the Promo Code field. <BR><BR><SPAN class=smallText>*All flights in a reservation must include valid routes and travel dates in order to receive a discount. If only one direction of travel is valid, please book your valid flight as a one way trip using the promotional code and the other segment as a one way trip without the code.</SPAN>    
