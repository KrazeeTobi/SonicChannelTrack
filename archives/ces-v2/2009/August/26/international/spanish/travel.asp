...
<head><!-- PageID 1146 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    ...
    <title>2010 CES: Informaci&oacute;n de viajes y visas</title>
...
<P><STRONG>&iquest;Necesita ayuda?</STRONG> <BR><A href="/docs/2K10VisaInterviewTips_Fly_SP.pdf" target=_blank>Descargue nuestra Hoja de consejos para obtener una visa</A>, que consta de instrucciones detalladas, direcciones de sitios web y otra informaci&oacute;n para ayudarlo a completar satisfactoriamente su proceso de solicitud de visado. <BR><BR>A partir del 12 de enero de 2009, se requiere que las personas que visiten los Estados Unidos procedentes de pa&iacute;ses bajo el programa de exenci&oacute;n de visa, se registren en l&iacute;nea y obtengan la autorizaci&oacute;n para su ingreso como parte del nuevo <A href="http://www.dhs.gov/xnews/releases/pr_1212498415724.shtm " target=_blank>Sistema Electr&oacute;nico de Autorizaci&oacute;n de Viajes (en ingl&eacute;s)</A>. <BR></P>
<H2>Viajes</H2>
