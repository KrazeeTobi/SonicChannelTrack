...
<head><!-- PageID 1476 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    ...
    <title>2010 CES: CES Meeting Place Exhibitors</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li class="selected"><a href="/exhibitors/manual/meetingPlace.asp">CES Meeting Place Exhibitors</a></li>
        
            <li ><a href="/exhibitors/manual/0798B27532FA40B2A1DFEE38EA88AB18.htm">FAQs by Venue</a></li>
        
            <li ><a href="/exhibitors/manual/techzoneExhibitors.asp">TechZone Exhibitors</a></li>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/manual/default.asp" class="footer">Show Operations and Logistics</a>&nbsp;&gt;&nbsp;CES Meeting Place Exhibitors</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/manual/meetingPlace.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
CES offers a <A href="/docs/2010_CES_Meeting_Place_Exhibitor_Manual.pdf">packet of information specific to your space at the CES Meeting Place</A> – it’s your one-stop shop for all your CES set-up information.&nbsp;Please review all the materials in the PDF to familiarize yourself with your exhibit space and order forms. Keep in mind you can click on the overall&nbsp;Exhibitor Manual&nbsp;for more information&nbsp;about the show.&nbsp;

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibitors/manual/meetingPlace.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
