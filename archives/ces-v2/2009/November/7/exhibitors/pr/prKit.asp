...
<head><!-- PageID 626 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Exhibitor PR Kit</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li class="selected"><a href="/exhibitors/pr/prKit.asp">Exhibitor PR Kit</a></li>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/pr/default.asp" class="footer">PR Help</a>&nbsp;&gt;&nbsp;Exhibitor PR Kit</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/pr/prKit.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
Maximize your company's media exposure and get the most of your CES experience by using the CES Exhibitor PR Manual. The manual includes valuable ideas on preliminary promotion, comprehensive communications strategies, press conference and publicity tips, press kit information and much more. Download it in is entirety, or simply select the sections you need.<BR><BR>
<H3><A href="/docs/PRkit_All.pdf" target=_blank>2010 CES Exhibitor Public Relations Kit (Complete)</A></H3><BR>
<H3><A href="/docs/Publicity__Tips.pdf" target=_blank>Publicity Tips</A></H3><BR>
<H3><A href="/docs/Key_Deadlines.pdf" target=_blank>Key Deadlines</A></H3><BR>
<H3><A href="/docs/Key_Contacts.pdf" target=_blank>Key Contacts</A></H3><BR>
<H3><A href="/docs/Exhibitor_PR.pdf" target=_blank>Exhibitor PR/ IR Contact Information</A></H3><BR>
<H3><A href="/docs/SpEventCeleb_info.pdf" target=_blank>Special Events and/or Celebrity Appearance Information</A></H3><BR>
<H3><A href="/docs/SpEventCeleb_form.pdf" target=_blank>Special Event/Celebrity Appearance Form</A></H3><BR>
<H3><A href="/docs/PreRegMediaList.pdf" target=_blank>Pre-Registered Media List Information</A></H3><BR>
<H3><A href="/docs/PreCESPressEvent.pdf" target=_blank>Pre-CES Press Events</A></H3><BR>
<H3><A href="/docs/PressBlogger.pdf" target=_blank>Press Rooms and Blogger Lounge</A></H3><BR>
<H3><A href="/docs/GreenRoom.pdf" target=_blank>Green Press Room and Electronic Press Kit Preparation</A></H3><BR>
<H3><A href="/docs/InvestRelations.pdf" target=_blank>Investor Relations</A></H3><BR>
<H3><A href="/docs/OnlineMedia.pdf" target=_blank>Online Media Center</A></H3><BR>
<H3><A href="/docs/PressInvest.pdf" target=_blank>Press and Investor Relations Kit Distribution</A></H3><BR>
<H3><A href="/docs/SamplePress.pdf" target=_blank>Sample Press Release</A></H3><BR>
<H3><A href="/docs/ExhibitorPressConf.pdf" target=_blank>Exhibitor Press Conferences</A></H3><BR>
<H3><A href="/docs/PressDoDont.pdf" target=_blank>Press Conference Dos and Don’ts</A></H3><BR>
<H3><A href="/docs/PressConf_Form.pdf" target=_blank>Press Conference Reservation Form</A></H3><BR>
<H3><A href="/docs/OnsiteInterview.pdf" target=_blank>On-site Interview Rooms</A></H3><BR>
<H3><A href="/docs/RegionalMedia.pdf" target=_blank>2010 International CES Regional Media Outreach Campaign</A></H3><BR>
<H3><A href="/docs/AwardsProgram.pdf" target=_blank>2010 International CES Awards</A></H3>

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibitors/pr/prKit.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
