...
<head><!-- PageID 2942 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: Hotel Reservations</title>
...
<body>
    ...
    <ul>
        ...
        <li class="dd-hotel"><a onmouseover="showDropDown('hotel','show')" onmouseout="setMenuTimer()" href="/hotelTravel/default.asp"><img src="/images/framework/mainnav_hotel_on.gif" /></a></li>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <li class="bottom"></li>
            ...
            <li ><a href="/hotelTravel/blockRequest.asp">2010 CES Block Request Form</a></li>
            ...
            <li ><a href="/hotelTravel/cars.asp">Transportation and Parking</a></li>
                ...
                <div id="main-content-column2">
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/hotelTravel/hotel.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
CES hotels are now <A href="/hotelTravel/blockRequest.asp">accepting reservations for groups (10-20 rooms or more)</A> and individual reservations. Submit your request now. Please check directly with the hotel for rates outside those listed below. Rates and hotels updated as&nbsp;of&nbsp;November 18, 2009.&nbsp;
<br>
...
<A href="/docs/2010_CES_Shuttle_Map_for_CESweb.pdf" target=_blank><IMG border=0 hspace=5 align=right src="/images/content/2010ShuttleBus_Map.jpg" width=126 height=197></A>The hotels below are the official 2010 CES hotels. Complimentary CES shuttle service will be offered to/from these properties only. <A href="/hotelTravel/blockRequest.asp">Request your group block of 10-20 rooms or more now.</A> <BR><BR>To view the hotels on a map and for more information on the free CES shuttle services being offered, <A href="/docs/2010_CES_Shuttle_Map_for_CESweb.pdf" target=_blank>download the shuttle map </A>or visit the <A href="/hotelTravel/shuttle.asp">CES Shuttle page.</A> <BR><BR>For more information on a particular property,&nbsp;select the hotel's name to be directed to their website. From there, you can learn more about the hotel's available services and amenities. <BR><BR><STRONG>Note:&nbsp;</STRONG>As of&nbsp;July 1, 2009, the Clark County room tax&nbsp;has increased&nbsp;from 9 percent&nbsp;to 12 percent&nbsp;per room, per night. <BR><BR><A href="/docs/2010_CES_Shuttle_Map_for_CESweb.pdf" target=_blank>Download map (PDF)</A>
<br /><br />
...
<tr>
    ...
    <td valign="top"><b>Wed<BR>Jan<BR>6</b></td>
    <td valign="top"><b>Thur<BR>Jan<BR>7</b></td> 
    <td valign="top"><b>Fri<BR>Jan<BR>8</b></td>
    <td valign="top"><b>Sat<BR>Jan<BR>9</b></td>
    <td valign="top"><b>Sun<BR>Jan<BR>10</b></td> 
...
<tr class="alternateRows">
    <td valign="top">
        ...
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$79-just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$79-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$79-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$79-just reduced!</FONT>
<P></P></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$69-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText">Under special rates, enter CES1110 in the group number field</span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href="https://reservations.mgmmirage.com/bookingengine.aspx?pid=930&host=group&code=cesm10" target="_blank"><span class="smallText">ARIA Resort & Casino at CityCenter</span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$159-just reduced! </FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$229- just reduced!</FONT> </span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$229-just reduced! </FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$179- just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$179- just reduced! </FONT></span></td>        
        <td valign="top"><span class="smallText">No code needed online</span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="http://www.bellagio.com/" target="_blank"><span class="smallText">Bellagio Deluxe</span></a></td>
        ...
        <td valign="top"><span class="smallText">$199</span></td>        
        <td valign="top"><span class="smallText">CES10</span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href="https://reservations.mgmmirage.com/bookingengine.aspx?pid=ccc&host=promo&code=VICES10" target="_blank"><span class="smallText">Circus Circus run of house</span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$50-just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$75- just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$75-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$65-just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText">$27</span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>Early bird rates&nbsp;extended through&nbsp;November 30, 2009</FONT>; rates shown include $1 daily phone fee*</span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="https://reservations.mgmmirage.com/bookingengine.aspx?pid=ccc&host=promo&code=VICES10" target="_blank"><span class="smallText">Circus Circus West tower</span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#000000>$75</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$92-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$92-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$87-just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText">$40</span></td>        
        <td valign="top"><span class="smallText">
<P><FONT color=#ff0000>Early bird rates are available through November 30, 2009.</FONT> No code needed online; rates shown include $1 daily phone fee*</P></span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href="https://resweb.passkey.com/go/CESCEA2010" target="_blank"><span class="smallText">Encore at Wynn Las Vegas</span></a></td>
        <td valign="top"><span class="smallText">$249</span></td>
        <td valign="top"><span class="smallText">$249</span></td>        
        <td valign="top"><span class="smallText">$249</span></td>        
        <td valign="top"><span class="smallText">$249</span></td>
        <td valign="top"><span class="smallText">$179</span></td>        
        <td valign="top"><span class="smallText">Reservations may be made online or by calling&nbsp;866-770-7555/702-770-7100 and referring to group code 6CEA0110</span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="https://reservations.mgmmirage.com/bookingengine.aspx?pid=EXC&host=offer&code=xces10" target="_blank"><span class="smallText">Excalibur widescreen room</span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$66-just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$96-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$96-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$66-just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText">$40</span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>Early bird rates extended through&nbsp;November 30, 2009</FONT>; rates shown&nbsp;include $5 daily resort fee*</span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href="https://resweb.passkey.com/go/2010CES" target="_blank"><span class="smallText">Hard Rock Hotel & Casino Las Vegas Casino/Paradise tower*</span></a></td>
        <td valign="top"><span class="smallText">$106</span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$199-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$199-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$156- just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText">$106</span></td>        
        <td valign="top"><span class="smallText">Rates shown include $7 daily resort fee*</span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="https://resweb.passkey.com/Resweb.do?mode=welcome_ei_new&eventID=1381309 " target="_blank"><span class="smallText">Hard Rock Hotel & Casino Las Vegas HRH All Suite tower*</span></a></td>
        <td valign="top"><span class="smallText">$146</span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$229-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$229-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$206-just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText">$146</span></td>        
        <td valign="top"><span class="smallText">Rates shown include $7 daily resort fee*</span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href="http://www1.hilton.com/en_US/hi/hotel/LASLVGV-Hilton-Grand-Vacations-Club-at-the-Las-Vegas-Hilton-Nevada/index.do" target="_blank"><span class="smallText">Hilton Grand Vacations Club- Las Vegas studio**</span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$199- just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$199- just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$199-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText">$119</span></td>
        <td valign="top"><span class="smallText">$119</span></td>        
        <td valign="top"><span class="smallText"><SPAN class=smallText>Online reservations not available; call 877-651-4482/702-946-9220 and refer to group code CES</SPAN></span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="http://www1.hilton.com/en_US/hi/hotel/LASLVGV-Hilton-Grand-Vacations-Club-at-the-Las-Vegas-Hilton-Nevada/index.do" target="_blank"><span class="smallText">Hilton Grand Vacations Club -Las Vegas one bedroom suite**</span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$229- just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$229-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$229-&nbsp; just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText">$149</span></td>
        <td valign="top"><span class="smallText">$149</span></td>        
        <td valign="top"><span class="smallText"><SPAN class=smallText>
<P><SPAN class=smallText><SPAN class=smallText>Online reservations not available; call 877-651-4482/702-946-9220 and refer to group code CES</SPAN></SPAN></P></SPAN></span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href="http://www1.hilton.com/en_US/hi/hotel/LASVSGV-Hilton-Grand-Vacations-Club-on-the-Las-Vegas-Strip-Nevada/index.do" target="_blank"><span class="smallText">Hilton Grand Vacations Club on the LV Strip studio</span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$119-just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$119- just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$119-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$89-just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$89-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><SPAN class=smallText><SPAN class=smallText>Online reservations not available; call 877-651-4482/702-946-9220 and refer to group code CES</SPAN></SPAN></span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="http://www1.hilton.com/en_US/hi/hotel/LASVSGV-Hilton-Grand-Vacations-Club-on-the-Las-Vegas-Strip-Nevada/index.do" target="_blank"><span class="smallText">Hilton Grand Vacations Club on the LV Strip one bedroom suite</span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$159-just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$159-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$159-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$129-just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$129-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><SPAN class=smallText><SPAN class=smallText>Online reservations not available; call 877-651-4482/702-946-9220 and refer to group code CES</SPAN></SPAN></span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href="https://reseze.hchvegas.com/servlet/WebresResDesk?hotelid=1247&groupId=479067" target="_blank"><span class="smallText">Hooters Casino Hotel</span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$45-just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$94-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$94-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$94-just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText">$45</span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>Early bird rates shown are valid through December 1, 2009</FONT>. Reservations may be made online or by calling 800-522-7366/702-739-9000 and referring to group code 479067; $5 resort fee waived for CES guests! See below for details</span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="http://www.hyatt.com/hyatt/reservations/flow6/place/propCheckAvailability.jsp?pid=laszl&extCorporateId=G-CES1 " target="_blank"><span class="smallText">Hyatt Place Las Vegas</span></a></td>
...
<tr class="">
    <td valign="top">
        <a href="https://resweb.passkey.com/Resweb.do?mode=welcome_ei_new&eventID=1349389&fromResdesk=true" target="_blank"><span class="smallText">Las Vegas Hilton run of house</span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$209- just reduced! </FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$209- just reduced! </FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$209- just reduced! </FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$209- just reduced! </FONT></span></td>
...
<tr class="alternateRows">
    <td valign="top">
        <a href="https://resweb.passkey.com/Resweb.do?mode=welcome_ei_new&eventID=1349389&fromResdesk=true" target="_blank"><span class="smallText">Las Vegas Hilton premium room</span></a></td>
...
<tr class="">
    <td valign="top">
        <a href="https://resweb.passkey.com/go/CES10P" target="_blank"><span class="smallText">Luxor Tower King room</span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$70- just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$120- just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$120-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$95-just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT style="BACKGROUND-COLOR: #ffffff" color=#ff0000>$54-just reduced! </FONT></span></td>        
        <td valign="top"><span class="smallText">No code needed online; rates shown&nbsp;include $5 daily resort&nbsp;fee*</span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="https://resweb.passkey.com/Resweb.do?mode=welcome_ei_new&eventID=1100277" target="_blank"><span class="smallText">Mandalay Bay</span></a></td>
        <td valign="top"><span class="smallText">$129</span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$189-just reduced! </FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$189-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText">$129</span></td>
        <td valign="top"><span class="smallText">$89</span></td>        
        <td valign="top"><span class="smallText">No code needed online; rate includes daily Internet access ($14.99 value) at no additional charge. At Spa Mandalay and THE Bathouse, book two spa treaments and receive the second treatment at 50 percent off. See Mandalay reservation page for details. </span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href="http://www.mgmgrand.com" target="_blank"><span class="smallText">MGM Grand</span></a></td>
        <td valign="top"><span class="smallText">$109</span></td>
        <td valign="top"><span class="smallText">$199</span></td>        
        <td valign="top"><span class="smallText">$199</span></td>        
        <td valign="top"><span class="smallText">$125</span></td>
        <td valign="top"><span class="smallText">$109</span></td>        
        <td valign="top"><span class="smallText">CES248</span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="https://reservations.mgmmirage.com/bookingengine.aspx?host=group&pid=160&code=ces10" target="_blank"><span class="smallText">Mirage</span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#008000>$95-reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#008000>$205-reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#008000>$205-reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#008000>$130-reduced! </FONT></span></td>
        <td valign="top"><span class="smallText">$65</span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>Early bird rates extended through November 19, 2009</FONT>; no code needed online</span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href=" https://reservations.mgmmirage.com/bookingengine.aspx?pid=MCH&host=group&code=XCES10" target="_blank"><span class="smallText">Monte Carlo</span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$70- just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$125- just reduced! </FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$125- just reduced! </FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$105- just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText">$59</span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>Early bird rates shown are valid through November 20, 2009</FONT>. No code needed online</span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="https://reservations.mgmmirage.com/bookingengine.aspx?pid=010&host=group&code=2010CES" target="_blank"><span class="smallText">New York New York</span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$78- just reduced!</FONT> </span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$148- just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$148- just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText">$118</span></td>
        <td valign="top"><span class="smallText">$58</span></td>        
        <td valign="top"><span class="smallText">No code needed online; rates shown include $3 daily phone fee*</span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href="http://www.palms.com" target="_blank"><span class="smallText">Palms</span></a></td>
        <td valign="top"><span class="smallText">$129</span></td>
        <td valign="top"><span class="smallText">$179</span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$209-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$209-just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText">$129</span></td>        
        <td valign="top"><span class="smallText"><SPAN class=smallText><SPAN class=smallText>
<P><SPAN class=smallText><SPAN class=smallText>Online reservations not available; call 866-942-7777/702-942-7777 and refer to group code AC0110F.&nbsp;Complimentary daily spa/fitness center access for CES guests, a $20 daily value <FONT face=Arial,Arial color=#000080 size=2><FONT face=Arial,Arial color=#000080 size=2><FONT face=Arial,Arial color=#000080 size=2><SPAN lang=EN></P>
<P></FONT></FONT></FONT></SPAN></SPAN></SPAN><FONT face=Arial,Arial color=#000080 size=2><FONT face=Arial,Arial color=#000080 size=2><FONT face=Arial,Arial color=#000080 size=2><SPAN lang=EN></P></FONT></FONT></FONT></SPAN></SPAN></SPAN></span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="http://www.palmsplace.com" target="_blank"><span class="smallText">Palms Place</span></a></td>
        ...
        <td valign="top"><span class="smallText">$139</span></td>        
        <td valign="top"><span class="smallText"><SPAN class=smallText>
<P><SPAN class=smallText><SPAN class=smallText>Online reservations not available; call 866-942-7772/702-932-7777 and refer to group code AC1210V. Complimentary daily spa/fitness center access for CES guests, a $35 daily value. <FONT face=Arial,Arial color=#000080 size=2><FONT face=Arial,Arial color=#000080 size=2><FONT face=Arial,Arial color=#000080 size=2><SPAN lang=EN></P></FONT></FONT></FONT></SPAN></SPAN></SPAN></SPAN></span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href="https://reservations.ihotelier.com/crs/g_reservation.cfm?groupID=372636&hotelID=15019" target="_blank"><span class="smallText">Platinum Hotel & Spa***</span></a></td>
        <td valign="top"><span class="smallText">$149</span></td>
        <td valign="top"><span class="smallText">Sold out </span></td>        
        <td valign="top"><span class="smallText">Sold out </span></td>        
        <td valign="top"><span class="smallText">$149</span></td>
        <td valign="top"><span class="smallText">$149</span></td>        
        <td valign="top"><span class="smallText">Hotel is sold out January 7-8; no code needed online</span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="http://www.planethollywood.com" target="_blank"><span class="smallText">Planet Hollywood Resort & Casino</span></a></td>
        <td valign="top"><span class="smallText">$109</span></td>
        <td valign="top"><span class="smallText">$199</span></td>        
        <td valign="top"><span class="smallText">$199</span></td>        
        <td valign="top"><span class="smallText">$109</span></td>
        <td valign="top"><span class="smallText">$109</span></td>        
        <td valign="top"><span class="smallText">Online reservations not available. Call 877-244-9474/702-785-9455 and refer to<BR>group code CES. Starwood Preferred Guests (SPG)&nbsp;earn double reward points! Please provide your SPG number at the time of booking. </span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href="http://www.renaissancelasvegas.com" target="_blank"><span class="smallText">Renaissance Las Vegas</span></a></td>
        <td valign="top"><span class="smallText">n/a for individuals </span></td>
        <td valign="top"><span class="smallText">n/a for individuals </span></td>        
        <td valign="top"><span class="smallText">n/a for individuals </span></td>        
        <td valign="top"><span class="smallText">n/a for individuals </span></td>
        <td valign="top"><span class="smallText">n/a for individuals </span></td>        
        <td valign="top"><span class="smallText">CES rate is $289, however, hotel only accepts groups of 10 or more rooms. <BR>See <A href="/hotelTravel/blockRequest.asp">group block request form</A> for details.</span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="http://www.rivierahotel.com/resnet/roomres.asp?ID=314 " target="_blank"><span class="smallText">Riviera </span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$79- just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$99- just reduced! </FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$99- just reduced! </FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$99- just reduced! </FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$49- just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText">No code needed online</span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href="http://www.saharavegas.com" target="_blank"><span class="smallText">Sahara</span></a></td>
        <td valign="top"><span class="smallText">$30</span></td>
        <td valign="top"><span class="smallText">$80</span></td>        
        <td valign="top"><span class="smallText">$80</span></td>        
        <td valign="top"><span class="smallText">$80</span></td>
        <td valign="top"><span class="smallText">$30</span></td>        
        <td valign="top"><span class="smallText"><SPAN class=smallText>Online reservations not available; call 888-696-2121/702-737-2654 and refer to group code CES10. Note $6 daily&nbsp;facility fee is waived for CES guests! See below for details </SPAN></span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="http://www.signaturemgmgrand.com" target="_blank"><span class="smallText">Signature at MGM Grand junior suite</span></a></td>
        <td valign="top"><span class="smallText">$169</span></td>
        <td valign="top"><span class="smallText"><FONT color=#008000>$219-reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#008000>$219-reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#008000>$199-reduced!</FONT></span></td>
        <td valign="top"><span class="smallText">$149</span></td>        
        <td valign="top"><span class="smallText">CES980; rates shown include $20 daily resort fee*</span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href="https://resweb.passkey.com/Resweb.do?mode=welcome_ei_new&eventID=1100277" target="_blank"><span class="smallText">THEhotel at Mandalay Bay</span></a></td>
        <td valign="top"><span class="smallText">$148</span></td>
        <td valign="top"><span class="smallText">$249</span></td>        
        <td valign="top"><span class="smallText">$249</span></td>        
        <td valign="top"><span class="smallText">$148</span></td>
        <td valign="top"><span class="smallText">$118</span></td>        
...
<tr class="alternateRows">
    <td valign="top">
        <a href="http://www.treasureisland.com" target="_blank"><span class="smallText">Treasure Island</span></a></td>
        <td valign="top"><span class="smallText">$99</span></td>
        <td valign="top"><span class="smallText">$199</span></td>        
        <td valign="top"><span class="smallText">$199</span></td>        
        <td valign="top"><span class="smallText">$129</span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$79-just reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText">CESWEB2010</span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href="http://tinyurl.com/http-tropces10-com" target="_blank"><span class="smallText">Tropicana Las Vegas</span></a></td>
        <td valign="top"><span class="smallText">$49</span></td>
        <td valign="top"><span class="smallText">$99</span></td>        
        <td valign="top"><span class="smallText">$99</span></td>        
        <td valign="top"><span class="smallText">$99</span></td>
        <td valign="top"><span class="smallText">$49</span></td>        
...
<tr class="alternateRows">
    <td valign="top">
        <a href="http://booking.ihotelier.com/istay/istay.jsp?hotelID=15526&userType=GRP " target="_blank"><span class="smallText">Trump International Hotel Las Vegas studio city view suite</span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#008000>$89-reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#008000>$209-reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#008000>$209-reduced!</FONT></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#008000>$209-reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#000000>$89</FONT></span></td>        
        <td valign="top"><span class="smallText">2010 CES; $15 daily resort fee waived for CES guests! See below for details</span></td>
</tr>
<tr class="">
    <td valign="top">
        <a href="https://reservations.mgmmirage.com/bookingengine.aspx?pid=938&host=offer&code=CES110" target="_blank"><span class="smallText">Vdara at CityCenter deluxe suite</span></a></td>
        <td valign="top"><span class="smallText">$129</span></td>
        <td valign="top"><span class="smallText">$229</span></td>        
        <td valign="top"><span class="smallText">$229</span></td>        
        <td valign="top"><span class="smallText">$179</span></td>
        <td valign="top"><span class="smallText">$129</span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>Early bird rates extended through November 30, 2009</FONT>. No code needed online; rates shown include $15 daily resort fee*</span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="https://resweb.passkey.com/go/RCEASB" target="_blank"><span class="smallText">Venetian</span></a></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$259- just reduced!</FONT></span></td>
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$259- just reduced!</FONT>
<P></P></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$259- just reduced!</FONT>
<P></P></span></td>        
        <td valign="top"><span class="smallText"><FONT color=#ff0000>$259- just reduced!</FONT></span></td>
...
<tr class="">
    <td valign="top">
        <a href="http://www.starwoodmeeting.com/StarGroupsWeb/res?id=0903273023&key=C29ED" target="_blank"><span class="smallText">Westin Casuarina</span></a></td>
        <td valign="top"><span class="smallText">$205</span></td>
        <td valign="top"><span class="smallText">$205</span></td>        
        <td valign="top"><span class="smallText">$205</span></td>        
        <td valign="top"><span class="smallText">$125</span></td>
        <td valign="top"><span class="smallText">$125</span></td>        
        <td valign="top"><span class="smallText">No code needed online; Westin is offering CES&nbsp;guests special discounts and deals during CES. See&nbsp;the&nbsp;<A href="/hotelTravel/lasVegas.asp">Discounts and Coupons&nbsp;</A>page for details.&nbsp;</span></td>
</tr>
<tr class="alternateRows">
    <td valign="top">
        <a href="https://resweb.passkey.com/go/CESCEA2010" target="_blank"><span class="smallText">Wynn Las Vegas</span></a></td>
        <td valign="top"><span class="smallText">$239</span></td>
        <td valign="top"><span class="smallText">$239</span></td>        
        <td valign="top"><span class="smallText">$239</span></td>        
        <td valign="top"><span class="smallText">$239</span></td>
        <td valign="top"><span class="smallText">$169</span></td>        
        <td valign="top"><span class="smallText">Reservations may be made online or by calling&nbsp;866-770-7555/702-770-7100 and referring to group code 8CEA0110</span></td>
</tr>
</table>
<br>
<H4>*Hotel Phone and Resort Fees</H4>
<UL class=text>
<LI class=text><STRONG>Circus Circus: </STRONG>$1 daily phone fee includes unlimited local calls </LI>
<LI class=text><STRONG>Excalibur:</STRONG> $5 daily resort fee includes unlimited local calls; long distance domestic calls at 10 cents per minute; fitness center access; one voucher for two well drinks in any casino bar and a pass for two games per stay at the hotel's Midway Entertainment venue </LI>
<LI class=text><STRONG>Hard Rock: </STRONG>$7 daily resort fee includes limited shuttle service to the strip; limited business services; pool/towel service; valet and self parking; concierge services </LI>
<LI class=text><STRONG>Hooters Casino Hotel:</STRONG>&nbsp;Resort fee waived for CES guests. Included in room rate at no charge: unlimited local and toll free calls and unlimited gym access </LI>
<LI class=text><STRONG>Luxor: </STRONG>$5 daily&nbsp;resort fee includes daily newspaper, two bottles of water daily, access to Nurture Fitness Center, and&nbsp;ulimited local, domestic long distance, and toll-free calls </LI>
<LI class=text><STRONG>New York New York: </STRONG>$3 daily phone fee includes unlimited local and toll free calls; direct dial long distance calls are AT&amp;T operator assisted rate plus 55% </LI>
<LI class=text><STRONG>Sahara:</STRONG>&nbsp;Daily facility fee waived for CES guests.&nbsp;Unlimited local calls, toll free calls, access to the fitness center and pool are included in room rate at no charge </LI>
<LI class=text><STRONG>Signature at MGM Grand:</STRONG>&nbsp;$20 daily resort fee includes insuite and public space Internet access; two bottles of water per room, per day; local and toll-free calls; access to The Signature fitness center; in-suite private label coffee; valet parking </LI>
<LI class=text><STRONG>Trump International Hotel Las Vegas:</STRONG> Resort fee waived for CES guests. Included in room rate at no charge: overnight valet parking; fitness center access; use of pool facilities; two bottles of water in room, replenished daily; newspaper delivery; coffee in room, replenished daily; shoe shine service; incoming faxes; local and toll-free calls </LI>
<LI class=text><STRONG></STRONG><STRONG>Vdara at CityCenter:</STRONG>&nbsp;$15 daily resort fee includes daily fitness center access; wireless high speed Internet access; nightly turndown service; two bottles of water daily; daily newspaper; unlimited local and toll-free calls </LI></UL>All fees are subject to change&nbsp;and&nbsp;are taxable at the current rate of&nbsp;12 percent. <BR><BR>**Formerly known as Hilton Grand Vacations Club at the LV Hilton<BR>***Walking distance to CES shuttle route<BR><BR><BR>
<H3>Housing Agency/Bureau Policy</H3>The Consumer Electronics Association (CEA), producer of the International CES, would like to remind CES attendees and exhibitors that CES does not use or endorse housing agencies or bureaus. CES attendees and exhibitors are to contact the CES hotels directly to receive the contracted CES rate. Claims by housing agencies/bureaus that they are the official CES housing agency are untrue. Please feel free to contact <A href="mailto:CEShotels@CE.org">CEShotels@CE.org</A> for further information. <BR>    
