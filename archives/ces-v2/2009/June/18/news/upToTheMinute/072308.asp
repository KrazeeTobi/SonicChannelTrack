...
<head><!-- PageID 1588 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2010 International CES, January 7-10: July 23, 2008</title>
...
<A href="/hotel.asp"><IMG height=125 hspace=8 src="/images/photos/Strip_165x125.jpg" width=165 align=right border=0>CES hotels are now accepting reservations for the 2009 CES</A>. As a reminder, CES does not have an official housing agency or bureau. Attendees are responsible for contacting CES hotels directly via CESweb.org to book rooms. More than three dozen Vegas properties offer discounts for CES attendees. "No vacancy" signs are starting to appear for CES show days (January 8-11), however, so learn more about how to book your room.<BR><BR><A href="/hotel.asp">CES goers can book single reservations online</A> or can <A href="/hotelTravel/blockRequest.asp">book blocks of 10 or 20 rooms</A>, depending on the property. Six properties offer nightly rates under $200 for show days.<BR><BR>If you are contacted by a group claiming to be the official CES housing agency, please e-mail <A href="mailto:CEShotels@CE.org">CEShotels@CE.org</A> immediately. For more information, please e-mail <A href="mailto:CEShotels@CE.org">CEShotels@CE.org</A>.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
