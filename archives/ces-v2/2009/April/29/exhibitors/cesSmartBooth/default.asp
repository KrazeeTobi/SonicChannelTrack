...
<head><!-- PageID 362 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2010 International CES, January 7-10: MyCES Exhibitor Portal</title>
...
The MyCES Exhibitor Portal is the exhibitor interface to the MyCES online directory as well as the printed Official International CES Show Directory.&nbsp; With this powerful, web-based tool, you can enter your company’s directory information as well as access value-added prospecting and measurement products that allow you to maximizeand continue your show investment before, during and after CES. <BR><BR>Every CES exhibitor receives a free <A href="https://myces.bdmetrics.com/exhibitorportal/" target=_blank>MyCES Exhibitor Portal</A> that allows you to: 
<UL class=text>
<LI class=text>Complete your company information for the printed Official International CES Show Directory. </LI>
<LI class=text>Add additional information beyond your print listing that will be searched and viewed online in MyCES.</LI>
<LI class=text>Be found online by attendees leading up to the show AND buyers searching the Internet. </LI>
<LI class=text>Detect how many buyers of your products and services have registered for CES.&nbsp; </LI></UL><STRONG>MyCES —</STRONG> Every attendee automatically receives a login to the MyCES online show portal. There they can search for sessions and exhibitors: receive recommendations based on their personal profile; and create individual event plans and walking maps. Additionally, MyCES serves as the search engine for the show website and, the MyCES content is crawled by the major internet search engines. So, by establishing and enhancing your online presence in MyCES, you extend your reach and impact from a few days in the exhibit hall to all year long.<BR><BR>Also available is an<STRONG> Exhibitor Microsite</STRONG>. With an Exhibitor Microsite you can further enhance your CES directory listing, promote your brand and further increase your online MyCES. Learn how.<BR><BR><A href="https://myces.bdmetrics.com/exhibitorportal/" target=_blank>Login to your free MyCES Exhibitor Portal*</A> today to take advantage of these benefits and more. The sooner you update your information; the sooner attendees can find you. <BR><BR>For more information on other MyCES online marketing opportunities, check out the MyCES Advertising Opportunities or contact Ed Gorey at 410-402-1070, <A href="mailto:ed.gorey@bdmetrics.com">ed.gorey@bdmetrics.com</A>.<BR><BR>*Note: Login required. Your company's credentials were e-mailed to the main exhibitor representative we have on file. For assistance e-mail <A href="mailto:Support@BDMetrics.com">Support@BDMetrics.com</A> or call 800-931-5103 and select option 1. 
<P>&nbsp;</P>
