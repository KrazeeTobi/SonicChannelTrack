...
<body>
    ...
    <div id="search">
        <img src="/print/images/framework/ces-date2010.gif" width="319" height="45" alt="International CES January 7-10, 2010" /><br />
        ...
        <img src="/print/images/framework/linkarrow.gif" width="11" height="12" alt="[bullet image]" /><a href="http://blog.ce.org" target="_blank">CES Blog</a><br />
...
You have two options if your preferred hotel is sold out. You can consult the <A href="/print/hotel.asp">online CES hotel program</A>, where rates tend to be lower, and look for alternate properties near where you want/need to stay.&nbsp; For example, although the CES block for The Venetian&nbsp;sold out&nbsp;in the fall preceding the&nbsp;2008 International CES, many other hotels nearby participated in the CES hotel program and had available rooms, including Treasure Island, Mirage, Harrah’s and Imperial Palace. <BR><BR>You can also contact your preferred hotel(s) directly to book a room, although if their CES block is sold out, you will likely end up paying higher prices. <A href="/print/hotelTravel/default.asp">Get more hotel information.</A> 
<br><img src="/print/images/framework/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><BR>
