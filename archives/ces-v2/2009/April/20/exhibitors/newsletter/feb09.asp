...
<head><!-- PageID 2898 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2009 CES, Jan. 8-11: February 2009</title>
...
<tr>
    ...
    <!-- article start -->
    <p><strong>CES Defies the Odds</strong><br> by Dan Cole</p>
    <p>Congratulations on your participation in the world’s largest consumer technology tradeshow! Despite a challenging economic climate and pervasive uncertainty, the 2009 International CES managed to defy the odds and deliver the type of high-quality, business-focused event that the CE industry – and world – has come to expect. Final audited numbers will be shared in May, but preliminary numbers show that more than 110,000 attendees and 2,700 exhibitors showcasing 20,000 plus new products and technologies convened in Las Vegas in one of the most successful shows in recent memory.
<P>Often, at large trade events such as CES, there is too great an emphasis placed on sheer attendee numbers alone. But the 2009 International CES proved that quality, not quantity, is the key factor in delivering R.O.I. for its participants. Feedback from key exhibitors and attendees alike confirmed that attendee quality was perhaps the best ever. Exhibitors like Fry’s Electronics claimed that the 2009 CES boasted “more CEOs than any previous show,” while others like Cisco held an unprecedented 450 out of 450 pre-scheduled meetings. This feedback is a testament to the importance that key decision makers focused on doing business at CES were present.</P>
<P>Through the support and participation of companies like yours, the CES conference and keynote program was as strong as ever. Microsoft CEO Steve Ballmer outlined three opportunities that lay ahead for the technology industry, including the convergence of the PC, phone and TV. Sony President and CEO Sir Howard Stringer announced a partnership with MTV Networks and host of new Sony products, including the Wi-fi Cyber-shot camera and a new Internet-enabled alarm clock. Continuing the major automotive OEM participation in CES, Ford president and CEO Alan Mulally showcased the latest additions to the Sync infotainment and connectivity platform, including personalized traffic reporting and driving direction features. </P>
<P>Intel Chairman Craig Barrett and Cisco CEO Chairman &amp; CEO John Chambers headlined the second year of CEA’s Technology and Emerging Countries (TEC) program.&nbsp; Barrett discussed a number of key technology initiatives in advancing economic development in emerging regions: access to inexpensive technology, connectivity and content. In Chambers’ closing keynote, he outlined five key pillars of strength for a country — education, infrastructure, high-speed broadband to allow information to be shared, innovation and market transitions, and a supportive government.<BR></P></p>
    <!-- article end -->
    <p>Continued on <a href="/exhibitors/newsletter/feb09pro.asp">next page</a>.<br></p>
    </span>
    </td>
</tr>
</table>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;February 2009</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/newsletter/feb09.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<div align="center">
    ...
    [ <a href="/exhibitors/newsletter/feb09pro.asp">Promotions</a> ]

    [ <a href="/exhibitors/newsletter/feb09ev.asp">Events</a> ]

    [ <a href="/exhibitors/newsletter/feb09ops.asp">Operations</a> ]
...
<div class="sub-content-header">2009 International CES by the Numbers</div>
<br />

<IMG height=179 hspace=10 src="/images/photos/Arch.jpg" width=250 align=right vspace=10>2009 was another great year for CES. Once again, CES attracted the best in the industry. Our preliminary audit shows an attendance of 112,583. Feedback from our exhibitors and board members supports early signs that the quality of attendees was better than ever.&nbsp; 
<P></P>
<P>Below is a brief summary of our show attendance highlights. Our full Attendee Audit Summary Results will be available in May 2009.</P><STRONG>CES General Show Attendance Highlights</STRONG> <BR>
<TABLE cellSpacing=0 cellPadding=3 width="75%" border=1>
<TBODY>
<TR vAlign=top>
...
<TR vAlign=top>
<TD>Total&nbsp;</TD>
<TD>112,583</TD></TR></TBODY></TABLE>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="2917"></a>

<div class="sub-content-header">New CE Spotlights for the 2010 Show Floor</div>
<br />

While settling down from this year’s successful CES, it’s already time to start looking forward to the 2010 show. CES is excited to announce two new areas on the show floor that are sure to bring in many first time exhibitors and some exciting fodder for attendees.<BR><BR><STRONG>EHX@CES</STRONG><BR><A href="http://www.ehxweb.com/" target=_blank>EHX</A> and <EM><A href="http://www.cepro.com/" target=_blank>CE Pro Magazine</A></EM> have partnered with the <A href="www.ce.org" target=_blank>Consumer Electronics Association </A>(CEA)&reg; to bring the EHX experience to CES to create a dedicated integrators destination at the 2010 International CES. Here is your opportunity to leverage the reach of CES and the targeted audience delivered by EHX. CEPro is the integrator’s choice for information which ensures that you will reach a quality audience with access to direct channels to integrators. <BR>If you are interested in exhibiting at EHX@CES, please contact an <A href="http://www.ehpub.com/events/exhibitor_prospectus.html" target=_blank>EHX sales representative today</A>!<BR><BR>
<TABLE cellSpacing=1 cellPadding=1 width="75%" border=0>
<TBODY>
<TR>
<TD>Company Names A-M<BR>Susan Celli<BR>800-375-8015 Ext. 265<BR><A href="mailto:scelli@ehpub.com">scelli@ehpub.com</A>&nbsp;</TD>
<TD>Company Names N-Z<BR>George Keegan<BR>800-375-8015 Ext. 229<BR><A href="mailto:gkeegan@ehpub.com">gkeegan@ehpub.com</A></TD></TR></TBODY></TABLE><BR><STRONG>iLounge Pavilion</STRONG><BR>The <A href="www.ce.org" target=_blank>Consumer Electronics Association </A>(CEA)&reg; recently announced the official launch of the iLounge&reg; Pavilion, a unified iPod&reg;, iPhone&reg; and Mac&reg; exhibition area&nbsp;at the 2010 CES. The iLounge Pavilion, co-sponsored by CEA and <A href="http://www.ilounge.com/" target=_blank>iLounge.com</A>, will be located in the Las Vegas Convention Center (LVCC) and will feature manufacturers and retailers of iPod and iPhone accessories, related products and services, and based on requests from vendors, will now grow to include leading Mac developers and retailers as well.<BR><BR>Due to overwhelming demand, CES has recently quadrupled the space on the show floor dedicated to the iLounge Pavilion. Space is filling up quickly. Companies interested in exhibiting in the iLounge Pavilion at the 2010 International CES should contact Tira Gordon, National Account Manager for CES, at <A href="mailto:tgordon@CE.org">tgordon@CE.org</A>.
