...
<head><!-- PageID 2979 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: MyCES Opportunities</title>
...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li class="selected"><a href="/exhibitors/sponsorships/myCES-ops.asp">MyCES Opportunities</a></li>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/sponsorships/default.asp" class="footer">Promotional Opportunities</a>&nbsp;&gt;&nbsp;MyCES Opportunities</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/sponsorships/myCES-ops.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>MyCES Opportunities</h1>
                                                               
                        

Extend your reach of the International CES audience.&nbsp;Featuring a robust search engine and supplier directory, the International CES online portal doubles as a year-round resource for industry insiders. Sponsorship of the MyCES portal not only builds interest in your business among tradeshow attendees, it also builds awareness of your brand among an in-market audience all year long.<br /><br />
<div class="page_header_block">
    <div class="blue_box">
        ...
        <li><a href="#2989">exhibitorMicrosite</a></li><!---->
        
        <li><a href="#2988">eventLeads</a></li><!---->
        
            </ul>
        
            <ul>
        
        <li><a href="#2987">eventAds</a></li><!---->
        
        <li><a href="#2986">eventVideo</a></li><!---->
        
            </ul>
        
            <ul>
        
        <li><a href="#2984">eventMobile</a></li><!---->
...
<div class="sponsorshipTitle">exhibitorMicrosite</div>
<br />Upgrade your free listing on the MyCES portal to a comprehensive microsite featuring your products, news and more – plus an information request form for online lead capture.<BR><BR><STRONG>A great thing about this promotional opportunity:<BR></STRONG>It helps drive booth traffic and drives website traffic&nbsp; year round. <BR><BR><STRONG>Sponsorship Investment<BR></STRONG>$495 <BR><BR><STRONG>Contact<BR></STRONG>Ed Gorey<BR>VP Sales, MyCES<BR>Phone: 410-402-1070<BR>E-mail: <A href="mailto:ed.gorey@bdmetrics.com">ed.gorey@bdmetrics.com</A> <BR>
...
<div class="sponsorshipTitle">eventLeads</div>
<br />eventLeads enables you to identify your ideal prospects from within the International CES attendee database. Not only will you receive your own pre-show prospect list, you can connect directly with these prospects via the MyCES personal recommendation engine and through each attendee’s own event plan and walking map. MyCES eventLeads automatically: 
<UL class=text>
<LI class=text>Identifies your best prospects from the list of pre-registered attendees </LI>
<LI class=text>Adds your company to attendees' Event Plan</LI>
<LI class=text>Highlights your exhibitor listing for your three select eventKeywords</LI>
<LI class=text>Highlights your booth on attendees' Personal Walking Maps </LI>
<LI class=text>Sends your custom message or invitation to highly qualified leads</LI></UL>
<P><BR><STRONG>Sponsorship Investment<BR></STRONG>$2995<BR><BR><STRONG>Contact</STRONG><BR>Ed Gorey<BR>VP Sales, MyCES<BR>Phone: 410-402-1070<BR>E-mail: <A href="mailto:ed.gorey@bdmetrics.com">ed.gorey@bdmetrics.com</A></P>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sponsorshipTitle">eventAds:&nbsp;<span class="lt_blue">Price varies</span></div>
<br />You can build awareness of your brand and interest in your booth via targeted advertising on the MyCES online portal, on-site kiosks and email alerts. eventAds opportunities include: 
<UL class=text>
<LI class=text><STRONG>eventAds Web</STRONG> <BR>We offer a wide variety of ad sizes and placements throughout the MyCES online portal</LI>
<LI class=text><STRONG>eventAds Web3D</STRONG> <BR>Floating, rich-media ads appear on the MyCES home page – with the option of placing your 3D ad on your own site at no additional cost.</LI>
<LI class=text><STRONG>eventAds Kiosk</STRONG> <BR>The MyCES portal is accessible via on-site kiosks. Your ad will appear prominently on every page.</LI>
<LI class=text><STRONG>eventAds Email</STRONG> <BR>Your ad will appear atop e-newsletters and email alerts featuring personalized show recommendations. </LI></UL><BR><STRONG>Sponsorship Investment</STRONG><BR>$ Price Varies <BR>Contact<BR>Ed Gorey<BR>VP Sales, MyCES<BR>Phone: 410-402-1070<BR>E-mail: <A href="mailto:ed.gorey@bdmetrics.com">ed.gorey@bdmetrics.com</A>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sponsorshipTitle">eventVideo:&nbsp;<span class="lt_blue">$1,700</span></div>
<br />You can add existing video footage to your Exhibitor Microsite, or we can create an “eventVideo” news station branded to your business. Your branded news station will feature your choice of broadcast news anchor presenting your professionally crafted news story using a blend of active video, stills and text. Your eventVideo news station will appear on: 
<UL class=text>
<LI class=text>The Portal Home Page</LI>
<LI class=text>Your Exhibitor Microsite </LI>
<LI class=text>Your Corporate Website</LI></UL><BR>Sponsorship Investment<BR>$1700<BR>Contact<BR>Ed Gorey<BR>VP Sales, MyCES<BR>Phone: 410-402-1070<BR>E-mail: <A href="mailto:ed.gorey@bdmetrics.com">ed.gorey@bdmetrics.com</A>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<div class="sponsorshipTitle">eventMobile:&nbsp;<span class="lt_blue">$25,000</span></div>
<br />Exclusive sponsorship of MyCES mobile puts your brand directly in the hands of attendees. The MyCES mobile portal enables attendees to search for sessions, locate booths, build itineraries, book taxis, make restaurant reservations and more straight from the show floor.<BR>Your exclusive eventMobile sponsorship will include:
<UL class=text>
<LI class=text>“Sponsored By” Placements </LI>
<LI class=text>Top Search Ranking </LI>
<LI class=text>Custom Channel</LI></UL>
<P>Sponsorship Investment<BR>$25,000</P>
<P><BR>Contact<BR>Ed Gorey<BR>VP Sales, MyCES<BR>Phone: 410-402-1070<BR>E-mail: <A href="mailto:ed.gorey@bdmetrics.com">ed.gorey@bdmetrics.com</A><BR></P>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/exhibitors/sponsorships/myCES-ops.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
