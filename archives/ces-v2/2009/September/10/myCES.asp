...
<A href="http://myces.bdmetrics.com/account/login.aspx"><IMG height=93 hspace=6 src="/images/content/MyCES_240.gif" width=240 align=right border=0></A> 
<H2>Five easy steps to a successful four days at CES</H2>MyCES helps you maximize your time at CES by providing the tools you need to find the products, partnerships and information that are important to your business’ success.<BR><BR>In just FIVE easy steps, you can search the exhibitor directory, build a show agenda, connect with peers, and more. Here’s how: 
<H2></H2>
<OL>
<LI><A href="http://myces.bdmetrics.com/account/login.aspx">Create your MyCES account by providing a unique e-mail address.</A> You can use the same one you used to register for CES as long as it’s unique to only you. </LI>
...
<LI>Revisit your MyCES portal often to build your Event Plan with new exhibitors, products, events and sessions that are important to you. </LI>
<LI>As soon as you get to the show, print your customized map of the exhibitors and products you added to your event plan, and...</LI></OL>
<P>...spend the next four days experiencing CES like never before!</P>

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/myCES.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
