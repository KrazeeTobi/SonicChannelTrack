...
<head><!-- PageID 1042 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <title>2010 International CES, January 7-10: June 2008 Operations</title>
...
<div id="blog-sidebar">
    ...
    <a class="blog" href="http://www.cesweb.org/blog" target="_blank"><span>Join the Conversation</span></a>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/jun08.asp" class="footer">June 2008</a>&nbsp;&gt;&nbsp;June 2008 Operations</div>
                    </div>
                    <div id="inner-content-right">
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/newsletter/jun08ops.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
                    ...
                    <div id="inner-content-long">
                        <h1>June 2008 Operations</h1>
                                                               
                        
<div align="center">

    [ <a href="/exhibitors/newsletter/jun08.asp">News</a> ]
...
<div class="sub-content-header">Budgeting for the 2009 International CES</div>
<br />

The International CES will be going back to a Thursday-Sunday show pattern, and that means savings for you since your move-in and move-out hours will most likely not incur overtime rates. See below for money-saving information on your material handling rates at the show.<BR><BR>Dont forget to look up your target move-in and move-out information by visiting <A href="/exhibitors/manual/default.asp">www.CESweb.org/manual</A> and downloading the maps that correspond to your hall. This helps you plan in advance and determine your budget. Also keep in mind during your planning that <STRONG>January 1, 2009, will be a dark day</STRONG>, and no exhibitor floor work will be permitted.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="1082"></a>

<div class="sub-content-header">Material Handing Rates: What You Need to Know</div>
<br />

The 2009 material handling rates will be reduced as exhibitors will be moving in on weekdays (the show date pattern has reverted back to Thursday through Sunday this year). Material handling charges include receiving and unloading your freight at the docks, delivery to your booth, storage/return of empties at the close of the show, removal of your freight from your booth, and reloading onto your outbound carrier. Material handling rates are charged per 100-pound increments, referred to as hundred-weight, with a minimum of 300 pounds.<BR><BR>To find when your materials can be delivered direct to showsite, please access targeted freight floor plans at <A href="/exhibitors/manual/default.asp">CESweb.org/manual</A>.<BR><BR><STRONG>NOTE: </STRONG>If you are a Venetian meeting room exhibitor or a Venetian Tower suite exhibitor and have questions regarding your move-in and move-out dates, please <A href="mailto:gsims@CE.org" target=_blank>e-mail Gaiya Sims</A> for additional information. This information will also be posted in your exhibitor manuals.<BR><BR><STRONG>LVCC, Sands, Hilton Exhibitors: </STRONG>Advance shipments to the GES warehouse sent by December 15, 2008, will be charged $50.08 per hundred-weight ($150.24 300 lb. minimum). Crated shipments sent direct to show site on the date(s) noted herein will be charged at $35.48 per hundred-weight ($106.44 300 lb. minimum). <BR><BR><STRONG>Venetian Meeting Room Exhibitors: </STRONG>Shipments sent in advance to the GES warehouse by December 28, 2008, will be charged at the rate of $50.08 per hundred-weight ($150.24 300 lb. minimum). Direct shipments will be charged at $70.00 per hundred-weight ($210.00 300 lb. min). <BR><BR>For exhibitors bringing their materials in a small passenger vehicle, a special freight service called Cartload Service is offered to those exhibitors needing a hand. This service is for those who have small hand-carry items, all of which must fit on a 3'x4' pushcart in one trip only. A cartload is eight pieces or less weighing up to a maximum of 250 pounds. One cartload is permitted per booth. This service is one laborer with one pushcart, for one trip for a charge of $44.29 each way. Please note: If you arrive with a truck/van or trailer filled with exhibit material, you do not qualify for this service and will be redirected to the marshalling yard. Sands exhibitors will receive this one time, round-trip service, at no charge. This service is offered on limited dates and times. More information will be available in the exhibitor manual coming in mid-August.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="1382"></a>

<div class="sub-content-header">Installation &amp; Dismantle Labor in 2009</div>
<br />

<SPAN style="FONT-FAMILY: ">GES Exposition Services</SPAN><SPAN style="FONT-FAMILY: "> is also the official labor contractor of CES and will be assigned on a first-come, first-served basis. Please submit your labor order form as early as possible to avoid overtime labor charges. The deadline to order this year is December 15, 2008.<BR><BR></SPAN><SPAN style="FONT-FAMILY: ">Plan to begin your labor at least four hours after your initial target delivery time. The rate for straight time is $67.27 per hour at all facilities. The rate for overtime (before 8 a.m., after 5 p.m. on weekdays and all weekends), is $120.15 per hour. Keep an eye out for the exhibitor manual at <A href="http://www.cesweb.org/Manual" target=_blank>www.CESweb.org/manual</A> in mid-August.</SPAN>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="1081"></a>

<div class="sub-content-header">Specialized Event Services (SES) at the Sands/Venetian</div>
<br />

For exhibitors at Sands or The Venetian, SES is the exclusive provider of telecommunications, Internet, electrical, cleaning, hanging applications, video signal distribution, compressed air, water and drainage. A full listing of all SES services will be provided in the 2009 SES brochure, which will be included in your upcoming 2009 International CES Exhibitor Manual.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="1384"></a>

<div class="sub-content-header">Hotel program opening next week!</div>
<br />

<SPAN style="FONT-FAMILY: ">The CES hotel program will open Monday, June 9 for individual reservations (less than 20 rooms). If you need 20 or more rooms, you can do that now by visiting <A href="http://www.cesweb.org/hotel" target=_blank>www.CESweb.org/hotel</A> to see the full list of CES hotels and rates. Make your reservations early as hotels sell out quickly! </SPAN>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />

<a name="1079"></a>

<div class="sub-content-header">Transportation In and Around Las Vegas</div>
<br />

Wondering how to get around to all the CES venues? Check out <A href="/hotelTravel/default.asp">www.CESweb.org/hotelTravel</A> for the latest on the free CES hotel shuttles, taxi and parking information.
