...
<ul id="sub-faqs" class="subnav" style="display: none;" onmouseout="setMenuTimer()">
    ...
    <ul>
            ...
            <li ><a href="/exhibitors/sponsorships/myCES-ops.asp">MyCES Opportunities</a></li>
...
<div class="page_header_block">
    <div class="blue_box">
        ...
        <li><a href="#693">CES Store Kiosks</a></li><!---->
...
<div class="sponsorshipTitle">CES Store Kiosks:&nbsp;<span class="lt_blue">$5,000</span></div>
<br />The International CES Store kiosks, located throughout the show floor, are the <I>only</I>&nbsp;spots where CES exhibitors can sell products. These stores&nbsp;are a huge draw for attendees who want to bring souvenirs home. Make your logo and product stand out before a tech-savvy audience. <BR><BR>
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
<TBODY>
<TR>
<TD vAlign=top><STRONG>Sponsorship Investment<BR></STRONG>$5,000 <BR><BR><B>Contact</B><BR>Manager, Promotional Opportunities, CES<BR>Phone: 703-907-4324 <BR>E-mail: <A href="mailto:byb@CE.org">byb@CE.org</A></TD>
...
<UL class=text>
<LI class=text>Includes two seven-foot, free-standing sponsor signs at the entrance and inside the reception</LI>
<LI class=text>Product literature distribution in a highly trafficked area </LI>
<LI class=text>Logo recognition in the official CES Directory, on on-site reception signage, on the reception invitation and on CESweb.org </LI>
<LI class=text>Access to the post-show mailing list, through a third party mail house</LI></UL><BR><STRONG>A great thing about this promotional opportunity:<BR></STRONG>Honing in on a select, targeted group of influencers from the market that matters to you most.<BR><BR><B>Sponsorship Investment</B><BR>Call for details&nbsp;<BR><BR><B>Contact</B><BR>Manager, Promotional Opportunities, CES<BR>Phone: 703-907-4324 <BR>E-mail: <A href="mailto:byb@CE.org">byb@CE.org</A>
<br /><img width="1" height="4" src="/images/framework/spacer.gif"/><br /><a class="back_to_top" href="#">[back to top]</a>
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/><br />
        <img height="15" alt="" src="/images/framework/divider-line-long.gif"/><br />
...
<LI class=text>Sponsor's website or International CES booth message as the homepage</STRONG></LI></UL><BR><B>Sponsorship Investment</B><BR>Average fee: $25,000. Pricing varies, per quantities of kiosks placed.<BR>Price includes Internet, electrical, freestanding structures and graphics.<BR><BR><B>Contact</B><BR>Manager, Promotional Opportunities, International CES<BR>Phone: 703-907-4324 <BR>E-mail: <A href="mailto:byb@CE.org">byb@CE.org</A></TD>
<TD width=10>&nbsp;</TD>
...
<br />If global expansion ranks high in your company's goals, then this promotional opportunity is perfect for you. Reach distribution channels from overseas, and target-brand thousands of global visitors and OEM contacts. Sponsor the International Commerce Centers (ICCs) and International Reception to tap consumer technology professionals from approximately 140 countries. <BR><BR>Located in the Las Vegas Convention Center, the Sands Expo and Convention Center, and the Las Vegas Hilton, International Commerce Centers are popular destinations for non-U.S. attendees. Each center includes: 
<UL class=text>
...
<LI class=text>Complimentary refreshments from 2-4 p.m.</LI></UL><BR>This promotional opportunity extends far beyond the walls of the centers and reception room. Get months of exposure when you receive: 
<UL class=text>
...
<LI class=text>Recognition during remarks by CEA at reception</LI></UL><BR><STRONG>A great thing about this promotional opportunity:<BR></STRONG>Reaching CE professionals from approximately 140 countries without leaving the country.<BR><BR>
<TABLE>
<TBODY>
<TR>
...
<br />The extremely popular International Reception, held the first night of the show, averages an attendance of 300 each year. Invitations are e-mailed in advance and&nbsp;are distributed on-site in the International Registration area and the International Commerce Centers.<BR><BR><STRONG>Sponsorship Benefits</STRONG> 
<UL class=text>
<LI class=text>Electronic invitation sent to all pre-registered international attendees (approximately 20,000) with your logo and information included </LI>
<LI class=text>Your company name and logo logo on the invitation for the international reception that is distributed on-site in the International Registration area and the International Commerce Centers</LI>
<LI class=text>Reception sponsor recognition on CESweb.org </LI>
...
<UL class=text>
<LI class=text></STRONG>Recognition in dinner welcome remarks made by Gary Shapiro, president and CEO of CEA</STRONG> </STRONG></STRONG></STRONG></STRONG></STRONG></LI></STRONG>
...
<LI class=text>Opportunity to purchase up to 10 additional dinner tickets at $250 each </LI></UL><BR><STRONG>LIT Dinner Reception - $10,000</STRONG> 
<UL class=text>
...
<LI class=text>Logo placement on cocktail napkins during reception<BR></LI></UL>
<P class=text><STRONG>LIT Dinner Dessert Reception - $5,000</STRONG> </P>
<UL class=text>
<LI class=text>Logo and acknowledgement in the dinner program </LI>
<LI class=text>Logo and acknowledgement on invitation </LI>
<LI class=text>Recognition in dinner welcome remarks made by Gary Shapiro, president and CEO of CEA </LI>
