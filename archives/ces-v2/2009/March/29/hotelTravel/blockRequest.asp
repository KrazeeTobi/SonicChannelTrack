...
function validForm(passedForm)
	{
		...
		if (((radio_value=="LVHilton")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="Mandalay")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="THE")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="Trump")&&(passedForm.number_of_rooms.value < 10)) || ((radio_value=="Renaissance")&&(passedForm.number_of_rooms.value < 10)))
			{
		...
		if (((radio_value!="LVHilton")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="Mandalay")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="THE")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="Trump")&&(passedForm.number_of_rooms.value < 20)) && ((radio_value!="Renaissance")&&(passedForm.number_of_rooms.value < 20)))
			{
...
<tr>
	<td width="33%" valign="top" class="text">
		...
		<input type="radio" name="hotel" value="Fontainebleau">Fontainebleau<br>
	...
	<td width="33%" valign="top" class="text">		
		...
		<!--<input type="radio" name="hotel" value="Westin">Venetian<br>-->
