...
<head><!-- PageID 3379 - published by RedDot 7.5 - 7.5.1.75 - 16244 -->
    <!-- force IE7 compatability mode -->
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />

    <title>2010 CES: October 2009</title>
...
<tr>
    <td bgcolor="#1B3D85" class="columnsubhead"><div align="center">A Message From CES Administration</div></td>
</tr>
<tr>
    <td>
    <p align="center"><img src="/images/content/Allison_Burdine.jpg" alt="Karen Chupka"><br>
    <span class="smallText">
    <strong>Allison Burdine</strong><br>
   Specialist, CES Projects</p>
    <hr align="center" width="90%" size="1" noshade color="#999999">
    <!-- article start -->
    <p><strong>Make the Most of CES with the CES Awards Program</strong><br> 
by Allison Burdine</p>
    <p>We are just 16 weeks away from CES, and the countdown is on. Labor Day generally marks the time when exhibitors like you crank into high gear and focus on figuring out the best way to pull together the best possible exhibit experience.<BR><BR>In this economy, standing out and truly being heard is crucial to succeed and boost sales. Because consumers are spending less and wanting more, every move you make matters. Companies have to strategize to make sure their products are the ones consumers want. Your average shoppers now constantly compare and judge products before they make a final purchase, and they are looking for products that stand out among the rest. <BR><BR>How can CES help in this environment? There are a variety of ways, but now’s the time to consider submitting entries in one of many <A href="/awards/default.asp" target=_blank>awards programs</A> hosted at CES.<BR><BR>Allow industry experts to review, critique, analyze and evaluate your products and projects and put consumers at ease by confirming your products are worthy of their trust and hard-earned income. Whether you are a product designer, engineer or a maverick in the television and advanced media arena, CES has an award to recognize you.<BR><BR>First up: Innovations. Since 1976, the <A href="/awards/innovations/default.asp" target=_blank>CES Innovations Design and Engineering Awards Program</A> recognizes the pinnacle of innovation in the consumer electronics industry. With entrants from 36 different product categories representing the hottest technologies in the CE industry, the CES Innovations Awards have become the hallmark of the best designed products in consumer technology. The 2010 Best of Innovations honorees will be announced at the New York Press Preview on November 10, 2009, at the Metropolitan Pavilion and showcased at the 2010 International CES.<BR><BR>Next, CNET has been an outstanding CEA partner through the years and will continue to produce the <A href="/awards/bestOfCES.asp" target=_blank>Best of CES Awards</A> program for 2010. The CNET Best of CES awards recognize the best new products at CES in nine categories. The competition is judged by CNET’s esteemed editorial team and also includes a Best of Show and People’s Voice award. Product entry review just started, so now’s the time to submit your entry.<BR><BR>The <A href="http://www.ce.org/Events/Awards/113.asp" target=_blank>Mark of Excellence Awards</A> program, presented by CEA's TechHome Division, recognizes the best in home electronics products, services, and installed technology. Each year, manufacturers, distributors, and systems integrators enter to compete in over 34 award categories for this coveted honor judged by independent experts. The Mark of Excellence Awards program culminates with the announcement of the winners at the Mark of Excellence Awards Dinner, held during the EHX (Electronic House Expo) Spring event in Orlando, Florida at the Orange County Convention Center. <A href="http://www.ce.org/Events/Awards/113.asp" target=_blank>Call for entries</A> starts December 7, 2009. Mark your calendar.&nbsp;<BR><BR>Ever dreamed of winning an Emmy? If you’re in the content technology arena, you just may make your dream come true. The National Academy of Television Arts & Sciences now uses CES to host the&nbsp;<A href="/awards/techEmmys.asp" target=_blank>Emmy Awards for outstanding achievement in Engineering and Technical Development</A>. This will be the fourth consecutive year that the awards will be presented during the International CES. This awards program recognizes companies, individuals or scientific/technical organizations for advances in engineering technologies that improve reception, recording or transmission of television programming.&nbsp; The awards are presented during a special ceremony the opening night of the show. This year,&nbsp;&nbsp;the Board of Trustees of the NATAS is proud to honor and recognize the humanitarian efforts of Jerry Lewis who, since 1966, has masterfully used the medium of television during his annual MDA Labor Day Telethon to raise $1 billion for Muscular Dystrophy research and equipment. Jerry will be presented with the Academy’s most prestigious honor at the 61st annual Technology & Engineering Emmy Awards. Visit <A href="http://emmyonline.tv/tech/">http://emmyonline.tv/tech/</A> for more information on the awards. <BR><BR>Awards programs at CES are just one more way help your company stand out at the most important consumer technology event of the year. Mark your calendar for all of these now. They’re among the best press generators and credibility builders around.<BR></p>
    <!-- article end -->
    </span>
    </td>
</tr>
...
<!-- End Slider --><div id="blog-sidebar">
    ...
    <img src="/images/framework/blogFiller.gif"><br/>
                ...
                <div id="main-content-column2">
                    <div id="breadcrumb">
                        <div><a href="/default.asp" class="footer">Home</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/default.asp" class="footer">For Exhibitors</a>&nbsp;&gt;&nbsp;<a href="/exhibitors/newsletter/default.asp" class="footer">Exhibitor's Source Newsletter</a>&nbsp;&gt;&nbsp;October 2009</div>
                    </div>
                    ...
                    <div align="center">
                        ...
                        <div id="standard-nav">
                            <ul>
                                <li>
                                    <img src="/images/framework/standard-arrow.gif" alt="[bullet image]"><a href="#" onclick="window.open('/print/exhibitors/newsletter/oct09.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="footer">PRINT</a></li>
                                <li>
...
<div align="center">
    ...
    [ <a href="/exhibitors/newsletter/oct09ops.asp">Operations</a> ]

    [ <a href="/exhibitors/newsletter/oct09ven.asp">Venetian Corner</a> ]
...
<div class="sub-content-header">Microsoft, Ford, Intel, Nokia and Hisense CEOs to Keynote 2010 CES</div>
<br />

<IMG hspace=10 vspace=10 align=right src="/images/photos/ballmer-1-1.jpg" width=100 height=140>Microsoft's Steve Ballmer, Ford's Alan Mulally, Intel's Paul Otellini, Nokia's Olli-Pekka Kallasvuo and Hisense's Zhou Houjian are preparing to unveil the next generation of technology at the upcoming 2010 International CES.<BR><BR>These exciting keynote speakers are leaders that are changing the way technology is being incorporated into not only everyday life but into new markets and enterprises. Attendees will flock to CES to hear what we can anticipate from the future endeavors from these prominent technology leaders.<BR><BR><A href="/sessions/keynotes.asp">Learn more about the 2010 keynote lineup</A>.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="3395"></a>

<div class="sub-content-header">Enter New CES Video Competition – Get Free Promotion on CESweb.org</div>
<br />

<STRONG><IMG hspace=10 vspace=10 align=right src="/images/photos/clapboard.jpg" width=100 height=96>And ACTION!</STRONG> Enter the "<A href="http://www.cesweb.org/contest" target=_blank>Visit Me at CES" 2010 Exhibitor Video Contest</A>, powered by Votigo, to win a month's worth of free exposure on CESweb.org. You know why CES is among the most important things you do for your business each year. Now tell everyone else about it and reap the rewards. <BR><BR><STRONG>Here's how</STRONG>: Create a short clip that explains why your company is at CES and why attendees should visit your booth. Your video must be one minute or less and include your booth number. Help us generate momentum while creating buzz for your own exhibit.<BR><BR>Five winners will be selected through voting by the general public. We’ll be promoting this competition to attendees via our attendee newsletter, <EM>CES Up to the Minute</EM>, <A href="http://www.cesweb.org/" target=_blank>CESweb.org</A> and various social media outlets. You can also get more votes by getting your staff involved and sending out info to your clients and contacts. The more participation, the merrier!<BR><BR><A href="http://www.cesweb.org/contest" target=_blank>Enter your video today</A>! The deadline for video submission is November 10.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="3391"></a>

<div class="sub-content-header">Exhibitor Invitations are Now Available - Get Your Best Customers to CES</div>
<br />

<IMG height=188 hspace=5 src="/images/photos/2010_Exhibitor_Invitation_72dpi.jpg" width=250 align=right vspace=5>CES offers <A href="http://www.cesweb.org/exhibitors/sponsorships/freeOpps.asp#1925">exhibitor invitations</A> for you to send to your most important guests. This inexpensive, effective marketing tool allows your guests FREE advance registration to the International CES up until December 15, 2009. Or if they register on-site, they will save $100 on the $200 on-site registration fee.<BR><BR>You can either <A href="http://www.cesweb.org/exhibitors/sponsorships/freeOpps.asp#1925">download an electronic PDF version</A> of the invitations to send to your contacts via e-mail or order up to 1,000 printed invitations and we'll cover the print and production costs. Visit <A href="http://CESinvites.hbp.com" target=_blank>http://CESinvites.hbp.com</A> for details and more information on how to personalize and mail your invitations. <BR><BR>Questions? Contact <A href="mailto:Invitations@CE.org">Invitations@CE.org</A> for more information. Don't miss this opportunity to invite your best customers to the 2010 International CES.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="3390"></a>

<div class="sub-content-header">Last Chance to Complete Your Exhibitor Directory Listing</div>
<br />

<IMG hspace=5 vspace=5 align=right src="/images/photos/Directory.jpg" width=150 height=195>The deadline for your listing in the print <EM>Official International CES Show Directory</EM> is October 16, 2009.<BR><BR>Attendees are already searching the 2010 International CES online exhibitor directory, powered by MyCES. Will they find you? Complete your listing today. For assistance with your directory listing, e-mail <A href="mailto:Support@BDMetrics.com">Support@BDMetrics.com</A> or call 800-931-5103 and select option 1. <BR><BR>Once you have completed your directory listing, upgrade your free listing on the MyCES portal to a comprehensive microsite featuring your products, news and more. <BR><BR>Contact Ed Gorey at <A href="mailto:ed.gorey@bdmetrics.com">ed.gorey@bdmetrics.com</A> for assistance with CES exhibitor microsite.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="3389"></a>

<div class="sub-content-header">Register Today for the Free 2010 Exhibitor Workshop Webcast Series</div>
<br />

<STRONG>Tips, Tricks and Savings to Maximize Your Tradeshow Experience<IMG height=109 hspace=10 src="/images/photos/laptop.jpg" width=125 align=right vspace=10></STRONG><BR><BR>It's not too late to participate in the <A href="/exhibitors/resources/workshop.asp">2010 CES Exhibitor Workshop</A>! Register today for any one of the two remaining webcasts and gain access to the workshop community site to retrieve archives of past presentations. Learn marketing and PR tips, discover promotional opportunities, receive help planning your exhibiting logistics, hear from CES experts and receive discounts from vendors. The workshop also offers a forum for you to pose all your questions to our GES Panel and CES team members. <BR><BR><STRONG>CES Exhibiting - The Insight Edition<BR></STRONG>2 p.m. EST October 22, 2009<BR>Our general show contractor GES will steer you through the maze of rules and regulations and outline exactly what you need to know to plan for a successful exhibit experience and save money! <BR><A href="http://www.cesweb.org/exhibitors/resources/workshop/rd_registration.asp" target=_blank>Register</A><BR><BR><STRONG>What I Wish I Knew – CES Exhibitor Expert Panel</STRONG><BR>2 p.m. EST October 28, 2009<BR>A group of seasoned CES exhibitors discuss best practices for success at the 2010 International CES. <BR><A href="http://www.cesweb.org/exhibitors/resources/workshop/rd_registration.asp" target=_blank>Register</A> <BR><BR>For more information about the workshop, contact Michelle Griffin at <A href="mailto:mgriffin@CE.org">mgriffin@CE.org</A>.
        <br /><img width="1" height="20" src="/images/framework/spacer.gif"/>
        <img height="15" alt="" src="/images/framework/divider-line.gif"/><br />

<a name="3388"></a>

<div class="sub-content-header">Exhibiting at Both the International CES and Greener Gadgets in 2010? Maybe You Should.</div>
<br />

<A href="/exhibits/displays/sustaintablePlanet.asp"><IMG height=93 hspace=5 src="/images/content/SustainablePlanet_noshadow.jpg" width=220 align=right border=0></A>We’re offering an easy, cost-effective way to get your booth and exhibit material directly from Las Vegas to New York.<BR><BR>Learn more about exhibiting opportunities for <A href="/exhibits/displays/sustaintablePlanet.asp">Sustainable Planet</A> and <A href="http://www.greenergadgets.com/" target=_blank>Greener Gadgets</A>. <BR><BR>GES Exposition Services will pick up your crated freight and boxes from CES, store them at their warehouse in Las Vegas and then transport them to Greener Gadgets in New York in February.<BR><BR><STRONG><A href="http://www.greenergadgets.com/" target=_blank><IMG height=81 hspace=5 src="/images/content/Greener-Gadgets_logo_green.jpg" width=217 align=right border=0></A>Rates:</STRONG><BR>51 to 499 lbs: $561.38<BR>500 to 1000 lbs.: $987.50<BR>1001 to 1500 lbs.: $1,481.25<BR>1501 to 1999 lbs.: $1,974.01<BR><BR>Small packages under 50 lbs – 1st package: $81.25, additional packages: $50 each<BR><BR>Material handling rates will still apply once your shipment has arrived at Greener Gadgets. Rates are $117.06 per 100 lbs. with a 200 lb. minimum per shipment. Small packages are $45 for the first and $22 for additional.<BR><BR>Contact Imelda Trevino, GES account manager, for further information or to arrange for service at <A href="mailto:itrevino@GES.com">itrevino@GES.com</A>.
...
by Allison Burdine</p>
    ...
    <div>
        ...
        <ul>
            <li><a href="http://cesweb.org/register">Free registration ends Oct. 7</li>
