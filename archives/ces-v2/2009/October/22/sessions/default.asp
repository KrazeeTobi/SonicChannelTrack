...
<A href="http://digital.virtualmarketingpartners.com/vmp/cea/conference-brochure-09/index.php" target=_blank></A>Each year at&nbsp;the International CES, you have the opportunity to fill your schedule with the knowledge you need to succeed in the consumer electronics industry. <BR><BR>
...
<TR>
<TD>
<H3>Best Value: Ultimate and All-Access Passes</H3><STRONG>All Access Pass - $849 advance/$949 on-site</STRONG><BR>Includes all CES Knowledge Track sessions as well as the following Partner Programs: Digital Hollywood, Cable Conference at CES, CES Game Power, CES Mobile Entertainment, CES Reinventing Advertising, CONNECTIONS™ SUMMIT, Consumer Electronics Supply Chain Academy, Digital Health Summit, Entertainment Technology@CES, HigherEd TECH, HD Voice Summit at the 2010 <A>CES</A>, Kids@Play, Mommy Tech, MPEGIF Master Class: TV X.0 - Present & Future, P2P MEDIA SUMMIT at CES, Silvers Summit, Social Media Jungle@2010 CES, Storage Solutions: Flash Memory in Consumer Products, Tech Policy Summit and Technology and Emerging Countries. <BR><BR><STRONG>Ultimate Pass - $549 advance/$849 on-site</STRONG><BR>Includes all CES Knowledge Track sessions and all of the following Partner Programs: Digital Hollywood, Cable Conference at CES, CES Game Power, CES Mobile Entertainment and CES Reinventing Advertising. <BR><BR>If you've already registered for CES: <A href="/register">Login with your registration credentials</A>, and pick the sessions you want to attend.<BR><BR>If you haven't registered yet: <A href="/register">Register now</A>, and start picking your sessions.</TD></TR></TBODY></TABLE><BR>
<H3><A href="/sessions/keynotes.asp">Keynotes</A></H3>Ford, Nokia, Hisense, Intel and Microsoft will join the 2010 CES keynote stage. <BR><BR>
<H3><A href="/sessions/SuperSessions.asp">SuperSessions</A></H3>Rise above the clutter and take away the real deal on the subjects that matter most.&nbsp;Get unbelievable amounts of thought-provoking information and insight into an-easy-to-digest format. And do it all for free in these sessions.<BR><BR>
<H3><A href="/sessions/KnowledgeTracks.asp">CES Knowledge Tracks</A></H3>Knowledge Tracks cover every aspect of the highly competitive, multibillion-dollar CE industry, and put you on the inside track to everything new. <BR><BR>
<H3><A href="/sessions/PartnerPrograms.asp">CES Partner Programs</A></H3>Several industry-leading partners engage and educate to prepare you and your business for ground-breaking advances in consumer electronics.<BR><BR>
<H3><A href="/sessions/speakers/speakerServices.asp">Speaker Services</A></H3>Official International CES speakers receive automatic registration, access to Internet-enabled computers and the opportunity to help shape the consumer technology industry. <BR><BR>
<H3><A href="/sessions/speakers/default.asp">Call for Speakers</A></H3>The Call for Speakers has officially closed. Sign up to be put on a back-up list for reference in case of speaker cancellations.<BR><BR>
<TABLE cellSpacing=1 cellPadding=1 width="100%" border=0>
<TBODY>
<TR>
<TD width="32%"><IMG src="/images/photos/ballmer_shapiro_stage.jpg"></TD>
<TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
<TD width="32%"><IMG src="/images/photos/Ford_mulally_stage.jpg"></TD>
<TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
<TD width="32%"><IMG src="/images/photos/counting_crows_intel_stage_190.jpg"></TD></TR>
<TR>
<TD vAlign=top><SPAN class=smallText>CEA President and CEO Gary Shapiro gives the stage to Microsoft CEO Steve Ballmer&nbsp;at the&nbsp;2009 show. </SPAN></TD>
<TD>&nbsp;</TD>
<TD vAlign=top><SPAN class=smallText>Alan Mulally of Ford delivers a keynote address in Las Vegas, Nev., this past January.</SPAN></TD>
<TD>&nbsp;</TD>
<TD vAlign=top><SPAN class=smallText>Intel Chairman Craig Barrett welcomes Counting Crows front man Adam Duritz to the stage during a 2009 CES keynote address. <BR></SPAN></TD></TR></TBODY></TABLE>

    
                    
                         <br /><br /><br />
                         <img align="middle" src="/images/framework/printThis.gif">&nbsp;<a href="#" onclick="window.open('/print/sessions/default.asp?', '_blank', 'status=yes,toolbar=yes,menubar=yes,scrollbars=yes,location=no,width=1024');return false;" class="printEmail">PRINT THIS</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="middle" src="/images/framework/emailThis.gif">&nbsp;<a href="javascript:openNew('/utilities/emailPage.asp');" class="printEmail">E-MAIL THIS</a>
