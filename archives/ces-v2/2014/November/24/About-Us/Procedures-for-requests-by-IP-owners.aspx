...
<head id="head"><title>
	Procedures for Requests by IP Owners to Visit 2014 CES&#174; Exhibit Booths - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/About-Us/Procedures-for-requests-by-IP-owners" />
<meta property="og:title" content="Procedures for Requests by IP Owners to Visit 2014 CES® Exhibit Booths" />
...
<meta name="twitter:title" content="Procedures for Requests by IP Owners to Visit 2014 CES® Exhibit Booths">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/About-Us/Procedures-for-requests-by-IP-owners.aspx" id="form">
...
<section>
        ...
        <div class="container clearfix above">
            ...
            <div class="three-fourth">
                <div class="body-content">
                    <h1>Procedures for Requests by IP Owners to Visit 2014 CES® Exhibit Booths</h1>

                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                                <a id="p_lt_ctl06_pageplaceholder_p_lt_hypBChome" href="../">Home</a></li>
                             <li class="bread-div">|</li><li><a href="/About-Us.aspx" class="CMSBreadCrumbsLink">About Us</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">Procedures for Requests by IP Owners to Visit 2014 CES® Exhibit Booths</span>
</li>
                    ...
                    <div class="article-content-area">
                       ...
                       <p>
	<strong>A.&nbsp;&nbsp;&nbsp;&nbsp; </strong><strong><u>IP Owners&#39; Requests and Notification of Exhibitors </u></strong><br />
	...
	&nbsp;<br />
	IP Owners or their representatives (&quot;IP Owners&quot;) should contact CEA Legal to request a time slot to visit CES exhibit booths. IP Owners should provide CEA Legal with a list of the booths they intend to visit and the products on display that they believe infringe their IP.<br />
	&nbsp;<br />
	IP Owners must communicate in writing, by letter, email and/or fax, with the individual responsible for exhibit coordination and, if possible, with the exhibitor&#39;s legal department to inform them that:<br />
	&nbsp;<br />
	&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The IP Owner has reason to believe that the exhibitor will display infringing products at the exhibit booth;<br />
	&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The IP Owner plans to visit the exhibitor&rsquo;s booth;<br />
	&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; If the IP Owner finds infringing products at the booth, the exhibitor will be asked to remove the infringing products from display;<br />
	&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; If the exhibitor refuses to remove the infringing products, the IP Owner may seek a court order to have the products removed from display.<br />
	&nbsp;<br />
	CEA Legal must receive copies of all such communications before the IP Owner&rsquo;s request will be approved.<br />
	&nbsp;<br />
	<strong>B.&nbsp;&nbsp;&nbsp;&nbsp; </strong><strong><u>Appointments </u></strong><br />
	Appointments can be scheduled with CEA Legal by emailing CEALegalServices@ce.org.<br />
	&nbsp;<br />
	CEA will provide email confirmation to the IP Owner of the date and time of the appointment, including the names and locations of the exhibit booths to be visited. IP Owners must adhere to the appointment schedules. IP Owners who do not appear within five minutes of their scheduled appointments will be presumed to have cancelled the appointment.<br />
	&nbsp;<br />
	IP Owners are responsible for obtaining and paying for any translation services needed for the appointment.<br />
	&nbsp;<br />
	<strong>C.&nbsp;&nbsp;&nbsp;&nbsp; </strong><strong><u>Rules for Visiting Exhibits </u></strong><br />
	Oral communications between the exhibitor and the IP Owner must take place in the presence of an authorized CEA representative.<br />
	&nbsp;<br />
	To ensure that the visits are conducted in an appropriate manner, the following rules will be observed:<br />
	&nbsp;<br />
	&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; IP Owners and exhibitors must be civil and courteous. Loud, offensive or embarrassing confrontations are not permitted. Exhibitors may not be verbally or physically threatened or abused.<br />
	&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; The IP Owner can advise an exhibitor that if the exhibitor refuses to remove infringing products, the IP Owner may seek a court injunction against the exhibitor. However, an IP Owner may not remove or attempt to remove the infringing products from the exhibit booth.<br />
	&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; IP Owners are strongly encouraged to limit the size of the groups visiting exhibit booths to no more than two company representatives, one translator, if applicable, and one attorney.<br />
	&middot;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; If possible, IP Owners should bring with them a list of all of their approved licensees.<br />
	&nbsp;<br />
	<strong>D. <u>Violations </u></strong><br />
	Violations of these procedures can result in the immediate suspension or cancellation of a scheduled appointment and the revocation of an IP Owner&#39;s permission to be present on the CES floor.</p>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJODc3OTc4NjAwD2QWAgIBEGRkFgICBQ9kFgJmD2QWAmYPZBYCAg0PZBYCZg9kFgICAg9kFgJmD2QWAmYPZBYCAgMPZBYCZg8PFgIeB1Zpc2libGVoZGRk49KrVfR1lvk9yAOSpt0IU1G0+XlN7Oets4zRHNNtoyU=" />
    <script type="text/javascript"> 
      //<![CDATA[
