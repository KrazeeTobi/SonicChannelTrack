...
<meta property="og:url" content="http://www.cesweb.org/Exhibitor/Show-Planning/Exhibitor-Manuals/Sands-Venetian-Exhibitor-Manuals/Venetian-Sands-Target-Freight-Floor-Plans" />
<meta property="og:title" content="Sands and Venetian Target Freight Floorplans" />
...
<meta name="twitter:title" content="Sands and Venetian Target Freight Floorplans">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Exhibitor/Show-Planning/Exhibitor-Manuals/Sands-Venetian-Exhibitor-Manuals/Venetian-Sands-Target-Freight-Floor-Plans.aspx" id="form">
        ...
        <div class="container clearfix above">
            ...
            <div class="three-fourth">
                <div class="body-content">
                    <h1>Sands and Venetian Target Freight Floorplans</h1>

                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                                <a id="p_lt_ctl06_pageplaceholder_p_lt_hypBChome" href="../../../../">Home</a></li>
                             <li class="bread-div">|</li><li><a href="/Exhibitors.aspx" class="CMSBreadCrumbsLink">Exhibitors</a> </li><li class="bread-div">|</li><li> <a href="/Exhibitor/Show-Planning.aspx" class="CMSBreadCrumbsLink">Show Planning</a> </li><li class="bread-div">|</li><li> <a href="/Exhibitors/Show-Planning/Exhibitor-Manuals.aspx" class="CMSBreadCrumbsLink">Exhibitor Manuals</a> </li><li class="bread-div">|</li><li> <a href="/Exhibitors/Show-Planning/Exhibitor-Manuals/Sands-and-Venetian-Exhibitor-Manuals.aspx" class="CMSBreadCrumbsLink">Sands and Venetian Exhibitor Manuals</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">Sands and Venetian Target Freight Floorplans</span>
</li>
                    ...
                    <div class="article-content-area">
                       ...
                       <p>
	CES operates on a targeted freight move-in and move-out system. Exhibitors are assigned a specific date and time for their freight to arrive and to be removed from the exhibit hall. This process allows for a smooth move-in for all exhibitors and ensures the show will be set up in time for show opening.<br />
	<br />
	These floorplans detail your specific freight move-in and move-out times. Missing target times during move-in or move-out will delay your set up and may result in additional charges.<br />
	<br />
	Read the following information carefully, and if you have any questions, contact Freeman at&nbsp;<a href="mailto:CESfreight@freemanco.com">CESfreight@freemanco.com</a>&nbsp;or 702-579-1705.<br />
	<br />
	<br />
	<a href="http://ces.experiencefreeman.com/2015-Floorplans/Move-In/2015_INTL_CES_SANDS_HallsA-C_Target_Move-In.pdf" target="_blank">Sands Move-In</a><br />
	<a href="http://ces.experiencefreeman.com/2015-Floorplans/Move-Out/2015_INTL_CES_SANDS_HallsA-C_Target_Move-Out.pdf" target="_blank">Sands Move-Out</a><br />
	<br />
	<a href="http://ces.experiencefreeman.com/2015-Floorplans/Move-In/2015_INTL_CES_VENETIAN_MeetingRoomsLevel2_Target_Move-In.pdf" target="_blank">Venetian, Level 2, Meeting Rooms Move-In</a><br />
	<a href="http://ces.experiencefreeman.com/2015-Floorplans/Move-Out/2015_INTL_CES_VENETIAN_MeetingRoomsLevel2_Target_Move-Out.pdf" target="_blank">Venetian, Level 2, Meeting Rooms Move-Out</a><br />
	<br />
	<a href="http://ces.experiencefreeman.com/2015-Floorplans/Move-In/2015_INTL_CES_VENETIAN_MeetingRoomsLevel3_Target_Move-In.pdf" target="_blank">Venetian, Level 3, Meeting Rooms Move-In</a><br />
	<a href="http://ces.experiencefreeman.com/2015-Floorplans/Move-Out/2015_INTL_CES_VENETIAN_MeetingRoomsLevel3_Target_Move-Out.pdf" target="_blank">Venetian, Level 3, Meeting Rooms Move-Out</a><br />
	<br />
	<br />
	Exhibiting in multiple venues? View the target freight floorplans for:<br />
	<a href="/Exhibitor/Show-Planning/Exhibitor-Manuals/LVCC-Exhibitor-Manuals/LVCC-Target-Freight-Floor-Plans.aspx">Las Vegas Convention and World Trade Center (LVCC)</a><br />
	<a href="/Exhibitor/Show-Planning/Exhibitor-Manuals/LVH-and-Renaissance-Exhibitor-Manuals/LVH-and-Renaissance-Target-Freight-Floor-Plans.aspx">LVH</a><br />
	&nbsp;</p>
<br />
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJODc3OTc4NjAwD2QWAgIBEGRkFgICBQ9kFgJmD2QWAmYPZBYCAg0PZBYCZg9kFgICAg9kFgJmD2QWAmYPZBYCAgMPZBYCZg8PFgIeCEJhbm5lcklEAq8BZGRkAWCsT1W+5uvlgnq3BqvxkOsfUMbNkiT5Lyv50lTjF+4=" />
    <script type="text/javascript"> 
      //<![CDATA[
