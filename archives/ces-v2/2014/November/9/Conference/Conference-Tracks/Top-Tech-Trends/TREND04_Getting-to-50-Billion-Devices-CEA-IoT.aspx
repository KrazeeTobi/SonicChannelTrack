...
<head id="head"><title>
	TREND04_Getting to 50 Billion Devices: CEA &amp; IoT - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Top-Tech-Trends/TREND04_Getting-to-50-Billion-Devices-CEA-IoT" />
...
<div>
    ...
    <div class="paragraphText">The world is running out of the existing stock of 4.3 billion IPv4 addresses. Learn from industry experts how to build future proof IPv6 devices and what&rsquo;s behind CEA&rsquo;s new standard, Host and Router Profiles for IPv6.</div>
  </div>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
    <script type="text/javascript"> 
      //<![CDATA[
