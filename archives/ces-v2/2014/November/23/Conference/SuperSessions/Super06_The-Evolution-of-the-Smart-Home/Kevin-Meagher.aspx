...
<head id="head"><title>
	Kevin Meagher - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/SuperSessions/Super06_The-Evolution-of-the-Smart-Home/Kevin-Meagher" />
<meta property="og:title" content="Kevin Meagher" />
...
<meta name="twitter:title" content="Kevin Meagher">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/SuperSessions/Super06_The-Evolution-of-the-Smart-Home/Kevin-Meagher.aspx" id="form">
...
<h2>Kevin Meagher</h2>
<h3>VP and General Manager Smart Home<br />Lowe's Home Improvement</h3>
<div style="float: left;">
  <img src="" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Kevin Meagher">
</div>
<div style="margin: 10px;">
  <b>Kevin Meagher<br>Vice President and General Manager, Smart Home</b><br><br>Kevin Meagher was named vice president and general manager, smart home in 2011.<br><br>Meagher leads the company’s smart home initiative, including the development of Iris, Lowe’s exclusive Cloud platform designed to monitor and control virtually everything in the home from a computer or smart phone.<br><br>Prior to Lowe’s, Meagher founded Intamac Systems, a UK company focused on Cloud platforms that deliver new, value-added services to the mass consumer market through telecommunications companies and utilities.&nbsp; Following Intamac, he was a consultant specializing in the Internet of Things.<br><br>Meagher has been recognized as one of the global pioneers of the smart home. He has lectured on business management and published papers at national and international conferences. Additionally, he is the recipient of numerous awards including Ruban d’Honneur as European Entrepreneur of the Year, and his company won the European Best Business Innovation Award. He has also served as a Group Captain in the Royal Air Force.<br><br>Meagher is a Chartered Engineer in Aeronautics and holds an MBA from the Open University. <br>
</div>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJODc3OTc4NjAwD2QWAgIBEGRkFgICBQ9kFgJmD2QWAmYPZBYCAg0PZBYCZg9kFgICAg9kFgJmD2QWAmYPZBYEAgMPZBYCZg8PFgIeCEJhbm5lcklEAgpkZAIPD2QWAmYPDxYCHgdWaXNpYmxlaGRkZJVuzRahVNkXhb4526D8XInG5FxK4AmfW0x+JyS/vUAA" />
    <script type="text/javascript"> 
      //<![CDATA[
