...
<section>
        ...
        <div class="container clearfix above">
            <div class="one-sixth-leftnav">
                <div class="leftnav">
                    <ul><li class="left-current"><a href="/International/Travel-Visas">旅行とビザ情報</a><ul></ul><li><a href="/International/Hotel-Reservations">ホテル予約</a><li><a href="/International/Delegation-Group-Program">代表団プログラム</a><li><a href="/International/International-Services">国際サービス</a><li><a href="/International/Shuttle-Service">シャトルサービス</a></ul>
...
<h2>CES参加に向けて海外から米国に入国される方のために、</h2>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
    <script type="text/javascript"> 
      //<![CDATA[
