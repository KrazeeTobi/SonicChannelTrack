...
<head id="head"><title>
	TREND12_Streaming Music Wars: Will there be a Winner? - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Top-Tech-Trends/TREND12_Streaming-Music-Wars-Will-there-be-a-Winne" />
...
<div>
    ...
    <div class="paragraphText">Streaming music services are becoming more popular with new offerings from YouTube and Amazon in 2014<em>. </em>Are there enough consumers to make this a viable category for multiple players? Will this result in better user experiences and lower prices? </div>
  </div>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
    <script type="text/javascript"> 
      //<![CDATA[
