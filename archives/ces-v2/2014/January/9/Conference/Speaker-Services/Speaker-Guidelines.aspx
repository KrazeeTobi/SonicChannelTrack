...
<head id="head"><title>
	Speaker Guidelines - 2014 International CES, January 7-10
...
<ul>
	...
	<li>
		Press and analysts are admitted to conference sessions free of charge.&nbsp;There are no specific press services offered for speakers.&nbsp;If your company is exhibiting at CES, we do have&nbsp;<a href="http://staging.ces.org/Exhibitor/Media-and-PR-Opportunities/PR-Resources.aspx">public relations resources</a>&nbsp;available.&nbsp;</li>
	<li>
		If selected to speak at CES, your session title and bio will&nbsp;be&nbsp;<a href="http://staging.ces.org/Conference/Session-Schedule-Brochure.aspx">promoted&nbsp;</a>on CESweb.org.</li>
	<li>
		All&nbsp;conference session times and locations&nbsp;are listed online in the&nbsp;<a href="http://staging.ces.org/Conference/Session-Schedule-Brochure.aspx">Session Schedule</a>. Please note that the schedule is subject to change. Speakers should coordinate rehearsals and arrival times with their session moderators.</li>
	<li>
		Handouts can be uploaded to the official&nbsp;<a href="http://staging.ces.org/Show-Floor/CES-Mobile-App.aspx">International CES mobile app</a>.&nbsp;Contact&nbsp;<a href="mailto:nnguyen@ce.org">Nhu Nguyen</a>&nbsp;for more details.</li>
	<li>
		Promotional materials may not be distributed in session rooms. This is a privilege offered to paying sponsors only. Get more information on these&nbsp;<a href="http://staging.ces.org/Exhibitor/Branding-Opportunities/Sponsorships.aspx">sponsorship opportunities</a>.</li>
	<li>
