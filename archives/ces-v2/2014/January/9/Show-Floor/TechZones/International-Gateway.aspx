...
<head id="head"><title>
	International Gateway - 2014 International CES, January 7-10
...
<meta name="twitter:title" content="International Gateway">
        ...
        <div class="container clearfix above">
            ...
            <div class="three-fourth">
                <div class="body-content">
                    <h1>International Gateway</h1>

                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                                <a id="p_lt_ctl06_pageplaceholder_p_lt_hypBChome" href="../../">Home</a></li>
                             <li class="bread-div">|</li><li><a href="/Show-Floor.aspx" class="CMSBreadCrumbsLink">Show Floor</a> </li><li class="bread-div">|</li><li> <a href="/Show-Floor/TechZones.aspx" class="CMSBreadCrumbsLink">TechZones</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">International Gateway</span>
</li>
                    ...
                    <div class="article-content-area">
                       ...
                       <div class="feature-float-right"><img src="/CES/media/2014/landing%20pages/show%20floor/techzones/CES-243_CES-International-Gateway.jpg?width=150&height=85&ext=.jpg" ></div>
<h2>The Venetian, Level 2, Venetian Ballroom and Hall D</h2>
<p class="intro">Expand your global network by visiting the International Gateway. The International Gateway features more than 800 exhibitors showcasing the latest innovative technologies and products from around the world.<br />
<br />
<a href="http://ces14.mapyourshow.com/exhibitor_results.cfm?type=pavilion&amp;pavilion=International+Gateway" target="_blank">View the list of exhibitors</a></p>  
