...
<head id="head"><title>
	처음 참가자들을 위한 유용한 정보 - 2014 International CES, January 7-10
...
<meta name="twitter:title" content="처음 참가자들을 위한 유용한 정보">
...
<body class="LTR KOKR ContentBody" >
    <form method="post" action="/Register-Plan/처음-참가자들을-위한-유용한-정보.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
                    ...
                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                             ...
                             <li class="bread-div">|</li><li><a href="/Register-Plan.aspx" class="CMSBreadCrumbsLink">Register & Plan</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">처음 참가자들을 위한 유용한 정보</span>
</li>
...
<p class="intro">매년, 전세계 첨단 기술 혁신가들을 한 곳으로 집합시키는 큰 이벤트가 있습니다. 그리고 그 이벤트가 개최되는 나흘 동안, 라스베이거스의 분위기는 한층 더 고조되고 빛납니다. 귀하가 최초의 CES 참가를 성공적으로 계획하실 수 있도록 ≪처음 참가자들을 위한 유용한 정보≫를 종합하여 제공해 드립니다.<br />
<div>
	<div>
...
<p>
	<br />
	<strong>CES 공식 장소</strong></p>
<ul>
	<li>
		<p>
			라스베이거스 컨벤션 및 월드 트레이드 센터(LVCC)/ LVH</p>
	</li>
	<li>
		<p>
			베네시안 호텔(The Venetian)</p>
	</li>
</ul>
<p>
	<strong>호텔과 여행</strong><br />
	<a href="/Register-Plan/Hotel.aspx">CES 공식 호텔</a>에 머물면서 비용을 절약하십시오. 그리고 호텔과 공식 장소를 오가는 무료 <a href="/Register-Plan/Transportation/Shuttle-Service.aspx">CES 셔틀 서비스</a>도 받으십시오.<br />
	<br />
	<strong>계획 및 관람</strong><br />
	출발하기 전에: <a href="/Show-Floor/MyCES-Planner.aspx">MyCES 계정을 개설</a>하여 귀하의 CES 참관을 계획하고 준비하십시오. 귀하가 관심을 가지는 전람업체를 파악하고 여러 회의 세션과 약속 일정을 귀하의 달력에서 관리하실 수 있습니다.<br />
	<br />
	현장에서 사용: <a href="/Show-Floor/CES-Mobile-App.aspx">CES 공식 모바일 앱</a>을 이용하여 귀하의 MyCES 계정을 동시 조정하여 현장에서 사용하십시오. 그러면 박람회 개최 전에 계획했던 모든 내용에 접속할 수 있을뿐만 아니라 중요한 전람 주의 소식, 최신 CES 뉴스, 그리고 실시간 대화식 전람 회장 지도를 받을 수 있게 됩니다.<br />
	<br />
	<strong>소셜 네트워킹</strong><br />
	인터내셔널 CES는 단순한 나흘간의 이벤트가 아닙니다. 이 박람회는 연중 계속되는 네트워킹 행사입니다!<br />
	<br />
	유명 인사 목격담, 상품 출시, 그리고 귀하가 꼭 가봐야 할 곳이 어딘지 알려 주는 내부 정보를 포함한 소식을 실시간으로 보십시오. 그런 다음 귀하의 탁월한 식견을 제공하십시오. 예를 들면 &ldquo;저기 회장에 있는 멋진 상품은 무엇인가요?&rdquo; &ldquo;기조연설에 대해 어떻게 생각하십니까?&rdquo; 등등. 참가자, 전람업체, 그리고 CEA 스태프와 대화를 나누십시오. 아래 <a href="/News/CES-Social.aspx">소셜 네트워크에서 CES</a>를 찾아보십시오.<br />
	<br />
	<strong>전람 회장 인터내셔널 서비스</strong><br />
	통역사, 특별 네트워킹 리셉션, 작업 전용 구역, 회의실, 그리고 기타 편의 시설은 <a href="/International.aspx">국제 참가자에게 제공되는 혜택 </a>중 일부입니다.<br />
	<br />
	<strong>전람 회장</strong></p>
<ul>
	<li>
		<a href="/Show-Floor/Maps.aspx">CES 공식 장소</a> &ndash; 190만 평방 피트에 달하는 공간에 걸쳐서 전시되는 첨단 기술을 LVCC, LVH 그리고 The Venetian에서 생생히 목격할 수 있습니다.</li>
</ul>
<ul>
	<li>
		<a href="/Show-Floor/TechZones.aspx">TechZone</a> &ndash; 각각 유일한 주제를 지닌 20여 개의 TechZone에서는 신기술 마켓을 배열하고 곧 출시될 제품, 서비스, 그리고 업계 회사 등을 소개합니다.</li>
</ul>
<p>
	<strong>이벤트와 시상식</strong><br />
	CES와 유명 파트너 업체 및 기관은 시상식 프로그램, 고무적인 기조연설, 그리고 특별 이벤트 등을 개최하여 업계 리더, 획기적인 상품과 기술을 표창합니다. 2014년 CES에 어떤 <a href="/Conference/Keynote-Addresses.aspx">기조연설</a>, <a href="/Events-Awards/Awards.aspx">시상식</a>, <a href="/Events-Awards/Events.aspx">그리고 이벤트</a>가 있을지 계속해서 주목해 주십시오.<br />
	<br />
	<strong>컨퍼런스 프로그램</strong><br />
	<a href="/Conference.aspx">인터내셔널 CES 컨퍼런스 프로그램</a>은 소비자 전자제품(CE) 산업의 모든 획기적이고 마켓 선도적이며 선구적인 제품 및 기술을 총 망라합니다. 10월 1일부터 모든 일정을 검색하고 2014년도 SuperSession 모음을 보고, 컨퍼런스 출입증을 구입할 수 있습니다. 그런 다음 귀하의 지식과 영감을 무한히 늘릴 준비를 하십시오.<br />
	<br />
	<strong>라스베이거스 처음 방문자</strong><br />
	라스베이거스 현지 주민이 제공하는 가장 정확하고 유용한 정보를 찾아보십시오. 여기 <a href="http://VisitLasVegas.com">VisitLasVegas.com</a>에 접속하는 링크가 있습니다. 이는 라스베이거스 관광청(Las Vegas Convention and Visitors Authority, LVCVA)에서 준비한 관광객 대상 웹사이트입니다. LVCVA는 라스베이거스와 인근 클라크 카운티 지역을 대표하는 공식 마케팅 기관입니다.</p>
<br />
