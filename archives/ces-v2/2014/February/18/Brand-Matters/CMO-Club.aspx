...
<head id="head"><title>
	CMO Club - 2015 International CES, January 6-9
...
<meta name="twitter:title" content="CMO Club">
...
<section>
        ...
        <div class="container clearfix above">
            <div class="one-sixth-leftnav">
                <div class="leftnav">
                    <ul><li><a href="/Brand-Matters/About-Brand-Matters">About Brand Matters</a><li class="left-current"><a href="/Brand-Matters/CMO-Club">CMO Club</a><ul></ul><li><a href="/Brand-Matters/Program-Calendar">Program Calendar</a><li><a href="/Brand-Matters/Sponsors">Sponsors</a><li><a href="/Brand-Matters/Register-Now">Register Now</a></ul>
                    ...
                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                             ...
                             <li class="bread-div">|</li><li><a href="/Brand-Matters.aspx" class="CMSBreadCrumbsLink">Brand Matters</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">CMO Club</span>
</li>
...
<p class="intro"><img alt="" src="/getmedia/44dc4d91-2873-4b26-9a08-d8eb51fca80c/Brand-Matters-logo_ML-Adobe_sized-for-web.aspx?width=200&amp;height=112" style="width: 200px; height: 112px;" /><br />
<br />
The CMO Club is an exclusive, invitation-only VIP program open to a select list of marketing and advertising executives. Participants in the CMO Club at CES&nbsp;experience the most influential technology&nbsp;show in the world from a unique executive level perspective.</p>  

<img alt="" height="199" src="/CES/media/2014/landing%20pages/brand%20matters/IWP_5287.JPG" style="margin: 10px; width: 175px; height: 119px; float: right;" width="300" />
<h3>
 CMO Club benefits include:</h3>
<ul>
 <li>
  Free access to the CES show floor.</li>
 <li>
  Access to the CMO Club lounge on the show floor <em>(located just inside the N4 entrance of the LVCC, North Hall Lobby).</em></li>
 <li>
  Meeting room in the lounge, reserved on a first-come, first-served basis.</li>
 <li>
  Customized, guided tours of the show floor (space is limited).</li>
 <li>
  Priority VIP passes to keynote addresses&nbsp;<em>(keynote passes available in the CMO Club Lounge - quantities limited).</em></li>
 <li>
  20 percent discount on the <a href="http://cesweb.org/Conference/Purchase-Passes" target="_blank">Entertainment Matters Conference Pass</a>.</li>
 <li>
  Access to a <a href="https://resweb.passkey.com/Resweb.do?mode=welcome_ei_new&amp;eventID=10636348" target="_blank">hotel block at the Bellagio </a>available on a first-come, first-served basis through December 6. Use password CMO14 when making your reservation.</li>
</ul>
<h3>
 CMO Club Show Floor Tours</h3>
<p>
 Bespoke to the media and&nbsp;marketing communities,&nbsp;MediaLink is offering highly curated CES show floor tours, led by industry experts. For more information on these customized tours, contact <a href="mailto:CEStours@medialink.com">CEStours@medialink.com</a>.</p>
