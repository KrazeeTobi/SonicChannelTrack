...
<head id="head"><title>
	BBU04_Want 8K? Get Fiber! - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Broadband/BBU04_Want-8K-Get-Fiber!" />
...
<div>
    ...
    <div class="paragraphText">This session reviews FTTH deployment and the implications for device adoption, such as high resolution television.&nbsp;Learn which geographic markets are the most likely to support the band hogs and how consumer attitudes toward bandwidth are driving further deployment.</div>
  </div>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
    <script type="text/javascript"> 
      //<![CDATA[
