...
<meta property="og:url" content="http://www.cesweb.org/Exhibitor/Branding-Opportunities/Sponsorships/On-site-Attendee-Materials" />
<meta property="og:title" content="On-site Attendee Materials" />
<meta property="og:description" content="Explore sponsorships for on-site attendee materials.">
...
<meta name="twitter:title" content="On-site Attendee Materials">
<meta name="twitter:description" content="Explore sponsorships for on-site attendee materials.">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Exhibitor/Branding-Opportunities/Sponsorships/On-site-Attendee-Materials.aspx" id="form">
        ...
        <div class="container clearfix above">
            ...
            <div class="three-fourth">
                <div class="body-content">
                    <h1>On-site Attendee Materials</h1>

                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                                <a id="p_lt_ctl06_pageplaceholder_p_lt_hypBChome" href="../../../">Home</a></li>
                             <li class="bread-div">|</li><li><a href="/Exhibitors.aspx" class="CMSBreadCrumbsLink">Exhibitors</a> </li><li class="bread-div">|</li><li> <a href="/Exhibitor/Branding-Opportunities.aspx" class="CMSBreadCrumbsLink">Branding Opportunities</a> </li><li class="bread-div">|</li><li> <a href="/Exhibitors/Branding-Opportunities/Sponsorships.aspx" class="CMSBreadCrumbsLink">Sponsorships</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">On-site Attendee Materials</span>
</li>
...
<h2>Place your company logo on some of the more tangible items at CES. </h2>
<p class="intro">Sure to be seen, touched, used and carried by attendees, these on-site items puts you in the spotlight.</p>  

<div>
	<p>
		<strong>Badge Lanyards</strong><br />
		Lanyards are the must-have accessory at CES. Hang your company name and logo around the neck of&nbsp;all International CES attendees. The lanyards are distributed at all registration and badge pick up locations. And they have a great shelf life. You&#39;ll often see people wearing CES lanyards at other events!</p>
</div>
<div>
	<p>
		The sponsor is responsible for producing the lanyards and delivering a specified amount to the LVCC. Lanyards must arrive no later than December 26, 2014.<br />
		<br />
		<strong>Sponsorship Investment:&nbsp;</strong>Call for details.<br />
		&nbsp;<br />
		Contact us at&nbsp;<a href="mailto:ltardif@CE.org?subject=Interested%20in%20CES%20Badge%20Lanyard%20Sponsorship">ltardif@CE.org</a>&nbsp;or 703-907-7681 to secure this opportunity.</p>
	<hr />
	<p>
		<strong>Email Stations</strong></p>
	<p>
		If your company aims to be the king of the Internet marketplace, then consider this promotional opportunity. Promote your company name, graphics and homepage at email stations in lobbies of International CES venues. They&rsquo;re strategically placed throughout these high traffic areas of the show and encased with prominent, eye-catching graphics and signage. Your website or a CES booth message is also featured as the homepage for all search engines.<img alt="" src="/CES/media/2014/landing%20pages/for%20exhibitors/MyCES_EmailKiosks.jpg" style="font-weight: bold; float: right; margin: 10px;" /></p>
	<p>
		<strong>Sponsorship Investment:&nbsp;</strong>$25,000</p>
	<p>
		Contact us at&nbsp;<a href="mailto:ltardif@CE.org?subject=Interested%20in%20CES%20Email%20Station%20Sponsorship">ltardif@CE.org</a>&nbsp;or 703-907-7681 to secure this opportunity.</p>
</div>
<div>
	<p>
		<br />
		<strong>MyCES Kiosks and Tablets</strong><br />
		Attendees depend on these kiosks to navigate the show floor and plan their strategy to see specific exhibitors and products. The MyCES kiosks and tablets, placed strategically around the show floor, allow attendees to search by company, booth number or product category. Attendees can also print a map of exhibitors they want to visit and their agenda planner. Your logo will print each time on these pieces. As an official sponsor, your company name and logo and homepage shine on the interactive kiosks and tablets.<br />
		<br />
		<strong>Sponsorship Investment:&nbsp;</strong>$25,000. Pricing varies per quantities of kiosks placed. Pricing includes Internet, electrical, freestanding structures and graphics.<br />
		&nbsp;<br />
		Contact us at&nbsp;<a href="mailto:ltardif@CE.org?subject=Interested%20in%20MyCES%20Kiosk%20Sponsorship">ltardif@CE.org</a>&nbsp;or 703-907-7681 to secure this opportunity.</p>
	<hr />
	<p>
		<strong>Registration Greeters</strong><br />
		Enlist your company as an official corporate greeter and be the first company to welcome International CES attendees to the show. Corporate greeters have space in the LVCC registration area, along with one draped table for literature and underneath storage. Distribute giveaways, product information or incentives to visit your exhibit!<br />
		&nbsp;<br />
		<strong>Sponsorship Investment:&nbsp;</strong>$6,000<br />
		&nbsp;<br />
		Contact us at&nbsp;<a href="mailto:ltardif@CE.org?subject=Interested%20in%20CES%20Registration%20Greeter%20Sponsorship">ltardif@CE.org</a>&nbsp;or 703-907-7681 to secure this opportunity.</p>
	<hr />
	<p>
		<strong>Show Bags</strong><br />
		Put your brand on the official show bags. Available at registration and exhibit entrances, attendees carry these branded bags throughout the show to hold the materials and giveaways they collect along the way. Your brand will be in thousands of locations throughout the show as people move from exhibit to exhibit. The official show bags receive exclusive distribution in all registration and badge pick up areas; entrances to exhibit halls; lobby space and a variety of other heavily trafficked locations at the LVCC and The Venetian.<br />
		&nbsp;<br />
		<strong>Sponsorship Investment:&nbsp;</strong>$35,000. Does not include production costs. The sponsor is responsible for producing the bags.<br />
		<br />
		Contact us at&nbsp;<a href="mailto:ltardif@CE.org?subject=Interested%20in%20CES%20Show%20Bag%20Sponsorship">ltardif@CE.org</a>&nbsp;or 703-907-7681 to secure this opportunity.</p>
</div>
<br />
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
    <script type="text/javascript"> 
      //<![CDATA[
