...
<head id="head"><title>
	호텔 예약 - 2015 International CES, January 6-9
...
<meta property="og:title" content="호텔 예약" />
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJODc3OTc4NjAwD2QWAgIBEGRkFgICBQ9kFgJmD2QWAmYPZBYCAg0PZBYCZg9kFgICAg9kFgJmD2QWAmYPZBYCAgMPZBYCZg8PFgIeCEJhbm5lcklEAg5kZGQLWvZcqOt13JHV8yUgsFMGWfftIfsSiSUpS4/2SxwVCw==" />
</div>
...
<ul></ul>
</li><li><a href=" /Register-Plan/Badges"> CES(소비자 가전 박람회) 명찰 정보</a>
...
<section>
        ...
        <div class="container clearfix above">
            <div class="one-sixth-leftnav">
                <div class="leftnav">
                    <ul><li><a href="/International/Travel-Visas">여행 및 비자 안내</a><li class="left-current"><a href="/International/Hotel-Reservations">호텔 예약</a><ul></ul><li><a href="/International/Delegation-Group-Program">대표단 프로그램</a><li><a href="/International/International-Services">해외 방문객 서비스</a><li><a href="/International/How-to-Register-for-CES">CES 등록 방법</a><li><a href="/International/First-Timers-Resources">처음 참가자들을 위한 유용한 정보</a></ul>
            ...
            <div class="three-fourth">
                <div class="body-content">
                    ...
                    <div class="article-content-area">
                       ...
                       <p>
	웹사이트 <a href="/Register-Plan/Hotel.aspx">CESweb.org/hotel</a>(영문)을 방문하시면 여행 계획 수립에 도움이 되는 CES 공식 호텔 및 요금에 관한 전체 목록을 확인하실 수 있습니다. CES 요금 혜택을 받으시려면 투숙하고자 하는 호텔과 연결되는 링크를 선택해서 객실을 직접 예약해야 합니다. 그러면 해당 호텔의 예약 페이지로 이동하여 호텔을 예약할 수 있습니다.<br />
	<br />
	20개 이상의 객실이 필요하신 경우에는 <a href="/Register-Plan/Hotel/Reserve-a-Room-Block.aspx">선택한 호텔에 직접 요청서를 제출</a>하실 수도 있습니다. 예약 요청서는 호텔로 직접 전송되며, 해당 호텔은 삼(3) 근무일 이내에 가격 정보와 함께 예약 가능 여부에 대해 답변을 제공합니다.<br />
	<br />
	참고: 국제전자제품박람회(International CES)는 숙박 담당 부서 또는 호텔숙박 또는 다른 여행계획 전담 &nbsp;대행사를 운영하지 않습니다. 이와 다르게 업체들이 주장하는 경우 사실이 아닙니다. 반드시 참가자 본인이 직접 저희 <a href="/Register-Plan/Hotel.aspx">웹사이트</a> 상의 링크를 통해 예약하거나 해당 호텔에 직접 예약하셔야 합니다.<br />
	<br />
	궁금한 사항이 있으십니까? <a href="mailto:CEShotels@CE.org">CEShotels@CE.org</a>로 이메일을 보내 주십시오.</p>
<div>
	&nbsp;</div>
