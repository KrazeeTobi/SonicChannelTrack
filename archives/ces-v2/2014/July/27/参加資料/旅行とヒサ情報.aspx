...
<head id="head"><title>
	旅行とビザ情報 - 2015 International CES, January 6-9
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<section>
        ...
        <div class="container clearfix above">
            <div class="one-sixth-leftnav">
                <div class="leftnav">
                    <ul><li class="left-current"><a href="/International/Travel-Visas">旅行とビザ情報</a><ul></ul><li><a href="/International/Hotel-Reservations">ホテル予約</a><li><a href="/International/Delegation-Group-Program">代表団プログラム</a><li><a href="/International/International-Services">国際サービス</a><li><a href="/International/How-to-Register-for-CES">CESへのご登録方法</a><li><a href="/International/First-Timers-Resources">初めてご参加の方のための情報</a></ul>
                    ...
                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                             ...
                             <li class="bread-div">|</li><li><a href="/%e5%8f%82%e5%8a%a0%e8%b3%87%e6%96%99.aspx" class="CMSBreadCrumbsLink">参加資料</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">旅行とビザ情報</span>
</li>
...
<p class="intro">CES参加に向けて海外から米国に入国される方のために、ラスベガスとCESへのご旅行に必要な情報をすべて提供いたします。</p>  

<h3>
	旅行情報</h3>
<p>
	CESへの旅行計画については、CESweb.org の<a href="/Register-Plan/Transportation.aspx">旅行セクション</a> (英語版) をご覧ください。格安航空券、レンタルカー、現地での移動手段の手配などについてお役立てください。<br />
	<br />
...
<p>
	渡航ビザが必要ですか？　</p>
<p>
	<a href="https://ceac.state.gov/genniv/" target="_blank">オンライン</a>によるビザ申請フォームで今すぐ手続きを行なえます。</p>
<p>
	<br />
	<strong>詳細な情報が必要ですか?</strong></p>
<p>
	ヘルプが必要な場合は、弊社の<a href="/CES/media/2014/International%20Pages/2015%20CES%20Intl/FINAL_2015-CES-Visa-Tip-Sheet_JP.pdf">ビザ関連説明書</a>をダウンロードし、順を追った説明やウェブサイトアドレスなどの情報でビザ申請手続きの助力を得てください。<br />
	&nbsp;</p>
<h3>
	米国入国・出国を伴う参加者の方々の重要事項：</h3>
<p>
	1. 米国の空港での乗り継ぎや荷物の再チェックイン、米国税関・国境警備局の入国手続きには、少なくとも3時間の余裕をみておくことをお勧めします。<br />
	<br />
