...
<head id="head"><title>
	代表団プログラム - 2015 International CES, January 6-9
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<ul></ul>
</li><li><a href=" /Register-Plan/Badges"> CES バッジについて</a>
...
<section>
        ...
        <div class="container clearfix above">
            <div class="one-sixth-leftnav">
                <div class="leftnav">
                    <ul><li><a href="/International/Travel-Visas">旅行とビザ情報</a><li><a href="/International/Hotel-Reservations">ホテル予約</a><li class="left-current"><a href="/International/Delegation-Group-Program">代表団プログラム</a><ul></ul><li><a href="/International/International-Services">国際サービス</a><li><a href="/International/How-to-Register-for-CES">CESへのご登録方法</a><li><a href="/International/First-Timers-Resources">初めてご参加の方のための情報</a></ul>

                </div>
                <a id="p_lt_ctl06_pageplaceholder_p_lt_ctl01_BannerRotator_lnkBanner" class="CMSBanner Banner" href="http://www.ce.org/Membership/Join-CEA.aspx" onclick="this.href=&#39;/CMSModules/BannerManagement/CMSPages/BannerRedirect.ashx?bannerID=14&#39;;" onmouseup="this.href=&#39;/CMSModules/BannerManagement/CMSPages/BannerRedirect.ashx?bannerID=14&#39;;"><img id="p_lt_ctl06_pageplaceholder_p_lt_ctl01_BannerRotator_imgBanner" src="/CES/media/2014/advertisements/13352_JoinCEA_CESweb.jpg" style="" /></a>
                    ...
                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                             ...
                             <li class="bread-div">|</li><li><a href="/%e5%8f%82%e5%8a%a0%e8%b3%87%e6%96%99.aspx" class="CMSBreadCrumbsLink">参加資料</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">代表団プログラム</span>
</li>
...
<p class="intro">2015年インターナショナルCESへの業界専門家による団体派遣にご関心がおありですか？ CESでは公式代表団プログラムをご用意し、代表団リーダーと代表団メンバーの方にさまざまなメリットをお届けしています。代表団リーダーの方は、クライアントの方々にショー会場でご覧いただくものや誰に会うか計画を立てるお手伝いをしていただくことにより、CESへの出張の価値を最大限に高められます。代表団リーダーのご登録は11月28日までです。ご質問やご懸念等についてはどうぞ<a href="mailto:delegations@ce.org">お問い合わせください</a>。</p>  

<h2>
	プログラム内容</h2>
<ul>
	<li>
		代表団プログラムは米国外からの参加者のみが対象となります。</li>
</ul>
<ul>
	<li>
		代表団は、消費者向けテクノロジー業界に関係するビジネスに携わる方々で構成してください。</li>
</ul>
<ul>
	<li>
		代表団は15人以上とします。15人に満たないグループは、個人での参加登録が必要となります。</li>
</ul>
<p>
	代表団リーダーの方は、50人を超えるグループを率いる場合の無料ホテル滞在 (所定の条件が適用される場合あり) やCES代表団リーダー感謝ディナーへのご招待など、さまざまな特典をご利用いただけます。無料のExhibits Plus Passパス登録は、派遣団プログラム参加者全員の特典のひとつです。代表団に参加し、8月31日より後にCESに登録される場合は、事前登録料金$100は免除されます。<br />
	<br />
	代表団プログラムの特典の詳細は、<a href="/CES/media/2014/International%20Pages/2015%20CES%20Intl/FINAL_2015-CES-Delegation-Program-Benefit-Flyer_JP.pdf">こちらをクリック</a>してください。</p>
<p>
	*代表団リーダーのご登録は、ショーへの参加<a href="/Register-Plan/Register-Now.aspx">登録</a>とは別になりますのでご注意ください。公式のインターナショナルCES登録手順に従って登録を完了し、登録証を受け取る必要があります。<br />
	&nbsp;</p>
<h2>
	2015 CES 代表団リーダー用ツール</h2>
<ul>
	<li>
		<a href="/CES/media/2014/International%20Pages/2015%20CES%20Intl/13954_CESInterimBrochure_Web.pdf">英語版総合パンフレット（PDF）</a></li>
	<li>
		<a href="/CES/media/2014/International%20Pages/2015%20CES%20Intl/FINAL_2015-CES-Fact-Sheet_JA.pdf">日本語版2015 CESファクトシート（PDF）</a></li>
	<li>
		<a href="/CES/media/2014/International%20Pages/12562_2014CESDelgationBro_Web.pdf">代表団向け各国語版パンフレット</a></li>
	<li>
		<a href="/CES/media/2014/International%20Pages/2015%20CES%20Intl/FINAL_2015-CES-Delegation-Program-Benefit-Flyer_JP.pdf">代表団リーダーと代表者の特典（PDF）</a></li>
</ul>
<h2>
	<br />
	米国商務省の国際的バイヤープログラム</h2>
<h2>
...
<p>
	インターナショナルCESは、米国商務省の国際バイヤープログラム (IBP) に加盟しています。これは、世界中の米国大使館・領事館にある商務部のネットワークを通じて、スクリーニングされた海外バイヤー代表団をIBPがピックアップし、米国の優れたトレードショーに招待して、米国企業と海外のバイヤーを結びつけるものです。&nbsp;<br />
	<br />
