...
<head id="head"><title>
	ホテル予約 - 2015 International CES, January 6-9
...
<meta property="og:title" content="ホテル予約" />
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJODc3OTc4NjAwD2QWAgIBEGRkFgICBQ9kFgJmD2QWAmYPZBYCAg0PZBYCZg9kFgICAg9kFgJmD2QWAmYPZBYCAgMPZBYCZg8PFgIeCEJhbm5lcklEAg5kZGT5o7RgTf4NFY8kcRosEa7rCH7rWNZyNiSTty5VvvfuRQ==" />
</div>
...
<section>
        ...
        <div class="container clearfix above">
            <div class="one-sixth-leftnav">
                <div class="leftnav">
                    <ul><li><a href="/International/Travel-Visas">旅行とビザ情報</a><li class="left-current"><a href="/International/Hotel-Reservations">ホテル予約</a><ul></ul><li><a href="/International/Delegation-Group-Program">代表団プログラム</a><li><a href="/International/International-Services">国際サービス</a><li><a href="/International/How-to-Register-for-CES">CESへのご登録方法</a><li><a href="/International/First-Timers-Resources">初めてご参加の方のための情報</a></ul>
            ...
            <div class="three-fourth">
                <div class="body-content">
                    ...
                    <div class="article-content-area">
                       ...
                       <p>
	<a href="/Register-Plan/Hotel.aspx">CESweb.org/hotel</a> (英語版) より、CES公認のホテルと客室料金の全リストをご覧いただけますので、旅行の計画にお役立てください。CES公認の客室料金をご利用いただくには、お部屋はすべて、ご希望のホテルのリンクより直接予約していただく必要があります。リンクをクリックするとホテルの予約ページに移動しますので、そこからご予約ください。<br />
	<br />
	20客室以上のご予約が必要な場合は、<a href="/Register-Plan/Hotel/Reserve-a-Room-Block.aspx">ご希望のホテルに直接リクエストを送信</a>できます。送信後3営業日以内に、ホテルより宿泊料金とお部屋の空き状況について折り返し連絡が届きます。<br />
	<br />
	ご注意: インターナショナルCESでは、宿泊施設およびその他の旅行手配に関して、ハウジングビューローまたは代理店の使用は一切行なっておりません。虚偽の宣伝にご注意ください。ご予約に際しては、必ず公式<a href="/Register-Plan/Hotel.aspx">ウェブサイト</a>にあるリンクから、またはご希望のホテルと直接、手続きを行なうようにしてください。<br />
	<br />
	ご質問がある場合は、<a href="mailto:CEShotels@CE.org">CEShotels@CE.org</a>&nbsp;までメールでお問い合わせください。</p>
