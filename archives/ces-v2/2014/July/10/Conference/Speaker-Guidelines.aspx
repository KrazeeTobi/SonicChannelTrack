...
<head id="head"><title>
	Speaker Guidelines - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Speaker-Guidelines" />
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Speaker-Guidelines.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<section>
        ...
        <div class="container clearfix above">
            <div class="one-sixth-leftnav">
                <div class="leftnav">
                    <ul><li><a href="/Conference/Keynotes">Keynote Addresses</a><li><a href="/Conference/Conference-Tracks">Conference Tracks</a><li><a href="/Conference/Become-a-Speaker">Become a Speaker</a><li class="left-current"><a href="/Conference/Speaker-Guidelines">Speaker Guidelines</a><ul></ul></ul>
                    ...
                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                             ...
                             <li class="bread-div">|</li><li><a href="/Conference.aspx" class="CMSBreadCrumbsLink">Conference</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">Speaker Guidelines</span>
</li>
...
<h2>10 Things You Need to Know About Speaking at CES</h2>
<p class="intro"><br />
</p>  
...
<ul>
	...
	<li>
		Speakers should coordinate rehearsals and arrival times with their session moderators.</li>
	<li>
		Press and analysts are admitted to conference sessions free of charge.&nbsp;There are no specific press services offered for speakers.&nbsp;If your company is exhibiting at CES, we do have&nbsp;<a href="http://cesweb.org/Exhibitor/Media-and-PR-Opportunities/PR-Resources">public relations resources</a>&nbsp;available.&nbsp;</li>
	<li>
		If selected to speak at CES, your title, company and bio will&nbsp;be&nbsp;promoted&nbsp;on CESweb.org.</li>
	<li>
		All&nbsp;conference session times and locations&nbsp;are listed online in the&nbsp;Session Schedule. Please note that the schedule is subject to change. Speakers should coordinate rehearsals and arrival times with their session moderators.</li>
	<li>
		Handouts can be uploaded to the official&nbsp;<a href="http://cesweb.org/Show-Floor/CES-Mobile-App">International CES mobile app</a>.&nbsp; More details will be available later this fall.</li>
	<li>
		Promotional materials may not be distributed in session rooms. This is a privilege offered to paying sponsors only. Get more information on these&nbsp;<a href="http://cesweb.org/Exhibitor/Branding-Opportunities/Sponsorships">sponsorship opportunities</a>.</li>
	<li>
		We do not share our attendee or press lists with speakers.</li>
	<li>
		All CES speakers have access to the&nbsp;Speaker Ready Room. Located in the North Hall of the LVCC (room N263) this room is equipped with Wi-Fi and refreshments and is the perfect spot to meet up your fellow panelists.</li>
	<li>
		Each speaker receives up to 5 complimentary session passes to attend other conference sessions. This can be picked up in the Speaker Ready Room when retrieving speaker badges.</li>
</ul>
