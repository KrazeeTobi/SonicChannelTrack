...
<head id="head"><title>
	Mandalay Bay Press Event Manual - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Exhibitor/Show-Planning/Exhibitor-Manuals/Mandalay-Bay-Press-Conference-Manual" />
<meta property="og:title" content="Mandalay Bay Press Event Manual" />
...
<meta name="twitter:title" content="Mandalay Bay Press Event Manual">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Exhibitor/Show-Planning/Exhibitor-Manuals/Mandalay-Bay-Press-Conference-Manual.aspx" id="form">
        ...
        <div class="container clearfix above">
            ...
            <div class="three-fourth">
                <div class="body-content">
                    <h1>Mandalay Bay Press Event Manual</h1>

                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                                <a id="p_lt_ctl06_pageplaceholder_p_lt_hypBChome" href="../../../">Home</a></li>
                             <li class="bread-div">|</li><li><a href="/Exhibitors.aspx" class="CMSBreadCrumbsLink">Exhibitors</a> </li><li class="bread-div">|</li><li> <a href="/Exhibitor/Show-Planning.aspx" class="CMSBreadCrumbsLink">Show Planning</a> </li><li class="bread-div">|</li><li> <a href="/Exhibitors/Show-Planning/Exhibitor-Manuals.aspx" class="CMSBreadCrumbsLink">Exhibitor Manuals</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">Mandalay Bay Press Event Manual</span>
</li>
                    ...
                    <div class="article-content-area">
                       ...
                       <p>
	<strong><img alt="" src="/CES/media/2014/landing%20pages/for%20exhibitors/MAN00314.jpg" style="float: right; margin: 10px;" /><a href="http://www.freemanco.com/store/showSpecific/ces2015/show/ces-show-information.jsp?showID=303610" target="_blank">Mandalay Bay Press Event Manual&nbsp;</a></strong><br />
	Use the link above to access the 2015 CES Press Event Manual. This manual contains the details, forms and guidance on building your 2015 CES experience.&nbsp;<br />
	<br />
	Want to see what other press conferences will take place during the show? Our&nbsp;<strong>2015 CES Exhibitor Press Events Schedule&nbsp;</strong>will be available later this fall.<br />
	&nbsp;<br />
	You can also find tips for hosting your CES press event by downloading the <strong>2015 CES Press Conference Dos &amp; Don&rsquo;ts Flyer</strong>, also available later this fall.<br />
	&nbsp;<br />
	A press conference is one way to maximize your media coverage at the 2015 CES. Learn about other CES PR opportunities through <strong><em>Exhibitor PR News</em></strong> and in the <strong>2015 International CES Exhibitor PR Kit</strong>, both arriving later this fall.</p>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJODc3OTc4NjAwD2QWAgIBEGRkFgICBQ9kFgJmD2QWAmYPZBYCAg0PZBYCZg9kFgICAg9kFgJmD2QWAmYPZBYCAgMPZBYCZg8PFgIeCEJhbm5lcklEAq8BZGRknOcTA2MQrxI9iTJbY+fvmJhF3096Zlku7Eod9JAAY/c=" />
    <script type="text/javascript"> 
      //<![CDATA[
