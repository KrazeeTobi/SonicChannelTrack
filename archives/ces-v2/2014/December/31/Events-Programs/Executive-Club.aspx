...
<head id="head"><title>
	Executive Club - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Events-Programs/Executive-Club" />
...
<section>
        ...
        <div class="container clearfix above">
            <div class="one-sixth-leftnav">
                <div class="leftnav">
                    <ul><li><a href="/Events-Programs/Events">Events</a><li><a href="/Events-Programs/Innovation">CES Innovation Awards</a><li><a href="/Events-Programs/Awards">Awards</a><li><a href="/Events-Programs/CES-Unveiled">CES Unveiled</a><li class="left-current"><a href="/Events-Programs/Executive-Club">Executive Club</a><ul><li><a href="/Events-Programs/Executive-Club/Executive-Club-Registration">Executive Club Registration</a></ul><li><a href="/Events-Programs/Entertainment-Matters">Entertainment Matters</a><li><a href="/Events-Programs/Brand-Matters">Brand Matters</a><li><a href="/Events-Programs/CES-Asia">CES Asia</a><li><a href="/Events-Programs/Gary-s-Book-Club">Gary's Book Club</a></ul>
                    ...
                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                             ...
                             <li class="bread-div">|</li><li><a href="/Events-Programs.aspx" class="CMSBreadCrumbsLink">Events & Programs</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">Executive Club</span>
</li>
...
<h2>One Club, Endless Connections</h2>
<p class="intro">The Executive Club offers high-level industry insiders unique access to the 2015 International CES. The club allows you to be among the first to discover disruptive new technologies while connecting with peers and other influencers who share the same interests in products and companies, content and innovation. From buyers in key retail organizations, to entertainment executives, CMOs and beyond, the Executive Club provides an opportunity to make new contacts and discover new international distribution platforms and channels.<br />
</p>  

<p>
	All programs previously known as CE Platinum Club, Red Carpet Club, CMO Club and VIP Buyer Program &ndash; Gold and Silver levels &ndash; have been combined into one robust Executive Club program, each representing a specific level of membership within the Club.<br />
	&nbsp;<br />
	...
	Questions? Contact us at <a href="mailto:Silver@CE.org">Silver@CE.org</a> or 703-907-5286.<br />
	&nbsp;<br />
	All members of the <strong>Executive Club</strong> receive the following benefits at CES:</p>
<ul>
	<li>
		25 percent discount towards any conference pass</li>
	<li>
		VIP keynote pass good for entry to any CES keynote</li>
	<li>
		Access to exclusive hotel blocks</li>
	<li>
		Plus additional benefits unique to each level of membership</li>
</ul>
<p>
	&nbsp;</p>
<h3>
	Access your Executive Club Benefits and Register</h3>
<ul>
	<li>
		<strong><em>If you have not yet registered for CES:</em></strong> Please <a href="https://ces.itnint.com/ces15/regonline/RegECMLogin.aspx" target="_blank">register and access your Executive Club benefits</a> today. You will need the personal access code provided within your Executive Club invitations.<br />
		&nbsp;</li>
	<li>
		<strong><em>If you have already registered for CES and need to&nbsp;activate your Executive Club benefits:&nbsp;</em></strong>Simply<a href="https://ces.itnint.com/CES15/regonline/RegLogin.aspx" target="_blank">&nbsp;log back in to your CES registration account</a>&nbsp;using the username and password you created during the registration process. When you log back in your Executive Club benefit options will be available in&nbsp;&quot;My Account&quot;.<br />
		&nbsp;</li>
</ul>
<h3>
	Membership Consideration</h3>
<p>
	To be considered for Executive Club membership please email us at <a href="mailto:ExecutiveClub@CE.org">ExecutiveClub@CE.org</a>.</p>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
    <script type="text/javascript"> 
      //<![CDATA[
