...
<head id="head"><title>
	C&#233;dric Hutchings - 2015 International CES, January 6-9
...
<meta property="og:url" content="http://www.cesweb.org/Conference/Conference-Tracks/Digital-Health-Summit/DHTH11_To-Serve-and-Protect-Sleep,-Sound-and-Sight/Cedric-Hutchings" />
<meta property="og:title" content="Cédric Hutchings" />
...
<meta name="twitter:title" content="Cédric Hutchings">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Conference/Conference-Tracks/Digital-Health-Summit/DHTH11_To-Serve-and-Protect-Sleep,-Sound-and-Sight/Cedric-Hutchings.aspx" id="form">
...
<h2>Cédric Hutchings</h2>
<h3>CEO<br />Withings</h3>
<div style="float: left;">
  <img src="/CES/media/2014/Conference/SpeakerHeadshots/Cedric_Hutchings_Withings.jpg?ext=.jpg" style="margin: 0px 15px 10px 0px; max-width: 275px;" alt="Cédric Hutchings">
</div>
<div style="margin: 10px;">
  Cédric’s passion for innovation and understanding of consumers' needs fuels Withings’ fast growth. Armed with an engineering degree from Ecole Centrale and a Masters from Massachusetts Institute of Technology (MIT), Cédric first worked as a product manager at Inventel, overseeing the launch of residential wireless gateways. He then joined Thompson as Marketing Director for Domestic Products.&nbsp; <br><br>Driving the development of Withings’ life-changing products, his vision along with partner Eric Carreel, is to radicalize our relationship with health, taking away any pain and fear associated with it and putting us back in control.<br>
</div>
...
(function() {var fn = function() {$get("manScript_HiddenField").value = '';Sys.Application.remove_init(fn);};Sys.Application.add_init(fn);})();//]]>
  ...
  <input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
    <script type="text/javascript"> 
      //<![CDATA[
