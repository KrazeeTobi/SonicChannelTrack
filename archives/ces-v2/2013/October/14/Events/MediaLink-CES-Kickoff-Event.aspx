...
<head id="head"><title>
	MediaLink CES Kickoff Event - 2014 International CES, January 7 - 10
...
<meta name="twitter:title" content="MediaLink CES Kickoff Event">
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Events/MediaLink-CES-Kickoff-Event.aspx" id="form">
...
<div class="headerbox">
      <h1>MediaLink CES Kickoff Event</h1>
</div>
<div style="float: right;">
    
</div>
<div>
    <strong><img alt="" src="/cesweb/media/CESWeb/Events/CES-719-MediaLink.jpg" style="float: right; margin: 10px;" />7:30-11:30 p.m. Monday,&nbsp;January 6<br />
