...
<head id="head"><title>
	Conference Pricing - 2014 International CES, January 7 - 10
...
</script><script type="text/javascript" src="/cesweb/media/CESWeb/assets/js/ITN/underscore.js"></script>
...
<style>
  .addToCartOver { background-color: #333!important; cursor: pointer!important; }
  .addToCartOut { background-color: #fff!important; cursor: arrow!important; }
</style> 
...
<div id="exhibit">
	...
	<ul id="menuElem">
		...
		<li class="highlighted"><a href="/Conference-Program/Conference-Pricing.aspx" >Conference Pricing</a></li>
...
<div>
	<h2>
		2014 Conference Pricing Overview</h2>
	<p>
		CES offers a variety of options for purchasing passes to conference programming, from single conference sessions to All Access, which will get you in everywhere. Explore our options and select what fits your needs.<br />
		&nbsp;</p>
	<ul>
		<li>
			Advance Pricing: October 1 - January 1, 2014</li>
		<li>
			On-site Pricing: January 1, 2014 &ndash; January 10, 2014</li>
	</ul>
</div>
...
<div style="width: 720px; height: auto; overflow: hidden;">
	...
	<div class="pricingcols" id="pricingLeft">
		...
		<div class="laundrylist">
			<div style="margin-left: 40px;">
				Advertising Week at CES | Automotive Electronics Technology | Broadband Unlimited | Business of Innovation | Cable Conference at CES | Connecting to the Cloud | Content and Disruptive Technology | Digital Health Summit | Digital Hollywood | Digital Music at CES | Fitness Tech | Marketing and Engagement | MEMS Sensor Fusion &ndash; Revolutionizing the Internet of Things | Memory Goes Mobile | PMA@CES Conference Sessions | Robotics Business Review Presents: The Next Trillion Dollar Consumer Market: Robotics | StoryTech at CES | Seeing Is Believing - 3D, 4K and UHD | Silvers Summit | Smartphones and Tablets Conference | Technology Trends | <em>Variety</em>&rsquo;s Entertainment Summit at CES | Wireless and Mobile Technology</div>
			<ul>
			</ul>
		</div>
	</div>
	<div class="pricingcols" id="pricingLeftCenter">
		...
		<div class="laundrylist">
			<div style="margin-left: 40px;">
				Automotive Electronics Technology | Business of Innovation | Cable Conference at CES | Connecting to the Cloud | Content and Disruptive Technology | Digital Hollywood | Digital Music at CES | Marketing and Engagement | Seeing Is Believing - 3D, 4K and UHD | Smartphones and Tablets Conference | StoryTech at CES | <em>Variety</em>&rsquo;s Entertainment Summit at CES | Wireless and Mobile Technology</div>
			<ul type="disc">
			</ul>
		</div>
	</div>
	<div class="pricingcols" id="pricingRightCenter">
		...
		<div class="laundrylist">
			<div style="margin-left: 40px;">
				Automotive Electronics Technology | Business of Innovation | Content and Disruptive Technology | Marketing and Engagement | Technology Trends | Wireless and Mobile Technology</div>
			<ul type="disc">
			</ul>
		</div>
	</div>
	<div class="pricingcols" id="pricingRight">
		...
		<div class="laundrylist">
			<div style="margin-left: 40px;">
				Automotive Electronics Technology | Business of Innovation | Cable Conference at CES | CONNECTIONS Summit | Content and Disruptive Technology | Digital Hollywood | Marketing and Engagement | PMA@CES Conference Sessions | Smartphones and Tablets Conference | Technology Trends | Wireless and Mobile Technology</div>
			<ul type="disc">
			</ul>
		</div>
	</div>
	...
	<div style="width: 720px; height: auto; overflow: hidden;">
		...
		<div class="pricingcols" id="pricingLeftlower">
			...
			<div class="laundrylist">
				<div style="margin-left: 40px;">
					Broadband Unlimited | Cable Conference at CES | CONNECTIONS Summit | Fitness Tech | Seeing Is Believing - 3D, 4K and UHD | Silvers Summit</div>
				<ul type="disc">
				</ul>
			</div>
		</div>
		<div class="pricingcols" id="pricingLeftCenterlower">
			...
			<div class="laundrylist">
				<div style="margin-left: 40px;">
					Advertising Week at CES | Connecting to the Cloud | Digital Music at CES | MEMS Sensor Fusion &ndash; Revolutionizing the Internet of Things | Memory Goes Mobile | Robotics Business Review Presents: The Next Trillion Dollar Consumer Market: Robotics | StoryTech at CES | <em>Variety</em>&rsquo;s Entertainment Summit at CES</div>
			</div>
		</div>
		<div class="pricingcols" id="pricingRightCenterLower">
			<div class="passnameprice">
				<strong><a name="multiday"></a>Multi-Day Conference Programs</strong><br />
				Advance: $450 | On-site: $600<br />
				<br />
				Includes:</div>
			<div class="laundrylist">
				<div style="margin-left: 40px;">
					Digital Health Summit | Digital Hollywood | PMA@CES Conference Sessions | Smartphones and Tablets Conference</div>
				<ul type="disc">
				</ul>
			</div>
		</div>
		<div class="pricingcols" id="pricingRightlower">
			...
			<div class="laundrylist">
				<div style="margin-left: 40px;">
					3D Printing Don&#39;t Believe the Hype? - 3D Printing Uncovered | CEA Innovation Policy Summit | CEA Research Summit | Internet of Everything | Kids@Play &amp; MommyTech | TransformingEDU</div>
			</div>
		</div>
		<div class="pricingcols" id="pricingLeftlower">
			<div class="passnameprice">
				<strong><a name="fulldaytrain"></a>Full Day Training - THX Certified Home Theater Professional Level 1</strong><br />
				Advance: $500 | On-site: $550<br />
				&nbsp;</div>
		</div>
	</div>
</div>
