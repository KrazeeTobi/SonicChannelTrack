...
<head id="head"><title>
	RSS News - 2014 International CES, January 7 - 10
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Footer-Pages/RSS-News.aspx" id="form">
...
<div id="exhibit">
	...
	<ul id="menuElem">
		<li class="HighLighted" style=""><a href="/Footer-Pages/RSS-News.aspx" style="" >RSS News</a></li>
	</ul>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='rss-news end'><a href='/Footer-Pages/RSS-News.aspx'>RSS News</a></li></ul>
...
<div id="footer-home">
	...
	<ul class="footerCMSListMenuUL" id="menuElem">
		...
		<li class="footerCMSListMenuHighlightedLI" style=""><a href="/Footer-Pages/RSS-News.aspx" class="footerCMSListMenuLinkHighlighted" style="" >RSS&nbsp;News</a></li>
