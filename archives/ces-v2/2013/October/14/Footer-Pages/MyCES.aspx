...
<head id="head"><title>
	MyCES - 2014 International CES, January 7 - 10
...
<meta name="twitter:title" content="MyCES">
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Footer-Pages/MyCES.aspx" id="form">
...
<div id="exhibit">
	...
	<ul id="menuElem">
		<li class="HighLighted" style=""><a href="/Footer-Pages/MyCES.aspx" style="" >MyCES</a></li>
	</ul>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='myces end'><a href='/Footer-Pages/MyCES.aspx'>MyCES</a></li></ul>
...
<div>
    <script language="javascript" src="http://www.mapyourshow.com/includes/floorplan.js"></script><img alt="" src="/cesweb/media/CESWeb/MY_CES_2k10.gif" style="width: 128px; height: 85px; float: left; " />With the MyCES Planner, you can&nbsp;create a personalized show agenda that allows you to:<br />
<ul>
	<li>
		Add exhibitors of interest to your agenda</li>
	<li>
		Use the My Events calendar to organize your show-related activities</li>
	<li>
		Print a map of the show floor highlighting your exhibitors of interest</li>
</ul>
If you already have a <a href="http://ces14.mapyourshow.com/5_0/myshow/login.cfm?">MyCES account</a>, take advantage of these tools and start planning your show today!&nbsp;If you don&rsquo;t have a MyCES account, <a href="http://ces14.mapyourshow.com/5_0/myshow/login.cfm?" target="_blank">create one today</a>, watch the 2014 CES come to life as we add new exhibitors, events and announcements,&nbsp;and start planning your show today!<br />
<br />
<table border="0" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
			<th colspan="7">
				<img alt="" src="/cesweb/media/CESWeb/myCES-top.jpg" style="width: 665px; height: 23px; " /></th>
		</tr>
		<tr>
			<th colspan="7">
				&nbsp;</th>
		...
		<tr align="center">
			<td valign="top">
				<div align="center">
					<br />
					<a href="http://ces14.mapyourshow.com/5_0/search.cfm?" target="_blank"><img alt="" src="/cesweb/media/CESWeb/dir-search(1).jpg" style="width: 95px; height: 87px; border-width: 0px; border-style: solid; " /></a></div>
			</td>
			<td valign="top">
				<div align="center">
					<br />
					<a href="http://ces14.mapyourshow.com/5_0/exhibitor_results.cfm?type=list&amp;list=featured" target="_blank"><img alt="" src="/cesweb/media/CESWeb/featured-exhibitors(1).jpg" style="width: 95px; height: 87px; border-width: 0px; border-style: solid; " /></a></div>
			</td>
			<td valign="top">
				<div align="center">
					<br />
					<a href="http://ces14.mapyourshow.com/5_0/advanced_search.cfm?by=category" target="_blank"><img alt="" src="/cesweb/media/CESWeb/product-search(2).jpg" style="width: 95px; height: 87px; border-width: 0px; border-style: solid; " /></a></div>
			</td>
			<td valign="top">
				<div align="center">
					<br />
					<a href="http://ces14.mapyourshow.com/5_0/myshow/login.cfm?" target="_blank"><img alt="" src="/cesweb/media/CESWeb/myplanner(1).jpg" style="width: 95px; height: 87px; border-width: 0px; border-style: solid; " /></a></div>
			</td>
			<td valign="top">
				<br />
				<a href="http://www.mapyourshow.com/shows/index.cfm?Show_ID=CES14" target="_blank"><img alt="" src="/cesweb/media/CESWeb/maps(2).jpg" style="border-width: 0px; border-style: solid; vertical-align: top;" /></a><br />
				&nbsp;</td>
		...
		<tr>
			<th colspan="7">
				<img alt="" src="/cesweb/media/CESWeb/myCES-bottom.jpg" style="width: 665px; height: 23px; " /></th>
		</tr>
	</tbody>
</table>
<br />
...
<div id="footer-home">
	...
	<ul class="footerCMSListMenuUL" id="menuElem">
		...
		<li class="footerCMSListMenuHighlightedLI" style=""><a href="/Footer-Pages/MyCES.aspx" class="footerCMSListMenuLinkHighlighted" style="" >MyCES</a></li>
