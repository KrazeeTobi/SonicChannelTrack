...
<div id="exhibit">
	...
	<ul id="menuElem">
		...
		<li class="highlighted"><a href="/videos.aspx" >CES TV</a></li>
...
<div class="headerbox">
      <h1>CES TV</h1><span style="font-size:18px;">The <strong>official </strong>home for video from the International CES. Find out what to explore at the show and catch up on keynotes, conference sessions and more.</span><br />
<br />
<br />
<br />
...
--><script language="JavaScript" type="text/javascript" src="http://admin.brightcove.com/js/BrightcoveExperiences.js"></script><object class="BrightcoveExperience" id="myExperience"><param name="bgcolor" value="#FFFFFF" /><param name="width" value="695" /><param name="height" value="560" /><param name="playerID" value="1995274169001" /><param name="playerKey" value="AQ~~,AAAABh3C_dE~,zBkXqCU8KVaPD5eWMlL4TSd-72riLdgV" /><param name="isVid" value="true" /><param name="isUI" value="true" /><param name="dynamicStreaming" value="true" /></object><!-- 
