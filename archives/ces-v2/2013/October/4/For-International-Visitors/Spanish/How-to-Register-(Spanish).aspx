...
<head id="head"><title>
	C&#243;mo puede registrarse para la CES  - 2014 International CES, January 7 - 10
...
<meta name="twitter:title" content="Cómo puede registrarse para la CES ">
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/Spanish/How-to-Register-(Spanish).aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/Spanish/How-to-Register-(Spanish).aspx" >C&#243;mo puede registrarse para la CES </a></li>
		</ul>
		</li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='spanish'><a href='/For-International-Visitors/Spanish.aspx'>Español</a></li><li class='how-to-register-(spanish) end'><a href='/For-International-Visitors/Spanish/How-to-Register-(Spanish).aspx'>Cómo puede ...</a></li></ul>
...
<div class="headerbox">
      <h1>Cómo puede registrarse para la CES </h1>
</div>
...
<div>
	...
	<img alt="" src="/cesweb/media/CESWeb/International%20Pages/12998_2014CES_HowtoReg_Spanish.jpg" /><br />
	El primer paso para asistir a la CES Internacional en Las Vegas es registrarse para el evento. Inscríbase con tiempo para ahorrar dinero, evitar largas esperas para obtener su identificación &iexcl;y llegar lo más rápidamente posible al salón de exposiciones y a toda la acción que allí lo espera!&nbsp;<br />
	<br />
	Siga estos fáciles pasos para completar su inscripción y verificación de negocios para la CES Internacional 2014:</p>
<ol style="background-color: rgb(255, 255, 255);">
	<li>
		<strong>Visite&nbsp;</strong><a href="https://ces.itnint.com/2014/regonline/RegLogin.aspx"><strong>CESweb.org/register</strong></a>&nbsp;y elija el tipo de inscripción que necesita (Asistente, Expositor, Prensa o Delegación).</li>
	<li>
		<strong>Ingrese su información </strong>en los campos del formulario. El símbolo &#39;*&#39; indica que el campo es obligatorio.</li>
	<li>
		<strong>Proporcione la verificación de negocios de su sector.</strong> Una tarjeta de negocios, carta de su empresa, breve descripción o prueba de su puesto en el sector <strong>debe </strong>ser cargada como parte del proceso de inscripción para verificar su afiliación con la industria de la tecnología. Esto puede ser tan fácil como tomar una foto a su tarjeta de negocios y adjuntarla a su inscripción. Es importante que recuerde que su estado de preinscripción se considerará <strong>incompleto</strong> hasta que haya incluido esta verificación y sea aprobada. Sin embargo, los asistentes que visitaron la CES el año pasado con el mismo nombre y dirección de correo electrónico serán preaprobados y no se les solicitará esa información para la CES 2014.</li>
	<li>
		<a href="http://www.cesweb.org/For-International-Visitors/Spanish/Spanish-Badge-Information.aspx"><strong>Recoja su identificación</strong></a>&nbsp;<strong>en Las Vegas</strong>&nbsp;en enero y &iexcl;comience su experiencia en la CES 2014! Las identificaciones <strong><u>NO</u></strong> se enviarán anticipadamente por correo a los participantes. En lugar de ello, deberán retirarlas en cualquiera de las más de 25&nbsp;<a href="/For-International-Visitors/Spanish/Spanish-Badge-Information.aspx">áreas de retiro de identificaciones</a><a href="http://www.cesweb.org/For-International-Visitors/Spanish/Spanish-Badge-Information.aspx">.&nbsp;</a></li>
</ol>
<p style="background-color: rgb(255, 255, 255);">
	Para que recoger su identificación sea más fácil, estamos precalificando a los asistentes durante el proceso de inscripción. Por favor, envíe sus credenciales del sector durante el proceso de inscripción en línea para no tener que hacerlo al recoger su identificación. Aún cuando haya enviado esos datos, se controlará su documento de identidad en los sitios de retiro de identificaciones de la CES.</p>
