...
<head id="head"><title>
	CES 등록 방법 - 2014 International CES, January 7 - 10
...
<meta name="twitter:title" content="CES 등록 방법">
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/Korean/How-to-Register-(Korean).aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/Korean/How-to-Register-(Korean).aspx" >CES 등록 방법</a></li>
		</ul>
		</li>
	</ul>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='korean'><a href='/For-International-Visitors/Korean.aspx'>한국어</a></li><li class='how-to-register-(korean) end'><a href='/For-International-Visitors/Korean/How-to-Register-(Korean).aspx'>CES 등록 방법</a></li></ul>
...
<div>
    <img alt="" src="/cesweb/media/CESWeb/International%20Pages/12998_2014CES_HowtoReg_Korean.jpg" /><br />
라스베이거스 국제전자제품박람회 참가를 위한 첫 단계는 박람회에 등록하는 것입니다. 사전에 등록하면 비용도 절약하고 명찰을 받기 위해 길게 줄을 서서 기다리지 않아도 되므로 전시층에 최대한 신속하게 입장하실 수 있습니다!<br />
<br />
다음과 같은 간편한 단계에 따라 2014년 국제전자제품박람회 등록 및 산업 확인 과정을 완료하시기 바랍니다.<br />
<ol>
	<li>
		<strong>웹사이트</strong> <a href="https://ces.itnint.com/2014/regonline/RegLogin.aspx"><strong>CESweb.org/register&nbsp;</strong></a>에서 필요한 등록 유형(참가자, 전시업체, 언론, 대표단)을 선택하십시오.</li>
	<li>
		지정된 양식 필드에 <strong>귀하의</strong> <strong>정보를</strong> <strong>입력하십시오</strong>. &#39;*&#39; 심볼은 필수 입력 필드를 의미합니다.</li>
	<li>
		<strong>산업</strong> <strong>확인</strong> <strong>증명</strong> <strong>자료를</strong> <strong>제공하십시오</strong><strong>.</strong>&nbsp;업계 소속 여부를 검증하기 위한 등록 절차의 일환으로 명함, 회사 서신, 짧은 설명 또는 귀사의 업계 회원 여부를 증명할 수 있는 서류를 <strong>반드시</strong> 업로드해야 합니다. 이 절차는 명함 사진을 찍어서 등록 서류에 붙이는 것만큼 간단합니다. 이 검증 자료들을 업로드해서 승인을 얻기 전까지는 귀하의 사전등록은 <strong>미완료</strong> 상태로 간주된다는 사실을 유념해 주십시오. 단, 동일한 이름과 이메일 주소로 작년에 CES를 방문했던 참가자는 사전 승인을 받을 수 있으며 2014년 CES에 업계 회원증을 제출하지 않아도 됩니다.</li>
	<li>
		1월에 <strong>라스베이거스에서</strong> <a href="http://www.cesweb.org/For-International-Visitors/Korean/CES(%EC%86%8C%EB%B9%84%EC%9E%90-%EA%B0%80%EC%A0%84-%EB%B0%95%EB%9E%8C%ED%9A%8C)-%EB%AA%85%EC%B0%B0-%EC%A0%95%EB%B3%B4.aspx"><strong>명찰을</strong> <strong>찾은</strong> <strong>후</strong></a> 2014년 CES에 참가하십시오! 명찰은 등록자에게 사전에 우편으로 발송하지 <strong><u>않습니다</u></strong>. 대신에 참가자는 25개 이상의&nbsp;<a href="http://www.cesweb.org/For-International-Visitors/Korean/CES(%EC%86%8C%EB%B9%84%EC%9E%90-%EA%B0%80%EC%A0%84-%EB%B0%95%EB%9E%8C%ED%9A%8C)-%EB%AA%85%EC%B0%B0-%EC%A0%95%EB%B3%B4.aspx">명찰 배부 장소</a>에서 자신의 명찰을 찾으면 됩니다.&nbsp;</li>
</ol>
저희는 참가자들이 더욱 간편하게 명찰을 찾을 수 있도록 등록 절차를 진행하는 동안 참가자들에 대한 사전 심사를 진행하고 있습니다. 명찰을 찾을 때 업계 회원증을 제출할 필요가 없도록 온라인 등록 절차를 진행하는 동안 업계 회원증을 제출해 주십시오. 개인 신분증은 명찰 배부 장소에서도 제시해야 합니다.
