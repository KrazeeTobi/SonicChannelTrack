...
<head id="head"><title>
	CESへのご登録方法 - 2014 International CES, January 7 - 10
...
<meta name="twitter:title" content="CESへのご登録方法">
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/japanese/How-to-Register-(Japanese).aspx" id="form">
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/japanese/How-to-Register-(Japanese).aspx" >CESへのご登録方法</a></li>
		</ul>
		</li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='japanese'><a href='/For-International-Visitors/japanese.aspx'>日本語</a></li><li class='how-to-register-(japanese) end'><a href='/For-International-Visitors/japanese/How-to-Register-(Japanese).aspx'>CESへのご登録方法</a></li></ul>
...
<div>
    <img alt="" src="/cesweb/media/CESWeb/International%20Pages/12998_2014CES_HowtoReg_Japanese.jpg" /><br />
ラスベガスで開催されるインターナショナルCESに参加をご希望の場合、まず初めにショーにご登録ください。事前に登録されると、経費節約となり、バッジを受け取るために長時間待たされることもありません。展示フロアのアクションパックをいち早くお届けいたします!  <br />
<br />
以下の手順に従って、2014インターナショナルCESへのご登録と業界審査の手続きを行ってください。<br />
<ol>
	<li>
		<a href="https://ces.itnint.com/2014/regonline/RegLogin.aspx"><strong>CESweb.org/register</strong></a> に<strong>アクセス</strong>し、ご希望のご登録タイプ (参加者、出展者、プレス、派遣団) をお選びください。</li>
	<li>
		指定フォーム欄に<strong>ご登録者の情報を入力</strong>してください。「*」の印が付いた欄は必須項目です。</li>
	<li>
		<strong>業界関係者であることを証明するものをご提示ください。</strong>登録手続きには、技術産業に所属されていることを証明する名刺、会社発行の所属証明の手紙、業界でのポジション・役職についての簡単な記述や証明書をアップロードしていただくことが<strong>必須</strong>となります。たとえば、名刺の写真を撮って登録書に添付するなどをしていただくだけで結構です。この証明書をアップロードして承認されるまでは、登録が<strong>完了したことにはなりません</strong>のでご注意ください。ただし、昨年のCESに参加された方は、名前とメールアドレスに変更がなければ事前承認がなされ、2014 CESに証明書を提示していただく必要はありません。</li>
	<li>
		1月に<strong>ラスベガスで</strong><a href="http://www.cesweb.org/For-International-Visitors/japanese/CES-%E3%83%8F%E3%83%83%E3%82%B7%E3%81%AB%E3%81%A4%E3%81%84%E3%81%A6.aspx"><strong>バッジをお受け取りになり</strong></a>、2014 CESで新たな体験をお楽しみください! バッジは、ご登録者に事前に郵送<strong><u>されません</u></strong>。その代わり、参加者の方には25か所以上の<a href="http://www.cesweb.org/For-International-Visitors/japanese/CES-%E3%83%8F%E3%83%83%E3%82%B7%E3%81%AB%E3%81%A4%E3%81%84%E3%81%A6.aspx">指定バッジ受取所</a>でバッジを受け取っていただきます。</li>
</ol>
バッジをより簡単に受け取っていただくため、登録手続きのなかで参加者の事前承認をさせていただきます。業界関係者であることを証明するものをオンライン登録の際にご提示していただければ、当日バッジを受け取られる際に証明書を提示していただく必要がなくなります。ただし、バッジ受取所では個人のIDの提示をお願いしておりますので、ご了承ください。<br />
