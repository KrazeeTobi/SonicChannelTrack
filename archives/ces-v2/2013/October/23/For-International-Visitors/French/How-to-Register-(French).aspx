...
<head id="head"><title>
	Comment vous inscrire au CES  - 2014 International CES, January 7 - 10
...
<meta name="twitter:title" content="Comment vous inscrire au CES ">
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/French/How-to-Register-(French).aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/French/How-to-Register-(French).aspx" >Comment vous inscrire au CES </a></li>
		</ul>
		</li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='french'><a href='/For-International-Visitors/French.aspx'>Français</a></li><li class='how-to-register-(french) end'><a href='/For-International-Visitors/French/How-to-Register-(French).aspx'>Comment vous ...</a></li></ul>
...
<div class="headerbox">
      <h1>Comment vous inscrire au CES </h1>
</div>
<div style="float: right;">
    
</div>
<div>
    <img alt="" src="/cesweb/media/CESWeb/International%20Pages/12998_2014CES_HowtoReg_French.jpg" /><br />
La première étape pour participer au CES International à Las Vegas est de vous inscrire au salon. Inscrivez-vous à l&rsquo;avance pour faire des économies et éviter de faire une longue queue pour obtenir votre badge, ce qui vous permet d&rsquo;aller sur la surface d&rsquo;exposition débordante d&rsquo;activités le plus vite possible&nbsp;!<br />
<br />
Suivez ces étapes simples pour vous inscrire au CES International 2014 et fournir un document permettant de vérifier votre industrie&nbsp;:&nbsp;&nbsp;<br />
<ol>
	<li>
		<strong>Consultez&nbsp;</strong><a href="https://ces.itnint.com/2014/regonline/RegLogin.aspx"><strong>CESweb.org/register</strong></a>&nbsp;et sélectionnez le type d&rsquo;inscription qu&rsquo;il vous faut (visiteur, exposant, membre de la presse, délégation). &nbsp;</li>
	<li>
		<strong>Saisissez les informations </strong>vous concernant dans les champs du formulaire à cet effet. Le symbole &#39;*&#39; indique que ce champ est obligatoire.</li>
	<li>
		<strong>Fournissez une preuve de votre industrie.</strong>&nbsp;Une carte de visite, une lettre de l&rsquo;entreprise, une brève description ou une preuve de votre poste dans l&rsquo;industrie <strong>doit</strong> être téléchargée dans le cadre du processus d&rsquo;inscription afin de vérifier votre affiliation à l&rsquo;industrie technologique. Ce processus peut être aussi simple que de prendre une photo de votre carte de visite et de la joindre à votre inscription. Il est à noter que votre préinscription sera considérée <strong>incomplète </strong>jusqu&rsquo;à ce que le document à vérifier ait été téléchargé et approuvé. Cependant, les visiteurs qui sont venus au CES l&rsquo;année dernière, sous le même nom et avec la même adresse de courriel, seront approuvés à l&rsquo;avance et ne seront pas priés de fournir des références pour CES 2014. &nbsp; &nbsp;</li>
	<li>
		<a href="http://www.cesweb.org/For-International-Visitors/French/Informations-concernant-les-badges-pour-CES.aspx"><strong>Retirez votre badge</strong></a>&nbsp;<strong>à Las Vegas</strong>&nbsp;en janvier et commencez votre expérience CES 2014&nbsp;! Les badges <strong><u>NE SERONT PAS</u></strong> expédiés aux personnes qui s&rsquo;inscrivent à l&rsquo;avance. Les participants pourront retirer leurs badges dans plus 25&nbsp;<a href="http://www.cesweb.org/For-International-Visitors/French/Informations-concernant-les-badges-pour-CES.aspx">endroits réservés au retrait des badges</a>.&nbsp;</li>
</ol>
Pour vous permettre de retirer plus facilement votre badge, nous faisons une présélection des participants lors du processus d&rsquo;inscription. Veuillez soumettre les références de votre industrie lors de votre inscription en ligne et vous n&rsquo;aurez plus besoin de le faire quand vous retirerez votre badge. Les cartes d&rsquo;identité seront toutefois vérifiées dans les endroits où les badges sont remis.
