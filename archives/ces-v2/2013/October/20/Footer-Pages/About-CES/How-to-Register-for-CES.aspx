...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Footer-Pages/About-CES/How-to-Register-for-CES.aspx" id="form">
...
<div id="exhibit">
	...
	<ul id="menuElem">
		<li class="highlighted"><a href="/Footer-Pages/About-CES/How-to-Register-for-CES.aspx" >How to Register for CES</a></li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='about-ces'><a href='/Footer-Pages/About-CES.aspx'>About CES</a></li><li class='how-to-register-for-ces end'><a href='/Footer-Pages/About-CES/How-to-Register-for-CES.aspx'>How to Register for ...</a></li></ul>
...
<div>
    <iframe frameborder="0" height="400" src="http://prezi.com/embed/kew0z_rf4s2f/?bgcolor=ffffff&amp;lock_to_path=0&amp;autoplay=0&amp;autohide_ctrls=0&amp;features=undefined&amp;disabled_features=undefined" width="700"></iframe><br />
<br />
<table align="right" border="0" cellpadding="1" cellspacing="1" style="width: 200px;">
	<tbody>
		<tr>
			<td style="text-align: center;">
				<strong>Select a Language</strong></td>
		</tr>
		<tr>
			<td style="text-align: center;">
				<a href="/For-International-Visitors/Spanish/How-to-Register-(Spanish).aspx">Español</a><br />
				<a href="/For-International-Visitors/French/How-to-Register-(French).aspx">Français</a><br />
				<a href="/For-International-Visitors/chinese/How-to-Register-(French).aspx">汉语</a><br />
				<a href="/For-International-Visitors/japanese/How-to-Register-(Japanese).aspx">日本語</a><br />
				<a href="/For-International-Visitors/Korean/How-to-Register-(Korean).aspx">한국어</a></td>
		</tr>
	</tbody>
</table>
Your first step to attending the International CES in Las Vegas is to register for the show. Register in advance to save money and avoid waiting in long lines to get your badge<span style="font-size: 11pt; line-height: 115%; font-family: Calibri, sans-serif;">&mdash;</span>getting you to the action-packed show floor as quickly as possible!&nbsp;<br />
<br />
Follow these easy steps to complete your registration and industry verification for the 2014 International CES:
<p>
	&nbsp;</p>
<ol>
	<li>
		<strong>Visit <a href="https://ces.itnint.com/2014/regonline/RegLogin.aspx" target="_blank">CESweb.org/register</a></strong> and select which type of registration&nbsp;<a href="https://ces.itnint.com/2014/regonline/" style="text-decoration: underline; color: rgb(0, 185, 212); text-align: center;" target="_blank"><img alt="" src="/cesweb/media/CESWeb/Badge%20Info/Register_CEorg_Final-(2).jpg" style="width: 200px; height: 132px; float: right; margin: 10px;" /></a>you need (Attendee, Exhibitor, Press, Delegation).</li>
	<li>
		<strong>Enter your information</strong> into the designated form fields. A &#39;*&#39; symbol indicates a required field.</li>
	<li>
		<strong>Provide industry verification.</strong> A business card, company letter, short description or proof of your industry position <strong>must</strong> be uploaded as part of the registration process to verify tech industry affiliation. This can be as easy as taking a picture of your business card and attaching it to your registration. It&rsquo;s important to note that your preregistration status will be considered <strong>incomplete</strong> until this verification has been uploaded and approved. However, attendees who came to last year&rsquo;s CES under the same name and email address will be preapproved and not asked to provide credentials for the 2014 CES.</li>
	<li>
		<strong><a href="/Footer-Pages/About-CES/Badge-Information.aspx">Pick up your badge</a></strong> <strong>in Las Vegas</strong> in January and begin your 2014 CES experience! Badges will <strong><u>NOT</u></strong> be mailed to registrants in advance. Instead, attendees will pick up their badge at more than 25 <a href="/Footer-Pages/About-CES/Badge-Information.aspx">badge pickup areas</a>.&nbsp;</li>
</ol>
<p>
	...
	<br />
	<span style="color: rgb(34, 34, 34); font-family: Arial, Verdana, sans-serif; line-height: normal; background-color: rgb(255, 255, 255);">Registration fees increase to $200 on January 2, 2014.&nbsp;</span><br />
	&nbsp;</p>
<p class="Default">
	<b>Cancellations: </b><span style="font-size:9.0pt">Cancellations for paid registrations received in writing on/before December 27, 2013, are refundable, minus a $50 processing fee. After December 27, 2013, cancellations are subject to the entire fee. If you do not cancel by December 27, 2013, and do not attend International CES, you are still responsible for payment. You may substitute the name of one conference registrant for another at any time. Please submit all cancellations in writing by sending your request to <a href="mailto:CESreg@CE.org">CESreg@CE.org</a> or via fax to 801-406-0660. Cancellation requests not received in writing will not be honored.&nbsp;<o:p></o:p></span></p>
