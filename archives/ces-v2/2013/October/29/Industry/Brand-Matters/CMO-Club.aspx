...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Industry/Brand-Matters/CMO-Club.aspx" id="form">
...
<div id="exhibit">
	...
	<ul id="menuElem">
		...
		<ul>
			<li class="highlighted"><a href="/Industry/Brand-Matters/CMO-Club.aspx" >CMO Club</a></li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='brand-matters'><a href='/Industry/Brand-Matters.aspx'>Brand Matters</a></li><li class='cmo-club end'><a href='/Industry/Brand-Matters/CMO-Club.aspx'>CMO Club</a></li></ul>
...
<div>
    <img alt="" src="/getmedia/8c933e3e-2871-487a-b6fe-a389c75c04b6/IWP_5287.aspx?width=300&amp;height=199" style="width: 300px; height: 199px; float: right; margin: 10px;" />The CMO Club is an exclusive, invitation only VIP program open to a select list of marketing and advertising executives.<br />
&nbsp;<br />
Participants in the CMO Club at CES experience the most influential technology show in the world from a unique, executive level perspective.<br />
&nbsp;<br />
CMO Club benefits include:
<ul>
	<li>
		Free access to the CES show floor</li>
	<li>
		Access to the CMO Club lounge on the show floor</li>
	<li>
	...
	<li>
		Priority VIP passes to Keynote Addresses (quantity is limited)</li>
	<li>
		20% discount on the <a href="http://cesweb.org/Conference-Program/Conference-Pricing.aspx#entertainment">Entertainment Matters Conference Pass</a></li>
	<li>
		Access to a hotel block at the Bellagio available on a first-come, first-served basis</li>
</ul>
<br />
<strong>CMO Club Show Floor Tours</strong><br />
Bespoke to marketing communities, the CMO Club also offers highly curated CES Show Floor Tours, led by industry experts.<br />
