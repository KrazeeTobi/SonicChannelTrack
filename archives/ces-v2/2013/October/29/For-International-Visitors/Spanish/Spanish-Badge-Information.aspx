...
<head id="head"><title>
	Informaci&#243;n sobre las identificaciones para la CES - 2014 International CES, January 7 - 10
...
<meta name="twitter:title" content="Información sobre las identificaciones para la CES">
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/Spanish/Spanish-Badge-Information.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/Spanish/Spanish-Badge-Information.aspx" >Informaci&#243;n sobre las identificaciones para la CES</a></li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='spanish'><a href='/For-International-Visitors/Spanish.aspx'>Español</a></li><li class='spanish-badge-information end'><a href='/For-International-Visitors/Spanish/Spanish-Badge-Information.aspx'>Información sobre ...</a></li></ul>
...
<div class="headerbox">
      <h1>Información sobre las identificaciones para la CES</h1>
</div>
<div style="float: right;">
    
</div>
<div>
    En CES Internacional, el principal evento sobre innovación del mundo, hacemos todo lo posible para que la tecnología mejore su experiencia. Este año, gracias a las nuevas identificaciones con mejor funcionalidad y facilidad de uso, las esperas serán más cortas. Las nuevas identificaciones tendrán tecnología de comunicación de campo cercano (NFC), que nos permite acceder a la información y actualizarla rápida y eficazmente.<br />
<br />
<strong>Un cambio importante en la CES 2014 </strong>es que las identificaciones <strong><u>NO</u></strong> se enviarán por anticipado. Una vez que se inscriba y reciba la confirmación, podrá recoger su identificación cuando llegue a Las Vegas. Debajo se incluye una lista completa de los sitios donde puede hacerlo. Sin embargo, para registrarse en forma más rápida y eficiente, le recomendamos que no espere a llegar al sitio del evento. Simplemente recoja su credencial en el aeropuerto McCarran mientras espera su equipaje, o después de registrarse en uno de los hoteles oficiales de la CES.<br />
<div>
	<img alt="" src="/getmedia/6dc56385-0685-40b6-bd68-6369d1f6db16/badge-page.aspx?width=300&amp;height=301" style="width: 300px; height: 301px; border: 10px solid rgb(0, 0, 0); float: right; margin: 10px;" /><strong>Lugares fuera del evento donde puede recoger su identificación:</strong></div>
<div>
	<ul>
		<li>
			McCarran Airport, Terminal 1 Baggage Claim</li>
		<li>
			McCarran Airport, Terminal 3 Baggage Claim</li>
		<li>
			ARIA</li>
		<li>
			Circus Circus</li>
	...
	<strong>Lugares en el evento donde puede recoger su identificación:</strong><br />
	<ul>
		<li>
			LVH, Ballroom Foyer</li>
		<li>
			LVCC, North Hall 3 Lobby</li>
		<li>
			LVCC, Central Lobby, Patio</li>
		<li>
			LVCC, Central Hall 2, Entrance</li>
		<li>
			LVCC, South Hall 1, Patio</li>
		<li>
			LVCC, South Hall 1, Front Lobby</li>
		<li>
			LVCC, South Hall 2, Lobby</li>
		<li>
			LVCC, South Hall Connector, Outside S229 (Press Only)</li>
		<li>
			Venetian, Level 1, Meeting Space</li>
		<li>
			Venetian, Level 2, Foyer</li>
		<li>
			Venetian, Tower Elevator Bank Entrance</li>
	</ul>
	Este año, para verificar sus datos y recibir la identificación de la CES, solo tendrá que mostrar un documento de identidad emitido por el gobierno (licencia de conductor o pasaporte) y el código QR de su página de confirmación (en papel o a través de un teléfono, una tableta o computadora portátil). Recuerde por favor que <u>todos</u> los asistentes, sin importar en qué categoría estén registrados, pueden recoger sus identificaciones en cualquiera de los lugares indicados en el evento o fuera de él.<br />
	&nbsp;</div>
<br />
