...
<head id="head"><title>
	IOE01 - What Can We Make Possible with the Internet of Everything? - 2014 International CES, January 7-10
...
<meta name="twitter:title" content="IOE01 - What Can We Make Possible with the Internet of Everything?">
...
<div>
    <h2>What Can We Make Possible with the Internet of Everything?</h2>
    <div class="leftTrackColumn">
      
      <div class="waysToBuy">
        <div id="addToCartIOE1" class="cartItem"></div>
      </div>
    </div>
    <h3>January 9, 2014, 3&#45;4 p.m.<br />
    LVCC, North Hall&nbsp;N260</h3>
    <div><p>What happens when we wake the world up and start connecting the 99 percent of everything that is not yet connected? What is the future effect of this immense amount of connectedness? This session will challenge you to imagine what the outcome could be and how to make it possible.</p></div>
...
<div class=""><strong>Presenter:</strong><div class=""><li>
  ...
  <strong>David &nbsp;Evans</strong>,&nbsp;Cisco Chief Futurist, Cisco Consulting Services, Cisco
</li></div></div>
</div> 
</ul>
