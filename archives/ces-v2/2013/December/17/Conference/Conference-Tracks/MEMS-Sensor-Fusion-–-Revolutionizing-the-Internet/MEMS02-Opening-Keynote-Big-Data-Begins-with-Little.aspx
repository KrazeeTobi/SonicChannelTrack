...
<head id="head"><title>
	MEMS02 - Opening Keynote: Big Data Begins with Little Data - 2014 International CES, January 7-10
</title><meta name="description" content="In this must-attend half-day conference session organized by MEMS Industry Group (MIG), attendees will engage with industry experts on how micro-electromechanical systems (MEMS) and sensor fusion will play a critical role in a more intelligent and intuitive Internet of Things." /> 
...
<meta name="twitter:title" content="MEMS02 - Opening Keynote: Big Data Begins with Little Data">
...
<div>
    <h2>Opening Keynote: Big Data Begins with Little Data</h2>
    <div class="leftTrackColumn">
      
      <div class="waysToBuy">
        <div id="addToCartMEMS2" class="cartItem"></div>
      </div>
    </div>
    <h3>January 8, 2014, 1:15&#45;2 p.m.<br />
    LVCC, North Hall&nbsp;N261</h3>
    <div><p>The IoT will be fueled by little data -- the data that comes from the billions of tiny sensors embedded all around us. These sensors are the foundation upon which new services and business models can be built. Their continued evolution will help to determine the long-term success of the IoT.</p></div>
...
<div class=""><strong>Keynote:</strong><div class=""><li>
  ...
  <strong>Michael &nbsp;Muller</strong>,&nbsp;CTO, ARM
</li></div></div>
</div> 
</ul>
