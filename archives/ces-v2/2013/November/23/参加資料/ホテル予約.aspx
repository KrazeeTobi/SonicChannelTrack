...
<head id="head"><title>
	ホテル予約 - 2014 International CES, January 7-10
...
<meta name="twitter:title" content="ホテル予約">
            ...
            <div class="three-fourth">
                <div class="body-content">
                    ...
                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                             ...
                             <li class="bread-div">|</li><li><a href="/%e5%8f%82%e5%8a%a0%e8%b3%87%e6%96%99.aspx" class="CMSBreadCrumbsLink">参加資料</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">ホテル予約</span>
</li>
                    ...
                    <div class="article-content-area">
                       ...
                       <p>
	皆様の旅行プランをお手伝いするため、CESではラスベガス選りすぐりのホテルと交渉し、割引料金を提供しています。<br />
	<br />
	ホテルと料金の全リストは <a href="/Register-Plan/Hotel.aspx">www.CESweb.org/hotel</a> (英語のみ) をご覧ください。CES向け料金でのご利用には、<a href="/Register-Plan/Hotel.aspx">www.CESweb.org/hotel</a> でホテル名を選択し、直接ホテルにご予約いただく必要があります。このサイトから直接ホテルの予約ページに移行し、そこでクレジットカード情報を入力することができます。多くのCESホテルではすでに満室か、またはCES特別価格分がすでに予約済みとなったため、オーバーフローのためのホテル (CESシャトルサービスはありません) のリストがCESウェブサイトに追加されました。<br />
	<br />
	20部屋以上のご予約が必要な場合は、<a href="/Register-Plan/Hotel/Reserve-a-Room-Block.aspx">http://www.cesweb.org/Register-Plan/Hotel/Reserve-a-Room-Block</a>, でご希望のホテル名を直接リクエストしていただいても結構です。お客様のリクエストは直接ホテルに伝えられ、ホテル側から3営業日以内に返答が届きます。<br />
	<br />
	注意：CEA/CESの宿泊斡旋代理店や機関はありません。もし、公式CES宿泊斡旋代理店であると自称する代理店や機関からの連絡があった場合、それは虚偽です。<br />
	<br />
	ご質問は、<a href="mailto:CEShotels@CE.org">CEShotels@CE.org</a> までメールでお問い合わせください。</p>
