...
<meta name="twitter:title" content="Lounges and Meeting Space">
<meta name="twitter:description" content="Explore sponsorship opportunities for lounges and meeting space. ">
...
<body class="LTR ENUS ContentBody" >
    <form method="post" action="/Exhibitors/Branding-Opportunities/Sponsorships/Lounges-and-Meeting-Space.aspx" id="form">
...
<li class='left-current'> <a href='/Exhibitor/Branding-Opportunities/Sponsorships/Lounges-and-Meeting-Space'>Lounges and Meeting Space </a></li>
            ...
            <div class="three-fourth">
                <div class="body-content">
                    ...
                    <div class="breadcrumbs-article">
                        <ul class="breadcrumbs-left">
                            <li>
                             ...
                             <li class="bread-div">|</li><li><a href="/Exhibitors.aspx" class="CMSBreadCrumbsLink">Exhibitors</a> </li><li class="bread-div">|</li><li> <a href="/Exhibitor/Branding-Opportunities.aspx" class="CMSBreadCrumbsLink">Branding Opportunities</a> </li><li class="bread-div">|</li><li> <a href="/Exhibitors/Branding-Opportunities/Sponsorships.aspx" class="CMSBreadCrumbsLink">Sponsorships</a> </li><li class="bread-div">|</li><li> <span  class="CMSBreadCrumbsCurrentItem">Lounges and Meeting Space</span>
</li>
                    ...
                    <div class="article-content-area">
                       ...
                       <div>
	<p>
		<strong>CEA Member Lounges<img alt="" src="/CES/media/2014/landing%20pages/for%20exhibitors/CEAlogo.jpg" style="width: 200px; height: 70px; float: right; margin: 10px;" /></strong></p>
</div>
<div>
	<p>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Choose from any of these sponsorship options:</p>
	...
	<p style="margin-left: 40px;">
		...
		&nbsp;<br />
		<strong>Sponsorship Investment:&nbsp;</strong>$7,500<br />
		&nbsp;</p>
	<div align="center">
		<hr align="center" size="2" width="100%" />
	</div>
	...
	<p style="margin-left: 40px;">
		...
		&nbsp;<br />
		<strong>Sponsorship Investment:&nbsp;</strong>$10,000</p>
	<p>
		&nbsp;<br />
		Contact us at&nbsp;<a href="mailto:ltardif@CE.org?subject=Interested%20in%20CEA%20Member%20Lounge%20Sponsorships">ltardif@CE.org</a>&nbsp;or 703-907-7681 to secure these opportunities.</p>
	<hr />
	<p>
		<br />
		...
		<br />
		Located in the Las Vegas Convention Center and The Venetian, the ICC&nbsp;is a&nbsp;popular destination for non-U.S. attendees. The ICC&rsquo;s include:</p>
	<ul>
		<li>
			<p>
				Internet stations for email and online access</p>
		</li>
		<li>
			<p>
				Private meeting rooms available by appointment</p>
		</li>
		<li>
			<p>
				A multilingual staff&nbsp;</p>
		</li>
		<li>
			<p>
				Complimentary coffee, tea and pastries, available every morning&nbsp;</p>
		</li>
		<li>
			<p>
				Complimentary refreshments during the afternoon</p>
		</li>
		<li>
			<p>
				U.S. Department of Commerce staff that provide export counseling and matchmaking services for U.S. exhibitors and foreign buyers</p>
		</li>
	</ul>
	<p>
		This promotional opportunity extends far beyond the walls of the ICC. You&rsquo;ll receive months of exposure with the following promotions:</p>
	<ul>
		<li>
			<p>
				Recognition in all preshow and on-site materials referencing the ICC</p>
		</li>
		<li>
			<p>
				Signs and banners in the ICC</p>
		</li>
		<li>
			<p>
				The opportunity to display literature in the ICC</p>
		</li>
		<li>
			<p>
				Your homepage up on the Internet stations in the ICC</p>
		</li>
		<li>
			<p>
				Electronic direct mail to all pre-registered international attendees (approx. 25,000) with your logo and information included</p>
		</li>
	</ul>
	<p>
		<strong>Sponsorship Investment:&nbsp;</strong>Call for details<br />
		&nbsp;<br />
		Contact us at&nbsp;<a href="mailto:byb@CE.org?subject=Interested%20in%20ICC%20Sponsorship">byb@CE.org</a>&nbsp;or 703-907-4324 to secure this opportunity.</p>
</div>
<br />
