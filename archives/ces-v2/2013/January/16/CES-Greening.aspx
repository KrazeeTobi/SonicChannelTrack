...
<head id="head"><title>
	2014 International CES, January 7 - 10 - CES Greening
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/CES-Greening.aspx" id="form">
...
<div><h1 style="font-size: 30px; color: rgb(51, 51, 51); text-align: left; background-color: rgb(255, 255, 255); ">
	An Eco-Friendly Global Event</h1>
</div>
<br /><div><h2>
	<strong>The World&#39;s Largest Annual Innovation Event is also the Greenest</strong></h2>
The world&#39;s largest annual innovation event is also the greenest. Trade Show Executive Magazine recently names the 2012 International CES as the tradeshow with the &ldquo;Most Innovative Green Initiatives by Show Management.&rdquo; In 2010, the publication previously named the International CES North America&#39;s Greenest Show.</div><div>
<br>
<hr class="separator">
<br>
<a name="437"><span style="display: none">Attendees: A smaller footprint with bigger opportunities</span></a>
<div class="sub-content-header">Attendees: A smaller footprint with bigger opportunities</div><br/>

<p>The International CES provides our industry an opportunity to convene at one time, in one place, at an eco-friendly blockbuster that minimizes your annual travel.
<ul>
	<li>
		CES attendees connect with one another, get business done and collectively avoid 1.97 million miles in business trips that they otherwise would have to take if not for the International CES</li>
	<li>
		Representatives travel from more than 150 different countries, offering a truly global opportunity.</li>
</ul>
</p>
<br><br>
<hr class="separator">
<br>
<a name="436"><span style="display: none">How Green Is The International CES?</span></a>
<div class="sub-content-header">How Green Is The International CES?</div><br/>

<p>The 2013 International CES will include a vast array of green initiatives as part of our efforts to reduce waste and give back to the local Las Vegas community.<br />
<ul>
	<li>
		For the second year, production of more than 190,000 badge holders made by <a href="http://www.repurposeamerica.org/" target="_blank">Repurpose AMERICA</a> from vinyl banners from the 2012 International CES</li>
	<li>
		Collection of more than 80,000 square feet of magnetic and vinyl banners &ndash; more than 20,000 pounds of magnetic material alone &ndash; in cooperation with key exhibitors to repurpose even more post show waste</li>
	<li>
		Collection of discarded publications and show collateral with a goal to surpass last year&rsquo;s collection of 50,000 pounds</li>
	<li>
		All of our interior show signs were produced with an eco-friendly Falcon-board material</li>
	<li>
		Increase reuse/recycle rate for solid waste generated at the show beyond last year&rsquo;s high of 75 percent</li>
	<li>
		Use of recyclable carpet for all exhibit floor aisles, TechZones, Registration areas and turnkey booth packages</li>
	<li>
		Development of turnkey booth packages with recyclable panels and graphics printed using soy ink</li>
	<li>
		Print production reduction by nearly 50 percent from six years ago; remaining print materials are printed on recycled paper, use soy-based ink and meet the standards of the Sustainable Forest Initiative and Forest Stewardship Council</li>
	<li>
		Mandate of paperless exhibitor press kits online, or via USB or DVD&nbsp;</li>
</ul>
&nbsp;<br />
On January 7, 2013, The Consumer Electronics Association will continue its tradition of supporting projects that promote sustainability in the city of Las Vegas and benefit the local community. 2012 International CES recipients include:<br />
<ul>
	<li>
		$50,000 to Green Chips, a non-profit organization promoting carbon neutrality, which will use the funds to install solar panels at the Las Vegas Rescue Mission. In 2011, we donated $75,000 to Green Chips for a similar project at the Salvation Army and saw that project come to fruition in 2011</li>
	<li>
		$25,000 to Repurpose AMERICA for sun shades, one of which was installed at the UNLV Rebel Recycling Center in June 2013</li>
</ul>
<img alt="" src="/getmedia/54e4f1a9-358b-47b2-96fc-b6d39c7d8968/samsunglogogreen.aspx?width=250&amp;height=191" style="width: 250px; height: 191px; float: left;" /><br />
<br />
<br />
<br />
<br />
...
<br />
<br />
<strong>Official green sponsor of the 2013 International CES</strong></p>
<br><br>
<hr class="separator">
<br>
<a name="438"><span style="display: none">Green Exhibits at CES</span></a>
<div class="sub-content-header">Green Exhibits at CES</div><br/>
<img style ='float: right; margin: 0 5px 5px 5px;' src="/cesweb/media/CESWeb/TechZones/CES_TZ_SustainablePlanet_200.jpg"/>
<p><a href="http://cesweb.org/techzones#4jump">The Sustainable Planet TechZone</a> at The Venetian showcases the latest in eco-friendly products and energy efficiency technologies. It highlights the latest products that make it possible for every person on this planet to stay connected and informed, and live sustainable lifestyles through advances in green building, alternative energy technologies, green business services and solutions, smart grid technologies, solar and renewable products, sustainable packaging and wireless convergence.&nbsp;<br />
</p>
<br><br>
<hr class="separator">
<br>
<a name="435"><span style="display: none">Get Charged Up About Electric Vehicles</span></a>
<div class="sub-content-header">Get Charged Up About Electric Vehicles</div><br/>
<img style ='float: right; margin: 0 5px 5px 5px;' src="/cesweb/media/CESWeb/TechZones/CES_TZ_GoElecDrive_200.jpg"/>
<p>The <a href="http://cesweb.org/techzones#7jump">GoElectricDrive TechZone</a> in the LVCC North Hall showcases a full range of high and low-speed electric vehicles, energy storage devices and charging solutions. Sponsored by the Electric Drive Transportation Association, this TechZone highlights an area of great potential and growth for the industry as electric vehicles are quickly gaining in popularity among consumers seeking to live more sustainably by using alternative transportation.<br />
</p>
<br><br>
<hr class="separator">
<br>
<a name="898"><span style="display: none">CEA Members Among the World’s Greenest Companies</span></a>
<div class="sub-content-header">CEA Members Among the World’s Greenest Companies</div><br/>

<p>CEA member companies IBM, Hewlett-Packard, Dell, Nvidia, Intel, Accenture and Microsoft took seven of the top 15 spots on <a href="http://www.thedailybeast.com/newsweek/features/2012/newsweek-green-rankings.html" target="_blank"><em>Newsweek&rsquo;s </em>list of the World&rsquo;s Greenest Companies</a>, according to environmental impact, management and transparency.</p>
<br><br>
<hr class="separator">
<br>
<a name="441"><span style="display: none">Greener Gadgets</span></a>
<div class="sub-content-header">Greener Gadgets</div><br/>

<p><a href="http://www.greenergadgets.org" target="_blank"><img alt="" src="http://staging.cesweb.org/getmedia/6755955f-fa83-499c-9a71-6f75b991e0a3/greenergadgets.aspx?width=250&amp;height=25" style="width: 250px; height: 25px; " /></a><br />
<br />
CEA operates&nbsp;<a href="http://www.greenergadgets.org" target="_blank">GreenerGadgets.org</a>, an online resource for consumers that highlights the industry trend toward &ldquo;greener gadgets&rdquo; &ndash; smaller, smarter, more energy efficient devices that can do more than ever before. Tech-savvy shoppers now have more eco-friendly options, and this resource has valuable information about how to buy green electronics, use them efficiently and recycle them at the end of their useful life.<br />
<br />
The site also features a powerful&nbsp;<a href="http://www.greenergadgets.org/Energy-Calc.aspx" target="_blank">energy use calculator</a>&nbsp;with the most up-to-date products and energy use figures to help consumers better understand their energy usage and a&nbsp;<a href="http://www.greenergadgets.org/Recycle-Electronics.aspx" target="_blank">recycling locator tool</a>. When it comes to end-of-life electronics many people are concerned with what happens after they drop off their products. The recycling locator database includes industry programs, which use strict standards, and third-party certified recyclers, so rest assured your device will be safely recycled!<br />
</p>
<br><br>
<hr class="separator">
<br>
<a name="439"><span style="display: none">CEA highlights green research</span></a>
<div class="sub-content-header">CEA highlights green research</div><br/>

<p>From trends in eco-friendly TVs to illuminating detail about consumer attitudes on energy efficiency with consumer electronics, CEA has the latest research. Visit <a href="http://www.ce.org/green">www.CE.org/green</a> for more information.&nbsp;<br />
</p>
<br>
</div> 
