...
<head id="head"><title>
	2014 International CES, January 7 - 10 - Startup America Live at Eureka Park
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Events/Startup-America-Live-at-Eureka-Park.aspx" id="form">
...
<div class="headerbox">
      <h1>Startup America Live at Eureka Park</h1>
</div>
<div style="float: right;">
    
</div>
<div>
    <strong>January 8-11 schedule: </strong><a href="http://www.s.co/eurekapark">http://www.s.co/eurekapark</a> <strong><img alt="" src="/cesweb/media/CESWeb/Events/CES-867-sap_whtbck.jpg" style="float: right; margin: 10px;" /><br />
The Venetian, Eureka Park</strong><br />
&nbsp;<br />
CEA has teamed up with the Startup America Partnership to showcase and celebrate some of the most innovative companies at the 2013 International CES. Startup America Live at Eureka Park will consist of daily programming featuring fireside chats with iconic entrepreneurs, panels with leading investors, corporate execs and media, and office hours to connect startups directly with the experts. Visit <a href="http://www.s.co/eurekapark">http://www.s.co/eurekapark</a> for a full list of programming, including an opening conversation with Tony Hsieh, founder of Zappos.<br />
