...
<head id="head"><title>
	2014 International CES, January 7 - 10 - Session Schedule
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<a class='lefttopnavhead' href='/Conference-Program'>Conference Program</a>
	<ul id="menuElem">
		...
		<li class="highlighted"><a href="/Conference-Program/Session-Schedule.aspx" >Session Schedule</a></li>
...
<script id="tmplLocation" type="text/x-jquery-tmpl">
   ...
   <div class="expand borderStuff" id="SessionDetail${ID}">
    <div class="header">
     ...
     <div>
     <div style="float: right;">{{html formatHelpers.displaySponsorLogos(SponsorLogos)}}</div>{{html Description}}
     </div>
