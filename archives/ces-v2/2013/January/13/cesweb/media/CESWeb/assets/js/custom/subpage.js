(function($){
	$(document).ready(function(){
		...
		$.getScript(url+'/cesweb/media/CESWeb/assets/js/custom/rollOver.js');
	//	$.getScript(url+'/cesweb/media/CESWeb/assets/js/plugins/flashDetect.js');
		$.getScript(url+'/cesweb/media/CESWeb/assets/js/custom/emailPage.js');
		
		$.getScript(url+'/cesweb/media/CESWeb/assets/js/plugins/jquery-expander.js', function(){
		...
		for(var i = 1;i <= 3;i++){
			$(".preload").append('<img src="/cesweb/media/CESWeb/assets/images/sliders/arrow_left'+i+'.png" style="display: none;" />');
			$(".preload").append('<img src="/cesweb/media/CESWeb/assets/images/sliders/arrow_right'+i+'.png" style="display: none;" />/>');
		}
		...
		$(".sub-page-slider-right").mousedown(function(){
			$(this).css({"background":"url('/cesweb/media/CESWeb/assets/images/sliders/arrow_right3.png') no-repeat 0px 0px"});
		}).mouseup(function(){
			$(this).css({"background":"url('/cesweb/media/CESWeb/assets/images/sliders/arrow_right2.png') no-repeat 0px 0px"});
			$(this).hover(function(){
				$(this).css({"background":"url('/cesweb/media/CESWeb/assets/images/sliders/arrow_right2.png') no-repeat 0px 0px"});
			},function(){
				$(this).css({"background":"url('/cesweb/media/CESWeb/assets/images/sliders/arrow_right1.png') no-repeat 0px 0px"});
			});
		});
		$(".sub-page-slider-left").mousedown(function(){
			$(this).css({"background":"url('/cesweb/media/CESWeb/assets/images/sliders/arrow_left3.png') no-repeat 0px 0px"});
		}).mouseup(function(){
			$(this).css({"background":"url('/cesweb/media/CESWeb/assets/images/sliders/arrow_left2.png') no-repeat 0px 0px"});
			$(this).hover(function(){
				$(this).css({"background":"url('/cesweb/media/CESWeb/assets/images/sliders/arrow_left2.png') no-repeat 0px 0px"});
			},function(){
				$(this).css({"background":"url('/cesweb/media/CESWeb/assets/images/sliders/arrow_left1.png') no-repeat 0px 0px"});
			});
		});
...
function initMenu() {
// this first bit should be deprecated once the new CES left nav launches.
	$('#menu ul').hide();
    ...
    $('.leftNavSpecial').find('ul:first').hide();
    $('.leftNavSpecial a').hover(function () {
        var checkElement = $(this).next();
        if ((checkElement.is('ul')) && (!checkElement.is(':visible'))) {
            $('.leftNavSpecial').find('ul:first:visible').slideUp('normal');
            checkElement.slideDown('normal');
            return false;
        }
    });
