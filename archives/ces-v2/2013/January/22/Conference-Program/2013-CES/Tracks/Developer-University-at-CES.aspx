...
<head id="head"><title>
	2014 International CES, January 7 - 10 - Developer University at CES
...
(function ($) {
    $(document).ready(function() {
        if ( !jQuery('#menuElem').find('li').hasClass('HighLighted') ) jQuery('#menuElem').find('li:first').addClass('HighLighted');
        $('.st_tab_view').css('display', '').css('position', '');
        //$('.st_tab_view').removeClass('st_tab_view st_ext');
        $(".st_tab_view").delegate("a.sessionPopup", "click", function(event){
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Conference-Program/2013-CES/Tracks/Developer-University-at-CES.aspx" id="form">
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='conference-program first'><a href='/Conference-Program.aspx'>Conference Program</a></li><li class='tracks'><a href='/Conference-Program/2013-CES/Tracks.aspx'>Tracks</a></li><li class='developer-university-at-ces end'><a href='/Conference-Program/2013-CES/Tracks/Developer-University-at-CES.aspx'>Developer ...</a></li></ul>
