...
<head id="head"><title>
	2014 International CES, January 7 - 10 - 国際サービス
...
<a name="214"><span style="display: none">国際参加者登録エリア </span></a>
<div class="sub-content-header">国際参加者登録エリア </div>

<p><em>LVCC</em><em>、</em><em>CES </em><em>セントラル・プラザ・メイン登録エリア</em><br />
<br />
LVCCのCESセントラル・プラザに、国際参加者用の特別登録エリアが設けられています。ここで、当日登録やバッジホルダーの受取りができます。また、特別通訳サービスもご利用いただけます。<br />
</p>
<hr class="separator" /><a name="215"><span style="display: none">インターナショナル・コマース・センター (ICC) </span></a>
<div class="sub-content-header">インターナショナル・コマース・センター (ICC) </div>

<p>LVCC、サウスホール・コネクター、S224～S225号室<br />
新規追加： ザ・ベネチアン 1階 Marco Polo<br />
<br />
インターナショナル・コマース・センター (ICC) では、海外からの参加者と展示企業専用のビジネスサービスが提供されています。ここには、個室ミーティングルーム (ご予約は先着順)、会社と連絡をとることができるインターネットアクセス付きコンピューター、同業者の方との待ち合わせや、多忙なショー会場を抜けておくつろぎいただけるラウンジエリアが用意されています。必要に応じて通訳サービスもご利用いただけます。<br />
</p>
<hr class="separator" /><a name="216"><span style="display: none">グローバル・マッチメーキング & インターナショナル・レセプション</span></a>
<div class="sub-content-header">グローバル・マッチメーキング & インターナショナル・レセプション</div>

<p>2013年1月8日 (火)<br />
6:00～7:30 p.m.<br />
<strong>LVCC、サウスホール・コネクタ、S222室</strong><br />
<br />
海外からの来場者、出展者、メディア関係者の全員がCESのインターナショナル・レセプションに招待されます。本レセ プションは海外から参加されている方のみが入場できます。人々との新たな出会い、同僚とのビジネスについての議論や、ビジネスパートナー関係を新たに結ぶ 絶好のチャンスである本レセプションに、是非ともご参加ください。今年は、本レセプションにおいて海外での事業展開を模索している米国企業向けに、米国商 務省による仲介プログラムが用意されます。会場にて皆様にお目にかかれることを楽しみにしています!</p>
<hr class="separator" /><a name="217"><span style="display: none">通訳サービス</span></a>
<div class="sub-content-header">通訳サービス</div>

<p>LVCC ICCおよび下記の登録エリアでは、通訳スタッフがお手伝いいたします：&nbsp; LVCC、CESセントラル・プラザ・メイン登録エリア、および ザ・ベネチアン 2階ベネチアン・ボールルーム・フォイヤー、展示企業登録エリア。通訳サービスは、スペイン語、フランス語、中国語、日本語、韓国語を含む複数の言語がご利用いただけます。国際登録エリアでこのサービスが必要になった場合は、「Interpretation Services (通訳サービス)」カウンターまでお申し付けください。ミーティングのために通訳を雇う必要がある場合は、下記の通訳会社により通訳サービスが利用できます。<br />
<ul>
	<li>
...
<hr class="separator" /><a name="218"><span style="display: none">国際バイヤープログラム</span></a>
<div class="sub-content-header">国際バイヤープログラム</div>

<p>インターナショナルCESは、米国商務省、国際通商局が後援する国際 バイヤープログラム（IBP）に参加しています。米国商務省の国際貿易スペシャリストがメインICC(LVCC南ホールコネクタ、S224/225号室) に待機しており、海外の来場者や出展社に出会いの場や輸出カウンセリングを提供します。</p>
