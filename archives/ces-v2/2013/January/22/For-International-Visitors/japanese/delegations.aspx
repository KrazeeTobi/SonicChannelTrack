...
<head id="head"><title>
	2014 International CES, January 7 - 10 - 代表団プログラム
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/japanese/delegations.aspx" id="form">
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/japanese/delegations.aspx" >代表団プログラム</a></li>
			...
			<li><a href="/For-International-Visitors/japanese/%e5%88%9d%e3%82%81%e3%81%a6%e3%81%93%e5%8f%82%e5%8a%a0%e3%81%ae%e6%96%b9%e3%81%ae%e3%81%9f%e3%82%81%e3%81%ae%e6%83%85%e5%a0%b1.aspx" >初めてご参加の方のための情報 </a></li>
		</ul>
		</li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='japanese'><a href='/For-International-Visitors/japanese.aspx'>日本語</a></li><li class='delegations end'><a href='/For-International-Visitors/japanese/delegations.aspx'>代表団プログラム</a></li></ul>
    ...
    <div id="inner-content-left">
        インターナショナルCESへの業界専門家の団体派遣にご興味がおありですか？ CEAでは公式代表団プログラムをご用意し、代表団リーダーと代表団メンバーの方にさまざまなメリットをお届けしています。代表団リーダーの方には、ショー会場で何を見、誰に会うか計画を立てる際にお手伝いいたします。これによりCESへの出張の価値を皆様に最大限にご活用いただけます。代表団リーダーのご登録は12月1日締切りです。ご質問やご懸念等は、どうぞ<a href="mailto:delegations@ce.org">お問い合わせください</a>。<br />
<br />
代表団プログラム参加者の特典のひとつに、ショー登録料が無料になることが挙げられます。代表団に参加し、8月31日過ぎにCESに登録なさる場合、事前登録料金$100は免除されます。<br />
<br />
...
<ul>
	<li>
		代表団プログラムは米国外からの参加者のみが対象となります。<br />
		&nbsp;</li>
	<li>
		代表団は、消費者向けエレクトロニクス業界のビジネスに携わる方々で構成されていなければなりません。<br />
		&nbsp;</li>
	<li>
		代表団は15人以上である必要があります。15人未満のグループは、個人個人で参加登録が必要となります。</li>
</ul>
<strong>代表団リーダーの特典</strong>
<ul>
	<li>
		CESに50人 (政府関係団体の場合は15人) を率いて参加する代表団のリーダーの方は、ホテル滞在が無料となります。団体は、CESの4週間前までに確認が必要です。この期限に確認されない場合、宿泊は保証されません。<br />
		&nbsp;</li>
	<li>
		プログラムの特典を受けるための重要な期日や締切りを含む、代表団プログラムとCESに関する最新情報が記載された、電子ニュースレター。<br />
		&nbsp;</li>
	<li>
		参加者募集に役立つ、宣伝パンフレットと電子テンプレート。<br />
		&nbsp;</li>
	<li>
		&nbsp;宣伝資料に利用するためのCESロゴ (マーケティング資料はCESの事前承認が必要です)。<br />
		&nbsp;</li>
	<li>
		Exhibits Plusパス無料サービス (このパスで、展示ショー会場、基調講演、SuperSession、一部のカンファレンスセッションへのアクセスが可能になります)。<br />
		&nbsp;</li>
	<li>
		代表団メンバーをオンラインで登録でき、変更や新メンバー追加もオンラインで可能。<br />
		&nbsp;</li>
	<li>
		CES開催期間中、CES代表団リーダー感謝ディナーにご招待。<br />
		&nbsp;</li>
	<li>
		海外からの参加者と展示企業専用の、インターナショナル・コマース・センター (ICC) へのアクセス。ここには、無料サービスのインターネットステーション、軽いスナックとお飲み物、通訳サービス、個室ミーティングルームが用意されています。<br />
		&nbsp;</li>
	<li>
		グローバル・マッチメーキング &amp; インターナショナル・レセプションにご招待。無料でお食事とお飲み物を楽しみながら、他の海外からの参加者とネットワークを築くことができます。</li>
</ul>
<a href="/default.aspx">代表団リーダーとしての登録は、ショーご参加の登録にはなりませんのでご注意ください</a>。公式のインターナショナルCES登録プロセスによって登録を完了し、登録証を受け取る必要があります。<br />
<br />
<strong>代表団メンバーの特典</strong>
<ul>
	<li>
		Exhibits Plusパス無料サービス (このパスで、展示ショー会場、基調講演、SuperSession、一部のカンファレンスセッションへのアクセスが可能になります)。<br />
		&nbsp;</li>
	<li>
		海外からの参加者・展示企業に、マッチメーキング支援と輸出カウンセリングを提供する、米国商務省の国際貿易スペシャリストへのアクセス。<br />
		&nbsp;</li>
	<li>
		CESグローバル・マッチメーキング &amp; インターナショナル・レセプションにご招待。 &nbsp;<br />
		&nbsp;</li>
	<li>
		その代表団の国や地域に輸出を行っている、あるいは輸出に関心を示している、輸出業者のリスト。<br />
		&nbsp;</li>
	<li>
		海外からの参加者と展示企業専用の、インターナショナル・コマース・センター (ICC) へのアクセス。ここには、無料サービスのインターネットステーション、軽いスナックとお飲み物、通訳サービス、個室ミーティングルームが用意されています。<br />
		&nbsp;</li>
	<li>
		代表団の国の消費者向けエレクトロニクスの業界専門家の方々と一緒に旅行するチャンス。<br />
		&nbsp;</li>
	<li>
		グローバル・マッチメーキング &amp; インターナショナル・レセプションにご招待。無料でお食事とお飲み物を楽しみながら、他の海外からの参加者とネットワークを築くことができます。</li>
</ul>
<strong>米国商務省の国際的バイヤープログラム</strong><br />
<br />
...
<br />
各国の大使館または領事館にある商務部スペシャリストが、ショーの登録をお手伝いし、ショーで買い付けを行いたい製品探しや、米国企業とのミーティングのセットアップをお手伝いすることができます。IBPの一環として、海外から数多くの商務スペシャリストがCESへ代表団を率いて参加します。<a href="http://export.gov/eac/index.asp" target="_blank">お近くの商務部貿易スペシャリストにご連絡ください。</a><br />
<br />
CES代表団プログラムに関するご質問やご懸念は、<a href="mailto:delegations@ce.org?subject=Delegation%20Program">delegations@CE.org</a>にお寄せください。<br />
<br />
<br />
<br />
...
<li><a href="/For-International-Visitors/Espanol"></a></li>
	...
	<li>
		<a href="/cesweb/media/CESWeb/Documents/International/CES_General_Overview_Brochure_International.pdf" target="_blank">英語版総合パンフレット（PDF）</a></li>
	<li>
		<a href="/cesweb/media/CESWeb/Documents/International/CES_FactSheet_Japanese.pdf" target="_blank">日本語版CESファクトシート（PDF）</a></li>
	<li>
		<a href="/cesweb/media/CESWeb/Documents/International/CES_Delegation_Brochure.pdf" target="_blank">代表団向け各国語版パンフレット</a></li>
	<li>
		<a href="/cesweb/media/CESWeb/Documents/International/CES_Delegation_Program_Benefits.pdf" target="_blank">代表団リーダーと代表者の特典（英語版PDF）</a></li>
</ul>
</div>
    </div>
