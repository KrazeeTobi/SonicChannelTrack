...
<head id="head"><title>
	2014 International CES, January 7 - 10 - 旅行とビザ情報
...
<p><a href="/cesweb/media/CESWeb/Documents/International/CES_VisaTips_Japanese.pdf" target="_blank">ヘルプが必要な場合は、弊社のビザ関連説明書をダウンロードし</a>、順を追った説明やウェブサイトアドレスなどの情報でビザ申請手続きの助力を得てください。</p>
	...
	&nbsp;</h3>
<h3>
	ビザ免除プログラムでの参加者への重要なお知らせ</h3>
電子渡航認証システム (ESTA) の登録申請又は更新には手数料$14.00が必要です (クレジットカード又はデビットカードでお支払い)。現在のESTA申請は、有効期限日まで有効です。詳細については、<a href="http://cbp.gov/xp/cgov/travel/id_visa/esta/" target="_blank">国土安全保障省、税関国境警備局ウェブサイトのESTAウェブページ</a>をご覧ください。</div>
</div>
