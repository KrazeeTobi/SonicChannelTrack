...
<head id="head"><title>
	2014 International CES, January 7 - 10 - シャトルサービス
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/japanese/shuttles.aspx" id="form">
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/japanese/shuttles.aspx" >シャトルサービス</a></li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='japanese'><a href='/For-International-Visitors/japanese.aspx'>日本語</a></li><li class='shuttles end'><a href='/For-International-Visitors/japanese/shuttles.aspx'>シャトルサービス</a></li></ul>
...
<div>
時間も費用も節約！ CES公式ホテルに滞在すれば、ラスベガスコンベンション &amp; ワールドトレードセンター (LVCC) への送迎無料バスがご利用いただけ、タクシーやレンタカーの費用が節約できます。また、LVCC周辺、およびLVCC－ザ・ベネチアン間往復の無料シャト ルもご利用いただけます。ショー終わりの2日間は、空港までの無料シャトルサービスもご利用ください。
</div>
<hr class="separator" />

<a name="224"><span style="display: none">CESシャトルバスサービス</span></a>
<div class="sub-content-header">CESシャトルバスサービス</div>

<p>インターナショナルCESでは、4日間の開催期間中、無料シャトルサービスが提供されます。また、期間中にネットワークづくりやビジネス交渉で成果を上げた後、ご帰宅の際に、空港までのシャトルサービスもご利用いただけます。<br />
<a href="/cesweb/media/CESWeb/Hotel%20and%20Travel%20Images/Shuttle%20map/2013ShuttleMap_web_11-6.pdf">ダウンロードはこちらから。</a> </p>
<hr class="separator" /><a name="253"><span style="display: none">ホテルのシャトルバス</span></a>
<div class="sub-content-header">ホテルのシャトルバス</div>

<p>インターナショナルCESでは、月曜～金曜、ラスベガスコンベンションセンター (LVCC) と大半の公式ホテルとの間を往復する無料シャトルサービスがご利用いただけます。<a href="/Hotel-Travel/CES-Shuttle-Service.aspx">ルートや場所に関する詳細は、運行表をダウンロードしてください</a>。<br />
</p>
<hr class="separator" /><a name="225"><span style="display: none">ラスベガスコンベンションセンターシャトルループ</span></a>
<div class="sub-content-header">ラスベガスコンベンションセンターシャトルループ</div>

<p>ラスベガスコンベンションセンターの反対側まで行かなければならないときは、このシャトルをご利用いただくと、時間の節約になり、疲れた足を休めていただくことができます。このシャトルは10分間隔で運行され、ビル周囲の主要ポイント5か所で止まります。</p>
<hr class="separator" /><a name="226"><span style="display: none">ラスベガスコンベンションセンター連絡ゴルフカート</span></a>
<div class="sub-content-header">ラスベガスコンベンションセンター連絡ゴルフカート</div>

<p>ラスベガスコンベンションセンターではショー開催時間中、セントラルホール5裏とサウスホール1～2裏との間で、無料の連絡ゴルフカートサービスがご利用いただけます。 </p>
<hr class="separator" /><a name="227"><span style="display: none">ベネチアンエクスプレス</span></a>
<div class="sub-content-header">ベネチアンエクスプレス</div>

<p>月曜～木曜は7:30 a.m.～6:30&nbsp;p.m、金曜は7:30 a.m.～4:30 p.m.、ザ・ベネチアンとLVCCとの間に、10分間隔でエクスプレスシャトルサービスが運行されます。<br />
</p>
<hr class="separator" /><a name="254"><span style="display: none">マンダレイ・エクスプレス</span></a>
<div class="sub-content-header">マンダレイ・エクスプレス</div>

<p>プレス・デイである1月7日 (月) には、LVCCとの間をマンダレイ・エクスプレスが7:30 a.m.～5:30 p.m.の間運行されます。<br />
</p>
<hr class="separator" /><a name="228"><span style="display: none">空港シャトルサービス</span></a>
<div class="sub-content-header">空港シャトルサービス</div>

<p>ラスベガスコンベンションセンターおよびザ・ベネチアン (バス乗り場) からマッカラン国際空港までのシャトルサービスがご利用いただけます。料金はお一人様片道$5で、ショー終わりの2日間、30分間隔で運行されます。</p>
<hr class="separator" /><a name="229"><span style="display: none">乗客の指定乗降場</span></a>
<div class="sub-content-header">乗客の指定乗降場</div>

<p>LVCCでお知り合いやご同僚の送迎をご予定ですか？ 交通渋滞を緩和し、送迎をより安全なものにするため、CESではLVCCゴールドロットの一部を、自家用車用 (POV) に指定しています。ゴールドロットはParadiseとConvention Center Driveの角近くにあり、Convention Center Driveから入ります。<br />
<div>
	<br />
	注： 運転者は車内に留まる必要があります。駐車は禁じられています。</div>
</p>
