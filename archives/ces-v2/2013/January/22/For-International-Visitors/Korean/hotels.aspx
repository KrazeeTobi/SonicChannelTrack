...
<head id="head"><title>
	2014 International CES, January 7 - 10 - 호텔 예약
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/Korean/hotels.aspx" id="form">
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/Korean/hotels.aspx" >호텔 예약</a></li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='korean'><a href='/For-International-Visitors/Korean.aspx'>한국어</a></li><li class='hotels end'><a href='/For-International-Visitors/Korean/hotels.aspx'>호텔 예약</a></li></ul>
...
<br />
<span style="background-color: rgb(255, 255, 255); text-align: left; ">호텔 및 가격 목록은&nbsp;</span><a href="/Hotel-Travel/Hotel-Reservations.aspx"><span style="text-align: left;">www.CESweb.org/hote</span><span style="text-align: left;">l</span></a><span style="background-color: rgb(255, 255, 255); text-align: left; ">을 참고하십시오(영어로 제공). CES 할인가격을 획득하려면 모든 객실은 반드시&nbsp;</span><a href="/Hotel-Travel/Hotel-Reservations.aspx"><span style="text-align: left;">www.CESweb.org/hotel</span></a><span style="background-color: rgb(255, 255, 255); text-align: left; ">을 방문하여 호텔이름을 선택한 다음 직접 해당 호텔을 통해서 예약해야 합니다. 귀하는 해당 호텔의 예약 페이지로 안내되어 귀하의 신용카드 정보를 입력할 수 있게 됩니다.&nbsp;</span>대부분의 CES 호텔 객실은 매진되거나 CES 할인요금의 객실이 매진된 상태이므로, (CES 셔틀버스 서비스가 없는) 별도의 호텔 리스트가 CES 웹사이트에 추가되었습니다.<br />
<p style="text-align: left; background-color: rgb(255, 255, 255); ">
	20개 이상의 객실이 필요한 경우, <a href="/Hotel-Travel/Hotel-Reservations.aspx">http://www.cesweb.org/hotelTravel/blockRequest.asp</a>을 방문하여 원하는 호텔(들)을 선택한 다음 직접 예약 신청을 제출할 수 있습니다. 귀하의 신청은 해당 호텔(들)로 직접 전송되며, 호텔은 3일의 영업일 이내에 응답할 것입니다.</p>
주의사항: CEA/CES 숙소 담당기관 또는 사무소는 없습니다. CES의 공식 숙소 담당기관이라고 사칭하는 숙소 담당기관/사무소가 있으나 이는 사실이 아닙니다.<br />
<br />
질문사항이 있습니까? <a href="mailto:CEShotels@CE.org">CEShotels@CE.org</a>로 이메일을 보내주십시오.
</div>
