...
<head id="head"><title>
	2014 International CES, January 7 - 10 - 여행 및 비자 안내
...
<p>단계별&nbsp;설명을&nbsp;제공하는&nbsp;<a href="/cesweb/media/CESWeb/Documents/International/CES_VisaTips_Korean.pdf" target="_blank">비자&nbsp;안내서를</a>&nbsp;다운로드&nbsp;하십시오.&nbsp;&nbsp;비자&nbsp;신청&nbsp;절차에&nbsp;대한&nbsp;웹사이트&nbsp;주소와&nbsp;각종&nbsp;정보가&nbsp;제공됩니다.</p>
...
<p><a href="https://ceac.state.gov/genniv/">이제&nbsp;비자&nbsp;신청서를&nbsp;온라인으로&nbsp;접수시킬&nbsp;수&nbsp;있습니다</a><a href="https://ceac.state.gov/genniv/">.&nbsp;</a></p>
	...
	비자 면제 프로그램으로 여행하시는 참가자 여러분들을 위한 중요한 정보</h3>
모든 전자여행허가제(ESTA) 등록 신청 또는 갱신은 신용카드나 현금카드로 수수료 14달러 납부해야 합니다. 기존의 전자여행허가 (ESTA)는 만료일까지 유효합니다. 더 자세한 정보를 원하시면&nbsp;&nbsp;<a href="http://cbp.gov/xp/cgov/travel/id_visa/esta/" target="_blank">국토 안보부 (Department of Homeland Security)의 관세 및 국경 보안청 (Customs and Border Protection) 웹사이트에 있는 전자여행허가 (ESTA) 웹페이지를 방문하십시오</a>.</div>
</div>
