...
<body class="">
    <form method="post" action="error.aspx?aspxerrorpath=%2fCEA_CMS_Items%2fHandlers%2fgetUrlHash.ashx" id="form1">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKLTU2ODMyMjI1Mg9kFgICARBkZBYCAgEPZBYCAgEPZBYCAgEPZBYCZg9kFgICAQ8PFgIeB1Zpc2libGVnZBYCAgEPFgIeBXN0eWxlBQt3aWR0aDoxMDAlOxYCZg9kFgRmDxYCHwEFHndpZHRoOjEwMCU7d2hpdGUtc3BhY2U6bm93cmFwO2QCAg9kFgICAQ8PFgIfAGhkZGRV181NqD/r4ZMeYLiGbc7cuFLxJ3kt02SNKFLKC6rDnw==" />
</div>
...
//]]>
    ...
    <div id="titleElem_pnlTitle" class="PageTitleHeader">
        ...
        <table id="titleElem_titleTable" cellpadding="0" cellspacing="0" border="0" style="width:100%;">
                    ...
                    <img id="titleElem_imgTitle" class="PageTitleImage" alt="" src="/App_Themes/Default/Images/Others/Messages/error.png" />
                    <span id="titleElem_lblTitle" class="PageTitle">System error</span>
                </td>
						<td class="TextRight">
            ...
            <div id="PanelContent" class="PageContent">
                ...
                <span id="lblInfo">An error occurred processing your request at URL <strong>/CEA_CMS_Items/Handlers/getUrlHash.ashx</strong>.</span>
                <br />
                <br />
