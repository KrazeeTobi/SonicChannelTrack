...
<head id="head"><title>
	2014 International CES, January 7 - 10 - Hotel Reservations
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<td><span class="smallText">$89</span></td><td><span class="smallText">$89</span></td><td><span class="smallText">$99, Sold Out</span></td><td><span class="smallText">$89</span></td><td><span class="smallText">$89</span></td>
...
<td><span class="smallText">$314*</span></td><td><span class="smallText">CES Rate($395*) No longer available, prevailing rate applies</span></td><td><span class="smallText">CES Rate($395*) No longer available, prevailing rate applies</span></td><td><span class="smallText">$314*</span></td><td><span class="smallText">$194*</span></td>
...
<td><span class="smallText">CES Rate($325*) No longer available, prevailing rate applies</span></td><td><span class="smallText">$390*, Sold Out</span></td><td><span class="smallText">CES Rate($390*) No longer available, prevailing rate applies</span></td><td><span class="smallText">$399*</span></td><td><span class="smallText">$271*</span></td>
...
<td><span class="smallText">$58.95*</span></td><td><span class="smallText">$169.95*</span></td><td><span class="smallText">$169.95*</span></td><td><span class="smallText">$68.95*</span></td><td><span class="smallText">$68.95*</span></td>
...
<td><span class="smallText">$68.95*</span></td><td><span class="smallText">$159.95*, Sold Out</span></td><td><span class="smallText">$159.95*, Sold Out</span></td><td><span class="smallText">$73.95*</span></td><td><span class="smallText">$73.95*</span></td>
...
<td><span class="smallText">$87*</span></td><td><span class="smallText">$160*</span></td><td><span class="smallText">$170*</span></td><td><span class="smallText">$87*</span></td><td><span class="smallText">$80*</span></td>
...
<td><span class="smallText">$98*</span></td><td><span class="smallText">$239*</span></td><td><span class="smallText">$219*</span></td><td><span class="smallText">$98*</span></td><td><span class="smallText">$98*</span></td>
...
<td><span class="smallText">$325*</span></td><td><span class="smallText">$310*, Sold Out</span></td><td><span class="smallText">$395*</span></td><td><span class="smallText">$152*</span></td><td><span class="smallText">$165*</span></td>
...
<td><span class="smallText">$264*, Sold Out</span></td><td><span class="smallText">$374*, Sold Out</span></td><td><span class="smallText">$374*, Sold Out</span></td><td><span class="smallText">$214*, Sold Out</span></td><td><span class="smallText">$165*</span></td>
...
<td><span class="smallText">$175*</span></td><td><span class="smallText">CES Rate($400*) No longer available, prevailing rate applies</span></td><td><span class="smallText">CES Rate($400*) No longer available, prevailing rate applies</span></td><td><span class="smallText">$170*</span></td><td><span class="smallText">$125*</span></td>

</td><td width="30%">*Rates shown include resort fee</td>
</tr><tr><td width="20%"><a href='https://resweb.passkey.com/go/XCES13' target="_blank"><span class="smallText">Monte Carlo*</span></a></td><td>
<td><span class="smallText">$150*</span></td><td><span class="smallText">$340*</span></td><td><span class="smallText">$340*</span></td><td><span class="smallText">$150*</span></td><td><span class="smallText">$115*</span></td>
...
<td><span class="smallText">$149*</span></td><td><span class="smallText">$369*</span></td><td><span class="smallText">$369*</span></td><td><span class="smallText">$159*</span></td><td><span class="smallText">$123*</span></td>
...
<td><span class="smallText">$150*</span></td><td><span class="smallText">$310*</span></td><td><span class="smallText">$310*</span></td><td><span class="smallText">$200*</span></td><td><span class="smallText">$140*</span></td>
...
<td><span class="smallText">$185*</span></td><td><span class="smallText">$365*, Sold Out</span></td><td><span class="smallText">CES Rate($365*) No longer available, prevailing rate applies</span></td><td><span class="smallText">$220*</span></td><td><span class="smallText">$135*</span></td>
...
<td><span class="smallText">CES Rate($385*) No longer available, prevailing rate applies</span></td><td><span class="smallText">$385*, Sold Out</span></td><td><span class="smallText">CES Rate($385*) No longer available, prevailing rate applies</span></td><td><span class="smallText">$200*</span></td><td><span class="smallText">$186*</span></td>
...
<td><span class="smallText">$279</span></td><td><span class="smallText">$379</span></td><td><span class="smallText">$379</span></td><td><span class="smallText">$279</span></td><td><span class="smallText">$149</span></td>
...
<td><span class="smallText">$178</span></td><td><span class="smallText">$228</span></td><td><span class="smallText">$228</span></td><td><span class="smallText">$228</span></td><td><span class="smallText">$178</span></td>
