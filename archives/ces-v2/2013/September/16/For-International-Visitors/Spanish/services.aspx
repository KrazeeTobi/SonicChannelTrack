...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/Spanish/services.aspx" >Servicios Internacionales</a></li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='spanish'><a href='/For-International-Visitors/Spanish.aspx'>Español</a></li><li class='services end'><a href='/For-International-Visitors/Spanish/services.aspx'>Servicios ...</a></li></ul>
...
<a name="1019"><span style="display: none">Nuevo proceso de entrega de identificaciones</span></a>
<div class="sub-content-header">Nuevo proceso de entrega de identificaciones</div>

<p>Una novedad para la CES 2014 es que las identificaciones de los asistentes no se enviarán por correo anticipadamente. Todos los asistentes deberán recogerlas en las instalaciones de la CES 2014. Conozca más sobre el <a href="/For-International-Visitors/Spanish/Spanish-Badge-Information.aspx">nuevo proceso de identificaciones</a>.</p>
<hr class="separator" /><a name="263"><span style="display: none">Área de registro para asistentes internacionales</span></a>
<div class="sub-content-header">Área de registro para asistentes internacionales</div>

<p><div>
	<em><em>LVCC, CES Central Plaza, Registro Principal (Main Registration)</em></em><br />
	<br />
	En el LVCC habrá un área de registro especial para los asistentes internacionales, en CES Central Plaza. Allí los asistentes internacionales podrán registrarse en persona o recoger sus identificaciones. Habrá también intérpretes multilingües para ayudarlos.</div>
</p>
<hr class="separator" /><a name="264"><span style="display: none">Centro de Comercio Internacional (ICC, International Commerce Center)</span></a>
<div class="sub-content-header">Centro de Comercio Internacional (ICC, International Commerce Center)</div>

<p><em>LVCC, Conector del vestíbulo sur (South Hall Connector), Salas S224-S225</em><br />
<br />
...
<hr class="separator" /><a name="265"><span style="display: none">Recepción Internacional y de Enlace Global</span></a>
<div class="sub-content-header">Recepción Internacional y de Enlace Global</div>

<p><p style="text-align: left; background-color: rgb(255, 255, 255);">
 Martes 7 de enero de 2014<br />
 6:00-7:30 p. m.<br />
 <em>LVCC, Conector del vestíbulo sur (South Hall Connector), Sala S222</em></p>
<span style="text-align: left; background-color: rgb(255, 255, 255);">Todos los asistentes, expositores y medios internacionales están invitados a la Recepción Internacional y de Enlace Global. Esta recepción es sólo para visitantes internacionales. No se pierda la oportunidad y disfrute de refrigerios ligeros después de un emocionante día en la sala de exposiciones de la CES. Este evento está abierto a todos los participantes internacionales y sus invitados.<br />
&nbsp;<br />
En esta recepción, el Departamento de Comercio de los Estados Unidos organizará una vez más un programa para facilitar que las empresas estadounidenses que deseen hacer negocios en el extranjero encuentren socios comerciales. &iquest;Es usted un expositor en la CES radicado en EE.&nbsp;UU. y está interesado en participar? <a href="mailto:delegations@ce.org"><u>Comuníquese con nosotros</u></a> para más información. &iexcl;Lo esperamos!</span><br />
<br />
</p>
<hr class="separator" /><a name="266"><span style="display: none">Intérpretes</span></a>
<div class="sub-content-header">Intérpretes</div>

<p>Habrá personal multilingüe en el ICC de LVCC y en las siguientes áreas de registro: LVCC, CES Central Plaza, en el Área de registro principal (Main Registration) y en The Venetian, Nivel 2, Vestíbulo del salón de baile Venetian (Venetian Ballroom Foyer), Área de registro de expositores (Exhibitor Registration Area).<br />
<br />
Habrá intérpretes para ayudarle en varios idiomas, incluidos chino, japonés, francés, coreano y español. En el área de registro internacional busque el mostrador &ldquo;Servicios de interpretación&rdquo; (Interpretation Services) si necesita ayuda. &iquest;Necesita contratar un intérprete para una reunión? Debajo encontrará dos proveedores que pueden ofrecerle este servicio:<br />
<ul>
 <li>
  <u><a href="/cesweb/media/CESWeb/International%20Pages/TransPerfect-Flyer.pdf" target="_blank">TransPerfect</a></u></li>
 <li>
  <u><a href="/cesweb/media/CESWeb/International%20Pages/CES-2013-INTERPRETER_Judy-Venn-and-Associates.pdf" style="color: rgb(0, 185, 212);" target="_blank">Judy Venn and Associates, Inc.</a></u></li>
</ul>
</p>
<hr class="separator" /><a name="267"><span style="display: none">Programa de compradores internacionales</span></a>
<div class="sub-content-header">Programa de compradores internacionales</div>

<p>En CES Internacional nos enorgullece participar en el Programa de Compradores Internacionales patrocinado por la Administración de Comercio Internacional del Departamento de Comercio de los Estados Unidos. Habrá especialistas en comercio internacional del Departamento de Comercio de los Estados Unidos en el ICC (LVCC, South Hall Connector, Salas S224/S225) para ofrecer ayuda en la búsqueda de socios de negocios y asesoramiento en materia de exportaciones a los asistentes y expositores internacionales.<br />
<p>
 &nbsp;</p>
</p>
