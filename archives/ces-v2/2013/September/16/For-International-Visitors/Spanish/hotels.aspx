...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/Spanish/hotels.aspx" id="form">
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/Spanish/hotels.aspx" >Reservas de Hotel</a></li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='spanish'><a href='/For-International-Visitors/Spanish.aspx'>Español</a></li><li class='hotels end'><a href='/For-International-Visitors/Spanish/hotels.aspx'>Reservas de Hotel</a></li></ul>
...
<br />
Visite&nbsp;<a href="/Hotel-Travel/Hotel-Reservations.aspx">www.CESweb.org/hotel</a> (disponible en inglés) para ver la lista completa de hoteles y tarifas. Para obtener la tarifa de CES, se deben hacer todas las reservaciones de habitación directamente en el hotel. Visite&nbsp;<a href="/Hotel-Travel/Hotel-Reservations.aspx">www.CESweb.org/hotel </a>y seleccione el nombre de un hotel.&nbsp;Como ya la mayoría de los hoteles del CES están completamente reservados, o han agotado sus habitaciones con tarifas para el CES, se ha agregado una lista de hoteles adicionales (sin servicio de transporte al CES) en el sitio web del CES.&nbsp;Se conectará directamente con la página de reservaciones de ese hotel, donde podrá ingresar la información de su tarjeta de crédito.<br />
<br />
Si necesita 20 habitaciones o más, puede solicitarlas directamente de su hotel preferido visitando <a href="/Hotel-Travel/Hotel-Reservations.aspx">http://www.cesweb.org/hotelTravel/blockRequest.asp</a>. Su solicitud se transmitirá directamente al hotel y el hotel tendrá un plazo de tres días hábiles para responder.<br />
<br />
...
<br />
&iquest;Tiene alguna pregunta? Sírvase enviar un mensaje electrónico a <a href="mailto:CEShotels@CE.org">CEShotels@CE.org</a>.
