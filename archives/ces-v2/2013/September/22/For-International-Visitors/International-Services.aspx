...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<li class="highlighted"><a href="/For-International-Visitors/International-Services.aspx" >International Services</a></li>
...
<a name="1020"><span style="display: none">New Badge Pickup Process</span></a>
<div class="sub-content-header">New Badge Pickup Process</div>

<p>New for the 2014 CES, attendee badges will not be mailed in advance. All attendees will need to pick their badges up onsite at the 2014 CES. <a href="http://cesweb.org/About-CES/Badge-Information.aspx">Learn more </a>about the new badge process.<br />
</p>
<hr class="separator" /><a name="249"><span style="display: none">International Attendee Registration Area</span></a>
<div class="sub-content-header">International Attendee Registration Area</div>

<p><em>LVCC, CES Central Plaza, Main Registration</em><br />
<br />
A special registration area for international attendees is located in the LVCC, CES Central Plaza. In this area, international attendees can register on-site or pick up a badge holder. Special language assistance from multilingual interpreters will also be available.<br />
</p>
<hr class="separator" /><a name="250"><span style="display: none">International Commerce Center (ICC) </span></a>
<div class="sub-content-header">International Commerce Center (ICC) </div>

<p><em>LVCC, South Hall Connector, Room S224-S225</em><br />
<br />
...
<hr class="separator" /><a name="251"><span style="display: none">Global Matchmaking and International Reception</span></a>
<div class="sub-content-header">Global Matchmaking and International Reception</div>

<p>Tuesday, January 7, 2014<br />
6:00-7:30 p.m.<br />
...
<hr class="separator" /><a name="252"><span style="display: none">Interpreters</span></a>
<div class="sub-content-header">Interpreters</div>

<p><p>
	A multilingual staff is available in the LVCC ICC and in the following areas to assist with registration: LVCC, CES Central Plaza, Main Registration Area and in The Venetian, Level 2, Venetian Ballroom Foyer, Exhibitor Registration Area.</p>
<p>
	Interpreters are available to assist you in several languages, including Spanish, French, Chinese, Japanese, and Korean. In the Main Registration Area, look for the counter titled, &ldquo;International Interpretation&rdquo; if you need assistance.</p>
<ul>
	<li>
