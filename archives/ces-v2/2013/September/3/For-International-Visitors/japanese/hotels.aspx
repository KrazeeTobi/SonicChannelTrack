...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/japanese/hotels.aspx" id="form">
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/japanese/hotels.aspx" >ホテル予約</a></li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='japanese'><a href='/For-International-Visitors/japanese.aspx'>日本語</a></li><li class='hotels end'><a href='/For-International-Visitors/japanese/hotels.aspx'>ホテル予約</a></li></ul>
...
<br />
ホテルと料金の全リストは<a href="/Hotel-Travel/Hotel-Reservations.aspx">www.CESweb.org/hotel</a> (英語のみ) をご覧ください。CES向け料金でのご利用には、<a href="/Hotel-Travel/Hotel-Reservations.aspx">www.CESweb.org/hotel</a>でホテル名を選択し、直接ホテルにご予約いただく必要があります。このサイトから直接ホテルの予約ページに移行し、そこでクレジットカード情報を入力することができます。多くのCESホテルではすでに満室か、またはCES特別価格分がすでに予約済みとなったため、オーバーフローのためのホテル (CESシャトルサービスはありません) のリストがCESウェブサイトに追加されました。&nbsp;<br />
<br />
20部屋以上のご予約が必要な場合は、<a href="/Hotel-Travel/Hotel-Reservations.aspx">http://www.cesweb.org/hotelTravel/blockRequest.asp</a>でご希望のホテル名を直接リクエストしていただいても結構です。お客様のリクエストは直接ホテルに伝えられ、ホテル側から3営業日以内に返答が届きます。<br />
<br />
注意：CEA/CESの宿泊斡旋代理店や機関はありません。もし、公式CES宿泊斡旋代理店であると自称する代理店や機関からの連絡があった場合、それは虚偽です。<br />
<br />
ご質問は、<a href="mailto:CEShotels@CE.org">CEShotels@CE.org</a>までメールでお問い合わせください。
