...
<head id="head"><title>
	国際サービス - 2014 International CES, January 7 - 10
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/japanese/services.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/japanese/services.aspx" >国際サービス</a></li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='japanese'><a href='/For-International-Visitors/japanese.aspx'>日本語</a></li><li class='services end'><a href='/For-International-Visitors/japanese/services.aspx'>国際サービス</a></li></ul>
...
<a name="1022"><span style="display: none">新しくなったバッジ手続き</span></a>
<div class="sub-content-header">新しくなったバッジ手続き</div>

<p>2014 CESでは、新たに参加者バッジは事前に郵送されなくなります。参加者は全員、2014 CES会場でバッジをピックアップする必要があります。詳しくは<a href="/For-International-Visitors/japanese/CES-ハッシについて.aspx">新しいバッジ手続き</a>をご覧ください。<br />
</p>
<hr class="separator" /><a name="296"><span style="display: none">国際参加者登録エリア </span></a>
<div class="sub-content-header">国際参加者登録エリア </div>

<p><em>LVCC、CESセントラル・プラザ・メイン登録エリア</em><br />
<br />
LVCCのCESセントラル・プラザに、国際参加者用の特別登録エリアが設けられています。ここで、当日登録やバッジホルダーをお受取りいただけます。また、特別通訳サービスもご利用いただけます。</p>
<hr class="separator" /><a name="297"><span style="display: none">インターナショナル・コマース・センター (ICC) </span></a>
<div class="sub-content-header">インターナショナル・コマース・センター (ICC) </div>

<p>LVCC、サウスホール・コネクター、S224～S225号室<br />
<br />
インターナショナル・コマース・センター (ICC) では、海外からの参加者と展示企業専用のビジネスサービスが提供されます。ここには、個室ミーティングルーム (ご予約は先着順)、会社との連絡に便利なノートパソコン接続ブースやインターネット接続が可能なコンピュータ、同業者の方との待ち合わせや、多忙なショー会場を抜けておくつろぎいただけるラウンジエリアが用意されています。必要に応じて通訳サービスもご利用いただけます。</p>
<hr class="separator" /><a name="298"><span style="display: none">グローバル・マッチメーキング & インターナショナル・レセプション</span></a>
<div class="sub-content-header">グローバル・マッチメーキング & インターナショナル・レセプション</div>

<p>2014年1月7日 (火)<br />
6:00～7:30 p.m.<br />
<em>LVCC、サウスホール・コネクター、S222号室</em><br />
<br />
海外からお越しの参加者、展示企業、メディアの方々は全員、グローバル・マッチメーキング &amp; インターナショナル・レセプションにご招待。このレセプションは海外からのお客様限定です。この機会をお見逃しなく。CES会場でエキサイティングな1日を過ごした後は、軽いスナックとお飲み物でおくつろぎください。このイベントには、国際登録者とその招待客全員が参加できます。<br />
&nbsp;<br />
米国商務省は今年も、このレセプションにおいて、外国企業との取引を求める米国企業とのマッチメーキング・プログラムを主催します。米国に本拠地を置くCES展示企業で、このプログラムに参加をご希望の場合、詳細について<a href="mailto:delegations@ce.org">お問い合わせください</a>。皆様のお越しをお待ちしております。</p>
<hr class="separator" /><a name="299"><span style="display: none">通訳サービス</span></a>
<div class="sub-content-header">通訳サービス</div>

<p>LVCC ICCおよび下記の登録エリアでは、通訳スタッフがお手伝いいたします： LVCC、CESセントラル・プラザ・メイン登録エリア、ザ・ベネチアン 2階ベネチアン・ボールルーム・フォイヤー、展示企業登録エリア。<br />
<br />
通訳サービスは、中国語、日本語、フランス語、韓国語、スペイン語を含む複数の言語がご利用いただけます。国際登録エリアでこのサービスが必要になった場合は、「Interpretation Services (通訳サービス)」カウンターまでお申し付けください。ミーティングのために通訳を雇う必要がある場合は、下記の通訳会社により通訳サービスがご利用になれます。<br />
<ul>
	<li>
...
<hr class="separator" /><a name="300"><span style="display: none">国際バイヤープログラム</span></a>
<div class="sub-content-header">国際バイヤープログラム</div>

<p>インターナショナルCESは、米国商務省国際貿易局提供の国際バイヤープログラム (IBP) に加盟しています。米国商務省の国際貿易スペシャリストが、ICC (LVCC、サウスホール・コネクター、S224/S225号室) において、海外からの参加者・展示企業にマッチメーキング支援と輸出カウンセリングを提供します。</p>
