...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/Korean/CES(소비자-가전-박람회)-명찰-정보.aspx" id="form">
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/Korean/CES(%ec%86%8c%eb%b9%84%ec%9e%90-%ea%b0%80%ec%a0%84-%eb%b0%95%eb%9e%8c%ed%9a%8c)-%eb%aa%85%ec%b0%b0-%ec%a0%95%eb%b3%b4.aspx" >CES(소비자 가전 박람회) 명찰 정보</a></li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='korean'><a href='/For-International-Visitors/Korean.aspx'>한국어</a></li><li class='ces(소비자-가전-박람회)-명찰-정보 end'><a href='/For-International-Visitors/Korean/CES(소비자-가전-박람회)-명찰-정보.aspx'>CES(소비자 가전 박람회) 명찰 ...</a></li></ul>
...
<div>
    CES는 세계 최고의 혁신 이벤트로, 기술을 활용하여 국제 CES 참가자 여러분들께 최상의 경험을 제공해 드리기 위해 최선을 다하고 있습니다. 올해 CES는 더 많은 기능을 가진 새로운 명찰을 도입하여 기다리는 시간을 줄이고 명찰의 사용을 훨씬 쉽게 만들었습니다. 새로운 명찰에는 근거리 무선통신(NFC) 기술을 사용하고 있어 신속하고 효율적으로 명찰 정보에 접근하고 업데이트할 수 있게 되었습니다.<br />
<br />
...
<br />
<strong>명찰을</strong> <strong>찾을</strong> <strong>수</strong> <strong>있는</strong> <strong>행사장</strong> <strong>외부</strong> <strong>장소</strong><strong>:</strong><img alt="" src="/getmedia/6dc56385-0685-40b6-bd68-6369d1f6db16/badge-page.aspx?width=300&amp;height=301" style="border-width: 10px; border-style: solid; width: 300px; height: 301px; float: right;" />
<div>
	<ul>
		<li>
	...
	&nbsp;<br />
	<strong>명찰을 찾을 수 있는 행사장 내 장소</strong><strong>:</strong><br />
	<ul>
		<li>
	...
	올해 CES 참가자들은 운전면허증이나 여권과 같이 정부에서 발행한 신분증 하나와 인쇄본, 전화, 테블릿 또는 노트북 컴퓨터를 통해 QR코드가 있는 확인 페이지를 보여 주시면 그 자리에서 신분을 확인하고 명찰을 받으실 수 있습니다. 모든 참가자들은 참가 유형에 관계 없이 행사장 내부 또는 외부의 장소에서 명찰을 찾아가실 수 있습니다.</div>
<br />
