...
<head id="head"><title>
	왕복 운행 - 2014 International CES, January 7 - 10
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/Korean/shuttles.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/Korean/shuttles.aspx" >왕복 운행</a></li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='korean'><a href='/For-International-Visitors/Korean.aspx'>한국어</a></li><li class='shuttles end'><a href='/For-International-Visitors/Korean/shuttles.aspx'>왕복 운행</a></li></ul>
...
<div>
CES는 귀하의 시간과 돈을 절약해 드립니다! CES의 공식 호텔에 숙박하고 호텔과 라스베이거스 컨벤션 센터 및 월드 트레이드 센터(LVCC)를 왕래하는 무료 버스를 탑승하여 택시 이용 및 렌트카 비용을 절약하십시오. CES는 LVCC 주위 및 LVCC와 베네시안 호텔(The Venetian) 사이의 무료 셔틀 버스도 제공합니다. 전람회 마지막 2일에는 편리한 무료 셔틀 버스 서비스를 이용하여 공항으로 가십시오.
...
<a name="312"><span style="display: none">CES 셔틀버스 서비스</span></a>
<div class="sub-content-header">CES 셔틀버스 서비스</div>

<p>인터내셔널 CES는 4일간의 인터내셔널 CES 전람회 기간 중 매일 무료 셔틀 서비스를 제공합니다. 저희는 또한 귀하가 네트워킹과 거래를 성공적으로 성사시킨 후 집으로 돌아갈 때 공항까지 편안하게 가실 수 있도록 도와드립니다.<br />
<a href="/cesweb/media/CESWeb/Hotel%20and%20Travel%20Images/Shuttle%20map/2014ShuttleMap_press_4-3c.pdf">여기서 다운로드.&nbsp;</a></p>
<hr class="separator" /><a name="337"><span style="display: none">호텔 셔틀버스 </span></a>
<div class="sub-content-header">호텔 셔틀버스 </div>

<p>국제 CES는 라스베이거스 컨벤션 센터(LVCC)와 대부분의 공식 CES 호텔 사이를 왕복하는 무료 셔틀버스 서비스를 월요일부터 금요일까지 제공합니다. <a href="/Hotel-Travel/CES-Shuttle-Service.aspx">자세한 노선과 장소는 완전한 셔틀버스 시간표를 다운로드 하십시오.</a><br />
</p>
<hr class="separator" /><a name="313"><span style="display: none">라스베이거스 컨벤션 센터 순환 셔틀</span></a>
<div class="sub-content-header">라스베이거스 컨벤션 센터 순환 셔틀</div>

<p>라스베이거스 컨벤션 센터의 한 쪽에서 다른 쪽으로 이동할 필요가 있는 경우, 순환 셔틀을 이용하여 시간을 절약하고 피곤한 다리를 잠시 쉬게 하십시오. 셔틀 버스는 10분 간격으로 운행되며 컨벤션 센터의 5개 주요 장소에 정차합니다.</p>
<hr class="separator" /><a name="314"><span style="display: none">라스베이거스 골프차 서비스</span></a>
<div class="sub-content-header">라스베이거스 골프차 서비스</div>

<p>라스베이거스 컨벤션 센터에서 무료 골프차 서비스를 이용하여 전람 시간 동안 센트럴 홀 5에서 사우스 홀 1-2의 뒷쪽으로 이동하십시오.&nbsp;</p>
<hr class="separator" /><a name="315"><span style="display: none">베네시안 익스프레스</span></a>
<div class="sub-content-header">베네시안 익스프레스</div>

<p>직행 셔틀버스 서비스는 10분 간격으로 베네시안 호텔과 LVCC 사이를 왕복합니다. 운행시간은 월요일부터 목요일까지는 오전 7:30에서 오후 6:30까지, 그리고 금요일은 오전 7:30부터 오후 4:30까지 입니다.<br />
</p>
<hr class="separator" /><a name="338"><span style="display: none">만다레이 호텔 직행 셔틀버스 </span></a>
<div class="sub-content-header">만다레이 호텔 직행 셔틀버스 </div>

<p>1월 6일 월요일의 프레스 데이에 만다레이 호텔과 LVCC 사이를 왕복하는 직행 셔틀버스가 오전 7:30부터 오후 5:30까지 운행됩니다.<br />
</p>
<hr class="separator" /><a name="316"><span style="display: none">공항 셔틀 서비스</span></a>
<div class="sub-content-header">공항 셔틀 서비스</div>

<p>라스베이거스 컨벤션 센터와 베네시안 호텔(버스 탑승 구역)에서 McCarran 국제공항으로 향하는 셔틀 서비스가 제공됩니다. 편도 티켓은 일인 당 $5이며, 셔틀 버스는 전람회 마지막 2일부터 매일 30분 간격으로 운행됩니다.</p>
<hr class="separator" /><a name="317"><span style="display: none">승객 승/하차 지정 구역 </span></a>
<div class="sub-content-header">승객 승/하차 지정 구역 </div>

<p><p>
	친구나 동료를 LVCC에서 마중하거나 LVCC로 태워다 주셔야 합니까? 교통혼잡을 피하고 보다 안전한 승객의 승/하차를 보장하기 위해 골드 주차장의 일부분이 개인차량(POV) 이용 구역으로 지정되었습니다. 골드 주차장은Paradise와 Convention Center Drive 코너에 위치하며, Convention Center Drive 쪽으로 들어와서 이용할 수 있습니다.<br />
	<br />
	주의: 운전자는 반드시 차량에 승차하고 있어야 합니다. 주차불가.</p>
</p>
