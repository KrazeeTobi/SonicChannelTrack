...
<head id="head"><title>
	대표단 프로그램 - 2014 International CES, January 7 - 10
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li><a href="/For-International-Visitors/Korean/CES(%ec%86%8c%eb%b9%84%ec%9e%90-%ea%b0%80%ec%a0%84-%eb%b0%95%eb%9e%8c%ed%9a%8c)-%eb%aa%85%ec%b0%b0-%ec%a0%95%eb%b3%b4.aspx" >CES(소비자 가전 박람회) 명찰 정보</a></li>
			<li><a href="/For-International-Visitors/Korean/How-to-Register-(Korean).aspx" >CES 등록 방법</a></li>
		</ul>
		</li>
	</ul>
...
--><script type="text/javascript" src="http://admin.brightcove.com/js/BrightcoveExperiences.js"></script><object class="BrightcoveExperience" id="myExperience2564206079001"><param name="bgcolor" value="#FFFFFF" /><param name="width" value="486" /><param name="height" value="412" /><param name="playerID" value="26356940001" /><param name="playerKey" value="AQ~~,AAAABh3C_dE~,zBkXqCU8KVYYG5utII4f8nND4rqBAlFX" /><param name="isVid" value="true" /><param name="dynamicStreaming" value="true" /><param name="@videoPlayer" value="2564206079001" /></object><!-- 
This script tag will cause the Brightcove Players defined above it to be created as soon
as the line is read by the browser. If you wish to have the player instantiated only after
the rest of the HTML is processed and the page load is complete, remove the line.
--><script type="text/javascript">brightcove.createExperiences();</script><!-- End of Brightcove Player -->2014 국제전자제품박람회(International CES&reg;)에 업계 전문가 그룹을 인솔하여 오실 계획이 있으십니까? CES는 공식 대표단 프로그램을 운영하여 대표단 리더와 일행 분들께 많은 혜택을 제공해드립니다. 대표단 리더로서 귀사의 고객이 견학할 대상과 전시회에서 만날 사람을 계획하는 것을 도와 귀사의 고객들이 CES 참여를 통해 얻을 수 있는 가치를 극대화할 수 있도록 지원해드릴 수 있습니다.&nbsp;대표단 리더 등록은 11월 29일 마감되며, 궁금한 점이나 관심 사항이 있으시면 <a href="mailto:delegations@ce.org">저희에게 연락</a>해 주시기 바랍니다.<br />
<br />
<strong>프로그램</strong> <strong>세부</strong> <strong>내용</strong><br />
<br />
&bull; &nbsp;이 대표단 프로그램은 미국 외 지역 참가자들만을 위한 것입니다.<br />
<br />
&bull; &nbsp;대표단은 소비자 가전 산업과 관련된 업계 전문가들로 구성되어야 합니다.<br />
<br />
&bull; &nbsp;대표단은 최소 15인 이상으로 구성되어야 합니다. 15인 미만의 단체는 일반 참가자로 개별 등록하셔야 합니다.<br />
<br />
대표단 리더께는 무료 호텔 숙박 혜택이 제공되며, 50인을 초과하는 대표단 리더께는 CES 대표단 리더들을 위한 감사 만찬(CES Delegation Leader Appreciation Dinner) 초대권이 제공됩니다. 무료 전시회 플러스 입장권(Exhibits Plus Pass)은 모든 대표단 프로그램 참가자들에게 제공합니다. 8월 31일 이후 대표단에 참가하셔서 CES에 등록하시는 경우 미화 100달러의 사전 등록비를 면제해 드립니다.<br />
&nbsp;<br />
대표단 프로그램을 통해 제공되는 혜택에 대한 자세한 내용은 <a href="/cesweb/media/CESWeb/International%20Pages/Flyers/12191-DelegationProgramBenefits_updates_KO_rev.pdf">여기를 클릭하십시오</a>.<br />
<br />
*참고:&nbsp;대표단 리더로 <a href="https://ces.itnint.com/2014/regonline/RegLogin.aspx">등록</a>했다고 해서 박람회에 등록하신 것은 아닙니다. 대표단 리더도 국제전자제품박람회CES 등록 절차를 통해 등록을 완료하셔서 자격증명을 받으셔야 합니다.<br />
<br />
...
CES 대표단 프로그램에 관한 질문이나 의문사항은 <a href="mailto:delegations@ce.org">delegations@CE.org</a>로 연락하십시오.<br />
	...
	<li>
		<a href="/cesweb/media/CESWeb/Documents/International/2014CES_General_Overview_Brochure_International.pdf" target="_blank">영어본 개관 안내책자 (pdf)</a></li>
	<li>
		<a href="http://www.cesweb.org/cesweb/media/CESWeb/International%20Pages/Flyers/12401_2K14_CESfactSheet_KO_8-22.pdf" target="_blank">번역된 CES 개황 보고서 (pdf)</a></li>
	<li>
		<a href="/cesweb/media/CESWeb/International%20Pages/Flyers/12562_2014CESDelgationBro_Web.pdf" target="_blank">다국어 대표단 안내 책자</a></li>
	<li>
		<a href="/cesweb/media/CESWeb/International%20Pages/Flyers/12191-DelegationProgramBenefits_updates_KO_rev.pdf" target="_blank">대표단 리더와 대표단 사절들을 위한 혜택 (pdf)</a></li>
</ul>
