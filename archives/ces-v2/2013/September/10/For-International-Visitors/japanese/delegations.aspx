...
<head id="head"><title>
	代表団プログラム - 2014 International CES, January 7 - 10
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<div id="exhibit">
	...
	<ul class="level1CMSListMenuUL" id="topnav">
		...
		<ul class="subnav">
			...
			<li class="level2CMSListMenuHighlightedLI last "><a href="/Show-Floor/Show-Floor-Tours.aspx" class="level2CMSListMenuLinkHighlighted">Show Floor Tours</a></li>
		</ul>
		</li>
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li><a href="/For-International-Visitors/japanese/CES-%e3%83%8f%e3%83%83%e3%82%b7%e3%81%ab%e3%81%a4%e3%81%84%e3%81%a6.aspx" >CES バッジについて</a></li>
			<li><a href="/For-International-Visitors/japanese/How-to-Register-(Japanese).aspx" >CESへのご登録方法</a></li>
		</ul>
		</li>
...
--><script type="text/javascript" src="http://admin.brightcove.com/js/BrightcoveExperiences.js"></script><object class="BrightcoveExperience" id="myExperience2564181923001"><param name="bgcolor" value="#FFFFFF" /><param name="width" value="486" /><param name="height" value="412" /><param name="playerID" value="26356940001" /><param name="playerKey" value="AQ~~,AAAABh3C_dE~,zBkXqCU8KVYYG5utII4f8nND4rqBAlFX" /><param name="isVid" value="true" /><param name="dynamicStreaming" value="true" /><param name="@videoPlayer" value="2564181923001" /></object><!-- 
This script tag will cause the Brightcove Players defined above it to be created as soon
as the line is read by the browser. If you wish to have the player instantiated only after
the rest of the HTML is processed and the page load is complete, remove the line.
--><script type="text/javascript">brightcove.createExperiences();</script><!-- End of Brightcove Player -->2014年インターナショナルCESへの業界専門家による団体派遣にご関心がおありですか？ CESでは公式代表団プログラムをご用意し、代表団リーダーと代表団メンバーの方にさまざまなメリットをお届けしています。代表団リーダーの方は、クライアントの方々にショー会場でご覧いただくものや誰に会うか計画を立てるお手伝いをしていただくことにより、CESへの出張の価値を最大限に高められます。代表団リーダーのご登録は11月29日までです。ご質問やご懸念等についてはどうぞ<a href="mailto:delegations@ce.org">お問い合わせください</a>。<br />
<br />
...
<ul>
	<li>
		...
		&nbsp;</li>
	<li>
		代表団は、消費者向けテクノロジー業界に関係するビジネスに携わる方々で構成してください。<br />
		&nbsp;</li>
	<li>
		代表団は15人以上とします。15人に満たないグループは、個人での参加登録が必要となります。</li>
</ul>
代表団リーダーの方は、無料ホテル滞在 （50人を超えるグループを率いる場合） やCES代表団リーダー感謝ディナーへのご招待など、さまざまな特典をご利用いただけます。無料のExhibits Plus Passパス登録は、派遣団プログラム参加者全員の特典のひとつです。代表団に参加し、8月31日より後にCESに登録される場合は、事前登録料金$100は免除されます。<br />
<br />
代表団プログラムの特典の詳細は、<a href="/cesweb/media/CESWeb/International%20Pages/Flyers/12191-DelegationProgramBenefits_updates_JA_rev.pdf">こちらをクリック</a>してください。<br />
<br />
*代表団リーダーのご登録は、ショーへの参加<a href="https://ces.itnint.com/2014/regonline/RegLogin.aspx">登録</a>とは別になりますのでご注意ください。公式のインターナショナルCES登録手順に従って登録を完了し、登録証を受け取る必要があります。<br />
<br />
...
<br />
	...
	<li>
		<a href="/cesweb/media/CESWeb/Documents/International/2014CES_General_Overview_Brochure_International.pdf" target="_blank">英語版総合パンフレット（PDF）</a></li>
	<li>
		<a href="http://www.cesweb.org/cesweb/media/CESWeb/International%20Pages/Flyers/12401_2K14_CESfactSheet_JA_8-22.pdf" target="_blank">日本語版CESファクトシート（PDF）</a></li>
	<li>
		<a href="/cesweb/media/CESWeb/International%20Pages/Flyers/12562_2014CESDelgationBro_Web.pdf" target="_blank">代表団向け各国語版パンフレット</a></li>
	<li>
		<a href="/cesweb/media/CESWeb/International%20Pages/Flyers/12191-DelegationProgramBenefits_updates_JA_rev.pdf" target="_blank">代表団リーダーと代表者の特典（PDF）</a></li>
</ul>
