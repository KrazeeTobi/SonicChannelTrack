...
<head id="head"><title>
	旅行とビザ情報 - 2014 International CES, January 7 - 10
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/japanese/travel.aspx" id="form">
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			<li class="highlighted"><a href="/For-International-Visitors/japanese/travel.aspx" >旅行とビザ情報</a></li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='japanese'><a href='/For-International-Visitors/japanese.aspx'>日本語</a></li><li class='travel end'><a href='/For-International-Visitors/japanese/travel.aspx'>旅行とビザ情報</a></li></ul>
...
<span class="paragraphHeader">CES会場への道順が必要ですか？</span>
<p><a href="/Hotel-Travel.aspx">CESweb.orgのトラベル・セクション [/attendees/travel]（英語）</a>にアクセスし、最もお得な航空運賃やレンタカー料金、および現地の交通情報を見つけてください。</p>

<span class="paragraphHeader">宿泊施設の情報が必要ですか？</span>
<p><a href="/Hotel-Travel/Hotel-Reservations.aspx">CESweb.orgのホテル・セクション （英語）</a>にアクセスし、団体または個人予約をしてください。</p>
...
<span class="paragraphHeader">あなたはビザが必要なのでしょうか？</span>
<p><a href="https://ceac.state.gov/genniv/" target="_blank">ビザをお求めですか？現在、オンラインでビザ申請書をご記入いただけます。</a></p>

<span class="paragraphHeader">助けが必要ですか？</span>
<p><a href="/cesweb/media/CESWeb/International%20Pages/Flyers/2K14VisaTips_JA.pdf" target="_blank">ヘルプが必要な場合は、弊社のビザ関連説明書をダウンロードし</a>、順を追った説明やウェブサイトアドレスなどの情報でビザ申請手続きの助力を得てください。</p>


    <div style="border:#9f9f9f 1px solid; padding: 5px;"><h3 style="background-color: rgb(255, 255, 255); font-size: 16px; color: rgb(51, 51, 51); margin-top: 10px; margin-bottom: 10px; text-align: left; ">
	<span style="color: rgb(40, 69, 149); font-size: 13px;">米国入国・出国を伴う参加者の方々の重要事項：</span></h3>
1. &nbsp; 米国の空港での乗り継ぎや荷物の再チェックイン、米国税関・国境警備局の入国手<br />
&nbsp; &nbsp; &nbsp; 続きには、少なくとも3時間の余裕をみておくことをお勧めします。<br />
2. &nbsp; 2013年4月以降、Form I-94はペーパーレスになっておりますのでご注意ください。<br />
&nbsp; &nbsp; &nbsp; 渡航者のと公文書には、CBP入国許可スタンプが押されます。外国人登録や滞在資<br />
&nbsp; &nbsp; &nbsp; 格、就労許可の確認のためにI-94 (入国記録) のコピーが必要な場合は、<a href="https://i94.cbp.dhs.gov/I94/request.html">こちら</a>で入<br />
&nbsp; &nbsp; &nbsp; 手できます。詳しくは、<a href="http://cbp.gov/linkhandler/cgov/newsroom/fact_sheets/travel/i94_factsheet.ctt/i94_factsheet.pdf">I-94自動化</a>をご覧ください。<br />
