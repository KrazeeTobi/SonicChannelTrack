...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/japanese/CES-ハッシについて.aspx" id="form">
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/japanese/CES-%e3%83%8f%e3%83%83%e3%82%b7%e3%81%ab%e3%81%a4%e3%81%84%e3%81%a6.aspx" >CES バッジについて</a></li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='japanese'><a href='/For-International-Visitors/japanese.aspx'>日本語</a></li><li class='ces-ハッシについて end'><a href='/For-International-Visitors/japanese/CES-ハッシについて.aspx'>CES バッジについて</a></li></ul>
...
<div>
    世界トップレベルのイベントとして、インターナショナルCESでは参加者の皆様により優れた経験をしていただくために、テクノロジーの活用に努めています。待ち時間をより短くし、バッジの機能性と使いやすさを高めるため、今年度より新しいバッジを導入することになりました。新バッジには、近距離無線通信（NFC）テクノロジーが搭載されていますので、素早く効率的なバッジへのアクセスと情報のアップデートが可能になります。<br />
<br />
...
<br />
<strong>現地以外のバッジ受け取り場所：</strong><img alt="" src="/getmedia/6dc56385-0685-40b6-bd68-6369d1f6db16/badge-page.aspx?width=300&amp;height=301" style="border-width: 10px; border-style: solid; width: 300px; height: 301px; float: right;" />
<div>
	<ul>
		<li>
	...
	<br />
	<strong>現地でのバッジ受け取り場所：</strong><br />
	<ul>
		<li>
	...
	今年度の現地での身元確認とバッジの受け取りに必要なものは、政府発行のID（運転免許証やパスポート）、および確認通知のページ（プリントアウト、携帯、タブレット、ノートパソコン上）に記載のQRコードを提示していただくだけです。イベントに参加する<u>全ての方</u>は、参加タイプに関わらず、どの受け取り場所においてもバッジをお受け取りになれます。</div>
<br />
