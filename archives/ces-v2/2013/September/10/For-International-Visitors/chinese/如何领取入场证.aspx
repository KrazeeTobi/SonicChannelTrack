...
<head id="head"><title>
	如何领取CES入场证 - 2014 International CES, January 7 - 10
...
<meta name="twitter:title" content="如何领取CES入场证">
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/chinese/如何领取入场证.aspx" id="form">
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/chinese/%e5%a6%82%e4%bd%95%e9%a2%86%e5%8f%96%e5%85%a5%e5%9c%ba%e8%af%81.aspx" >如何领取CES入场证</a></li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='chinese'><a href='/For-International-Visitors/chinese.aspx'>汉语</a></li><li class='如何领取入场证 end'><a href='/For-International-Visitors/chinese/如何领取入场证.aspx'>如何领取CES入场证</a></li></ul>
...
<div>
    作为国际领航的创新盛会，我们努力将科技元素融入活动中，以提升您在国际消费电子展的参与体验。今年，我们采用了全新的入场证，这将缩短您在领取过程中的等待时间，并赋予更多元化的功能和更人性化的操作。新的入场证将拥有近距离无线通讯功能（NFC），使您能更快更有效地获取和更新各类信息。<br />
&nbsp;<br />
<strong>2014</strong><strong>年国际消费电子展的一项重大改变是：</strong><u>入场证将不再提前邮寄给参与者</u>。取而代之的是，当您完成注册信息并收到确认邮件后，您只需在到达美国拉斯维加斯后前往指定地点领取。所有领取地点如下方所示。值得一提的是，若您想要更快更方便地取得您的入场证，您无须特地前往国际消费电子展的展会现场领取，我们在拉斯维加斯的麦卡伦机场(McCarran Airport)和活动指定酒店均设有领取专柜。所以，趁着您等待行李的间隙，或完成酒店入住登记后的片刻，您便可轻松领取您的展会入场证。<br />
<br />
<strong>以下是拉斯维加斯市内可领取入场证的地点</strong><strong>:</strong><img alt="" src="/getmedia/6dc56385-0685-40b6-bd68-6369d1f6db16/badge-page.aspx?width=300&amp;height=301" style="border: 10px solid rgb(0, 0, 0); width: 300px; height: 301px; float: right;" />
<div>
	<ul>
		<li>
	...
	&nbsp;<br />
	<strong>以下是国际消费电子展展会现场可领取入场证的地点</strong><strong>:</strong><br />
	<ul>
		<li>
	...
	今年，您只需出示政府颁发的有效证件（驾照或护照）并提供您注册确认邮件上的二维条码（打印件、手机端、平板电脑、或笔记本电脑显示均可），以便现场确认并领取入场证。请注意：不论您以什么身份注册，所有参与者均可到任意一个市内或现场领取点领取入场证。</div>
<br />
