...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-International-Visitors/Korean/services.aspx" id="form">
...
<a href='/For-International-Visitors.aspx'><img src='/cesweb/media/CESWeb/assets/images/nav/cesweb_visitors2.png'></a>
	<ul id="menuElem">
		...
		<ul>
			...
			<li class="highlighted"><a href="/For-International-Visitors/Korean/services.aspx" >해외 방문객 서비스</a></li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='korean'><a href='/For-International-Visitors/Korean.aspx'>한국어</a></li><li class='services end'><a href='/For-International-Visitors/Korean/services.aspx'>해외 방문객 서비스</a></li></ul>
...
<a name="1023"><span style="display: none">명찰 발급 관련 신규 절차</span></a>
<div class="sub-content-header">명찰 발급 관련 신규 절차</div>

<p>2014 CES의 신규 절차에 따라 참가자 명찰은 사전에 우편으로 발송되지 않습니다. 모든 참가자는 2014 CES 현장에서 자신의 명찰을 찾아가셔야 합니다. <a href="/For-International-Visitors/Korean/CES(소비자-가전-박람회)-명찰-정보.aspx"><u>신규</u> <u>명찰</u> <u>발급</u> <u>절차</u></a>에 대해 자세히 알아보시기 바랍니다<br />
</p>
<hr class="separator" /><a name="301"><span style="display: none">해외 참가가 등록 구역</span></a>
<div class="sub-content-header">해외 참가가 등록 구역</div>

<p><em>CES Central Plaza, LVCC, Main Registration(기본 등록)</em><br />
<br />
해외 참가자들을 위한 특별 등록 구역은 CES Central Plaza(CES 센트럴 플라자), LVCC에 위치해 있습니다. 이 곳에서 해외 참가자들은 현장 등록하시거나 명찰 홀더를 받으실 수 있습니다. 다국어 통역사가 제공하는 특별 언어 지원도 제공됩니다.<br />
</p>
<hr class="separator" /><a name="302"><span style="display: none">국제상업센터(International Commerce Center: ICC)</span></a>
<div class="sub-content-header">국제상업센터(International Commerce Center: ICC)</div>

<p>LVCC, 사우스 홀 커넥터, S224-S225실<br />
<br />
국제상업센터(International Commerce Center)에서는 해외 참가자 및&nbsp; 출품업체 만을 대상으로 전용 비즈니스 서비스를 제공합니다. 이용하실 수 있는 서비스에는 선착순 예약에 의한 소회의실, 인터넷 이용이 가능한 노트북 연결구 및 컴퓨터, 전시회 참가 후 동료들과 휴식을 취할 수 있는 라운지 등이 있습니다. 필요한 경우 다국어 통역사들도 이용하실 수 있습니다.</p>
<hr class="separator" /><a name="303"><span style="display: none">글로벌 연결 지원 및 인터내셔널 리셉션</span></a>
<div class="sub-content-header">글로벌 연결 지원 및 인터내셔널 리셉션</div>

<p>2014년 1월 7일 화요일<br />
오후 6:00-7:30<br />
<strong>라스베이거스 컨벤션 센터 (LVCC), 사우스 홀, S222호실</strong><br />
<br />
...
<hr class="separator" /><a name="304"><span style="display: none">통역사</span></a>
<div class="sub-content-header">통역사</div>

<p>다국어 가능 직원은 LVCC ICC 및LVCC, CES Central Plaza, 기본 등록 구역(Main Registration Area), Venetian 2층 Venetian Ballroom Foyer, 출품업체 등록 구역(Exhibitor Registration Area)에 배치되어 있습니다.<br />
<br />
통역사가 지원하는 언어는 중국어, 일본어, 프랑스어, 한국어, 스페인어입니다. 도움이 필요하신 경우 국제 등록(International Registration) 구역에서 &ldquo;Interpretation Services&rdquo;(통역 서비스) 카운터를 찾으십시오. 회의에 통역사가 필요하십니까? 아래의 두 업체가 통역 서비스를 제공해드립니다.<br />
<ul>
	<li>
...
<hr class="separator" /><a name="305"><span style="display: none">국제 바이어 프로그램</span></a>
<div class="sub-content-header">국제 바이어 프로그램</div>

<p>국제전자제품박람회 CES는 미국 상무부 국제무역행정청(U.S. Department of Commerce, International Trade Administration)이 후원하는 국제 바이어 프로그램에 참여하고 있습니다. ICC&nbsp;(LVCC South Hall Connector, S224/225호)에서는 미국 상무부 소속 국제무역 전문가들이 해외 참가자와 출품업체를 위해 업체 연결 지원 및 수출 거래에 대한 상담을 해드립니다.<br />
</p>
