...
<head id="head"><title>
	2013 Keynotes/Events - 2014 International CES, January 7 - 10
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/Brand-Matters/Keynotes-Events.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
...
<div id="exhibit">
	...
	<ul id="menuElem">
		<li><a href="/Brand-Matters/CMO-Club.aspx" >CMO Club </a></li>
		<li class="highlighted"><a href="/Brand-Matters/Keynotes-Events.aspx" >2013 Keynotes/Events</a></li>
		<li><a href="/Brand-Matters/Conference-Tracks.aspx" >2013 Conference Tracks </a></li>
		<li><a href="/Brand-Matters/Sponsors.aspx" >Sponsors</a></li>
		<li><a href="/Brand-Matters/Sponsorship-Opportunities.aspx" >Sponsorship Opportunities</a></li>
		<li><a href="https://ces.itnint.com/2014/regonline/RegLogin.aspx" >Register Now</a></li>
	</ul>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='keynotes-events end'><a href='/Brand-Matters/Keynotes-Events.aspx'>2013 Keynotes/Events</a></li></ul>
...
<div class="headerbox">
      <h1>2013 Keynotes/Events</h1>
</div>
<div style="float: right;">
    
</div>
<div>
    <img alt="" src="/getmedia/ed59260a-2455-4689-ad80-0a75de2e19bc/BrandMatters_1.aspx?width=220&amp;height=94" style="width: 220px; height: 94px;" /><br />
<br />
The Brand Matters program for 2013 included thought-provoking discussions at the following events. We are currently developing the Brand Matters programming for 2014. Check back often for updated information on what stimulating topics will be discussed this year.<br />
<br />
<table border="0" cellpadding="1" cellspacing="1" style="width: 500px;">
	<tbody>
		<tr>
			<td>
				<h2>
					<strong>The Next Generation of Innovators Keynote</strong></h2>
			</td>
			<td>
				&nbsp;</td>
		</tr>
...
<br />
As the consumer technology industry continues to reinvent itself with stunning speed in a mobile world, who will be at the forefront of the next wave of big ideas and must-have products? In this panel you will meet several Founder CEOs who just might have created the &ldquo;next big thing.&rdquo; Join moderator Jeff Jordan, entrepreneur and tech exec, now partner at Silicon Valley&rsquo;s hottest VC firm, as he explores the trials and potential rewards ahead for some of tech&rsquo;s hottest young innovators.<br />
&nbsp;<br />
<strong>Moderator:</strong>&nbsp; Jeff Jordan, Partner, Andreessen Horowitz<br />
&nbsp;<br />
<strong>Panelists:</strong>&nbsp;<br />
David Lieb, CEO and Co-Founder, Bump Technologies<br />
Cyrus Massoumi, CEO and Founder, ZocDoc<br />
Eric Vishria, Co-Founder and CEO, Rockmelt Inc.<br />
will.i.am, Founder and Chairman, i.am.plus llc<br />
<br />
<br />
<table border="0" cellpadding="1" cellspacing="1" style="width: 500px;">
	<tbody>
		<tr>
			<td>
				<h2>
					<strong>Brand Matters Keynote:&nbsp;</strong>Marketing in the Cloud</h2>
			</td>
			<td>
				<div>
					&nbsp;</div>
...
<p>
	...
	Michael Kassan, Chairman &amp; CEO, MediaLink</p>
<p>
	<strong>Panelists:&nbsp;</strong><br />
	Marc Benioff, Chairman and CEO, salesforce.com<br />
	Michael Bowling, Chief Marketing Officer, Business Solutions, AT&amp;T<br />
	Josh Silverman, President, U.S. Consumer Services, American Express<br />
	Joseph Tripodi, EVP, Chief Marketing &amp; Commercial Officer, The Coca Cola Co.<br />
	Keith Weed, Chief Marketing and Communications Officer, Unilever</p>
<br />
<table border="0" cellpadding="1" cellspacing="1" style="width: 500px;">
	<tbody>
		<tr>
			<td>
				<h2>
					Brand Matters SuperSession:&nbsp;How Are Your Consumers REALLY Engaging With Digital Media?</h2>
			</td>
			<td>
				<h2>
					&nbsp;</h2>
...
<p>
	Join senior product executives from some of the biggest digital platform companies as they respond to a panel of consumers about how they really engage with digital media and in the process, unearth the social, cultural, technological and media forces that are making them increasingly elusive for most marketers.<br />
	&nbsp;<br />
	<strong>Moderators:</strong> Xavier Kochhar of MediaLink and Jamie Gutfreund, The Intelligence Group&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
	<br />
	<strong>Panelists:</strong><br />
	Derek Gottfrid,&nbsp; VP of Product, Tumblr<br />
	Holger Luedorf,&nbsp; Head of Product Strategy, Foursquare<br />
	Shiva Rajaraman, Director, Product Management, YouTube<br />
	Michael Vernal,&nbsp; Director, Product Engineering, Facebook<br />
	Dan Wright,&nbsp; Director, Connected Devices, Amazon<br />
	Guy Yalif, Head of Product Marketing, Twitter<br />
	&nbsp;</p>
<h2>
	Brand Matters Luncheon: Advertising Re-Imagined: New Technologies That Will Make Your Creative Smarter<br />
	Produced by MESA and <em>Variety</em></h2>
<p>
	What are the new technologies that are transforming the way creatives explore, suggest and execute innovative campaigns for their clients and brands? What new technology platforms are creative technologists embracing to bring their ideas to life? How is the 2nd screen offering a wider palette for creative development? And what&#39;s new at CES that will impact agency work in the years ahead? These questions and more will be addressed by a keynote presentation and a panel of agency and marketing executives who will offer case-study examples about how they are re-imagining the creative process via technology. <a href="http://mesalliance.org/brand-matters-luncheon/">Join this invitation-only luncheon discussion (first come first serve)</a>, which is part of the official International CES Brand Matters program.<br />
	&nbsp;<br />
	<strong>Keynote</strong>: Peter Crofut, Head of Creative Platforms Strategy, Google<br />
	<br />
	<strong>Panelists</strong>:<br />
	Lisa Archambault, Manager, Display Marketing, Zappos.com<br />
	Pete Deutschman, Chief Executive Officer &amp; Founder, The Buddy Group<br />
	David Payne, Chief Digital Officer, Gannett Co.<br />
	Julian Zilberbrand, Senior Vice President, Global Digital Director, Technology Activation Group, Starcom MediaVest Group<br />
	<br />
	<strong>Panel Moderator</strong>: Jay VanDerzee, Head of Sales, Media Platforms, Google</p>
