...
<head id="head"><title>
	Lounges and Meeting Space - 2014 International CES, January 7 - 10
...
<body class="LTR ENUS ContentBody"  class="home" id="home">
    <form method="post" action="/For-Exhibitors/Branding-Opportunities/Sponsorships/Lounges-and-Meeting-Space.aspx" id="form">
<div class="aspNetHidden">
<input type="hidden" name="manScript_HiddenField" id="manScript_HiddenField" value="" />
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
</div>
	...
	<ul id="menuElem">
		...
		<ul>
			...
			<ul>
				...
				<li><a href="/For-Exhibitors/Branding-Opportunities/Sponsorships/Awards,-Events-and-Programs.aspx" >Awards, Events and Programs</a></li>
				<li class="highlighted"><a href="/For-Exhibitors/Branding-Opportunities/Sponsorships/Lounges-and-Meeting-Space.aspx" >Lounges and Meeting Space</a></li>
			</ul>
			</li>
...
<ul id="breadcrumbs"><li class='home'><a href='/'>Home</a></li><li class='branding-opportunities'><a href='/For-Exhibitors/Branding-Opportunities.aspx'>Branding ...</a></li><li class='sponsorships'><a href='/For-Exhibitors/Branding-Opportunities/Sponsorships.aspx'>Sponsorships</a></li><li class='lounges-and-meeting-space end'><a href='/For-Exhibitors/Branding-Opportunities/Sponsorships/Lounges-and-Meeting-Space.aspx'>Lounges and Meeting ...</a></li></ul>
...
<div class="headerbox">
      <h1>Lounges and Meeting Space</h1>
</div>
<div style="float: right;">
    
</div>
<div>
    <strong>CEA Member Lounges</strong><img alt="" src="/cesweb/media/CESWeb/For%20Exhibitors/Branding%20Opps/CEAlogo.jpg" style="float: right; margin: 10px;" /><br />
CEA hosts three member lounges located in high-traffic areas throughout the show. Sponsoring a member lounge (or certain products and amenities within it) not only aligns your brand with CEA but puts your brand in front of our members. The CEA Member lounges can be found in the following locations:<br />
&nbsp;<br />
LVCC, North Hall, Outside of Room N250<br />
LVCC, South Hall Connector, Room S220<br />
The Venetian, Venetian Tower, Suite #30-140<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Choose from any of these sponsorship options:<br />
<div style="margin-left: 40px;">
	<br />
	<strong>Individual Member Lounge Sponsorship</strong><br />
	You&rsquo;ll receive signage throughout the lounge along with company literature distribution. In addition, you&rsquo;ll receive two dedicated email blasts sent by CEA on your behalf to CEA members and your logo displayed on member-only sections of CE.org.<br />
	&nbsp;<br />
	<strong>Sponsorship Investment: </strong>$20,000<br />
	&nbsp;</div>
<div align="center" style="margin-left:.75in;">
	<hr align="center" size="2" width="100%" />
</div>
<div style="margin-left: 40px;">
	&nbsp;<br />
	<strong>Afternoon Refreshments</strong><br />
	You&rsquo;ll receive signage in each member lounge along with company literature distribution on or near the refreshment display. In addition, you&rsquo;ll receive one dedicated email blast sent by CEA on your behalf to CEA members and your logo displayed on member-only sections of CE.org.<br />
	&nbsp;<br />
	<strong>Sponsorship Investment: </strong>$8,000<br />
	&nbsp;</div>
<div align="center" style="margin-left:.75in;">
	<hr align="center" size="2" width="100%" />
</div>
<div style="margin-left: 40px;">
	&nbsp;<br />
	<strong>Breakfast Station</strong><br />
	You&rsquo;ll receive signage in each member lounge along with company literature distribution on or near the breakfast display. In addition, you&rsquo;ll receive one dedicated email blast sent by CEA on your behalf to CEA members and your logo displayed on member-only sections of CE.org.<br />
	&nbsp;<br />
	<strong>Sponsorship Investment: </strong>$8,000<br />
	&nbsp;</div>
<div align="center" style="margin-left:.75in;">
...
<div style="margin-left: 40px;">
	&nbsp;<br />
	<strong>Coffee Station</strong><br />
	You&rsquo;ll receive signage in each member lounge along with company literature distribution on or near the coffee display. In addition, you&rsquo;ll receive one dedicated email blast sent by CEA on your behalf to CEA members and your logo displayed on member-only sections of CE.org.<br />
	&nbsp;<br />
	<strong>Sponsorship Investment: </strong>$10,000</div>
&nbsp;<br />
Contact us at <a href="mailto:ltardif@CE.org?subject=Interested%20in%20CEA%20Member%20Lounge%20Sponsorships">ltardif@CE.org</a> or 703-907-7681 to secure these opportunities.<br />
<br />
<hr />
<br />
<strong>International Commerce Center (ICC)</strong><br />
Sponsoring the International Commerce Center (ICC) allows you to tap into consumer technology professionals from 150 countries. Reach distribution channels from overseas and target-brand thousands of global visitors.<br />
<br />
Located in the Las Vegas Convention Center and The Venetian, the ICC&nbsp;is a&nbsp;popular destination for non-U.S. attendees. The ICC&rsquo;s include:<br />
<ul>
	<li>
...
This promotional opportunity extends far beyond the walls of the ICC. You&rsquo;ll receive months of exposure with the following promotions:<br />
<ul>
	<li>
		Recognition in all preshow and on-site materials referencing the ICC</li>
	<li>
...
&nbsp;<br />
Contact us at <a href="mailto:byb@CE.org?subject=Interested%20in%20ICC%20Sponsorship">byb@CE.org</a> or 703-907-4324 to secure this opportunity.
