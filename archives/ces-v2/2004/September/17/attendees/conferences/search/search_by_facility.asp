...
<html>
<head><!-- PageID 1696 - generated by RedDot 5.6 - 5.6.0.25 - Y-9bp -->
...
<div>
<form action="/attendees/conferences/search/session_by_facility_list.asp" method=post><table cellpadding=3 cellspacing=1 border=0><tr><td><span class='subhead'>Choose a facility from the drop-down list.</span></td></tr><tr height=7><td></td></tr><tr><td colspan=1><select class=formdata name=faevfacility><option value=0>Choose a Facility&nbsp;&nbsp;<option value="Gold Exhibits @ LVCC">Gold Exhibits @ LVCC<option value="North Hall">North Hall<option value="South Hall">South Hall</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
</div>
