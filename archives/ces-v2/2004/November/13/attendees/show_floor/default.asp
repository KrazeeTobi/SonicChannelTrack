...
<a href="/attendees/show_floor/floor_plans/default.asp">Floor Plans</a><br>
    ...
    <img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
               <script language="JavaScript">
              <!--
                  if (checkActiveNav("/attendees/show_floor/floor_plans/default.asp")) { document.getElementById("fourth_row_container35").style.display = "";}
              //-->
              </script> <img src="/global_images2005/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
<a href="/attendees/show_floor/product_locator/default.asp">Product Locator</a><br>
    ...
    <img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
               <script language="JavaScript">
              <!--
                  if (checkActiveNav("/attendees/show_floor/product_locator/default.asp")) { document.getElementById("fourth_row_container171").style.display = "";}
              //-->
              </script> 
        <img src="/global_images2005/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
