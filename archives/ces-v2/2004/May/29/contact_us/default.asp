...
<head>
	...
	<title>2004 International CES:&nbsp;Contact Us</title>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="home7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Contact the International CES<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				
	
<div id="0.3">	
<!-- text for main page -->
<span class="section_title">Need help? Have a question?</span>
<br><br>
Contact our Customer Service Center, and we will be happy to assist.
...
<tr>
	<td colspan=3><b>Please assist us in directing your e-mail message by answering the following questions.</b>
...
<tr>
	<td colspan=3><strong>Do you have ideas for improving this site? Are there features that can be added to make this site more valuable for you?</strong><br><br></td>
</tr>
...
To speak with a customer service representative, call our Customer Service Center at (866) 233-7968. We are available to answer calls during normal business hours (9 a.m. to 5 p.m. EST Monday through Friday). 
