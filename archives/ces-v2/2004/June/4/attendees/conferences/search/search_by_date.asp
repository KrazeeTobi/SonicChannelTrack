...
<head>
	...
	<title>2004 International CES:&nbsp;Search the Conference Program by Date</title>
...
<!-- CONFERENCES -->
	...
	<a href="/attendees/conferences/search/search_by_name.asp">Search for Sessions</a><br>
			...
			<span class="nav_fourth_arrow"><b>></b> &nbsp;</span>by Date</a><br>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Sessions by Date<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<!-- text for main page -->
<div id="1.1.6.4">
<form action=session_by_date_list.asp method=post><table cellpadding=3 cellspacing=1 border=0><tr><td><span class='subhead'>Choose a date from the drop-down list.</span></td></tr><tr height=7><td></td></tr><tr><td colspan=1><select class=formdata name=sessiondate><option value=0>Choose a Date&nbsp;&nbsp;<option value="1/6/2004">Tuesday, January 6<option value="1/7/2004">Wednesday, January 7<option value="1/8/2004">Thursday, January 8, CES Day 1<option value="1/9/2004">Friday, January 9, CES Day 2<option value="1/10/2004">Saturday, January 10, CES Day 3<option value="1/11/2004">Sunday, January 11, CES Day 4</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
