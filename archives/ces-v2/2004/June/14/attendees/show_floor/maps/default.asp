...
<head>
	...
	<title>2005 International CES:&nbsp;Venue Maps</title>
...
<!-- SHOW FLOOR -->
	...
	<a href="/attendees/show_floor/areas/">Exhibit Areas</a><br>
	...
	<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
	<!--
	<a href="/attendees/show_floor/floor_plans/floor_plans.asp">Floor Plans</a><br>
	<img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
	-->
	<a href="/attendees/show_floor/techzones/">TechZones</a><br>
	<img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="24" alt="" border="0"><br>
	<!--
	<a href="/attendees/show_floor/displays/">Special Displays</a><br>
	<img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
	<a href="">Product Locator</a><br>
	<img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="24" alt="" border="0"><br>
	-->
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/1.0/1.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Venue Maps<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
<!-- text for main page -->
<!--
<span class="subhead">2004 International CES Interactive Birds Eye View</span><br>
Get an interactive view of the 2004 International CES. <strong>Simply click on the image below.</strong> Once it downloads, select the colored sections of the map to learn more about what's featured within the Las Vegas Convention Center as well as the Alexis Park Hotel, Las Vegas Hilton and other areas of the world's largest annual consumer technology event.<br>
<span class="text_colored">(Flash required.)</span>
<br><br><br>
<table width="100%" cellpadding="0" cellspacing="0" border="0">
<tr>
	<td align="center">
	<a href="FlashMapCES04.swf" target="new"><img src="images/interactive.gif" border="0" style="border: 4px #333333 solid"></a>
	</td>
</tr>
</table>
-->
...
<span class="subhead">2005 International CES Location Map</span><br>
Locate registration, shuttle bus routes, parking and much more. <a href="locationMap6-10.pdf" target="_blank">Download and print an Adobe PDF version</a> of the 2005 International CES Location map and bring it with you to the show.
<br><br><br>
<table width="100%" cellpadding="0" cellspacing="0">
<tr>
	<td align="center"><a href="locationMap6-10.pdf" target="_blank"><img src="images/locationMap.jpg" border="0" style="border: 1px #cccccc solid"></a>
	</td>
</tr>
</table>
