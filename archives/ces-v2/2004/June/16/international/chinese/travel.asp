...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/international/">International Visitors</a>&nbsp;>&nbsp;<a href="/international/chinese/">Chinese</a>&nbsp;>&nbsp;
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.7.1") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="380"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">旅行和签证信息<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<meta http-equiv="Content-Type" content="text/html; charset=gb2312"><div id="4.7.1">	
<!-- text for main page -->
...
让我们帮助您为参加2005年国际消费电子产品展CES <a href="/attendees/travel/">组织您的旅行计划 (英文版)</a>。我们与许多旅馆、航空公司、租车公司和其他旅行专家协作，为国际消费电子产品展CES 的参加者和参展厂商提供打折优惠价格。 
<br>

<img src="/global_images/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/4.0/4.0.line.gif" alt="-----------------------------------------------" width="380" height="2" hspace="0" vspace="0" border="0"><br>
<div class="section_title">签证信息</div>
您需要为参加 2005 年国际消费电子产品展 CES 办理护照签证手续吗?现在您可以 <a href="http://evisaforms.state.gov/" target="_blank">上网填写签证申请表</a>。
<br><br>
当您申请入美签证时，应该做的事情： 
<ol>
	<li><strong>尽早</strong>申请签证！美国所有驻外使馆均设立<a href="http://travel.state.gov/specialnotice.html" target="_blank">新审核程序</a>，这样就拉长了您的申请时间。美国领事馆建议您至少在旅行日前60天开始办理签证申请手续。您可以打电话到<a href="http://travel.state.gov/links.html" target="_blank">当地大使馆</a>的领事处，了解签证约谈的等候时间。
	<li>显示证据证明您与您的居住国之间有着紧密的联系。对您的工作或拥有的企业的证明是‘紧密联系’的良好实例。 
	<li>如果可能，显示证据证明您过去曾经出国访问过，而且您在护照规定的时间范围内返回自己的居住国。 
	<li>在接受签证约谈时，向领事馆出示您的签证邀请函。签证邀请函虽然并非签证申请之必备文件，但能够作为支持性文件而有所帮助。若要获取邀请函，您必须 <a href="/register/">登记参加 2005 年国际消费电子产品展</a>。 
</ol>
<br>
欲知更多有关签证约谈成功秘诀的信息， 请 <a href="file:///B|/Translation%20Jobs%20-%202004/04-054%20CEA%20website/Source/ASP%20files/pdf/2k5tips_english.pdf" target="_blank">下载我们的签证提示单 (pdf 文件)</a>。
<br><br>

<span class="subhead">免签证计划 (VWP) – 新旅行政策生效</span><br>
从2004年10月26日起，所有27个享有免签证来美待遇 (VWP) 国家的免签证旅客，必须出示电脑可读护照或美国签证。欲知详情，请参阅“关于免签证和所要求的电脑可读护照，<a href="http://travel.state.gov/vwp.html#3" target="_blank">我需要知道什么</a>。”
<br>
<br>

<span class="subhead">US-Visit Program（美国访问计划）</span><br>
“美国访问计划”是美国国土安全部制订的一项增强国家出入境安全的计划。它使美国能够有效地验证来访者身份，确保符合签证及移民政策的规定。 
<br><br>
若要知道其他方面的信息，请访问 <a href="http://www.dhs.gov/us-visit" target="_blank">美国国土安全部</a> 旅行和交通网站。
<br><br>
入境美国的手续： 
<ul>
	<li>许多今天仍在使用的美国入境手续将保持不变，国际旅客对这些手续也十分熟悉。 
	<li>新的不用墨的数字 "指纹扫描仪" 使用方便。持签证的旅客先将左手食指，然后再将右手食指放在玻璃板上，电子指纹扫描仪很快地就能捕获到两个指纹。
	<li>美国海关及边防守护官员将检查诸如签证和护照之类的旅行文件，并询问旅客与其在美国停留有关的问题。
	<li>旅客还将脸对摄影机，拍下他们的数字相片。 
	<li>入关手续的加强将增加少量的手续时间，在大多数情况下，平均每人增加15秒钟的时间。
</ul>
...
<span class="subhead">其它有用的链接：</span>
<ul>
<li><a href="http://travel.state.gov/DS-0156.pdf" target="_blank">Nonimmigrant Visa Application (pdf) （PDF文件格式的非移民签证申请）</a>
<li><a href="http://www.UnitedStatesVisas.gov" target="_blank">Current visa information （目前签证信息）</a>
<li><a href="http://www.tsa.gov/public/display?theme=183&content=090005198007e349" target="_blank">Airport security travel tips （机场保安旅行提示）</a>
<li><a href="http://www.dhs.gov/us-visit" target="_blank">U.S. Dept. of Homeland Security （美国国土安全部）</a>
<li><a href="/international/english/pdf/2k5 Visa Tip Sheet Eng..pdf" target="_blank">Visa Tip Sheet (pdf) （PDF文件格式的签证提示单）</a>
</ul>
...
<span class="subhead">团体旅行</span><br>
如果您想参加团体旅行，请了解有关我们的 <a href="/international/chinese/delegations.asp">代表团方案。</a>
<br>

<img src="/global_images2005/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/4.0/4.0.line.gif" alt="-----------------------------------------------" width="100%" height="2" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/spacer.gif" alt="" width="1" height="3" hspace="0" vspace="0" border="0"><br>
<span class="subhead">美国商业部国际买主项目（IBP）</span><br>
2005 年国际消费电子产品展 CES 荣幸参与美国商业部所属美国商业服务中心主办的 <a href="http://www.export.gov/comm_svc/intl_buyer_program.html" target="_blank">国际买主项目(IBP)</a>。
<br><img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<a href="http://www.export.gov/comm_svc/intl_buyer_program.html" target="_blank"><img src="/international/images/IBPlogo.gif" style="border: 1px #999999 solid" alt="U.S Dept. of Commerce International Buyer Program"></a>
