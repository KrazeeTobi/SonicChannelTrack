...
<head>
	...
	<title>2005 International CES:&nbsp;About Best of CES</title>
...
<!-- AWARDS -->
	...
	<a href="/attendees/awards/best_of_ces/">Best of CES</a><br>
			...
			<span class="nav_fourth_arrow"><b>></b> &nbsp;</span><a href="/attendees/awards/best_of_ces/2004.asp">2004 Award Winners</a><br>
			</span>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/1.0/1.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">About Best of CES<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
<br><img src="/global_images2005/spacer.gif" alt="" width="1" height="25" hspace="0" vspace="0" border="0"><br>
...
<ul>
	<li><b>Accessories:</b> Peripheral devices and software that enhance the other categories without replacing them. Includes innovative apparel, adapters, carrying cases, and add-ons.
	<li><b>Auto, Marine, and RV:</b> Anything that goes in your car, boat, or RV. Includes car stereo systems, car alarms, mobile entertainment systems, satellite antennas, fixed navigation systems, and other in-dash systems. 
	<li><b>High-End Audio:</b> For the real audiophile. Includes tube amps, high-end speaker systems, external digital-to-analog decoders, and ultrahigh-quality media players. 
	<li><b>High-End Video:</b> High-definition TVs and display technologies including rear-projection TVs, projectors, DLPs, LCOS displays, and high-end video components. 
	<li><b>Home Audio and Video:</b> Consumer-level amps, all-in-one home theater systems, PVRs, 5.1 audio systems, speakers, and components. 
	<li><b>Home Media Devices:</b> Media servers and receivers. Includes devices that manage, distribute, and aggregate all your home digital media. 
	...
	<li><b>Mobile Computing and Wireless:</b> Portable systems and mobile wireless devices. Includes PDAs, handheld GPS devices, handheld computers, wireless add-ons, cellular phones, 2.5 and 3G handsets, and other portable data devices. 
	<li><b>Photo and Imaging:</b> Anything that helps you take or print better pictures. Includes digital cameras, photo printers, scanners, photo-finishing devices and services, ink, and paper. 
	<li><b>Portable Audio and Video:</b> Includes portable digital audio and video players, DV and analog camcorders, portable DVD players, and portable displays. 
</ul>
<br>
<span class="subhead">Best of the Best</span> 
<ul>
    <li><b>Best of Show:</b> One overall Best of Show award is given out to the best product at CES, as voted by the judges. The winner from each category is eligible for this award.
</ul>
...
<img src="/global_images2005/spacer.gif" alt="" width="1" height="25" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/1.0/1.0.line.gif" alt="-----------------------------------------------" width="590" height="2" hspace="0" vspace="0" border="0"><br>
<div class="section_title">How is Best of CES Award different from the CES Innovations Award?</div>
...
<br><br>
<!--<span class="subhead">Visit <a href="http://www.techtv.com/freshgear/bestofces/story/0,23008,3353578,00.html" target="new">www.TechTV.com</a> this Fall for information on how to submit your new product in TechTV's Best of CES.</span>
<!-- /text for main page -->
