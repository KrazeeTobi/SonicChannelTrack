...
<!-- logo and banner image row -->	
	<tr>
	    ...
	    <td width="10"></td>
	    <td width="610" colspan="6"><img src="/global_images/4.0/random_main0/4.0.banner.gif" alt="" width="610" height="74" border="0"></td>
	</tr>
<!-- /logo and banner image row -->		
...
<!-- colored row with section color 4 - 5 pixels high --> 
	<tr>
	    ...
	    <td width="140"></td>
	    <td width="10"></td>
	    <td width="610" colspan="6"  background="/global_images/spacer.gif" class="international4"><img src="/global_images/4.0/random_main0/4.0.bc_top.gif" width="610" height="5" hspace="0" vspace="0" border="0"></td>
	 </tr>
<!-- /colored row with section color 4 - 5 pixels high --> 	 
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<td width="610" colspan="6" background="/global_images/spacer.gif" class="international5"><img src="/global_images/4.0/random_main0/4.0.bc.gif" width="610" height="40" hspace="0" vspace="0" border="0"></td>
