...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.7.3") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">国际服务<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<meta http-equiv="Content-Type" content="text/html; charset=gb2312"><div id="4.7.3">	
<!-- text for main page -->

<span class="subhead">国际商务中心 (ICC)</span><br>
国际商务中心是您和参加会展的同行聚会的最佳场所。查看电子邮件，品尝茶点饮料，请通晓多种语言的工作人员解答您有关会展的问题。国际商务中心位于拉斯维加斯会议中心南楼和拉斯维加斯希尔顿大酒店楼上，对所有国际参加者和参展厂商开放。 
<br><br>

<span class="subhead">提供口译员</span><br>
通晓多种语言的现场工作人员在 ICC 所在地以及南楼低层的国际来宾登记报到处迎候您的光顾。口译员可以流利地讲说以下语言：西班牙语、德语、法语、汉语、日语、韩语、意大利语和葡萄牙语。 
<br><br>

<span class="subhead">国际招待会</span><br>
在会展的第一个晚上，享受与世界各地的参展厂商和参加者的沟通和交流。国际招待会将于1月6日星期4晚上6时至7时30分在南楼 S222 室举行。所有国际参加者、参展厂商以及新闻界人士均将被邀请出席这一人际交流的盛会。 
<br><br>
您还建议我们向国际参加者和参展厂商提供其它什么服务吗？若有的话， 请发电子邮件给 Diann Groff， 地址为： <a href="mailto:dgroff@ce.org">dgroff@ce.org</a>。
