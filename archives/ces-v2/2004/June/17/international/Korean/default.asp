...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.5") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">해외 방문객<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<meta http-equiv="Content-Type" content="text/html; charset=euc-kr"><div id="4.5">	
<!-- text for main page -->

International CES는 광범위한 성격의 해외 전시 업체와 참관인은 물론 전세계의 회사들과 네트워킹을 원하는 수천 개의 미국 가전 분야 전문가들을 유치하는 모임입니다. 
<br>
...
<tr>
    <td width="285" valign="top"><span class="subhead"><a href="travel.asp">여행 및 비자 안내</a><br></span>
2005 International CES를 위한 여행 계획은 일찍 하실수록 좋습니다. 저희는 호텔 할인 요금에서부터 비자 신청까지 편리하신 미국 여행이 되도록 도와드리기 위해 최선을 다하고 있습니다. 		<br><br>
		<span class="subhead"><a href="delegations.asp">대표단 프로그램 (신규!)</a><br></span>
2005년 1월 6-9일에 있게 될 유명 가전 쇼를 직접 체험하시고, 미국 라스베가스에 개최되는 2005 International CES에는 대표단과 함께 오시기 바랍니다. 이 새로운 프로그램에 대해 문의하십시오. 	</td>
    
	<td width="20"><img src="/global_images2005/spacer.gif" alt="" width="20" height="1" border="0"></td>
    
	<td width="285" valign="top">
		<span class="subhead"><a href="services.asp">해외 방문객 서비스</a><br></span>
International CES는 외국에서 오시는 전시업체와 참관인을 위해 특별히 마련된 다양한 서비스를 제공합니다. 통역 서비스와 무역 센터, 리셉션 등에 대해 문의해 주십시오.	</td>
</tr>
</table>
