...
<head>
	...
	<title>2004 International CES:&nbsp;Search the Conference Program by Facility</title>
...
<!-- CONFERENCES -->
	...
	<a href="/attendees/conferences/search/search_by_name.asp">Search for Sessions</a><br>
			...
			<span class="nav_fourth_arrow"><b>></b> &nbsp;</span>by Facility</a><br>			
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Search by Facility<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
				

<!-- text for main page -->
<div id="1.1.6.6">
<form action=session_by_facility_list.asp method=post><table cellpadding=3 cellspacing=1 border=0><tr><td><span class='subhead'>Choose a facility from the drop-down list.</span></td></tr><tr height=7><td></td></tr><tr><td colspan=1><select class=formdata name=faevfacility><option value=0>Choose a Facility&nbsp;&nbsp;<option value="Alexis Park">Alexis Park<option value="Gold Lot @ LVCC">Gold Lot @ LVCC<option value="Las Vegas Hilton">Las Vegas Hilton<option value="North Hall">North Hall<option value="Riviera Convention Center">Riviera Convention Center<option value="South Hall">South Hall</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
