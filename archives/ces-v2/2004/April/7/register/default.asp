...
<head>
	...
	<title>2004 International CES:&nbsp;2005 International CES Registration</title>
	
	<!-- INSERT SEARCH ZONE HERE -->
	<META NAME="searchZone" CONTENT="generalCESweb">

	<!-- INSERT ANY SCRIPT TAGS FOR THIS PAGE HERE (header.asp closes the <head> tag!) -->
	<!--<SCRIPT language="javascript1.2" SRC="/register/include/js/validate_reg_form.js"></SCRIPT>-->
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="home7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">2005 International CES Registration<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
...
<!-- text for main page -->
	...
	<br><br>
	<span class="subhead">Be the first to register!</span>
	<br>
	<span class="text_colored">Please enter your e-mail address, and we'll let you know when registration begins for the 2005 International CES.</span>
	<br><br>

	<form name="registration_form" action="default.asp" method="post">
...
<tr>
	...
	<tr><td><img src="/global_images/spacer.gif" height="16" width="1"></td></tr>	
	<tr>
		<td>&nbsp;</td>
		<td><span class="text+colored">*Your privacy is important to us. Please review our <a href="/privacy/default.asp">privacy policy</a> for details.</span></td>
	</tr>
	</table>
	</form>
