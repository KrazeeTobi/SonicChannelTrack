...
<head>
	...
	<title>2004 International CES:&nbsp;byb+ Direct Mail Opportunities</title>
...
<br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images/spacer.gif" height="10" width="1"><br><div class="body_title">Direct Mail Opportunities<br><img src="/global_images/spacer.gif" height="16" width="1"></div>
...
<table class="exhibitor8" width="590" cellspacing="0" cellpadding="0" border="0">
	<tr>
	    ...
	    <td width="154"><img src="/global_images/spacer.gif" alt="" width="154" height="10" hspace="0" vspace="0" border="0"></td>
	    <td width="10"><img src="/global_images/spacer.gif" alt="" width="10" height="10" hspace="0" vspace="0" border="0"></td>
	    <td width="213"><img src="/global_images/spacer.gif" alt="" width="213" height="10" hspace="0" vspace="0" border="0"></td>
		<td width="10"><img src="/global_images/spacer.gif" alt="" width="10" height="10" hspace="0" vspace="0" border="0"></td>
...
<table width="590" cellspacing=0 cellpadding=1 border=0 ID="Table1">
	...
	<tr>
		<td colspan=3><br>
		Coordinate your e-marketing campaign with the extensive International CES marketing campaign. Add your message to CES e-mails. Reach more than 80,000 readers per e-mail, including pre-registrants and 2003 International CES attendees, loyal CES customers, conference attendees, VIP buyers, an international audience and more.
		<br><br>
	...
	<tr valign="top">
		<td width="300"><span class="section_title">2003 International CES Post Show Attendee Mailing Lists</span></td>
		<td width="290"><span class="section_title">$625+</span></td>
	</tr>	
	<tr>
		<td colspan=3><br>
		Reach a targeted group of International CES attendees via mail, months before the show doors open. Reinforce your messaging to our verified, post show 2003 attendee list.
		<br><br>	
		<a href="pdfs/ListRentalAgreementForm.pdf" target="new">Download and print the order form.</a>	
		<br><br>
		<B>Marketing Investment</B><br>
