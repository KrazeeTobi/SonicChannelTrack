...
<!-- Rollover script -->	
		...
		/* for graphical rollovers*/
			...
			function introllOver(which,name) 
				{
				var on="/global_images/4.0/random_main4/4.0_" + which + "_r.gif";
			...
			function introllOff(which) 
				{
				var on="/global_images/4.0/random_main4/4.0_" + which + ".gif";
...
<!-- logo and banner image row -->	
	<tr>
	    ...
	    <td width="10"></td>
	    <td width="610" colspan="6"><img src="/global_images/4.0/random_main4/4.0.banner.gif" alt="" width="610" height="74" border="0"></td>
	</tr>
<!-- /logo and banner image row -->		
...
<!-- colored row with section color 4 - 5 pixels high --> 
	<tr>
	    ...
	    <td width="140"></td>
	    <td width="10"></td>
	    <td width="610" colspan="6"  background="/global_images/spacer.gif" class="international4"><img src="/global_images/4.0/random_main4/4.0.bc_top.gif" width="610" height="5" hspace="0" vspace="0" border="0"></td>
	 </tr>
<!-- /colored row with section color 4 - 5 pixels high --> 	 
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<td width="610" colspan="6" background="/global_images/spacer.gif" class="international5"><img src="/global_images/4.0/random_main4/4.0.bc.gif" width="610" height="40" hspace="0" vspace="0" border="0"></td>
...
-->
	...
	<tr>
		...
		<img src="/global_images/spacer.gif" width="10" height="12"><br>
		<div class="section_title">Prepare for the 2004 International CES today</div>
		<!--
		<span class="subhead"><a href="http://ww4.expocard.com/ces041/default.asp">Get your Visa Letter of Invitation now</a></span><br>
		You must <a href="http://ww4.expocard.com/ces041/default.asp">register</a> for the 2004 International CES to receive a visa letter of invitation&mdash;which is mandatory for some international travelers coming to the U.S. Once you register and complete the registration process, you will receive you letter by airmail within approximately four weeks. 
		<br><br>
		-->
		<span class="subhead"><a href="/attendees/conferences/keynotes.asp">See the impressive 2004 keynote lineup</a></span><br>
		Learn what is happening next in the industry from the people right on the forefront of consumer technology. Hear Bill Gates (Microsoft), Carly Fiorina (HP), Fumio Ohtsubo (Panasonic/Matsushita) and other top-level executives from some of the industry's most powerful companies.
		<br><br>
		<span class="subhead"><a href="/attendees/conferences/">Enjoy the benefits of being an international traveler</a></span><br>
		The International Premier Package gives you access to all the exhibits, keynotes, SuperSessions, and more than 50 Knowledge Track sessions. Plus, receive tickets to VIP luncheons, the International Reception and other benefits offered <strong>exclusively to our international attendees</strong> for $299 (U.S.) if purchased before December 5, 2003.
	
		<!--
		<span class="subhead"><a href="/attendees/travel/hotel.asp">Book your hotel room early</a></span><br>
		Rent one room or get quotes for an entire block. Our new hotel program makes either option easy. 
		<br><br>
		<span class="subhead"><a href="english/default.asp#IPP">International Premier Package</a></span><br>
		Gain access to all the exhibits, keynotes, SuperSessions, and more than 70 conference sessions. Plus, you receive tickets to VIP luncheons, the International Reception, and much more!
		<br><br>
		<span class="subhead"><a href="english/default.asp#IPP">International Buyer Program (IBP)</a></span><br>	
		International CES Attendees can take advantage of the IBP's Global Matchmaking Program and find exhibitors interested in exporting opportunities outside the United States.
		-->
		<br><br><br>
		</td>
		...
		<!--a href="/about_ces/photos/default.asp"><img src="/global_images/4.0/cabinet.jpg" width="190" height="111" alt="show floor image" border="0"></a><br><img src="/global_images/spacer.gif" width="1" height="20"><br>-->
			...
			<table cellpadding="0" cellspacing="4" border="0" style="border: 1px #999999 solid">
				<tr>
					<td colspan="3"><span class="subhead">Show days and times</span></td>
				</tr>
				<tr>
				...
				<tr><td><img src="/global_images/spacer.gif" width="1" height="4" border="0"></td></tr>
				<tr>
					<td colspan="3">
					*South Hall exhibits open at 9 a.m.
					</td>
				</tr>
			</table>
			<br>
			<span class="subhead"><a href="/faqs/general.asp?id=20#security">Show security</a></span><br>
			To keep the show running safely and smoothly, please review the security guidelines.
			<br><br>
			<span class="subhead">New: International travel security</span><br>
			International visitors from non visa-waiver countries may be affected by the new US VISIT program, a screening process that includes fingerprint scanning.
			Visit the <a href="http://www.dhs.gov/dhspublic/interapp/editorial/editorial_0333.xml" target="new">Department of Homeland Security site</a> for more information.
			<br><br><br>
		</td>
		<td width="10" class="international8"><img src="/global_images/spacer.gif" width="10" height="1"></td>
	</tr>
