...
<LI>8' x 8' screen </LI>
<LI>VGA switch box </LI></UL><BR><SPAN class=subhead>Presentation materials</SPAN><BR>Speakers who wish to use visuals during their conference session must provide their own laptops and are encouraged to use the <A href="/print/docs/2k5_CES_Speaker.ppt" target=_blank>International CES PowerPoint template</A>&nbsp;(pdf).
</span>
<a name="397"></a>
<img src="/print/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
