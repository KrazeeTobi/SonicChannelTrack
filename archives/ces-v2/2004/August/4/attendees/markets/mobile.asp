...
<head>
	...
	<title>2005 International CES:&nbsp;Mobile Electronics</title>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/1.0/1.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
	...
	<tr> 
		...
		Learn about <a href="http://www.ce.org/ce_technologies/display.asp?id=Mobile" target="new">CEA Mobile Electronics initiatives</a> and how you can get involved.<br>
	...
	<tr> 
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="380"  background="/global_images2005/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Mobile Electronics<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="1.6.7">		
<!-- text for main page -->
<!--span class="section_title">What moves you?</span><br><br>-->
<img src="images/mobile2.jpg" align="right" hspace="5" style="border: 1px #cccccc solid">
The family car is about to be swept up in the multimedia revolution that already has transformed living rooms into home theaters. People want to take their music and video wherever they spend their time&mdash;including in their cars&mdash;mobile electronic entertainment will push to rival the living room experience in terms of audio and video quality and convenience. Both in-dash and overhead video units with an integrated DVD receiver/player are becoming the focal point for a mobile entertainment system.
 
<br><br>Innovative technology and design achievements continue to dramatically raise the bar for the mobile electronics industry. See it all at the 2005 International CES: hard-disk-based source components, head-units that play music stored on flash media, mobile video with multi-channel sound, GPS vehicle navigation, satellite radio and more.
...
At the 2005 International CES, expect more than 270 mobile electronics exhibitors, including Alpine, Blaupunkt, Clarion, Delphi and iBiquity.
<br><br>
Use the <a href="/attendees/directory/exhibitor_name.asp">exhibitor directory</a> and search by product category to see a complete list of 2005 mobile electronics exhibitors.
<!--<ul>-->
...
These 2005 International CES TechZones offer buyers, distributors, engineers and other attendees and exhibitors a condensed cross-section of the mobile electronics market:
...
<ul>
	<li><a href="/attendees/conferences/search/session_by_track_list.asp?ID_track=MECP04&ref=MECP04">MECP</a><br>
</ul>
<br>
...
See the full list of <a href="/attendees/special_events/">special events</a> and <a href="/attendees/exhibit_floor/displays/">displays</a> that took place at the 2004 International CES, including these designed for the mobile electronics market:
<ul> 
	<li>Mobile Electronics Division and MECP Reception
	<li>2004 Select Products MECP Installer Challenge
	<li>Acura: Official Automotive Sponsor
	<li>TechnoCar 
</ul>
<br>-->
<strong>Visit the CEA website, <a href="http://www.CE.org">www.CE.org</a></strong>, to learn more about publications, upcoming events and current initiatives in mobile electronics.
<br>
...
<tr> 
	...
	<tr>
		<td><img src="/global_images2005/markets/mobile.gif" alt="" hspace="0" vspace="0" border="0"></td>
	</tr>
	<tr>
		<td>Look for this sign to find mobile electronics exhibits on the 2005 International CES show floor.</td>
	</tr>
	</table>
	</td>
...
<tr>
	<td valign="top"><img src="/global_images2005/bullet.gif"></td><td><strong>Mobile Electronics Division and MECP Reception</strong><br><span class="text_colored">5:30-7:30 p.m. January 9, LVCC South Hall, Room S226</td>
</tr>
<tr>
	<td valign="top"><img src="/global_images2005/bullet.gif"></td><td><strong>2004 Select Products MECP Installer Challenge</strong><br><span class="text_colored">LVCC Gold Exhibits</span><br>Watch as the best-of-the-best installers compete in this four-day mobile installation contest.</td>
</tr>
<tr>
	<td valign="top"><img src="/global_images2005/bullet.gif"></td><td><strong>Acura: Official Automotive Sponsor</strong><br><span class="text_colored">LVCC Silver Exhibits</span><br>Acura will feature the 270-hp TL for viewing and demonstrations of technological firsts.</td>
</tr>
<tr>
...
<span class="subhead">Mobile Electronics at the International CES</span><br>
<ul>
	<li>CES is the largest mobile electronics tradeshow in the world.
	<li>Whether it's GPS, IDB, vehicle navigation, car audio and security, radar detectors or satellite radio, CES is the place to catch the latest developments in mobile electronics.
	<li>CEA's TechnoCar showcases the latest mobile electronics innovations for drivers and riders in one simple display.
	<li>Leading executives from the Society of Automotive Engineers (SAE), the transportation industry and car manufacturing industry come to CES to see and learn about the latest in mobile electronics.
	<li>More than 23,000 attendees conducted mobile electronics business at the 2004 International CES.
	<li>Conference sessions cover mobile electronics topics, including GPS technology, aftermarket automotive parts and telematics.
	<li>CES offers on-site MECP training and testing for professional installers. Topics include navigation, multimedia and mobile computing, as well as audio, security, troubleshooting, installation technique and shop safety.
</ul><br>
...
<!--
<img src="/global_images2005/spacer.gif" alt="" width="1" height="20" hspace="0" vspace="0" border="0"><br>
<span class="subhead">2003-2004 Mobile Electronics Advances</span>
<ul>
	<li>In-car DVD lets consumers take the show on the road. 
	<li>Drop-down and in-dash displays get bigger, better. 
	<li>CEA-2006 amp standard receives widespread industry support. 
	<li>Speaker, head-unit suppliers get a boost from multi-channel sound.  
	<li>Telematics systems move beyond roadside assistance. 
	<li>Satellite radio services add real-time traffic, financial reports.  
	<li>Digital radio (HD Radio) debuts in more than 100 markets.  
	<li>Navigation chalks up solid sales gains.  
	<li>Radar detectors counteract “pop” guns.  
</ul>
<br>
