...
<head>
	...
	<title>2005 International CES:&nbsp;Speaker Services</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/attendees/">Attendees</a>&nbsp;>&nbsp;<a href="/attendees/conferences/">Conferences</a>&nbsp;>&nbsp;<a href="/attendees/conferences/speakers/">Speaking Opportunities</a>&nbsp;>&nbsp;Speaker Services
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="attendees6"><img src="/global_images2005/1.0/1.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","1.1.7.2") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/1.0/1.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/1.0/1.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/1.0/1.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Speaker Services<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<!-- text for main page -->
<div id="1.1.7.2">
<!--AUGUST 15th DEADLINE HAS PASSED
Thank you for your interest in our speaking opportunities for the 2004 International CES.  Unfortunately, the deadline has passed and we are no longer accepting call for speakers.  However, if you would like us to keep you in mind for future CEA/CES events, continue on to the submission form. (www.ce.org/events/speaking_opps.asp)
-->
...
CES speakers have access to our Speaker Ready Rooms. Take advantage of this area to orient yourself with the program location, fine tune your presentation and network with your peers. The Speaker Ready Rooms are located in the Las Vegas Convention above the North Hall exhibits next to room N263 and in the South Hall Room S117/118.
<br><br>
Amenities include:
<ul>
...
<span class="subhead">Presentation materials</span><br>
<!--Speakers who wish to use visuals during their conference session must provide their own laptops and are encouraged to use the International CES PowerPoint template.  <a href="include/2004Presentation.ppt" target="new">Download it now.</a>-->
Speakers who wish to use visuals during their conference session must provide their own laptops and are encouraged to use the International CES PowerPoint template.  The CES PowerPoint template will be available at a later time.
<br><img src="/global_images2005/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/1.0/1.0.line.gif" alt="-----------------------------------------------" width="590" height="2" hspace="0" vspace="0" border="0"><br>
...
<br>
<a href="mailto:kricker@CE.org">Kelly Ricker</a> Director, Conferences 
<br>
<a href="mailto:mkeenan@CE.org">Meghan Keenan</a>, Manager, Conferences
<br>
<a href="mailto:khooper@CE.org">Kartraice D. Hooper</a>, Senior Coordinator, Conferences
<br>
<a href="mailto:mwest@CE.org">Megan West</a>, Assistant, Conferences
