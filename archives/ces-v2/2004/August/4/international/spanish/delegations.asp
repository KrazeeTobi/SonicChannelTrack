...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.2.2") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<!-- SPANISH -->
	...
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
	Programa de grupos de delegaciones</a><br>
	<img src="/global_images2005/spacer.gif" width="140" height="6" alt="" border="0"><br>
	<img src="/global_images2005/navigation/3nav_bar_gray.gif" alt="--------" width="140" height="1" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br> 
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Programa de grupos de delegaciones<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="4.2.2">	
<!-- text for main page -->

La feria International CES le facilita todo lo que sea posible el proceso de reclutar y traer un grupo a la exposición. Trabajaremos con usted para ayudarle a alcanzar el éxito con sus esfuerzos y para que sus delegados queden satisfechos con el valor agregado y los incentivos que reciben por viajar en su grupo.
<br><br>
Conviértase hoy mismo en un líder oficial de delegaciones. Simplemente llene el <a href="/international/english/pdf/International Delegation Group Program Application.pdf" target="_blank">Formulario de solicitud para delegación (formato pdf)</a> y envíelo por fax a Elena Vasquez al 703-907-7602.
<br><br>

<span class="subhead">Los beneficios como líder de delegaciones incluyen: </span>
<ul>
	<li>Folletos promocionales y plantillas electrónicas para ayudarle a reclutar delegados.
	<li>Acceso al logotipo de la CES 2005 para identificar los materiales promocionales.
	  *
	<li>Capacidad de registrar en línea a los miembros de la delegación y de darle mantenimiento a su lista.
	<li>Estancia gratuita en el hotel para los líderes de delegaciones que traigan 50 personas o más a la CES (15 para los grupos gubernamentales).
	<li>Inclusión en el sitio web de International CES (<a href="http://www.CESweb.org">www.CESweb.org</a>) como líder oficial de delegaciones.
	<li>Invitación a la cena para los líderes de delegaciones.
	<li>Una mochila de CES con ruedas, para que pueda portar fácilmente el material de la exposición mientras se desplaza por el área de la exposición.
</ul>
<br>

* <em>CES debe revisar y autorizar los materiales promocionales antes de hacer uso del logotipo.</em>
<br><br>

<span class="subhead">Los beneficios para las personas que vengan como parte de un grupo incluyen: </span>
<ul>
	<li>Antes de la CES, el acceso a la lista de expositores que exportan o que han manifestado algún interés por exportar al país y a la región del mundo del grupo.
	<li>Posible asistencia a una sesión de la conferencia de forma gratuita.    
	  <ul>
	    <li> Cada líder de delegación recibirá de 5 a 10 pases. Cada pase es una admisión a una sesión de conferencia. <br>
	      Póngase en contacto con el líder de su delegación si le interesa asistir a una sesión
	      de conferencia. </li>
    </ul>
	<li>Pase Plus de cortesía para las exhibiciones para los miembros de la delegación.
	<li>Guía para la Delegación, que incluye los puntos destacados de la International CES.
	<li>Invitación a la Recepción Internacional.
	<li>Invitación a una sesión informativa y desayuno continental para la delegación durante la mañana del día de la inauguración de la exposición.
</ul>
