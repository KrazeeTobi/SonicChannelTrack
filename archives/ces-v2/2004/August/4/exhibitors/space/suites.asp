...
<head>
	...
	<title>2005 International CES:&nbsp;International CES Meeting Place</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/exhibitors/">Exhibitor Services</a>&nbsp;>&nbsp;<a href="/exhibitors/space/">Exhibit Space</a>&nbsp;>&nbsp;Meeting Place
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.1.4") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/2.0/2.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">CES Meeting Place<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="2.1.4">		
<!-- text for main page -->
<span class="section_title"><i>A Powerful New Opportunity</i></span><br><br>

Take advantage of a unique atmosphere featuring exclusive hospitality suites that deliver a private meeting or display area to suit your needs at the 2005 International CES.  Located right on the show floor, CES Meeting Place hospitality suites deliver an unconventional venue to meet with attendees in a private, comfortable, professional environment.
<br>
...
<img src="images/MeetingPlace.jpg" align="right">
If you're an existing exhibitor who needs more space, or a newcomer who wants to be a part of the International CES success story, the CES Meeting Place can work for you.<br><br>
<span class="subhead">You can:</span><br>
<ul>
<li>Conduct pre-arranged meetings in a convenient location for guests.<br>
<li>Hold spontaneous meetings that, otherwise, wouldn't or couldn't occur.<br>
<li>Collaborate with multiple interested parties in a private setting.<br>
<li>Save your guests time and money by meeting right on the show floor.<br>
<li>Benefit from a networking center that includes complimentary office services such as fax, phone and Internet stations.<br>
<li>Stay close to the show floor action!
</ul><br>

<span class="subhead">The CES Meeting Place package includes:</span>
<ul>
...
<br>
<span class="subhead">Terrific Space. Customized By You.</span><br>Contact an International CES <a href="contacts.asp">business development representative</a> today.
<!--
<br>
<img src="/global_images2005/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/2.0/2.0.line.gif" alt="-----------------------------------------------" width="590" height="2" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/spacer.gif" alt="" width="1" height="8" hspace="0" vspace="0" border="0"><br>
<a href="http://www.channelintelligence.com" target="new"><img border="0" src="/exhibitors/space/images/channelInt.gif" alt="Channel Intelligence" align="bottom"></a>&nbsp;&nbsp;Exclusive sponsor of the CES Meeting Place
-->
<!-- /text for main page -->
</div>	
