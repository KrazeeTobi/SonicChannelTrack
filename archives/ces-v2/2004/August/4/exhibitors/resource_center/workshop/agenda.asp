...
<head>
	...
	<title>2005 International CES:&nbsp;Proposed Exhibitor Workshop Agenda</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.3.8.2") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/2.0/2.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Exhibitor Workshop Agenda<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="2.3.8.2">	
<!-- text for main page -->
<span class="subhead">Tuesday, September 21, 2004</span><br><br>
<b>Continental Breakfast</b><br>8:30 a.m. - 9 a.m.
<br><br>
<b>Information Downloads</b><br>9 a.m. - 11:45 a.m.
<br>
<ul>
	<li>Welcome from CES Show Management and Introductions</li>
	<li>CEA Update: <em>Association Activities to Benefit from the CE Industry</em>
	...
	<li>Operations and Logistics: <em>Effective Planning</em></li>
</ul><br>
<b>Lunch</b><br>12 p.m. - 2 p.m.
<br>
<ul>
	<li>Roundtable Discussions</li>
	<li>Vendor Fair</i>
</ul><br>
<b>Industry Insight / Peer-to-Peer Discussion</b><br>2 p.m. - 3 p.m.
<br><br>
Do it right! Learn from leading exhibitor representatives, ready to share proven ways to maximize your International CES experience.
<br>
<ul>
	<li><em>Making the Most of your Relationship with CES:</em> Jon Bromberg, Industry Consultant, Formerly Director of Events, Microsoft</li>
	<li><em>Learn from the Experts:</em> Exhibitor Panel
</ul>
<br>
<b>Las Vegas Convention Center Tour</b><br>3 p.m. - 4 p.m.
<br><br>
<span class="text_colored">Note: More panelists and speakers are on tap. Check back for updates to this agenda.</span>
