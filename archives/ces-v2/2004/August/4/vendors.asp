...
<head>
	...
	<title>2005 International CES:&nbsp;Prospective Vendor Presentation Request Form</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="home6"><img src="/global_images2005/0.0/0.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","0.12") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/0.0/0.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/0.0/0.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/0.0/0.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Prospective Vendor Presentation Request Form<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
<tr><td colspan=2 height="4"><img src="/global_images2005/spacer.gif" height="25"></td></tr>
...
<tr><td colspan=2 height="25"><img src="/global_images2005/spacer.gif" height="30"></td></tr>
<tr>
	<td colspan="2">
	<img src="/global_images2005/0.0/0.0.line.gif" alt="-----------------------------------------------" width="590" height="2" hspace="0" vspace="0" border="0"><br>
	<img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
...
<tr>
	<td colspan=3><strong>What distinguishes you from your competition?</strong><br><br>
</td>
</tr>
<tr><td colspan=2 height="4"><img src="/global_images2005/spacer.gif" height="4"></td></tr>
<tr>
...
<tr>
	<td colspan=3><strong>References: Please provide 3-5 references from companies with needs similar to CES.</strong>
		<br><span class="text_colored">Be sure to include: company name, address and contact information for each reference.</font><br><br>
