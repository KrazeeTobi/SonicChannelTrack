...
<head>
	...
	<title>2005 International CES:&nbsp;International CES Exhibit Space</title>
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
			...
			<a href="/default.asp">Home</a>&nbsp;>&nbsp;<a href="/exhibitors/">Exhibitor Services</a>&nbsp;>&nbsp;Exhibit Space
			</span><br><img src="/global_images2005/spacer.gif" height="8" width="1"></td>
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="exhibitor6"><img src="/global_images2005/2.0/2.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","2.1") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/2.0/2.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/2.0/2.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<tr> 
    ...
    <td width="130" valign="top" class="greybox">
		<div class="white10"><strong>CEA member discount</strong><br>
		Save on exhibit space and get other great International CES perks when you <a href="http://www.CE.org/join_cea" target="new">join CEA</a>.	
		</div>
	...
	<td width="5" height="14"><img height="14" width=5 src="/global_images2005/grey_BR.gif"  align="top"></td>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="380"  background="/global_images2005/spacer.gif" class="exhibitor7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Exhibit Space<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="2.1">		
<!-- text for main page -->
<img src="/exhibitors/images/demo.jpg" style="border: 1px #cccccc solid" align="right" vspace="4" hspace="8">The 2005 International CES offers the premier location to strike deals, engage in global partnerships and connect to distributors, buyers, resellers and manufacturers of consumer technology. To make the most of each exhibitor's experience, the International CES offers a variety of exhibit space options.
...
Use our <a href="/exhibitors/downloads/Exhibit_Overview.pdf" target="_blank">Exhibitor Overview (pdf)</a> to learn more about who attends the International CES and why, and then look below to see what kind of exhibit space works best for you.
<br><br>

<span class="subhead"><a href="areas.asp">Exhibit Booth Space</a></span><br>
Choose from a variety of exhibiting options, from open space on the show floor to turnkey designer packages.  Divided into easy-to-navigate categories, the show floor's design offers your company maximum exposure to the attendees you need to meet.
<br><br>

<span class="subhead"><a href="techzones.asp">TechZones</a></span><br>
<a href="techzones.asp"><img src="images/techzone_small.gif" align="right" border="0"></a>
Showcase your company in a CES TechZone.  These high-energy, show-within-a-show zones thrust developing technologies and new companies into the limelight.<br>
<br>

<span class="subhead"><a href="suites.asp">Meeting Place</a></span><br>
Conduct private meetings and product demonstrations in hard-walled CES Meeting Place hospitality suites&mdash;right on the show floor!  Customize your meeting space according to your needs.  Access the concierge area.  Receive food and beverage service.  It's that easy.
<br><br>

<span class="subhead">Other Meeting Room Options</span><br>
Hilton hospitality suites and permanent convention center meeting rooms provide other options for exhibitors. Contact an International CES <a href="contacts.asp">business development representative</a> to review availability.
<br>
...
<tr> 
    <td width="5" valign="top" background="/global_images2005/2.0/2.0.box_L.gif"><img height="10" width="5" src="/global_images2005/spacer.gif" vspace="1"></td>
    <td width="180" valign="top" class="box11_5margin"><span class="colored11_bold">Secure your space today</span><br>
	Download the 2005 International CES <a href="/exhibitors/downloads/2k5_space_contract.pdf" target="_blank">Space Agreement (pdf)</a> and contact a <a href="contacts.asp">sales representative</a> to review options and availability.
	</td>
    <td width="5" background="/global_images2005/2.0/2.0.box_R.gif"><img height="5" width="5" src="/global_images2005/spacer.gif"></td>
</tr>
<tr> 
...
<!--
<img src="global_images2005/spacer.gif" alt="" width="1" height="10" hspace="0" vspace="0" border="0"><br>
<img src="/exhibitors/space/images/demo.jpg" alt="" hspace="0" vspace="0"  style="border: 1px #999999 solid"><br>
-->

<span class="section_title">Exhibitor benefits</span><br>
<span class="subhead">At no additional investment</span><br>
<ul>
	...
	<li>Link from CESweb.org to your site
</ul>
<br><br>
		</td>
	    <td width="10"  background="/global_images2005/spacer.gif" class="exhibitor8">&nbsp;</td>
