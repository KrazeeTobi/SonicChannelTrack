...
<img src="/global_images2005/0.0/random_main2/0.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a>
<br>
</span>
		...
		<!-- checking to see if the page is a main section page or not -->
			...
			<tr>
				...
				-->
					...
					<tr>
						<td colspan=2><img src="global_images2005/0.0/random_main2/0.0.main.gif" alt="Main Image" width="610" height="149" border="0"></td>
					</tr>
					<tr>
						<td><a href="/register/" onmouseover=introllOver('register'); onmouseout=introllOff('register');><img src="global_images2005/0.0/random_main2/0.0_register.gif" alt="register" width="162" height="56" border="0" name="register" id="register"></a></td>
						<td><img src="global_images2005/0.0/random_main2/0.0.bottom.right.gif" alt="picture" width="448" height="56" border="0"></td>
					</tr>
					</table>
