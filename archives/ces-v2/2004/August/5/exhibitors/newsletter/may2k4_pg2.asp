...
<a name="article8"></a><span class="subhead">Make a Strategic Move</span><br>
...
<img src="/global_images2005/2.0/2.0.line.gif" alt="-----------------------------------------------" width="380" height="2" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
<a name="article9"></a><span class="subhead">Speaking Opportunities at 2005 International
CES</span><br>
Now&rsquo;s the time to consider speaking at the 2005 International CES conference
program. It&rsquo;s the world&rsquo;s largest industry education forum, exchanges
ideas among presenters and participants and helps attendees discover the newest
trends, strategies and profit opportunities in the consumer and IT industries.
If you want to be notified when the official 2005 International CES Call for
Speakers (CFS) opens later this month just e-mail Kartraice D. Hooper at <a href="mailto:khooper@ce.org">khooper@ce.org</a> and
let her know.
</p>
<p> In the meantime, take a look at the following list of suggested topics. Keep
  in mind that a limited number of presenters are accepted because of the number
  of sessions and the need for a balanced program. All proposals will be considered
  based on industry representation, professionalism, prior public speaking experience
  and relevance to session topic. </p>
...
<p name="channel"><a name="channel"></a> <img src="/global_images2005/spacer.gif" alt="" width="1" height="12" hspace="0" vspace="0" border="0"><br>
  <img src="/global_images2005/2.0/2.0.line.gif" alt="-----------------------------------------------" width="380" height="2" hspace="0" vspace="0" border="0"><br>
  <img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
  <a name="article10"></a><span class="subhead">CEA Welcomes New Members</span><br>
...
<p>View the list of <a href="may2k4_pg3.asp">new CEA members</a>. </p>
...
<div align="center">[ <a href="may2k4_pg1.asp">page 1</a> ] &nbsp; [ <strong>page
    2</strong> ]</a> &nbsp; [ <a href="may2k4_pg3.asp">page 3</a> ]</a></div>
...
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableborder">
  ...
  <tr>
    <td valign="top"><ul>
        <li>Investigate other CEA event sponsorships. Visit <a href="http://www.CE.org/events" target="_blank">www.CE.org/events</a>.</li>
        <li> Check out the <a href="http://www.ce.org/press_room/national_media_tour/schedule.asp" target="_blank">CEA
            nationwide media tour</a>.</li>
        <li>Have you planned your budget for the 2005 International CES yet?</li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5" class="tableborder">
  ...
  <tr>
    <td><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="35%" valign="top">MAY 31</td>
          <td width="65%">Second Exhibitor Space Selection payment due.</td>
        </tr>
        <tr>
