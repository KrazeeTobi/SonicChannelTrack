...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.6") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">国際ビジター<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<meta http-equiv="Content-Type" content="text/html; charset=Shift_JIS"><div id="4.6">	
<!-- text for main page -->

国際CESへ、世界中の企業とのネットワーク作りを切望している、多岐にわたる海外の出展企業や参加企業、そして多数の米国消費者テクノロジー専門家がぞくぞくと集まっています。
<br>
...
<tr>
    <td width="285" valign="top"><span class="subhead"><a href="travel.asp">旅行とビザ情報</a><br></span>
2005年度国際CESに参加するための旅行計画を立てるのに、早すぎるということは決してありません。割引ホテル料金からビザ申請まで、米国への旅行ができる限り容易になるよう全面的にお手伝いいたします。
		<br><br>
		<span class="subhead"><a href="delegations.asp">代表者団プログラム（新企画！）</a><br></span>
2005年1月6日～9日の期間中トップクラスの消費者テクノロジー見本市に参加し、米国ネバダ州ラスベガスで開催予定の2005年度国際CESへ代表団を送り込みましょう。この新しい団体プログラムについての情報を揃えています。
	</td>
    
	<td width="20"><img src="/global_images2005/spacer.gif" alt="" width="20" height="1" border="0"></td>
    
	<td width="285" valign="top">
		<span class="subhead"><a href="services.asp">国際サービス</a><br></span>
国際CESでは、海外から米国へお越しの出展企業や参加企業の皆様のために特別企画した各種のサービスを提供します。会場での通訳、商業センター、レセプションなどについての情報を収集しましょう。</td>
</tr>
</table>
