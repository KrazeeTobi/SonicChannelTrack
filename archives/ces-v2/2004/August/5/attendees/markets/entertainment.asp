...
<head>
	...
	<title>2005 International CES:&nbsp;Digital Entertainment</title>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/1.0/1.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="380"  background="/global_images2005/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Digital Entertainment<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="1.6.2">		
<!-- text for main page -->
<!--<span class="section_title">Got game?</span><br><br>-->
Video digital entertainment is one of the most successful categories in the consumer electronics industry. It has invaded nearly every communications product on the market. Americans now play games on TVs, PCs, the Internet, cell phones, mobile Internet services and on electronic devices installed in our automobiles. Using new technologies such as Bluetooth, gamers can connect and play with anyone worldwide. CEA, producer of the International CES, estimates that digital entertainment software will top $8 billion in 2004, an all-time record and a 60 percent increase from just five years ago.

<br><br>With 2,400 exhibitors and companies of all sizes and expertise, the 2005 International CES is your best source for the newest developments in digital entertainment. Make plans to join 130,000 other consumer technology professionals in Las Vegas January 6-9, 2005.
...
<div class="section_title">Digital Entertainment Exhibitors</div>
Major digital entertainment companies such as Microsoft, Nvidia, Logitech, Dolby, Monster Cable and Sony exhibit at the International CES.
<br><br>
Use the <a href="/attendees/directory/exhibitor_name.asp">exhibitor directory</a> and search by product category to see a complete list of 2005 digital entertainment exhibitors.
<!--<ul>-->
...
<img src="/global_images2005/spacer.gif" alt="" width="1" height="30" hspace="0" vspace="0" border="0"><br>
<img src="/global_images2005/1.0/1.0.line.gif" alt="-----------------------------------------------" width="380" height="2" hspace="0" vspace="0" border="0"><br>
<div class="section_title">International CES TechZones: Digital Entertainment</div>
These 2005 International CES TechZones offer buyers, distributors, engineers and other attendees and exhibitors a condensed cross-section of the digital entertainment market:
<ul>
...
<span class="text_colored">January 8-11, Stardust Hotel, Tournament Finals at the Riviera</span><br><img src="/global_images2005/spacer.gif" alt="" width="1" height="7" hspace="0" vspace="0" border="0"><br>
...
<br>-->
<strong>Visit the CEA website, <a href="http://www.CE.org">www.CE.org</a></strong>, to learn more about publications, upcoming events and current initiatives in digital entertainment.
<br>
