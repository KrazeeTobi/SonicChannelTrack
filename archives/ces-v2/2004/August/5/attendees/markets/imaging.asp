...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/1.0/1.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="380"  background="/global_images2005/spacer.gif" class="attendees7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Digital Imaging<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="1.6.2">		
<!-- text for main page -->
<!--<span class="section_title">Picture this</span><br><br>-->
<img src="images/digital_imaging2.jpg" align="right" hspace="5" style="border: 1px #cccccc solid">
Digital imaging has catapulted into the mainstream and continues to expand its reach as it mirrors the traditional camera market in user segmentation and behavior patterns. A recovering economy, user-friendly features, aggressive manufacturer and retailer promotion and consumer testimonials are contributing to digital cameras' quick ascent. 

<br><br>With 2,400 exhibitors and companies of all sizes and expertise, the 2005 International CES is your best source for the newest developments in digital imaging. Make plans to join 130,000 other consumer technology professionals in Las Vegas January 6-9, 2005.
...
Major digital imaging companies such as Canon, Fuji, Hewlett-Packard, Kodak, Olympus, Panasonic and Sony exhibit at the International CES.
<br><br>
Use the <a href="/attendees/directory/exhibitor_name.asp">exhibitor directory</a> and search by product category to see a complete list of 2005 digital imaging exhibitors.
...
These 2005 International CES TechZones offer buyers, distributors, engineers and other attendees and exhibitors a condensed cross-section of the digital imaging market:
	<ul>
		<li>Assistive Technologies
		<li>Connected Home Entertainment
		<li>Digital Car/Telematics
		<li>Flash Forward: Bringing Digital Imaging Into Focus
		<li>RWPPI
		<li>SD Card
...
<tr> 
	...
	<tr>
		<td><img src="/global_images2005/markets/imaging.gif" alt="" hspace="0" vspace="0" border="0"></td>
	</tr>
	<tr>
		<td>Look for this sign to find digital imaging exhibits on the 2005 International CES show floor.</td>
	</tr>
	</table>
	</td>
...
<ul>
	...
	<li>The camcorder market will decrease slightly in 2004.  
</ul>
<br>
