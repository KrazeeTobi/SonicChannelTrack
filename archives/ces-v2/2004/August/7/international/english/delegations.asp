...
<!-- logo and banner image row -->
	<tr>
	    ...
	    <td width="10"></td>
	    <td width="610" colspan="6"><img src="/global_images2005/4.0/random_main2/4.0.banner.gif" alt="" width="610" height="74" border="0"></td>
	</tr>
<!-- /logo and banner image row -->
...
<!-- breadcrumb row -->
	<tr>
		...
		<td width="10"></td>		
		    ...
		    <td width="200" background="/global_images2005/spacer.gif" colspan="2" class="international6"><img src="/global_images2005/4.0/4.0_print_mail.gif" width="115" height="40" alt="print - email" border="0"><a href=javascript:newWin("/global_include/asp/page_tools/print.asp","4.1.2") onmouseover=snrollOver('_button_print'); onmouseout=snrollOff('_button_print');><img src="/global_images2005/4.0/4.0_button_print.gif" alt="Print" name="_button_print" id="_button_print" width="42" height="40" hspace="0" vspace="0" border="0"></a><A HREF=javascript:openNewWindow("/global_include/asp/page_tools/email.asp") onmouseover=snrollOver('_button_mail'); onmouseout=snrollOff('_button_mail');><img src="/global_images2005/4.0/4.0_button_mail.gif" alt="Email" name="_button_mail" id="_button_mail" width="42" height="40" hspace="0" vspace="0" border="0"></a></td>
...
<a href="http://www.ce.org" target="new" onmouseover=snrollOver('_logo_cea'); onmouseout=snrollOff('_logo_cea');><img src="/global_images2005/4.0/4.0_logo_cea.gif" name="_logo_cea" width="140" height="116" alt="Produced by Consumer Electronics Association" border="0"></a><br><img src="/global_images2005/spacer.gif" width="1" height="12" border="0"><br>
		...
		<!-- checking to see if the page is a main section page or not -->
		    ...
		    <td width="590" colspan="4"  background="/global_images2005/spacer.gif" class="international7" valign="top">
					...
					<img src="/global_images2005/spacer.gif" height="10" width="1"><br><div class="body_title">Delegation Group Program<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
				

<div id="4.1.2">	
<!-- text for main page -->

International CES makes it as easy as possible for you to recruit and bring a group to the show. We will work with you to help make your effort successful and your delegates pleased with the added value and incentives they receive for traveling in your group. 
<br><br>
Become an official delegation leader today. Simply fill out the <a href="/international/english/pdf/International delegation group program application.pdf" target="_blank">Delegation Application form (pdf)</a> and fax it to Elena Vasquez at 703-907-7602.
<br><br>

<span class="subhead">Delegation leader benefits include:</span>
<ul>
	<li>Promotional brochures and electronic templates to help you recruit delegates.
	<li>Access to the 2005 CES logo to brand promotional materials.*
	<li>Online capability to register delegation members and maintain your list.
	<li>Free hotel stay for delegation leaders who bring 50 or more individuals to CES (15 for government groups).
	<li>Listing on the International CES website (<a href="http://www.CESweb.org">www.CESweb.org</a>) as an official delegation leader.
	<li>An invitation to a Delegation Leader Dinner.
	<li>A CES rolling backpack for use in easily carrying your show materials around the show floor.
</ul>
<br>

* <em>Promotional materials must be reviewed and approved by CES prior to use of the logo.</em>
<br><br>

<span class="subhead">Benefits for individuals who come as part of a group include:</span>
<ul>
	<li>Prior to CES, access to a list of exhibitors who export or have indicated an interest in exporting to the group's country and region of the world.
	<li>Potential to attend a conference session for free. 
	<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;Each delegation leader will be given 5-10 passes. Each pass offers admission to one conference session.<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please contact your delegation leader if you are interested in attending a conference session. 
	<li>Complimentary Exhibits Plus Pass for delegation members.
	<li>Delegation Guide that features highlights of the International CES.
	<li>Invitation to the International Reception. 
	<li>Invitation to a delegation continental breakfast briefing the opening morning of the show.
</ul>
