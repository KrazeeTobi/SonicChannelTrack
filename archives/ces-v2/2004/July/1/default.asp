		...
		<tr>
			...
			<td width="375" valign="top"><img src="global_images2005/spacer.gif" width="10" height="18"><br>
				...
				<table cellspacing="0" cellpadding="0" border="0">
					<tr>
						<td width="90" valign="top"><img src="global_images2005/spacer.gif" width="10" height="2"><br><img src="/global_images2005/HPkitchen.jpg" alt="" width="90" height="70" border="0"></td>
						<td width="10">&nbsp;</td>
						<td width="275" valign="top"><font style="color:#ffffff">Calling all CES alumni! All general attendees from the 2004 International CES can register free for the 2005 show, January 6-9.  With the pre-populated form, it takes no time at all.</font>
						<span class="homepagelink"><a href="/register">Register now.</a></span></td>
					</tr>
					<tr>
						<td width="375" colspan="3"><img src="global_images2005/spacer.gif" width="1" height="10"></td>
					</tr>
					<tr>
						<td width="90" valign="top"><img src="global_images2005/spacer.gif" width="10" height="2"><br><img src="/global_images2005/HPstrip.jpg" alt="" width="90" height="69" border="0"></td>
						<td width="10">&nbsp;</td>
						<td width="275" valign="top"><font style="color:#ffffff">Selling out on the Las Vegas Strip. It's true, some hotels are already full during the 2005 International CES. The CES hotel program offers attendees and exhibitors discounts and other great conveniences.</font>
						<span class="homepagelink"><a href="/attendees/travel">Book today.</a></span></td>
					</tr>
				</table>
			</td>
