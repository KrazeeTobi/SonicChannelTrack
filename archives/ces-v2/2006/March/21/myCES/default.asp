...
<html>
<head><!-- PageID 2966 - generated by RedDot 5.6 - 5.6.1.9 - Y-9bp -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2006 International CES:&nbsp;MyCES</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/myCES/default.asp';
...
<div class="body_title">MyCES<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<SPAN class=section_title><IMG height=94 hspace=6 src="/images/general/myCES_225.gif" width=225 align=right>Make the right connections</SPAN><BR><BR>What if CES automatically gathered the people, products, and knowledge that make up your perfect show? <A href="/register">Register now</A> and CES can.<BR><BR>Introducing MyCES, the personal assistant that intelligently mines through the CES community and finds the knowledge, people, and products most closely matched to meeting your objectives.<BR><BR>MyCES does the work for you. It’s&nbsp;FREE and activates when you register for the show.
</span>
...
<div class="section_title">Want to justify your attendance by seeing CES built around you?</div>
<span class="text">
<A href="http://myces-justify.bdmetrics.com/" target=_blank><IMG height=194 hspace=8 src="/images/general/myCES-justfication-button.jpg" width=138 align=left border=0></A>MyCES starts by creating your “Attendee Justification Report.”&nbsp; Just tell MyCES what you’re looking for from the event, and watch while it finds what you need week-by-week as registration builds. Your MyCES Attendee Justification Report automatically brings you the best of what you want from the event community.<BR><BR><SPAN class=subhead>Need personalized justification to attend the show?</SPAN><BR><A href="http://myces-justify.bdmetrics.com/" target=_blank>Personalize and view a sample of your report today.<BR></A><BR><BR><BR><BR><BR>
</span>
<a name="2969"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<span class="text">
<IMG height=69 hspace=6 src="/images/general/myCES-search-box.jpg" width=271 align=right>Looking for something in particular at the world's largest annual tradeshow for consumer technology and America's largest annual tradeshow of any kind? MyCES’ event search engine can find it for you from your desktop now. <A href="/register">Register now</A> and start searching the event today.
</span>
<a name="2971"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Want to build a personal show agenda with business value for you?</div>
<span class="text">
<IMG height=89 hspace=8 src="/images/general/myCESview-show-plan-button.jpg" width=126 align=left>My Show Plan – your personalized event planner in MyCES – keeps a list of companies, products, sessions, people, and other resources that are of immediate value to your business.<BR><BR>Just click “Add To My Show Plan” when you find things of value in your MyCES searches, recommendations, and incoming connection requests.&nbsp; Click “View My Show Plan” anytime to review your must-see list for the show.&nbsp;<A href="/register">Register now</A> to start using My Show Plan, and make CES the most valuable and efficient two days of the year.&nbsp; Don’t walk the show floor without it.
</span>
<a name="2972"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Register now and do it all FREE – with MyCES</div>
<span class="text">
<A href="/register">Register now</A> and get MyCES – a suite of revolutionary web-based tools that help you realize new value from attending CES.&nbsp; You will receive your first MyCES “You Based Event” email alert shortly after your registration is complete.&nbsp; Discover the fusion of face-to-face and online communities.
</span>
<a name="2999"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Already registered to attend?</div>
<span class="text">
Start using MyCES now. <A href="https://myces.bdmetrics.com/portal" target=_blank>https://MyCES.bdmetrics.com/portal</A>
</span>
<!-- text for main page -->
</div>
