...
<title>2006 International CES:&nbsp;by Date</title>
...
<div>
<form action="/attendees/conferences/search/session_by_date_list.asp"  method=post><table cellpadding=3 cellspacing=1 border=0><tr><td><span class='subhead'>Choose a date from the drop-down list.</span></td></tr><tr height=7><td></td></tr><tr><td colspan=1><select class=formdata name=sessiondate><option value=0>Choose a Date&nbsp;&nbsp;<option value="1/4/2006">Wednesday, January 4<option value="1/5/2006">Thursday, January 5<option value="1/6/2006">Friday, January 6<option value="1/7/2006">Saturday, January 7<option value="1/9/2006">Monday, January 9</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
<!--
<br>
