...
<div class="body_title">2006 International CES Exhibitor Directory<br><img src="/print/global_images2005/spacer.gif" height="16" width="1"></div>
...
<br>
<form name="searchByGeographicLocation" action="/print/attendees/directory/rd_geographic_location_search_results.asp?page=1" method="POST">
