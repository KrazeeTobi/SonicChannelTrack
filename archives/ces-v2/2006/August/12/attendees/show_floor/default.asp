...
<span class="text">
Here's where to get familiar with the layout of the&nbsp;largest&nbsp;consumer technology tradeshow. From digital device and entertainment companies to&nbsp;wireless and mobile technology creators — 2,700 exhibitors from around the world&nbsp;make CES the global meeting ground for consumer electronics. <BR><BR>Make sure to add The Venetian to your must-see destinations at CES this year. This new home for <A href="/attendees/markets/hpaht.asp">high-performance audio &amp; home theater</A> is adjacent to the Sands Expo and Convention Center. Check back later this year for more details on this and other CES venues.<BR><BR><STRONG>NEW THIS YEAR:</STRONG> If you need to make a local (Las Vegas) or&nbsp;800&nbsp;telephone call, you can do it for free at any Las Vegas Convention Center payphone.
</span>
...
<span class="text">
<SPAN class=subhead><A href="/attendees/show_floor/maps/default.asp">Venue Maps</A></SPAN><BR>Need a visual? Download and print the location map. Make sure to check out the Sands Expo and Convention Center/The Venetian.<BR><BR><SPAN class=subhead><A href="/attendees/show_floor/techzones/default.asp">TechZones</A></SPAN><BR>International CES TechZones&nbsp;deliver you the&nbsp;newest of the new technology for a variety of different product categories.
</span>
<!-- text for main page -->
</div>
