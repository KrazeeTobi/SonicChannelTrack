...
<span class="text">
See what happens at the 2006 International CES—from registration kiosks to special displays&nbsp;and conference rooms. Also look&nbsp;in this section&nbsp;for general booth locations and product categories. To help you navigate the show floor, look for the product category icons and color-coded signs featured below.<BR><IMG height=96 hspace=12 src="/images/ces_photos/CES_130.jpg" width=130 align=right><BR><STRONG>NEW!</STRONG> Innovations Plus at the Sands Expo and Convention Center launches the next milestone for consumer electronics. Under the banner of Innovations Plus, the 2006 International CES will house digital imaging, enabling technologies and emerging applications at the Sands.<BR><BR>Need a visual? <A href="/docs/2k6CESLocationMap.pdf" target=_blank>Download and print a location map (pdf).</A>
</span>
...
<LI>Car Clinic Network</LI></UL><A href="/attendees/show_floor/areas/north.asp">Get more details.</A><A href="/attendees/show_floor/areas/central.asp"></A></TD></TR>
<TR>
<TD width=1 colSpan=3 height=10>&nbsp;</TD></TR>
<TR>
...
<div class="section_title">Renaissance Las Vegas</div>
<span class="text">
<UL>
<LI>Exhibitor Suites</LI></UL><A href="/attendees/show_floor/areas/other.asp">
Get more details.</A>
</span>
<!-- text for main page -->
</div>
