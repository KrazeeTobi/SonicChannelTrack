...
<br>
	Logos are available in EPS, PSD, JPEG, and TIFF formats for $25 each. GIF format is available free of charge. 
	Purchase a complete set for $75 and save $25! If you should have any questions, please e-mail <a href="mailto:innovations@ce.org">innovations@ce.org</a>
<br><br>		
...
<form name="frm_submit" action="honoree_login_validation.asp" method="post">
	...
	<tr>
		...
		<td colspan="3"><input type="text" name="uname" size="30" maxlength="50"></td>
	</tr>
	<tr>
		<td align="right">Password</td>
		<td colspan="2"><input type="password" name="pword" size="30" maxlength="25"></td>
	</tr>
	<tr>
		<td class="rowlabel">E-mail</td>
		<td colspan="3"><input type="text" name="email" size="30" maxlength="50" value="">
	</tr>
	<tr>
	...
	<tr>
		...
		<td colspan="2"><b>Forgot your password?</b><br>E-mail <a href="mailto:innovations@ce.org?subject=innovations login help">innovations@ce.org</a></td>
	</tr>
</form>
</table>
