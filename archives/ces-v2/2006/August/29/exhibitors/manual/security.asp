...
<html>
<head><!-- PageID 1123 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;Booth Security</title>
...
<tr>
   ...
   <a href="/default.htm">Home</a>&nbsp;&gt;&nbsp;Booth Security
...
<!--/exhibitors/manual/1246.htm--><span class="nav_fourth_arrow"><b>&gt;&nbsp;&nbsp;</b></span><a href="#manual1246" class="inpagenav">Security Information</a><BR>
...
<span class="nav_fourth_arrow"><b>&gt;&nbsp;&nbsp;</b></span><a href="/docs/COP_Booth_Security_Order__Form.doc" target="new" class="inpagenav">COP Security Order Form</a><BR>
<span class="nav_fourth_arrow"><b>&gt;&nbsp;&nbsp;</b></span><a href="/docs/16_ProTect_booth_security_form.pdf" target="new" class="inpagenav">Pro-Tect Security Order Form</a><BR>
<span class="nav_fourth_arrow"><b>&gt;&nbsp;&nbsp;</b></span><a href="/docs/16_SOA_Booth_Security_form.pdf" target="new" class="inpagenav">SOA Security Order Form</a><BR>
...
<span class="subhead">Security Information</span>
<br><br>
...
<P><SPAN class=subhead>Hiring Booth Security <BR></SPAN>Any of the companies below can be hired to provide security guards in your booth.&nbsp; You do not have to hire the company that is providing perimeter security for your particular hall:&nbsp; <BR><BR><STRONG>•&nbsp;Pro-Tect Security </STRONG>will provide perimeter security around the LVCC North and Central Halls.<BR><STRONG>•&nbsp;SOA </STRONG>will provide perimeter security around the LVCC South Halls and Las Vegas Hilton.<BR><STRONG>•&nbsp;COP Security </STRONG>will provide perimeter security around the Sands. <BR><BR>You may also have a different security company to guard your booth but they must first be licensed by Clark County and the State of Nevada, and be permitted to work in the exhibit venue.&nbsp; Also, you must complete all the appropriate Exhibitor Appointed Contractor paperwork (see <A href="/exhibitors/manual/contractors.asp">Exhibitor Appointed Contractors section</A>). E-mail CES Operations at <A href="mailto:CESops@CE.org">CESops@CE.org</A> for approval to bring in your own security company.&nbsp; </P>
<P>As a third option, you may also utilize your own staff to provide overnight security, provided they are full-time employees of your company.&nbsp; Please e-mail <A href="mailto:CESops@CE.org">CESops@CE.org</A> for approval if you plan to use your own staff to provide security coverage after hours.<BR><BR><SPAN class=subhead>Display Product Delivery Information <BR></SPAN>Display product may arrive any time after your official target move in date, however, for security purposes we strongly recommend delaying delivery to your booth until Monday, January 2, 2006. Although perimeter security is provided, exhibitors should order their own booth security in case product needs to be delivered prior to this date. </P>
<P><STRONG>CES is not responsible for any theft of property</STRONG>.&nbsp; Please review the section of your exhibit space contract entitled Responsibility for Property.&nbsp; The Consumer Electronics Association and its employees or contractors assume no liability for loss or injury due to theft, fire, accident, or any other destructive causes.&nbsp; We strongly suggest that you obtain a rider to your existing insurance policy to protect your booth/product from the time it leaves your warehouse to the time it returns.&nbsp; Please contact your insurance agent for details.</P>
<P>For added security, you may order a locking security cage from GES.&nbsp; For more information or to order a cage, please call (702) 475-2098.</P>
<P>Should you experience a theft or security incident on-site, immediately proceed to the CES Security Office in room C-105 or S-219 (at the LVCC) or room 101, lower level (at the Sands) to file a report.&nbsp; This is for documentation purposes only and is different than an insurance claim.&nbsp; Claims must be filed with your insurance provider, not GES or CES.<BR></P>
...
<LI><STRONG>DO</STRONG> record serial numbers and take pictures of valuable or expense pieces of equipment!</LI>
<LI class=exhibitor11><STRONG>DO</STRONG> contact GES to arrange for secure accessible storage.</LI>
<LI><STRONG>DO</STRONG> secure your staff's personal property, briefcases, purses and toolboxes.</LI>
<LI class=exhibitor11><STRONG>DO</STRONG> cover your product each night. Inventory all valuable items in your booth by recording serial numbers and descriptions.</LI>
<LI><STRONG>DO</STRONG> contact CES Security immediately if assistance is needed.</LI>
<LI class=exhibitor11><STRONG>DO</STRONG> stay with your product on closing day until it has been securely packed and picked up for shipment; or, hire booth security for this duty.</LI>
<LI><STRONG>DO NOT</STRONG> give product away to or offer laborers the opportunity to “help themselves” to your discarded product.</LI>
<LI class=exhibitor11><STRONG>DO NOT</STRONG> mark the contents on the carton.</LI>
<LI><STRONG>DO NOT</STRONG> store your excess product in "empty cartons".&nbsp; <BR></LI></UL>
<br><img src="/global_images2005/spacer.gif" alt="" width="1" height="5" hspace="0" vspace="0" border="0"><br>
...
<br><br>
<UL>
<LI class=exhibitor11>&nbsp;Whether it’s for a few moments or overnight, <STRONG>never leave small electronic equipment </STRONG>such as video players, monitors, cameras, PC’s, cell phones, etc. unattended in your booth.&nbsp; <BR><BR></LI>
...
<LI class=exhibitor11>&nbsp;When shipping any product, <STRONG>do not identify contents on outside of cartons and boxes</STRONG>.&nbsp; Use coded labels. <BR><BR></LI>
