...
<html>
<head><!-- PageID 2966 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;MyCES</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/myCES/default.asp';
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue2966', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue2966', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue2966" id="leftAddedValue2966" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">MyCES Personal Planner<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<SPAN class=section_title><IMG height=93 src="/images/general/MyCES_240.gif" width=240 align=right>Building Your Perfect Show<BR></SPAN><BR>- Who are the 10 people YOU need to see at CES?<BR>- What are the 10 products YOU need to see at CES?<BR>- When are the&nbsp;5 conference sessions YOU need to attend at CES?<BR><BR>Let the MyCES Personal Planner tell you.<BR><BR><SPAN class=subhead>Here’s how the MyCES Personal Planner works<BR></SPAN>MyCES lets you connect online – before the show – with the exhibitors and attendees who hold the answers to your specific questions.<BR><BR>When you <A href="\register">register for CES</A>, you also can provide an e-mail address just for MyCES – or use the same one you use to register for CES as long as it's unique to only you. Your MyCES e-mail address&nbsp;gives you access to your own portal and the ability to search the entire community of CES exhibitors, attendees, products and educational sessions that match your specific criteria and goals to make the most of your four days at the show. &nbsp; <BR><BR><STRONG>NOTE:</STRONG> The MyCES Personal Planner activates 90 days before the show opens. You can still <A href="\register">register for CES</A> now, and you will receive an e-mail in October notifying you when the MyCES Personal Planner is ready for you to use.<BR><BR>The MyCES Personal Planner is a powerful tool that helps you build your perfect show: 
<UL>
...
<LI>Create a personalized map showing the locations of the exhibitors, products and sessions you’ve chosen to visit</LI></UL><BR>You will also receive regular e-mails with updated people, products and knowledge sessions that will add value to your CES experience. Keep visiting your MyCES portal often – as the CES community grows, so does the information you’ll want to know to maximize your time. Use the MyCES Personal Planner to build your perfect show!
</span>
...
<div class="section_title">Get an Attendee Justification Report that proves why you should attend.</div>
<span class="text">
<A href="https://myces2007.bdmetrics.com/Proportal" target=_blank><IMG height=194 hspace=8 src="/images/general/myCES-justfication-button.jpg" width=138 align=left border=0></A>MyCES will create your own Attendee Justification Report. Just tell MyCES what you’re looking for at the show and watch while it finds what you need week-by-week as registration builds. Your MyCES Attendee Justification Report automatically delivers the best of what you want to prove your time at CES will be well spent.<BR><BR><SPAN class=subhead>Need personalized justification to attend the show?</SPAN><BR><A href="https://myces2007.bdmetrics.com/Proportal" target=_blank>Personalize and view a sample of your report today.<BR></A><BR><BR><BR><BR><BR>
</span>
<a name="2969"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Like to connect with people based on why you should meet them?</div>
<span class="text">
<IMG src="/images/general/myCES-request-connection.jpg"><BR><BR>MyCES lets you connect online – before the show – with the people in the event community who hold the answers to your specific questions. MyCES gathers people, products, and knowledge based on why you tell it you need them. Now you have a reason to connect in advance and schedule meetings for the show. MyCES sifts the entire community of CES registrants for you. You connect with the click of a button to those who answer the question “why?” Start building your instant network.&nbsp; <A href="/register">Register now.</A><BR><STRONG><BR>NOTE:</STRONG> The MyCES Personal Planner activates 90 days before the show opens. You can still <A href="\register">register for CES now</A>, and you will receive an e-mail in October notifying you when the MyCES Personal Planner is ready for you to use.
</span>
<a name="2970"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
...
<div class="section_title">Like to search CES from your desktop?</div>
<span class="text">
<IMG height=69 hspace=6 src="/images/general/myCES-search-box.jpg" width=271 align=right>Looking for something in particular at the world's largest annual tradeshow for consumer technology and America's largest annual tradeshow of any kind? MyCES’ event search engine can find it for you from your desktop when the MyCES Personal Planner launches later this year.
</span>
<!-- text for main page -->
</div>
