...
<html>
<head><!-- PageID 642 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;Publicity Tips</title>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue642', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue642', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue642" id="leftAddedValue642" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Publicity Tips<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
At the 2007 International CES, expect live broadcasts from all the major channels. Look for more than 4,500 journalists generating an unprecedented number of newspaper and magazine articles, television and radio reports and online stories. <BR>Follow these tips to garner the publicity you deserve. <BR><BR>
<TABLE class=text cellSpacing=0 cellPadding=0 width=590 border=0>
<TBODY>
<TR>
<TD vAlign=top width=285><SPAN class=subhead>1) Media Positioning</SPAN><BR>The International CES defines innovation. <A href="/exhibitors/pr/pr_kit/kit.asp#1376">Develop press materials</A> that capture that innovative spirit and reflect how your company's brand or products portray forward thinking. <BR><BR><SPAN class=subhead>2) Announce New Products at the International CES</SPAN><BR>Debut your new products at the show to generate extensive&nbsp;global publicity, including television coverage. Will your product be the hot talk of the show? <BR><BR><SPAN class=subhead>3) Name Drop: The International CES</SPAN><BR>Use your exhibitor status in your announcements and benefit from CES branding. <A href="/exhibitors/resource_center/logos/default.asp">Download the official logo</A> for your marketing materials (login required). Also, list your CES booth number so media can find you.<BR><BR><SPAN class=subhead>4) Use the Web</SPAN><BR>Post your releases on Virtual Press Office and Business Wire through&nbsp;<A href="http://www.virtualpressoffice.com/CES/index.jsp">CESweb.org</A> for extreme exposure. CESweb.org garnered more than 10 million&nbsp;page views&nbsp;during the 2006 International CES. Don't miss the coverage! <BR><BR><SPAN class=subhead>5) Press/Analyst Materials</SPAN><BR>CES continues to be the showcase for the consumer technology industry, with the most anticipated product launches and OEM deals. Make sure&nbsp;your materials&nbsp;stand out from the competition. <BR><BR><SPAN class=subhead>6) New Product Listing</SPAN><BR>Beginning July 15, <A href="/directoryUpdates">update your exhibitor directory listing</A>.&nbsp; List announcements and product launches you plan to make, and identify which company reps will be available for interviews. Make it easy for reporters to find your booth during the show. </TD>
<TD width=20>&nbsp;</TD>
<TD vAlign=top width=285><SPAN class=subhead>7) Think TV</SPAN><BR>Be prepared to present your products to television journalists. Television coverage of the International CES increases annually, with more programs reporting directly from the show floor. Make your presentation visually interesting and be prepared to do television interviews. <BR><BR><SPAN class=subhead>8) Tell Your Local Media</SPAN><BR>Announce to your local media that you'll be at the 2007 International CES. Local newspapers and business publications are likely to be interested in your CES exhibit plans. For maximum coverage, consider participating in our regional <A href="/exhibitors/pr/pr_kit/events.asp#1397">media outreach campaign</A>. <BR><BR><SPAN class=subhead>9) Call CES for Help</SPAN><BR>The International CES wants to keep your company's name in front of key industry decision makers. CEA promotes the consumer technology industry and the International CES all year long through <A href="http://www.ce.org/events" target=new>industry-specific events</A> and international media tours. Contact Wendy Hudak at 770-643-7144 or <A href="mailto:whudak@CE.org">whudak@CE.org</A> for promotion assistance. <BR><BR><SPAN class=subhead>10) Host a Special Event or a Celebrity</SPAN><BR>Want the media to flock to your booth? There's no better way to draw attention to your product than with a <A href="/exhibitors/pr/pr_kit/events.asp#1396">special event or celebrity appearance</A>. If you've got something special planned, fill out the celebrity appearance form and let us know. </TD></TR></TBODY></TABLE>
</span>
