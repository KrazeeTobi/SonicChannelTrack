...
<span class="text">
<SPAN class=subhead><A href="/about_ces/fact_sheet.asp">CES Fact Sheet</A><BR></SPAN>From exhibitor and attendee profiles to how the International CES came to be, scroll through the CES Fact Sheet to get background on the largest annual consumer technology show in the world. <BR><BR><SPAN class=subhead><A href="/about_ces/photos/default.asp">CES Photos</A><BR></SPAN>The International CES photo library shows you a cross-section of the people, the products, and the high-energy show floor.
</span>
<!-- text for main page -->
</div>
