...
<span class="text">
<SPAN class=subhead><IMG height=140 hspace=6 src="/images/general/CES-PodNews.gif" width=140 align=right>What is a podcast?<BR></SPAN>Podcasts are audio files that are automatically delivered directly to your computer and can be transfered to your iPod or other portable audio MP3 player.&nbsp;Wikipedia.com explains, "In the podcasting model, a publisher publishes a list of [audio files] in a special format, known as a 'feed,' on the web. A user who wants to...hear the [audio] subscribes to the feed in special 'podcatching' software (a type of aggregator), which periodically checks the feed and automatically downloads new [audio files] as they become available."&nbsp;If you're familiar with <A href="http://en.wikipedia.org/wiki/RSS_(protocol)" target=_blank>RSS</A>, simply think of podcasting as RSS for audio. <BR><BR><SPAN class=subhead>How can I use podcasts?</SPAN><BR>First, you will need to install podcatching client software. Once&nbsp;you have subsribed to the feed provided on this page,&nbsp;the software&nbsp;will continually check the podcast feed for the latest audio updates and automatically send them to your computer. A number of free podcatching software packages are available for download. Popular&nbsp;options include Yahoo!, iTunes, iPodder, RSSRadio and iPodderX.<BR><BR><SPAN class=subhead>What audio format does CESweb.org use?<BR></SPAN>All CESweb.org podcasts are available in MP3 format and will work with virtually any audio player software or portable MP3 player.
</span>
...
<span class="text">
<STRONG>DIRECTIONS:</STRONG><BR>To subscribe to the International CES podcast feed, right-click the "PODCAST" button below, select "Copy Shortcut," then paste the link into your podcatching software.&nbsp; <BR><BR>Already an Yahoo! user?&nbsp; Simply click on the "Yahoo!" button, and let it do the work for you.<BR><BR><A href="http://www.cesweb.org/podcasts/cespodcasts.xml"><IMG height=21 src="/images/general/podcast.gif" width=69 align=middle border=0></A>&nbsp;&nbsp;&nbsp;<STRONG><SPAN class=subhead><STRONG>2006 International CES Audio Center<A href="http://podcasts.yahoo.com/series?s=96552aedbc7d25a0d6da60f99e155279"><IMG height=17 hspace=12 src="/images/general/yahoo_podcast.gif" width=120 align=middle border=0></A></STRONG></SPAN></STRONG><A href="http://podcasts.yahoo.com/series?s=96552aedbc7d25a0d6da60f99e155279"> </A><BR><BR><STRONG>Now featuring:</STRONG> 
<UL>
<LI><STRONG><A href="http://content.cesweb.org/podcasts/sands_highlights.mp3">Innovations Plus at the Sands</A>&nbsp;(7 min)</STRONG><BR>Find out why you can't afford to miss the&nbsp;show's newest venue.<BR><BR></LI>
<LI><STRONG><A href="http://content.cesweb.org/podcasts/ces_planner.mp3">2006 International CES Pre-Show Planner</A> (16 min)</STRONG><BR>Get the inside scoop on what's new at the 2006 International CES.<BR><BR></LI>
<LI><STRONG>2006 International CES Pre-Show Press Briefing</STRONG><BR>Hear from: 
<UL>
<LI><A href="http://content.cesweb.org/podcasts/gshapiro_cespre06.mp3">Gary Shapiro, President &amp; CEO, CEA</A> (17 min) </LI>
<LI><A href="http://content.cesweb.org/podcasts/kchupka_cespre06.mp3">Karen Chupka, VP, Events &amp; Conferences, CEA</A> (14 min) </LI>
<LI><A href="http://content.cesweb.org/podcasts/swargo_cespre06.mp3">Sean Wargo, Director, Industry Analysis, CEA</A> (36 min)</LI></UL></LI></UL>
</span>
<a name="3012"></a>
<img src="/global_images2005/spacer.gif" alt="" width="100%" height="30" hspace="0" vspace="0" border="0"><br>
