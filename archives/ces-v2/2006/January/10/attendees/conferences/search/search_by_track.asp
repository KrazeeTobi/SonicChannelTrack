...
<title>2006 International CES:&nbsp;by Track/Partner Program</title>
...
<div>
<form action="/attendees/conferences/search/session_by_track_list.asp" method=post><table cellpadding=3 cellspacing=1 border=0><tr><td><span class='subhead'>Choose a track or partner program from the drop-down list.</span></td></tr><tr height=7><td></td></tr><tr><td colspan=2><select class=formdata name=ID_track><option value=0>Choose a Track&nbsp;&nbsp;<option value=CMT06>Car Technology<option value=V06>CE Vision<option value=DMT06>CES Digital Media Training<option value=GP06>CES Game Power Showcase and Forum<option value=CON06>CONNECTIONS<option value=PUL06>Consumer VoIP Summit <option value=DH06>Digital Hollywood<option value=DI06>Digital Imaging<option value=CMP06>EE Times Great Minds, Great Ideas <option value=HLE06>Home & Lifestyle Entertainment<option value=HN06>Home Networking<option value=ICCE06>ICCE<option value=IIS06>Industry Insiders<option value=JTF06>Just the Facts<option value=MECPChallenge06>MECP Free Demos<option value=MECP06>MECP Installer Training<option value=ME06>Mobile Entertainment<option value=IPv606>New Internet (IPv6) Consumer Electronics<option value=PA06>Parks Associates<option value=R06>Robotics Professional Development Program<option value=SBCA06>SBCA<option value=SV06>Storage Visions (TM)<option value=SS06>SuperSession<option value=W06>Wireless<option value=WR06>Wireless Retail</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
<!--
<br>
