...
<html>
<head><!-- PageID 2450 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/exhibitors/travel/vegas.asp';
...
<a href="/exhibitors/travel/hotel.asp">Hotel Reservations</a><br>
...
Las Vegas Information<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container2449")) { document.getElementById("fourth_row_container2449").style.display = "";}
        //-->
    </script>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue2450', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue2450', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue2450" id="leftAddedValue2450" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
