...
<html>
<head><!-- PageID 1546 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;Order Exhibitor & Top Ten Buyer Badges</title>
...
<img src="/global_images2005/spacer.gif" width="140" height="4" alt="" border="0"><br>
Order Exhibitor & Top Ten Buyer Badges<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container1545")) { document.getElementById("fourth_row_container1545").style.display = "";}
        //-->
    </script>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue1546', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue1546', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue1546" id="leftAddedValue1546" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Order Exhibitor & Top Ten Buyer Badges<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<SPAN class=section_title>Exhibitor registration for the 2007 International CES is now available!</SPAN> <BR><BR>If you are prepared to register your exhibitor booth personnel and/or top&nbsp;10 buyers, <A href="/exhibitors/resource_center/badges/login.asp">register now</A>. You will need to login with your unique exhibitor customer number; customer numbers are located in the upper right corner of your booth invoice. Please contact us at <A href="mailto:exhreg@CE.org">exhreg@CE.org</A> or at 866-233-7968 for assistance. <BR><BR>After you've entered your customer number to access the online system, you may order individual badges or use our simple spreadsheet for placing large orders. <BR><BR><A href="/exhibitors/resource_center/badges/login.asp">Register now.</A>
</span>
