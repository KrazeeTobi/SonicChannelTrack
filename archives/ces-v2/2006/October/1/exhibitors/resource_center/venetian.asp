...
<html>
<head><!-- PageID 3270 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;CES Venetian Preview</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/exhibitors/resource_center/venetian.asp';
...
CES Venetian Preview<br>
    ...
    <script language="JavaScript">
        <!--
            if (document.getElementById("fourth_row_container3269")) { document.getElementById("fourth_row_container3269").style.display = "";}
        //-->
    </script>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue3270', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue3270', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue3270" id="leftAddedValue3270" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">The CES Venetian Preview<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<SPAN class=section_title>An Exclusive Tour, A First Look — Just For You<BR><BR></SPAN>We realize a move of any magnitude is a demanding task, which is why we want to make the transition as smooth as possible for you, our valuable high-performance audio &amp; home theater exhibitor. To assist you, we hosted the CES Venetian Preview for our high-performance audio &amp; home theater exhibitors.<BR><BR>If you missed the Venetian Preview in July, check back soon to download recordings of the Venetian Preview presentations.
</span>
...
<div class="section_title">Prepare for Success: Informational Sessions, Tours and More</div>
<span class="text">
<SPAN class=text1><SPAN style="mso-fareast-font-family: 'Times New Roman'; mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA">The CES Venetian Preview included informational sessions and tips from the experts, interactive activities and most importantly, an exclusive tour of The Venetian suites and demo rooms.&nbsp;To view the day’s activities, <A href="/docs/2007_Venetian_Preview_Agenda.pdf" target=_blank>download the agenda (pdf).</A></SPAN></SPAN><BR>
</span>
<!-- text for main page -->
</div>
