...
<html>
<head><!-- PageID 3307 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;Workshop Details</title>
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue3307', '/global_images2005/2.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue3307', '/global_images2005/2.0_logo_cea.gif');"><img src="/global_images2005/2.0_logo_cea.gif" name="leftAddedValue3307" id="leftAddedValue3307" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Exhibitor Workshop Details<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
<div class="text"> 
<!-- text for main page -->

<span class="text">
<IMG height=111 hspace=8 src="/images/ces_photos/workshop2.jpg" width=150 align=right>Meet us in Las Vegas on Wednesday, October 4, 2006, for our most valuable exhibitor-focused event – the CES Exhibitor Workshop.&nbsp; Plan marketing strategies, determine exhibit logistics and place orders with vendors, all in one day. <A href="/exhibitors/resource_center/workshop/rd_registration.asp">Register.</A><BR><BR><SPAN class=subhead>Roundtable Discussions and Vendor Fair</SPAN><BR>Use the roundtable discussions to hear great advice from tradeshow experts. Roundtable topics include space selection and floor plans, booth set-up and logistics, electrical, freight, wireless, promotional opportunities and communications.<BR><BR>Also, profit from making new contacts at our vendor fair. Get discounts on logistical supplies and services, from furniture to material handling at the vendor fair. Meet with the behind-the-scenes people that make CES come alive.<BR><BR><SPAN class=subhead>Tour the Show Floor</SPAN><BR>Join us for a tour of the LVCC, The Sands Expo and Convention Center and the newest addition to CES, The Venetian. Tours are good for first-timers to get familiar with CES and for veterans who need to visualize placement of banners and other promotional opportunities available.<BR><BR><SPAN class=subhead>2007 International CES Operations</SPAN><BR>Make your booth planning easy by talking with members of the CES Operations team. Gain tips on show logistics for moving in and out, setting up and staying within the guidelines of utility requirements, security, fire marshal rules and other regulations.&nbsp; <BR><BR><SPAN class=subhead>An Education in SmartBooth</SPAN><BR>Get a firsthand look at MyCES and Smartbooth and learn how you can use them to make your CES experience a success.&nbsp; By understanding these resources, you can learn how to attract your target audience and drive qualified attendees straight to your booth. <BR><BR><SPAN class=subhead>Public Relations and Marketing</SPAN><BR>Will your company make headlines at the 2007 International CES? Hear what you can do to grab the attention of the thousands of media at CES from around the world. <BR><BR><SPAN class=subhead>Exhibitor Panel<BR></SPAN>Ask questions and get advice from CES exhibiting experts. <BR>
<TABLE cellSpacing=1 cellPadding=1 width="75%" border=0>
<TBODY>
<TR vAlign=top>
<TD>&nbsp;<IMG height=100 src="/images/general/kaplan_t_eab.jpg" width=88><BR>Tally Kaplan<BR>Sr. Corp. Comm. Manager<BR>Marvell&nbsp;<BR><BR></TD>
<TD><IMG height=100 src="/images/general/EAB_Glenda_Brungardt_88.jpg" width=88 align=top><BR>Glenda Brungardt<BR>Program Manager<BR>Hewlett-Packard Company</TD>
<TD><IMG src="/images/general/EAB_EDare_88.jpg"><BR>Erin Dare<BR>Trade Show Manager<BR>Dolby</TD>
<TD>&nbsp;<BR></TD></TR></TBODY></TABLE><BR><SPAN class=subhead></SPAN><SPAN class=subhead></SPAN><SPAN class=subhead>Questions</SPAN><BR>For more information on the International CES Exhibitor Workshop, contact <A href="mailto:kcovert@CE.org">Kathryn Covert</A> or call (703) 907-5247. <BR><BR><A href="/exhibitors/resource_center/workshop/rd_registration.asp">Register.</A><BR>
</span>
