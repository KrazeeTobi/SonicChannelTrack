...
<div>
<form action="/attendees/conferences/search/session_by_track_list.asp" method=post><table cellpadding=3 cellspacing=1 border=0><tr><td><span class='subhead'>Choose a track or partner program from the drop-down list.</span></td></tr><tr height=7><td></td></tr><tr><td colspan=2><select class=formdata name=ID_track><option value=0>Choose a Track&nbsp;&nbsp;<option value=CES07_AVPOD>Audio and Video Podcasting<option value=CES07_CT>Car Technology<option value=CES07_DMT>CES Digital Media Training (Future Media Concepts)<option value=CES07_GP>CES Game Power Conference<option value=CESGvt>CES Government 2007<option value=CES07_KT>CES Knowledge Tracks<option value=CES07_ME>CES Mobile Entertainment<option value=CES07_PP>CES Partner Programs<option value=CES07_CONN>Connections: The Digital Home Conference<option value=ESC>Consumer Electronics Supply Chain Academy<option value=CES07_CVOIP>Consumer VoIP Summit<option value=CES07_DH>Digital Hollywood<option value=CES07_DI>Digital Imaging<option value=CES07_GMNG>Gaming<option value=CES07_HLE>Home & Lifestyle Entertainment<option value=CES07_HF>Home Furnishings Summit<option value=CES07_IEEE>IEEE: International Conference on Consumer Electronics--ICCE<option value=IIS>Industry Insiders<option value=CES07_IA>Issues & Attitudes<option value=CES07_JTF>Just the Facts<option value=KEY>Keynotes<option value=CES07_MARTY>Martin Porter Associates<option value=CES07_MECPIT>MECP Installation Training<option value=MB>MOBILE & PERSONAL BROADBAND CONFERENCE<option value=CES07_MMT>Mobile/Consumer Market Trends & Memory Solutions<option value=R>ROBOTICS PROFESSIONAL DEVELOPMENT PROGRAM<option value=CES07_SM>Sales & Marketing<option value=CES07_SS>SuperSessions<option value=TBS>TechHome Basic Training<option value=CES07_WR>Wireless Retail</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
<!--
<br>
