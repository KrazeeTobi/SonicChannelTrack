...
<html>
<head><!-- PageID 1692 - published by RedDot 6.5 - 6.5.2.14 - 16244 -->

<meta http-equiv="Content-Type" content="text/html;charset=utf-8" />

<!-- INSERT PAGE TITLE HERE (immediately following gblPAGE_TITLE) -->
<title>2007 International CES:&nbsp;Sessions by Time</title>
...
<script language="javascript">
    <!--
    var activeNavId=0;
    var thisPageUrl='/attendees/conferences/search/session_by_time_list.asp';
    
        var parentLinks=new Array('dummy','/attendees/default.htm','/attendees/conferences/default.asp','/attendees/conferences/search_by_time.asp');
...
<!-- CEA badge -->
    <a href="http://www.ce.org" target="new" onmouseover="headerRollOver('leftAddedValue1692', '/global_images2005/1.0_logo_cea_r.gif');" onmouseout="headerRollOff('leftAddedValue1692', '/global_images2005/1.0_logo_cea.gif');"><img src="/global_images2005/1.0_logo_cea.gif" name="leftAddedValue1692" id="leftAddedValue1692" border="0"></a><br><img src="/global_images2005/spacer.gif" height="10" width="1">
<!-- /CEA badge -->
...
<div class="body_title">Sessions by Time<br><img src="/global_images2005/spacer.gif" height="16" width="1"></div>
...
<div>
<table cellpadding=3 cellspacing=1 border=0><tr height=7><td></td></tr><tr><td><strong>No time was selected. Please <a href="javascript:window.history.back();">try again</a>.</strong></td></tr></table>
</div>
