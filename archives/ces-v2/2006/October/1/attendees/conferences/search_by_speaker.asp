...
<div>
<form action="/attendees/conferences/search/session_by_speaker_list.asp" method=post><table cellpadding=3 cellspacing=1 border=0><tr><td><span class='subhead'>Choose a speaker from the drop-down list.</span></td></tr><tr height=7><td></td></tr><tr><td colspan=1><select class=formdata name=ID_speaker><option value=0>Choose a Speaker&nbsp;&nbsp;<option value=G188167>Bhow, Gunjan<option value=J504421>Bomgaars, Joel<option value=B323742>Bruce, Brady<option value=J99712>Burke, John<option value=S883251>Conahan, Shawn<option value=CHR753031>Cook, Chris<option value=-590908>Eckstein, -Ing. Lutz<option value=T148113>Fagenson, Ted<option value=M576717>Flynn-Ripley, Meredith<option value=M905620>Freitas, Michael <option value=M485363>Gardner, Michael<option value=J117992>Hankey, Ph.D., Jonathan M.<option value=F921215>Hanzlik, Frank<option value=R640621>Kapur, Rajeev<option value=G237896>Krueger, Greg<option value=K92495>Morse, Ken<option value=F630718>Provenzano, Frank<option value=D508510>Putterman, Daniel<option value=R3627>Resendes, Raymond<option value=P133541>Roessger, Peter<option value=D24913>Simpkins, Daniel<option value=S445202>Srinivas, Singu<option value=B625866>Stone, Bill<option value=R812038>Summer, Robert<option value=J50991>Urbahn, Jan<option value=L623745>Wardani, Ladd<option value=M716869>Weinraub, Mitchell<option value=STE244274>Wollenberg, Steve</select>&nbsp;&nbsp;&nbsp;<input class=formdata type=submit value="Go"></td></tr></table></form>
<!--
<br>
