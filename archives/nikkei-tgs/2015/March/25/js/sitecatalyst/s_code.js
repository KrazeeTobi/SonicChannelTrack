...
var s_account="nbptrnprod,nbpmstallprod,nikkeicojpgrpmstallprod";
...
/************************** サイト毎の定義 **************************/
 ...
 //サイトのドメインネーム
 var HostName = 'trendy.nikkeibp.co.jp';
...
/********************************************************************/
 ...
 prop = {
  ...
  'prop13': ckstr,
  'server': HostName,
  'pageName': (location.protocol + '//' + HostName + location.pathname.replace(/index\.\w+$/, '') + location.search),
  'channel': channel,
  'eVar1': (location.protocol + '//' + HostName + location.pathname.replace(/index\.\w+$/, '') + location.search)
 };
 for(i in prop){
  s[i] = prop[i];
 }
...
s.linkInternalFilters="javascript:,wol.nikkeibp.co.jp,joshibu.nikkeibp.co.jp";
s.linkLeaveQueryString=false;
s.linkTrackVars="None";
s.linkTrackEvents="None";
/* getTimeParting Config */
s.dstStart="1/1/2009";
s.dstEnd="1/1/2009";
...
s.trackingServer="stats.nikkeibp.co.jp"
s.trackingServerSecure="sstats.nikkeibp.co.jp"
