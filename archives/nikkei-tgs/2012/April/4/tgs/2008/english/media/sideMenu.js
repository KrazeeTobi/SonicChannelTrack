function sideMenuWrite(){
		...
		str += '<li id="sideNaviTitle"><img src="images/side_title.gif" /></li>';
					...
					if(thisPage.match('media/registration.html')){
					str+='<li><img src="images/side_bt1_on.gif" /></li>';
					}
					else{
					str+='<li><a href="registration.html"><img src="images/side_bt1.gif" onmouseover="this.src=\'images/side_bt1_on.gif\'" onmouseout="this.src=\'images/side_bt1.gif\'" /></a></li>';
					}
					...
					str+='<li><a href="news.html"><img src="images/side_bt4.gif" onmouseover="this.src=\'images/side_bt4_on.gif\'" onmouseout="this.src=\'images/side_bt4.gif\'" /></a></li>';
					}
