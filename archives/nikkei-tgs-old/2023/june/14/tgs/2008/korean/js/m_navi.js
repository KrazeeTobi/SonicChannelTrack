...
function showMainNavi(){
    document.write(' <ul class="navmenu">');
	   ...
	   document.write('<li><a href="/tgs/2008/korean/attendee_info/index.html">방문자 분들에게</a>');
          document.write('<ul>');
            document.write('<li><a href="/tgs/2008/korean/attendee_info/index.html">개최 개요</a></li>');
             document.write('<li><a href="/tgs/2008/korean/attendee_info/map.html">홀지도</a></li>');
             document.write('<li><a href="/tgs/2008/korean/attendee_info/list.html">참가 업체</a></li>');
             document.write('<li><a href="/tgs/2008/korean/attendee_info/events.html">Events</a></li>');
             document.write('<li><a href="/tgs/2008/korean/attendee_info/forum.html">TGS Forum</a></li>');
             document.write('<li><a href="/tgs/2008/korean/attendee_info/admission.html">Admission</a></li>');
             document.write('<li><a href="/tgs/2008/korean/attendee_info/travel.html">Travel</a></li>');
          document.write('</ul>');
       document.write('</li>');
    
       document.write('<li><a href="/tgs/2008/korean/media/">미디어</a>');
           document.write('<ul>');
              document.write('<li><a href="/tgs/2008/korean/media/">보도 자료</a></li>');
           document.write('</ul>');
       document.write('</li>');
