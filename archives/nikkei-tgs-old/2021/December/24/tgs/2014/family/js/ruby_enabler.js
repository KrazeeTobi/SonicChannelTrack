	...
	execute : function(){
		...
		/* そのた: Firefox や Opera : HTML4 の記述に合わせてスタイル適用 */
			...
			newss.innerHTML = "ruby{display:inline-table;text-align:center !important;text-indent:0 !important;margin:0 !important;padding:0 !important;vertical-align:bottom;}\n" + 
				...
				"ruby>rt,ruby>rtc{display:table-header-group !important;font-size:10px;line-height:1.2em !important;letter-spacing:0 !important;font-style:normal !important;}\n" + 
				"rbc>rb{display:table-cell !important;}\n" + 
				"rtc>rt{display:table-cell !important;letter-spacing:0 !important;line-height:1.2em !important;}\n" + 
