...
commonClass.prototype.putHeader = function (){
	...
	code += '<h1><a href="' + linkPath + 'index.html"><img src="' + dirPath + 'common/images/logo.gif" alt="『新興奮。新感動。新時代。』東京ゲームショウ2006" /></a></h1>';
	code += '<p class="Banner"><script type="text/javascript">com.RandomBanner()</script><noscript><a href="#"><img src="' + dirPath + 'common/banner/1.gif" alt="banner" /></a></noscript></p>';
	code += '<p class="Clear"></p>';
	code += '</div>';
	//メインメニュー
	code += '<ul class="MainMenu">';
	code += '<li class="Menu01"><a href="' + linkPath + 'index.html">TOP</a></li>';
	code += '<li class="Menu02"><a href="' + linkPath + 'visitor/">来場者の方へ</a></li>';
	code += '<li class="Menu03"><a href="' + linkPath + 'media/">メディアの方へ</a></li>';
	code += '<li class="Menu04"><a href="' + linkPath + 'business/">ビジネス目的の方へ</a></li>';
	code += '<li class="Menu05"><a href="' + linkPath + 'kids/">キッズのみんな（保護者の方へ）</a></li>';
	code += '</ul>';
	//その他のメニュー
	...
	if (com.UA.OS == "MAC" && com.UA.Browser == "IE") {
		...
		code += '<p class="Menu01"><a href="' + linkPath + 'index.html">TOP</a></p>';
		code += '<p class="Menu02"><a href="' + linkPath + 'visitor/">来場者の方へ</a></p>';
		code += '<p class="Menu03"><a href="' + linkPath + 'media/">メディアの方へ</a></p>';
		code += '<p class="Menu04"><a href="' + linkPath + 'business/">ビジネス目的の方へ</a></p>';
		code += '<p class="Menu05"><a href="' + linkPath + 'kids/">キッズのみんな（保護者の方へ）</a></p>';
		code += '</div>';
		//その他のメニュー
