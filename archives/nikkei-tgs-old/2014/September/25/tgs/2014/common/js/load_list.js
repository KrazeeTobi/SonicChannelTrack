$(function () {
    ...
    var CATEGORY_HEADER = {
        ...
        */
        ...
        338 : {title_id: 'TitleIndies', title: 'インディーゲームコーナー'},
        ...
        337 : {title_id: 'TitleSmartAccessories', title: 'スマートフォン・アクセサリー・コレクション 2014'},
    };
    ...
    if (category_id != undefined || (fifty_id == undefined && category_id == undefined)) {
        ...
        $.ajax({
            ...
            url: docurl + 'list/ja/category/all.json',
