...
function menuWriteL2(){
	...
	document.write('<li><a href="../../english/index.html"><img src="images/english.gif" onmouseover="this.src=\'./images/english_on.gif\'" onmouseout="this.src=\'./images/english.gif\'" alt="english" /></a></li>');
	document.write('</ul>');
}
...
function menuWrite(){
		...
		var str = '<ul>';
					...
					str+='<li><a href="index.html"><img src="images/navi1_on.gif" alt="Outline" /></a></li>';
					
					}else{
						
					str+='<li><a href="index.html"><img src="images/navi1.gif" alt="Outline" onmouseover="this.src=\'./images/navi1_on.gif\'" onmouseout="this.src=\'./images/navi1.gif\'" /></a></li>';
					
					}
					
					if(thisPage.match('exhibition/area.html')){
		
					str+='<li><a href="area.html"><img src="images/navi2_on.gif" alt="Areas and charges" /></a></li>';
					
					}else{
						
					str+='<li><a href="area.html"><img src="images/navi2.gif" alt="Areas and charges" onmouseover="this.src=\'./images/navi2_on.gif\'" onmouseout="this.src=\'./images/navi2.gif\'" /></a></li>';
					
					}
					if(thisPage.match('exhibition/support.html')){
		
					str+='<li><a href="support.html"><img src="images/navi3_on.gif" alt="Areas and charges" /></a></li>';
					
					}else{
						
					str+='<li><a href="support.html"><img src="images/navi3.gif" alt="Areas and charges" onmouseover="this.src=\'./images/navi3_on.gif\'" onmouseout="this.src=\'./images/navi3.gif\'" /></a></li>';
					
					}
					if(thisPage.match('exhibition/rule.html')){
		
					str+='<li><a href="rule.html"><img src="images/navi4_on.gif" alt="Concerning display booths" /></a></li>';
					
					}else{
						
					str+='<li><a href="rule.html"><img src="images/navi4.gif" alt="Concerning display booths" onmouseover="this.src=\'./images/navi4_on.gif\'" onmouseout="this.src=\'./images/navi4.gif\'" /></a></li>';
