...
<body>
<form name="aspnetForm" method="post" action="/utilities/sitemap.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
...
<!--E3 2006-->
    <h3>E<sup>3</sup> 2006 Sitemap</h3>
    <h4 class="smconference">Conference Programs</h4>
	<ul>
        <li><a href="../conference-program/default.aspx">Conference Program Overview</a></li>      
        <li><a href="../conference-program/workshop-description-overview.aspx">Workshop Descriptions</a></li>              
        <li><a href="../conference-program/session-description-overview.aspx">Track &amp; Session Descriptions</a></li>             
        <li><a href="../conference-program/at-a-glance.aspx">Conference at a Glance</a></li>              
        <li><a href="../conference-program/view-by-day.aspx">View by Day</a></li>                            
        <li><a href="../conference-program/speaker-list.aspx">Speaker List</a></li>
        <li><a href="../conference-program/floorplan.aspx">Floorplan</a></li>
        <li><a href="../conference-program/exhibitor-list.aspx">Exhibitor List</a></li>
        <li><a href="../conference-program/speakers-only.aspx">Speakers Only</a></li>
    </ul>
    <h4 class="smexhibitor">Exhibitors</h4>
    <ul>
        <li><a href="../exhibitors/default.aspx">Exhibitor Overview</a></li>              
        <li><a href="http://www.e3expo.com/exhibitors/prospectus/index.html" rel="external">Exhibitor Prospectus</a></li>
        <li><a href="../exhibitors/exhibitor-list.aspx">Exhibitor List</a></li>
        <li><a href="../exhibitors/request-info.aspx">Request Info</a></li>
        <li><a href="../exhibitors/floorplans.aspx">Floorplans</a></li>    
        <li><a href="../exhibitors/e3insider.aspx">E3Insider.com</a></li>
        <li><a href="../media/show-news.aspx">E<sup>3</sup> Show News</a></li>                                                
        <li><a href="http://www.virtualpressoffice.com/media/show/display.jsp?showId=1122945241594" rel="external">Exhibitor News</a></li>               
        <li><a href="../exhibitors/event-marketing.aspx">Event Marketing</a></li>    
        <li><a href="../exhibitors/registration.aspx">Registration</a></li>                   
        <li><a href="../exhibitors/information/Default.aspx">Exhibitor Information</a>
            <ul>
                <li><a href="../../exhibitor-bulletins.aspx">Exhibitor Bulletins</a></li>
                <li><a href="../../important-deadlines.aspx">Important Deadlines</a></li>
                <li><a href="../../operating-schedule.aspx">Operating Schedule</a></li>
                <li><a href="../../support-service-contractors.aspx">Official Support Service Contractors</a></li>
            </ul>
        </li>
        <li><a href="../exhibitors/show-management-contacts.aspx">Show Management Contacts</a></li>
        <li><a href="../exhibitors/housing-and-travel.aspx">Housing &amp; Travel</a></li>
        <li><a href="../exhibitors/faq.aspx">Exhibitor FAQ</a></li>
        <li><a href="../exhibitors/booth-space-sharing-form.aspx">Booth Space Sharing Form</a></li>
        <li><a href="../exhibitors/reciprocal-link-request-form.aspx">Reciprocal Link Request Form</a></li>
        <li><a href="../exhibitors/media-relations/Default.aspx">Promotional and Media Relations</a>
            <ul>
                <li><a href="../../activities-calendar.aspx">Activities Calendar</a></li>
                <li><a href="../../business-wire.aspx">Business Wire</a></li>
                <li><a href="../../media-lists.aspx">Media Lists</a></li>
                <li><a href="../../media-relations-faq.aspx">Promotions and Media Relations FAQ</a></li>
                <li><a href="../../media-relations-opp.aspx">Promotions and Media Relations Opportunities</a></li>
                <li><a href="../../vpo.aspx">VPO</a></li>                                            
            </ul>
         </li>
    </ul>
    <h4 class="smattendees">Attendees</h4>
    <ul>
        <li><a href="../attendees/default.aspx">Attendee Overview</a></li>              
        <li><a href="../attendees/floorplans.aspx">Floorplans</a></li>
        <li><a href="../attendees/exhibitor-list.aspx">Exhibitor List</a></li>
        <li><a href="../attendees/registration.aspx">Registration</a></li>
        <li><a href="../attendees/pricing.aspx">Pricing</a></li>
        <li><a href="../attendees/industry-identification.aspx">Industry Identification</a></li>
        ...
        <li><a href="../attendees/international-visitors.aspx">International Visitors</a></li>
        <li><a href="../media/show-news.aspx">E<sup>3</sup> Show News</a></li>          
        <li><a href="http://www.virtualpressoffice.com/media/order/orderForm.jsp?orderId=1131114879488&showId=1122945241594&ofref=jp">Exhibitor News</a></li>                       
        <li><a href="../attendees/vip-retailers.aspx">VIP Retailers</a></li>
    </ul>
    <h4 class="smmedia">Media</h4>
    <ul>
        <li><a href="../media/default.aspx">Media Overview</a></li>
        <li><a href="../media/show-news.aspx">E<sup>3</sup>Show News</a></li>
        <li><a href="http://www.virtualpressoffice.com/media/order/orderForm.jsp?orderId=1131114879488&showId=1122945241594&ofref=jp">Exhibitor News</a></li>              
        <li><a href="../media/floorplans.aspx">Floorplans</a></li>
        <li><a href="../media/exhibitor-list.aspx">Exhibitor List</a></li>
        <li><a href="../media/registration.aspx">Registration</a></li>
        <li><a href="../media/housing-and-travel.aspx">Housing &amp; Travel</a></li>
        <li><a href="../media/factsheet.aspx">E<sup>3</sup> Factsheet</a></li>              
        <li><a href="../media/media-faq.aspx">Media FAQ</a></li>
        <li><a href="../media/about-the-esa.aspx">About the ESA</a></li>
        <li><a href="../media/photos-and-logos.aspx">E<sup>3</sup> Photos &amp; Logos</a></li>
        <li><a href="../media/onsite-services.aspx">On-Site Services</a></li>
              ...
              <div id="pretertiaryNav">
                <div id="pretertiary-top"></div>
                  ...
                  <!--not necessary anymore
                    ...
                    <li class="spacer"></li>
                    -->
                    <li><a class="email" href="/utilities/email.aspx?URL=utilities%2fsitemap.aspx"><b>Email</b></a></li>
                    <li class="spacer"></li>
