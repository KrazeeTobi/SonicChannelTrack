...
<body>
<form name="aspnetForm" method="post" action="/utilities/email.aspx?URL=utilities%2femail.aspx%3fURL%3dutilities%252femail.aspx%253fURL%253dutilities%25252femail.aspx%25253fURL%25253dutilities%2525252femail.aspx%2525253fURL%2525253dutilities%252525252femail.aspx%252525253fURL%252525253dconference-program%25252525252fworkshop-description-overview.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
...
<p>
    <span id="ctl00_cphMain_senderNameLabel">Senders Name*:</span><br />
    <input name="ctl00$cphMain$senderName" type="text" id="ctl00_cphMain_senderName" /><br />
    <span id="ctl00_cphMain_senderEmailLabel">Senders Email Addresss: </span><br />
    <input name="ctl00$cphMain$senderEmail" type="text" id="ctl00_cphMain_senderEmail" /><br />
    <span id="ctl00_cphMain_receiverNameLabel">Recipients Name: </span><br />
    <input name="ctl00$cphMain$receiverName" type="text" id="ctl00_cphMain_receiverName" /><br />
    <span id="ctl00_cphMain_receiverEmailLabel">Recipients Email Address*:</span><br />
    <input name="ctl00$cphMain$receiverEmail" type="text" id="ctl00_cphMain_receiverEmail" /><br />
    <span id="ctl00_cphMain_labelDescription">Comments:</span><br />
    <input name="ctl00$cphMain$description" type="text" size="60" id="ctl00_cphMain_description" multiline="true" /><br /><br />
              ...
              <div id="pretertiaryNav">
                <div id="pretertiary-top"></div>
                  ...
                  <!--not necessary anymore
                    ...
                    <li class="spacer"></li>
                    -->
                    <li><a class="email" href="/utilities/email.aspx?URL=utilities%2femail.aspx%3fURL%3dutilities%252femail.aspx%253fURL%253dutilities%25252femail.aspx%25253fURL%25253dutilities%2525252femail.aspx%2525253fURL%2525253dutilities%252525252femail.aspx%252525253fURL%252525253dutilities%25252525252femail.aspx%25252525253fURL%25252525253dconference-program%2525252525252fworkshop-description-overview.aspx"><b>Email</b></a></li>
                    <li class="spacer"></li>
