...
<body>
<form name="aspnetForm" method="post" action="/default.aspx?aspxerrorpath=%2fexhibitors%2fmedia-relations%2fexhibitor-list.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />


  <div id="container">
    <div id="header">
      <h1><b>E<sup>3</sup> Expo 2006 | Where business gets fun</b></h1>
      ...
      <div id="banner">
        <div id="logo">
          <h2><a href="default.aspx" title="E&sup3; Expo Home"><b>E<sup>3</sup> Expo 2006 | Home</b></a></h2>
        </div>
        <div id="newsBox-container">
          <div id="newsBox-top"></div>
          <div id="newsBox">
            <ul>
              <li>Mark your calendar as E<sup>3</sup> will be opening its doors <i>May 10-12, 2006</i>
              <br />Los Angeles Convention Center</li>
              <li class="spacer"></li>
              <li><b>Conference Program:</b> May 9<sup>th</sup>&mdash;11<sup>th</sup>
              <br /><b>Expo:</b> May 10<sup>th</sup>&mdash;12<sup>th</sup></li>
            </ul>
          </div> <!-- /newsBox -->
          <div id="newsBox-bottom"></div>
        </div> <!-- /newsBox-container -->
      </div> <!-- /banner -->
      <div id="subNav">
        <ul>
      ...
      <div id="headerImg">
        <object type="application/x-shockwave-flash" data="_images/E3Expo.swf" width="780" height="181">
        <param name="movie" value="_images/E3Expo.swf" />
        </object>
      </div> <!-- /headerImg -->
    </div> <!-- /header -->
    ...
    <h3>The E<sup>3</sup>  2006 Conference Program: </h3> <H3>
The biggest games, the biggest names. They're all represented. </h3>
<br/>
Looking to understand the design secrets behind award winning and top-selling games including Guitar Hero, God of War, Doom 3, F.E.A.R., Indigo Prophecy, King Kong, Call of Duty, Civilization IV, Half-Life 2, The Movies, and Lumines?
<br/>
<br/>

Lead designers and core design team members will all be present at this year's Conference Program. 
<br/>
<br/>

Peter Molyneux of Lionhead, David Jaffe from SCEA, Quantic Dream founder David Cage, Infinity Ward president Grant Collier, and Q Entertainment founder Tetsuya Mizuguchi are some of the designers from these critically acclaimed titles who are participating on panels. 
<br/>
<br/>

Key members of upcoming games are also represented: Spore, Project Assassins, Tabula Rasa, Pirates of the Caribbean, and Saints Row are some of the soon-to-be-released titles that will have lead designers or key members of the design team on panels. 

<br/>
<br/>

Maxis' Will Wright, Ubisoft's Patrice Desilets, and NCsoft's Richard Garriott are some of the designers representing these upcoming titles.
<br/>
<br/>

The program reaches into the upper echelons of business as well. Topics to be addressed include the latest trends surrounding in-game advertising (two sessions this year, including a special session that will focus on the marketer's perspective), a session that will focus on how to profit from online communities, and a topic which is just taking hold in the game industry, massively cross-platform gaming.
<br/>
<br/>


Speakers added this past week include Carol Kruse, Vice President Interactive Marketing, Coca Cola; Paul Maglione, President, Vivendi Universal Games Mobile; Michael Dowling, General Manager, Nielsen Interactive Entertainment; Chris Allen, Product Strategy & Marketing, Yahoo! Music; Julie Ask, Research Director, Jupiter Research; and Eric (Yong Joo) Kwun, Managing Director, Overseas Business of Korea's Gravity Corp.
<br/>
<br/>

The line-up of speakers is updated daily so check back often. 
<br/>
<br/>

We look forward to seeing past attendees as well as first timers.  <a href="http://www.e3expo.com/attendees/registration.aspx">Register today</a> to take advantage of early-bird pricing.</strong>
<br/>
<br/>
            ...
            <div id="sidebar">
              <div id="pretertiaryNav">
                <div id="pretertiary-top"></div>
                  <ul>
                    ...
                    <li><a href="http://www.virtualpressoffice.com/media/show/display.jsp?showId=1122945241594" target="_blank"><b>Exhibitor News</b></a></li>
                    <li class="spacer"></li>
              ...
              <div id="tertiaryNav">
                ...
                <ul>
                  ...
                  <li><a href="exhibitors/exhibitor-list.aspx"><b>Exhibitor List</b></a></li>
                  <li class="spacer"></li>
