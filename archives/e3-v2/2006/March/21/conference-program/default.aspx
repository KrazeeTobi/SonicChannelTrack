...
<body>
<form name="aspnetForm" method="post" action="/conference-program/default.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
  ...
  <div id="container">
    ...
    <h2>Welcome to the next generation of video games.</h2>
        <p> With a trio of new home consoles close to full deployment, the game industry is taking giant steps toward the future.</p>
        <p> The increasing reach of high-speed connectivity into the home and out to wireless handsets, and the availability of sophisticated handheld devices are building additional momentum.</p>
        <p> Game content has also taken strides in the past year. New technology has allowed game design to advance artistically. The industry as a whole has gained unprecedented relevance among a mass market audience and other entertainment sectors. Games are now recognized as a magnet for entertainment players from the music, movies, and TV industries.</p>
        <p> This progress forms the backdrop of the 2006 E<sup>3</sup> Conference Program.</p>
        <p> This year's conference sessions and workshops will focus on a number of key topics, distilling what is most important to existing developers and publishers, as well as what those from other industries need to know to successfully enter the game industry.</p>
        <p> Topics include:</p>
            <ul>
                <li>How in-game, around-game, and product placement are redefining the relationship between the game industry and Madison Avenue</li>
                <li>The slow, steady, and inevitable rise of the casual game marketplace</li>
                <li>How the PSP, DS, and 3G handsets are redefining the future of portable gaming</li>
                <li>Where gaming fits in to an all-digital, on-demand entertainment ecosystem</li>
                <li>Casual game success stories from Asia and Europe</li>
                <li>New technologies in mobile communications and how they are accelerating change in wireless gaming</li>
                <li>Digital distribution (Are we there yet?)</li>
                <li>The new generation of home consoles and their impact on the economics of game development and publishing</li>
            </ul>
        <p> We invite you to join us in Los Angeles on May 9, 10, 11, 2006, as we present over 30 sessions that can help guide your business enterprise toward the most promising opportunities within the interactive entertainment industry today.</p>   
        <p> Check this web site often for updates and more information on the upcoming program.</p>
        <p> We look forward to seeing you in May.</p>
        <p> And remember: E<sup>3</sup> is offering a special rate to all 2005 and 2004 Conference Program alumni. Register for a Super Pass by April 7, 2006 and lock in last year's pricing. Look for your Alumni e-mail detailing this opportunity and learn how you can benefit from this special cost-saving opportunity.</p>   
              ...
              <div id="pretertiaryNav">
                <div id="pretertiary-top"></div>
                  ...
                  <!--not necessary anymore
                    ...
                    <li class="spacer"></li>
                    -->
                    <li><a class="email" href="/utilities/email.aspx?URL=conference-program%2fdefault.aspx"><b>Email</b></a></li>
                    <li class="spacer"></li>
