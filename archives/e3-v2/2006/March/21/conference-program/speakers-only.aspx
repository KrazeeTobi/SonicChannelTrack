...
<body>
<form name="aspnetForm" method="post" action="/conference-program/speakers-only.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
    ...
    <div id="mainContent-container">
      <table>
        <tr>
          <td id="main">
            <div id="mainContent">
              The page you are trying to view is password protected. You must use a Speaker login to access this content.
            </div> <!-- /mainContent -->
          </td>
          <td>
            <div id="sidebar">
              <div id="pretertiaryNav">
                <div id="pretertiary-top"></div>
                  ...
                  <!--not necessary anymore
                    ...
                    <li class="spacer"></li>
                    -->
                    <li><a class="email" href="/utilities/email.aspx?URL=conference-program%2fspeakers-only.aspx"><b>Email</b></a></li>
                    <li class="spacer"></li>
