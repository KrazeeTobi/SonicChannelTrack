...
<body>
<form name="aspnetForm" method="post" action="/attendees/default.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
  ...
  <div id="container">
    ...
    <h2>Attendee Overview</h2>
        <h4> Welcome to the Attendee section of E3Expo.com. </h4>
        <p> Here you'll find all the information you'll need to register and plan your trip to this year's show. </p>
        <p> As a trade event, E<sup>3</sup> is only open to industry professionals. Learn more about requirements in the Registration and Industry Identification pages, linked to the right.</p>
        <p> After registering for the show, you can start gearing up for this exciting event by keeping up with Show and Exhibitor News, checking out the dynamic sessions offered through the Conference Program, reviewing Floor Plans and more.</p>
              ...
              <div id="pretertiaryNav">
                <div id="pretertiary-top"></div>
                  ...
                  <!--not necessary anymore
                    ...
                    <li class="spacer"></li>
                    -->
                    <li><a class="email" href="/utilities/email.aspx?URL=attendees%2fdefault.aspx"><b>Email</b></a></li>
                    <li class="spacer"></li>
