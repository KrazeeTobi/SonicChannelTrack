...
<body>
<form name="aspnetForm" method="post" action="event-marketing.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
  ...
  <div id="container">
    ...
    <div id="mainContent-container">
      <table>
       ...
       <h2>Commence Branding</h2>
        <p>For three days in May, the people you most want to reach will be at E<sup>3</sup> 2006!</p>
        <p>What an opportunity! Here's your chance to get face-to-face with key industry professionals. You can generate high level awareness among potential buyers, sellers, partners, distributors, reporters, and investors and do it all in just 3 days. It's a marketing dream come true!</p>
        <p>As the eyes of the world are focused on E<sup>3</sup>, the value-added publicity is immeasurable.  Both the Los Angeles Convention Center and our host city overflow with advertising and sponsorship opportunities.  Your messaging can appear on impressive outdoor banners or you might have thousands of attendees actually wearing your messaging every day of the show on the badge lanyards.  There are programs for every budget and flexibility, so whether your goal is to announce a new product, drive traffic to your exhibit, or make a big splash with attendees away from your exhibit space, you can make it happen with Event Marketing!</p>
        ...
        <table>
            <tr>
                <td>
                    ...
                    <ul>
                    <li>Attendee Email Promotion</li>
                    <li>Badge Holder Inserts</li>
                    <li>Badge Lanyards</li>
                    <li>Business Service Center</li>
                    <li>Concession Cups & Napkins</li>
                    <li>Conference Bag Insert</li>
                    <li>Conference Notebook</li>
                    <li>Custom Carpet</li>
                    <li>E<sup>3</sup> Merchandise Store</li>
                    <li>Floor Coverings</li>
                    <li>Hotel Keys</li>	 
                    <li>Hotel Promotional Distributions</li>
                    <li>Interactive Distribution</li>
                    <li>Media Hospitality Lounge</li>
                    <li>Media Work Center/Registration</li>
                    <li>Parking Garage Promotions</li>
                    <li>Promotional Distributions</li>
                    <li>Registration Greeters</li>
                    <li>Show Bags</li>
                    <li>Shuttle Bus Advertising</li>
                    <li>Shuttle Bus Wristbands</li>
                    <li>Sports Bars</li>
                    <li>The Internet Zone</li>
                    <li>VIP Retailer Gifts</li>
                    <li>VIP Retailer Lounge</li>
                    </ul>
                </td>
                <td>
                    <h4>On-Site Marketing</h4>
                    <ul>
                    <li>Banners (Indoor/Outdoor)</li>
                    <li>Column Wraps</li>
                    <li>Concourse Window Banners</li>
                    <li>Door Graphics</li>
                    <li>Floor Graphics</li>
                    <li>Freestanding Ad Walls</li>
                    <li>Light Boxes</li>
                    <li>Meeting Room Entrance Units</li>
                    <li>Stair Riser Graphics</li>
                    <li>Table Top Graphics</li>
                    </ul>
                </td>
            </tr>
        </table>
        ...
        <p>
        Explore the sponsorship and on-site marketing programs 
        <a href="event-marketing-protected.aspx">online</a>
        available exclusively to E<sup>3</sup> 2006 exhibitors.
        </p>
              ...
              <div id="pretertiaryNav">
                <div id="pretertiary-top"></div>
                  ...
                  <!--not necessary anymore
                    ...
                    <li class="spacer"></li>
                    -->
                    <li><a class="email" href="/utilities/email.aspx?URL=exhibitors%2fevent-marketing.aspx"><b>Email</b></a></li>
                    <li class="spacer"></li>
