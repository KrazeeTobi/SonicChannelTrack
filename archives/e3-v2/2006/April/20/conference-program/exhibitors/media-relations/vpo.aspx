...
<body>
<form name="aspnetForm" method="post" action="vpo.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
  ...
  <div id="container">
    ...
    <h2>Virtual Press Office</h2>
        <!-- <p><a href="media-relations-opp.aspx">back to media relations opportunities</a></p> -->
			<p> <img src="../../_images/exhibitors/vpo.gif" alt="VPO"/>Now there's no more running out of press kits and no limit to the number of journalists who can review your company's news and information on the show’s Web site.  An online press kit is available to journalists 24/7 – before, during and after the show.</p>
			<h4>Benifits Include:</h4>
				<ul>
					<li><span class="strong">Cost Savings – only $545 for:</span>
						<ul>
							<li>Posting of six documents</li>
							<li>Multimedia capability includes images, screen shots, product demos and more</li>
							<li>Proactive distribution to pre-registered and industry media</li>
							<li>An ROI measuring tool – a post-show usage report that details which journalists or analysts reviewed your press materials</li>
							<li>Archive of press kit for one year</li>
						</ul>
					</li>
					<li><span class="strong">Wider reach of media:</span>
						<ul>
							<li>Hard copy press kits can only reach journalists who attend E<sup>3</sup> and only during the hours of the event.  Online press kits are available at www.E3expo.com 24 hours a day to journalists and analysts attending the event and to thousands worldwide who may not be in attendance.</li>
							<li>75% of attending journalists use www.E3Expo.com as their primary news source from the event.</li>
							<li>Online press kits received 24,000 hits from members of the media last year.</li>
						</ul>
					</li>
					<li><span class="strong">Easy and convenient for journalists and exhibitors:</span>
						<ul>
							<li>Reporters no longer have to sift through hundreds of hard copy press kits.</li> 
							<li>Journalists can avoid having to check out hundreds of company Web sites to get the latest news.</li>
							<li>Unlike hard copy press kits that need to be finalized days before the show, with VPO, uploading press materials is almost instantaneous.</li>
						</ul>
					</li>
					<li><span class="strong">Pique media interest before the flood of show news hits:</span>
						<ul>
							<li>Documents can be posted during the months leading up to the show.  Exhibitors can start posting their press materials now.</li>
						</ul>
					</li>
					<li><span class="strong">Customized for each exhibitor’s specific needs:</span>
						<ul>
							<li>Whether it’s a traditional press kit, a product demo video or publicizing events, VPO can tailor its online offering to each individual exhibitor’s needs.</li>
						</ul>
					</li>
				</ul>
				<h4>How does it work?</h4>
					<ul>
						<li>Exhibitors supply documents of any length.  VPO posts all the press kit files to the E<sup>3</sup> Web site.  To order, please click on the online <a href="http://www.virtualpressoffice.com/media/order/orderForm.jsp?orderId=1131114879488&showId=1122945241594&ofref=jp" rel="external">Order Form</a>.</li>
						<li>VPO then distributes exhibitor news to pre-registered and attending press and alerts its database of 25,000 worldwide media.  Journalists at the show and around the world can also access exhibitor press kits directly from E<sup>3</sup>'s <a href="http://www.virtualpressoffice.com/media/show/display.jsp?showId=1122945241594" rel="external">Official Online Media Center</a>.</li>
						<li>After the show, VPO provides an online media usage report, detailing the individuals interested in each participating exhibitor’s electronic press kit.  The report is available up to three months after the show.</li>
						<li>For specific questions, contact Scott Valenz at (973) 783-7787 or scott@virtualpressoffice.com</li>
					</ul>
		<!-- <p><a href="media-relations-opp.aspx">back to media relations opportunities</a></p> -->
              ...
              <div id="pretertiaryNav">
                <div id="pretertiary-top"></div>
                  ...
                  <!--not necessary anymore
                    ...
                    <li class="spacer"></li>
                    -->
                    <li><a class="email" href="/utilities/email.aspx?URL=conference-program%2fexhibitors%2fmedia-relations%2fvpo.aspx"><b>Email</b></a></li>
                    <li class="spacer"></li>
