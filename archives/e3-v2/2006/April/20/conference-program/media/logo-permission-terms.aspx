...
<body>
<form name="aspnetForm" method="post" action="logo-permission-terms.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
  ...
  <div id="container">
    ...
    <div id="mainContent-container">
      <table>
        ...
        <h2>Permission to Use E<sup>3</sup> logo</h2>
			<p> The E<sup>3</sup> Logo is a registered trademark owned by the Entertainment Software Association, Inc. ("ESA") and is a copyrighted design in which all rights are owned by ESA.  ESA is willing to grant permission for you to copy and reproduce the E<sup>3</sup> Logo on the following terms and conditions.</p>
				<ol>
					<li>You will use the E<sup>3</sup> Logo only for the purpose of advertising or promoting your participation in or involvement with the Electronic Entertainment Expo.  In making this use, you will not represent that ESA approves, sponsors or endorses your products in any way.</li>
					<li>You will use the E<sup>3</sup> Logo precisely in the form downloaded from this Web site and will not alter, mutilate or add to the E<sup>3</sup> Logo in any way.</li>
					<li>You will use the E<sup>3</sup> Logo only in materials bearing your own name and trademarks, and will not use the E<sup>3</sup> Logo as a trademark for your own goods or services.</li>
					<li>You will not claim any rights in the E<sup>3</sup> Logo and will not challenge ESA’s ownership of its rights in the E<sup>3</sup> Logo.</li>
					<li>This permission is personal to you and/or any company of which you are an employee. You will not authorize the reproduction or use of the E<sup>3</sup> Logo by anyone else.</li>
					<li>Permission to reproduce or use the E<sup>3</sup> Logo may be withdrawn by ESA at any time, for any reason, upon reasonable notice to you.</li>
				</ol>
			<p> If these terms and conditions are agreeable, please click the "I accept" button below.</p>
			<img name="Accept" src="" width="32" height="15" alt="I accept the terms" style="background-color: #eeeeee" />
              ...
              <div id="pretertiaryNav">
                <div id="pretertiary-top"></div>
                  ...
                  <!--not necessary anymore
                    ...
                    <li class="spacer"></li>
                    -->
                    <li><a class="email" href="/utilities/email.aspx?URL=conference-program%2fmedia%2flogo-permission-terms.aspx"><b>Email</b></a></li>
                    <li class="spacer"></li>
