...
<body>
<form name="aspnetForm" method="post" action="onsite-services.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
  ...
  <div id="container">
    ...
    <h2>On-Site Services</h2>
		<h4>E<sup>3</sup> On-Site Media Center</h4>
		<p> The E<sup>3</sup> 2006 Media Center offers convenient support for journalists covering the show free of charge.  It features a large working newsroom equipped with:
		</p>
			<ul>
			...
			<table>
				<tr>
					<td colspan="3"><span class="strong">Media Center and Media Registration Hours</span></td>
				</tr>
				<tr>
					<td class="grey">Monday, May 8</td>
					<td class="grey">10 a.m. to 6:30 p.m.</td>
					<td>(for badge-holder pick up only)</td>
				</tr>
				<tr>
				    <td class="grey">Tuesday, May 9</td>
				    <td class="grey">8 a.m. to 6:30 p.m.</td>
				</tr>
				<tr>
				    <td class="grey">Wednesday, May 10</td>
				    <td class="grey">7 a.m. to 6:30 p.m.</td>
				</tr>	
				<tr>
				...
				<tr>
				    ...
				    <td class="grey">8 a.m. to 4:30 p.m.</td>
				</tr>				
			</table>
			
			<table>
				<tr>
					<td colspan="2"><span class="strong">Media Center Room Assignments</span></td>
				</tr>
				<tr>
					<td class="grey">Media Registration</td>
					<td class="grey">West Hall Room 502A</td>	
				</tr>
				<tr>
					<td class="grey">Working News Room</td>
					<td class="grey">West Hall Room 502B</td>	
				</tr>	
				<tr>
					<td class="grey">Media Hospitality Suite<br />
						(media only)</td>
					<td class="grey">West Hall Room 515</td>	
				</tr>	
			</table>
			
		<h4>ESA Media Briefing and Breakfast</h4>
		<p>	ESA President, Doug Lowenstein, will present a "state of the industry" address before the show floor opens on May 10th. Check back in March for details.
		</p>
		<p> <a href="exhibitor-list.aspx">Exhibitor Booth Assignments</a></p>
	    <h4>E<sup>3</sup> Floorplans</h4>
		<p> E<sup>3</sup> floorplans will be available in April.
		</p>
              ...
              <div id="pretertiaryNav">
                <div id="pretertiary-top"></div>
                  ...
                  <!--not necessary anymore
                    ...
                    <li class="spacer"></li>
                    -->
                    <li><a class="email" href="/utilities/email.aspx?URL=conference-program%2fmedia%2fonsite-services.aspx"><b>Email</b></a></li>
                    <li class="spacer"></li>
