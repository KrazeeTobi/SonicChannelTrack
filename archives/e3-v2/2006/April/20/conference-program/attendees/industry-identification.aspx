...
<body>
<form name="aspnetForm" method="post" action="industry-identification.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
  ...
  <div id="container">
    ...
    <h2>Industry Identification</h2>
	    <h4>E<sup class="three">3</sup> 2006 Accepted Form of Industry Identification</h4>
			<ul>
				<li>Resale Tax Certificate</li>
				<li>Company Credit Card (WITH APPLICANT'S NAME)</li>
		...
		<p>If you are from the retail sector, you must be selected by your parent company in order to receive Package Five admission.</p>
		<p> To be considered for registration, two forms of industry ID must accompany your application.  <span class="strong">At least one form of industry ID must contain both your name and the name of the company where you are employed.</span>  Individuals who are not able to document their direct and current professional affiliation to the interactive entertainment industry are not qualified to attend.</p>
              ...
              <div id="pretertiaryNav">
                <div id="pretertiary-top"></div>
                  ...
                  <!--not necessary anymore
                    ...
                    <li class="spacer"></li>
                    -->
                    <li><a class="email" href="/utilities/email.aspx?URL=conference-program%2fattendees%2findustry-identification.aspx"><b>Email</b></a></li>
                    <li class="spacer"></li>
