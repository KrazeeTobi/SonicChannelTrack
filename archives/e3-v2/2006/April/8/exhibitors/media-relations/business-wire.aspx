...
<body>
<form name="aspnetForm" method="post" action="business-wire.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
  ...
  <div id="container">
    ...
    <h2>Business Wire</h2>
        <!-- <p><a href="media-relations-opp.aspx">back to media relations opportunities</a></p><br /> -->
			
			<table border="0">
			    <tr>
			        <td width="150" valign="middle"><img src="../../_images/exhibitors/bw.gif" width="150"></td>
			        <td><p> Business Wire offers a variety of options for the timely distribution of video gaming and related news releases and photos. In addition, Business Wire is offering free distribution of a 100-word exhibitor profile.</p></td>
			    </tr>
			    
			</table>
			
			<h4>All news release distribution circuits automatically include:</h4>
				<ul>
                    <li>Attending Media and Analysts</li>
                    <li>Relevant gaming, software and related trade media worldwide</li>
                    <li>Posting to the exhibitor news area of the official show site</li>
                    <li>National disclosure and financial media for public companies</li>
                    <li>The Business Wire Reach, Posting and Access Reports along with the Virtual Press Office </li>
                    <li>DayTrak media interest report</li>
                    <li>Automatic distribution of photos via the AP Photo system with all photo releases</li>
				</ul>
			<p>For a complete overview of show related news distribution circuits and to receive the free profile template, email <a href="mailto:tradeshow@businesswire.com">tradeshow@businesswire.com</a></p>
              ...
              <div id="pretertiaryNav">
                <div id="pretertiary-top"></div>
                  ...
                  <!--not necessary anymore
                    ...
                    <li class="spacer"></li>
                    -->
                    <li><a class="email" href="/utilities/email.aspx?URL=exhibitors%2fmedia-relations%2fbusiness-wire.aspx"><b>Email</b></a></li>
                    <li class="spacer"></li>
