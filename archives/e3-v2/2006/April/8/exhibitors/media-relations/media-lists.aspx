...
<body>
<form name="aspnetForm" method="post" action="media-lists.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
  ...
  <div id="container">
    ...
    <h2>Media Lists</h2>   
        <div id="altNav">
	        ...
	        <p>	As the world's premiere trade show for computer and video games and related products, E<sup>3</sup> attracts a broad cross section of media.  Below, for your reference, is the list of pre-registered media who are qualified to attend E<sup>3</sup> 2006. </p>
	        <p>	<span class="strong">IMPORTANT</span>: Please refer to the last three columns of the Media List which indicate the preferences of the journalist in recieving information from exhibitors.
	        </p>	
	        <p> <span class="strong">Download E<sup>3</sup> 2006 Pre-Registered Media List</span></p>			
	            <ul>
		            <li><a href="../../_assets/xls/medialist_20060331.xls">Excel Format</a> (XLS 461KB)</li>

		            <li><a href="../../_assets/txt/medialist_20060331.txt" rel="external">Text Format</a> (TXT 213KB) </li>
	            </ul>				
	        <!--<p>Note: The E<sup>3</sup> Excel format media lists are in .ZIP and .SIT format. You must have <a href="http://www.winzip.com/ddchomea.htm" rel="external">WinZip</a> (PC), <a href="http://www.stuffit.com/mac/" rel="external">StuffIt Expander</a> (PC/Mac/Linux) or an equivalent utility installed and configured in order to view these files.</p> -->                                        
              ...
              <div id="pretertiaryNav">
                <div id="pretertiary-top"></div>
                  ...
                  <!--not necessary anymore
                    ...
                    <li class="spacer"></li>
                    -->
                    <li><a class="email" href="/utilities/email.aspx?URL=exhibitors%2fmedia-relations%2fmedia-lists.aspx"><b>Email</b></a></li>
                    <li class="spacer"></li>
