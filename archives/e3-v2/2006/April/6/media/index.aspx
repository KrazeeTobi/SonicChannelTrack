...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
  ...
  <div id="container">
    ...
    <div id="mainContent-container">
      <table>
		...
		<h2>Media Center Intro Page:</h2>
			<ul>
				<li><a href="registration.aspx">Media eRegistration</a> – This links to Media eReg copy below &amp; RCS reg pages</li>
				<li><a href="show-news.aspx">Show News</a> – This links to Show News copy below, including link to exhibitor news</li>
				<li><a href="#">Exhibitors</a> – This links to the exhibitor list</li>
				<li><a href="housing-travel.aspx">Transportation</a> – This links to the main transportation page</li>
				<li><a href="onsite-services.aspx">On-site Services</a> – This links to the on-site services copy below</li>
				<li><a href="media-faq.aspx">Questions</a> – This links to the Media FAQ that will be posted within the Show News page</li>
				<li><a href="media-overview.html">Contact Us</a> – This links to our contact info within the Media Center intro page below</li>
			</ul>
		 <h4>E3 Online Media Center</h4>
			<p>Welcome to E3 2006 – "Where Business Gets Fun."  This online Media Center allows you to submit your request for media registration and provides the latest E3 2006 news and information for covering the show, May 10 – 12, 2006, at the Los Angeles Convention Center. 
			</p>
			<table>
				<tr>
					<td width="30%"><b>Exhibit Hours</b><br />
						Wednesday, May 10<br />
						Wednesday, May 10<br />
						Thursday, May 11<br />
						Friday, May 12
					...
					<td width="40%">(E3 Early Access: pre-registered media only)</td>
				</tr>
			</table>
		<p> <a href="#">Workshops &amp; Conferences</a> – (LINK TO CONFERENCE INFO WITHIN SITE)<br />
			May 9 – 11, 2006
		</p>
		<p>	<span class="strong">Contact Us</span><br />
			For additional E3 2006 information, please contact the E3 Media Relations Team at <a href="mailto:media@e3expo.com">media@e3expo.com</a>.
		</p>
		<h4> Additional Resources</h4>
			<ul>
				<li>Entertainment Software Association (<a href="http://www.theesa.com">www.theesa.com</a>)</li>
				<li>E3 Insider (<a href="http://www.e3insider.com">www.e3insider.com</a>)</li>
				<li>Entertainment Software Rating Board (<a href="http://www.esrb.org">www.esrb.org</a>)</li>
				<li>Into the Pixel (<a href="http://www.intothepixel.com">www.intothepixel.com</a>)</li>
				<li>Los Angeles Convention Center (<a href="http://www.lacclink.com">www.lacclink.com</a>)</li>
				<li>Business Wire (<a href="http://www.businesswire.com">www.businesswire.com</a>)</li>
				<li>Virtual Press Office (<a href="http://www.virtualpressoffice.com/event/e3expo">www.virtualpressoffice.com/event/e3expo</a>)</li>
			</ul>
		<p> E3 2006 is a trade event and not open to the general public. No one under 18 will be admitted including infants.</p>
		
					<a href="media-registration.html">SUB PAGE 1: MEDIA E-REGISTRATION</a><br />
					<a href="media-exhibitor-news.html">SUB PAGE 2: Show News</a><br />
					<a href="#">SUB PAGE 3: EXHIBITOR NEWS</a><br />
					<a href="../exhibitor/exhibitor-list.html">Exhibitor List – (LINK TO EXHBITOR LIST WITHIN SITE)</a><br />
					<a href="media-housing-travel.html">SUB PAGE 5: Media Travel</a><br />
					<a href="media-services.html">SUB PAGE 6: On-site Services </a><br />
		
		<a href="media-faq.aspx">SUB PAGE 7: Questions – (LINK TO MEDIA FAQ)</a><br />
		<br />
		<a href="#">SUB PAGE 8: Contact Us – (LINK TO E3 MEDIA RELATIONS CONTACT INFO ON MAIN CENTER PAGE)</a>
              ...
              <div id="pretertiaryNav">
                <div id="pretertiary-top"></div>
                  ...
                  <!--not necessary anymore
                    ...
                    <li class="spacer"></li>
                    -->
                    <li><a class="email" href="/utilities/email.aspx?URL=media%2findex.aspx"><b>Email</b></a></li>
                    <li class="spacer"></li>
