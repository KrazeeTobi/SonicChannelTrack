...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
  ...
  <div id="container">
    ...
    <h2>Media Registration</h2>
        <p> Welcome to E<sup>3</sup> 2006 Media Registration. Online media registration will be available December 15 through April 13. Only qualified working journalists from commercial news organizations may submit a registration request to receive a complimentary media badge for E<sup>3</sup> 2006. <span class="strong">Please Note</span> that submitting the registration request form does not automatically qualify you for a media badge at E<sup>3</sup> 2006. The management of E<sup>3</sup> 2006 reserves the right to deny any applicant a media badge. </p>
        
	<p> <span class="strong">New This Year: E<sup>3</sup>’s Early Access hours</span><br />
	 E<sup>3</sup> 2006 is offering early access hours to pre-registered media (media who have submitted                      credentials to the E<sup>3</sup> Media Relations Team by April 13) allowing access to the show floor                     during E<sup>3</sup>’s Early Access hours on Wednesday, May 10 from 9 – 11 a.m. We strongly encourage                    all media to take advantage of the online media registration to complete pre-registration for the 2006                   show.
	  <br />
	  <br />
        Please Note: Media badges do not provide access to workshops or conferences. (Please see the media FAQ to find out how to attend conferences and workshops.) 
       <br />
       <br />
    <a href="https://register.rcsreg.com/regos-1.0/e3la2006/pr" rel="external">Click here</a> to proceed to media registration.</p>
    
    <p>To qualify as media, please provide:
    <br />
    <br />
    <span class="strong">Print Media & Newswire Reporters:</span>
        <ul>
     ...
     <span class="strong">Freelance Journalists:</span><br />
     Please note: Freelance writers from unqualified media outlets will not be admitted. Qualification of all media outlets will be determined by the E<sup>3</sup> 2006 Media Registration staff.<br />
        <ul>
            <li>A copy of your driver’s license or government issued photo identification clearly showing your name and date of birth (no one under 18 will be admitted), AND </li>
            <li>A copy of your business card with name, editorial title and media outlet's logo, AND </li>
     ...
     <span class="strong">Broadcast Journalists & Photographers:</span><br />
     Please note: Each member of a broadcast crew must register separately.<br />
     <ul>
        <li>A copy of your driver’s license or government issued photo identification clearly showing your name and date of birth (no one under 18 will be admitted), AND </li>
        <li>A copy of your business card with name, editorial title and media outlet's logo, AND </li>
        <li>A letter from a producer/editor (on company letterhead) stating that you are covering E3 2006 on assignment. </li>
        <li>Please note: The name on your business card and your photo identification must match to be accepted</li>
     </ul>
     <br />
     <span class="strong">Industry and Financial Analysts:</span>
     <ul>
        <li>A copy of your driver’s license or government issued photo identification clearly showing your name and date of birth (no one under 18 will be admitted), AND </li>
        ...
        <li>Please note: The name on your business card and your photo identification must match to be accepted. </li>
				...
				<p> <span class="strong">Online Media Registration Verification</span><br />
					If you have already filled out a registration request form for E<sup>3</sup> 2006 and would like to check the status of your media registration, please visit our <a href="https://register.rcsreg.com/regos-1.0/e3la2006/pr" rel="external">online media registration verification system</a>.</p>
              ...
              <div id="pretertiaryNav">
                <div id="pretertiary-top"></div>
                  ...
                  <!--not necessary anymore
                    ...
                    <li class="spacer"></li>
                    -->
                    <li><a class="email" href="/utilities/email.aspx?URL=media%2fregistration.aspx"><b>Email</b></a></li>
                    <li class="spacer"></li>
