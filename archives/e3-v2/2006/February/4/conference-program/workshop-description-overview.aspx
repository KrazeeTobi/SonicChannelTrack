...
<body>
<form name="aspnetForm" method="post" action="workshop-description-overview.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
  ...
  <div id="container">
    ...
    <h2>Workshop Descriptions: '06 program</h2>

        <p><span class="strong"><a href="workshop-descriptions.aspx">E<sup>3</sup> Workshops</a></span></p>
            <p> The game industry has grown up. Games are supplanting traditional marketing vehicles, a new generation of consoles are taking their place alongside legacy systems, and wireless and handheld gaming are moving portable gameplay out of the home and on the road.</p>
            <p> Just as the industry has matured, so have the games--becoming more advanced, realistic, and immersive. Game industry business models are also evolving. New investment strategies and distribution models, once merely imagined, are either in play or being seriously experimented with.</p>
            <p> E<sup>3</sup> workshops focus on the industry's significant new trends and will assemble a speaker lineup of leaders and influencers driving the growth of the industry.</p>
            <p> Session topics will include:</p>
                <ul>
                    <li>In-game and around-game advertising</li>
                    <li>Casual game update: Report from the global marketplace</li> 
                    <li>The future of portable and handheld games</li>
                    <li>Game design for next-generation consoles</li>
                    <li>Tracking the new digital economy</li> 
                    <li>Upcoming digital distribution models</li>
                </ul>
            <p> In addition to nine workshops, three lunchtime presentations will provide insight from industry executives and renowned creative talent who will share their knowledge and view of the future.</p>
            <p> Take advantage of this unique E<sup>3</sup> opportunity. A full day of workshops will put you in the center of what's driving today's game industry.</p>
              ...
              <div id="pretertiaryNav">
                <div id="pretertiary-top"></div>
                  ...
                  <!--not necessary anymore
                    ...
                    <li class="spacer"></li>
                    -->
                    <li><a class="email" href="/utilities/email.aspx?URL=conference-program%2fworkshop-description-overview.aspx"><b>Email</b></a></li>
                    <li class="spacer"></li>
