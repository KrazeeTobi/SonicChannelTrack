...
<body onResize="window.location.href = window.location.href;">
    ...
    <div id="GlobalNavigation">
        ...
        <img src="/assets/images/global-navigation/Home/divider.gif" width="4" height="4" id="GlobalNav-Divider1" name="GlobalNav-Divider1" alt="" />
...
<img src="/assets/images/header-graphics/home-football.jpg" width="693" height="193" alt="TEAM PLAYER Image from ESPN NFL 2K5 &copy;2004 Sega Corporation. All Rights Reserved. Used with Permission." /></div>
    <div id="HomepageCalloutBox">       <!-- <a href="" 
            onmouseover="changeImages('HomepageCalloutBoxBanner', '/assets/images/homepage/conference_over.gif'); return true;"
            onmouseout="changeImages('HomepageCalloutBoxBanner', '/assets/images/homepage/conference.gif'); return true;">
	        ...
	        <tr>
                ...
                <table width="693" border="0" cellspacing="0" cellpadding="0">
				    <tr>
                        ...
                        <td><div id="HomePageDynamicText">

    <p>Welcome to the 2005 E3Expo.com website.  As we all prepare for the year's most exciting interactive entertainment show, there is no better place to get all your show-related information.</p>
    
    <p>With preparations rapidly increasing, check back often for updates and milestones. </p>
    
    <p>Currently on the calendar:
        <br />-Attendee Registration Now Open
	    <br />-December 6th: Exhibitor Registration begins
	    <br />-December 15th: Media Registration begins
    </p>
    
    <p>
        Also coming soon:
	    <br />-Conference Program
	    <br />-More Exhibitor and Show News
	    <br />-Exhibitor Prospectus Sales Kit
    </p>
    
    <p><i>E<sup>3</sup> is where the business of interactive entertainment meets the fun of games!</i></p>
...
<div id="RightSideNavigationArrows">
    ...
    <a href="" 
    onmouseover="changeImages('LoginArrrow', '/assets/images/side_navigation/login_arrow_over.gif'); return true;"
    onmouseout="changeImages('LoginArrrow', '/assets/images/side_navigation/login_arrow.gif'); return true;">        
    <img src="/assets/images/side_navigation/login_arrow.gif" alt="" name="LoginArrrow" id="LoginArrrow" width="17" height="19" border="0"></a> 
    ...
    <a href="" 
    onmouseover="changeImages('LinkArrow5', '/assets/images/side_navigation/link_arrow_over.gif'); return true;"
    onmouseout="changeImages('LinkArrow5', '/assets/images/side_navigation/link_arrow.gif'); return true;">        
    <img src="/assets/images/side_navigation/link_arrow.gif" alt="" name="LinkArrow5" id="LinkArrow5" width="17" height="19" border="0"></a>                    
...
<!--        <a href="" 
        onmouseover="changeImages('Login', '/assets/images/side_navigation/login_button_over.gif','LoginArrrow', '/assets/images/side_navigation/login_arrow_over.gif'); return true;"
        onmouseout="changeImages('Login', '/assets/images/side_navigation/login_button.gif','LoginArrrow', '/assets/images/side_navigation/login_arrow.gif'); return true;">
    
        <img src="/assets/images/side_navigation/login_button.gif" alt="LOGIN" name="Login" id="Login" width="42" height="13" border="0" /></a>-->

        <input type="image" SRC="/assets/images/side_navigation/login_button.gif" width="42" height="13" id="Login" name="Login">

        
        <div id="PasswordLabel">PASSWORD:</div>
        <input type="text" id="LoginPassword" name="LoginPassword" maxlength="25">        
    ...
    onmouseover="changeImages('E3News', '/assets/images/side_navigation/e3_news_over.gif','E3NewsArrrow', '/assets/images/side_navigation/e3_news_arrrow_over.gif'); return true;"
    onmouseout="changeImages('E3News', '/assets/images/side_navigation/e3_news.gif','E3NewsArrrow', '/assets/images/side_navigation/e3_news_arrrow.gif'); return true;">           
    <img src="/assets/images/side_navigation/e3_news.gif" alt="" name="E3News" id="E3News" width="91" height="33" border="0" /></a>
...
<script language="JavaScript1.2" src="/assets/js/menuProperties.js"></script>
