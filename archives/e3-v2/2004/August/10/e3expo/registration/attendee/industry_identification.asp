...
<table border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td valign="middle">
			...
			<span class="breadcrumbSecondary"> / Industy Identification</span></td>
	</tr>
</table>
...
<table width="214" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
	<tr>	
		...
		<!------------------------ Title Graphic ---------------------------------------->			
		<img src="/images/headers/e3expo/industry_identification.gif" alt="Industy Identification" width="329" height="15" border="0"><br>
		
		<!------------------------ Main Content Section ---------------------------------->
			<p class="bodyText">
				E<sup>3</sup> 2004 Accepted Forms of Industry Identification
				<br><br>
				<ul>
