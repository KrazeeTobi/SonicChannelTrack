...
&nbsp;</td>
			...
			<br /><br />	
				...
				<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#DEDEDE">
					...
					<tr>
						<td width="18%" class="tableRowEven">Speaker:</td>
						<td class="tableRowEven">Speaker to be Added Shortly&nbsp;</td>
					</tr>
			...
			<br /><br />	
				...
				<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#DEDEDE">
					...
					<tr>
						<td class="tableRowEven">Panelists:</td>
						<td class="tableRowEven">Phil Cooke, Chief Technology Officer - I-play<br>Tim Harrison, Head of Games - Vodafone Group Services, Limited<br>Satoshi Nakajima, Chief Architect - Square-Enix<br>Rob Sears, Director, Network Game Platforms - Nokia<br>Brian Wolkenberg, Games Lead, Global Entertainment Solutions - Motorola Mobile Devices&nbsp;</td>
					</tr>
