...
As consumers move away from traditional advertising vehicles such as print and TV, and spend more time playing games, advertisers, agencies, and publishers are hammering out a set of best practices to effectively place ads in games. This session's presenters will take attendees inside the fast-developing business model that marries the reach of games with the appetite of brands to deliver impressions. Speakers, drawn from different points in the value chain—the brand, the agency, the game maker, and the technology provider (from both the traditional and mobile spaces)—will each present a case study that highlights their unique solution and approach. As the total market for in-game advertising climbs from $200 million to an estimated $1 billion worldwide by 2008, understanding the goals of advertisers, the nuances of in-game ad placement, and the technologies that seamlessly deliver the messages, will separate the participants from the observers.
...
&nbsp;</td>
			...
			<br /><br />	
				...
				<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#DEDEDE">
					...
					<tr>
						<td class="tableRowEven">Panelists:</td>
						<td class="tableRowEven">Bill Gardner, President and CEO - O~3 Entertainment, Inc.<br>Ken Gold, Vice President of Marketing - Majesco Entertainment<br>Danny Hammett, Senior Vice President, Value Line Publishing - NA - Vivendi Universal Games<br>Gene Mauro, Chief Executive Officer - Myelin Media&nbsp;</td>
					</tr>
			...
			<br /><br />	
				...
				<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#DEDEDE">
					...
					<tr>
						<td class="tableRowEven">Panelists:</td>
						<td class="tableRowEven">Geoff Graber, General Manager - Yahoo! Games<br>Don Ryan, General Manager - Microsoft Game Studios<br>Monte Singman, Chief Operating Officer - Shanda<br>Wade Tinney, Founding Partner/Game Designer - Large Animal Games&nbsp;</td>
					</tr>
			...
			<br /><br />	
				...
				<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#DEDEDE">
					...
					<tr>
						<td class="tableRowEven">Panelists:</td>
						<td class="tableRowEven">Todd Howard, Executive Producer - Bethesda Softworks (The Elder Scrolls IV:Oblivion)<br>Tetsuya Mizuguchi, Chief Creative Officer - Q Entertainment (Meteos, Lumines)<br>Tim Willits, Lead Designer - id Software (Doom 3)&nbsp;</td>
					</tr>
