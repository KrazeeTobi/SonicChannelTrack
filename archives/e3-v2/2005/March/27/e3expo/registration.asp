...
<head>
	...
	<title>E3 2005 Registration</title>
...
<div id="TertiaryContent">
	...
	<h3>E<sup>3</sup> 2005 Registration</h3>
                            
	<p>
		<b>Register Today for E<sup>3</sup> 2005</b><br />
		If you're in the business of games, you need to be at the center of the games business - E<sup>3</sup>! Your source for everything in interactive entertainment. 
	</p>                            
	<p>First, select if you will be attending E<sup>3</sup> 2005 as...</p>
	<ul>
		<li><a href="/exhibitors/exhibitor_registration.asp">An Exhibitor</a></li>
		<li><a href="/media/media_e-registration.asp">A Member of the Media</a></li>
		<li><a href="/attendees/attendee_registration.asp">An Attendee</a></li>
		<li><a href="javascript:MM_openBrWindow('/e3expo/industy_invite.asp','win','width=300,height=210,scrollbars=0,top=320,left=300');">Industry Invite</a></li>
	</ul>
...
<div id="EmailPrintContainer">
    ...
    <div id="EmailIconLabel"><a href="/email.asp?RefererTitle=E3+2005+Registration" class="EmailPrintLink">Email</a></div>
        ...
        <table width="100%" cellspacing="0" cellpadding="0">
	        <tr>
		        ...
		        <td width="693" bgcolor="#718893">
                    ...
                    <p id="FooterBanners">                       
						<a href="http://www.chproducts.com/" onclick="javascript:urchinTracker('/assets/images/banners/CH_Products/');" class="Image" target="_blank"><img src="/assets/images/banners/CH_Products/ch_products.gif" alt="CHProducts" name="FooterBanner1" id="FooterBanner1" width="214" height="70" border="0" /></a>
