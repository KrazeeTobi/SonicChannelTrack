...
<div id="TertiaryNavigation">
    ...
    <img src="/assets/images/tertiary_navigation_divider/E3expo.gif" alt="" name="TertiaryNavDivider" id="TertiaryNavDivider" width="4" height="4" border="0" />
    <a href="/e3expo/conference_at_a_glance.asp" class="TertiaryNavigationLink">View By Day</a>        
</div>
...
<div id="TertiaryContent">
    ...
    <h3>View By Day</h3>
			...
			<select onchange="location = this.options[this.selectedIndex].value;">
					...
					<option value="view_by_day.asp?sec=session&dateID=4" >Wednesday, May 18, 3:30 PM - 4:30 PM</option>
					...
					<option value="view_by_day.asp?sec=session&dateID=8" >Thursday, May 19, 3:30 PM - 4:30 PM</option>
