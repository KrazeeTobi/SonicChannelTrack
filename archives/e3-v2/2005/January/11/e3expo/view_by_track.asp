...
<div id="TertiaryContent">
	...
	<p><a href="./workshop_list.asp">Click here</a> to view the complete list of workshops.</p>
			
	<p>Select a track to view full session information:</p>
...
<div id="EmailPrintContainer">
    ...
    <div id="EmailIconLabel"><a href="/email.asp?RefererTitle=View+By+Track" class="EmailPrintLink">Email</a></div>
