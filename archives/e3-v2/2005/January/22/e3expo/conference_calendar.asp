...
<div id="TertiaryNavigation">
    ...
    <img src="/assets/images/tertiary_navigation_divider/E3expo.gif" alt="" name="TertiaryNavDivider" id="TertiaryNavDivider" width="4" height="4" border="0" />
    <a href="/e3expo/view_by_track.asp" class="TertiaryNavigationLink">View By Track</a>
    <img src="/assets/images/tertiary_navigation_divider/E3expo.gif" alt="" name="TertiaryNavDivider" id="TertiaryNavDivider" width="4" height="4" border="0" />
...
<div id="TertiaryContent">
    ...
    <h3>Conference Program</h3>
		...
		<ul style="width:200px;border: thin solid Black;background-color: #F4F4F4;padding:13px 13px 13px 29px;">
			<span style="margin-left: -13px;"><strong>Be sure to check out these links:</strong></span>
			<li style="padding:10px 5px 5px 5px;"><a href="/e3expo/speaker_list.asp">Speaker List</a></li>
			<li style="padding:5px;"><a href="/e3expo/conference_at_a_glance.asp">Conference at a Glance</a></li>
			<li style="padding:5px;"><a href="/e3expo/view_by_track.asp">View By Track</a></li>
			<li style="padding:5px;"><a href="/e3expo/view_by_day.asp">View By Day</a></li>
		</ul>
