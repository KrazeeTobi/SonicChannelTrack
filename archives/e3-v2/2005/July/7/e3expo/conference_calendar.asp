...
<div id="TertiaryContent">
    ...
    <h3>Conference Program</h3>
		...
		<ul style="width:230px;border: thin solid Black;background-color: #F4F4F4;padding:13px 13px 13px 29px;">
			<span style="margin-left: -13px;"><strong>Be sure to check out these links:</strong></span>
			<li style="padding:10px 5px 5px 5px;"><a href="/e3expo/workshop_list.asp">E<sup>3</sup> Workshops</a></li>
			<li style="padding:5px;"><a href="/e3expo/track_details.asp?trackID=1">Track 1: Creativity and Technology</a></li>
			<li style="padding:5px;"><a href="/e3expo/track_details.asp?trackID=2">Track 2: Business Strategy</a></li>
			<li style="padding:5px;"><a href="/e3expo/track_details.asp?trackID=3">Track 3: Marketing Analysis</a></li>
		</ul>
    ...
    <p>Check often for updates and more information on the upcoming program, to be held in Los Angeles, May 17, 18, 19, 2005.</p>
