...
<div id="HomePageDynamicText">
    ...
    <h3>Email</h3>
        ...
        <p class="bodyText">Senders Name*:
            <br /><input type="text" name="SenderName" value="" size="30" maxlength="70" /></p>

        <p>Senders Email Address:
            <br /><input type="text" name="SenderEmail" value="" size="30" maxlength="70" /></p>

        <p>Recipients Name:
            <br /><input type="text" name="RecipientName" value="" size="30" maxlength="70" /></p>

        <p class="bodyText">Recipients Email Address*:
            <br /><input type="text" name="RecipientEmail" value="" size="30" maxlength="70" /></p>

        <p>
            Comments:<br />
            <textarea cols="39" rows="4" name="Comments" id="Comments"></textarea>
        </p>
        
        <p>
            <input type="submit" value="Submit" />
            <input type="hidden" name="Referer" value="">
            <input type="hidden" name="RefererTitle" value="">
        </p>
