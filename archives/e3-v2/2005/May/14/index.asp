...
<a href="/sitemap.asp" 
    onmouseover="changeImages('GlobalNav-Sitemap', '/assets/images/global-navigation/Home/sitemap_over.gif'); return true;"
    onmouseout="changeImages('GlobalNav-Sitemap', '/assets/images/global-navigation/Home/sitemap.gif'); return true;">
<img src="/assets/images/global-navigation/Home/sitemap.gif" width="56" height="10" id="GlobalNav-Sitemap" name="GlobalNav-Sitemap" alt="Sitemap" /></a>
...
<img src="/assets/images/global-navigation/Home/divider.gif" width="4" height="4" id="GlobalNav-Divider4" alt="" />
...
<img src="/assets/images/header-graphics/home-baseball.jpg" width="693" height="193" alt="SALES PITCH Image from ESPN Major League Baseball &copy;2004 Sega Corporation. All Rights Reserved. Used with Permission." /></div>
    <div id="HomepageCalloutBox"><img src="/assets/images/homepage/conference.gif" alt="" name="HomepageCalloutBoxBanner" id="HomepageCalloutBoxBanner" width="462" height="100" border="0" usemap="#conference_Map" />
<a href="http://www.1up.com" onclick="javascript:urchinTracker('/assets/images/banners/1UP/');" target="_blank"><img src="/assets/images/banners/1UP/1up.gif" title="1UP" name="HomepageCalloutBoxAd" id="HomepageCalloutBoxAd" width="191" height="51" border="0" /></a>
<map name="conference_Map">
<area shape="rect" alt="" coords="183,67,399,84" href="/e3expo/conference_at_a_glance.asp">
<area shape="rect" alt="" coords="33,67,115,85" href="/e3expo/conference_calendar.asp">
<area shape="rect" alt="" coords="337,46,441,67" href="/e3expo/conference_calendar.asp">
<area shape="rect" alt="" coords="0,0,337,46" href="/e3expo/conference_calendar.asp">
</map>
        </div>
...
<div id="HomePageDynamicText">
	<p><b>Welcome to the 2005 E3Expo.com website.</b>
	<br /><br />
	In the interest of keeping Conference Program attendees up to date, a few additions and changes to the program are worth noting. 
	<br /><br />
	Industry analyst Edward Woo of Wedbush Morgan Securities will take his colleague Michael Pachter's place in Wednesday's morning session, &quot;Game plan for the next gen consoles.&quot; And Ken Schachter, Gameloft's Head of Games, North America, has joined the Tuesday afternoon session titled, &quot;Mobile Games: Taking advantage of what's new in handset technology.&quot;
	<br /><br />
	Conference Program Luncheon Sessions have been finalized!
	<br /><br />
	Leading the lineup of the three sessions to be held on Tuesday, May 17, is a special presentation by Xiao Wei Kou, the Deputy Director of GAPP, the China government agency that approves all online games in that market. For North American publishers, a meeting with Mr. Kou is an essential first step to navigating the avenues to getting a game approved for online play in the fast-growing market in China. This is the first time Mr. Kou has spoken publicly in North America. This session will provide a unique opportunity to hear the current agenda of the Chinese government when it comes to online games.
	<br /><br />
	A second session will present "Word of Mouse" author Jim Banister. Banister will discuss the implication of consumers who no longer just consume, but also produce, distribute, and market digital content along side the brand owners; how networked media is transforming the audience's relationships with products, services, and entertainment; and how the game industry is contributing to that evolution. 
	<br /><br />
	A third luncheon session will focus on the latest data available from the mobile marketplace. Jupiter Research Senior Analyst Julie Ask will lead a discussion between herself, Sorrent Marketing veep Jill Braff, and Mobile Entertainment Forum-Americas chair Ralph Simon. Each will present their most recent data and findings, with a focus on the emergence of "tweens" as a driving force in the mobile marketplace (including a breakout of gender preferences), usage figures, how revenues are tracking, adoption rates, trends in consumer behavior, as well as trends in Europe.
	<br /><br />
	We remain excited about our special Thursday session that presents Mistwalker founder (and Final Fantasy creator) Hironobu Sakaguchi and Xbox Japan General Manager Yoshihiro Maruyama, with Newsweek's N'Gai Croal moderating. 
	<br /><br />
	As well, screenwriter and film director John Milius headlines an already talent-heavy session on Wednesday morning, May 18. Milius, who co-wrote the screenplay for Apocalypse Now with Francis Ford Coppola, is working with the Medal of Honor team on that franchises upcoming European Assault title. He joins game designer Toby Gard of Tomb Raider fame, Psychonauts designer Tim Schafer, and Bungie Studios cinematics director Joe Staten. 
	<br /><br />
	Our two in-game advertising sessions - one on Tuesday, another on Wednesday - are filling up with leaders in that fast-developing space. Mitch Davis from Massive, Guy Bendov of Double Fusion, Licensing Director Dave Anderson of Activision, Electronic Arts Director of Advertising Julie Shumaker, and Michael Dowling of Nielsen Interactive Entertainment are just a few of the thought leaders and actors in the in-game sector participating in sessions this year. 
	<br /><br />
	Of course, the Sneak Peeks session (presenting The Godfather, King Kong, and Call of Duty II) returns, this year on Wednesday, May 18th.
	<br /><br />
	Some of the industry's most renowned designers included in this year's program include Tetsuya Mizuguchi (Meteos, Lumines), Alex Ward (Burnout, Black), Todd Howard (Morrowind), Toby Gard (the upcoming Tomb Raider title), Yoot Saito (Odama), and Tim Schafer (Psychonauts) are on board. 
	<br /><br />
	Check back often for updates and milestones.
	<br /><br />
	<a href='/e3expo/conference_at_a_glance.asp'>Click here</a> to view the 2005 Conference Program.
	<br /><br />
	<p><a href='http://www.intothepixel.com' target='_blank'><img src='/assets/images/homepage/into_the_pixel.gif' alt='Into The Pixel' width='199' height='58' border='0' /></a></p>
	<b>Into the Pixel:</b>
	<br />
	Don't miss the 2005 Into the Pixel computer and videogame art gallery, in the Concourse Lobby at this year's E3Expo. Co-hosted by the Academy of Interactive Arts & Sciences, the LA County Museum of Art and E3Expo, Into the Pixel will feature 16 works of art from games, selected by a jury of experts from both the art and interactive entertainment fields. To learn more, or to submit your art, go to <a href='http://www.intothepixel.com'target='_blank'>www.intothepixel.com.</p>
	        ...
	        <tr>
		        ...
		        <td width="693" bgcolor="#718893">
                    ...
                    <p id="FooterText">The Electronic Entertainment Expo (E<sup>3</sup>) is not sponsored by or affiliated with E3 Corporation. 
                        ...
                        SALES PITCH<br />Image from ESPN Major League Baseball &copy;2004 Sega Corporation. All Rights Reserved.<br />Used with Permission.
                    </p>
