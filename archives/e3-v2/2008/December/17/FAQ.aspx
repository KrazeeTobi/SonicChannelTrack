...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKLTcwODg1MTE2NmRk9fmsH3N5prouIlnTlURegOEYYCw=" />

    <div id="content">
        <a id="interestInEsa" href="mailto:esa@theesa.com"><span>Interested in joining the ESA?</span></a>
        
    <div class="inner faq">
    <p class="title">2009 Electronic Entertainment Expo (E3) FAQ</p>
    <p class="heading">What are the elements of E3?</p>
    A full schedule will be released in the coming months. However, it will include:<br />
    
    &nbsp;&nbsp; - Exhibit floor featuring the latest in interactive entertainment and peripheral technology;<br />
    &nbsp;&nbsp; - Press conferences held by both console companies and third-party publishers; and,<br />
    &nbsp;&nbsp; - Private, in-suite meetings with leading game company executives.
   
    <p class="heading">Who can attend?</p>
    ...
    <p class="heading">Who will be exhibiting at the E3?</p>
...
<p class="heading">Are we going back to the "old" E3?</p> 
...
<p class="heading">Why the decision to remain in Los Angeles?</p>
...
<p class="heading">Why did you move the Expo to June?</p>
...
<p class="heading">I’d like to exhibit, who can I contact?</p>

Please contact IDG World Expo at (877) 216-6264.

<p class="heading">I’d like to attend E3. Who can I contact?</p>

Additional information about attending E3 will be available shortly on our website, <a href="http://www.e3expo.com" target="_blank">www.e3expo.com</a>.

<p class="title">Media</p>

<p class="heading">Will all media be able to attend to the E3? </p>
...
<p class="heading">Will you require media credentials?</p>

Yes.

<p class="heading">What are the criteria for being credentialed?</p>
...
<p class="heading">I’m a blogger/podcaster, am I considered media?</p>

ESA will credential bloggers, podcasters and other media on a case by case basis.

<p class="heading">Will press conferences be open to credentialed media only?</p>
...
<p class="heading">Will there be media only hours for the expo floor?</p>

The show floor will be open to all attendees at the same time.

<p class="title">Analysts</p>

<p class="heading">Will analysts be required to have credentials?</p>
To be admitted as an industry professional you must submit two pieces of direct and current industry identification such as a company credit card, paycheck stub or W-2 form. Individuals who cannot provide such documentation will not be permitted to attend.

<p class="heading">Will company executives still hold private meetings with analysts?</p>
