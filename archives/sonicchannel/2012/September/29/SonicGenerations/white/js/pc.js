...
function 	pageStart(){
	if(selectedPage == 1 ){//ストーリー
		...
		$("a[rel='chemicalplant']").colorbox();
		$("a[rel='skysanctuary']").colorbox();	
		$("a[rel='cityescape']").colorbox();	
		$("a[rel='speedhighway']").colorbox();	
		$("a[rel='seasidehill']").colorbox();
		$("a[rel='crisiscity']").colorbox();
		$("a[rel='orangeroofs']").colorbox();
		$("a[rel='planetwisp']").colorbox();
