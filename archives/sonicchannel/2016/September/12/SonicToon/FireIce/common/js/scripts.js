...
------------------------------------------------------------*/
	...
	*/
	...
	$(".swiper-pagination-bullet:nth-child(1),.swiper-pagination-bullet:nth-child(4)").append("<div class='newInfo'>new</div>");
...
------------------------------------------------------------*/
	...
	function characterHeight(){
		...
		if( 960 > _characterWidth && 480 < _characterWidth ){
