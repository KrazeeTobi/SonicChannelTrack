...
<div class="content3">
  ...
  <!--<form id="loginForm" name="loginForm" action="/login_toyshowuser.php" method="POST">-->
  <form id="loginForm" name="loginForm" action="" method="POST">
 
  <fieldset>
  <legend>■東京おもちゃショー2024特設サイト開発関係者ページ</legend>
	    <div></div>
   <div class="g-recaptcha" data-callback="clearcall" data-sitekey="6LfbHvMjAAAAAE94UoF6_wjX4aBw9DeaE31NIgRp"></div>                          
<script type="text/javascript">
	...
	<label for="userid">　ユーザID　</label><input type="text" id="userid" name="userid" value=""  disabled>
  <br>
  <label for="password">　パスワード </label><input type="password" id="password" name="password" value="" disabled>
  <br>
  　
  <input type="submit" id="login" name="login" value="ログイン">
    ...
    <tr>
      <td>&nbsp;</td>
      <td><span class="bd12">本ページは東京おもちゃショー2024開発中ページへのログイン画面となります。<br />
<br />
出展者様・商談日参加をご検討されている方々、一般来場者様方へ向けたページ公開ではございませんのでご了承ください。</span></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><font size="-2">※東京おもちゃショー2024運営関係者であることが入室の条件となります。正式なオープンの際は改めて告知いたしますので、今しばらくお待ちください。</font></td>
      <td>&nbsp;</td>
    </tr>
</table>
</DIV>
