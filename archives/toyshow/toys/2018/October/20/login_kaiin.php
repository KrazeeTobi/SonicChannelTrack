...
<!-- TemplateEndEditable -->
<style type="text/css"></style><!--[if lte IE 7]>
<style>
...
.style111 {font-size: 12px; color: #003300; }
...
<div class="container">
    ...
    <table width="999" border="0">
      <tr>
        <td width="1113" valign="bottom"><table width="993" border="0">
          <tr>
            <td width="505" rowspan="2" align="right" valign="bottom" class="bd10"><a href="http://www.toys.or.jp/index.html"><img src="images/home.gif"  align="left" width="300" height="50" border="0" /></a></td>
          ...
          <tr>
            <!-- Google -->
            <td height="35" colspan="5" align="right" valign="top" class="bd10"><form action="http://www.google.co.jp/search" method="get"  target="_blank">
              <input type="hidden" name="as_occt" value="any">
              <input type="hidden" name="as_sitesearch" value="www.toys.or.jp">
              <input type="hidden" name="num" value="10">サイト内検索
               <input type="text" size="20" name="as_q">
               <input type="submit" name="btnG" value="検索">Powered by <a href="http://www.google.co.jp/">Google</a>
              </form>
            <!-- Google -->
            </tr>
        </table></td> 
 ...
 <!--　ヘッダメニュー　-->
    <ul id="MenuBar1" class="MenuBarHorizontal">
      ...
      <li><a class="MenuBarItemSubmenu" href="jigyou_top.html">協会の主な事業</a>
        <ul>
          ...
          <li><a href="jigyou_kyoyuu_top.html">共遊玩具推進事業</a>
            <ul>  
              <li><a href="jigyou_kyoyuu_top.html">共遊玩具推進部会の活動</a></li>
              <li><a href="jigyou_kyoyuu_moudouken.html">盲導犬マークのおもちゃ</a></li>
              <li><a href="jigyou_kyoyuu_usagi.html">うさぎマークのおもちゃ</a></li>
              <li><a href="jigyou_kyoyuu_world.html">世界に広がる共遊玩具</a></li>
              <li><a href="jigyou_kyoyuu_catalog.html">お問合せ・カタログ</a></li>
            </ul>
      ...
      <li><a href="login_kaiin.html">会員専用ページ</a></li>
    </ul> 
...
<div class="content3">
  ...
  <!--<form id="loginForm" name="loginForm" action="/login_kaiin.php" method="POST">-->
  <form id="loginForm" name="loginForm" action="" method="POST">
 
  <fieldset>
  <legend>会員専用ページ</legend>
  <div></div>
  ...
  <input type="submit" id="login" name="login" value="ログイン">
    ...
    <tr>
      <td>&nbsp;</td>
      <td><span class="bd12"><u>        IDは、数字から始まります</u>。会員更新手続き時の年１回ＩＤ・パスワードを変更させていただいております。<br />
<br />
ST申請システムのIDとは異なりますのでご注意ください(こちらのIDはアルファベット1文字で始まります)。</span></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><font size="-2">※日本玩具協会会員であることが入室の条件となります。ＩＤ，パスワードは、会員企業各社へ配布しておりますので、ご担当部署にお問い合わせください。</font></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><span class="bd12">■<a href="kaiin_ichiran.html">会員一覧</a></span></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><span class="bd12">■<a href="nyukai.html">入会のご案内</a></span></td>
      <td>&nbsp;</td>
    </tr>
</table>
</DIV>
