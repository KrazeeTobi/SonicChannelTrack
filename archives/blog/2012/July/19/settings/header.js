...
//        str += '<img alt="' + unescape('3D%u30C6%u30EC%u30D3%u306B%u8208%u5473%u306F%u3042%u308A%u307E%u3059%u304B%3F%28%u30D7%u30EC%u30BC%u30F3%u30C8%u4ED8%u304D%29') + '" src="http://parts.blog.livedoor.jp/img/user_blog/livedoor/pickup.gif" /><a href="http://blogpark.jp/common_theme-196840.html">' + unescape('3D%u30C6%u30EC%u30D3%u306B%u8208%u5473%u306F%u3042%u308A%u307E%u3059%u304B%3F%28%u30D7%u30EC%u30BC%u30F3%u30C8%u4ED8%u304D%29') + '</a>';
    ...
    str += 'table#header{width:100%;height:20px!important;font-size:10px!important;}';
    ...
    deleteOldHeader = function () {
        ...
        if (typeof(ld_blog_vars) == 'object') {
            ...
            if(ld_blog_vars.blog_category.hierarchy.length >= 1 && (ld_blog_vars.blog_category.hierarchy[0].id == 143 || ld_blog_vars.blog_category.hierarchy[0].permalink.match(/\/143\//))) {
            	load_ads([
       ...
       function () {
          ...
          var ldReSearchFormatter = function(p) {
             ...
             var str = [
                ...
                '</a>',
                '<a href="' + p.search_link_url + '" class="ReSearchLink" style="display: block;position: relative;z-index: 2;width: 232px;height: 87px;text-align: center;text-decoration: none;color: #424242;"><span style="display: block;padding: 5px 5px 5px 20px;margin: 29px 15px 0 5px;text-align: left;font-weight: bold;background: #fff url(http://parts.blog.livedoor.jp/img/static/search_frame/blue/search.gif) no-repeat 0 5px;border-color: #46b1da;border: 1px solid #46b1da;font-weight: bold; -moz-border-radius: 4px; -webkit-border-radius: 4px;">' + p.escaped_query + '</span></a>',
                '</div>',
                '</div>',
                '<style type="text/css">',
                '#ReSearchFormWrapper {',
