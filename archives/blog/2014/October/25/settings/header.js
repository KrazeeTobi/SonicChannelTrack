(function () {
    ...
    var ads = [
    '<a href="http://api.unthem.com/click?zid=1130&aid=17910&url=http%3A%2F%2Fblog.livedoor.com%2Flp%2Fsignup%3Facode%3Dbf5fc5a8468a334d8ce67c19e1da0ebe&guid=on" class="">\u30D6\u30ED\u30B0\u958B\u8A2D\uFF08\u7121\u6599\uFF09</a>',
    '<a href="http://api.unthem.com/click?zid=1130&aid=17911&url=http%3A%2F%2Fblog.jp%2F%3Facode%3Dbf5fc5a8468a334d8ce67c19e1da0ebe&guid=on" class="">\u30D6\u30ED\u30B0\u958B\u8A2D\uFF08\u7121\u6599\uFF09</a>',
    '<a href="http://api.unthem.com/click?zid=1130&aid=17912&url=http%3A%2F%2Fblog.livedoor.com%2Flp%2Fsignup%3Facode%3Db8423226c6a5b645c47c863bb765a09c&guid=on" class="">\u30D6\u30ED\u30B0\u3092\u4F5C\u308B</a>'
    ];
...
//        str += '<img alt="' + unescape('3D%u30C6%u30EC%u30D3%u306B%u8208%u5473%u306F%u3042%u308A%u307E%u3059%u304B%3F%28%u30D7%u30EC%u30BC%u30F3%u30C8%u4ED8%u304D%29') + '" src="http://parts.blog.livedoor.jp/img/user_blog/livedoor/pickup.gif" /><a href="http://blogpark.jp/common_theme-196840.html">' + unescape('3D%u30C6%u30EC%u30D3%u306B%u8208%u5473%u306F%u3042%u308A%u307E%u3059%u304B%3F%28%u30D7%u30EC%u30BC%u30F3%u30C8%u4ED8%u304D%29') + '</a>';
    ...
    str += '<a href="http://blog.livedoor.com/news/">'+ month +'\u6708' + day +"\u65E5"+'\u8A71\u984C\u306E\u8A18\u4E8B</a>';
    str += '</td>';
    str += '</tr>';
    str += '</table></div>';
    ...
    str += 'table#header span.common-header-category{margin-right:20px;}';
    str += 'table#header td.newstickerbox{width:97%;}';
    str += 'table#header td.startblogbox{white-space:nowrap;padding:0;padding:0 10px 0 21px;font-size:12px;vertical-align:middle;background:url(http://parts.blog.livedoor.jp/img/user_blog/livedoor/calendar_icon.png) no-repeat center left;zoom:1;}';
    str += 'table#header td.startblogbox.startblogboxEntry{background:url(http://parts.blog.livedoor.jp/img/user_blog/livedoor/entry_icon.png) no-repeat center left;padding-right: 15px;}';
    str += 'table#header td.catprbox{width:1%;white-space:nowrap;}';
    str += 'table#header td.catprbox span{margin-right:15px;}';
    str += 'table#header td.pickuptheme{width:1%;white-space:nowrap;}';
    str += '</style>';
