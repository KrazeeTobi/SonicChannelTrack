var characters = {
	mario : {
		...
		charDesc : "Een vrolijke loodgieter en de favoriete superster van iedereen. Hij neemt het met zijn springtalent en atletische vaardigheid op tegen Bowser.",
	...
	luigi: {
		...
		charDesc : "Mario's jongere tweelingbroer. Hij is een beetje verlegen (vooral bij spoken) maar hij is aardig en net zo goed als zijn broer.",
	...
	peach: {
		...
		charDesc : "Prinses van het Mushroom Kingdom. Ze heeft een goede band met Mario en is altijd aardig. Ze houdt van koken en bakken.",
	...
	yoshi: {
		...
		charDesc : "Mario's vriendelijke, relaxte bondgenoot van Yoshi's Island. Met zijn lange tong kan hij zowel fruit als vijanden opeten en ze in eieren veranderen.",
	...
	bowser: {
		...
		charDesc : "De kracht en vurige adem van de Koopa Koning en zijn grote leger Goomba's, Koopa Troopa's, en meer maken hem een constant gevaar voor de wereldvrede.",
	...
	sonic: {
		...
		charDesc : "De snelste egel ter wereld. Hij kan impulsief en ongeduldig zijn, maar hij wordt gedreven door goedheid en een sterk gevoel voor rechtvaardigheid.",
	...
	knuckles: {
		...
		charDesc : "Een machtige mierenegel die op Angel Island woont als de eenzame bewaker van de Master Emerald.",
	...
	tails: {
		...
		charDesc : "Een aardige vos met twee staarten. Hij kan vliegen door zijn staarten als rotor te gebruiken en met zijn technische talent helpt hij Sonic op zijn avonturen.",
	...
	amy: {
		...
		charDesc : "Een egel die een echte doorzetter is en de kamer doet oplichten als ze er is. Ze is doortastend en zal niet aarzelen om het kwaad aan te pakken met haar trouwe hamer.",
	...
	eggman: {
		...
		charDesc : "Een zogenaamde boosaardige wetenschapper en mechanisch genie met een IQ van 300. Hij geeft nooit zijn plannen op om de wereld over te nemen.",
	...
	daisy: {
		...
		charDesc : "De Prinses van Sarasaland. Ze is vrolijk, actief en altijd boordevol energie.",
	...
	wario: {
		...
		charDesc : "Het is nooit saai met Wario, een luidruchtige, brutale gast die zegt dat hij Mario's grootste rivaal is. Hij is dol op knoflook en geld.",
	...
	waluigi: {
		...
		charDesc : "Het vriendje van Wario, dat denkt dat hij Luigi's rivaal is. Zijn slungelige armen en benen maken hem een geduchte tegenstander in allerlei sporten.",
	...
	donkeykong: {
		...
		charDesc : "Koning van de jungle en superster van de Kong Family. Hij is zo sterk, dat het niet grappig meer is. Hij zou alles doen voor een paar bananen.",
	...
	bowserjr: {
		...
		charDesc : "Het kleine zoontje van de Koopa Koning. Hij mag dan wel klein zijn, maar hij is net zo sterk en egoïstisch als zijn vader. Heeft een masker met een grote mond op.",
	...
	shadow: {
		...
		charDesc : "Een zwarte egel die bekend staat als de ultieme levensvorm. Hij heeft een onsterfelijk lichaam en gebruikt Chaos Emeralds om ruimte en tijd te vervormen.",
	...
	silver: {
		...
		charDesc : "Een egel uit een verwoeste toekomst. Hij is altijd positief en heeft een sterk rechtvaardigheidsgevoel. Met zijn krachtige telekinese kan hij grote voorwerpen verplaatsen en hij kan er ook door vliegen.",
	...
	metalsonic: {
		...
		charDesc : "Een zeer vernuftige robot, gebouwd door Dr. Eggman om Sonic na te bootsen. Hij heeft Sonics snelheid en dient als gehoorzame helper van Eggman.",
	...
	blaze: {
		...
		charDesc : "Een prinses uit een andere wereld die de Sol Emeralds gebruikt die ze beschermt. Ze houdt altijd het hoofd koel en is hard voor zichzelf, maar toch blijft ze een beetje verlegen.",
	...
	vector: {
		...
		charDesc : "Het hoofd van de Chaotix Detective Agency. Hij heeft een scherpe geest en een scherpe tong, maar hij is ook een optimist met een meelevend hart.",
