var characters = {
	mario : {
		...
		charDesc : "Un plombier toujours enjoué et adoré par les fans. Il défie Bowser avec ses talents en saut et ses compétences athlétiques supérieures.",
	...
	luigi: {
		...
		charDesc : "Jeune jumeau de Mario. Il est un peu timide (surtout près des fantômes), mais il a bon cœur et est tout aussi doué que son frère.",
	...
	peach: {
		...
		charDesc : "La princesse du Royaume Champignon. Elle est très attachée à Mario et fait preuve d'une bonté sans faille. C'est un vrai cordon bleu !",
	...
	yoshi: {
		...
		charDesc : "Ami gentil et paisible de Mario, venu de l'Île des Yoshis. Avec sa grande langue, il peut gober les ennemis pour les changer en œufs.",
	...
	bowser: {
		...
		charDesc : "Le roi des Koopa possède une force étonnante, crache du feu et commande une grande armée de Goombas et de Koopa.",
	...
	sonic: {
		...
		charDesc : "Le hérisson le plus rapide du monde. Il peut se montrer têtu et impatient, mais il n'est motivé que par la justice et le devoir.",
	...
	knuckles: {
		...
		charDesc : "Un échidné puissant qui habite sur Angel Island en tant que gardien solitaire de la Master Emerald.",
	...
	tails: {
		...
		charDesc : "Jeune renard tendre, il peut faire tournoyer ses deux queues pour voler. Ses talents bricoleurs aident Sonic dans ses aventures.",
	...
	amy: {
		...
		charDesc : "Hérissonne toujours partante pour s'amuser. Très déterminée, elle n'hésite pas à brandir son marteau fétiche pour combattre le mal.",
	...
	eggman: {
		...
		charDesc : "Scientifique diabolique autoproclamé et génie mécanique doté d'un QI de 300. Il n'abandonne jamais ses plans de conquête du monde.",
	...
	daisy: {
		...
		charDesc : "La princesse de Sarasaland. Toujours enjouée, elle déborde d'énergie et trouve toujours de quoi s'occuper.",
	...
	wario: {
		...
		charDesc : "On ne s'ennuie jamais avec Wario. Ce lourdaud au rire puissant prétend être le plus grand rival de Mario. Il adore l'ail et le miel.",
	...
	waluigi: {
		...
		charDesc : "Le compagnon de Wario qui se prend pour le rival de Luigi. Son physique dégingandé lui permet de participer à toutes sortes de sports.",
	...
	donkeykong: {
		...
		charDesc : "Roi de la jungle et vedette de la famille Kong. Il est si fort que ça en devient presque énervant. Il ferait tout pour une banane ou dix.",
	...
	bowserjr: {
		...
		charDesc : "Le fiston du roi Bowser. Il a beau être petit, il est aussi fort et égoïste que son père. Il porte un masque avec une grosse bouche.",
	...
	shadow: {
		...
		charDesc : "Hérisson noir connu comme la forme de vie ultime. Immortel, il utilise les Chaos Emerald pour ses voyages spatiaux-temporels.",
	...
	silver: {
		...
		charDesc : "Hérisson du futur. Toujours optimiste, il œuvre pour la justice. Avec ses pouvoirs de télékinésie, il peut déplacer de gros objets et léviter.",
	...
	metalsonic: {
		...
		charDesc : "Un robot ultra sophistiqué conçu par Dr. Eggman pour imiter Sonic. Il est aussi rapide et puissant que ce dernier mais œuvre au service de Dr. Eggman.",
	...
	blaze: {
		...
		charDesc : "Princesse d'un autre univers, les Sol Emeralds la protègent. Parfois timide, elle a la tête sur les épaules et est intransigeante.",
	...
	vector: {
		...
		charDesc : "Chef de l'Agence de détectives Chaotix. Il a l'esprit vif et la répartie acerbe, mais c'est un éternel optimiste avec le cœur sur la main.",
