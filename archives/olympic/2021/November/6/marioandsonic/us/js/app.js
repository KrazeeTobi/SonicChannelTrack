var characters = {
	mario : {
		...
		charDesc : "A cheerful plumber and everyone's favorite superstar. He stands up to Bowser with his jumping skills and all-around athletic ability.",
	...
	luigi: {
		...
		charDesc : "Mario's younger twin brother. He's a little timid (especially around ghosts) but is kind and just as capable as his brother.",
	...
	peach: {
		...
		charDesc : "Princess of the Mushroom Kingdom. She has a close bond with Mario and is unfailingly kind. She loves baking and cooking.",
	...
	yoshi: {
		...
		charDesc : "Mario's kind, chill ally from Yoshi's Island. His long tongue lets him gobble up fruit and foe alike and turn them into eggs.",
	...
	bowser: {
		...
		charDesc : "The Koopa King's strength, fire breath, and large army of Goombas, Koopa Troopas, and more make him a constant threat to world peace.",
	...
	sonic: {
		...
		charDesc : "The world's fastest hedgehog. He can be impulsive and impatient, but he is driven by kindness and a strong sense of justice.",
	...
	knuckles: {
		...
		charDesc : "A powerful echidna who lives on Angel Island as the lone guardian of the Master Emerald.",
	...
	tails: {
		...
		charDesc : "A kind, twin-tailed fox kit. He can spin his tails to fly through the air, and his engineering talent helps Sonic on his adventures.",
	...
	amy: {
		...
		charDesc : "A hedgehog who is a real go-getter and lights up the room when she's around. She's quite strong-minded, and won't hesitate at taking on evil with her trusty hammer.",
	...
	eggman: {
		...
		charDesc : "A self-proclaimed evil scientist and mechanical genius with an IQ of 300. He never gives up on his plans to take over the world.",
	...
	daisy: {
		...
		charDesc : "The Princess of Sarasaland. She is cheerful, active, and always full of energy.",
	...
	wario: {
		...
		charDesc : "Never a dull moment with Wario, a loud, brash fellow who says he's Mario's greatest rival. He loves garlic and money.",
	...
	waluigi: {
		...
		charDesc : "Wario's pal who thinks he's Luigi's rival. His gangly arms and legs make him a fierce competitor in all manner of sports.",
	...
	donkeykong: {
		...
		charDesc : "King of the jungle and superstar of the Kong Family. He's so strong, it isn't funny. He'd do anything for a banana or ten.",
	...
	bowserjr: {
		...
		charDesc : "The Koopa King's little boy. He might be small, but he's got all of Papa's strength and selfishness. Wears a mask with a big mouth on it.",
	...
	shadow: {
		...
		charDesc : "A black hedgehog known as the ultimate life form. Created with an immortal body, he wields Chaos Emeralds to warp space and time.",
	...
	silver: {
		...
		charDesc : "A hedgehog from a devastated future. He is always positive and has a strong sense of justice. His powerful psychokinesis can move big objects as well as allow him to levitate.",
	...
	metalsonic: {
		...
		charDesc : "A high-performance robot built by Dr. Eggman to mimic Sonic. He has Sonic's speed and power, and serves as Eggman's obedient henchman.",
	...
	blaze: {
		...
		charDesc : "A princess from another world who uses the Sol Emeralds she protects. Cool-headed and hard on herself, she's still a little shy.",
	...
	vector: {
		...
		charDesc : "The head of the Chaotix Detective Agency. He has a sharp mind and a sharp tongue, but is also an optimist with a compassionate heart.",
	...
	//preloader
	function preloader() {
		jQuery("html, body").animate({ scrollTop: jQuery('.hero').offset().top + 20 }, 100);
...
//	var winWidth = jQuery(window).width();
	jQuery("html, body").animate({ scrollTop: jQuery('#purchase').offset().top - 100 }, 1000);
//	if (winWidth < 1024){
