var characters = {
	mario : {
		...
		charDesc : "Неунывающий сантехник и всеобщий любимец. Он противопоставляет Боузеру свои прыжковые навыки и всестороннюю спортивную подготовку.",
	...
	luigi: {
		...
		charDesc : "Младший брат-близнец Марио. Немного робкий (особенно когда дело касается призраков), но в то же время добрый и умелый, как и его старший брат.",
	...
	peach: {
		...
		charDesc : "Принцесса Грибного королевства. Она всегда доброжелательна и всем сердцем привязана к Марио. Любит готовить и печь.",
	...
	yoshi: {
		...
		charDesc : "Миролюбивый и спокойный товарищ Марио с острова Йоши. С помощью длинного языка может не только доставать фрукты с высоких веток, но и хватать врагов, превращая их в яйца.",
	...
	bowser: {
		...
		charDesc : "Вечный соперник Марио. Сила, огненное дыхание и огромная армия гумб, купа-трупов и других существ превращают Короля Куп в вечную угрозу для всего мира.",
	...
	sonic: {
		...
		charDesc : "Самый быстрый ёжик в мире. Порой импульсивный и нетерпеливый, он, тем не менее, всегда руководствуется добрыми намерениями и сильным чувством справедливости.",
	...
	knuckles: {
		...
		charDesc : "Ехидна-силач с острова Ангелов. Одинокий страж Мастера Изумруда.",
	...
	tails: {
		...
		charDesc : "Добрый двухвостый лисёнок. Умеет летать, особым образом раскручивая хвосты, а его инженерный талант не раз выручал Соника в различных приключениях.",
	...
	amy: {
		...
		charDesc : "Ежиха, способная сделать лучше всё, к чему прикасается. Рядом с ней даже солнце светит ярче. Энергичная и умная, она в то же время не стесняется расправляться со злом с помощью своего молотка.",
	...
	eggman: {
		...
		charDesc : "Самопровозглашённый злобный учёный и гениальный механик с IQ 300. Никогда не отступает от своих планов по захвату мира.",
	...
	daisy: {
		...
		charDesc : "Принцесса Сарасалэнда. Весёлая, энергичная и деятельная девушка.",
	...
	wario: {
		...
		charDesc : "Рядом с шумным и дерзким Варио скучать не придётся. Он называет себя величайшим соперником Марио. А ещё любит чеснок и деньги.",
	...
	waluigi: {
		...
		charDesc : "Приятель Варио, считающий себя соперником Луиджи. Длинные руки и ноги делают его опасным конкурентом во всех видах спорта.",
	...
	donkeykong: {
		...
		charDesc : "Король джунглей и настоящая суперзвезда семейства Конгов. Он настолько силён, что это уже не смешно. И готов на всё ради банана. Или десятка бананов.",
	...
	bowserjr: {
		...
		charDesc : "Отпрыск Короля Куп. Может, он пока и мал, зато в полной мере унаследовал отцовскую силу и эгоизм. Носит маску с большим нарисованным ртом.",
	...
	shadow: {
		...
		charDesc : "Чёрный ёж, известный как высшая форма жизни. Создатели наделили его бессмертным телом и способностью перемещаться в пространстве и времени с помощью Изумрудов Хаоса.",
	...
	silver: {
		...
		charDesc : "Ёжик из практически погибшего мира будущего. Оптимист с сильным чувством справедливости. С помощью телекинеза может левитировать и двигать большие объекты.",
	...
	metalsonic: {
		...
		charDesc : "Высокопроизводительный робот, созданный доктором Эггманом в попытке скопировать Соника. Он обладает силой и скоростью Соника, которые Эггман использует в своих целях.",
	...
	blaze: {
		...
		charDesc : "Принцесса другого мира, способная использовать Сол Изумруды, находящиеся под её защитой. Хладнокровная и требовательная к самой себе, она в то же время может быть и немного стеснительной.",
	...
	vector: {
		...
		charDesc : "Глава детективного агентства «Хаотикс». Отличается острым умом и не менее острым языком, оптимизмом и большим сердцем, способным сострадать.",
