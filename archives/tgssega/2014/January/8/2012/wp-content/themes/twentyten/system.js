$(document).ready(function() {
	$.Juitter.start({
		...
		searchObject:"SEGA_EVENT,%23SEGA_TGS2012", // needed, you can insert a username here or a word to be searched for, if you wish multiple search, separate the words by comma.
