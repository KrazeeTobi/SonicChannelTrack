$(document).ready(function() {
	$.Juitter.start({
		...
		searchObject:"%23TGS_SEGA", // needed, you can insert a username here or a word to be searched for, if you wish multiple search, separate the words by comma.
		...
		readMore: "Twitterで読む", // read more message to be show after the tweet content
